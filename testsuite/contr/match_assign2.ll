...
define internal void @"$create_event_63"(%Uint128 %_amount, [20 x i8]* %"$_sender_64", %Int32 %m) {
entry:
...
define internal void @"$t1_102"(%Uint128 %_amount, [20 x i8]* %"$_sender_103", %"TName_Pair_List_(Int32)_Int32"* %p) {
entry:
...
"$have_gas_132":                                  ; preds = %"$out_of_gas_131", %"$Pair_123"
  ...
  call void @"$create_event_63"(%Uint128 %_amount, [20 x i8]* %"$create_event__sender_134", %Int32 %"$$a_0_135")
...
"$have_gas_139":                                  ; preds = %"$out_of_gas_138", %"$matchsucc_119"
  ...
  call void @"$create_event_63"(%Uint128 %_amount, [20 x i8]* %"$create_event__sender_141", %Int32 %"$a_142")
  ret void
}
...
entry:
  ...
  call void @"$t1_102"(%Uint128 %_amount, [20 x i8]* %"$_sender_147", %"TName_Pair_List_(Int32)_Int32"* %p)
  ret void
}
