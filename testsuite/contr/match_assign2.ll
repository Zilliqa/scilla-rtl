...
define internal void @"$create_event_69"(%Uint128 %_amount, [20 x i8]* %"$_origin_70", [20 x i8]* %"$_sender_71", %Int32 %m) {
entry:
...
"$have_gas_105":                                  ; preds = %"$out_of_gas_104", %"$have_gas_80"
  ...
  call void @_event(i8* %"$execptr_load_107", %_TyDescrTy_Typ* @"$TyDescr_Event_26", i8* %"$e_108")
  ret void
}
...
define internal void @"$t1_109"(%Uint128 %_amount, [20 x i8]* %"$_origin_110", [20 x i8]* %"$_sender_111", %"TName_Pair_List_(Int32)_Int32"* %p) {
entry:
...
"$have_gas_140":                                  ; preds = %"$out_of_gas_139", %"$Pair_131"
  ...
  call void @"$create_event_69"(%Uint128 %_amount, [20 x i8]* %"$create_event__origin_142", [20 x i8]* %"$create_event__sender_143", %Int32 %"$$a_1_144")
...
"$have_gas_148":                                  ; preds = %"$out_of_gas_147", %"$matchsucc_127"
  ...
  call void @"$create_event_69"(%Uint128 %_amount, [20 x i8]* %"$create_event__origin_150", [20 x i8]* %"$create_event__sender_151", %Int32 %"$a_152")
  ret void
}
...
entry:
  ...
  call void @"$t1_109"(%Uint128 %_amount, [20 x i8]* %"$_origin_157", [20 x i8]* %"$_sender_159", %"TName_Pair_List_(Int32)_Int32"* %p)
  ret void
}
