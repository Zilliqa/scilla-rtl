...
define internal void @"$t1_116"(%Uint128 %_amount, [20 x i8]* %"$_origin_117", [20 x i8]* %"$_sender_118", %"TName_Pair_List_(Int32)_Int32"* %p) {
entry:
...
"$have_gas_147":                                  ; preds = %"$out_of_gas_146", %"$Pair_138"
  ...
  call void @"$create_event_76"(%Uint128 %_amount, [20 x i8]* %"$create_event__origin_149", [20 x i8]* %"$create_event__sender_150", %Int32 %"$$a_1_151")
...
"$have_gas_155":                                  ; preds = %"$out_of_gas_154", %"$matchsucc_134"
  ...
  call void @"$create_event_76"(%Uint128 %_amount, [20 x i8]* %"$create_event__origin_157", [20 x i8]* %"$create_event__sender_158", %Int32 %"$a_159")
  ret void
}
...
entry:
  ...
  call void @"$t1_116"(%Uint128 %_amount, [20 x i8]* %"$_origin_164", [20 x i8]* %"$_sender_166", %"TName_Pair_List_(Int32)_Int32"* %p)
  ret void
}
