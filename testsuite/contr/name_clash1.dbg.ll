...
"$have_gas_70":                                   ; preds = %"$out_of_gas_69", %entry
  ...
  call void @_update_field(i8* %"$execptr_load_72", i8* getelementptr inbounds ([2 x i8], [2 x i8]* @"$x_73", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Int32_8", i32 0, i8* null, i8* %"$update_value_76"), !dbg !10
  ret void
}
...
define internal void @"$create_event_77"(%Uint128 %_amount, [20 x i8]* %"$_sender_78", %Int32 %m) !dbg !11 {
entry:
...
"$have_gas_112":                                  ; preds = %"$out_of_gas_111", %"$have_gas_87"
  ...
  call void @_event(i8* %"$execptr_load_114", %_TyDescrTy_Typ* @"$TyDescr_Event_30", i8* %"$e_115"), !dbg !13
  ret void
}
...
define internal void @"$t1_116"(%Uint128 %_amount, [20 x i8]* %"$_sender_117", %TName_Bool* %c) !dbg !14 {
entry:
  %_sender = load [20 x i8], [20 x i8]* %"$_sender_117", align 1
  %"$x_0" = alloca %Int32, align 8
  %"$execptr_load_118" = load i8*, i8** @_execptr, align 8
  %"$$x_0_120" = call i8* @_fetch_field(i8* %"$execptr_load_118", i8* getelementptr inbounds ([2 x i8], [2 x i8]* @"$x_119", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Int32_8", i32 0, i8* null, i32 1), !dbg !15
...
"$have_gas_141":                                  ; preds = %"$out_of_gas_140", %"$have_gas_136"
  ...
  store %TName_List_Int32* %"$adtptr_145", %TName_List_Int32** %"$x_1", align 8, !dbg !16
...
"$have_gas_170":                                  ; preds = %"$out_of_gas_169", %"$Cons_161"
  ...
  store %Int32 %"$$x_2_172", %Int32* %"$x_3", align 4, !dbg !18
...
"$have_gas_183":                                  ; preds = %"$out_of_gas_182", %"$matchsucc_156"
  ...
  call void @"$create_event_77"(%Uint128 %_amount, [20 x i8]* %"$create_event__sender_185", %Int32 %"$$x_3_186"), !dbg !23
  ret void
}
...
entry:
  ...
  call void @"$t1_116"(%Uint128 %_amount, [20 x i8]* %"$_sender_191", %TName_Bool* %c), !dbg !25
  ret void
}
