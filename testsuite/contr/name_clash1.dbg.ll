...
"$have_gas_80":                                   ; preds = %"$out_of_gas_79", %entry
  ...
  call void @_update_field(i8* %"$execptr_load_82", i8* getelementptr inbounds ([2 x i8], [2 x i8]* @"$x_83", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Int32_9", i32 0, i8* null, i8* %"$update_value_86"), !dbg !11
  ret void
}

declare void @_update_field(i8*, i8*, %_TyDescrTy_Typ*, i32, i8*, i8*)

define internal void @"$create_event_87"(%Uint128 %_amount, [20 x i8]* %"$_origin_88", [20 x i8]* %"$_sender_89", %Int32 %m) !dbg !12 {
entry:
...
"$have_gas_98":                                   ; preds = %"$out_of_gas_97", %"$have_gas_93"
  ...
  store i8* %"$msgobj_100", i8** %e, align 8, !dbg !13
...
"$have_gas_123":                                  ; preds = %"$out_of_gas_122", %"$have_gas_98"
  ...
  call void @_event(i8* %"$execptr_load_125", %_TyDescrTy_Typ* @"$TyDescr_Event_31", i8* %"$e_126"), !dbg !14
  ret void
}
...
define internal void @"$t1_127"(%Uint128 %_amount, [20 x i8]* %"$_origin_128", [20 x i8]* %"$_sender_129", %TName_Bool* %c) !dbg !15 {
entry:
  ...
  %"$$x_1_call_132" = call i8* @_fetch_field(i8* %"$execptr_load_131", i8* getelementptr inbounds ([2 x i8], [2 x i8]* @"$x_130", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Int32_9", i32 0, i8* null, i32 1), !dbg !16
...
"$have_gas_153":                                  ; preds = %"$out_of_gas_152", %"$have_gas_148"
  ...
  store %TName_List_Int32* %"$adtptr_157", %TName_List_Int32** %"$x_2", align 8, !dbg !17
...
"$have_gas_182":                                  ; preds = %"$out_of_gas_181", %"$Cons_173"
  ...
  store %Int32 %"$$x_3_184", %Int32* %"$x_4", align 4, !dbg !19
...
"$have_gas_195":                                  ; preds = %"$out_of_gas_194", %"$matchsucc_168"
  ...
  call void @"$create_event_87"(%Uint128 %_amount, [20 x i8]* %"$create_event__origin_197", [20 x i8]* %"$create_event__sender_198", %Int32 %"$$x_4_199"), !dbg !24
  ret void
}
...
entry:
  ...
  call void @"$t1_127"(%Uint128 %_amount, [20 x i8]* %"$_origin_204", [20 x i8]* %"$_sender_206", %TName_Bool* %c), !dbg !26
  ret void
}
