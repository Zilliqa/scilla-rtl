...
@"$tparams_t1_211" = unnamed_addr constant [4 x %"$ParamDescr_203"] [%"$ParamDescr_203" { %ParamDescrString { i8* getelementptr inbounds ([7 x i8], [7 x i8]* @"$tpname__amount_207", i32 0, i32 0), i32 7 }, %_TyDescrTy_Typ* @"$TyDescr_Uint128_18" }, %"$ParamDescr_203" { %ParamDescrString { i8* getelementptr inbounds ([7 x i8], [7 x i8]* @"$tpname__origin_208", i32 0, i32 0), i32 7 }, %_TyDescrTy_Typ* @"$TyDescr_Addr_45" }, %"$ParamDescr_203" { %ParamDescrString { i8* getelementptr inbounds ([7 x i8], [7 x i8]* @"$tpname__sender_209", i32 0, i32 0), i32 7 }, %_TyDescrTy_Typ* @"$TyDescr_Addr_45" }, %"$ParamDescr_203" { %ParamDescrString { i8* getelementptr inbounds ([1 x i8], [1 x i8]* @"$tpname_c_210", i32 0, i32 0), i32 1 }, %_TyDescrTy_Typ* @"$TyDescr_ADT_Bool_41" }]
@"$tname_t1_212" = unnamed_addr constant [2 x i8] c"t1"
@_transition_parameters = constant [1 x %"$TransDescr_204"] [%"$TransDescr_204" { %ParamDescrString { i8* getelementptr inbounds ([2 x i8], [2 x i8]* @"$tname_t1_212", i32 0, i32 0), i32 2 }, i32 4, %"$ParamDescr_203"* getelementptr inbounds ([4 x %"$ParamDescr_203"], [4 x %"$ParamDescr_203"]* @"$tparams_t1_211", i32 0, i32 0) }]
...
"$have_gas_74":                                   ; preds = %"$out_of_gas_73", %entry
  ...
  store %Int32 { i32 1 }, %Int32* %"$x_5", align 4, !dbg !10
  ...
  call void @_update_field(i8* %"$execptr_load_76", i8* getelementptr inbounds ([2 x i8], [2 x i8]* @"$x_77", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Int32_8", i32 0, i8* null, i8* %"$update_value_80"), !dbg !10
  ret void
}
...
define internal void @"$create_event_81"(%Uint128 %_amount, [20 x i8]* %"$_origin_82", [20 x i8]* %"$_sender_83", %Int32 %m) !dbg !11 {
entry:
...
"$have_gas_92":                                   ; preds = %"$out_of_gas_91", %"$have_gas_87"
  ...
  store i8* %"$msgobj_94", i8** %e, align 8, !dbg !12
...
"$have_gas_117":                                  ; preds = %"$out_of_gas_116", %"$have_gas_92"
  ...
  call void @_event(i8* %"$execptr_load_119", %_TyDescrTy_Typ* @"$TyDescr_Event_30", i8* %"$e_120"), !dbg !13
  ret void
}
...
define internal void @"$t1_121"(%Uint128 %_amount, [20 x i8]* %"$_origin_122", [20 x i8]* %"$_sender_123", %TName_Bool* %c) !dbg !14 {
entry:
  ...
  %"$$x_0_call_126" = call i8* @_fetch_field(i8* %"$execptr_load_125", i8* getelementptr inbounds ([2 x i8], [2 x i8]* @"$x_124", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Int32_8", i32 0, i8* null, i32 1), !dbg !15
...
"$have_gas_147":                                  ; preds = %"$out_of_gas_146", %"$have_gas_142"
  ...
  store %TName_List_Int32* %"$adtptr_151", %TName_List_Int32** %"$x_1", align 8, !dbg !16
...
"$have_gas_176":                                  ; preds = %"$out_of_gas_175", %"$Cons_167"
  ...
  store %Int32 %"$$x_2_178", %Int32* %"$x_3", align 4, !dbg !18
...
"$have_gas_184":                                  ; preds = %"$out_of_gas_183", %"$Nil_179"
  ...
  store %Int32 { i32 2 }, %Int32* %"$x_3", align 4, !dbg !21
  br label %"$matchsucc_162"
...
"$have_gas_189":                                  ; preds = %"$out_of_gas_188", %"$matchsucc_162"
  ...
  call void @"$create_event_81"(%Uint128 %_amount, [20 x i8]* %"$create_event__origin_191", [20 x i8]* %"$create_event__sender_192", %Int32 %"$$x_3_193"), !dbg !23
  ret void
}
...
entry:
  ...
  call void @"$t1_121"(%Uint128 %_amount, [20 x i8]* %"$_origin_198", [20 x i8]* %"$_sender_200", %TName_Bool* %c), !dbg !25
  ret void
}
...
!16 = !DILocation(line: 14, column: 7, scope: !14)
!17 = !DILocation(line: 15, column: 7, scope: !14)
!18 = !DILocation(line: 16, column: 21, scope: !19)
!19 = distinct !DILexicalBlock(scope: !20, file: !2, line: 16, column: 9)
!20 = distinct !DILexicalBlock(scope: !14, file: !2, line: 15, column: 7)
!21 = !DILocation(line: 17, column: 16, scope: !22)
!22 = distinct !DILexicalBlock(scope: !20, file: !2, line: 17, column: 9)
!23 = !DILocation(line: 19, column: 3, scope: !14)
!24 = distinct !DISubprogram(name: "t1", linkageName: "t1", scope: !2, file: !2, line: 12, type: !6, scopeLine: 12, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !1, retainedNodes: !3)
