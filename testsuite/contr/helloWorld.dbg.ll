...
"$have_gas_197":                                  ; preds = %"$out_of_gas_196", %"$have_gas_192"
  ...
  store i8* %"$msgobj_199", i8** %e, align 8, !dbg !22
...
"$have_gas_223":                                  ; preds = %"$out_of_gas_222", %"$have_gas_197"
  ...
  call void @_event(i8* %"$execptr_load_225", %_TyDescrTy_Typ* @"$TyDescr_Event_29", i8* %"$e_226"), !dbg !25
...
"$have_gas_235":                                  ; preds = %"$out_of_gas_234", %"$True_227"
  ...
  call void @_update_field(i8* %"$execptr_load_237", i8* getelementptr inbounds ([12 x i8], [12 x i8]* @"$welcome_msg_238", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_String_23", i32 0, i8* null, i8* %"$update_value_240"), !dbg !26
...
"$have_gas_249":                                  ; preds = %"$out_of_gas_248", %"$have_gas_244"
  ...
  store i8* %"$msgobj_251", i8** %e1, align 8, !dbg !28
...
"$have_gas_275":                                  ; preds = %"$out_of_gas_274", %"$have_gas_249"
  ...
  call void @_event(i8* %"$execptr_load_277", %_TyDescrTy_Typ* @"$TyDescr_Event_29", i8* %"$e_278"), !dbg !29
  br label %"$matchsucc_182"
...
entry:
  ...
  call void @"$setHello_162"(%Uint128 %_amount, [20 x i8]* %"$_origin_283", [20 x i8]* %"$_sender_285", %String %msg), !dbg !31
  ret void
}

define internal void @"$getHello_288"(%Uint128 %_amount, [20 x i8]* %"$_origin_289", [20 x i8]* %"$_sender_290") !dbg !32 {
entry:
  ...
  %"$r_call_293" = call i8* @_fetch_field(i8* %"$execptr_load_292", i8* getelementptr inbounds ([12 x i8], [12 x i8]* @"$welcome_msg_291", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_String_23", i32 0, i8* null, i32 1), !dbg !33
...
"$have_gas_314":                                  ; preds = %"$out_of_gas_313", %"$have_gas_309"
  ...
  store i8* %"$msgobj_316", i8** %e, align 8, !dbg !34
...
"$have_gas_340":                                  ; preds = %"$out_of_gas_339", %"$have_gas_314"
  ...
  call void @_event(i8* %"$execptr_load_342", %_TyDescrTy_Typ* @"$TyDescr_Event_29", i8* %"$e_343"), !dbg !35
  ret void
}
...
entry:
  ...
  call void @"$getHello_288"(%Uint128 %_amount, [20 x i8]* %"$_origin_348", [20 x i8]* %"$_sender_350"), !dbg !37
  ret void
}

define internal void @"$multipleMsgs_351"(%Uint128 %_amount, [20 x i8]* %"$_origin_352", [20 x i8]* %"$_sender_353") !dbg !38 {
entry:
...
"$have_gas_362":                                  ; preds = %"$out_of_gas_361", %"$have_gas_357"
  ...
  store i8* %"$msgobj_364", i8** %msg1, align 8, !dbg !39
...
"$have_gas_396":                                  ; preds = %"$out_of_gas_395", %"$have_gas_391"
  ...
  store i8* %"$msgobj_398", i8** %msg2, align 8, !dbg !40
...
"$have_gas_430":                                  ; preds = %"$out_of_gas_429", %"$have_gas_425"
  ...
  %"$helloWorld.one_msg_call_436" = call %TName_List_Message* %"$helloWorld.one_msg_fptr_433"(i8* %"$helloWorld.one_msg_envptr_434", i8* %"$msg1_435"), !dbg !41
  store %TName_List_Message* %"$helloWorld.one_msg_call_436", %TName_List_Message** %"$helloWorld.one_msg_0", align 8, !dbg !41
  %"$$helloWorld.one_msg_0_437" = load %TName_List_Message*, %TName_List_Message** %"$helloWorld.one_msg_0", align 8
  store %TName_List_Message* %"$$helloWorld.one_msg_0_437", %TName_List_Message** %msgs1, align 8, !dbg !41
...
"$have_gas_446":                                  ; preds = %"$out_of_gas_445", %"$have_gas_441"
  ...
  store %TName_List_Message* %"$adtptr_454", %TName_List_Message** %msgs2, align 8, !dbg !42
...
"$have_gas_461":                                  ; preds = %"$out_of_gas_460", %"$have_gas_446"
  ...
  call void @_send(i8* %"$execptr_load_463", %_TyDescrTy_Typ* @"$TyDescr_ADT_List_Message_42", %TName_List_Message* %"$msgs2_464"), !dbg !43
  ret void
}
...
entry:
  ...
  call void @"$multipleMsgs_351"(%Uint128 %_amount, [20 x i8]* %"$_origin_469", [20 x i8]* %"$_sender_471"), !dbg !45
  ret void
}

define internal void @"$contrAddr_472"(%Uint128 %_amount, [20 x i8]* %"$_origin_473", [20 x i8]* %"$_sender_474") !dbg !46 {
entry:
...
"$have_gas_483":                                  ; preds = %"$out_of_gas_482", %"$have_gas_478"
  ...
  store i8* %"$msgobj_485", i8** %msg1, align 8, !dbg !47
...
"$have_gas_509":                                  ; preds = %"$out_of_gas_508", %"$have_gas_483"
  ...
  call void @_event(i8* %"$execptr_load_511", %_TyDescrTy_Typ* @"$TyDescr_Event_29", i8* %"$msg1_512"), !dbg !48
  ret void
}
...
entry:
  ...
  call void @"$contrAddr_472"(%Uint128 %_amount, [20 x i8]* %"$_origin_517", [20 x i8]* %"$_sender_519"), !dbg !50
  ret void
}

define internal void @"$printContrParams_520"(%Uint128 %_amount, [20 x i8]* %"$_origin_521", [20 x i8]* %"$_sender_522") !dbg !51 {
entry:
...
"$have_gas_531":                                  ; preds = %"$out_of_gas_530", %"$have_gas_526"
  ...
  store i8* %"$msgobj_533", i8** %e, align 8, !dbg !52
...
"$have_gas_605":                                  ; preds = %"$out_of_gas_604", %"$have_gas_531"
  ...
  call void @_event(i8* %"$execptr_load_607", %_TyDescrTy_Typ* @"$TyDescr_Event_29", i8* %"$e_608"), !dbg !53
  ret void
}
...
entry:
  ...
  call void @"$printContrParams_520"(%Uint128 %_amount, [20 x i8]* %"$_origin_613", [20 x i8]* %"$_sender_615"), !dbg !55
  ret void
}
