...
"$have_gas_160":                                  ; preds = %"$out_of_gas_159", %"$have_gas_155"
  ...
  store %String %"$name_162", %String* %"$welcome_msg_5", align 8, !dbg !18
  ...
  call void @_update_field(i8* %"$execptr_load_163", i8* getelementptr inbounds ([12 x i8], [12 x i8]* @"$welcome_msg_164", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_String_25", i32 0, i8* null, i8* %"$update_value_167"), !dbg !18
...
"$have_gas_171":                                  ; preds = %"$out_of_gas_170", %"$have_gas_160"
  ...
  store %String %"$helloWorld.smsg_173", %String* %"$sendoff_msg_6", align 8, !dbg !19
  ...
  call void @_update_field(i8* %"$execptr_load_174", i8* getelementptr inbounds ([12 x i8], [12 x i8]* @"$sendoff_msg_175", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_String_25", i32 0, i8* null, i8* %"$update_value_178"), !dbg !19
  ret void
}

declare void @_update_field(i8*, i8*, %_TyDescrTy_Typ*, i32, i8*, i8*)

define internal void @"$setHello_179"(%Uint128 %_amount, [20 x i8]* %"$_origin_180", [20 x i8]* %"$_sender_181", %String %msg) !dbg !20 {
entry:
...
"$have_gas_190":                                  ; preds = %"$out_of_gas_189", %"$have_gas_185"
  ...
  %"$eq_call_198" = call %TName_Bool* @_eq_ByStrX(i8* %"$execptr_load_192", i32 20, i8* %"$$eq_owner_193_195", i8* %"$$eq__sender_196_197"), !dbg !21
  store %TName_Bool* %"$eq_call_198", %TName_Bool** %is_owner, align 8, !dbg !21
...
"$have_gas_220":                                  ; preds = %"$out_of_gas_219", %"$have_gas_215"
  ...
  store i8* %"$msgobj_222", i8** %e, align 8, !dbg !23
...
"$have_gas_246":                                  ; preds = %"$out_of_gas_245", %"$have_gas_220"
  ...
  call void @_event(i8* %"$execptr_load_248", %_TyDescrTy_Typ* @"$TyDescr_Event_31", i8* %"$e_249"), !dbg !26
...
"$have_gas_258":                                  ; preds = %"$out_of_gas_257", %"$True_250"
  ...
  call void @_update_field(i8* %"$execptr_load_260", i8* getelementptr inbounds ([12 x i8], [12 x i8]* @"$welcome_msg_261", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_String_25", i32 0, i8* null, i8* %"$update_value_263"), !dbg !27
...
"$have_gas_272":                                  ; preds = %"$out_of_gas_271", %"$have_gas_267"
  ...
  store i8* %"$msgobj_274", i8** %e1, align 8, !dbg !29
...
"$have_gas_298":                                  ; preds = %"$out_of_gas_297", %"$have_gas_272"
  ...
  call void @_event(i8* %"$execptr_load_300", %_TyDescrTy_Typ* @"$TyDescr_Event_31", i8* %"$e_301"), !dbg !30
  br label %"$matchsucc_205"
...
entry:
  ...
  call void @"$setHello_179"(%Uint128 %_amount, [20 x i8]* %"$_origin_306", [20 x i8]* %"$_sender_308", %String %msg), !dbg !32
  ret void
}

define internal void @"$getHello_311"(%Uint128 %_amount, [20 x i8]* %"$_origin_312", [20 x i8]* %"$_sender_313") !dbg !33 {
entry:
  ...
  %"$r_call_316" = call i8* @_fetch_field(i8* %"$execptr_load_315", i8* getelementptr inbounds ([12 x i8], [12 x i8]* @"$welcome_msg_314", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_String_25", i32 0, i8* null, i32 1), !dbg !34
...
"$have_gas_337":                                  ; preds = %"$out_of_gas_336", %"$have_gas_332"
  ...
  store i8* %"$msgobj_339", i8** %e, align 8, !dbg !35
...
"$have_gas_363":                                  ; preds = %"$out_of_gas_362", %"$have_gas_337"
  ...
  call void @_event(i8* %"$execptr_load_365", %_TyDescrTy_Typ* @"$TyDescr_Event_31", i8* %"$e_366"), !dbg !36
  ret void
}
...
entry:
  ...
  call void @"$getHello_311"(%Uint128 %_amount, [20 x i8]* %"$_origin_371", [20 x i8]* %"$_sender_373"), !dbg !38
  ret void
}

define internal void @"$multipleMsgs_374"(%Uint128 %_amount, [20 x i8]* %"$_origin_375", [20 x i8]* %"$_sender_376") !dbg !39 {
entry:
...
"$have_gas_385":                                  ; preds = %"$out_of_gas_384", %"$have_gas_380"
  ...
  store i8* %"$msgobj_387", i8** %msg1, align 8, !dbg !40
...
"$have_gas_419":                                  ; preds = %"$out_of_gas_418", %"$have_gas_414"
  ...
  store i8* %"$msgobj_421", i8** %msg2, align 8, !dbg !41
...
"$have_gas_453":                                  ; preds = %"$out_of_gas_452", %"$have_gas_448"
  ...
  %"$helloWorld.one_msg_call_459" = call %TName_List_Message* %"$helloWorld.one_msg_fptr_456"(i8* %"$helloWorld.one_msg_envptr_457", i8* %"$msg1_458"), !dbg !42
  store %TName_List_Message* %"$helloWorld.one_msg_call_459", %TName_List_Message** %"$helloWorld.one_msg_2", align 8, !dbg !42
  %"$$helloWorld.one_msg_2_460" = load %TName_List_Message*, %TName_List_Message** %"$helloWorld.one_msg_2", align 8
  store %TName_List_Message* %"$$helloWorld.one_msg_2_460", %TName_List_Message** %msgs1, align 8, !dbg !42
...
"$have_gas_469":                                  ; preds = %"$out_of_gas_468", %"$have_gas_464"
  ...
  store %TName_List_Message* %"$adtptr_477", %TName_List_Message** %msgs2, align 8, !dbg !43
...
"$have_gas_484":                                  ; preds = %"$out_of_gas_483", %"$have_gas_469"
  ...
  call void @_send(i8* %"$execptr_load_486", %_TyDescrTy_Typ* @"$TyDescr_ADT_List_Message_44", %TName_List_Message* %"$msgs2_487"), !dbg !44
  ret void
}
...
entry:
  ...
  call void @"$multipleMsgs_374"(%Uint128 %_amount, [20 x i8]* %"$_origin_492", [20 x i8]* %"$_sender_494"), !dbg !46
  ret void
}

define internal void @"$contrAddr_495"(%Uint128 %_amount, [20 x i8]* %"$_origin_496", [20 x i8]* %"$_sender_497") !dbg !47 {
entry:
...
"$have_gas_506":                                  ; preds = %"$out_of_gas_505", %"$have_gas_501"
  ...
  store i8* %"$msgobj_508", i8** %msg1, align 8, !dbg !48
...
"$have_gas_532":                                  ; preds = %"$out_of_gas_531", %"$have_gas_506"
  ...
  call void @_event(i8* %"$execptr_load_534", %_TyDescrTy_Typ* @"$TyDescr_Event_31", i8* %"$msg1_535"), !dbg !49
  ret void
}
...
entry:
  ...
  call void @"$contrAddr_495"(%Uint128 %_amount, [20 x i8]* %"$_origin_540", [20 x i8]* %"$_sender_542"), !dbg !51
  ret void
}

define internal void @"$printContrParams_543"(%Uint128 %_amount, [20 x i8]* %"$_origin_544", [20 x i8]* %"$_sender_545") !dbg !52 {
entry:
...
"$have_gas_554":                                  ; preds = %"$out_of_gas_553", %"$have_gas_549"
  ...
  store i8* %"$msgobj_556", i8** %e, align 8, !dbg !53
...
"$have_gas_628":                                  ; preds = %"$out_of_gas_627", %"$have_gas_554"
  ...
  call void @_event(i8* %"$execptr_load_630", %_TyDescrTy_Typ* @"$TyDescr_Event_31", i8* %"$e_631"), !dbg !54
  ret void
}
...
entry:
  ...
  call void @"$printContrParams_543"(%Uint128 %_amount, [20 x i8]* %"$_origin_636", [20 x i8]* %"$_sender_638"), !dbg !56
  ret void
}
