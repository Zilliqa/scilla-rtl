...
"$have_gas_150":                                  ; preds = %"$out_of_gas_149", %entry
  ...
  store %TName_Bool* %"$adtptr_154", %TName_Bool** @ud-proxy.true, align 8, !dbg !14
...
"$have_gas_158":                                  ; preds = %"$out_of_gas_157", %"$have_gas_150"
  ...
  store %TName_List_Message* %"$adtptr_162", %TName_List_Message** @ud-proxy.nilMessage, align 8, !dbg !15
...
"$have_gas_166":                                  ; preds = %"$out_of_gas_165", %"$have_gas_158"
  ...
  store { %TName_List_Message* (i8*, i8*)*, i8* } %"$$fundef_7_cloval_171", { %TName_List_Message* (i8*, i8*)*, i8* }* @ud-proxy.oneMsg, align 8, !dbg !16
...
"$have_gas_177":                                  ; preds = %"$out_of_gas_176", %"$have_gas_166"
  ...
  store { { i8* (i8*, %TName_Bool*)*, i8* } (i8*, [20 x i8]*)*, i8* } { { i8* (i8*, %TName_Bool*)*, i8* } (i8*, [20 x i8]*)* bitcast ({ i8* (i8*, %TName_Bool*)*, i8* } (%"$$fundef_3_env_87"*, [20 x i8]*)* @"$fundef_3" to { i8* (i8*, %TName_Bool*)*, i8* } (i8*, [20 x i8]*)*), i8* null }, { { i8* (i8*, %TName_Bool*)*, i8* } (i8*, [20 x i8]*)*, i8* }* @ud-proxy.eAdminSet, align 8, !dbg !17
...
"$have_gas_185":                                  ; preds = %"$out_of_gas_184", %"$have_gas_177"
  ...
  store i8* %"$msgobj_187", i8** @ud-proxy.eError, align 8, !dbg !18
  ret void
}

define void @_init_state() !dbg !19 {
entry:
...
"$have_gas_205":                                  ; preds = %"$out_of_gas_204", %"$have_gas_200"
  ...
  store %Map_ByStr20_Bool* %"$Emp_209", %Map_ByStr20_Bool** %empty, align 8, !dbg !20
  ...
  store %Map_ByStr20_Bool* %"$_put_219", %Map_ByStr20_Bool** %"$admins_9", align 8, !dbg !21
  ...
  call void @_update_field(i8* %"$execptr_load_220", i8* getelementptr inbounds ([7 x i8], [7 x i8]* @"$admins_221", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_48", i32 0, i8* null, i8* %"$update_value_223"), !dbg !20
  ret void
}
...
define internal void @"$setAdmin_224"(%Uint128 %_amount, [20 x i8]* %"$_sender_225", [20 x i8]* %"$address_226", %TName_Bool* %isApproved) !dbg !22 {
entry:
  ...
  %"$maybeAdmin_231" = call i8* @_fetch_field(i8* %"$execptr_load_229", i8* getelementptr inbounds ([7 x i8], [7 x i8]* @"$admins_230", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_48", i32 1, i8* %"$indices_buf_227", i32 1), !dbg !23
...
"$have_gas_265":                                  ; preds = %"$out_of_gas_264", %"$Some_258"
  ...
  store %TName_Bool* %"$approval_267", %TName_Bool** %isSenderAdmin, align 8, !dbg !25
...
"$have_gas_273":                                  ; preds = %"$out_of_gas_272", %"$None_268"
  ...
  store %TName_Bool* %"$adtptr_277", %TName_Bool** %isSenderAdmin, align 8, !dbg !28
  br label %"$matchsucc_253"
...
"$have_gas_296":                                  ; preds = %"$out_of_gas_295", %"$True_288"
  ...
  call void @_update_field(i8* %"$execptr_load_300", i8* getelementptr inbounds ([7 x i8], [7 x i8]* @"$admins_301", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_48", i32 1, i8* %"$indices_buf_298", i8* %"$update_value_302"), !dbg !31
...
"$have_gas_311":                                  ; preds = %"$out_of_gas_310", %"$have_gas_306"
  ...
  %"$ud-proxy.eAdminSet_call_317" = call { i8* (i8*, %TName_Bool*)*, i8* } %"$ud-proxy.eAdminSet_fptr_314"(i8* %"$ud-proxy.eAdminSet_envptr_315", [20 x i8]* %"$ud-proxy.eAdminSet_address_316"), !dbg !34
  store { i8* (i8*, %TName_Bool*)*, i8* } %"$ud-proxy.eAdminSet_call_317", { i8* (i8*, %TName_Bool*)*, i8* }* %"$ud-proxy.eAdminSet_0", align 8, !dbg !34
  ...
  %"$$ud-proxy.eAdminSet_0_call_321" = call i8* %"$$ud-proxy.eAdminSet_0_fptr_319"(i8* %"$$ud-proxy.eAdminSet_0_envptr_320", %TName_Bool* %isApproved), !dbg !34
  store i8* %"$$ud-proxy.eAdminSet_0_call_321", i8** %"$ud-proxy.eAdminSet_1", align 8, !dbg !34
  %"$$ud-proxy.eAdminSet_1_322" = load i8*, i8** %"$ud-proxy.eAdminSet_1", align 8
  store i8* %"$$ud-proxy.eAdminSet_1_322", i8** %e, align 8, !dbg !34
...
"$have_gas_329":                                  ; preds = %"$out_of_gas_328", %"$have_gas_311"
  ...
  call void @_event(i8* %"$execptr_load_331", %_TyDescrTy_Typ* @"$TyDescr_Event_34", i8* %"$e_332"), !dbg !35
...
"$have_gas_341":                                  ; preds = %"$out_of_gas_340", %"$False_333"
  ...
  call void @_event(i8* %"$execptr_load_343", %_TyDescrTy_Typ* @"$TyDescr_Event_34", i8* %"$ud-proxy.eError_344"), !dbg !36
  br label %"$matchsucc_283"
...
define void @setAdmin(i8* %0) !dbg !38 {
entry:
  ...
  call void @"$setAdmin_224"(%Uint128 %_amount, [20 x i8]* %"$_sender_349", [20 x i8]* %"$address_351", %TName_Bool* %isApproved), !dbg !39
  ret void
}

define internal void @"$bestow_354"(%Uint128 %_amount, [20 x i8]* %"$_sender_355", %String %label, [20 x i8]* %"$owner_356", [20 x i8]* %"$resolver_357") !dbg !40 {
entry:
  ...
  %"$maybeAdmin_362" = call i8* @_fetch_field(i8* %"$execptr_load_360", i8* getelementptr inbounds ([7 x i8], [7 x i8]* @"$admins_361", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_48", i32 1, i8* %"$indices_buf_358", i32 1), !dbg !41
...
"$have_gas_396":                                  ; preds = %"$out_of_gas_395", %"$Some_389"
  ...
  store %TName_Bool* %"$isAdmin_398", %TName_Bool** %isSenderAdmin, align 8, !dbg !43
...
"$have_gas_404":                                  ; preds = %"$out_of_gas_403", %"$None_399"
  ...
  store %TName_Bool* %"$adtptr_408", %TName_Bool** %isSenderAdmin, align 8, !dbg !46
  br label %"$matchsucc_384"
...
"$have_gas_434":                                  ; preds = %"$out_of_gas_433", %"$have_gas_429"
  ...
  store i8* %"$msgobj_436", i8** %m, align 8, !dbg !49
...
"$have_gas_485":                                  ; preds = %"$out_of_gas_484", %"$have_gas_434"
  ...
  %"$ud-proxy.oneMsg_call_491" = call %TName_List_Message* %"$ud-proxy.oneMsg_fptr_488"(i8* %"$ud-proxy.oneMsg_envptr_489", i8* %"$m_490"), !dbg !52
  store %TName_List_Message* %"$ud-proxy.oneMsg_call_491", %TName_List_Message** %"$ud-proxy.oneMsg_2", align 8, !dbg !52
  %"$$ud-proxy.oneMsg_2_492" = load %TName_List_Message*, %TName_List_Message** %"$ud-proxy.oneMsg_2", align 8
  store %TName_List_Message* %"$$ud-proxy.oneMsg_2_492", %TName_List_Message** %msgs, align 8, !dbg !52
...
"$have_gas_499":                                  ; preds = %"$out_of_gas_498", %"$have_gas_485"
  ...
  call void @_send(i8* %"$execptr_load_501", %_TyDescrTy_Typ* @"$TyDescr_ADT_List_Message_46", %TName_List_Message* %"$msgs_502"), !dbg !53
...
"$have_gas_511":                                  ; preds = %"$out_of_gas_510", %"$False_503"
  ...
  call void @_event(i8* %"$execptr_load_513", %_TyDescrTy_Typ* @"$TyDescr_Event_34", i8* %"$ud-proxy.eError_514"), !dbg !54
  br label %"$matchsucc_414"
...
define void @bestow(i8* %0) !dbg !56 {
entry:
  ...
  call void @"$bestow_354"(%Uint128 %_amount, [20 x i8]* %"$_sender_519", %String %label, [20 x i8]* %"$owner_523", [20 x i8]* %"$resolver_525"), !dbg !57
  ret void
}
...
!13 = distinct !DISubprogram(name: "_init_libs", linkageName: "_init_libs", scope: !2, file: !2, type: !5, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !1, retainedNodes: !3)
!14 = !DILocation(line: 7, column: 12, scope: !13)
!15 = !DILocation(line: 8, column: 18, scope: !13)
!16 = !DILocation(line: 12, column: 5, scope: !13)
!17 = !DILocation(line: 16, column: 3, scope: !13)
!18 = !DILocation(line: 19, column: 14, scope: !13)
!19 = distinct !DISubprogram(name: "_init_state", linkageName: "_init_state", scope: !2, file: !2, type: !5, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !1, retainedNodes: !3)
!20 = !DILocation(line: 26, column: 15, scope: !19)
!21 = !DILocation(line: 27, column: 5, scope: !19)
!22 = distinct !DISubprogram(name: "setAdmin", linkageName: "setAdmin", scope: !2, file: !2, line: 29, type: !5, scopeLine: 29, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !1, retainedNodes: !3)
!23 = !DILocation(line: 30, column: 3, scope: !22)
!24 = !DILocation(line: 33, column: 5, scope: !22)
!25 = !DILocation(line: 34, column: 24, scope: !26)
!26 = distinct !DILexicalBlock(scope: !27, file: !2, line: 34, column: 7)
!27 = distinct !DILexicalBlock(scope: !22, file: !2, line: 33, column: 5)
!28 = !DILocation(line: 35, column: 15, scope: !29)
!29 = distinct !DILexicalBlock(scope: !27, file: !2, line: 35, column: 7)
!30 = !DILocation(line: 38, column: 3, scope: !22)
!31 = !DILocation(line: 40, column: 5, scope: !32)
!32 = distinct !DILexicalBlock(scope: !33, file: !2, line: 39, column: 5)
!33 = distinct !DILexicalBlock(scope: !22, file: !2, line: 38, column: 3)
!34 = !DILocation(line: 42, column: 9, scope: !32)
!35 = !DILocation(line: 43, column: 5, scope: !32)
!36 = !DILocation(line: 45, column: 5, scope: !37)
!37 = distinct !DILexicalBlock(scope: !33, file: !2, line: 44, column: 5)
!38 = distinct !DISubprogram(name: "setAdmin", linkageName: "setAdmin", scope: !2, file: !2, line: 29, type: !5, scopeLine: 29, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !1, retainedNodes: !3)
!39 = !DILocation(line: 29, column: 12, scope: !38)
!40 = distinct !DISubprogram(name: "bestow", linkageName: "bestow", scope: !2, file: !2, line: 49, type: !5, scopeLine: 49, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !1, retainedNodes: !3)
!41 = !DILocation(line: 50, column: 3, scope: !40)
!42 = !DILocation(line: 53, column: 5, scope: !40)
!43 = !DILocation(line: 54, column: 23, scope: !44)
!44 = distinct !DILexicalBlock(scope: !45, file: !2, line: 54, column: 7)
!45 = distinct !DILexicalBlock(scope: !40, file: !2, line: 53, column: 5)
!46 = !DILocation(line: 55, column: 15, scope: !47)
!47 = distinct !DILexicalBlock(scope: !45, file: !2, line: 55, column: 7)
!48 = !DILocation(line: 58, column: 3, scope: !40)
!49 = !DILocation(line: 61, column: 15, scope: !50)
!50 = distinct !DILexicalBlock(scope: !51, file: !2, line: 59, column: 5)
!51 = distinct !DILexicalBlock(scope: !40, file: !2, line: 58, column: 3)
!52 = !DILocation(line: 63, column: 7, scope: !50)
!53 = !DILocation(line: 64, column: 5, scope: !50)
!54 = !DILocation(line: 66, column: 5, scope: !55)
!55 = distinct !DILexicalBlock(scope: !51, file: !2, line: 65, column: 5)
!56 = distinct !DISubprogram(name: "bestow", linkageName: "bestow", scope: !2, file: !2, line: 49, type: !5, scopeLine: 49, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !1, retainedNodes: !3)
