...
define internal void @"$setAdmin_228"(%Uint128 %_amount, [20 x i8]* %"$_sender_229", [20 x i8]* %"$address_230", %TName_Bool* %isApproved) {
entry:
  ...
  %"$maybeAdmin_235" = call i8* @_fetch_field(i8* %"$execptr_load_233", i8* getelementptr inbounds ([7 x i8], [7 x i8]* @"$admins_234", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_48", i32 1, i8* %"$indices_buf_231", i32 1)
...
"$have_gas_269":                                  ; preds = %"$out_of_gas_268", %"$Some_262"
  ...
  store %TName_Bool* %"$approval_271", %TName_Bool** %isSenderAdmin, align 8
...
"$have_gas_277":                                  ; preds = %"$out_of_gas_276", %"$None_272"
  ...
  store %TName_Bool* %"$adtptr_281", %TName_Bool** %isSenderAdmin, align 8
  br label %"$matchsucc_257"
...
"$have_gas_300":                                  ; preds = %"$out_of_gas_299", %"$True_292"
  ...
  call void @_update_field(i8* %"$execptr_load_304", i8* getelementptr inbounds ([7 x i8], [7 x i8]* @"$admins_305", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_48", i32 1, i8* %"$indices_buf_302", i8* %"$update_value_306")
...
"$have_gas_315":                                  ; preds = %"$out_of_gas_314", %"$have_gas_310"
  ...
  %"$ud-proxy.eAdminSet_call_321" = call { i8* (i8*, %TName_Bool*)*, i8* } %"$ud-proxy.eAdminSet_fptr_318"(i8* %"$ud-proxy.eAdminSet_envptr_319", [20 x i8]* %"$ud-proxy.eAdminSet_address_320")
  store { i8* (i8*, %TName_Bool*)*, i8* } %"$ud-proxy.eAdminSet_call_321", { i8* (i8*, %TName_Bool*)*, i8* }* %"$ud-proxy.eAdminSet_0", align 8
  ...
  %"$$ud-proxy.eAdminSet_0_call_325" = call i8* %"$$ud-proxy.eAdminSet_0_fptr_323"(i8* %"$$ud-proxy.eAdminSet_0_envptr_324", %TName_Bool* %isApproved)
  store i8* %"$$ud-proxy.eAdminSet_0_call_325", i8** %"$ud-proxy.eAdminSet_1", align 8
  %"$$ud-proxy.eAdminSet_1_326" = load i8*, i8** %"$ud-proxy.eAdminSet_1", align 8
  store i8* %"$$ud-proxy.eAdminSet_1_326", i8** %e, align 8
...
"$have_gas_333":                                  ; preds = %"$out_of_gas_332", %"$have_gas_315"
  ...
  call void @_event(i8* %"$execptr_load_335", %_TyDescrTy_Typ* @"$TyDescr_Event_34", i8* %"$e_336")
...
"$have_gas_345":                                  ; preds = %"$out_of_gas_344", %"$False_337"
  ...
  call void @_event(i8* %"$execptr_load_347", %_TyDescrTy_Typ* @"$TyDescr_Event_34", i8* %"$ud-proxy.eError_348")
  br label %"$matchsucc_287"
...
entry:
  ...
  call void @"$setAdmin_228"(%Uint128 %_amount, [20 x i8]* %"$_sender_353", [20 x i8]* %"$address_355", %TName_Bool* %isApproved)
  ret void
}

define internal void @"$bestow_358"(%Uint128 %_amount, [20 x i8]* %"$_sender_359", %String %label, [20 x i8]* %"$owner_360", [20 x i8]* %"$resolver_361") {
entry:
  ...
  %"$maybeAdmin_366" = call i8* @_fetch_field(i8* %"$execptr_load_364", i8* getelementptr inbounds ([7 x i8], [7 x i8]* @"$admins_365", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_48", i32 1, i8* %"$indices_buf_362", i32 1)
...
"$have_gas_400":                                  ; preds = %"$out_of_gas_399", %"$Some_393"
  ...
  store %TName_Bool* %"$isAdmin_402", %TName_Bool** %isSenderAdmin, align 8
...
"$have_gas_408":                                  ; preds = %"$out_of_gas_407", %"$None_403"
  ...
  store %TName_Bool* %"$adtptr_412", %TName_Bool** %isSenderAdmin, align 8
  br label %"$matchsucc_388"
...
"$have_gas_438":                                  ; preds = %"$out_of_gas_437", %"$have_gas_433"
  ...
  store i8* %"$msgobj_440", i8** %m, align 8
...
"$have_gas_489":                                  ; preds = %"$out_of_gas_488", %"$have_gas_438"
  ...
  %"$ud-proxy.oneMsg_call_495" = call %TName_List_Message* %"$ud-proxy.oneMsg_fptr_492"(i8* %"$ud-proxy.oneMsg_envptr_493", i8* %"$m_494")
  store %TName_List_Message* %"$ud-proxy.oneMsg_call_495", %TName_List_Message** %"$ud-proxy.oneMsg_2", align 8
  %"$$ud-proxy.oneMsg_2_496" = load %TName_List_Message*, %TName_List_Message** %"$ud-proxy.oneMsg_2", align 8
  store %TName_List_Message* %"$$ud-proxy.oneMsg_2_496", %TName_List_Message** %msgs, align 8
...
"$have_gas_503":                                  ; preds = %"$out_of_gas_502", %"$have_gas_489"
  ...
  call void @_send(i8* %"$execptr_load_505", %_TyDescrTy_Typ* @"$TyDescr_ADT_List_Message_46", %TName_List_Message* %"$msgs_506")
...
"$have_gas_515":                                  ; preds = %"$out_of_gas_514", %"$False_507"
  ...
  call void @_event(i8* %"$execptr_load_517", %_TyDescrTy_Typ* @"$TyDescr_Event_34", i8* %"$ud-proxy.eError_518")
  br label %"$matchsucc_418"
...
entry:
  ...
  call void @"$bestow_358"(%Uint128 %_amount, [20 x i8]* %"$_sender_523", %String %label, [20 x i8]* %"$owner_527", [20 x i8]* %"$resolver_529")
  ret void
}
