...
define internal i8* @"$fundef_1"(%"$$fundef_1_env_86"* %0, [20 x i8]* %1, %TName_Bool* %2) {
entry:
...
"$have_gas_105":                                  ; preds = %"$out_of_gas_104", %entry
  ...
  store i8* %"$msgobj_107", i8** %"$retval_2", align 8
  %"$$retval_2_131" = load i8*, i8** %"$retval_2", align 8
  ret i8* %"$$retval_2_131"
}

define internal %TName_List_Message* @"$fundef_3"(%"$$fundef_3_env_87"* %0, i8* %1) {
entry:
...
"$have_gas_93":                                   ; preds = %"$out_of_gas_92", %entry
  ...
  store %TName_List_Message* %"$adtptr_100", %TName_List_Message** %"$retval_4", align 8
...
"$have_gas_135":                                  ; preds = %"$out_of_gas_134", %entry
  ...
  store %TName_Bool* %"$adtptr_139", %TName_Bool** @ud-proxy.true, align 8
...
"$have_gas_143":                                  ; preds = %"$out_of_gas_142", %"$have_gas_135"
  ...
  store %TName_List_Message* %"$adtptr_147", %TName_List_Message** @ud-proxy.nilMessage, align 8
...
"$have_gas_151":                                  ; preds = %"$out_of_gas_150", %"$have_gas_143"
  ...
  store { %TName_List_Message* (i8*, i8*)*, i8* } %"$$fundef_3_cloval_156", { %TName_List_Message* (i8*, i8*)*, i8* }* @ud-proxy.oneMsg, align 8
...
"$have_gas_162":                                  ; preds = %"$out_of_gas_161", %"$have_gas_151"
  ...
  store { i8* (i8*, [20 x i8]*, %TName_Bool*)*, i8* } { i8* (i8*, [20 x i8]*, %TName_Bool*)* bitcast (i8* (%"$$fundef_1_env_86"*, [20 x i8]*, %TName_Bool*)* @"$fundef_1" to i8* (i8*, [20 x i8]*, %TName_Bool*)*), i8* null }, { i8* (i8*, [20 x i8]*, %TName_Bool*)*, i8* }* @ud-proxy.eAdminSet, align 8
...
"$have_gas_170":                                  ; preds = %"$out_of_gas_169", %"$have_gas_162"
  ...
  store i8* %"$msgobj_172", i8** @ud-proxy.eError, align 8
  ret void
}
...
"$have_gas_190":                                  ; preds = %"$out_of_gas_189", %"$have_gas_185"
  ...
  store %Map_ByStr20_Bool* %"$_new_empty_map_194", %Map_ByStr20_Bool** %empty, align 8
...
"$have_gas_202":                                  ; preds = %"$out_of_gas_201", %"$have_gas_190"
  ...
  %"$put_call_212" = call i8* @_put(i8* %"$execptr_load_204", %_TyDescrTy_Typ* @"$TyDescr_Map_44", i8* %"$$empty_205_206", i8* %"$$put_initialAdmin_207_209", i8* %"$$ud-proxy.true_210_211")
  %"$put_213" = bitcast i8* %"$put_call_212" to %Map_ByStr20_Bool*
  store %Map_ByStr20_Bool* %"$put_213", %Map_ByStr20_Bool** %"$admins_5", align 8
  ...
  call void @_update_field(i8* %"$execptr_load_214", i8* getelementptr inbounds ([7 x i8], [7 x i8]* @"$admins_215", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_44", i32 0, i8* null, i8* %"$update_value_217")
  ret void
}
...
define internal void @"$setAdmin_218"(%Uint128 %_amount, [20 x i8]* %"$_origin_219", [20 x i8]* %"$_sender_220", [20 x i8]* %"$address_221", %TName_Bool* %isApproved) {
entry:
  ...
  %"$maybeAdmin_call_226" = call i8* @_fetch_field(i8* %"$execptr_load_225", i8* getelementptr inbounds ([7 x i8], [7 x i8]* @"$admins_224", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_44", i32 1, i8* %"$indices_buf_222", i32 1)
...
"$have_gas_260":                                  ; preds = %"$out_of_gas_259", %"$Some_253"
  ...
  store %TName_Bool* %"$approval_262", %TName_Bool** %isSenderAdmin, align 8
...
"$have_gas_268":                                  ; preds = %"$out_of_gas_267", %"$None_263"
  ...
  store %TName_Bool* %"$adtptr_272", %TName_Bool** %isSenderAdmin, align 8
  br label %"$matchsucc_248"
...
"$have_gas_291":                                  ; preds = %"$out_of_gas_290", %"$True_283"
  ...
  call void @_update_field(i8* %"$execptr_load_295", i8* getelementptr inbounds ([7 x i8], [7 x i8]* @"$admins_296", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_44", i32 1, i8* %"$indices_buf_293", i8* %"$update_value_297")
...
"$have_gas_306":                                  ; preds = %"$out_of_gas_305", %"$have_gas_301"
  ...
  %"$ud-proxy.eAdminSet_call_312" = call i8* %"$ud-proxy.eAdminSet_fptr_309"(i8* %"$ud-proxy.eAdminSet_envptr_310", [20 x i8]* %"$ud-proxy.eAdminSet_address_311", %TName_Bool* %isApproved)
  store i8* %"$ud-proxy.eAdminSet_call_312", i8** %e, align 8
...
"$have_gas_319":                                  ; preds = %"$out_of_gas_318", %"$have_gas_306"
  ...
  call void @_event(i8* %"$execptr_load_321", %_TyDescrTy_Typ* @"$TyDescr_Event_30", i8* %"$e_322")
...
"$have_gas_331":                                  ; preds = %"$out_of_gas_330", %"$False_323"
  ...
  call void @_event(i8* %"$execptr_load_333", %_TyDescrTy_Typ* @"$TyDescr_Event_30", i8* %"$ud-proxy.eError_334")
  br label %"$matchsucc_278"
...
entry:
  ...
  call void @"$setAdmin_218"(%Uint128 %_amount, [20 x i8]* %"$_origin_339", [20 x i8]* %"$_sender_341", [20 x i8]* %"$address_343", %TName_Bool* %isApproved)
  ret void
}

define internal void @"$bestow_346"(%Uint128 %_amount, [20 x i8]* %"$_origin_347", [20 x i8]* %"$_sender_348", %String %label, [20 x i8]* %"$owner_349", [20 x i8]* %"$resolver_350") {
entry:
  ...
  %"$maybeAdmin_call_355" = call i8* @_fetch_field(i8* %"$execptr_load_354", i8* getelementptr inbounds ([7 x i8], [7 x i8]* @"$admins_353", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_44", i32 1, i8* %"$indices_buf_351", i32 1)
...
"$have_gas_389":                                  ; preds = %"$out_of_gas_388", %"$Some_382"
  ...
  store %TName_Bool* %"$isAdmin_391", %TName_Bool** %isSenderAdmin, align 8
...
"$have_gas_397":                                  ; preds = %"$out_of_gas_396", %"$None_392"
  ...
  store %TName_Bool* %"$adtptr_401", %TName_Bool** %isSenderAdmin, align 8
  br label %"$matchsucc_377"
...
"$have_gas_427":                                  ; preds = %"$out_of_gas_426", %"$have_gas_422"
  ...
  store i8* %"$msgobj_429", i8** %m, align 8
...
"$have_gas_478":                                  ; preds = %"$out_of_gas_477", %"$have_gas_427"
  ...
  %"$ud-proxy.oneMsg_call_484" = call %TName_List_Message* %"$ud-proxy.oneMsg_fptr_481"(i8* %"$ud-proxy.oneMsg_envptr_482", i8* %"$m_483")
  store %TName_List_Message* %"$ud-proxy.oneMsg_call_484", %TName_List_Message** %"$ud-proxy.oneMsg_0", align 8
  %"$$ud-proxy.oneMsg_0_485" = load %TName_List_Message*, %TName_List_Message** %"$ud-proxy.oneMsg_0", align 8
  store %TName_List_Message* %"$$ud-proxy.oneMsg_0_485", %TName_List_Message** %msgs, align 8
...
"$have_gas_492":                                  ; preds = %"$out_of_gas_491", %"$have_gas_478"
  ...
  call void @_send(i8* %"$execptr_load_494", %_TyDescrTy_Typ* @"$TyDescr_ADT_List_Message_42", %TName_List_Message* %"$msgs_495")
...
"$have_gas_504":                                  ; preds = %"$out_of_gas_503", %"$False_496"
  ...
  call void @_event(i8* %"$execptr_load_506", %_TyDescrTy_Typ* @"$TyDescr_Event_30", i8* %"$ud-proxy.eError_507")
  br label %"$matchsucc_407"
...
entry:
  ...
  call void @"$bestow_346"(%Uint128 %_amount, [20 x i8]* %"$_origin_512", [20 x i8]* %"$_sender_514", %String %label, [20 x i8]* %"$owner_518", [20 x i8]* %"$resolver_520")
  ret void
}
