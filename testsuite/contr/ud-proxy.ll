...
define internal i8* @"$fundef_8"(%"$$fundef_8_env_95"* %0, %TName_Bool* %1) {
entry:
...
"$have_gas_128":                                  ; preds = %"$out_of_gas_127", %entry
  ...
  store i8* %"$msgobj_130", i8** %"$retval_9", align 8
  %"$$retval_9_155" = load i8*, i8** %"$retval_9", align 8
  ret i8* %"$$retval_9_155"
}

define internal { i8* (i8*, %TName_Bool*)*, i8* } @"$fundef_6"(%"$$fundef_6_env_96"* %0, [20 x i8]* %1) {
entry:
...
"$have_gas_115":                                  ; preds = %"$out_of_gas_114", %entry
  ...
  store { i8* (i8*, %TName_Bool*)*, i8* } %"$$fundef_8_cloval_120", { i8* (i8*, %TName_Bool*)*, i8* }* %"$retval_7", align 8
  %"$$retval_7_122" = load { i8* (i8*, %TName_Bool*)*, i8* }, { i8* (i8*, %TName_Bool*)*, i8* }* %"$retval_7", align 8
  ret { i8* (i8*, %TName_Bool*)*, i8* } %"$$retval_7_122"
}

define internal %TName_List_Message* @"$fundef_10"(%"$$fundef_10_env_97"* %0, i8* %1) {
entry:
...
"$have_gas_103":                                  ; preds = %"$out_of_gas_102", %entry
  ...
  store %TName_List_Message* %"$adtptr_110", %TName_List_Message** %"$retval_11", align 8
...
"$have_gas_174":                                  ; preds = %"$out_of_gas_173", %"$have_gas_169"
  ...
  store %TName_Bool* %"$adtptr_178", %TName_Bool** @ud-proxy.true, align 8
...
"$have_gas_182":                                  ; preds = %"$out_of_gas_181", %"$have_gas_174"
  ...
  store %TName_List_Message* %"$adtptr_186", %TName_List_Message** @ud-proxy.nilMessage, align 8
...
"$have_gas_190":                                  ; preds = %"$out_of_gas_189", %"$have_gas_182"
  ...
  store { %TName_List_Message* (i8*, i8*)*, i8* } %"$$fundef_10_cloval_195", { %TName_List_Message* (i8*, i8*)*, i8* }* @ud-proxy.oneMsg, align 8
...
"$have_gas_201":                                  ; preds = %"$out_of_gas_200", %"$have_gas_190"
  ...
  store { { i8* (i8*, %TName_Bool*)*, i8* } (i8*, [20 x i8]*)*, i8* } { { i8* (i8*, %TName_Bool*)*, i8* } (i8*, [20 x i8]*)* bitcast ({ i8* (i8*, %TName_Bool*)*, i8* } (%"$$fundef_6_env_96"*, [20 x i8]*)* @"$fundef_6" to { i8* (i8*, %TName_Bool*)*, i8* } (i8*, [20 x i8]*)*), i8* null }, { { i8* (i8*, %TName_Bool*)*, i8* } (i8*, [20 x i8]*)*, i8* }* @ud-proxy.eAdminSet, align 8
...
"$have_gas_209":                                  ; preds = %"$out_of_gas_208", %"$have_gas_201"
  ...
  store i8* %"$msgobj_211", i8** @ud-proxy.eError, align 8
  ret void
}
...
"$have_gas_234":                                  ; preds = %"$out_of_gas_233", %"$have_gas_229"
  ...
  store %Map_ByStr20_Bool* %"$_new_empty_map_238", %Map_ByStr20_Bool** %empty, align 8
...
"$have_gas_246":                                  ; preds = %"$out_of_gas_245", %"$have_gas_234"
  ...
  %"$put_call_256" = call i8* @_put(i8* %"$execptr_load_248", %_TyDescrTy_Typ* @"$TyDescr_Map_53", i8* %"$$empty_249_250", i8* %"$$put_initialAdmin_251_253", i8* %"$$ud-proxy.true_254_255")
  %"$put_257" = bitcast i8* %"$put_call_256" to %Map_ByStr20_Bool*
  store %Map_ByStr20_Bool* %"$put_257", %Map_ByStr20_Bool** %"$admins_12", align 8
  ...
  call void @_update_field(i8* %"$execptr_load_258", i8* getelementptr inbounds ([7 x i8], [7 x i8]* @"$admins_259", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_53", i32 0, i8* null, i8* %"$update_value_261")
  ret void
}
...
define internal void @"$setAdmin_262"(%Uint128 %_amount, [20 x i8]* %"$_origin_263", [20 x i8]* %"$_sender_264", [20 x i8]* %"$address_265", %TName_Bool* %isApproved) {
entry:
  ...
  %"$maybeAdmin_call_270" = call i8* @_fetch_field(i8* %"$execptr_load_269", i8* getelementptr inbounds ([7 x i8], [7 x i8]* @"$admins_268", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_53", i32 1, i8* %"$indices_buf_266", i32 1)
...
"$have_gas_304":                                  ; preds = %"$out_of_gas_303", %"$Some_297"
  ...
  store %TName_Bool* %"$approval_306", %TName_Bool** %isSenderAdmin, align 8
...
"$have_gas_312":                                  ; preds = %"$out_of_gas_311", %"$None_307"
  ...
  store %TName_Bool* %"$adtptr_316", %TName_Bool** %isSenderAdmin, align 8
  br label %"$matchsucc_292"
...
"$have_gas_335":                                  ; preds = %"$out_of_gas_334", %"$True_327"
  ...
  call void @_update_field(i8* %"$execptr_load_339", i8* getelementptr inbounds ([7 x i8], [7 x i8]* @"$admins_340", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_53", i32 1, i8* %"$indices_buf_337", i8* %"$update_value_341")
...
"$have_gas_350":                                  ; preds = %"$out_of_gas_349", %"$have_gas_345"
  ...
  %"$ud-proxy.eAdminSet_call_356" = call { i8* (i8*, %TName_Bool*)*, i8* } %"$ud-proxy.eAdminSet_fptr_353"(i8* %"$ud-proxy.eAdminSet_envptr_354", [20 x i8]* %"$ud-proxy.eAdminSet_address_355")
  store { i8* (i8*, %TName_Bool*)*, i8* } %"$ud-proxy.eAdminSet_call_356", { i8* (i8*, %TName_Bool*)*, i8* }* %"$ud-proxy.eAdminSet_3", align 8
  ...
  %"$$ud-proxy.eAdminSet_3_call_360" = call i8* %"$$ud-proxy.eAdminSet_3_fptr_358"(i8* %"$$ud-proxy.eAdminSet_3_envptr_359", %TName_Bool* %isApproved)
  store i8* %"$$ud-proxy.eAdminSet_3_call_360", i8** %"$ud-proxy.eAdminSet_4", align 8
  %"$$ud-proxy.eAdminSet_4_361" = load i8*, i8** %"$ud-proxy.eAdminSet_4", align 8
  store i8* %"$$ud-proxy.eAdminSet_4_361", i8** %e, align 8
...
"$have_gas_368":                                  ; preds = %"$out_of_gas_367", %"$have_gas_350"
  ...
  call void @_event(i8* %"$execptr_load_370", %_TyDescrTy_Typ* @"$TyDescr_Event_37", i8* %"$e_371")
...
"$have_gas_380":                                  ; preds = %"$out_of_gas_379", %"$False_372"
  ...
  call void @_event(i8* %"$execptr_load_382", %_TyDescrTy_Typ* @"$TyDescr_Event_37", i8* %"$ud-proxy.eError_383")
  br label %"$matchsucc_322"
...
entry:
  ...
  call void @"$setAdmin_262"(%Uint128 %_amount, [20 x i8]* %"$_origin_388", [20 x i8]* %"$_sender_390", [20 x i8]* %"$address_392", %TName_Bool* %isApproved)
  ret void
}

define internal void @"$bestow_395"(%Uint128 %_amount, [20 x i8]* %"$_origin_396", [20 x i8]* %"$_sender_397", %String %label, [20 x i8]* %"$owner_398", [20 x i8]* %"$resolver_399") {
entry:
  ...
  %"$maybeAdmin_call_404" = call i8* @_fetch_field(i8* %"$execptr_load_403", i8* getelementptr inbounds ([7 x i8], [7 x i8]* @"$admins_402", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_53", i32 1, i8* %"$indices_buf_400", i32 1)
...
"$have_gas_438":                                  ; preds = %"$out_of_gas_437", %"$Some_431"
  ...
  store %TName_Bool* %"$isAdmin_440", %TName_Bool** %isSenderAdmin, align 8
...
"$have_gas_446":                                  ; preds = %"$out_of_gas_445", %"$None_441"
  ...
  store %TName_Bool* %"$adtptr_450", %TName_Bool** %isSenderAdmin, align 8
  br label %"$matchsucc_426"
...
"$have_gas_476":                                  ; preds = %"$out_of_gas_475", %"$have_gas_471"
  ...
  store i8* %"$msgobj_478", i8** %m, align 8
...
"$have_gas_527":                                  ; preds = %"$out_of_gas_526", %"$have_gas_476"
  ...
  %"$ud-proxy.oneMsg_call_533" = call %TName_List_Message* %"$ud-proxy.oneMsg_fptr_530"(i8* %"$ud-proxy.oneMsg_envptr_531", i8* %"$m_532")
  store %TName_List_Message* %"$ud-proxy.oneMsg_call_533", %TName_List_Message** %"$ud-proxy.oneMsg_5", align 8
  %"$$ud-proxy.oneMsg_5_534" = load %TName_List_Message*, %TName_List_Message** %"$ud-proxy.oneMsg_5", align 8
  store %TName_List_Message* %"$$ud-proxy.oneMsg_5_534", %TName_List_Message** %msgs, align 8
...
"$have_gas_541":                                  ; preds = %"$out_of_gas_540", %"$have_gas_527"
  ...
  call void @_send(i8* %"$execptr_load_543", %_TyDescrTy_Typ* @"$TyDescr_ADT_List_Message_51", %TName_List_Message* %"$msgs_544")
...
"$have_gas_553":                                  ; preds = %"$out_of_gas_552", %"$False_545"
  ...
  call void @_event(i8* %"$execptr_load_555", %_TyDescrTy_Typ* @"$TyDescr_Event_37", i8* %"$ud-proxy.eError_556")
  br label %"$matchsucc_456"
...
entry:
  ...
  call void @"$bestow_395"(%Uint128 %_amount, [20 x i8]* %"$_origin_561", [20 x i8]* %"$_sender_563", %String %label, [20 x i8]* %"$owner_567", [20 x i8]* %"$resolver_569")
  ret void
}
