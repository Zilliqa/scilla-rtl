...
"$have_gas_277":                                  ; preds = %"$out_of_gas_276", %entry
  ...
  store [20 x i8] %"$cparam3_279", [20 x i8]* %"$assign_test_1_4", align 1, !dbg !11
  ...
  call void @_update_field(i8* %"$execptr_load_280", i8* getelementptr inbounds ([14 x i8], [14 x i8]* @"$assign_test_1_281", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Addr_98", i32 0, i8* null, i8* %"$update_value_284"), !dbg !11
...
"$have_gas_288":                                  ; preds = %"$out_of_gas_287", %"$have_gas_277"
  ...
  store [20 x i8] %"$cparam3_290", [20 x i8]* %"$assign_test_2_5", align 1, !dbg !12
  ...
  call void @_update_field(i8* %"$execptr_load_291", i8* getelementptr inbounds ([14 x i8], [14 x i8]* @"$assign_test_2_292", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Addr_98", i32 0, i8* null, i8* %"$update_value_295"), !dbg !12
...
"$have_gas_299":                                  ; preds = %"$out_of_gas_298", %"$have_gas_288"
  ...
  store [20 x i8] %"$cparam3_301", [20 x i8]* %"$assign_test_3_6", align 1, !dbg !13
  ...
  call void @_update_field(i8* %"$execptr_load_302", i8* getelementptr inbounds ([14 x i8], [14 x i8]* @"$assign_test_3_303", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Addr_98", i32 0, i8* null, i8* %"$update_value_306"), !dbg !13
...
"$have_gas_310":                                  ; preds = %"$out_of_gas_309", %"$have_gas_299"
  ...
  store [20 x i8] %"$cparam3_312", [20 x i8]* %"$assign_test_4_7", align 1, !dbg !14
  ...
  call void @_update_field(i8* %"$execptr_load_313", i8* getelementptr inbounds ([14 x i8], [14 x i8]* @"$assign_test_4_314", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Addr_98", i32 0, i8* null, i8* %"$update_value_317"), !dbg !14
...
"$have_gas_321":                                  ; preds = %"$out_of_gas_320", %"$have_gas_310"
  ...
  store [20 x i8] %"$cparam3_323", [20 x i8]* %"$assign_test_5_8", align 1, !dbg !15
  ...
  call void @_update_field(i8* %"$execptr_load_324", i8* getelementptr inbounds ([14 x i8], [14 x i8]* @"$assign_test_5_325", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Addr_98", i32 0, i8* null, i8* %"$update_value_328"), !dbg !15
...
"$have_gas_332":                                  ; preds = %"$out_of_gas_331", %"$have_gas_321"
  ...
  store [20 x i8] %"$cparam3_334", [20 x i8]* %"$assign_test_6_9", align 1, !dbg !16
  ...
  call void @_update_field(i8* %"$execptr_load_335", i8* getelementptr inbounds ([14 x i8], [14 x i8]* @"$assign_test_6_336", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Addr_98", i32 0, i8* null, i8* %"$update_value_339"), !dbg !16
...
"$have_gas_343":                                  ; preds = %"$out_of_gas_342", %"$have_gas_332"
  ...
  store [20 x i8] %"$cparam3_345", [20 x i8]* %"$assign_test_7_10", align 1, !dbg !17
  ...
  call void @_update_field(i8* %"$execptr_load_346", i8* getelementptr inbounds ([14 x i8], [14 x i8]* @"$assign_test_7_347", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Addr_98", i32 0, i8* null, i8* %"$update_value_350"), !dbg !17
...
"$have_gas_354":                                  ; preds = %"$out_of_gas_353", %"$have_gas_343"
  ...
  store %TName_0x3620c286757a29985cee194eb90064270fb65414.AddressADT* %"$adtptr_360", %TName_0x3620c286757a29985cee194eb90064270fb65414.AddressADT** %"$assign_test_8_11", align 8, !dbg !18
  ...
  call void @_update_field(i8* %"$execptr_load_361", i8* getelementptr inbounds ([14 x i8], [14 x i8]* @"$assign_test_8_362", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_ADT_0x3620c286757a29985cee194eb90064270fb65414.AddressADT_75", i32 0, i8* null, i8* %"$update_value_364"), !dbg !18
...
"$have_gas_368":                                  ; preds = %"$out_of_gas_367", %"$have_gas_354"
  ...
  store %TName_List_0x3620c286757a29985cee194eb90064270fb65414.AddressADT* %"$adtptr_372", %TName_List_0x3620c286757a29985cee194eb90064270fb65414.AddressADT** %"$assign_test_9_12", align 8, !dbg !19
  ...
  call void @_update_field(i8* %"$execptr_load_373", i8* getelementptr inbounds ([14 x i8], [14 x i8]* @"$assign_test_9_374", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_ADT_List_0x3620c286757a29985cee194eb90064270fb65414.AddressADT_70", i32 0, i8* null, i8* %"$update_value_376"), !dbg !19
...
"$have_gas_380":                                  ; preds = %"$out_of_gas_379", %"$have_gas_368"
  ...
  store %"Map_Uint128_Map_(Uint128)_(0x3620c286757a29985cee194eb90064270fb65414.AddressADT)"* %"$_new_empty_map_384", %"Map_Uint128_Map_(Uint128)_(0x3620c286757a29985cee194eb90064270fb65414.AddressADT)"** %"$assign_test_10_13", align 8, !dbg !20
  ...
  call void @_update_field(i8* %"$execptr_load_385", i8* getelementptr inbounds ([15 x i8], [15 x i8]* @"$assign_test_10_386", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_79", i32 0, i8* null, i8* %"$update_value_388"), !dbg !20
...
"$have_gas_392":                                  ; preds = %"$out_of_gas_391", %"$have_gas_380"
  ...
  call void @_update_field(i8* %"$execptr_load_394", i8* getelementptr inbounds ([26 x i8], [26 x i8]* @"$remote_reads_test_res_1_1_395", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Uint128_43", i32 0, i8* null, i8* %"$update_value_398"), !dbg !21
...
"$have_gas_402":                                  ; preds = %"$out_of_gas_401", %"$have_gas_392"
  ...
  call void @_update_field(i8* %"$execptr_load_404", i8* getelementptr inbounds ([26 x i8], [26 x i8]* @"$remote_reads_test_res_2_1_405", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Uint128_43", i32 0, i8* null, i8* %"$update_value_408"), !dbg !22
...
"$have_gas_412":                                  ; preds = %"$out_of_gas_411", %"$have_gas_402"
  ...
  call void @_update_field(i8* %"$execptr_load_414", i8* getelementptr inbounds ([26 x i8], [26 x i8]* @"$remote_reads_test_res_3_1_415", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Uint128_43", i32 0, i8* null, i8* %"$update_value_418"), !dbg !23
...
"$have_gas_422":                                  ; preds = %"$out_of_gas_421", %"$have_gas_412"
  ...
  call void @_update_field(i8* %"$execptr_load_424", i8* getelementptr inbounds ([26 x i8], [26 x i8]* @"$remote_reads_test_res_3_3_425", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Uint32_35", i32 0, i8* null, i8* %"$update_value_428"), !dbg !24
...
"$have_gas_432":                                  ; preds = %"$out_of_gas_431", %"$have_gas_422"
  ...
  store [20 x i8] %"$cparam3_434", [20 x i8]* %"$remote_reads_test_res_3_4_18", align 1, !dbg !25
  ...
  call void @_update_field(i8* %"$execptr_load_435", i8* getelementptr inbounds ([26 x i8], [26 x i8]* @"$remote_reads_test_res_3_4_436", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Addr_98", i32 0, i8* null, i8* %"$update_value_439"), !dbg !25
...
"$have_gas_443":                                  ; preds = %"$out_of_gas_442", %"$have_gas_432"
  ...
  call void @_update_field(i8* %"$execptr_load_445", i8* getelementptr inbounds ([26 x i8], [26 x i8]* @"$remote_reads_test_res_3_5_446", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Uint128_43", i32 0, i8* null, i8* %"$update_value_449"), !dbg !26
...
"$have_gas_453":                                  ; preds = %"$out_of_gas_452", %"$have_gas_443"
  ...
  store %Map_ByStr20_with_end_Bool* %"$_new_empty_map_457", %Map_ByStr20_with_end_Bool** %"$remote_reads_test_res_3_6_20", align 8, !dbg !27
  ...
  call void @_update_field(i8* %"$execptr_load_458", i8* getelementptr inbounds ([26 x i8], [26 x i8]* @"$remote_reads_test_res_3_6_459", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_84", i32 0, i8* null, i8* %"$update_value_461"), !dbg !27
...
"$have_gas_465":                                  ; preds = %"$out_of_gas_464", %"$have_gas_453"
  ...
  store %TName_Bool* %"$adtptr_469", %TName_Bool** %"$remote_reads_test_res_3_7_21", align 8, !dbg !28
  ...
  call void @_update_field(i8* %"$execptr_load_470", i8* getelementptr inbounds ([26 x i8], [26 x i8]* @"$remote_reads_test_res_3_7_471", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_ADT_Bool_76", i32 0, i8* null, i8* %"$update_value_473"), !dbg !28
...
"$have_gas_482":                                  ; preds = %"$out_of_gas_481", %"$have_gas_477"
  ...
  store %TName_Bool* %"$adtptr_486", %TName_Bool** %x, align 8, !dbg !29
...
"$have_gas_490":                                  ; preds = %"$out_of_gas_489", %"$have_gas_482"
  ...
  store %TName_Option_Bool* %"$adtptr_496", %TName_Option_Bool** %"$remote_reads_test_res_3_8_22", align 8, !dbg !30
  ...
  call void @_update_field(i8* %"$execptr_load_497", i8* getelementptr inbounds ([26 x i8], [26 x i8]* @"$remote_reads_test_res_3_8_498", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_ADT_Option_Bool_74", i32 0, i8* null, i8* %"$update_value_500"), !dbg !29
...
"$have_gas_504":                                  ; preds = %"$out_of_gas_503", %"$have_gas_490"
  ...
  store %"Map_Uint32_Map_(ByStr20_with_end)_(Bool)"* %"$_new_empty_map_508", %"Map_Uint32_Map_(ByStr20_with_end)_(Bool)"** %"$remote_reads_test_res_3_9_23", align 8, !dbg !31
  ...
  call void @_update_field(i8* %"$execptr_load_509", i8* getelementptr inbounds ([26 x i8], [26 x i8]* @"$remote_reads_test_res_3_9_510", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_83", i32 0, i8* null, i8* %"$update_value_512"), !dbg !31
...
"$have_gas_516":                                  ; preds = %"$out_of_gas_515", %"$have_gas_504"
  ...
  store %TName_Bool* %"$adtptr_520", %TName_Bool** %"$remote_reads_test_res_3_10_24", align 8, !dbg !32
  ...
  call void @_update_field(i8* %"$execptr_load_521", i8* getelementptr inbounds ([27 x i8], [27 x i8]* @"$remote_reads_test_res_3_10_522", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_ADT_Bool_76", i32 0, i8* null, i8* %"$update_value_524"), !dbg !32
...
"$have_gas_528":                                  ; preds = %"$out_of_gas_527", %"$have_gas_516"
  ...
  store %"TName_Option_Map_(ByStr20_with_end)_(Bool)"* %"$adtptr_532", %"TName_Option_Map_(ByStr20_with_end)_(Bool)"** %"$remote_reads_test_res_3_11_25", align 8, !dbg !33
  ...
  call void @_update_field(i8* %"$execptr_load_533", i8* getelementptr inbounds ([27 x i8], [27 x i8]* @"$remote_reads_test_res_3_11_534", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_ADT_Option_Map_(ByStr20_with_end)_(Bool)_73", i32 0, i8* null, i8* %"$update_value_536"), !dbg !33
...
"$have_gas_540":                                  ; preds = %"$out_of_gas_539", %"$have_gas_528"
  ...
  store %TName_Bool* %"$adtptr_544", %TName_Bool** %"$remote_reads_test_res_3_12_26", align 8, !dbg !34
  ...
  call void @_update_field(i8* %"$execptr_load_545", i8* getelementptr inbounds ([27 x i8], [27 x i8]* @"$remote_reads_test_res_3_12_546", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_ADT_Bool_76", i32 0, i8* null, i8* %"$update_value_548"), !dbg !34
...
"$have_gas_552":                                  ; preds = %"$out_of_gas_551", %"$have_gas_540"
  ...
  store %TName_Option_Bool* %"$adtptr_556", %TName_Option_Bool** %"$remote_reads_test_res_3_13_27", align 8, !dbg !35
  ...
  call void @_update_field(i8* %"$execptr_load_557", i8* getelementptr inbounds ([27 x i8], [27 x i8]* @"$remote_reads_test_res_3_13_558", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_ADT_Option_Bool_74", i32 0, i8* null, i8* %"$update_value_560"), !dbg !35
...
"$have_gas_564":                                  ; preds = %"$out_of_gas_563", %"$have_gas_552"
  ...
  call void @_update_field(i8* %"$execptr_load_566", i8* getelementptr inbounds ([19 x i8], [19 x i8]* @"$sender_balance_pre_567", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Uint128_43", i32 0, i8* null, i8* %"$update_value_570"), !dbg !36
...
"$have_gas_574":                                  ; preds = %"$out_of_gas_573", %"$have_gas_564"
  ...
  call void @_update_field(i8* %"$execptr_load_576", i8* getelementptr inbounds ([19 x i8], [19 x i8]* @"$sender_balance_mid_577", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Uint128_43", i32 0, i8* null, i8* %"$update_value_580"), !dbg !37
...
"$have_gas_584":                                  ; preds = %"$out_of_gas_583", %"$have_gas_574"
  ...
  call void @_update_field(i8* %"$execptr_load_586", i8* getelementptr inbounds ([20 x i8], [20 x i8]* @"$sender_balance_post_587", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Uint128_43", i32 0, i8* null, i8* %"$update_value_590"), !dbg !38
  ret void
}
...
define internal void @"$RemoteReadsTest_591"(%Uint128 %_amount, [20 x i8]* %"$_origin_592", [20 x i8]* %"$_sender_593", [20 x i8]* %"$remote1_594", [20 x i8]* %"$remote2_595", [20 x i8]* %"$remote3_596") !dbg !39 {
entry:
  ...
  %"$tmp_1_1_call_600" = call i8* @_fetch_remote_field(i8* %"$execptr_load_598", [20 x i8]* %"$tmp_1_1_remote1_599", i8* getelementptr inbounds ([9 x i8], [9 x i8]* @"$_balance_597", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Uint128_43", i32 0, i8* null, i32 1), !dbg !40
...
"$have_gas_620":                                  ; preds = %"$out_of_gas_619", %"$have_gas_611"
  ...
  call void @_update_field(i8* %"$execptr_load_622", i8* getelementptr inbounds ([26 x i8], [26 x i8]* @"$remote_reads_test_res_1_1_623", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Uint128_43", i32 0, i8* null, i8* %"$update_value_626"), !dbg !41
  ...
  %"$tmp_2_1_call_630" = call i8* @_fetch_remote_field(i8* %"$execptr_load_628", [20 x i8]* %"$tmp_2_1_remote2_629", i8* getelementptr inbounds ([9 x i8], [9 x i8]* @"$_balance_627", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Uint128_43", i32 0, i8* null, i32 1), !dbg !42
...
"$have_gas_650":                                  ; preds = %"$out_of_gas_649", %"$have_gas_641"
  ...
  call void @_update_field(i8* %"$execptr_load_652", i8* getelementptr inbounds ([26 x i8], [26 x i8]* @"$remote_reads_test_res_2_1_653", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Uint128_43", i32 0, i8* null, i8* %"$update_value_656"), !dbg !43
  ...
  %"$tmp_3_1_call_660" = call i8* @_fetch_remote_field(i8* %"$execptr_load_658", [20 x i8]* %"$tmp_3_1_remote3_659", i8* getelementptr inbounds ([9 x i8], [9 x i8]* @"$_balance_657", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Uint128_43", i32 0, i8* null, i32 1), !dbg !44
...
"$have_gas_680":                                  ; preds = %"$out_of_gas_679", %"$have_gas_671"
  ...
  call void @_update_field(i8* %"$execptr_load_682", i8* getelementptr inbounds ([26 x i8], [26 x i8]* @"$remote_reads_test_res_3_1_683", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Uint128_43", i32 0, i8* null, i8* %"$update_value_686"), !dbg !45
  ...
  %"$tmp_3_3_call_690" = call i8* @_fetch_remote_field(i8* %"$execptr_load_688", [20 x i8]* %"$tmp_3_3_remote3_689", i8* getelementptr inbounds ([17 x i8], [17 x i8]* @"$transactionCount_687", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Uint32_35", i32 0, i8* null, i32 1), !dbg !46
...
"$have_gas_710":                                  ; preds = %"$out_of_gas_709", %"$have_gas_701"
  ...
  call void @_update_field(i8* %"$execptr_load_712", i8* getelementptr inbounds ([26 x i8], [26 x i8]* @"$remote_reads_test_res_3_3_713", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Uint32_35", i32 0, i8* null, i8* %"$update_value_716"), !dbg !47
  ...
  %"$tmp_3_4_call_720" = call i8* @_fetch_remote_field(i8* %"$execptr_load_718", [20 x i8]* %"$tmp_3_4_remote3_719", i8* getelementptr inbounds ([6 x i8], [6 x i8]* @"$admin_717", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Addr_100", i32 0, i8* null, i32 1), !dbg !48
...
"$have_gas_740":                                  ; preds = %"$out_of_gas_739", %"$have_gas_731"
  ...
  call void @_update_field(i8* %"$execptr_load_742", i8* getelementptr inbounds ([26 x i8], [26 x i8]* @"$remote_reads_test_res_3_4_743", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Addr_100", i32 0, i8* null, i8* %"$update_value_746"), !dbg !49
  ...
  %"$tmp_3_5_call_751" = call i8* @_fetch_remote_field(i8* %"$execptr_load_748", [20 x i8]* %"$tmp_3_5_tmp_3_4_749", i8* getelementptr inbounds ([9 x i8], [9 x i8]* @"$_balance_747", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Uint128_43", i32 0, i8* null, i32 1), !dbg !50
...
"$have_gas_771":                                  ; preds = %"$out_of_gas_770", %"$have_gas_762"
  ...
  call void @_update_field(i8* %"$execptr_load_773", i8* getelementptr inbounds ([26 x i8], [26 x i8]* @"$remote_reads_test_res_3_5_774", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Uint128_43", i32 0, i8* null, i8* %"$update_value_777"), !dbg !51
  ...
  %"$tmp_3_6_call_781" = call i8* @_fetch_remote_field(i8* %"$execptr_load_779", [20 x i8]* %"$tmp_3_6_remote3_780", i8* getelementptr inbounds ([7 x i8], [7 x i8]* @"$owners_778", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_84", i32 0, i8* null, i32 1), !dbg !52
...
"$have_gas_801":                                  ; preds = %"$out_of_gas_800", %"$have_gas_793"
  ...
  call void @_update_field(i8* %"$execptr_load_803", i8* getelementptr inbounds ([26 x i8], [26 x i8]* @"$remote_reads_test_res_3_6_804", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_84", i32 0, i8* null, i8* %"$update_value_806"), !dbg !53
  ...
  %"$tmp_3_7_call_812" = call i8* @_fetch_remote_field(i8* %"$execptr_load_810", [20 x i8]* %"$tmp_3_7_remote3_811", i8* getelementptr inbounds ([7 x i8], [7 x i8]* @"$owners_809", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_84", i32 1, i8* %"$indices_buf_807", i32 0), !dbg !54
...
"$have_gas_830":                                  ; preds = %"$out_of_gas_829", %"$have_gas_822"
  ...
  call void @_update_field(i8* %"$execptr_load_832", i8* getelementptr inbounds ([26 x i8], [26 x i8]* @"$remote_reads_test_res_3_7_833", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_ADT_Bool_76", i32 0, i8* null, i8* %"$update_value_835"), !dbg !55
  ...
  %"$tmp_3_8_call_841" = call i8* @_fetch_remote_field(i8* %"$execptr_load_839", [20 x i8]* %"$tmp_3_8_remote3_840", i8* getelementptr inbounds ([7 x i8], [7 x i8]* @"$owners_838", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_84", i32 1, i8* %"$indices_buf_836", i32 1), !dbg !56
...
"$have_gas_859":                                  ; preds = %"$out_of_gas_858", %"$have_gas_851"
  ...
  call void @_update_field(i8* %"$execptr_load_861", i8* getelementptr inbounds ([26 x i8], [26 x i8]* @"$remote_reads_test_res_3_8_862", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_ADT_Option_Bool_74", i32 0, i8* null, i8* %"$update_value_864"), !dbg !57
  ...
  %"$tmp_3_9_call_868" = call i8* @_fetch_remote_field(i8* %"$execptr_load_866", [20 x i8]* %"$tmp_3_9_remote3_867", i8* getelementptr inbounds ([11 x i8], [11 x i8]* @"$signatures_865", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_83", i32 0, i8* null, i32 1), !dbg !58
...
"$have_gas_888":                                  ; preds = %"$out_of_gas_887", %"$have_gas_880"
  ...
  call void @_update_field(i8* %"$execptr_load_890", i8* getelementptr inbounds ([26 x i8], [26 x i8]* @"$remote_reads_test_res_3_9_891", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_83", i32 0, i8* null, i8* %"$update_value_893"), !dbg !59
...
"$have_gas_902":                                  ; preds = %"$out_of_gas_901", %"$have_gas_897"
  ...
  %"$tmp_3_10_call_910" = call i8* @_fetch_remote_field(i8* %"$execptr_load_908", [20 x i8]* %"$tmp_3_10_remote3_909", i8* getelementptr inbounds ([11 x i8], [11 x i8]* @"$signatures_907", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_83", i32 1, i8* %"$indices_buf_904", i32 0), !dbg !61
...
"$have_gas_928":                                  ; preds = %"$out_of_gas_927", %"$have_gas_920"
  ...
  call void @_update_field(i8* %"$execptr_load_930", i8* getelementptr inbounds ([27 x i8], [27 x i8]* @"$remote_reads_test_res_3_10_931", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_ADT_Bool_76", i32 0, i8* null, i8* %"$update_value_933"), !dbg !62
  ...
  %"$tmp_3_11_call_940" = call i8* @_fetch_remote_field(i8* %"$execptr_load_938", [20 x i8]* %"$tmp_3_11_remote3_939", i8* getelementptr inbounds ([11 x i8], [11 x i8]* @"$signatures_937", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_83", i32 1, i8* %"$indices_buf_934", i32 1), !dbg !63
...
"$have_gas_961":                                  ; preds = %"$out_of_gas_960", %"$have_gas_953"
  ...
  call void @_update_field(i8* %"$execptr_load_963", i8* getelementptr inbounds ([27 x i8], [27 x i8]* @"$remote_reads_test_res_3_11_964", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_ADT_Option_Map_(ByStr20_with_end)_(Bool)_73", i32 0, i8* null, i8* %"$update_value_966"), !dbg !64
  ...
  %"$tmp_3_12_call_974" = call i8* @_fetch_remote_field(i8* %"$execptr_load_972", [20 x i8]* %"$tmp_3_12_remote3_973", i8* getelementptr inbounds ([11 x i8], [11 x i8]* @"$signatures_971", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_83", i32 2, i8* %"$indices_buf_967", i32 0), !dbg !65
...
"$have_gas_992":                                  ; preds = %"$out_of_gas_991", %"$have_gas_984"
  ...
  call void @_update_field(i8* %"$execptr_load_994", i8* getelementptr inbounds ([27 x i8], [27 x i8]* @"$remote_reads_test_res_3_12_995", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_ADT_Bool_76", i32 0, i8* null, i8* %"$update_value_997"), !dbg !66
  ...
  %"$tmp_3_13_call_1005" = call i8* @_fetch_remote_field(i8* %"$execptr_load_1003", [20 x i8]* %"$tmp_3_13_remote3_1004", i8* getelementptr inbounds ([11 x i8], [11 x i8]* @"$signatures_1002", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_83", i32 2, i8* %"$indices_buf_998", i32 1), !dbg !67
...
"$have_gas_1023":                                 ; preds = %"$out_of_gas_1022", %"$have_gas_1015"
  ...
  call void @_update_field(i8* %"$execptr_load_1025", i8* getelementptr inbounds ([27 x i8], [27 x i8]* @"$remote_reads_test_res_3_13_1026", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_ADT_Option_Bool_74", i32 0, i8* null, i8* %"$update_value_1028"), !dbg !68
  ret void
}
...
"$have_gas_1076":                                 ; preds = %"$out_of_gas_1075", %"$have_gas_1071"
  ...
  store i8* %"$msgobj_1078", i8** %msg, align 8, !dbg !75
...
"$have_gas_1123":                                 ; preds = %"$out_of_gas_1122", %"$have_gas_1118"
  ...
  store %TName_List_Message* %"$adtptr_1127", %TName_List_Message** %n, align 8, !dbg !76
...
"$have_gas_1131":                                 ; preds = %"$out_of_gas_1130", %"$have_gas_1123"
  ...
  store %TName_List_Message* %"$adtptr_1139", %TName_List_Message** %msgs, align 8, !dbg !77
...
"$have_gas_1146":                                 ; preds = %"$out_of_gas_1145", %"$have_gas_1131"
  ...
  call void @_send(i8* %"$execptr_load_1148", %_TyDescrTy_Typ* @"$TyDescr_ADT_List_Message_65", %TName_List_Message* %"$msgs_1149"), !dbg !78
...
"$have_gas_1158":                                 ; preds = %"$out_of_gas_1157", %"$have_gas_1153"
  ...
  store i8* %"$msgobj_1160", i8** %e1, align 8, !dbg !79
...
"$have_gas_1184":                                 ; preds = %"$out_of_gas_1183", %"$have_gas_1158"
  ...
  call void @_event(i8* %"$execptr_load_1186", %_TyDescrTy_Typ* @"$TyDescr_Event_55", i8* %"$e1_1187"), !dbg !80
...
"$have_gas_1196":                                 ; preds = %"$out_of_gas_1195", %"$have_gas_1191"
  ...
  store i8* %"$msgobj_1198", i8** %e2, align 8, !dbg !81
...
"$have_gas_1222":                                 ; preds = %"$out_of_gas_1221", %"$have_gas_1196"
  ...
  call void @_event(i8* %"$execptr_load_1224", %_TyDescrTy_Typ* @"$TyDescr_Event_55", i8* %"$e2_1225"), !dbg !82
  ret void
}
...
entry:
  ...
  call void @"$OutgoingMsgTest_1065"(%Uint128 %_amount, [20 x i8]* %"$_origin_1230", [20 x i8]* %"$_sender_1232"), !dbg !84
  ret void
}

define internal void @"$ExceptionTest_1233"(%Uint128 %_amount, [20 x i8]* %"$_origin_1234", [20 x i8]* %"$_sender_1235") !dbg !85 {
entry:
...
"$have_gas_1244":                                 ; preds = %"$out_of_gas_1243", %"$have_gas_1239"
  ...
  store i8* %"$msgobj_1246", i8** %e, align 8, !dbg !86
...
"$have_gas_1270":                                 ; preds = %"$out_of_gas_1269", %"$have_gas_1244"
  ...
  call void @_throw(i8* %"$execptr_load_1272", %_TyDescrTy_Typ* @"$TyDescr_Exception_57", i8* %"$e_1273"), !dbg !87
  ret void
}
...
entry:
  ...
  call void @"$ExceptionTest_1233"(%Uint128 %_amount, [20 x i8]* %"$_origin_1278", [20 x i8]* %"$_sender_1280"), !dbg !89
  ret void
}

define internal void @"$AssignTest_1281"(%Uint128 %_amount, [20 x i8]* %"$_origin_1282", [20 x i8]* %"$_sender_1283") !dbg !90 {
entry:
...
"$have_gas_1292":                                 ; preds = %"$out_of_gas_1291", %"$have_gas_1287"
  ...
  store %TName_0x3620c286757a29985cee194eb90064270fb65414.AddressADT* %"$adtptr_1298", %TName_0x3620c286757a29985cee194eb90064270fb65414.AddressADT** %"$x_2", align 8, !dbg !91
...
"$have_gas_1305":                                 ; preds = %"$out_of_gas_1304", %"$have_gas_1292"
  ...
  call void @_update_field(i8* %"$execptr_load_1307", i8* getelementptr inbounds ([14 x i8], [14 x i8]* @"$assign_test_8_1308", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_ADT_0x3620c286757a29985cee194eb90064270fb65414.AddressADT_75", i32 0, i8* null, i8* %"$update_value_1310"), !dbg !92
...
"$have_gas_1324":                                 ; preds = %"$out_of_gas_1323", %"$have_gas_1319"
  ...
  store %TName_List_0x3620c286757a29985cee194eb90064270fb65414.AddressADT* %"$adtptr_1328", %TName_List_0x3620c286757a29985cee194eb90064270fb65414.AddressADT** %n, align 8, !dbg !93
...
"$have_gas_1332":                                 ; preds = %"$out_of_gas_1331", %"$have_gas_1324"
  ...
  store %TName_List_0x3620c286757a29985cee194eb90064270fb65414.AddressADT* %"$adtptr_1340", %TName_List_0x3620c286757a29985cee194eb90064270fb65414.AddressADT** %y, align 8, !dbg !94
...
"$have_gas_1347":                                 ; preds = %"$out_of_gas_1346", %"$have_gas_1332"
  ...
  call void @_update_field(i8* %"$execptr_load_1349", i8* getelementptr inbounds ([14 x i8], [14 x i8]* @"$assign_test_9_1350", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_ADT_List_0x3620c286757a29985cee194eb90064270fb65414.AddressADT_70", i32 0, i8* null, i8* %"$update_value_1352"), !dbg !95
...
"$have_gas_1366":                                 ; preds = %"$out_of_gas_1365", %"$have_gas_1361"
  ...
  store %"Map_Uint128_Map_(Uint128)_(0x3620c286757a29985cee194eb90064270fb65414.AddressADT)"* %"$_new_empty_map_1370", %"Map_Uint128_Map_(Uint128)_(0x3620c286757a29985cee194eb90064270fb65414.AddressADT)"** %"$n_3", align 8, !dbg !96
...
"$have_gas_1379":                                 ; preds = %"$out_of_gas_1378", %"$have_gas_1374"
  ...
  store %Map_Uint128_0x3620c286757a29985cee194eb90064270fb65414.AddressADT* %"$_new_empty_map_1383", %Map_Uint128_0x3620c286757a29985cee194eb90064270fb65414.AddressADT** %sub_n, align 8, !dbg !97
...
"$have_gas_1406":                                 ; preds = %"$out_of_gas_1405", %"$have_gas_1397"
  ...
  %"$put_call_1416" = call i8* @_put(i8* %"$execptr_load_1408", %_TyDescrTy_Typ* @"$TyDescr_Map_78", i8* %"$$sub_n_1409_1410", i8* %"$$put_sub_k_1411_1413", i8* %"$$$x_2_1414_1415"), !dbg !99
  %"$put_1417" = bitcast i8* %"$put_call_1416" to %Map_Uint128_0x3620c286757a29985cee194eb90064270fb65414.AddressADT*
  store %Map_Uint128_0x3620c286757a29985cee194eb90064270fb65414.AddressADT* %"$put_1417", %Map_Uint128_0x3620c286757a29985cee194eb90064270fb65414.AddressADT** %sub_res, align 8, !dbg !99
...
"$have_gas_1425":                                 ; preds = %"$out_of_gas_1424", %"$have_gas_1406"
  ...
  %"$put_call_1435" = call i8* @_put(i8* %"$execptr_load_1427", %_TyDescrTy_Typ* @"$TyDescr_Map_79", i8* %"$$$n_3_1428_1429", i8* %"$$put_sub_k_1430_1432", i8* %"$$sub_res_1433_1434"), !dbg !100
  %"$put_1436" = bitcast i8* %"$put_call_1435" to %"Map_Uint128_Map_(Uint128)_(0x3620c286757a29985cee194eb90064270fb65414.AddressADT)"*
  store %"Map_Uint128_Map_(Uint128)_(0x3620c286757a29985cee194eb90064270fb65414.AddressADT)"* %"$put_1436", %"Map_Uint128_Map_(Uint128)_(0x3620c286757a29985cee194eb90064270fb65414.AddressADT)"** %z, align 8, !dbg !100
...
"$have_gas_1443":                                 ; preds = %"$out_of_gas_1442", %"$have_gas_1425"
  ...
  call void @_update_field(i8* %"$execptr_load_1445", i8* getelementptr inbounds ([15 x i8], [15 x i8]* @"$assign_test_10_1446", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_79", i32 0, i8* null, i8* %"$update_value_1448"), !dbg !101
...
"$have_gas_1476":                                 ; preds = %"$out_of_gas_1475", %"$have_gas_1467"
  ...
  call void @_update_field(i8* %"$execptr_load_1483", i8* getelementptr inbounds ([15 x i8], [15 x i8]* @"$assign_test_10_1484", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_79", i32 2, i8* %"$indices_buf_1478", i8* %"$update_value_1486"), !dbg !104
  ret void
}
...
entry:
  ...
  call void @"$AssignTest_1281"(%Uint128 %_amount, [20 x i8]* %"$_origin_1491", [20 x i8]* %"$_sender_1493"), !dbg !106
  ret void
}
