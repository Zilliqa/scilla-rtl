...
"$have_gas_254":                                  ; preds = %"$out_of_gas_253", %entry
  ...
  store [20 x i8] %"$cparam3_256", [20 x i8]* %"$assign_test_1_3", align 1, !dbg !10
  ...
  call void @_update_field(i8* %"$execptr_load_257", i8* getelementptr inbounds ([14 x i8], [14 x i8]* @"$assign_test_1_258", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Addr_95", i32 0, i8* null, i8* %"$update_value_261"), !dbg !10
...
"$have_gas_265":                                  ; preds = %"$out_of_gas_264", %"$have_gas_254"
  ...
  store [20 x i8] %"$cparam3_267", [20 x i8]* %"$assign_test_2_4", align 1, !dbg !11
  ...
  call void @_update_field(i8* %"$execptr_load_268", i8* getelementptr inbounds ([14 x i8], [14 x i8]* @"$assign_test_2_269", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Addr_95", i32 0, i8* null, i8* %"$update_value_272"), !dbg !11
...
"$have_gas_276":                                  ; preds = %"$out_of_gas_275", %"$have_gas_265"
  ...
  store [20 x i8] %"$cparam3_278", [20 x i8]* %"$assign_test_3_5", align 1, !dbg !12
  ...
  call void @_update_field(i8* %"$execptr_load_279", i8* getelementptr inbounds ([14 x i8], [14 x i8]* @"$assign_test_3_280", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Addr_95", i32 0, i8* null, i8* %"$update_value_283"), !dbg !12
...
"$have_gas_287":                                  ; preds = %"$out_of_gas_286", %"$have_gas_276"
  ...
  store [20 x i8] %"$cparam3_289", [20 x i8]* %"$assign_test_4_6", align 1, !dbg !13
  ...
  call void @_update_field(i8* %"$execptr_load_290", i8* getelementptr inbounds ([14 x i8], [14 x i8]* @"$assign_test_4_291", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Addr_95", i32 0, i8* null, i8* %"$update_value_294"), !dbg !13
...
"$have_gas_298":                                  ; preds = %"$out_of_gas_297", %"$have_gas_287"
  ...
  store [20 x i8] %"$cparam3_300", [20 x i8]* %"$assign_test_5_7", align 1, !dbg !14
  ...
  call void @_update_field(i8* %"$execptr_load_301", i8* getelementptr inbounds ([14 x i8], [14 x i8]* @"$assign_test_5_302", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Addr_95", i32 0, i8* null, i8* %"$update_value_305"), !dbg !14
...
"$have_gas_309":                                  ; preds = %"$out_of_gas_308", %"$have_gas_298"
  ...
  store [20 x i8] %"$cparam3_311", [20 x i8]* %"$assign_test_6_8", align 1, !dbg !15
  ...
  call void @_update_field(i8* %"$execptr_load_312", i8* getelementptr inbounds ([14 x i8], [14 x i8]* @"$assign_test_6_313", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Addr_95", i32 0, i8* null, i8* %"$update_value_316"), !dbg !15
...
"$have_gas_320":                                  ; preds = %"$out_of_gas_319", %"$have_gas_309"
  ...
  store [20 x i8] %"$cparam3_322", [20 x i8]* %"$assign_test_7_9", align 1, !dbg !16
  ...
  call void @_update_field(i8* %"$execptr_load_323", i8* getelementptr inbounds ([14 x i8], [14 x i8]* @"$assign_test_7_324", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Addr_95", i32 0, i8* null, i8* %"$update_value_327"), !dbg !16
...
"$have_gas_331":                                  ; preds = %"$out_of_gas_330", %"$have_gas_320"
  ...
  store %TName_0x3620c286757a29985cee194eb90064270fb65414.AddressADT* %"$adtptr_337", %TName_0x3620c286757a29985cee194eb90064270fb65414.AddressADT** %"$assign_test_8_10", align 8, !dbg !17
  ...
  call void @_update_field(i8* %"$execptr_load_338", i8* getelementptr inbounds ([14 x i8], [14 x i8]* @"$assign_test_8_339", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_ADT_0x3620c286757a29985cee194eb90064270fb65414.AddressADT_72", i32 0, i8* null, i8* %"$update_value_341"), !dbg !17
...
"$have_gas_345":                                  ; preds = %"$out_of_gas_344", %"$have_gas_331"
  ...
  store %TName_List_0x3620c286757a29985cee194eb90064270fb65414.AddressADT* %"$adtptr_349", %TName_List_0x3620c286757a29985cee194eb90064270fb65414.AddressADT** %"$assign_test_9_11", align 8, !dbg !18
  ...
  call void @_update_field(i8* %"$execptr_load_350", i8* getelementptr inbounds ([14 x i8], [14 x i8]* @"$assign_test_9_351", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_ADT_List_0x3620c286757a29985cee194eb90064270fb65414.AddressADT_68", i32 0, i8* null, i8* %"$update_value_353"), !dbg !18
...
"$have_gas_357":                                  ; preds = %"$out_of_gas_356", %"$have_gas_345"
  ...
  store %"Map_Uint128_Map_(Uint128)_(0x3620c286757a29985cee194eb90064270fb65414.AddressADT)"* %"$_new_empty_map_361", %"Map_Uint128_Map_(Uint128)_(0x3620c286757a29985cee194eb90064270fb65414.AddressADT)"** %"$assign_test_10_12", align 8, !dbg !19
  ...
  call void @_update_field(i8* %"$execptr_load_362", i8* getelementptr inbounds ([15 x i8], [15 x i8]* @"$assign_test_10_363", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_76", i32 0, i8* null, i8* %"$update_value_365"), !dbg !19
...
"$have_gas_369":                                  ; preds = %"$out_of_gas_368", %"$have_gas_357"
  ...
  call void @_update_field(i8* %"$execptr_load_371", i8* getelementptr inbounds ([26 x i8], [26 x i8]* @"$remote_reads_test_res_1_1_372", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Uint128_42", i32 0, i8* null, i8* %"$update_value_375"), !dbg !20
...
"$have_gas_379":                                  ; preds = %"$out_of_gas_378", %"$have_gas_369"
  ...
  call void @_update_field(i8* %"$execptr_load_381", i8* getelementptr inbounds ([26 x i8], [26 x i8]* @"$remote_reads_test_res_2_1_382", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Uint128_42", i32 0, i8* null, i8* %"$update_value_385"), !dbg !21
...
"$have_gas_389":                                  ; preds = %"$out_of_gas_388", %"$have_gas_379"
  ...
  call void @_update_field(i8* %"$execptr_load_391", i8* getelementptr inbounds ([26 x i8], [26 x i8]* @"$remote_reads_test_res_3_1_392", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Uint128_42", i32 0, i8* null, i8* %"$update_value_395"), !dbg !22
...
"$have_gas_399":                                  ; preds = %"$out_of_gas_398", %"$have_gas_389"
  ...
  call void @_update_field(i8* %"$execptr_load_401", i8* getelementptr inbounds ([26 x i8], [26 x i8]* @"$remote_reads_test_res_3_3_402", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Uint32_34", i32 0, i8* null, i8* %"$update_value_405"), !dbg !23
...
"$have_gas_409":                                  ; preds = %"$out_of_gas_408", %"$have_gas_399"
  ...
  store [20 x i8] %"$cparam3_411", [20 x i8]* %"$remote_reads_test_res_3_4_17", align 1, !dbg !24
  ...
  call void @_update_field(i8* %"$execptr_load_412", i8* getelementptr inbounds ([26 x i8], [26 x i8]* @"$remote_reads_test_res_3_4_413", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Addr_95", i32 0, i8* null, i8* %"$update_value_416"), !dbg !24
...
"$have_gas_420":                                  ; preds = %"$out_of_gas_419", %"$have_gas_409"
  ...
  call void @_update_field(i8* %"$execptr_load_422", i8* getelementptr inbounds ([26 x i8], [26 x i8]* @"$remote_reads_test_res_3_5_423", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Uint128_42", i32 0, i8* null, i8* %"$update_value_426"), !dbg !25
...
"$have_gas_430":                                  ; preds = %"$out_of_gas_429", %"$have_gas_420"
  ...
  store %Map_ByStr20_with_end_Bool* %"$_new_empty_map_434", %Map_ByStr20_with_end_Bool** %"$remote_reads_test_res_3_6_19", align 8, !dbg !26
  ...
  call void @_update_field(i8* %"$execptr_load_435", i8* getelementptr inbounds ([26 x i8], [26 x i8]* @"$remote_reads_test_res_3_6_436", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_81", i32 0, i8* null, i8* %"$update_value_438"), !dbg !26
...
"$have_gas_442":                                  ; preds = %"$out_of_gas_441", %"$have_gas_430"
  ...
  store %TName_Bool* %"$adtptr_446", %TName_Bool** %"$remote_reads_test_res_3_7_20", align 8, !dbg !27
  ...
  call void @_update_field(i8* %"$execptr_load_447", i8* getelementptr inbounds ([26 x i8], [26 x i8]* @"$remote_reads_test_res_3_7_448", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_ADT_Bool_73", i32 0, i8* null, i8* %"$update_value_450"), !dbg !27
...
"$have_gas_459":                                  ; preds = %"$out_of_gas_458", %"$have_gas_454"
  ...
  store %TName_Bool* %"$adtptr_463", %TName_Bool** %x, align 8, !dbg !28
...
"$have_gas_467":                                  ; preds = %"$out_of_gas_466", %"$have_gas_459"
  ...
  store %TName_Option_Bool* %"$adtptr_473", %TName_Option_Bool** %"$remote_reads_test_res_3_8_21", align 8, !dbg !29
  ...
  call void @_update_field(i8* %"$execptr_load_474", i8* getelementptr inbounds ([26 x i8], [26 x i8]* @"$remote_reads_test_res_3_8_475", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_ADT_Option_Bool_71", i32 0, i8* null, i8* %"$update_value_477"), !dbg !28
...
"$have_gas_481":                                  ; preds = %"$out_of_gas_480", %"$have_gas_467"
  ...
  store %"Map_Uint32_Map_(ByStr20_with_end)_(Bool)"* %"$_new_empty_map_485", %"Map_Uint32_Map_(ByStr20_with_end)_(Bool)"** %"$remote_reads_test_res_3_9_22", align 8, !dbg !30
  ...
  call void @_update_field(i8* %"$execptr_load_486", i8* getelementptr inbounds ([26 x i8], [26 x i8]* @"$remote_reads_test_res_3_9_487", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_80", i32 0, i8* null, i8* %"$update_value_489"), !dbg !30
...
"$have_gas_493":                                  ; preds = %"$out_of_gas_492", %"$have_gas_481"
  ...
  store %TName_Bool* %"$adtptr_497", %TName_Bool** %"$remote_reads_test_res_3_10_23", align 8, !dbg !31
  ...
  call void @_update_field(i8* %"$execptr_load_498", i8* getelementptr inbounds ([27 x i8], [27 x i8]* @"$remote_reads_test_res_3_10_499", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_ADT_Bool_73", i32 0, i8* null, i8* %"$update_value_501"), !dbg !31
...
"$have_gas_505":                                  ; preds = %"$out_of_gas_504", %"$have_gas_493"
  ...
  store %"TName_Option_Map_(ByStr20_with_end)_(Bool)"* %"$adtptr_509", %"TName_Option_Map_(ByStr20_with_end)_(Bool)"** %"$remote_reads_test_res_3_11_24", align 8, !dbg !32
  ...
  call void @_update_field(i8* %"$execptr_load_510", i8* getelementptr inbounds ([27 x i8], [27 x i8]* @"$remote_reads_test_res_3_11_511", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_ADT_Option_Map_(ByStr20_with_end)_(Bool)_70", i32 0, i8* null, i8* %"$update_value_513"), !dbg !32
...
"$have_gas_517":                                  ; preds = %"$out_of_gas_516", %"$have_gas_505"
  ...
  store %TName_Bool* %"$adtptr_521", %TName_Bool** %"$remote_reads_test_res_3_12_25", align 8, !dbg !33
  ...
  call void @_update_field(i8* %"$execptr_load_522", i8* getelementptr inbounds ([27 x i8], [27 x i8]* @"$remote_reads_test_res_3_12_523", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_ADT_Bool_73", i32 0, i8* null, i8* %"$update_value_525"), !dbg !33
...
"$have_gas_529":                                  ; preds = %"$out_of_gas_528", %"$have_gas_517"
  ...
  store %TName_Option_Bool* %"$adtptr_533", %TName_Option_Bool** %"$remote_reads_test_res_3_13_26", align 8, !dbg !34
  ...
  call void @_update_field(i8* %"$execptr_load_534", i8* getelementptr inbounds ([27 x i8], [27 x i8]* @"$remote_reads_test_res_3_13_535", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_ADT_Option_Bool_71", i32 0, i8* null, i8* %"$update_value_537"), !dbg !34
...
"$have_gas_541":                                  ; preds = %"$out_of_gas_540", %"$have_gas_529"
  ...
  call void @_update_field(i8* %"$execptr_load_543", i8* getelementptr inbounds ([19 x i8], [19 x i8]* @"$sender_balance_pre_544", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Uint128_42", i32 0, i8* null, i8* %"$update_value_547"), !dbg !35
...
"$have_gas_551":                                  ; preds = %"$out_of_gas_550", %"$have_gas_541"
  ...
  call void @_update_field(i8* %"$execptr_load_553", i8* getelementptr inbounds ([19 x i8], [19 x i8]* @"$sender_balance_mid_554", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Uint128_42", i32 0, i8* null, i8* %"$update_value_557"), !dbg !36
...
"$have_gas_561":                                  ; preds = %"$out_of_gas_560", %"$have_gas_551"
  ...
  call void @_update_field(i8* %"$execptr_load_563", i8* getelementptr inbounds ([20 x i8], [20 x i8]* @"$sender_balance_post_564", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Uint128_42", i32 0, i8* null, i8* %"$update_value_567"), !dbg !37
  ret void
}
...
define internal void @"$RemoteReadsTest_568"(%Uint128 %_amount, [20 x i8]* %"$_origin_569", [20 x i8]* %"$_sender_570", [20 x i8]* %"$remote1_571", [20 x i8]* %"$remote2_572", [20 x i8]* %"$remote3_573") !dbg !38 {
entry:
  ...
  %"$tmp_1_1_call_577" = call i8* @_fetch_remote_field(i8* %"$execptr_load_575", [20 x i8]* %"$tmp_1_1_remote1_576", i8* getelementptr inbounds ([9 x i8], [9 x i8]* @"$_balance_574", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Uint128_42", i32 0, i8* null, i32 1), !dbg !39
...
"$have_gas_597":                                  ; preds = %"$out_of_gas_596", %"$have_gas_588"
  ...
  call void @_update_field(i8* %"$execptr_load_599", i8* getelementptr inbounds ([26 x i8], [26 x i8]* @"$remote_reads_test_res_1_1_600", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Uint128_42", i32 0, i8* null, i8* %"$update_value_603"), !dbg !40
  ...
  %"$tmp_2_1_call_607" = call i8* @_fetch_remote_field(i8* %"$execptr_load_605", [20 x i8]* %"$tmp_2_1_remote2_606", i8* getelementptr inbounds ([9 x i8], [9 x i8]* @"$_balance_604", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Uint128_42", i32 0, i8* null, i32 1), !dbg !41
...
"$have_gas_627":                                  ; preds = %"$out_of_gas_626", %"$have_gas_618"
  ...
  call void @_update_field(i8* %"$execptr_load_629", i8* getelementptr inbounds ([26 x i8], [26 x i8]* @"$remote_reads_test_res_2_1_630", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Uint128_42", i32 0, i8* null, i8* %"$update_value_633"), !dbg !42
  ...
  %"$tmp_3_1_call_637" = call i8* @_fetch_remote_field(i8* %"$execptr_load_635", [20 x i8]* %"$tmp_3_1_remote3_636", i8* getelementptr inbounds ([9 x i8], [9 x i8]* @"$_balance_634", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Uint128_42", i32 0, i8* null, i32 1), !dbg !43
...
"$have_gas_657":                                  ; preds = %"$out_of_gas_656", %"$have_gas_648"
  ...
  call void @_update_field(i8* %"$execptr_load_659", i8* getelementptr inbounds ([26 x i8], [26 x i8]* @"$remote_reads_test_res_3_1_660", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Uint128_42", i32 0, i8* null, i8* %"$update_value_663"), !dbg !44
  ...
  %"$tmp_3_3_call_667" = call i8* @_fetch_remote_field(i8* %"$execptr_load_665", [20 x i8]* %"$tmp_3_3_remote3_666", i8* getelementptr inbounds ([17 x i8], [17 x i8]* @"$transactionCount_664", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Uint32_34", i32 0, i8* null, i32 1), !dbg !45
...
"$have_gas_687":                                  ; preds = %"$out_of_gas_686", %"$have_gas_678"
  ...
  call void @_update_field(i8* %"$execptr_load_689", i8* getelementptr inbounds ([26 x i8], [26 x i8]* @"$remote_reads_test_res_3_3_690", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Uint32_34", i32 0, i8* null, i8* %"$update_value_693"), !dbg !46
  ...
  %"$tmp_3_4_call_697" = call i8* @_fetch_remote_field(i8* %"$execptr_load_695", [20 x i8]* %"$tmp_3_4_remote3_696", i8* getelementptr inbounds ([6 x i8], [6 x i8]* @"$admin_694", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Addr_97", i32 0, i8* null, i32 1), !dbg !47
...
"$have_gas_717":                                  ; preds = %"$out_of_gas_716", %"$have_gas_708"
  ...
  call void @_update_field(i8* %"$execptr_load_719", i8* getelementptr inbounds ([26 x i8], [26 x i8]* @"$remote_reads_test_res_3_4_720", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Addr_97", i32 0, i8* null, i8* %"$update_value_723"), !dbg !48
  ...
  %"$tmp_3_5_call_728" = call i8* @_fetch_remote_field(i8* %"$execptr_load_725", [20 x i8]* %"$tmp_3_5_tmp_3_4_726", i8* getelementptr inbounds ([9 x i8], [9 x i8]* @"$_balance_724", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Uint128_42", i32 0, i8* null, i32 1), !dbg !49
...
"$have_gas_748":                                  ; preds = %"$out_of_gas_747", %"$have_gas_739"
  ...
  call void @_update_field(i8* %"$execptr_load_750", i8* getelementptr inbounds ([26 x i8], [26 x i8]* @"$remote_reads_test_res_3_5_751", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Uint128_42", i32 0, i8* null, i8* %"$update_value_754"), !dbg !50
  ...
  %"$tmp_3_6_call_758" = call i8* @_fetch_remote_field(i8* %"$execptr_load_756", [20 x i8]* %"$tmp_3_6_remote3_757", i8* getelementptr inbounds ([7 x i8], [7 x i8]* @"$owners_755", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_81", i32 0, i8* null, i32 1), !dbg !51
...
"$have_gas_778":                                  ; preds = %"$out_of_gas_777", %"$have_gas_770"
  ...
  call void @_update_field(i8* %"$execptr_load_780", i8* getelementptr inbounds ([26 x i8], [26 x i8]* @"$remote_reads_test_res_3_6_781", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_81", i32 0, i8* null, i8* %"$update_value_783"), !dbg !52
  ...
  %"$tmp_3_7_call_789" = call i8* @_fetch_remote_field(i8* %"$execptr_load_787", [20 x i8]* %"$tmp_3_7_remote3_788", i8* getelementptr inbounds ([7 x i8], [7 x i8]* @"$owners_786", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_81", i32 1, i8* %"$indices_buf_784", i32 0), !dbg !53
...
"$have_gas_807":                                  ; preds = %"$out_of_gas_806", %"$have_gas_799"
  ...
  call void @_update_field(i8* %"$execptr_load_809", i8* getelementptr inbounds ([26 x i8], [26 x i8]* @"$remote_reads_test_res_3_7_810", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_ADT_Bool_73", i32 0, i8* null, i8* %"$update_value_812"), !dbg !54
  ...
  %"$tmp_3_8_call_818" = call i8* @_fetch_remote_field(i8* %"$execptr_load_816", [20 x i8]* %"$tmp_3_8_remote3_817", i8* getelementptr inbounds ([7 x i8], [7 x i8]* @"$owners_815", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_81", i32 1, i8* %"$indices_buf_813", i32 1), !dbg !55
...
"$have_gas_836":                                  ; preds = %"$out_of_gas_835", %"$have_gas_828"
  ...
  call void @_update_field(i8* %"$execptr_load_838", i8* getelementptr inbounds ([26 x i8], [26 x i8]* @"$remote_reads_test_res_3_8_839", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_ADT_Option_Bool_71", i32 0, i8* null, i8* %"$update_value_841"), !dbg !56
  ...
  %"$tmp_3_9_call_845" = call i8* @_fetch_remote_field(i8* %"$execptr_load_843", [20 x i8]* %"$tmp_3_9_remote3_844", i8* getelementptr inbounds ([11 x i8], [11 x i8]* @"$signatures_842", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_80", i32 0, i8* null, i32 1), !dbg !57
...
"$have_gas_865":                                  ; preds = %"$out_of_gas_864", %"$have_gas_857"
  ...
  call void @_update_field(i8* %"$execptr_load_867", i8* getelementptr inbounds ([26 x i8], [26 x i8]* @"$remote_reads_test_res_3_9_868", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_80", i32 0, i8* null, i8* %"$update_value_870"), !dbg !58
...
"$have_gas_879":                                  ; preds = %"$out_of_gas_878", %"$have_gas_874"
  ...
  %"$tmp_3_10_call_887" = call i8* @_fetch_remote_field(i8* %"$execptr_load_885", [20 x i8]* %"$tmp_3_10_remote3_886", i8* getelementptr inbounds ([11 x i8], [11 x i8]* @"$signatures_884", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_80", i32 1, i8* %"$indices_buf_881", i32 0), !dbg !60
...
"$have_gas_905":                                  ; preds = %"$out_of_gas_904", %"$have_gas_897"
  ...
  call void @_update_field(i8* %"$execptr_load_907", i8* getelementptr inbounds ([27 x i8], [27 x i8]* @"$remote_reads_test_res_3_10_908", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_ADT_Bool_73", i32 0, i8* null, i8* %"$update_value_910"), !dbg !61
  ...
  %"$tmp_3_11_call_917" = call i8* @_fetch_remote_field(i8* %"$execptr_load_915", [20 x i8]* %"$tmp_3_11_remote3_916", i8* getelementptr inbounds ([11 x i8], [11 x i8]* @"$signatures_914", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_80", i32 1, i8* %"$indices_buf_911", i32 1), !dbg !62
...
"$have_gas_935":                                  ; preds = %"$out_of_gas_934", %"$have_gas_927"
  ...
  call void @_update_field(i8* %"$execptr_load_937", i8* getelementptr inbounds ([27 x i8], [27 x i8]* @"$remote_reads_test_res_3_11_938", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_ADT_Option_Map_(ByStr20_with_end)_(Bool)_70", i32 0, i8* null, i8* %"$update_value_940"), !dbg !63
  ...
  %"$tmp_3_12_call_948" = call i8* @_fetch_remote_field(i8* %"$execptr_load_946", [20 x i8]* %"$tmp_3_12_remote3_947", i8* getelementptr inbounds ([11 x i8], [11 x i8]* @"$signatures_945", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_80", i32 2, i8* %"$indices_buf_941", i32 0), !dbg !64
...
"$have_gas_966":                                  ; preds = %"$out_of_gas_965", %"$have_gas_958"
  ...
  call void @_update_field(i8* %"$execptr_load_968", i8* getelementptr inbounds ([27 x i8], [27 x i8]* @"$remote_reads_test_res_3_12_969", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_ADT_Bool_73", i32 0, i8* null, i8* %"$update_value_971"), !dbg !65
  ...
  %"$tmp_3_13_call_979" = call i8* @_fetch_remote_field(i8* %"$execptr_load_977", [20 x i8]* %"$tmp_3_13_remote3_978", i8* getelementptr inbounds ([11 x i8], [11 x i8]* @"$signatures_976", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_80", i32 2, i8* %"$indices_buf_972", i32 1), !dbg !66
...
"$have_gas_997":                                  ; preds = %"$out_of_gas_996", %"$have_gas_989"
  ...
  call void @_update_field(i8* %"$execptr_load_999", i8* getelementptr inbounds ([27 x i8], [27 x i8]* @"$remote_reads_test_res_3_13_1000", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_ADT_Option_Bool_71", i32 0, i8* null, i8* %"$update_value_1002"), !dbg !67
  ret void
}
...
"$have_gas_1050":                                 ; preds = %"$out_of_gas_1049", %"$have_gas_1045"
  ...
  store i8* %"$msgobj_1052", i8** %msg, align 8, !dbg !74
...
"$have_gas_1097":                                 ; preds = %"$out_of_gas_1096", %"$have_gas_1092"
  ...
  store %TName_List_Message* %"$adtptr_1101", %TName_List_Message** %n, align 8, !dbg !75
...
"$have_gas_1105":                                 ; preds = %"$out_of_gas_1104", %"$have_gas_1097"
  ...
  store %TName_List_Message* %"$adtptr_1113", %TName_List_Message** %msgs, align 8, !dbg !76
...
"$have_gas_1120":                                 ; preds = %"$out_of_gas_1119", %"$have_gas_1105"
  ...
  call void @_send(i8* %"$execptr_load_1122", %_TyDescrTy_Typ* @"$TyDescr_ADT_List_Message_64", %TName_List_Message* %"$msgs_1123"), !dbg !77
...
"$have_gas_1132":                                 ; preds = %"$out_of_gas_1131", %"$have_gas_1127"
  ...
  store i8* %"$msgobj_1134", i8** %e1, align 8, !dbg !78
...
"$have_gas_1158":                                 ; preds = %"$out_of_gas_1157", %"$have_gas_1132"
  ...
  call void @_event(i8* %"$execptr_load_1160", %_TyDescrTy_Typ* @"$TyDescr_Event_54", i8* %"$e1_1161"), !dbg !79
...
"$have_gas_1170":                                 ; preds = %"$out_of_gas_1169", %"$have_gas_1165"
  ...
  store i8* %"$msgobj_1172", i8** %e2, align 8, !dbg !80
...
"$have_gas_1196":                                 ; preds = %"$out_of_gas_1195", %"$have_gas_1170"
  ...
  call void @_event(i8* %"$execptr_load_1198", %_TyDescrTy_Typ* @"$TyDescr_Event_54", i8* %"$e2_1199"), !dbg !81
  ret void
}
...
entry:
  ...
  call void @"$OutgoingMsgTest_1039"(%Uint128 %_amount, [20 x i8]* %"$_origin_1204", [20 x i8]* %"$_sender_1206"), !dbg !83
  ret void
}

define internal void @"$ExceptionTest_1207"(%Uint128 %_amount, [20 x i8]* %"$_origin_1208", [20 x i8]* %"$_sender_1209") !dbg !84 {
entry:
...
"$have_gas_1218":                                 ; preds = %"$out_of_gas_1217", %"$have_gas_1213"
  ...
  store i8* %"$msgobj_1220", i8** %e, align 8, !dbg !85
...
"$have_gas_1244":                                 ; preds = %"$out_of_gas_1243", %"$have_gas_1218"
  ...
  call void @_throw(i8* %"$execptr_load_1246", %_TyDescrTy_Typ* @"$TyDescr_Exception_56", i8* %"$e_1247"), !dbg !86
  ret void
}
...
entry:
  ...
  call void @"$ExceptionTest_1207"(%Uint128 %_amount, [20 x i8]* %"$_origin_1252", [20 x i8]* %"$_sender_1254"), !dbg !88
  ret void
}

define internal void @"$AssignTest_1255"(%Uint128 %_amount, [20 x i8]* %"$_origin_1256", [20 x i8]* %"$_sender_1257") !dbg !89 {
entry:
...
"$have_gas_1266":                                 ; preds = %"$out_of_gas_1265", %"$have_gas_1261"
  ...
  store %TName_0x3620c286757a29985cee194eb90064270fb65414.AddressADT* %"$adtptr_1272", %TName_0x3620c286757a29985cee194eb90064270fb65414.AddressADT** %"$x_1", align 8, !dbg !90
...
"$have_gas_1279":                                 ; preds = %"$out_of_gas_1278", %"$have_gas_1266"
  ...
  call void @_update_field(i8* %"$execptr_load_1281", i8* getelementptr inbounds ([14 x i8], [14 x i8]* @"$assign_test_8_1282", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_ADT_0x3620c286757a29985cee194eb90064270fb65414.AddressADT_72", i32 0, i8* null, i8* %"$update_value_1284"), !dbg !91
...
"$have_gas_1298":                                 ; preds = %"$out_of_gas_1297", %"$have_gas_1293"
  ...
  store %TName_List_0x3620c286757a29985cee194eb90064270fb65414.AddressADT* %"$adtptr_1302", %TName_List_0x3620c286757a29985cee194eb90064270fb65414.AddressADT** %n, align 8, !dbg !92
...
"$have_gas_1306":                                 ; preds = %"$out_of_gas_1305", %"$have_gas_1298"
  ...
  store %TName_List_0x3620c286757a29985cee194eb90064270fb65414.AddressADT* %"$adtptr_1314", %TName_List_0x3620c286757a29985cee194eb90064270fb65414.AddressADT** %y, align 8, !dbg !93
...
"$have_gas_1321":                                 ; preds = %"$out_of_gas_1320", %"$have_gas_1306"
  ...
  call void @_update_field(i8* %"$execptr_load_1323", i8* getelementptr inbounds ([14 x i8], [14 x i8]* @"$assign_test_9_1324", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_ADT_List_0x3620c286757a29985cee194eb90064270fb65414.AddressADT_68", i32 0, i8* null, i8* %"$update_value_1326"), !dbg !94
...
"$have_gas_1340":                                 ; preds = %"$out_of_gas_1339", %"$have_gas_1335"
  ...
  store %"Map_Uint128_Map_(Uint128)_(0x3620c286757a29985cee194eb90064270fb65414.AddressADT)"* %"$_new_empty_map_1344", %"Map_Uint128_Map_(Uint128)_(0x3620c286757a29985cee194eb90064270fb65414.AddressADT)"** %"$n_2", align 8, !dbg !95
...
"$have_gas_1353":                                 ; preds = %"$out_of_gas_1352", %"$have_gas_1348"
  ...
  store %Map_Uint128_0x3620c286757a29985cee194eb90064270fb65414.AddressADT* %"$_new_empty_map_1357", %Map_Uint128_0x3620c286757a29985cee194eb90064270fb65414.AddressADT** %sub_n, align 8, !dbg !96
...
"$have_gas_1371":                                 ; preds = %"$out_of_gas_1370", %"$have_gas_1366"
  ...
  %"$put_call_1381" = call i8* @_put(i8* %"$execptr_load_1373", %_TyDescrTy_Typ* @"$TyDescr_Map_75", i8* %"$$sub_n_1374_1375", i8* %"$$put_sub_k_1376_1378", i8* %"$$$x_1_1379_1380"), !dbg !98
  %"$put_1382" = bitcast i8* %"$put_call_1381" to %Map_Uint128_0x3620c286757a29985cee194eb90064270fb65414.AddressADT*
  store %Map_Uint128_0x3620c286757a29985cee194eb90064270fb65414.AddressADT* %"$put_1382", %Map_Uint128_0x3620c286757a29985cee194eb90064270fb65414.AddressADT** %sub_res, align 8, !dbg !98
  ...
  %"$put_call_1391" = call i8* @_put(i8* %"$execptr_load_1383", %_TyDescrTy_Typ* @"$TyDescr_Map_76", i8* %"$$$n_2_1384_1385", i8* %"$$put_sub_k_1386_1388", i8* %"$$sub_res_1389_1390"), !dbg !99
  %"$put_1392" = bitcast i8* %"$put_call_1391" to %"Map_Uint128_Map_(Uint128)_(0x3620c286757a29985cee194eb90064270fb65414.AddressADT)"*
  store %"Map_Uint128_Map_(Uint128)_(0x3620c286757a29985cee194eb90064270fb65414.AddressADT)"* %"$put_1392", %"Map_Uint128_Map_(Uint128)_(0x3620c286757a29985cee194eb90064270fb65414.AddressADT)"** %z, align 8, !dbg !99
...
"$have_gas_1399":                                 ; preds = %"$out_of_gas_1398", %"$have_gas_1371"
  ...
  call void @_update_field(i8* %"$execptr_load_1401", i8* getelementptr inbounds ([15 x i8], [15 x i8]* @"$assign_test_10_1402", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_76", i32 0, i8* null, i8* %"$update_value_1404"), !dbg !100
...
"$have_gas_1432":                                 ; preds = %"$out_of_gas_1431", %"$have_gas_1423"
  ...
  call void @_update_field(i8* %"$execptr_load_1439", i8* getelementptr inbounds ([15 x i8], [15 x i8]* @"$assign_test_10_1440", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_76", i32 2, i8* %"$indices_buf_1434", i8* %"$update_value_1442"), !dbg !103
  ret void
}
...
entry:
  ...
  call void @"$AssignTest_1255"(%Uint128 %_amount, [20 x i8]* %"$_origin_1447", [20 x i8]* %"$_sender_1449"), !dbg !105
  ret void
}

define internal void @"$SenderBalanceTest_1450"(%Uint128 %_amount, [20 x i8]* %"$_origin_1451", [20 x i8]* %"$_sender_1452") !dbg !106 {
entry:
  ...
  %"$pre_call_1456" = call i8* @_fetch_remote_field(i8* %"$execptr_load_1454", [20 x i8]* %"$pre__sender_1455", i8* getelementptr inbounds ([9 x i8], [9 x i8]* @"$_balance_1453", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Uint128_42", i32 0, i8* null, i32 1), !dbg !107
...
"$have_gas_1476":                                 ; preds = %"$out_of_gas_1475", %"$have_gas_1467"
  ...
  call void @_update_field(i8* %"$execptr_load_1478", i8* getelementptr inbounds ([19 x i8], [19 x i8]* @"$sender_balance_pre_1479", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Uint128_42", i32 0, i8* null, i8* %"$update_value_1482"), !dbg !108
...
"$have_gas_1486":                                 ; preds = %"$out_of_gas_1485", %"$have_gas_1476"
  ...
  call void @_accept(i8* %"$execptr_load_1488"), !dbg !109
  ...
  %"$mid_call_1492" = call i8* @_fetch_remote_field(i8* %"$execptr_load_1490", [20 x i8]* %"$mid__sender_1491", i8* getelementptr inbounds ([9 x i8], [9 x i8]* @"$_balance_1489", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Uint128_42", i32 0, i8* null, i32 1), !dbg !110
...
"$have_gas_1512":                                 ; preds = %"$out_of_gas_1511", %"$have_gas_1503"
  ...
  call void @_update_field(i8* %"$execptr_load_1514", i8* getelementptr inbounds ([19 x i8], [19 x i8]* @"$sender_balance_mid_1515", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Uint128_42", i32 0, i8* null, i8* %"$update_value_1518"), !dbg !111
...
"$have_gas_1522":                                 ; preds = %"$out_of_gas_1521", %"$have_gas_1512"
  ...
  call void @_accept(i8* %"$execptr_load_1524"), !dbg !112
  ...
  %"$post_call_1528" = call i8* @_fetch_remote_field(i8* %"$execptr_load_1526", [20 x i8]* %"$post__sender_1527", i8* getelementptr inbounds ([9 x i8], [9 x i8]* @"$_balance_1525", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Uint128_42", i32 0, i8* null, i32 1), !dbg !113
...
"$have_gas_1548":                                 ; preds = %"$out_of_gas_1547", %"$have_gas_1539"
  ...
  call void @_update_field(i8* %"$execptr_load_1550", i8* getelementptr inbounds ([20 x i8], [20 x i8]* @"$sender_balance_post_1551", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Uint128_42", i32 0, i8* null, i8* %"$update_value_1554"), !dbg !114
  ret void
}
...
entry:
  ...
  call void @"$SenderBalanceTest_1450"(%Uint128 %_amount, [20 x i8]* %"$_origin_1559", [20 x i8]* %"$_sender_1561"), !dbg !116
  ret void
}
