...
"$have_gas_955":                                  ; preds = %"$out_of_gas_954", %"$have_gas_947"
  ...
  call void @_update_field(i8* %"$execptr_load_957", i8* getelementptr inbounds ([27 x i8], [27 x i8]* @"$remote_reads_test_res_3_11_958", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_ADT_Option_Map_(ByStr20_with_end)_(Bool)_72", i32 0, i8* null, i8* %"$update_value_960"), !dbg !63
  ...
  %"$tmp_3_12_call_968" = call i8* @_fetch_remote_field(i8* %"$execptr_load_966", [20 x i8]* %"$tmp_3_12_remote3_967", i8* getelementptr inbounds ([11 x i8], [11 x i8]* @"$signatures_965", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_82", i32 2, i8* %"$indices_buf_961", i32 0), !dbg !64
...
"$have_gas_986":                                  ; preds = %"$out_of_gas_985", %"$have_gas_978"
  ...
  call void @_update_field(i8* %"$execptr_load_988", i8* getelementptr inbounds ([27 x i8], [27 x i8]* @"$remote_reads_test_res_3_12_989", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_ADT_Bool_75", i32 0, i8* null, i8* %"$update_value_991"), !dbg !65
  ...
  %"$tmp_3_13_call_999" = call i8* @_fetch_remote_field(i8* %"$execptr_load_997", [20 x i8]* %"$tmp_3_13_remote3_998", i8* getelementptr inbounds ([11 x i8], [11 x i8]* @"$signatures_996", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_82", i32 2, i8* %"$indices_buf_992", i32 1), !dbg !66
...
"$have_gas_1017":                                 ; preds = %"$out_of_gas_1016", %"$have_gas_1009"
  ...
  call void @_update_field(i8* %"$execptr_load_1019", i8* getelementptr inbounds ([27 x i8], [27 x i8]* @"$remote_reads_test_res_3_13_1020", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_ADT_Option_Bool_73", i32 0, i8* null, i8* %"$update_value_1022"), !dbg !67
  ret void
}
...
define internal void @"$OutgoingMsgTest_1059"(%Uint128 %_amount, [20 x i8]* %"$_origin_1060", [20 x i8]* %"$_sender_1061") !dbg !73 {
entry:
...
"$have_gas_1070":                                 ; preds = %"$out_of_gas_1069", %"$have_gas_1065"
  ...
  store i8* %"$msgobj_1072", i8** %msg, align 8, !dbg !74
...
"$have_gas_1117":                                 ; preds = %"$out_of_gas_1116", %"$have_gas_1112"
  ...
  store %TName_List_Message* %"$adtptr_1121", %TName_List_Message** %n, align 8, !dbg !75
...
"$have_gas_1125":                                 ; preds = %"$out_of_gas_1124", %"$have_gas_1117"
  ...
  store %TName_List_Message* %"$adtptr_1133", %TName_List_Message** %msgs, align 8, !dbg !76
...
"$have_gas_1140":                                 ; preds = %"$out_of_gas_1139", %"$have_gas_1125"
  ...
  call void @_send(i8* %"$execptr_load_1142", %_TyDescrTy_Typ* @"$TyDescr_ADT_List_Message_64", %TName_List_Message* %"$msgs_1143"), !dbg !77
...
"$have_gas_1152":                                 ; preds = %"$out_of_gas_1151", %"$have_gas_1147"
  ...
  store i8* %"$msgobj_1154", i8** %e1, align 8, !dbg !78
...
"$have_gas_1178":                                 ; preds = %"$out_of_gas_1177", %"$have_gas_1152"
  ...
  call void @_event(i8* %"$execptr_load_1180", %_TyDescrTy_Typ* @"$TyDescr_Event_54", i8* %"$e1_1181"), !dbg !79
...
"$have_gas_1190":                                 ; preds = %"$out_of_gas_1189", %"$have_gas_1185"
  ...
  store i8* %"$msgobj_1192", i8** %e2, align 8, !dbg !80
...
"$have_gas_1216":                                 ; preds = %"$out_of_gas_1215", %"$have_gas_1190"
  ...
  call void @_event(i8* %"$execptr_load_1218", %_TyDescrTy_Typ* @"$TyDescr_Event_54", i8* %"$e2_1219"), !dbg !81
  ret void
}
...
entry:
  ...
  call void @"$OutgoingMsgTest_1059"(%Uint128 %_amount, [20 x i8]* %"$_origin_1224", [20 x i8]* %"$_sender_1226"), !dbg !83
  ret void
}

define internal void @"$ExceptionTest_1227"(%Uint128 %_amount, [20 x i8]* %"$_origin_1228", [20 x i8]* %"$_sender_1229") !dbg !84 {
entry:
...
"$have_gas_1238":                                 ; preds = %"$out_of_gas_1237", %"$have_gas_1233"
  ...
  store i8* %"$msgobj_1240", i8** %e, align 8, !dbg !85
...
"$have_gas_1264":                                 ; preds = %"$out_of_gas_1263", %"$have_gas_1238"
  ...
  call void @_throw(i8* %"$execptr_load_1266", %_TyDescrTy_Typ* @"$TyDescr_Exception_56", i8* %"$e_1267"), !dbg !86
  ret void
}
...
entry:
  ...
  call void @"$ExceptionTest_1227"(%Uint128 %_amount, [20 x i8]* %"$_origin_1272", [20 x i8]* %"$_sender_1274"), !dbg !88
  ret void
}

define internal void @"$AssignTest_1275"(%Uint128 %_amount, [20 x i8]* %"$_origin_1276", [20 x i8]* %"$_sender_1277") !dbg !89 {
entry:
...
"$have_gas_1286":                                 ; preds = %"$out_of_gas_1285", %"$have_gas_1281"
  ...
  store %TName_0x3620c286757a29985cee194eb90064270fb65414.AddressADT* %"$adtptr_1292", %TName_0x3620c286757a29985cee194eb90064270fb65414.AddressADT** %"$x_1", align 8, !dbg !90
...
"$have_gas_1299":                                 ; preds = %"$out_of_gas_1298", %"$have_gas_1286"
  ...
  call void @_update_field(i8* %"$execptr_load_1301", i8* getelementptr inbounds ([14 x i8], [14 x i8]* @"$assign_test_8_1302", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_ADT_0x3620c286757a29985cee194eb90064270fb65414.AddressADT_74", i32 0, i8* null, i8* %"$update_value_1304"), !dbg !91
...
"$have_gas_1318":                                 ; preds = %"$out_of_gas_1317", %"$have_gas_1313"
  ...
  store %TName_List_0x3620c286757a29985cee194eb90064270fb65414.AddressADT* %"$adtptr_1322", %TName_List_0x3620c286757a29985cee194eb90064270fb65414.AddressADT** %n, align 8, !dbg !92
...
"$have_gas_1326":                                 ; preds = %"$out_of_gas_1325", %"$have_gas_1318"
  ...
  store %TName_List_0x3620c286757a29985cee194eb90064270fb65414.AddressADT* %"$adtptr_1334", %TName_List_0x3620c286757a29985cee194eb90064270fb65414.AddressADT** %y, align 8, !dbg !93
...
"$have_gas_1341":                                 ; preds = %"$out_of_gas_1340", %"$have_gas_1326"
  ...
  call void @_update_field(i8* %"$execptr_load_1343", i8* getelementptr inbounds ([14 x i8], [14 x i8]* @"$assign_test_9_1344", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_ADT_List_0x3620c286757a29985cee194eb90064270fb65414.AddressADT_69", i32 0, i8* null, i8* %"$update_value_1346"), !dbg !94
...
"$have_gas_1360":                                 ; preds = %"$out_of_gas_1359", %"$have_gas_1355"
  ...
  store %"Map_Uint128_Map_(Uint128)_(0x3620c286757a29985cee194eb90064270fb65414.AddressADT)"* %"$_new_empty_map_1364", %"Map_Uint128_Map_(Uint128)_(0x3620c286757a29985cee194eb90064270fb65414.AddressADT)"** %"$n_2", align 8, !dbg !95
...
"$have_gas_1373":                                 ; preds = %"$out_of_gas_1372", %"$have_gas_1368"
  ...
  store %Map_Uint128_0x3620c286757a29985cee194eb90064270fb65414.AddressADT* %"$_new_empty_map_1377", %Map_Uint128_0x3620c286757a29985cee194eb90064270fb65414.AddressADT** %sub_n, align 8, !dbg !96
...
"$have_gas_1400":                                 ; preds = %"$out_of_gas_1399", %"$have_gas_1391"
  ...
  %"$put_call_1410" = call i8* @_put(i8* %"$execptr_load_1402", %_TyDescrTy_Typ* @"$TyDescr_Map_77", i8* %"$$sub_n_1403_1404", i8* %"$$put_sub_k_1405_1407", i8* %"$$$x_1_1408_1409"), !dbg !98
  %"$put_1411" = bitcast i8* %"$put_call_1410" to %Map_Uint128_0x3620c286757a29985cee194eb90064270fb65414.AddressADT*
  store %Map_Uint128_0x3620c286757a29985cee194eb90064270fb65414.AddressADT* %"$put_1411", %Map_Uint128_0x3620c286757a29985cee194eb90064270fb65414.AddressADT** %sub_res, align 8, !dbg !98
...
"$have_gas_1419":                                 ; preds = %"$out_of_gas_1418", %"$have_gas_1400"
  ...
  %"$put_call_1429" = call i8* @_put(i8* %"$execptr_load_1421", %_TyDescrTy_Typ* @"$TyDescr_Map_78", i8* %"$$$n_2_1422_1423", i8* %"$$put_sub_k_1424_1426", i8* %"$$sub_res_1427_1428"), !dbg !99
  %"$put_1430" = bitcast i8* %"$put_call_1429" to %"Map_Uint128_Map_(Uint128)_(0x3620c286757a29985cee194eb90064270fb65414.AddressADT)"*
  store %"Map_Uint128_Map_(Uint128)_(0x3620c286757a29985cee194eb90064270fb65414.AddressADT)"* %"$put_1430", %"Map_Uint128_Map_(Uint128)_(0x3620c286757a29985cee194eb90064270fb65414.AddressADT)"** %z, align 8, !dbg !99
...
"$have_gas_1437":                                 ; preds = %"$out_of_gas_1436", %"$have_gas_1419"
  ...
  call void @_update_field(i8* %"$execptr_load_1439", i8* getelementptr inbounds ([15 x i8], [15 x i8]* @"$assign_test_10_1440", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_78", i32 0, i8* null, i8* %"$update_value_1442"), !dbg !100
...
"$have_gas_1470":                                 ; preds = %"$out_of_gas_1469", %"$have_gas_1461"
  ...
  call void @_update_field(i8* %"$execptr_load_1477", i8* getelementptr inbounds ([15 x i8], [15 x i8]* @"$assign_test_10_1478", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_78", i32 2, i8* %"$indices_buf_1472", i8* %"$update_value_1480"), !dbg !103
  ret void
}
...
entry:
  ...
  call void @"$AssignTest_1275"(%Uint128 %_amount, [20 x i8]* %"$_origin_1485", [20 x i8]* %"$_sender_1487"), !dbg !105
  ret void
}
