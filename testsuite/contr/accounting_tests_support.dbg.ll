...
"$have_gas_75":                                   ; preds = %"$out_of_gas_74", %entry
  ...
  store %TName_List_String* %"$adtptr_79", %TName_List_String** %"$stored_strings_1", align 8, !dbg !11
  ...
  call void @_update_field(i8* %"$execptr_load_80", i8* getelementptr inbounds ([15 x i8], [15 x i8]* @"$stored_strings_81", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_ADT_List_String_37", i32 0, i8* null, i8* %"$update_value_83"), !dbg !11
  ret void
}
...
define internal void @"$Reset_84"(%Uint128 %_amount, [20 x i8]* %"$_origin_85", [20 x i8]* %"$_sender_86") !dbg !12 {
entry:
...
"$have_gas_95":                                   ; preds = %"$out_of_gas_94", %"$have_gas_90"
  ...
  store %TName_List_String* %"$adtptr_99", %TName_List_String** %new_strings, align 8, !dbg !13
...
"$have_gas_106":                                  ; preds = %"$out_of_gas_105", %"$have_gas_95"
  ...
  call void @_update_field(i8* %"$execptr_load_108", i8* getelementptr inbounds ([15 x i8], [15 x i8]* @"$stored_strings_109", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_ADT_List_String_37", i32 0, i8* null, i8* %"$update_value_111"), !dbg !14
  ret void
}
...
entry:
  ...
  call void @"$Reset_84"(%Uint128 %_amount, [20 x i8]* %"$_origin_116", [20 x i8]* %"$_sender_118"), !dbg !16
  ret void
}

define internal void @"$StoreString_119"(%Uint128 %_amount, [20 x i8]* %"$_origin_120", [20 x i8]* %"$_sender_121", %String %s) !dbg !17 {
entry:
  ...
  %"$old_strings_call_124" = call i8* @_fetch_field(i8* %"$execptr_load_123", i8* getelementptr inbounds ([15 x i8], [15 x i8]* @"$stored_strings_122", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_ADT_List_String_37", i32 0, i8* null, i32 1), !dbg !18
...
"$have_gas_143":                                  ; preds = %"$out_of_gas_142", %"$have_gas_138"
  ...
  store %TName_List_String* %"$adtptr_150", %TName_List_String** %new_strings, align 8, !dbg !19
...
"$have_gas_157":                                  ; preds = %"$out_of_gas_156", %"$have_gas_143"
  ...
  call void @_update_field(i8* %"$execptr_load_159", i8* getelementptr inbounds ([15 x i8], [15 x i8]* @"$stored_strings_160", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_ADT_List_String_37", i32 0, i8* null, i8* %"$update_value_162"), !dbg !20
  ret void
}
...
entry:
  ...
  call void @"$StoreString_119"(%Uint128 %_amount, [20 x i8]* %"$_origin_167", [20 x i8]* %"$_sender_169", %String %s), !dbg !22
  ret void
}

define internal void @"$Accept_172"(%Uint128 %_amount, [20 x i8]* %"$_origin_173", [20 x i8]* %"$_sender_174") !dbg !23 {
entry:
...
"$have_gas_178":                                  ; preds = %"$out_of_gas_177", %entry
  ...
  call void @_accept(i8* %"$execptr_load_180"), !dbg !24
  ret void
}
...
entry:
  ...
  call void @"$Accept_172"(%Uint128 %_amount, [20 x i8]* %"$_origin_185", [20 x i8]* %"$_sender_187"), !dbg !26
  ret void
}

define internal void @"$AcceptTwice_188"(%Uint128 %_amount, [20 x i8]* %"$_origin_189", [20 x i8]* %"$_sender_190") !dbg !27 {
entry:
...
"$have_gas_200":                                  ; preds = %"$out_of_gas_199", %"$have_gas_194"
  ...
  call void @_accept(i8* %"$execptr_load_202"), !dbg !29
  ret void
}
...
entry:
  ...
  call void @"$AcceptTwice_188"(%Uint128 %_amount, [20 x i8]* %"$_origin_207", [20 x i8]* %"$_sender_209"), !dbg !31
  ret void
}

define internal void @"$NonAccept_210"(%Uint128 %_amount, [20 x i8]* %"$_origin_211", [20 x i8]* %"$_sender_212") !dbg !32 {
entry:
...
entry:
  ...
  call void @"$NonAccept_210"(%Uint128 %_amount, [20 x i8]* %"$_origin_217", [20 x i8]* %"$_sender_219"), !dbg !34
  ret void
}

define internal void @"$CheckBalance_220"(%Uint128 %_amount, [20 x i8]* %"$_origin_221", [20 x i8]* %"$_sender_222", %Uint128 %expected_balance) !dbg !35 {
entry:
  ...
  %"$cur_balance_call_225" = call i8* @_fetch_field(i8* %"$execptr_load_224", i8* getelementptr inbounds ([9 x i8], [9 x i8]* @"$_balance_223", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Uint128_14", i32 0, i8* null, i32 1), !dbg !36
...
"$have_gas_247":                                  ; preds = %"$out_of_gas_246", %"$have_gas_241"
  ...
  %"$eq_call_251" = call %TName_Bool* @_eq_Uint128(i8* %"$execptr_load_249", %Uint128 %expected_balance, %Uint128 %"$cur_balance_250"), !dbg !37
  store %TName_Bool* %"$eq_call_251", %TName_Bool** %is_expected, align 8, !dbg !37
...
"$have_gas_275":                                  ; preds = %"$out_of_gas_274", %"$have_gas_270"
  ...
  store i8* %"$msgobj_277", i8** %e, align 8, !dbg !39
...
"$have_gas_308":                                  ; preds = %"$out_of_gas_307", %"$have_gas_275"
  ...
  call void @_throw(i8* %"$execptr_load_310", %_TyDescrTy_Typ* @"$TyDescr_Exception_28", i8* %"$e_311"), !dbg !42
  br label %"$matchsucc_258"
...
define internal void @"$CheckSenderBalance_312"(%Uint128 %_amount, [20 x i8]* %"$_origin_313", [20 x i8]* %"$_sender_314", %Uint128 %expected_balance) !dbg !43 {
entry:
  ...
  %"$cur_balance_call_318" = call i8* @_fetch_remote_field(i8* %"$execptr_load_316", [20 x i8]* %"$cur_balance__sender_317", i8* getelementptr inbounds ([9 x i8], [9 x i8]* @"$_balance_315", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Uint128_14", i32 0, i8* null, i32 1), !dbg !44
...
"$have_gas_340":                                  ; preds = %"$out_of_gas_339", %"$have_gas_334"
  ...
  %"$eq_call_344" = call %TName_Bool* @_eq_Uint128(i8* %"$execptr_load_342", %Uint128 %expected_balance, %Uint128 %"$cur_balance_343"), !dbg !45
  store %TName_Bool* %"$eq_call_344", %TName_Bool** %is_expected, align 8, !dbg !45
...
"$have_gas_368":                                  ; preds = %"$out_of_gas_367", %"$have_gas_363"
  ...
  store i8* %"$msgobj_370", i8** %e, align 8, !dbg !47
...
"$have_gas_401":                                  ; preds = %"$out_of_gas_400", %"$have_gas_368"
  ...
  call void @_throw(i8* %"$execptr_load_403", %_TyDescrTy_Typ* @"$TyDescr_Exception_28", i8* %"$e_404"), !dbg !50
  br label %"$matchsucc_351"
...
define internal void @"$AcceptAndCheckBalance_405"(%Uint128 %_amount, [20 x i8]* %"$_origin_406", [20 x i8]* %"$_sender_407") !dbg !51 {
entry:
  ...
  %"$init_bal_call_410" = call i8* @_fetch_field(i8* %"$execptr_load_409", i8* getelementptr inbounds ([9 x i8], [9 x i8]* @"$_balance_408", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Uint128_14", i32 0, i8* null, i32 1), !dbg !52
...
"$have_gas_426":                                  ; preds = %"$out_of_gas_425", %"$have_gas_421"
  ...
  call void @_accept(i8* %"$execptr_load_428"), !dbg !53
...
"$have_gas_438":                                  ; preds = %"$out_of_gas_437", %"$have_gas_432"
  ...
  %"$add_call_441" = call %Uint128 @_add_Uint128(%Uint128 %"$init_bal_440", %Uint128 %_amount), !dbg !54
  store %Uint128 %"$add_call_441", %Uint128* %expected_balance, align 8, !dbg !54
...
"$have_gas_445":                                  ; preds = %"$out_of_gas_444", %"$have_gas_438"
  ...
  call void @"$CheckBalance_220"(%Uint128 %_amount, [20 x i8]* %"$CheckBalance__origin_447", [20 x i8]* %"$CheckBalance__sender_448", %Uint128 %"$expected_balance_449"), !dbg !55
  ret void
}
...
entry:
  ...
  call void @"$AcceptAndCheckBalance_405"(%Uint128 %_amount, [20 x i8]* %"$_origin_454", [20 x i8]* %"$_sender_456"), !dbg !57
  ret void
}

define internal void @"$AcceptTwiceAndCheckBalance_457"(%Uint128 %_amount, [20 x i8]* %"$_origin_458", [20 x i8]* %"$_sender_459") !dbg !58 {
entry:
  ...
  %"$init_bal_call_462" = call i8* @_fetch_field(i8* %"$execptr_load_461", i8* getelementptr inbounds ([9 x i8], [9 x i8]* @"$_balance_460", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Uint128_14", i32 0, i8* null, i32 1), !dbg !59
...
"$have_gas_478":                                  ; preds = %"$out_of_gas_477", %"$have_gas_473"
  ...
  call void @_accept(i8* %"$execptr_load_480"), !dbg !60
...
"$have_gas_490":                                  ; preds = %"$out_of_gas_489", %"$have_gas_484"
  ...
  %"$add_call_493" = call %Uint128 @_add_Uint128(%Uint128 %"$init_bal_492", %Uint128 %_amount), !dbg !61
  store %Uint128 %"$add_call_493", %Uint128* %expected_balance, align 8, !dbg !61
...
"$have_gas_497":                                  ; preds = %"$out_of_gas_496", %"$have_gas_490"
  ...
  call void @"$CheckBalance_220"(%Uint128 %_amount, [20 x i8]* %"$CheckBalance__origin_499", [20 x i8]* %"$CheckBalance__sender_500", %Uint128 %"$expected_balance_501"), !dbg !62
...
"$have_gas_505":                                  ; preds = %"$out_of_gas_504", %"$have_gas_497"
  ...
  call void @_accept(i8* %"$execptr_load_507"), !dbg !63
...
"$have_gas_511":                                  ; preds = %"$out_of_gas_510", %"$have_gas_505"
  ...
  call void @"$CheckBalance_220"(%Uint128 %_amount, [20 x i8]* %"$CheckBalance__origin_513", [20 x i8]* %"$CheckBalance__sender_514", %Uint128 %"$expected_balance_515"), !dbg !64
  ret void
}
...
entry:
  ...
  call void @"$AcceptTwiceAndCheckBalance_457"(%Uint128 %_amount, [20 x i8]* %"$_origin_520", [20 x i8]* %"$_sender_522"), !dbg !66
  ret void
}

define internal void @"$AcceptAndCheckSenderBalance_523"(%Uint128 %_amount, [20 x i8]* %"$_origin_524", [20 x i8]* %"$_sender_525") !dbg !67 {
entry:
  ...
  %"$init_bal_call_529" = call i8* @_fetch_remote_field(i8* %"$execptr_load_527", [20 x i8]* %"$init_bal__sender_528", i8* getelementptr inbounds ([9 x i8], [9 x i8]* @"$_balance_526", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Uint128_14", i32 0, i8* null, i32 1), !dbg !68
...
"$have_gas_545":                                  ; preds = %"$out_of_gas_544", %"$have_gas_540"
  ...
  call void @_accept(i8* %"$execptr_load_547"), !dbg !69
...
"$have_gas_551":                                  ; preds = %"$out_of_gas_550", %"$have_gas_545"
  ...
  call void @"$CheckSenderBalance_312"(%Uint128 %_amount, [20 x i8]* %"$CheckSenderBalance__origin_553", [20 x i8]* %"$CheckSenderBalance__sender_554", %Uint128 %"$init_bal_555"), !dbg !70
  ret void
}
...
entry:
  ...
  call void @"$AcceptAndCheckSenderBalance_523"(%Uint128 %_amount, [20 x i8]* %"$_origin_560", [20 x i8]* %"$_sender_562"), !dbg !72
  ret void
}
