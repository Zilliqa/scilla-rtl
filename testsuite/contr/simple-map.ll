...
"$have_gas_63":                                   ; preds = %"$out_of_gas_62", %entry
  ...
  store %Int32 { i32 1 }, %Int32* @simple-map.one, align 4, !dbg !10
...
"$have_gas_68":                                   ; preds = %"$out_of_gas_67", %"$have_gas_63"
  ...
  store { %Int32 (i8*, %Int32)*, i8* } %"$$fundef_1_cloval_73", { %Int32 (i8*, %Int32)*, i8* }* @simple-map.inc, align 8, !dbg !11
  ret void
}
...
define void @_init_state() !dbg !12 {
entry:
...
"$have_gas_79":                                   ; preds = %"$out_of_gas_78", %entry
  ...
  store %Map_ByStr20_Int32* %"$Emp_83", %Map_ByStr20_Int32** %"$access_count_3", align 8, !dbg !13
  ...
  call void @_update_field(i8* %"$execptr_load_84", i8* getelementptr inbounds ([13 x i8], [13 x i8]* @"$access_count_85", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_40", i32 0, i8* null, i8* %"$update_value_87"), !dbg !13
  ret void
}
...
define internal void @"$Increment_88"(%Uint128 %_amount, [20 x i8]* %"$_sender_89") !dbg !14 {
entry:
  ...
  %"$cur_94" = call i8* @_fetch_field(i8* %"$execptr_load_92", i8* getelementptr inbounds ([13 x i8], [13 x i8]* @"$access_count_93", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_40", i32 1, i8* %"$indices_buf_90", i32 1), !dbg !15
...
"$have_gas_128":                                  ; preds = %"$out_of_gas_127", %"$have_gas_123"
  ...
  %"$simple-map.inc_call_134" = call %Int32 %"$simple-map.inc_fptr_131"(i8* %"$simple-map.inc_envptr_132", %Int32 %"$i_133"), !dbg !17
  store %Int32 %"$simple-map.inc_call_134", %Int32* %"$simple-map.inc_0", align 4, !dbg !17
  %"$$simple-map.inc_0_135" = load %Int32, %Int32* %"$simple-map.inc_0", align 4
  store %Int32 %"$$simple-map.inc_0_135", %Int32* %j, align 4, !dbg !17
...
"$have_gas_144":                                  ; preds = %"$out_of_gas_143", %"$have_gas_128"
  ...
  call void @_update_field(i8* %"$execptr_load_148", i8* getelementptr inbounds ([13 x i8], [13 x i8]* @"$access_count_149", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_40", i32 1, i8* %"$indices_buf_146", i8* %"$update_value_152"), !dbg !20
...
"$have_gas_163":                                  ; preds = %"$out_of_gas_162", %"$None_153"
  ...
  call void @_update_field(i8* %"$execptr_load_167", i8* getelementptr inbounds ([13 x i8], [13 x i8]* @"$access_count_168", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_40", i32 1, i8* %"$indices_buf_165", i8* %"$update_value_171"), !dbg !21
  br label %"$matchsucc_111"
...
define void @Increment(i8* %0) !dbg !23 {
entry:
  ...
  call void @"$Increment_88"(%Uint128 %_amount, [20 x i8]* %"$_sender_176"), !dbg !24
  ret void
}

define internal void @"$IncrementN_177"(%Uint128 %_amount, [20 x i8]* %"$_sender_178", %Int32 %n) !dbg !25 {
entry:
  ...
  %"$cur_183" = call i8* @_fetch_field(i8* %"$execptr_load_181", i8* getelementptr inbounds ([13 x i8], [13 x i8]* @"$access_count_182", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_40", i32 1, i8* %"$indices_buf_179", i32 1), !dbg !26
...
"$have_gas_212":                                  ; preds = %"$out_of_gas_211", %"$Some_205"
  ...
  store %Int32 %"$add_call_215", %Int32* %j, align 4, !dbg !28
...
"$have_gas_224":                                  ; preds = %"$out_of_gas_223", %"$have_gas_212"
  ...
  call void @_update_field(i8* %"$execptr_load_228", i8* getelementptr inbounds ([13 x i8], [13 x i8]* @"$access_count_229", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_40", i32 1, i8* %"$indices_buf_226", i8* %"$update_value_232"), !dbg !31
...
"$have_gas_242":                                  ; preds = %"$out_of_gas_241", %"$None_233"
  ...
  call void @_update_field(i8* %"$execptr_load_246", i8* getelementptr inbounds ([13 x i8], [13 x i8]* @"$access_count_247", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_40", i32 1, i8* %"$indices_buf_244", i8* %"$update_value_249"), !dbg !32
  br label %"$matchsucc_200"
...
define internal void @"$IncrementNOpt_250"(%Uint128 %_amount, [20 x i8]* %"$_sender_251", %TName_Option_Int32* %nopt) !dbg !34 {
entry:
...
"$have_gas_268":                                  ; preds = %"$out_of_gas_267", %"$Some_261"
  ...
  call void @"$IncrementN_177"(%Uint128 %_amount, [20 x i8]* %"$IncrementN__sender_270", %Int32 %"$n_271"), !dbg !36
...
define void @IncrementNOpt(i8* %0) !dbg !39 {
entry:
  ...
  call void @"$IncrementNOpt_250"(%Uint128 %_amount, [20 x i8]* %"$_sender_278", %TName_Option_Int32* %nopt), !dbg !40
  ret void
}
...
!9 = distinct !DISubprogram(name: "_init_libs", linkageName: "_init_libs", scope: !2, file: !2, type: !5, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !1, retainedNodes: !3)
!10 = !DILocation(line: 5, column: 11, scope: !9)
!11 = !DILocation(line: 9, column: 5, scope: !9)
!12 = distinct !DISubprogram(name: "_init_state", linkageName: "_init_state", scope: !2, file: !2, type: !5, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !1, retainedNodes: !3)
!13 = !DILocation(line: 13, column: 42, scope: !12)
!14 = distinct !DISubprogram(name: "Increment", linkageName: "Increment", scope: !2, file: !2, line: 15, type: !5, scopeLine: 15, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !1, retainedNodes: !3)
!15 = !DILocation(line: 16, column: 3, scope: !14)
!16 = !DILocation(line: 17, column: 3, scope: !14)
!17 = !DILocation(line: 19, column: 9, scope: !18)
!18 = distinct !DILexicalBlock(scope: !19, file: !2, line: 18, column: 5)
!19 = distinct !DILexicalBlock(scope: !14, file: !2, line: 17, column: 3)
!20 = !DILocation(line: 20, column: 5, scope: !18)
!21 = !DILocation(line: 22, column: 5, scope: !22)
!22 = distinct !DILexicalBlock(scope: !19, file: !2, line: 21, column: 5)
!23 = distinct !DISubprogram(name: "Increment", linkageName: "Increment", scope: !2, file: !2, line: 15, type: !5, scopeLine: 15, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !1, retainedNodes: !3)
!24 = !DILocation(line: 15, column: 12, scope: !23)
!25 = distinct !DISubprogram(name: "IncrementN", linkageName: "IncrementN", scope: !2, file: !2, line: 26, type: !5, scopeLine: 26, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !1, retainedNodes: !3)
!26 = !DILocation(line: 27, column: 3, scope: !25)
!27 = !DILocation(line: 28, column: 3, scope: !25)
!28 = !DILocation(line: 30, column: 9, scope: !29)
!29 = distinct !DILexicalBlock(scope: !30, file: !2, line: 29, column: 5)
!30 = distinct !DILexicalBlock(scope: !25, file: !2, line: 28, column: 3)
!31 = !DILocation(line: 31, column: 5, scope: !29)
!32 = !DILocation(line: 33, column: 5, scope: !33)
!33 = distinct !DILexicalBlock(scope: !30, file: !2, line: 32, column: 5)
!34 = distinct !DISubprogram(name: "IncrementNOpt", linkageName: "IncrementNOpt", scope: !2, file: !2, line: 37, type: !5, scopeLine: 37, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !1, retainedNodes: !3)
!35 = !DILocation(line: 38, column: 3, scope: !34)
!36 = !DILocation(line: 40, column: 5, scope: !37)
!37 = distinct !DILexicalBlock(scope: !38, file: !2, line: 39, column: 5)
!38 = distinct !DILexicalBlock(scope: !34, file: !2, line: 38, column: 3)
!39 = distinct !DISubprogram(name: "IncrementNOpt", linkageName: "IncrementNOpt", scope: !2, file: !2, line: 37, type: !5, scopeLine: 37, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !1, retainedNodes: !3)
