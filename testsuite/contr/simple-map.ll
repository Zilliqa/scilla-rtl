...
define internal %Int32 @"$fundef_2"(%"$$fundef_2_env_61"* %0, %Int32 %1) {
entry:
...
"$have_gas_67":                                   ; preds = %"$out_of_gas_66", %entry
  ...
  %"$add_call_70" = call %Int32 @_add_Int32(%Int32 %1, %Int32 %"$simple-map.one_69")
  store %Int32 %"$add_call_70", %Int32* %"$retval_3", align 4
...
"$have_gas_85":                                   ; preds = %"$out_of_gas_84", %"$have_gas_80"
  ...
  store { %Int32 (i8*, %Int32)*, i8* } %"$$fundef_2_cloval_90", { %Int32 (i8*, %Int32)*, i8* }* @simple-map.inc, align 8
  ret void
}
...
"$have_gas_101":                                  ; preds = %"$out_of_gas_100", %"$have_gas_96"
  ...
  store %Map_ByStr20_Int32* %"$_new_empty_map_105", %Map_ByStr20_Int32** %"$access_count_4", align 8
  ...
  call void @_update_field(i8* %"$execptr_load_106", i8* getelementptr inbounds ([13 x i8], [13 x i8]* @"$access_count_107", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_43", i32 0, i8* null, i8* %"$update_value_109")
  ret void
}
...
define internal void @"$Increment_110"(%Uint128 %_amount, [20 x i8]* %"$_origin_111", [20 x i8]* %"$_sender_112") {
entry:
  ...
  %"$cur_call_117" = call i8* @_fetch_field(i8* %"$execptr_load_116", i8* getelementptr inbounds ([13 x i8], [13 x i8]* @"$access_count_115", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_43", i32 1, i8* %"$indices_buf_113", i32 1)
...
"$have_gas_151":                                  ; preds = %"$out_of_gas_150", %"$have_gas_146"
  ...
  %"$simple-map.inc_call_157" = call %Int32 %"$simple-map.inc_fptr_154"(i8* %"$simple-map.inc_envptr_155", %Int32 %"$i_156")
  store %Int32 %"$simple-map.inc_call_157", %Int32* %"$simple-map.inc_1", align 4
  %"$$simple-map.inc_1_158" = load %Int32, %Int32* %"$simple-map.inc_1", align 4
  store %Int32 %"$$simple-map.inc_1_158", %Int32* %j, align 4
...
"$have_gas_167":                                  ; preds = %"$out_of_gas_166", %"$have_gas_151"
  ...
  call void @_update_field(i8* %"$execptr_load_171", i8* getelementptr inbounds ([13 x i8], [13 x i8]* @"$access_count_172", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_43", i32 1, i8* %"$indices_buf_169", i8* %"$update_value_175")
...
"$have_gas_186":                                  ; preds = %"$out_of_gas_185", %"$None_176"
  ...
  call void @_update_field(i8* %"$execptr_load_190", i8* getelementptr inbounds ([13 x i8], [13 x i8]* @"$access_count_191", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_43", i32 1, i8* %"$indices_buf_188", i8* %"$update_value_194")
  br label %"$matchsucc_134"
...
entry:
  ...
  call void @"$Increment_110"(%Uint128 %_amount, [20 x i8]* %"$_origin_199", [20 x i8]* %"$_sender_201")
  ret void
}

define internal void @"$IncrementN_202"(%Uint128 %_amount, [20 x i8]* %"$_origin_203", [20 x i8]* %"$_sender_204", %Int32 %n) {
entry:
  ...
  %"$cur_call_209" = call i8* @_fetch_field(i8* %"$execptr_load_208", i8* getelementptr inbounds ([13 x i8], [13 x i8]* @"$access_count_207", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_43", i32 1, i8* %"$indices_buf_205", i32 1)
...
"$have_gas_243":                                  ; preds = %"$out_of_gas_242", %"$have_gas_238"
  ...
  %"$add_call_246" = call %Int32 @_add_Int32(%Int32 %"$i_245", %Int32 %n)
  store %Int32 %"$add_call_246", %Int32* %j, align 4
...
"$have_gas_255":                                  ; preds = %"$out_of_gas_254", %"$have_gas_243"
  ...
  call void @_update_field(i8* %"$execptr_load_259", i8* getelementptr inbounds ([13 x i8], [13 x i8]* @"$access_count_260", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_43", i32 1, i8* %"$indices_buf_257", i8* %"$update_value_263")
...
"$have_gas_273":                                  ; preds = %"$out_of_gas_272", %"$None_264"
  ...
  call void @_update_field(i8* %"$execptr_load_277", i8* getelementptr inbounds ([13 x i8], [13 x i8]* @"$access_count_278", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_43", i32 1, i8* %"$indices_buf_275", i8* %"$update_value_280")
  br label %"$matchsucc_226"
...
define internal void @"$IncrementNOpt_281"(%Uint128 %_amount, [20 x i8]* %"$_origin_282", [20 x i8]* %"$_sender_283", %TName_Option_Int32* %nopt) {
entry:
...
"$have_gas_300":                                  ; preds = %"$out_of_gas_299", %"$Some_293"
  ...
  call void @"$IncrementN_202"(%Uint128 %_amount, [20 x i8]* %"$IncrementN__origin_302", [20 x i8]* %"$IncrementN__sender_303", %Int32 %"$n_304")
...
entry:
  ...
  call void @"$IncrementNOpt_281"(%Uint128 %_amount, [20 x i8]* %"$_origin_311", [20 x i8]* %"$_sender_313", %TName_Option_Int32* %nopt)
  ret void
}
