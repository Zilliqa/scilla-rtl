...
@"$pname_cparam_444" = unnamed_addr constant [6 x i8] c"cparam"
@_contract_parameters = constant [3 x %"$ParamDescr_440"] [%"$ParamDescr_440" { %ParamDescrString { i8* getelementptr inbounds ([15 x i8], [15 x i8]* @"$pname__scilla_version_442", i32 0, i32 0), i32 15 }, %_TyDescrTy_Typ* @"$TyDescr_Uint32_8" }, %"$ParamDescr_440" { %ParamDescrString { i8* getelementptr inbounds ([13 x i8], [13 x i8]* @"$pname__this_address_443", i32 0, i32 0), i32 13 }, %_TyDescrTy_Typ* @"$TyDescr_Bystr20_34" }, %"$ParamDescr_440" { %ParamDescrString { i8* getelementptr inbounds ([6 x i8], [6 x i8]* @"$pname_cparam_444", i32 0, i32 0), i32 6 }, %_TyDescrTy_Typ* @"$TyDescr_Addr_51" }]
@_contract_parameters_length = constant i32 3
@"$tpname__amount_445" = unnamed_addr constant [7 x i8] c"_amount"
@"$tpname__origin_446" = unnamed_addr constant [7 x i8] c"_origin"
@"$tpname__sender_447" = unnamed_addr constant [7 x i8] c"_sender"
@"$tpname_remote_448" = unnamed_addr constant [6 x i8] c"remote"
@"$tparams_RemoteReadsOfRemoteRead_449" = unnamed_addr constant [4 x %"$ParamDescr_440"] [%"$ParamDescr_440" { %ParamDescrString { i8* getelementptr inbounds ([7 x i8], [7 x i8]* @"$tpname__amount_445", i32 0, i32 0), i32 7 }, %_TyDescrTy_Typ* @"$TyDescr_Uint128_16" }, %"$ParamDescr_440" { %ParamDescrString { i8* getelementptr inbounds ([7 x i8], [7 x i8]* @"$tpname__origin_446", i32 0, i32 0), i32 7 }, %_TyDescrTy_Typ* @"$TyDescr_Addr_50" }, %"$ParamDescr_440" { %ParamDescrString { i8* getelementptr inbounds ([7 x i8], [7 x i8]* @"$tpname__sender_447", i32 0, i32 0), i32 7 }, %_TyDescrTy_Typ* @"$TyDescr_Addr_50" }, %"$ParamDescr_440" { %ParamDescrString { i8* getelementptr inbounds ([6 x i8], [6 x i8]* @"$tpname_remote_448", i32 0, i32 0), i32 6 }, %_TyDescrTy_Typ* @"$TyDescr_Addr_49" }]
@"$tname_RemoteReadsOfRemoteRead_450" = unnamed_addr constant [23 x i8] c"RemoteReadsOfRemoteRead"
@"$tpname__amount_451" = unnamed_addr constant [7 x i8] c"_amount"
@"$tpname__origin_452" = unnamed_addr constant [7 x i8] c"_origin"
@"$tpname__sender_453" = unnamed_addr constant [7 x i8] c"_sender"
@"$tpname_remote_454" = unnamed_addr constant [6 x i8] c"remote"
@"$tparams_RemoteReadsOfRemoteMap_455" = unnamed_addr constant [4 x %"$ParamDescr_440"] [%"$ParamDescr_440" { %ParamDescrString { i8* getelementptr inbounds ([7 x i8], [7 x i8]* @"$tpname__amount_451", i32 0, i32 0), i32 7 }, %_TyDescrTy_Typ* @"$TyDescr_Uint128_16" }, %"$ParamDescr_440" { %ParamDescrString { i8* getelementptr inbounds ([7 x i8], [7 x i8]* @"$tpname__origin_452", i32 0, i32 0), i32 7 }, %_TyDescrTy_Typ* @"$TyDescr_Addr_50" }, %"$ParamDescr_440" { %ParamDescrString { i8* getelementptr inbounds ([7 x i8], [7 x i8]* @"$tpname__sender_453", i32 0, i32 0), i32 7 }, %_TyDescrTy_Typ* @"$TyDescr_Addr_50" }, %"$ParamDescr_440" { %ParamDescrString { i8* getelementptr inbounds ([6 x i8], [6 x i8]* @"$tpname_remote_454", i32 0, i32 0), i32 6 }, %_TyDescrTy_Typ* @"$TyDescr_Addr_46" }]
@"$tname_RemoteReadsOfRemoteMap_456" = unnamed_addr constant [22 x i8] c"RemoteReadsOfRemoteMap"
@"$tpname__amount_457" = unnamed_addr constant [7 x i8] c"_amount"
@"$tpname__origin_458" = unnamed_addr constant [7 x i8] c"_origin"
@"$tpname__sender_459" = unnamed_addr constant [7 x i8] c"_sender"
@"$tparams_RemoteReadsContractParam_460" = unnamed_addr constant [3 x %"$ParamDescr_440"] [%"$ParamDescr_440" { %ParamDescrString { i8* getelementptr inbounds ([7 x i8], [7 x i8]* @"$tpname__amount_457", i32 0, i32 0), i32 7 }, %_TyDescrTy_Typ* @"$TyDescr_Uint128_16" }, %"$ParamDescr_440" { %ParamDescrString { i8* getelementptr inbounds ([7 x i8], [7 x i8]* @"$tpname__origin_458", i32 0, i32 0), i32 7 }, %_TyDescrTy_Typ* @"$TyDescr_Addr_50" }, %"$ParamDescr_440" { %ParamDescrString { i8* getelementptr inbounds ([7 x i8], [7 x i8]* @"$tpname__sender_459", i32 0, i32 0), i32 7 }, %_TyDescrTy_Typ* @"$TyDescr_Addr_50" }]
@"$tname_RemoteReadsContractParam_461" = unnamed_addr constant [24 x i8] c"RemoteReadsContractParam"
@"$tpname__amount_462" = unnamed_addr constant [7 x i8] c"_amount"
@"$tpname__origin_463" = unnamed_addr constant [7 x i8] c"_origin"
@"$tpname__sender_464" = unnamed_addr constant [7 x i8] c"_sender"
@"$tparams_AddressTypeErasureTest1_465" = unnamed_addr constant [3 x %"$ParamDescr_440"] [%"$ParamDescr_440" { %ParamDescrString { i8* getelementptr inbounds ([7 x i8], [7 x i8]* @"$tpname__amount_462", i32 0, i32 0), i32 7 }, %_TyDescrTy_Typ* @"$TyDescr_Uint128_16" }, %"$ParamDescr_440" { %ParamDescrString { i8* getelementptr inbounds ([7 x i8], [7 x i8]* @"$tpname__origin_463", i32 0, i32 0), i32 7 }, %_TyDescrTy_Typ* @"$TyDescr_Addr_50" }, %"$ParamDescr_440" { %ParamDescrString { i8* getelementptr inbounds ([7 x i8], [7 x i8]* @"$tpname__sender_464", i32 0, i32 0), i32 7 }, %_TyDescrTy_Typ* @"$TyDescr_Addr_50" }]
@"$tname_AddressTypeErasureTest1_466" = unnamed_addr constant [23 x i8] c"AddressTypeErasureTest1"
...
@"$tparams_AddressTypeErasureTest2_470" = unnamed_addr constant [3 x %"$ParamDescr_440"] [%"$ParamDescr_440" { %ParamDescrString { i8* getelementptr inbounds ([7 x i8], [7 x i8]* @"$tpname__amount_467", i32 0, i32 0), i32 7 }, %_TyDescrTy_Typ* @"$TyDescr_Uint128_16" }, %"$ParamDescr_440" { %ParamDescrString { i8* getelementptr inbounds ([7 x i8], [7 x i8]* @"$tpname__origin_468", i32 0, i32 0), i32 7 }, %_TyDescrTy_Typ* @"$TyDescr_Addr_50" }, %"$ParamDescr_440" { %ParamDescrString { i8* getelementptr inbounds ([7 x i8], [7 x i8]* @"$tpname__sender_469", i32 0, i32 0), i32 7 }, %_TyDescrTy_Typ* @"$TyDescr_Addr_50" }]
@"$tname_AddressTypeErasureTest2_471" = unnamed_addr constant [23 x i8] c"AddressTypeErasureTest2"
@_transition_parameters = constant [5 x %"$TransDescr_441"] [%"$TransDescr_441" { %ParamDescrString { i8* getelementptr inbounds ([23 x i8], [23 x i8]* @"$tname_RemoteReadsOfRemoteRead_450", i32 0, i32 0), i32 23 }, i32 4, %"$ParamDescr_440"* getelementptr inbounds ([4 x %"$ParamDescr_440"], [4 x %"$ParamDescr_440"]* @"$tparams_RemoteReadsOfRemoteRead_449", i32 0, i32 0) }, %"$TransDescr_441" { %ParamDescrString { i8* getelementptr inbounds ([22 x i8], [22 x i8]* @"$tname_RemoteReadsOfRemoteMap_456", i32 0, i32 0), i32 22 }, i32 4, %"$ParamDescr_440"* getelementptr inbounds ([4 x %"$ParamDescr_440"], [4 x %"$ParamDescr_440"]* @"$tparams_RemoteReadsOfRemoteMap_455", i32 0, i32 0) }, %"$TransDescr_441" { %ParamDescrString { i8* getelementptr inbounds ([24 x i8], [24 x i8]* @"$tname_RemoteReadsContractParam_461", i32 0, i32 0), i32 24 }, i32 3, %"$ParamDescr_440"* getelementptr inbounds ([3 x %"$ParamDescr_440"], [3 x %"$ParamDescr_440"]* @"$tparams_RemoteReadsContractParam_460", i32 0, i32 0) }, %"$TransDescr_441" { %ParamDescrString { i8* getelementptr inbounds ([23 x i8], [23 x i8]* @"$tname_AddressTypeErasureTest1_466", i32 0, i32 0), i32 23 }, i32 3, %"$ParamDescr_440"* getelementptr inbounds ([3 x %"$ParamDescr_440"], [3 x %"$ParamDescr_440"]* @"$tparams_AddressTypeErasureTest1_465", i32 0, i32 0) }, %"$TransDescr_441" { %ParamDescrString { i8* getelementptr inbounds ([23 x i8], [23 x i8]* @"$tname_AddressTypeErasureTest2_471", i32 0, i32 0), i32 23 }, i32 3, %"$ParamDescr_440"* getelementptr inbounds ([3 x %"$ParamDescr_440"], [3 x %"$ParamDescr_440"]* @"$tparams_AddressTypeErasureTest2_470", i32 0, i32 0) }]
...
"$have_gas_91":                                   ; preds = %"$out_of_gas_90", %entry
  ...
  store %Uint128 zeroinitializer, %Uint128* %"$remote_read_remote_read_res_1_0", align 8
  ...
  call void @_update_field(i8* %"$execptr_load_93", i8* getelementptr inbounds ([30 x i8], [30 x i8]* @"$remote_read_remote_read_res_1_94", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Uint128_16", i32 0, i8* null, i8* %"$update_value_97")
...
"$have_gas_101":                                  ; preds = %"$out_of_gas_100", %"$have_gas_91"
  ...
  store %TName_Option_Uint128* %"$adtptr_105", %TName_Option_Uint128** %"$remote_read_remote_read_res_2_1", align 8
  ...
  call void @_update_field(i8* %"$execptr_load_106", i8* getelementptr inbounds ([30 x i8], [30 x i8]* @"$remote_read_remote_read_res_2_107", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_ADT_Option_Uint128_38", i32 0, i8* null, i8* %"$update_value_109")
...
"$have_gas_113":                                  ; preds = %"$out_of_gas_112", %"$have_gas_101"
  ...
  call void @_update_field(i8* %"$execptr_load_116", i8* getelementptr inbounds ([30 x i8], [30 x i8]* @"$remote_read_remote_read_res_3_117", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Bystr20_34", i32 0, i8* null, i8* %"$update_value_120")
...
"$have_gas_124":                                  ; preds = %"$out_of_gas_123", %"$have_gas_113"
  ...
  store %Map_Uint128_ByStr20_with_end* %"$_new_empty_map_128", %Map_Uint128_ByStr20_with_end** %"$address_type_erasure_test_res_1_3", align 8
  ...
  call void @_update_field(i8* %"$execptr_load_129", i8* getelementptr inbounds ([32 x i8], [32 x i8]* @"$address_type_erasure_test_res_1_130", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_41", i32 0, i8* null, i8* %"$update_value_132")
  ret void
}
...
define internal void @"$RemoteReadsOfRemoteRead_133"(%Uint128 %_amount, [20 x i8]* %"$_origin_134", [20 x i8]* %"$_sender_135", [20 x i8]* %"$remote_136") {
entry:
  ...
  %"$ad_call_140" = call i8* @_fetch_remote_field(i8* %"$execptr_load_138", [20 x i8]* %"$ad_remote_139", i8* getelementptr inbounds ([6 x i8], [6 x i8]* @"$admin_137", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Addr_48", i32 0, i8* null, i32 1)
...
"$have_gas_151":                                  ; preds = %"$out_of_gas_150", %entry
  ...
  %"$this_f_call_157" = call i8* @_fetch_remote_field(i8* %"$execptr_load_154", [20 x i8]* %"$this_f_ad_155", i8* getelementptr inbounds ([2 x i8], [2 x i8]* @"$f_153", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Addr_47", i32 0, i8* null, i32 1)
...
"$have_gas_168":                                  ; preds = %"$out_of_gas_167", %"$have_gas_151"
  ...
  %"$this_g_call_174" = call i8* @_fetch_remote_field(i8* %"$execptr_load_171", [20 x i8]* %"$this_g_this_f_172", i8* getelementptr inbounds ([2 x i8], [2 x i8]* @"$g_170", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Uint128_16", i32 0, i8* null, i32 1)
...
"$have_gas_194":                                  ; preds = %"$out_of_gas_193", %"$have_gas_185"
  ...
  call void @_update_field(i8* %"$execptr_load_196", i8* getelementptr inbounds ([30 x i8], [30 x i8]* @"$remote_read_remote_read_res_1_197", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Uint128_16", i32 0, i8* null, i8* %"$update_value_200")
  ret void
}
...
entry:
  ...
  call void @"$RemoteReadsOfRemoteRead_133"(%Uint128 %_amount, [20 x i8]* %"$_origin_205", [20 x i8]* %"$_sender_207", [20 x i8]* %"$remote_209")
  ret void
}

define internal void @"$RemoteReadsOfRemoteMap_210"(%Uint128 %_amount, [20 x i8]* %"$_origin_211", [20 x i8]* %"$_sender_212", [20 x i8]* %"$remote_213") {
entry:
  ...
  %"$ad_call_217" = call i8* @_fetch_remote_field(i8* %"$execptr_load_215", [20 x i8]* %"$ad_remote_216", i8* getelementptr inbounds ([6 x i8], [6 x i8]* @"$admin_214", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Addr_45", i32 0, i8* null, i32 1)
...
"$have_gas_228":                                  ; preds = %"$out_of_gas_227", %entry
  ...
  %"$this_f_call_234" = call i8* @_fetch_remote_field(i8* %"$execptr_load_231", [20 x i8]* %"$this_f_ad_232", i8* getelementptr inbounds ([2 x i8], [2 x i8]* @"$f_230", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Addr_44", i32 0, i8* null, i32 1)
...
"$have_gas_255":                                  ; preds = %"$out_of_gas_254", %"$have_gas_250"
  ...
  %"$this_g_call_264" = call i8* @_fetch_remote_field(i8* %"$execptr_load_261", [20 x i8]* %"$this_g_this_f_262", i8* getelementptr inbounds ([2 x i8], [2 x i8]* @"$g_260", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_40", i32 1, i8* %"$indices_buf_257", i32 1)
...
"$have_gas_282":                                  ; preds = %"$out_of_gas_281", %"$have_gas_274"
  ...
  call void @_update_field(i8* %"$execptr_load_284", i8* getelementptr inbounds ([30 x i8], [30 x i8]* @"$remote_read_remote_read_res_2_285", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_ADT_Option_Uint128_38", i32 0, i8* null, i8* %"$update_value_287")
  ret void
}
...
entry:
  ...
  call void @"$RemoteReadsOfRemoteMap_210"(%Uint128 %_amount, [20 x i8]* %"$_origin_292", [20 x i8]* %"$_sender_294", [20 x i8]* %"$remote_296")
  ret void
}

define internal void @"$RemoteReadsContractParam_297"(%Uint128 %_amount, [20 x i8]* %"$_origin_298", [20 x i8]* %"$_sender_299") {
entry:
...
"$have_gas_324":                                  ; preds = %"$out_of_gas_323", %"$have_gas_315"
  ...
  call void @_update_field(i8* %"$execptr_load_326", i8* getelementptr inbounds ([30 x i8], [30 x i8]* @"$remote_read_remote_read_res_3_327", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Bystr20_34", i32 0, i8* null, i8* %"$update_value_330")
  ret void
}
...
entry:
  ...
  call void @"$RemoteReadsContractParam_297"(%Uint128 %_amount, [20 x i8]* %"$_origin_335", [20 x i8]* %"$_sender_337")
  ret void
}

define internal void @"$AddressTypeErasureTest1_338"(%Uint128 %_amount, [20 x i8]* %"$_origin_339", [20 x i8]* %"$_sender_340") {
entry:
...
"$have_gas_359":                                  ; preds = %"$out_of_gas_358", %"$have_gas_349"
  ...
  call void @_update_field(i8* %"$execptr_load_364", i8* getelementptr inbounds ([32 x i8], [32 x i8]* @"$address_type_erasure_test_res_1_365", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_41", i32 1, i8* %"$indices_buf_361", i8* %"$update_value_368")
  ret void
}
...
entry:
  ...
  call void @"$AddressTypeErasureTest1_338"(%Uint128 %_amount, [20 x i8]* %"$_origin_373", [20 x i8]* %"$_sender_375")
  ret void
}

define internal void @"$AddressTypeErasureTest2_376"(%Uint128 %_amount, [20 x i8]* %"$_origin_377", [20 x i8]* %"$_sender_378") {
entry:
...
"$have_gas_387":                                  ; preds = %"$out_of_gas_386", %"$have_gas_382"
  ...
  %"$emp_map_call_391" = call i8* @_fetch_field(i8* %"$execptr_load_390", i8* getelementptr inbounds ([32 x i8], [32 x i8]* @"$address_type_erasure_test_res_1_389", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_41", i32 0, i8* null, i32 1)
...
"$have_gas_408":                                  ; preds = %"$out_of_gas_407", %"$have_gas_403"
  ...
  store %Map_Uint128_ByStr20_with_end* %"$put_420", %Map_Uint128_ByStr20_with_end** %new_map, align 8
...
"$have_gas_427":                                  ; preds = %"$out_of_gas_426", %"$have_gas_408"
  ...
  call void @_update_field(i8* %"$execptr_load_429", i8* getelementptr inbounds ([32 x i8], [32 x i8]* @"$address_type_erasure_test_res_1_430", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_41", i32 0, i8* null, i8* %"$update_value_432")
  ret void
}
...
entry:
  ...
  call void @"$AddressTypeErasureTest2_376"(%Uint128 %_amount, [20 x i8]* %"$_origin_437", [20 x i8]* %"$_sender_439")
  ret void
}
