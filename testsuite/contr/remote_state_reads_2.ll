...
"$have_gas_97":                                   ; preds = %"$out_of_gas_96", %entry
  ...
  call void @_update_field(i8* %"$execptr_load_99", i8* getelementptr inbounds ([30 x i8], [30 x i8]* @"$remote_read_remote_read_res_1_100", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Uint128_17", i32 0, i8* null, i8* %"$update_value_103")
...
"$have_gas_107":                                  ; preds = %"$out_of_gas_106", %"$have_gas_97"
  ...
  store %TName_Option_Uint128* %"$adtptr_111", %TName_Option_Uint128** %"$remote_read_remote_read_res_2_2", align 8
  ...
  call void @_update_field(i8* %"$execptr_load_112", i8* getelementptr inbounds ([30 x i8], [30 x i8]* @"$remote_read_remote_read_res_2_113", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_ADT_Option_Uint128_39", i32 0, i8* null, i8* %"$update_value_115")
...
"$have_gas_119":                                  ; preds = %"$out_of_gas_118", %"$have_gas_107"
  ...
  store [20 x i8] %"$_this_address_121", [20 x i8]* %"$remote_read_remote_read_res_3_3", align 1
  ...
  call void @_update_field(i8* %"$execptr_load_122", i8* getelementptr inbounds ([30 x i8], [30 x i8]* @"$remote_read_remote_read_res_3_123", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Bystr20_35", i32 0, i8* null, i8* %"$update_value_126")
...
"$have_gas_130":                                  ; preds = %"$out_of_gas_129", %"$have_gas_119"
  ...
  store %Map_Uint128_ByStr20_with_end* %"$_new_empty_map_134", %Map_Uint128_ByStr20_with_end** %"$address_type_erasure_test_res_1_4", align 8
  ...
  call void @_update_field(i8* %"$execptr_load_135", i8* getelementptr inbounds ([32 x i8], [32 x i8]* @"$address_type_erasure_test_res_1_136", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_42", i32 0, i8* null, i8* %"$update_value_138")
  ret void
}
...
define internal void @"$RemoteReadsOfRemoteRead_139"(%Uint128 %_amount, [20 x i8]* %"$_origin_140", [20 x i8]* %"$_sender_141", [20 x i8]* %"$remote_142") {
entry:
  ...
  %"$ad_call_146" = call i8* @_fetch_remote_field(i8* %"$execptr_load_144", [20 x i8]* %"$ad_remote_145", i8* getelementptr inbounds ([6 x i8], [6 x i8]* @"$admin_143", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Addr_49", i32 0, i8* null, i32 1)
...
"$have_gas_157":                                  ; preds = %"$out_of_gas_156", %entry
  ...
  %"$this_f_call_163" = call i8* @_fetch_remote_field(i8* %"$execptr_load_160", [20 x i8]* %"$this_f_ad_161", i8* getelementptr inbounds ([2 x i8], [2 x i8]* @"$f_159", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Addr_48", i32 0, i8* null, i32 1)
...
"$have_gas_174":                                  ; preds = %"$out_of_gas_173", %"$have_gas_157"
  ...
  %"$this_g_call_180" = call i8* @_fetch_remote_field(i8* %"$execptr_load_177", [20 x i8]* %"$this_g_this_f_178", i8* getelementptr inbounds ([2 x i8], [2 x i8]* @"$g_176", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Uint128_17", i32 0, i8* null, i32 1)
...
"$have_gas_200":                                  ; preds = %"$out_of_gas_199", %"$have_gas_191"
  ...
  call void @_update_field(i8* %"$execptr_load_202", i8* getelementptr inbounds ([30 x i8], [30 x i8]* @"$remote_read_remote_read_res_1_203", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Uint128_17", i32 0, i8* null, i8* %"$update_value_206")
  ret void
}
...
entry:
  ...
  call void @"$RemoteReadsOfRemoteRead_139"(%Uint128 %_amount, [20 x i8]* %"$_origin_211", [20 x i8]* %"$_sender_213", [20 x i8]* %"$remote_215")
  ret void
}

define internal void @"$RemoteReadsOfRemoteMap_216"(%Uint128 %_amount, [20 x i8]* %"$_origin_217", [20 x i8]* %"$_sender_218", [20 x i8]* %"$remote_219") {
entry:
  ...
  %"$ad_call_223" = call i8* @_fetch_remote_field(i8* %"$execptr_load_221", [20 x i8]* %"$ad_remote_222", i8* getelementptr inbounds ([6 x i8], [6 x i8]* @"$admin_220", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Addr_46", i32 0, i8* null, i32 1)
...
"$have_gas_234":                                  ; preds = %"$out_of_gas_233", %entry
  ...
  %"$this_f_call_240" = call i8* @_fetch_remote_field(i8* %"$execptr_load_237", [20 x i8]* %"$this_f_ad_238", i8* getelementptr inbounds ([2 x i8], [2 x i8]* @"$f_236", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Addr_45", i32 0, i8* null, i32 1)
...
"$have_gas_261":                                  ; preds = %"$out_of_gas_260", %"$have_gas_256"
  ...
  %"$this_g_call_270" = call i8* @_fetch_remote_field(i8* %"$execptr_load_267", [20 x i8]* %"$this_g_this_f_268", i8* getelementptr inbounds ([2 x i8], [2 x i8]* @"$g_266", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_41", i32 1, i8* %"$indices_buf_263", i32 1)
...
"$have_gas_288":                                  ; preds = %"$out_of_gas_287", %"$have_gas_280"
  ...
  call void @_update_field(i8* %"$execptr_load_290", i8* getelementptr inbounds ([30 x i8], [30 x i8]* @"$remote_read_remote_read_res_2_291", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_ADT_Option_Uint128_39", i32 0, i8* null, i8* %"$update_value_293")
  ret void
}
...
entry:
  ...
  call void @"$RemoteReadsOfRemoteMap_216"(%Uint128 %_amount, [20 x i8]* %"$_origin_298", [20 x i8]* %"$_sender_300", [20 x i8]* %"$remote_302")
  ret void
}

define internal void @"$RemoteReadsContractParam_303"(%Uint128 %_amount, [20 x i8]* %"$_origin_304", [20 x i8]* %"$_sender_305") {
entry:
  ...
  %"$ad_call_310" = call i8* @_fetch_remote_field(i8* %"$execptr_load_307", [20 x i8]* %"$ad_cparam_308", i8* getelementptr inbounds ([6 x i8], [6 x i8]* @"$admin_306", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Bystr20_35", i32 0, i8* null, i32 1)
...
"$have_gas_330":                                  ; preds = %"$out_of_gas_329", %"$have_gas_321"
  ...
  call void @_update_field(i8* %"$execptr_load_332", i8* getelementptr inbounds ([30 x i8], [30 x i8]* @"$remote_read_remote_read_res_3_333", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Bystr20_35", i32 0, i8* null, i8* %"$update_value_336")
  ret void
}
...
entry:
  ...
  call void @"$RemoteReadsContractParam_303"(%Uint128 %_amount, [20 x i8]* %"$_origin_341", [20 x i8]* %"$_sender_343")
  ret void
}

define internal void @"$AddressTypeErasureTest1_344"(%Uint128 %_amount, [20 x i8]* %"$_origin_345", [20 x i8]* %"$_sender_346") {
entry:
...
"$have_gas_365":                                  ; preds = %"$out_of_gas_364", %"$have_gas_355"
  ...
  call void @_update_field(i8* %"$execptr_load_370", i8* getelementptr inbounds ([32 x i8], [32 x i8]* @"$address_type_erasure_test_res_1_371", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_42", i32 1, i8* %"$indices_buf_367", i8* %"$update_value_374")
  ret void
}
...
entry:
  ...
  call void @"$AddressTypeErasureTest1_344"(%Uint128 %_amount, [20 x i8]* %"$_origin_379", [20 x i8]* %"$_sender_381")
  ret void
}

define internal void @"$AddressTypeErasureTest2_382"(%Uint128 %_amount, [20 x i8]* %"$_origin_383", [20 x i8]* %"$_sender_384") {
entry:
...
"$have_gas_393":                                  ; preds = %"$out_of_gas_392", %"$have_gas_388"
  ...
  %"$emp_map_call_397" = call i8* @_fetch_field(i8* %"$execptr_load_396", i8* getelementptr inbounds ([32 x i8], [32 x i8]* @"$address_type_erasure_test_res_1_395", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_42", i32 0, i8* null, i32 1)
...
"$have_gas_423":                                  ; preds = %"$out_of_gas_422", %"$have_gas_414"
  ...
  %"$put_call_434" = call i8* @_put(i8* %"$execptr_load_425", %_TyDescrTy_Typ* @"$TyDescr_Map_42", i8* %"$$emp_map_426_427", i8* %"$$put_zero_428_430", i8* %"$$put_cparam_431_433")
  %"$put_435" = bitcast i8* %"$put_call_434" to %Map_Uint128_ByStr20_with_end*
  store %Map_Uint128_ByStr20_with_end* %"$put_435", %Map_Uint128_ByStr20_with_end** %new_map, align 8
...
"$have_gas_442":                                  ; preds = %"$out_of_gas_441", %"$have_gas_423"
  ...
  call void @_update_field(i8* %"$execptr_load_444", i8* getelementptr inbounds ([32 x i8], [32 x i8]* @"$address_type_erasure_test_res_1_445", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_42", i32 0, i8* null, i8* %"$update_value_447")
  ret void
}
...
entry:
  ...
  call void @"$AddressTypeErasureTest2_382"(%Uint128 %_amount, [20 x i8]* %"$_origin_452", [20 x i8]* %"$_sender_454")
  ret void
}
