...
"$have_gas_124":                                  ; preds = %"$out_of_gas_123", %"$have_gas_113"
  ...
  store %Map_Uint128_ByStr20_with_end* %"$Emp_128", %Map_Uint128_ByStr20_with_end** %"$address_type_erasure_test_res_1_3", align 8
...
"$have_gas_408":                                  ; preds = %"$out_of_gas_407", %"$have_gas_403"
  ...
  store %Map_Uint128_ByStr20_with_end* %"$_put_420", %Map_Uint128_ByStr20_with_end** %new_map, align 8
