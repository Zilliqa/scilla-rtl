...
"$have_gas_417":                                  ; preds = %"$out_of_gas_416", %"$have_gas_408"
  ...
  %"$put_call_428" = call i8* @_put(i8* %"$execptr_load_419", %_TyDescrTy_Typ* @"$TyDescr_Map_41", i8* %"$$emp_map_420_421", i8* %"$$put_zero_422_424", i8* %"$$put_cparam_425_427")
  %"$put_429" = bitcast i8* %"$put_call_428" to %Map_Uint128_ByStr20_with_end*
  store %Map_Uint128_ByStr20_with_end* %"$put_429", %Map_Uint128_ByStr20_with_end** %new_map, align 8
...
"$have_gas_436":                                  ; preds = %"$out_of_gas_435", %"$have_gas_417"
  ...
  call void @_update_field(i8* %"$execptr_load_438", i8* getelementptr inbounds ([32 x i8], [32 x i8]* @"$address_type_erasure_test_res_1_439", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_41", i32 0, i8* null, i8* %"$update_value_441")
  ret void
}
...
entry:
  ...
  call void @"$AddressTypeErasureTest2_376"(%Uint128 %_amount, [20 x i8]* %"$_origin_446", [20 x i8]* %"$_sender_448")
  ret void
}
