...
define internal void @"$EventN_56"(%Uint128 %_amount, [20 x i8]* %"$_origin_57", [20 x i8]* %"$_sender_58", %Int32 %n) {
entry:
...
"$have_gas_67":                                   ; preds = %"$out_of_gas_66", %"$have_gas_62"
  ...
  store i8* %"$msgobj_69", i8** %e, align 8
...
"$have_gas_92":                                   ; preds = %"$out_of_gas_91", %"$have_gas_67"
  ...
  call void @_event(i8* %"$execptr_load_94", %_TyDescrTy_Typ* @"$TyDescr_Event_28", i8* %"$e_95")
  ret void
}
...
define internal void @"$NEvents_96"(%Uint128 %_amount, [20 x i8]* %"$_origin_97", [20 x i8]* %"$_sender_98", %TName_List_Int32* %nlist) {
entry:
...
"$have_gas_104":                                  ; preds = %"$out_of_gas_103", %entry
  ...
  store %TName_List_Int32* %nlist, %TName_List_Int32** %"$nlist_0", align 8
...
"$Cons_113":                                      ; preds = %"$loop_header_107"
  ...
  call void @"$EventN_56"(%Uint128 %_amount, [20 x i8]* %"$EventN__origin_119", [20 x i8]* %"$EventN__sender_120", %Int32 %"$$list_cur_2_121")
  %"$$list_next_3_122" = load %TName_List_Int32*, %TName_List_Int32** %"$list_next_3", align 8
  store %TName_List_Int32* %"$$list_next_3_122", %TName_List_Int32** %"$nlist_0", align 8
  br label %"$loop_header_107"
...
entry:
  ...
  call void @"$NEvents_96"(%Uint128 %_amount, [20 x i8]* %"$_origin_129", [20 x i8]* %"$_sender_131", %TName_List_Int32* %nlist)
  ret void
}
