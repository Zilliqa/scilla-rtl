...
"$have_gas_91":                                   ; preds = %"$out_of_gas_90", %entry
  ...
  %"$execptr_load_93" = load i8*, i8** @_execptr
...
"$have_gas_97":                                   ; preds = %"$out_of_gas_96", %"$have_gas_91"
  ...
  %"$execptr_load_99" = load i8*, i8** @_execptr
...
"$have_gas_110":                                  ; preds = %"$out_of_gas_109", %entry
  ...
  %"$execptr_load_112" = load i8*, i8** @_execptr
...
"$have_gas_121":                                  ; preds = %"$out_of_gas_120", %"$have_gas_116"
  ...
  %"$msgobj_123_salloc_load" = load i8*, i8** @_execptr
...
"$have_gas_169":                                  ; preds = %"$out_of_gas_168", %"$have_gas_155"
  ...
  %"$msgs_172" = load %TName_List_Message*, %TName_List_Message** %msgs
...
entry:
  ...
  %_amount = load %Uint128, %Uint128* %"$_amount_175"
...
entry:
  %_sender = load [20 x i8], [20 x i8]* %"$_sender_179"
...
"$have_gas_194":                                  ; preds = %"$out_of_gas_193", %"$have_gas_189"
  ...
  %"$msgobj_196_salloc_load" = load i8*, i8** @_execptr
...
"$have_gas_242":                                  ; preds = %"$out_of_gas_241", %"$have_gas_228"
  ...
  %"$execptr_load_244" = load i8*, i8** @_execptr
  %"$msgs_245" = load %TName_List_Message*, %TName_List_Message** %msgs
...
entry:
  ...
  %_amount = load %Uint128, %Uint128* %"$_amount_248"
