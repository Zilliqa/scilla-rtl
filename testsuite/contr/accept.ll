...
"$have_gas_81":                                   ; preds = %"$out_of_gas_80", %entry
  ...
  store { %TName_List_Message* (i8*, i8*)*, i8* } { %TName_List_Message* (i8*, i8*)* bitcast (%TName_List_Message* (%"$$fundef_2_env_52"*, i8*)* @"$fundef_2" to %TName_List_Message* (i8*, i8*)*), i8* null }, { %TName_List_Message* (i8*, i8*)*, i8* }* @accept.one_msg, align 8, !dbg !11
  ret void
}
...
define internal void @"$Accept1_86"(%Uint128 %_amount, [20 x i8]* %"$_sender_87") !dbg !13 {
entry:
...
"$have_gas_91":                                   ; preds = %"$out_of_gas_90", %entry
  ...
  call void @_accept(i8* %"$execptr_load_93"), !dbg !14
...
"$have_gas_97":                                   ; preds = %"$out_of_gas_96", %"$have_gas_91"
  ...
  call void @_accept(i8* %"$execptr_load_99"), !dbg !15
  ret void
}

declare void @_accept(i8*)

define void @Accept1(i8* %0) !dbg !16 {
entry:
  ...
  call void @"$Accept1_86"(%Uint128 %_amount, [20 x i8]* %"$_sender_104"), !dbg !17
  ret void
}

define internal void @"$Accept2_105"(%Uint128 %_amount, [20 x i8]* %"$_sender_106") !dbg !18 {
entry:
...
"$have_gas_110":                                  ; preds = %"$out_of_gas_109", %entry
  ...
  call void @_accept(i8* %"$execptr_load_112"), !dbg !19
...
"$have_gas_121":                                  ; preds = %"$out_of_gas_120", %"$have_gas_116"
  ...
  store i8* %"$msgobj_123", i8** %msg1, align 8, !dbg !20
...
"$have_gas_155":                                  ; preds = %"$out_of_gas_154", %"$have_gas_150"
  ...
  %"$accept.one_msg_call_161" = call %TName_List_Message* %"$accept.one_msg_fptr_158"(i8* %"$accept.one_msg_envptr_159", i8* %"$msg1_160"), !dbg !21
  store %TName_List_Message* %"$accept.one_msg_call_161", %TName_List_Message** %"$accept.one_msg_0", align 8, !dbg !21
  %"$$accept.one_msg_0_162" = load %TName_List_Message*, %TName_List_Message** %"$accept.one_msg_0", align 8
  store %TName_List_Message* %"$$accept.one_msg_0_162", %TName_List_Message** %msgs, align 8, !dbg !21
...
"$have_gas_169":                                  ; preds = %"$out_of_gas_168", %"$have_gas_155"
  ...
  call void @_send(i8* %"$execptr_load_171", %_TyDescrTy_Typ* @"$TyDescr_ADT_List_Message_38", %TName_List_Message* %"$msgs_172"), !dbg !22
  ret void
}
...
define void @Accept2(i8* %0) !dbg !23 {
entry:
  ...
  call void @"$Accept2_105"(%Uint128 %_amount, [20 x i8]* %"$_sender_177"), !dbg !24
  ret void
}

define internal void @"$Accept3_178"(%Uint128 %_amount, [20 x i8]* %"$_sender_179") !dbg !25 {
entry:
...
"$have_gas_183":                                  ; preds = %"$out_of_gas_182", %entry
  ...
  call void @_accept(i8* %"$execptr_load_185"), !dbg !26
...
"$have_gas_194":                                  ; preds = %"$out_of_gas_193", %"$have_gas_189"
  ...
  store i8* %"$msgobj_196", i8** %msg1, align 8, !dbg !27
...
"$have_gas_228":                                  ; preds = %"$out_of_gas_227", %"$have_gas_223"
  ...
  %"$accept.one_msg_call_234" = call %TName_List_Message* %"$accept.one_msg_fptr_231"(i8* %"$accept.one_msg_envptr_232", i8* %"$msg1_233"), !dbg !28
  store %TName_List_Message* %"$accept.one_msg_call_234", %TName_List_Message** %"$accept.one_msg_1", align 8, !dbg !28
  %"$$accept.one_msg_1_235" = load %TName_List_Message*, %TName_List_Message** %"$accept.one_msg_1", align 8
  store %TName_List_Message* %"$$accept.one_msg_1_235", %TName_List_Message** %msgs, align 8, !dbg !28
...
"$have_gas_242":                                  ; preds = %"$out_of_gas_241", %"$have_gas_228"
  ...
  call void @_send(i8* %"$execptr_load_244", %_TyDescrTy_Typ* @"$TyDescr_ADT_List_Message_38", %TName_List_Message* %"$msgs_245"), !dbg !29
  ret void
}

define void @Accept3(i8* %0) !dbg !30 {
entry:
  ...
  call void @"$Accept3_178"(%Uint128 %_amount, [20 x i8]* %"$_sender_250"), !dbg !31
  ret void
}
...
!11 = !DILocation(line: 7, column: 3, scope: !10)
...
!13 = distinct !DISubprogram(name: "Accept1", linkageName: "Accept1", scope: !2, file: !2, line: 13, type: !5, scopeLine: 13, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !1, retainedNodes: !3)
!14 = !DILocation(line: 14, column: 3, scope: !13)
!15 = !DILocation(line: 15, column: 3, scope: !13)
!16 = distinct !DISubprogram(name: "Accept1", linkageName: "Accept1", scope: !2, file: !2, line: 13, type: !5, scopeLine: 13, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !1, retainedNodes: !3)
!17 = !DILocation(line: 13, column: 12, scope: !16)
!18 = distinct !DISubprogram(name: "Accept2", linkageName: "Accept2", scope: !2, file: !2, line: 18, type: !5, scopeLine: 18, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !1, retainedNodes: !3)
!19 = !DILocation(line: 19, column: 3, scope: !18)
!20 = !DILocation(line: 20, column: 10, scope: !18)
!21 = !DILocation(line: 21, column: 10, scope: !18)
!22 = !DILocation(line: 22, column: 3, scope: !18)
!23 = distinct !DISubprogram(name: "Accept2", linkageName: "Accept2", scope: !2, file: !2, line: 18, type: !5, scopeLine: 18, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !1, retainedNodes: !3)
!24 = !DILocation(line: 18, column: 12, scope: !23)
!25 = distinct !DISubprogram(name: "Accept3", linkageName: "Accept3", scope: !2, file: !2, line: 25, type: !5, scopeLine: 25, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !1, retainedNodes: !3)
!26 = !DILocation(line: 26, column: 3, scope: !25)
!27 = !DILocation(line: 27, column: 10, scope: !25)
!28 = !DILocation(line: 28, column: 10, scope: !25)
!29 = !DILocation(line: 29, column: 3, scope: !25)
!30 = distinct !DISubprogram(name: "Accept3", linkageName: "Accept3", scope: !2, file: !2, line: 25, type: !5, scopeLine: 25, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !1, retainedNodes: !3)
!31 = !DILocation(line: 25, column: 12, scope: !30)
