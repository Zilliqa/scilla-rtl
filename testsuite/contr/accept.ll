...
@"$tparams_Accept1_271" = unnamed_addr constant [3 x %"$ParamDescr_264"] [%"$ParamDescr_264" { %ParamDescrString { i8* getelementptr inbounds ([7 x i8], [7 x i8]* @"$tpname__amount_268", i32 0, i32 0), i32 7 }, %_TyDescrTy_Typ* @"$TyDescr_Uint128_16" }, %"$ParamDescr_264" { %ParamDescrString { i8* getelementptr inbounds ([7 x i8], [7 x i8]* @"$tpname__origin_269", i32 0, i32 0), i32 7 }, %_TyDescrTy_Typ* @"$TyDescr_Addr_42" }, %"$ParamDescr_264" { %ParamDescrString { i8* getelementptr inbounds ([7 x i8], [7 x i8]* @"$tpname__sender_270", i32 0, i32 0), i32 7 }, %_TyDescrTy_Typ* @"$TyDescr_Addr_42" }]
@"$tname_Accept1_272" = unnamed_addr constant [7 x i8] c"Accept1"
...
@"$tparams_Accept2_276" = unnamed_addr constant [3 x %"$ParamDescr_264"] [%"$ParamDescr_264" { %ParamDescrString { i8* getelementptr inbounds ([7 x i8], [7 x i8]* @"$tpname__amount_273", i32 0, i32 0), i32 7 }, %_TyDescrTy_Typ* @"$TyDescr_Uint128_16" }, %"$ParamDescr_264" { %ParamDescrString { i8* getelementptr inbounds ([7 x i8], [7 x i8]* @"$tpname__origin_274", i32 0, i32 0), i32 7 }, %_TyDescrTy_Typ* @"$TyDescr_Addr_42" }, %"$ParamDescr_264" { %ParamDescrString { i8* getelementptr inbounds ([7 x i8], [7 x i8]* @"$tpname__sender_275", i32 0, i32 0), i32 7 }, %_TyDescrTy_Typ* @"$TyDescr_Addr_42" }]
@"$tname_Accept2_277" = unnamed_addr constant [7 x i8] c"Accept2"
...
@"$tparams_Accept3_281" = unnamed_addr constant [3 x %"$ParamDescr_264"] [%"$ParamDescr_264" { %ParamDescrString { i8* getelementptr inbounds ([7 x i8], [7 x i8]* @"$tpname__amount_278", i32 0, i32 0), i32 7 }, %_TyDescrTy_Typ* @"$TyDescr_Uint128_16" }, %"$ParamDescr_264" { %ParamDescrString { i8* getelementptr inbounds ([7 x i8], [7 x i8]* @"$tpname__origin_279", i32 0, i32 0), i32 7 }, %_TyDescrTy_Typ* @"$TyDescr_Addr_42" }, %"$ParamDescr_264" { %ParamDescrString { i8* getelementptr inbounds ([7 x i8], [7 x i8]* @"$tpname__sender_280", i32 0, i32 0), i32 7 }, %_TyDescrTy_Typ* @"$TyDescr_Addr_42" }]
@"$tname_Accept3_282" = unnamed_addr constant [7 x i8] c"Accept3"
@_transition_parameters = constant [3 x %"$TransDescr_265"] [%"$TransDescr_265" { %ParamDescrString { i8* getelementptr inbounds ([7 x i8], [7 x i8]* @"$tname_Accept1_272", i32 0, i32 0), i32 7 }, i32 3, %"$ParamDescr_264"* getelementptr inbounds ([3 x %"$ParamDescr_264"], [3 x %"$ParamDescr_264"]* @"$tparams_Accept1_271", i32 0, i32 0) }, %"$TransDescr_265" { %ParamDescrString { i8* getelementptr inbounds ([7 x i8], [7 x i8]* @"$tname_Accept2_277", i32 0, i32 0), i32 7 }, i32 3, %"$ParamDescr_264"* getelementptr inbounds ([3 x %"$ParamDescr_264"], [3 x %"$ParamDescr_264"]* @"$tparams_Accept2_276", i32 0, i32 0) }, %"$TransDescr_265" { %ParamDescrString { i8* getelementptr inbounds ([7 x i8], [7 x i8]* @"$tname_Accept3_282", i32 0, i32 0), i32 7 }, i32 3, %"$ParamDescr_264"* getelementptr inbounds ([3 x %"$ParamDescr_264"], [3 x %"$ParamDescr_264"]* @"$tparams_Accept3_281", i32 0, i32 0) }]
...
define internal void @"$Accept1_90"(%Uint128 %_amount, [20 x i8]* %"$_origin_91", [20 x i8]* %"$_sender_92") {
entry:
...
"$have_gas_96":                                   ; preds = %"$out_of_gas_95", %entry
  ...
  call void @_accept(i8* %"$execptr_load_98")
...
"$have_gas_102":                                  ; preds = %"$out_of_gas_101", %"$have_gas_96"
  ...
  call void @_accept(i8* %"$execptr_load_104")
  ret void
}
...
entry:
  ...
  call void @"$Accept1_90"(%Uint128 %_amount, [20 x i8]* %"$_origin_109", [20 x i8]* %"$_sender_111")
  ret void
}

define internal void @"$Accept2_112"(%Uint128 %_amount, [20 x i8]* %"$_origin_113", [20 x i8]* %"$_sender_114") {
entry:
...
"$have_gas_118":                                  ; preds = %"$out_of_gas_117", %entry
  ...
  call void @_accept(i8* %"$execptr_load_120")
...
"$have_gas_129":                                  ; preds = %"$out_of_gas_128", %"$have_gas_124"
  ...
  store i8* %"$msgobj_131", i8** %msg1, align 8
...
"$have_gas_163":                                  ; preds = %"$out_of_gas_162", %"$have_gas_158"
  ...
  %"$accept.one_msg_call_169" = call %TName_List_Message* %"$accept.one_msg_fptr_166"(i8* %"$accept.one_msg_envptr_167", i8* %"$msg1_168")
  store %TName_List_Message* %"$accept.one_msg_call_169", %TName_List_Message** %"$accept.one_msg_0", align 8
  %"$$accept.one_msg_0_170" = load %TName_List_Message*, %TName_List_Message** %"$accept.one_msg_0", align 8
  store %TName_List_Message* %"$$accept.one_msg_0_170", %TName_List_Message** %msgs, align 8
...
"$have_gas_177":                                  ; preds = %"$out_of_gas_176", %"$have_gas_163"
  ...
  call void @_send(i8* %"$execptr_load_179", %_TyDescrTy_Typ* @"$TyDescr_ADT_List_Message_38", %TName_List_Message* %"$msgs_180")
  ret void
}
...
entry:
  ...
  call void @"$Accept2_112"(%Uint128 %_amount, [20 x i8]* %"$_origin_185", [20 x i8]* %"$_sender_187")
  ret void
}

define internal void @"$Accept3_188"(%Uint128 %_amount, [20 x i8]* %"$_origin_189", [20 x i8]* %"$_sender_190") {
entry:
...
"$have_gas_205":                                  ; preds = %"$out_of_gas_204", %"$have_gas_200"
  ...
  store i8* %"$msgobj_207", i8** %msg1, align 8
...
"$have_gas_239":                                  ; preds = %"$out_of_gas_238", %"$have_gas_234"
  ...
  %"$accept.one_msg_call_245" = call %TName_List_Message* %"$accept.one_msg_fptr_242"(i8* %"$accept.one_msg_envptr_243", i8* %"$msg1_244")
  store %TName_List_Message* %"$accept.one_msg_call_245", %TName_List_Message** %"$accept.one_msg_1", align 8
  %"$$accept.one_msg_1_246" = load %TName_List_Message*, %TName_List_Message** %"$accept.one_msg_1", align 8
  store %TName_List_Message* %"$$accept.one_msg_1_246", %TName_List_Message** %msgs, align 8
...
"$have_gas_253":                                  ; preds = %"$out_of_gas_252", %"$have_gas_239"
  ...
  call void @_send(i8* %"$execptr_load_255", %_TyDescrTy_Typ* @"$TyDescr_ADT_List_Message_38", %TName_List_Message* %"$msgs_256")
  ret void
}
...
entry:
  ...
  call void @"$Accept3_188"(%Uint128 %_amount, [20 x i8]* %"$_origin_261", [20 x i8]* %"$_sender_263")
  ret void
}
