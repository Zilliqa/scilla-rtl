...
define internal void @"$Accept1_96"(%Uint128 %_amount, [20 x i8]* %"$_origin_97", [20 x i8]* %"$_sender_98") {
entry:
...
"$have_gas_108":                                  ; preds = %"$out_of_gas_107", %"$have_gas_102"
  ...
  call void @_accept(i8* %"$execptr_load_110")
  ret void
}
...
entry:
  ...
  call void @"$Accept1_96"(%Uint128 %_amount, [20 x i8]* %"$_origin_115", [20 x i8]* %"$_sender_117")
  ret void
}

define internal void @"$Accept2_118"(%Uint128 %_amount, [20 x i8]* %"$_origin_119", [20 x i8]* %"$_sender_120") {
entry:
...
"$have_gas_124":                                  ; preds = %"$out_of_gas_123", %entry
  ...
  call void @_accept(i8* %"$execptr_load_126")
...
"$have_gas_135":                                  ; preds = %"$out_of_gas_134", %"$have_gas_130"
  ...
  store i8* %"$msgobj_137", i8** %msg1, align 8
...
"$have_gas_169":                                  ; preds = %"$out_of_gas_168", %"$have_gas_164"
  ...
  %"$accept.one_msg_call_175" = call %TName_List_Message* %"$accept.one_msg_fptr_172"(i8* %"$accept.one_msg_envptr_173", i8* %"$msg1_174")
  store %TName_List_Message* %"$accept.one_msg_call_175", %TName_List_Message** %"$accept.one_msg_1", align 8
  %"$$accept.one_msg_1_176" = load %TName_List_Message*, %TName_List_Message** %"$accept.one_msg_1", align 8
  store %TName_List_Message* %"$$accept.one_msg_1_176", %TName_List_Message** %msgs, align 8
...
"$have_gas_183":                                  ; preds = %"$out_of_gas_182", %"$have_gas_169"
  ...
  call void @_send(i8* %"$execptr_load_185", %_TyDescrTy_Typ* @"$TyDescr_ADT_List_Message_39", %TName_List_Message* %"$msgs_186")
  ret void
}
...
entry:
  ...
  call void @"$Accept2_118"(%Uint128 %_amount, [20 x i8]* %"$_origin_191", [20 x i8]* %"$_sender_193")
  ret void
}

define internal void @"$Accept3_194"(%Uint128 %_amount, [20 x i8]* %"$_origin_195", [20 x i8]* %"$_sender_196") {
entry:
...
"$have_gas_211":                                  ; preds = %"$out_of_gas_210", %"$have_gas_206"
  ...
  store i8* %"$msgobj_213", i8** %msg1, align 8
...
"$have_gas_245":                                  ; preds = %"$out_of_gas_244", %"$have_gas_240"
  ...
  %"$accept.one_msg_call_251" = call %TName_List_Message* %"$accept.one_msg_fptr_248"(i8* %"$accept.one_msg_envptr_249", i8* %"$msg1_250")
  store %TName_List_Message* %"$accept.one_msg_call_251", %TName_List_Message** %"$accept.one_msg_2", align 8
  %"$$accept.one_msg_2_252" = load %TName_List_Message*, %TName_List_Message** %"$accept.one_msg_2", align 8
  store %TName_List_Message* %"$$accept.one_msg_2_252", %TName_List_Message** %msgs, align 8
...
"$have_gas_259":                                  ; preds = %"$out_of_gas_258", %"$have_gas_245"
  ...
  call void @_send(i8* %"$execptr_load_261", %_TyDescrTy_Typ* @"$TyDescr_ADT_List_Message_39", %TName_List_Message* %"$msgs_262")
  ret void
}
...
entry:
  ...
  call void @"$Accept3_194"(%Uint128 %_amount, [20 x i8]* %"$_origin_267", [20 x i8]* %"$_sender_269")
  ret void
}
