...
define internal %TName_List_Message* @"$fundef_3"(%"$$fundef_3_env_94"* %0, i8* %1) {
entry:
...
"$have_gas_111":                                  ; preds = %"$out_of_gas_110", %"$have_gas_103"
  ...
  store %TName_List_Message* %"$adtptr_118", %TName_List_Message** %"$retval_4", align 8
...
"$have_gas_133":                                  ; preds = %"$out_of_gas_132", %"$have_gas_128"
  ...
  store { %TName_List_Message* (i8*, i8*)*, i8* } { %TName_List_Message* (i8*, i8*)* bitcast (%TName_List_Message* (%"$$fundef_3_env_94"*, i8*)* @"$fundef_3" to %TName_List_Message* (i8*, i8*)*), i8* null }, { %TName_List_Message* (i8*, i8*)*, i8* }* @helloWorld.one_msg, align 8
...
"$have_gas_151":                                  ; preds = %"$out_of_gas_150", %"$have_gas_146"
  ...
  store %String { i8* getelementptr inbounds ([8 x i8], [8 x i8]* @"$stringlit_153", i32 0, i32 0), i32 8 }, %String* @helloWorld.smsg, align 8
  ret void
}
...
"$have_gas_162":                                  ; preds = %"$out_of_gas_161", %"$have_gas_157"
  ...
  store %String %"$name_164", %String* %"$welcome_msg_5", align 8
  ...
  call void @_update_field(i8* %"$execptr_load_165", i8* getelementptr inbounds ([12 x i8], [12 x i8]* @"$welcome_msg_166", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_String_25", i32 0, i8* null, i8* %"$update_value_169")
...
"$have_gas_173":                                  ; preds = %"$out_of_gas_172", %"$have_gas_162"
  ...
  store %String %"$helloWorld.smsg_175", %String* %"$sendoff_msg_6", align 8
  ...
  call void @_update_field(i8* %"$execptr_load_176", i8* getelementptr inbounds ([12 x i8], [12 x i8]* @"$sendoff_msg_177", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_String_25", i32 0, i8* null, i8* %"$update_value_180")
  ret void
}

declare void @_update_field(i8*, i8*, %_TyDescrTy_Typ*, i32, i8*, i8*)

define internal void @"$setHello_181"(%Uint128 %_amount, [20 x i8]* %"$_origin_182", [20 x i8]* %"$_sender_183", %String %msg) {
entry:
...
"$have_gas_192":                                  ; preds = %"$out_of_gas_191", %"$have_gas_187"
  ...
  %"$eq_call_200" = call %TName_Bool* @_eq_ByStrX(i8* %"$execptr_load_194", i32 20, i8* %"$$eq_owner_195_197", i8* %"$$eq__sender_198_199")
  store %TName_Bool* %"$eq_call_200", %TName_Bool** %is_owner, align 8
...
"$have_gas_222":                                  ; preds = %"$out_of_gas_221", %"$have_gas_217"
  ...
  store i8* %"$msgobj_224", i8** %e, align 8
...
"$have_gas_248":                                  ; preds = %"$out_of_gas_247", %"$have_gas_222"
  ...
  call void @_event(i8* %"$execptr_load_250", %_TyDescrTy_Typ* @"$TyDescr_Event_31", i8* %"$e_251")
...
"$have_gas_260":                                  ; preds = %"$out_of_gas_259", %"$True_252"
  ...
  call void @_update_field(i8* %"$execptr_load_262", i8* getelementptr inbounds ([12 x i8], [12 x i8]* @"$welcome_msg_263", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_String_25", i32 0, i8* null, i8* %"$update_value_265")
...
"$have_gas_274":                                  ; preds = %"$out_of_gas_273", %"$have_gas_269"
  ...
  store i8* %"$msgobj_276", i8** %e1, align 8
...
"$have_gas_300":                                  ; preds = %"$out_of_gas_299", %"$have_gas_274"
  ...
  call void @_event(i8* %"$execptr_load_302", %_TyDescrTy_Typ* @"$TyDescr_Event_31", i8* %"$e_303")
  br label %"$matchsucc_207"
...
entry:
  ...
  call void @"$setHello_181"(%Uint128 %_amount, [20 x i8]* %"$_origin_308", [20 x i8]* %"$_sender_310", %String %msg)
  ret void
}

define internal void @"$getHello_313"(%Uint128 %_amount, [20 x i8]* %"$_origin_314", [20 x i8]* %"$_sender_315") {
entry:
  ...
  %"$r_call_318" = call i8* @_fetch_field(i8* %"$execptr_load_317", i8* getelementptr inbounds ([12 x i8], [12 x i8]* @"$welcome_msg_316", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_String_25", i32 0, i8* null, i32 1)
...
"$have_gas_339":                                  ; preds = %"$out_of_gas_338", %"$have_gas_334"
  ...
  store i8* %"$msgobj_341", i8** %e, align 8
...
"$have_gas_365":                                  ; preds = %"$out_of_gas_364", %"$have_gas_339"
  ...
  call void @_event(i8* %"$execptr_load_367", %_TyDescrTy_Typ* @"$TyDescr_Event_31", i8* %"$e_368")
  ret void
}
...
entry:
  ...
  call void @"$getHello_313"(%Uint128 %_amount, [20 x i8]* %"$_origin_373", [20 x i8]* %"$_sender_375")
  ret void
}

define internal void @"$multipleMsgs_376"(%Uint128 %_amount, [20 x i8]* %"$_origin_377", [20 x i8]* %"$_sender_378") {
entry:
...
"$have_gas_387":                                  ; preds = %"$out_of_gas_386", %"$have_gas_382"
  ...
  store i8* %"$msgobj_389", i8** %msg1, align 8
...
"$have_gas_421":                                  ; preds = %"$out_of_gas_420", %"$have_gas_416"
  ...
  store i8* %"$msgobj_423", i8** %msg2, align 8
...
"$have_gas_455":                                  ; preds = %"$out_of_gas_454", %"$have_gas_450"
  ...
  %"$helloWorld.one_msg_call_461" = call %TName_List_Message* %"$helloWorld.one_msg_fptr_458"(i8* %"$helloWorld.one_msg_envptr_459", i8* %"$msg1_460")
  store %TName_List_Message* %"$helloWorld.one_msg_call_461", %TName_List_Message** %"$helloWorld.one_msg_2", align 8
  %"$$helloWorld.one_msg_2_462" = load %TName_List_Message*, %TName_List_Message** %"$helloWorld.one_msg_2", align 8
  store %TName_List_Message* %"$$helloWorld.one_msg_2_462", %TName_List_Message** %msgs1, align 8
...
"$have_gas_471":                                  ; preds = %"$out_of_gas_470", %"$have_gas_466"
  ...
  store %TName_List_Message* %"$adtptr_479", %TName_List_Message** %msgs2, align 8
...
"$have_gas_486":                                  ; preds = %"$out_of_gas_485", %"$have_gas_471"
  ...
  call void @_send(i8* %"$execptr_load_488", %_TyDescrTy_Typ* @"$TyDescr_ADT_List_Message_46", %TName_List_Message* %"$msgs2_489")
  ret void
}
...
entry:
  ...
  call void @"$multipleMsgs_376"(%Uint128 %_amount, [20 x i8]* %"$_origin_494", [20 x i8]* %"$_sender_496")
  ret void
}

define internal void @"$contrAddr_497"(%Uint128 %_amount, [20 x i8]* %"$_origin_498", [20 x i8]* %"$_sender_499") {
entry:
...
"$have_gas_508":                                  ; preds = %"$out_of_gas_507", %"$have_gas_503"
  ...
  store i8* %"$msgobj_510", i8** %msg1, align 8
...
"$have_gas_534":                                  ; preds = %"$out_of_gas_533", %"$have_gas_508"
  ...
  call void @_event(i8* %"$execptr_load_536", %_TyDescrTy_Typ* @"$TyDescr_Event_31", i8* %"$msg1_537")
  ret void
}
...
entry:
  ...
  call void @"$contrAddr_497"(%Uint128 %_amount, [20 x i8]* %"$_origin_542", [20 x i8]* %"$_sender_544")
  ret void
}

define internal void @"$printContrParams_545"(%Uint128 %_amount, [20 x i8]* %"$_origin_546", [20 x i8]* %"$_sender_547") {
entry:
...
"$have_gas_556":                                  ; preds = %"$out_of_gas_555", %"$have_gas_551"
  ...
  store i8* %"$msgobj_558", i8** %e, align 8
...
"$have_gas_630":                                  ; preds = %"$out_of_gas_629", %"$have_gas_556"
  ...
  call void @_event(i8* %"$execptr_load_632", %_TyDescrTy_Typ* @"$TyDescr_Event_31", i8* %"$e_633")
  ret void
}
...
entry:
  ...
  call void @"$printContrParams_545"(%Uint128 %_amount, [20 x i8]* %"$_origin_638", [20 x i8]* %"$_sender_640")
  ret void
}
