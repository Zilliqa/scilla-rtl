...
"$have_gas_173":                                  ; preds = %"$out_of_gas_172", %"$have_gas_168"
  ...
  %"$eq_call_181" = call %TName_Bool* @_eq_ByStrX(i8* %"$execptr_load_175", i32 20, i8* %"$$eq_owner_176_178", i8* %"$$eq__sender_179_180")
  store %TName_Bool* %"$eq_call_181", %TName_Bool** %is_owner, align 8
...
"$have_gas_203":                                  ; preds = %"$out_of_gas_202", %"$have_gas_198"
  ...
  store i8* %"$msgobj_205", i8** %e, align 8
...
"$have_gas_229":                                  ; preds = %"$out_of_gas_228", %"$have_gas_203"
  ...
  call void @_event(i8* %"$execptr_load_231", %_TyDescrTy_Typ* @"$TyDescr_Event_29", i8* %"$e_232")
...
"$have_gas_241":                                  ; preds = %"$out_of_gas_240", %"$True_233"
  ...
  call void @_update_field(i8* %"$execptr_load_243", i8* getelementptr inbounds ([12 x i8], [12 x i8]* @"$welcome_msg_244", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_String_23", i32 0, i8* null, i8* %"$update_value_246")
...
"$have_gas_255":                                  ; preds = %"$out_of_gas_254", %"$have_gas_250"
  ...
  store i8* %"$msgobj_257", i8** %e1, align 8
...
"$have_gas_281":                                  ; preds = %"$out_of_gas_280", %"$have_gas_255"
  ...
  call void @_event(i8* %"$execptr_load_283", %_TyDescrTy_Typ* @"$TyDescr_Event_29", i8* %"$e_284")
  br label %"$matchsucc_188"
...
entry:
  ...
  call void @"$setHello_162"(%Uint128 %_amount, [20 x i8]* %"$_origin_289", [20 x i8]* %"$_sender_291", %String %msg)
  ret void
}

define internal void @"$getHello_294"(%Uint128 %_amount, [20 x i8]* %"$_origin_295", [20 x i8]* %"$_sender_296") {
entry:
  ...
  %"$r_call_299" = call i8* @_fetch_field(i8* %"$execptr_load_298", i8* getelementptr inbounds ([12 x i8], [12 x i8]* @"$welcome_msg_297", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_String_23", i32 0, i8* null, i32 1)
...
"$have_gas_320":                                  ; preds = %"$out_of_gas_319", %"$have_gas_315"
  ...
  store i8* %"$msgobj_322", i8** %e, align 8
...
"$have_gas_346":                                  ; preds = %"$out_of_gas_345", %"$have_gas_320"
  ...
  call void @_event(i8* %"$execptr_load_348", %_TyDescrTy_Typ* @"$TyDescr_Event_29", i8* %"$e_349")
  ret void
}
...
entry:
  ...
  call void @"$getHello_294"(%Uint128 %_amount, [20 x i8]* %"$_origin_354", [20 x i8]* %"$_sender_356")
  ret void
}

define internal void @"$multipleMsgs_357"(%Uint128 %_amount, [20 x i8]* %"$_origin_358", [20 x i8]* %"$_sender_359") {
entry:
...
"$have_gas_368":                                  ; preds = %"$out_of_gas_367", %"$have_gas_363"
  ...
  store i8* %"$msgobj_370", i8** %msg1, align 8
...
"$have_gas_402":                                  ; preds = %"$out_of_gas_401", %"$have_gas_397"
  ...
  store i8* %"$msgobj_404", i8** %msg2, align 8
...
"$have_gas_436":                                  ; preds = %"$out_of_gas_435", %"$have_gas_431"
  ...
  %"$helloWorld.one_msg_call_442" = call %TName_List_Message* %"$helloWorld.one_msg_fptr_439"(i8* %"$helloWorld.one_msg_envptr_440", i8* %"$msg1_441")
  store %TName_List_Message* %"$helloWorld.one_msg_call_442", %TName_List_Message** %"$helloWorld.one_msg_0", align 8
  %"$$helloWorld.one_msg_0_443" = load %TName_List_Message*, %TName_List_Message** %"$helloWorld.one_msg_0", align 8
  store %TName_List_Message* %"$$helloWorld.one_msg_0_443", %TName_List_Message** %msgs1, align 8
...
"$have_gas_452":                                  ; preds = %"$out_of_gas_451", %"$have_gas_447"
  ...
  store %TName_List_Message* %"$adtptr_460", %TName_List_Message** %msgs2, align 8
...
"$have_gas_467":                                  ; preds = %"$out_of_gas_466", %"$have_gas_452"
  ...
  call void @_send(i8* %"$execptr_load_469", %_TyDescrTy_Typ* @"$TyDescr_ADT_List_Message_42", %TName_List_Message* %"$msgs2_470")
  ret void
}
...
entry:
  ...
  call void @"$multipleMsgs_357"(%Uint128 %_amount, [20 x i8]* %"$_origin_475", [20 x i8]* %"$_sender_477")
  ret void
}

define internal void @"$contrAddr_478"(%Uint128 %_amount, [20 x i8]* %"$_origin_479", [20 x i8]* %"$_sender_480") {
entry:
...
"$have_gas_489":                                  ; preds = %"$out_of_gas_488", %"$have_gas_484"
  ...
  store i8* %"$msgobj_491", i8** %msg1, align 8
...
"$have_gas_515":                                  ; preds = %"$out_of_gas_514", %"$have_gas_489"
  ...
  call void @_event(i8* %"$execptr_load_517", %_TyDescrTy_Typ* @"$TyDescr_Event_29", i8* %"$msg1_518")
  ret void
}
...
entry:
  ...
  call void @"$contrAddr_478"(%Uint128 %_amount, [20 x i8]* %"$_origin_523", [20 x i8]* %"$_sender_525")
  ret void
}

define internal void @"$printContrParams_526"(%Uint128 %_amount, [20 x i8]* %"$_origin_527", [20 x i8]* %"$_sender_528") {
entry:
...
"$have_gas_537":                                  ; preds = %"$out_of_gas_536", %"$have_gas_532"
  ...
  store i8* %"$msgobj_539", i8** %e, align 8
...
"$have_gas_611":                                  ; preds = %"$out_of_gas_610", %"$have_gas_537"
  ...
  call void @_event(i8* %"$execptr_load_613", %_TyDescrTy_Typ* @"$TyDescr_Event_29", i8* %"$e_614")
  ret void
}
...
entry:
  ...
  call void @"$printContrParams_526"(%Uint128 %_amount, [20 x i8]* %"$_origin_619", [20 x i8]* %"$_sender_621")
  ret void
}
