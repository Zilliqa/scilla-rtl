...
"$have_gas_71":                                   ; preds = %"$out_of_gas_70", %"$have_gas_66"
  ...
  call void @_update_field(i8* %"$execptr_load_73", i8* getelementptr inbounds ([2 x i8], [2 x i8]* @"$x_74", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Int32_6", i32 0, i8* null, i8* %"$update_value_77")
  ret void
}
...
define internal void @"$t1_118"(%Uint128 %_amount, [20 x i8]* %"$_origin_119", [20 x i8]* %"$_sender_120", %TName_Bool* %c) {
entry:
  ...
  %"$$x_1_call_123" = call i8* @_fetch_field(i8* %"$execptr_load_122", i8* getelementptr inbounds ([2 x i8], [2 x i8]* @"$x_121", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Int32_6", i32 0, i8* null, i32 1)
...
"$have_gas_154":                                  ; preds = %"$out_of_gas_153", %"$have_gas_149"
  ...
  store %Int32 %"$$x_2_156", %Int32* %y, align 4
...
"$have_gas_165":                                  ; preds = %"$out_of_gas_164", %"$have_gas_160"
  ...
  %"$add_call_169" = call %Int32 @_add_Int32(%Int32 %"$$x_1_167", %Int32 %"$y_168")
  store %Int32 %"$add_call_169", %Int32* %z, align 4
...
"$have_gas_173":                                  ; preds = %"$out_of_gas_172", %"$have_gas_165"
  ...
  call void @"$create_event_78"(%Uint128 %_amount, [20 x i8]* %"$create_event__origin_175", [20 x i8]* %"$create_event__sender_176", %Int32 %"$z_177")
  ret void
}
...
entry:
  ...
  call void @"$t1_118"(%Uint128 %_amount, [20 x i8]* %"$_origin_182", [20 x i8]* %"$_sender_184", %TName_Bool* %c)
  ret void
}
