...
define internal void @"$create_event_50"(%Uint128 %_amount, [20 x i8]* %"$_sender_51", %Int32 %m) !dbg !9 {
entry:
...
"$have_gas_60":                                   ; preds = %"$out_of_gas_59", %"$have_gas_55"
  ...
  store i8* %"$msgobj_62", i8** %e, align 8, !dbg !10
...
"$have_gas_85":                                   ; preds = %"$out_of_gas_84", %"$have_gas_60"
  ...
  call void @_event(i8* %"$execptr_load_87", %_TyDescrTy_Typ* @"$TyDescr_Event_26", i8* %"$e_88"), !dbg !11
  ret void
}
...
define internal void @"$t1_89"(%Uint128 %_amount, [20 x i8]* %"$_sender_90", %TName_Bool* %c) !dbg !12 {
entry:
...
"$have_gas_110":                                  ; preds = %"$out_of_gas_109", %"$True_105"
  ...
  store %Int32 { i32 11 }, %Int32* %x, align 4, !dbg !14
...
"$have_gas_117":                                  ; preds = %"$out_of_gas_116", %"$False_112"
  ...
  store %Int32 { i32 41 }, %Int32* %x, align 4, !dbg !17
  br label %"$matchsucc_101"
...
"$have_gas_122":                                  ; preds = %"$out_of_gas_121", %"$matchsucc_101"
  ...
  call void @"$create_event_50"(%Uint128 %_amount, [20 x i8]* %"$create_event__sender_124", %Int32 %"$x_125"), !dbg !19
...
"$have_gas_134":                                  ; preds = %"$out_of_gas_133", %"$have_gas_129"
  ...
  store %Int32 { i32 31 }, %Int32* %y, align 4, !dbg !20
...
"$have_gas_155":                                  ; preds = %"$out_of_gas_154", %"$have_gas_150"
  ...
  store %Int32 { i32 101 }, %Int32* %"$y_0", align 4, !dbg !22
...
"$have_gas_160":                                  ; preds = %"$out_of_gas_159", %"$have_gas_155"
  ...
  call void @"$create_event_50"(%Uint128 %_amount, [20 x i8]* %"$create_event__sender_162", %Int32 %"$$y_0_163"), !dbg !25
...
"$have_gas_174":                                  ; preds = %"$out_of_gas_173", %"$have_gas_169"
  ...
  store %Int32 { i32 102 }, %Int32* %"$y_1", align 4, !dbg !26
...
"$have_gas_179":                                  ; preds = %"$out_of_gas_178", %"$have_gas_174"
  ...
  call void @"$create_event_50"(%Uint128 %_amount, [20 x i8]* %"$create_event__sender_181", %Int32 %"$$y_1_182"), !dbg !28
  br label %"$matchsucc_141"
...
"$have_gas_186":                                  ; preds = %"$out_of_gas_185", %"$matchsucc_141"
  ...
  call void @"$create_event_50"(%Uint128 %_amount, [20 x i8]* %"$create_event__sender_188", %Int32 %"$y_189"), !dbg !29
  ret void
}
...
entry:
  ...
  call void @"$t1_89"(%Uint128 %_amount, [20 x i8]* %"$_sender_194", %TName_Bool* %c), !dbg !31
  ret void
}
...
!14 = !DILocation(line: 14, column: 9, scope: !15)
!15 = distinct !DILexicalBlock(scope: !16, file: !2, line: 13, column: 9)
!16 = distinct !DILexicalBlock(scope: !12, file: !2, line: 12, column: 7)
!17 = !DILocation(line: 16, column: 9, scope: !18)
!18 = distinct !DILexicalBlock(scope: !16, file: !2, line: 15, column: 9)
!19 = !DILocation(line: 18, column: 3, scope: !12)
!20 = !DILocation(line: 20, column: 7, scope: !12)
!21 = !DILocation(line: 21, column: 3, scope: !12)
!22 = !DILocation(line: 23, column: 9, scope: !23)
!23 = distinct !DILexicalBlock(scope: !24, file: !2, line: 22, column: 5)
!24 = distinct !DILexicalBlock(scope: !12, file: !2, line: 21, column: 3)
!25 = !DILocation(line: 24, column: 5, scope: !23)
!26 = !DILocation(line: 26, column: 9, scope: !27)
!27 = distinct !DILexicalBlock(scope: !24, file: !2, line: 25, column: 5)
!28 = !DILocation(line: 27, column: 5, scope: !27)
!29 = !DILocation(line: 30, column: 3, scope: !12)
!30 = distinct !DISubprogram(name: "t1", linkageName: "t1", scope: !2, file: !2, line: 10, type: !5, scopeLine: 10, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !1, retainedNodes: !3)
