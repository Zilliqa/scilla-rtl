...
"$have_gas_221":                                  ; preds = %"$out_of_gas_220", %"$have_gas_209"
  ...
  %"$put_call_231" = call i8* @_put(i8* %"$execptr_load_223", %_TyDescrTy_Typ* @"$TyDescr_Map_48", i8* %"$$empty_224_225", i8* %"$$put_initialAdmin_226_228", i8* %"$$ud-proxy.true_229_230"), !dbg !22
  %"$put_232" = bitcast i8* %"$put_call_231" to %Map_ByStr20_Bool*
  store %Map_ByStr20_Bool* %"$put_232", %Map_ByStr20_Bool** %"$admins_9", align 8, !dbg !22
  ...
  call void @_update_field(i8* %"$execptr_load_233", i8* getelementptr inbounds ([7 x i8], [7 x i8]* @"$admins_234", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_48", i32 0, i8* null, i8* %"$update_value_236"), !dbg !21
  ret void
}
...
define internal void @"$setAdmin_237"(%Uint128 %_amount, [20 x i8]* %"$_origin_238", [20 x i8]* %"$_sender_239", [20 x i8]* %"$address_240", %TName_Bool* %isApproved) !dbg !23 {
entry:
  ...
  %"$maybeAdmin_call_245" = call i8* @_fetch_field(i8* %"$execptr_load_244", i8* getelementptr inbounds ([7 x i8], [7 x i8]* @"$admins_243", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_48", i32 1, i8* %"$indices_buf_241", i32 1), !dbg !24
...
"$have_gas_279":                                  ; preds = %"$out_of_gas_278", %"$Some_272"
  ...
  store %TName_Bool* %"$approval_281", %TName_Bool** %isSenderAdmin, align 8, !dbg !26
...
"$have_gas_287":                                  ; preds = %"$out_of_gas_286", %"$None_282"
  ...
  store %TName_Bool* %"$adtptr_291", %TName_Bool** %isSenderAdmin, align 8, !dbg !29
  br label %"$matchsucc_267"
...
"$have_gas_310":                                  ; preds = %"$out_of_gas_309", %"$True_302"
  ...
  call void @_update_field(i8* %"$execptr_load_314", i8* getelementptr inbounds ([7 x i8], [7 x i8]* @"$admins_315", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_48", i32 1, i8* %"$indices_buf_312", i8* %"$update_value_316"), !dbg !32
...
"$have_gas_325":                                  ; preds = %"$out_of_gas_324", %"$have_gas_320"
  ...
  %"$ud-proxy.eAdminSet_call_331" = call { i8* (i8*, %TName_Bool*)*, i8* } %"$ud-proxy.eAdminSet_fptr_328"(i8* %"$ud-proxy.eAdminSet_envptr_329", [20 x i8]* %"$ud-proxy.eAdminSet_address_330"), !dbg !35
  store { i8* (i8*, %TName_Bool*)*, i8* } %"$ud-proxy.eAdminSet_call_331", { i8* (i8*, %TName_Bool*)*, i8* }* %"$ud-proxy.eAdminSet_0", align 8, !dbg !35
  ...
  %"$$ud-proxy.eAdminSet_0_call_335" = call i8* %"$$ud-proxy.eAdminSet_0_fptr_333"(i8* %"$$ud-proxy.eAdminSet_0_envptr_334", %TName_Bool* %isApproved), !dbg !35
  store i8* %"$$ud-proxy.eAdminSet_0_call_335", i8** %"$ud-proxy.eAdminSet_1", align 8, !dbg !35
  %"$$ud-proxy.eAdminSet_1_336" = load i8*, i8** %"$ud-proxy.eAdminSet_1", align 8
  store i8* %"$$ud-proxy.eAdminSet_1_336", i8** %e, align 8, !dbg !35
...
"$have_gas_343":                                  ; preds = %"$out_of_gas_342", %"$have_gas_325"
  ...
  call void @_event(i8* %"$execptr_load_345", %_TyDescrTy_Typ* @"$TyDescr_Event_34", i8* %"$e_346"), !dbg !36
...
"$have_gas_355":                                  ; preds = %"$out_of_gas_354", %"$False_347"
  ...
  call void @_event(i8* %"$execptr_load_357", %_TyDescrTy_Typ* @"$TyDescr_Event_34", i8* %"$ud-proxy.eError_358"), !dbg !37
  br label %"$matchsucc_297"
...
entry:
  ...
  call void @"$setAdmin_237"(%Uint128 %_amount, [20 x i8]* %"$_origin_363", [20 x i8]* %"$_sender_365", [20 x i8]* %"$address_367", %TName_Bool* %isApproved), !dbg !40
  ret void
}

define internal void @"$bestow_370"(%Uint128 %_amount, [20 x i8]* %"$_origin_371", [20 x i8]* %"$_sender_372", %String %label, [20 x i8]* %"$owner_373", [20 x i8]* %"$resolver_374") !dbg !41 {
entry:
  ...
  %"$maybeAdmin_call_379" = call i8* @_fetch_field(i8* %"$execptr_load_378", i8* getelementptr inbounds ([7 x i8], [7 x i8]* @"$admins_377", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_48", i32 1, i8* %"$indices_buf_375", i32 1), !dbg !42
...
"$have_gas_413":                                  ; preds = %"$out_of_gas_412", %"$Some_406"
  ...
  store %TName_Bool* %"$isAdmin_415", %TName_Bool** %isSenderAdmin, align 8, !dbg !44
...
"$have_gas_421":                                  ; preds = %"$out_of_gas_420", %"$None_416"
  ...
  store %TName_Bool* %"$adtptr_425", %TName_Bool** %isSenderAdmin, align 8, !dbg !47
  br label %"$matchsucc_401"
...
"$have_gas_502":                                  ; preds = %"$out_of_gas_501", %"$have_gas_451"
  ...
  %"$ud-proxy.oneMsg_call_508" = call %TName_List_Message* %"$ud-proxy.oneMsg_fptr_505"(i8* %"$ud-proxy.oneMsg_envptr_506", i8* %"$m_507"), !dbg !53
  store %TName_List_Message* %"$ud-proxy.oneMsg_call_508", %TName_List_Message** %"$ud-proxy.oneMsg_2", align 8, !dbg !53
  %"$$ud-proxy.oneMsg_2_509" = load %TName_List_Message*, %TName_List_Message** %"$ud-proxy.oneMsg_2", align 8
  store %TName_List_Message* %"$$ud-proxy.oneMsg_2_509", %TName_List_Message** %msgs, align 8, !dbg !53
...
"$have_gas_516":                                  ; preds = %"$out_of_gas_515", %"$have_gas_502"
  ...
  call void @_send(i8* %"$execptr_load_518", %_TyDescrTy_Typ* @"$TyDescr_ADT_List_Message_46", %TName_List_Message* %"$msgs_519"), !dbg !54
...
"$have_gas_528":                                  ; preds = %"$out_of_gas_527", %"$False_520"
  ...
  call void @_event(i8* %"$execptr_load_530", %_TyDescrTy_Typ* @"$TyDescr_Event_34", i8* %"$ud-proxy.eError_531"), !dbg !55
  br label %"$matchsucc_431"
...
entry:
  ...
  call void @"$bestow_370"(%Uint128 %_amount, [20 x i8]* %"$_origin_536", [20 x i8]* %"$_sender_538", %String %label, [20 x i8]* %"$owner_542", [20 x i8]* %"$resolver_544"), !dbg !58
  ret void
}
