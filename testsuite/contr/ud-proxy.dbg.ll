...
@"$pname__creation_block_540" = unnamed_addr constant [15 x i8] c"_creation_block"
@"$pname_initialAdmin_541" = unnamed_addr constant [12 x i8] c"initialAdmin"
@"$pname_registry_542" = unnamed_addr constant [8 x i8] c"registry"
@_contract_parameters = constant [5 x %"$ParamDescr_536"] [%"$ParamDescr_536" { %ParamDescrString { i8* getelementptr inbounds ([15 x i8], [15 x i8]* @"$pname__scilla_version_538", i32 0, i32 0), i32 15 }, %_TyDescrTy_Typ* @"$TyDescr_Uint32_14" }, %"$ParamDescr_536" { %ParamDescrString { i8* getelementptr inbounds ([13 x i8], [13 x i8]* @"$pname__this_address_539", i32 0, i32 0), i32 13 }, %_TyDescrTy_Typ* @"$TyDescr_Bystr20_40" }, %"$ParamDescr_536" { %ParamDescrString { i8* getelementptr inbounds ([15 x i8], [15 x i8]* @"$pname__creation_block_540", i32 0, i32 0), i32 15 }, %_TyDescrTy_Typ* @"$TyDescr_Bnum_30" }, %"$ParamDescr_536" { %ParamDescrString { i8* getelementptr inbounds ([12 x i8], [12 x i8]* @"$pname_initialAdmin_541", i32 0, i32 0), i32 12 }, %_TyDescrTy_Typ* @"$TyDescr_Bystr20_40" }, %"$ParamDescr_536" { %ParamDescrString { i8* getelementptr inbounds ([8 x i8], [8 x i8]* @"$pname_registry_542", i32 0, i32 0), i32 8 }, %_TyDescrTy_Typ* @"$TyDescr_Bystr20_40" }]
...
@"$tpname_address_546" = unnamed_addr constant [7 x i8] c"address"
@"$tpname_isApproved_547" = unnamed_addr constant [10 x i8] c"isApproved"
@"$tparams_setAdmin_548" = unnamed_addr constant [5 x %"$ParamDescr_536"] [%"$ParamDescr_536" { %ParamDescrString { i8* getelementptr inbounds ([7 x i8], [7 x i8]* @"$tpname__amount_543", i32 0, i32 0), i32 7 }, %_TyDescrTy_Typ* @"$TyDescr_Uint128_22" }, %"$ParamDescr_536" { %ParamDescrString { i8* getelementptr inbounds ([7 x i8], [7 x i8]* @"$tpname__origin_544", i32 0, i32 0), i32 7 }, %_TyDescrTy_Typ* @"$TyDescr_Addr_51" }, %"$ParamDescr_536" { %ParamDescrString { i8* getelementptr inbounds ([7 x i8], [7 x i8]* @"$tpname__sender_545", i32 0, i32 0), i32 7 }, %_TyDescrTy_Typ* @"$TyDescr_Addr_51" }, %"$ParamDescr_536" { %ParamDescrString { i8* getelementptr inbounds ([7 x i8], [7 x i8]* @"$tpname_address_546", i32 0, i32 0), i32 7 }, %_TyDescrTy_Typ* @"$TyDescr_Bystr20_40" }, %"$ParamDescr_536" { %ParamDescrString { i8* getelementptr inbounds ([10 x i8], [10 x i8]* @"$tpname_isApproved_547", i32 0, i32 0), i32 10 }, %_TyDescrTy_Typ* @"$TyDescr_ADT_Bool_45" }]
@"$tname_setAdmin_549" = unnamed_addr constant [8 x i8] c"setAdmin"
@"$tpname__amount_550" = unnamed_addr constant [7 x i8] c"_amount"
@"$tpname__origin_551" = unnamed_addr constant [7 x i8] c"_origin"
@"$tpname__sender_552" = unnamed_addr constant [7 x i8] c"_sender"
@"$tpname_label_553" = unnamed_addr constant [5 x i8] c"label"
@"$tpname_owner_554" = unnamed_addr constant [5 x i8] c"owner"
@"$tpname_resolver_555" = unnamed_addr constant [8 x i8] c"resolver"
@"$tparams_bestow_556" = unnamed_addr constant [6 x %"$ParamDescr_536"] [%"$ParamDescr_536" { %ParamDescrString { i8* getelementptr inbounds ([7 x i8], [7 x i8]* @"$tpname__amount_550", i32 0, i32 0), i32 7 }, %_TyDescrTy_Typ* @"$TyDescr_Uint128_22" }, %"$ParamDescr_536" { %ParamDescrString { i8* getelementptr inbounds ([7 x i8], [7 x i8]* @"$tpname__origin_551", i32 0, i32 0), i32 7 }, %_TyDescrTy_Typ* @"$TyDescr_Addr_51" }, %"$ParamDescr_536" { %ParamDescrString { i8* getelementptr inbounds ([7 x i8], [7 x i8]* @"$tpname__sender_552", i32 0, i32 0), i32 7 }, %_TyDescrTy_Typ* @"$TyDescr_Addr_51" }, %"$ParamDescr_536" { %ParamDescrString { i8* getelementptr inbounds ([5 x i8], [5 x i8]* @"$tpname_label_553", i32 0, i32 0), i32 5 }, %_TyDescrTy_Typ* @"$TyDescr_String_28" }, %"$ParamDescr_536" { %ParamDescrString { i8* getelementptr inbounds ([5 x i8], [5 x i8]* @"$tpname_owner_554", i32 0, i32 0), i32 5 }, %_TyDescrTy_Typ* @"$TyDescr_Bystr20_40" }, %"$ParamDescr_536" { %ParamDescrString { i8* getelementptr inbounds ([8 x i8], [8 x i8]* @"$tpname_resolver_555", i32 0, i32 0), i32 8 }, %_TyDescrTy_Typ* @"$TyDescr_Bystr20_40" }]
@"$tname_bestow_557" = unnamed_addr constant [6 x i8] c"bestow"
@_transition_parameters = constant [2 x %"$TransDescr_537"] [%"$TransDescr_537" { %ParamDescrString { i8* getelementptr inbounds ([8 x i8], [8 x i8]* @"$tname_setAdmin_549", i32 0, i32 0), i32 8 }, i32 5, %"$ParamDescr_536"* getelementptr inbounds ([5 x %"$ParamDescr_536"], [5 x %"$ParamDescr_536"]* @"$tparams_setAdmin_548", i32 0, i32 0) }, %"$TransDescr_537" { %ParamDescrString { i8* getelementptr inbounds ([6 x i8], [6 x i8]* @"$tname_bestow_557", i32 0, i32 0), i32 6 }, i32 6, %"$ParamDescr_536"* getelementptr inbounds ([6 x %"$ParamDescr_536"], [6 x %"$ParamDescr_536"]* @"$tparams_bestow_556", i32 0, i32 0) }]
...
"$have_gas_209":                                  ; preds = %"$out_of_gas_208", %"$have_gas_204"
  ...
  store %Map_ByStr20_Bool* %"$_new_empty_map_213", %Map_ByStr20_Bool** %empty, align 8, !dbg !21
...
define internal void @"$setAdmin_228"(%Uint128 %_amount, [20 x i8]* %"$_origin_229", [20 x i8]* %"$_sender_230", [20 x i8]* %"$address_231", %TName_Bool* %isApproved) !dbg !23 {
entry:
  ...
  %"$maybeAdmin_call_236" = call i8* @_fetch_field(i8* %"$execptr_load_235", i8* getelementptr inbounds ([7 x i8], [7 x i8]* @"$admins_234", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_48", i32 1, i8* %"$indices_buf_232", i32 1), !dbg !24
...
"$have_gas_270":                                  ; preds = %"$out_of_gas_269", %"$Some_263"
  ...
  store %TName_Bool* %"$approval_272", %TName_Bool** %isSenderAdmin, align 8, !dbg !26
...
"$have_gas_278":                                  ; preds = %"$out_of_gas_277", %"$None_273"
  ...
  store %TName_Bool* %"$adtptr_282", %TName_Bool** %isSenderAdmin, align 8, !dbg !29
  br label %"$matchsucc_258"
...
"$have_gas_301":                                  ; preds = %"$out_of_gas_300", %"$True_293"
  ...
  call void @_update_field(i8* %"$execptr_load_305", i8* getelementptr inbounds ([7 x i8], [7 x i8]* @"$admins_306", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_48", i32 1, i8* %"$indices_buf_303", i8* %"$update_value_307"), !dbg !32
...
"$have_gas_316":                                  ; preds = %"$out_of_gas_315", %"$have_gas_311"
  ...
  %"$ud-proxy.eAdminSet_call_322" = call { i8* (i8*, %TName_Bool*)*, i8* } %"$ud-proxy.eAdminSet_fptr_319"(i8* %"$ud-proxy.eAdminSet_envptr_320", [20 x i8]* %"$ud-proxy.eAdminSet_address_321"), !dbg !35
  store { i8* (i8*, %TName_Bool*)*, i8* } %"$ud-proxy.eAdminSet_call_322", { i8* (i8*, %TName_Bool*)*, i8* }* %"$ud-proxy.eAdminSet_0", align 8, !dbg !35
  ...
  %"$$ud-proxy.eAdminSet_0_call_326" = call i8* %"$$ud-proxy.eAdminSet_0_fptr_324"(i8* %"$$ud-proxy.eAdminSet_0_envptr_325", %TName_Bool* %isApproved), !dbg !35
  store i8* %"$$ud-proxy.eAdminSet_0_call_326", i8** %"$ud-proxy.eAdminSet_1", align 8, !dbg !35
  %"$$ud-proxy.eAdminSet_1_327" = load i8*, i8** %"$ud-proxy.eAdminSet_1", align 8
  store i8* %"$$ud-proxy.eAdminSet_1_327", i8** %e, align 8, !dbg !35
...
"$have_gas_334":                                  ; preds = %"$out_of_gas_333", %"$have_gas_316"
  ...
  call void @_event(i8* %"$execptr_load_336", %_TyDescrTy_Typ* @"$TyDescr_Event_34", i8* %"$e_337"), !dbg !36
...
"$have_gas_346":                                  ; preds = %"$out_of_gas_345", %"$False_338"
  ...
  call void @_event(i8* %"$execptr_load_348", %_TyDescrTy_Typ* @"$TyDescr_Event_34", i8* %"$ud-proxy.eError_349"), !dbg !37
  br label %"$matchsucc_288"
...
entry:
  ...
  call void @"$setAdmin_228"(%Uint128 %_amount, [20 x i8]* %"$_origin_354", [20 x i8]* %"$_sender_356", [20 x i8]* %"$address_358", %TName_Bool* %isApproved), !dbg !40
  ret void
}

define internal void @"$bestow_361"(%Uint128 %_amount, [20 x i8]* %"$_origin_362", [20 x i8]* %"$_sender_363", %String %label, [20 x i8]* %"$owner_364", [20 x i8]* %"$resolver_365") !dbg !41 {
entry:
  ...
  %"$maybeAdmin_call_370" = call i8* @_fetch_field(i8* %"$execptr_load_369", i8* getelementptr inbounds ([7 x i8], [7 x i8]* @"$admins_368", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_48", i32 1, i8* %"$indices_buf_366", i32 1), !dbg !42
...
"$have_gas_404":                                  ; preds = %"$out_of_gas_403", %"$Some_397"
  ...
  store %TName_Bool* %"$isAdmin_406", %TName_Bool** %isSenderAdmin, align 8, !dbg !44
...
"$have_gas_412":                                  ; preds = %"$out_of_gas_411", %"$None_407"
  ...
  store %TName_Bool* %"$adtptr_416", %TName_Bool** %isSenderAdmin, align 8, !dbg !47
  br label %"$matchsucc_392"
...
"$have_gas_442":                                  ; preds = %"$out_of_gas_441", %"$have_gas_437"
  ...
  store i8* %"$msgobj_444", i8** %m, align 8, !dbg !50
...
"$have_gas_493":                                  ; preds = %"$out_of_gas_492", %"$have_gas_442"
  ...
  %"$ud-proxy.oneMsg_call_499" = call %TName_List_Message* %"$ud-proxy.oneMsg_fptr_496"(i8* %"$ud-proxy.oneMsg_envptr_497", i8* %"$m_498"), !dbg !53
  store %TName_List_Message* %"$ud-proxy.oneMsg_call_499", %TName_List_Message** %"$ud-proxy.oneMsg_2", align 8, !dbg !53
  %"$$ud-proxy.oneMsg_2_500" = load %TName_List_Message*, %TName_List_Message** %"$ud-proxy.oneMsg_2", align 8
  store %TName_List_Message* %"$$ud-proxy.oneMsg_2_500", %TName_List_Message** %msgs, align 8, !dbg !53
...
"$have_gas_507":                                  ; preds = %"$out_of_gas_506", %"$have_gas_493"
  ...
  call void @_send(i8* %"$execptr_load_509", %_TyDescrTy_Typ* @"$TyDescr_ADT_List_Message_46", %TName_List_Message* %"$msgs_510"), !dbg !54
...
"$have_gas_519":                                  ; preds = %"$out_of_gas_518", %"$False_511"
  ...
  call void @_event(i8* %"$execptr_load_521", %_TyDescrTy_Typ* @"$TyDescr_Event_34", i8* %"$ud-proxy.eError_522"), !dbg !55
  br label %"$matchsucc_422"
...
entry:
  ...
  call void @"$bestow_361"(%Uint128 %_amount, [20 x i8]* %"$_origin_527", [20 x i8]* %"$_sender_529", %String %label, [20 x i8]* %"$owner_533", [20 x i8]* %"$resolver_535"), !dbg !58
  ret void
}
