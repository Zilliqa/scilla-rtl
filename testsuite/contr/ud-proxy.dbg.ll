...
define internal i8* @"$fundef_8"(%"$$fundef_8_env_93"* %0, %TName_Bool* %1) !dbg !4 {
entry:
...
"$have_gas_126":                                  ; preds = %"$out_of_gas_125", %entry
  ...
  store i8* %"$msgobj_128", i8** %"$retval_9", align 8, !dbg !8
  %"$$retval_9_153" = load i8*, i8** %"$retval_9", align 8
  ret i8* %"$$retval_9_153"
}

define internal { i8* (i8*, %TName_Bool*)*, i8* } @"$fundef_6"(%"$$fundef_6_env_94"* %0, [20 x i8]* %1) !dbg !9 {
entry:
...
"$have_gas_113":                                  ; preds = %"$out_of_gas_112", %entry
  ...
  store { i8* (i8*, %TName_Bool*)*, i8* } %"$$fundef_8_cloval_118", { i8* (i8*, %TName_Bool*)*, i8* }* %"$retval_7", align 8, !dbg !10
  %"$$retval_7_120" = load { i8* (i8*, %TName_Bool*)*, i8* }, { i8* (i8*, %TName_Bool*)*, i8* }* %"$retval_7", align 8
  ret { i8* (i8*, %TName_Bool*)*, i8* } %"$$retval_7_120"
}

define internal %TName_List_Message* @"$fundef_10"(%"$$fundef_10_env_95"* %0, i8* %1) !dbg !11 {
entry:
...
"$have_gas_101":                                  ; preds = %"$out_of_gas_100", %entry
  ...
  store %TName_List_Message* %"$adtptr_108", %TName_List_Message** %"$retval_11", align 8, !dbg !12
...
"$have_gas_172":                                  ; preds = %"$out_of_gas_171", %"$have_gas_167"
  ...
  store %TName_Bool* %"$adtptr_176", %TName_Bool** @ud-proxy.true, align 8, !dbg !16
...
"$have_gas_180":                                  ; preds = %"$out_of_gas_179", %"$have_gas_172"
  ...
  store %TName_List_Message* %"$adtptr_184", %TName_List_Message** @ud-proxy.nilMessage, align 8, !dbg !17
...
"$have_gas_188":                                  ; preds = %"$out_of_gas_187", %"$have_gas_180"
  ...
  store { %TName_List_Message* (i8*, i8*)*, i8* } %"$$fundef_10_cloval_193", { %TName_List_Message* (i8*, i8*)*, i8* }* @ud-proxy.oneMsg, align 8, !dbg !18
...
"$have_gas_199":                                  ; preds = %"$out_of_gas_198", %"$have_gas_188"
  ...
  store { { i8* (i8*, %TName_Bool*)*, i8* } (i8*, [20 x i8]*)*, i8* } { { i8* (i8*, %TName_Bool*)*, i8* } (i8*, [20 x i8]*)* bitcast ({ i8* (i8*, %TName_Bool*)*, i8* } (%"$$fundef_6_env_94"*, [20 x i8]*)* @"$fundef_6" to { i8* (i8*, %TName_Bool*)*, i8* } (i8*, [20 x i8]*)*), i8* null }, { { i8* (i8*, %TName_Bool*)*, i8* } (i8*, [20 x i8]*)*, i8* }* @ud-proxy.eAdminSet, align 8, !dbg !19
...
"$have_gas_207":                                  ; preds = %"$out_of_gas_206", %"$have_gas_199"
  ...
  store i8* %"$msgobj_209", i8** @ud-proxy.eError, align 8, !dbg !20
  ret void
}
...
"$have_gas_227":                                  ; preds = %"$out_of_gas_226", %"$have_gas_222"
  ...
  store %Map_ByStr20_Bool* %"$_new_empty_map_231", %Map_ByStr20_Bool** %empty, align 8, !dbg !22
...
"$have_gas_239":                                  ; preds = %"$out_of_gas_238", %"$have_gas_227"
  ...
  %"$put_call_249" = call i8* @_put(i8* %"$execptr_load_241", %_TyDescrTy_Typ* @"$TyDescr_Map_51", i8* %"$$empty_242_243", i8* %"$$put_initialAdmin_244_246", i8* %"$$ud-proxy.true_247_248"), !dbg !23
  %"$put_250" = bitcast i8* %"$put_call_249" to %Map_ByStr20_Bool*
  store %Map_ByStr20_Bool* %"$put_250", %Map_ByStr20_Bool** %"$admins_12", align 8, !dbg !23
  ...
  call void @_update_field(i8* %"$execptr_load_251", i8* getelementptr inbounds ([7 x i8], [7 x i8]* @"$admins_252", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_51", i32 0, i8* null, i8* %"$update_value_254"), !dbg !22
  ret void
}
...
define internal void @"$setAdmin_255"(%Uint128 %_amount, [20 x i8]* %"$_origin_256", [20 x i8]* %"$_sender_257", [20 x i8]* %"$address_258", %TName_Bool* %isApproved) !dbg !24 {
entry:
  ...
  %"$maybeAdmin_call_263" = call i8* @_fetch_field(i8* %"$execptr_load_262", i8* getelementptr inbounds ([7 x i8], [7 x i8]* @"$admins_261", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_51", i32 1, i8* %"$indices_buf_259", i32 1), !dbg !25
...
"$have_gas_297":                                  ; preds = %"$out_of_gas_296", %"$Some_290"
  ...
  store %TName_Bool* %"$approval_299", %TName_Bool** %isSenderAdmin, align 8, !dbg !27
...
"$have_gas_305":                                  ; preds = %"$out_of_gas_304", %"$None_300"
  ...
  store %TName_Bool* %"$adtptr_309", %TName_Bool** %isSenderAdmin, align 8, !dbg !30
  br label %"$matchsucc_285"
...
"$have_gas_328":                                  ; preds = %"$out_of_gas_327", %"$True_320"
  ...
  call void @_update_field(i8* %"$execptr_load_332", i8* getelementptr inbounds ([7 x i8], [7 x i8]* @"$admins_333", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_51", i32 1, i8* %"$indices_buf_330", i8* %"$update_value_334"), !dbg !33
...
"$have_gas_343":                                  ; preds = %"$out_of_gas_342", %"$have_gas_338"
  ...
  %"$ud-proxy.eAdminSet_call_349" = call { i8* (i8*, %TName_Bool*)*, i8* } %"$ud-proxy.eAdminSet_fptr_346"(i8* %"$ud-proxy.eAdminSet_envptr_347", [20 x i8]* %"$ud-proxy.eAdminSet_address_348"), !dbg !36
  store { i8* (i8*, %TName_Bool*)*, i8* } %"$ud-proxy.eAdminSet_call_349", { i8* (i8*, %TName_Bool*)*, i8* }* %"$ud-proxy.eAdminSet_3", align 8, !dbg !36
  ...
  %"$$ud-proxy.eAdminSet_3_call_353" = call i8* %"$$ud-proxy.eAdminSet_3_fptr_351"(i8* %"$$ud-proxy.eAdminSet_3_envptr_352", %TName_Bool* %isApproved), !dbg !36
  store i8* %"$$ud-proxy.eAdminSet_3_call_353", i8** %"$ud-proxy.eAdminSet_4", align 8, !dbg !36
  %"$$ud-proxy.eAdminSet_4_354" = load i8*, i8** %"$ud-proxy.eAdminSet_4", align 8
  store i8* %"$$ud-proxy.eAdminSet_4_354", i8** %e, align 8, !dbg !36
...
"$have_gas_361":                                  ; preds = %"$out_of_gas_360", %"$have_gas_343"
  ...
  call void @_event(i8* %"$execptr_load_363", %_TyDescrTy_Typ* @"$TyDescr_Event_37", i8* %"$e_364"), !dbg !37
...
"$have_gas_373":                                  ; preds = %"$out_of_gas_372", %"$False_365"
  ...
  call void @_event(i8* %"$execptr_load_375", %_TyDescrTy_Typ* @"$TyDescr_Event_37", i8* %"$ud-proxy.eError_376"), !dbg !38
  br label %"$matchsucc_315"
...
entry:
  ...
  call void @"$setAdmin_255"(%Uint128 %_amount, [20 x i8]* %"$_origin_381", [20 x i8]* %"$_sender_383", [20 x i8]* %"$address_385", %TName_Bool* %isApproved), !dbg !41
  ret void
}

define internal void @"$bestow_388"(%Uint128 %_amount, [20 x i8]* %"$_origin_389", [20 x i8]* %"$_sender_390", %String %label, [20 x i8]* %"$owner_391", [20 x i8]* %"$resolver_392") !dbg !42 {
entry:
  ...
  %"$maybeAdmin_call_397" = call i8* @_fetch_field(i8* %"$execptr_load_396", i8* getelementptr inbounds ([7 x i8], [7 x i8]* @"$admins_395", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_51", i32 1, i8* %"$indices_buf_393", i32 1), !dbg !43
...
"$have_gas_431":                                  ; preds = %"$out_of_gas_430", %"$Some_424"
  ...
  store %TName_Bool* %"$isAdmin_433", %TName_Bool** %isSenderAdmin, align 8, !dbg !45
...
"$have_gas_439":                                  ; preds = %"$out_of_gas_438", %"$None_434"
  ...
  store %TName_Bool* %"$adtptr_443", %TName_Bool** %isSenderAdmin, align 8, !dbg !48
  br label %"$matchsucc_419"
...
"$have_gas_469":                                  ; preds = %"$out_of_gas_468", %"$have_gas_464"
  ...
  store i8* %"$msgobj_471", i8** %m, align 8, !dbg !51
...
"$have_gas_520":                                  ; preds = %"$out_of_gas_519", %"$have_gas_469"
  ...
  %"$ud-proxy.oneMsg_call_526" = call %TName_List_Message* %"$ud-proxy.oneMsg_fptr_523"(i8* %"$ud-proxy.oneMsg_envptr_524", i8* %"$m_525"), !dbg !54
  store %TName_List_Message* %"$ud-proxy.oneMsg_call_526", %TName_List_Message** %"$ud-proxy.oneMsg_5", align 8, !dbg !54
  %"$$ud-proxy.oneMsg_5_527" = load %TName_List_Message*, %TName_List_Message** %"$ud-proxy.oneMsg_5", align 8
  store %TName_List_Message* %"$$ud-proxy.oneMsg_5_527", %TName_List_Message** %msgs, align 8, !dbg !54
...
"$have_gas_534":                                  ; preds = %"$out_of_gas_533", %"$have_gas_520"
  ...
  call void @_send(i8* %"$execptr_load_536", %_TyDescrTy_Typ* @"$TyDescr_ADT_List_Message_49", %TName_List_Message* %"$msgs_537"), !dbg !55
...
"$have_gas_546":                                  ; preds = %"$out_of_gas_545", %"$False_538"
  ...
  call void @_event(i8* %"$execptr_load_548", %_TyDescrTy_Typ* @"$TyDescr_Event_37", i8* %"$ud-proxy.eError_549"), !dbg !56
  br label %"$matchsucc_449"
...
entry:
  ...
  call void @"$bestow_388"(%Uint128 %_amount, [20 x i8]* %"$_origin_554", [20 x i8]* %"$_sender_556", %String %label, [20 x i8]* %"$owner_560", [20 x i8]* %"$resolver_562"), !dbg !59
  ret void
}
...
!21 = distinct !DISubprogram(name: "_init_state", linkageName: "_init_state", scope: !14, file: !14, type: !5, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !1, retainedNodes: !3)
