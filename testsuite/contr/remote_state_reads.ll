...
@"$TyDescr_AddrFields_268" = unnamed_addr constant %"$TyDescr_AddrTyp_87" { i32 -3, %"$TyDescr_AddrFieldTyp_86"* null }
...
"$have_gas_282":                                  ; preds = %"$out_of_gas_281", %"$have_gas_277"
  ...
  store [20 x i8] %"$cparam3_284", [20 x i8]* %"$assign_test_1_4", align 1
  ...
  call void @_update_field(i8* %"$execptr_load_285", i8* getelementptr inbounds ([14 x i8], [14 x i8]* @"$assign_test_1_286", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Addr_98", i32 0, i8* null, i8* %"$update_value_289")
...
"$have_gas_293":                                  ; preds = %"$out_of_gas_292", %"$have_gas_282"
  ...
  store [20 x i8] %"$cparam3_295", [20 x i8]* %"$assign_test_2_5", align 1
  ...
  call void @_update_field(i8* %"$execptr_load_296", i8* getelementptr inbounds ([14 x i8], [14 x i8]* @"$assign_test_2_297", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Addr_98", i32 0, i8* null, i8* %"$update_value_300")
...
"$have_gas_304":                                  ; preds = %"$out_of_gas_303", %"$have_gas_293"
  ...
  store [20 x i8] %"$cparam3_306", [20 x i8]* %"$assign_test_3_6", align 1
  ...
  call void @_update_field(i8* %"$execptr_load_307", i8* getelementptr inbounds ([14 x i8], [14 x i8]* @"$assign_test_3_308", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Addr_98", i32 0, i8* null, i8* %"$update_value_311")
...
"$have_gas_315":                                  ; preds = %"$out_of_gas_314", %"$have_gas_304"
  ...
  store [20 x i8] %"$cparam3_317", [20 x i8]* %"$assign_test_4_7", align 1
  ...
  call void @_update_field(i8* %"$execptr_load_318", i8* getelementptr inbounds ([14 x i8], [14 x i8]* @"$assign_test_4_319", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Addr_98", i32 0, i8* null, i8* %"$update_value_322")
...
"$have_gas_326":                                  ; preds = %"$out_of_gas_325", %"$have_gas_315"
  ...
  store [20 x i8] %"$cparam3_328", [20 x i8]* %"$assign_test_5_8", align 1
  ...
  call void @_update_field(i8* %"$execptr_load_329", i8* getelementptr inbounds ([14 x i8], [14 x i8]* @"$assign_test_5_330", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Addr_98", i32 0, i8* null, i8* %"$update_value_333")
...
"$have_gas_337":                                  ; preds = %"$out_of_gas_336", %"$have_gas_326"
  ...
  store [20 x i8] %"$cparam3_339", [20 x i8]* %"$assign_test_6_9", align 1
  ...
  call void @_update_field(i8* %"$execptr_load_340", i8* getelementptr inbounds ([14 x i8], [14 x i8]* @"$assign_test_6_341", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Addr_98", i32 0, i8* null, i8* %"$update_value_344")
...
"$have_gas_348":                                  ; preds = %"$out_of_gas_347", %"$have_gas_337"
  ...
  store [20 x i8] %"$cparam3_350", [20 x i8]* %"$assign_test_7_10", align 1
  ...
  call void @_update_field(i8* %"$execptr_load_351", i8* getelementptr inbounds ([14 x i8], [14 x i8]* @"$assign_test_7_352", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Addr_98", i32 0, i8* null, i8* %"$update_value_355")
...
"$have_gas_359":                                  ; preds = %"$out_of_gas_358", %"$have_gas_348"
  ...
  store %TName_0x3620c286757a29985cee194eb90064270fb65414.AddressADT* %"$adtptr_365", %TName_0x3620c286757a29985cee194eb90064270fb65414.AddressADT** %"$assign_test_8_11", align 8
  ...
  call void @_update_field(i8* %"$execptr_load_366", i8* getelementptr inbounds ([14 x i8], [14 x i8]* @"$assign_test_8_367", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_ADT_0x3620c286757a29985cee194eb90064270fb65414.AddressADT_75", i32 0, i8* null, i8* %"$update_value_369")
...
"$have_gas_373":                                  ; preds = %"$out_of_gas_372", %"$have_gas_359"
  ...
  store %TName_List_0x3620c286757a29985cee194eb90064270fb65414.AddressADT* %"$adtptr_377", %TName_List_0x3620c286757a29985cee194eb90064270fb65414.AddressADT** %"$assign_test_9_12", align 8
  ...
  call void @_update_field(i8* %"$execptr_load_378", i8* getelementptr inbounds ([14 x i8], [14 x i8]* @"$assign_test_9_379", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_ADT_List_0x3620c286757a29985cee194eb90064270fb65414.AddressADT_70", i32 0, i8* null, i8* %"$update_value_381")
...
"$have_gas_385":                                  ; preds = %"$out_of_gas_384", %"$have_gas_373"
  ...
  store %"Map_Uint128_Map_(Uint128)_(0x3620c286757a29985cee194eb90064270fb65414.AddressADT)"* %"$_new_empty_map_389", %"Map_Uint128_Map_(Uint128)_(0x3620c286757a29985cee194eb90064270fb65414.AddressADT)"** %"$assign_test_10_13", align 8
  ...
  call void @_update_field(i8* %"$execptr_load_390", i8* getelementptr inbounds ([15 x i8], [15 x i8]* @"$assign_test_10_391", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_79", i32 0, i8* null, i8* %"$update_value_393")
...
"$have_gas_397":                                  ; preds = %"$out_of_gas_396", %"$have_gas_385"
  ...
  call void @_update_field(i8* %"$execptr_load_399", i8* getelementptr inbounds ([26 x i8], [26 x i8]* @"$remote_reads_test_res_1_1_400", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Uint128_43", i32 0, i8* null, i8* %"$update_value_403")
...
"$have_gas_407":                                  ; preds = %"$out_of_gas_406", %"$have_gas_397"
  ...
  call void @_update_field(i8* %"$execptr_load_409", i8* getelementptr inbounds ([26 x i8], [26 x i8]* @"$remote_reads_test_res_2_1_410", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Uint128_43", i32 0, i8* null, i8* %"$update_value_413")
...
"$have_gas_417":                                  ; preds = %"$out_of_gas_416", %"$have_gas_407"
  ...
  call void @_update_field(i8* %"$execptr_load_419", i8* getelementptr inbounds ([26 x i8], [26 x i8]* @"$remote_reads_test_res_3_1_420", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Uint128_43", i32 0, i8* null, i8* %"$update_value_423")
...
"$have_gas_427":                                  ; preds = %"$out_of_gas_426", %"$have_gas_417"
  ...
  call void @_update_field(i8* %"$execptr_load_429", i8* getelementptr inbounds ([26 x i8], [26 x i8]* @"$remote_reads_test_res_3_3_430", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Uint32_35", i32 0, i8* null, i8* %"$update_value_433")
...
"$have_gas_437":                                  ; preds = %"$out_of_gas_436", %"$have_gas_427"
  ...
  store [20 x i8] %"$cparam3_439", [20 x i8]* %"$remote_reads_test_res_3_4_18", align 1
  ...
  call void @_update_field(i8* %"$execptr_load_440", i8* getelementptr inbounds ([26 x i8], [26 x i8]* @"$remote_reads_test_res_3_4_441", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Addr_98", i32 0, i8* null, i8* %"$update_value_444")
...
"$have_gas_448":                                  ; preds = %"$out_of_gas_447", %"$have_gas_437"
  ...
  call void @_update_field(i8* %"$execptr_load_450", i8* getelementptr inbounds ([26 x i8], [26 x i8]* @"$remote_reads_test_res_3_5_451", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Uint128_43", i32 0, i8* null, i8* %"$update_value_454")
...
"$have_gas_458":                                  ; preds = %"$out_of_gas_457", %"$have_gas_448"
  ...
  store %Map_ByStr20_with_end_Bool* %"$_new_empty_map_462", %Map_ByStr20_with_end_Bool** %"$remote_reads_test_res_3_6_20", align 8
  ...
  call void @_update_field(i8* %"$execptr_load_463", i8* getelementptr inbounds ([26 x i8], [26 x i8]* @"$remote_reads_test_res_3_6_464", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_84", i32 0, i8* null, i8* %"$update_value_466")
...
"$have_gas_470":                                  ; preds = %"$out_of_gas_469", %"$have_gas_458"
  ...
  store %TName_Bool* %"$adtptr_474", %TName_Bool** %"$remote_reads_test_res_3_7_21", align 8
  ...
  call void @_update_field(i8* %"$execptr_load_475", i8* getelementptr inbounds ([26 x i8], [26 x i8]* @"$remote_reads_test_res_3_7_476", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_ADT_Bool_76", i32 0, i8* null, i8* %"$update_value_478")
...
"$have_gas_487":                                  ; preds = %"$out_of_gas_486", %"$have_gas_482"
  ...
  store %TName_Bool* %"$adtptr_491", %TName_Bool** %x, align 8
...
"$have_gas_495":                                  ; preds = %"$out_of_gas_494", %"$have_gas_487"
  ...
  store %TName_Option_Bool* %"$adtptr_501", %TName_Option_Bool** %"$remote_reads_test_res_3_8_22", align 8
  ...
  call void @_update_field(i8* %"$execptr_load_502", i8* getelementptr inbounds ([26 x i8], [26 x i8]* @"$remote_reads_test_res_3_8_503", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_ADT_Option_Bool_74", i32 0, i8* null, i8* %"$update_value_505")
...
"$have_gas_509":                                  ; preds = %"$out_of_gas_508", %"$have_gas_495"
  ...
  store %"Map_Uint32_Map_(ByStr20_with_end)_(Bool)"* %"$_new_empty_map_513", %"Map_Uint32_Map_(ByStr20_with_end)_(Bool)"** %"$remote_reads_test_res_3_9_23", align 8
  ...
  call void @_update_field(i8* %"$execptr_load_514", i8* getelementptr inbounds ([26 x i8], [26 x i8]* @"$remote_reads_test_res_3_9_515", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_83", i32 0, i8* null, i8* %"$update_value_517")
...
"$have_gas_521":                                  ; preds = %"$out_of_gas_520", %"$have_gas_509"
  ...
  store %TName_Bool* %"$adtptr_525", %TName_Bool** %"$remote_reads_test_res_3_10_24", align 8
  ...
  call void @_update_field(i8* %"$execptr_load_526", i8* getelementptr inbounds ([27 x i8], [27 x i8]* @"$remote_reads_test_res_3_10_527", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_ADT_Bool_76", i32 0, i8* null, i8* %"$update_value_529")
...
"$have_gas_533":                                  ; preds = %"$out_of_gas_532", %"$have_gas_521"
  ...
  store %"TName_Option_Map_(ByStr20_with_end)_(Bool)"* %"$adtptr_537", %"TName_Option_Map_(ByStr20_with_end)_(Bool)"** %"$remote_reads_test_res_3_11_25", align 8
  ...
  call void @_update_field(i8* %"$execptr_load_538", i8* getelementptr inbounds ([27 x i8], [27 x i8]* @"$remote_reads_test_res_3_11_539", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_ADT_Option_Map_(ByStr20_with_end)_(Bool)_73", i32 0, i8* null, i8* %"$update_value_541")
...
"$have_gas_545":                                  ; preds = %"$out_of_gas_544", %"$have_gas_533"
  ...
  store %TName_Bool* %"$adtptr_549", %TName_Bool** %"$remote_reads_test_res_3_12_26", align 8
  ...
  call void @_update_field(i8* %"$execptr_load_550", i8* getelementptr inbounds ([27 x i8], [27 x i8]* @"$remote_reads_test_res_3_12_551", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_ADT_Bool_76", i32 0, i8* null, i8* %"$update_value_553")
...
"$have_gas_557":                                  ; preds = %"$out_of_gas_556", %"$have_gas_545"
  ...
  store %TName_Option_Bool* %"$adtptr_561", %TName_Option_Bool** %"$remote_reads_test_res_3_13_27", align 8
  ...
  call void @_update_field(i8* %"$execptr_load_562", i8* getelementptr inbounds ([27 x i8], [27 x i8]* @"$remote_reads_test_res_3_13_563", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_ADT_Option_Bool_74", i32 0, i8* null, i8* %"$update_value_565")
...
"$have_gas_569":                                  ; preds = %"$out_of_gas_568", %"$have_gas_557"
  ...
  call void @_update_field(i8* %"$execptr_load_571", i8* getelementptr inbounds ([19 x i8], [19 x i8]* @"$sender_balance_pre_572", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Uint128_43", i32 0, i8* null, i8* %"$update_value_575")
...
"$have_gas_579":                                  ; preds = %"$out_of_gas_578", %"$have_gas_569"
  ...
  call void @_update_field(i8* %"$execptr_load_581", i8* getelementptr inbounds ([19 x i8], [19 x i8]* @"$sender_balance_mid_582", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Uint128_43", i32 0, i8* null, i8* %"$update_value_585")
...
"$have_gas_589":                                  ; preds = %"$out_of_gas_588", %"$have_gas_579"
  ...
  call void @_update_field(i8* %"$execptr_load_591", i8* getelementptr inbounds ([20 x i8], [20 x i8]* @"$sender_balance_post_592", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Uint128_43", i32 0, i8* null, i8* %"$update_value_595")
  ret void
}
...
define internal void @"$RemoteReadsTest_596"(%Uint128 %_amount, [20 x i8]* %"$_origin_597", [20 x i8]* %"$_sender_598", [20 x i8]* %"$remote1_599", [20 x i8]* %"$remote2_600", [20 x i8]* %"$remote3_601") {
entry:
  ...
  %"$tmp_1_1_call_605" = call i8* @_fetch_remote_field(i8* %"$execptr_load_603", [20 x i8]* %"$tmp_1_1_remote1_604", i8* getelementptr inbounds ([9 x i8], [9 x i8]* @"$_balance_602", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Uint128_43", i32 0, i8* null, i32 1)
...
"$have_gas_625":                                  ; preds = %"$out_of_gas_624", %"$have_gas_616"
  ...
  call void @_update_field(i8* %"$execptr_load_627", i8* getelementptr inbounds ([26 x i8], [26 x i8]* @"$remote_reads_test_res_1_1_628", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Uint128_43", i32 0, i8* null, i8* %"$update_value_631")
  ...
  %"$tmp_2_1_call_635" = call i8* @_fetch_remote_field(i8* %"$execptr_load_633", [20 x i8]* %"$tmp_2_1_remote2_634", i8* getelementptr inbounds ([9 x i8], [9 x i8]* @"$_balance_632", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Uint128_43", i32 0, i8* null, i32 1)
...
"$have_gas_655":                                  ; preds = %"$out_of_gas_654", %"$have_gas_646"
  ...
  call void @_update_field(i8* %"$execptr_load_657", i8* getelementptr inbounds ([26 x i8], [26 x i8]* @"$remote_reads_test_res_2_1_658", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Uint128_43", i32 0, i8* null, i8* %"$update_value_661")
  ...
  %"$tmp_3_1_call_665" = call i8* @_fetch_remote_field(i8* %"$execptr_load_663", [20 x i8]* %"$tmp_3_1_remote3_664", i8* getelementptr inbounds ([9 x i8], [9 x i8]* @"$_balance_662", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Uint128_43", i32 0, i8* null, i32 1)
...
"$have_gas_685":                                  ; preds = %"$out_of_gas_684", %"$have_gas_676"
  ...
  call void @_update_field(i8* %"$execptr_load_687", i8* getelementptr inbounds ([26 x i8], [26 x i8]* @"$remote_reads_test_res_3_1_688", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Uint128_43", i32 0, i8* null, i8* %"$update_value_691")
  ...
  %"$tmp_3_3_call_695" = call i8* @_fetch_remote_field(i8* %"$execptr_load_693", [20 x i8]* %"$tmp_3_3_remote3_694", i8* getelementptr inbounds ([17 x i8], [17 x i8]* @"$transactionCount_692", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Uint32_35", i32 0, i8* null, i32 1)
...
"$have_gas_715":                                  ; preds = %"$out_of_gas_714", %"$have_gas_706"
  ...
  call void @_update_field(i8* %"$execptr_load_717", i8* getelementptr inbounds ([26 x i8], [26 x i8]* @"$remote_reads_test_res_3_3_718", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Uint32_35", i32 0, i8* null, i8* %"$update_value_721")
  ...
  %"$tmp_3_4_call_725" = call i8* @_fetch_remote_field(i8* %"$execptr_load_723", [20 x i8]* %"$tmp_3_4_remote3_724", i8* getelementptr inbounds ([6 x i8], [6 x i8]* @"$admin_722", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Addr_100", i32 0, i8* null, i32 1)
...
"$have_gas_745":                                  ; preds = %"$out_of_gas_744", %"$have_gas_736"
  ...
  call void @_update_field(i8* %"$execptr_load_747", i8* getelementptr inbounds ([26 x i8], [26 x i8]* @"$remote_reads_test_res_3_4_748", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Addr_100", i32 0, i8* null, i8* %"$update_value_751")
  ...
  %"$tmp_3_5_call_756" = call i8* @_fetch_remote_field(i8* %"$execptr_load_753", [20 x i8]* %"$tmp_3_5_tmp_3_4_754", i8* getelementptr inbounds ([9 x i8], [9 x i8]* @"$_balance_752", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Uint128_43", i32 0, i8* null, i32 1)
...
"$have_gas_776":                                  ; preds = %"$out_of_gas_775", %"$have_gas_767"
  ...
  call void @_update_field(i8* %"$execptr_load_778", i8* getelementptr inbounds ([26 x i8], [26 x i8]* @"$remote_reads_test_res_3_5_779", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Uint128_43", i32 0, i8* null, i8* %"$update_value_782")
  ...
  %"$tmp_3_6_call_786" = call i8* @_fetch_remote_field(i8* %"$execptr_load_784", [20 x i8]* %"$tmp_3_6_remote3_785", i8* getelementptr inbounds ([7 x i8], [7 x i8]* @"$owners_783", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_84", i32 0, i8* null, i32 1)
...
"$have_gas_806":                                  ; preds = %"$out_of_gas_805", %"$have_gas_798"
  ...
  call void @_update_field(i8* %"$execptr_load_808", i8* getelementptr inbounds ([26 x i8], [26 x i8]* @"$remote_reads_test_res_3_6_809", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_84", i32 0, i8* null, i8* %"$update_value_811")
  ...
  %"$tmp_3_7_call_817" = call i8* @_fetch_remote_field(i8* %"$execptr_load_815", [20 x i8]* %"$tmp_3_7_remote3_816", i8* getelementptr inbounds ([7 x i8], [7 x i8]* @"$owners_814", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_84", i32 1, i8* %"$indices_buf_812", i32 0)
...
"$have_gas_835":                                  ; preds = %"$out_of_gas_834", %"$have_gas_827"
  ...
  call void @_update_field(i8* %"$execptr_load_837", i8* getelementptr inbounds ([26 x i8], [26 x i8]* @"$remote_reads_test_res_3_7_838", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_ADT_Bool_76", i32 0, i8* null, i8* %"$update_value_840")
  ...
  %"$tmp_3_8_call_846" = call i8* @_fetch_remote_field(i8* %"$execptr_load_844", [20 x i8]* %"$tmp_3_8_remote3_845", i8* getelementptr inbounds ([7 x i8], [7 x i8]* @"$owners_843", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_84", i32 1, i8* %"$indices_buf_841", i32 1)
...
"$have_gas_864":                                  ; preds = %"$out_of_gas_863", %"$have_gas_856"
  ...
  call void @_update_field(i8* %"$execptr_load_866", i8* getelementptr inbounds ([26 x i8], [26 x i8]* @"$remote_reads_test_res_3_8_867", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_ADT_Option_Bool_74", i32 0, i8* null, i8* %"$update_value_869")
  ...
  %"$tmp_3_9_call_873" = call i8* @_fetch_remote_field(i8* %"$execptr_load_871", [20 x i8]* %"$tmp_3_9_remote3_872", i8* getelementptr inbounds ([11 x i8], [11 x i8]* @"$signatures_870", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_83", i32 0, i8* null, i32 1)
...
"$have_gas_893":                                  ; preds = %"$out_of_gas_892", %"$have_gas_885"
  ...
  call void @_update_field(i8* %"$execptr_load_895", i8* getelementptr inbounds ([26 x i8], [26 x i8]* @"$remote_reads_test_res_3_9_896", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_83", i32 0, i8* null, i8* %"$update_value_898")
...
"$have_gas_907":                                  ; preds = %"$out_of_gas_906", %"$have_gas_902"
  ...
  %"$tmp_3_10_call_915" = call i8* @_fetch_remote_field(i8* %"$execptr_load_913", [20 x i8]* %"$tmp_3_10_remote3_914", i8* getelementptr inbounds ([11 x i8], [11 x i8]* @"$signatures_912", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_83", i32 1, i8* %"$indices_buf_909", i32 0)
...
"$have_gas_933":                                  ; preds = %"$out_of_gas_932", %"$have_gas_925"
  ...
  call void @_update_field(i8* %"$execptr_load_935", i8* getelementptr inbounds ([27 x i8], [27 x i8]* @"$remote_reads_test_res_3_10_936", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_ADT_Bool_76", i32 0, i8* null, i8* %"$update_value_938")
  ...
  %"$tmp_3_11_call_945" = call i8* @_fetch_remote_field(i8* %"$execptr_load_943", [20 x i8]* %"$tmp_3_11_remote3_944", i8* getelementptr inbounds ([11 x i8], [11 x i8]* @"$signatures_942", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_83", i32 1, i8* %"$indices_buf_939", i32 1)
...
"$have_gas_966":                                  ; preds = %"$out_of_gas_965", %"$have_gas_958"
  ...
  call void @_update_field(i8* %"$execptr_load_968", i8* getelementptr inbounds ([27 x i8], [27 x i8]* @"$remote_reads_test_res_3_11_969", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_ADT_Option_Map_(ByStr20_with_end)_(Bool)_73", i32 0, i8* null, i8* %"$update_value_971")
  ...
  %"$tmp_3_12_call_979" = call i8* @_fetch_remote_field(i8* %"$execptr_load_977", [20 x i8]* %"$tmp_3_12_remote3_978", i8* getelementptr inbounds ([11 x i8], [11 x i8]* @"$signatures_976", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_83", i32 2, i8* %"$indices_buf_972", i32 0)
...
"$have_gas_997":                                  ; preds = %"$out_of_gas_996", %"$have_gas_989"
  ...
  call void @_update_field(i8* %"$execptr_load_999", i8* getelementptr inbounds ([27 x i8], [27 x i8]* @"$remote_reads_test_res_3_12_1000", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_ADT_Bool_76", i32 0, i8* null, i8* %"$update_value_1002")
  ...
  %"$tmp_3_13_call_1010" = call i8* @_fetch_remote_field(i8* %"$execptr_load_1008", [20 x i8]* %"$tmp_3_13_remote3_1009", i8* getelementptr inbounds ([11 x i8], [11 x i8]* @"$signatures_1007", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_83", i32 2, i8* %"$indices_buf_1003", i32 1)
...
"$have_gas_1028":                                 ; preds = %"$out_of_gas_1027", %"$have_gas_1020"
  ...
  call void @_update_field(i8* %"$execptr_load_1030", i8* getelementptr inbounds ([27 x i8], [27 x i8]* @"$remote_reads_test_res_3_13_1031", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_ADT_Option_Bool_74", i32 0, i8* null, i8* %"$update_value_1033")
  ret void
}
...
"$have_gas_1081":                                 ; preds = %"$out_of_gas_1080", %"$have_gas_1076"
  ...
  store i8* %"$msgobj_1083", i8** %msg, align 8
...
"$have_gas_1128":                                 ; preds = %"$out_of_gas_1127", %"$have_gas_1123"
  ...
  store %TName_List_Message* %"$adtptr_1132", %TName_List_Message** %n, align 8
...
"$have_gas_1136":                                 ; preds = %"$out_of_gas_1135", %"$have_gas_1128"
  ...
  store %TName_List_Message* %"$adtptr_1144", %TName_List_Message** %msgs, align 8
...
"$have_gas_1151":                                 ; preds = %"$out_of_gas_1150", %"$have_gas_1136"
  ...
  call void @_send(i8* %"$execptr_load_1153", %_TyDescrTy_Typ* @"$TyDescr_ADT_List_Message_65", %TName_List_Message* %"$msgs_1154")
...
"$have_gas_1163":                                 ; preds = %"$out_of_gas_1162", %"$have_gas_1158"
  ...
  store i8* %"$msgobj_1165", i8** %e1, align 8
...
"$have_gas_1189":                                 ; preds = %"$out_of_gas_1188", %"$have_gas_1163"
  ...
  call void @_event(i8* %"$execptr_load_1191", %_TyDescrTy_Typ* @"$TyDescr_Event_55", i8* %"$e1_1192")
...
"$have_gas_1201":                                 ; preds = %"$out_of_gas_1200", %"$have_gas_1196"
  ...
  store i8* %"$msgobj_1203", i8** %e2, align 8
...
"$have_gas_1227":                                 ; preds = %"$out_of_gas_1226", %"$have_gas_1201"
  ...
  call void @_event(i8* %"$execptr_load_1229", %_TyDescrTy_Typ* @"$TyDescr_Event_55", i8* %"$e2_1230")
  ret void
}
...
entry:
  ...
  call void @"$OutgoingMsgTest_1070"(%Uint128 %_amount, [20 x i8]* %"$_origin_1235", [20 x i8]* %"$_sender_1237")
  ret void
}

define internal void @"$ExceptionTest_1238"(%Uint128 %_amount, [20 x i8]* %"$_origin_1239", [20 x i8]* %"$_sender_1240") {
entry:
...
"$have_gas_1249":                                 ; preds = %"$out_of_gas_1248", %"$have_gas_1244"
  ...
  store i8* %"$msgobj_1251", i8** %e, align 8
...
"$have_gas_1275":                                 ; preds = %"$out_of_gas_1274", %"$have_gas_1249"
  ...
  call void @_throw(i8* %"$execptr_load_1277", %_TyDescrTy_Typ* @"$TyDescr_Exception_57", i8* %"$e_1278")
  ret void
}
...
entry:
  ...
  call void @"$ExceptionTest_1238"(%Uint128 %_amount, [20 x i8]* %"$_origin_1283", [20 x i8]* %"$_sender_1285")
  ret void
}

define internal void @"$AssignTest_1286"(%Uint128 %_amount, [20 x i8]* %"$_origin_1287", [20 x i8]* %"$_sender_1288") {
entry:
...
"$have_gas_1297":                                 ; preds = %"$out_of_gas_1296", %"$have_gas_1292"
  ...
  store %TName_0x3620c286757a29985cee194eb90064270fb65414.AddressADT* %"$adtptr_1303", %TName_0x3620c286757a29985cee194eb90064270fb65414.AddressADT** %"$x_2", align 8
...
"$have_gas_1310":                                 ; preds = %"$out_of_gas_1309", %"$have_gas_1297"
  ...
  call void @_update_field(i8* %"$execptr_load_1312", i8* getelementptr inbounds ([14 x i8], [14 x i8]* @"$assign_test_8_1313", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_ADT_0x3620c286757a29985cee194eb90064270fb65414.AddressADT_75", i32 0, i8* null, i8* %"$update_value_1315")
...
"$have_gas_1329":                                 ; preds = %"$out_of_gas_1328", %"$have_gas_1324"
  ...
  store %TName_List_0x3620c286757a29985cee194eb90064270fb65414.AddressADT* %"$adtptr_1333", %TName_List_0x3620c286757a29985cee194eb90064270fb65414.AddressADT** %n, align 8
...
"$have_gas_1337":                                 ; preds = %"$out_of_gas_1336", %"$have_gas_1329"
  ...
  store %TName_List_0x3620c286757a29985cee194eb90064270fb65414.AddressADT* %"$adtptr_1345", %TName_List_0x3620c286757a29985cee194eb90064270fb65414.AddressADT** %y, align 8
...
"$have_gas_1352":                                 ; preds = %"$out_of_gas_1351", %"$have_gas_1337"
  ...
  call void @_update_field(i8* %"$execptr_load_1354", i8* getelementptr inbounds ([14 x i8], [14 x i8]* @"$assign_test_9_1355", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_ADT_List_0x3620c286757a29985cee194eb90064270fb65414.AddressADT_70", i32 0, i8* null, i8* %"$update_value_1357")
...
"$have_gas_1371":                                 ; preds = %"$out_of_gas_1370", %"$have_gas_1366"
  ...
  store %"Map_Uint128_Map_(Uint128)_(0x3620c286757a29985cee194eb90064270fb65414.AddressADT)"* %"$_new_empty_map_1375", %"Map_Uint128_Map_(Uint128)_(0x3620c286757a29985cee194eb90064270fb65414.AddressADT)"** %"$n_3", align 8
...
"$have_gas_1384":                                 ; preds = %"$out_of_gas_1383", %"$have_gas_1379"
  ...
  store %Map_Uint128_0x3620c286757a29985cee194eb90064270fb65414.AddressADT* %"$_new_empty_map_1388", %Map_Uint128_0x3620c286757a29985cee194eb90064270fb65414.AddressADT** %sub_n, align 8
...
"$have_gas_1411":                                 ; preds = %"$out_of_gas_1410", %"$have_gas_1402"
  ...
  %"$put_call_1421" = call i8* @_put(i8* %"$execptr_load_1413", %_TyDescrTy_Typ* @"$TyDescr_Map_78", i8* %"$$sub_n_1414_1415", i8* %"$$put_sub_k_1416_1418", i8* %"$$$x_2_1419_1420")
  %"$put_1422" = bitcast i8* %"$put_call_1421" to %Map_Uint128_0x3620c286757a29985cee194eb90064270fb65414.AddressADT*
  store %Map_Uint128_0x3620c286757a29985cee194eb90064270fb65414.AddressADT* %"$put_1422", %Map_Uint128_0x3620c286757a29985cee194eb90064270fb65414.AddressADT** %sub_res, align 8
...
"$have_gas_1430":                                 ; preds = %"$out_of_gas_1429", %"$have_gas_1411"
  ...
  %"$put_call_1440" = call i8* @_put(i8* %"$execptr_load_1432", %_TyDescrTy_Typ* @"$TyDescr_Map_79", i8* %"$$$n_3_1433_1434", i8* %"$$put_sub_k_1435_1437", i8* %"$$sub_res_1438_1439")
  %"$put_1441" = bitcast i8* %"$put_call_1440" to %"Map_Uint128_Map_(Uint128)_(0x3620c286757a29985cee194eb90064270fb65414.AddressADT)"*
  store %"Map_Uint128_Map_(Uint128)_(0x3620c286757a29985cee194eb90064270fb65414.AddressADT)"* %"$put_1441", %"Map_Uint128_Map_(Uint128)_(0x3620c286757a29985cee194eb90064270fb65414.AddressADT)"** %z, align 8
...
"$have_gas_1448":                                 ; preds = %"$out_of_gas_1447", %"$have_gas_1430"
  ...
  call void @_update_field(i8* %"$execptr_load_1450", i8* getelementptr inbounds ([15 x i8], [15 x i8]* @"$assign_test_10_1451", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_79", i32 0, i8* null, i8* %"$update_value_1453")
...
"$have_gas_1481":                                 ; preds = %"$out_of_gas_1480", %"$have_gas_1472"
  ...
  call void @_update_field(i8* %"$execptr_load_1488", i8* getelementptr inbounds ([15 x i8], [15 x i8]* @"$assign_test_10_1489", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_79", i32 2, i8* %"$indices_buf_1483", i8* %"$update_value_1491")
  ret void
}
...
entry:
  ...
  call void @"$AssignTest_1286"(%Uint128 %_amount, [20 x i8]* %"$_origin_1496", [20 x i8]* %"$_sender_1498")
  ret void
}
