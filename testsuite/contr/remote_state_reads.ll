...
@"$pname__creation_block_1563" = unnamed_addr constant [15 x i8] c"_creation_block"
@"$pname_cparam1_1564" = unnamed_addr constant [7 x i8] c"cparam1"
@"$pname_cparam2_1565" = unnamed_addr constant [7 x i8] c"cparam2"
@"$pname_cparam3_1566" = unnamed_addr constant [7 x i8] c"cparam3"
@_contract_parameters = constant [6 x %"$ParamDescr_1559"] [%"$ParamDescr_1559" { %ParamDescrString { i8* getelementptr inbounds ([15 x i8], [15 x i8]* @"$pname__scilla_version_1561", i32 0, i32 0), i32 15 }, %_TyDescrTy_Typ* @"$TyDescr_Uint32_31" }, %"$ParamDescr_1559" { %ParamDescrString { i8* getelementptr inbounds ([13 x i8], [13 x i8]* @"$pname__this_address_1562", i32 0, i32 0), i32 13 }, %_TyDescrTy_Typ* @"$TyDescr_Bystr20_57" }, %"$ParamDescr_1559" { %ParamDescrString { i8* getelementptr inbounds ([15 x i8], [15 x i8]* @"$pname__creation_block_1563", i32 0, i32 0), i32 15 }, %_TyDescrTy_Typ* @"$TyDescr_Bnum_47" }, %"$ParamDescr_1559" { %ParamDescrString { i8* getelementptr inbounds ([7 x i8], [7 x i8]* @"$pname_cparam1_1564", i32 0, i32 0), i32 7 }, %_TyDescrTy_Typ* @"$TyDescr_Addr_94" }, %"$ParamDescr_1559" { %ParamDescrString { i8* getelementptr inbounds ([7 x i8], [7 x i8]* @"$pname_cparam2_1565", i32 0, i32 0), i32 7 }, %_TyDescrTy_Typ* @"$TyDescr_Addr_93" }, %"$ParamDescr_1559" { %ParamDescrString { i8* getelementptr inbounds ([7 x i8], [7 x i8]* @"$pname_cparam3_1566", i32 0, i32 0), i32 7 }, %_TyDescrTy_Typ* @"$TyDescr_Addr_92" }]
@_contract_parameters_length = constant i32 6
@"$tpname__amount_1567" = unnamed_addr constant [7 x i8] c"_amount"
@"$tpname__origin_1568" = unnamed_addr constant [7 x i8] c"_origin"
@"$tpname__sender_1569" = unnamed_addr constant [7 x i8] c"_sender"
@"$tpname_remote1_1570" = unnamed_addr constant [7 x i8] c"remote1"
@"$tpname_remote2_1571" = unnamed_addr constant [7 x i8] c"remote2"
@"$tpname_remote3_1572" = unnamed_addr constant [7 x i8] c"remote3"
@"$tparams_RemoteReadsTest_1573" = unnamed_addr constant [6 x %"$ParamDescr_1559"] [%"$ParamDescr_1559" { %ParamDescrString { i8* getelementptr inbounds ([7 x i8], [7 x i8]* @"$tpname__amount_1567", i32 0, i32 0), i32 7 }, %_TyDescrTy_Typ* @"$TyDescr_Uint128_39" }, %"$ParamDescr_1559" { %ParamDescrString { i8* getelementptr inbounds ([7 x i8], [7 x i8]* @"$tpname__origin_1568", i32 0, i32 0), i32 7 }, %_TyDescrTy_Typ* @"$TyDescr_Addr_94" }, %"$ParamDescr_1559" { %ParamDescrString { i8* getelementptr inbounds ([7 x i8], [7 x i8]* @"$tpname__sender_1569", i32 0, i32 0), i32 7 }, %_TyDescrTy_Typ* @"$TyDescr_Addr_94" }, %"$ParamDescr_1559" { %ParamDescrString { i8* getelementptr inbounds ([7 x i8], [7 x i8]* @"$tpname_remote1_1570", i32 0, i32 0), i32 7 }, %_TyDescrTy_Typ* @"$TyDescr_Addr_94" }, %"$ParamDescr_1559" { %ParamDescrString { i8* getelementptr inbounds ([7 x i8], [7 x i8]* @"$tpname_remote2_1571", i32 0, i32 0), i32 7 }, %_TyDescrTy_Typ* @"$TyDescr_Addr_93" }, %"$ParamDescr_1559" { %ParamDescrString { i8* getelementptr inbounds ([7 x i8], [7 x i8]* @"$tpname_remote3_1572", i32 0, i32 0), i32 7 }, %_TyDescrTy_Typ* @"$TyDescr_Addr_85" }]
@"$tname_RemoteReadsTest_1574" = unnamed_addr constant [15 x i8] c"RemoteReadsTest"
@"$tpname__amount_1575" = unnamed_addr constant [7 x i8] c"_amount"
@"$tpname__origin_1576" = unnamed_addr constant [7 x i8] c"_origin"
@"$tpname__sender_1577" = unnamed_addr constant [7 x i8] c"_sender"
@"$tpname_list1_1578" = unnamed_addr constant [5 x i8] c"list1"
@"$tpname_list2_1579" = unnamed_addr constant [5 x i8] c"list2"
@"$tpname_list3_1580" = unnamed_addr constant [5 x i8] c"list3"
@"$tpname_pair1_1581" = unnamed_addr constant [5 x i8] c"pair1"
@"$tpname_adt1_1582" = unnamed_addr constant [4 x i8] c"adt1"
@"$tpname_remote1_1583" = unnamed_addr constant [7 x i8] c"remote1"
@"$tparams_RemoteReadsADTTest_1584" = unnamed_addr constant [9 x %"$ParamDescr_1559"] [%"$ParamDescr_1559" { %ParamDescrString { i8* getelementptr inbounds ([7 x i8], [7 x i8]* @"$tpname__amount_1575", i32 0, i32 0), i32 7 }, %_TyDescrTy_Typ* @"$TyDescr_Uint128_39" }, %"$ParamDescr_1559" { %ParamDescrString { i8* getelementptr inbounds ([7 x i8], [7 x i8]* @"$tpname__origin_1576", i32 0, i32 0), i32 7 }, %_TyDescrTy_Typ* @"$TyDescr_Addr_94" }, %"$ParamDescr_1559" { %ParamDescrString { i8* getelementptr inbounds ([7 x i8], [7 x i8]* @"$tpname__sender_1577", i32 0, i32 0), i32 7 }, %_TyDescrTy_Typ* @"$TyDescr_Addr_94" }, %"$ParamDescr_1559" { %ParamDescrString { i8* getelementptr inbounds ([5 x i8], [5 x i8]* @"$tpname_list1_1578", i32 0, i32 0), i32 5 }, %_TyDescrTy_Typ* @"$TyDescr_ADT_List_ByStr20_with_end_64" }, %"$ParamDescr_1559" { %ParamDescrString { i8* getelementptr inbounds ([5 x i8], [5 x i8]* @"$tpname_list2_1579", i32 0, i32 0), i32 5 }, %_TyDescrTy_Typ* @"$TyDescr_ADT_List_ByStr20_with_contract_field_f_:_Uint128_end_63" }, %"$ParamDescr_1559" { %ParamDescrString { i8* getelementptr inbounds ([5 x i8], [5 x i8]* @"$tpname_list3_1580", i32 0, i32 0), i32 5 }, %_TyDescrTy_Typ* @"$TyDescr_ADT_List_ByStr20_with_contract_field_g_:_0x3620c286757a29985cee194eb90064270fb65414.AddressADT_end_62" }, %"$ParamDescr_1559" { %ParamDescrString { i8* getelementptr inbounds ([5 x i8], [5 x i8]* @"$tpname_pair1_1581", i32 0, i32 0), i32 5 }, %_TyDescrTy_Typ* @"$TyDescr_ADT_Pair_ByStr20_with_end_0x3620c286757a29985cee194eb90064270fb65414.AddressADT_66" }, %"$ParamDescr_1559" { %ParamDescrString { i8* getelementptr inbounds ([4 x i8], [4 x i8]* @"$tpname_adt1_1582", i32 0, i32 0), i32 4 }, %_TyDescrTy_Typ* @"$TyDescr_ADT_0x3620c286757a29985cee194eb90064270fb65414.AddressADT_69" }, %"$ParamDescr_1559" { %ParamDescrString { i8* getelementptr inbounds ([7 x i8], [7 x i8]* @"$tpname_remote1_1583", i32 0, i32 0), i32 7 }, %_TyDescrTy_Typ* @"$TyDescr_Addr_82" }]
@"$tname_RemoteReadsADTTest_1585" = unnamed_addr constant [18 x i8] c"RemoteReadsADTTest"
@"$tpname__amount_1586" = unnamed_addr constant [7 x i8] c"_amount"
@"$tpname__origin_1587" = unnamed_addr constant [7 x i8] c"_origin"
@"$tpname__sender_1588" = unnamed_addr constant [7 x i8] c"_sender"
@"$tparams_OutgoingMsgTest_1589" = unnamed_addr constant [3 x %"$ParamDescr_1559"] [%"$ParamDescr_1559" { %ParamDescrString { i8* getelementptr inbounds ([7 x i8], [7 x i8]* @"$tpname__amount_1586", i32 0, i32 0), i32 7 }, %_TyDescrTy_Typ* @"$TyDescr_Uint128_39" }, %"$ParamDescr_1559" { %ParamDescrString { i8* getelementptr inbounds ([7 x i8], [7 x i8]* @"$tpname__origin_1587", i32 0, i32 0), i32 7 }, %_TyDescrTy_Typ* @"$TyDescr_Addr_94" }, %"$ParamDescr_1559" { %ParamDescrString { i8* getelementptr inbounds ([7 x i8], [7 x i8]* @"$tpname__sender_1588", i32 0, i32 0), i32 7 }, %_TyDescrTy_Typ* @"$TyDescr_Addr_94" }]
@"$tname_OutgoingMsgTest_1590" = unnamed_addr constant [15 x i8] c"OutgoingMsgTest"
@"$tpname__amount_1591" = unnamed_addr constant [7 x i8] c"_amount"
@"$tpname__origin_1592" = unnamed_addr constant [7 x i8] c"_origin"
@"$tpname__sender_1593" = unnamed_addr constant [7 x i8] c"_sender"
@"$tparams_ExceptionTest_1594" = unnamed_addr constant [3 x %"$ParamDescr_1559"] [%"$ParamDescr_1559" { %ParamDescrString { i8* getelementptr inbounds ([7 x i8], [7 x i8]* @"$tpname__amount_1591", i32 0, i32 0), i32 7 }, %_TyDescrTy_Typ* @"$TyDescr_Uint128_39" }, %"$ParamDescr_1559" { %ParamDescrString { i8* getelementptr inbounds ([7 x i8], [7 x i8]* @"$tpname__origin_1592", i32 0, i32 0), i32 7 }, %_TyDescrTy_Typ* @"$TyDescr_Addr_94" }, %"$ParamDescr_1559" { %ParamDescrString { i8* getelementptr inbounds ([7 x i8], [7 x i8]* @"$tpname__sender_1593", i32 0, i32 0), i32 7 }, %_TyDescrTy_Typ* @"$TyDescr_Addr_94" }]
@"$tname_ExceptionTest_1595" = unnamed_addr constant [13 x i8] c"ExceptionTest"
@"$tpname__amount_1596" = unnamed_addr constant [7 x i8] c"_amount"
@"$tpname__origin_1597" = unnamed_addr constant [7 x i8] c"_origin"
@"$tpname__sender_1598" = unnamed_addr constant [7 x i8] c"_sender"
@"$tparams_AssignTest_1599" = unnamed_addr constant [3 x %"$ParamDescr_1559"] [%"$ParamDescr_1559" { %ParamDescrString { i8* getelementptr inbounds ([7 x i8], [7 x i8]* @"$tpname__amount_1596", i32 0, i32 0), i32 7 }, %_TyDescrTy_Typ* @"$TyDescr_Uint128_39" }, %"$ParamDescr_1559" { %ParamDescrString { i8* getelementptr inbounds ([7 x i8], [7 x i8]* @"$tpname__origin_1597", i32 0, i32 0), i32 7 }, %_TyDescrTy_Typ* @"$TyDescr_Addr_94" }, %"$ParamDescr_1559" { %ParamDescrString { i8* getelementptr inbounds ([7 x i8], [7 x i8]* @"$tpname__sender_1598", i32 0, i32 0), i32 7 }, %_TyDescrTy_Typ* @"$TyDescr_Addr_94" }]
@"$tname_AssignTest_1600" = unnamed_addr constant [10 x i8] c"AssignTest"
@"$tpname__amount_1601" = unnamed_addr constant [7 x i8] c"_amount"
@"$tpname__origin_1602" = unnamed_addr constant [7 x i8] c"_origin"
@"$tpname__sender_1603" = unnamed_addr constant [7 x i8] c"_sender"
@"$tparams_SenderBalanceTest_1604" = unnamed_addr constant [3 x %"$ParamDescr_1559"] [%"$ParamDescr_1559" { %ParamDescrString { i8* getelementptr inbounds ([7 x i8], [7 x i8]* @"$tpname__amount_1601", i32 0, i32 0), i32 7 }, %_TyDescrTy_Typ* @"$TyDescr_Uint128_39" }, %"$ParamDescr_1559" { %ParamDescrString { i8* getelementptr inbounds ([7 x i8], [7 x i8]* @"$tpname__origin_1602", i32 0, i32 0), i32 7 }, %_TyDescrTy_Typ* @"$TyDescr_Addr_94" }, %"$ParamDescr_1559" { %ParamDescrString { i8* getelementptr inbounds ([7 x i8], [7 x i8]* @"$tpname__sender_1603", i32 0, i32 0), i32 7 }, %_TyDescrTy_Typ* @"$TyDescr_Addr_94" }]
@"$tname_SenderBalanceTest_1605" = unnamed_addr constant [17 x i8] c"SenderBalanceTest"
@_transition_parameters = constant [6 x %"$TransDescr_1560"] [%"$TransDescr_1560" { %ParamDescrString { i8* getelementptr inbounds ([15 x i8], [15 x i8]* @"$tname_RemoteReadsTest_1574", i32 0, i32 0), i32 15 }, i32 6, %"$ParamDescr_1559"* getelementptr inbounds ([6 x %"$ParamDescr_1559"], [6 x %"$ParamDescr_1559"]* @"$tparams_RemoteReadsTest_1573", i32 0, i32 0) }, %"$TransDescr_1560" { %ParamDescrString { i8* getelementptr inbounds ([18 x i8], [18 x i8]* @"$tname_RemoteReadsADTTest_1585", i32 0, i32 0), i32 18 }, i32 9, %"$ParamDescr_1559"* getelementptr inbounds ([9 x %"$ParamDescr_1559"], [9 x %"$ParamDescr_1559"]* @"$tparams_RemoteReadsADTTest_1584", i32 0, i32 0) }, %"$TransDescr_1560" { %ParamDescrString { i8* getelementptr inbounds ([15 x i8], [15 x i8]* @"$tname_OutgoingMsgTest_1590", i32 0, i32 0), i32 15 }, i32 3, %"$ParamDescr_1559"* getelementptr inbounds ([3 x %"$ParamDescr_1559"], [3 x %"$ParamDescr_1559"]* @"$tparams_OutgoingMsgTest_1589", i32 0, i32 0) }, %"$TransDescr_1560" { %ParamDescrString { i8* getelementptr inbounds ([13 x i8], [13 x i8]* @"$tname_ExceptionTest_1595", i32 0, i32 0), i32 13 }, i32 3, %"$ParamDescr_1559"* getelementptr inbounds ([3 x %"$ParamDescr_1559"], [3 x %"$ParamDescr_1559"]* @"$tparams_ExceptionTest_1594", i32 0, i32 0) }, %"$TransDescr_1560" { %ParamDescrString { i8* getelementptr inbounds ([10 x i8], [10 x i8]* @"$tname_AssignTest_1600", i32 0, i32 0), i32 10 }, i32 3, %"$ParamDescr_1559"* getelementptr inbounds ([3 x %"$ParamDescr_1559"], [3 x %"$ParamDescr_1559"]* @"$tparams_AssignTest_1599", i32 0, i32 0) }, %"$TransDescr_1560" { %ParamDescrString { i8* getelementptr inbounds ([17 x i8], [17 x i8]* @"$tname_SenderBalanceTest_1605", i32 0, i32 0), i32 17 }, i32 3, %"$ParamDescr_1559"* getelementptr inbounds ([3 x %"$ParamDescr_1559"], [3 x %"$ParamDescr_1559"]* @"$tparams_SenderBalanceTest_1604", i32 0, i32 0) }]
...
"$have_gas_251":                                  ; preds = %"$out_of_gas_250", %entry
  ...
  store [20 x i8] %"$cparam3_253", [20 x i8]* %"$assign_test_1_0", align 1
  ...
  call void @_update_field(i8* %"$execptr_load_254", i8* getelementptr inbounds ([14 x i8], [14 x i8]* @"$assign_test_1_255", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Addr_92", i32 0, i8* null, i8* %"$update_value_258")
...
"$have_gas_262":                                  ; preds = %"$out_of_gas_261", %"$have_gas_251"
  ...
  store [20 x i8] %"$cparam3_264", [20 x i8]* %"$assign_test_2_1", align 1
  ...
  call void @_update_field(i8* %"$execptr_load_265", i8* getelementptr inbounds ([14 x i8], [14 x i8]* @"$assign_test_2_266", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Addr_92", i32 0, i8* null, i8* %"$update_value_269")
...
"$have_gas_273":                                  ; preds = %"$out_of_gas_272", %"$have_gas_262"
  ...
  store [20 x i8] %"$cparam3_275", [20 x i8]* %"$assign_test_3_2", align 1
  ...
  call void @_update_field(i8* %"$execptr_load_276", i8* getelementptr inbounds ([14 x i8], [14 x i8]* @"$assign_test_3_277", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Addr_92", i32 0, i8* null, i8* %"$update_value_280")
...
"$have_gas_284":                                  ; preds = %"$out_of_gas_283", %"$have_gas_273"
  ...
  store [20 x i8] %"$cparam3_286", [20 x i8]* %"$assign_test_4_3", align 1
  ...
  call void @_update_field(i8* %"$execptr_load_287", i8* getelementptr inbounds ([14 x i8], [14 x i8]* @"$assign_test_4_288", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Addr_92", i32 0, i8* null, i8* %"$update_value_291")
...
"$have_gas_295":                                  ; preds = %"$out_of_gas_294", %"$have_gas_284"
  ...
  store [20 x i8] %"$cparam3_297", [20 x i8]* %"$assign_test_5_4", align 1
  ...
  call void @_update_field(i8* %"$execptr_load_298", i8* getelementptr inbounds ([14 x i8], [14 x i8]* @"$assign_test_5_299", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Addr_92", i32 0, i8* null, i8* %"$update_value_302")
...
"$have_gas_306":                                  ; preds = %"$out_of_gas_305", %"$have_gas_295"
  ...
  store [20 x i8] %"$cparam3_308", [20 x i8]* %"$assign_test_6_5", align 1
  ...
  call void @_update_field(i8* %"$execptr_load_309", i8* getelementptr inbounds ([14 x i8], [14 x i8]* @"$assign_test_6_310", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Addr_92", i32 0, i8* null, i8* %"$update_value_313")
...
"$have_gas_317":                                  ; preds = %"$out_of_gas_316", %"$have_gas_306"
  ...
  store [20 x i8] %"$cparam3_319", [20 x i8]* %"$assign_test_7_6", align 1
  ...
  call void @_update_field(i8* %"$execptr_load_320", i8* getelementptr inbounds ([14 x i8], [14 x i8]* @"$assign_test_7_321", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Addr_92", i32 0, i8* null, i8* %"$update_value_324")
...
"$have_gas_328":                                  ; preds = %"$out_of_gas_327", %"$have_gas_317"
  ...
  store %TName_0x3620c286757a29985cee194eb90064270fb65414.AddressADT* %"$adtptr_334", %TName_0x3620c286757a29985cee194eb90064270fb65414.AddressADT** %"$assign_test_8_7", align 8
  ...
  call void @_update_field(i8* %"$execptr_load_335", i8* getelementptr inbounds ([14 x i8], [14 x i8]* @"$assign_test_8_336", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_ADT_0x3620c286757a29985cee194eb90064270fb65414.AddressADT_69", i32 0, i8* null, i8* %"$update_value_338")
...
"$have_gas_342":                                  ; preds = %"$out_of_gas_341", %"$have_gas_328"
  ...
  store %TName_List_0x3620c286757a29985cee194eb90064270fb65414.AddressADT* %"$adtptr_346", %TName_List_0x3620c286757a29985cee194eb90064270fb65414.AddressADT** %"$assign_test_9_8", align 8
  ...
  call void @_update_field(i8* %"$execptr_load_347", i8* getelementptr inbounds ([14 x i8], [14 x i8]* @"$assign_test_9_348", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_ADT_List_0x3620c286757a29985cee194eb90064270fb65414.AddressADT_65", i32 0, i8* null, i8* %"$update_value_350")
...
"$have_gas_354":                                  ; preds = %"$out_of_gas_353", %"$have_gas_342"
  ...
  store %"Map_Uint128_Map_(Uint128)_(0x3620c286757a29985cee194eb90064270fb65414.AddressADT)"* %"$_new_empty_map_358", %"Map_Uint128_Map_(Uint128)_(0x3620c286757a29985cee194eb90064270fb65414.AddressADT)"** %"$assign_test_10_9", align 8
  ...
  call void @_update_field(i8* %"$execptr_load_359", i8* getelementptr inbounds ([15 x i8], [15 x i8]* @"$assign_test_10_360", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_73", i32 0, i8* null, i8* %"$update_value_362")
...
"$have_gas_366":                                  ; preds = %"$out_of_gas_365", %"$have_gas_354"
  ...
  store %Uint128 zeroinitializer, %Uint128* %"$remote_reads_test_res_1_1_10", align 8
  ...
  call void @_update_field(i8* %"$execptr_load_368", i8* getelementptr inbounds ([26 x i8], [26 x i8]* @"$remote_reads_test_res_1_1_369", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Uint128_39", i32 0, i8* null, i8* %"$update_value_372")
...
"$have_gas_376":                                  ; preds = %"$out_of_gas_375", %"$have_gas_366"
  ...
  store %Uint128 zeroinitializer, %Uint128* %"$remote_reads_test_res_2_1_11", align 8
  ...
  call void @_update_field(i8* %"$execptr_load_378", i8* getelementptr inbounds ([26 x i8], [26 x i8]* @"$remote_reads_test_res_2_1_379", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Uint128_39", i32 0, i8* null, i8* %"$update_value_382")
...
"$have_gas_386":                                  ; preds = %"$out_of_gas_385", %"$have_gas_376"
  ...
  store %Uint128 zeroinitializer, %Uint128* %"$remote_reads_test_res_3_1_12", align 8
  ...
  call void @_update_field(i8* %"$execptr_load_388", i8* getelementptr inbounds ([26 x i8], [26 x i8]* @"$remote_reads_test_res_3_1_389", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Uint128_39", i32 0, i8* null, i8* %"$update_value_392")
...
"$have_gas_396":                                  ; preds = %"$out_of_gas_395", %"$have_gas_386"
  ...
  store %Uint32 zeroinitializer, %Uint32* %"$remote_reads_test_res_3_3_13", align 4
  ...
  call void @_update_field(i8* %"$execptr_load_398", i8* getelementptr inbounds ([26 x i8], [26 x i8]* @"$remote_reads_test_res_3_3_399", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Uint32_31", i32 0, i8* null, i8* %"$update_value_402")
...
"$have_gas_406":                                  ; preds = %"$out_of_gas_405", %"$have_gas_396"
  ...
  store [20 x i8] %"$cparam3_408", [20 x i8]* %"$remote_reads_test_res_3_4_14", align 1
  ...
  call void @_update_field(i8* %"$execptr_load_409", i8* getelementptr inbounds ([26 x i8], [26 x i8]* @"$remote_reads_test_res_3_4_410", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Addr_92", i32 0, i8* null, i8* %"$update_value_413")
...
"$have_gas_417":                                  ; preds = %"$out_of_gas_416", %"$have_gas_406"
  ...
  store %Uint128 zeroinitializer, %Uint128* %"$remote_reads_test_res_3_5_15", align 8
  ...
  call void @_update_field(i8* %"$execptr_load_419", i8* getelementptr inbounds ([26 x i8], [26 x i8]* @"$remote_reads_test_res_3_5_420", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Uint128_39", i32 0, i8* null, i8* %"$update_value_423")
...
"$have_gas_427":                                  ; preds = %"$out_of_gas_426", %"$have_gas_417"
  ...
  store %Map_ByStr20_with_end_Bool* %"$_new_empty_map_431", %Map_ByStr20_with_end_Bool** %"$remote_reads_test_res_3_6_16", align 8
  ...
  call void @_update_field(i8* %"$execptr_load_432", i8* getelementptr inbounds ([26 x i8], [26 x i8]* @"$remote_reads_test_res_3_6_433", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_78", i32 0, i8* null, i8* %"$update_value_435")
...
"$have_gas_439":                                  ; preds = %"$out_of_gas_438", %"$have_gas_427"
  ...
  store %TName_Bool* %"$adtptr_443", %TName_Bool** %"$remote_reads_test_res_3_7_17", align 8
  ...
  call void @_update_field(i8* %"$execptr_load_444", i8* getelementptr inbounds ([26 x i8], [26 x i8]* @"$remote_reads_test_res_3_7_445", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_ADT_Bool_70", i32 0, i8* null, i8* %"$update_value_447")
...
"$have_gas_456":                                  ; preds = %"$out_of_gas_455", %"$have_gas_451"
  ...
  store %TName_Bool* %"$adtptr_460", %TName_Bool** %x, align 8
...
"$have_gas_464":                                  ; preds = %"$out_of_gas_463", %"$have_gas_456"
  ...
  store %TName_Option_Bool* %"$adtptr_470", %TName_Option_Bool** %"$remote_reads_test_res_3_8_18", align 8
  ...
  call void @_update_field(i8* %"$execptr_load_471", i8* getelementptr inbounds ([26 x i8], [26 x i8]* @"$remote_reads_test_res_3_8_472", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_ADT_Option_Bool_68", i32 0, i8* null, i8* %"$update_value_474")
...
"$have_gas_478":                                  ; preds = %"$out_of_gas_477", %"$have_gas_464"
  ...
  store %"Map_Uint32_Map_(ByStr20_with_end)_(Bool)"* %"$_new_empty_map_482", %"Map_Uint32_Map_(ByStr20_with_end)_(Bool)"** %"$remote_reads_test_res_3_9_19", align 8
  ...
  call void @_update_field(i8* %"$execptr_load_483", i8* getelementptr inbounds ([26 x i8], [26 x i8]* @"$remote_reads_test_res_3_9_484", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_77", i32 0, i8* null, i8* %"$update_value_486")
...
"$have_gas_490":                                  ; preds = %"$out_of_gas_489", %"$have_gas_478"
  ...
  store %TName_Bool* %"$adtptr_494", %TName_Bool** %"$remote_reads_test_res_3_10_20", align 8
  ...
  call void @_update_field(i8* %"$execptr_load_495", i8* getelementptr inbounds ([27 x i8], [27 x i8]* @"$remote_reads_test_res_3_10_496", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_ADT_Bool_70", i32 0, i8* null, i8* %"$update_value_498")
...
"$have_gas_502":                                  ; preds = %"$out_of_gas_501", %"$have_gas_490"
  ...
  store %"TName_Option_Map_(ByStr20_with_end)_(Bool)"* %"$adtptr_506", %"TName_Option_Map_(ByStr20_with_end)_(Bool)"** %"$remote_reads_test_res_3_11_21", align 8
  ...
  call void @_update_field(i8* %"$execptr_load_507", i8* getelementptr inbounds ([27 x i8], [27 x i8]* @"$remote_reads_test_res_3_11_508", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_ADT_Option_Map_(ByStr20_with_end)_(Bool)_67", i32 0, i8* null, i8* %"$update_value_510")
...
"$have_gas_514":                                  ; preds = %"$out_of_gas_513", %"$have_gas_502"
  ...
  store %TName_Bool* %"$adtptr_518", %TName_Bool** %"$remote_reads_test_res_3_12_22", align 8
  ...
  call void @_update_field(i8* %"$execptr_load_519", i8* getelementptr inbounds ([27 x i8], [27 x i8]* @"$remote_reads_test_res_3_12_520", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_ADT_Bool_70", i32 0, i8* null, i8* %"$update_value_522")
...
"$have_gas_526":                                  ; preds = %"$out_of_gas_525", %"$have_gas_514"
  ...
  store %TName_Option_Bool* %"$adtptr_530", %TName_Option_Bool** %"$remote_reads_test_res_3_13_23", align 8
  ...
  call void @_update_field(i8* %"$execptr_load_531", i8* getelementptr inbounds ([27 x i8], [27 x i8]* @"$remote_reads_test_res_3_13_532", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_ADT_Option_Bool_68", i32 0, i8* null, i8* %"$update_value_534")
...
"$have_gas_538":                                  ; preds = %"$out_of_gas_537", %"$have_gas_526"
  ...
  store %Uint128 zeroinitializer, %Uint128* %"$sender_balance_pre_24", align 8
  ...
  call void @_update_field(i8* %"$execptr_load_540", i8* getelementptr inbounds ([19 x i8], [19 x i8]* @"$sender_balance_pre_541", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Uint128_39", i32 0, i8* null, i8* %"$update_value_544")
...
"$have_gas_548":                                  ; preds = %"$out_of_gas_547", %"$have_gas_538"
  ...
  store %Uint128 zeroinitializer, %Uint128* %"$sender_balance_mid_25", align 8
  ...
  call void @_update_field(i8* %"$execptr_load_550", i8* getelementptr inbounds ([19 x i8], [19 x i8]* @"$sender_balance_mid_551", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Uint128_39", i32 0, i8* null, i8* %"$update_value_554")
...
"$have_gas_558":                                  ; preds = %"$out_of_gas_557", %"$have_gas_548"
  ...
  store %Uint128 zeroinitializer, %Uint128* %"$sender_balance_post_26", align 8
  ...
  call void @_update_field(i8* %"$execptr_load_560", i8* getelementptr inbounds ([20 x i8], [20 x i8]* @"$sender_balance_post_561", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Uint128_39", i32 0, i8* null, i8* %"$update_value_564")
  ret void
}
...
define internal void @"$RemoteReadsTest_565"(%Uint128 %_amount, [20 x i8]* %"$_origin_566", [20 x i8]* %"$_sender_567", [20 x i8]* %"$remote1_568", [20 x i8]* %"$remote2_569", [20 x i8]* %"$remote3_570") {
entry:
  ...
  %"$tmp_1_1_call_574" = call i8* @_fetch_remote_field(i8* %"$execptr_load_572", [20 x i8]* %"$tmp_1_1_remote1_573", i8* getelementptr inbounds ([9 x i8], [9 x i8]* @"$_balance_571", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Uint128_39", i32 0, i8* null, i32 1)
...
"$have_gas_594":                                  ; preds = %"$out_of_gas_593", %"$have_gas_585"
  ...
  call void @_update_field(i8* %"$execptr_load_596", i8* getelementptr inbounds ([26 x i8], [26 x i8]* @"$remote_reads_test_res_1_1_597", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Uint128_39", i32 0, i8* null, i8* %"$update_value_600")
  ...
  %"$tmp_2_1_call_604" = call i8* @_fetch_remote_field(i8* %"$execptr_load_602", [20 x i8]* %"$tmp_2_1_remote2_603", i8* getelementptr inbounds ([9 x i8], [9 x i8]* @"$_balance_601", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Uint128_39", i32 0, i8* null, i32 1)
...
"$have_gas_624":                                  ; preds = %"$out_of_gas_623", %"$have_gas_615"
  ...
  call void @_update_field(i8* %"$execptr_load_626", i8* getelementptr inbounds ([26 x i8], [26 x i8]* @"$remote_reads_test_res_2_1_627", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Uint128_39", i32 0, i8* null, i8* %"$update_value_630")
  ...
  %"$tmp_3_1_call_634" = call i8* @_fetch_remote_field(i8* %"$execptr_load_632", [20 x i8]* %"$tmp_3_1_remote3_633", i8* getelementptr inbounds ([9 x i8], [9 x i8]* @"$_balance_631", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Uint128_39", i32 0, i8* null, i32 1)
...
"$have_gas_654":                                  ; preds = %"$out_of_gas_653", %"$have_gas_645"
  ...
  call void @_update_field(i8* %"$execptr_load_656", i8* getelementptr inbounds ([26 x i8], [26 x i8]* @"$remote_reads_test_res_3_1_657", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Uint128_39", i32 0, i8* null, i8* %"$update_value_660")
  ...
  %"$tmp_3_3_call_664" = call i8* @_fetch_remote_field(i8* %"$execptr_load_662", [20 x i8]* %"$tmp_3_3_remote3_663", i8* getelementptr inbounds ([17 x i8], [17 x i8]* @"$transactionCount_661", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Uint32_31", i32 0, i8* null, i32 1)
...
"$have_gas_684":                                  ; preds = %"$out_of_gas_683", %"$have_gas_675"
  ...
  call void @_update_field(i8* %"$execptr_load_686", i8* getelementptr inbounds ([26 x i8], [26 x i8]* @"$remote_reads_test_res_3_3_687", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Uint32_31", i32 0, i8* null, i8* %"$update_value_690")
  ...
  %"$tmp_3_4_call_694" = call i8* @_fetch_remote_field(i8* %"$execptr_load_692", [20 x i8]* %"$tmp_3_4_remote3_693", i8* getelementptr inbounds ([6 x i8], [6 x i8]* @"$admin_691", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Addr_94", i32 0, i8* null, i32 1)
...
"$have_gas_714":                                  ; preds = %"$out_of_gas_713", %"$have_gas_705"
  ...
  call void @_update_field(i8* %"$execptr_load_716", i8* getelementptr inbounds ([26 x i8], [26 x i8]* @"$remote_reads_test_res_3_4_717", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Addr_94", i32 0, i8* null, i8* %"$update_value_720")
  ...
  %"$tmp_3_5_call_725" = call i8* @_fetch_remote_field(i8* %"$execptr_load_722", [20 x i8]* %"$tmp_3_5_tmp_3_4_723", i8* getelementptr inbounds ([9 x i8], [9 x i8]* @"$_balance_721", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Uint128_39", i32 0, i8* null, i32 1)
...
"$have_gas_745":                                  ; preds = %"$out_of_gas_744", %"$have_gas_736"
  ...
  call void @_update_field(i8* %"$execptr_load_747", i8* getelementptr inbounds ([26 x i8], [26 x i8]* @"$remote_reads_test_res_3_5_748", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Uint128_39", i32 0, i8* null, i8* %"$update_value_751")
  ...
  %"$tmp_3_6_call_755" = call i8* @_fetch_remote_field(i8* %"$execptr_load_753", [20 x i8]* %"$tmp_3_6_remote3_754", i8* getelementptr inbounds ([7 x i8], [7 x i8]* @"$owners_752", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_78", i32 0, i8* null, i32 1)
...
"$have_gas_775":                                  ; preds = %"$out_of_gas_774", %"$have_gas_767"
  ...
  call void @_update_field(i8* %"$execptr_load_777", i8* getelementptr inbounds ([26 x i8], [26 x i8]* @"$remote_reads_test_res_3_6_778", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_78", i32 0, i8* null, i8* %"$update_value_780")
  ...
  %"$tmp_3_7_call_786" = call i8* @_fetch_remote_field(i8* %"$execptr_load_784", [20 x i8]* %"$tmp_3_7_remote3_785", i8* getelementptr inbounds ([7 x i8], [7 x i8]* @"$owners_783", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_78", i32 1, i8* %"$indices_buf_781", i32 0)
...
"$have_gas_804":                                  ; preds = %"$out_of_gas_803", %"$have_gas_796"
  ...
  call void @_update_field(i8* %"$execptr_load_806", i8* getelementptr inbounds ([26 x i8], [26 x i8]* @"$remote_reads_test_res_3_7_807", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_ADT_Bool_70", i32 0, i8* null, i8* %"$update_value_809")
  ...
  %"$tmp_3_8_call_815" = call i8* @_fetch_remote_field(i8* %"$execptr_load_813", [20 x i8]* %"$tmp_3_8_remote3_814", i8* getelementptr inbounds ([7 x i8], [7 x i8]* @"$owners_812", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_78", i32 1, i8* %"$indices_buf_810", i32 1)
...
"$have_gas_833":                                  ; preds = %"$out_of_gas_832", %"$have_gas_825"
  ...
  call void @_update_field(i8* %"$execptr_load_835", i8* getelementptr inbounds ([26 x i8], [26 x i8]* @"$remote_reads_test_res_3_8_836", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_ADT_Option_Bool_68", i32 0, i8* null, i8* %"$update_value_838")
  ...
  %"$tmp_3_9_call_842" = call i8* @_fetch_remote_field(i8* %"$execptr_load_840", [20 x i8]* %"$tmp_3_9_remote3_841", i8* getelementptr inbounds ([11 x i8], [11 x i8]* @"$signatures_839", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_77", i32 0, i8* null, i32 1)
...
"$have_gas_862":                                  ; preds = %"$out_of_gas_861", %"$have_gas_854"
  ...
  call void @_update_field(i8* %"$execptr_load_864", i8* getelementptr inbounds ([26 x i8], [26 x i8]* @"$remote_reads_test_res_3_9_865", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_77", i32 0, i8* null, i8* %"$update_value_867")
...
"$have_gas_876":                                  ; preds = %"$out_of_gas_875", %"$have_gas_871"
  ...
  store %Uint32 zeroinitializer, %Uint32* %x, align 4
  ...
  %"$tmp_3_10_call_884" = call i8* @_fetch_remote_field(i8* %"$execptr_load_882", [20 x i8]* %"$tmp_3_10_remote3_883", i8* getelementptr inbounds ([11 x i8], [11 x i8]* @"$signatures_881", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_77", i32 1, i8* %"$indices_buf_878", i32 0)
...
"$have_gas_902":                                  ; preds = %"$out_of_gas_901", %"$have_gas_894"
  ...
  call void @_update_field(i8* %"$execptr_load_904", i8* getelementptr inbounds ([27 x i8], [27 x i8]* @"$remote_reads_test_res_3_10_905", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_ADT_Bool_70", i32 0, i8* null, i8* %"$update_value_907")
  ...
  %"$tmp_3_11_call_914" = call i8* @_fetch_remote_field(i8* %"$execptr_load_912", [20 x i8]* %"$tmp_3_11_remote3_913", i8* getelementptr inbounds ([11 x i8], [11 x i8]* @"$signatures_911", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_77", i32 1, i8* %"$indices_buf_908", i32 1)
...
"$have_gas_932":                                  ; preds = %"$out_of_gas_931", %"$have_gas_924"
  ...
  call void @_update_field(i8* %"$execptr_load_934", i8* getelementptr inbounds ([27 x i8], [27 x i8]* @"$remote_reads_test_res_3_11_935", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_ADT_Option_Map_(ByStr20_with_end)_(Bool)_67", i32 0, i8* null, i8* %"$update_value_937")
  ...
  %"$tmp_3_12_call_945" = call i8* @_fetch_remote_field(i8* %"$execptr_load_943", [20 x i8]* %"$tmp_3_12_remote3_944", i8* getelementptr inbounds ([11 x i8], [11 x i8]* @"$signatures_942", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_77", i32 2, i8* %"$indices_buf_938", i32 0)
...
"$have_gas_963":                                  ; preds = %"$out_of_gas_962", %"$have_gas_955"
  ...
  call void @_update_field(i8* %"$execptr_load_965", i8* getelementptr inbounds ([27 x i8], [27 x i8]* @"$remote_reads_test_res_3_12_966", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_ADT_Bool_70", i32 0, i8* null, i8* %"$update_value_968")
  ...
  %"$tmp_3_13_call_976" = call i8* @_fetch_remote_field(i8* %"$execptr_load_974", [20 x i8]* %"$tmp_3_13_remote3_975", i8* getelementptr inbounds ([11 x i8], [11 x i8]* @"$signatures_973", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_77", i32 2, i8* %"$indices_buf_969", i32 1)
...
"$have_gas_994":                                  ; preds = %"$out_of_gas_993", %"$have_gas_986"
  ...
  call void @_update_field(i8* %"$execptr_load_996", i8* getelementptr inbounds ([27 x i8], [27 x i8]* @"$remote_reads_test_res_3_13_997", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_ADT_Option_Bool_68", i32 0, i8* null, i8* %"$update_value_999")
  ret void
}
...
"$have_gas_1047":                                 ; preds = %"$out_of_gas_1046", %"$have_gas_1042"
  ...
  store %_TyDescrTy_Typ* @"$TyDescr_Bystr20_57", %_TyDescrTy_Typ** %"$msgobj_td_1062", align 8
  ...
  store %_TyDescrTy_Typ* @"$TyDescr_Bystr20_57", %_TyDescrTy_Typ** %"$msgobj_td_1076", align 8
  ...
  store i8* %"$msgobj_1049", i8** %msg, align 8
...
"$have_gas_1094":                                 ; preds = %"$out_of_gas_1093", %"$have_gas_1089"
  ...
  store %TName_List_Message* %"$adtptr_1098", %TName_List_Message** %n, align 8
...
"$have_gas_1102":                                 ; preds = %"$out_of_gas_1101", %"$have_gas_1094"
  ...
  store %TName_List_Message* %"$adtptr_1110", %TName_List_Message** %msgs, align 8
...
"$have_gas_1117":                                 ; preds = %"$out_of_gas_1116", %"$have_gas_1102"
  ...
  call void @_send(i8* %"$execptr_load_1119", %_TyDescrTy_Typ* @"$TyDescr_ADT_List_Message_61", %TName_List_Message* %"$msgs_1120")
...
"$have_gas_1129":                                 ; preds = %"$out_of_gas_1128", %"$have_gas_1124"
  ...
  store %_TyDescrTy_Typ* @"$TyDescr_Bystr20_57", %_TyDescrTy_Typ** %"$msgobj_td_1144", align 8
  ...
  store i8* %"$msgobj_1131", i8** %e1, align 8
...
"$have_gas_1155":                                 ; preds = %"$out_of_gas_1154", %"$have_gas_1129"
  ...
  call void @_event(i8* %"$execptr_load_1157", %_TyDescrTy_Typ* @"$TyDescr_Event_51", i8* %"$e1_1158")
...
"$have_gas_1167":                                 ; preds = %"$out_of_gas_1166", %"$have_gas_1162"
  ...
  store %_TyDescrTy_Typ* @"$TyDescr_Bystr20_57", %_TyDescrTy_Typ** %"$msgobj_td_1182", align 8
  ...
  store i8* %"$msgobj_1169", i8** %e2, align 8
...
"$have_gas_1193":                                 ; preds = %"$out_of_gas_1192", %"$have_gas_1167"
  ...
  call void @_event(i8* %"$execptr_load_1195", %_TyDescrTy_Typ* @"$TyDescr_Event_51", i8* %"$e2_1196")
  ret void
}
...
entry:
  ...
  call void @"$OutgoingMsgTest_1036"(%Uint128 %_amount, [20 x i8]* %"$_origin_1201", [20 x i8]* %"$_sender_1203")
  ret void
}

define internal void @"$ExceptionTest_1204"(%Uint128 %_amount, [20 x i8]* %"$_origin_1205", [20 x i8]* %"$_sender_1206") {
entry:
...
"$have_gas_1215":                                 ; preds = %"$out_of_gas_1214", %"$have_gas_1210"
  ...
  store %_TyDescrTy_Typ* @"$TyDescr_Bystr20_57", %_TyDescrTy_Typ** %"$msgobj_td_1230", align 8
  ...
  store i8* %"$msgobj_1217", i8** %e, align 8
...
"$have_gas_1241":                                 ; preds = %"$out_of_gas_1240", %"$have_gas_1215"
  ...
  call void @_throw(i8* %"$execptr_load_1243", %_TyDescrTy_Typ* @"$TyDescr_Exception_53", i8* %"$e_1244")
  ret void
}
...
entry:
  ...
  call void @"$ExceptionTest_1204"(%Uint128 %_amount, [20 x i8]* %"$_origin_1249", [20 x i8]* %"$_sender_1251")
  ret void
}

define internal void @"$AssignTest_1252"(%Uint128 %_amount, [20 x i8]* %"$_origin_1253", [20 x i8]* %"$_sender_1254") {
entry:
...
"$have_gas_1263":                                 ; preds = %"$out_of_gas_1262", %"$have_gas_1258"
  ...
  store %TName_0x3620c286757a29985cee194eb90064270fb65414.AddressADT* %"$adtptr_1269", %TName_0x3620c286757a29985cee194eb90064270fb65414.AddressADT** %x, align 8
...
"$have_gas_1276":                                 ; preds = %"$out_of_gas_1275", %"$have_gas_1263"
  ...
  call void @_update_field(i8* %"$execptr_load_1278", i8* getelementptr inbounds ([14 x i8], [14 x i8]* @"$assign_test_8_1279", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_ADT_0x3620c286757a29985cee194eb90064270fb65414.AddressADT_69", i32 0, i8* null, i8* %"$update_value_1281")
...
"$have_gas_1295":                                 ; preds = %"$out_of_gas_1294", %"$have_gas_1290"
  ...
  store %TName_List_0x3620c286757a29985cee194eb90064270fb65414.AddressADT* %"$adtptr_1299", %TName_List_0x3620c286757a29985cee194eb90064270fb65414.AddressADT** %n, align 8
...
"$have_gas_1303":                                 ; preds = %"$out_of_gas_1302", %"$have_gas_1295"
  ...
  store %TName_List_0x3620c286757a29985cee194eb90064270fb65414.AddressADT* %"$adtptr_1311", %TName_List_0x3620c286757a29985cee194eb90064270fb65414.AddressADT** %y, align 8
...
"$have_gas_1318":                                 ; preds = %"$out_of_gas_1317", %"$have_gas_1303"
  ...
  call void @_update_field(i8* %"$execptr_load_1320", i8* getelementptr inbounds ([14 x i8], [14 x i8]* @"$assign_test_9_1321", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_ADT_List_0x3620c286757a29985cee194eb90064270fb65414.AddressADT_65", i32 0, i8* null, i8* %"$update_value_1323")
...
"$have_gas_1337":                                 ; preds = %"$out_of_gas_1336", %"$have_gas_1332"
  ...
  store %"Map_Uint128_Map_(Uint128)_(0x3620c286757a29985cee194eb90064270fb65414.AddressADT)"* %"$_new_empty_map_1341", %"Map_Uint128_Map_(Uint128)_(0x3620c286757a29985cee194eb90064270fb65414.AddressADT)"** %n1, align 8
...
"$have_gas_1350":                                 ; preds = %"$out_of_gas_1349", %"$have_gas_1345"
  ...
  store %Map_Uint128_0x3620c286757a29985cee194eb90064270fb65414.AddressADT* %"$_new_empty_map_1354", %Map_Uint128_0x3620c286757a29985cee194eb90064270fb65414.AddressADT** %sub_n, align 8
...
"$have_gas_1368":                                 ; preds = %"$out_of_gas_1367", %"$have_gas_1363"
  ...
  store %Map_Uint128_0x3620c286757a29985cee194eb90064270fb65414.AddressADT* %"$put_1379", %Map_Uint128_0x3620c286757a29985cee194eb90064270fb65414.AddressADT** %sub_res, align 8
  ...
  store %"Map_Uint128_Map_(Uint128)_(0x3620c286757a29985cee194eb90064270fb65414.AddressADT)"* %"$put_1389", %"Map_Uint128_Map_(Uint128)_(0x3620c286757a29985cee194eb90064270fb65414.AddressADT)"** %z, align 8
...
"$have_gas_1396":                                 ; preds = %"$out_of_gas_1395", %"$have_gas_1368"
  ...
  call void @_update_field(i8* %"$execptr_load_1398", i8* getelementptr inbounds ([15 x i8], [15 x i8]* @"$assign_test_10_1399", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_73", i32 0, i8* null, i8* %"$update_value_1401")
...
"$have_gas_1429":                                 ; preds = %"$out_of_gas_1428", %"$have_gas_1420"
  ...
  call void @_update_field(i8* %"$execptr_load_1436", i8* getelementptr inbounds ([15 x i8], [15 x i8]* @"$assign_test_10_1437", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_73", i32 2, i8* %"$indices_buf_1431", i8* %"$update_value_1439")
  ret void
}
...
entry:
  ...
  call void @"$AssignTest_1252"(%Uint128 %_amount, [20 x i8]* %"$_origin_1444", [20 x i8]* %"$_sender_1446")
  ret void
}

define internal void @"$SenderBalanceTest_1447"(%Uint128 %_amount, [20 x i8]* %"$_origin_1448", [20 x i8]* %"$_sender_1449") {
entry:
  ...
  %"$pre_call_1453" = call i8* @_fetch_remote_field(i8* %"$execptr_load_1451", [20 x i8]* %"$pre__sender_1452", i8* getelementptr inbounds ([9 x i8], [9 x i8]* @"$_balance_1450", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Uint128_39", i32 0, i8* null, i32 1)
...
"$have_gas_1473":                                 ; preds = %"$out_of_gas_1472", %"$have_gas_1464"
  ...
  call void @_update_field(i8* %"$execptr_load_1475", i8* getelementptr inbounds ([19 x i8], [19 x i8]* @"$sender_balance_pre_1476", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Uint128_39", i32 0, i8* null, i8* %"$update_value_1479")
...
"$have_gas_1483":                                 ; preds = %"$out_of_gas_1482", %"$have_gas_1473"
  ...
  call void @_accept(i8* %"$execptr_load_1485")
  ...
  %"$mid_call_1489" = call i8* @_fetch_remote_field(i8* %"$execptr_load_1487", [20 x i8]* %"$mid__sender_1488", i8* getelementptr inbounds ([9 x i8], [9 x i8]* @"$_balance_1486", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Uint128_39", i32 0, i8* null, i32 1)
...
"$have_gas_1509":                                 ; preds = %"$out_of_gas_1508", %"$have_gas_1500"
  ...
  call void @_update_field(i8* %"$execptr_load_1511", i8* getelementptr inbounds ([19 x i8], [19 x i8]* @"$sender_balance_mid_1512", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Uint128_39", i32 0, i8* null, i8* %"$update_value_1515")
...
"$have_gas_1519":                                 ; preds = %"$out_of_gas_1518", %"$have_gas_1509"
  ...
  call void @_accept(i8* %"$execptr_load_1521")
  ...
  %"$post_call_1525" = call i8* @_fetch_remote_field(i8* %"$execptr_load_1523", [20 x i8]* %"$post__sender_1524", i8* getelementptr inbounds ([9 x i8], [9 x i8]* @"$_balance_1522", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Uint128_39", i32 0, i8* null, i32 1)
...
"$have_gas_1545":                                 ; preds = %"$out_of_gas_1544", %"$have_gas_1536"
  ...
  call void @_update_field(i8* %"$execptr_load_1547", i8* getelementptr inbounds ([20 x i8], [20 x i8]* @"$sender_balance_post_1548", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Uint128_39", i32 0, i8* null, i8* %"$update_value_1551")
  ret void
}
...
entry:
  ...
  call void @"$SenderBalanceTest_1447"(%Uint128 %_amount, [20 x i8]* %"$_origin_1556", [20 x i8]* %"$_sender_1558")
  ret void
}
