...
"$have_gas_2188":                                 ; preds = %"$out_of_gas_2187", %entry
  ...
  %"$eq_call_2197" = call %TName_Bool* @_eq_ByStrX(i8* %"$execptr_load_2190", i32 20, i8* %"$$eq_sender_2191_2193", i8* %"$$eq_recordOwner_2194_2196")
  store %TName_Bool* %"$eq_call_2197", %TName_Bool** %isOwner, align 8
...
"$have_gas_2219":                                 ; preds = %"$out_of_gas_2218", %"$None_2214"
  ...
  store %TName_Bool* %"$adtptr_2223", %TName_Bool** %isApproved, align 8
...
"$Some_2224":                                     ; preds = %"$have_gas_2207"
  ...
  %"$eq_call_2235" = call %TName_Bool* @_eq_ByStrX(i8* %"$execptr_load_2228", i32 20, i8* %"$$eq_sender_2229_2231", i8* %"$$eq_approved_2232_2234")
  store %TName_Bool* %"$eq_call_2235", %TName_Bool** %isApproved, align 8
  br label %"$matchsucc_2209"
...
"$have_gas_2256":                                 ; preds = %"$out_of_gas_2255", %"$None_2251"
  ...
  store %TName_Bool* %"$adtptr_2260", %TName_Bool** %isOperator, align 8
...
"$have_gas_2268":                                 ; preds = %"$out_of_gas_2267", %"$Some_2261"
  ...
  %"$ud-registry.listByStr20Contains_call_2274" = call { %TName_Bool* (i8*, [20 x i8]*)*, i8* } %"$ud-registry.listByStr20Contains_fptr_2271"(i8* %"$ud-registry.listByStr20Contains_envptr_2272", %TName_List_ByStr20* %"$operators_2273")
  store { %TName_Bool* (i8*, [20 x i8]*)*, i8* } %"$ud-registry.listByStr20Contains_call_2274", { %TName_Bool* (i8*, [20 x i8]*)*, i8* }* %"$ud-registry.listByStr20Contains_39", align 8
  ...
  %"$$ud-registry.listByStr20Contains_39_call_2280" = call %TName_Bool* %"$$ud-registry.listByStr20Contains_39_fptr_2276"(i8* %"$$ud-registry.listByStr20Contains_39_envptr_2277", [20 x i8]* %"$$ud-registry.listByStr20Contains_39_sender_2278")
  store %TName_Bool* %"$$ud-registry.listByStr20Contains_39_call_2280", %TName_Bool** %"$ud-registry.listByStr20Contains_40", align 8
  %"$$ud-registry.listByStr20Contains_40_2281" = load %TName_Bool*, %TName_Bool** %"$ud-registry.listByStr20Contains_40", align 8
  store %TName_Bool* %"$$ud-registry.listByStr20Contains_40_2281", %TName_Bool** %isOperator, align 8
  br label %"$matchsucc_2247"
...
"$have_gas_2290":                                 ; preds = %"$out_of_gas_2289", %"$have_gas_2285"
  ...
  %"$BoolUtils.orb_call_2296" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.orb_fptr_2293"(i8* %"$BoolUtils.orb_envptr_2294", %TName_Bool* %"$isOwner_2295")
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.orb_call_2296", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.orb_41", align 8
  ...
  %"$$BoolUtils.orb_41_call_2301" = call %TName_Bool* %"$$BoolUtils.orb_41_fptr_2298"(i8* %"$$BoolUtils.orb_41_envptr_2299", %TName_Bool* %"$isApproved_2300")
  store %TName_Bool* %"$$BoolUtils.orb_41_call_2301", %TName_Bool** %"$BoolUtils.orb_42", align 8
  %"$$BoolUtils.orb_42_2302" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.orb_42", align 8
  store %TName_Bool* %"$$BoolUtils.orb_42_2302", %TName_Bool** %b1, align 8
...
"$have_gas_2306":                                 ; preds = %"$out_of_gas_2305", %"$have_gas_2290"
  ...
  %"$BoolUtils.orb_call_2312" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.orb_fptr_2309"(i8* %"$BoolUtils.orb_envptr_2310", %TName_Bool* %"$b1_2311")
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.orb_call_2312", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.orb_43", align 8
  ...
  %"$$BoolUtils.orb_43_call_2317" = call %TName_Bool* %"$$BoolUtils.orb_43_fptr_2314"(i8* %"$$BoolUtils.orb_43_envptr_2315", %TName_Bool* %"$isOperator_2316")
  store %TName_Bool* %"$$BoolUtils.orb_43_call_2317", %TName_Bool** %"$BoolUtils.orb_44", align 8
  %"$$BoolUtils.orb_44_2318" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.orb_44", align 8
  store %TName_Bool* %"$$BoolUtils.orb_44_2318", %TName_Bool** %"$retval_215", align 8
...
"$have_gas_2159":                                 ; preds = %"$out_of_gas_2158", %entry
  ...
  store { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* } %"$$fundef_214_cloval_2164", { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* }* %"$retval_213", align 8
...
"$have_gas_2134":                                 ; preds = %"$out_of_gas_2133", %entry
  ...
  store { { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* } (i8*, %TName_Option_ByStr20*)*, i8* } %"$$fundef_212_cloval_2139", { { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* } (i8*, %TName_Option_ByStr20*)*, i8* }* %"$retval_211", align 8
...
"$have_gas_2113":                                 ; preds = %"$out_of_gas_2112", %entry
  ...
  store { { { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* } (i8*, %TName_Option_ByStr20*)*, i8* } (i8*, [20 x i8]*)*, i8* } %"$$fundef_210_cloval_2118", { { { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* } (i8*, %TName_Option_ByStr20*)*, i8* } (i8*, [20 x i8]*)*, i8* }* %"$retval_209", align 8
...
"$have_gas_2075":                                 ; preds = %"$out_of_gas_2074", %entry
  ...
  %"$sha256hash_call_2080" = call [32 x i8]* @_sha256hash(i8* %"$execptr_load_2077", %_TyDescrTy_Typ* @"$TyDescr_String_295", i8* %"$$sha256hash_label_2078_2079")
  %"$sha256hash_2082" = load [32 x i8], [32 x i8]* %"$sha256hash_call_2080", align 1
  store [32 x i8] %"$sha256hash_2082", [32 x i8]* %labelHash, align 1
...
"$have_gas_2086":                                 ; preds = %"$out_of_gas_2085", %"$have_gas_2075"
  ...
  %"$concat_call_2095" = call i8* @_concat_ByStrX(i8* %"$execptr_load_2088", i32 32, i8* %"$$concat_parent_2089_2091", i32 32, i8* %"$$concat_labelHash_2092_2094")
  %"$concat_2096" = bitcast i8* %"$concat_call_2095" to [64 x i8]*
  %"$concat_2097" = load [64 x i8], [64 x i8]* %"$concat_2096", align 1
  store [64 x i8] %"$concat_2097", [64 x i8]* %nodeInput, align 1
  ...
  %"$sha256hash_call_2102" = call [32 x i8]* @_sha256hash(i8* %"$execptr_load_2098", %_TyDescrTy_Typ* @"$TyDescr_Bystr64_307", i8* %"$$sha256hash_nodeInput_2099_2101")
  %"$sha256hash_2104" = load [32 x i8], [32 x i8]* %"$sha256hash_call_2102", align 1
  store [32 x i8] %"$sha256hash_2104", [32 x i8]* %"$retval_219", align 1
...
"$have_gas_2062":                                 ; preds = %"$out_of_gas_2061", %entry
  ...
  store { void (i8*, [32 x i8]*, %String)*, i8* } %"$$fundef_218_cloval_2067", { void (i8*, [32 x i8]*, %String)*, i8* }* %"$retval_217", align 8
...
"$have_gas_2029":                                 ; preds = %"$out_of_gas_2028", %"$None_2024"
  ...
  store [20 x i8] %"$ud-registry.zeroByStr20_2031", [20 x i8]* %"$retval_221", align 1
...
"$have_gas_2055":                                 ; preds = %"$out_of_gas_2054", %"$ud-registry.Record_2046"
  ...
  store [20 x i8] %"$owner_2057", [20 x i8]* %"$retval_221", align 1
...
"$have_gas_1993":                                 ; preds = %"$out_of_gas_1992", %entry
  ...
  store i8* %"$msgobj_1995", i8** %"$retval_223", align 8
...
"$have_gas_1954":                                 ; preds = %"$out_of_gas_1953", %entry
  ...
  store i8* %"$msgobj_1956", i8** %"$retval_229", align 8
...
"$have_gas_1937":                                 ; preds = %"$out_of_gas_1936", %entry
  ...
  store { i8* (i8*, [20 x i8]*)*, i8* } %"$$fundef_228_cloval_1942", { i8* (i8*, [20 x i8]*)*, i8* }* %"$retval_227", align 8
...
"$have_gas_1924":                                 ; preds = %"$out_of_gas_1923", %entry
  ...
  store { { i8* (i8*, [20 x i8]*)*, i8* } (i8*, [20 x i8]*)*, i8* } %"$$fundef_226_cloval_1929", { { i8* (i8*, [20 x i8]*)*, i8* } (i8*, [20 x i8]*)*, i8* }* %"$retval_225", align 8
...
"$have_gas_1893":                                 ; preds = %"$out_of_gas_1892", %entry
  ...
  store i8* %"$msgobj_1895", i8** %"$retval_233", align 8
...
"$have_gas_1880":                                 ; preds = %"$out_of_gas_1879", %entry
  ...
  store { i8* (i8*, %String)*, i8* } %"$$fundef_232_cloval_1885", { i8* (i8*, %String)*, i8* }* %"$retval_231", align 8
...
"$have_gas_1857":                                 ; preds = %"$out_of_gas_1856", %entry
  ...
  store i8* %"$msgobj_1859", i8** %"$retval_235", align 8
...
"$have_gas_1834":                                 ; preds = %"$out_of_gas_1833", %entry
  ...
  store i8* %"$msgobj_1836", i8** %"$retval_237", align 8
...
"$have_gas_1795":                                 ; preds = %"$out_of_gas_1794", %entry
  ...
  store i8* %"$msgobj_1797", i8** %"$retval_243", align 8
...
"$have_gas_1778":                                 ; preds = %"$out_of_gas_1777", %entry
  ...
  store { i8* (i8*, %TName_Bool*)*, i8* } %"$$fundef_242_cloval_1783", { i8* (i8*, %TName_Bool*)*, i8* }* %"$retval_241", align 8
...
"$have_gas_1765":                                 ; preds = %"$out_of_gas_1764", %entry
  ...
  store { { i8* (i8*, %TName_Bool*)*, i8* } (i8*, [20 x i8]*)*, i8* } %"$$fundef_240_cloval_1770", { { i8* (i8*, %TName_Bool*)*, i8* } (i8*, [20 x i8]*)*, i8* }* %"$retval_239", align 8
...
"$have_gas_1734":                                 ; preds = %"$out_of_gas_1733", %entry
  ...
  store i8* %"$msgobj_1736", i8** %"$retval_247", align 8
...
"$have_gas_1721":                                 ; preds = %"$out_of_gas_1720", %entry
  ...
  store { i8* (i8*, %TName_Bool*)*, i8* } %"$$fundef_246_cloval_1726", { i8* (i8*, %TName_Bool*)*, i8* }* %"$retval_245", align 8
...
"$have_gas_1671":                                 ; preds = %"$out_of_gas_1670", %"$True_1666"
  ...
  store %TName_Bool* %"$adtptr_1675", %TName_Bool** %"$retval_251", align 8
...
"$have_gas_1702":                                 ; preds = %"$out_of_gas_1701", %"$True_1697"
  ...
  store %TName_Bool* %"$adtptr_1706", %TName_Bool** %"$retval_251", align 8
...
"$have_gas_1635":                                 ; preds = %"$out_of_gas_1634", %entry
  ...
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$$fundef_250_cloval_1640", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$retval_249", align 8
...
"$have_gas_1610":                                 ; preds = %"$out_of_gas_1609", %entry
  ...
  %"$eq_call_1618" = call %TName_Bool* @_eq_ByStrX(i8* %"$execptr_load_1612", i32 20, i8* %"$$eq_v_1613_1614", i8* %"$$eq_bs_1615_1617")
  store %TName_Bool* %"$eq_call_1618", %TName_Bool** %b, align 8
...
"$have_gas_1623":                                 ; preds = %"$out_of_gas_1622", %"$have_gas_1610"
  ...
  %"$BoolUtils.negb_call_1629" = call %TName_Bool* %"$BoolUtils.negb_fptr_1626"(i8* %"$BoolUtils.negb_envptr_1627", %TName_Bool* %"$b_1628")
  store %TName_Bool* %"$BoolUtils.negb_call_1629", %TName_Bool** %"$BoolUtils.negb_36", align 8
  %"$$BoolUtils.negb_36_1630" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.negb_36", align 8
  store %TName_Bool* %"$$BoolUtils.negb_36_1630", %TName_Bool** %"$retval_257", align 8
...
"$have_gas_1560":                                 ; preds = %"$out_of_gas_1559", %"$have_gas_1555"
  ...
  %"$ListUtils.list_filter_call_1568" = call { { %TName_List_ByStr20* (i8*, %TName_List_ByStr20*)*, i8* } (i8*, { %TName_Bool* (i8*, [20 x i8]*)*, i8* })*, i8* } %"$ListUtils.list_filter_fptr_1566"(i8* %"$ListUtils.list_filter_envptr_1567")
  store { { %TName_List_ByStr20* (i8*, %TName_List_ByStr20*)*, i8* } (i8*, { %TName_Bool* (i8*, [20 x i8]*)*, i8* })*, i8* } %"$ListUtils.list_filter_call_1568", { { %TName_List_ByStr20* (i8*, %TName_List_ByStr20*)*, i8* } (i8*, { %TName_Bool* (i8*, [20 x i8]*)*, i8* })*, i8* }* %listByStr20Filter, align 8
...
"$have_gas_1577":                                 ; preds = %"$out_of_gas_1576", %"$have_gas_1572"
  ...
  store { %TName_Bool* (i8*, [20 x i8]*)*, i8* } %"$$fundef_256_cloval_1582", { %TName_Bool* (i8*, [20 x i8]*)*, i8* }* %fn, align 8
...
"$have_gas_1589":                                 ; preds = %"$out_of_gas_1588", %"$have_gas_1577"
  ...
  %"$listByStr20Filter_call_1595" = call { %TName_List_ByStr20* (i8*, %TName_List_ByStr20*)*, i8* } %"$listByStr20Filter_fptr_1592"(i8* %"$listByStr20Filter_envptr_1593", { %TName_Bool* (i8*, [20 x i8]*)*, i8* } %"$fn_1594")
  store { %TName_List_ByStr20* (i8*, %TName_List_ByStr20*)*, i8* } %"$listByStr20Filter_call_1595", { %TName_List_ByStr20* (i8*, %TName_List_ByStr20*)*, i8* }* %"$listByStr20Filter_37", align 8
  ...
  %"$$listByStr20Filter_37_call_1600" = call %TName_List_ByStr20* %"$$listByStr20Filter_37_fptr_1597"(i8* %"$$listByStr20Filter_37_envptr_1598", %TName_List_ByStr20* %"$list_1599")
  store %TName_List_ByStr20* %"$$listByStr20Filter_37_call_1600", %TName_List_ByStr20** %"$listByStr20Filter_38", align 8
  %"$$listByStr20Filter_38_1601" = load %TName_List_ByStr20*, %TName_List_ByStr20** %"$listByStr20Filter_38", align 8
  store %TName_List_ByStr20* %"$$listByStr20Filter_38_1601", %TName_List_ByStr20** %"$retval_255", align 8
...
"$have_gas_1534":                                 ; preds = %"$out_of_gas_1533", %entry
  ...
  store { %TName_List_ByStr20* (i8*, [20 x i8]*)*, i8* } %"$$fundef_254_cloval_1539", { %TName_List_ByStr20* (i8*, [20 x i8]*)*, i8* }* %"$retval_253", align 8
...
"$have_gas_1502":                                 ; preds = %"$out_of_gas_1501", %"$have_gas_1497"
  ...
  %"$ud-registry.listByStr20Contains_call_1508" = call { %TName_Bool* (i8*, [20 x i8]*)*, i8* } %"$ud-registry.listByStr20Contains_fptr_1505"(i8* %"$ud-registry.listByStr20Contains_envptr_1506", %TName_List_ByStr20* %"$list_1507")
  store { %TName_Bool* (i8*, [20 x i8]*)*, i8* } %"$ud-registry.listByStr20Contains_call_1508", { %TName_Bool* (i8*, [20 x i8]*)*, i8* }* %"$ud-registry.listByStr20Contains_33", align 8
  ...
  %"$$ud-registry.listByStr20Contains_33_call_1513" = call %TName_Bool* %"$$ud-registry.listByStr20Contains_33_fptr_1510"(i8* %"$$ud-registry.listByStr20Contains_33_envptr_1511", [20 x i8]* %"$$ud-registry.listByStr20Contains_33_bs_1512")
  store %TName_Bool* %"$$ud-registry.listByStr20Contains_33_call_1513", %TName_Bool** %"$ud-registry.listByStr20Contains_34", align 8
  %"$$ud-registry.listByStr20Contains_34_1514" = load %TName_Bool*, %TName_Bool** %"$ud-registry.listByStr20Contains_34", align 8
  store %TName_Bool* %"$$ud-registry.listByStr20Contains_34_1514", %TName_Bool** %b, align 8
...
"$have_gas_1518":                                 ; preds = %"$out_of_gas_1517", %"$have_gas_1502"
  ...
  %"$BoolUtils.negb_call_1524" = call %TName_Bool* %"$BoolUtils.negb_fptr_1521"(i8* %"$BoolUtils.negb_envptr_1522", %TName_Bool* %"$b_1523")
  store %TName_Bool* %"$BoolUtils.negb_call_1524", %TName_Bool** %"$BoolUtils.negb_35", align 8
  %"$$BoolUtils.negb_35_1525" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.negb_35", align 8
  store %TName_Bool* %"$$BoolUtils.negb_35_1525", %TName_Bool** %"$retval_261", align 8
...
"$have_gas_1476":                                 ; preds = %"$out_of_gas_1475", %entry
  ...
  store { %TName_Bool* (i8*, [20 x i8]*)*, i8* } %"$$fundef_260_cloval_1481", { %TName_Bool* (i8*, [20 x i8]*)*, i8* }* %"$retval_259", align 8
...
"$have_gas_1438":                                 ; preds = %"$out_of_gas_1437", %"$have_gas_1433"
  ...
  %"$ListUtils.list_mem_call_1446" = call { { { %TName_Bool* (i8*, %TName_List_ByStr20*)*, i8* } (i8*, [20 x i8]*)*, i8* } (i8*, { { %TName_Bool* (i8*, [20 x i8]*)*, i8* } (i8*, [20 x i8]*)*, i8* })*, i8* } %"$ListUtils.list_mem_fptr_1444"(i8* %"$ListUtils.list_mem_envptr_1445")
  store { { { %TName_Bool* (i8*, %TName_List_ByStr20*)*, i8* } (i8*, [20 x i8]*)*, i8* } (i8*, { { %TName_Bool* (i8*, [20 x i8]*)*, i8* } (i8*, [20 x i8]*)*, i8* })*, i8* } %"$ListUtils.list_mem_call_1446", { { { %TName_Bool* (i8*, %TName_List_ByStr20*)*, i8* } (i8*, [20 x i8]*)*, i8* } (i8*, { { %TName_Bool* (i8*, [20 x i8]*)*, i8* } (i8*, [20 x i8]*)*, i8* })*, i8* }* %listMemByStr20, align 8
...
"$have_gas_1450":                                 ; preds = %"$out_of_gas_1449", %"$have_gas_1438"
  ...
  %"$listMemByStr20_call_1456" = call { { %TName_Bool* (i8*, %TName_List_ByStr20*)*, i8* } (i8*, [20 x i8]*)*, i8* } %"$listMemByStr20_fptr_1453"(i8* %"$listMemByStr20_envptr_1454", { { %TName_Bool* (i8*, [20 x i8]*)*, i8* } (i8*, [20 x i8]*)*, i8* } %"$ud-registry.eqByStr20_1455")
  store { { %TName_Bool* (i8*, %TName_List_ByStr20*)*, i8* } (i8*, [20 x i8]*)*, i8* } %"$listMemByStr20_call_1456", { { %TName_Bool* (i8*, %TName_List_ByStr20*)*, i8* } (i8*, [20 x i8]*)*, i8* }* %"$listMemByStr20_30", align 8
  ...
  %"$$listMemByStr20_30_call_1461" = call { %TName_Bool* (i8*, %TName_List_ByStr20*)*, i8* } %"$$listMemByStr20_30_fptr_1458"(i8* %"$$listMemByStr20_30_envptr_1459", [20 x i8]* %"$$listMemByStr20_30_bs_1460")
  store { %TName_Bool* (i8*, %TName_List_ByStr20*)*, i8* } %"$$listMemByStr20_30_call_1461", { %TName_Bool* (i8*, %TName_List_ByStr20*)*, i8* }* %"$listMemByStr20_31", align 8
  ...
  %"$$listMemByStr20_31_call_1466" = call %TName_Bool* %"$$listMemByStr20_31_fptr_1463"(i8* %"$$listMemByStr20_31_envptr_1464", %TName_List_ByStr20* %"$list_1465")
  store %TName_Bool* %"$$listMemByStr20_31_call_1466", %TName_Bool** %"$listMemByStr20_32", align 8
  %"$$listMemByStr20_32_1467" = load %TName_Bool*, %TName_Bool** %"$listMemByStr20_32", align 8
  store %TName_Bool* %"$$listMemByStr20_32_1467", %TName_Bool** %"$retval_265", align 8
...
"$have_gas_1412":                                 ; preds = %"$out_of_gas_1411", %entry
  ...
  store { %TName_Bool* (i8*, [20 x i8]*)*, i8* } %"$$fundef_264_cloval_1417", { %TName_Bool* (i8*, [20 x i8]*)*, i8* }* %"$retval_263", align 8
...
entry:
  ...
  %"$eq_call_1402" = call %TName_Bool* @_eq_ByStrX(i8* %"$execptr_load_1396", i32 20, i8* %"$$eq_bs1_1397_1399", i8* %"$$eq_bs2_1400_1401")
  store %TName_Bool* %"$eq_call_1402", %TName_Bool** %"$retval_269", align 8
...
"$have_gas_2323":                                 ; preds = %"$out_of_gas_2322", %entry
  ...
  store { i8*, i8* }* %"$dyndisp_table_2328", { i8*, i8* }** @list_foldr, align 8
...
"$have_gas_2334":                                 ; preds = %"$out_of_gas_2333", %"$have_gas_2323"
  ...
  store { i8*, i8* }* %"$dyndisp_table_2339", { i8*, i8* }** @list_foldk, align 8
...
"$have_gas_2369":                                 ; preds = %"$out_of_gas_2368", %"$have_gas_2361"
  ...
  store { i8*, i8* }* %"$dyndisp_table_2377", { i8*, i8* }** @ListUtils.list_filter, align 8
...
"$have_gas_2383":                                 ; preds = %"$out_of_gas_2382", %"$have_gas_2369"
  ...
  store { i8*, i8* }* %"$dyndisp_table_2391", { i8*, i8* }** @ListUtils.list_find, align 8
...
"$have_gas_2397":                                 ; preds = %"$out_of_gas_2396", %"$have_gas_2383"
  ...
  store { i8*, i8* }* %"$dyndisp_table_2405", { i8*, i8* }** @ListUtils.list_exists, align 8
...
"$have_gas_2411":                                 ; preds = %"$out_of_gas_2410", %"$have_gas_2397"
  ...
  store { i8*, i8* }* %"$dyndisp_table_2419", { i8*, i8* }** @ListUtils.list_mem, align 8
...
"$have_gas_2430":                                 ; preds = %"$out_of_gas_2429", %"$have_gas_2425"
  ...
  store %TName_List_ByStr20* %"$adtptr_2434", %TName_List_ByStr20** @ud-registry.nilByStr20, align 8
...
"$have_gas_2438":                                 ; preds = %"$out_of_gas_2437", %"$have_gas_2430"
  ...
  store %TName_List_Message* %"$adtptr_2442", %TName_List_Message** @ud-registry.nilMessage, align 8
...
"$have_gas_2446":                                 ; preds = %"$out_of_gas_2445", %"$have_gas_2438"
  ...
  store { %TName_List_Message* (i8*, i8*)*, i8* } %"$$fundef_270_cloval_2451", { %TName_List_Message* (i8*, i8*)*, i8* }* @ud-registry.oneMsg, align 8
...
"$have_gas_2465":                                 ; preds = %"$out_of_gas_2464", %"$have_gas_2457"
  ...
  store { { %TName_Bool* (i8*, [20 x i8]*)*, i8* } (i8*, %TName_List_ByStr20*)*, i8* } %"$$fundef_262_cloval_2470", { { %TName_Bool* (i8*, [20 x i8]*)*, i8* } (i8*, %TName_List_ByStr20*)*, i8* }* @ud-registry.listByStr20Contains, align 8
...
"$have_gas_2478":                                 ; preds = %"$out_of_gas_2477", %"$have_gas_2465"
  ...
  store { { %TName_Bool* (i8*, [20 x i8]*)*, i8* } (i8*, %TName_List_ByStr20*)*, i8* } %"$$fundef_258_cloval_2483", { { %TName_Bool* (i8*, [20 x i8]*)*, i8* } (i8*, %TName_List_ByStr20*)*, i8* }* @ud-registry.listByStr20Excludes, align 8
...
"$have_gas_2491":                                 ; preds = %"$out_of_gas_2490", %"$have_gas_2478"
  ...
  store { { %TName_List_ByStr20* (i8*, [20 x i8]*)*, i8* } (i8*, %TName_List_ByStr20*)*, i8* } %"$$fundef_252_cloval_2496", { { %TName_List_ByStr20* (i8*, [20 x i8]*)*, i8* } (i8*, %TName_List_ByStr20*)*, i8* }* @ud-registry.listByStr20FilterOut, align 8
...
"$have_gas_2568":                                 ; preds = %"$out_of_gas_2567", %"$have_gas_2560"
  ...
  store { void (i8*, [20 x i8]*, %TName_Option_ud-registry.Record*)*, i8* } %"$$fundef_220_cloval_2573", { void (i8*, [20 x i8]*, %TName_Option_ud-registry.Record*)*, i8* }* @ud-registry.recordMemberOwner, align 8
...
"$have_gas_2587":                                 ; preds = %"$out_of_gas_2586", %"$have_gas_2579"
  ...
  store { { { { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* } (i8*, %TName_Option_ByStr20*)*, i8* } (i8*, [20 x i8]*)*, i8* } (i8*, [20 x i8]*)*, i8* } %"$$fundef_208_cloval_2592", { { { { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* } (i8*, %TName_Option_ByStr20*)*, i8* } (i8*, [20 x i8]*)*, i8* } (i8*, [20 x i8]*)*, i8* }* @ud-registry.getIsOAO, align 8
  ret void
}
...
"$have_gas_2605":                                 ; preds = %"$out_of_gas_2604", %"$have_gas_2600"
  ...
  store %Map_ByStr32_ud-registry.Record* %"$_new_empty_map_2609", %Map_ByStr32_ud-registry.Record** %empty, align 8
...
"$have_gas_2618":                                 ; preds = %"$out_of_gas_2617", %"$have_gas_2613"
  ...
  store %TName_ud-registry.Record* %"$adtptr_2626", %TName_ud-registry.Record** %rootRecord, align 8
  ...
  %"$put_call_2635" = call i8* @_put(i8* %"$execptr_load_2627", %_TyDescrTy_Typ* @"$TyDescr_Map_325", i8* %"$$empty_2628_2629", i8* %"$$put_rootNode_2630_2632", i8* %"$$rootRecord_2633_2634")
  %"$put_2636" = bitcast i8* %"$put_call_2635" to %Map_ByStr32_ud-registry.Record*
  store %Map_ByStr32_ud-registry.Record* %"$put_2636", %Map_ByStr32_ud-registry.Record** %"$records_272", align 8
  ...
  call void @_update_field(i8* %"$execptr_load_2637", i8* getelementptr inbounds ([8 x i8], [8 x i8]* @"$records_2638", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_325", i32 0, i8* null, i8* %"$update_value_2640")
...
"$have_gas_2644":                                 ; preds = %"$out_of_gas_2643", %"$have_gas_2618"
  ...
  store [20 x i8] %"$ud-registry.zeroByStr20_2646", [20 x i8]* %"$registrar_273", align 1
  ...
  call void @_update_field(i8* %"$execptr_load_2647", i8* getelementptr inbounds ([10 x i8], [10 x i8]* @"$registrar_2648", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Bystr20_311", i32 0, i8* null, i8* %"$update_value_2651")
...
"$have_gas_2655":                                 ; preds = %"$out_of_gas_2654", %"$have_gas_2644"
  ...
  store %Map_ByStr32_ByStr20* %"$_new_empty_map_2659", %Map_ByStr32_ByStr20** %"$approvals_274", align 8
  ...
  call void @_update_field(i8* %"$execptr_load_2660", i8* getelementptr inbounds ([10 x i8], [10 x i8]* @"$approvals_2661", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_324", i32 0, i8* null, i8* %"$update_value_2663")
...
"$have_gas_2667":                                 ; preds = %"$out_of_gas_2666", %"$have_gas_2655"
  ...
  store %"Map_ByStr20_List_(ByStr20)"* %"$_new_empty_map_2671", %"Map_ByStr20_List_(ByStr20)"** %"$operators_275", align 8
  ...
  call void @_update_field(i8* %"$execptr_load_2672", i8* getelementptr inbounds ([10 x i8], [10 x i8]* @"$operators_2673", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_323", i32 0, i8* null, i8* %"$update_value_2675")
...
"$have_gas_2679":                                 ; preds = %"$out_of_gas_2678", %"$have_gas_2667"
  ...
  store %TName_List_ByStr20* %"$adtptr_2687", %TName_List_ByStr20** %"$admins_276", align 8
  ...
  call void @_update_field(i8* %"$execptr_load_2688", i8* getelementptr inbounds ([7 x i8], [7 x i8]* @"$admins_2689", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_ADT_List_ByStr20_320", i32 0, i8* null, i8* %"$update_value_2691")
  ret void
}
...
define internal void @"$setAdmin_2692"(%Uint128 %_amount, [20 x i8]* %"$_origin_2693", [20 x i8]* %"$_sender_2694", [20 x i8]* %"$address_2695", %TName_Bool* %isApproved) {
entry:
  ...
  %"$currentAdmins_call_2698" = call i8* @_fetch_field(i8* %"$execptr_load_2697", i8* getelementptr inbounds ([7 x i8], [7 x i8]* @"$admins_2696", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_ADT_List_ByStr20_320", i32 0, i8* null, i32 1)
...
"$have_gas_2717":                                 ; preds = %"$out_of_gas_2716", %"$have_gas_2712"
  ...
  %"$ud-registry.listByStr20Contains_call_2723" = call { %TName_Bool* (i8*, [20 x i8]*)*, i8* } %"$ud-registry.listByStr20Contains_fptr_2720"(i8* %"$ud-registry.listByStr20Contains_envptr_2721", %TName_List_ByStr20* %"$currentAdmins_2722")
  store { %TName_Bool* (i8*, [20 x i8]*)*, i8* } %"$ud-registry.listByStr20Contains_call_2723", { %TName_Bool* (i8*, [20 x i8]*)*, i8* }* %"$ud-registry.listByStr20Contains_54", align 8
  ...
  %"$$ud-registry.listByStr20Contains_54_call_2728" = call %TName_Bool* %"$$ud-registry.listByStr20Contains_54_fptr_2725"(i8* %"$$ud-registry.listByStr20Contains_54_envptr_2726", [20 x i8]* %"$$ud-registry.listByStr20Contains_54__sender_2727")
  store %TName_Bool* %"$$ud-registry.listByStr20Contains_54_call_2728", %TName_Bool** %"$ud-registry.listByStr20Contains_55", align 8
  %"$$ud-registry.listByStr20Contains_55_2729" = load %TName_Bool*, %TName_Bool** %"$ud-registry.listByStr20Contains_55", align 8
  store %TName_Bool* %"$$ud-registry.listByStr20Contains_55_2729", %TName_Bool** %isSenderAdmin, align 8
...
"$have_gas_2755":                                 ; preds = %"$out_of_gas_2754", %"$have_gas_2750"
  ...
  %"$ud-registry.listByStr20Excludes_call_2761" = call { %TName_Bool* (i8*, [20 x i8]*)*, i8* } %"$ud-registry.listByStr20Excludes_fptr_2758"(i8* %"$ud-registry.listByStr20Excludes_envptr_2759", %TName_List_ByStr20* %"$currentAdmins_2760")
  store { %TName_Bool* (i8*, [20 x i8]*)*, i8* } %"$ud-registry.listByStr20Excludes_call_2761", { %TName_Bool* (i8*, [20 x i8]*)*, i8* }* %"$ud-registry.listByStr20Excludes_49", align 8
  ...
  %"$$ud-registry.listByStr20Excludes_49_call_2766" = call %TName_Bool* %"$$ud-registry.listByStr20Excludes_49_fptr_2763"(i8* %"$$ud-registry.listByStr20Excludes_49_envptr_2764", [20 x i8]* %"$$ud-registry.listByStr20Excludes_49_address_2765")
  store %TName_Bool* %"$$ud-registry.listByStr20Excludes_49_call_2766", %TName_Bool** %"$ud-registry.listByStr20Excludes_50", align 8
  %"$$ud-registry.listByStr20Excludes_50_2767" = load %TName_Bool*, %TName_Bool** %"$ud-registry.listByStr20Excludes_50", align 8
  store %TName_Bool* %"$$ud-registry.listByStr20Excludes_50_2767", %TName_Bool** %b, align 8
...
"$have_gas_2771":                                 ; preds = %"$out_of_gas_2770", %"$have_gas_2755"
  ...
  %"$ud-registry.xandb_call_2777" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$ud-registry.xandb_fptr_2774"(i8* %"$ud-registry.xandb_envptr_2775", %TName_Bool* %"$b_2776")
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$ud-registry.xandb_call_2777", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$ud-registry.xandb_51", align 8
  ...
  %"$$ud-registry.xandb_51_call_2781" = call %TName_Bool* %"$$ud-registry.xandb_51_fptr_2779"(i8* %"$$ud-registry.xandb_51_envptr_2780", %TName_Bool* %isApproved)
  store %TName_Bool* %"$$ud-registry.xandb_51_call_2781", %TName_Bool** %"$ud-registry.xandb_52", align 8
  %"$$ud-registry.xandb_52_2782" = load %TName_Bool*, %TName_Bool** %"$ud-registry.xandb_52", align 8
  store %TName_Bool* %"$$ud-registry.xandb_52_2782", %TName_Bool** %needsToChange, align 8
...
"$have_gas_2814":                                 ; preds = %"$out_of_gas_2813", %"$True_2809"
  ...
  store %TName_List_ByStr20* %"$adtptr_2821", %TName_List_ByStr20** %newAdmins, align 8
...
"$have_gas_2827":                                 ; preds = %"$out_of_gas_2826", %"$False_2822"
  ...
  %"$ud-registry.listByStr20FilterOut_call_2833" = call { %TName_List_ByStr20* (i8*, [20 x i8]*)*, i8* } %"$ud-registry.listByStr20FilterOut_fptr_2830"(i8* %"$ud-registry.listByStr20FilterOut_envptr_2831", %TName_List_ByStr20* %"$currentAdmins_2832")
  store { %TName_List_ByStr20* (i8*, [20 x i8]*)*, i8* } %"$ud-registry.listByStr20FilterOut_call_2833", { %TName_List_ByStr20* (i8*, [20 x i8]*)*, i8* }* %"$ud-registry.listByStr20FilterOut_47", align 8
  ...
  %"$$ud-registry.listByStr20FilterOut_47_call_2838" = call %TName_List_ByStr20* %"$$ud-registry.listByStr20FilterOut_47_fptr_2835"(i8* %"$$ud-registry.listByStr20FilterOut_47_envptr_2836", [20 x i8]* %"$$ud-registry.listByStr20FilterOut_47_address_2837")
  store %TName_List_ByStr20* %"$$ud-registry.listByStr20FilterOut_47_call_2838", %TName_List_ByStr20** %"$ud-registry.listByStr20FilterOut_48", align 8
  ...
  store %TName_List_ByStr20* %"$$ud-registry.listByStr20FilterOut_48_2839", %TName_List_ByStr20** %newAdmins, align 8
  br label %"$matchsucc_2805"
...
"$have_gas_2846":                                 ; preds = %"$out_of_gas_2845", %"$matchsucc_2805"
  ...
  call void @_update_field(i8* %"$execptr_load_2848", i8* getelementptr inbounds ([7 x i8], [7 x i8]* @"$admins_2849", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_ADT_List_ByStr20_320", i32 0, i8* null, i8* %"$update_value_2851")
...
"$have_gas_2860":                                 ; preds = %"$out_of_gas_2859", %"$have_gas_2855"
  ...
  %"$ud-registry.eAdminSet_call_2866" = call { i8* (i8*, %TName_Bool*)*, i8* } %"$ud-registry.eAdminSet_fptr_2863"(i8* %"$ud-registry.eAdminSet_envptr_2864", [20 x i8]* %"$ud-registry.eAdminSet_address_2865")
  store { i8* (i8*, %TName_Bool*)*, i8* } %"$ud-registry.eAdminSet_call_2866", { i8* (i8*, %TName_Bool*)*, i8* }* %"$ud-registry.eAdminSet_45", align 8
  ...
  %"$$ud-registry.eAdminSet_45_call_2870" = call i8* %"$$ud-registry.eAdminSet_45_fptr_2868"(i8* %"$$ud-registry.eAdminSet_45_envptr_2869", %TName_Bool* %isApproved)
  store i8* %"$$ud-registry.eAdminSet_45_call_2870", i8** %"$ud-registry.eAdminSet_46", align 8
  %"$$ud-registry.eAdminSet_46_2871" = load i8*, i8** %"$ud-registry.eAdminSet_46", align 8
  store i8* %"$$ud-registry.eAdminSet_46_2871", i8** %e, align 8
...
"$have_gas_2878":                                 ; preds = %"$out_of_gas_2877", %"$have_gas_2860"
  ...
  call void @_event(i8* %"$execptr_load_2880", %_TyDescrTy_Typ* @"$TyDescr_Event_301", i8* %"$e_2881")
...
"$have_gas_2897":                                 ; preds = %"$out_of_gas_2896", %"$have_gas_2892"
  ...
  store %String { i8* getelementptr inbounds ([26 x i8], [26 x i8]* @"$stringlit_2899", i32 0, i32 0), i32 26 }, %String* %m, align 8
...
"$have_gas_2903":                                 ; preds = %"$out_of_gas_2902", %"$have_gas_2897"
  ...
  %"$ud-registry.eError_call_2909" = call i8* %"$ud-registry.eError_fptr_2906"(i8* %"$ud-registry.eError_envptr_2907", %String %"$m_2908")
  store i8* %"$ud-registry.eError_call_2909", i8** %"$ud-registry.eError_53", align 8
  %"$$ud-registry.eError_53_2910" = load i8*, i8** %"$ud-registry.eError_53", align 8
  store i8* %"$$ud-registry.eError_53_2910", i8** %e1, align 8
...
"$have_gas_2917":                                 ; preds = %"$out_of_gas_2916", %"$have_gas_2903"
  ...
  call void @_event(i8* %"$execptr_load_2919", %_TyDescrTy_Typ* @"$TyDescr_Event_301", i8* %"$e_2920")
  br label %"$matchsucc_2735"
...
entry:
  ...
  call void @"$setAdmin_2692"(%Uint128 %_amount, [20 x i8]* %"$_origin_2925", [20 x i8]* %"$_sender_2927", [20 x i8]* %"$address_2929", %TName_Bool* %isApproved)
  ret void
}

define internal void @"$approve_2932"(%Uint128 %_amount, [20 x i8]* %"$_origin_2933", [20 x i8]* %"$_sender_2934", [32 x i8]* %"$node_2935", [20 x i8]* %"$address_2936") {
entry:
  ...
  %"$maybeRecord_call_2941" = call i8* @_fetch_field(i8* %"$execptr_load_2940", i8* getelementptr inbounds ([8 x i8], [8 x i8]* @"$records_2939", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_325", i32 1, i8* %"$indices_buf_2937", i32 1)
...
"$have_gas_2961":                                 ; preds = %"$out_of_gas_2960", %"$have_gas_2956"
  ...
  call void %"$ud-registry.recordMemberOwner_fptr_2964"(i8* %"$ud-registry.recordMemberOwner_envptr_2965", [20 x i8]* %"$ud-registry.recordMemberOwner_retalloca_2967", %TName_Option_ud-registry.Record* %"$maybeRecord_2966")
  %"$ud-registry.recordMemberOwner_ret_2968" = load [20 x i8], [20 x i8]* %"$ud-registry.recordMemberOwner_retalloca_2967", align 1
  store [20 x i8] %"$ud-registry.recordMemberOwner_ret_2968", [20 x i8]* %"$ud-registry.recordMemberOwner_59", align 1
  %"$$ud-registry.recordMemberOwner_59_2969" = load [20 x i8], [20 x i8]* %"$ud-registry.recordMemberOwner_59", align 1
  store [20 x i8] %"$$ud-registry.recordMemberOwner_59_2969", [20 x i8]* %recordOwner, align 1
...
"$have_gas_2973":                                 ; preds = %"$out_of_gas_2972", %"$have_gas_2961"
  ...
  %"$eq_call_2981" = call %TName_Bool* @_eq_ByStrX(i8* %"$execptr_load_2975", i32 20, i8* %"$$eq__sender_2976_2977", i8* %"$$eq_recordOwner_2978_2980")
  store %TName_Bool* %"$eq_call_2981", %TName_Bool** %isSenderNodeOwner, align 8
...
"$True_2993":                                     ; preds = %"$have_gas_2986"
  ...
  %"$maybeApproved_call_2999" = call i8* @_fetch_field(i8* %"$execptr_load_2998", i8* getelementptr inbounds ([10 x i8], [10 x i8]* @"$approvals_2997", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_324", i32 1, i8* %"$indices_buf_2995", i32 1)
...
"$have_gas_3031":                                 ; preds = %"$out_of_gas_3030", %"$None_3026"
  ...
  store [20 x i8] %"$ud-registry.zeroByStr20_3033", [20 x i8]* %currentlyApproved, align 1
...
"$have_gas_3041":                                 ; preds = %"$out_of_gas_3040", %"$Some_3034"
  ...
  store [20 x i8] %"$approved_3043", [20 x i8]* %currentlyApproved, align 1
  br label %"$matchsucc_3021"
...
"$have_gas_3052":                                 ; preds = %"$out_of_gas_3051", %"$have_gas_3047"
  ...
  %"$eq_call_3060" = call %TName_Bool* @_eq_ByStrX(i8* %"$execptr_load_3054", i32 20, i8* %"$$eq_currentlyApproved_3055_3057", i8* %"$$eq_address_3058_3059")
  store %TName_Bool* %"$eq_call_3060", %TName_Bool** %b, align 8
...
"$have_gas_3065":                                 ; preds = %"$out_of_gas_3064", %"$have_gas_3052"
  ...
  %"$BoolUtils.negb_call_3071" = call %TName_Bool* %"$BoolUtils.negb_fptr_3068"(i8* %"$BoolUtils.negb_envptr_3069", %TName_Bool* %"$b_3070")
  store %TName_Bool* %"$BoolUtils.negb_call_3071", %TName_Bool** %"$BoolUtils.negb_57", align 8
  %"$$BoolUtils.negb_57_3072" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.negb_57", align 8
  store %TName_Bool* %"$$BoolUtils.negb_57_3072", %TName_Bool** %needsToChange, align 8
...
"$have_gas_3092":                                 ; preds = %"$out_of_gas_3091", %"$True_3083"
  ...
  call void @_update_field(i8* %"$execptr_load_3096", i8* getelementptr inbounds ([10 x i8], [10 x i8]* @"$approvals_3097", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_324", i32 1, i8* %"$indices_buf_3094", i8* %"$update_value_3099")
...
"$have_gas_3108":                                 ; preds = %"$out_of_gas_3107", %"$have_gas_3103"
  ...
  %"$ud-registry.eApproved_call_3114" = call i8* %"$ud-registry.eApproved_fptr_3111"(i8* %"$ud-registry.eApproved_envptr_3112", [20 x i8]* %"$ud-registry.eApproved_address_3113")
  store i8* %"$ud-registry.eApproved_call_3114", i8** %"$ud-registry.eApproved_56", align 8
  %"$$ud-registry.eApproved_56_3115" = load i8*, i8** %"$ud-registry.eApproved_56", align 8
  store i8* %"$$ud-registry.eApproved_56_3115", i8** %e, align 8
...
"$have_gas_3122":                                 ; preds = %"$out_of_gas_3121", %"$have_gas_3108"
  ...
  call void @_event(i8* %"$execptr_load_3124", %_TyDescrTy_Typ* @"$TyDescr_Event_301", i8* %"$e_3125")
...
"$have_gas_3141":                                 ; preds = %"$out_of_gas_3140", %"$have_gas_3136"
  ...
  store %String { i8* getelementptr inbounds ([21 x i8], [21 x i8]* @"$stringlit_3143", i32 0, i32 0), i32 21 }, %String* %m, align 8
...
"$have_gas_3147":                                 ; preds = %"$out_of_gas_3146", %"$have_gas_3141"
  ...
  %"$ud-registry.eError_call_3153" = call i8* %"$ud-registry.eError_fptr_3150"(i8* %"$ud-registry.eError_envptr_3151", %String %"$m_3152")
  store i8* %"$ud-registry.eError_call_3153", i8** %"$ud-registry.eError_58", align 8
  %"$$ud-registry.eError_58_3154" = load i8*, i8** %"$ud-registry.eError_58", align 8
  store i8* %"$$ud-registry.eError_58_3154", i8** %e3, align 8
...
"$have_gas_3161":                                 ; preds = %"$out_of_gas_3160", %"$have_gas_3147"
  ...
  call void @_event(i8* %"$execptr_load_3163", %_TyDescrTy_Typ* @"$TyDescr_Event_301", i8* %"$e_3164")
  br label %"$matchsucc_2988"
...
entry:
  ...
  call void @"$approve_2932"(%Uint128 %_amount, [20 x i8]* %"$_origin_3169", [20 x i8]* %"$_sender_3171", [32 x i8]* %"$node_3173", [20 x i8]* %"$address_3175")
  ret void
}

define internal void @"$approveFor_3176"(%Uint128 %_amount, [20 x i8]* %"$_origin_3177", [20 x i8]* %"$_sender_3178", [20 x i8]* %"$address_3179", %TName_Bool* %isApproved) {
entry:
  ...
  %"$maybeOperators_call_3184" = call i8* @_fetch_field(i8* %"$execptr_load_3183", i8* getelementptr inbounds ([10 x i8], [10 x i8]* @"$operators_3182", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_323", i32 1, i8* %"$indices_buf_3180", i32 1)
...
"$have_gas_3216":                                 ; preds = %"$out_of_gas_3215", %"$None_3211"
  ...
  store %TName_List_ByStr20* %"$ud-registry.nilByStr20_3218", %TName_List_ByStr20** %currentOperators, align 8
...
"$have_gas_3226":                                 ; preds = %"$out_of_gas_3225", %"$Some_3219"
  ...
  store %TName_List_ByStr20* %"$ops_3228", %TName_List_ByStr20** %currentOperators, align 8
  br label %"$matchsucc_3206"
...
"$have_gas_3242":                                 ; preds = %"$out_of_gas_3241", %"$have_gas_3237"
  ...
  %"$ud-registry.listByStr20Excludes_call_3248" = call { %TName_Bool* (i8*, [20 x i8]*)*, i8* } %"$ud-registry.listByStr20Excludes_fptr_3245"(i8* %"$ud-registry.listByStr20Excludes_envptr_3246", %TName_List_ByStr20* %"$currentOperators_3247")
  store { %TName_Bool* (i8*, [20 x i8]*)*, i8* } %"$ud-registry.listByStr20Excludes_call_3248", { %TName_Bool* (i8*, [20 x i8]*)*, i8* }* %"$ud-registry.listByStr20Excludes_65", align 8
  ...
  %"$$ud-registry.listByStr20Excludes_65_call_3253" = call %TName_Bool* %"$$ud-registry.listByStr20Excludes_65_fptr_3250"(i8* %"$$ud-registry.listByStr20Excludes_65_envptr_3251", [20 x i8]* %"$$ud-registry.listByStr20Excludes_65_address_3252")
  store %TName_Bool* %"$$ud-registry.listByStr20Excludes_65_call_3253", %TName_Bool** %"$ud-registry.listByStr20Excludes_66", align 8
  %"$$ud-registry.listByStr20Excludes_66_3254" = load %TName_Bool*, %TName_Bool** %"$ud-registry.listByStr20Excludes_66", align 8
  store %TName_Bool* %"$$ud-registry.listByStr20Excludes_66_3254", %TName_Bool** %b, align 8
...
"$have_gas_3258":                                 ; preds = %"$out_of_gas_3257", %"$have_gas_3242"
  ...
  %"$ud-registry.xandb_call_3264" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$ud-registry.xandb_fptr_3261"(i8* %"$ud-registry.xandb_envptr_3262", %TName_Bool* %"$b_3263")
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$ud-registry.xandb_call_3264", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$ud-registry.xandb_67", align 8
  ...
  %"$$ud-registry.xandb_67_call_3268" = call %TName_Bool* %"$$ud-registry.xandb_67_fptr_3266"(i8* %"$$ud-registry.xandb_67_envptr_3267", %TName_Bool* %isApproved)
  store %TName_Bool* %"$$ud-registry.xandb_67_call_3268", %TName_Bool** %"$ud-registry.xandb_68", align 8
  %"$$ud-registry.xandb_68_3269" = load %TName_Bool*, %TName_Bool** %"$ud-registry.xandb_68", align 8
  store %TName_Bool* %"$$ud-registry.xandb_68_3269", %TName_Bool** %needsToChange, align 8
...
"$have_gas_3301":                                 ; preds = %"$out_of_gas_3300", %"$True_3296"
  ...
  store %TName_List_ByStr20* %"$adtptr_3308", %TName_List_ByStr20** %newOperators, align 8
...
"$have_gas_3314":                                 ; preds = %"$out_of_gas_3313", %"$False_3309"
  ...
  %"$ud-registry.listByStr20FilterOut_call_3320" = call { %TName_List_ByStr20* (i8*, [20 x i8]*)*, i8* } %"$ud-registry.listByStr20FilterOut_fptr_3317"(i8* %"$ud-registry.listByStr20FilterOut_envptr_3318", %TName_List_ByStr20* %"$currentOperators_3319")
  store { %TName_List_ByStr20* (i8*, [20 x i8]*)*, i8* } %"$ud-registry.listByStr20FilterOut_call_3320", { %TName_List_ByStr20* (i8*, [20 x i8]*)*, i8* }* %"$ud-registry.listByStr20FilterOut_63", align 8
  ...
  %"$$ud-registry.listByStr20FilterOut_63_call_3325" = call %TName_List_ByStr20* %"$$ud-registry.listByStr20FilterOut_63_fptr_3322"(i8* %"$$ud-registry.listByStr20FilterOut_63_envptr_3323", [20 x i8]* %"$$ud-registry.listByStr20FilterOut_63_address_3324")
  store %TName_List_ByStr20* %"$$ud-registry.listByStr20FilterOut_63_call_3325", %TName_List_ByStr20** %"$ud-registry.listByStr20FilterOut_64", align 8
  ...
  store %TName_List_ByStr20* %"$$ud-registry.listByStr20FilterOut_64_3326", %TName_List_ByStr20** %newOperators, align 8
  br label %"$matchsucc_3292"
...
"$have_gas_3334":                                 ; preds = %"$out_of_gas_3333", %"$matchsucc_3292"
  ...
  call void @_update_field(i8* %"$execptr_load_3338", i8* getelementptr inbounds ([10 x i8], [10 x i8]* @"$operators_3339", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_323", i32 1, i8* %"$indices_buf_3336", i8* %"$update_value_3341")
...
"$have_gas_3350":                                 ; preds = %"$out_of_gas_3349", %"$have_gas_3345"
  ...
  %"$ud-registry.eApprovedFor_call_3356" = call { { i8* (i8*, %TName_Bool*)*, i8* } (i8*, [20 x i8]*)*, i8* } %"$ud-registry.eApprovedFor_fptr_3353"(i8* %"$ud-registry.eApprovedFor_envptr_3354", [20 x i8]* %"$ud-registry.eApprovedFor__sender_3355")
  store { { i8* (i8*, %TName_Bool*)*, i8* } (i8*, [20 x i8]*)*, i8* } %"$ud-registry.eApprovedFor_call_3356", { { i8* (i8*, %TName_Bool*)*, i8* } (i8*, [20 x i8]*)*, i8* }* %"$ud-registry.eApprovedFor_60", align 8
  ...
  %"$$ud-registry.eApprovedFor_60_call_3361" = call { i8* (i8*, %TName_Bool*)*, i8* } %"$$ud-registry.eApprovedFor_60_fptr_3358"(i8* %"$$ud-registry.eApprovedFor_60_envptr_3359", [20 x i8]* %"$$ud-registry.eApprovedFor_60_address_3360")
  store { i8* (i8*, %TName_Bool*)*, i8* } %"$$ud-registry.eApprovedFor_60_call_3361", { i8* (i8*, %TName_Bool*)*, i8* }* %"$ud-registry.eApprovedFor_61", align 8
  ...
  %"$$ud-registry.eApprovedFor_61_call_3365" = call i8* %"$$ud-registry.eApprovedFor_61_fptr_3363"(i8* %"$$ud-registry.eApprovedFor_61_envptr_3364", %TName_Bool* %isApproved)
  store i8* %"$$ud-registry.eApprovedFor_61_call_3365", i8** %"$ud-registry.eApprovedFor_62", align 8
  %"$$ud-registry.eApprovedFor_62_3366" = load i8*, i8** %"$ud-registry.eApprovedFor_62", align 8
  store i8* %"$$ud-registry.eApprovedFor_62_3366", i8** %e, align 8
...
"$have_gas_3373":                                 ; preds = %"$out_of_gas_3372", %"$have_gas_3350"
  ...
  call void @_event(i8* %"$execptr_load_3375", %_TyDescrTy_Typ* @"$TyDescr_Event_301", i8* %"$e_3376")
...
entry:
  ...
  call void @"$approveFor_3176"(%Uint128 %_amount, [20 x i8]* %"$_origin_3381", [20 x i8]* %"$_sender_3383", [20 x i8]* %"$address_3385", %TName_Bool* %isApproved)
  ret void
}

define internal void @"$configureNode_3388"(%Uint128 %_amount, [20 x i8]* %"$_origin_3389", [20 x i8]* %"$_sender_3390", [32 x i8]* %"$node_3391", [20 x i8]* %"$owner_3392", [20 x i8]* %"$resolver_3393") {
entry:
  ...
  %"$maybeRecord_call_3398" = call i8* @_fetch_field(i8* %"$execptr_load_3397", i8* getelementptr inbounds ([8 x i8], [8 x i8]* @"$records_3396", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_325", i32 1, i8* %"$indices_buf_3394", i32 1)
...
"$have_gas_3408":                                 ; preds = %"$out_of_gas_3407", %entry
  ...
  %"$maybeApproved_call_3414" = call i8* @_fetch_field(i8* %"$execptr_load_3413", i8* getelementptr inbounds ([10 x i8], [10 x i8]* @"$approvals_3412", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_324", i32 1, i8* %"$indices_buf_3410", i32 1)
...
"$have_gas_3434":                                 ; preds = %"$out_of_gas_3433", %"$have_gas_3429"
  ...
  call void %"$ud-registry.recordMemberOwner_fptr_3437"(i8* %"$ud-registry.recordMemberOwner_envptr_3438", [20 x i8]* %"$ud-registry.recordMemberOwner_retalloca_3440", %TName_Option_ud-registry.Record* %"$maybeRecord_3439")
  %"$ud-registry.recordMemberOwner_ret_3441" = load [20 x i8], [20 x i8]* %"$ud-registry.recordMemberOwner_retalloca_3440", align 1
  store [20 x i8] %"$ud-registry.recordMemberOwner_ret_3441", [20 x i8]* %"$ud-registry.recordMemberOwner_79", align 1
  %"$$ud-registry.recordMemberOwner_79_3442" = load [20 x i8], [20 x i8]* %"$ud-registry.recordMemberOwner_79", align 1
  store [20 x i8] %"$$ud-registry.recordMemberOwner_79_3442", [20 x i8]* %recordOwner, align 1
  %maybeOperators = alloca %"TName_Option_List_(ByStr20)"*, align 8
  ...
  %"$maybeOperators_call_3448" = call i8* @_fetch_field(i8* %"$execptr_load_3447", i8* getelementptr inbounds ([10 x i8], [10 x i8]* @"$operators_3446", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_323", i32 1, i8* %"$indices_buf_3443", i32 1)
...
"$have_gas_3468":                                 ; preds = %"$out_of_gas_3467", %"$have_gas_3463"
  ...
  %"$ud-registry.getIsOAO_call_3474" = call { { { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* } (i8*, %TName_Option_ByStr20*)*, i8* } (i8*, [20 x i8]*)*, i8* } %"$ud-registry.getIsOAO_fptr_3471"(i8* %"$ud-registry.getIsOAO_envptr_3472", [20 x i8]* %"$ud-registry.getIsOAO__sender_3473")
  store { { { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* } (i8*, %TName_Option_ByStr20*)*, i8* } (i8*, [20 x i8]*)*, i8* } %"$ud-registry.getIsOAO_call_3474", { { { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* } (i8*, %TName_Option_ByStr20*)*, i8* } (i8*, [20 x i8]*)*, i8* }* %"$ud-registry.getIsOAO_75", align 8
  ...
  %"$$ud-registry.getIsOAO_75_call_3480" = call { { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* } (i8*, %TName_Option_ByStr20*)*, i8* } %"$$ud-registry.getIsOAO_75_fptr_3476"(i8* %"$$ud-registry.getIsOAO_75_envptr_3477", [20 x i8]* %"$$ud-registry.getIsOAO_75_recordOwner_3478")
  store { { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* } (i8*, %TName_Option_ByStr20*)*, i8* } %"$$ud-registry.getIsOAO_75_call_3480", { { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* } (i8*, %TName_Option_ByStr20*)*, i8* }* %"$ud-registry.getIsOAO_76", align 8
  ...
  %"$$ud-registry.getIsOAO_76_call_3485" = call { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* } %"$$ud-registry.getIsOAO_76_fptr_3482"(i8* %"$$ud-registry.getIsOAO_76_envptr_3483", %TName_Option_ByStr20* %"$maybeApproved_3484")
  store { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* } %"$$ud-registry.getIsOAO_76_call_3485", { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* }* %"$ud-registry.getIsOAO_77", align 8
  ...
  %"$$ud-registry.getIsOAO_77_call_3490" = call %TName_Bool* %"$$ud-registry.getIsOAO_77_fptr_3487"(i8* %"$$ud-registry.getIsOAO_77_envptr_3488", %"TName_Option_List_(ByStr20)"* %"$maybeOperators_3489")
  store %TName_Bool* %"$$ud-registry.getIsOAO_77_call_3490", %TName_Bool** %"$ud-registry.getIsOAO_78", align 8
  %"$$ud-registry.getIsOAO_78_3491" = load %TName_Bool*, %TName_Bool** %"$ud-registry.getIsOAO_78", align 8
  store %TName_Bool* %"$$ud-registry.getIsOAO_78_3491", %TName_Bool** %isSenderOAO, align 8
...
"$have_gas_3512":                                 ; preds = %"$out_of_gas_3511", %"$have_gas_3507"
  ...
  store %TName_ud-registry.Record* %"$adtptr_3518", %TName_ud-registry.Record** %newRecord, align 8
...
"$have_gas_3526":                                 ; preds = %"$out_of_gas_3525", %"$have_gas_3512"
  ...
  call void @_update_field(i8* %"$execptr_load_3530", i8* getelementptr inbounds ([8 x i8], [8 x i8]* @"$records_3531", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_325", i32 1, i8* %"$indices_buf_3528", i8* %"$update_value_3533")
...
"$have_gas_3542":                                 ; preds = %"$out_of_gas_3541", %"$have_gas_3537"
  ...
  %"$ud-registry.eConfigured_call_3548" = call { { i8* (i8*, [20 x i8]*)*, i8* } (i8*, [20 x i8]*)*, i8* } %"$ud-registry.eConfigured_fptr_3545"(i8* %"$ud-registry.eConfigured_envptr_3546", [32 x i8]* %"$ud-registry.eConfigured_node_3547")
  store { { i8* (i8*, [20 x i8]*)*, i8* } (i8*, [20 x i8]*)*, i8* } %"$ud-registry.eConfigured_call_3548", { { i8* (i8*, [20 x i8]*)*, i8* } (i8*, [20 x i8]*)*, i8* }* %"$ud-registry.eConfigured_70", align 8
  ...
  %"$$ud-registry.eConfigured_70_call_3553" = call { i8* (i8*, [20 x i8]*)*, i8* } %"$$ud-registry.eConfigured_70_fptr_3550"(i8* %"$$ud-registry.eConfigured_70_envptr_3551", [20 x i8]* %"$$ud-registry.eConfigured_70_owner_3552")
  store { i8* (i8*, [20 x i8]*)*, i8* } %"$$ud-registry.eConfigured_70_call_3553", { i8* (i8*, [20 x i8]*)*, i8* }* %"$ud-registry.eConfigured_71", align 8
  ...
  %"$$ud-registry.eConfigured_71_call_3558" = call i8* %"$$ud-registry.eConfigured_71_fptr_3555"(i8* %"$$ud-registry.eConfigured_71_envptr_3556", [20 x i8]* %"$$ud-registry.eConfigured_71_resolver_3557")
  store i8* %"$$ud-registry.eConfigured_71_call_3558", i8** %"$ud-registry.eConfigured_72", align 8
  %"$$ud-registry.eConfigured_72_3559" = load i8*, i8** %"$ud-registry.eConfigured_72", align 8
  store i8* %"$$ud-registry.eConfigured_72_3559", i8** %e, align 8
...
"$have_gas_3566":                                 ; preds = %"$out_of_gas_3565", %"$have_gas_3542"
  ...
  call void @_event(i8* %"$execptr_load_3568", %_TyDescrTy_Typ* @"$TyDescr_Event_301", i8* %"$e_3569")
...
"$have_gas_3583":                                 ; preds = %"$out_of_gas_3582", %"$have_gas_3578"
  ...
  store i8* %"$msgobj_3585", i8** %m, align 8
...
"$have_gas_3626":                                 ; preds = %"$out_of_gas_3625", %"$have_gas_3583"
  ...
  %"$ud-registry.oneMsg_call_3632" = call %TName_List_Message* %"$ud-registry.oneMsg_fptr_3629"(i8* %"$ud-registry.oneMsg_envptr_3630", i8* %"$m_3631")
  store %TName_List_Message* %"$ud-registry.oneMsg_call_3632", %TName_List_Message** %"$ud-registry.oneMsg_69", align 8
  %"$$ud-registry.oneMsg_69_3633" = load %TName_List_Message*, %TName_List_Message** %"$ud-registry.oneMsg_69", align 8
  store %TName_List_Message* %"$$ud-registry.oneMsg_69_3633", %TName_List_Message** %msgs, align 8
...
"$have_gas_3640":                                 ; preds = %"$out_of_gas_3639", %"$have_gas_3626"
  ...
  call void @_send(i8* %"$execptr_load_3642", %_TyDescrTy_Typ* @"$TyDescr_ADT_List_Message_319", %TName_List_Message* %"$msgs_3643")
...
"$have_gas_3659":                                 ; preds = %"$out_of_gas_3658", %"$have_gas_3654"
  ...
  store %String { i8* getelementptr inbounds ([43 x i8], [43 x i8]* @"$stringlit_3661", i32 0, i32 0), i32 43 }, %String* %m5, align 8
...
"$have_gas_3665":                                 ; preds = %"$out_of_gas_3664", %"$have_gas_3659"
  ...
  %"$ud-registry.eError_call_3671" = call i8* %"$ud-registry.eError_fptr_3668"(i8* %"$ud-registry.eError_envptr_3669", %String %"$m_3670")
  store i8* %"$ud-registry.eError_call_3671", i8** %"$ud-registry.eError_74", align 8
  %"$$ud-registry.eError_74_3672" = load i8*, i8** %"$ud-registry.eError_74", align 8
  store i8* %"$$ud-registry.eError_74_3672", i8** %e4, align 8
...
"$have_gas_3679":                                 ; preds = %"$out_of_gas_3678", %"$have_gas_3665"
  ...
  call void @_event(i8* %"$execptr_load_3681", %_TyDescrTy_Typ* @"$TyDescr_Event_301", i8* %"$e_3682")
...
"$have_gas_3696":                                 ; preds = %"$out_of_gas_3695", %"$have_gas_3691"
  ...
  store i8* %"$msgobj_3698", i8** %"$m_0", align 8
...
"$have_gas_3740":                                 ; preds = %"$out_of_gas_3739", %"$have_gas_3696"
  ...
  %"$ud-registry.oneMsg_call_3746" = call %TName_List_Message* %"$ud-registry.oneMsg_fptr_3743"(i8* %"$ud-registry.oneMsg_envptr_3744", i8* %"$$m_0_3745")
  store %TName_List_Message* %"$ud-registry.oneMsg_call_3746", %TName_List_Message** %"$ud-registry.oneMsg_73", align 8
  %"$$ud-registry.oneMsg_73_3747" = load %TName_List_Message*, %TName_List_Message** %"$ud-registry.oneMsg_73", align 8
  store %TName_List_Message* %"$$ud-registry.oneMsg_73_3747", %TName_List_Message** %msgs6, align 8
...
"$have_gas_3754":                                 ; preds = %"$out_of_gas_3753", %"$have_gas_3740"
  ...
  call void @_send(i8* %"$execptr_load_3756", %_TyDescrTy_Typ* @"$TyDescr_ADT_List_Message_319", %TName_List_Message* %"$msgs_3757")
  br label %"$matchsucc_3497"
...
entry:
  ...
  call void @"$configureNode_3388"(%Uint128 %_amount, [20 x i8]* %"$_origin_3762", [20 x i8]* %"$_sender_3764", [32 x i8]* %"$node_3766", [20 x i8]* %"$owner_3768", [20 x i8]* %"$resolver_3770")
  ret void
}

define internal void @"$configureResolver_3771"(%Uint128 %_amount, [20 x i8]* %"$_origin_3772", [20 x i8]* %"$_sender_3773", [32 x i8]* %"$node_3774", [20 x i8]* %"$resolver_3775") {
entry:
  ...
  %"$maybeRecord_call_3780" = call i8* @_fetch_field(i8* %"$execptr_load_3779", i8* getelementptr inbounds ([8 x i8], [8 x i8]* @"$records_3778", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_325", i32 1, i8* %"$indices_buf_3776", i32 1)
...
"$have_gas_3790":                                 ; preds = %"$out_of_gas_3789", %entry
  ...
  %"$maybeApproved_call_3796" = call i8* @_fetch_field(i8* %"$execptr_load_3795", i8* getelementptr inbounds ([10 x i8], [10 x i8]* @"$approvals_3794", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_324", i32 1, i8* %"$indices_buf_3792", i32 1)
...
"$have_gas_3816":                                 ; preds = %"$out_of_gas_3815", %"$have_gas_3811"
  ...
  call void %"$ud-registry.recordMemberOwner_fptr_3819"(i8* %"$ud-registry.recordMemberOwner_envptr_3820", [20 x i8]* %"$ud-registry.recordMemberOwner_retalloca_3822", %TName_Option_ud-registry.Record* %"$maybeRecord_3821")
  %"$ud-registry.recordMemberOwner_ret_3823" = load [20 x i8], [20 x i8]* %"$ud-registry.recordMemberOwner_retalloca_3822", align 1
  store [20 x i8] %"$ud-registry.recordMemberOwner_ret_3823", [20 x i8]* %"$ud-registry.recordMemberOwner_88", align 1
  %"$$ud-registry.recordMemberOwner_88_3824" = load [20 x i8], [20 x i8]* %"$ud-registry.recordMemberOwner_88", align 1
  store [20 x i8] %"$$ud-registry.recordMemberOwner_88_3824", [20 x i8]* %recordOwner, align 1
  %maybeOperators = alloca %"TName_Option_List_(ByStr20)"*, align 8
  ...
  %"$maybeOperators_call_3830" = call i8* @_fetch_field(i8* %"$execptr_load_3829", i8* getelementptr inbounds ([10 x i8], [10 x i8]* @"$operators_3828", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_323", i32 1, i8* %"$indices_buf_3825", i32 1)
...
"$have_gas_3850":                                 ; preds = %"$out_of_gas_3849", %"$have_gas_3845"
  ...
  %"$ud-registry.getIsOAO_call_3856" = call { { { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* } (i8*, %TName_Option_ByStr20*)*, i8* } (i8*, [20 x i8]*)*, i8* } %"$ud-registry.getIsOAO_fptr_3853"(i8* %"$ud-registry.getIsOAO_envptr_3854", [20 x i8]* %"$ud-registry.getIsOAO__sender_3855")
  store { { { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* } (i8*, %TName_Option_ByStr20*)*, i8* } (i8*, [20 x i8]*)*, i8* } %"$ud-registry.getIsOAO_call_3856", { { { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* } (i8*, %TName_Option_ByStr20*)*, i8* } (i8*, [20 x i8]*)*, i8* }* %"$ud-registry.getIsOAO_84", align 8
  ...
  %"$$ud-registry.getIsOAO_84_call_3862" = call { { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* } (i8*, %TName_Option_ByStr20*)*, i8* } %"$$ud-registry.getIsOAO_84_fptr_3858"(i8* %"$$ud-registry.getIsOAO_84_envptr_3859", [20 x i8]* %"$$ud-registry.getIsOAO_84_recordOwner_3860")
  store { { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* } (i8*, %TName_Option_ByStr20*)*, i8* } %"$$ud-registry.getIsOAO_84_call_3862", { { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* } (i8*, %TName_Option_ByStr20*)*, i8* }* %"$ud-registry.getIsOAO_85", align 8
  ...
  %"$$ud-registry.getIsOAO_85_call_3867" = call { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* } %"$$ud-registry.getIsOAO_85_fptr_3864"(i8* %"$$ud-registry.getIsOAO_85_envptr_3865", %TName_Option_ByStr20* %"$maybeApproved_3866")
  store { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* } %"$$ud-registry.getIsOAO_85_call_3867", { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* }* %"$ud-registry.getIsOAO_86", align 8
  ...
  %"$$ud-registry.getIsOAO_86_call_3872" = call %TName_Bool* %"$$ud-registry.getIsOAO_86_fptr_3869"(i8* %"$$ud-registry.getIsOAO_86_envptr_3870", %"TName_Option_List_(ByStr20)"* %"$maybeOperators_3871")
  store %TName_Bool* %"$$ud-registry.getIsOAO_86_call_3872", %TName_Bool** %"$ud-registry.getIsOAO_87", align 8
  %"$$ud-registry.getIsOAO_87_3873" = load %TName_Bool*, %TName_Bool** %"$ud-registry.getIsOAO_87", align 8
  store %TName_Bool* %"$$ud-registry.getIsOAO_87_3873", %TName_Bool** %isSenderOAO, align 8
...
"$have_gas_3894":                                 ; preds = %"$out_of_gas_3893", %"$have_gas_3889"
  ...
  store %TName_ud-registry.Record* %"$adtptr_3901", %TName_ud-registry.Record** %newRecord, align 8
...
"$have_gas_3909":                                 ; preds = %"$out_of_gas_3908", %"$have_gas_3894"
  ...
  call void @_update_field(i8* %"$execptr_load_3913", i8* getelementptr inbounds ([8 x i8], [8 x i8]* @"$records_3914", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_325", i32 1, i8* %"$indices_buf_3911", i8* %"$update_value_3916")
...
"$have_gas_3925":                                 ; preds = %"$out_of_gas_3924", %"$have_gas_3920"
  ...
  %"$ud-registry.eConfigured_call_3931" = call { { i8* (i8*, [20 x i8]*)*, i8* } (i8*, [20 x i8]*)*, i8* } %"$ud-registry.eConfigured_fptr_3928"(i8* %"$ud-registry.eConfigured_envptr_3929", [32 x i8]* %"$ud-registry.eConfigured_node_3930")
  store { { i8* (i8*, [20 x i8]*)*, i8* } (i8*, [20 x i8]*)*, i8* } %"$ud-registry.eConfigured_call_3931", { { i8* (i8*, [20 x i8]*)*, i8* } (i8*, [20 x i8]*)*, i8* }* %"$ud-registry.eConfigured_80", align 8
  ...
  %"$$ud-registry.eConfigured_80_call_3937" = call { i8* (i8*, [20 x i8]*)*, i8* } %"$$ud-registry.eConfigured_80_fptr_3933"(i8* %"$$ud-registry.eConfigured_80_envptr_3934", [20 x i8]* %"$$ud-registry.eConfigured_80_recordOwner_3935")
  store { i8* (i8*, [20 x i8]*)*, i8* } %"$$ud-registry.eConfigured_80_call_3937", { i8* (i8*, [20 x i8]*)*, i8* }* %"$ud-registry.eConfigured_81", align 8
  ...
  %"$$ud-registry.eConfigured_81_call_3942" = call i8* %"$$ud-registry.eConfigured_81_fptr_3939"(i8* %"$$ud-registry.eConfigured_81_envptr_3940", [20 x i8]* %"$$ud-registry.eConfigured_81_resolver_3941")
  store i8* %"$$ud-registry.eConfigured_81_call_3942", i8** %"$ud-registry.eConfigured_82", align 8
  %"$$ud-registry.eConfigured_82_3943" = load i8*, i8** %"$ud-registry.eConfigured_82", align 8
  store i8* %"$$ud-registry.eConfigured_82_3943", i8** %e, align 8
...
"$have_gas_3950":                                 ; preds = %"$out_of_gas_3949", %"$have_gas_3925"
  ...
  call void @_event(i8* %"$execptr_load_3952", %_TyDescrTy_Typ* @"$TyDescr_Event_301", i8* %"$e_3953")
...
"$have_gas_3969":                                 ; preds = %"$out_of_gas_3968", %"$have_gas_3964"
  ...
  store %String { i8* getelementptr inbounds ([43 x i8], [43 x i8]* @"$stringlit_3971", i32 0, i32 0), i32 43 }, %String* %m, align 8
...
"$have_gas_3975":                                 ; preds = %"$out_of_gas_3974", %"$have_gas_3969"
  ...
  %"$ud-registry.eError_call_3981" = call i8* %"$ud-registry.eError_fptr_3978"(i8* %"$ud-registry.eError_envptr_3979", %String %"$m_3980")
  store i8* %"$ud-registry.eError_call_3981", i8** %"$ud-registry.eError_83", align 8
  %"$$ud-registry.eError_83_3982" = load i8*, i8** %"$ud-registry.eError_83", align 8
  store i8* %"$$ud-registry.eError_83_3982", i8** %e4, align 8
...
"$have_gas_3989":                                 ; preds = %"$out_of_gas_3988", %"$have_gas_3975"
  ...
  call void @_event(i8* %"$execptr_load_3991", %_TyDescrTy_Typ* @"$TyDescr_Event_301", i8* %"$e_3992")
  br label %"$matchsucc_3879"
...
entry:
  ...
  call void @"$configureResolver_3771"(%Uint128 %_amount, [20 x i8]* %"$_origin_3997", [20 x i8]* %"$_sender_3999", [32 x i8]* %"$node_4001", [20 x i8]* %"$resolver_4003")
  ret void
}

define internal void @"$transfer_4004"(%Uint128 %_amount, [20 x i8]* %"$_origin_4005", [20 x i8]* %"$_sender_4006", [32 x i8]* %"$node_4007", [20 x i8]* %"$owner_4008") {
entry:
  ...
  %"$maybeRecord_call_4013" = call i8* @_fetch_field(i8* %"$execptr_load_4012", i8* getelementptr inbounds ([8 x i8], [8 x i8]* @"$records_4011", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_325", i32 1, i8* %"$indices_buf_4009", i32 1)
...
"$have_gas_4023":                                 ; preds = %"$out_of_gas_4022", %entry
  ...
  %"$maybeApproved_call_4029" = call i8* @_fetch_field(i8* %"$execptr_load_4028", i8* getelementptr inbounds ([10 x i8], [10 x i8]* @"$approvals_4027", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_324", i32 1, i8* %"$indices_buf_4025", i32 1)
...
"$have_gas_4049":                                 ; preds = %"$out_of_gas_4048", %"$have_gas_4044"
  ...
  call void %"$ud-registry.recordMemberOwner_fptr_4052"(i8* %"$ud-registry.recordMemberOwner_envptr_4053", [20 x i8]* %"$ud-registry.recordMemberOwner_retalloca_4055", %TName_Option_ud-registry.Record* %"$maybeRecord_4054")
  %"$ud-registry.recordMemberOwner_ret_4056" = load [20 x i8], [20 x i8]* %"$ud-registry.recordMemberOwner_retalloca_4055", align 1
  store [20 x i8] %"$ud-registry.recordMemberOwner_ret_4056", [20 x i8]* %"$ud-registry.recordMemberOwner_99", align 1
  %"$$ud-registry.recordMemberOwner_99_4057" = load [20 x i8], [20 x i8]* %"$ud-registry.recordMemberOwner_99", align 1
  store [20 x i8] %"$$ud-registry.recordMemberOwner_99_4057", [20 x i8]* %recordOwner, align 1
  %maybeOperators = alloca %"TName_Option_List_(ByStr20)"*, align 8
  ...
  %"$maybeOperators_call_4063" = call i8* @_fetch_field(i8* %"$execptr_load_4062", i8* getelementptr inbounds ([10 x i8], [10 x i8]* @"$operators_4061", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_323", i32 1, i8* %"$indices_buf_4058", i32 1)
...
"$have_gas_4083":                                 ; preds = %"$out_of_gas_4082", %"$have_gas_4078"
  ...
  %"$ud-registry.getIsOAO_call_4089" = call { { { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* } (i8*, %TName_Option_ByStr20*)*, i8* } (i8*, [20 x i8]*)*, i8* } %"$ud-registry.getIsOAO_fptr_4086"(i8* %"$ud-registry.getIsOAO_envptr_4087", [20 x i8]* %"$ud-registry.getIsOAO__sender_4088")
  store { { { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* } (i8*, %TName_Option_ByStr20*)*, i8* } (i8*, [20 x i8]*)*, i8* } %"$ud-registry.getIsOAO_call_4089", { { { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* } (i8*, %TName_Option_ByStr20*)*, i8* } (i8*, [20 x i8]*)*, i8* }* %"$ud-registry.getIsOAO_95", align 8
  ...
  %"$$ud-registry.getIsOAO_95_call_4095" = call { { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* } (i8*, %TName_Option_ByStr20*)*, i8* } %"$$ud-registry.getIsOAO_95_fptr_4091"(i8* %"$$ud-registry.getIsOAO_95_envptr_4092", [20 x i8]* %"$$ud-registry.getIsOAO_95_recordOwner_4093")
  store { { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* } (i8*, %TName_Option_ByStr20*)*, i8* } %"$$ud-registry.getIsOAO_95_call_4095", { { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* } (i8*, %TName_Option_ByStr20*)*, i8* }* %"$ud-registry.getIsOAO_96", align 8
  ...
  %"$$ud-registry.getIsOAO_96_call_4100" = call { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* } %"$$ud-registry.getIsOAO_96_fptr_4097"(i8* %"$$ud-registry.getIsOAO_96_envptr_4098", %TName_Option_ByStr20* %"$maybeApproved_4099")
  store { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* } %"$$ud-registry.getIsOAO_96_call_4100", { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* }* %"$ud-registry.getIsOAO_97", align 8
  ...
  %"$$ud-registry.getIsOAO_97_call_4105" = call %TName_Bool* %"$$ud-registry.getIsOAO_97_fptr_4102"(i8* %"$$ud-registry.getIsOAO_97_envptr_4103", %"TName_Option_List_(ByStr20)"* %"$maybeOperators_4104")
  store %TName_Bool* %"$$ud-registry.getIsOAO_97_call_4105", %TName_Bool** %"$ud-registry.getIsOAO_98", align 8
  %"$$ud-registry.getIsOAO_98_4106" = load %TName_Bool*, %TName_Bool** %"$ud-registry.getIsOAO_98", align 8
  store %TName_Bool* %"$$ud-registry.getIsOAO_98_4106", %TName_Bool** %isSenderOAO, align 8
...
"$have_gas_4122":                                 ; preds = %"$out_of_gas_4121", %"$True_4117"
  ...
  call void @_update_field(i8* %"$execptr_load_4126", i8* getelementptr inbounds ([10 x i8], [10 x i8]* @"$approvals_4127", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_324", i32 1, i8* %"$indices_buf_4124", i8* null)
...
"$have_gas_4136":                                 ; preds = %"$out_of_gas_4135", %"$have_gas_4131"
  ...
  store %TName_ud-registry.Record* %"$adtptr_4143", %TName_ud-registry.Record** %newRecord, align 8
...
"$have_gas_4151":                                 ; preds = %"$out_of_gas_4150", %"$have_gas_4136"
  ...
  call void @_update_field(i8* %"$execptr_load_4155", i8* getelementptr inbounds ([8 x i8], [8 x i8]* @"$records_4156", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_325", i32 1, i8* %"$indices_buf_4153", i8* %"$update_value_4158")
...
"$have_gas_4167":                                 ; preds = %"$out_of_gas_4166", %"$have_gas_4162"
  ...
  %"$ud-registry.eConfigured_call_4173" = call { { i8* (i8*, [20 x i8]*)*, i8* } (i8*, [20 x i8]*)*, i8* } %"$ud-registry.eConfigured_fptr_4170"(i8* %"$ud-registry.eConfigured_envptr_4171", [32 x i8]* %"$ud-registry.eConfigured_node_4172")
  store { { i8* (i8*, [20 x i8]*)*, i8* } (i8*, [20 x i8]*)*, i8* } %"$ud-registry.eConfigured_call_4173", { { i8* (i8*, [20 x i8]*)*, i8* } (i8*, [20 x i8]*)*, i8* }* %"$ud-registry.eConfigured_90", align 8
  ...
  %"$$ud-registry.eConfigured_90_call_4178" = call { i8* (i8*, [20 x i8]*)*, i8* } %"$$ud-registry.eConfigured_90_fptr_4175"(i8* %"$$ud-registry.eConfigured_90_envptr_4176", [20 x i8]* %"$$ud-registry.eConfigured_90_owner_4177")
  store { i8* (i8*, [20 x i8]*)*, i8* } %"$$ud-registry.eConfigured_90_call_4178", { i8* (i8*, [20 x i8]*)*, i8* }* %"$ud-registry.eConfigured_91", align 8
  ...
  %"$$ud-registry.eConfigured_91_call_4184" = call i8* %"$$ud-registry.eConfigured_91_fptr_4180"(i8* %"$$ud-registry.eConfigured_91_envptr_4181", [20 x i8]* %"$$ud-registry.eConfigured_91_ud-registry.zeroByStr20_4182")
  store i8* %"$$ud-registry.eConfigured_91_call_4184", i8** %"$ud-registry.eConfigured_92", align 8
  %"$$ud-registry.eConfigured_92_4185" = load i8*, i8** %"$ud-registry.eConfigured_92", align 8
  store i8* %"$$ud-registry.eConfigured_92_4185", i8** %e, align 8
...
"$have_gas_4192":                                 ; preds = %"$out_of_gas_4191", %"$have_gas_4167"
  ...
  call void @_event(i8* %"$execptr_load_4194", %_TyDescrTy_Typ* @"$TyDescr_Event_301", i8* %"$e_4195")
...
"$have_gas_4209":                                 ; preds = %"$out_of_gas_4208", %"$have_gas_4204"
  ...
  store i8* %"$msgobj_4211", i8** %m, align 8
...
"$have_gas_4252":                                 ; preds = %"$out_of_gas_4251", %"$have_gas_4209"
  ...
  %"$ud-registry.oneMsg_call_4258" = call %TName_List_Message* %"$ud-registry.oneMsg_fptr_4255"(i8* %"$ud-registry.oneMsg_envptr_4256", i8* %"$m_4257")
  store %TName_List_Message* %"$ud-registry.oneMsg_call_4258", %TName_List_Message** %"$ud-registry.oneMsg_89", align 8
  %"$$ud-registry.oneMsg_89_4259" = load %TName_List_Message*, %TName_List_Message** %"$ud-registry.oneMsg_89", align 8
  store %TName_List_Message* %"$$ud-registry.oneMsg_89_4259", %TName_List_Message** %msgs, align 8
...
"$have_gas_4266":                                 ; preds = %"$out_of_gas_4265", %"$have_gas_4252"
  ...
  call void @_send(i8* %"$execptr_load_4268", %_TyDescrTy_Typ* @"$TyDescr_ADT_List_Message_319", %TName_List_Message* %"$msgs_4269")
...
"$have_gas_4285":                                 ; preds = %"$out_of_gas_4284", %"$have_gas_4280"
  ...
  store %String { i8* getelementptr inbounds ([43 x i8], [43 x i8]* @"$stringlit_4287", i32 0, i32 0), i32 43 }, %String* %m6, align 8
...
"$have_gas_4291":                                 ; preds = %"$out_of_gas_4290", %"$have_gas_4285"
  ...
  %"$ud-registry.eError_call_4297" = call i8* %"$ud-registry.eError_fptr_4294"(i8* %"$ud-registry.eError_envptr_4295", %String %"$m_4296")
  store i8* %"$ud-registry.eError_call_4297", i8** %"$ud-registry.eError_94", align 8
  %"$$ud-registry.eError_94_4298" = load i8*, i8** %"$ud-registry.eError_94", align 8
  store i8* %"$$ud-registry.eError_94_4298", i8** %e5, align 8
...
"$have_gas_4305":                                 ; preds = %"$out_of_gas_4304", %"$have_gas_4291"
  ...
  call void @_event(i8* %"$execptr_load_4307", %_TyDescrTy_Typ* @"$TyDescr_Event_301", i8* %"$e_4308")
...
"$have_gas_4322":                                 ; preds = %"$out_of_gas_4321", %"$have_gas_4317"
  ...
  store i8* %"$msgobj_4324", i8** %"$m_1", align 8
...
"$have_gas_4365":                                 ; preds = %"$out_of_gas_4364", %"$have_gas_4322"
  ...
  %"$ud-registry.oneMsg_call_4371" = call %TName_List_Message* %"$ud-registry.oneMsg_fptr_4368"(i8* %"$ud-registry.oneMsg_envptr_4369", i8* %"$$m_1_4370")
  store %TName_List_Message* %"$ud-registry.oneMsg_call_4371", %TName_List_Message** %"$ud-registry.oneMsg_93", align 8
  %"$$ud-registry.oneMsg_93_4372" = load %TName_List_Message*, %TName_List_Message** %"$ud-registry.oneMsg_93", align 8
  store %TName_List_Message* %"$$ud-registry.oneMsg_93_4372", %TName_List_Message** %msgs7, align 8
...
"$have_gas_4379":                                 ; preds = %"$out_of_gas_4378", %"$have_gas_4365"
  ...
  call void @_send(i8* %"$execptr_load_4381", %_TyDescrTy_Typ* @"$TyDescr_ADT_List_Message_319", %TName_List_Message* %"$msgs_4382")
  br label %"$matchsucc_4112"
...
entry:
  ...
  call void @"$transfer_4004"(%Uint128 %_amount, [20 x i8]* %"$_origin_4387", [20 x i8]* %"$_sender_4389", [32 x i8]* %"$node_4391", [20 x i8]* %"$owner_4393")
  ret void
}

define internal void @"$assign_4394"(%Uint128 %_amount, [20 x i8]* %"$_origin_4395", [20 x i8]* %"$_sender_4396", [32 x i8]* %"$parent_4397", %String %label, [20 x i8]* %"$owner_4398") {
entry:
  ...
  %"$maybeRecord_call_4403" = call i8* @_fetch_field(i8* %"$execptr_load_4402", i8* getelementptr inbounds ([8 x i8], [8 x i8]* @"$records_4401", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_325", i32 1, i8* %"$indices_buf_4399", i32 1)
...
"$have_gas_4413":                                 ; preds = %"$out_of_gas_4412", %entry
  ...
  %"$maybeApproved_call_4419" = call i8* @_fetch_field(i8* %"$execptr_load_4418", i8* getelementptr inbounds ([10 x i8], [10 x i8]* @"$approvals_4417", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_324", i32 1, i8* %"$indices_buf_4415", i32 1)
...
"$have_gas_4439":                                 ; preds = %"$out_of_gas_4438", %"$have_gas_4434"
  ...
  call void %"$ud-registry.recordMemberOwner_fptr_4442"(i8* %"$ud-registry.recordMemberOwner_envptr_4443", [20 x i8]* %"$ud-registry.recordMemberOwner_retalloca_4445", %TName_Option_ud-registry.Record* %"$maybeRecord_4444")
  %"$ud-registry.recordMemberOwner_ret_4446" = load [20 x i8], [20 x i8]* %"$ud-registry.recordMemberOwner_retalloca_4445", align 1
  store [20 x i8] %"$ud-registry.recordMemberOwner_ret_4446", [20 x i8]* %"$ud-registry.recordMemberOwner_114", align 1
  %"$$ud-registry.recordMemberOwner_114_4447" = load [20 x i8], [20 x i8]* %"$ud-registry.recordMemberOwner_114", align 1
  store [20 x i8] %"$$ud-registry.recordMemberOwner_114_4447", [20 x i8]* %recordOwner, align 1
  %maybeOperators = alloca %"TName_Option_List_(ByStr20)"*, align 8
  ...
  %"$maybeOperators_call_4453" = call i8* @_fetch_field(i8* %"$execptr_load_4452", i8* getelementptr inbounds ([10 x i8], [10 x i8]* @"$operators_4451", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_323", i32 1, i8* %"$indices_buf_4448", i32 1)
...
"$have_gas_4473":                                 ; preds = %"$out_of_gas_4472", %"$have_gas_4468"
  ...
  %"$ud-registry.getIsOAO_call_4479" = call { { { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* } (i8*, %TName_Option_ByStr20*)*, i8* } (i8*, [20 x i8]*)*, i8* } %"$ud-registry.getIsOAO_fptr_4476"(i8* %"$ud-registry.getIsOAO_envptr_4477", [20 x i8]* %"$ud-registry.getIsOAO__sender_4478")
  store { { { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* } (i8*, %TName_Option_ByStr20*)*, i8* } (i8*, [20 x i8]*)*, i8* } %"$ud-registry.getIsOAO_call_4479", { { { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* } (i8*, %TName_Option_ByStr20*)*, i8* } (i8*, [20 x i8]*)*, i8* }* %"$ud-registry.getIsOAO_110", align 8
  ...
  %"$$ud-registry.getIsOAO_110_call_4485" = call { { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* } (i8*, %TName_Option_ByStr20*)*, i8* } %"$$ud-registry.getIsOAO_110_fptr_4481"(i8* %"$$ud-registry.getIsOAO_110_envptr_4482", [20 x i8]* %"$$ud-registry.getIsOAO_110_recordOwner_4483")
  store { { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* } (i8*, %TName_Option_ByStr20*)*, i8* } %"$$ud-registry.getIsOAO_110_call_4485", { { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* } (i8*, %TName_Option_ByStr20*)*, i8* }* %"$ud-registry.getIsOAO_111", align 8
  ...
  %"$$ud-registry.getIsOAO_111_call_4490" = call { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* } %"$$ud-registry.getIsOAO_111_fptr_4487"(i8* %"$$ud-registry.getIsOAO_111_envptr_4488", %TName_Option_ByStr20* %"$maybeApproved_4489")
  store { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* } %"$$ud-registry.getIsOAO_111_call_4490", { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* }* %"$ud-registry.getIsOAO_112", align 8
  ...
  %"$$ud-registry.getIsOAO_112_call_4495" = call %TName_Bool* %"$$ud-registry.getIsOAO_112_fptr_4492"(i8* %"$$ud-registry.getIsOAO_112_envptr_4493", %"TName_Option_List_(ByStr20)"* %"$maybeOperators_4494")
  store %TName_Bool* %"$$ud-registry.getIsOAO_112_call_4495", %TName_Bool** %"$ud-registry.getIsOAO_113", align 8
  %"$$ud-registry.getIsOAO_113_4496" = load %TName_Bool*, %TName_Bool** %"$ud-registry.getIsOAO_113", align 8
  store %TName_Bool* %"$$ud-registry.getIsOAO_113_4496", %TName_Bool** %isSenderOAO, align 8
...
"$have_gas_4517":                                 ; preds = %"$out_of_gas_4516", %"$have_gas_4512"
  ...
  %"$ud-registry.parentLabelToNode_call_4523" = call { void (i8*, [32 x i8]*, %String)*, i8* } %"$ud-registry.parentLabelToNode_fptr_4520"(i8* %"$ud-registry.parentLabelToNode_envptr_4521", [32 x i8]* %"$ud-registry.parentLabelToNode_parent_4522")
  store { void (i8*, [32 x i8]*, %String)*, i8* } %"$ud-registry.parentLabelToNode_call_4523", { void (i8*, [32 x i8]*, %String)*, i8* }* %"$ud-registry.parentLabelToNode_106", align 8
  ...
  call void %"$$ud-registry.parentLabelToNode_106_fptr_4525"(i8* %"$$ud-registry.parentLabelToNode_106_envptr_4526", [32 x i8]* %"$$ud-registry.parentLabelToNode_106_retalloca_4527", %String %label)
  %"$$ud-registry.parentLabelToNode_106_ret_4528" = load [32 x i8], [32 x i8]* %"$$ud-registry.parentLabelToNode_106_retalloca_4527", align 1
  store [32 x i8] %"$$ud-registry.parentLabelToNode_106_ret_4528", [32 x i8]* %"$ud-registry.parentLabelToNode_107", align 1
  %"$$ud-registry.parentLabelToNode_107_4529" = load [32 x i8], [32 x i8]* %"$ud-registry.parentLabelToNode_107", align 1
  store [32 x i8] %"$$ud-registry.parentLabelToNode_107_4529", [32 x i8]* %node, align 1
  ...
  %"$recordExists_call_4535" = call i8* @_fetch_field(i8* %"$execptr_load_4534", i8* getelementptr inbounds ([8 x i8], [8 x i8]* @"$records_4533", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_325", i32 1, i8* %"$indices_buf_4530", i32 0)
...
"$have_gas_4567":                                 ; preds = %"$out_of_gas_4566", %"$have_gas_4562"
  ...
  %"$ud-registry.eNewDomain_call_4573" = call { i8* (i8*, %String)*, i8* } %"$ud-registry.eNewDomain_fptr_4570"(i8* %"$ud-registry.eNewDomain_envptr_4571", [32 x i8]* %"$ud-registry.eNewDomain_parent_4572")
  store { i8* (i8*, %String)*, i8* } %"$ud-registry.eNewDomain_call_4573", { i8* (i8*, %String)*, i8* }* %"$ud-registry.eNewDomain_104", align 8
  ...
  %"$$ud-registry.eNewDomain_104_call_4577" = call i8* %"$$ud-registry.eNewDomain_104_fptr_4575"(i8* %"$$ud-registry.eNewDomain_104_envptr_4576", %String %label)
  store i8* %"$$ud-registry.eNewDomain_104_call_4577", i8** %"$ud-registry.eNewDomain_105", align 8
  %"$$ud-registry.eNewDomain_105_4578" = load i8*, i8** %"$ud-registry.eNewDomain_105", align 8
  store i8* %"$$ud-registry.eNewDomain_105_4578", i8** %e, align 8
...
"$have_gas_4585":                                 ; preds = %"$out_of_gas_4584", %"$have_gas_4567"
  ...
  call void @_event(i8* %"$execptr_load_4587", %_TyDescrTy_Typ* @"$TyDescr_Event_301", i8* %"$e_4588")
...
"$have_gas_4592":                                 ; preds = %"$out_of_gas_4591", %"$matchsucc_4552"
  ...
  call void @_update_field(i8* %"$execptr_load_4597", i8* getelementptr inbounds ([10 x i8], [10 x i8]* @"$approvals_4598", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_324", i32 1, i8* %"$indices_buf_4594", i8* null)
...
"$have_gas_4607":                                 ; preds = %"$out_of_gas_4606", %"$have_gas_4602"
  ...
  store %TName_ud-registry.Record* %"$adtptr_4614", %TName_ud-registry.Record** %newRecord, align 8
...
"$have_gas_4622":                                 ; preds = %"$out_of_gas_4621", %"$have_gas_4607"
  ...
  call void @_update_field(i8* %"$execptr_load_4627", i8* getelementptr inbounds ([8 x i8], [8 x i8]* @"$records_4628", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_325", i32 1, i8* %"$indices_buf_4624", i8* %"$update_value_4630")
...
"$have_gas_4639":                                 ; preds = %"$out_of_gas_4638", %"$have_gas_4634"
  ...
  %"$ud-registry.eConfigured_call_4646" = call { { i8* (i8*, [20 x i8]*)*, i8* } (i8*, [20 x i8]*)*, i8* } %"$ud-registry.eConfigured_fptr_4642"(i8* %"$ud-registry.eConfigured_envptr_4643", [32 x i8]* %"$ud-registry.eConfigured_node_4644")
  store { { i8* (i8*, [20 x i8]*)*, i8* } (i8*, [20 x i8]*)*, i8* } %"$ud-registry.eConfigured_call_4646", { { i8* (i8*, [20 x i8]*)*, i8* } (i8*, [20 x i8]*)*, i8* }* %"$ud-registry.eConfigured_101", align 8
  ...
  %"$$ud-registry.eConfigured_101_call_4651" = call { i8* (i8*, [20 x i8]*)*, i8* } %"$$ud-registry.eConfigured_101_fptr_4648"(i8* %"$$ud-registry.eConfigured_101_envptr_4649", [20 x i8]* %"$$ud-registry.eConfigured_101_owner_4650")
  store { i8* (i8*, [20 x i8]*)*, i8* } %"$$ud-registry.eConfigured_101_call_4651", { i8* (i8*, [20 x i8]*)*, i8* }* %"$ud-registry.eConfigured_102", align 8
  ...
  %"$$ud-registry.eConfigured_102_call_4657" = call i8* %"$$ud-registry.eConfigured_102_fptr_4653"(i8* %"$$ud-registry.eConfigured_102_envptr_4654", [20 x i8]* %"$$ud-registry.eConfigured_102_ud-registry.zeroByStr20_4655")
  store i8* %"$$ud-registry.eConfigured_102_call_4657", i8** %"$ud-registry.eConfigured_103", align 8
  %"$$ud-registry.eConfigured_103_4658" = load i8*, i8** %"$ud-registry.eConfigured_103", align 8
  store i8* %"$$ud-registry.eConfigured_103_4658", i8** %e6, align 8
...
"$have_gas_4665":                                 ; preds = %"$out_of_gas_4664", %"$have_gas_4639"
  ...
  call void @_event(i8* %"$execptr_load_4667", %_TyDescrTy_Typ* @"$TyDescr_Event_301", i8* %"$e_4668")
...
"$have_gas_4682":                                 ; preds = %"$out_of_gas_4681", %"$have_gas_4677"
  ...
  store i8* %"$msgobj_4684", i8** %m, align 8
...
"$have_gas_4732":                                 ; preds = %"$out_of_gas_4731", %"$have_gas_4682"
  ...
  %"$ud-registry.oneMsg_call_4738" = call %TName_List_Message* %"$ud-registry.oneMsg_fptr_4735"(i8* %"$ud-registry.oneMsg_envptr_4736", i8* %"$m_4737")
  store %TName_List_Message* %"$ud-registry.oneMsg_call_4738", %TName_List_Message** %"$ud-registry.oneMsg_100", align 8
  %"$$ud-registry.oneMsg_100_4739" = load %TName_List_Message*, %TName_List_Message** %"$ud-registry.oneMsg_100", align 8
  store %TName_List_Message* %"$$ud-registry.oneMsg_100_4739", %TName_List_Message** %msgs, align 8
...
"$have_gas_4746":                                 ; preds = %"$out_of_gas_4745", %"$have_gas_4732"
  ...
  call void @_send(i8* %"$execptr_load_4748", %_TyDescrTy_Typ* @"$TyDescr_ADT_List_Message_319", %TName_List_Message* %"$msgs_4749")
...
"$have_gas_4765":                                 ; preds = %"$out_of_gas_4764", %"$have_gas_4760"
  ...
  store %String { i8* getelementptr inbounds ([45 x i8], [45 x i8]* @"$stringlit_4767", i32 0, i32 0), i32 45 }, %String* %m8, align 8
...
"$have_gas_4771":                                 ; preds = %"$out_of_gas_4770", %"$have_gas_4765"
  ...
  %"$ud-registry.eError_call_4777" = call i8* %"$ud-registry.eError_fptr_4774"(i8* %"$ud-registry.eError_envptr_4775", %String %"$m_4776")
  store i8* %"$ud-registry.eError_call_4777", i8** %"$ud-registry.eError_109", align 8
  %"$$ud-registry.eError_109_4778" = load i8*, i8** %"$ud-registry.eError_109", align 8
  store i8* %"$$ud-registry.eError_109_4778", i8** %e7, align 8
...
"$have_gas_4785":                                 ; preds = %"$out_of_gas_4784", %"$have_gas_4771"
  ...
  call void @_event(i8* %"$execptr_load_4787", %_TyDescrTy_Typ* @"$TyDescr_Event_301", i8* %"$e_4788")
...
"$have_gas_4802":                                 ; preds = %"$out_of_gas_4801", %"$have_gas_4797"
  ...
  store i8* %"$msgobj_4804", i8** %"$m_2", align 8
...
"$have_gas_4853":                                 ; preds = %"$out_of_gas_4852", %"$have_gas_4802"
  ...
  %"$ud-registry.oneMsg_call_4859" = call %TName_List_Message* %"$ud-registry.oneMsg_fptr_4856"(i8* %"$ud-registry.oneMsg_envptr_4857", i8* %"$$m_2_4858")
  store %TName_List_Message* %"$ud-registry.oneMsg_call_4859", %TName_List_Message** %"$ud-registry.oneMsg_108", align 8
  %"$$ud-registry.oneMsg_108_4860" = load %TName_List_Message*, %TName_List_Message** %"$ud-registry.oneMsg_108", align 8
  store %TName_List_Message* %"$$ud-registry.oneMsg_108_4860", %TName_List_Message** %msgs9, align 8
...
"$have_gas_4867":                                 ; preds = %"$out_of_gas_4866", %"$have_gas_4853"
  ...
  call void @_send(i8* %"$execptr_load_4869", %_TyDescrTy_Typ* @"$TyDescr_ADT_List_Message_319", %TName_List_Message* %"$msgs_4870")
  br label %"$matchsucc_4502"
...
entry:
  ...
  call void @"$assign_4394"(%Uint128 %_amount, [20 x i8]* %"$_origin_4875", [20 x i8]* %"$_sender_4877", [32 x i8]* %"$parent_4879", %String %label, [20 x i8]* %"$owner_4883")
  ret void
}

define internal void @"$bestow_4884"(%Uint128 %_amount, [20 x i8]* %"$_origin_4885", [20 x i8]* %"$_sender_4886", %String %label, [20 x i8]* %"$owner_4887", [20 x i8]* %"$resolver_4888") {
entry:
  ...
  %"$currentAdmins_call_4891" = call i8* @_fetch_field(i8* %"$execptr_load_4890", i8* getelementptr inbounds ([7 x i8], [7 x i8]* @"$admins_4889", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_ADT_List_ByStr20_320", i32 0, i8* null, i32 1)
...
"$have_gas_4910":                                 ; preds = %"$out_of_gas_4909", %"$have_gas_4905"
  ...
  call void %"$$ud-registry.parentLabelToNode_132_fptr_4919"(i8* %"$$ud-registry.parentLabelToNode_132_envptr_4920", [32 x i8]* %"$$ud-registry.parentLabelToNode_132_retalloca_4921", %String %label)
  %"$$ud-registry.parentLabelToNode_132_ret_4922" = load [32 x i8], [32 x i8]* %"$$ud-registry.parentLabelToNode_132_retalloca_4921", align 1
  store [32 x i8] %"$$ud-registry.parentLabelToNode_132_ret_4922", [32 x i8]* %"$ud-registry.parentLabelToNode_133", align 1
  %"$$ud-registry.parentLabelToNode_133_4923" = load [32 x i8], [32 x i8]* %"$ud-registry.parentLabelToNode_133", align 1
  store [32 x i8] %"$$ud-registry.parentLabelToNode_133_4923", [32 x i8]* %node, align 1
  %recordExists = alloca %TName_Bool*, align 8
  ...
  %"$recordExists_call_4929" = call i8* @_fetch_field(i8* %"$execptr_load_4928", i8* getelementptr inbounds ([8 x i8], [8 x i8]* @"$records_4927", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_325", i32 1, i8* %"$indices_buf_4924", i32 0)
...
"$have_gas_4939":                                 ; preds = %"$out_of_gas_4938", %"$have_gas_4910"
  ...
  %"$maybeRecord_call_4946" = call i8* @_fetch_field(i8* %"$execptr_load_4945", i8* getelementptr inbounds ([8 x i8], [8 x i8]* @"$records_4944", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_325", i32 1, i8* %"$indices_buf_4941", i32 1)
...
"$have_gas_4956":                                 ; preds = %"$out_of_gas_4955", %"$have_gas_4939"
  ...
  %"$currentRegistrar_call_4960" = call i8* @_fetch_field(i8* %"$execptr_load_4959", i8* getelementptr inbounds ([10 x i8], [10 x i8]* @"$registrar_4958", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Bystr20_311", i32 0, i8* null, i32 1)
...
"$have_gas_4986":                                 ; preds = %"$out_of_gas_4985", %"$have_gas_4981"
  ...
  %"$ud-registry.listByStr20Contains_call_4992" = call { %TName_Bool* (i8*, [20 x i8]*)*, i8* } %"$ud-registry.listByStr20Contains_fptr_4989"(i8* %"$ud-registry.listByStr20Contains_envptr_4990", %TName_List_ByStr20* %"$currentAdmins_4991")
  store { %TName_Bool* (i8*, [20 x i8]*)*, i8* } %"$ud-registry.listByStr20Contains_call_4992", { %TName_Bool* (i8*, [20 x i8]*)*, i8* }* %"$ud-registry.listByStr20Contains_121", align 8
  ...
  %"$$ud-registry.listByStr20Contains_121_call_4997" = call %TName_Bool* %"$$ud-registry.listByStr20Contains_121_fptr_4994"(i8* %"$$ud-registry.listByStr20Contains_121_envptr_4995", [20 x i8]* %"$$ud-registry.listByStr20Contains_121__sender_4996")
  store %TName_Bool* %"$$ud-registry.listByStr20Contains_121_call_4997", %TName_Bool** %"$ud-registry.listByStr20Contains_122", align 8
  %"$$ud-registry.listByStr20Contains_122_4998" = load %TName_Bool*, %TName_Bool** %"$ud-registry.listByStr20Contains_122", align 8
  store %TName_Bool* %"$$ud-registry.listByStr20Contains_122_4998", %TName_Bool** %isSenderAdmin, align 8
...
"$have_gas_5002":                                 ; preds = %"$out_of_gas_5001", %"$have_gas_4986"
  ...
  %"$eq_call_5010" = call %TName_Bool* @_eq_ByStrX(i8* %"$execptr_load_5004", i32 20, i8* %"$$eq_currentRegistrar_5005_5007", i8* %"$$eq__sender_5008_5009")
  store %TName_Bool* %"$eq_call_5010", %TName_Bool** %isSenderRegistrar, align 8
...
"$have_gas_5020":                                 ; preds = %"$out_of_gas_5019", %"$have_gas_5015"
  ...
  %"$BoolUtils.orb_call_5026" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.orb_fptr_5023"(i8* %"$BoolUtils.orb_envptr_5024", %TName_Bool* %"$isSenderRegistrar_5025")
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.orb_call_5026", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.orb_123", align 8
  ...
  %"$$BoolUtils.orb_123_call_5031" = call %TName_Bool* %"$$BoolUtils.orb_123_fptr_5028"(i8* %"$$BoolUtils.orb_123_envptr_5029", %TName_Bool* %"$isSenderAdmin_5030")
  store %TName_Bool* %"$$BoolUtils.orb_123_call_5031", %TName_Bool** %"$BoolUtils.orb_124", align 8
  %"$$BoolUtils.orb_124_5032" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.orb_124", align 8
  store %TName_Bool* %"$$BoolUtils.orb_124_5032", %TName_Bool** %isOkSender, align 8
...
"$have_gas_5041":                                 ; preds = %"$out_of_gas_5040", %"$have_gas_5036"
  ...
  call void %"$ud-registry.recordMemberOwner_fptr_5044"(i8* %"$ud-registry.recordMemberOwner_envptr_5045", [20 x i8]* %"$ud-registry.recordMemberOwner_retalloca_5047", %TName_Option_ud-registry.Record* %"$maybeRecord_5046")
  %"$ud-registry.recordMemberOwner_ret_5048" = load [20 x i8], [20 x i8]* %"$ud-registry.recordMemberOwner_retalloca_5047", align 1
  store [20 x i8] %"$ud-registry.recordMemberOwner_ret_5048", [20 x i8]* %"$ud-registry.recordMemberOwner_125", align 1
  %"$$ud-registry.recordMemberOwner_125_5049" = load [20 x i8], [20 x i8]* %"$ud-registry.recordMemberOwner_125", align 1
  store [20 x i8] %"$$ud-registry.recordMemberOwner_125_5049", [20 x i8]* %recordOwner, align 1
...
"$have_gas_5053":                                 ; preds = %"$out_of_gas_5052", %"$have_gas_5041"
  ...
  %"$eq_call_5062" = call %TName_Bool* @_eq_ByStrX(i8* %"$execptr_load_5055", i32 20, i8* %"$$eq_recordOwner_5056_5058", i8* %"$$eq_ud-registry.zeroByStr20_5059_5061")
  store %TName_Bool* %"$eq_call_5062", %TName_Bool** %recordIsUnowned, align 8
...
"$have_gas_5067":                                 ; preds = %"$out_of_gas_5066", %"$have_gas_5053"
  ...
  %"$eq_call_5076" = call %TName_Bool* @_eq_ByStrX(i8* %"$execptr_load_5069", i32 20, i8* %"$$eq_recordOwner_5070_5072", i8* %"$$eq_currentRegistrar_5073_5075")
  store %TName_Bool* %"$eq_call_5076", %TName_Bool** %recordIsOwnedByRegistrar, align 8
...
"$have_gas_5086":                                 ; preds = %"$out_of_gas_5085", %"$have_gas_5081"
  ...
  %"$BoolUtils.andb_call_5092" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_fptr_5089"(i8* %"$BoolUtils.andb_envptr_5090", %TName_Bool* %"$recordIsOwnedByRegistrar_5091")
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_call_5092", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.andb_126", align 8
  ...
  %"$$BoolUtils.andb_126_call_5097" = call %TName_Bool* %"$$BoolUtils.andb_126_fptr_5094"(i8* %"$$BoolUtils.andb_126_envptr_5095", %TName_Bool* %"$isSenderRegistrar_5096")
  store %TName_Bool* %"$$BoolUtils.andb_126_call_5097", %TName_Bool** %"$BoolUtils.andb_127", align 8
  %"$$BoolUtils.andb_127_5098" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.andb_127", align 8
  store %TName_Bool* %"$$BoolUtils.andb_127_5098", %TName_Bool** %isRegistrarSenderAndOwned, align 8
...
"$have_gas_5107":                                 ; preds = %"$out_of_gas_5106", %"$have_gas_5102"
  ...
  %"$BoolUtils.orb_call_5113" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.orb_fptr_5110"(i8* %"$BoolUtils.orb_envptr_5111", %TName_Bool* %"$recordIsUnowned_5112")
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.orb_call_5113", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.orb_128", align 8
  ...
  %"$$BoolUtils.orb_128_call_5118" = call %TName_Bool* %"$$BoolUtils.orb_128_fptr_5115"(i8* %"$$BoolUtils.orb_128_envptr_5116", %TName_Bool* %"$isRegistrarSenderAndOwned_5117")
  store %TName_Bool* %"$$BoolUtils.orb_128_call_5118", %TName_Bool** %"$BoolUtils.orb_129", align 8
  %"$$BoolUtils.orb_129_5119" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.orb_129", align 8
  store %TName_Bool* %"$$BoolUtils.orb_129_5119", %TName_Bool** %isOkRecordOwner, align 8
...
"$have_gas_5123":                                 ; preds = %"$out_of_gas_5122", %"$have_gas_5107"
  ...
  %"$BoolUtils.andb_call_5129" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_fptr_5126"(i8* %"$BoolUtils.andb_envptr_5127", %TName_Bool* %"$isOkSender_5128")
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_call_5129", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.andb_130", align 8
  ...
  %"$$BoolUtils.andb_130_call_5134" = call %TName_Bool* %"$$BoolUtils.andb_130_fptr_5131"(i8* %"$$BoolUtils.andb_130_envptr_5132", %TName_Bool* %"$isOkRecordOwner_5133")
  store %TName_Bool* %"$$BoolUtils.andb_130_call_5134", %TName_Bool** %"$BoolUtils.andb_131", align 8
  %"$$BoolUtils.andb_131_5135" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.andb_131", align 8
  store %TName_Bool* %"$$BoolUtils.andb_131_5135", %TName_Bool** %isOk, align 8
...
"$have_gas_5168":                                 ; preds = %"$out_of_gas_5167", %"$have_gas_5163"
  ...
  %"$$ud-registry.eNewDomain_118_call_5179" = call i8* %"$$ud-registry.eNewDomain_118_fptr_5177"(i8* %"$$ud-registry.eNewDomain_118_envptr_5178", %String %label)
  store i8* %"$$ud-registry.eNewDomain_118_call_5179", i8** %"$ud-registry.eNewDomain_119", align 8
  %"$$ud-registry.eNewDomain_119_5180" = load i8*, i8** %"$ud-registry.eNewDomain_119", align 8
  store i8* %"$$ud-registry.eNewDomain_119_5180", i8** %e, align 8
...
"$have_gas_5187":                                 ; preds = %"$out_of_gas_5186", %"$have_gas_5168"
  ...
  call void @_event(i8* %"$execptr_load_5189", %_TyDescrTy_Typ* @"$TyDescr_Event_301", i8* %"$e_5190")
...
"$have_gas_5199":                                 ; preds = %"$out_of_gas_5198", %"$have_gas_5194"
  ...
  store %TName_ud-registry.Record* %"$adtptr_5205", %TName_ud-registry.Record** %newRecord, align 8
...
"$have_gas_5213":                                 ; preds = %"$out_of_gas_5212", %"$have_gas_5199"
  ...
  call void @_update_field(i8* %"$execptr_load_5218", i8* getelementptr inbounds ([8 x i8], [8 x i8]* @"$records_5219", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_325", i32 1, i8* %"$indices_buf_5215", i8* %"$update_value_5221")
...
"$have_gas_5230":                                 ; preds = %"$out_of_gas_5229", %"$have_gas_5225"
  ...
  %"$ud-registry.eConfigured_call_5237" = call { { i8* (i8*, [20 x i8]*)*, i8* } (i8*, [20 x i8]*)*, i8* } %"$ud-registry.eConfigured_fptr_5233"(i8* %"$ud-registry.eConfigured_envptr_5234", [32 x i8]* %"$ud-registry.eConfigured_node_5235")
  store { { i8* (i8*, [20 x i8]*)*, i8* } (i8*, [20 x i8]*)*, i8* } %"$ud-registry.eConfigured_call_5237", { { i8* (i8*, [20 x i8]*)*, i8* } (i8*, [20 x i8]*)*, i8* }* %"$ud-registry.eConfigured_115", align 8
  ...
  %"$$ud-registry.eConfigured_115_call_5242" = call { i8* (i8*, [20 x i8]*)*, i8* } %"$$ud-registry.eConfigured_115_fptr_5239"(i8* %"$$ud-registry.eConfigured_115_envptr_5240", [20 x i8]* %"$$ud-registry.eConfigured_115_owner_5241")
  store { i8* (i8*, [20 x i8]*)*, i8* } %"$$ud-registry.eConfigured_115_call_5242", { i8* (i8*, [20 x i8]*)*, i8* }* %"$ud-registry.eConfigured_116", align 8
  ...
  %"$$ud-registry.eConfigured_116_call_5247" = call i8* %"$$ud-registry.eConfigured_116_fptr_5244"(i8* %"$$ud-registry.eConfigured_116_envptr_5245", [20 x i8]* %"$$ud-registry.eConfigured_116_resolver_5246")
  store i8* %"$$ud-registry.eConfigured_116_call_5247", i8** %"$ud-registry.eConfigured_117", align 8
  %"$$ud-registry.eConfigured_117_5248" = load i8*, i8** %"$ud-registry.eConfigured_117", align 8
  store i8* %"$$ud-registry.eConfigured_117_5248", i8** %e3, align 8
...
"$have_gas_5255":                                 ; preds = %"$out_of_gas_5254", %"$have_gas_5230"
  ...
  call void @_event(i8* %"$execptr_load_5257", %_TyDescrTy_Typ* @"$TyDescr_Event_301", i8* %"$e_5258")
...
"$have_gas_5274":                                 ; preds = %"$out_of_gas_5273", %"$have_gas_5269"
  ...
  store %String { i8* getelementptr inbounds ([12 x i8], [12 x i8]* @"$stringlit_5276", i32 0, i32 0), i32 12 }, %String* %m, align 8
...
"$have_gas_5280":                                 ; preds = %"$out_of_gas_5279", %"$have_gas_5274"
  ...
  %"$ud-registry.eError_call_5286" = call i8* %"$ud-registry.eError_fptr_5283"(i8* %"$ud-registry.eError_envptr_5284", %String %"$m_5285")
  store i8* %"$ud-registry.eError_call_5286", i8** %"$ud-registry.eError_120", align 8
  %"$$ud-registry.eError_120_5287" = load i8*, i8** %"$ud-registry.eError_120", align 8
  store i8* %"$$ud-registry.eError_120_5287", i8** %e4, align 8
...
"$have_gas_5294":                                 ; preds = %"$out_of_gas_5293", %"$have_gas_5280"
  ...
  call void @_event(i8* %"$execptr_load_5296", %_TyDescrTy_Typ* @"$TyDescr_Event_301", i8* %"$e_5297")
  br label %"$matchsucc_5141"
...
entry:
  ...
  call void @"$bestow_4884"(%Uint128 %_amount, [20 x i8]* %"$_origin_5302", [20 x i8]* %"$_sender_5304", %String %label, [20 x i8]* %"$owner_5308", [20 x i8]* %"$resolver_5310")
  ret void
}

define internal void @"$setRegistrar_5311"(%Uint128 %_amount, [20 x i8]* %"$_origin_5312", [20 x i8]* %"$_sender_5313", [20 x i8]* %"$address_5314") {
entry:
  ...
  %"$currentAdmins_call_5317" = call i8* @_fetch_field(i8* %"$execptr_load_5316", i8* getelementptr inbounds ([7 x i8], [7 x i8]* @"$admins_5315", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_ADT_List_ByStr20_320", i32 0, i8* null, i32 1)
...
"$have_gas_5336":                                 ; preds = %"$out_of_gas_5335", %"$have_gas_5331"
  ...
  %"$ud-registry.listByStr20Contains_call_5342" = call { %TName_Bool* (i8*, [20 x i8]*)*, i8* } %"$ud-registry.listByStr20Contains_fptr_5339"(i8* %"$ud-registry.listByStr20Contains_envptr_5340", %TName_List_ByStr20* %"$currentAdmins_5341")
  store { %TName_Bool* (i8*, [20 x i8]*)*, i8* } %"$ud-registry.listByStr20Contains_call_5342", { %TName_Bool* (i8*, [20 x i8]*)*, i8* }* %"$ud-registry.listByStr20Contains_135", align 8
  ...
  %"$$ud-registry.listByStr20Contains_135_call_5347" = call %TName_Bool* %"$$ud-registry.listByStr20Contains_135_fptr_5344"(i8* %"$$ud-registry.listByStr20Contains_135_envptr_5345", [20 x i8]* %"$$ud-registry.listByStr20Contains_135__sender_5346")
  store %TName_Bool* %"$$ud-registry.listByStr20Contains_135_call_5347", %TName_Bool** %"$ud-registry.listByStr20Contains_136", align 8
  %"$$ud-registry.listByStr20Contains_136_5348" = load %TName_Bool*, %TName_Bool** %"$ud-registry.listByStr20Contains_136", align 8
  store %TName_Bool* %"$$ud-registry.listByStr20Contains_136_5348", %TName_Bool** %isOk, align 8
...
"$have_gas_5369":                                 ; preds = %"$out_of_gas_5368", %"$have_gas_5364"
  ...
  %"$ud-registry.eNewRegistrar_call_5375" = call i8* %"$ud-registry.eNewRegistrar_fptr_5372"(i8* %"$ud-registry.eNewRegistrar_envptr_5373", [20 x i8]* %"$ud-registry.eNewRegistrar_address_5374")
  store i8* %"$ud-registry.eNewRegistrar_call_5375", i8** %"$ud-registry.eNewRegistrar_134", align 8
  %"$$ud-registry.eNewRegistrar_134_5376" = load i8*, i8** %"$ud-registry.eNewRegistrar_134", align 8
  store i8* %"$$ud-registry.eNewRegistrar_134_5376", i8** %e, align 8
...
"$have_gas_5383":                                 ; preds = %"$out_of_gas_5382", %"$have_gas_5369"
  ...
  call void @_event(i8* %"$execptr_load_5385", %_TyDescrTy_Typ* @"$TyDescr_Event_301", i8* %"$e_5386")
...
"$have_gas_5393":                                 ; preds = %"$out_of_gas_5392", %"$have_gas_5383"
  ...
  call void @_update_field(i8* %"$execptr_load_5395", i8* getelementptr inbounds ([10 x i8], [10 x i8]* @"$registrar_5396", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Bystr20_311", i32 0, i8* null, i8* %"$update_value_5398")
...
entry:
  ...
  call void @"$setRegistrar_5311"(%Uint128 %_amount, [20 x i8]* %"$_origin_5403", [20 x i8]* %"$_sender_5405", [20 x i8]* %"$address_5407")
  ret void
}

define internal void @"$register_5408"(%Uint128 %_amount, [20 x i8]* %"$_origin_5409", [20 x i8]* %"$_sender_5410", [32 x i8]* %"$parent_5411", %String %label) {
entry:
...
"$have_gas_5420":                                 ; preds = %"$out_of_gas_5419", %"$have_gas_5415"
  ...
  %"$ud-registry.parentLabelToNode_call_5426" = call { void (i8*, [32 x i8]*, %String)*, i8* } %"$ud-registry.parentLabelToNode_fptr_5423"(i8* %"$ud-registry.parentLabelToNode_envptr_5424", [32 x i8]* %"$ud-registry.parentLabelToNode_parent_5425")
  store { void (i8*, [32 x i8]*, %String)*, i8* } %"$ud-registry.parentLabelToNode_call_5426", { void (i8*, [32 x i8]*, %String)*, i8* }* %"$ud-registry.parentLabelToNode_141", align 8
  ...
  call void %"$$ud-registry.parentLabelToNode_141_fptr_5428"(i8* %"$$ud-registry.parentLabelToNode_141_envptr_5429", [32 x i8]* %"$$ud-registry.parentLabelToNode_141_retalloca_5430", %String %label)
  %"$$ud-registry.parentLabelToNode_141_ret_5431" = load [32 x i8], [32 x i8]* %"$$ud-registry.parentLabelToNode_141_retalloca_5430", align 1
  store [32 x i8] %"$$ud-registry.parentLabelToNode_141_ret_5431", [32 x i8]* %"$ud-registry.parentLabelToNode_142", align 1
  %"$$ud-registry.parentLabelToNode_142_5432" = load [32 x i8], [32 x i8]* %"$ud-registry.parentLabelToNode_142", align 1
  store [32 x i8] %"$$ud-registry.parentLabelToNode_142_5432", [32 x i8]* %node, align 1
  %maybeRecord = alloca %TName_Option_ud-registry.Record*, align 8
  ...
  %"$maybeRecord_call_5438" = call i8* @_fetch_field(i8* %"$execptr_load_5437", i8* getelementptr inbounds ([8 x i8], [8 x i8]* @"$records_5436", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_325", i32 1, i8* %"$indices_buf_5433", i32 1)
...
"$have_gas_5448":                                 ; preds = %"$out_of_gas_5447", %"$have_gas_5420"
  ...
  %"$maybeApproved_call_5455" = call i8* @_fetch_field(i8* %"$execptr_load_5454", i8* getelementptr inbounds ([10 x i8], [10 x i8]* @"$approvals_5453", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_324", i32 1, i8* %"$indices_buf_5450", i32 1)
...
"$have_gas_5475":                                 ; preds = %"$out_of_gas_5474", %"$have_gas_5470"
  ...
  call void %"$ud-registry.recordMemberOwner_fptr_5478"(i8* %"$ud-registry.recordMemberOwner_envptr_5479", [20 x i8]* %"$ud-registry.recordMemberOwner_retalloca_5481", %TName_Option_ud-registry.Record* %"$maybeRecord_5480")
  %"$ud-registry.recordMemberOwner_ret_5482" = load [20 x i8], [20 x i8]* %"$ud-registry.recordMemberOwner_retalloca_5481", align 1
  store [20 x i8] %"$ud-registry.recordMemberOwner_ret_5482", [20 x i8]* %"$ud-registry.recordMemberOwner_140", align 1
  %"$$ud-registry.recordMemberOwner_140_5483" = load [20 x i8], [20 x i8]* %"$ud-registry.recordMemberOwner_140", align 1
  store [20 x i8] %"$$ud-registry.recordMemberOwner_140_5483", [20 x i8]* %recordOwner, align 1
...
"$have_gas_5504":                                 ; preds = %"$out_of_gas_5503", %"$None_5499"
  ...
  store [20 x i8] %"$ud-registry.zeroByStr20_5506", [20 x i8]* %approved, align 1
...
"$have_gas_5514":                                 ; preds = %"$out_of_gas_5513", %"$Some_5507"
  ...
  store [20 x i8] %"$approved_5516", [20 x i8]* %approved2, align 1
  br label %"$matchsucc_5494"
...
"$matchsucc_5494":                                ; preds = %"$have_gas_5514", %"$have_gas_5504", %"$empty_default_5498"
  ...
  %"$currentRegistrar_call_5519" = call i8* @_fetch_field(i8* %"$execptr_load_5518", i8* getelementptr inbounds ([10 x i8], [10 x i8]* @"$registrar_5517", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Bystr20_311", i32 0, i8* null, i32 1)
...
"$have_gas_5540":                                 ; preds = %"$out_of_gas_5539", %"$have_gas_5535"
  ...
  %"$eq_call_5549" = call %TName_Bool* @_eq_ByStrX(i8* %"$execptr_load_5542", i32 20, i8* %"$$eq_recordOwner_5543_5545", i8* %"$$eq_ud-registry.zeroByStr20_5546_5548")
  store %TName_Bool* %"$eq_call_5549", %TName_Bool** %isRecordUnowned, align 8
...
"$have_gas_5554":                                 ; preds = %"$out_of_gas_5553", %"$have_gas_5540"
  ...
  %"$eq_call_5563" = call %TName_Bool* @_eq_ByStrX(i8* %"$execptr_load_5556", i32 20, i8* %"$$eq_approved_5557_5559", i8* %"$$eq_ud-registry.zeroByStr20_5560_5562")
  store %TName_Bool* %"$eq_call_5563", %TName_Bool** %isUnapproved, align 8
...
"$have_gas_5568":                                 ; preds = %"$out_of_gas_5567", %"$have_gas_5554"
  ...
  %"$BoolUtils.andb_call_5574" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_fptr_5571"(i8* %"$BoolUtils.andb_envptr_5572", %TName_Bool* %"$isRecordUnowned_5573")
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_call_5574", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.andb_138", align 8
  ...
  %"$$BoolUtils.andb_138_call_5579" = call %TName_Bool* %"$$BoolUtils.andb_138_fptr_5576"(i8* %"$$BoolUtils.andb_138_envptr_5577", %TName_Bool* %"$isUnapproved_5578")
  store %TName_Bool* %"$$BoolUtils.andb_138_call_5579", %TName_Bool** %"$BoolUtils.andb_139", align 8
  %"$$BoolUtils.andb_139_5580" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.andb_139", align 8
  store %TName_Bool* %"$$BoolUtils.andb_139_5580", %TName_Bool** %isOk, align 8
...
"$have_gas_5596":                                 ; preds = %"$out_of_gas_5595", %"$True_5591"
  ...
  call void @_accept(i8* %"$execptr_load_5598")
...
"$have_gas_5612":                                 ; preds = %"$out_of_gas_5611", %"$have_gas_5607"
  ...
  store i8* %"$msgobj_5614", i8** %m, align 8
...
"$have_gas_5671":                                 ; preds = %"$out_of_gas_5670", %"$have_gas_5612"
  ...
  %"$ud-registry.oneMsg_call_5677" = call %TName_List_Message* %"$ud-registry.oneMsg_fptr_5674"(i8* %"$ud-registry.oneMsg_envptr_5675", i8* %"$m_5676")
  store %TName_List_Message* %"$ud-registry.oneMsg_call_5677", %TName_List_Message** %"$ud-registry.oneMsg_137", align 8
  %"$$ud-registry.oneMsg_137_5678" = load %TName_List_Message*, %TName_List_Message** %"$ud-registry.oneMsg_137", align 8
  store %TName_List_Message* %"$$ud-registry.oneMsg_137_5678", %TName_List_Message** %msgs, align 8
...
"$have_gas_5685":                                 ; preds = %"$out_of_gas_5684", %"$have_gas_5671"
  ...
  call void @_send(i8* %"$execptr_load_5687", %_TyDescrTy_Typ* @"$TyDescr_ADT_List_Message_319", %TName_List_Message* %"$msgs_5688")
...
entry:
  ...
  call void @"$register_5408"(%Uint128 %_amount, [20 x i8]* %"$_origin_5695", [20 x i8]* %"$_sender_5697", [32 x i8]* %"$parent_5699", %String %label)
  ret void
}

define internal void @"$onResolverConfigured_5702"(%Uint128 %_amount, [20 x i8]* %"$_origin_5703", [20 x i8]* %"$_sender_5704", [32 x i8]* %"$node_5705") {
entry:
  ...
  %"$maybeRecord_call_5710" = call i8* @_fetch_field(i8* %"$execptr_load_5709", i8* getelementptr inbounds ([8 x i8], [8 x i8]* @"$records_5708", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_325", i32 1, i8* %"$indices_buf_5706", i32 1)
...
"$have_gas_5757":                                 ; preds = %"$out_of_gas_5756", %"$ud-registry.Record_5748"
  ...
  %"$eq_call_5765" = call %TName_Bool* @_eq_ByStrX(i8* %"$execptr_load_5759", i32 20, i8* %"$$eq_resolver_5760_5762", i8* %"$$eq__sender_5763_5764")
  store %TName_Bool* %"$eq_call_5765", %TName_Bool** %isOk, align 8
...
"$have_gas_5787":                                 ; preds = %"$out_of_gas_5786", %"$have_gas_5782"
  ...
  %"$ud-registry.eConfigured_call_5793" = call { { i8* (i8*, [20 x i8]*)*, i8* } (i8*, [20 x i8]*)*, i8* } %"$ud-registry.eConfigured_fptr_5790"(i8* %"$ud-registry.eConfigured_envptr_5791", [32 x i8]* %"$ud-registry.eConfigured_node_5792")
  store { { i8* (i8*, [20 x i8]*)*, i8* } (i8*, [20 x i8]*)*, i8* } %"$ud-registry.eConfigured_call_5793", { { i8* (i8*, [20 x i8]*)*, i8* } (i8*, [20 x i8]*)*, i8* }* %"$ud-registry.eConfigured_143", align 8
  ...
  %"$$ud-registry.eConfigured_143_call_5799" = call { i8* (i8*, [20 x i8]*)*, i8* } %"$$ud-registry.eConfigured_143_fptr_5795"(i8* %"$$ud-registry.eConfigured_143_envptr_5796", [20 x i8]* %"$$ud-registry.eConfigured_143_owner_5797")
  store { i8* (i8*, [20 x i8]*)*, i8* } %"$$ud-registry.eConfigured_143_call_5799", { i8* (i8*, [20 x i8]*)*, i8* }* %"$ud-registry.eConfigured_144", align 8
  ...
  %"$$ud-registry.eConfigured_144_call_5805" = call i8* %"$$ud-registry.eConfigured_144_fptr_5801"(i8* %"$$ud-registry.eConfigured_144_envptr_5802", [20 x i8]* %"$$ud-registry.eConfigured_144_resolver_5803")
  store i8* %"$$ud-registry.eConfigured_144_call_5805", i8** %"$ud-registry.eConfigured_145", align 8
  %"$$ud-registry.eConfigured_145_5806" = load i8*, i8** %"$ud-registry.eConfigured_145", align 8
  store i8* %"$$ud-registry.eConfigured_145_5806", i8** %e, align 8
...
"$have_gas_5813":                                 ; preds = %"$out_of_gas_5812", %"$have_gas_5787"
  ...
  call void @_event(i8* %"$execptr_load_5815", %_TyDescrTy_Typ* @"$TyDescr_Event_301", i8* %"$e_5816")
...
entry:
  ...
  call void @"$onResolverConfigured_5702"(%Uint128 %_amount, [20 x i8]* %"$_origin_5823", [20 x i8]* %"$_sender_5825", [32 x i8]* %"$node_5827")
  ret void
}
