...
define internal %TName_Bool* @"$fundef_119"(%"$$fundef_119_env_288"* %0, [20 x i8]* %1, [20 x i8]* %2, %TName_Option_ByStr20* %3, %"TName_Option_List_(ByStr20)"* %4) {
entry:
...
"$have_gas_1808":                                 ; preds = %"$out_of_gas_1807", %"$have_gas_1803"
  ...
  %"$eq_call_1815" = call %TName_Bool* @_eq_ByStrX(i8* %"$execptr_load_1810", i32 20, i8* %"$$eq_sender_1811_1812", i8* %"$$eq_recordOwner_1813_1814")
  store %TName_Bool* %"$eq_call_1815", %TName_Bool** %isOwner, align 8
...
"$have_gas_1836":                                 ; preds = %"$out_of_gas_1835", %"$None_1831"
  ...
  store %TName_Bool* %"$adtptr_1840", %TName_Bool** %isApproved, align 8
...
"$have_gas_1848":                                 ; preds = %"$out_of_gas_1847", %"$Some_1841"
  ...
  %"$eq_call_1856" = call %TName_Bool* @_eq_ByStrX(i8* %"$execptr_load_1850", i32 20, i8* %"$$eq_sender_1851_1852", i8* %"$$eq_approved_1853_1855")
  store %TName_Bool* %"$eq_call_1856", %TName_Bool** %isApproved, align 8
  br label %"$matchsucc_1827"
...
"$have_gas_1877":                                 ; preds = %"$out_of_gas_1876", %"$None_1872"
  ...
  store %TName_Bool* %"$adtptr_1881", %TName_Bool** %isOperator, align 8
...
"$have_gas_1889":                                 ; preds = %"$out_of_gas_1888", %"$Some_1882"
  ...
  %"$ud-registry.listByStr20Contains_call_1896" = call %TName_Bool* %"$ud-registry.listByStr20Contains_fptr_1892"(i8* %"$ud-registry.listByStr20Contains_envptr_1893", %TName_List_ByStr20* %"$operators_1894", [20 x i8]* %"$ud-registry.listByStr20Contains_sender_1895")
  store %TName_Bool* %"$ud-registry.listByStr20Contains_call_1896", %TName_Bool** %isOperator, align 8
  br label %"$matchsucc_1868"
...
"$have_gas_1905":                                 ; preds = %"$out_of_gas_1904", %"$have_gas_1900"
  ...
  %"$BoolUtils.orb_call_1912" = call %TName_Bool* %"$BoolUtils.orb_fptr_1908"(i8* %"$BoolUtils.orb_envptr_1909", %TName_Bool* %"$isOwner_1910", %TName_Bool* %"$isApproved_1911")
  store %TName_Bool* %"$BoolUtils.orb_call_1912", %TName_Bool** %b1, align 8
...
"$have_gas_1916":                                 ; preds = %"$out_of_gas_1915", %"$have_gas_1905"
  ...
  %"$BoolUtils.orb_call_1923" = call %TName_Bool* %"$BoolUtils.orb_fptr_1919"(i8* %"$BoolUtils.orb_envptr_1920", %TName_Bool* %"$b1_1921", %TName_Bool* %"$isOperator_1922")
  store %TName_Bool* %"$BoolUtils.orb_call_1923", %TName_Bool** %"$retval_120", align 8
  %"$$retval_120_1924" = load %TName_Bool*, %TName_Bool** %"$retval_120", align 8
  ret %TName_Bool* %"$$retval_120_1924"
}

define internal void @"$fundef_121"(%"$$fundef_121_env_289"* %0, [32 x i8]* %1, [32 x i8]* %2, %String %3) {
entry:
...
"$have_gas_1747":                                 ; preds = %"$out_of_gas_1746", %"$have_gas_1734"
  ...
  %"$sha256hash_call_1752" = call [32 x i8]* @_sha256hash(i8* %"$execptr_load_1749", %_TyDescrTy_Typ* @"$TyDescr_String_178", i8* %"$$sha256hash_label_1750_1751")
...
"$have_gas_1763":                                 ; preds = %"$out_of_gas_1762", %"$have_gas_1758"
  ...
  %"$concat_call_1771" = call i8* @_concat_ByStrX(i8* %"$execptr_load_1765", i32 32, i8* %"$$concat_parent_1766_1767", i32 32, i8* %"$$concat_labelHash_1768_1770")
...
"$have_gas_1786":                                 ; preds = %"$out_of_gas_1785", %"$have_gas_1763"
  ...
  %"$sha256hash_call_1792" = call [32 x i8]* @_sha256hash(i8* %"$execptr_load_1788", %_TyDescrTy_Typ* @"$TyDescr_Bystr64_190", i8* %"$$sha256hash_nodeInput_1789_1791")
  %"$sha256hash_1794" = load [32 x i8], [32 x i8]* %"$sha256hash_call_1792", align 1
  store [32 x i8] %"$sha256hash_1794", [32 x i8]* %"$retval_122", align 1
  %"$$retval_122_1795" = load [32 x i8], [32 x i8]* %"$retval_122", align 1
  store [32 x i8] %"$$retval_122_1795", [32 x i8]* %1, align 1
  ret void
}

define internal void @"$fundef_123"(%"$$fundef_123_env_290"* %0, [20 x i8]* %1, %TName_Option_ud-registry.Record* %2) {
entry:
...
define internal i8* @"$fundef_125"(%"$$fundef_125_env_291"* %0, %String %1) {
entry:
...
"$have_gas_1665":                                 ; preds = %"$out_of_gas_1664", %entry
  ...
  store i8* %"$msgobj_1667", i8** %"$retval_126", align 8
  %"$$retval_126_1684" = load i8*, i8** %"$retval_126", align 8
  ret i8* %"$$retval_126_1684"
}

define internal i8* @"$fundef_127"(%"$$fundef_127_env_292"* %0, [32 x i8]* %1, [20 x i8]* %2, [20 x i8]* %3) {
entry:
...
"$have_gas_1628":                                 ; preds = %"$out_of_gas_1627", %entry
  ...
  store i8* %"$msgobj_1630", i8** %"$retval_128", align 8
  %"$$retval_128_1661" = load i8*, i8** %"$retval_128", align 8
  ret i8* %"$$retval_128_1661"
}

define internal i8* @"$fundef_129"(%"$$fundef_129_env_293"* %0, [32 x i8]* %1, %String %2) {
entry:
...
"$have_gas_1598":                                 ; preds = %"$out_of_gas_1597", %entry
  ...
  store i8* %"$msgobj_1600", i8** %"$retval_130", align 8
  %"$$retval_130_1624" = load i8*, i8** %"$retval_130", align 8
  ret i8* %"$$retval_130_1624"
}

define internal i8* @"$fundef_131"(%"$$fundef_131_env_294"* %0, [20 x i8]* %1) {
entry:
...
"$have_gas_1575":                                 ; preds = %"$out_of_gas_1574", %entry
  ...
  store i8* %"$msgobj_1577", i8** %"$retval_132", align 8
  %"$$retval_132_1594" = load i8*, i8** %"$retval_132", align 8
  ret i8* %"$$retval_132_1594"
}

define internal i8* @"$fundef_133"(%"$$fundef_133_env_295"* %0, [20 x i8]* %1) {
entry:
  %address = load [20 x i8], [20 x i8]* %1, align 1
...
"$have_gas_1552":                                 ; preds = %"$out_of_gas_1551", %entry
  ...
  store i8* %"$msgobj_1554", i8** %"$retval_134", align 8
  %"$$retval_134_1571" = load i8*, i8** %"$retval_134", align 8
  ret i8* %"$$retval_134_1571"
}

define internal i8* @"$fundef_135"(%"$$fundef_135_env_296"* %0, [20 x i8]* %1, [20 x i8]* %2, %TName_Bool* %3) {
entry:
...
"$have_gas_1515":                                 ; preds = %"$out_of_gas_1514", %entry
  ...
  store i8* %"$msgobj_1517", i8** %"$retval_136", align 8
  %"$$retval_136_1548" = load i8*, i8** %"$retval_136", align 8
  ret i8* %"$$retval_136_1548"
}

define internal i8* @"$fundef_137"(%"$$fundef_137_env_297"* %0, [20 x i8]* %1, %TName_Bool* %2) {
entry:
  %address = load [20 x i8], [20 x i8]* %1, align 1
...
"$have_gas_1485":                                 ; preds = %"$out_of_gas_1484", %entry
  ...
  store i8* %"$msgobj_1487", i8** %"$retval_138", align 8
  %"$$retval_138_1511" = load i8*, i8** %"$retval_138", align 8
  ret i8* %"$$retval_138_1511"
}

define internal %TName_Bool* @"$fundef_139"(%"$$fundef_139_env_298"* %0, %TName_Bool* %1, %TName_Bool* %2) {
entry:
...
"$have_gas_1435":                                 ; preds = %"$out_of_gas_1434", %"$True_1430"
  ...
  store %TName_Bool* %"$adtptr_1439", %TName_Bool** %"$retval_140", align 8
...
"$have_gas_1445":                                 ; preds = %"$out_of_gas_1444", %"$False_1440"
  ...
  store %TName_Bool* %"$adtptr_1449", %TName_Bool** %"$retval_140", align 8
  br label %"$matchsucc_1426"
...
"$have_gas_1466":                                 ; preds = %"$out_of_gas_1465", %"$True_1461"
  ...
  store %TName_Bool* %"$adtptr_1470", %TName_Bool** %"$retval_140", align 8
...
"$have_gas_1476":                                 ; preds = %"$out_of_gas_1475", %"$False_1471"
  ...
  store %TName_Bool* %"$adtptr_1480", %TName_Bool** %"$retval_140", align 8
  br label %"$matchsucc_1457"
...
define internal %TName_Bool* @"$fundef_143"(%"$$fundef_143_env_299"* %0, [20 x i8]* %1) {
entry:
...
"$have_gas_1388":                                 ; preds = %"$out_of_gas_1387", %"$have_gas_1383"
  ...
  %"$eq_call_1396" = call %TName_Bool* @_eq_ByStrX(i8* %"$execptr_load_1390", i32 20, i8* %"$$eq_v_1391_1392", i8* %"$$eq_bs_1393_1395")
  store %TName_Bool* %"$eq_call_1396", %TName_Bool** %b, align 8
...
"$have_gas_1401":                                 ; preds = %"$out_of_gas_1400", %"$have_gas_1388"
  ...
  %"$BoolUtils.negb_call_1407" = call %TName_Bool* %"$BoolUtils.negb_fptr_1404"(i8* %"$BoolUtils.negb_envptr_1405", %TName_Bool* %"$b_1406")
  store %TName_Bool* %"$BoolUtils.negb_call_1407", %TName_Bool** %"$BoolUtils.negb_34", align 8
  %"$$BoolUtils.negb_34_1408" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.negb_34", align 8
  store %TName_Bool* %"$$BoolUtils.negb_34_1408", %TName_Bool** %"$retval_144", align 8
  %"$$retval_144_1409" = load %TName_Bool*, %TName_Bool** %"$retval_144", align 8
  ret %TName_Bool* %"$$retval_144_1409"
}

define internal %TName_List_ByStr20* @"$fundef_141"(%"$$fundef_141_env_300"* %0, %TName_List_ByStr20* %1, [20 x i8]* %2) {
entry:
...
"$have_gas_1334":                                 ; preds = %"$out_of_gas_1333", %"$have_gas_1329"
  ...
  %"$ListUtils.list_filter_call_1342" = call { { %TName_List_ByStr20* (i8*, %TName_List_ByStr20*)*, i8* } (i8*, { %TName_Bool* (i8*, [20 x i8]*)*, i8* })*, i8* } %"$ListUtils.list_filter_fptr_1340"(i8* %"$ListUtils.list_filter_envptr_1341")
  store { { %TName_List_ByStr20* (i8*, %TName_List_ByStr20*)*, i8* } (i8*, { %TName_Bool* (i8*, [20 x i8]*)*, i8* })*, i8* } %"$ListUtils.list_filter_call_1342", { { %TName_List_ByStr20* (i8*, %TName_List_ByStr20*)*, i8* } (i8*, { %TName_Bool* (i8*, [20 x i8]*)*, i8* })*, i8* }* %listByStr20Filter, align 8
...
"$have_gas_1351":                                 ; preds = %"$out_of_gas_1350", %"$have_gas_1346"
  ...
  store { %TName_Bool* (i8*, [20 x i8]*)*, i8* } %"$$fundef_143_cloval_1356", { %TName_Bool* (i8*, [20 x i8]*)*, i8* }* %fn, align 8
...
"$have_gas_1363":                                 ; preds = %"$out_of_gas_1362", %"$have_gas_1351"
  ...
  %"$listByStr20Filter_call_1369" = call { %TName_List_ByStr20* (i8*, %TName_List_ByStr20*)*, i8* } %"$listByStr20Filter_fptr_1366"(i8* %"$listByStr20Filter_envptr_1367", { %TName_Bool* (i8*, [20 x i8]*)*, i8* } %"$fn_1368")
  store { %TName_List_ByStr20* (i8*, %TName_List_ByStr20*)*, i8* } %"$listByStr20Filter_call_1369", { %TName_List_ByStr20* (i8*, %TName_List_ByStr20*)*, i8* }* %"$listByStr20Filter_35", align 8
  ...
  %"$$listByStr20Filter_35_call_1373" = call %TName_List_ByStr20* %"$$listByStr20Filter_35_fptr_1371"(i8* %"$$listByStr20Filter_35_envptr_1372", %TName_List_ByStr20* %1)
  store %TName_List_ByStr20* %"$$listByStr20Filter_35_call_1373", %TName_List_ByStr20** %"$listByStr20Filter_36", align 8
  %"$$listByStr20Filter_36_1374" = load %TName_List_ByStr20*, %TName_List_ByStr20** %"$listByStr20Filter_36", align 8
  store %TName_List_ByStr20* %"$$listByStr20Filter_36_1374", %TName_List_ByStr20** %"$retval_142", align 8
  %"$$retval_142_1375" = load %TName_List_ByStr20*, %TName_List_ByStr20** %"$retval_142", align 8
  ret %TName_List_ByStr20* %"$$retval_142_1375"
}

define internal %TName_Bool* @"$fundef_145"(%"$$fundef_145_env_301"* %0, %TName_List_ByStr20* %1, [20 x i8]* %2) {
entry:
  %bs = load [20 x i8], [20 x i8]* %2, align 1
...
"$have_gas_1303":                                 ; preds = %"$out_of_gas_1302", %"$have_gas_1298"
  ...
  %"$ud-registry.listByStr20Contains_call_1309" = call %TName_Bool* %"$ud-registry.listByStr20Contains_fptr_1306"(i8* %"$ud-registry.listByStr20Contains_envptr_1307", %TName_List_ByStr20* %1, [20 x i8]* %"$ud-registry.listByStr20Contains_bs_1308")
  store %TName_Bool* %"$ud-registry.listByStr20Contains_call_1309", %TName_Bool** %b, align 8
...
"$have_gas_1313":                                 ; preds = %"$out_of_gas_1312", %"$have_gas_1303"
  ...
  %"$BoolUtils.negb_call_1319" = call %TName_Bool* %"$BoolUtils.negb_fptr_1316"(i8* %"$BoolUtils.negb_envptr_1317", %TName_Bool* %"$b_1318")
  store %TName_Bool* %"$BoolUtils.negb_call_1319", %TName_Bool** %"$BoolUtils.negb_33", align 8
  %"$$BoolUtils.negb_33_1320" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.negb_33", align 8
  store %TName_Bool* %"$$BoolUtils.negb_33_1320", %TName_Bool** %"$retval_146", align 8
  %"$$retval_146_1321" = load %TName_Bool*, %TName_Bool** %"$retval_146", align 8
  ret %TName_Bool* %"$$retval_146_1321"
}

define internal %TName_Bool* @"$fundef_147"(%"$$fundef_147_env_302"* %0, %TName_List_ByStr20* %1, [20 x i8]* %2) {
entry:
  %bs = load [20 x i8], [20 x i8]* %2, align 1
...
"$have_gas_1261":                                 ; preds = %"$out_of_gas_1260", %"$have_gas_1256"
  ...
  %"$ListUtils.list_mem_call_1269" = call { { { %TName_Bool* (i8*, %TName_List_ByStr20*)*, i8* } (i8*, [20 x i8]*)*, i8* } (i8*, { { %TName_Bool* (i8*, [20 x i8]*)*, i8* } (i8*, [20 x i8]*)*, i8* })*, i8* } %"$ListUtils.list_mem_fptr_1267"(i8* %"$ListUtils.list_mem_envptr_1268")
  store { { { %TName_Bool* (i8*, %TName_List_ByStr20*)*, i8* } (i8*, [20 x i8]*)*, i8* } (i8*, { { %TName_Bool* (i8*, [20 x i8]*)*, i8* } (i8*, [20 x i8]*)*, i8* })*, i8* } %"$ListUtils.list_mem_call_1269", { { { %TName_Bool* (i8*, %TName_List_ByStr20*)*, i8* } (i8*, [20 x i8]*)*, i8* } (i8*, { { %TName_Bool* (i8*, [20 x i8]*)*, i8* } (i8*, [20 x i8]*)*, i8* })*, i8* }* %listMemByStr20, align 8
...
"$have_gas_1273":                                 ; preds = %"$out_of_gas_1272", %"$have_gas_1261"
  ...
  %"$listMemByStr20_call_1279" = call { { %TName_Bool* (i8*, %TName_List_ByStr20*)*, i8* } (i8*, [20 x i8]*)*, i8* } %"$listMemByStr20_fptr_1276"(i8* %"$listMemByStr20_envptr_1277", { { %TName_Bool* (i8*, [20 x i8]*)*, i8* } (i8*, [20 x i8]*)*, i8* } %"$ud-registry.eqByStr20_1278")
  store { { %TName_Bool* (i8*, %TName_List_ByStr20*)*, i8* } (i8*, [20 x i8]*)*, i8* } %"$listMemByStr20_call_1279", { { %TName_Bool* (i8*, %TName_List_ByStr20*)*, i8* } (i8*, [20 x i8]*)*, i8* }* %"$listMemByStr20_30", align 8
  ...
  %"$$listMemByStr20_30_call_1284" = call { %TName_Bool* (i8*, %TName_List_ByStr20*)*, i8* } %"$$listMemByStr20_30_fptr_1281"(i8* %"$$listMemByStr20_30_envptr_1282", [20 x i8]* %"$$listMemByStr20_30_bs_1283")
  store { %TName_Bool* (i8*, %TName_List_ByStr20*)*, i8* } %"$$listMemByStr20_30_call_1284", { %TName_Bool* (i8*, %TName_List_ByStr20*)*, i8* }* %"$listMemByStr20_31", align 8
  ...
  %"$$listMemByStr20_31_call_1288" = call %TName_Bool* %"$$listMemByStr20_31_fptr_1286"(i8* %"$$listMemByStr20_31_envptr_1287", %TName_List_ByStr20* %1)
  store %TName_Bool* %"$$listMemByStr20_31_call_1288", %TName_Bool** %"$listMemByStr20_32", align 8
  %"$$listMemByStr20_32_1289" = load %TName_Bool*, %TName_Bool** %"$listMemByStr20_32", align 8
  store %TName_Bool* %"$$listMemByStr20_32_1289", %TName_Bool** %"$retval_148", align 8
  %"$$retval_148_1290" = load %TName_Bool*, %TName_Bool** %"$retval_148", align 8
  ret %TName_Bool* %"$$retval_148_1290"
}

define internal %TName_Bool* @"$fundef_151"(%"$$fundef_151_env_303"* %0, [20 x i8]* %1) {
entry:
...
"$have_gas_1238":                                 ; preds = %"$out_of_gas_1237", %entry
  ...
  %"$eq_call_1246" = call %TName_Bool* @_eq_ByStrX(i8* %"$execptr_load_1240", i32 20, i8* %"$$eq_bs1_1241_1243", i8* %"$$eq_bs2_1244_1245")
  store %TName_Bool* %"$eq_call_1246", %TName_Bool** %"$retval_152", align 8
  %"$$retval_152_1248" = load %TName_Bool*, %TName_Bool** %"$retval_152", align 8
  ret %TName_Bool* %"$$retval_152_1248"
}

define internal { %TName_Bool* (i8*, [20 x i8]*)*, i8* } @"$fundef_149"(%"$$fundef_149_env_304"* %0, [20 x i8]* %1) {
entry:
...
"$have_gas_1225":                                 ; preds = %"$out_of_gas_1224", %entry
  ...
  store { %TName_Bool* (i8*, [20 x i8]*)*, i8* } %"$$fundef_151_cloval_1230", { %TName_Bool* (i8*, [20 x i8]*)*, i8* }* %"$retval_150", align 8
...
define internal %TName_List_Message* @"$fundef_153"(%"$$fundef_153_env_305"* %0, i8* %1) {
entry:
...
"$have_gas_1213":                                 ; preds = %"$out_of_gas_1212", %entry
  ...
  store %TName_List_Message* %"$adtptr_1220", %TName_List_Message** %"$retval_154", align 8
  %"$$retval_154_1221" = load %TName_List_Message*, %TName_List_Message** %"$retval_154", align 8
  ret %TName_List_Message* %"$$retval_154_1221"
}

define internal { %TName_Bool* (i8*, %TName_List_ByStr20*)*, i8* } @"$fundef_93"(%"$$fundef_93_env_306"* %0, [20 x i8]* %1) {
entry:
...
"$have_gas_1171":                                 ; preds = %"$out_of_gas_1170", %"$have_gas_1166"
  ...
  %"$f_call_1177" = call { %TName_Bool* (i8*, [20 x i8]*)*, i8* } %"$f_fptr_1174"(i8* %"$f_envptr_1175", [20 x i8]* %"$f_m_1176")
  store { %TName_Bool* (i8*, [20 x i8]*)*, i8* } %"$f_call_1177", { %TName_Bool* (i8*, [20 x i8]*)*, i8* }* %"$f_28", align 8
  %"$$f_28_1178" = load { %TName_Bool* (i8*, [20 x i8]*)*, i8* }, { %TName_Bool* (i8*, [20 x i8]*)*, i8* }* %"$f_28", align 8
  store { %TName_Bool* (i8*, [20 x i8]*)*, i8* } %"$$f_28_1178", { %TName_Bool* (i8*, [20 x i8]*)*, i8* }* %ex_pred, align 8
...
"$have_gas_1187":                                 ; preds = %"$out_of_gas_1186", %"$have_gas_1182"
  ...
  %"$ListUtils.list_exists_call_1195" = call { { %TName_Bool* (i8*, %TName_List_ByStr20*)*, i8* } (i8*, { %TName_Bool* (i8*, [20 x i8]*)*, i8* })*, i8* } %"$ListUtils.list_exists_fptr_1193"(i8* %"$ListUtils.list_exists_envptr_1194")
  store { { %TName_Bool* (i8*, %TName_List_ByStr20*)*, i8* } (i8*, { %TName_Bool* (i8*, [20 x i8]*)*, i8* })*, i8* } %"$ListUtils.list_exists_call_1195", { { %TName_Bool* (i8*, %TName_List_ByStr20*)*, i8* } (i8*, { %TName_Bool* (i8*, [20 x i8]*)*, i8* })*, i8* }* %ex, align 8
...
"$have_gas_1199":                                 ; preds = %"$out_of_gas_1198", %"$have_gas_1187"
  ...
  %"$ex_call_1205" = call { %TName_Bool* (i8*, %TName_List_ByStr20*)*, i8* } %"$ex_fptr_1202"(i8* %"$ex_envptr_1203", { %TName_Bool* (i8*, [20 x i8]*)*, i8* } %"$ex_pred_1204")
  store { %TName_Bool* (i8*, %TName_List_ByStr20*)*, i8* } %"$ex_call_1205", { %TName_Bool* (i8*, %TName_List_ByStr20*)*, i8* }* %"$ex_29", align 8
  %"$$ex_29_1206" = load { %TName_Bool* (i8*, %TName_List_ByStr20*)*, i8* }, { %TName_Bool* (i8*, %TName_List_ByStr20*)*, i8* }* %"$ex_29", align 8
  store { %TName_Bool* (i8*, %TName_List_ByStr20*)*, i8* } %"$$ex_29_1206", { %TName_Bool* (i8*, %TName_List_ByStr20*)*, i8* }* %"$retval_94", align 8
...
define internal { { %TName_Bool* (i8*, %TName_List_ByStr20*)*, i8* } (i8*, [20 x i8]*)*, i8* } @"$fundef_91"(%"$$fundef_91_env_307"* %0, { { %TName_Bool* (i8*, [20 x i8]*)*, i8* } (i8*, [20 x i8]*)*, i8* } %1) {
entry:
...
"$have_gas_1149":                                 ; preds = %"$out_of_gas_1148", %entry
  ...
  store { { %TName_Bool* (i8*, %TName_List_ByStr20*)*, i8* } (i8*, [20 x i8]*)*, i8* } %"$$fundef_93_cloval_1154", { { %TName_Bool* (i8*, %TName_List_ByStr20*)*, i8* } (i8*, [20 x i8]*)*, i8* }* %"$retval_92", align 8
...
define internal { { { %TName_Bool* (i8*, %TName_List_ByStr20*)*, i8* } (i8*, [20 x i8]*)*, i8* } (i8*, { { %TName_Bool* (i8*, [20 x i8]*)*, i8* } (i8*, [20 x i8]*)*, i8* })*, i8* } @"$fundef_89"(%"$$fundef_89_env_308"* %0) {
entry:
...
"$have_gas_1135":                                 ; preds = %"$out_of_gas_1134", %entry
  ...
  store { { { %TName_Bool* (i8*, %TName_List_ByStr20*)*, i8* } (i8*, [20 x i8]*)*, i8* } (i8*, { { %TName_Bool* (i8*, [20 x i8]*)*, i8* } (i8*, [20 x i8]*)*, i8* })*, i8* } %"$$fundef_91_cloval_1140", { { { %TName_Bool* (i8*, %TName_List_ByStr20*)*, i8* } (i8*, [20 x i8]*)*, i8* } (i8*, { { %TName_Bool* (i8*, [20 x i8]*)*, i8* } (i8*, [20 x i8]*)*, i8* })*, i8* }* %"$retval_90", align 8
...
define internal %TName_Bool* @"$fundef_99"(%"$$fundef_99_env_309"* %0, %TName_List_ByStr20* %1) {
entry:
...
"$have_gas_1068":                                 ; preds = %"$out_of_gas_1067", %"$have_gas_1063"
  ...
  %"$ListUtils.list_find_call_1076" = call { { %TName_Option_ByStr20* (i8*, %TName_List_ByStr20*)*, i8* } (i8*, { %TName_Bool* (i8*, [20 x i8]*)*, i8* })*, i8* } %"$ListUtils.list_find_fptr_1074"(i8* %"$ListUtils.list_find_envptr_1075")
  store { { %TName_Option_ByStr20* (i8*, %TName_List_ByStr20*)*, i8* } (i8*, { %TName_Bool* (i8*, [20 x i8]*)*, i8* })*, i8* } %"$ListUtils.list_find_call_1076", { { %TName_Option_ByStr20* (i8*, %TName_List_ByStr20*)*, i8* } (i8*, { %TName_Bool* (i8*, [20 x i8]*)*, i8* })*, i8* }* %find, align 8
...
"$have_gas_1085":                                 ; preds = %"$out_of_gas_1084", %"$have_gas_1080"
  ...
  %"$find_call_1091" = call { %TName_Option_ByStr20* (i8*, %TName_List_ByStr20*)*, i8* } %"$find_fptr_1088"(i8* %"$find_envptr_1089", { %TName_Bool* (i8*, [20 x i8]*)*, i8* } %"$p_1090")
  store { %TName_Option_ByStr20* (i8*, %TName_List_ByStr20*)*, i8* } %"$find_call_1091", { %TName_Option_ByStr20* (i8*, %TName_List_ByStr20*)*, i8* }* %"$find_26", align 8
  ...
  %"$$find_26_call_1095" = call %TName_Option_ByStr20* %"$$find_26_fptr_1093"(i8* %"$$find_26_envptr_1094", %TName_List_ByStr20* %1)
  store %TName_Option_ByStr20* %"$$find_26_call_1095", %TName_Option_ByStr20** %"$find_27", align 8
  %"$$find_27_1096" = load %TName_Option_ByStr20*, %TName_Option_ByStr20** %"$find_27", align 8
  store %TName_Option_ByStr20* %"$$find_27_1096", %TName_Option_ByStr20** %search, align 8
...
"$have_gas_1114":                                 ; preds = %"$out_of_gas_1113", %"$Some_1107"
  ...
  store %TName_Bool* %"$adtptr_1118", %TName_Bool** %"$retval_100", align 8
...
"$have_gas_1124":                                 ; preds = %"$out_of_gas_1123", %"$None_1119"
  ...
  store %TName_Bool* %"$adtptr_1128", %TName_Bool** %"$retval_100", align 8
  br label %"$matchsucc_1102"
...
define internal { %TName_Bool* (i8*, %TName_List_ByStr20*)*, i8* } @"$fundef_97"(%"$$fundef_97_env_310"* %0, { %TName_Bool* (i8*, [20 x i8]*)*, i8* } %1) {
entry:
...
"$have_gas_1046":                                 ; preds = %"$out_of_gas_1045", %entry
  ...
  store { %TName_Bool* (i8*, %TName_List_ByStr20*)*, i8* } %"$$fundef_99_cloval_1051", { %TName_Bool* (i8*, %TName_List_ByStr20*)*, i8* }* %"$retval_98", align 8
...
define internal { { %TName_Bool* (i8*, %TName_List_ByStr20*)*, i8* } (i8*, { %TName_Bool* (i8*, [20 x i8]*)*, i8* })*, i8* } @"$fundef_95"(%"$$fundef_95_env_311"* %0) {
entry:
...
"$have_gas_1032":                                 ; preds = %"$out_of_gas_1031", %entry
  ...
  store { { %TName_Bool* (i8*, %TName_List_ByStr20*)*, i8* } (i8*, { %TName_Bool* (i8*, [20 x i8]*)*, i8* })*, i8* } %"$$fundef_97_cloval_1037", { { %TName_Bool* (i8*, %TName_List_ByStr20*)*, i8* } (i8*, { %TName_Bool* (i8*, [20 x i8]*)*, i8* })*, i8* }* %"$retval_96", align 8
...
define internal %TName_Option_ByStr20* @"$fundef_109"(%"$$fundef_109_env_312"* %0, { %TName_Option_ByStr20* (i8*, %TName_Option_ByStr20*)*, i8* } %1) {
entry:
...
"$have_gas_983":                                  ; preds = %"$out_of_gas_982", %"$have_gas_978"
  ...
  %"$p_call_990" = call %TName_Bool* %"$p_fptr_986"(i8* %"$p_envptr_987", [20 x i8]* %"$p_x_988")
  store %TName_Bool* %"$p_call_990", %TName_Bool** %"$p_22", align 8
  %"$$p_22_991" = load %TName_Bool*, %TName_Bool** %"$p_22", align 8
  store %TName_Bool* %"$$p_22_991", %TName_Bool** %p_x, align 8
...
"$have_gas_1007":                                 ; preds = %"$out_of_gas_1006", %"$True_1002"
  ...
  store %TName_Option_ByStr20* %"$adtptr_1013", %TName_Option_ByStr20** %"$retval_110", align 8
...
"$have_gas_1019":                                 ; preds = %"$out_of_gas_1018", %"$False_1014"
  ...
  %"$recurse_call_1024" = call %TName_Option_ByStr20* %"$recurse_fptr_1021"(i8* %"$recurse_envptr_1022", %TName_Option_ByStr20* %"$init_1023")
  store %TName_Option_ByStr20* %"$recurse_call_1024", %TName_Option_ByStr20** %"$recurse_23", align 8
  %"$$recurse_23_1025" = load %TName_Option_ByStr20*, %TName_Option_ByStr20** %"$recurse_23", align 8
  store %TName_Option_ByStr20* %"$$recurse_23_1025", %TName_Option_ByStr20** %"$retval_110", align 8
  br label %"$matchsucc_997"
...
define internal { %TName_Option_ByStr20* (i8*, { %TName_Option_ByStr20* (i8*, %TName_Option_ByStr20*)*, i8* })*, i8* } @"$fundef_107"(%"$$fundef_107_env_313"* %0, [20 x i8]* %1) {
entry:
...
"$have_gas_957":                                  ; preds = %"$out_of_gas_956", %entry
  ...
  store { %TName_Option_ByStr20* (i8*, { %TName_Option_ByStr20* (i8*, %TName_Option_ByStr20*)*, i8* })*, i8* } %"$$fundef_109_cloval_962", { %TName_Option_ByStr20* (i8*, { %TName_Option_ByStr20* (i8*, %TName_Option_ByStr20*)*, i8* })*, i8* }* %"$retval_108", align 8
...
define internal { { %TName_Option_ByStr20* (i8*, { %TName_Option_ByStr20* (i8*, %TName_Option_ByStr20*)*, i8* })*, i8* } (i8*, [20 x i8]*)*, i8* } @"$fundef_105"(%"$$fundef_105_env_314"* %0, %TName_Option_ByStr20* %1) {
entry:
...
"$have_gas_939":                                  ; preds = %"$out_of_gas_938", %entry
  ...
  store { { %TName_Option_ByStr20* (i8*, { %TName_Option_ByStr20* (i8*, %TName_Option_ByStr20*)*, i8* })*, i8* } (i8*, [20 x i8]*)*, i8* } %"$$fundef_107_cloval_944", { { %TName_Option_ByStr20* (i8*, { %TName_Option_ByStr20* (i8*, %TName_Option_ByStr20*)*, i8* })*, i8* } (i8*, [20 x i8]*)*, i8* }* %"$retval_106", align 8
...
define internal { %TName_Option_ByStr20* (i8*, %TName_List_ByStr20*)*, i8* } @"$fundef_103"(%"$$fundef_103_env_315"* %0, { %TName_Bool* (i8*, [20 x i8]*)*, i8* } %1) {
entry:
...
"$have_gas_870":                                  ; preds = %"$out_of_gas_869", %"$have_gas_865"
  ...
  %"$list_foldk_call_878" = call { i8*, i8* }* %"$list_foldk_fptr_876"(i8* %"$list_foldk_envptr_877")
  ...
  %"$list_foldk_call_884" = call { { { %TName_Option_ByStr20* (i8*, %TName_List_ByStr20*)*, i8* } (i8*, %TName_Option_ByStr20*)*, i8* } (i8*, { { { %TName_Option_ByStr20* (i8*, { %TName_Option_ByStr20* (i8*, %TName_Option_ByStr20*)*, i8* })*, i8* } (i8*, [20 x i8]*)*, i8* } (i8*, %TName_Option_ByStr20*)*, i8* })*, i8* } %"$list_foldk_fptr_882"(i8* %"$list_foldk_envptr_883")
...
"$have_gas_893":                                  ; preds = %"$out_of_gas_892", %"$have_gas_888"
  ...
  store %TName_Option_ByStr20* %"$adtptr_897", %TName_Option_ByStr20** %init, align 8
...
"$have_gas_906":                                  ; preds = %"$out_of_gas_905", %"$have_gas_901"
  ...
  store { { { %TName_Option_ByStr20* (i8*, { %TName_Option_ByStr20* (i8*, %TName_Option_ByStr20*)*, i8* })*, i8* } (i8*, [20 x i8]*)*, i8* } (i8*, %TName_Option_ByStr20*)*, i8* } %"$$fundef_105_cloval_911", { { { %TName_Option_ByStr20* (i8*, { %TName_Option_ByStr20* (i8*, %TName_Option_ByStr20*)*, i8* })*, i8* } (i8*, [20 x i8]*)*, i8* } (i8*, %TName_Option_ByStr20*)*, i8* }* %predicate_step, align 8
...
"$have_gas_918":                                  ; preds = %"$out_of_gas_917", %"$have_gas_906"
  ...
  %"$foldk_call_924" = call { { %TName_Option_ByStr20* (i8*, %TName_List_ByStr20*)*, i8* } (i8*, %TName_Option_ByStr20*)*, i8* } %"$foldk_fptr_921"(i8* %"$foldk_envptr_922", { { { %TName_Option_ByStr20* (i8*, { %TName_Option_ByStr20* (i8*, %TName_Option_ByStr20*)*, i8* })*, i8* } (i8*, [20 x i8]*)*, i8* } (i8*, %TName_Option_ByStr20*)*, i8* } %"$predicate_step_923")
  store { { %TName_Option_ByStr20* (i8*, %TName_List_ByStr20*)*, i8* } (i8*, %TName_Option_ByStr20*)*, i8* } %"$foldk_call_924", { { %TName_Option_ByStr20* (i8*, %TName_List_ByStr20*)*, i8* } (i8*, %TName_Option_ByStr20*)*, i8* }* %"$foldk_24", align 8
  ...
  %"$$foldk_24_call_929" = call { %TName_Option_ByStr20* (i8*, %TName_List_ByStr20*)*, i8* } %"$$foldk_24_fptr_926"(i8* %"$$foldk_24_envptr_927", %TName_Option_ByStr20* %"$init_928")
  store { %TName_Option_ByStr20* (i8*, %TName_List_ByStr20*)*, i8* } %"$$foldk_24_call_929", { %TName_Option_ByStr20* (i8*, %TName_List_ByStr20*)*, i8* }* %"$foldk_25", align 8
  ...
  store { %TName_Option_ByStr20* (i8*, %TName_List_ByStr20*)*, i8* } %"$$foldk_25_930", { %TName_Option_ByStr20* (i8*, %TName_List_ByStr20*)*, i8* }* %"$retval_104", align 8
...
define internal { { %TName_Option_ByStr20* (i8*, %TName_List_ByStr20*)*, i8* } (i8*, { %TName_Bool* (i8*, [20 x i8]*)*, i8* })*, i8* } @"$fundef_101"(%"$$fundef_101_env_316"* %0) {
entry:
...
"$have_gas_851":                                  ; preds = %"$out_of_gas_850", %entry
  ...
  store { { %TName_Option_ByStr20* (i8*, %TName_List_ByStr20*)*, i8* } (i8*, { %TName_Bool* (i8*, [20 x i8]*)*, i8* })*, i8* } %"$$fundef_103_cloval_856", { { %TName_Option_ByStr20* (i8*, %TName_List_ByStr20*)*, i8* } (i8*, { %TName_Bool* (i8*, [20 x i8]*)*, i8* })*, i8* }* %"$retval_102", align 8
...
define internal %TName_List_ByStr20* @"$fundef_117"(%"$$fundef_117_env_317"* %0, %TName_List_ByStr20* %1) {
entry:
...
"$have_gas_806":                                  ; preds = %"$out_of_gas_805", %"$have_gas_801"
  ...
  %"$f_call_813" = call %TName_Bool* %"$f_fptr_809"(i8* %"$f_envptr_810", [20 x i8]* %"$f_h_811")
  store %TName_Bool* %"$f_call_813", %TName_Bool** %"$f_19", align 8
  %"$$f_19_814" = load %TName_Bool*, %TName_Bool** %"$f_19", align 8
  store %TName_Bool* %"$$f_19_814", %TName_Bool** %h1, align 8
...
"$have_gas_830":                                  ; preds = %"$out_of_gas_829", %"$True_825"
  ...
  store %TName_List_ByStr20* %"$adtptr_837", %TName_List_ByStr20** %"$retval_118", align 8
...
"$have_gas_843":                                  ; preds = %"$out_of_gas_842", %"$False_838"
  ...
  store %TName_List_ByStr20* %1, %TName_List_ByStr20** %"$retval_118", align 8
  br label %"$matchsucc_820"
...
define internal { %TName_List_ByStr20* (i8*, %TName_List_ByStr20*)*, i8* } @"$fundef_115"(%"$$fundef_115_env_318"* %0, [20 x i8]* %1) {
entry:
...
"$have_gas_784":                                  ; preds = %"$out_of_gas_783", %entry
  ...
  store { %TName_List_ByStr20* (i8*, %TName_List_ByStr20*)*, i8* } %"$$fundef_117_cloval_789", { %TName_List_ByStr20* (i8*, %TName_List_ByStr20*)*, i8* }* %"$retval_116", align 8
...
define internal { %TName_List_ByStr20* (i8*, %TName_List_ByStr20*)*, i8* } @"$fundef_113"(%"$$fundef_113_env_319"* %0, { %TName_Bool* (i8*, [20 x i8]*)*, i8* } %1) {
entry:
...
"$have_gas_719":                                  ; preds = %"$out_of_gas_718", %"$have_gas_714"
  ...
  %"$list_foldr_call_727" = call { i8*, i8* }* %"$list_foldr_fptr_725"(i8* %"$list_foldr_envptr_726")
  ...
  %"$list_foldr_call_733" = call { { { %TName_List_ByStr20* (i8*, %TName_List_ByStr20*)*, i8* } (i8*, %TName_List_ByStr20*)*, i8* } (i8*, { { %TName_List_ByStr20* (i8*, %TName_List_ByStr20*)*, i8* } (i8*, [20 x i8]*)*, i8* })*, i8* } %"$list_foldr_fptr_731"(i8* %"$list_foldr_envptr_732")
...
"$have_gas_742":                                  ; preds = %"$out_of_gas_741", %"$have_gas_737"
  ...
  store { { %TName_List_ByStr20* (i8*, %TName_List_ByStr20*)*, i8* } (i8*, [20 x i8]*)*, i8* } %"$$fundef_115_cloval_747", { { %TName_List_ByStr20* (i8*, %TName_List_ByStr20*)*, i8* } (i8*, [20 x i8]*)*, i8* }* %iter, align 8
...
"$have_gas_757":                                  ; preds = %"$out_of_gas_756", %"$have_gas_752"
  ...
  store %TName_List_ByStr20* %"$adtptr_761", %TName_List_ByStr20** %init, align 8
...
"$have_gas_765":                                  ; preds = %"$out_of_gas_764", %"$have_gas_757"
  ...
  %"$foldr_call_771" = call { { %TName_List_ByStr20* (i8*, %TName_List_ByStr20*)*, i8* } (i8*, %TName_List_ByStr20*)*, i8* } %"$foldr_fptr_768"(i8* %"$foldr_envptr_769", { { %TName_List_ByStr20* (i8*, %TName_List_ByStr20*)*, i8* } (i8*, [20 x i8]*)*, i8* } %"$iter_770")
  store { { %TName_List_ByStr20* (i8*, %TName_List_ByStr20*)*, i8* } (i8*, %TName_List_ByStr20*)*, i8* } %"$foldr_call_771", { { %TName_List_ByStr20* (i8*, %TName_List_ByStr20*)*, i8* } (i8*, %TName_List_ByStr20*)*, i8* }* %"$foldr_20", align 8
  ...
  %"$$foldr_20_call_776" = call { %TName_List_ByStr20* (i8*, %TName_List_ByStr20*)*, i8* } %"$$foldr_20_fptr_773"(i8* %"$$foldr_20_envptr_774", %TName_List_ByStr20* %"$init_775")
  store { %TName_List_ByStr20* (i8*, %TName_List_ByStr20*)*, i8* } %"$$foldr_20_call_776", { %TName_List_ByStr20* (i8*, %TName_List_ByStr20*)*, i8* }* %"$foldr_21", align 8
  ...
  store { %TName_List_ByStr20* (i8*, %TName_List_ByStr20*)*, i8* } %"$$foldr_21_777", { %TName_List_ByStr20* (i8*, %TName_List_ByStr20*)*, i8* }* %"$retval_114", align 8
...
define internal { { %TName_List_ByStr20* (i8*, %TName_List_ByStr20*)*, i8* } (i8*, { %TName_Bool* (i8*, [20 x i8]*)*, i8* })*, i8* } @"$fundef_111"(%"$$fundef_111_env_320"* %0) {
entry:
...
"$have_gas_700":                                  ; preds = %"$out_of_gas_699", %entry
  ...
  store { { %TName_List_ByStr20* (i8*, %TName_List_ByStr20*)*, i8* } (i8*, { %TName_Bool* (i8*, [20 x i8]*)*, i8* })*, i8* } %"$$fundef_113_cloval_705", { { %TName_List_ByStr20* (i8*, %TName_List_ByStr20*)*, i8* } (i8*, { %TName_Bool* (i8*, [20 x i8]*)*, i8* })*, i8* }* %"$retval_112", align 8
...
define internal %TName_Bool* @"$fundef_83"(%"$$fundef_83_env_321"* %0, %TName_Bool* %1) {
entry:
...
"$have_gas_679":                                  ; preds = %"$out_of_gas_678", %"$True_674"
  ...
  store %TName_Bool* %"$adtptr_683", %TName_Bool** %"$retval_84", align 8
...
"$have_gas_689":                                  ; preds = %"$out_of_gas_688", %"$False_684"
  ...
  store %TName_Bool* %"$adtptr_693", %TName_Bool** %"$retval_84", align 8
  br label %"$matchsucc_670"
...
define internal %TName_Bool* @"$fundef_85"(%"$$fundef_85_env_322"* %0, %TName_Bool* %1, %TName_Bool* %2) {
entry:
...
"$have_gas_652":                                  ; preds = %"$out_of_gas_651", %"$True_647"
  ...
  store %TName_Bool* %"$adtptr_656", %TName_Bool** %"$retval_86", align 8
...
"$have_gas_662":                                  ; preds = %"$out_of_gas_661", %"$False_657"
  ...
  store %TName_Bool* %2, %TName_Bool** %"$retval_86", align 8
  br label %"$matchsucc_643"
...
define internal %TName_Bool* @"$fundef_87"(%"$$fundef_87_env_323"* %0, %TName_Bool* %1, %TName_Bool* %2) {
entry:
...
"$have_gas_625":                                  ; preds = %"$out_of_gas_624", %"$False_620"
  ...
  store %TName_Bool* %"$adtptr_629", %TName_Bool** %"$retval_88", align 8
...
"$have_gas_635":                                  ; preds = %"$out_of_gas_634", %"$True_630"
  ...
  store %TName_Bool* %2, %TName_Bool** %"$retval_88", align 8
  br label %"$matchsucc_616"
...
define internal %TName_Option_ByStr20* @"$fundef_71"(%"$$fundef_71_env_324"* %0, %TName_Option_ByStr20* %1) {
entry:
...
"$have_gas_598":                                  ; preds = %"$out_of_gas_597", %entry
  ...
  %"$g_call_603" = call { %TName_Option_ByStr20* (i8*, %TName_List_ByStr20*)*, i8* } %"$g_fptr_601"(i8* %"$g_envptr_602", %TName_Option_ByStr20* %1)
  store { %TName_Option_ByStr20* (i8*, %TName_List_ByStr20*)*, i8* } %"$g_call_603", { %TName_Option_ByStr20* (i8*, %TName_List_ByStr20*)*, i8* }* %"$g_14", align 8
  ...
  %"$$g_14_call_608" = call %TName_Option_ByStr20* %"$$g_14_fptr_605"(i8* %"$$g_14_envptr_606", %TName_List_ByStr20* %"$t_607")
  store %TName_Option_ByStr20* %"$$g_14_call_608", %TName_Option_ByStr20** %"$g_15", align 8
  %"$$g_15_609" = load %TName_Option_ByStr20*, %TName_Option_ByStr20** %"$g_15", align 8
  store %TName_Option_ByStr20* %"$$g_15_609", %TName_Option_ByStr20** %"$retval_72", align 8
  %"$$retval_72_610" = load %TName_Option_ByStr20*, %TName_Option_ByStr20** %"$retval_72", align 8
  ret %TName_Option_ByStr20* %"$$retval_72_610"
}

define internal %TName_Option_ByStr20* @"$fundef_69"(%"$$fundef_69_env_325"* %0, %TName_List_ByStr20* %1) {
entry:
...
"$have_gas_550":                                  ; preds = %"$out_of_gas_549", %"$have_gas_545"
  ...
  store { %TName_Option_ByStr20* (i8*, %TName_Option_ByStr20*)*, i8* } %"$$fundef_71_cloval_555", { %TName_Option_ByStr20* (i8*, %TName_Option_ByStr20*)*, i8* }* %partial, align 8
...
"$have_gas_563":                                  ; preds = %"$out_of_gas_562", %"$have_gas_550"
  ...
  %"$f_call_569" = call { { %TName_Option_ByStr20* (i8*, { %TName_Option_ByStr20* (i8*, %TName_Option_ByStr20*)*, i8* })*, i8* } (i8*, [20 x i8]*)*, i8* } %"$f_fptr_566"(i8* %"$f_envptr_567", %TName_Option_ByStr20* %"$z_568")
  store { { %TName_Option_ByStr20* (i8*, { %TName_Option_ByStr20* (i8*, %TName_Option_ByStr20*)*, i8* })*, i8* } (i8*, [20 x i8]*)*, i8* } %"$f_call_569", { { %TName_Option_ByStr20* (i8*, { %TName_Option_ByStr20* (i8*, %TName_Option_ByStr20*)*, i8* })*, i8* } (i8*, [20 x i8]*)*, i8* }* %"$f_16", align 8
  ...
  %"$$f_16_call_575" = call { %TName_Option_ByStr20* (i8*, { %TName_Option_ByStr20* (i8*, %TName_Option_ByStr20*)*, i8* })*, i8* } %"$$f_16_fptr_571"(i8* %"$$f_16_envptr_572", [20 x i8]* %"$$f_16_h_573")
  store { %TName_Option_ByStr20* (i8*, { %TName_Option_ByStr20* (i8*, %TName_Option_ByStr20*)*, i8* })*, i8* } %"$$f_16_call_575", { %TName_Option_ByStr20* (i8*, { %TName_Option_ByStr20* (i8*, %TName_Option_ByStr20*)*, i8* })*, i8* }* %"$f_17", align 8
  ...
  %"$$f_17_call_580" = call %TName_Option_ByStr20* %"$$f_17_fptr_577"(i8* %"$$f_17_envptr_578", { %TName_Option_ByStr20* (i8*, %TName_Option_ByStr20*)*, i8* } %"$partial_579")
  store %TName_Option_ByStr20* %"$$f_17_call_580", %TName_Option_ByStr20** %"$f_18", align 8
  %"$$f_18_581" = load %TName_Option_ByStr20*, %TName_Option_ByStr20** %"$f_18", align 8
  store %TName_Option_ByStr20* %"$$f_18_581", %TName_Option_ByStr20** %"$retval_70", align 8
...
"$have_gas_587":                                  ; preds = %"$out_of_gas_586", %"$Nil_582"
  ...
  store %TName_Option_ByStr20* %"$z_589", %TName_Option_ByStr20** %"$retval_70", align 8
  br label %"$matchsucc_532"
...
define internal { %TName_Option_ByStr20* (i8*, %TName_List_ByStr20*)*, i8* } @"$fundef_67"(%"$$fundef_67_env_326"* %0, %TName_Option_ByStr20* %1) {
entry:
...
"$have_gas_509":                                  ; preds = %"$out_of_gas_508", %entry
  ...
  store { %TName_Option_ByStr20* (i8*, %TName_List_ByStr20*)*, i8* } %"$$fundef_69_cloval_514", { %TName_Option_ByStr20* (i8*, %TName_List_ByStr20*)*, i8* }* %"$retval_68", align 8
...
define internal { { %TName_Option_ByStr20* (i8*, %TName_List_ByStr20*)*, i8* } (i8*, %TName_Option_ByStr20*)*, i8* } @"$fundef_65"(%"$$fundef_65_env_327"* %0, { { { %TName_Option_ByStr20* (i8*, { %TName_Option_ByStr20* (i8*, %TName_Option_ByStr20*)*, i8* })*, i8* } (i8*, [20 x i8]*)*, i8* } (i8*, %TName_Option_ByStr20*)*, i8* } %1) {
entry:
...
"$have_gas_491":                                  ; preds = %"$out_of_gas_490", %"$have_gas_486"
  ...
  %g = alloca { { %TName_Option_ByStr20* (i8*, %TName_List_ByStr20*)*, i8* } (i8*, %TName_Option_ByStr20*)*, i8* }, align 8
  store { { %TName_Option_ByStr20* (i8*, %TName_List_ByStr20*)*, i8* } (i8*, %TName_Option_ByStr20*)*, i8* } %"$$fundef_67_cloval_496", { { %TName_Option_ByStr20* (i8*, %TName_List_ByStr20*)*, i8* } (i8*, %TName_Option_ByStr20*)*, i8* }* %g, align 8
  ...
  store { { %TName_Option_ByStr20* (i8*, %TName_List_ByStr20*)*, i8* } (i8*, %TName_Option_ByStr20*)*, i8* } %"$g_500", { { %TName_Option_ByStr20* (i8*, %TName_List_ByStr20*)*, i8* } (i8*, %TName_Option_ByStr20*)*, i8* }* %"$retval_66", align 8
...
define internal { { { %TName_Option_ByStr20* (i8*, %TName_List_ByStr20*)*, i8* } (i8*, %TName_Option_ByStr20*)*, i8* } (i8*, { { { %TName_Option_ByStr20* (i8*, { %TName_Option_ByStr20* (i8*, %TName_Option_ByStr20*)*, i8* })*, i8* } (i8*, [20 x i8]*)*, i8* } (i8*, %TName_Option_ByStr20*)*, i8* })*, i8* } @"$fundef_63"(%"$$fundef_63_env_328"* %0) {
entry:
...
define internal { i8*, i8* }* @"$fundef_61"(%"$$fundef_61_env_329"* %0) {
entry:
...
"$have_gas_465":                                  ; preds = %"$out_of_gas_464", %entry
  ...
  store { i8*, i8* }* %"$dyndisp_table_470", { i8*, i8* }** %"$retval_62", align 8
  %"$$retval_62_473" = load { i8*, i8* }*, { i8*, i8* }** %"$retval_62", align 8
  ret { i8*, i8* }* %"$$retval_62_473"
}

define internal %TName_List_ByStr20* @"$fundef_81"(%"$$fundef_81_env_330"* %0, %TName_List_ByStr20* %1) {
entry:
...
"$have_gas_423":                                  ; preds = %"$out_of_gas_422", %"$have_gas_418"
  ...
  %"$g_call_429" = call { %TName_List_ByStr20* (i8*, %TName_List_ByStr20*)*, i8* } %"$g_fptr_426"(i8* %"$g_envptr_427", %TName_List_ByStr20* %"$z_428")
  store { %TName_List_ByStr20* (i8*, %TName_List_ByStr20*)*, i8* } %"$g_call_429", { %TName_List_ByStr20* (i8*, %TName_List_ByStr20*)*, i8* }* %"$g_10", align 8
  ...
  %"$$g_10_call_434" = call %TName_List_ByStr20* %"$$g_10_fptr_431"(i8* %"$$g_10_envptr_432", %TName_List_ByStr20* %"$t_433")
  store %TName_List_ByStr20* %"$$g_10_call_434", %TName_List_ByStr20** %"$g_11", align 8
  %"$$g_11_435" = load %TName_List_ByStr20*, %TName_List_ByStr20** %"$g_11", align 8
  store %TName_List_ByStr20* %"$$g_11_435", %TName_List_ByStr20** %res, align 8
...
"$have_gas_439":                                  ; preds = %"$out_of_gas_438", %"$have_gas_423"
  ...
  %"$f_call_446" = call { %TName_List_ByStr20* (i8*, %TName_List_ByStr20*)*, i8* } %"$f_fptr_442"(i8* %"$f_envptr_443", [20 x i8]* %"$f_h_444")
  store { %TName_List_ByStr20* (i8*, %TName_List_ByStr20*)*, i8* } %"$f_call_446", { %TName_List_ByStr20* (i8*, %TName_List_ByStr20*)*, i8* }* %"$f_12", align 8
  ...
  %"$$f_12_call_451" = call %TName_List_ByStr20* %"$$f_12_fptr_448"(i8* %"$$f_12_envptr_449", %TName_List_ByStr20* %"$res_450")
  store %TName_List_ByStr20* %"$$f_12_call_451", %TName_List_ByStr20** %"$f_13", align 8
  %"$$f_13_452" = load %TName_List_ByStr20*, %TName_List_ByStr20** %"$f_13", align 8
  store %TName_List_ByStr20* %"$$f_13_452", %TName_List_ByStr20** %"$retval_82", align 8
...
"$have_gas_458":                                  ; preds = %"$out_of_gas_457", %"$Nil_453"
  ...
  store %TName_List_ByStr20* %"$z_460", %TName_List_ByStr20** %"$retval_82", align 8
  br label %"$matchsucc_405"
...
define internal { %TName_List_ByStr20* (i8*, %TName_List_ByStr20*)*, i8* } @"$fundef_79"(%"$$fundef_79_env_331"* %0, %TName_List_ByStr20* %1) {
entry:
...
"$have_gas_382":                                  ; preds = %"$out_of_gas_381", %entry
  ...
  store { %TName_List_ByStr20* (i8*, %TName_List_ByStr20*)*, i8* } %"$$fundef_81_cloval_387", { %TName_List_ByStr20* (i8*, %TName_List_ByStr20*)*, i8* }* %"$retval_80", align 8
...
define internal { { %TName_List_ByStr20* (i8*, %TName_List_ByStr20*)*, i8* } (i8*, %TName_List_ByStr20*)*, i8* } @"$fundef_77"(%"$$fundef_77_env_332"* %0, { { %TName_List_ByStr20* (i8*, %TName_List_ByStr20*)*, i8* } (i8*, [20 x i8]*)*, i8* } %1) {
entry:
...
"$have_gas_364":                                  ; preds = %"$out_of_gas_363", %"$have_gas_359"
  ...
  %g = alloca { { %TName_List_ByStr20* (i8*, %TName_List_ByStr20*)*, i8* } (i8*, %TName_List_ByStr20*)*, i8* }, align 8
  store { { %TName_List_ByStr20* (i8*, %TName_List_ByStr20*)*, i8* } (i8*, %TName_List_ByStr20*)*, i8* } %"$$fundef_79_cloval_369", { { %TName_List_ByStr20* (i8*, %TName_List_ByStr20*)*, i8* } (i8*, %TName_List_ByStr20*)*, i8* }* %g, align 8
  ...
  store { { %TName_List_ByStr20* (i8*, %TName_List_ByStr20*)*, i8* } (i8*, %TName_List_ByStr20*)*, i8* } %"$g_373", { { %TName_List_ByStr20* (i8*, %TName_List_ByStr20*)*, i8* } (i8*, %TName_List_ByStr20*)*, i8* }* %"$retval_78", align 8
...
define internal { { { %TName_List_ByStr20* (i8*, %TName_List_ByStr20*)*, i8* } (i8*, %TName_List_ByStr20*)*, i8* } (i8*, { { %TName_List_ByStr20* (i8*, %TName_List_ByStr20*)*, i8* } (i8*, [20 x i8]*)*, i8* })*, i8* } @"$fundef_75"(%"$$fundef_75_env_333"* %0) {
entry:
...
define internal { i8*, i8* }* @"$fundef_73"(%"$$fundef_73_env_334"* %0) {
entry:
...
"$have_gas_338":                                  ; preds = %"$out_of_gas_337", %entry
  ...
  store { i8*, i8* }* %"$dyndisp_table_343", { i8*, i8* }** %"$retval_74", align 8
...
"$have_gas_1928":                                 ; preds = %"$out_of_gas_1927", %entry
  ...
  store { i8*, i8* }* %"$dyndisp_table_1933", { i8*, i8* }** @list_foldr, align 8
...
"$have_gas_1939":                                 ; preds = %"$out_of_gas_1938", %"$have_gas_1928"
  ...
  store { i8*, i8* }* %"$dyndisp_table_1944", { i8*, i8* }** @list_foldk, align 8
...
"$have_gas_1950":                                 ; preds = %"$out_of_gas_1949", %"$have_gas_1939"
  ...
  store { %TName_Bool* (i8*, %TName_Bool*, %TName_Bool*)*, i8* } { %TName_Bool* (i8*, %TName_Bool*, %TName_Bool*)* bitcast (%TName_Bool* (%"$$fundef_87_env_323"*, %TName_Bool*, %TName_Bool*)* @"$fundef_87" to %TName_Bool* (i8*, %TName_Bool*, %TName_Bool*)*), i8* null }, { %TName_Bool* (i8*, %TName_Bool*, %TName_Bool*)*, i8* }* @BoolUtils.andb, align 8
...
"$have_gas_1958":                                 ; preds = %"$out_of_gas_1957", %"$have_gas_1950"
  ...
  store { %TName_Bool* (i8*, %TName_Bool*, %TName_Bool*)*, i8* } { %TName_Bool* (i8*, %TName_Bool*, %TName_Bool*)* bitcast (%TName_Bool* (%"$$fundef_85_env_322"*, %TName_Bool*, %TName_Bool*)* @"$fundef_85" to %TName_Bool* (i8*, %TName_Bool*, %TName_Bool*)*), i8* null }, { %TName_Bool* (i8*, %TName_Bool*, %TName_Bool*)*, i8* }* @BoolUtils.orb, align 8
...
"$have_gas_1966":                                 ; preds = %"$out_of_gas_1965", %"$have_gas_1958"
  ...
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } { %TName_Bool* (i8*, %TName_Bool*)* bitcast (%TName_Bool* (%"$$fundef_83_env_321"*, %TName_Bool*)* @"$fundef_83" to %TName_Bool* (i8*, %TName_Bool*)*), i8* null }, { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* @BoolUtils.negb, align 8
...
"$have_gas_1974":                                 ; preds = %"$out_of_gas_1973", %"$have_gas_1966"
  ...
  store { i8*, i8* }* %"$dyndisp_table_1982", { i8*, i8* }** @ListUtils.list_filter, align 8
...
"$have_gas_1988":                                 ; preds = %"$out_of_gas_1987", %"$have_gas_1974"
  ...
  store { i8*, i8* }* %"$dyndisp_table_1996", { i8*, i8* }** @ListUtils.list_find, align 8
...
"$have_gas_2002":                                 ; preds = %"$out_of_gas_2001", %"$have_gas_1988"
  ...
  store { i8*, i8* }* %"$dyndisp_table_2010", { i8*, i8* }** @ListUtils.list_exists, align 8
...
"$have_gas_2016":                                 ; preds = %"$out_of_gas_2015", %"$have_gas_2002"
  ...
  store { i8*, i8* }* %"$dyndisp_table_2024", { i8*, i8* }** @ListUtils.list_mem, align 8
...
"$have_gas_2035":                                 ; preds = %"$out_of_gas_2034", %"$have_gas_2030"
  ...
  store %TName_List_ByStr20* %"$adtptr_2039", %TName_List_ByStr20** @ud-registry.nilByStr20, align 8
...
"$have_gas_2043":                                 ; preds = %"$out_of_gas_2042", %"$have_gas_2035"
  ...
  store %TName_List_Message* %"$adtptr_2047", %TName_List_Message** @ud-registry.nilMessage, align 8
...
"$have_gas_2051":                                 ; preds = %"$out_of_gas_2050", %"$have_gas_2043"
  ...
  store { %TName_List_Message* (i8*, i8*)*, i8* } %"$$fundef_153_cloval_2056", { %TName_List_Message* (i8*, i8*)*, i8* }* @ud-registry.oneMsg, align 8
...
"$have_gas_2062":                                 ; preds = %"$out_of_gas_2061", %"$have_gas_2051"
  ...
  store { { %TName_Bool* (i8*, [20 x i8]*)*, i8* } (i8*, [20 x i8]*)*, i8* } { { %TName_Bool* (i8*, [20 x i8]*)*, i8* } (i8*, [20 x i8]*)* bitcast ({ %TName_Bool* (i8*, [20 x i8]*)*, i8* } (%"$$fundef_149_env_304"*, [20 x i8]*)* @"$fundef_149" to { %TName_Bool* (i8*, [20 x i8]*)*, i8* } (i8*, [20 x i8]*)*), i8* null }, { { %TName_Bool* (i8*, [20 x i8]*)*, i8* } (i8*, [20 x i8]*)*, i8* }* @ud-registry.eqByStr20, align 8
...
"$have_gas_2070":                                 ; preds = %"$out_of_gas_2069", %"$have_gas_2062"
  ...
  store { %TName_Bool* (i8*, %TName_List_ByStr20*, [20 x i8]*)*, i8* } %"$$fundef_147_cloval_2075", { %TName_Bool* (i8*, %TName_List_ByStr20*, [20 x i8]*)*, i8* }* @ud-registry.listByStr20Contains, align 8
...
"$have_gas_2083":                                 ; preds = %"$out_of_gas_2082", %"$have_gas_2070"
  ...
  store { %TName_Bool* (i8*, %TName_List_ByStr20*, [20 x i8]*)*, i8* } %"$$fundef_145_cloval_2088", { %TName_Bool* (i8*, %TName_List_ByStr20*, [20 x i8]*)*, i8* }* @ud-registry.listByStr20Excludes, align 8
...
"$have_gas_2096":                                 ; preds = %"$out_of_gas_2095", %"$have_gas_2083"
  ...
  store { %TName_List_ByStr20* (i8*, %TName_List_ByStr20*, [20 x i8]*)*, i8* } %"$$fundef_141_cloval_2101", { %TName_List_ByStr20* (i8*, %TName_List_ByStr20*, [20 x i8]*)*, i8* }* @ud-registry.listByStr20FilterOut, align 8
...
"$have_gas_2109":                                 ; preds = %"$out_of_gas_2108", %"$have_gas_2096"
  ...
  store { %TName_Bool* (i8*, %TName_Bool*, %TName_Bool*)*, i8* } { %TName_Bool* (i8*, %TName_Bool*, %TName_Bool*)* bitcast (%TName_Bool* (%"$$fundef_139_env_298"*, %TName_Bool*, %TName_Bool*)* @"$fundef_139" to %TName_Bool* (i8*, %TName_Bool*, %TName_Bool*)*), i8* null }, { %TName_Bool* (i8*, %TName_Bool*, %TName_Bool*)*, i8* }* @ud-registry.xandb, align 8
...
"$have_gas_2117":                                 ; preds = %"$out_of_gas_2116", %"$have_gas_2109"
  ...
  store { i8* (i8*, [20 x i8]*, %TName_Bool*)*, i8* } { i8* (i8*, [20 x i8]*, %TName_Bool*)* bitcast (i8* (%"$$fundef_137_env_297"*, [20 x i8]*, %TName_Bool*)* @"$fundef_137" to i8* (i8*, [20 x i8]*, %TName_Bool*)*), i8* null }, { i8* (i8*, [20 x i8]*, %TName_Bool*)*, i8* }* @ud-registry.eAdminSet, align 8
...
"$have_gas_2125":                                 ; preds = %"$out_of_gas_2124", %"$have_gas_2117"
  ...
  store { i8* (i8*, [20 x i8]*, [20 x i8]*, %TName_Bool*)*, i8* } { i8* (i8*, [20 x i8]*, [20 x i8]*, %TName_Bool*)* bitcast (i8* (%"$$fundef_135_env_296"*, [20 x i8]*, [20 x i8]*, %TName_Bool*)* @"$fundef_135" to i8* (i8*, [20 x i8]*, [20 x i8]*, %TName_Bool*)*), i8* null }, { i8* (i8*, [20 x i8]*, [20 x i8]*, %TName_Bool*)*, i8* }* @ud-registry.eApprovedFor, align 8
...
"$have_gas_2133":                                 ; preds = %"$out_of_gas_2132", %"$have_gas_2125"
  ...
  store { i8* (i8*, [20 x i8]*)*, i8* } { i8* (i8*, [20 x i8]*)* bitcast (i8* (%"$$fundef_133_env_295"*, [20 x i8]*)* @"$fundef_133" to i8* (i8*, [20 x i8]*)*), i8* null }, { i8* (i8*, [20 x i8]*)*, i8* }* @ud-registry.eApproved, align 8
...
"$have_gas_2141":                                 ; preds = %"$out_of_gas_2140", %"$have_gas_2133"
  ...
  store { i8* (i8*, [20 x i8]*)*, i8* } { i8* (i8*, [20 x i8]*)* bitcast (i8* (%"$$fundef_131_env_294"*, [20 x i8]*)* @"$fundef_131" to i8* (i8*, [20 x i8]*)*), i8* null }, { i8* (i8*, [20 x i8]*)*, i8* }* @ud-registry.eNewRegistrar, align 8
...
"$have_gas_2149":                                 ; preds = %"$out_of_gas_2148", %"$have_gas_2141"
  ...
  store { i8* (i8*, [32 x i8]*, %String)*, i8* } { i8* (i8*, [32 x i8]*, %String)* bitcast (i8* (%"$$fundef_129_env_293"*, [32 x i8]*, %String)* @"$fundef_129" to i8* (i8*, [32 x i8]*, %String)*), i8* null }, { i8* (i8*, [32 x i8]*, %String)*, i8* }* @ud-registry.eNewDomain, align 8
...
"$have_gas_2157":                                 ; preds = %"$out_of_gas_2156", %"$have_gas_2149"
  ...
  store { i8* (i8*, [32 x i8]*, [20 x i8]*, [20 x i8]*)*, i8* } { i8* (i8*, [32 x i8]*, [20 x i8]*, [20 x i8]*)* bitcast (i8* (%"$$fundef_127_env_292"*, [32 x i8]*, [20 x i8]*, [20 x i8]*)* @"$fundef_127" to i8* (i8*, [32 x i8]*, [20 x i8]*, [20 x i8]*)*), i8* null }, { i8* (i8*, [32 x i8]*, [20 x i8]*, [20 x i8]*)*, i8* }* @ud-registry.eConfigured, align 8
...
"$have_gas_2165":                                 ; preds = %"$out_of_gas_2164", %"$have_gas_2157"
  ...
  store { i8* (i8*, %String)*, i8* } { i8* (i8*, %String)* bitcast (i8* (%"$$fundef_125_env_291"*, %String)* @"$fundef_125" to i8* (i8*, %String)*), i8* null }, { i8* (i8*, %String)*, i8* }* @ud-registry.eError, align 8
...
"$have_gas_2173":                                 ; preds = %"$out_of_gas_2172", %"$have_gas_2165"
  ...
  store { void (i8*, [20 x i8]*, %TName_Option_ud-registry.Record*)*, i8* } %"$$fundef_123_cloval_2178", { void (i8*, [20 x i8]*, %TName_Option_ud-registry.Record*)*, i8* }* @ud-registry.recordMemberOwner, align 8
...
"$have_gas_2184":                                 ; preds = %"$out_of_gas_2183", %"$have_gas_2173"
  ...
  store { void (i8*, [32 x i8]*, [32 x i8]*, %String)*, i8* } { void (i8*, [32 x i8]*, [32 x i8]*, %String)* bitcast (void (%"$$fundef_121_env_289"*, [32 x i8]*, [32 x i8]*, %String)* @"$fundef_121" to void (i8*, [32 x i8]*, [32 x i8]*, %String)*), i8* null }, { void (i8*, [32 x i8]*, [32 x i8]*, %String)*, i8* }* @ud-registry.parentLabelToNode, align 8
...
"$have_gas_2192":                                 ; preds = %"$out_of_gas_2191", %"$have_gas_2184"
  ...
  store { %TName_Bool* (i8*, [20 x i8]*, [20 x i8]*, %TName_Option_ByStr20*, %"TName_Option_List_(ByStr20)"*)*, i8* } %"$$fundef_119_cloval_2197", { %TName_Bool* (i8*, [20 x i8]*, [20 x i8]*, %TName_Option_ByStr20*, %"TName_Option_List_(ByStr20)"*)*, i8* }* @ud-registry.getIsOAO, align 8
  ret void
}
...
"$have_gas_2210":                                 ; preds = %"$out_of_gas_2209", %"$have_gas_2205"
  ...
  store %Map_ByStr32_ud-registry.Record* %"$_new_empty_map_2214", %Map_ByStr32_ud-registry.Record** %empty, align 8
...
"$have_gas_2223":                                 ; preds = %"$out_of_gas_2222", %"$have_gas_2218"
  ...
  store %TName_ud-registry.Record* %"$adtptr_2231", %TName_ud-registry.Record** %rootRecord, align 8
...
"$have_gas_2239":                                 ; preds = %"$out_of_gas_2238", %"$have_gas_2223"
  ...
  %"$put_call_2249" = call i8* @_put(i8* %"$execptr_load_2241", %_TyDescrTy_Typ* @"$TyDescr_Map_208", i8* %"$$empty_2242_2243", i8* %"$$put_rootNode_2244_2246", i8* %"$$rootRecord_2247_2248")
  %"$put_2250" = bitcast i8* %"$put_call_2249" to %Map_ByStr32_ud-registry.Record*
  store %Map_ByStr32_ud-registry.Record* %"$put_2250", %Map_ByStr32_ud-registry.Record** %"$records_155", align 8
  ...
  call void @_update_field(i8* %"$execptr_load_2251", i8* getelementptr inbounds ([8 x i8], [8 x i8]* @"$records_2252", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_208", i32 0, i8* null, i8* %"$update_value_2254")
...
"$have_gas_2258":                                 ; preds = %"$out_of_gas_2257", %"$have_gas_2239"
  ...
  store [20 x i8] %"$ud-registry.zeroByStr20_2260", [20 x i8]* %"$registrar_156", align 1
  ...
  call void @_update_field(i8* %"$execptr_load_2261", i8* getelementptr inbounds ([10 x i8], [10 x i8]* @"$registrar_2262", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Bystr20_194", i32 0, i8* null, i8* %"$update_value_2265")
...
"$have_gas_2269":                                 ; preds = %"$out_of_gas_2268", %"$have_gas_2258"
  ...
  store %Map_ByStr32_ByStr20* %"$_new_empty_map_2273", %Map_ByStr32_ByStr20** %"$approvals_157", align 8
  ...
  call void @_update_field(i8* %"$execptr_load_2274", i8* getelementptr inbounds ([10 x i8], [10 x i8]* @"$approvals_2275", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_207", i32 0, i8* null, i8* %"$update_value_2277")
...
"$have_gas_2281":                                 ; preds = %"$out_of_gas_2280", %"$have_gas_2269"
  ...
  store %"Map_ByStr20_List_(ByStr20)"* %"$_new_empty_map_2285", %"Map_ByStr20_List_(ByStr20)"** %"$operators_158", align 8
  ...
  call void @_update_field(i8* %"$execptr_load_2286", i8* getelementptr inbounds ([10 x i8], [10 x i8]* @"$operators_2287", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_206", i32 0, i8* null, i8* %"$update_value_2289")
...
"$have_gas_2293":                                 ; preds = %"$out_of_gas_2292", %"$have_gas_2281"
  ...
  store %TName_List_ByStr20* %"$adtptr_2301", %TName_List_ByStr20** %"$admins_159", align 8
  ...
  call void @_update_field(i8* %"$execptr_load_2302", i8* getelementptr inbounds ([7 x i8], [7 x i8]* @"$admins_2303", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_ADT_List_ByStr20_203", i32 0, i8* null, i8* %"$update_value_2305")
  ret void
}
...
define internal void @"$setAdmin_2306"(%Uint128 %_amount, [20 x i8]* %"$_origin_2307", [20 x i8]* %"$_sender_2308", [20 x i8]* %"$address_2309", %TName_Bool* %isApproved) {
entry:
  ...
  %"$currentAdmins_call_2312" = call i8* @_fetch_field(i8* %"$execptr_load_2311", i8* getelementptr inbounds ([7 x i8], [7 x i8]* @"$admins_2310", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_ADT_List_ByStr20_203", i32 0, i8* null, i32 1)
...
"$have_gas_2331":                                 ; preds = %"$out_of_gas_2330", %"$have_gas_2326"
  ...
  %"$ud-registry.listByStr20Contains_call_2338" = call %TName_Bool* %"$ud-registry.listByStr20Contains_fptr_2334"(i8* %"$ud-registry.listByStr20Contains_envptr_2335", %TName_List_ByStr20* %"$currentAdmins_2336", [20 x i8]* %"$ud-registry.listByStr20Contains__sender_2337")
  store %TName_Bool* %"$ud-registry.listByStr20Contains_call_2338", %TName_Bool** %isSenderAdmin, align 8
...
"$have_gas_2364":                                 ; preds = %"$out_of_gas_2363", %"$have_gas_2359"
  ...
  %"$ud-registry.listByStr20Excludes_call_2371" = call %TName_Bool* %"$ud-registry.listByStr20Excludes_fptr_2367"(i8* %"$ud-registry.listByStr20Excludes_envptr_2368", %TName_List_ByStr20* %"$currentAdmins_2369", [20 x i8]* %"$ud-registry.listByStr20Excludes_address_2370")
  store %TName_Bool* %"$ud-registry.listByStr20Excludes_call_2371", %TName_Bool** %b, align 8
...
"$have_gas_2375":                                 ; preds = %"$out_of_gas_2374", %"$have_gas_2364"
  ...
  %"$ud-registry.xandb_call_2381" = call %TName_Bool* %"$ud-registry.xandb_fptr_2378"(i8* %"$ud-registry.xandb_envptr_2379", %TName_Bool* %"$b_2380", %TName_Bool* %isApproved)
  store %TName_Bool* %"$ud-registry.xandb_call_2381", %TName_Bool** %needsToChange, align 8
...
"$have_gas_2413":                                 ; preds = %"$out_of_gas_2412", %"$True_2408"
  ...
  store %TName_List_ByStr20* %"$adtptr_2420", %TName_List_ByStr20** %newAdmins, align 8
...
"$have_gas_2426":                                 ; preds = %"$out_of_gas_2425", %"$False_2421"
  ...
  %"$ud-registry.listByStr20FilterOut_call_2433" = call %TName_List_ByStr20* %"$ud-registry.listByStr20FilterOut_fptr_2429"(i8* %"$ud-registry.listByStr20FilterOut_envptr_2430", %TName_List_ByStr20* %"$currentAdmins_2431", [20 x i8]* %"$ud-registry.listByStr20FilterOut_address_2432")
  store %TName_List_ByStr20* %"$ud-registry.listByStr20FilterOut_call_2433", %TName_List_ByStr20** %newAdmins, align 8
  br label %"$matchsucc_2404"
...
"$have_gas_2440":                                 ; preds = %"$out_of_gas_2439", %"$matchsucc_2404"
  ...
  call void @_update_field(i8* %"$execptr_load_2442", i8* getelementptr inbounds ([7 x i8], [7 x i8]* @"$admins_2443", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_ADT_List_ByStr20_203", i32 0, i8* null, i8* %"$update_value_2445")
...
"$have_gas_2454":                                 ; preds = %"$out_of_gas_2453", %"$have_gas_2449"
  ...
  %"$ud-registry.eAdminSet_call_2460" = call i8* %"$ud-registry.eAdminSet_fptr_2457"(i8* %"$ud-registry.eAdminSet_envptr_2458", [20 x i8]* %"$ud-registry.eAdminSet_address_2459", %TName_Bool* %isApproved)
  store i8* %"$ud-registry.eAdminSet_call_2460", i8** %e, align 8
...
"$have_gas_2467":                                 ; preds = %"$out_of_gas_2466", %"$have_gas_2454"
  ...
  call void @_event(i8* %"$execptr_load_2469", %_TyDescrTy_Typ* @"$TyDescr_Event_184", i8* %"$e_2470")
...
"$have_gas_2486":                                 ; preds = %"$out_of_gas_2485", %"$have_gas_2481"
  ...
  store %String { i8* getelementptr inbounds ([26 x i8], [26 x i8]* @"$stringlit_2488", i32 0, i32 0), i32 26 }, %String* %m, align 8
...
"$have_gas_2492":                                 ; preds = %"$out_of_gas_2491", %"$have_gas_2486"
  ...
  %"$ud-registry.eError_call_2498" = call i8* %"$ud-registry.eError_fptr_2495"(i8* %"$ud-registry.eError_envptr_2496", %String %"$m_2497")
  store i8* %"$ud-registry.eError_call_2498", i8** %"$ud-registry.eError_37", align 8
  %"$$ud-registry.eError_37_2499" = load i8*, i8** %"$ud-registry.eError_37", align 8
  store i8* %"$$ud-registry.eError_37_2499", i8** %e1, align 8
...
"$have_gas_2506":                                 ; preds = %"$out_of_gas_2505", %"$have_gas_2492"
  ...
  call void @_event(i8* %"$execptr_load_2508", %_TyDescrTy_Typ* @"$TyDescr_Event_184", i8* %"$e_2509")
  br label %"$matchsucc_2344"
...
entry:
  ...
  call void @"$setAdmin_2306"(%Uint128 %_amount, [20 x i8]* %"$_origin_2514", [20 x i8]* %"$_sender_2516", [20 x i8]* %"$address_2518", %TName_Bool* %isApproved)
  ret void
}

define internal void @"$approve_2521"(%Uint128 %_amount, [20 x i8]* %"$_origin_2522", [20 x i8]* %"$_sender_2523", [32 x i8]* %"$node_2524", [20 x i8]* %"$address_2525") {
entry:
  ...
  %"$maybeRecord_call_2530" = call i8* @_fetch_field(i8* %"$execptr_load_2529", i8* getelementptr inbounds ([8 x i8], [8 x i8]* @"$records_2528", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_208", i32 1, i8* %"$indices_buf_2526", i32 1)
...
"$have_gas_2550":                                 ; preds = %"$out_of_gas_2549", %"$have_gas_2545"
  ...
  call void %"$ud-registry.recordMemberOwner_fptr_2553"(i8* %"$ud-registry.recordMemberOwner_envptr_2554", [20 x i8]* %"$ud-registry.recordMemberOwner_retalloca_2556", %TName_Option_ud-registry.Record* %"$maybeRecord_2555")
  %"$ud-registry.recordMemberOwner_ret_2557" = load [20 x i8], [20 x i8]* %"$ud-registry.recordMemberOwner_retalloca_2556", align 1
  store [20 x i8] %"$ud-registry.recordMemberOwner_ret_2557", [20 x i8]* %"$ud-registry.recordMemberOwner_38", align 1
...
"$have_gas_2567":                                 ; preds = %"$out_of_gas_2566", %"$have_gas_2562"
  ...
  %"$eq_call_2575" = call %TName_Bool* @_eq_ByStrX(i8* %"$execptr_load_2569", i32 20, i8* %"$$eq__sender_2570_2571", i8* %"$$eq_recordOwner_2572_2574")
  store %TName_Bool* %"$eq_call_2575", %TName_Bool** %isSenderNodeOwner, align 8
...
"$True_2587":                                     ; preds = %"$have_gas_2580"
  ...
  %"$maybeApproved_call_2593" = call i8* @_fetch_field(i8* %"$execptr_load_2592", i8* getelementptr inbounds ([10 x i8], [10 x i8]* @"$approvals_2591", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_207", i32 1, i8* %"$indices_buf_2589", i32 1)
...
"$have_gas_2651":                                 ; preds = %"$out_of_gas_2650", %"$have_gas_2646"
  ...
  %"$eq_call_2659" = call %TName_Bool* @_eq_ByStrX(i8* %"$execptr_load_2653", i32 20, i8* %"$$eq_currentlyApproved_2654_2656", i8* %"$$eq_address_2657_2658")
  store %TName_Bool* %"$eq_call_2659", %TName_Bool** %b, align 8
...
"$have_gas_2664":                                 ; preds = %"$out_of_gas_2663", %"$have_gas_2651"
  ...
  %"$BoolUtils.negb_call_2670" = call %TName_Bool* %"$BoolUtils.negb_fptr_2667"(i8* %"$BoolUtils.negb_envptr_2668", %TName_Bool* %"$b_2669")
  store %TName_Bool* %"$BoolUtils.negb_call_2670", %TName_Bool** %"$BoolUtils.negb_39", align 8
  %"$$BoolUtils.negb_39_2671" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.negb_39", align 8
  store %TName_Bool* %"$$BoolUtils.negb_39_2671", %TName_Bool** %needsToChange, align 8
...
"$have_gas_2691":                                 ; preds = %"$out_of_gas_2690", %"$True_2682"
  ...
  call void @_update_field(i8* %"$execptr_load_2695", i8* getelementptr inbounds ([10 x i8], [10 x i8]* @"$approvals_2696", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_207", i32 1, i8* %"$indices_buf_2693", i8* %"$update_value_2698")
...
"$have_gas_2707":                                 ; preds = %"$out_of_gas_2706", %"$have_gas_2702"
  ...
  store i8* %"$ud-registry.eApproved_call_2713", i8** %"$ud-registry.eApproved_40", align 8
  %"$$ud-registry.eApproved_40_2714" = load i8*, i8** %"$ud-registry.eApproved_40", align 8
  store i8* %"$$ud-registry.eApproved_40_2714", i8** %e, align 8
...
"$have_gas_2721":                                 ; preds = %"$out_of_gas_2720", %"$have_gas_2707"
  ...
  call void @_event(i8* %"$execptr_load_2723", %_TyDescrTy_Typ* @"$TyDescr_Event_184", i8* %"$e_2724")
...
"$have_gas_2740":                                 ; preds = %"$out_of_gas_2739", %"$have_gas_2735"
  ...
  store %String { i8* getelementptr inbounds ([21 x i8], [21 x i8]* @"$stringlit_2742", i32 0, i32 0), i32 21 }, %String* %m, align 8
...
"$have_gas_2746":                                 ; preds = %"$out_of_gas_2745", %"$have_gas_2740"
  ...
  %"$ud-registry.eError_call_2752" = call i8* %"$ud-registry.eError_fptr_2749"(i8* %"$ud-registry.eError_envptr_2750", %String %"$m_2751")
  store i8* %"$ud-registry.eError_call_2752", i8** %"$ud-registry.eError_41", align 8
  %"$$ud-registry.eError_41_2753" = load i8*, i8** %"$ud-registry.eError_41", align 8
  store i8* %"$$ud-registry.eError_41_2753", i8** %e3, align 8
...
"$have_gas_2760":                                 ; preds = %"$out_of_gas_2759", %"$have_gas_2746"
  ...
  call void @_event(i8* %"$execptr_load_2762", %_TyDescrTy_Typ* @"$TyDescr_Event_184", i8* %"$e_2763")
  br label %"$matchsucc_2582"
...
entry:
  ...
  call void @"$approve_2521"(%Uint128 %_amount, [20 x i8]* %"$_origin_2768", [20 x i8]* %"$_sender_2770", [32 x i8]* %"$node_2772", [20 x i8]* %"$address_2774")
  ret void
}

define internal void @"$approveFor_2775"(%Uint128 %_amount, [20 x i8]* %"$_origin_2776", [20 x i8]* %"$_sender_2777", [20 x i8]* %"$address_2778", %TName_Bool* %isApproved) {
entry:
  ...
  %"$maybeOperators_call_2783" = call i8* @_fetch_field(i8* %"$execptr_load_2782", i8* getelementptr inbounds ([10 x i8], [10 x i8]* @"$operators_2781", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_206", i32 1, i8* %"$indices_buf_2779", i32 1)
...
"$have_gas_2815":                                 ; preds = %"$out_of_gas_2814", %"$None_2810"
  ...
  store %TName_List_ByStr20* %"$ud-registry.nilByStr20_2817", %TName_List_ByStr20** %currentOperators, align 8
...
"$have_gas_2825":                                 ; preds = %"$out_of_gas_2824", %"$Some_2818"
  ...
  store %TName_List_ByStr20* %"$ops_2827", %TName_List_ByStr20** %currentOperators, align 8
  br label %"$matchsucc_2805"
...
"$have_gas_2841":                                 ; preds = %"$out_of_gas_2840", %"$have_gas_2836"
  ...
  %"$ud-registry.listByStr20Excludes_call_2848" = call %TName_Bool* %"$ud-registry.listByStr20Excludes_fptr_2844"(i8* %"$ud-registry.listByStr20Excludes_envptr_2845", %TName_List_ByStr20* %"$currentOperators_2846", [20 x i8]* %"$ud-registry.listByStr20Excludes_address_2847")
  store %TName_Bool* %"$ud-registry.listByStr20Excludes_call_2848", %TName_Bool** %b, align 8
...
"$have_gas_2852":                                 ; preds = %"$out_of_gas_2851", %"$have_gas_2841"
  ...
  %"$ud-registry.xandb_call_2858" = call %TName_Bool* %"$ud-registry.xandb_fptr_2855"(i8* %"$ud-registry.xandb_envptr_2856", %TName_Bool* %"$b_2857", %TName_Bool* %isApproved)
  store %TName_Bool* %"$ud-registry.xandb_call_2858", %TName_Bool** %needsToChange, align 8
...
"$have_gas_2890":                                 ; preds = %"$out_of_gas_2889", %"$True_2885"
  ...
  store %TName_List_ByStr20* %"$adtptr_2897", %TName_List_ByStr20** %newOperators, align 8
...
"$have_gas_2903":                                 ; preds = %"$out_of_gas_2902", %"$False_2898"
  ...
  %"$ud-registry.listByStr20FilterOut_call_2910" = call %TName_List_ByStr20* %"$ud-registry.listByStr20FilterOut_fptr_2906"(i8* %"$ud-registry.listByStr20FilterOut_envptr_2907", %TName_List_ByStr20* %"$currentOperators_2908", [20 x i8]* %"$ud-registry.listByStr20FilterOut_address_2909")
  store %TName_List_ByStr20* %"$ud-registry.listByStr20FilterOut_call_2910", %TName_List_ByStr20** %newOperators, align 8
  br label %"$matchsucc_2881"
...
"$have_gas_2918":                                 ; preds = %"$out_of_gas_2917", %"$matchsucc_2881"
  ...
  call void @_update_field(i8* %"$execptr_load_2922", i8* getelementptr inbounds ([10 x i8], [10 x i8]* @"$operators_2923", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_206", i32 1, i8* %"$indices_buf_2920", i8* %"$update_value_2925")
...
"$have_gas_2934":                                 ; preds = %"$out_of_gas_2933", %"$have_gas_2929"
  ...
  %"$ud-registry.eApprovedFor_call_2941" = call i8* %"$ud-registry.eApprovedFor_fptr_2937"(i8* %"$ud-registry.eApprovedFor_envptr_2938", [20 x i8]* %"$ud-registry.eApprovedFor__sender_2939", [20 x i8]* %"$ud-registry.eApprovedFor_address_2940", %TName_Bool* %isApproved)
  store i8* %"$ud-registry.eApprovedFor_call_2941", i8** %e, align 8
...
"$have_gas_2948":                                 ; preds = %"$out_of_gas_2947", %"$have_gas_2934"
  ...
  call void @_event(i8* %"$execptr_load_2950", %_TyDescrTy_Typ* @"$TyDescr_Event_184", i8* %"$e_2951")
...
entry:
  ...
  call void @"$approveFor_2775"(%Uint128 %_amount, [20 x i8]* %"$_origin_2956", [20 x i8]* %"$_sender_2958", [20 x i8]* %"$address_2960", %TName_Bool* %isApproved)
  ret void
}

define internal void @"$configureNode_2963"(%Uint128 %_amount, [20 x i8]* %"$_origin_2964", [20 x i8]* %"$_sender_2965", [32 x i8]* %"$node_2966", [20 x i8]* %"$owner_2967", [20 x i8]* %"$resolver_2968") {
entry:
  ...
  %"$maybeRecord_call_2973" = call i8* @_fetch_field(i8* %"$execptr_load_2972", i8* getelementptr inbounds ([8 x i8], [8 x i8]* @"$records_2971", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_208", i32 1, i8* %"$indices_buf_2969", i32 1)
...
"$have_gas_2983":                                 ; preds = %"$out_of_gas_2982", %entry
  ...
  %"$maybeApproved_call_2989" = call i8* @_fetch_field(i8* %"$execptr_load_2988", i8* getelementptr inbounds ([10 x i8], [10 x i8]* @"$approvals_2987", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_207", i32 1, i8* %"$indices_buf_2985", i32 1)
...
"$have_gas_3009":                                 ; preds = %"$out_of_gas_3008", %"$have_gas_3004"
  ...
  call void %"$ud-registry.recordMemberOwner_fptr_3012"(i8* %"$ud-registry.recordMemberOwner_envptr_3013", [20 x i8]* %"$ud-registry.recordMemberOwner_retalloca_3015", %TName_Option_ud-registry.Record* %"$maybeRecord_3014")
  ...
  %"$maybeOperators_call_3023" = call i8* @_fetch_field(i8* %"$execptr_load_3022", i8* getelementptr inbounds ([10 x i8], [10 x i8]* @"$operators_3021", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_206", i32 1, i8* %"$indices_buf_3018", i32 1)
...
"$have_gas_3043":                                 ; preds = %"$out_of_gas_3042", %"$have_gas_3038"
  ...
  %"$ud-registry.getIsOAO_call_3053" = call %TName_Bool* %"$ud-registry.getIsOAO_fptr_3046"(i8* %"$ud-registry.getIsOAO_envptr_3047", [20 x i8]* %"$ud-registry.getIsOAO__sender_3048", [20 x i8]* %"$ud-registry.getIsOAO_recordOwner_3049", %TName_Option_ByStr20* %"$maybeApproved_3051", %"TName_Option_List_(ByStr20)"* %"$maybeOperators_3052")
  store %TName_Bool* %"$ud-registry.getIsOAO_call_3053", %TName_Bool** %isSenderOAO, align 8
...
"$have_gas_3074":                                 ; preds = %"$out_of_gas_3073", %"$have_gas_3069"
  ...
  store %TName_ud-registry.Record* %"$adtptr_3080", %TName_ud-registry.Record** %newRecord, align 8
...
"$have_gas_3088":                                 ; preds = %"$out_of_gas_3087", %"$have_gas_3074"
  ...
  call void @_update_field(i8* %"$execptr_load_3092", i8* getelementptr inbounds ([8 x i8], [8 x i8]* @"$records_3093", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_208", i32 1, i8* %"$indices_buf_3090", i8* %"$update_value_3095")
...
"$have_gas_3104":                                 ; preds = %"$out_of_gas_3103", %"$have_gas_3099"
  ...
  %"$ud-registry.eConfigured_call_3112" = call i8* %"$ud-registry.eConfigured_fptr_3107"(i8* %"$ud-registry.eConfigured_envptr_3108", [32 x i8]* %"$ud-registry.eConfigured_node_3109", [20 x i8]* %"$ud-registry.eConfigured_owner_3110", [20 x i8]* %"$ud-registry.eConfigured_resolver_3111")
  store i8* %"$ud-registry.eConfigured_call_3112", i8** %e, align 8
...
"$have_gas_3119":                                 ; preds = %"$out_of_gas_3118", %"$have_gas_3104"
  ...
  call void @_event(i8* %"$execptr_load_3121", %_TyDescrTy_Typ* @"$TyDescr_Event_184", i8* %"$e_3122")
...
"$have_gas_3136":                                 ; preds = %"$out_of_gas_3135", %"$have_gas_3131"
  ...
  store i8* %"$msgobj_3138", i8** %m, align 8
...
"$have_gas_3179":                                 ; preds = %"$out_of_gas_3178", %"$have_gas_3136"
  ...
  %"$ud-registry.oneMsg_call_3185" = call %TName_List_Message* %"$ud-registry.oneMsg_fptr_3182"(i8* %"$ud-registry.oneMsg_envptr_3183", i8* %"$m_3184")
  store %TName_List_Message* %"$ud-registry.oneMsg_call_3185", %TName_List_Message** %"$ud-registry.oneMsg_43", align 8
  %"$$ud-registry.oneMsg_43_3186" = load %TName_List_Message*, %TName_List_Message** %"$ud-registry.oneMsg_43", align 8
  store %TName_List_Message* %"$$ud-registry.oneMsg_43_3186", %TName_List_Message** %msgs, align 8
...
"$have_gas_3193":                                 ; preds = %"$out_of_gas_3192", %"$have_gas_3179"
  ...
  call void @_send(i8* %"$execptr_load_3195", %_TyDescrTy_Typ* @"$TyDescr_ADT_List_Message_202", %TName_List_Message* %"$msgs_3196")
...
"$have_gas_3212":                                 ; preds = %"$out_of_gas_3211", %"$have_gas_3207"
  ...
  store %String { i8* getelementptr inbounds ([43 x i8], [43 x i8]* @"$stringlit_3214", i32 0, i32 0), i32 43 }, %String* %m5, align 8
...
"$have_gas_3218":                                 ; preds = %"$out_of_gas_3217", %"$have_gas_3212"
  ...
  store i8* %"$ud-registry.eError_call_3224", i8** %"$ud-registry.eError_44", align 8
  %"$$ud-registry.eError_44_3225" = load i8*, i8** %"$ud-registry.eError_44", align 8
  store i8* %"$$ud-registry.eError_44_3225", i8** %e4, align 8
...
"$have_gas_3232":                                 ; preds = %"$out_of_gas_3231", %"$have_gas_3218"
  ...
  call void @_event(i8* %"$execptr_load_3234", %_TyDescrTy_Typ* @"$TyDescr_Event_184", i8* %"$e_3235")
...
"$have_gas_3249":                                 ; preds = %"$out_of_gas_3248", %"$have_gas_3244"
  ...
  store i8* %"$msgobj_3251", i8** %"$m_0", align 8
...
"$have_gas_3293":                                 ; preds = %"$out_of_gas_3292", %"$have_gas_3249"
  ...
  %"$ud-registry.oneMsg_call_3299" = call %TName_List_Message* %"$ud-registry.oneMsg_fptr_3296"(i8* %"$ud-registry.oneMsg_envptr_3297", i8* %"$$m_0_3298")
  store %TName_List_Message* %"$ud-registry.oneMsg_call_3299", %TName_List_Message** %"$ud-registry.oneMsg_45", align 8
  %"$$ud-registry.oneMsg_45_3300" = load %TName_List_Message*, %TName_List_Message** %"$ud-registry.oneMsg_45", align 8
  store %TName_List_Message* %"$$ud-registry.oneMsg_45_3300", %TName_List_Message** %msgs6, align 8
...
"$have_gas_3307":                                 ; preds = %"$out_of_gas_3306", %"$have_gas_3293"
  ...
  call void @_send(i8* %"$execptr_load_3309", %_TyDescrTy_Typ* @"$TyDescr_ADT_List_Message_202", %TName_List_Message* %"$msgs_3310")
  br label %"$matchsucc_3059"
...
entry:
  ...
  call void @"$configureNode_2963"(%Uint128 %_amount, [20 x i8]* %"$_origin_3315", [20 x i8]* %"$_sender_3317", [32 x i8]* %"$node_3319", [20 x i8]* %"$owner_3321", [20 x i8]* %"$resolver_3323")
  ret void
}

define internal void @"$configureResolver_3324"(%Uint128 %_amount, [20 x i8]* %"$_origin_3325", [20 x i8]* %"$_sender_3326", [32 x i8]* %"$node_3327", [20 x i8]* %"$resolver_3328") {
entry:
  ...
  %"$maybeRecord_call_3333" = call i8* @_fetch_field(i8* %"$execptr_load_3332", i8* getelementptr inbounds ([8 x i8], [8 x i8]* @"$records_3331", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_208", i32 1, i8* %"$indices_buf_3329", i32 1)
...
"$have_gas_3343":                                 ; preds = %"$out_of_gas_3342", %entry
  ...
  %"$maybeApproved_call_3349" = call i8* @_fetch_field(i8* %"$execptr_load_3348", i8* getelementptr inbounds ([10 x i8], [10 x i8]* @"$approvals_3347", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_207", i32 1, i8* %"$indices_buf_3345", i32 1)
...
"$have_gas_3369":                                 ; preds = %"$out_of_gas_3368", %"$have_gas_3364"
  ...
  call void %"$ud-registry.recordMemberOwner_fptr_3372"(i8* %"$ud-registry.recordMemberOwner_envptr_3373", [20 x i8]* %"$ud-registry.recordMemberOwner_retalloca_3375", %TName_Option_ud-registry.Record* %"$maybeRecord_3374")
  ...
  %"$maybeOperators_call_3383" = call i8* @_fetch_field(i8* %"$execptr_load_3382", i8* getelementptr inbounds ([10 x i8], [10 x i8]* @"$operators_3381", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_206", i32 1, i8* %"$indices_buf_3378", i32 1)
...
"$have_gas_3403":                                 ; preds = %"$out_of_gas_3402", %"$have_gas_3398"
  ...
  %"$ud-registry.getIsOAO_call_3413" = call %TName_Bool* %"$ud-registry.getIsOAO_fptr_3406"(i8* %"$ud-registry.getIsOAO_envptr_3407", [20 x i8]* %"$ud-registry.getIsOAO__sender_3408", [20 x i8]* %"$ud-registry.getIsOAO_recordOwner_3409", %TName_Option_ByStr20* %"$maybeApproved_3411", %"TName_Option_List_(ByStr20)"* %"$maybeOperators_3412")
  store %TName_Bool* %"$ud-registry.getIsOAO_call_3413", %TName_Bool** %isSenderOAO, align 8
...
"$have_gas_3434":                                 ; preds = %"$out_of_gas_3433", %"$have_gas_3429"
  ...
  store %TName_ud-registry.Record* %"$adtptr_3441", %TName_ud-registry.Record** %newRecord, align 8
...
"$have_gas_3449":                                 ; preds = %"$out_of_gas_3448", %"$have_gas_3434"
  ...
  call void @_update_field(i8* %"$execptr_load_3453", i8* getelementptr inbounds ([8 x i8], [8 x i8]* @"$records_3454", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_208", i32 1, i8* %"$indices_buf_3451", i8* %"$update_value_3456")
...
"$have_gas_3465":                                 ; preds = %"$out_of_gas_3464", %"$have_gas_3460"
  ...
  %"$ud-registry.eConfigured_call_3474" = call i8* %"$ud-registry.eConfigured_fptr_3468"(i8* %"$ud-registry.eConfigured_envptr_3469", [32 x i8]* %"$ud-registry.eConfigured_node_3470", [20 x i8]* %"$ud-registry.eConfigured_recordOwner_3471", [20 x i8]* %"$ud-registry.eConfigured_resolver_3473")
  store i8* %"$ud-registry.eConfigured_call_3474", i8** %e, align 8
...
"$have_gas_3481":                                 ; preds = %"$out_of_gas_3480", %"$have_gas_3465"
  ...
  call void @_event(i8* %"$execptr_load_3483", %_TyDescrTy_Typ* @"$TyDescr_Event_184", i8* %"$e_3484")
...
"$have_gas_3500":                                 ; preds = %"$out_of_gas_3499", %"$have_gas_3495"
  ...
  store %String { i8* getelementptr inbounds ([43 x i8], [43 x i8]* @"$stringlit_3502", i32 0, i32 0), i32 43 }, %String* %m, align 8
...
"$have_gas_3506":                                 ; preds = %"$out_of_gas_3505", %"$have_gas_3500"
  ...
  %"$ud-registry.eError_call_3512" = call i8* %"$ud-registry.eError_fptr_3509"(i8* %"$ud-registry.eError_envptr_3510", %String %"$m_3511")
  store i8* %"$ud-registry.eError_call_3512", i8** %"$ud-registry.eError_47", align 8
  %"$$ud-registry.eError_47_3513" = load i8*, i8** %"$ud-registry.eError_47", align 8
  store i8* %"$$ud-registry.eError_47_3513", i8** %e4, align 8
...
"$have_gas_3520":                                 ; preds = %"$out_of_gas_3519", %"$have_gas_3506"
  ...
  call void @_event(i8* %"$execptr_load_3522", %_TyDescrTy_Typ* @"$TyDescr_Event_184", i8* %"$e_3523")
  br label %"$matchsucc_3419"
...
entry:
  ...
  call void @"$configureResolver_3324"(%Uint128 %_amount, [20 x i8]* %"$_origin_3528", [20 x i8]* %"$_sender_3530", [32 x i8]* %"$node_3532", [20 x i8]* %"$resolver_3534")
  ret void
}

define internal void @"$transfer_3535"(%Uint128 %_amount, [20 x i8]* %"$_origin_3536", [20 x i8]* %"$_sender_3537", [32 x i8]* %"$node_3538", [20 x i8]* %"$owner_3539") {
entry:
  ...
  %"$maybeRecord_call_3544" = call i8* @_fetch_field(i8* %"$execptr_load_3543", i8* getelementptr inbounds ([8 x i8], [8 x i8]* @"$records_3542", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_208", i32 1, i8* %"$indices_buf_3540", i32 1)
...
"$have_gas_3554":                                 ; preds = %"$out_of_gas_3553", %entry
  ...
  %"$maybeApproved_call_3560" = call i8* @_fetch_field(i8* %"$execptr_load_3559", i8* getelementptr inbounds ([10 x i8], [10 x i8]* @"$approvals_3558", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_207", i32 1, i8* %"$indices_buf_3556", i32 1)
...
"$have_gas_3580":                                 ; preds = %"$out_of_gas_3579", %"$have_gas_3575"
  ...
  call void %"$ud-registry.recordMemberOwner_fptr_3583"(i8* %"$ud-registry.recordMemberOwner_envptr_3584", [20 x i8]* %"$ud-registry.recordMemberOwner_retalloca_3586", %TName_Option_ud-registry.Record* %"$maybeRecord_3585")
  %"$ud-registry.recordMemberOwner_ret_3587" = load [20 x i8], [20 x i8]* %"$ud-registry.recordMemberOwner_retalloca_3586", align 1
  store [20 x i8] %"$ud-registry.recordMemberOwner_ret_3587", [20 x i8]* %"$ud-registry.recordMemberOwner_48", align 1
  ...
  %"$maybeOperators_call_3594" = call i8* @_fetch_field(i8* %"$execptr_load_3593", i8* getelementptr inbounds ([10 x i8], [10 x i8]* @"$operators_3592", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_206", i32 1, i8* %"$indices_buf_3589", i32 1)
...
"$have_gas_3614":                                 ; preds = %"$out_of_gas_3613", %"$have_gas_3609"
  ...
  %"$ud-registry.getIsOAO_call_3624" = call %TName_Bool* %"$ud-registry.getIsOAO_fptr_3617"(i8* %"$ud-registry.getIsOAO_envptr_3618", [20 x i8]* %"$ud-registry.getIsOAO__sender_3619", [20 x i8]* %"$ud-registry.getIsOAO_recordOwner_3620", %TName_Option_ByStr20* %"$maybeApproved_3622", %"TName_Option_List_(ByStr20)"* %"$maybeOperators_3623")
  store %TName_Bool* %"$ud-registry.getIsOAO_call_3624", %TName_Bool** %isSenderOAO, align 8
...
"$have_gas_3640":                                 ; preds = %"$out_of_gas_3639", %"$True_3635"
  ...
  call void @_update_field(i8* %"$execptr_load_3644", i8* getelementptr inbounds ([10 x i8], [10 x i8]* @"$approvals_3645", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_207", i32 1, i8* %"$indices_buf_3642", i8* null)
...
"$have_gas_3654":                                 ; preds = %"$out_of_gas_3653", %"$have_gas_3649"
  ...
  store %TName_ud-registry.Record* %"$adtptr_3661", %TName_ud-registry.Record** %newRecord, align 8
...
"$have_gas_3669":                                 ; preds = %"$out_of_gas_3668", %"$have_gas_3654"
  ...
  call void @_update_field(i8* %"$execptr_load_3673", i8* getelementptr inbounds ([8 x i8], [8 x i8]* @"$records_3674", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_208", i32 1, i8* %"$indices_buf_3671", i8* %"$update_value_3676")
...
"$have_gas_3685":                                 ; preds = %"$out_of_gas_3684", %"$have_gas_3680"
  ...
  %"$ud-registry.eConfigured_call_3694" = call i8* %"$ud-registry.eConfigured_fptr_3688"(i8* %"$ud-registry.eConfigured_envptr_3689", [32 x i8]* %"$ud-registry.eConfigured_node_3690", [20 x i8]* %"$ud-registry.eConfigured_owner_3691", [20 x i8]* %"$ud-registry.eConfigured_ud-registry.zeroByStr20_3692")
  store i8* %"$ud-registry.eConfigured_call_3694", i8** %e, align 8
...
"$have_gas_3701":                                 ; preds = %"$out_of_gas_3700", %"$have_gas_3685"
  ...
  call void @_event(i8* %"$execptr_load_3703", %_TyDescrTy_Typ* @"$TyDescr_Event_184", i8* %"$e_3704")
...
"$have_gas_3718":                                 ; preds = %"$out_of_gas_3717", %"$have_gas_3713"
  ...
  store i8* %"$msgobj_3720", i8** %m, align 8
...
"$have_gas_3761":                                 ; preds = %"$out_of_gas_3760", %"$have_gas_3718"
  ...
  %"$ud-registry.oneMsg_call_3767" = call %TName_List_Message* %"$ud-registry.oneMsg_fptr_3764"(i8* %"$ud-registry.oneMsg_envptr_3765", i8* %"$m_3766")
  store %TName_List_Message* %"$ud-registry.oneMsg_call_3767", %TName_List_Message** %"$ud-registry.oneMsg_49", align 8
  %"$$ud-registry.oneMsg_49_3768" = load %TName_List_Message*, %TName_List_Message** %"$ud-registry.oneMsg_49", align 8
  store %TName_List_Message* %"$$ud-registry.oneMsg_49_3768", %TName_List_Message** %msgs, align 8
...
"$have_gas_3775":                                 ; preds = %"$out_of_gas_3774", %"$have_gas_3761"
  ...
  call void @_send(i8* %"$execptr_load_3777", %_TyDescrTy_Typ* @"$TyDescr_ADT_List_Message_202", %TName_List_Message* %"$msgs_3778")
...
"$have_gas_3794":                                 ; preds = %"$out_of_gas_3793", %"$have_gas_3789"
  ...
  store %String { i8* getelementptr inbounds ([43 x i8], [43 x i8]* @"$stringlit_3796", i32 0, i32 0), i32 43 }, %String* %m6, align 8
...
"$have_gas_3800":                                 ; preds = %"$out_of_gas_3799", %"$have_gas_3794"
  ...
  %"$ud-registry.eError_call_3806" = call i8* %"$ud-registry.eError_fptr_3803"(i8* %"$ud-registry.eError_envptr_3804", %String %"$m_3805")
  store i8* %"$ud-registry.eError_call_3806", i8** %"$ud-registry.eError_50", align 8
  %"$$ud-registry.eError_50_3807" = load i8*, i8** %"$ud-registry.eError_50", align 8
  store i8* %"$$ud-registry.eError_50_3807", i8** %e5, align 8
...
"$have_gas_3814":                                 ; preds = %"$out_of_gas_3813", %"$have_gas_3800"
  ...
  call void @_event(i8* %"$execptr_load_3816", %_TyDescrTy_Typ* @"$TyDescr_Event_184", i8* %"$e_3817")
...
"$have_gas_3831":                                 ; preds = %"$out_of_gas_3830", %"$have_gas_3826"
  ...
  store i8* %"$msgobj_3833", i8** %"$m_1", align 8
...
"$have_gas_3874":                                 ; preds = %"$out_of_gas_3873", %"$have_gas_3831"
  ...
  %"$ud-registry.oneMsg_call_3880" = call %TName_List_Message* %"$ud-registry.oneMsg_fptr_3877"(i8* %"$ud-registry.oneMsg_envptr_3878", i8* %"$$m_1_3879")
  store %TName_List_Message* %"$ud-registry.oneMsg_call_3880", %TName_List_Message** %"$ud-registry.oneMsg_51", align 8
  %"$$ud-registry.oneMsg_51_3881" = load %TName_List_Message*, %TName_List_Message** %"$ud-registry.oneMsg_51", align 8
  store %TName_List_Message* %"$$ud-registry.oneMsg_51_3881", %TName_List_Message** %msgs7, align 8
...
"$have_gas_3888":                                 ; preds = %"$out_of_gas_3887", %"$have_gas_3874"
  ...
  call void @_send(i8* %"$execptr_load_3890", %_TyDescrTy_Typ* @"$TyDescr_ADT_List_Message_202", %TName_List_Message* %"$msgs_3891")
  br label %"$matchsucc_3630"
...
entry:
  ...
  call void @"$transfer_3535"(%Uint128 %_amount, [20 x i8]* %"$_origin_3896", [20 x i8]* %"$_sender_3898", [32 x i8]* %"$node_3900", [20 x i8]* %"$owner_3902")
  ret void
}

define internal void @"$assign_3903"(%Uint128 %_amount, [20 x i8]* %"$_origin_3904", [20 x i8]* %"$_sender_3905", [32 x i8]* %"$parent_3906", %String %label, [20 x i8]* %"$owner_3907") {
entry:
  ...
  %"$maybeRecord_call_3912" = call i8* @_fetch_field(i8* %"$execptr_load_3911", i8* getelementptr inbounds ([8 x i8], [8 x i8]* @"$records_3910", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_208", i32 1, i8* %"$indices_buf_3908", i32 1)
...
"$have_gas_3922":                                 ; preds = %"$out_of_gas_3921", %entry
  ...
  %"$maybeApproved_call_3928" = call i8* @_fetch_field(i8* %"$execptr_load_3927", i8* getelementptr inbounds ([10 x i8], [10 x i8]* @"$approvals_3926", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_207", i32 1, i8* %"$indices_buf_3924", i32 1)
...
"$have_gas_3948":                                 ; preds = %"$out_of_gas_3947", %"$have_gas_3943"
  ...
  call void %"$ud-registry.recordMemberOwner_fptr_3951"(i8* %"$ud-registry.recordMemberOwner_envptr_3952", [20 x i8]* %"$ud-registry.recordMemberOwner_retalloca_3954", %TName_Option_ud-registry.Record* %"$maybeRecord_3953")
  %"$ud-registry.recordMemberOwner_ret_3955" = load [20 x i8], [20 x i8]* %"$ud-registry.recordMemberOwner_retalloca_3954", align 1
  store [20 x i8] %"$ud-registry.recordMemberOwner_ret_3955", [20 x i8]* %"$ud-registry.recordMemberOwner_52", align 1
  ...
  %"$maybeOperators_call_3962" = call i8* @_fetch_field(i8* %"$execptr_load_3961", i8* getelementptr inbounds ([10 x i8], [10 x i8]* @"$operators_3960", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_206", i32 1, i8* %"$indices_buf_3957", i32 1)
...
"$have_gas_3982":                                 ; preds = %"$out_of_gas_3981", %"$have_gas_3977"
  ...
  %"$ud-registry.getIsOAO_call_3992" = call %TName_Bool* %"$ud-registry.getIsOAO_fptr_3985"(i8* %"$ud-registry.getIsOAO_envptr_3986", [20 x i8]* %"$ud-registry.getIsOAO__sender_3987", [20 x i8]* %"$ud-registry.getIsOAO_recordOwner_3988", %TName_Option_ByStr20* %"$maybeApproved_3990", %"TName_Option_List_(ByStr20)"* %"$maybeOperators_3991")
  store %TName_Bool* %"$ud-registry.getIsOAO_call_3992", %TName_Bool** %isSenderOAO, align 8
...
"$have_gas_4013":                                 ; preds = %"$out_of_gas_4012", %"$have_gas_4008"
  ...
  call void %"$ud-registry.parentLabelToNode_fptr_4016"(i8* %"$ud-registry.parentLabelToNode_envptr_4017", [32 x i8]* %"$ud-registry.parentLabelToNode_retalloca_4019", [32 x i8]* %"$ud-registry.parentLabelToNode_parent_4018", %String %label)
  ...
  %"$recordExists_call_4026" = call i8* @_fetch_field(i8* %"$execptr_load_4025", i8* getelementptr inbounds ([8 x i8], [8 x i8]* @"$records_4024", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_208", i32 1, i8* %"$indices_buf_4021", i32 0)
...
"$have_gas_4058":                                 ; preds = %"$out_of_gas_4057", %"$have_gas_4053"
  ...
  %"$ud-registry.eNewDomain_call_4064" = call i8* %"$ud-registry.eNewDomain_fptr_4061"(i8* %"$ud-registry.eNewDomain_envptr_4062", [32 x i8]* %"$ud-registry.eNewDomain_parent_4063", %String %label)
  store i8* %"$ud-registry.eNewDomain_call_4064", i8** %e, align 8
...
"$have_gas_4071":                                 ; preds = %"$out_of_gas_4070", %"$have_gas_4058"
  ...
  call void @_event(i8* %"$execptr_load_4073", %_TyDescrTy_Typ* @"$TyDescr_Event_184", i8* %"$e_4074")
...
"$have_gas_4078":                                 ; preds = %"$out_of_gas_4077", %"$matchsucc_4043"
  ...
  call void @_update_field(i8* %"$execptr_load_4083", i8* getelementptr inbounds ([10 x i8], [10 x i8]* @"$approvals_4084", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_207", i32 1, i8* %"$indices_buf_4080", i8* null)
...
"$have_gas_4093":                                 ; preds = %"$out_of_gas_4092", %"$have_gas_4088"
  ...
  store %TName_ud-registry.Record* %"$adtptr_4100", %TName_ud-registry.Record** %newRecord, align 8
...
"$have_gas_4108":                                 ; preds = %"$out_of_gas_4107", %"$have_gas_4093"
  ...
  call void @_update_field(i8* %"$execptr_load_4113", i8* getelementptr inbounds ([8 x i8], [8 x i8]* @"$records_4114", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_208", i32 1, i8* %"$indices_buf_4110", i8* %"$update_value_4116")
...
"$have_gas_4125":                                 ; preds = %"$out_of_gas_4124", %"$have_gas_4120"
  ...
  %"$ud-registry.eConfigured_call_4135" = call i8* %"$ud-registry.eConfigured_fptr_4128"(i8* %"$ud-registry.eConfigured_envptr_4129", [32 x i8]* %"$ud-registry.eConfigured_node_4130", [20 x i8]* %"$ud-registry.eConfigured_owner_4132", [20 x i8]* %"$ud-registry.eConfigured_ud-registry.zeroByStr20_4133")
  store i8* %"$ud-registry.eConfigured_call_4135", i8** %e6, align 8
...
"$have_gas_4142":                                 ; preds = %"$out_of_gas_4141", %"$have_gas_4125"
  ...
  call void @_event(i8* %"$execptr_load_4144", %_TyDescrTy_Typ* @"$TyDescr_Event_184", i8* %"$e_4145")
...
"$have_gas_4159":                                 ; preds = %"$out_of_gas_4158", %"$have_gas_4154"
  ...
  store i8* %"$msgobj_4161", i8** %m, align 8
...
"$have_gas_4209":                                 ; preds = %"$out_of_gas_4208", %"$have_gas_4159"
  ...
  %"$ud-registry.oneMsg_call_4215" = call %TName_List_Message* %"$ud-registry.oneMsg_fptr_4212"(i8* %"$ud-registry.oneMsg_envptr_4213", i8* %"$m_4214")
  store %TName_List_Message* %"$ud-registry.oneMsg_call_4215", %TName_List_Message** %"$ud-registry.oneMsg_53", align 8
  %"$$ud-registry.oneMsg_53_4216" = load %TName_List_Message*, %TName_List_Message** %"$ud-registry.oneMsg_53", align 8
  store %TName_List_Message* %"$$ud-registry.oneMsg_53_4216", %TName_List_Message** %msgs, align 8
...
"$have_gas_4223":                                 ; preds = %"$out_of_gas_4222", %"$have_gas_4209"
  ...
  call void @_send(i8* %"$execptr_load_4225", %_TyDescrTy_Typ* @"$TyDescr_ADT_List_Message_202", %TName_List_Message* %"$msgs_4226")
...
"$have_gas_4242":                                 ; preds = %"$out_of_gas_4241", %"$have_gas_4237"
  ...
  store %String { i8* getelementptr inbounds ([45 x i8], [45 x i8]* @"$stringlit_4244", i32 0, i32 0), i32 45 }, %String* %m8, align 8
...
"$have_gas_4248":                                 ; preds = %"$out_of_gas_4247", %"$have_gas_4242"
  ...
  %"$ud-registry.eError_call_4254" = call i8* %"$ud-registry.eError_fptr_4251"(i8* %"$ud-registry.eError_envptr_4252", %String %"$m_4253")
  store i8* %"$ud-registry.eError_call_4254", i8** %"$ud-registry.eError_54", align 8
  %"$$ud-registry.eError_54_4255" = load i8*, i8** %"$ud-registry.eError_54", align 8
  store i8* %"$$ud-registry.eError_54_4255", i8** %e7, align 8
...
"$have_gas_4262":                                 ; preds = %"$out_of_gas_4261", %"$have_gas_4248"
  ...
  call void @_event(i8* %"$execptr_load_4264", %_TyDescrTy_Typ* @"$TyDescr_Event_184", i8* %"$e_4265")
...
"$have_gas_4279":                                 ; preds = %"$out_of_gas_4278", %"$have_gas_4274"
  ...
  store i8* %"$msgobj_4281", i8** %"$m_2", align 8
...
"$have_gas_4330":                                 ; preds = %"$out_of_gas_4329", %"$have_gas_4279"
  ...
  %"$ud-registry.oneMsg_call_4336" = call %TName_List_Message* %"$ud-registry.oneMsg_fptr_4333"(i8* %"$ud-registry.oneMsg_envptr_4334", i8* %"$$m_2_4335")
  store %TName_List_Message* %"$ud-registry.oneMsg_call_4336", %TName_List_Message** %"$ud-registry.oneMsg_55", align 8
  %"$$ud-registry.oneMsg_55_4337" = load %TName_List_Message*, %TName_List_Message** %"$ud-registry.oneMsg_55", align 8
  store %TName_List_Message* %"$$ud-registry.oneMsg_55_4337", %TName_List_Message** %msgs9, align 8
...
"$have_gas_4344":                                 ; preds = %"$out_of_gas_4343", %"$have_gas_4330"
  ...
  call void @_send(i8* %"$execptr_load_4346", %_TyDescrTy_Typ* @"$TyDescr_ADT_List_Message_202", %TName_List_Message* %"$msgs_4347")
  br label %"$matchsucc_3998"
...
entry:
  ...
  call void @"$assign_3903"(%Uint128 %_amount, [20 x i8]* %"$_origin_4352", [20 x i8]* %"$_sender_4354", [32 x i8]* %"$parent_4356", %String %label, [20 x i8]* %"$owner_4360")
  ret void
}

define internal void @"$bestow_4361"(%Uint128 %_amount, [20 x i8]* %"$_origin_4362", [20 x i8]* %"$_sender_4363", %String %label, [20 x i8]* %"$owner_4364", [20 x i8]* %"$resolver_4365") {
entry:
  ...
  %"$currentAdmins_call_4368" = call i8* @_fetch_field(i8* %"$execptr_load_4367", i8* getelementptr inbounds ([7 x i8], [7 x i8]* @"$admins_4366", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_ADT_List_ByStr20_203", i32 0, i8* null, i32 1)
...
"$have_gas_4387":                                 ; preds = %"$out_of_gas_4386", %"$have_gas_4382"
  ...
  call void %"$ud-registry.parentLabelToNode_fptr_4390"(i8* %"$ud-registry.parentLabelToNode_envptr_4391", [32 x i8]* %"$ud-registry.parentLabelToNode_retalloca_4394", [32 x i8]* %"$ud-registry.parentLabelToNode_rootNode_4392", %String %label)
  ...
  %"$recordExists_call_4401" = call i8* @_fetch_field(i8* %"$execptr_load_4400", i8* getelementptr inbounds ([8 x i8], [8 x i8]* @"$records_4399", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_208", i32 1, i8* %"$indices_buf_4396", i32 0)
...
"$have_gas_4411":                                 ; preds = %"$out_of_gas_4410", %"$have_gas_4387"
  ...
  %"$maybeRecord_call_4418" = call i8* @_fetch_field(i8* %"$execptr_load_4417", i8* getelementptr inbounds ([8 x i8], [8 x i8]* @"$records_4416", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_208", i32 1, i8* %"$indices_buf_4413", i32 1)
...
"$have_gas_4428":                                 ; preds = %"$out_of_gas_4427", %"$have_gas_4411"
  ...
  %"$currentRegistrar_call_4432" = call i8* @_fetch_field(i8* %"$execptr_load_4431", i8* getelementptr inbounds ([10 x i8], [10 x i8]* @"$registrar_4430", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Bystr20_194", i32 0, i8* null, i32 1)
...
"$have_gas_4458":                                 ; preds = %"$out_of_gas_4457", %"$have_gas_4453"
  ...
  %"$ud-registry.listByStr20Contains_call_4465" = call %TName_Bool* %"$ud-registry.listByStr20Contains_fptr_4461"(i8* %"$ud-registry.listByStr20Contains_envptr_4462", %TName_List_ByStr20* %"$currentAdmins_4463", [20 x i8]* %"$ud-registry.listByStr20Contains__sender_4464")
  store %TName_Bool* %"$ud-registry.listByStr20Contains_call_4465", %TName_Bool** %isSenderAdmin, align 8
...
"$have_gas_4474":                                 ; preds = %"$out_of_gas_4473", %"$have_gas_4469"
  ...
  %"$eq_call_4482" = call %TName_Bool* @_eq_ByStrX(i8* %"$execptr_load_4476", i32 20, i8* %"$$eq_currentRegistrar_4477_4479", i8* %"$$eq__sender_4480_4481")
  store %TName_Bool* %"$eq_call_4482", %TName_Bool** %isSenderRegistrar, align 8
...
"$have_gas_4492":                                 ; preds = %"$out_of_gas_4491", %"$have_gas_4487"
  ...
  %"$BoolUtils.orb_call_4499" = call %TName_Bool* %"$BoolUtils.orb_fptr_4495"(i8* %"$BoolUtils.orb_envptr_4496", %TName_Bool* %"$isSenderRegistrar_4497", %TName_Bool* %"$isSenderAdmin_4498")
  store %TName_Bool* %"$BoolUtils.orb_call_4499", %TName_Bool** %isOkSender, align 8
...
"$have_gas_4508":                                 ; preds = %"$out_of_gas_4507", %"$have_gas_4503"
  ...
  call void %"$ud-registry.recordMemberOwner_fptr_4511"(i8* %"$ud-registry.recordMemberOwner_envptr_4512", [20 x i8]* %"$ud-registry.recordMemberOwner_retalloca_4514", %TName_Option_ud-registry.Record* %"$maybeRecord_4513")
  %"$ud-registry.recordMemberOwner_ret_4515" = load [20 x i8], [20 x i8]* %"$ud-registry.recordMemberOwner_retalloca_4514", align 1
  store [20 x i8] %"$ud-registry.recordMemberOwner_ret_4515", [20 x i8]* %"$ud-registry.recordMemberOwner_56", align 1
...
"$have_gas_4525":                                 ; preds = %"$out_of_gas_4524", %"$have_gas_4520"
  ...
  %"$eq_call_4534" = call %TName_Bool* @_eq_ByStrX(i8* %"$execptr_load_4527", i32 20, i8* %"$$eq_recordOwner_4528_4530", i8* %"$$eq_ud-registry.zeroByStr20_4531_4533")
  store %TName_Bool* %"$eq_call_4534", %TName_Bool** %recordIsUnowned, align 8
...
"$have_gas_4544":                                 ; preds = %"$out_of_gas_4543", %"$have_gas_4539"
  ...
  %"$eq_call_4553" = call %TName_Bool* @_eq_ByStrX(i8* %"$execptr_load_4546", i32 20, i8* %"$$eq_recordOwner_4547_4549", i8* %"$$eq_currentRegistrar_4550_4552")
  store %TName_Bool* %"$eq_call_4553", %TName_Bool** %recordIsOwnedByRegistrar, align 8
...
"$have_gas_4563":                                 ; preds = %"$out_of_gas_4562", %"$have_gas_4558"
  ...
  %"$BoolUtils.andb_call_4570" = call %TName_Bool* %"$BoolUtils.andb_fptr_4566"(i8* %"$BoolUtils.andb_envptr_4567", %TName_Bool* %"$recordIsOwnedByRegistrar_4568", %TName_Bool* %"$isSenderRegistrar_4569")
  store %TName_Bool* %"$BoolUtils.andb_call_4570", %TName_Bool** %isRegistrarSenderAndOwned, align 8
...
"$have_gas_4579":                                 ; preds = %"$out_of_gas_4578", %"$have_gas_4574"
  ...
  %"$BoolUtils.orb_call_4586" = call %TName_Bool* %"$BoolUtils.orb_fptr_4582"(i8* %"$BoolUtils.orb_envptr_4583", %TName_Bool* %"$recordIsUnowned_4584", %TName_Bool* %"$isRegistrarSenderAndOwned_4585")
  store %TName_Bool* %"$BoolUtils.orb_call_4586", %TName_Bool** %isOkRecordOwner, align 8
...
"$have_gas_4590":                                 ; preds = %"$out_of_gas_4589", %"$have_gas_4579"
  ...
  %"$BoolUtils.andb_call_4597" = call %TName_Bool* %"$BoolUtils.andb_fptr_4593"(i8* %"$BoolUtils.andb_envptr_4594", %TName_Bool* %"$isOkSender_4595", %TName_Bool* %"$isOkRecordOwner_4596")
  store %TName_Bool* %"$BoolUtils.andb_call_4597", %TName_Bool** %isOk, align 8
...
"$have_gas_4630":                                 ; preds = %"$out_of_gas_4629", %"$have_gas_4625"
  ...
  %"$ud-registry.eNewDomain_call_4637" = call i8* %"$ud-registry.eNewDomain_fptr_4633"(i8* %"$ud-registry.eNewDomain_envptr_4634", [32 x i8]* %"$ud-registry.eNewDomain_rootNode_4635", %String %label)
  store i8* %"$ud-registry.eNewDomain_call_4637", i8** %e, align 8
...
"$have_gas_4644":                                 ; preds = %"$out_of_gas_4643", %"$have_gas_4630"
  ...
  call void @_event(i8* %"$execptr_load_4646", %_TyDescrTy_Typ* @"$TyDescr_Event_184", i8* %"$e_4647")
...
"$have_gas_4656":                                 ; preds = %"$out_of_gas_4655", %"$have_gas_4651"
  ...
  store %TName_ud-registry.Record* %"$adtptr_4662", %TName_ud-registry.Record** %newRecord, align 8
...
"$have_gas_4670":                                 ; preds = %"$out_of_gas_4669", %"$have_gas_4656"
  ...
  call void @_update_field(i8* %"$execptr_load_4675", i8* getelementptr inbounds ([8 x i8], [8 x i8]* @"$records_4676", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_208", i32 1, i8* %"$indices_buf_4672", i8* %"$update_value_4678")
...
"$have_gas_4687":                                 ; preds = %"$out_of_gas_4686", %"$have_gas_4682"
  ...
  %"$ud-registry.eConfigured_call_4696" = call i8* %"$ud-registry.eConfigured_fptr_4690"(i8* %"$ud-registry.eConfigured_envptr_4691", [32 x i8]* %"$ud-registry.eConfigured_node_4692", [20 x i8]* %"$ud-registry.eConfigured_owner_4694", [20 x i8]* %"$ud-registry.eConfigured_resolver_4695")
  store i8* %"$ud-registry.eConfigured_call_4696", i8** %e3, align 8
...
"$have_gas_4703":                                 ; preds = %"$out_of_gas_4702", %"$have_gas_4687"
  ...
  call void @_event(i8* %"$execptr_load_4705", %_TyDescrTy_Typ* @"$TyDescr_Event_184", i8* %"$e_4706")
...
"$have_gas_4722":                                 ; preds = %"$out_of_gas_4721", %"$have_gas_4717"
  ...
  store %String { i8* getelementptr inbounds ([12 x i8], [12 x i8]* @"$stringlit_4724", i32 0, i32 0), i32 12 }, %String* %m, align 8
...
"$have_gas_4728":                                 ; preds = %"$out_of_gas_4727", %"$have_gas_4722"
  ...
  %"$ud-registry.eError_call_4734" = call i8* %"$ud-registry.eError_fptr_4731"(i8* %"$ud-registry.eError_envptr_4732", %String %"$m_4733")
  store i8* %"$ud-registry.eError_call_4734", i8** %"$ud-registry.eError_57", align 8
  %"$$ud-registry.eError_57_4735" = load i8*, i8** %"$ud-registry.eError_57", align 8
  store i8* %"$$ud-registry.eError_57_4735", i8** %e4, align 8
...
"$have_gas_4742":                                 ; preds = %"$out_of_gas_4741", %"$have_gas_4728"
  ...
  call void @_event(i8* %"$execptr_load_4744", %_TyDescrTy_Typ* @"$TyDescr_Event_184", i8* %"$e_4745")
  br label %"$matchsucc_4603"
...
entry:
  ...
  call void @"$bestow_4361"(%Uint128 %_amount, [20 x i8]* %"$_origin_4750", [20 x i8]* %"$_sender_4752", %String %label, [20 x i8]* %"$owner_4756", [20 x i8]* %"$resolver_4758")
  ret void
}

define internal void @"$setRegistrar_4759"(%Uint128 %_amount, [20 x i8]* %"$_origin_4760", [20 x i8]* %"$_sender_4761", [20 x i8]* %"$address_4762") {
entry:
  ...
  %"$currentAdmins_call_4765" = call i8* @_fetch_field(i8* %"$execptr_load_4764", i8* getelementptr inbounds ([7 x i8], [7 x i8]* @"$admins_4763", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_ADT_List_ByStr20_203", i32 0, i8* null, i32 1)
...
"$have_gas_4784":                                 ; preds = %"$out_of_gas_4783", %"$have_gas_4779"
  ...
  %"$ud-registry.listByStr20Contains_call_4791" = call %TName_Bool* %"$ud-registry.listByStr20Contains_fptr_4787"(i8* %"$ud-registry.listByStr20Contains_envptr_4788", %TName_List_ByStr20* %"$currentAdmins_4789", [20 x i8]* %"$ud-registry.listByStr20Contains__sender_4790")
  store %TName_Bool* %"$ud-registry.listByStr20Contains_call_4791", %TName_Bool** %isOk, align 8
...
"$have_gas_4812":                                 ; preds = %"$out_of_gas_4811", %"$have_gas_4807"
  ...
  %"$ud-registry.eNewRegistrar_call_4818" = call i8* %"$ud-registry.eNewRegistrar_fptr_4815"(i8* %"$ud-registry.eNewRegistrar_envptr_4816", [20 x i8]* %"$ud-registry.eNewRegistrar_address_4817")
  store i8* %"$ud-registry.eNewRegistrar_call_4818", i8** %"$ud-registry.eNewRegistrar_58", align 8
  %"$$ud-registry.eNewRegistrar_58_4819" = load i8*, i8** %"$ud-registry.eNewRegistrar_58", align 8
  store i8* %"$$ud-registry.eNewRegistrar_58_4819", i8** %e, align 8
...
"$have_gas_4826":                                 ; preds = %"$out_of_gas_4825", %"$have_gas_4812"
  ...
  call void @_event(i8* %"$execptr_load_4828", %_TyDescrTy_Typ* @"$TyDescr_Event_184", i8* %"$e_4829")
...
"$have_gas_4836":                                 ; preds = %"$out_of_gas_4835", %"$have_gas_4826"
  ...
  call void @_update_field(i8* %"$execptr_load_4838", i8* getelementptr inbounds ([10 x i8], [10 x i8]* @"$registrar_4839", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Bystr20_194", i32 0, i8* null, i8* %"$update_value_4841")
...
entry:
  ...
  call void @"$setRegistrar_4759"(%Uint128 %_amount, [20 x i8]* %"$_origin_4846", [20 x i8]* %"$_sender_4848", [20 x i8]* %"$address_4850")
  ret void
}

define internal void @"$register_4851"(%Uint128 %_amount, [20 x i8]* %"$_origin_4852", [20 x i8]* %"$_sender_4853", [32 x i8]* %"$parent_4854", %String %label) {
entry:
...
"$have_gas_4863":                                 ; preds = %"$out_of_gas_4862", %"$have_gas_4858"
  ...
  call void %"$ud-registry.parentLabelToNode_fptr_4866"(i8* %"$ud-registry.parentLabelToNode_envptr_4867", [32 x i8]* %"$ud-registry.parentLabelToNode_retalloca_4869", [32 x i8]* %"$ud-registry.parentLabelToNode_parent_4868", %String %label)
  ...
  %"$maybeRecord_call_4876" = call i8* @_fetch_field(i8* %"$execptr_load_4875", i8* getelementptr inbounds ([8 x i8], [8 x i8]* @"$records_4874", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_208", i32 1, i8* %"$indices_buf_4871", i32 1)
...
"$have_gas_4886":                                 ; preds = %"$out_of_gas_4885", %"$have_gas_4863"
  ...
  %"$maybeApproved_call_4893" = call i8* @_fetch_field(i8* %"$execptr_load_4892", i8* getelementptr inbounds ([10 x i8], [10 x i8]* @"$approvals_4891", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_207", i32 1, i8* %"$indices_buf_4888", i32 1)
...
"$matchsucc_4932":                                ; preds = %"$have_gas_4952", %"$have_gas_4942", %"$empty_default_4936"
  ...
  %"$currentRegistrar_call_4957" = call i8* @_fetch_field(i8* %"$execptr_load_4956", i8* getelementptr inbounds ([10 x i8], [10 x i8]* @"$registrar_4955", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Bystr20_194", i32 0, i8* null, i32 1)
...
"$have_gas_4983":                                 ; preds = %"$out_of_gas_4982", %"$have_gas_4978"
  ...
  %"$eq_call_4992" = call %TName_Bool* @_eq_ByStrX(i8* %"$execptr_load_4985", i32 20, i8* %"$$eq_recordOwner_4986_4988", i8* %"$$eq_ud-registry.zeroByStr20_4989_4991")
  store %TName_Bool* %"$eq_call_4992", %TName_Bool** %isRecordUnowned, align 8
...
"$have_gas_5002":                                 ; preds = %"$out_of_gas_5001", %"$have_gas_4997"
  ...
  %"$eq_call_5011" = call %TName_Bool* @_eq_ByStrX(i8* %"$execptr_load_5004", i32 20, i8* %"$$eq_approved_5005_5007", i8* %"$$eq_ud-registry.zeroByStr20_5008_5010")
  store %TName_Bool* %"$eq_call_5011", %TName_Bool** %isUnapproved, align 8
...
"$have_gas_5016":                                 ; preds = %"$out_of_gas_5015", %"$have_gas_5002"
  ...
  %"$BoolUtils.andb_call_5023" = call %TName_Bool* %"$BoolUtils.andb_fptr_5019"(i8* %"$BoolUtils.andb_envptr_5020", %TName_Bool* %"$isRecordUnowned_5021", %TName_Bool* %"$isUnapproved_5022")
  store %TName_Bool* %"$BoolUtils.andb_call_5023", %TName_Bool** %isOk, align 8
...
"$have_gas_5039":                                 ; preds = %"$out_of_gas_5038", %"$True_5034"
  ...
  call void @_accept(i8* %"$execptr_load_5041")
...
"$have_gas_5055":                                 ; preds = %"$out_of_gas_5054", %"$have_gas_5050"
  ...
  store i8* %"$msgobj_5057", i8** %m, align 8
...
"$have_gas_5114":                                 ; preds = %"$out_of_gas_5113", %"$have_gas_5055"
  ...
  %"$ud-registry.oneMsg_call_5120" = call %TName_List_Message* %"$ud-registry.oneMsg_fptr_5117"(i8* %"$ud-registry.oneMsg_envptr_5118", i8* %"$m_5119")
  store %TName_List_Message* %"$ud-registry.oneMsg_call_5120", %TName_List_Message** %"$ud-registry.oneMsg_60", align 8
  %"$$ud-registry.oneMsg_60_5121" = load %TName_List_Message*, %TName_List_Message** %"$ud-registry.oneMsg_60", align 8
  store %TName_List_Message* %"$$ud-registry.oneMsg_60_5121", %TName_List_Message** %msgs, align 8
...
"$have_gas_5128":                                 ; preds = %"$out_of_gas_5127", %"$have_gas_5114"
  ...
  call void @_send(i8* %"$execptr_load_5130", %_TyDescrTy_Typ* @"$TyDescr_ADT_List_Message_202", %TName_List_Message* %"$msgs_5131")
...
entry:
  ...
  call void @"$register_4851"(%Uint128 %_amount, [20 x i8]* %"$_origin_5138", [20 x i8]* %"$_sender_5140", [32 x i8]* %"$parent_5142", %String %label)
  ret void
}

define internal void @"$onResolverConfigured_5145"(%Uint128 %_amount, [20 x i8]* %"$_origin_5146", [20 x i8]* %"$_sender_5147", [32 x i8]* %"$node_5148") {
entry:
  ...
  %"$maybeRecord_call_5153" = call i8* @_fetch_field(i8* %"$execptr_load_5152", i8* getelementptr inbounds ([8 x i8], [8 x i8]* @"$records_5151", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_208", i32 1, i8* %"$indices_buf_5149", i32 1)
...
"$have_gas_5205":                                 ; preds = %"$out_of_gas_5204", %"$have_gas_5200"
  ...
  %"$eq_call_5213" = call %TName_Bool* @_eq_ByStrX(i8* %"$execptr_load_5207", i32 20, i8* %"$$eq_resolver_5208_5210", i8* %"$$eq__sender_5211_5212")
  store %TName_Bool* %"$eq_call_5213", %TName_Bool** %isOk, align 8
...
"$have_gas_5235":                                 ; preds = %"$out_of_gas_5234", %"$have_gas_5230"
  ...
  %"$ud-registry.eConfigured_call_5245" = call i8* %"$ud-registry.eConfigured_fptr_5238"(i8* %"$ud-registry.eConfigured_envptr_5239", [32 x i8]* %"$ud-registry.eConfigured_node_5240", [20 x i8]* %"$ud-registry.eConfigured_owner_5241", [20 x i8]* %"$ud-registry.eConfigured_resolver_5243")
  store i8* %"$ud-registry.eConfigured_call_5245", i8** %e, align 8
...
"$have_gas_5252":                                 ; preds = %"$out_of_gas_5251", %"$have_gas_5235"
  ...
  call void @_event(i8* %"$execptr_load_5254", %_TyDescrTy_Typ* @"$TyDescr_Event_184", i8* %"$e_5255")
...
entry:
  ...
  call void @"$onResolverConfigured_5145"(%Uint128 %_amount, [20 x i8]* %"$_origin_5262", [20 x i8]* %"$_sender_5264", [32 x i8]* %"$node_5266")
  ret void
}
