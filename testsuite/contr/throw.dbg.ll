...
define internal void @"$ThrowEmpty_56"(%Uint128 %_amount, [20 x i8]* %"$_origin_57", [20 x i8]* %"$_sender_58") !dbg !11 {
entry:
...
"$have_gas_62":                                   ; preds = %"$out_of_gas_61", %entry
  ...
  call void @_throw(i8* %"$execptr_load_64", %_TyDescrTy_Typ* @"$TyDescr_Exception_28", i8* null), !dbg !12
  ret void
}
...
entry:
  ...
  call void @"$ThrowEmpty_56"(%Uint128 %_amount, [20 x i8]* %"$_origin_69", [20 x i8]* %"$_sender_71"), !dbg !14
  ret void
}

define internal void @"$ThrowObj_72"(%Uint128 %_amount, [20 x i8]* %"$_origin_73", [20 x i8]* %"$_sender_74") !dbg !15 {
entry:
...
"$have_gas_83":                                   ; preds = %"$out_of_gas_82", %"$have_gas_78"
  ...
  store i8* %"$msgobj_85", i8** %t, align 8, !dbg !16
...
"$have_gas_101":                                  ; preds = %"$out_of_gas_100", %"$have_gas_83"
  ...
  call void @_throw(i8* %"$execptr_load_103", %_TyDescrTy_Typ* @"$TyDescr_Exception_28", i8* %"$t_104"), !dbg !17
  ret void
}
...
entry:
  ...
  call void @"$ThrowObj_72"(%Uint128 %_amount, [20 x i8]* %"$_origin_109", [20 x i8]* %"$_sender_111"), !dbg !19
  ret void
}
