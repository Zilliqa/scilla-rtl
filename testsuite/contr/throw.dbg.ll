...
define internal void @"$ThrowEmpty_39"(%Uint128 %_amount, [20 x i8]* %"$_sender_40") !dbg !10 {
entry:
...
"$have_gas_44":                                   ; preds = %"$out_of_gas_43", %entry
  ...
  call void @_throw(i8* %"$execptr_load_46", %_TyDescrTy_Typ* @"$TyDescr_Exception_26", i8* null), !dbg !11
  ret void
}
...
entry:
  ...
  call void @"$ThrowEmpty_39"(%Uint128 %_amount, [20 x i8]* %"$_sender_51"), !dbg !13
  ret void
}

define internal void @"$ThrowObj_52"(%Uint128 %_amount, [20 x i8]* %"$_sender_53") !dbg !14 {
entry:
...
"$have_gas_62":                                   ; preds = %"$out_of_gas_61", %"$have_gas_57"
  ...
  store i8* %"$msgobj_64", i8** %t, align 8, !dbg !15
...
"$have_gas_80":                                   ; preds = %"$out_of_gas_79", %"$have_gas_62"
  ...
  call void @_throw(i8* %"$execptr_load_82", %_TyDescrTy_Typ* @"$TyDescr_Exception_26", i8* %"$t_83"), !dbg !16
  ret void
}
...
entry:
  ...
  call void @"$ThrowObj_52"(%Uint128 %_amount, [20 x i8]* %"$_sender_88"), !dbg !18
  ret void
}
