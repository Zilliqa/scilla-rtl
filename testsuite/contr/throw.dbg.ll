...
define internal void @"$ThrowEmpty_51"(%Uint128 %_amount, [20 x i8]* %"$_origin_52", [20 x i8]* %"$_sender_53") !dbg !11 {
entry:
...
"$have_gas_57":                                   ; preds = %"$out_of_gas_56", %entry
  ...
  call void @_throw(i8* %"$execptr_load_59", %_TyDescrTy_Typ* @"$TyDescr_Exception_28", i8* null), !dbg !12
  ret void
}
...
entry:
  ...
  call void @"$ThrowEmpty_51"(%Uint128 %_amount, [20 x i8]* %"$_origin_64", [20 x i8]* %"$_sender_66"), !dbg !14
  ret void
}

define internal void @"$ThrowObj_67"(%Uint128 %_amount, [20 x i8]* %"$_origin_68", [20 x i8]* %"$_sender_69") !dbg !15 {
entry:
...
"$have_gas_78":                                   ; preds = %"$out_of_gas_77", %"$have_gas_73"
  ...
  store i8* %"$msgobj_80", i8** %t, align 8, !dbg !16
...
"$have_gas_96":                                   ; preds = %"$out_of_gas_95", %"$have_gas_78"
  ...
  call void @_throw(i8* %"$execptr_load_98", %_TyDescrTy_Typ* @"$TyDescr_Exception_28", i8* %"$t_99"), !dbg !17
  ret void
}
...
entry:
  ...
  call void @"$ThrowObj_67"(%Uint128 %_amount, [20 x i8]* %"$_origin_104", [20 x i8]* %"$_sender_106"), !dbg !19
  ret void
}
