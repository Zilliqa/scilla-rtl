...
@"$TyDescr_AddrFields_41" = unnamed_addr constant %"$TyDescr_AddrTyp_39" { i32 -1, %"$TyDescr_AddrFieldTyp_38"* null }
...
"$have_gas_55":                                   ; preds = %"$out_of_gas_54", %entry
  ...
  %"$eq_call_60" = call %TName_Bool* @_eq_Int32(i8* %"$execptr_load_57", %Int32 %"$ivar_58", %Int32 %"$cconstraint.one_59"), !dbg !12
  store %TName_Bool* %"$eq_call_60", %TName_Bool** %"$cconstraint_result_1", align 8, !dbg !12
...
"$False_67":                                      ; preds = %"$have_gas_55"
  ...
  store i8* %"$msgobj_69", i8** %"$cconstraint_fail_2", align 8, !dbg !13
  %"$execptr_load_79" = load i8*, i8** @_execptr, align 8
  %"$$cconstraint_fail_2_80" = load i8*, i8** %"$cconstraint_fail_2", align 8
  call void @_throw(i8* %"$execptr_load_79", %_TyDescrTy_Typ* @"$TyDescr_Exception_29", i8* %"$$cconstraint_fail_2_80"), !dbg !13
...
define internal void @"$dummy_83"(%Uint128 %_amount, [20 x i8]* %"$_origin_84", [20 x i8]* %"$_sender_85") !dbg !16 {
entry:
...
entry:
  ...
  call void @"$dummy_83"(%Uint128 %_amount, [20 x i8]* %"$_origin_90", [20 x i8]* %"$_sender_92"), !dbg !18
  ret void
}
