...
define internal %Int32 @"$fundef_3"(%"$$fundef_3_env_48"* %0, %Int32 %1, %Int32 %2) {
entry:
...
"$have_gas_75":                                   ; preds = %"$out_of_gas_74", %entry
  ...
  %"$add_call_77" = call %Int32 @_add_Int32(%Int32 %1, %Int32 %2)
  store %Int32 %"$add_call_77", %Int32* %"$retval_4", align 4
  %"$$retval_4_78" = load %Int32, %Int32* %"$retval_4", align 4
  ret %Int32 %"$$retval_4_78"
}

define internal %Int32 @"$fundef_7"(%"$$fundef_7_env_49"* %0, %Int32 %1) {
entry:
...
"$have_gas_67":                                   ; preds = %"$out_of_gas_66", %entry
  ...
  %"$add_call_70" = call %Int32 @_add_Int32(%Int32 %"$a_69", %Int32 %1)
  store %Int32 %"$add_call_70", %Int32* %"$retval_8", align 4
  %"$$retval_8_71" = load %Int32, %Int32* %"$retval_8", align 4
  ret %Int32 %"$$retval_8_71"
}

define internal { %Int32 (i8*, %Int32)*, i8* } @"$fundef_5"(%"$$fundef_5_env_50"* %0, %Int32 %1) {
entry:
...
"$have_gas_54":                                   ; preds = %"$out_of_gas_53", %entry
  ...
  store { %Int32 (i8*, %Int32)*, i8* } %"$$fundef_7_cloval_59", { %Int32 (i8*, %Int32)*, i8* }* %"$retval_6", align 8
...
"$have_gas_82":                                   ; preds = %"$out_of_gas_81", %entry
  ...
  store %Int32 zeroinitializer, %Int32* %"$res_2", align 4
  ...
  call void @_update_field(i8* %"$execptr_load_84", i8* getelementptr inbounds ([4 x i8], [4 x i8]* @"$res_85", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Int32_11", i32 0, i8* null, i8* %"$update_value_88")
  ret void
}

declare void @_update_field(i8*, i8*, %_TyDescrTy_Typ*, i32, i8*, i8*)

define internal void @"$dummy_89"(%Uint128 %_amount, [20 x i8]* %"$_origin_90", [20 x i8]* %"$_sender_91", %Int32 %x1, %Int32 %x2) {
entry:
...
"$have_gas_105":                                  ; preds = %"$out_of_gas_104", %"$have_gas_100"
  ...
  store { { %Int32 (i8*, %Int32)*, i8* } (i8*, %Int32)*, i8* } { { %Int32 (i8*, %Int32)*, i8* } (i8*, %Int32)* bitcast ({ %Int32 (i8*, %Int32)*, i8* } (%"$$fundef_5_env_50"*, %Int32)* @"$fundef_5" to { %Int32 (i8*, %Int32)*, i8* } (i8*, %Int32)*), i8* null }, { { %Int32 (i8*, %Int32)*, i8* } (i8*, %Int32)*, i8* }* %f, align 8
...
"$have_gas_113":                                  ; preds = %"$out_of_gas_112", %"$have_gas_105"
  ...
  store { { %Int32 (i8*, %Int32)*, i8* } (i8*, %Int32)*, i8* } %"$f_115", { { %Int32 (i8*, %Int32)*, i8* } (i8*, %Int32)*, i8* }* %x, align 8
...
"$have_gas_124":                                  ; preds = %"$out_of_gas_123", %"$have_gas_119"
  ...
  %"$x_call_129" = call { %Int32 (i8*, %Int32)*, i8* } %"$x_fptr_127"(i8* %"$x_envptr_128", %Int32 %x1)
  store { %Int32 (i8*, %Int32)*, i8* } %"$x_call_129", { %Int32 (i8*, %Int32)*, i8* }* %"$x_0", align 8
  ...
  %"$$x_0_call_133" = call %Int32 %"$$x_0_fptr_131"(i8* %"$$x_0_envptr_132", %Int32 %x2)
  store %Int32 %"$$x_0_call_133", %Int32* %"$x_1", align 4
  %"$$x_1_134" = load %Int32, %Int32* %"$x_1", align 4
  store %Int32 %"$$x_1_134", %Int32* %total_app, align 4
...
"$have_gas_142":                                  ; preds = %"$out_of_gas_141", %"$have_gas_124"
  ...
  call void @_update_field(i8* %"$execptr_load_144", i8* getelementptr inbounds ([4 x i8], [4 x i8]* @"$res_145", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Int32_11", i32 0, i8* null, i8* %"$update_value_148")
...
"$have_gas_157":                                  ; preds = %"$out_of_gas_156", %"$have_gas_152"
  ...
  store { %Int32 (i8*, %Int32, %Int32)*, i8* } { %Int32 (i8*, %Int32, %Int32)* bitcast (%Int32 (%"$$fundef_3_env_48"*, %Int32, %Int32)* @"$fundef_3" to %Int32 (i8*, %Int32, %Int32)*), i8* null }, { %Int32 (i8*, %Int32, %Int32)*, i8* }* %y, align 8
...
"$have_gas_170":                                  ; preds = %"$out_of_gas_169", %"$have_gas_165"
  ...
  %"$y_call_175" = call %Int32 %"$y_fptr_173"(i8* %"$y_envptr_174", %Int32 %x1, %Int32 %x2)
  store %Int32 %"$y_call_175", %Int32* %total_app2, align 4
...
"$have_gas_183":                                  ; preds = %"$out_of_gas_182", %"$have_gas_170"
  ...
  call void @_update_field(i8* %"$execptr_load_185", i8* getelementptr inbounds ([4 x i8], [4 x i8]* @"$res_186", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Int32_11", i32 0, i8* null, i8* %"$update_value_189")
  ret void
}
...
entry:
  ...
  call void @"$dummy_89"(%Uint128 %_amount, [20 x i8]* %"$_origin_194", [20 x i8]* %"$_sender_196", %Int32 %x1, %Int32 %x2)
  ret void
}
