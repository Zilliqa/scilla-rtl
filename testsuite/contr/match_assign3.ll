...
define internal void @"$create_event_48"(%Uint128 %_amount, [20 x i8]* %"$_sender_49", %Int32 %m) !dbg !9 {
entry:
...
"$have_gas_58":                                   ; preds = %"$out_of_gas_57", %"$have_gas_53"
  ...
  store i8* %"$msgobj_60", i8** %e, align 8, !dbg !10
...
"$have_gas_83":                                   ; preds = %"$out_of_gas_82", %"$have_gas_58"
  ...
  call void @_event(i8* %"$execptr_load_85", %_TyDescrTy_Typ* @"$TyDescr_Event_24", i8* %"$e_86"), !dbg !11
  ret void
}
...
define internal void @"$t1_87"(%Uint128 %_amount, [20 x i8]* %"$_sender_88", %TName_Bool* %c) !dbg !12 {
entry:
...
"$have_gas_120":                                  ; preds = %"$out_of_gas_119", %"$matchsucc_99"
  ...
  call void @"$create_event_48"(%Uint128 %_amount, [20 x i8]* %"$create_event__sender_122", %Int32 %"$x_123"), !dbg !19
...
"$have_gas_143":                                  ; preds = %"$out_of_gas_142", %"$have_gas_138"
  ...
  store %Int32 { i32 101 }, %Int32* %y, align 4, !dbg !21
...
"$have_gas_148":                                  ; preds = %"$out_of_gas_147", %"$have_gas_143"
  ...
  call void @"$create_event_48"(%Uint128 %_amount, [20 x i8]* %"$create_event__sender_150", %Int32 %"$y_151"), !dbg !24
...
"$have_gas_162":                                  ; preds = %"$out_of_gas_161", %"$have_gas_157"
  ...
  store %Int32 { i32 102 }, %Int32* %y1, align 4, !dbg !25
...
"$have_gas_167":                                  ; preds = %"$out_of_gas_166", %"$have_gas_162"
  ...
  call void @"$create_event_48"(%Uint128 %_amount, [20 x i8]* %"$create_event__sender_169", %Int32 %"$y_170"), !dbg !27
  br label %"$matchsucc_129"
...
entry:
  ...
  call void @"$t1_87"(%Uint128 %_amount, [20 x i8]* %"$_sender_175", %TName_Bool* %c), !dbg !29
  ret void
}
...
!20 = !DILocation(line: 20, column: 3, scope: !12)
!21 = !DILocation(line: 22, column: 9, scope: !22)
!22 = distinct !DILexicalBlock(scope: !23, file: !2, line: 21, column: 5)
!23 = distinct !DILexicalBlock(scope: !12, file: !2, line: 20, column: 3)
!24 = !DILocation(line: 23, column: 5, scope: !22)
!25 = !DILocation(line: 25, column: 9, scope: !26)
!26 = distinct !DILexicalBlock(scope: !23, file: !2, line: 24, column: 5)
!27 = !DILocation(line: 26, column: 5, scope: !26)
!28 = distinct !DISubprogram(name: "t1", linkageName: "t1", scope: !2, file: !2, line: 10, type: !5, scopeLine: 10, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !1, retainedNodes: !3)
!29 = !DILocation(line: 10, column: 12, scope: !28)
