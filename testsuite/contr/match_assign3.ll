...
"$have_gas_168":                                  ; preds = %"$out_of_gas_167", %"$have_gas_163"
  ...
  call void @"$create_event_65"(%Uint128 %_amount, [20 x i8]* %"$create_event__origin_170", [20 x i8]* %"$create_event__sender_171", %Int32 %"$y_172")
...
"$have_gas_188":                                  ; preds = %"$out_of_gas_187", %"$have_gas_183"
  ...
  call void @"$create_event_65"(%Uint128 %_amount, [20 x i8]* %"$create_event__origin_190", [20 x i8]* %"$create_event__sender_191", %Int32 %"$y_192")
  br label %"$matchsucc_149"
...
entry:
  ...
  call void @"$t1_105"(%Uint128 %_amount, [20 x i8]* %"$_origin_197", [20 x i8]* %"$_sender_199", %TName_Bool* %c)
  ret void
}
