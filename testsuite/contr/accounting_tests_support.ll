...
@"$TyDescr_AddrFields_66" = unnamed_addr constant %"$TyDescr_AddrTyp_40" { i32 -3, %"$TyDescr_AddrFieldTyp_39"* null }
...
"$have_gas_80":                                   ; preds = %"$out_of_gas_79", %"$have_gas_75"
  ...
  store %TName_List_String* %"$adtptr_84", %TName_List_String** %"$stored_strings_1", align 8
  ...
  call void @_update_field(i8* %"$execptr_load_85", i8* getelementptr inbounds ([15 x i8], [15 x i8]* @"$stored_strings_86", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_ADT_List_String_37", i32 0, i8* null, i8* %"$update_value_88")
  ret void
}
...
define internal void @"$Reset_89"(%Uint128 %_amount, [20 x i8]* %"$_origin_90", [20 x i8]* %"$_sender_91") {
entry:
...
"$have_gas_100":                                  ; preds = %"$out_of_gas_99", %"$have_gas_95"
  ...
  store %TName_List_String* %"$adtptr_104", %TName_List_String** %new_strings, align 8
...
"$have_gas_111":                                  ; preds = %"$out_of_gas_110", %"$have_gas_100"
  ...
  call void @_update_field(i8* %"$execptr_load_113", i8* getelementptr inbounds ([15 x i8], [15 x i8]* @"$stored_strings_114", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_ADT_List_String_37", i32 0, i8* null, i8* %"$update_value_116")
  ret void
}
...
entry:
  ...
  call void @"$Reset_89"(%Uint128 %_amount, [20 x i8]* %"$_origin_121", [20 x i8]* %"$_sender_123")
  ret void
}

define internal void @"$StoreString_124"(%Uint128 %_amount, [20 x i8]* %"$_origin_125", [20 x i8]* %"$_sender_126", %String %s) {
entry:
  ...
  %"$old_strings_call_129" = call i8* @_fetch_field(i8* %"$execptr_load_128", i8* getelementptr inbounds ([15 x i8], [15 x i8]* @"$stored_strings_127", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_ADT_List_String_37", i32 0, i8* null, i32 1)
...
"$have_gas_148":                                  ; preds = %"$out_of_gas_147", %"$have_gas_143"
  ...
  store %TName_List_String* %"$adtptr_155", %TName_List_String** %new_strings, align 8
...
"$have_gas_162":                                  ; preds = %"$out_of_gas_161", %"$have_gas_148"
  ...
  call void @_update_field(i8* %"$execptr_load_164", i8* getelementptr inbounds ([15 x i8], [15 x i8]* @"$stored_strings_165", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_ADT_List_String_37", i32 0, i8* null, i8* %"$update_value_167")
  ret void
}
...
entry:
  ...
  call void @"$StoreString_124"(%Uint128 %_amount, [20 x i8]* %"$_origin_172", [20 x i8]* %"$_sender_174", %String %s)
  ret void
}

define internal void @"$Accept_177"(%Uint128 %_amount, [20 x i8]* %"$_origin_178", [20 x i8]* %"$_sender_179") {
entry:
...
entry:
  ...
  call void @"$Accept_177"(%Uint128 %_amount, [20 x i8]* %"$_origin_190", [20 x i8]* %"$_sender_192")
  ret void
}

define internal void @"$AcceptTwice_193"(%Uint128 %_amount, [20 x i8]* %"$_origin_194", [20 x i8]* %"$_sender_195") {
entry:
...
"$have_gas_199":                                  ; preds = %"$out_of_gas_198", %entry
  ...
  call void @_accept(i8* %"$execptr_load_201")
...
entry:
  ...
  call void @"$AcceptTwice_193"(%Uint128 %_amount, [20 x i8]* %"$_origin_212", [20 x i8]* %"$_sender_214")
  ret void
}

define internal void @"$NonAccept_215"(%Uint128 %_amount, [20 x i8]* %"$_origin_216", [20 x i8]* %"$_sender_217") {
entry:
...
entry:
  ...
  call void @"$NonAccept_215"(%Uint128 %_amount, [20 x i8]* %"$_origin_222", [20 x i8]* %"$_sender_224")
  ret void
}

define internal void @"$CheckBalance_225"(%Uint128 %_amount, [20 x i8]* %"$_origin_226", [20 x i8]* %"$_sender_227", %Uint128 %expected_balance) {
entry:
  ...
  %"$cur_balance_call_230" = call i8* @_fetch_field(i8* %"$execptr_load_229", i8* getelementptr inbounds ([9 x i8], [9 x i8]* @"$_balance_228", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Uint128_14", i32 0, i8* null, i32 1)
...
"$have_gas_252":                                  ; preds = %"$out_of_gas_251", %"$have_gas_246"
  ...
  %"$eq_call_256" = call %TName_Bool* @_eq_Uint128(i8* %"$execptr_load_254", %Uint128 %expected_balance, %Uint128 %"$cur_balance_255")
  store %TName_Bool* %"$eq_call_256", %TName_Bool** %is_expected, align 8
...
"$have_gas_280":                                  ; preds = %"$out_of_gas_279", %"$have_gas_275"
  ...
  store i8* %"$msgobj_282", i8** %e, align 8
...
"$have_gas_313":                                  ; preds = %"$out_of_gas_312", %"$have_gas_280"
  ...
  call void @_throw(i8* %"$execptr_load_315", %_TyDescrTy_Typ* @"$TyDescr_Exception_28", i8* %"$e_316")
  br label %"$matchsucc_263"
...
define internal void @"$CheckSenderBalance_317"(%Uint128 %_amount, [20 x i8]* %"$_origin_318", [20 x i8]* %"$_sender_319", %Uint128 %expected_balance) {
entry:
  ...
  %"$cur_balance_call_323" = call i8* @_fetch_remote_field(i8* %"$execptr_load_321", [20 x i8]* %"$cur_balance__sender_322", i8* getelementptr inbounds ([9 x i8], [9 x i8]* @"$_balance_320", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Uint128_14", i32 0, i8* null, i32 1)
...
"$have_gas_345":                                  ; preds = %"$out_of_gas_344", %"$have_gas_339"
  ...
  %"$eq_call_349" = call %TName_Bool* @_eq_Uint128(i8* %"$execptr_load_347", %Uint128 %expected_balance, %Uint128 %"$cur_balance_348")
  store %TName_Bool* %"$eq_call_349", %TName_Bool** %is_expected, align 8
...
"$have_gas_373":                                  ; preds = %"$out_of_gas_372", %"$have_gas_368"
  ...
  store i8* %"$msgobj_375", i8** %e, align 8
...
"$have_gas_406":                                  ; preds = %"$out_of_gas_405", %"$have_gas_373"
  ...
  call void @_throw(i8* %"$execptr_load_408", %_TyDescrTy_Typ* @"$TyDescr_Exception_28", i8* %"$e_409")
  br label %"$matchsucc_356"
...
define internal void @"$AcceptAndCheckBalance_410"(%Uint128 %_amount, [20 x i8]* %"$_origin_411", [20 x i8]* %"$_sender_412") {
entry:
  ...
  %"$init_bal_call_415" = call i8* @_fetch_field(i8* %"$execptr_load_414", i8* getelementptr inbounds ([9 x i8], [9 x i8]* @"$_balance_413", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Uint128_14", i32 0, i8* null, i32 1)
...
"$have_gas_431":                                  ; preds = %"$out_of_gas_430", %"$have_gas_426"
  ...
  call void @_accept(i8* %"$execptr_load_433")
...
"$have_gas_443":                                  ; preds = %"$out_of_gas_442", %"$have_gas_437"
  ...
  %"$add_call_446" = call %Uint128 @_add_Uint128(%Uint128 %"$init_bal_445", %Uint128 %_amount)
  store %Uint128 %"$add_call_446", %Uint128* %expected_balance, align 8
...
"$have_gas_450":                                  ; preds = %"$out_of_gas_449", %"$have_gas_443"
  ...
  call void @"$CheckBalance_225"(%Uint128 %_amount, [20 x i8]* %"$CheckBalance__origin_452", [20 x i8]* %"$CheckBalance__sender_453", %Uint128 %"$expected_balance_454")
  ret void
}
...
entry:
  ...
  call void @"$AcceptAndCheckBalance_410"(%Uint128 %_amount, [20 x i8]* %"$_origin_459", [20 x i8]* %"$_sender_461")
  ret void
}

define internal void @"$AcceptTwiceAndCheckBalance_462"(%Uint128 %_amount, [20 x i8]* %"$_origin_463", [20 x i8]* %"$_sender_464") {
entry:
  ...
  %"$init_bal_call_467" = call i8* @_fetch_field(i8* %"$execptr_load_466", i8* getelementptr inbounds ([9 x i8], [9 x i8]* @"$_balance_465", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Uint128_14", i32 0, i8* null, i32 1)
...
"$have_gas_483":                                  ; preds = %"$out_of_gas_482", %"$have_gas_478"
  ...
  call void @_accept(i8* %"$execptr_load_485")
...
"$have_gas_495":                                  ; preds = %"$out_of_gas_494", %"$have_gas_489"
  ...
  %"$add_call_498" = call %Uint128 @_add_Uint128(%Uint128 %"$init_bal_497", %Uint128 %_amount)
  store %Uint128 %"$add_call_498", %Uint128* %expected_balance, align 8
...
"$have_gas_502":                                  ; preds = %"$out_of_gas_501", %"$have_gas_495"
  ...
  call void @"$CheckBalance_225"(%Uint128 %_amount, [20 x i8]* %"$CheckBalance__origin_504", [20 x i8]* %"$CheckBalance__sender_505", %Uint128 %"$expected_balance_506")
...
"$have_gas_510":                                  ; preds = %"$out_of_gas_509", %"$have_gas_502"
  ...
  call void @_accept(i8* %"$execptr_load_512")
...
"$have_gas_516":                                  ; preds = %"$out_of_gas_515", %"$have_gas_510"
  ...
  call void @"$CheckBalance_225"(%Uint128 %_amount, [20 x i8]* %"$CheckBalance__origin_518", [20 x i8]* %"$CheckBalance__sender_519", %Uint128 %"$expected_balance_520")
  ret void
}
...
entry:
  ...
  call void @"$AcceptTwiceAndCheckBalance_462"(%Uint128 %_amount, [20 x i8]* %"$_origin_525", [20 x i8]* %"$_sender_527")
  ret void
}

define internal void @"$AcceptAndCheckSenderBalance_528"(%Uint128 %_amount, [20 x i8]* %"$_origin_529", [20 x i8]* %"$_sender_530") {
entry:
  ...
  %"$init_bal_call_534" = call i8* @_fetch_remote_field(i8* %"$execptr_load_532", [20 x i8]* %"$init_bal__sender_533", i8* getelementptr inbounds ([9 x i8], [9 x i8]* @"$_balance_531", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Uint128_14", i32 0, i8* null, i32 1)
...
"$have_gas_550":                                  ; preds = %"$out_of_gas_549", %"$have_gas_545"
  ...
  call void @_accept(i8* %"$execptr_load_552")
...
"$have_gas_556":                                  ; preds = %"$out_of_gas_555", %"$have_gas_550"
  ...
  call void @"$CheckSenderBalance_317"(%Uint128 %_amount, [20 x i8]* %"$CheckSenderBalance__origin_558", [20 x i8]* %"$CheckSenderBalance__sender_559", %Uint128 %"$init_bal_560")
  ret void
}
...
entry:
  ...
  call void @"$AcceptAndCheckSenderBalance_528"(%Uint128 %_amount, [20 x i8]* %"$_origin_565", [20 x i8]* %"$_sender_567")
  ret void
}
