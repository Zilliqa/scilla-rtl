...
"$have_gas_69":                                   ; preds = %"$out_of_gas_68", %entry
  ...
  store %TName_List_String* %"$adtptr_73", %TName_List_String** %"$stored_strings_0", align 8
  ...
  call void @_update_field(i8* %"$execptr_load_74", i8* getelementptr inbounds ([15 x i8], [15 x i8]* @"$stored_strings_75", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_ADT_List_String_36", i32 0, i8* null, i8* %"$update_value_77")
  ret void
}
...
define internal void @"$Reset_78"(%Uint128 %_amount, [20 x i8]* %"$_origin_79", [20 x i8]* %"$_sender_80") {
entry:
...
"$have_gas_89":                                   ; preds = %"$out_of_gas_88", %"$have_gas_84"
  ...
  store %TName_List_String* %"$adtptr_93", %TName_List_String** %new_strings, align 8
...
"$have_gas_100":                                  ; preds = %"$out_of_gas_99", %"$have_gas_89"
  ...
  call void @_update_field(i8* %"$execptr_load_102", i8* getelementptr inbounds ([15 x i8], [15 x i8]* @"$stored_strings_103", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_ADT_List_String_36", i32 0, i8* null, i8* %"$update_value_105")
  ret void
}
...
entry:
  ...
  call void @"$Reset_78"(%Uint128 %_amount, [20 x i8]* %"$_origin_110", [20 x i8]* %"$_sender_112")
  ret void
}

define internal void @"$StoreString_113"(%Uint128 %_amount, [20 x i8]* %"$_origin_114", [20 x i8]* %"$_sender_115", %String %s) {
entry:
  ...
  %"$old_strings_call_118" = call i8* @_fetch_field(i8* %"$execptr_load_117", i8* getelementptr inbounds ([15 x i8], [15 x i8]* @"$stored_strings_116", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_ADT_List_String_36", i32 0, i8* null, i32 1)
...
"$have_gas_137":                                  ; preds = %"$out_of_gas_136", %"$have_gas_132"
  ...
  store %TName_List_String* %"$adtptr_144", %TName_List_String** %new_strings, align 8
...
"$have_gas_151":                                  ; preds = %"$out_of_gas_150", %"$have_gas_137"
  ...
  call void @_update_field(i8* %"$execptr_load_153", i8* getelementptr inbounds ([15 x i8], [15 x i8]* @"$stored_strings_154", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_ADT_List_String_36", i32 0, i8* null, i8* %"$update_value_156")
  ret void
}
...
entry:
  ...
  call void @"$StoreString_113"(%Uint128 %_amount, [20 x i8]* %"$_origin_161", [20 x i8]* %"$_sender_163", %String %s)
  ret void
}

define internal void @"$Accept_166"(%Uint128 %_amount, [20 x i8]* %"$_origin_167", [20 x i8]* %"$_sender_168") {
entry:
...
"$have_gas_172":                                  ; preds = %"$out_of_gas_171", %entry
  ...
  call void @_accept(i8* %"$execptr_load_174")
  ret void
}
...
entry:
  ...
  call void @"$Accept_166"(%Uint128 %_amount, [20 x i8]* %"$_origin_179", [20 x i8]* %"$_sender_181")
  ret void
}

define internal void @"$AcceptTwice_182"(%Uint128 %_amount, [20 x i8]* %"$_origin_183", [20 x i8]* %"$_sender_184") {
entry:
...
"$have_gas_188":                                  ; preds = %"$out_of_gas_187", %entry
  ...
  call void @_accept(i8* %"$execptr_load_190")
...
entry:
  ...
  call void @"$AcceptTwice_182"(%Uint128 %_amount, [20 x i8]* %"$_origin_201", [20 x i8]* %"$_sender_203")
  ret void
}

define internal void @"$NonAccept_204"(%Uint128 %_amount, [20 x i8]* %"$_origin_205", [20 x i8]* %"$_sender_206") {
entry:
...
entry:
  ...
  call void @"$NonAccept_204"(%Uint128 %_amount, [20 x i8]* %"$_origin_211", [20 x i8]* %"$_sender_213")
  ret void
}

define internal void @"$CheckBalance_214"(%Uint128 %_amount, [20 x i8]* %"$_origin_215", [20 x i8]* %"$_sender_216", %Uint128 %expected_balance) {
entry:
  ...
  %"$cur_balance_call_219" = call i8* @_fetch_field(i8* %"$execptr_load_218", i8* getelementptr inbounds ([9 x i8], [9 x i8]* @"$_balance_217", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Uint128_13", i32 0, i8* null, i32 1)
...
"$have_gas_241":                                  ; preds = %"$out_of_gas_240", %"$have_gas_235"
  ...
  %"$eq_call_245" = call %TName_Bool* @_eq_Uint128(i8* %"$execptr_load_243", %Uint128 %expected_balance, %Uint128 %"$cur_balance_244")
  store %TName_Bool* %"$eq_call_245", %TName_Bool** %is_expected, align 8
...
"$have_gas_269":                                  ; preds = %"$out_of_gas_268", %"$have_gas_264"
  ...
  store i8* %"$msgobj_271", i8** %e, align 8
...
"$have_gas_302":                                  ; preds = %"$out_of_gas_301", %"$have_gas_269"
  ...
  call void @_throw(i8* %"$execptr_load_304", %_TyDescrTy_Typ* @"$TyDescr_Exception_27", i8* %"$e_305")
  br label %"$matchsucc_252"
...
define internal void @"$CheckSenderBalance_306"(%Uint128 %_amount, [20 x i8]* %"$_origin_307", [20 x i8]* %"$_sender_308", %Uint128 %expected_balance) {
entry:
  ...
  %"$cur_balance_call_312" = call i8* @_fetch_remote_field(i8* %"$execptr_load_310", [20 x i8]* %"$cur_balance__sender_311", i8* getelementptr inbounds ([9 x i8], [9 x i8]* @"$_balance_309", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Uint128_13", i32 0, i8* null, i32 1)
...
"$have_gas_334":                                  ; preds = %"$out_of_gas_333", %"$have_gas_328"
  ...
  %"$eq_call_338" = call %TName_Bool* @_eq_Uint128(i8* %"$execptr_load_336", %Uint128 %expected_balance, %Uint128 %"$cur_balance_337")
  store %TName_Bool* %"$eq_call_338", %TName_Bool** %is_expected, align 8
...
"$have_gas_362":                                  ; preds = %"$out_of_gas_361", %"$have_gas_357"
  ...
  store i8* %"$msgobj_364", i8** %e, align 8
...
"$have_gas_395":                                  ; preds = %"$out_of_gas_394", %"$have_gas_362"
  ...
  call void @_throw(i8* %"$execptr_load_397", %_TyDescrTy_Typ* @"$TyDescr_Exception_27", i8* %"$e_398")
  br label %"$matchsucc_345"
...
define internal void @"$AcceptAndCheckBalance_399"(%Uint128 %_amount, [20 x i8]* %"$_origin_400", [20 x i8]* %"$_sender_401") {
entry:
  ...
  %"$init_bal_call_404" = call i8* @_fetch_field(i8* %"$execptr_load_403", i8* getelementptr inbounds ([9 x i8], [9 x i8]* @"$_balance_402", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Uint128_13", i32 0, i8* null, i32 1)
...
"$have_gas_420":                                  ; preds = %"$out_of_gas_419", %"$have_gas_415"
  ...
  call void @_accept(i8* %"$execptr_load_422")
...
"$have_gas_432":                                  ; preds = %"$out_of_gas_431", %"$have_gas_426"
  ...
  %"$add_call_435" = call %Uint128 @_add_Uint128(%Uint128 %"$init_bal_434", %Uint128 %_amount)
  store %Uint128 %"$add_call_435", %Uint128* %expected_balance, align 8
...
"$have_gas_439":                                  ; preds = %"$out_of_gas_438", %"$have_gas_432"
  ...
  call void @"$CheckBalance_214"(%Uint128 %_amount, [20 x i8]* %"$CheckBalance__origin_441", [20 x i8]* %"$CheckBalance__sender_442", %Uint128 %"$expected_balance_443")
  ret void
}
...
entry:
  ...
  call void @"$AcceptAndCheckBalance_399"(%Uint128 %_amount, [20 x i8]* %"$_origin_448", [20 x i8]* %"$_sender_450")
  ret void
}

define internal void @"$AcceptTwiceAndCheckBalance_451"(%Uint128 %_amount, [20 x i8]* %"$_origin_452", [20 x i8]* %"$_sender_453") {
entry:
  ...
  %"$init_bal_call_456" = call i8* @_fetch_field(i8* %"$execptr_load_455", i8* getelementptr inbounds ([9 x i8], [9 x i8]* @"$_balance_454", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Uint128_13", i32 0, i8* null, i32 1)
...
"$have_gas_472":                                  ; preds = %"$out_of_gas_471", %"$have_gas_467"
  ...
  call void @_accept(i8* %"$execptr_load_474")
...
"$have_gas_484":                                  ; preds = %"$out_of_gas_483", %"$have_gas_478"
  ...
  %"$add_call_487" = call %Uint128 @_add_Uint128(%Uint128 %"$init_bal_486", %Uint128 %_amount)
  store %Uint128 %"$add_call_487", %Uint128* %expected_balance, align 8
...
"$have_gas_491":                                  ; preds = %"$out_of_gas_490", %"$have_gas_484"
  ...
  call void @"$CheckBalance_214"(%Uint128 %_amount, [20 x i8]* %"$CheckBalance__origin_493", [20 x i8]* %"$CheckBalance__sender_494", %Uint128 %"$expected_balance_495")
...
"$have_gas_499":                                  ; preds = %"$out_of_gas_498", %"$have_gas_491"
  ...
  call void @_accept(i8* %"$execptr_load_501")
...
"$have_gas_505":                                  ; preds = %"$out_of_gas_504", %"$have_gas_499"
  ...
  call void @"$CheckBalance_214"(%Uint128 %_amount, [20 x i8]* %"$CheckBalance__origin_507", [20 x i8]* %"$CheckBalance__sender_508", %Uint128 %"$expected_balance_509")
  ret void
}
...
entry:
  ...
  call void @"$AcceptTwiceAndCheckBalance_451"(%Uint128 %_amount, [20 x i8]* %"$_origin_514", [20 x i8]* %"$_sender_516")
  ret void
}

define internal void @"$AcceptAndCheckSenderBalance_517"(%Uint128 %_amount, [20 x i8]* %"$_origin_518", [20 x i8]* %"$_sender_519") {
entry:
  ...
  %"$init_bal_call_523" = call i8* @_fetch_remote_field(i8* %"$execptr_load_521", [20 x i8]* %"$init_bal__sender_522", i8* getelementptr inbounds ([9 x i8], [9 x i8]* @"$_balance_520", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Uint128_13", i32 0, i8* null, i32 1)
...
"$have_gas_539":                                  ; preds = %"$out_of_gas_538", %"$have_gas_534"
  ...
  call void @_accept(i8* %"$execptr_load_541")
...
"$have_gas_545":                                  ; preds = %"$out_of_gas_544", %"$have_gas_539"
  ...
  call void @"$CheckSenderBalance_306"(%Uint128 %_amount, [20 x i8]* %"$CheckSenderBalance__origin_547", [20 x i8]* %"$CheckSenderBalance__sender_548", %Uint128 %"$init_bal_549")
  ret void
}
...
entry:
  ...
  call void @"$AcceptAndCheckSenderBalance_517"(%Uint128 %_amount, [20 x i8]* %"$_origin_554", [20 x i8]* %"$_sender_556")
  ret void
}
