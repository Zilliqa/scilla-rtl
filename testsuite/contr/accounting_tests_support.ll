...
"$have_gas_235":                                  ; preds = %"$out_of_gas_234", %"$have_gas_230"
  ...
  %"$eq_call_239" = call %TName_Bool* @_eq_Uint128(i8* %"$execptr_load_237", %Uint128 %expected_balance, %Uint128 %"$cur_balance_238")
  store %TName_Bool* %"$eq_call_239", %TName_Bool** %is_expected, align 8
...
"$have_gas_296":                                  ; preds = %"$out_of_gas_295", %"$have_gas_263"
  ...
  call void @_throw(i8* %"$execptr_load_298", %_TyDescrTy_Typ* @"$TyDescr_Exception_27", i8* %"$e_299")
  br label %"$matchsucc_246"
...
define internal void @"$CheckSenderBalance_300"(%Uint128 %_amount, [20 x i8]* %"$_origin_301", [20 x i8]* %"$_sender_302", %Uint128 %expected_balance) {
entry:
  ...
  %"$cur_balance_call_306" = call i8* @_fetch_remote_field(i8* %"$execptr_load_304", [20 x i8]* %"$cur_balance__sender_305", i8* getelementptr inbounds ([9 x i8], [9 x i8]* @"$_balance_303", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Uint128_13", i32 0, i8* null, i32 1)
...
"$have_gas_322":                                  ; preds = %"$out_of_gas_321", %"$have_gas_317"
  ...
  %"$eq_call_326" = call %TName_Bool* @_eq_Uint128(i8* %"$execptr_load_324", %Uint128 %expected_balance, %Uint128 %"$cur_balance_325")
  store %TName_Bool* %"$eq_call_326", %TName_Bool** %is_expected, align 8
...
"$have_gas_350":                                  ; preds = %"$out_of_gas_349", %"$have_gas_345"
  ...
  store i8* %"$msgobj_352", i8** %e, align 8
...
"$have_gas_383":                                  ; preds = %"$out_of_gas_382", %"$have_gas_350"
  ...
  call void @_throw(i8* %"$execptr_load_385", %_TyDescrTy_Typ* @"$TyDescr_Exception_27", i8* %"$e_386")
  br label %"$matchsucc_333"
...
define internal void @"$AcceptAndCheckBalance_387"(%Uint128 %_amount, [20 x i8]* %"$_origin_388", [20 x i8]* %"$_sender_389") {
entry:
  ...
  %"$init_bal_call_392" = call i8* @_fetch_field(i8* %"$execptr_load_391", i8* getelementptr inbounds ([9 x i8], [9 x i8]* @"$_balance_390", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Uint128_13", i32 0, i8* null, i32 1)
...
"$have_gas_408":                                  ; preds = %"$out_of_gas_407", %"$have_gas_403"
  ...
  call void @_accept(i8* %"$execptr_load_410")
...
"$have_gas_414":                                  ; preds = %"$out_of_gas_413", %"$have_gas_408"
  ...
  %"$add_call_417" = call %Uint128 @_add_Uint128(%Uint128 %"$init_bal_416", %Uint128 %_amount)
  store %Uint128 %"$add_call_417", %Uint128* %expected_balance, align 8
...
"$have_gas_421":                                  ; preds = %"$out_of_gas_420", %"$have_gas_414"
  ...
  call void @"$CheckBalance_214"(%Uint128 %_amount, [20 x i8]* %"$CheckBalance__origin_423", [20 x i8]* %"$CheckBalance__sender_424", %Uint128 %"$expected_balance_425")
  ret void
}
...
entry:
  ...
  call void @"$AcceptAndCheckBalance_387"(%Uint128 %_amount, [20 x i8]* %"$_origin_430", [20 x i8]* %"$_sender_432")
  ret void
}

define internal void @"$AcceptTwiceAndCheckBalance_433"(%Uint128 %_amount, [20 x i8]* %"$_origin_434", [20 x i8]* %"$_sender_435") {
entry:
  ...
  %"$init_bal_call_438" = call i8* @_fetch_field(i8* %"$execptr_load_437", i8* getelementptr inbounds ([9 x i8], [9 x i8]* @"$_balance_436", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Uint128_13", i32 0, i8* null, i32 1)
...
"$have_gas_454":                                  ; preds = %"$out_of_gas_453", %"$have_gas_449"
  ...
  call void @_accept(i8* %"$execptr_load_456")
...
"$have_gas_460":                                  ; preds = %"$out_of_gas_459", %"$have_gas_454"
  ...
  %"$add_call_463" = call %Uint128 @_add_Uint128(%Uint128 %"$init_bal_462", %Uint128 %_amount)
  store %Uint128 %"$add_call_463", %Uint128* %expected_balance, align 8
...
"$have_gas_467":                                  ; preds = %"$out_of_gas_466", %"$have_gas_460"
  ...
  call void @"$CheckBalance_214"(%Uint128 %_amount, [20 x i8]* %"$CheckBalance__origin_469", [20 x i8]* %"$CheckBalance__sender_470", %Uint128 %"$expected_balance_471")
...
"$have_gas_475":                                  ; preds = %"$out_of_gas_474", %"$have_gas_467"
  ...
  call void @_accept(i8* %"$execptr_load_477")
...
"$have_gas_481":                                  ; preds = %"$out_of_gas_480", %"$have_gas_475"
  ...
  call void @"$CheckBalance_214"(%Uint128 %_amount, [20 x i8]* %"$CheckBalance__origin_483", [20 x i8]* %"$CheckBalance__sender_484", %Uint128 %"$expected_balance_485")
  ret void
}
...
entry:
  ...
  call void @"$AcceptTwiceAndCheckBalance_433"(%Uint128 %_amount, [20 x i8]* %"$_origin_490", [20 x i8]* %"$_sender_492")
  ret void
}

define internal void @"$AcceptAndCheckSenderBalance_493"(%Uint128 %_amount, [20 x i8]* %"$_origin_494", [20 x i8]* %"$_sender_495") {
entry:
  ...
  %"$init_bal_call_499" = call i8* @_fetch_remote_field(i8* %"$execptr_load_497", [20 x i8]* %"$init_bal__sender_498", i8* getelementptr inbounds ([9 x i8], [9 x i8]* @"$_balance_496", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Uint128_13", i32 0, i8* null, i32 1)
...
"$have_gas_515":                                  ; preds = %"$out_of_gas_514", %"$have_gas_510"
  ...
  call void @_accept(i8* %"$execptr_load_517")
...
"$have_gas_521":                                  ; preds = %"$out_of_gas_520", %"$have_gas_515"
  ...
  call void @"$CheckSenderBalance_300"(%Uint128 %_amount, [20 x i8]* %"$CheckSenderBalance__origin_523", [20 x i8]* %"$CheckSenderBalance__sender_524", %Uint128 %"$init_bal_525")
  ret void
}
...
entry:
  ...
  call void @"$AcceptAndCheckSenderBalance_493"(%Uint128 %_amount, [20 x i8]* %"$_origin_530", [20 x i8]* %"$_sender_532")
  ret void
}
