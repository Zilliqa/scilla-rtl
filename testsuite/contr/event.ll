...
"$have_gas_84":                                   ; preds = %"$out_of_gas_83", %"$have_gas_50"
  ...
  call void @_event(i8* %"$execptr_load_86", %_TyDescrTy_Typ* @"$TyDescr_Event_24", i8* %"$e_87")
  ret void
}
...
entry:
  ...
  call void @"$EventCreate_39"(%Uint128 %_amount, [20 x i8]* %"$_origin_92", [20 x i8]* %"$_sender_94")
  ret void
}
