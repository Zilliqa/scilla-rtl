...
"$have_gas_132":                                  ; preds = %"$out_of_gas_131", %"$False_127"
  ...
  call void @"$create_event_63"(%Uint128 %_amount, [20 x i8]* %"$create_event__origin_134", [20 x i8]* %"$create_event__sender_135", %Int32 %"$x_136"), !dbg !17
  br label %"$matchsucc_121"
...
entry:
  ...
  call void @"$t1_103"(%Uint128 %_amount, [20 x i8]* %"$_origin_141", [20 x i8]* %"$_sender_143", %TName_Bool* %c), !dbg !21
  ret void
}
