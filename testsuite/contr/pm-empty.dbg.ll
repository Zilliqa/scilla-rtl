...
"$have_gas_127":                                  ; preds = %"$out_of_gas_126", %"$False_122"
  ...
  call void @"$create_event_58"(%Uint128 %_amount, [20 x i8]* %"$create_event__origin_129", [20 x i8]* %"$create_event__sender_130", %Int32 %"$x_131"), !dbg !17
  br label %"$matchsucc_116"
...
entry:
  ...
  call void @"$t1_98"(%Uint128 %_amount, [20 x i8]* %"$_origin_136", [20 x i8]* %"$_sender_138", %TName_Bool* %c), !dbg !21
  ret void
}
