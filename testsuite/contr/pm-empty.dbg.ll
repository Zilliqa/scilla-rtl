...
"$have_gas_119":                                  ; preds = %"$out_of_gas_118", %"$False_114"
  ...
  call void @"$create_event_52"(%Uint128 %_amount, [20 x i8]* %"$create_event__sender_121", %Int32 %"$x_122"), !dbg !16
  br label %"$matchsucc_108"
...
entry:
  ...
  call void @"$t1_91"(%Uint128 %_amount, [20 x i8]* %"$_sender_127", %TName_Bool* %c), !dbg !20
  ret void
}
