...
"$have_gas_134":                                  ; preds = %"$out_of_gas_133", %"$False_129"
  ...
  call void @"$create_event_65"(%Uint128 %_amount, [20 x i8]* %"$create_event__origin_136", [20 x i8]* %"$create_event__sender_137", %Int32 %"$x_138"), !dbg !17
  br label %"$matchsucc_123"
...
entry:
  ...
  call void @"$t1_105"(%Uint128 %_amount, [20 x i8]* %"$_origin_143", [20 x i8]* %"$_sender_145", %TName_Bool* %c), !dbg !21
  ret void
}
...
!17 = !DILocation(line: 14, column: 14, scope: !18)
!18 = distinct !DILexicalBlock(scope: !19, file: !2, line: 14, column: 5)
!19 = distinct !DILexicalBlock(scope: !14, file: !2, line: 12, column: 3)
