...
"$have_gas_134":                                  ; preds = %"$out_of_gas_133", %"$False_129"
  ...
  call void @"$create_event_65"(%Uint128 %_amount, [20 x i8]* %"$create_event__origin_136", [20 x i8]* %"$create_event__sender_137", %Int32 %"$x_138"), !dbg !24
  br label %"$matchsucc_123"
...
entry:
  ...
  call void @"$t1_105"(%Uint128 %_amount, [20 x i8]* %"$_origin_143", [20 x i8]* %"$_sender_145", %TName_Bool* %c), !dbg !28
  ret void
}
...
!19 = !DILocalVariable(name: "x", scope: !18, file: !2, line: 11, type: !20)
!20 = !DIBasicType(name: "Int32", size: 4)
!21 = !DILocation(line: 11, column: 3, scope: !18)
!22 = !DILocation(line: 11, column: 7, scope: !18)
!23 = !DILocation(line: 12, column: 3, scope: !18)
!24 = !DILocation(line: 14, column: 14, scope: !25)
!25 = distinct !DILexicalBlock(scope: !26, file: !2, line: 14, column: 5)
!26 = distinct !DILexicalBlock(scope: !18, file: !2, line: 12, column: 3)
