...
define internal void @"$EventTimestamp_64"(%Uint128 %_amount, [20 x i8]* %"$_origin_65", [20 x i8]* %"$_sender_66") !dbg !11 {
entry:
...
"$have_gas_75":                                   ; preds = %"$out_of_gas_74", %"$have_gas_70"
  ...
  store i8* %"$_new_bnum_call_79", i8** %bnum, align 8, !dbg !12
...
"$have_gas_84":                                   ; preds = %"$out_of_gas_83", %"$have_gas_75"
  ...
  %"$to_string_call_89" = call %String @_to_string(i8* %"$execptr_load_86", %_TyDescrTy_Typ* @"$TyDescr_Bnum_22", i8* %"$bnum_87"), !dbg !13
  store %String %"$to_string_call_89", %String* %"$bnum_1", align 8, !dbg !13
  %"$execptr_load_91" = load i8*, i8** @_execptr, align 8
  %"$$bnum_1_92" = load %String, %String* %"$bnum_1", align 8
  %"$ts_call_93" = call i8* @_read_blockchain(i8* %"$execptr_load_91", %BCQuery { i8* getelementptr inbounds ([9 x i8], [9 x i8]* @"$fetchbc_query_name_90", i32 0, i32 0), i32 9 }, %String %"$$bnum_1_92"), !dbg !13
...
"$have_gas_103":                                  ; preds = %"$out_of_gas_102", %"$have_gas_98"
  ...
  store i8* %"$msgobj_105", i8** %e, align 8, !dbg !14
...
"$have_gas_129":                                  ; preds = %"$out_of_gas_128", %"$have_gas_103"
  ...
  call void @_event(i8* %"$execptr_load_131", %_TyDescrTy_Typ* @"$TyDescr_Event_26", i8* %"$e_132"), !dbg !15
  ret void
}
...
entry:
  ...
  call void @"$EventTimestamp_64"(%Uint128 %_amount, [20 x i8]* %"$_origin_137", [20 x i8]* %"$_sender_139"), !dbg !17
  ret void
}
