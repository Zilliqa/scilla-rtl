...
"$have_gas_87":                                   ; preds = %"$out_of_gas_86", %"$have_gas_82"
  ...
  call void @_update_field(i8* %"$execptr_load_89", i8* getelementptr inbounds ([2 x i8], [2 x i8]* @"$x_90", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Int32_9", i32 0, i8* null, i8* %"$update_value_93")
  ret void
}

declare void @_update_field(i8*, i8*, %_TyDescrTy_Typ*, i32, i8*, i8*)

define internal void @"$create_event_94"(%Uint128 %_amount, [20 x i8]* %"$_origin_95", [20 x i8]* %"$_sender_96", %Int32 %m) {
entry:
...
"$have_gas_130":                                  ; preds = %"$out_of_gas_129", %"$have_gas_105"
  ...
  call void @_event(i8* %"$execptr_load_132", %_TyDescrTy_Typ* @"$TyDescr_Event_31", i8* %"$e_133")
  ret void
}
...
define internal void @"$t1_134"(%Uint128 %_amount, [20 x i8]* %"$_origin_135", [20 x i8]* %"$_sender_136", %TName_Bool* %c) {
entry:
  ...
  %"$$x_1_call_139" = call i8* @_fetch_field(i8* %"$execptr_load_138", i8* getelementptr inbounds ([2 x i8], [2 x i8]* @"$x_137", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Int32_9", i32 0, i8* null, i32 1)
...
"$have_gas_160":                                  ; preds = %"$out_of_gas_159", %"$have_gas_155"
  ...
  store %TName_List_Int32* %"$adtptr_164", %TName_List_Int32** %"$x_2", align 8
...
"$have_gas_189":                                  ; preds = %"$out_of_gas_188", %"$Cons_180"
  ...
  store %Int32 %"$$x_3_191", %Int32* %"$x_4", align 4
...
"$have_gas_202":                                  ; preds = %"$out_of_gas_201", %"$matchsucc_175"
  ...
  call void @"$create_event_94"(%Uint128 %_amount, [20 x i8]* %"$create_event__origin_204", [20 x i8]* %"$create_event__sender_205", %Int32 %"$$x_4_206")
  ret void
}
...
entry:
  ...
  call void @"$t1_134"(%Uint128 %_amount, [20 x i8]* %"$_origin_211", [20 x i8]* %"$_sender_213", %TName_Bool* %c)
  ret void
}
