...
define internal void @"$Increment_92"(%Uint128 %_amount, [20 x i8]* %"$_sender_93") !dbg !15 {
entry:
  ...
  %"$cur_98" = call i8* @_fetch_field(i8* %"$execptr_load_96", i8* getelementptr inbounds ([13 x i8], [13 x i8]* @"$access_count_97", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_40", i32 1, i8* %"$indices_buf_94", i32 1), !dbg !16
...
"$have_gas_132":                                  ; preds = %"$out_of_gas_131", %"$have_gas_127"
  ...
  %"$simple-map.inc_call_138" = call %Int32 %"$simple-map.inc_fptr_135"(i8* %"$simple-map.inc_envptr_136", %Int32 %"$i_137"), !dbg !18
  store %Int32 %"$simple-map.inc_call_138", %Int32* %"$simple-map.inc_0", align 4, !dbg !18
  %"$$simple-map.inc_0_139" = load %Int32, %Int32* %"$simple-map.inc_0", align 4
  store %Int32 %"$$simple-map.inc_0_139", %Int32* %j, align 4, !dbg !18
...
"$have_gas_148":                                  ; preds = %"$out_of_gas_147", %"$have_gas_132"
  ...
  call void @_update_field(i8* %"$execptr_load_152", i8* getelementptr inbounds ([13 x i8], [13 x i8]* @"$access_count_153", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_40", i32 1, i8* %"$indices_buf_150", i8* %"$update_value_156"), !dbg !21
...
"$have_gas_167":                                  ; preds = %"$out_of_gas_166", %"$None_157"
  ...
  call void @_update_field(i8* %"$execptr_load_171", i8* getelementptr inbounds ([13 x i8], [13 x i8]* @"$access_count_172", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_40", i32 1, i8* %"$indices_buf_169", i8* %"$update_value_175"), !dbg !22
  br label %"$matchsucc_115"
...
entry:
  ...
  call void @"$Increment_92"(%Uint128 %_amount, [20 x i8]* %"$_sender_180"), !dbg !25
  ret void
}

define internal void @"$IncrementN_181"(%Uint128 %_amount, [20 x i8]* %"$_sender_182", %Int32 %n) !dbg !26 {
entry:
  ...
  %"$cur_187" = call i8* @_fetch_field(i8* %"$execptr_load_185", i8* getelementptr inbounds ([13 x i8], [13 x i8]* @"$access_count_186", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_40", i32 1, i8* %"$indices_buf_183", i32 1), !dbg !27
...
"$have_gas_216":                                  ; preds = %"$out_of_gas_215", %"$Some_209"
  ...
  store %Int32 %"$add_call_219", %Int32* %j, align 4, !dbg !29
...
"$have_gas_228":                                  ; preds = %"$out_of_gas_227", %"$have_gas_216"
  ...
  call void @_update_field(i8* %"$execptr_load_232", i8* getelementptr inbounds ([13 x i8], [13 x i8]* @"$access_count_233", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_40", i32 1, i8* %"$indices_buf_230", i8* %"$update_value_236"), !dbg !32
...
"$have_gas_246":                                  ; preds = %"$out_of_gas_245", %"$None_237"
  ...
  call void @_update_field(i8* %"$execptr_load_250", i8* getelementptr inbounds ([13 x i8], [13 x i8]* @"$access_count_251", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_40", i32 1, i8* %"$indices_buf_248", i8* %"$update_value_253"), !dbg !33
  br label %"$matchsucc_204"
...
define internal void @"$IncrementNOpt_254"(%Uint128 %_amount, [20 x i8]* %"$_sender_255", %TName_Option_Int32* %nopt) !dbg !35 {
entry:
...
"$have_gas_272":                                  ; preds = %"$out_of_gas_271", %"$Some_265"
  ...
  call void @"$IncrementN_181"(%Uint128 %_amount, [20 x i8]* %"$IncrementN__sender_274", %Int32 %"$n_275"), !dbg !37
...
entry:
  ...
  call void @"$IncrementNOpt_254"(%Uint128 %_amount, [20 x i8]* %"$_sender_282", %TName_Option_Int32* %nopt), !dbg !41
  ret void
}
