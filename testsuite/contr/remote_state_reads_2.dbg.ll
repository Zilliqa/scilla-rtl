...
"$have_gas_102":                                  ; preds = %"$out_of_gas_101", %"$have_gas_97"
  ...
  call void @_update_field(i8* %"$execptr_load_104", i8* getelementptr inbounds ([30 x i8], [30 x i8]* @"$remote_read_remote_read_res_1_105", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Uint128_17", i32 0, i8* null, i8* %"$update_value_108"), !dbg !11
...
"$have_gas_112":                                  ; preds = %"$out_of_gas_111", %"$have_gas_102"
  ...
  store %TName_Option_Uint128* %"$adtptr_116", %TName_Option_Uint128** %"$remote_read_remote_read_res_2_2", align 8, !dbg !12
  ...
  call void @_update_field(i8* %"$execptr_load_117", i8* getelementptr inbounds ([30 x i8], [30 x i8]* @"$remote_read_remote_read_res_2_118", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_ADT_Option_Uint128_39", i32 0, i8* null, i8* %"$update_value_120"), !dbg !12
...
"$have_gas_124":                                  ; preds = %"$out_of_gas_123", %"$have_gas_112"
  ...
  store [20 x i8] %"$_this_address_126", [20 x i8]* %"$remote_read_remote_read_res_3_3", align 1, !dbg !13
  ...
  call void @_update_field(i8* %"$execptr_load_127", i8* getelementptr inbounds ([30 x i8], [30 x i8]* @"$remote_read_remote_read_res_3_128", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Bystr20_35", i32 0, i8* null, i8* %"$update_value_131"), !dbg !13
...
"$have_gas_135":                                  ; preds = %"$out_of_gas_134", %"$have_gas_124"
  ...
  store %Map_Uint128_ByStr20_with_end* %"$_new_empty_map_139", %Map_Uint128_ByStr20_with_end** %"$address_type_erasure_test_res_1_4", align 8, !dbg !14
  ...
  call void @_update_field(i8* %"$execptr_load_140", i8* getelementptr inbounds ([32 x i8], [32 x i8]* @"$address_type_erasure_test_res_1_141", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_42", i32 0, i8* null, i8* %"$update_value_143"), !dbg !14
  ret void
}
...
define internal void @"$RemoteReadsOfRemoteRead_144"(%Uint128 %_amount, [20 x i8]* %"$_origin_145", [20 x i8]* %"$_sender_146", [20 x i8]* %"$remote_147") !dbg !15 {
entry:
  ...
  %"$ad_call_151" = call i8* @_fetch_remote_field(i8* %"$execptr_load_149", [20 x i8]* %"$ad_remote_150", i8* getelementptr inbounds ([6 x i8], [6 x i8]* @"$admin_148", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Addr_49", i32 0, i8* null, i32 1), !dbg !16
...
"$have_gas_162":                                  ; preds = %"$out_of_gas_161", %entry
  ...
  %"$this_f_call_168" = call i8* @_fetch_remote_field(i8* %"$execptr_load_165", [20 x i8]* %"$this_f_ad_166", i8* getelementptr inbounds ([2 x i8], [2 x i8]* @"$f_164", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Addr_48", i32 0, i8* null, i32 1), !dbg !17
...
"$have_gas_179":                                  ; preds = %"$out_of_gas_178", %"$have_gas_162"
  ...
  %"$this_g_call_185" = call i8* @_fetch_remote_field(i8* %"$execptr_load_182", [20 x i8]* %"$this_g_this_f_183", i8* getelementptr inbounds ([2 x i8], [2 x i8]* @"$g_181", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Uint128_17", i32 0, i8* null, i32 1), !dbg !18
...
"$have_gas_205":                                  ; preds = %"$out_of_gas_204", %"$have_gas_196"
  ...
  call void @_update_field(i8* %"$execptr_load_207", i8* getelementptr inbounds ([30 x i8], [30 x i8]* @"$remote_read_remote_read_res_1_208", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Uint128_17", i32 0, i8* null, i8* %"$update_value_211"), !dbg !19
  ret void
}
...
entry:
  ...
  call void @"$RemoteReadsOfRemoteRead_144"(%Uint128 %_amount, [20 x i8]* %"$_origin_216", [20 x i8]* %"$_sender_218", [20 x i8]* %"$remote_220"), !dbg !21
  ret void
}

define internal void @"$RemoteReadsOfRemoteMap_221"(%Uint128 %_amount, [20 x i8]* %"$_origin_222", [20 x i8]* %"$_sender_223", [20 x i8]* %"$remote_224") !dbg !22 {
entry:
  ...
  %"$ad_call_228" = call i8* @_fetch_remote_field(i8* %"$execptr_load_226", [20 x i8]* %"$ad_remote_227", i8* getelementptr inbounds ([6 x i8], [6 x i8]* @"$admin_225", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Addr_46", i32 0, i8* null, i32 1), !dbg !23
...
"$have_gas_239":                                  ; preds = %"$out_of_gas_238", %entry
  ...
  %"$this_f_call_245" = call i8* @_fetch_remote_field(i8* %"$execptr_load_242", [20 x i8]* %"$this_f_ad_243", i8* getelementptr inbounds ([2 x i8], [2 x i8]* @"$f_241", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Addr_45", i32 0, i8* null, i32 1), !dbg !24
...
"$have_gas_266":                                  ; preds = %"$out_of_gas_265", %"$have_gas_261"
  ...
  %"$this_g_call_275" = call i8* @_fetch_remote_field(i8* %"$execptr_load_272", [20 x i8]* %"$this_g_this_f_273", i8* getelementptr inbounds ([2 x i8], [2 x i8]* @"$g_271", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_41", i32 1, i8* %"$indices_buf_268", i32 1), !dbg !26
...
"$have_gas_293":                                  ; preds = %"$out_of_gas_292", %"$have_gas_285"
  ...
  call void @_update_field(i8* %"$execptr_load_295", i8* getelementptr inbounds ([30 x i8], [30 x i8]* @"$remote_read_remote_read_res_2_296", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_ADT_Option_Uint128_39", i32 0, i8* null, i8* %"$update_value_298"), !dbg !27
  ret void
}
...
entry:
  ...
  call void @"$RemoteReadsOfRemoteMap_221"(%Uint128 %_amount, [20 x i8]* %"$_origin_303", [20 x i8]* %"$_sender_305", [20 x i8]* %"$remote_307"), !dbg !29
  ret void
}

define internal void @"$RemoteReadsContractParam_308"(%Uint128 %_amount, [20 x i8]* %"$_origin_309", [20 x i8]* %"$_sender_310") !dbg !30 {
entry:
  ...
  %"$ad_call_315" = call i8* @_fetch_remote_field(i8* %"$execptr_load_312", [20 x i8]* %"$ad_cparam_313", i8* getelementptr inbounds ([6 x i8], [6 x i8]* @"$admin_311", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Bystr20_35", i32 0, i8* null, i32 1), !dbg !31
...
"$have_gas_335":                                  ; preds = %"$out_of_gas_334", %"$have_gas_326"
  ...
  call void @_update_field(i8* %"$execptr_load_337", i8* getelementptr inbounds ([30 x i8], [30 x i8]* @"$remote_read_remote_read_res_3_338", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Bystr20_35", i32 0, i8* null, i8* %"$update_value_341"), !dbg !32
  ret void
}
...
entry:
  ...
  call void @"$RemoteReadsContractParam_308"(%Uint128 %_amount, [20 x i8]* %"$_origin_346", [20 x i8]* %"$_sender_348"), !dbg !34
  ret void
}

define internal void @"$AddressTypeErasureTest1_349"(%Uint128 %_amount, [20 x i8]* %"$_origin_350", [20 x i8]* %"$_sender_351") !dbg !35 {
entry:
...
"$have_gas_370":                                  ; preds = %"$out_of_gas_369", %"$have_gas_360"
  ...
  call void @_update_field(i8* %"$execptr_load_375", i8* getelementptr inbounds ([32 x i8], [32 x i8]* @"$address_type_erasure_test_res_1_376", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_42", i32 1, i8* %"$indices_buf_372", i8* %"$update_value_379"), !dbg !37
  ret void
}
...
entry:
  ...
  call void @"$AddressTypeErasureTest1_349"(%Uint128 %_amount, [20 x i8]* %"$_origin_384", [20 x i8]* %"$_sender_386"), !dbg !39
  ret void
}

define internal void @"$AddressTypeErasureTest2_387"(%Uint128 %_amount, [20 x i8]* %"$_origin_388", [20 x i8]* %"$_sender_389") !dbg !40 {
entry:
...
"$have_gas_398":                                  ; preds = %"$out_of_gas_397", %"$have_gas_393"
  ...
  %"$emp_map_call_402" = call i8* @_fetch_field(i8* %"$execptr_load_401", i8* getelementptr inbounds ([32 x i8], [32 x i8]* @"$address_type_erasure_test_res_1_400", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_42", i32 0, i8* null, i32 1), !dbg !42
...
"$have_gas_428":                                  ; preds = %"$out_of_gas_427", %"$have_gas_419"
  ...
  %"$put_call_439" = call i8* @_put(i8* %"$execptr_load_430", %_TyDescrTy_Typ* @"$TyDescr_Map_42", i8* %"$$emp_map_431_432", i8* %"$$put_zero_433_435", i8* %"$$put_cparam_436_438"), !dbg !43
  %"$put_440" = bitcast i8* %"$put_call_439" to %Map_Uint128_ByStr20_with_end*
  store %Map_Uint128_ByStr20_with_end* %"$put_440", %Map_Uint128_ByStr20_with_end** %new_map, align 8, !dbg !43
...
"$have_gas_447":                                  ; preds = %"$out_of_gas_446", %"$have_gas_428"
  ...
  call void @_update_field(i8* %"$execptr_load_449", i8* getelementptr inbounds ([32 x i8], [32 x i8]* @"$address_type_erasure_test_res_1_450", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_42", i32 0, i8* null, i8* %"$update_value_452"), !dbg !44
  ret void
}
...
entry:
  ...
  call void @"$AddressTypeErasureTest2_387"(%Uint128 %_amount, [20 x i8]* %"$_origin_457", [20 x i8]* %"$_sender_459"), !dbg !46
  ret void
}
