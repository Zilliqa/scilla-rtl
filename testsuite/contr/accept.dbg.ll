...
define internal void @"$Accept1_101"(%Uint128 %_amount, [20 x i8]* %"$_origin_102", [20 x i8]* %"$_sender_103") !dbg !15 {
entry:
...
"$have_gas_107":                                  ; preds = %"$out_of_gas_106", %entry
  ...
  call void @_accept(i8* %"$execptr_load_109"), !dbg !16
...
"$have_gas_113":                                  ; preds = %"$out_of_gas_112", %"$have_gas_107"
  ...
  call void @_accept(i8* %"$execptr_load_115"), !dbg !17
  ret void
}
...
entry:
  ...
  call void @"$Accept1_101"(%Uint128 %_amount, [20 x i8]* %"$_origin_120", [20 x i8]* %"$_sender_122"), !dbg !19
  ret void
}

define internal void @"$Accept2_123"(%Uint128 %_amount, [20 x i8]* %"$_origin_124", [20 x i8]* %"$_sender_125") !dbg !20 {
entry:
...
"$have_gas_129":                                  ; preds = %"$out_of_gas_128", %entry
  ...
  call void @_accept(i8* %"$execptr_load_131"), !dbg !21
...
"$have_gas_140":                                  ; preds = %"$out_of_gas_139", %"$have_gas_135"
  ...
  store i8* %"$msgobj_142", i8** %msg1, align 8, !dbg !22
...
"$have_gas_174":                                  ; preds = %"$out_of_gas_173", %"$have_gas_169"
  ...
  %"$accept.one_msg_call_180" = call %TName_List_Message* %"$accept.one_msg_fptr_177"(i8* %"$accept.one_msg_envptr_178", i8* %"$msg1_179"), !dbg !23
  store %TName_List_Message* %"$accept.one_msg_call_180", %TName_List_Message** %"$accept.one_msg_1", align 8, !dbg !23
  %"$$accept.one_msg_1_181" = load %TName_List_Message*, %TName_List_Message** %"$accept.one_msg_1", align 8
  store %TName_List_Message* %"$$accept.one_msg_1_181", %TName_List_Message** %msgs, align 8, !dbg !23
...
"$have_gas_188":                                  ; preds = %"$out_of_gas_187", %"$have_gas_174"
  ...
  call void @_send(i8* %"$execptr_load_190", %_TyDescrTy_Typ* @"$TyDescr_ADT_List_Message_39", %TName_List_Message* %"$msgs_191"), !dbg !24
  ret void
}
...
entry:
  ...
  call void @"$Accept2_123"(%Uint128 %_amount, [20 x i8]* %"$_origin_196", [20 x i8]* %"$_sender_198"), !dbg !26
  ret void
}

define internal void @"$Accept3_199"(%Uint128 %_amount, [20 x i8]* %"$_origin_200", [20 x i8]* %"$_sender_201") !dbg !27 {
entry:
...
"$have_gas_205":                                  ; preds = %"$out_of_gas_204", %entry
  ...
  call void @_accept(i8* %"$execptr_load_207"), !dbg !28
...
"$have_gas_216":                                  ; preds = %"$out_of_gas_215", %"$have_gas_211"
  ...
  store i8* %"$msgobj_218", i8** %msg1, align 8, !dbg !29
...
"$have_gas_250":                                  ; preds = %"$out_of_gas_249", %"$have_gas_245"
  ...
  %"$accept.one_msg_call_256" = call %TName_List_Message* %"$accept.one_msg_fptr_253"(i8* %"$accept.one_msg_envptr_254", i8* %"$msg1_255"), !dbg !30
  store %TName_List_Message* %"$accept.one_msg_call_256", %TName_List_Message** %"$accept.one_msg_2", align 8, !dbg !30
  %"$$accept.one_msg_2_257" = load %TName_List_Message*, %TName_List_Message** %"$accept.one_msg_2", align 8
  store %TName_List_Message* %"$$accept.one_msg_2_257", %TName_List_Message** %msgs, align 8, !dbg !30
...
"$have_gas_264":                                  ; preds = %"$out_of_gas_263", %"$have_gas_250"
  ...
  call void @_send(i8* %"$execptr_load_266", %_TyDescrTy_Typ* @"$TyDescr_ADT_List_Message_39", %TName_List_Message* %"$msgs_267"), !dbg !31
  ret void
}
...
entry:
  ...
  call void @"$Accept3_199"(%Uint128 %_amount, [20 x i8]* %"$_origin_272", [20 x i8]* %"$_sender_274"), !dbg !33
  ret void
}
