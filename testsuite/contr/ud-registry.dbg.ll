...
"$have_gas_2237":                                 ; preds = %"$out_of_gas_2236", %"$have_gas_2232"
  ...
  %"$eq_call_2246" = call %TName_Bool* @_eq_ByStrX(i8* %"$execptr_load_2239", i32 20, i8* %"$$eq_sender_2240_2242", i8* %"$$eq_recordOwner_2243_2245"), !dbg !8
  store %TName_Bool* %"$eq_call_2246", %TName_Bool** %isOwner, align 8, !dbg !8
...
"$have_gas_2268":                                 ; preds = %"$out_of_gas_2267", %"$None_2263"
  ...
  store %TName_Bool* %"$adtptr_2272", %TName_Bool** %isApproved, align 8, !dbg !10
...
"$have_gas_2280":                                 ; preds = %"$out_of_gas_2279", %"$Some_2273"
  ...
  %"$eq_call_2289" = call %TName_Bool* @_eq_ByStrX(i8* %"$execptr_load_2282", i32 20, i8* %"$$eq_sender_2283_2285", i8* %"$$eq_approved_2286_2288"), !dbg !13
  store %TName_Bool* %"$eq_call_2289", %TName_Bool** %isApproved, align 8, !dbg !13
  br label %"$matchsucc_2258"
...
"$have_gas_2310":                                 ; preds = %"$out_of_gas_2309", %"$None_2305"
  ...
  store %TName_Bool* %"$adtptr_2314", %TName_Bool** %isOperator, align 8, !dbg !16
...
"$have_gas_2322":                                 ; preds = %"$out_of_gas_2321", %"$Some_2315"
  ...
  %"$ud-registry.listByStr20Contains_call_2328" = call { %TName_Bool* (i8*, [20 x i8]*)*, i8* } %"$ud-registry.listByStr20Contains_fptr_2325"(i8* %"$ud-registry.listByStr20Contains_envptr_2326", %TName_List_ByStr20* %"$operators_2327"), !dbg !19
  store { %TName_Bool* (i8*, [20 x i8]*)*, i8* } %"$ud-registry.listByStr20Contains_call_2328", { %TName_Bool* (i8*, [20 x i8]*)*, i8* }* %"$ud-registry.listByStr20Contains_39", align 8, !dbg !19
  ...
  %"$$ud-registry.listByStr20Contains_39_call_2334" = call %TName_Bool* %"$$ud-registry.listByStr20Contains_39_fptr_2330"(i8* %"$$ud-registry.listByStr20Contains_39_envptr_2331", [20 x i8]* %"$$ud-registry.listByStr20Contains_39_sender_2332"), !dbg !19
  store %TName_Bool* %"$$ud-registry.listByStr20Contains_39_call_2334", %TName_Bool** %"$ud-registry.listByStr20Contains_40", align 8, !dbg !19
  %"$$ud-registry.listByStr20Contains_40_2335" = load %TName_Bool*, %TName_Bool** %"$ud-registry.listByStr20Contains_40", align 8
  store %TName_Bool* %"$$ud-registry.listByStr20Contains_40_2335", %TName_Bool** %isOperator, align 8, !dbg !19
  br label %"$matchsucc_2301"
...
"$have_gas_2344":                                 ; preds = %"$out_of_gas_2343", %"$have_gas_2339"
  ...
  %"$BoolUtils.orb_call_2350" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.orb_fptr_2347"(i8* %"$BoolUtils.orb_envptr_2348", %TName_Bool* %"$isOwner_2349"), !dbg !21
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.orb_call_2350", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.orb_41", align 8, !dbg !21
  ...
  %"$$BoolUtils.orb_41_call_2355" = call %TName_Bool* %"$$BoolUtils.orb_41_fptr_2352"(i8* %"$$BoolUtils.orb_41_envptr_2353", %TName_Bool* %"$isApproved_2354"), !dbg !21
  store %TName_Bool* %"$$BoolUtils.orb_41_call_2355", %TName_Bool** %"$BoolUtils.orb_42", align 8, !dbg !21
  %"$$BoolUtils.orb_42_2356" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.orb_42", align 8
  store %TName_Bool* %"$$BoolUtils.orb_42_2356", %TName_Bool** %b1, align 8, !dbg !21
...
"$have_gas_2360":                                 ; preds = %"$out_of_gas_2359", %"$have_gas_2344"
  ...
  %"$BoolUtils.orb_call_2366" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.orb_fptr_2363"(i8* %"$BoolUtils.orb_envptr_2364", %TName_Bool* %"$b1_2365"), !dbg !22
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.orb_call_2366", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.orb_43", align 8, !dbg !22
  ...
  %"$$BoolUtils.orb_43_call_2371" = call %TName_Bool* %"$$BoolUtils.orb_43_fptr_2368"(i8* %"$$BoolUtils.orb_43_envptr_2369", %TName_Bool* %"$isOperator_2370"), !dbg !22
  store %TName_Bool* %"$$BoolUtils.orb_43_call_2371", %TName_Bool** %"$BoolUtils.orb_44", align 8, !dbg !22
  %"$$BoolUtils.orb_44_2372" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.orb_44", align 8
  store %TName_Bool* %"$$BoolUtils.orb_44_2372", %TName_Bool** %"$retval_215", align 8, !dbg !22
...
"$have_gas_2203":                                 ; preds = %"$out_of_gas_2202", %entry
  ...
  store { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* } %"$$fundef_214_cloval_2208", { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* }* %"$retval_213", align 8, !dbg !24
...
"$have_gas_2178":                                 ; preds = %"$out_of_gas_2177", %entry
  ...
  store { { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* } (i8*, %TName_Option_ByStr20*)*, i8* } %"$$fundef_212_cloval_2183", { { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* } (i8*, %TName_Option_ByStr20*)*, i8* }* %"$retval_211", align 8, !dbg !26
...
"$have_gas_2157":                                 ; preds = %"$out_of_gas_2156", %entry
  ...
  store { { { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* } (i8*, %TName_Option_ByStr20*)*, i8* } (i8*, [20 x i8]*)*, i8* } %"$$fundef_210_cloval_2162", { { { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* } (i8*, %TName_Option_ByStr20*)*, i8* } (i8*, [20 x i8]*)*, i8* }* %"$retval_209", align 8, !dbg !28
...
"$have_gas_2099":                                 ; preds = %"$out_of_gas_2098", %"$have_gas_2085"
  ...
  %"$sha256hash_call_2104" = call [32 x i8]* @_sha256hash(i8* %"$execptr_load_2101", %_TyDescrTy_Typ* @"$TyDescr_String_295", i8* %"$$sha256hash_label_2102_2103"), !dbg !30
  %"$sha256hash_2106" = load [32 x i8], [32 x i8]* %"$sha256hash_call_2104", align 1
  store [32 x i8] %"$sha256hash_2106", [32 x i8]* %labelHash, align 1, !dbg !30
...
"$have_gas_2115":                                 ; preds = %"$out_of_gas_2114", %"$have_gas_2110"
  ...
  %"$concat_call_2124" = call i8* @_concat_ByStrX(i8* %"$execptr_load_2117", i32 32, i8* %"$$concat_parent_2118_2120", i32 32, i8* %"$$concat_labelHash_2121_2123"), !dbg !31
  %"$concat_2125" = bitcast i8* %"$concat_call_2124" to [64 x i8]*
  %"$concat_2126" = load [64 x i8], [64 x i8]* %"$concat_2125", align 1
  store [64 x i8] %"$concat_2126", [64 x i8]* %nodeInput, align 1, !dbg !31
...
"$have_gas_2140":                                 ; preds = %"$out_of_gas_2139", %"$have_gas_2115"
  ...
  %"$sha256hash_call_2146" = call [32 x i8]* @_sha256hash(i8* %"$execptr_load_2142", %_TyDescrTy_Typ* @"$TyDescr_Bystr64_307", i8* %"$$sha256hash_nodeInput_2143_2145"), !dbg !32
  %"$sha256hash_2148" = load [32 x i8], [32 x i8]* %"$sha256hash_call_2146", align 1
  store [32 x i8] %"$sha256hash_2148", [32 x i8]* %"$retval_219", align 1, !dbg !32
...
"$have_gas_2072":                                 ; preds = %"$out_of_gas_2071", %entry
  ...
  store { void (i8*, [32 x i8]*, %String)*, i8* } %"$$fundef_218_cloval_2077", { void (i8*, [32 x i8]*, %String)*, i8* }* %"$retval_217", align 8, !dbg !34
...
"$have_gas_2039":                                 ; preds = %"$out_of_gas_2038", %"$None_2034"
  ...
  store [20 x i8] %"$ud-registry.zeroByStr20_2041", [20 x i8]* %"$retval_221", align 1, !dbg !37
...
"$have_gas_2065":                                 ; preds = %"$out_of_gas_2064", %"$ud-registry.Record_2056"
  ...
  store [20 x i8] %"$owner_2067", [20 x i8]* %"$retval_221", align 1, !dbg !42
...
"$have_gas_2003":                                 ; preds = %"$out_of_gas_2002", %entry
  ...
  store i8* %"$msgobj_2005", i8** %"$retval_223", align 8, !dbg !46
...
"$have_gas_1964":                                 ; preds = %"$out_of_gas_1963", %entry
  ...
  store i8* %"$msgobj_1966", i8** %"$retval_229", align 8, !dbg !48
...
"$have_gas_1934":                                 ; preds = %"$out_of_gas_1933", %entry
  ...
  store { { i8* (i8*, [20 x i8]*)*, i8* } (i8*, [20 x i8]*)*, i8* } %"$$fundef_226_cloval_1939", { { i8* (i8*, [20 x i8]*)*, i8* } (i8*, [20 x i8]*)*, i8* }* %"$retval_225", align 8, !dbg !52
...
"$have_gas_1903":                                 ; preds = %"$out_of_gas_1902", %entry
  ...
  store i8* %"$msgobj_1905", i8** %"$retval_233", align 8, !dbg !54
...
"$have_gas_1890":                                 ; preds = %"$out_of_gas_1889", %entry
  ...
  store { i8* (i8*, %String)*, i8* } %"$$fundef_232_cloval_1895", { i8* (i8*, %String)*, i8* }* %"$retval_231", align 8, !dbg !56
...
"$have_gas_1867":                                 ; preds = %"$out_of_gas_1866", %entry
  ...
  store i8* %"$msgobj_1869", i8** %"$retval_235", align 8, !dbg !58
...
"$have_gas_1844":                                 ; preds = %"$out_of_gas_1843", %entry
  ...
  store i8* %"$msgobj_1846", i8** %"$retval_237", align 8, !dbg !60
...
"$have_gas_1805":                                 ; preds = %"$out_of_gas_1804", %entry
  ...
  store i8* %"$msgobj_1807", i8** %"$retval_243", align 8, !dbg !62
...
"$have_gas_1788":                                 ; preds = %"$out_of_gas_1787", %entry
  ...
  store { i8* (i8*, %TName_Bool*)*, i8* } %"$$fundef_242_cloval_1793", { i8* (i8*, %TName_Bool*)*, i8* }* %"$retval_241", align 8, !dbg !64
...
"$have_gas_1775":                                 ; preds = %"$out_of_gas_1774", %entry
  ...
  store { { i8* (i8*, %TName_Bool*)*, i8* } (i8*, [20 x i8]*)*, i8* } %"$$fundef_240_cloval_1780", { { i8* (i8*, %TName_Bool*)*, i8* } (i8*, [20 x i8]*)*, i8* }* %"$retval_239", align 8, !dbg !66
...
"$have_gas_1744":                                 ; preds = %"$out_of_gas_1743", %entry
  ...
  store i8* %"$msgobj_1746", i8** %"$retval_247", align 8, !dbg !68
...
"$have_gas_1731":                                 ; preds = %"$out_of_gas_1730", %entry
  ...
  store { i8* (i8*, %TName_Bool*)*, i8* } %"$$fundef_246_cloval_1736", { i8* (i8*, %TName_Bool*)*, i8* }* %"$retval_245", align 8, !dbg !70
...
"$have_gas_1681":                                 ; preds = %"$out_of_gas_1680", %"$True_1676"
  ...
  store %TName_Bool* %"$adtptr_1685", %TName_Bool** %"$retval_251", align 8, !dbg !76
...
"$have_gas_1691":                                 ; preds = %"$out_of_gas_1690", %"$False_1686"
  ...
  store %TName_Bool* %"$adtptr_1695", %TName_Bool** %"$retval_251", align 8, !dbg !79
  br label %"$matchsucc_1672"
...
"$have_gas_1712":                                 ; preds = %"$out_of_gas_1711", %"$True_1707"
  ...
  store %TName_Bool* %"$adtptr_1716", %TName_Bool** %"$retval_251", align 8, !dbg !83
...
"$have_gas_1722":                                 ; preds = %"$out_of_gas_1721", %"$False_1717"
  ...
  store %TName_Bool* %"$adtptr_1726", %TName_Bool** %"$retval_251", align 8, !dbg !86
  br label %"$matchsucc_1703"
...
"$have_gas_1645":                                 ; preds = %"$out_of_gas_1644", %entry
  ...
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$$fundef_250_cloval_1650", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$retval_249", align 8, !dbg !89
...
"$have_gas_1620":                                 ; preds = %"$out_of_gas_1619", %"$have_gas_1615"
  ...
  %"$eq_call_1628" = call %TName_Bool* @_eq_ByStrX(i8* %"$execptr_load_1622", i32 20, i8* %"$$eq_v_1623_1624", i8* %"$$eq_bs_1625_1627"), !dbg !91
  store %TName_Bool* %"$eq_call_1628", %TName_Bool** %b, align 8, !dbg !91
...
"$have_gas_1633":                                 ; preds = %"$out_of_gas_1632", %"$have_gas_1620"
  ...
  %"$BoolUtils.negb_call_1639" = call %TName_Bool* %"$BoolUtils.negb_fptr_1636"(i8* %"$BoolUtils.negb_envptr_1637", %TName_Bool* %"$b_1638"), !dbg !92
  store %TName_Bool* %"$BoolUtils.negb_call_1639", %TName_Bool** %"$BoolUtils.negb_36", align 8, !dbg !92
  %"$$BoolUtils.negb_36_1640" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.negb_36", align 8
  store %TName_Bool* %"$$BoolUtils.negb_36_1640", %TName_Bool** %"$retval_257", align 8, !dbg !92
...
"$have_gas_1565":                                 ; preds = %"$out_of_gas_1564", %"$have_gas_1560"
  ...
  %"$ListUtils.list_filter_call_1573" = call { { %TName_List_ByStr20* (i8*, %TName_List_ByStr20*)*, i8* } (i8*, { %TName_Bool* (i8*, [20 x i8]*)*, i8* })*, i8* } %"$ListUtils.list_filter_fptr_1571"(i8* %"$ListUtils.list_filter_envptr_1572"), !dbg !94
  store { { %TName_List_ByStr20* (i8*, %TName_List_ByStr20*)*, i8* } (i8*, { %TName_Bool* (i8*, [20 x i8]*)*, i8* })*, i8* } %"$ListUtils.list_filter_call_1573", { { %TName_List_ByStr20* (i8*, %TName_List_ByStr20*)*, i8* } (i8*, { %TName_Bool* (i8*, [20 x i8]*)*, i8* })*, i8* }* %listByStr20Filter, align 8, !dbg !95
...
"$have_gas_1582":                                 ; preds = %"$out_of_gas_1581", %"$have_gas_1577"
  ...
  store { %TName_Bool* (i8*, [20 x i8]*)*, i8* } %"$$fundef_256_cloval_1587", { %TName_Bool* (i8*, [20 x i8]*)*, i8* }* %fn, align 8, !dbg !96
...
"$have_gas_1594":                                 ; preds = %"$out_of_gas_1593", %"$have_gas_1582"
  ...
  %"$listByStr20Filter_call_1600" = call { %TName_List_ByStr20* (i8*, %TName_List_ByStr20*)*, i8* } %"$listByStr20Filter_fptr_1597"(i8* %"$listByStr20Filter_envptr_1598", { %TName_Bool* (i8*, [20 x i8]*)*, i8* } %"$fn_1599"), !dbg !97
  store { %TName_List_ByStr20* (i8*, %TName_List_ByStr20*)*, i8* } %"$listByStr20Filter_call_1600", { %TName_List_ByStr20* (i8*, %TName_List_ByStr20*)*, i8* }* %"$listByStr20Filter_37", align 8, !dbg !97
  ...
  %"$$listByStr20Filter_37_call_1605" = call %TName_List_ByStr20* %"$$listByStr20Filter_37_fptr_1602"(i8* %"$$listByStr20Filter_37_envptr_1603", %TName_List_ByStr20* %"$list_1604"), !dbg !97
  store %TName_List_ByStr20* %"$$listByStr20Filter_37_call_1605", %TName_List_ByStr20** %"$listByStr20Filter_38", align 8, !dbg !97
  %"$$listByStr20Filter_38_1606" = load %TName_List_ByStr20*, %TName_List_ByStr20** %"$listByStr20Filter_38", align 8
  store %TName_List_ByStr20* %"$$listByStr20Filter_38_1606", %TName_List_ByStr20** %"$retval_255", align 8, !dbg !97
...
"$have_gas_1539":                                 ; preds = %"$out_of_gas_1538", %entry
  ...
  store { %TName_List_ByStr20* (i8*, [20 x i8]*)*, i8* } %"$$fundef_254_cloval_1544", { %TName_List_ByStr20* (i8*, [20 x i8]*)*, i8* }* %"$retval_253", align 8, !dbg !99
...
"$have_gas_1507":                                 ; preds = %"$out_of_gas_1506", %"$have_gas_1502"
  ...
  %"$ud-registry.listByStr20Contains_call_1513" = call { %TName_Bool* (i8*, [20 x i8]*)*, i8* } %"$ud-registry.listByStr20Contains_fptr_1510"(i8* %"$ud-registry.listByStr20Contains_envptr_1511", %TName_List_ByStr20* %"$list_1512"), !dbg !101
  store { %TName_Bool* (i8*, [20 x i8]*)*, i8* } %"$ud-registry.listByStr20Contains_call_1513", { %TName_Bool* (i8*, [20 x i8]*)*, i8* }* %"$ud-registry.listByStr20Contains_33", align 8, !dbg !101
  ...
  %"$$ud-registry.listByStr20Contains_33_call_1518" = call %TName_Bool* %"$$ud-registry.listByStr20Contains_33_fptr_1515"(i8* %"$$ud-registry.listByStr20Contains_33_envptr_1516", [20 x i8]* %"$$ud-registry.listByStr20Contains_33_bs_1517"), !dbg !101
  store %TName_Bool* %"$$ud-registry.listByStr20Contains_33_call_1518", %TName_Bool** %"$ud-registry.listByStr20Contains_34", align 8, !dbg !101
  %"$$ud-registry.listByStr20Contains_34_1519" = load %TName_Bool*, %TName_Bool** %"$ud-registry.listByStr20Contains_34", align 8
  store %TName_Bool* %"$$ud-registry.listByStr20Contains_34_1519", %TName_Bool** %b, align 8, !dbg !101
...
"$have_gas_1523":                                 ; preds = %"$out_of_gas_1522", %"$have_gas_1507"
  ...
  %"$BoolUtils.negb_call_1529" = call %TName_Bool* %"$BoolUtils.negb_fptr_1526"(i8* %"$BoolUtils.negb_envptr_1527", %TName_Bool* %"$b_1528"), !dbg !102
  store %TName_Bool* %"$BoolUtils.negb_call_1529", %TName_Bool** %"$BoolUtils.negb_35", align 8, !dbg !102
  %"$$BoolUtils.negb_35_1530" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.negb_35", align 8
  store %TName_Bool* %"$$BoolUtils.negb_35_1530", %TName_Bool** %"$retval_261", align 8, !dbg !102
...
"$have_gas_1481":                                 ; preds = %"$out_of_gas_1480", %entry
  ...
  store { %TName_Bool* (i8*, [20 x i8]*)*, i8* } %"$$fundef_260_cloval_1486", { %TName_Bool* (i8*, [20 x i8]*)*, i8* }* %"$retval_259", align 8, !dbg !104
...
"$have_gas_1443":                                 ; preds = %"$out_of_gas_1442", %"$have_gas_1438"
  ...
  %"$ListUtils.list_mem_call_1451" = call { { { %TName_Bool* (i8*, %TName_List_ByStr20*)*, i8* } (i8*, [20 x i8]*)*, i8* } (i8*, { { %TName_Bool* (i8*, [20 x i8]*)*, i8* } (i8*, [20 x i8]*)*, i8* })*, i8* } %"$ListUtils.list_mem_fptr_1449"(i8* %"$ListUtils.list_mem_envptr_1450"), !dbg !106
  store { { { %TName_Bool* (i8*, %TName_List_ByStr20*)*, i8* } (i8*, [20 x i8]*)*, i8* } (i8*, { { %TName_Bool* (i8*, [20 x i8]*)*, i8* } (i8*, [20 x i8]*)*, i8* })*, i8* } %"$ListUtils.list_mem_call_1451", { { { %TName_Bool* (i8*, %TName_List_ByStr20*)*, i8* } (i8*, [20 x i8]*)*, i8* } (i8*, { { %TName_Bool* (i8*, [20 x i8]*)*, i8* } (i8*, [20 x i8]*)*, i8* })*, i8* }* %listMemByStr20, align 8, !dbg !107
...
"$have_gas_1455":                                 ; preds = %"$out_of_gas_1454", %"$have_gas_1443"
  ...
  %"$listMemByStr20_call_1461" = call { { %TName_Bool* (i8*, %TName_List_ByStr20*)*, i8* } (i8*, [20 x i8]*)*, i8* } %"$listMemByStr20_fptr_1458"(i8* %"$listMemByStr20_envptr_1459", { { %TName_Bool* (i8*, [20 x i8]*)*, i8* } (i8*, [20 x i8]*)*, i8* } %"$ud-registry.eqByStr20_1460"), !dbg !108
  store { { %TName_Bool* (i8*, %TName_List_ByStr20*)*, i8* } (i8*, [20 x i8]*)*, i8* } %"$listMemByStr20_call_1461", { { %TName_Bool* (i8*, %TName_List_ByStr20*)*, i8* } (i8*, [20 x i8]*)*, i8* }* %"$listMemByStr20_30", align 8, !dbg !108
  ...
  %"$$listMemByStr20_30_call_1466" = call { %TName_Bool* (i8*, %TName_List_ByStr20*)*, i8* } %"$$listMemByStr20_30_fptr_1463"(i8* %"$$listMemByStr20_30_envptr_1464", [20 x i8]* %"$$listMemByStr20_30_bs_1465"), !dbg !108
  store { %TName_Bool* (i8*, %TName_List_ByStr20*)*, i8* } %"$$listMemByStr20_30_call_1466", { %TName_Bool* (i8*, %TName_List_ByStr20*)*, i8* }* %"$listMemByStr20_31", align 8, !dbg !108
  ...
  %"$$listMemByStr20_31_call_1471" = call %TName_Bool* %"$$listMemByStr20_31_fptr_1468"(i8* %"$$listMemByStr20_31_envptr_1469", %TName_List_ByStr20* %"$list_1470"), !dbg !108
  store %TName_Bool* %"$$listMemByStr20_31_call_1471", %TName_Bool** %"$listMemByStr20_32", align 8, !dbg !108
  %"$$listMemByStr20_32_1472" = load %TName_Bool*, %TName_Bool** %"$listMemByStr20_32", align 8
  store %TName_Bool* %"$$listMemByStr20_32_1472", %TName_Bool** %"$retval_265", align 8, !dbg !108
...
"$have_gas_1417":                                 ; preds = %"$out_of_gas_1416", %entry
  ...
  store { %TName_Bool* (i8*, [20 x i8]*)*, i8* } %"$$fundef_264_cloval_1422", { %TName_Bool* (i8*, [20 x i8]*)*, i8* }* %"$retval_263", align 8, !dbg !110
...
"$have_gas_1399":                                 ; preds = %"$out_of_gas_1398", %entry
  ...
  %"$eq_call_1407" = call %TName_Bool* @_eq_ByStrX(i8* %"$execptr_load_1401", i32 20, i8* %"$$eq_bs1_1402_1404", i8* %"$$eq_bs2_1405_1406"), !dbg !112
  store %TName_Bool* %"$eq_call_1407", %TName_Bool** %"$retval_269", align 8, !dbg !112
...
"$have_gas_2377":                                 ; preds = %"$out_of_gas_2376", %entry
  ...
  store { i8*, i8* }* %"$dyndisp_table_2382", { i8*, i8* }** @list_foldr, align 8, !dbg !242
...
"$have_gas_2388":                                 ; preds = %"$out_of_gas_2387", %"$have_gas_2377"
  ...
  store { i8*, i8* }* %"$dyndisp_table_2393", { i8*, i8* }** @list_foldk, align 8, !dbg !242
...
"$have_gas_2423":                                 ; preds = %"$out_of_gas_2422", %"$have_gas_2415"
  ...
  store { i8*, i8* }* %"$dyndisp_table_2431", { i8*, i8* }** @ListUtils.list_filter, align 8, !dbg !246
...
"$have_gas_2437":                                 ; preds = %"$out_of_gas_2436", %"$have_gas_2423"
  ...
  store { i8*, i8* }* %"$dyndisp_table_2445", { i8*, i8* }** @ListUtils.list_find, align 8, !dbg !247
...
"$have_gas_2451":                                 ; preds = %"$out_of_gas_2450", %"$have_gas_2437"
  ...
  store { i8*, i8* }* %"$dyndisp_table_2459", { i8*, i8* }** @ListUtils.list_exists, align 8, !dbg !248
...
"$have_gas_2465":                                 ; preds = %"$out_of_gas_2464", %"$have_gas_2451"
  ...
  store { i8*, i8* }* %"$dyndisp_table_2473", { i8*, i8* }** @ListUtils.list_mem, align 8, !dbg !249
...
"$have_gas_2484":                                 ; preds = %"$out_of_gas_2483", %"$have_gas_2479"
  ...
  store %TName_List_ByStr20* %"$adtptr_2488", %TName_List_ByStr20** @ud-registry.nilByStr20, align 8, !dbg !251
...
"$have_gas_2492":                                 ; preds = %"$out_of_gas_2491", %"$have_gas_2484"
  ...
  store %TName_List_Message* %"$adtptr_2496", %TName_List_Message** @ud-registry.nilMessage, align 8, !dbg !252
...
"$have_gas_2500":                                 ; preds = %"$out_of_gas_2499", %"$have_gas_2492"
  ...
  store { %TName_List_Message* (i8*, i8*)*, i8* } %"$$fundef_270_cloval_2505", { %TName_List_Message* (i8*, i8*)*, i8* }* @ud-registry.oneMsg, align 8, !dbg !253
...
"$have_gas_2519":                                 ; preds = %"$out_of_gas_2518", %"$have_gas_2511"
  ...
  store { { %TName_Bool* (i8*, [20 x i8]*)*, i8* } (i8*, %TName_List_ByStr20*)*, i8* } %"$$fundef_262_cloval_2524", { { %TName_Bool* (i8*, [20 x i8]*)*, i8* } (i8*, %TName_List_ByStr20*)*, i8* }* @ud-registry.listByStr20Contains, align 8, !dbg !255
...
"$have_gas_2532":                                 ; preds = %"$out_of_gas_2531", %"$have_gas_2519"
  ...
  store { { %TName_Bool* (i8*, [20 x i8]*)*, i8* } (i8*, %TName_List_ByStr20*)*, i8* } %"$$fundef_258_cloval_2537", { { %TName_Bool* (i8*, [20 x i8]*)*, i8* } (i8*, %TName_List_ByStr20*)*, i8* }* @ud-registry.listByStr20Excludes, align 8, !dbg !256
...
"$have_gas_2545":                                 ; preds = %"$out_of_gas_2544", %"$have_gas_2532"
  ...
  store { { %TName_List_ByStr20* (i8*, [20 x i8]*)*, i8* } (i8*, %TName_List_ByStr20*)*, i8* } %"$$fundef_252_cloval_2550", { { %TName_List_ByStr20* (i8*, [20 x i8]*)*, i8* } (i8*, %TName_List_ByStr20*)*, i8* }* @ud-registry.listByStr20FilterOut, align 8, !dbg !257
...
"$have_gas_2622":                                 ; preds = %"$out_of_gas_2621", %"$have_gas_2614"
  ...
  store { void (i8*, [20 x i8]*, %TName_Option_ud-registry.Record*)*, i8* } %"$$fundef_220_cloval_2627", { void (i8*, [20 x i8]*, %TName_Option_ud-registry.Record*)*, i8* }* @ud-registry.recordMemberOwner, align 8, !dbg !266
...
"$have_gas_2641":                                 ; preds = %"$out_of_gas_2640", %"$have_gas_2633"
  ...
  store { { { { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* } (i8*, %TName_Option_ByStr20*)*, i8* } (i8*, [20 x i8]*)*, i8* } (i8*, [20 x i8]*)*, i8* } %"$$fundef_208_cloval_2646", { { { { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* } (i8*, %TName_Option_ByStr20*)*, i8* } (i8*, [20 x i8]*)*, i8* } (i8*, [20 x i8]*)*, i8* }* @ud-registry.getIsOAO, align 8, !dbg !268
  ret void
}
...
"$have_gas_2659":                                 ; preds = %"$out_of_gas_2658", %"$have_gas_2654"
  ...
  store %Map_ByStr32_ud-registry.Record* %"$_new_empty_map_2663", %Map_ByStr32_ud-registry.Record** %empty, align 8, !dbg !270
...
"$have_gas_2672":                                 ; preds = %"$out_of_gas_2671", %"$have_gas_2667"
  ...
  store %TName_ud-registry.Record* %"$adtptr_2680", %TName_ud-registry.Record** %rootRecord, align 8, !dbg !271
...
"$have_gas_2688":                                 ; preds = %"$out_of_gas_2687", %"$have_gas_2672"
  ...
  %"$put_call_2698" = call i8* @_put(i8* %"$execptr_load_2690", %_TyDescrTy_Typ* @"$TyDescr_Map_325", i8* %"$$empty_2691_2692", i8* %"$$put_rootNode_2693_2695", i8* %"$$rootRecord_2696_2697"), !dbg !272
  %"$put_2699" = bitcast i8* %"$put_call_2698" to %Map_ByStr32_ud-registry.Record*
  store %Map_ByStr32_ud-registry.Record* %"$put_2699", %Map_ByStr32_ud-registry.Record** %"$records_272", align 8, !dbg !272
  ...
  call void @_update_field(i8* %"$execptr_load_2700", i8* getelementptr inbounds ([8 x i8], [8 x i8]* @"$records_2701", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_325", i32 0, i8* null, i8* %"$update_value_2703"), !dbg !270
...
"$have_gas_2707":                                 ; preds = %"$out_of_gas_2706", %"$have_gas_2688"
  ...
  store [20 x i8] %"$ud-registry.zeroByStr20_2709", [20 x i8]* %"$registrar_273", align 1, !dbg !273
  ...
  call void @_update_field(i8* %"$execptr_load_2710", i8* getelementptr inbounds ([10 x i8], [10 x i8]* @"$registrar_2711", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Bystr20_311", i32 0, i8* null, i8* %"$update_value_2714"), !dbg !273
...
"$have_gas_2718":                                 ; preds = %"$out_of_gas_2717", %"$have_gas_2707"
  ...
  store %Map_ByStr32_ByStr20* %"$_new_empty_map_2722", %Map_ByStr32_ByStr20** %"$approvals_274", align 8, !dbg !274
  ...
  call void @_update_field(i8* %"$execptr_load_2723", i8* getelementptr inbounds ([10 x i8], [10 x i8]* @"$approvals_2724", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_324", i32 0, i8* null, i8* %"$update_value_2726"), !dbg !274
...
"$have_gas_2730":                                 ; preds = %"$out_of_gas_2729", %"$have_gas_2718"
  ...
  store %"Map_ByStr20_List_(ByStr20)"* %"$_new_empty_map_2734", %"Map_ByStr20_List_(ByStr20)"** %"$operators_275", align 8, !dbg !275
  ...
  call void @_update_field(i8* %"$execptr_load_2735", i8* getelementptr inbounds ([10 x i8], [10 x i8]* @"$operators_2736", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_323", i32 0, i8* null, i8* %"$update_value_2738"), !dbg !275
...
"$have_gas_2742":                                 ; preds = %"$out_of_gas_2741", %"$have_gas_2730"
  ...
  store %TName_List_ByStr20* %"$adtptr_2750", %TName_List_ByStr20** %"$admins_276", align 8, !dbg !276
  ...
  call void @_update_field(i8* %"$execptr_load_2751", i8* getelementptr inbounds ([7 x i8], [7 x i8]* @"$admins_2752", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_ADT_List_ByStr20_320", i32 0, i8* null, i8* %"$update_value_2754"), !dbg !276
  ret void
}
...
define internal void @"$setAdmin_2755"(%Uint128 %_amount, [20 x i8]* %"$_origin_2756", [20 x i8]* %"$_sender_2757", [20 x i8]* %"$address_2758", %TName_Bool* %isApproved) !dbg !277 {
entry:
  ...
  %"$currentAdmins_call_2761" = call i8* @_fetch_field(i8* %"$execptr_load_2760", i8* getelementptr inbounds ([7 x i8], [7 x i8]* @"$admins_2759", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_ADT_List_ByStr20_320", i32 0, i8* null, i32 1), !dbg !278
...
"$have_gas_2780":                                 ; preds = %"$out_of_gas_2779", %"$have_gas_2775"
  ...
  %"$ud-registry.listByStr20Contains_call_2786" = call { %TName_Bool* (i8*, [20 x i8]*)*, i8* } %"$ud-registry.listByStr20Contains_fptr_2783"(i8* %"$ud-registry.listByStr20Contains_envptr_2784", %TName_List_ByStr20* %"$currentAdmins_2785"), !dbg !279
  store { %TName_Bool* (i8*, [20 x i8]*)*, i8* } %"$ud-registry.listByStr20Contains_call_2786", { %TName_Bool* (i8*, [20 x i8]*)*, i8* }* %"$ud-registry.listByStr20Contains_54", align 8, !dbg !279
  ...
  %"$$ud-registry.listByStr20Contains_54_call_2791" = call %TName_Bool* %"$$ud-registry.listByStr20Contains_54_fptr_2788"(i8* %"$$ud-registry.listByStr20Contains_54_envptr_2789", [20 x i8]* %"$$ud-registry.listByStr20Contains_54__sender_2790"), !dbg !279
  store %TName_Bool* %"$$ud-registry.listByStr20Contains_54_call_2791", %TName_Bool** %"$ud-registry.listByStr20Contains_55", align 8, !dbg !279
  %"$$ud-registry.listByStr20Contains_55_2792" = load %TName_Bool*, %TName_Bool** %"$ud-registry.listByStr20Contains_55", align 8
  store %TName_Bool* %"$$ud-registry.listByStr20Contains_55_2792", %TName_Bool** %isSenderAdmin, align 8, !dbg !279
...
"$have_gas_2818":                                 ; preds = %"$out_of_gas_2817", %"$have_gas_2813"
  ...
  %"$ud-registry.listByStr20Excludes_call_2824" = call { %TName_Bool* (i8*, [20 x i8]*)*, i8* } %"$ud-registry.listByStr20Excludes_fptr_2821"(i8* %"$ud-registry.listByStr20Excludes_envptr_2822", %TName_List_ByStr20* %"$currentAdmins_2823"), !dbg !281
  store { %TName_Bool* (i8*, [20 x i8]*)*, i8* } %"$ud-registry.listByStr20Excludes_call_2824", { %TName_Bool* (i8*, [20 x i8]*)*, i8* }* %"$ud-registry.listByStr20Excludes_49", align 8, !dbg !281
  ...
  %"$$ud-registry.listByStr20Excludes_49_call_2829" = call %TName_Bool* %"$$ud-registry.listByStr20Excludes_49_fptr_2826"(i8* %"$$ud-registry.listByStr20Excludes_49_envptr_2827", [20 x i8]* %"$$ud-registry.listByStr20Excludes_49_address_2828"), !dbg !281
  store %TName_Bool* %"$$ud-registry.listByStr20Excludes_49_call_2829", %TName_Bool** %"$ud-registry.listByStr20Excludes_50", align 8, !dbg !281
  %"$$ud-registry.listByStr20Excludes_50_2830" = load %TName_Bool*, %TName_Bool** %"$ud-registry.listByStr20Excludes_50", align 8
  store %TName_Bool* %"$$ud-registry.listByStr20Excludes_50_2830", %TName_Bool** %b, align 8, !dbg !281
...
"$have_gas_2834":                                 ; preds = %"$out_of_gas_2833", %"$have_gas_2818"
  ...
  %"$ud-registry.xandb_call_2840" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$ud-registry.xandb_fptr_2837"(i8* %"$ud-registry.xandb_envptr_2838", %TName_Bool* %"$b_2839"), !dbg !284
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$ud-registry.xandb_call_2840", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$ud-registry.xandb_51", align 8, !dbg !284
  ...
  %"$$ud-registry.xandb_51_call_2844" = call %TName_Bool* %"$$ud-registry.xandb_51_fptr_2842"(i8* %"$$ud-registry.xandb_51_envptr_2843", %TName_Bool* %isApproved), !dbg !284
  store %TName_Bool* %"$$ud-registry.xandb_51_call_2844", %TName_Bool** %"$ud-registry.xandb_52", align 8, !dbg !284
  %"$$ud-registry.xandb_52_2845" = load %TName_Bool*, %TName_Bool** %"$ud-registry.xandb_52", align 8
  store %TName_Bool* %"$$ud-registry.xandb_52_2845", %TName_Bool** %needsToChange, align 8, !dbg !284
...
"$have_gas_2877":                                 ; preds = %"$out_of_gas_2876", %"$True_2872"
  ...
  store %TName_List_ByStr20* %"$adtptr_2884", %TName_List_ByStr20** %newAdmins, align 8, !dbg !289
...
"$have_gas_2890":                                 ; preds = %"$out_of_gas_2889", %"$False_2885"
  ...
  %"$ud-registry.listByStr20FilterOut_call_2896" = call { %TName_List_ByStr20* (i8*, [20 x i8]*)*, i8* } %"$ud-registry.listByStr20FilterOut_fptr_2893"(i8* %"$ud-registry.listByStr20FilterOut_envptr_2894", %TName_List_ByStr20* %"$currentAdmins_2895"), !dbg !292
  store { %TName_List_ByStr20* (i8*, [20 x i8]*)*, i8* } %"$ud-registry.listByStr20FilterOut_call_2896", { %TName_List_ByStr20* (i8*, [20 x i8]*)*, i8* }* %"$ud-registry.listByStr20FilterOut_47", align 8, !dbg !292
  ...
  %"$$ud-registry.listByStr20FilterOut_47_call_2901" = call %TName_List_ByStr20* %"$$ud-registry.listByStr20FilterOut_47_fptr_2898"(i8* %"$$ud-registry.listByStr20FilterOut_47_envptr_2899", [20 x i8]* %"$$ud-registry.listByStr20FilterOut_47_address_2900"), !dbg !292
  store %TName_List_ByStr20* %"$$ud-registry.listByStr20FilterOut_47_call_2901", %TName_List_ByStr20** %"$ud-registry.listByStr20FilterOut_48", align 8, !dbg !292
  ...
  store %TName_List_ByStr20* %"$$ud-registry.listByStr20FilterOut_48_2902", %TName_List_ByStr20** %newAdmins, align 8, !dbg !292
  br label %"$matchsucc_2868"
...
"$have_gas_2909":                                 ; preds = %"$out_of_gas_2908", %"$matchsucc_2868"
  ...
  call void @_update_field(i8* %"$execptr_load_2911", i8* getelementptr inbounds ([7 x i8], [7 x i8]* @"$admins_2912", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_ADT_List_ByStr20_320", i32 0, i8* null, i8* %"$update_value_2914"), !dbg !294
...
"$have_gas_2923":                                 ; preds = %"$out_of_gas_2922", %"$have_gas_2918"
  ...
  %"$ud-registry.eAdminSet_call_2929" = call { i8* (i8*, %TName_Bool*)*, i8* } %"$ud-registry.eAdminSet_fptr_2926"(i8* %"$ud-registry.eAdminSet_envptr_2927", [20 x i8]* %"$ud-registry.eAdminSet_address_2928"), !dbg !295
  store { i8* (i8*, %TName_Bool*)*, i8* } %"$ud-registry.eAdminSet_call_2929", { i8* (i8*, %TName_Bool*)*, i8* }* %"$ud-registry.eAdminSet_45", align 8, !dbg !295
  ...
  %"$$ud-registry.eAdminSet_45_call_2933" = call i8* %"$$ud-registry.eAdminSet_45_fptr_2931"(i8* %"$$ud-registry.eAdminSet_45_envptr_2932", %TName_Bool* %isApproved), !dbg !295
  store i8* %"$$ud-registry.eAdminSet_45_call_2933", i8** %"$ud-registry.eAdminSet_46", align 8, !dbg !295
  %"$$ud-registry.eAdminSet_46_2934" = load i8*, i8** %"$ud-registry.eAdminSet_46", align 8
  store i8* %"$$ud-registry.eAdminSet_46_2934", i8** %e, align 8, !dbg !295
...
"$have_gas_2941":                                 ; preds = %"$out_of_gas_2940", %"$have_gas_2923"
  ...
  call void @_event(i8* %"$execptr_load_2943", %_TyDescrTy_Typ* @"$TyDescr_Event_301", i8* %"$e_2944"), !dbg !296
...
"$have_gas_2960":                                 ; preds = %"$out_of_gas_2959", %"$have_gas_2955"
  ...
  store %String { i8* getelementptr inbounds ([26 x i8], [26 x i8]* @"$stringlit_2962", i32 0, i32 0), i32 26 }, %String* %m, align 8, !dbg !297
...
"$have_gas_2966":                                 ; preds = %"$out_of_gas_2965", %"$have_gas_2960"
  ...
  %"$ud-registry.eError_call_2972" = call i8* %"$ud-registry.eError_fptr_2969"(i8* %"$ud-registry.eError_envptr_2970", %String %"$m_2971"), !dbg !299
  store i8* %"$ud-registry.eError_call_2972", i8** %"$ud-registry.eError_53", align 8, !dbg !299
  %"$$ud-registry.eError_53_2973" = load i8*, i8** %"$ud-registry.eError_53", align 8
  store i8* %"$$ud-registry.eError_53_2973", i8** %e1, align 8, !dbg !299
...
"$have_gas_2980":                                 ; preds = %"$out_of_gas_2979", %"$have_gas_2966"
  ...
  call void @_event(i8* %"$execptr_load_2982", %_TyDescrTy_Typ* @"$TyDescr_Event_301", i8* %"$e_2983"), !dbg !300
  br label %"$matchsucc_2798"
...
entry:
  ...
  call void @"$setAdmin_2755"(%Uint128 %_amount, [20 x i8]* %"$_origin_2988", [20 x i8]* %"$_sender_2990", [20 x i8]* %"$address_2992", %TName_Bool* %isApproved), !dbg !302
  ret void
}

define internal void @"$approve_2995"(%Uint128 %_amount, [20 x i8]* %"$_origin_2996", [20 x i8]* %"$_sender_2997", [32 x i8]* %"$node_2998", [20 x i8]* %"$address_2999") !dbg !303 {
entry:
  ...
  %"$maybeRecord_call_3004" = call i8* @_fetch_field(i8* %"$execptr_load_3003", i8* getelementptr inbounds ([8 x i8], [8 x i8]* @"$records_3002", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_325", i32 1, i8* %"$indices_buf_3000", i32 1), !dbg !304
...
"$have_gas_3024":                                 ; preds = %"$out_of_gas_3023", %"$have_gas_3019"
  ...
  call void %"$ud-registry.recordMemberOwner_fptr_3027"(i8* %"$ud-registry.recordMemberOwner_envptr_3028", [20 x i8]* %"$ud-registry.recordMemberOwner_retalloca_3030", %TName_Option_ud-registry.Record* %"$maybeRecord_3029"), !dbg !305
  %"$ud-registry.recordMemberOwner_ret_3031" = load [20 x i8], [20 x i8]* %"$ud-registry.recordMemberOwner_retalloca_3030", align 1
  store [20 x i8] %"$ud-registry.recordMemberOwner_ret_3031", [20 x i8]* %"$ud-registry.recordMemberOwner_59", align 1, !dbg !305
  %"$$ud-registry.recordMemberOwner_59_3032" = load [20 x i8], [20 x i8]* %"$ud-registry.recordMemberOwner_59", align 1
  store [20 x i8] %"$$ud-registry.recordMemberOwner_59_3032", [20 x i8]* %recordOwner, align 1, !dbg !305
...
"$have_gas_3041":                                 ; preds = %"$out_of_gas_3040", %"$have_gas_3036"
  ...
  %"$eq_call_3049" = call %TName_Bool* @_eq_ByStrX(i8* %"$execptr_load_3043", i32 20, i8* %"$$eq__sender_3044_3045", i8* %"$$eq_recordOwner_3046_3048"), !dbg !306
  store %TName_Bool* %"$eq_call_3049", %TName_Bool** %isSenderNodeOwner, align 8, !dbg !306
...
"$True_3061":                                     ; preds = %"$have_gas_3054"
  ...
  %"$maybeApproved_call_3067" = call i8* @_fetch_field(i8* %"$execptr_load_3066", i8* getelementptr inbounds ([10 x i8], [10 x i8]* @"$approvals_3065", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_324", i32 1, i8* %"$indices_buf_3063", i32 1), !dbg !308
...
"$have_gas_3099":                                 ; preds = %"$out_of_gas_3098", %"$None_3094"
  ...
  store [20 x i8] %"$ud-registry.zeroByStr20_3101", [20 x i8]* %currentlyApproved, align 1, !dbg !312
...
"$have_gas_3109":                                 ; preds = %"$out_of_gas_3108", %"$Some_3102"
  ...
  store [20 x i8] %"$approved_3111", [20 x i8]* %currentlyApproved, align 1, !dbg !315
  br label %"$matchsucc_3089"
...
"$have_gas_3125":                                 ; preds = %"$out_of_gas_3124", %"$have_gas_3120"
  ...
  %"$eq_call_3133" = call %TName_Bool* @_eq_ByStrX(i8* %"$execptr_load_3127", i32 20, i8* %"$$eq_currentlyApproved_3128_3130", i8* %"$$eq_address_3131_3132"), !dbg !317
  store %TName_Bool* %"$eq_call_3133", %TName_Bool** %b, align 8, !dbg !317
...
"$have_gas_3138":                                 ; preds = %"$out_of_gas_3137", %"$have_gas_3125"
  ...
  %"$BoolUtils.negb_call_3144" = call %TName_Bool* %"$BoolUtils.negb_fptr_3141"(i8* %"$BoolUtils.negb_envptr_3142", %TName_Bool* %"$b_3143"), !dbg !318
  store %TName_Bool* %"$BoolUtils.negb_call_3144", %TName_Bool** %"$BoolUtils.negb_57", align 8, !dbg !318
  %"$$BoolUtils.negb_57_3145" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.negb_57", align 8
  store %TName_Bool* %"$$BoolUtils.negb_57_3145", %TName_Bool** %needsToChange, align 8, !dbg !318
...
"$have_gas_3165":                                 ; preds = %"$out_of_gas_3164", %"$True_3156"
  ...
  call void @_update_field(i8* %"$execptr_load_3169", i8* getelementptr inbounds ([10 x i8], [10 x i8]* @"$approvals_3170", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_324", i32 1, i8* %"$indices_buf_3167", i8* %"$update_value_3172"), !dbg !320
...
"$have_gas_3181":                                 ; preds = %"$out_of_gas_3180", %"$have_gas_3176"
  ...
  %"$ud-registry.eApproved_call_3187" = call i8* %"$ud-registry.eApproved_fptr_3184"(i8* %"$ud-registry.eApproved_envptr_3185", [20 x i8]* %"$ud-registry.eApproved_address_3186"), !dbg !323
  store i8* %"$ud-registry.eApproved_call_3187", i8** %"$ud-registry.eApproved_56", align 8, !dbg !323
  %"$$ud-registry.eApproved_56_3188" = load i8*, i8** %"$ud-registry.eApproved_56", align 8
  store i8* %"$$ud-registry.eApproved_56_3188", i8** %e, align 8, !dbg !323
...
"$have_gas_3195":                                 ; preds = %"$out_of_gas_3194", %"$have_gas_3181"
  ...
  call void @_event(i8* %"$execptr_load_3197", %_TyDescrTy_Typ* @"$TyDescr_Event_301", i8* %"$e_3198"), !dbg !324
...
"$have_gas_3214":                                 ; preds = %"$out_of_gas_3213", %"$have_gas_3209"
  ...
  store %String { i8* getelementptr inbounds ([21 x i8], [21 x i8]* @"$stringlit_3216", i32 0, i32 0), i32 21 }, %String* %m, align 8, !dbg !325
...
"$have_gas_3220":                                 ; preds = %"$out_of_gas_3219", %"$have_gas_3214"
  ...
  %"$ud-registry.eError_call_3226" = call i8* %"$ud-registry.eError_fptr_3223"(i8* %"$ud-registry.eError_envptr_3224", %String %"$m_3225"), !dbg !327
  store i8* %"$ud-registry.eError_call_3226", i8** %"$ud-registry.eError_58", align 8, !dbg !327
  %"$$ud-registry.eError_58_3227" = load i8*, i8** %"$ud-registry.eError_58", align 8
  store i8* %"$$ud-registry.eError_58_3227", i8** %e3, align 8, !dbg !327
...
"$have_gas_3234":                                 ; preds = %"$out_of_gas_3233", %"$have_gas_3220"
  ...
  call void @_event(i8* %"$execptr_load_3236", %_TyDescrTy_Typ* @"$TyDescr_Event_301", i8* %"$e_3237"), !dbg !328
  br label %"$matchsucc_3056"
...
entry:
  ...
  call void @"$approve_2995"(%Uint128 %_amount, [20 x i8]* %"$_origin_3242", [20 x i8]* %"$_sender_3244", [32 x i8]* %"$node_3246", [20 x i8]* %"$address_3248"), !dbg !330
  ret void
}

define internal void @"$approveFor_3249"(%Uint128 %_amount, [20 x i8]* %"$_origin_3250", [20 x i8]* %"$_sender_3251", [20 x i8]* %"$address_3252", %TName_Bool* %isApproved) !dbg !331 {
entry:
  ...
  %"$maybeOperators_call_3257" = call i8* @_fetch_field(i8* %"$execptr_load_3256", i8* getelementptr inbounds ([10 x i8], [10 x i8]* @"$operators_3255", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_323", i32 1, i8* %"$indices_buf_3253", i32 1), !dbg !332
...
"$have_gas_3289":                                 ; preds = %"$out_of_gas_3288", %"$None_3284"
  ...
  store %TName_List_ByStr20* %"$ud-registry.nilByStr20_3291", %TName_List_ByStr20** %currentOperators, align 8, !dbg !334
...
"$have_gas_3299":                                 ; preds = %"$out_of_gas_3298", %"$Some_3292"
  ...
  store %TName_List_ByStr20* %"$ops_3301", %TName_List_ByStr20** %currentOperators, align 8, !dbg !337
  br label %"$matchsucc_3279"
...
"$have_gas_3315":                                 ; preds = %"$out_of_gas_3314", %"$have_gas_3310"
  ...
  %"$ud-registry.listByStr20Excludes_call_3321" = call { %TName_Bool* (i8*, [20 x i8]*)*, i8* } %"$ud-registry.listByStr20Excludes_fptr_3318"(i8* %"$ud-registry.listByStr20Excludes_envptr_3319", %TName_List_ByStr20* %"$currentOperators_3320"), !dbg !339
  store { %TName_Bool* (i8*, [20 x i8]*)*, i8* } %"$ud-registry.listByStr20Excludes_call_3321", { %TName_Bool* (i8*, [20 x i8]*)*, i8* }* %"$ud-registry.listByStr20Excludes_65", align 8, !dbg !339
  ...
  %"$$ud-registry.listByStr20Excludes_65_call_3326" = call %TName_Bool* %"$$ud-registry.listByStr20Excludes_65_fptr_3323"(i8* %"$$ud-registry.listByStr20Excludes_65_envptr_3324", [20 x i8]* %"$$ud-registry.listByStr20Excludes_65_address_3325"), !dbg !339
  store %TName_Bool* %"$$ud-registry.listByStr20Excludes_65_call_3326", %TName_Bool** %"$ud-registry.listByStr20Excludes_66", align 8, !dbg !339
  %"$$ud-registry.listByStr20Excludes_66_3327" = load %TName_Bool*, %TName_Bool** %"$ud-registry.listByStr20Excludes_66", align 8
  store %TName_Bool* %"$$ud-registry.listByStr20Excludes_66_3327", %TName_Bool** %b, align 8, !dbg !339
...
"$have_gas_3331":                                 ; preds = %"$out_of_gas_3330", %"$have_gas_3315"
  ...
  %"$ud-registry.xandb_call_3337" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$ud-registry.xandb_fptr_3334"(i8* %"$ud-registry.xandb_envptr_3335", %TName_Bool* %"$b_3336"), !dbg !340
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$ud-registry.xandb_call_3337", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$ud-registry.xandb_67", align 8, !dbg !340
  ...
  %"$$ud-registry.xandb_67_call_3341" = call %TName_Bool* %"$$ud-registry.xandb_67_fptr_3339"(i8* %"$$ud-registry.xandb_67_envptr_3340", %TName_Bool* %isApproved), !dbg !340
  store %TName_Bool* %"$$ud-registry.xandb_67_call_3341", %TName_Bool** %"$ud-registry.xandb_68", align 8, !dbg !340
  %"$$ud-registry.xandb_68_3342" = load %TName_Bool*, %TName_Bool** %"$ud-registry.xandb_68", align 8
  store %TName_Bool* %"$$ud-registry.xandb_68_3342", %TName_Bool** %needsToChange, align 8, !dbg !340
...
"$have_gas_3374":                                 ; preds = %"$out_of_gas_3373", %"$True_3369"
  ...
  store %TName_List_ByStr20* %"$adtptr_3381", %TName_List_ByStr20** %newOperators, align 8, !dbg !345
...
"$have_gas_3387":                                 ; preds = %"$out_of_gas_3386", %"$False_3382"
  ...
  %"$ud-registry.listByStr20FilterOut_call_3393" = call { %TName_List_ByStr20* (i8*, [20 x i8]*)*, i8* } %"$ud-registry.listByStr20FilterOut_fptr_3390"(i8* %"$ud-registry.listByStr20FilterOut_envptr_3391", %TName_List_ByStr20* %"$currentOperators_3392"), !dbg !348
  store { %TName_List_ByStr20* (i8*, [20 x i8]*)*, i8* } %"$ud-registry.listByStr20FilterOut_call_3393", { %TName_List_ByStr20* (i8*, [20 x i8]*)*, i8* }* %"$ud-registry.listByStr20FilterOut_63", align 8, !dbg !348
  ...
  %"$$ud-registry.listByStr20FilterOut_63_call_3398" = call %TName_List_ByStr20* %"$$ud-registry.listByStr20FilterOut_63_fptr_3395"(i8* %"$$ud-registry.listByStr20FilterOut_63_envptr_3396", [20 x i8]* %"$$ud-registry.listByStr20FilterOut_63_address_3397"), !dbg !348
  store %TName_List_ByStr20* %"$$ud-registry.listByStr20FilterOut_63_call_3398", %TName_List_ByStr20** %"$ud-registry.listByStr20FilterOut_64", align 8, !dbg !348
  ...
  store %TName_List_ByStr20* %"$$ud-registry.listByStr20FilterOut_64_3399", %TName_List_ByStr20** %newOperators, align 8, !dbg !348
  br label %"$matchsucc_3365"
...
"$have_gas_3407":                                 ; preds = %"$out_of_gas_3406", %"$matchsucc_3365"
  ...
  call void @_update_field(i8* %"$execptr_load_3411", i8* getelementptr inbounds ([10 x i8], [10 x i8]* @"$operators_3412", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_323", i32 1, i8* %"$indices_buf_3409", i8* %"$update_value_3414"), !dbg !350
...
"$have_gas_3423":                                 ; preds = %"$out_of_gas_3422", %"$have_gas_3418"
  ...
  %"$ud-registry.eApprovedFor_call_3429" = call { { i8* (i8*, %TName_Bool*)*, i8* } (i8*, [20 x i8]*)*, i8* } %"$ud-registry.eApprovedFor_fptr_3426"(i8* %"$ud-registry.eApprovedFor_envptr_3427", [20 x i8]* %"$ud-registry.eApprovedFor__sender_3428"), !dbg !351
  store { { i8* (i8*, %TName_Bool*)*, i8* } (i8*, [20 x i8]*)*, i8* } %"$ud-registry.eApprovedFor_call_3429", { { i8* (i8*, %TName_Bool*)*, i8* } (i8*, [20 x i8]*)*, i8* }* %"$ud-registry.eApprovedFor_60", align 8, !dbg !351
  ...
  %"$$ud-registry.eApprovedFor_60_call_3434" = call { i8* (i8*, %TName_Bool*)*, i8* } %"$$ud-registry.eApprovedFor_60_fptr_3431"(i8* %"$$ud-registry.eApprovedFor_60_envptr_3432", [20 x i8]* %"$$ud-registry.eApprovedFor_60_address_3433"), !dbg !351
  store { i8* (i8*, %TName_Bool*)*, i8* } %"$$ud-registry.eApprovedFor_60_call_3434", { i8* (i8*, %TName_Bool*)*, i8* }* %"$ud-registry.eApprovedFor_61", align 8, !dbg !351
  ...
  %"$$ud-registry.eApprovedFor_61_call_3438" = call i8* %"$$ud-registry.eApprovedFor_61_fptr_3436"(i8* %"$$ud-registry.eApprovedFor_61_envptr_3437", %TName_Bool* %isApproved), !dbg !351
  store i8* %"$$ud-registry.eApprovedFor_61_call_3438", i8** %"$ud-registry.eApprovedFor_62", align 8, !dbg !351
  %"$$ud-registry.eApprovedFor_62_3439" = load i8*, i8** %"$ud-registry.eApprovedFor_62", align 8
  store i8* %"$$ud-registry.eApprovedFor_62_3439", i8** %e, align 8, !dbg !351
...
"$have_gas_3446":                                 ; preds = %"$out_of_gas_3445", %"$have_gas_3423"
  ...
  call void @_event(i8* %"$execptr_load_3448", %_TyDescrTy_Typ* @"$TyDescr_Event_301", i8* %"$e_3449"), !dbg !352
...
entry:
  ...
  call void @"$approveFor_3249"(%Uint128 %_amount, [20 x i8]* %"$_origin_3454", [20 x i8]* %"$_sender_3456", [20 x i8]* %"$address_3458", %TName_Bool* %isApproved), !dbg !354
  ret void
}

define internal void @"$configureNode_3461"(%Uint128 %_amount, [20 x i8]* %"$_origin_3462", [20 x i8]* %"$_sender_3463", [32 x i8]* %"$node_3464", [20 x i8]* %"$owner_3465", [20 x i8]* %"$resolver_3466") !dbg !355 {
entry:
  ...
  %"$maybeRecord_call_3471" = call i8* @_fetch_field(i8* %"$execptr_load_3470", i8* getelementptr inbounds ([8 x i8], [8 x i8]* @"$records_3469", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_325", i32 1, i8* %"$indices_buf_3467", i32 1), !dbg !356
...
"$have_gas_3481":                                 ; preds = %"$out_of_gas_3480", %entry
  ...
  %"$maybeApproved_call_3487" = call i8* @_fetch_field(i8* %"$execptr_load_3486", i8* getelementptr inbounds ([10 x i8], [10 x i8]* @"$approvals_3485", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_324", i32 1, i8* %"$indices_buf_3483", i32 1), !dbg !357
...
"$have_gas_3507":                                 ; preds = %"$out_of_gas_3506", %"$have_gas_3502"
  ...
  call void %"$ud-registry.recordMemberOwner_fptr_3510"(i8* %"$ud-registry.recordMemberOwner_envptr_3511", [20 x i8]* %"$ud-registry.recordMemberOwner_retalloca_3513", %TName_Option_ud-registry.Record* %"$maybeRecord_3512"), !dbg !358
  %"$ud-registry.recordMemberOwner_ret_3514" = load [20 x i8], [20 x i8]* %"$ud-registry.recordMemberOwner_retalloca_3513", align 1
  store [20 x i8] %"$ud-registry.recordMemberOwner_ret_3514", [20 x i8]* %"$ud-registry.recordMemberOwner_79", align 1, !dbg !358
  %"$$ud-registry.recordMemberOwner_79_3515" = load [20 x i8], [20 x i8]* %"$ud-registry.recordMemberOwner_79", align 1
  store [20 x i8] %"$$ud-registry.recordMemberOwner_79_3515", [20 x i8]* %recordOwner, align 1, !dbg !358
  %maybeOperators = alloca %"TName_Option_List_(ByStr20)"*, align 8
  ...
  %"$maybeOperators_call_3521" = call i8* @_fetch_field(i8* %"$execptr_load_3520", i8* getelementptr inbounds ([10 x i8], [10 x i8]* @"$operators_3519", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_323", i32 1, i8* %"$indices_buf_3516", i32 1), !dbg !359
...
"$have_gas_3541":                                 ; preds = %"$out_of_gas_3540", %"$have_gas_3536"
  ...
  %"$ud-registry.getIsOAO_call_3547" = call { { { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* } (i8*, %TName_Option_ByStr20*)*, i8* } (i8*, [20 x i8]*)*, i8* } %"$ud-registry.getIsOAO_fptr_3544"(i8* %"$ud-registry.getIsOAO_envptr_3545", [20 x i8]* %"$ud-registry.getIsOAO__sender_3546"), !dbg !360
  store { { { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* } (i8*, %TName_Option_ByStr20*)*, i8* } (i8*, [20 x i8]*)*, i8* } %"$ud-registry.getIsOAO_call_3547", { { { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* } (i8*, %TName_Option_ByStr20*)*, i8* } (i8*, [20 x i8]*)*, i8* }* %"$ud-registry.getIsOAO_75", align 8, !dbg !360
  ...
  %"$$ud-registry.getIsOAO_75_call_3553" = call { { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* } (i8*, %TName_Option_ByStr20*)*, i8* } %"$$ud-registry.getIsOAO_75_fptr_3549"(i8* %"$$ud-registry.getIsOAO_75_envptr_3550", [20 x i8]* %"$$ud-registry.getIsOAO_75_recordOwner_3551"), !dbg !360
  store { { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* } (i8*, %TName_Option_ByStr20*)*, i8* } %"$$ud-registry.getIsOAO_75_call_3553", { { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* } (i8*, %TName_Option_ByStr20*)*, i8* }* %"$ud-registry.getIsOAO_76", align 8, !dbg !360
  ...
  %"$$ud-registry.getIsOAO_76_call_3558" = call { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* } %"$$ud-registry.getIsOAO_76_fptr_3555"(i8* %"$$ud-registry.getIsOAO_76_envptr_3556", %TName_Option_ByStr20* %"$maybeApproved_3557"), !dbg !360
  store { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* } %"$$ud-registry.getIsOAO_76_call_3558", { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* }* %"$ud-registry.getIsOAO_77", align 8, !dbg !360
  ...
  %"$$ud-registry.getIsOAO_77_call_3563" = call %TName_Bool* %"$$ud-registry.getIsOAO_77_fptr_3560"(i8* %"$$ud-registry.getIsOAO_77_envptr_3561", %"TName_Option_List_(ByStr20)"* %"$maybeOperators_3562"), !dbg !360
  store %TName_Bool* %"$$ud-registry.getIsOAO_77_call_3563", %TName_Bool** %"$ud-registry.getIsOAO_78", align 8, !dbg !360
  %"$$ud-registry.getIsOAO_78_3564" = load %TName_Bool*, %TName_Bool** %"$ud-registry.getIsOAO_78", align 8
  store %TName_Bool* %"$$ud-registry.getIsOAO_78_3564", %TName_Bool** %isSenderOAO, align 8, !dbg !360
...
"$have_gas_3585":                                 ; preds = %"$out_of_gas_3584", %"$have_gas_3580"
  ...
  store %TName_ud-registry.Record* %"$adtptr_3591", %TName_ud-registry.Record** %newRecord, align 8, !dbg !362
...
"$have_gas_3599":                                 ; preds = %"$out_of_gas_3598", %"$have_gas_3585"
  ...
  call void @_update_field(i8* %"$execptr_load_3603", i8* getelementptr inbounds ([8 x i8], [8 x i8]* @"$records_3604", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_325", i32 1, i8* %"$indices_buf_3601", i8* %"$update_value_3606"), !dbg !365
...
"$have_gas_3615":                                 ; preds = %"$out_of_gas_3614", %"$have_gas_3610"
  ...
  %"$ud-registry.eConfigured_call_3621" = call { { i8* (i8*, [20 x i8]*)*, i8* } (i8*, [20 x i8]*)*, i8* } %"$ud-registry.eConfigured_fptr_3618"(i8* %"$ud-registry.eConfigured_envptr_3619", [32 x i8]* %"$ud-registry.eConfigured_node_3620"), !dbg !366
  store { { i8* (i8*, [20 x i8]*)*, i8* } (i8*, [20 x i8]*)*, i8* } %"$ud-registry.eConfigured_call_3621", { { i8* (i8*, [20 x i8]*)*, i8* } (i8*, [20 x i8]*)*, i8* }* %"$ud-registry.eConfigured_70", align 8, !dbg !366
  ...
  %"$$ud-registry.eConfigured_70_call_3626" = call { i8* (i8*, [20 x i8]*)*, i8* } %"$$ud-registry.eConfigured_70_fptr_3623"(i8* %"$$ud-registry.eConfigured_70_envptr_3624", [20 x i8]* %"$$ud-registry.eConfigured_70_owner_3625"), !dbg !366
  store { i8* (i8*, [20 x i8]*)*, i8* } %"$$ud-registry.eConfigured_70_call_3626", { i8* (i8*, [20 x i8]*)*, i8* }* %"$ud-registry.eConfigured_71", align 8, !dbg !366
  ...
  %"$$ud-registry.eConfigured_71_call_3631" = call i8* %"$$ud-registry.eConfigured_71_fptr_3628"(i8* %"$$ud-registry.eConfigured_71_envptr_3629", [20 x i8]* %"$$ud-registry.eConfigured_71_resolver_3630"), !dbg !366
  store i8* %"$$ud-registry.eConfigured_71_call_3631", i8** %"$ud-registry.eConfigured_72", align 8, !dbg !366
  %"$$ud-registry.eConfigured_72_3632" = load i8*, i8** %"$ud-registry.eConfigured_72", align 8
  store i8* %"$$ud-registry.eConfigured_72_3632", i8** %e, align 8, !dbg !366
...
"$have_gas_3639":                                 ; preds = %"$out_of_gas_3638", %"$have_gas_3615"
  ...
  call void @_event(i8* %"$execptr_load_3641", %_TyDescrTy_Typ* @"$TyDescr_Event_301", i8* %"$e_3642"), !dbg !367
...
"$have_gas_3656":                                 ; preds = %"$out_of_gas_3655", %"$have_gas_3651"
  ...
  store i8* %"$msgobj_3658", i8** %m, align 8, !dbg !368
...
"$have_gas_3699":                                 ; preds = %"$out_of_gas_3698", %"$have_gas_3656"
  ...
  %"$ud-registry.oneMsg_call_3705" = call %TName_List_Message* %"$ud-registry.oneMsg_fptr_3702"(i8* %"$ud-registry.oneMsg_envptr_3703", i8* %"$m_3704"), !dbg !369
  store %TName_List_Message* %"$ud-registry.oneMsg_call_3705", %TName_List_Message** %"$ud-registry.oneMsg_69", align 8, !dbg !369
  %"$$ud-registry.oneMsg_69_3706" = load %TName_List_Message*, %TName_List_Message** %"$ud-registry.oneMsg_69", align 8
  store %TName_List_Message* %"$$ud-registry.oneMsg_69_3706", %TName_List_Message** %msgs, align 8, !dbg !369
...
"$have_gas_3713":                                 ; preds = %"$out_of_gas_3712", %"$have_gas_3699"
  ...
  call void @_send(i8* %"$execptr_load_3715", %_TyDescrTy_Typ* @"$TyDescr_ADT_List_Message_319", %TName_List_Message* %"$msgs_3716"), !dbg !370
...
"$have_gas_3732":                                 ; preds = %"$out_of_gas_3731", %"$have_gas_3727"
  ...
  store %String { i8* getelementptr inbounds ([43 x i8], [43 x i8]* @"$stringlit_3734", i32 0, i32 0), i32 43 }, %String* %m5, align 8, !dbg !371
...
"$have_gas_3738":                                 ; preds = %"$out_of_gas_3737", %"$have_gas_3732"
  ...
  %"$ud-registry.eError_call_3744" = call i8* %"$ud-registry.eError_fptr_3741"(i8* %"$ud-registry.eError_envptr_3742", %String %"$m_3743"), !dbg !373
  store i8* %"$ud-registry.eError_call_3744", i8** %"$ud-registry.eError_74", align 8, !dbg !373
  %"$$ud-registry.eError_74_3745" = load i8*, i8** %"$ud-registry.eError_74", align 8
  store i8* %"$$ud-registry.eError_74_3745", i8** %e4, align 8, !dbg !373
...
"$have_gas_3752":                                 ; preds = %"$out_of_gas_3751", %"$have_gas_3738"
  ...
  call void @_event(i8* %"$execptr_load_3754", %_TyDescrTy_Typ* @"$TyDescr_Event_301", i8* %"$e_3755"), !dbg !374
...
"$have_gas_3769":                                 ; preds = %"$out_of_gas_3768", %"$have_gas_3764"
  ...
  store i8* %"$msgobj_3771", i8** %"$m_0", align 8, !dbg !375
...
"$have_gas_3813":                                 ; preds = %"$out_of_gas_3812", %"$have_gas_3769"
  ...
  %"$ud-registry.oneMsg_call_3819" = call %TName_List_Message* %"$ud-registry.oneMsg_fptr_3816"(i8* %"$ud-registry.oneMsg_envptr_3817", i8* %"$$m_0_3818"), !dbg !376
  store %TName_List_Message* %"$ud-registry.oneMsg_call_3819", %TName_List_Message** %"$ud-registry.oneMsg_73", align 8, !dbg !376
  %"$$ud-registry.oneMsg_73_3820" = load %TName_List_Message*, %TName_List_Message** %"$ud-registry.oneMsg_73", align 8
  store %TName_List_Message* %"$$ud-registry.oneMsg_73_3820", %TName_List_Message** %msgs6, align 8, !dbg !376
...
"$have_gas_3827":                                 ; preds = %"$out_of_gas_3826", %"$have_gas_3813"
  ...
  call void @_send(i8* %"$execptr_load_3829", %_TyDescrTy_Typ* @"$TyDescr_ADT_List_Message_319", %TName_List_Message* %"$msgs_3830"), !dbg !377
  br label %"$matchsucc_3570"
...
entry:
  ...
  call void @"$configureNode_3461"(%Uint128 %_amount, [20 x i8]* %"$_origin_3835", [20 x i8]* %"$_sender_3837", [32 x i8]* %"$node_3839", [20 x i8]* %"$owner_3841", [20 x i8]* %"$resolver_3843"), !dbg !379
  ret void
}

define internal void @"$configureResolver_3844"(%Uint128 %_amount, [20 x i8]* %"$_origin_3845", [20 x i8]* %"$_sender_3846", [32 x i8]* %"$node_3847", [20 x i8]* %"$resolver_3848") !dbg !380 {
entry:
  ...
  %"$maybeRecord_call_3853" = call i8* @_fetch_field(i8* %"$execptr_load_3852", i8* getelementptr inbounds ([8 x i8], [8 x i8]* @"$records_3851", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_325", i32 1, i8* %"$indices_buf_3849", i32 1), !dbg !381
...
"$have_gas_3863":                                 ; preds = %"$out_of_gas_3862", %entry
  ...
  %"$maybeApproved_call_3869" = call i8* @_fetch_field(i8* %"$execptr_load_3868", i8* getelementptr inbounds ([10 x i8], [10 x i8]* @"$approvals_3867", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_324", i32 1, i8* %"$indices_buf_3865", i32 1), !dbg !382
...
"$have_gas_3889":                                 ; preds = %"$out_of_gas_3888", %"$have_gas_3884"
  ...
  call void %"$ud-registry.recordMemberOwner_fptr_3892"(i8* %"$ud-registry.recordMemberOwner_envptr_3893", [20 x i8]* %"$ud-registry.recordMemberOwner_retalloca_3895", %TName_Option_ud-registry.Record* %"$maybeRecord_3894"), !dbg !383
  %"$ud-registry.recordMemberOwner_ret_3896" = load [20 x i8], [20 x i8]* %"$ud-registry.recordMemberOwner_retalloca_3895", align 1
  store [20 x i8] %"$ud-registry.recordMemberOwner_ret_3896", [20 x i8]* %"$ud-registry.recordMemberOwner_88", align 1, !dbg !383
  %"$$ud-registry.recordMemberOwner_88_3897" = load [20 x i8], [20 x i8]* %"$ud-registry.recordMemberOwner_88", align 1
  store [20 x i8] %"$$ud-registry.recordMemberOwner_88_3897", [20 x i8]* %recordOwner, align 1, !dbg !383
  %maybeOperators = alloca %"TName_Option_List_(ByStr20)"*, align 8
  ...
  %"$maybeOperators_call_3903" = call i8* @_fetch_field(i8* %"$execptr_load_3902", i8* getelementptr inbounds ([10 x i8], [10 x i8]* @"$operators_3901", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_323", i32 1, i8* %"$indices_buf_3898", i32 1), !dbg !384
...
"$have_gas_3923":                                 ; preds = %"$out_of_gas_3922", %"$have_gas_3918"
  ...
  %"$ud-registry.getIsOAO_call_3929" = call { { { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* } (i8*, %TName_Option_ByStr20*)*, i8* } (i8*, [20 x i8]*)*, i8* } %"$ud-registry.getIsOAO_fptr_3926"(i8* %"$ud-registry.getIsOAO_envptr_3927", [20 x i8]* %"$ud-registry.getIsOAO__sender_3928"), !dbg !385
  store { { { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* } (i8*, %TName_Option_ByStr20*)*, i8* } (i8*, [20 x i8]*)*, i8* } %"$ud-registry.getIsOAO_call_3929", { { { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* } (i8*, %TName_Option_ByStr20*)*, i8* } (i8*, [20 x i8]*)*, i8* }* %"$ud-registry.getIsOAO_84", align 8, !dbg !385
  ...
  %"$$ud-registry.getIsOAO_84_call_3935" = call { { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* } (i8*, %TName_Option_ByStr20*)*, i8* } %"$$ud-registry.getIsOAO_84_fptr_3931"(i8* %"$$ud-registry.getIsOAO_84_envptr_3932", [20 x i8]* %"$$ud-registry.getIsOAO_84_recordOwner_3933"), !dbg !385
  store { { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* } (i8*, %TName_Option_ByStr20*)*, i8* } %"$$ud-registry.getIsOAO_84_call_3935", { { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* } (i8*, %TName_Option_ByStr20*)*, i8* }* %"$ud-registry.getIsOAO_85", align 8, !dbg !385
  ...
  %"$$ud-registry.getIsOAO_85_call_3940" = call { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* } %"$$ud-registry.getIsOAO_85_fptr_3937"(i8* %"$$ud-registry.getIsOAO_85_envptr_3938", %TName_Option_ByStr20* %"$maybeApproved_3939"), !dbg !385
  store { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* } %"$$ud-registry.getIsOAO_85_call_3940", { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* }* %"$ud-registry.getIsOAO_86", align 8, !dbg !385
  ...
  %"$$ud-registry.getIsOAO_86_call_3945" = call %TName_Bool* %"$$ud-registry.getIsOAO_86_fptr_3942"(i8* %"$$ud-registry.getIsOAO_86_envptr_3943", %"TName_Option_List_(ByStr20)"* %"$maybeOperators_3944"), !dbg !385
  store %TName_Bool* %"$$ud-registry.getIsOAO_86_call_3945", %TName_Bool** %"$ud-registry.getIsOAO_87", align 8, !dbg !385
  %"$$ud-registry.getIsOAO_87_3946" = load %TName_Bool*, %TName_Bool** %"$ud-registry.getIsOAO_87", align 8
  store %TName_Bool* %"$$ud-registry.getIsOAO_87_3946", %TName_Bool** %isSenderOAO, align 8, !dbg !385
...
"$have_gas_3967":                                 ; preds = %"$out_of_gas_3966", %"$have_gas_3962"
  ...
  store %TName_ud-registry.Record* %"$adtptr_3974", %TName_ud-registry.Record** %newRecord, align 8, !dbg !387
...
"$have_gas_3982":                                 ; preds = %"$out_of_gas_3981", %"$have_gas_3967"
  ...
  call void @_update_field(i8* %"$execptr_load_3986", i8* getelementptr inbounds ([8 x i8], [8 x i8]* @"$records_3987", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_325", i32 1, i8* %"$indices_buf_3984", i8* %"$update_value_3989"), !dbg !390
...
"$have_gas_3998":                                 ; preds = %"$out_of_gas_3997", %"$have_gas_3993"
  ...
  %"$ud-registry.eConfigured_call_4004" = call { { i8* (i8*, [20 x i8]*)*, i8* } (i8*, [20 x i8]*)*, i8* } %"$ud-registry.eConfigured_fptr_4001"(i8* %"$ud-registry.eConfigured_envptr_4002", [32 x i8]* %"$ud-registry.eConfigured_node_4003"), !dbg !391
  store { { i8* (i8*, [20 x i8]*)*, i8* } (i8*, [20 x i8]*)*, i8* } %"$ud-registry.eConfigured_call_4004", { { i8* (i8*, [20 x i8]*)*, i8* } (i8*, [20 x i8]*)*, i8* }* %"$ud-registry.eConfigured_80", align 8, !dbg !391
  ...
  %"$$ud-registry.eConfigured_80_call_4010" = call { i8* (i8*, [20 x i8]*)*, i8* } %"$$ud-registry.eConfigured_80_fptr_4006"(i8* %"$$ud-registry.eConfigured_80_envptr_4007", [20 x i8]* %"$$ud-registry.eConfigured_80_recordOwner_4008"), !dbg !391
  store { i8* (i8*, [20 x i8]*)*, i8* } %"$$ud-registry.eConfigured_80_call_4010", { i8* (i8*, [20 x i8]*)*, i8* }* %"$ud-registry.eConfigured_81", align 8, !dbg !391
  ...
  %"$$ud-registry.eConfigured_81_call_4015" = call i8* %"$$ud-registry.eConfigured_81_fptr_4012"(i8* %"$$ud-registry.eConfigured_81_envptr_4013", [20 x i8]* %"$$ud-registry.eConfigured_81_resolver_4014"), !dbg !391
  store i8* %"$$ud-registry.eConfigured_81_call_4015", i8** %"$ud-registry.eConfigured_82", align 8, !dbg !391
  %"$$ud-registry.eConfigured_82_4016" = load i8*, i8** %"$ud-registry.eConfigured_82", align 8
  store i8* %"$$ud-registry.eConfigured_82_4016", i8** %e, align 8, !dbg !391
...
"$have_gas_4023":                                 ; preds = %"$out_of_gas_4022", %"$have_gas_3998"
  ...
  call void @_event(i8* %"$execptr_load_4025", %_TyDescrTy_Typ* @"$TyDescr_Event_301", i8* %"$e_4026"), !dbg !392
...
"$have_gas_4042":                                 ; preds = %"$out_of_gas_4041", %"$have_gas_4037"
  ...
  store %String { i8* getelementptr inbounds ([43 x i8], [43 x i8]* @"$stringlit_4044", i32 0, i32 0), i32 43 }, %String* %m, align 8, !dbg !393
...
"$have_gas_4048":                                 ; preds = %"$out_of_gas_4047", %"$have_gas_4042"
  ...
  %"$ud-registry.eError_call_4054" = call i8* %"$ud-registry.eError_fptr_4051"(i8* %"$ud-registry.eError_envptr_4052", %String %"$m_4053"), !dbg !395
  store i8* %"$ud-registry.eError_call_4054", i8** %"$ud-registry.eError_83", align 8, !dbg !395
  %"$$ud-registry.eError_83_4055" = load i8*, i8** %"$ud-registry.eError_83", align 8
  store i8* %"$$ud-registry.eError_83_4055", i8** %e4, align 8, !dbg !395
...
"$have_gas_4062":                                 ; preds = %"$out_of_gas_4061", %"$have_gas_4048"
  ...
  call void @_event(i8* %"$execptr_load_4064", %_TyDescrTy_Typ* @"$TyDescr_Event_301", i8* %"$e_4065"), !dbg !396
  br label %"$matchsucc_3952"
...
entry:
  ...
  call void @"$configureResolver_3844"(%Uint128 %_amount, [20 x i8]* %"$_origin_4070", [20 x i8]* %"$_sender_4072", [32 x i8]* %"$node_4074", [20 x i8]* %"$resolver_4076"), !dbg !398
  ret void
}

define internal void @"$transfer_4077"(%Uint128 %_amount, [20 x i8]* %"$_origin_4078", [20 x i8]* %"$_sender_4079", [32 x i8]* %"$node_4080", [20 x i8]* %"$owner_4081") !dbg !399 {
entry:
  ...
  %"$maybeRecord_call_4086" = call i8* @_fetch_field(i8* %"$execptr_load_4085", i8* getelementptr inbounds ([8 x i8], [8 x i8]* @"$records_4084", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_325", i32 1, i8* %"$indices_buf_4082", i32 1), !dbg !400
...
"$have_gas_4096":                                 ; preds = %"$out_of_gas_4095", %entry
  ...
  %"$maybeApproved_call_4102" = call i8* @_fetch_field(i8* %"$execptr_load_4101", i8* getelementptr inbounds ([10 x i8], [10 x i8]* @"$approvals_4100", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_324", i32 1, i8* %"$indices_buf_4098", i32 1), !dbg !401
...
"$have_gas_4122":                                 ; preds = %"$out_of_gas_4121", %"$have_gas_4117"
  ...
  call void %"$ud-registry.recordMemberOwner_fptr_4125"(i8* %"$ud-registry.recordMemberOwner_envptr_4126", [20 x i8]* %"$ud-registry.recordMemberOwner_retalloca_4128", %TName_Option_ud-registry.Record* %"$maybeRecord_4127"), !dbg !402
  %"$ud-registry.recordMemberOwner_ret_4129" = load [20 x i8], [20 x i8]* %"$ud-registry.recordMemberOwner_retalloca_4128", align 1
  store [20 x i8] %"$ud-registry.recordMemberOwner_ret_4129", [20 x i8]* %"$ud-registry.recordMemberOwner_99", align 1, !dbg !402
  %"$$ud-registry.recordMemberOwner_99_4130" = load [20 x i8], [20 x i8]* %"$ud-registry.recordMemberOwner_99", align 1
  store [20 x i8] %"$$ud-registry.recordMemberOwner_99_4130", [20 x i8]* %recordOwner, align 1, !dbg !402
  %maybeOperators = alloca %"TName_Option_List_(ByStr20)"*, align 8
  ...
  %"$maybeOperators_call_4136" = call i8* @_fetch_field(i8* %"$execptr_load_4135", i8* getelementptr inbounds ([10 x i8], [10 x i8]* @"$operators_4134", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_323", i32 1, i8* %"$indices_buf_4131", i32 1), !dbg !403
...
"$have_gas_4156":                                 ; preds = %"$out_of_gas_4155", %"$have_gas_4151"
  ...
  %"$ud-registry.getIsOAO_call_4162" = call { { { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* } (i8*, %TName_Option_ByStr20*)*, i8* } (i8*, [20 x i8]*)*, i8* } %"$ud-registry.getIsOAO_fptr_4159"(i8* %"$ud-registry.getIsOAO_envptr_4160", [20 x i8]* %"$ud-registry.getIsOAO__sender_4161"), !dbg !404
  store { { { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* } (i8*, %TName_Option_ByStr20*)*, i8* } (i8*, [20 x i8]*)*, i8* } %"$ud-registry.getIsOAO_call_4162", { { { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* } (i8*, %TName_Option_ByStr20*)*, i8* } (i8*, [20 x i8]*)*, i8* }* %"$ud-registry.getIsOAO_95", align 8, !dbg !404
  ...
  %"$$ud-registry.getIsOAO_95_call_4168" = call { { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* } (i8*, %TName_Option_ByStr20*)*, i8* } %"$$ud-registry.getIsOAO_95_fptr_4164"(i8* %"$$ud-registry.getIsOAO_95_envptr_4165", [20 x i8]* %"$$ud-registry.getIsOAO_95_recordOwner_4166"), !dbg !404
  store { { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* } (i8*, %TName_Option_ByStr20*)*, i8* } %"$$ud-registry.getIsOAO_95_call_4168", { { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* } (i8*, %TName_Option_ByStr20*)*, i8* }* %"$ud-registry.getIsOAO_96", align 8, !dbg !404
  ...
  %"$$ud-registry.getIsOAO_96_call_4173" = call { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* } %"$$ud-registry.getIsOAO_96_fptr_4170"(i8* %"$$ud-registry.getIsOAO_96_envptr_4171", %TName_Option_ByStr20* %"$maybeApproved_4172"), !dbg !404
  store { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* } %"$$ud-registry.getIsOAO_96_call_4173", { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* }* %"$ud-registry.getIsOAO_97", align 8, !dbg !404
  ...
  %"$$ud-registry.getIsOAO_97_call_4178" = call %TName_Bool* %"$$ud-registry.getIsOAO_97_fptr_4175"(i8* %"$$ud-registry.getIsOAO_97_envptr_4176", %"TName_Option_List_(ByStr20)"* %"$maybeOperators_4177"), !dbg !404
  store %TName_Bool* %"$$ud-registry.getIsOAO_97_call_4178", %TName_Bool** %"$ud-registry.getIsOAO_98", align 8, !dbg !404
  %"$$ud-registry.getIsOAO_98_4179" = load %TName_Bool*, %TName_Bool** %"$ud-registry.getIsOAO_98", align 8
  store %TName_Bool* %"$$ud-registry.getIsOAO_98_4179", %TName_Bool** %isSenderOAO, align 8, !dbg !404
...
"$have_gas_4195":                                 ; preds = %"$out_of_gas_4194", %"$True_4190"
  ...
  call void @_update_field(i8* %"$execptr_load_4199", i8* getelementptr inbounds ([10 x i8], [10 x i8]* @"$approvals_4200", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_324", i32 1, i8* %"$indices_buf_4197", i8* null), !dbg !406
...
"$have_gas_4209":                                 ; preds = %"$out_of_gas_4208", %"$have_gas_4204"
  ...
  store %TName_ud-registry.Record* %"$adtptr_4216", %TName_ud-registry.Record** %newRecord, align 8, !dbg !409
...
"$have_gas_4224":                                 ; preds = %"$out_of_gas_4223", %"$have_gas_4209"
  ...
  call void @_update_field(i8* %"$execptr_load_4228", i8* getelementptr inbounds ([8 x i8], [8 x i8]* @"$records_4229", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_325", i32 1, i8* %"$indices_buf_4226", i8* %"$update_value_4231"), !dbg !410
...
"$have_gas_4240":                                 ; preds = %"$out_of_gas_4239", %"$have_gas_4235"
  ...
  %"$ud-registry.eConfigured_call_4246" = call { { i8* (i8*, [20 x i8]*)*, i8* } (i8*, [20 x i8]*)*, i8* } %"$ud-registry.eConfigured_fptr_4243"(i8* %"$ud-registry.eConfigured_envptr_4244", [32 x i8]* %"$ud-registry.eConfigured_node_4245"), !dbg !411
  store { { i8* (i8*, [20 x i8]*)*, i8* } (i8*, [20 x i8]*)*, i8* } %"$ud-registry.eConfigured_call_4246", { { i8* (i8*, [20 x i8]*)*, i8* } (i8*, [20 x i8]*)*, i8* }* %"$ud-registry.eConfigured_90", align 8, !dbg !411
  ...
  %"$$ud-registry.eConfigured_90_call_4251" = call { i8* (i8*, [20 x i8]*)*, i8* } %"$$ud-registry.eConfigured_90_fptr_4248"(i8* %"$$ud-registry.eConfigured_90_envptr_4249", [20 x i8]* %"$$ud-registry.eConfigured_90_owner_4250"), !dbg !411
  store { i8* (i8*, [20 x i8]*)*, i8* } %"$$ud-registry.eConfigured_90_call_4251", { i8* (i8*, [20 x i8]*)*, i8* }* %"$ud-registry.eConfigured_91", align 8, !dbg !411
  ...
  %"$$ud-registry.eConfigured_91_call_4257" = call i8* %"$$ud-registry.eConfigured_91_fptr_4253"(i8* %"$$ud-registry.eConfigured_91_envptr_4254", [20 x i8]* %"$$ud-registry.eConfigured_91_ud-registry.zeroByStr20_4255"), !dbg !411
  store i8* %"$$ud-registry.eConfigured_91_call_4257", i8** %"$ud-registry.eConfigured_92", align 8, !dbg !411
  %"$$ud-registry.eConfigured_92_4258" = load i8*, i8** %"$ud-registry.eConfigured_92", align 8
  store i8* %"$$ud-registry.eConfigured_92_4258", i8** %e, align 8, !dbg !411
...
"$have_gas_4265":                                 ; preds = %"$out_of_gas_4264", %"$have_gas_4240"
  ...
  call void @_event(i8* %"$execptr_load_4267", %_TyDescrTy_Typ* @"$TyDescr_Event_301", i8* %"$e_4268"), !dbg !412
...
"$have_gas_4282":                                 ; preds = %"$out_of_gas_4281", %"$have_gas_4277"
  ...
  store i8* %"$msgobj_4284", i8** %m, align 8, !dbg !413
...
"$have_gas_4325":                                 ; preds = %"$out_of_gas_4324", %"$have_gas_4282"
  ...
  %"$ud-registry.oneMsg_call_4331" = call %TName_List_Message* %"$ud-registry.oneMsg_fptr_4328"(i8* %"$ud-registry.oneMsg_envptr_4329", i8* %"$m_4330"), !dbg !414
  store %TName_List_Message* %"$ud-registry.oneMsg_call_4331", %TName_List_Message** %"$ud-registry.oneMsg_89", align 8, !dbg !414
  %"$$ud-registry.oneMsg_89_4332" = load %TName_List_Message*, %TName_List_Message** %"$ud-registry.oneMsg_89", align 8
  store %TName_List_Message* %"$$ud-registry.oneMsg_89_4332", %TName_List_Message** %msgs, align 8, !dbg !414
...
"$have_gas_4339":                                 ; preds = %"$out_of_gas_4338", %"$have_gas_4325"
  ...
  call void @_send(i8* %"$execptr_load_4341", %_TyDescrTy_Typ* @"$TyDescr_ADT_List_Message_319", %TName_List_Message* %"$msgs_4342"), !dbg !415
...
"$have_gas_4358":                                 ; preds = %"$out_of_gas_4357", %"$have_gas_4353"
  ...
  store %String { i8* getelementptr inbounds ([43 x i8], [43 x i8]* @"$stringlit_4360", i32 0, i32 0), i32 43 }, %String* %m6, align 8, !dbg !416
...
"$have_gas_4364":                                 ; preds = %"$out_of_gas_4363", %"$have_gas_4358"
  ...
  %"$ud-registry.eError_call_4370" = call i8* %"$ud-registry.eError_fptr_4367"(i8* %"$ud-registry.eError_envptr_4368", %String %"$m_4369"), !dbg !418
  store i8* %"$ud-registry.eError_call_4370", i8** %"$ud-registry.eError_94", align 8, !dbg !418
  %"$$ud-registry.eError_94_4371" = load i8*, i8** %"$ud-registry.eError_94", align 8
  store i8* %"$$ud-registry.eError_94_4371", i8** %e5, align 8, !dbg !418
...
"$have_gas_4378":                                 ; preds = %"$out_of_gas_4377", %"$have_gas_4364"
  ...
  call void @_event(i8* %"$execptr_load_4380", %_TyDescrTy_Typ* @"$TyDescr_Event_301", i8* %"$e_4381"), !dbg !419
...
"$have_gas_4395":                                 ; preds = %"$out_of_gas_4394", %"$have_gas_4390"
  ...
  store i8* %"$msgobj_4397", i8** %"$m_1", align 8, !dbg !420
...
"$have_gas_4438":                                 ; preds = %"$out_of_gas_4437", %"$have_gas_4395"
  ...
  %"$ud-registry.oneMsg_call_4444" = call %TName_List_Message* %"$ud-registry.oneMsg_fptr_4441"(i8* %"$ud-registry.oneMsg_envptr_4442", i8* %"$$m_1_4443"), !dbg !421
  store %TName_List_Message* %"$ud-registry.oneMsg_call_4444", %TName_List_Message** %"$ud-registry.oneMsg_93", align 8, !dbg !421
  %"$$ud-registry.oneMsg_93_4445" = load %TName_List_Message*, %TName_List_Message** %"$ud-registry.oneMsg_93", align 8
  store %TName_List_Message* %"$$ud-registry.oneMsg_93_4445", %TName_List_Message** %msgs7, align 8, !dbg !421
...
"$have_gas_4452":                                 ; preds = %"$out_of_gas_4451", %"$have_gas_4438"
  ...
  call void @_send(i8* %"$execptr_load_4454", %_TyDescrTy_Typ* @"$TyDescr_ADT_List_Message_319", %TName_List_Message* %"$msgs_4455"), !dbg !422
  br label %"$matchsucc_4185"
...
entry:
  ...
  call void @"$transfer_4077"(%Uint128 %_amount, [20 x i8]* %"$_origin_4460", [20 x i8]* %"$_sender_4462", [32 x i8]* %"$node_4464", [20 x i8]* %"$owner_4466"), !dbg !424
  ret void
}

define internal void @"$assign_4467"(%Uint128 %_amount, [20 x i8]* %"$_origin_4468", [20 x i8]* %"$_sender_4469", [32 x i8]* %"$parent_4470", %String %label, [20 x i8]* %"$owner_4471") !dbg !425 {
entry:
  ...
  %"$maybeRecord_call_4476" = call i8* @_fetch_field(i8* %"$execptr_load_4475", i8* getelementptr inbounds ([8 x i8], [8 x i8]* @"$records_4474", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_325", i32 1, i8* %"$indices_buf_4472", i32 1), !dbg !426
...
"$have_gas_4486":                                 ; preds = %"$out_of_gas_4485", %entry
  ...
  %"$maybeApproved_call_4492" = call i8* @_fetch_field(i8* %"$execptr_load_4491", i8* getelementptr inbounds ([10 x i8], [10 x i8]* @"$approvals_4490", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_324", i32 1, i8* %"$indices_buf_4488", i32 1), !dbg !427
...
"$have_gas_4512":                                 ; preds = %"$out_of_gas_4511", %"$have_gas_4507"
  ...
  call void %"$ud-registry.recordMemberOwner_fptr_4515"(i8* %"$ud-registry.recordMemberOwner_envptr_4516", [20 x i8]* %"$ud-registry.recordMemberOwner_retalloca_4518", %TName_Option_ud-registry.Record* %"$maybeRecord_4517"), !dbg !428
  %"$ud-registry.recordMemberOwner_ret_4519" = load [20 x i8], [20 x i8]* %"$ud-registry.recordMemberOwner_retalloca_4518", align 1
  store [20 x i8] %"$ud-registry.recordMemberOwner_ret_4519", [20 x i8]* %"$ud-registry.recordMemberOwner_114", align 1, !dbg !428
  %"$$ud-registry.recordMemberOwner_114_4520" = load [20 x i8], [20 x i8]* %"$ud-registry.recordMemberOwner_114", align 1
  store [20 x i8] %"$$ud-registry.recordMemberOwner_114_4520", [20 x i8]* %recordOwner, align 1, !dbg !428
  %maybeOperators = alloca %"TName_Option_List_(ByStr20)"*, align 8
  ...
  %"$maybeOperators_call_4526" = call i8* @_fetch_field(i8* %"$execptr_load_4525", i8* getelementptr inbounds ([10 x i8], [10 x i8]* @"$operators_4524", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_323", i32 1, i8* %"$indices_buf_4521", i32 1), !dbg !429
...
"$have_gas_4546":                                 ; preds = %"$out_of_gas_4545", %"$have_gas_4541"
  ...
  %"$ud-registry.getIsOAO_call_4552" = call { { { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* } (i8*, %TName_Option_ByStr20*)*, i8* } (i8*, [20 x i8]*)*, i8* } %"$ud-registry.getIsOAO_fptr_4549"(i8* %"$ud-registry.getIsOAO_envptr_4550", [20 x i8]* %"$ud-registry.getIsOAO__sender_4551"), !dbg !430
  store { { { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* } (i8*, %TName_Option_ByStr20*)*, i8* } (i8*, [20 x i8]*)*, i8* } %"$ud-registry.getIsOAO_call_4552", { { { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* } (i8*, %TName_Option_ByStr20*)*, i8* } (i8*, [20 x i8]*)*, i8* }* %"$ud-registry.getIsOAO_110", align 8, !dbg !430
  ...
  %"$$ud-registry.getIsOAO_110_call_4558" = call { { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* } (i8*, %TName_Option_ByStr20*)*, i8* } %"$$ud-registry.getIsOAO_110_fptr_4554"(i8* %"$$ud-registry.getIsOAO_110_envptr_4555", [20 x i8]* %"$$ud-registry.getIsOAO_110_recordOwner_4556"), !dbg !430
  store { { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* } (i8*, %TName_Option_ByStr20*)*, i8* } %"$$ud-registry.getIsOAO_110_call_4558", { { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* } (i8*, %TName_Option_ByStr20*)*, i8* }* %"$ud-registry.getIsOAO_111", align 8, !dbg !430
  ...
  %"$$ud-registry.getIsOAO_111_call_4563" = call { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* } %"$$ud-registry.getIsOAO_111_fptr_4560"(i8* %"$$ud-registry.getIsOAO_111_envptr_4561", %TName_Option_ByStr20* %"$maybeApproved_4562"), !dbg !430
  store { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* } %"$$ud-registry.getIsOAO_111_call_4563", { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* }* %"$ud-registry.getIsOAO_112", align 8, !dbg !430
  ...
  %"$$ud-registry.getIsOAO_112_call_4568" = call %TName_Bool* %"$$ud-registry.getIsOAO_112_fptr_4565"(i8* %"$$ud-registry.getIsOAO_112_envptr_4566", %"TName_Option_List_(ByStr20)"* %"$maybeOperators_4567"), !dbg !430
  store %TName_Bool* %"$$ud-registry.getIsOAO_112_call_4568", %TName_Bool** %"$ud-registry.getIsOAO_113", align 8, !dbg !430
  %"$$ud-registry.getIsOAO_113_4569" = load %TName_Bool*, %TName_Bool** %"$ud-registry.getIsOAO_113", align 8
  store %TName_Bool* %"$$ud-registry.getIsOAO_113_4569", %TName_Bool** %isSenderOAO, align 8, !dbg !430
...
"$have_gas_4590":                                 ; preds = %"$out_of_gas_4589", %"$have_gas_4585"
  ...
  %"$ud-registry.parentLabelToNode_call_4596" = call { void (i8*, [32 x i8]*, %String)*, i8* } %"$ud-registry.parentLabelToNode_fptr_4593"(i8* %"$ud-registry.parentLabelToNode_envptr_4594", [32 x i8]* %"$ud-registry.parentLabelToNode_parent_4595"), !dbg !432
  store { void (i8*, [32 x i8]*, %String)*, i8* } %"$ud-registry.parentLabelToNode_call_4596", { void (i8*, [32 x i8]*, %String)*, i8* }* %"$ud-registry.parentLabelToNode_106", align 8, !dbg !432
  ...
  call void %"$$ud-registry.parentLabelToNode_106_fptr_4598"(i8* %"$$ud-registry.parentLabelToNode_106_envptr_4599", [32 x i8]* %"$$ud-registry.parentLabelToNode_106_retalloca_4600", %String %label), !dbg !432
  %"$$ud-registry.parentLabelToNode_106_ret_4601" = load [32 x i8], [32 x i8]* %"$$ud-registry.parentLabelToNode_106_retalloca_4600", align 1
  store [32 x i8] %"$$ud-registry.parentLabelToNode_106_ret_4601", [32 x i8]* %"$ud-registry.parentLabelToNode_107", align 1, !dbg !432
  %"$$ud-registry.parentLabelToNode_107_4602" = load [32 x i8], [32 x i8]* %"$ud-registry.parentLabelToNode_107", align 1
  store [32 x i8] %"$$ud-registry.parentLabelToNode_107_4602", [32 x i8]* %node, align 1, !dbg !432
  ...
  %"$recordExists_call_4608" = call i8* @_fetch_field(i8* %"$execptr_load_4607", i8* getelementptr inbounds ([8 x i8], [8 x i8]* @"$records_4606", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_325", i32 1, i8* %"$indices_buf_4603", i32 0), !dbg !435
...
"$have_gas_4640":                                 ; preds = %"$out_of_gas_4639", %"$have_gas_4635"
  ...
  %"$ud-registry.eNewDomain_call_4646" = call { i8* (i8*, %String)*, i8* } %"$ud-registry.eNewDomain_fptr_4643"(i8* %"$ud-registry.eNewDomain_envptr_4644", [32 x i8]* %"$ud-registry.eNewDomain_parent_4645"), !dbg !437
  store { i8* (i8*, %String)*, i8* } %"$ud-registry.eNewDomain_call_4646", { i8* (i8*, %String)*, i8* }* %"$ud-registry.eNewDomain_104", align 8, !dbg !437
  ...
  %"$$ud-registry.eNewDomain_104_call_4650" = call i8* %"$$ud-registry.eNewDomain_104_fptr_4648"(i8* %"$$ud-registry.eNewDomain_104_envptr_4649", %String %label), !dbg !437
  store i8* %"$$ud-registry.eNewDomain_104_call_4650", i8** %"$ud-registry.eNewDomain_105", align 8, !dbg !437
  %"$$ud-registry.eNewDomain_105_4651" = load i8*, i8** %"$ud-registry.eNewDomain_105", align 8
  store i8* %"$$ud-registry.eNewDomain_105_4651", i8** %e, align 8, !dbg !437
...
"$have_gas_4658":                                 ; preds = %"$out_of_gas_4657", %"$have_gas_4640"
  ...
  call void @_event(i8* %"$execptr_load_4660", %_TyDescrTy_Typ* @"$TyDescr_Event_301", i8* %"$e_4661"), !dbg !440
...
"$have_gas_4665":                                 ; preds = %"$out_of_gas_4664", %"$matchsucc_4625"
  ...
  call void @_update_field(i8* %"$execptr_load_4670", i8* getelementptr inbounds ([10 x i8], [10 x i8]* @"$approvals_4671", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_324", i32 1, i8* %"$indices_buf_4667", i8* null), !dbg !441
...
"$have_gas_4680":                                 ; preds = %"$out_of_gas_4679", %"$have_gas_4675"
  ...
  store %TName_ud-registry.Record* %"$adtptr_4687", %TName_ud-registry.Record** %newRecord, align 8, !dbg !442
...
"$have_gas_4695":                                 ; preds = %"$out_of_gas_4694", %"$have_gas_4680"
  ...
  call void @_update_field(i8* %"$execptr_load_4700", i8* getelementptr inbounds ([8 x i8], [8 x i8]* @"$records_4701", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_325", i32 1, i8* %"$indices_buf_4697", i8* %"$update_value_4703"), !dbg !443
...
"$have_gas_4712":                                 ; preds = %"$out_of_gas_4711", %"$have_gas_4707"
  ...
  %"$ud-registry.eConfigured_call_4719" = call { { i8* (i8*, [20 x i8]*)*, i8* } (i8*, [20 x i8]*)*, i8* } %"$ud-registry.eConfigured_fptr_4715"(i8* %"$ud-registry.eConfigured_envptr_4716", [32 x i8]* %"$ud-registry.eConfigured_node_4717"), !dbg !444
  store { { i8* (i8*, [20 x i8]*)*, i8* } (i8*, [20 x i8]*)*, i8* } %"$ud-registry.eConfigured_call_4719", { { i8* (i8*, [20 x i8]*)*, i8* } (i8*, [20 x i8]*)*, i8* }* %"$ud-registry.eConfigured_101", align 8, !dbg !444
  ...
  %"$$ud-registry.eConfigured_101_call_4724" = call { i8* (i8*, [20 x i8]*)*, i8* } %"$$ud-registry.eConfigured_101_fptr_4721"(i8* %"$$ud-registry.eConfigured_101_envptr_4722", [20 x i8]* %"$$ud-registry.eConfigured_101_owner_4723"), !dbg !444
  store { i8* (i8*, [20 x i8]*)*, i8* } %"$$ud-registry.eConfigured_101_call_4724", { i8* (i8*, [20 x i8]*)*, i8* }* %"$ud-registry.eConfigured_102", align 8, !dbg !444
  ...
  %"$$ud-registry.eConfigured_102_call_4730" = call i8* %"$$ud-registry.eConfigured_102_fptr_4726"(i8* %"$$ud-registry.eConfigured_102_envptr_4727", [20 x i8]* %"$$ud-registry.eConfigured_102_ud-registry.zeroByStr20_4728"), !dbg !444
  store i8* %"$$ud-registry.eConfigured_102_call_4730", i8** %"$ud-registry.eConfigured_103", align 8, !dbg !444
  %"$$ud-registry.eConfigured_103_4731" = load i8*, i8** %"$ud-registry.eConfigured_103", align 8
  store i8* %"$$ud-registry.eConfigured_103_4731", i8** %e6, align 8, !dbg !444
...
"$have_gas_4738":                                 ; preds = %"$out_of_gas_4737", %"$have_gas_4712"
  ...
  call void @_event(i8* %"$execptr_load_4740", %_TyDescrTy_Typ* @"$TyDescr_Event_301", i8* %"$e_4741"), !dbg !445
...
"$have_gas_4755":                                 ; preds = %"$out_of_gas_4754", %"$have_gas_4750"
  ...
  store i8* %"$msgobj_4757", i8** %m, align 8, !dbg !446
...
"$have_gas_4805":                                 ; preds = %"$out_of_gas_4804", %"$have_gas_4755"
  ...
  %"$ud-registry.oneMsg_call_4811" = call %TName_List_Message* %"$ud-registry.oneMsg_fptr_4808"(i8* %"$ud-registry.oneMsg_envptr_4809", i8* %"$m_4810"), !dbg !447
  store %TName_List_Message* %"$ud-registry.oneMsg_call_4811", %TName_List_Message** %"$ud-registry.oneMsg_100", align 8, !dbg !447
  %"$$ud-registry.oneMsg_100_4812" = load %TName_List_Message*, %TName_List_Message** %"$ud-registry.oneMsg_100", align 8
  store %TName_List_Message* %"$$ud-registry.oneMsg_100_4812", %TName_List_Message** %msgs, align 8, !dbg !447
...
"$have_gas_4819":                                 ; preds = %"$out_of_gas_4818", %"$have_gas_4805"
  ...
  call void @_send(i8* %"$execptr_load_4821", %_TyDescrTy_Typ* @"$TyDescr_ADT_List_Message_319", %TName_List_Message* %"$msgs_4822"), !dbg !448
...
"$have_gas_4838":                                 ; preds = %"$out_of_gas_4837", %"$have_gas_4833"
  ...
  store %String { i8* getelementptr inbounds ([45 x i8], [45 x i8]* @"$stringlit_4840", i32 0, i32 0), i32 45 }, %String* %m8, align 8, !dbg !449
...
"$have_gas_4844":                                 ; preds = %"$out_of_gas_4843", %"$have_gas_4838"
  ...
  %"$ud-registry.eError_call_4850" = call i8* %"$ud-registry.eError_fptr_4847"(i8* %"$ud-registry.eError_envptr_4848", %String %"$m_4849"), !dbg !451
  store i8* %"$ud-registry.eError_call_4850", i8** %"$ud-registry.eError_109", align 8, !dbg !451
  %"$$ud-registry.eError_109_4851" = load i8*, i8** %"$ud-registry.eError_109", align 8
  store i8* %"$$ud-registry.eError_109_4851", i8** %e7, align 8, !dbg !451
...
"$have_gas_4858":                                 ; preds = %"$out_of_gas_4857", %"$have_gas_4844"
  ...
  call void @_event(i8* %"$execptr_load_4860", %_TyDescrTy_Typ* @"$TyDescr_Event_301", i8* %"$e_4861"), !dbg !452
...
"$have_gas_4875":                                 ; preds = %"$out_of_gas_4874", %"$have_gas_4870"
  ...
  store i8* %"$msgobj_4877", i8** %"$m_2", align 8, !dbg !453
...
"$have_gas_4926":                                 ; preds = %"$out_of_gas_4925", %"$have_gas_4875"
  ...
  %"$ud-registry.oneMsg_call_4932" = call %TName_List_Message* %"$ud-registry.oneMsg_fptr_4929"(i8* %"$ud-registry.oneMsg_envptr_4930", i8* %"$$m_2_4931"), !dbg !454
  store %TName_List_Message* %"$ud-registry.oneMsg_call_4932", %TName_List_Message** %"$ud-registry.oneMsg_108", align 8, !dbg !454
  %"$$ud-registry.oneMsg_108_4933" = load %TName_List_Message*, %TName_List_Message** %"$ud-registry.oneMsg_108", align 8
  store %TName_List_Message* %"$$ud-registry.oneMsg_108_4933", %TName_List_Message** %msgs9, align 8, !dbg !454
...
"$have_gas_4940":                                 ; preds = %"$out_of_gas_4939", %"$have_gas_4926"
  ...
  call void @_send(i8* %"$execptr_load_4942", %_TyDescrTy_Typ* @"$TyDescr_ADT_List_Message_319", %TName_List_Message* %"$msgs_4943"), !dbg !455
  br label %"$matchsucc_4575"
...
entry:
  ...
  call void @"$assign_4467"(%Uint128 %_amount, [20 x i8]* %"$_origin_4948", [20 x i8]* %"$_sender_4950", [32 x i8]* %"$parent_4952", %String %label, [20 x i8]* %"$owner_4956"), !dbg !457
  ret void
}

define internal void @"$bestow_4957"(%Uint128 %_amount, [20 x i8]* %"$_origin_4958", [20 x i8]* %"$_sender_4959", %String %label, [20 x i8]* %"$owner_4960", [20 x i8]* %"$resolver_4961") !dbg !458 {
entry:
  ...
  %"$currentAdmins_call_4964" = call i8* @_fetch_field(i8* %"$execptr_load_4963", i8* getelementptr inbounds ([7 x i8], [7 x i8]* @"$admins_4962", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_ADT_List_ByStr20_320", i32 0, i8* null, i32 1), !dbg !459
...
"$have_gas_4983":                                 ; preds = %"$out_of_gas_4982", %"$have_gas_4978"
  ...
  %"$ud-registry.parentLabelToNode_call_4990" = call { void (i8*, [32 x i8]*, %String)*, i8* } %"$ud-registry.parentLabelToNode_fptr_4986"(i8* %"$ud-registry.parentLabelToNode_envptr_4987", [32 x i8]* %"$ud-registry.parentLabelToNode_rootNode_4988"), !dbg !460
  store { void (i8*, [32 x i8]*, %String)*, i8* } %"$ud-registry.parentLabelToNode_call_4990", { void (i8*, [32 x i8]*, %String)*, i8* }* %"$ud-registry.parentLabelToNode_132", align 8, !dbg !460
  ...
  call void %"$$ud-registry.parentLabelToNode_132_fptr_4992"(i8* %"$$ud-registry.parentLabelToNode_132_envptr_4993", [32 x i8]* %"$$ud-registry.parentLabelToNode_132_retalloca_4994", %String %label), !dbg !460
  %"$$ud-registry.parentLabelToNode_132_ret_4995" = load [32 x i8], [32 x i8]* %"$$ud-registry.parentLabelToNode_132_retalloca_4994", align 1
  store [32 x i8] %"$$ud-registry.parentLabelToNode_132_ret_4995", [32 x i8]* %"$ud-registry.parentLabelToNode_133", align 1, !dbg !460
  %"$$ud-registry.parentLabelToNode_133_4996" = load [32 x i8], [32 x i8]* %"$ud-registry.parentLabelToNode_133", align 1
  store [32 x i8] %"$$ud-registry.parentLabelToNode_133_4996", [32 x i8]* %node, align 1, !dbg !460
  %recordExists = alloca %TName_Bool*, align 8
  ...
  %"$recordExists_call_5002" = call i8* @_fetch_field(i8* %"$execptr_load_5001", i8* getelementptr inbounds ([8 x i8], [8 x i8]* @"$records_5000", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_325", i32 1, i8* %"$indices_buf_4997", i32 0), !dbg !461
...
"$have_gas_5012":                                 ; preds = %"$out_of_gas_5011", %"$have_gas_4983"
  ...
  %"$maybeRecord_call_5019" = call i8* @_fetch_field(i8* %"$execptr_load_5018", i8* getelementptr inbounds ([8 x i8], [8 x i8]* @"$records_5017", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_325", i32 1, i8* %"$indices_buf_5014", i32 1), !dbg !462
...
"$have_gas_5029":                                 ; preds = %"$out_of_gas_5028", %"$have_gas_5012"
  ...
  %"$currentRegistrar_call_5033" = call i8* @_fetch_field(i8* %"$execptr_load_5032", i8* getelementptr inbounds ([10 x i8], [10 x i8]* @"$registrar_5031", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Bystr20_311", i32 0, i8* null, i32 1), !dbg !463
...
"$have_gas_5059":                                 ; preds = %"$out_of_gas_5058", %"$have_gas_5054"
  ...
  %"$ud-registry.listByStr20Contains_call_5065" = call { %TName_Bool* (i8*, [20 x i8]*)*, i8* } %"$ud-registry.listByStr20Contains_fptr_5062"(i8* %"$ud-registry.listByStr20Contains_envptr_5063", %TName_List_ByStr20* %"$currentAdmins_5064"), !dbg !464
  store { %TName_Bool* (i8*, [20 x i8]*)*, i8* } %"$ud-registry.listByStr20Contains_call_5065", { %TName_Bool* (i8*, [20 x i8]*)*, i8* }* %"$ud-registry.listByStr20Contains_121", align 8, !dbg !464
  ...
  %"$$ud-registry.listByStr20Contains_121_call_5070" = call %TName_Bool* %"$$ud-registry.listByStr20Contains_121_fptr_5067"(i8* %"$$ud-registry.listByStr20Contains_121_envptr_5068", [20 x i8]* %"$$ud-registry.listByStr20Contains_121__sender_5069"), !dbg !464
  store %TName_Bool* %"$$ud-registry.listByStr20Contains_121_call_5070", %TName_Bool** %"$ud-registry.listByStr20Contains_122", align 8, !dbg !464
  %"$$ud-registry.listByStr20Contains_122_5071" = load %TName_Bool*, %TName_Bool** %"$ud-registry.listByStr20Contains_122", align 8
  store %TName_Bool* %"$$ud-registry.listByStr20Contains_122_5071", %TName_Bool** %isSenderAdmin, align 8, !dbg !464
...
"$have_gas_5080":                                 ; preds = %"$out_of_gas_5079", %"$have_gas_5075"
  ...
  %"$eq_call_5088" = call %TName_Bool* @_eq_ByStrX(i8* %"$execptr_load_5082", i32 20, i8* %"$$eq_currentRegistrar_5083_5085", i8* %"$$eq__sender_5086_5087"), !dbg !465
  store %TName_Bool* %"$eq_call_5088", %TName_Bool** %isSenderRegistrar, align 8, !dbg !465
...
"$have_gas_5098":                                 ; preds = %"$out_of_gas_5097", %"$have_gas_5093"
  ...
  %"$BoolUtils.orb_call_5104" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.orb_fptr_5101"(i8* %"$BoolUtils.orb_envptr_5102", %TName_Bool* %"$isSenderRegistrar_5103"), !dbg !466
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.orb_call_5104", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.orb_123", align 8, !dbg !466
  ...
  %"$$BoolUtils.orb_123_call_5109" = call %TName_Bool* %"$$BoolUtils.orb_123_fptr_5106"(i8* %"$$BoolUtils.orb_123_envptr_5107", %TName_Bool* %"$isSenderAdmin_5108"), !dbg !466
  store %TName_Bool* %"$$BoolUtils.orb_123_call_5109", %TName_Bool** %"$BoolUtils.orb_124", align 8, !dbg !466
  %"$$BoolUtils.orb_124_5110" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.orb_124", align 8
  store %TName_Bool* %"$$BoolUtils.orb_124_5110", %TName_Bool** %isOkSender, align 8, !dbg !466
...
"$have_gas_5119":                                 ; preds = %"$out_of_gas_5118", %"$have_gas_5114"
  ...
  call void %"$ud-registry.recordMemberOwner_fptr_5122"(i8* %"$ud-registry.recordMemberOwner_envptr_5123", [20 x i8]* %"$ud-registry.recordMemberOwner_retalloca_5125", %TName_Option_ud-registry.Record* %"$maybeRecord_5124"), !dbg !467
  %"$ud-registry.recordMemberOwner_ret_5126" = load [20 x i8], [20 x i8]* %"$ud-registry.recordMemberOwner_retalloca_5125", align 1
  store [20 x i8] %"$ud-registry.recordMemberOwner_ret_5126", [20 x i8]* %"$ud-registry.recordMemberOwner_125", align 1, !dbg !467
  %"$$ud-registry.recordMemberOwner_125_5127" = load [20 x i8], [20 x i8]* %"$ud-registry.recordMemberOwner_125", align 1
  store [20 x i8] %"$$ud-registry.recordMemberOwner_125_5127", [20 x i8]* %recordOwner, align 1, !dbg !467
...
"$have_gas_5136":                                 ; preds = %"$out_of_gas_5135", %"$have_gas_5131"
  ...
  %"$eq_call_5145" = call %TName_Bool* @_eq_ByStrX(i8* %"$execptr_load_5138", i32 20, i8* %"$$eq_recordOwner_5139_5141", i8* %"$$eq_ud-registry.zeroByStr20_5142_5144"), !dbg !468
  store %TName_Bool* %"$eq_call_5145", %TName_Bool** %recordIsUnowned, align 8, !dbg !468
...
"$have_gas_5155":                                 ; preds = %"$out_of_gas_5154", %"$have_gas_5150"
  ...
  %"$eq_call_5164" = call %TName_Bool* @_eq_ByStrX(i8* %"$execptr_load_5157", i32 20, i8* %"$$eq_recordOwner_5158_5160", i8* %"$$eq_currentRegistrar_5161_5163"), !dbg !469
  store %TName_Bool* %"$eq_call_5164", %TName_Bool** %recordIsOwnedByRegistrar, align 8, !dbg !469
...
"$have_gas_5174":                                 ; preds = %"$out_of_gas_5173", %"$have_gas_5169"
  ...
  %"$BoolUtils.andb_call_5180" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_fptr_5177"(i8* %"$BoolUtils.andb_envptr_5178", %TName_Bool* %"$recordIsOwnedByRegistrar_5179"), !dbg !470
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_call_5180", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.andb_126", align 8, !dbg !470
  ...
  %"$$BoolUtils.andb_126_call_5185" = call %TName_Bool* %"$$BoolUtils.andb_126_fptr_5182"(i8* %"$$BoolUtils.andb_126_envptr_5183", %TName_Bool* %"$isSenderRegistrar_5184"), !dbg !470
  store %TName_Bool* %"$$BoolUtils.andb_126_call_5185", %TName_Bool** %"$BoolUtils.andb_127", align 8, !dbg !470
  %"$$BoolUtils.andb_127_5186" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.andb_127", align 8
  store %TName_Bool* %"$$BoolUtils.andb_127_5186", %TName_Bool** %isRegistrarSenderAndOwned, align 8, !dbg !470
...
"$have_gas_5195":                                 ; preds = %"$out_of_gas_5194", %"$have_gas_5190"
  ...
  %"$BoolUtils.orb_call_5201" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.orb_fptr_5198"(i8* %"$BoolUtils.orb_envptr_5199", %TName_Bool* %"$recordIsUnowned_5200"), !dbg !471
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.orb_call_5201", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.orb_128", align 8, !dbg !471
  ...
  %"$$BoolUtils.orb_128_call_5206" = call %TName_Bool* %"$$BoolUtils.orb_128_fptr_5203"(i8* %"$$BoolUtils.orb_128_envptr_5204", %TName_Bool* %"$isRegistrarSenderAndOwned_5205"), !dbg !471
  store %TName_Bool* %"$$BoolUtils.orb_128_call_5206", %TName_Bool** %"$BoolUtils.orb_129", align 8, !dbg !471
  %"$$BoolUtils.orb_129_5207" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.orb_129", align 8
  store %TName_Bool* %"$$BoolUtils.orb_129_5207", %TName_Bool** %isOkRecordOwner, align 8, !dbg !471
...
"$have_gas_5211":                                 ; preds = %"$out_of_gas_5210", %"$have_gas_5195"
  ...
  %"$BoolUtils.andb_call_5217" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_fptr_5214"(i8* %"$BoolUtils.andb_envptr_5215", %TName_Bool* %"$isOkSender_5216"), !dbg !472
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_call_5217", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.andb_130", align 8, !dbg !472
  ...
  %"$$BoolUtils.andb_130_call_5222" = call %TName_Bool* %"$$BoolUtils.andb_130_fptr_5219"(i8* %"$$BoolUtils.andb_130_envptr_5220", %TName_Bool* %"$isOkRecordOwner_5221"), !dbg !472
  store %TName_Bool* %"$$BoolUtils.andb_130_call_5222", %TName_Bool** %"$BoolUtils.andb_131", align 8, !dbg !472
  %"$$BoolUtils.andb_131_5223" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.andb_131", align 8
  store %TName_Bool* %"$$BoolUtils.andb_131_5223", %TName_Bool** %isOk, align 8, !dbg !472
...
"$have_gas_5256":                                 ; preds = %"$out_of_gas_5255", %"$have_gas_5251"
  ...
  %"$ud-registry.eNewDomain_call_5263" = call { i8* (i8*, %String)*, i8* } %"$ud-registry.eNewDomain_fptr_5259"(i8* %"$ud-registry.eNewDomain_envptr_5260", [32 x i8]* %"$ud-registry.eNewDomain_rootNode_5261"), !dbg !477
  store { i8* (i8*, %String)*, i8* } %"$ud-registry.eNewDomain_call_5263", { i8* (i8*, %String)*, i8* }* %"$ud-registry.eNewDomain_118", align 8, !dbg !477
  ...
  %"$$ud-registry.eNewDomain_118_call_5267" = call i8* %"$$ud-registry.eNewDomain_118_fptr_5265"(i8* %"$$ud-registry.eNewDomain_118_envptr_5266", %String %label), !dbg !477
  store i8* %"$$ud-registry.eNewDomain_118_call_5267", i8** %"$ud-registry.eNewDomain_119", align 8, !dbg !477
  %"$$ud-registry.eNewDomain_119_5268" = load i8*, i8** %"$ud-registry.eNewDomain_119", align 8
  store i8* %"$$ud-registry.eNewDomain_119_5268", i8** %e, align 8, !dbg !477
...
"$have_gas_5275":                                 ; preds = %"$out_of_gas_5274", %"$have_gas_5256"
  ...
  call void @_event(i8* %"$execptr_load_5277", %_TyDescrTy_Typ* @"$TyDescr_Event_301", i8* %"$e_5278"), !dbg !480
...
"$have_gas_5287":                                 ; preds = %"$out_of_gas_5286", %"$have_gas_5282"
  ...
  store %TName_ud-registry.Record* %"$adtptr_5293", %TName_ud-registry.Record** %newRecord, align 8, !dbg !481
...
"$have_gas_5301":                                 ; preds = %"$out_of_gas_5300", %"$have_gas_5287"
  ...
  call void @_update_field(i8* %"$execptr_load_5306", i8* getelementptr inbounds ([8 x i8], [8 x i8]* @"$records_5307", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_325", i32 1, i8* %"$indices_buf_5303", i8* %"$update_value_5309"), !dbg !482
...
"$have_gas_5318":                                 ; preds = %"$out_of_gas_5317", %"$have_gas_5313"
  ...
  %"$ud-registry.eConfigured_call_5325" = call { { i8* (i8*, [20 x i8]*)*, i8* } (i8*, [20 x i8]*)*, i8* } %"$ud-registry.eConfigured_fptr_5321"(i8* %"$ud-registry.eConfigured_envptr_5322", [32 x i8]* %"$ud-registry.eConfigured_node_5323"), !dbg !483
  store { { i8* (i8*, [20 x i8]*)*, i8* } (i8*, [20 x i8]*)*, i8* } %"$ud-registry.eConfigured_call_5325", { { i8* (i8*, [20 x i8]*)*, i8* } (i8*, [20 x i8]*)*, i8* }* %"$ud-registry.eConfigured_115", align 8, !dbg !483
  ...
  %"$$ud-registry.eConfigured_115_call_5330" = call { i8* (i8*, [20 x i8]*)*, i8* } %"$$ud-registry.eConfigured_115_fptr_5327"(i8* %"$$ud-registry.eConfigured_115_envptr_5328", [20 x i8]* %"$$ud-registry.eConfigured_115_owner_5329"), !dbg !483
  store { i8* (i8*, [20 x i8]*)*, i8* } %"$$ud-registry.eConfigured_115_call_5330", { i8* (i8*, [20 x i8]*)*, i8* }* %"$ud-registry.eConfigured_116", align 8, !dbg !483
  ...
  %"$$ud-registry.eConfigured_116_call_5335" = call i8* %"$$ud-registry.eConfigured_116_fptr_5332"(i8* %"$$ud-registry.eConfigured_116_envptr_5333", [20 x i8]* %"$$ud-registry.eConfigured_116_resolver_5334"), !dbg !483
  store i8* %"$$ud-registry.eConfigured_116_call_5335", i8** %"$ud-registry.eConfigured_117", align 8, !dbg !483
  %"$$ud-registry.eConfigured_117_5336" = load i8*, i8** %"$ud-registry.eConfigured_117", align 8
  store i8* %"$$ud-registry.eConfigured_117_5336", i8** %e3, align 8, !dbg !483
...
"$have_gas_5343":                                 ; preds = %"$out_of_gas_5342", %"$have_gas_5318"
  ...
  call void @_event(i8* %"$execptr_load_5345", %_TyDescrTy_Typ* @"$TyDescr_Event_301", i8* %"$e_5346"), !dbg !484
...
"$have_gas_5362":                                 ; preds = %"$out_of_gas_5361", %"$have_gas_5357"
  ...
  store %String { i8* getelementptr inbounds ([12 x i8], [12 x i8]* @"$stringlit_5364", i32 0, i32 0), i32 12 }, %String* %m, align 8, !dbg !485
...
"$have_gas_5368":                                 ; preds = %"$out_of_gas_5367", %"$have_gas_5362"
  ...
  %"$ud-registry.eError_call_5374" = call i8* %"$ud-registry.eError_fptr_5371"(i8* %"$ud-registry.eError_envptr_5372", %String %"$m_5373"), !dbg !487
  store i8* %"$ud-registry.eError_call_5374", i8** %"$ud-registry.eError_120", align 8, !dbg !487
  %"$$ud-registry.eError_120_5375" = load i8*, i8** %"$ud-registry.eError_120", align 8
  store i8* %"$$ud-registry.eError_120_5375", i8** %e4, align 8, !dbg !487
...
"$have_gas_5382":                                 ; preds = %"$out_of_gas_5381", %"$have_gas_5368"
  ...
  call void @_event(i8* %"$execptr_load_5384", %_TyDescrTy_Typ* @"$TyDescr_Event_301", i8* %"$e_5385"), !dbg !488
  br label %"$matchsucc_5229"
...
entry:
  ...
  call void @"$bestow_4957"(%Uint128 %_amount, [20 x i8]* %"$_origin_5390", [20 x i8]* %"$_sender_5392", %String %label, [20 x i8]* %"$owner_5396", [20 x i8]* %"$resolver_5398"), !dbg !490
  ret void
}

define internal void @"$setRegistrar_5399"(%Uint128 %_amount, [20 x i8]* %"$_origin_5400", [20 x i8]* %"$_sender_5401", [20 x i8]* %"$address_5402") !dbg !491 {
entry:
  ...
  %"$currentAdmins_call_5405" = call i8* @_fetch_field(i8* %"$execptr_load_5404", i8* getelementptr inbounds ([7 x i8], [7 x i8]* @"$admins_5403", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_ADT_List_ByStr20_320", i32 0, i8* null, i32 1), !dbg !492
...
"$have_gas_5424":                                 ; preds = %"$out_of_gas_5423", %"$have_gas_5419"
  ...
  %"$ud-registry.listByStr20Contains_call_5430" = call { %TName_Bool* (i8*, [20 x i8]*)*, i8* } %"$ud-registry.listByStr20Contains_fptr_5427"(i8* %"$ud-registry.listByStr20Contains_envptr_5428", %TName_List_ByStr20* %"$currentAdmins_5429"), !dbg !493
  store { %TName_Bool* (i8*, [20 x i8]*)*, i8* } %"$ud-registry.listByStr20Contains_call_5430", { %TName_Bool* (i8*, [20 x i8]*)*, i8* }* %"$ud-registry.listByStr20Contains_135", align 8, !dbg !493
  ...
  %"$$ud-registry.listByStr20Contains_135_call_5435" = call %TName_Bool* %"$$ud-registry.listByStr20Contains_135_fptr_5432"(i8* %"$$ud-registry.listByStr20Contains_135_envptr_5433", [20 x i8]* %"$$ud-registry.listByStr20Contains_135__sender_5434"), !dbg !493
  store %TName_Bool* %"$$ud-registry.listByStr20Contains_135_call_5435", %TName_Bool** %"$ud-registry.listByStr20Contains_136", align 8, !dbg !493
  %"$$ud-registry.listByStr20Contains_136_5436" = load %TName_Bool*, %TName_Bool** %"$ud-registry.listByStr20Contains_136", align 8
  store %TName_Bool* %"$$ud-registry.listByStr20Contains_136_5436", %TName_Bool** %isOk, align 8, !dbg !493
...
"$have_gas_5457":                                 ; preds = %"$out_of_gas_5456", %"$have_gas_5452"
  ...
  %"$ud-registry.eNewRegistrar_call_5463" = call i8* %"$ud-registry.eNewRegistrar_fptr_5460"(i8* %"$ud-registry.eNewRegistrar_envptr_5461", [20 x i8]* %"$ud-registry.eNewRegistrar_address_5462"), !dbg !495
  store i8* %"$ud-registry.eNewRegistrar_call_5463", i8** %"$ud-registry.eNewRegistrar_134", align 8, !dbg !495
  %"$$ud-registry.eNewRegistrar_134_5464" = load i8*, i8** %"$ud-registry.eNewRegistrar_134", align 8
  store i8* %"$$ud-registry.eNewRegistrar_134_5464", i8** %e, align 8, !dbg !495
...
"$have_gas_5471":                                 ; preds = %"$out_of_gas_5470", %"$have_gas_5457"
  ...
  call void @_event(i8* %"$execptr_load_5473", %_TyDescrTy_Typ* @"$TyDescr_Event_301", i8* %"$e_5474"), !dbg !498
...
"$have_gas_5481":                                 ; preds = %"$out_of_gas_5480", %"$have_gas_5471"
  ...
  call void @_update_field(i8* %"$execptr_load_5483", i8* getelementptr inbounds ([10 x i8], [10 x i8]* @"$registrar_5484", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Bystr20_311", i32 0, i8* null, i8* %"$update_value_5486"), !dbg !499
...
entry:
  ...
  call void @"$setRegistrar_5399"(%Uint128 %_amount, [20 x i8]* %"$_origin_5491", [20 x i8]* %"$_sender_5493", [20 x i8]* %"$address_5495"), !dbg !501
  ret void
}

define internal void @"$register_5496"(%Uint128 %_amount, [20 x i8]* %"$_origin_5497", [20 x i8]* %"$_sender_5498", [32 x i8]* %"$parent_5499", %String %label) !dbg !502 {
entry:
...
"$have_gas_5508":                                 ; preds = %"$out_of_gas_5507", %"$have_gas_5503"
  ...
  %"$ud-registry.parentLabelToNode_call_5514" = call { void (i8*, [32 x i8]*, %String)*, i8* } %"$ud-registry.parentLabelToNode_fptr_5511"(i8* %"$ud-registry.parentLabelToNode_envptr_5512", [32 x i8]* %"$ud-registry.parentLabelToNode_parent_5513"), !dbg !503
  store { void (i8*, [32 x i8]*, %String)*, i8* } %"$ud-registry.parentLabelToNode_call_5514", { void (i8*, [32 x i8]*, %String)*, i8* }* %"$ud-registry.parentLabelToNode_141", align 8, !dbg !503
  ...
  call void %"$$ud-registry.parentLabelToNode_141_fptr_5516"(i8* %"$$ud-registry.parentLabelToNode_141_envptr_5517", [32 x i8]* %"$$ud-registry.parentLabelToNode_141_retalloca_5518", %String %label), !dbg !503
  %"$$ud-registry.parentLabelToNode_141_ret_5519" = load [32 x i8], [32 x i8]* %"$$ud-registry.parentLabelToNode_141_retalloca_5518", align 1
  store [32 x i8] %"$$ud-registry.parentLabelToNode_141_ret_5519", [32 x i8]* %"$ud-registry.parentLabelToNode_142", align 1, !dbg !503
  %"$$ud-registry.parentLabelToNode_142_5520" = load [32 x i8], [32 x i8]* %"$ud-registry.parentLabelToNode_142", align 1
  store [32 x i8] %"$$ud-registry.parentLabelToNode_142_5520", [32 x i8]* %node, align 1, !dbg !503
  %maybeRecord = alloca %TName_Option_ud-registry.Record*, align 8
  ...
  %"$maybeRecord_call_5526" = call i8* @_fetch_field(i8* %"$execptr_load_5525", i8* getelementptr inbounds ([8 x i8], [8 x i8]* @"$records_5524", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_325", i32 1, i8* %"$indices_buf_5521", i32 1), !dbg !504
...
"$have_gas_5536":                                 ; preds = %"$out_of_gas_5535", %"$have_gas_5508"
  ...
  %"$maybeApproved_call_5543" = call i8* @_fetch_field(i8* %"$execptr_load_5542", i8* getelementptr inbounds ([10 x i8], [10 x i8]* @"$approvals_5541", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_324", i32 1, i8* %"$indices_buf_5538", i32 1), !dbg !505
...
"$have_gas_5563":                                 ; preds = %"$out_of_gas_5562", %"$have_gas_5558"
  ...
  call void %"$ud-registry.recordMemberOwner_fptr_5566"(i8* %"$ud-registry.recordMemberOwner_envptr_5567", [20 x i8]* %"$ud-registry.recordMemberOwner_retalloca_5569", %TName_Option_ud-registry.Record* %"$maybeRecord_5568"), !dbg !506
  %"$ud-registry.recordMemberOwner_ret_5570" = load [20 x i8], [20 x i8]* %"$ud-registry.recordMemberOwner_retalloca_5569", align 1
  store [20 x i8] %"$ud-registry.recordMemberOwner_ret_5570", [20 x i8]* %"$ud-registry.recordMemberOwner_140", align 1, !dbg !506
  %"$$ud-registry.recordMemberOwner_140_5571" = load [20 x i8], [20 x i8]* %"$ud-registry.recordMemberOwner_140", align 1
  store [20 x i8] %"$$ud-registry.recordMemberOwner_140_5571", [20 x i8]* %recordOwner, align 1, !dbg !506
...
"$have_gas_5592":                                 ; preds = %"$out_of_gas_5591", %"$None_5587"
  ...
  store [20 x i8] %"$ud-registry.zeroByStr20_5594", [20 x i8]* %approved, align 1, !dbg !508
...
"$have_gas_5602":                                 ; preds = %"$out_of_gas_5601", %"$Some_5595"
  ...
  store [20 x i8] %"$approved_5604", [20 x i8]* %approved2, align 1, !dbg !511
  br label %"$matchsucc_5582"
...
"$matchsucc_5582":                                ; preds = %"$have_gas_5602", %"$have_gas_5592", %"$empty_default_5586"
  ...
  %"$currentRegistrar_call_5607" = call i8* @_fetch_field(i8* %"$execptr_load_5606", i8* getelementptr inbounds ([10 x i8], [10 x i8]* @"$registrar_5605", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Bystr20_311", i32 0, i8* null, i32 1), !dbg !513
...
"$have_gas_5633":                                 ; preds = %"$out_of_gas_5632", %"$have_gas_5628"
  ...
  %"$eq_call_5642" = call %TName_Bool* @_eq_ByStrX(i8* %"$execptr_load_5635", i32 20, i8* %"$$eq_recordOwner_5636_5638", i8* %"$$eq_ud-registry.zeroByStr20_5639_5641"), !dbg !514
  store %TName_Bool* %"$eq_call_5642", %TName_Bool** %isRecordUnowned, align 8, !dbg !514
...
"$have_gas_5652":                                 ; preds = %"$out_of_gas_5651", %"$have_gas_5647"
  ...
  %"$eq_call_5661" = call %TName_Bool* @_eq_ByStrX(i8* %"$execptr_load_5654", i32 20, i8* %"$$eq_approved_5655_5657", i8* %"$$eq_ud-registry.zeroByStr20_5658_5660"), !dbg !515
  store %TName_Bool* %"$eq_call_5661", %TName_Bool** %isUnapproved, align 8, !dbg !515
...
"$have_gas_5666":                                 ; preds = %"$out_of_gas_5665", %"$have_gas_5652"
  ...
  %"$BoolUtils.andb_call_5672" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_fptr_5669"(i8* %"$BoolUtils.andb_envptr_5670", %TName_Bool* %"$isRecordUnowned_5671"), !dbg !516
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_call_5672", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.andb_138", align 8, !dbg !516
  ...
  %"$$BoolUtils.andb_138_call_5677" = call %TName_Bool* %"$$BoolUtils.andb_138_fptr_5674"(i8* %"$$BoolUtils.andb_138_envptr_5675", %TName_Bool* %"$isUnapproved_5676"), !dbg !516
  store %TName_Bool* %"$$BoolUtils.andb_138_call_5677", %TName_Bool** %"$BoolUtils.andb_139", align 8, !dbg !516
  %"$$BoolUtils.andb_139_5678" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.andb_139", align 8
  store %TName_Bool* %"$$BoolUtils.andb_139_5678", %TName_Bool** %isOk, align 8, !dbg !516
...
"$have_gas_5694":                                 ; preds = %"$out_of_gas_5693", %"$True_5689"
  ...
  call void @_accept(i8* %"$execptr_load_5696"), !dbg !518
...
"$have_gas_5710":                                 ; preds = %"$out_of_gas_5709", %"$have_gas_5705"
  ...
  store i8* %"$msgobj_5712", i8** %m, align 8, !dbg !521
...
"$have_gas_5769":                                 ; preds = %"$out_of_gas_5768", %"$have_gas_5710"
  ...
  %"$ud-registry.oneMsg_call_5775" = call %TName_List_Message* %"$ud-registry.oneMsg_fptr_5772"(i8* %"$ud-registry.oneMsg_envptr_5773", i8* %"$m_5774"), !dbg !522
  store %TName_List_Message* %"$ud-registry.oneMsg_call_5775", %TName_List_Message** %"$ud-registry.oneMsg_137", align 8, !dbg !522
  %"$$ud-registry.oneMsg_137_5776" = load %TName_List_Message*, %TName_List_Message** %"$ud-registry.oneMsg_137", align 8
  store %TName_List_Message* %"$$ud-registry.oneMsg_137_5776", %TName_List_Message** %msgs, align 8, !dbg !522
...
"$have_gas_5783":                                 ; preds = %"$out_of_gas_5782", %"$have_gas_5769"
  ...
  call void @_send(i8* %"$execptr_load_5785", %_TyDescrTy_Typ* @"$TyDescr_ADT_List_Message_319", %TName_List_Message* %"$msgs_5786"), !dbg !523
...
entry:
  ...
  call void @"$register_5496"(%Uint128 %_amount, [20 x i8]* %"$_origin_5793", [20 x i8]* %"$_sender_5795", [32 x i8]* %"$parent_5797", %String %label), !dbg !525
  ret void
}

define internal void @"$onResolverConfigured_5800"(%Uint128 %_amount, [20 x i8]* %"$_origin_5801", [20 x i8]* %"$_sender_5802", [32 x i8]* %"$node_5803") !dbg !526 {
entry:
  ...
  %"$maybeRecord_call_5808" = call i8* @_fetch_field(i8* %"$execptr_load_5807", i8* getelementptr inbounds ([8 x i8], [8 x i8]* @"$records_5806", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_325", i32 1, i8* %"$indices_buf_5804", i32 1), !dbg !527
...
"$have_gas_5860":                                 ; preds = %"$out_of_gas_5859", %"$have_gas_5855"
  ...
  %"$eq_call_5868" = call %TName_Bool* @_eq_ByStrX(i8* %"$execptr_load_5862", i32 20, i8* %"$$eq_resolver_5863_5865", i8* %"$$eq__sender_5866_5867"), !dbg !532
  store %TName_Bool* %"$eq_call_5868", %TName_Bool** %isOk, align 8, !dbg !532
...
"$have_gas_5890":                                 ; preds = %"$out_of_gas_5889", %"$have_gas_5885"
  ...
  %"$ud-registry.eConfigured_call_5896" = call { { i8* (i8*, [20 x i8]*)*, i8* } (i8*, [20 x i8]*)*, i8* } %"$ud-registry.eConfigured_fptr_5893"(i8* %"$ud-registry.eConfigured_envptr_5894", [32 x i8]* %"$ud-registry.eConfigured_node_5895"), !dbg !536
  store { { i8* (i8*, [20 x i8]*)*, i8* } (i8*, [20 x i8]*)*, i8* } %"$ud-registry.eConfigured_call_5896", { { i8* (i8*, [20 x i8]*)*, i8* } (i8*, [20 x i8]*)*, i8* }* %"$ud-registry.eConfigured_143", align 8, !dbg !536
  ...
  %"$$ud-registry.eConfigured_143_call_5902" = call { i8* (i8*, [20 x i8]*)*, i8* } %"$$ud-registry.eConfigured_143_fptr_5898"(i8* %"$$ud-registry.eConfigured_143_envptr_5899", [20 x i8]* %"$$ud-registry.eConfigured_143_owner_5900"), !dbg !536
  store { i8* (i8*, [20 x i8]*)*, i8* } %"$$ud-registry.eConfigured_143_call_5902", { i8* (i8*, [20 x i8]*)*, i8* }* %"$ud-registry.eConfigured_144", align 8, !dbg !536
  ...
  %"$$ud-registry.eConfigured_144_call_5908" = call i8* %"$$ud-registry.eConfigured_144_fptr_5904"(i8* %"$$ud-registry.eConfigured_144_envptr_5905", [20 x i8]* %"$$ud-registry.eConfigured_144_resolver_5906"), !dbg !536
  store i8* %"$$ud-registry.eConfigured_144_call_5908", i8** %"$ud-registry.eConfigured_145", align 8, !dbg !536
  %"$$ud-registry.eConfigured_145_5909" = load i8*, i8** %"$ud-registry.eConfigured_145", align 8
  store i8* %"$$ud-registry.eConfigured_145_5909", i8** %e, align 8, !dbg !536
...
"$have_gas_5916":                                 ; preds = %"$out_of_gas_5915", %"$have_gas_5890"
  ...
  call void @_event(i8* %"$execptr_load_5918", %_TyDescrTy_Typ* @"$TyDescr_Event_301", i8* %"$e_5919"), !dbg !539
...
entry:
  ...
  call void @"$onResolverConfigured_5800"(%Uint128 %_amount, [20 x i8]* %"$_origin_5926", [20 x i8]* %"$_sender_5928", [32 x i8]* %"$node_5930"), !dbg !541
  ret void
}
