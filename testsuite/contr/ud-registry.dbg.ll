...
"$have_gas_2235":                                 ; preds = %"$out_of_gas_2234", %"$have_gas_2230"
  ...
  %"$eq_call_2244" = call %TName_Bool* @_eq_ByStrX(i8* %"$execptr_load_2237", i32 20, i8* %"$$eq_sender_2238_2240", i8* %"$$eq_recordOwner_2241_2243"), !dbg !8
  store %TName_Bool* %"$eq_call_2244", %TName_Bool** %isOwner, align 8, !dbg !8
...
"$have_gas_2266":                                 ; preds = %"$out_of_gas_2265", %"$None_2261"
  ...
  store %TName_Bool* %"$adtptr_2270", %TName_Bool** %isApproved, align 8, !dbg !10
...
"$have_gas_2278":                                 ; preds = %"$out_of_gas_2277", %"$Some_2271"
  ...
  %"$eq_call_2287" = call %TName_Bool* @_eq_ByStrX(i8* %"$execptr_load_2280", i32 20, i8* %"$$eq_sender_2281_2283", i8* %"$$eq_approved_2284_2286"), !dbg !13
  store %TName_Bool* %"$eq_call_2287", %TName_Bool** %isApproved, align 8, !dbg !13
  br label %"$matchsucc_2256"
...
"$have_gas_2308":                                 ; preds = %"$out_of_gas_2307", %"$None_2303"
  ...
  store %TName_Bool* %"$adtptr_2312", %TName_Bool** %isOperator, align 8, !dbg !16
...
"$have_gas_2320":                                 ; preds = %"$out_of_gas_2319", %"$Some_2313"
  ...
  %"$ud-registry.listByStr20Contains_call_2326" = call { %TName_Bool* (i8*, [20 x i8]*)*, i8* } %"$ud-registry.listByStr20Contains_fptr_2323"(i8* %"$ud-registry.listByStr20Contains_envptr_2324", %TName_List_ByStr20* %"$operators_2325"), !dbg !19
  store { %TName_Bool* (i8*, [20 x i8]*)*, i8* } %"$ud-registry.listByStr20Contains_call_2326", { %TName_Bool* (i8*, [20 x i8]*)*, i8* }* %"$ud-registry.listByStr20Contains_39", align 8, !dbg !19
  ...
  %"$$ud-registry.listByStr20Contains_39_call_2332" = call %TName_Bool* %"$$ud-registry.listByStr20Contains_39_fptr_2328"(i8* %"$$ud-registry.listByStr20Contains_39_envptr_2329", [20 x i8]* %"$$ud-registry.listByStr20Contains_39_sender_2330"), !dbg !19
  store %TName_Bool* %"$$ud-registry.listByStr20Contains_39_call_2332", %TName_Bool** %"$ud-registry.listByStr20Contains_40", align 8, !dbg !19
  %"$$ud-registry.listByStr20Contains_40_2333" = load %TName_Bool*, %TName_Bool** %"$ud-registry.listByStr20Contains_40", align 8
  store %TName_Bool* %"$$ud-registry.listByStr20Contains_40_2333", %TName_Bool** %isOperator, align 8, !dbg !19
  br label %"$matchsucc_2299"
...
"$have_gas_2342":                                 ; preds = %"$out_of_gas_2341", %"$have_gas_2337"
  ...
  %"$BoolUtils.orb_call_2348" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.orb_fptr_2345"(i8* %"$BoolUtils.orb_envptr_2346", %TName_Bool* %"$isOwner_2347"), !dbg !21
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.orb_call_2348", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.orb_41", align 8, !dbg !21
  ...
  %"$$BoolUtils.orb_41_call_2353" = call %TName_Bool* %"$$BoolUtils.orb_41_fptr_2350"(i8* %"$$BoolUtils.orb_41_envptr_2351", %TName_Bool* %"$isApproved_2352"), !dbg !21
  store %TName_Bool* %"$$BoolUtils.orb_41_call_2353", %TName_Bool** %"$BoolUtils.orb_42", align 8, !dbg !21
  %"$$BoolUtils.orb_42_2354" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.orb_42", align 8
  store %TName_Bool* %"$$BoolUtils.orb_42_2354", %TName_Bool** %b1, align 8, !dbg !21
...
"$have_gas_2358":                                 ; preds = %"$out_of_gas_2357", %"$have_gas_2342"
  ...
  %"$BoolUtils.orb_call_2364" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.orb_fptr_2361"(i8* %"$BoolUtils.orb_envptr_2362", %TName_Bool* %"$b1_2363"), !dbg !22
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.orb_call_2364", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.orb_43", align 8, !dbg !22
  ...
  %"$$BoolUtils.orb_43_call_2369" = call %TName_Bool* %"$$BoolUtils.orb_43_fptr_2366"(i8* %"$$BoolUtils.orb_43_envptr_2367", %TName_Bool* %"$isOperator_2368"), !dbg !22
  store %TName_Bool* %"$$BoolUtils.orb_43_call_2369", %TName_Bool** %"$BoolUtils.orb_44", align 8, !dbg !22
  %"$$BoolUtils.orb_44_2370" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.orb_44", align 8
  store %TName_Bool* %"$$BoolUtils.orb_44_2370", %TName_Bool** %"$retval_215", align 8, !dbg !22
...
"$have_gas_2201":                                 ; preds = %"$out_of_gas_2200", %entry
  ...
  store { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* } %"$$fundef_214_cloval_2206", { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* }* %"$retval_213", align 8, !dbg !24
...
"$have_gas_2176":                                 ; preds = %"$out_of_gas_2175", %entry
  ...
  store { { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* } (i8*, %TName_Option_ByStr20*)*, i8* } %"$$fundef_212_cloval_2181", { { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* } (i8*, %TName_Option_ByStr20*)*, i8* }* %"$retval_211", align 8, !dbg !26
...
"$have_gas_2155":                                 ; preds = %"$out_of_gas_2154", %entry
  ...
  store { { { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* } (i8*, %TName_Option_ByStr20*)*, i8* } (i8*, [20 x i8]*)*, i8* } %"$$fundef_210_cloval_2160", { { { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* } (i8*, %TName_Option_ByStr20*)*, i8* } (i8*, [20 x i8]*)*, i8* }* %"$retval_209", align 8, !dbg !28
...
"$have_gas_2098":                                 ; preds = %"$out_of_gas_2097", %"$have_gas_2085"
  ...
  %"$sha256hash_call_2103" = call [32 x i8]* @_sha256hash(i8* %"$execptr_load_2100", %_TyDescrTy_Typ* @"$TyDescr_String_295", i8* %"$$sha256hash_label_2101_2102"), !dbg !30
  %"$sha256hash_2105" = load [32 x i8], [32 x i8]* %"$sha256hash_call_2103", align 1
  store [32 x i8] %"$sha256hash_2105", [32 x i8]* %labelHash, align 1, !dbg !30
...
"$have_gas_2114":                                 ; preds = %"$out_of_gas_2113", %"$have_gas_2109"
  ...
  %"$concat_call_2123" = call i8* @_concat_ByStrX(i8* %"$execptr_load_2116", i32 32, i8* %"$$concat_parent_2117_2119", i32 32, i8* %"$$concat_labelHash_2120_2122"), !dbg !31
  %"$concat_2124" = bitcast i8* %"$concat_call_2123" to [64 x i8]*
  %"$concat_2125" = load [64 x i8], [64 x i8]* %"$concat_2124", align 1
  store [64 x i8] %"$concat_2125", [64 x i8]* %nodeInput, align 1, !dbg !31
...
"$have_gas_2138":                                 ; preds = %"$out_of_gas_2137", %"$have_gas_2114"
  ...
  %"$sha256hash_call_2144" = call [32 x i8]* @_sha256hash(i8* %"$execptr_load_2140", %_TyDescrTy_Typ* @"$TyDescr_Bystr64_307", i8* %"$$sha256hash_nodeInput_2141_2143"), !dbg !32
  %"$sha256hash_2146" = load [32 x i8], [32 x i8]* %"$sha256hash_call_2144", align 1
  store [32 x i8] %"$sha256hash_2146", [32 x i8]* %"$retval_219", align 1, !dbg !32
...
"$have_gas_2375":                                 ; preds = %"$out_of_gas_2374", %entry
  ...
  store { i8*, i8* }* %"$dyndisp_table_2380", { i8*, i8* }** @list_foldr, align 8, !dbg !242
...
"$have_gas_2386":                                 ; preds = %"$out_of_gas_2385", %"$have_gas_2375"
  ...
  store { i8*, i8* }* %"$dyndisp_table_2391", { i8*, i8* }** @list_foldk, align 8, !dbg !242
...
"$have_gas_2421":                                 ; preds = %"$out_of_gas_2420", %"$have_gas_2413"
  ...
  store { i8*, i8* }* %"$dyndisp_table_2429", { i8*, i8* }** @ListUtils.list_filter, align 8, !dbg !246
...
"$have_gas_2435":                                 ; preds = %"$out_of_gas_2434", %"$have_gas_2421"
  ...
  store { i8*, i8* }* %"$dyndisp_table_2443", { i8*, i8* }** @ListUtils.list_find, align 8, !dbg !247
...
"$have_gas_2449":                                 ; preds = %"$out_of_gas_2448", %"$have_gas_2435"
  ...
  store { i8*, i8* }* %"$dyndisp_table_2457", { i8*, i8* }** @ListUtils.list_exists, align 8, !dbg !248
...
"$have_gas_2463":                                 ; preds = %"$out_of_gas_2462", %"$have_gas_2449"
  ...
  store { i8*, i8* }* %"$dyndisp_table_2471", { i8*, i8* }** @ListUtils.list_mem, align 8, !dbg !249
...
"$have_gas_2482":                                 ; preds = %"$out_of_gas_2481", %"$have_gas_2477"
  ...
  store %TName_List_ByStr20* %"$adtptr_2486", %TName_List_ByStr20** @ud-registry.nilByStr20, align 8, !dbg !251
...
"$have_gas_2490":                                 ; preds = %"$out_of_gas_2489", %"$have_gas_2482"
  ...
  store %TName_List_Message* %"$adtptr_2494", %TName_List_Message** @ud-registry.nilMessage, align 8, !dbg !252
...
"$have_gas_2498":                                 ; preds = %"$out_of_gas_2497", %"$have_gas_2490"
  ...
  store { %TName_List_Message* (i8*, i8*)*, i8* } %"$$fundef_270_cloval_2503", { %TName_List_Message* (i8*, i8*)*, i8* }* @ud-registry.oneMsg, align 8, !dbg !253
...
"$have_gas_2517":                                 ; preds = %"$out_of_gas_2516", %"$have_gas_2509"
  ...
  store { { %TName_Bool* (i8*, [20 x i8]*)*, i8* } (i8*, %TName_List_ByStr20*)*, i8* } %"$$fundef_262_cloval_2522", { { %TName_Bool* (i8*, [20 x i8]*)*, i8* } (i8*, %TName_List_ByStr20*)*, i8* }* @ud-registry.listByStr20Contains, align 8, !dbg !255
...
"$have_gas_2530":                                 ; preds = %"$out_of_gas_2529", %"$have_gas_2517"
  ...
  store { { %TName_Bool* (i8*, [20 x i8]*)*, i8* } (i8*, %TName_List_ByStr20*)*, i8* } %"$$fundef_258_cloval_2535", { { %TName_Bool* (i8*, [20 x i8]*)*, i8* } (i8*, %TName_List_ByStr20*)*, i8* }* @ud-registry.listByStr20Excludes, align 8, !dbg !256
...
"$have_gas_2543":                                 ; preds = %"$out_of_gas_2542", %"$have_gas_2530"
  ...
  store { { %TName_List_ByStr20* (i8*, [20 x i8]*)*, i8* } (i8*, %TName_List_ByStr20*)*, i8* } %"$$fundef_252_cloval_2548", { { %TName_List_ByStr20* (i8*, [20 x i8]*)*, i8* } (i8*, %TName_List_ByStr20*)*, i8* }* @ud-registry.listByStr20FilterOut, align 8, !dbg !257
...
"$have_gas_2639":                                 ; preds = %"$out_of_gas_2638", %"$have_gas_2631"
  ...
  store { { { { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* } (i8*, %TName_Option_ByStr20*)*, i8* } (i8*, [20 x i8]*)*, i8* } (i8*, [20 x i8]*)*, i8* } %"$$fundef_208_cloval_2644", { { { { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* } (i8*, %TName_Option_ByStr20*)*, i8* } (i8*, [20 x i8]*)*, i8* } (i8*, [20 x i8]*)*, i8* }* @ud-registry.getIsOAO, align 8, !dbg !268
  ret void
}
...
"$have_gas_2657":                                 ; preds = %"$out_of_gas_2656", %"$have_gas_2652"
  ...
  store %Map_ByStr32_ud-registry.Record* %"$_new_empty_map_2661", %Map_ByStr32_ud-registry.Record** %empty, align 8, !dbg !270
...
"$have_gas_2670":                                 ; preds = %"$out_of_gas_2669", %"$have_gas_2665"
  ...
  store %TName_ud-registry.Record* %"$adtptr_2678", %TName_ud-registry.Record** %rootRecord, align 8, !dbg !271
...
"$have_gas_2686":                                 ; preds = %"$out_of_gas_2685", %"$have_gas_2670"
  ...
  %"$put_call_2696" = call i8* @_put(i8* %"$execptr_load_2688", %_TyDescrTy_Typ* @"$TyDescr_Map_325", i8* %"$$empty_2689_2690", i8* %"$$put_rootNode_2691_2693", i8* %"$$rootRecord_2694_2695"), !dbg !272
  %"$put_2697" = bitcast i8* %"$put_call_2696" to %Map_ByStr32_ud-registry.Record*
  store %Map_ByStr32_ud-registry.Record* %"$put_2697", %Map_ByStr32_ud-registry.Record** %"$records_272", align 8, !dbg !272
  ...
  call void @_update_field(i8* %"$execptr_load_2698", i8* getelementptr inbounds ([8 x i8], [8 x i8]* @"$records_2699", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_325", i32 0, i8* null, i8* %"$update_value_2701"), !dbg !270
...
"$have_gas_2705":                                 ; preds = %"$out_of_gas_2704", %"$have_gas_2686"
  ...
  store [20 x i8] %"$ud-registry.zeroByStr20_2707", [20 x i8]* %"$registrar_273", align 1, !dbg !273
  ...
  call void @_update_field(i8* %"$execptr_load_2708", i8* getelementptr inbounds ([10 x i8], [10 x i8]* @"$registrar_2709", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Bystr20_311", i32 0, i8* null, i8* %"$update_value_2712"), !dbg !273
...
"$have_gas_2716":                                 ; preds = %"$out_of_gas_2715", %"$have_gas_2705"
  ...
  store %Map_ByStr32_ByStr20* %"$_new_empty_map_2720", %Map_ByStr32_ByStr20** %"$approvals_274", align 8, !dbg !274
  ...
  call void @_update_field(i8* %"$execptr_load_2721", i8* getelementptr inbounds ([10 x i8], [10 x i8]* @"$approvals_2722", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_324", i32 0, i8* null, i8* %"$update_value_2724"), !dbg !274
...
"$have_gas_2728":                                 ; preds = %"$out_of_gas_2727", %"$have_gas_2716"
  ...
  store %"Map_ByStr20_List_(ByStr20)"* %"$_new_empty_map_2732", %"Map_ByStr20_List_(ByStr20)"** %"$operators_275", align 8, !dbg !275
  ...
  call void @_update_field(i8* %"$execptr_load_2733", i8* getelementptr inbounds ([10 x i8], [10 x i8]* @"$operators_2734", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_323", i32 0, i8* null, i8* %"$update_value_2736"), !dbg !275
...
"$have_gas_2740":                                 ; preds = %"$out_of_gas_2739", %"$have_gas_2728"
  ...
  store %TName_List_ByStr20* %"$adtptr_2748", %TName_List_ByStr20** %"$admins_276", align 8, !dbg !276
  ...
  call void @_update_field(i8* %"$execptr_load_2749", i8* getelementptr inbounds ([7 x i8], [7 x i8]* @"$admins_2750", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_ADT_List_ByStr20_320", i32 0, i8* null, i8* %"$update_value_2752"), !dbg !276
  ret void
}
...
define internal void @"$setAdmin_2753"(%Uint128 %_amount, [20 x i8]* %"$_origin_2754", [20 x i8]* %"$_sender_2755", [20 x i8]* %"$address_2756", %TName_Bool* %isApproved) !dbg !277 {
entry:
  ...
  %"$currentAdmins_call_2759" = call i8* @_fetch_field(i8* %"$execptr_load_2758", i8* getelementptr inbounds ([7 x i8], [7 x i8]* @"$admins_2757", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_ADT_List_ByStr20_320", i32 0, i8* null, i32 1), !dbg !278
...
"$have_gas_2778":                                 ; preds = %"$out_of_gas_2777", %"$have_gas_2773"
  ...
  %"$ud-registry.listByStr20Contains_call_2784" = call { %TName_Bool* (i8*, [20 x i8]*)*, i8* } %"$ud-registry.listByStr20Contains_fptr_2781"(i8* %"$ud-registry.listByStr20Contains_envptr_2782", %TName_List_ByStr20* %"$currentAdmins_2783"), !dbg !279
  store { %TName_Bool* (i8*, [20 x i8]*)*, i8* } %"$ud-registry.listByStr20Contains_call_2784", { %TName_Bool* (i8*, [20 x i8]*)*, i8* }* %"$ud-registry.listByStr20Contains_54", align 8, !dbg !279
  ...
  %"$$ud-registry.listByStr20Contains_54_call_2789" = call %TName_Bool* %"$$ud-registry.listByStr20Contains_54_fptr_2786"(i8* %"$$ud-registry.listByStr20Contains_54_envptr_2787", [20 x i8]* %"$$ud-registry.listByStr20Contains_54__sender_2788"), !dbg !279
  store %TName_Bool* %"$$ud-registry.listByStr20Contains_54_call_2789", %TName_Bool** %"$ud-registry.listByStr20Contains_55", align 8, !dbg !279
  %"$$ud-registry.listByStr20Contains_55_2790" = load %TName_Bool*, %TName_Bool** %"$ud-registry.listByStr20Contains_55", align 8
  store %TName_Bool* %"$$ud-registry.listByStr20Contains_55_2790", %TName_Bool** %isSenderAdmin, align 8, !dbg !279
...
"$have_gas_2816":                                 ; preds = %"$out_of_gas_2815", %"$have_gas_2811"
  ...
  %"$ud-registry.listByStr20Excludes_call_2822" = call { %TName_Bool* (i8*, [20 x i8]*)*, i8* } %"$ud-registry.listByStr20Excludes_fptr_2819"(i8* %"$ud-registry.listByStr20Excludes_envptr_2820", %TName_List_ByStr20* %"$currentAdmins_2821"), !dbg !281
  store { %TName_Bool* (i8*, [20 x i8]*)*, i8* } %"$ud-registry.listByStr20Excludes_call_2822", { %TName_Bool* (i8*, [20 x i8]*)*, i8* }* %"$ud-registry.listByStr20Excludes_49", align 8, !dbg !281
  ...
  %"$$ud-registry.listByStr20Excludes_49_call_2827" = call %TName_Bool* %"$$ud-registry.listByStr20Excludes_49_fptr_2824"(i8* %"$$ud-registry.listByStr20Excludes_49_envptr_2825", [20 x i8]* %"$$ud-registry.listByStr20Excludes_49_address_2826"), !dbg !281
  store %TName_Bool* %"$$ud-registry.listByStr20Excludes_49_call_2827", %TName_Bool** %"$ud-registry.listByStr20Excludes_50", align 8, !dbg !281
  %"$$ud-registry.listByStr20Excludes_50_2828" = load %TName_Bool*, %TName_Bool** %"$ud-registry.listByStr20Excludes_50", align 8
  store %TName_Bool* %"$$ud-registry.listByStr20Excludes_50_2828", %TName_Bool** %b, align 8, !dbg !281
...
"$have_gas_2832":                                 ; preds = %"$out_of_gas_2831", %"$have_gas_2816"
  ...
  %"$ud-registry.xandb_call_2838" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$ud-registry.xandb_fptr_2835"(i8* %"$ud-registry.xandb_envptr_2836", %TName_Bool* %"$b_2837"), !dbg !284
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$ud-registry.xandb_call_2838", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$ud-registry.xandb_51", align 8, !dbg !284
  ...
  %"$$ud-registry.xandb_51_call_2842" = call %TName_Bool* %"$$ud-registry.xandb_51_fptr_2840"(i8* %"$$ud-registry.xandb_51_envptr_2841", %TName_Bool* %isApproved), !dbg !284
  store %TName_Bool* %"$$ud-registry.xandb_51_call_2842", %TName_Bool** %"$ud-registry.xandb_52", align 8, !dbg !284
  %"$$ud-registry.xandb_52_2843" = load %TName_Bool*, %TName_Bool** %"$ud-registry.xandb_52", align 8
  store %TName_Bool* %"$$ud-registry.xandb_52_2843", %TName_Bool** %needsToChange, align 8, !dbg !284
...
"$have_gas_2875":                                 ; preds = %"$out_of_gas_2874", %"$True_2870"
  ...
  store %TName_List_ByStr20* %"$adtptr_2882", %TName_List_ByStr20** %newAdmins, align 8, !dbg !289
...
"$have_gas_2888":                                 ; preds = %"$out_of_gas_2887", %"$False_2883"
  ...
  %"$ud-registry.listByStr20FilterOut_call_2894" = call { %TName_List_ByStr20* (i8*, [20 x i8]*)*, i8* } %"$ud-registry.listByStr20FilterOut_fptr_2891"(i8* %"$ud-registry.listByStr20FilterOut_envptr_2892", %TName_List_ByStr20* %"$currentAdmins_2893"), !dbg !292
  store { %TName_List_ByStr20* (i8*, [20 x i8]*)*, i8* } %"$ud-registry.listByStr20FilterOut_call_2894", { %TName_List_ByStr20* (i8*, [20 x i8]*)*, i8* }* %"$ud-registry.listByStr20FilterOut_47", align 8, !dbg !292
  ...
  %"$$ud-registry.listByStr20FilterOut_47_call_2899" = call %TName_List_ByStr20* %"$$ud-registry.listByStr20FilterOut_47_fptr_2896"(i8* %"$$ud-registry.listByStr20FilterOut_47_envptr_2897", [20 x i8]* %"$$ud-registry.listByStr20FilterOut_47_address_2898"), !dbg !292
  store %TName_List_ByStr20* %"$$ud-registry.listByStr20FilterOut_47_call_2899", %TName_List_ByStr20** %"$ud-registry.listByStr20FilterOut_48", align 8, !dbg !292
  ...
  store %TName_List_ByStr20* %"$$ud-registry.listByStr20FilterOut_48_2900", %TName_List_ByStr20** %newAdmins, align 8, !dbg !292
  br label %"$matchsucc_2866"
...
"$have_gas_2907":                                 ; preds = %"$out_of_gas_2906", %"$matchsucc_2866"
  ...
  call void @_update_field(i8* %"$execptr_load_2909", i8* getelementptr inbounds ([7 x i8], [7 x i8]* @"$admins_2910", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_ADT_List_ByStr20_320", i32 0, i8* null, i8* %"$update_value_2912"), !dbg !294
...
"$have_gas_2921":                                 ; preds = %"$out_of_gas_2920", %"$have_gas_2916"
  ...
  %"$ud-registry.eAdminSet_call_2927" = call { i8* (i8*, %TName_Bool*)*, i8* } %"$ud-registry.eAdminSet_fptr_2924"(i8* %"$ud-registry.eAdminSet_envptr_2925", [20 x i8]* %"$ud-registry.eAdminSet_address_2926"), !dbg !295
  store { i8* (i8*, %TName_Bool*)*, i8* } %"$ud-registry.eAdminSet_call_2927", { i8* (i8*, %TName_Bool*)*, i8* }* %"$ud-registry.eAdminSet_45", align 8, !dbg !295
  ...
  %"$$ud-registry.eAdminSet_45_call_2931" = call i8* %"$$ud-registry.eAdminSet_45_fptr_2929"(i8* %"$$ud-registry.eAdminSet_45_envptr_2930", %TName_Bool* %isApproved), !dbg !295
  store i8* %"$$ud-registry.eAdminSet_45_call_2931", i8** %"$ud-registry.eAdminSet_46", align 8, !dbg !295
  %"$$ud-registry.eAdminSet_46_2932" = load i8*, i8** %"$ud-registry.eAdminSet_46", align 8
  store i8* %"$$ud-registry.eAdminSet_46_2932", i8** %e, align 8, !dbg !295
...
"$have_gas_2939":                                 ; preds = %"$out_of_gas_2938", %"$have_gas_2921"
  ...
  call void @_event(i8* %"$execptr_load_2941", %_TyDescrTy_Typ* @"$TyDescr_Event_301", i8* %"$e_2942"), !dbg !296
...
"$have_gas_2958":                                 ; preds = %"$out_of_gas_2957", %"$have_gas_2953"
  ...
  store %String { i8* getelementptr inbounds ([26 x i8], [26 x i8]* @"$stringlit_2960", i32 0, i32 0), i32 26 }, %String* %m, align 8, !dbg !297
...
"$have_gas_2964":                                 ; preds = %"$out_of_gas_2963", %"$have_gas_2958"
  ...
  %"$ud-registry.eError_call_2970" = call i8* %"$ud-registry.eError_fptr_2967"(i8* %"$ud-registry.eError_envptr_2968", %String %"$m_2969"), !dbg !299
  store i8* %"$ud-registry.eError_call_2970", i8** %"$ud-registry.eError_53", align 8, !dbg !299
  %"$$ud-registry.eError_53_2971" = load i8*, i8** %"$ud-registry.eError_53", align 8
  store i8* %"$$ud-registry.eError_53_2971", i8** %e1, align 8, !dbg !299
...
"$have_gas_2978":                                 ; preds = %"$out_of_gas_2977", %"$have_gas_2964"
  ...
  call void @_event(i8* %"$execptr_load_2980", %_TyDescrTy_Typ* @"$TyDescr_Event_301", i8* %"$e_2981"), !dbg !300
  br label %"$matchsucc_2796"
...
entry:
  ...
  call void @"$setAdmin_2753"(%Uint128 %_amount, [20 x i8]* %"$_origin_2986", [20 x i8]* %"$_sender_2988", [20 x i8]* %"$address_2990", %TName_Bool* %isApproved), !dbg !302
  ret void
}

define internal void @"$approve_2993"(%Uint128 %_amount, [20 x i8]* %"$_origin_2994", [20 x i8]* %"$_sender_2995", [32 x i8]* %"$node_2996", [20 x i8]* %"$address_2997") !dbg !303 {
entry:
  ...
  %"$maybeRecord_call_3002" = call i8* @_fetch_field(i8* %"$execptr_load_3001", i8* getelementptr inbounds ([8 x i8], [8 x i8]* @"$records_3000", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_325", i32 1, i8* %"$indices_buf_2998", i32 1), !dbg !304
...
"$have_gas_3022":                                 ; preds = %"$out_of_gas_3021", %"$have_gas_3017"
  ...
  call void %"$ud-registry.recordMemberOwner_fptr_3025"(i8* %"$ud-registry.recordMemberOwner_envptr_3026", [20 x i8]* %"$ud-registry.recordMemberOwner_retalloca_3028", %TName_Option_ud-registry.Record* %"$maybeRecord_3027"), !dbg !305
  %"$ud-registry.recordMemberOwner_ret_3029" = load [20 x i8], [20 x i8]* %"$ud-registry.recordMemberOwner_retalloca_3028", align 1
  store [20 x i8] %"$ud-registry.recordMemberOwner_ret_3029", [20 x i8]* %"$ud-registry.recordMemberOwner_59", align 1, !dbg !305
  %"$$ud-registry.recordMemberOwner_59_3030" = load [20 x i8], [20 x i8]* %"$ud-registry.recordMemberOwner_59", align 1
  store [20 x i8] %"$$ud-registry.recordMemberOwner_59_3030", [20 x i8]* %recordOwner, align 1, !dbg !305
...
"$have_gas_3039":                                 ; preds = %"$out_of_gas_3038", %"$have_gas_3034"
  ...
  %"$eq_call_3047" = call %TName_Bool* @_eq_ByStrX(i8* %"$execptr_load_3041", i32 20, i8* %"$$eq__sender_3042_3043", i8* %"$$eq_recordOwner_3044_3046"), !dbg !306
  store %TName_Bool* %"$eq_call_3047", %TName_Bool** %isSenderNodeOwner, align 8, !dbg !306
...
"$True_3059":                                     ; preds = %"$have_gas_3052"
  ...
  %"$maybeApproved_call_3065" = call i8* @_fetch_field(i8* %"$execptr_load_3064", i8* getelementptr inbounds ([10 x i8], [10 x i8]* @"$approvals_3063", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_324", i32 1, i8* %"$indices_buf_3061", i32 1), !dbg !308
...
"$have_gas_3097":                                 ; preds = %"$out_of_gas_3096", %"$None_3092"
  ...
  store [20 x i8] %"$ud-registry.zeroByStr20_3099", [20 x i8]* %currentlyApproved, align 1, !dbg !312
...
"$have_gas_3107":                                 ; preds = %"$out_of_gas_3106", %"$Some_3100"
  ...
  store [20 x i8] %"$approved_3109", [20 x i8]* %currentlyApproved, align 1, !dbg !315
  br label %"$matchsucc_3087"
...
"$have_gas_3123":                                 ; preds = %"$out_of_gas_3122", %"$have_gas_3118"
  ...
  %"$eq_call_3131" = call %TName_Bool* @_eq_ByStrX(i8* %"$execptr_load_3125", i32 20, i8* %"$$eq_currentlyApproved_3126_3128", i8* %"$$eq_address_3129_3130"), !dbg !317
  store %TName_Bool* %"$eq_call_3131", %TName_Bool** %b, align 8, !dbg !317
...
"$have_gas_3136":                                 ; preds = %"$out_of_gas_3135", %"$have_gas_3123"
  ...
  %"$BoolUtils.negb_call_3142" = call %TName_Bool* %"$BoolUtils.negb_fptr_3139"(i8* %"$BoolUtils.negb_envptr_3140", %TName_Bool* %"$b_3141"), !dbg !318
  store %TName_Bool* %"$BoolUtils.negb_call_3142", %TName_Bool** %"$BoolUtils.negb_57", align 8, !dbg !318
  %"$$BoolUtils.negb_57_3143" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.negb_57", align 8
  store %TName_Bool* %"$$BoolUtils.negb_57_3143", %TName_Bool** %needsToChange, align 8, !dbg !318
...
"$have_gas_3163":                                 ; preds = %"$out_of_gas_3162", %"$True_3154"
  ...
  call void @_update_field(i8* %"$execptr_load_3167", i8* getelementptr inbounds ([10 x i8], [10 x i8]* @"$approvals_3168", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_324", i32 1, i8* %"$indices_buf_3165", i8* %"$update_value_3170"), !dbg !320
...
"$have_gas_3179":                                 ; preds = %"$out_of_gas_3178", %"$have_gas_3174"
  ...
  %"$ud-registry.eApproved_call_3185" = call i8* %"$ud-registry.eApproved_fptr_3182"(i8* %"$ud-registry.eApproved_envptr_3183", [20 x i8]* %"$ud-registry.eApproved_address_3184"), !dbg !323
  store i8* %"$ud-registry.eApproved_call_3185", i8** %"$ud-registry.eApproved_56", align 8, !dbg !323
  %"$$ud-registry.eApproved_56_3186" = load i8*, i8** %"$ud-registry.eApproved_56", align 8
  store i8* %"$$ud-registry.eApproved_56_3186", i8** %e, align 8, !dbg !323
...
"$have_gas_3193":                                 ; preds = %"$out_of_gas_3192", %"$have_gas_3179"
  ...
  call void @_event(i8* %"$execptr_load_3195", %_TyDescrTy_Typ* @"$TyDescr_Event_301", i8* %"$e_3196"), !dbg !324
...
"$have_gas_3212":                                 ; preds = %"$out_of_gas_3211", %"$have_gas_3207"
  ...
  store %String { i8* getelementptr inbounds ([21 x i8], [21 x i8]* @"$stringlit_3214", i32 0, i32 0), i32 21 }, %String* %m, align 8, !dbg !325
...
"$have_gas_3218":                                 ; preds = %"$out_of_gas_3217", %"$have_gas_3212"
  ...
  %"$ud-registry.eError_call_3224" = call i8* %"$ud-registry.eError_fptr_3221"(i8* %"$ud-registry.eError_envptr_3222", %String %"$m_3223"), !dbg !327
  store i8* %"$ud-registry.eError_call_3224", i8** %"$ud-registry.eError_58", align 8, !dbg !327
  %"$$ud-registry.eError_58_3225" = load i8*, i8** %"$ud-registry.eError_58", align 8
  store i8* %"$$ud-registry.eError_58_3225", i8** %e3, align 8, !dbg !327
...
"$have_gas_3232":                                 ; preds = %"$out_of_gas_3231", %"$have_gas_3218"
  ...
  call void @_event(i8* %"$execptr_load_3234", %_TyDescrTy_Typ* @"$TyDescr_Event_301", i8* %"$e_3235"), !dbg !328
  br label %"$matchsucc_3054"
...
entry:
  ...
  call void @"$approve_2993"(%Uint128 %_amount, [20 x i8]* %"$_origin_3240", [20 x i8]* %"$_sender_3242", [32 x i8]* %"$node_3244", [20 x i8]* %"$address_3246"), !dbg !330
  ret void
}

define internal void @"$approveFor_3247"(%Uint128 %_amount, [20 x i8]* %"$_origin_3248", [20 x i8]* %"$_sender_3249", [20 x i8]* %"$address_3250", %TName_Bool* %isApproved) !dbg !331 {
entry:
  ...
  %"$maybeOperators_call_3255" = call i8* @_fetch_field(i8* %"$execptr_load_3254", i8* getelementptr inbounds ([10 x i8], [10 x i8]* @"$operators_3253", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_323", i32 1, i8* %"$indices_buf_3251", i32 1), !dbg !332
...
"$have_gas_3287":                                 ; preds = %"$out_of_gas_3286", %"$None_3282"
  ...
  store %TName_List_ByStr20* %"$ud-registry.nilByStr20_3289", %TName_List_ByStr20** %currentOperators, align 8, !dbg !334
...
"$have_gas_3297":                                 ; preds = %"$out_of_gas_3296", %"$Some_3290"
  ...
  store %TName_List_ByStr20* %"$ops_3299", %TName_List_ByStr20** %currentOperators, align 8, !dbg !337
  br label %"$matchsucc_3277"
...
"$have_gas_3313":                                 ; preds = %"$out_of_gas_3312", %"$have_gas_3308"
  ...
  %"$ud-registry.listByStr20Excludes_call_3319" = call { %TName_Bool* (i8*, [20 x i8]*)*, i8* } %"$ud-registry.listByStr20Excludes_fptr_3316"(i8* %"$ud-registry.listByStr20Excludes_envptr_3317", %TName_List_ByStr20* %"$currentOperators_3318"), !dbg !339
  store { %TName_Bool* (i8*, [20 x i8]*)*, i8* } %"$ud-registry.listByStr20Excludes_call_3319", { %TName_Bool* (i8*, [20 x i8]*)*, i8* }* %"$ud-registry.listByStr20Excludes_65", align 8, !dbg !339
  ...
  %"$$ud-registry.listByStr20Excludes_65_call_3324" = call %TName_Bool* %"$$ud-registry.listByStr20Excludes_65_fptr_3321"(i8* %"$$ud-registry.listByStr20Excludes_65_envptr_3322", [20 x i8]* %"$$ud-registry.listByStr20Excludes_65_address_3323"), !dbg !339
  store %TName_Bool* %"$$ud-registry.listByStr20Excludes_65_call_3324", %TName_Bool** %"$ud-registry.listByStr20Excludes_66", align 8, !dbg !339
  %"$$ud-registry.listByStr20Excludes_66_3325" = load %TName_Bool*, %TName_Bool** %"$ud-registry.listByStr20Excludes_66", align 8
  store %TName_Bool* %"$$ud-registry.listByStr20Excludes_66_3325", %TName_Bool** %b, align 8, !dbg !339
...
"$have_gas_3329":                                 ; preds = %"$out_of_gas_3328", %"$have_gas_3313"
  ...
  %"$ud-registry.xandb_call_3335" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$ud-registry.xandb_fptr_3332"(i8* %"$ud-registry.xandb_envptr_3333", %TName_Bool* %"$b_3334"), !dbg !340
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$ud-registry.xandb_call_3335", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$ud-registry.xandb_67", align 8, !dbg !340
  ...
  %"$$ud-registry.xandb_67_call_3339" = call %TName_Bool* %"$$ud-registry.xandb_67_fptr_3337"(i8* %"$$ud-registry.xandb_67_envptr_3338", %TName_Bool* %isApproved), !dbg !340
  store %TName_Bool* %"$$ud-registry.xandb_67_call_3339", %TName_Bool** %"$ud-registry.xandb_68", align 8, !dbg !340
  %"$$ud-registry.xandb_68_3340" = load %TName_Bool*, %TName_Bool** %"$ud-registry.xandb_68", align 8
  store %TName_Bool* %"$$ud-registry.xandb_68_3340", %TName_Bool** %needsToChange, align 8, !dbg !340
...
"$have_gas_3372":                                 ; preds = %"$out_of_gas_3371", %"$True_3367"
  ...
  store %TName_List_ByStr20* %"$adtptr_3379", %TName_List_ByStr20** %newOperators, align 8, !dbg !345
...
"$have_gas_3385":                                 ; preds = %"$out_of_gas_3384", %"$False_3380"
  ...
  %"$ud-registry.listByStr20FilterOut_call_3391" = call { %TName_List_ByStr20* (i8*, [20 x i8]*)*, i8* } %"$ud-registry.listByStr20FilterOut_fptr_3388"(i8* %"$ud-registry.listByStr20FilterOut_envptr_3389", %TName_List_ByStr20* %"$currentOperators_3390"), !dbg !348
  store { %TName_List_ByStr20* (i8*, [20 x i8]*)*, i8* } %"$ud-registry.listByStr20FilterOut_call_3391", { %TName_List_ByStr20* (i8*, [20 x i8]*)*, i8* }* %"$ud-registry.listByStr20FilterOut_63", align 8, !dbg !348
  ...
  %"$$ud-registry.listByStr20FilterOut_63_call_3396" = call %TName_List_ByStr20* %"$$ud-registry.listByStr20FilterOut_63_fptr_3393"(i8* %"$$ud-registry.listByStr20FilterOut_63_envptr_3394", [20 x i8]* %"$$ud-registry.listByStr20FilterOut_63_address_3395"), !dbg !348
  store %TName_List_ByStr20* %"$$ud-registry.listByStr20FilterOut_63_call_3396", %TName_List_ByStr20** %"$ud-registry.listByStr20FilterOut_64", align 8, !dbg !348
  ...
  store %TName_List_ByStr20* %"$$ud-registry.listByStr20FilterOut_64_3397", %TName_List_ByStr20** %newOperators, align 8, !dbg !348
  br label %"$matchsucc_3363"
...
"$have_gas_3405":                                 ; preds = %"$out_of_gas_3404", %"$matchsucc_3363"
  ...
  call void @_update_field(i8* %"$execptr_load_3409", i8* getelementptr inbounds ([10 x i8], [10 x i8]* @"$operators_3410", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_323", i32 1, i8* %"$indices_buf_3407", i8* %"$update_value_3412"), !dbg !350
...
"$have_gas_3421":                                 ; preds = %"$out_of_gas_3420", %"$have_gas_3416"
  ...
  %"$ud-registry.eApprovedFor_call_3427" = call { { i8* (i8*, %TName_Bool*)*, i8* } (i8*, [20 x i8]*)*, i8* } %"$ud-registry.eApprovedFor_fptr_3424"(i8* %"$ud-registry.eApprovedFor_envptr_3425", [20 x i8]* %"$ud-registry.eApprovedFor__sender_3426"), !dbg !351
  store { { i8* (i8*, %TName_Bool*)*, i8* } (i8*, [20 x i8]*)*, i8* } %"$ud-registry.eApprovedFor_call_3427", { { i8* (i8*, %TName_Bool*)*, i8* } (i8*, [20 x i8]*)*, i8* }* %"$ud-registry.eApprovedFor_60", align 8, !dbg !351
  ...
  %"$$ud-registry.eApprovedFor_60_call_3432" = call { i8* (i8*, %TName_Bool*)*, i8* } %"$$ud-registry.eApprovedFor_60_fptr_3429"(i8* %"$$ud-registry.eApprovedFor_60_envptr_3430", [20 x i8]* %"$$ud-registry.eApprovedFor_60_address_3431"), !dbg !351
  store { i8* (i8*, %TName_Bool*)*, i8* } %"$$ud-registry.eApprovedFor_60_call_3432", { i8* (i8*, %TName_Bool*)*, i8* }* %"$ud-registry.eApprovedFor_61", align 8, !dbg !351
  ...
  %"$$ud-registry.eApprovedFor_61_call_3436" = call i8* %"$$ud-registry.eApprovedFor_61_fptr_3434"(i8* %"$$ud-registry.eApprovedFor_61_envptr_3435", %TName_Bool* %isApproved), !dbg !351
  store i8* %"$$ud-registry.eApprovedFor_61_call_3436", i8** %"$ud-registry.eApprovedFor_62", align 8, !dbg !351
  %"$$ud-registry.eApprovedFor_62_3437" = load i8*, i8** %"$ud-registry.eApprovedFor_62", align 8
  store i8* %"$$ud-registry.eApprovedFor_62_3437", i8** %e, align 8, !dbg !351
...
"$have_gas_3444":                                 ; preds = %"$out_of_gas_3443", %"$have_gas_3421"
  ...
  call void @_event(i8* %"$execptr_load_3446", %_TyDescrTy_Typ* @"$TyDescr_Event_301", i8* %"$e_3447"), !dbg !352
...
entry:
  ...
  call void @"$approveFor_3247"(%Uint128 %_amount, [20 x i8]* %"$_origin_3452", [20 x i8]* %"$_sender_3454", [20 x i8]* %"$address_3456", %TName_Bool* %isApproved), !dbg !354
  ret void
}

define internal void @"$configureNode_3459"(%Uint128 %_amount, [20 x i8]* %"$_origin_3460", [20 x i8]* %"$_sender_3461", [32 x i8]* %"$node_3462", [20 x i8]* %"$owner_3463", [20 x i8]* %"$resolver_3464") !dbg !355 {
entry:
  ...
  %"$maybeRecord_call_3469" = call i8* @_fetch_field(i8* %"$execptr_load_3468", i8* getelementptr inbounds ([8 x i8], [8 x i8]* @"$records_3467", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_325", i32 1, i8* %"$indices_buf_3465", i32 1), !dbg !356
...
"$have_gas_3479":                                 ; preds = %"$out_of_gas_3478", %entry
  ...
  %"$maybeApproved_call_3485" = call i8* @_fetch_field(i8* %"$execptr_load_3484", i8* getelementptr inbounds ([10 x i8], [10 x i8]* @"$approvals_3483", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_324", i32 1, i8* %"$indices_buf_3481", i32 1), !dbg !357
...
"$have_gas_3505":                                 ; preds = %"$out_of_gas_3504", %"$have_gas_3500"
  ...
  call void %"$ud-registry.recordMemberOwner_fptr_3508"(i8* %"$ud-registry.recordMemberOwner_envptr_3509", [20 x i8]* %"$ud-registry.recordMemberOwner_retalloca_3511", %TName_Option_ud-registry.Record* %"$maybeRecord_3510"), !dbg !358
  %"$ud-registry.recordMemberOwner_ret_3512" = load [20 x i8], [20 x i8]* %"$ud-registry.recordMemberOwner_retalloca_3511", align 1
  store [20 x i8] %"$ud-registry.recordMemberOwner_ret_3512", [20 x i8]* %"$ud-registry.recordMemberOwner_79", align 1, !dbg !358
  %"$$ud-registry.recordMemberOwner_79_3513" = load [20 x i8], [20 x i8]* %"$ud-registry.recordMemberOwner_79", align 1
  store [20 x i8] %"$$ud-registry.recordMemberOwner_79_3513", [20 x i8]* %recordOwner, align 1, !dbg !358
  %maybeOperators = alloca %"TName_Option_List_(ByStr20)"*, align 8
  ...
  %"$maybeOperators_call_3519" = call i8* @_fetch_field(i8* %"$execptr_load_3518", i8* getelementptr inbounds ([10 x i8], [10 x i8]* @"$operators_3517", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_323", i32 1, i8* %"$indices_buf_3514", i32 1), !dbg !359
...
"$have_gas_3539":                                 ; preds = %"$out_of_gas_3538", %"$have_gas_3534"
  ...
  %"$ud-registry.getIsOAO_call_3545" = call { { { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* } (i8*, %TName_Option_ByStr20*)*, i8* } (i8*, [20 x i8]*)*, i8* } %"$ud-registry.getIsOAO_fptr_3542"(i8* %"$ud-registry.getIsOAO_envptr_3543", [20 x i8]* %"$ud-registry.getIsOAO__sender_3544"), !dbg !360
  store { { { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* } (i8*, %TName_Option_ByStr20*)*, i8* } (i8*, [20 x i8]*)*, i8* } %"$ud-registry.getIsOAO_call_3545", { { { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* } (i8*, %TName_Option_ByStr20*)*, i8* } (i8*, [20 x i8]*)*, i8* }* %"$ud-registry.getIsOAO_75", align 8, !dbg !360
  ...
  %"$$ud-registry.getIsOAO_75_call_3551" = call { { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* } (i8*, %TName_Option_ByStr20*)*, i8* } %"$$ud-registry.getIsOAO_75_fptr_3547"(i8* %"$$ud-registry.getIsOAO_75_envptr_3548", [20 x i8]* %"$$ud-registry.getIsOAO_75_recordOwner_3549"), !dbg !360
  store { { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* } (i8*, %TName_Option_ByStr20*)*, i8* } %"$$ud-registry.getIsOAO_75_call_3551", { { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* } (i8*, %TName_Option_ByStr20*)*, i8* }* %"$ud-registry.getIsOAO_76", align 8, !dbg !360
  ...
  %"$$ud-registry.getIsOAO_76_call_3556" = call { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* } %"$$ud-registry.getIsOAO_76_fptr_3553"(i8* %"$$ud-registry.getIsOAO_76_envptr_3554", %TName_Option_ByStr20* %"$maybeApproved_3555"), !dbg !360
  store { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* } %"$$ud-registry.getIsOAO_76_call_3556", { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* }* %"$ud-registry.getIsOAO_77", align 8, !dbg !360
  ...
  %"$$ud-registry.getIsOAO_77_call_3561" = call %TName_Bool* %"$$ud-registry.getIsOAO_77_fptr_3558"(i8* %"$$ud-registry.getIsOAO_77_envptr_3559", %"TName_Option_List_(ByStr20)"* %"$maybeOperators_3560"), !dbg !360
  store %TName_Bool* %"$$ud-registry.getIsOAO_77_call_3561", %TName_Bool** %"$ud-registry.getIsOAO_78", align 8, !dbg !360
  %"$$ud-registry.getIsOAO_78_3562" = load %TName_Bool*, %TName_Bool** %"$ud-registry.getIsOAO_78", align 8
  store %TName_Bool* %"$$ud-registry.getIsOAO_78_3562", %TName_Bool** %isSenderOAO, align 8, !dbg !360
...
"$have_gas_3583":                                 ; preds = %"$out_of_gas_3582", %"$have_gas_3578"
  ...
  store %TName_ud-registry.Record* %"$adtptr_3589", %TName_ud-registry.Record** %newRecord, align 8, !dbg !362
...
"$have_gas_3597":                                 ; preds = %"$out_of_gas_3596", %"$have_gas_3583"
  ...
  call void @_update_field(i8* %"$execptr_load_3601", i8* getelementptr inbounds ([8 x i8], [8 x i8]* @"$records_3602", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_325", i32 1, i8* %"$indices_buf_3599", i8* %"$update_value_3604"), !dbg !365
...
"$have_gas_3613":                                 ; preds = %"$out_of_gas_3612", %"$have_gas_3608"
  ...
  %"$ud-registry.eConfigured_call_3619" = call { { i8* (i8*, [20 x i8]*)*, i8* } (i8*, [20 x i8]*)*, i8* } %"$ud-registry.eConfigured_fptr_3616"(i8* %"$ud-registry.eConfigured_envptr_3617", [32 x i8]* %"$ud-registry.eConfigured_node_3618"), !dbg !366
  store { { i8* (i8*, [20 x i8]*)*, i8* } (i8*, [20 x i8]*)*, i8* } %"$ud-registry.eConfigured_call_3619", { { i8* (i8*, [20 x i8]*)*, i8* } (i8*, [20 x i8]*)*, i8* }* %"$ud-registry.eConfigured_70", align 8, !dbg !366
  ...
  %"$$ud-registry.eConfigured_70_call_3624" = call { i8* (i8*, [20 x i8]*)*, i8* } %"$$ud-registry.eConfigured_70_fptr_3621"(i8* %"$$ud-registry.eConfigured_70_envptr_3622", [20 x i8]* %"$$ud-registry.eConfigured_70_owner_3623"), !dbg !366
  store { i8* (i8*, [20 x i8]*)*, i8* } %"$$ud-registry.eConfigured_70_call_3624", { i8* (i8*, [20 x i8]*)*, i8* }* %"$ud-registry.eConfigured_71", align 8, !dbg !366
  ...
  %"$$ud-registry.eConfigured_71_call_3629" = call i8* %"$$ud-registry.eConfigured_71_fptr_3626"(i8* %"$$ud-registry.eConfigured_71_envptr_3627", [20 x i8]* %"$$ud-registry.eConfigured_71_resolver_3628"), !dbg !366
  store i8* %"$$ud-registry.eConfigured_71_call_3629", i8** %"$ud-registry.eConfigured_72", align 8, !dbg !366
  %"$$ud-registry.eConfigured_72_3630" = load i8*, i8** %"$ud-registry.eConfigured_72", align 8
  store i8* %"$$ud-registry.eConfigured_72_3630", i8** %e, align 8, !dbg !366
...
"$have_gas_3637":                                 ; preds = %"$out_of_gas_3636", %"$have_gas_3613"
  ...
  call void @_event(i8* %"$execptr_load_3639", %_TyDescrTy_Typ* @"$TyDescr_Event_301", i8* %"$e_3640"), !dbg !367
...
"$have_gas_3654":                                 ; preds = %"$out_of_gas_3653", %"$have_gas_3649"
  ...
  store i8* %"$msgobj_3656", i8** %m, align 8, !dbg !368
...
"$have_gas_3697":                                 ; preds = %"$out_of_gas_3696", %"$have_gas_3654"
  ...
  %"$ud-registry.oneMsg_call_3703" = call %TName_List_Message* %"$ud-registry.oneMsg_fptr_3700"(i8* %"$ud-registry.oneMsg_envptr_3701", i8* %"$m_3702"), !dbg !369
  store %TName_List_Message* %"$ud-registry.oneMsg_call_3703", %TName_List_Message** %"$ud-registry.oneMsg_69", align 8, !dbg !369
  %"$$ud-registry.oneMsg_69_3704" = load %TName_List_Message*, %TName_List_Message** %"$ud-registry.oneMsg_69", align 8
  store %TName_List_Message* %"$$ud-registry.oneMsg_69_3704", %TName_List_Message** %msgs, align 8, !dbg !369
...
"$have_gas_3711":                                 ; preds = %"$out_of_gas_3710", %"$have_gas_3697"
  ...
  call void @_send(i8* %"$execptr_load_3713", %_TyDescrTy_Typ* @"$TyDescr_ADT_List_Message_319", %TName_List_Message* %"$msgs_3714"), !dbg !370
...
"$have_gas_3730":                                 ; preds = %"$out_of_gas_3729", %"$have_gas_3725"
  ...
  store %String { i8* getelementptr inbounds ([43 x i8], [43 x i8]* @"$stringlit_3732", i32 0, i32 0), i32 43 }, %String* %m5, align 8, !dbg !371
...
"$have_gas_3736":                                 ; preds = %"$out_of_gas_3735", %"$have_gas_3730"
  ...
  %"$ud-registry.eError_call_3742" = call i8* %"$ud-registry.eError_fptr_3739"(i8* %"$ud-registry.eError_envptr_3740", %String %"$m_3741"), !dbg !373
  store i8* %"$ud-registry.eError_call_3742", i8** %"$ud-registry.eError_74", align 8, !dbg !373
  %"$$ud-registry.eError_74_3743" = load i8*, i8** %"$ud-registry.eError_74", align 8
  store i8* %"$$ud-registry.eError_74_3743", i8** %e4, align 8, !dbg !373
...
"$have_gas_3750":                                 ; preds = %"$out_of_gas_3749", %"$have_gas_3736"
  ...
  call void @_event(i8* %"$execptr_load_3752", %_TyDescrTy_Typ* @"$TyDescr_Event_301", i8* %"$e_3753"), !dbg !374
...
"$have_gas_3767":                                 ; preds = %"$out_of_gas_3766", %"$have_gas_3762"
  ...
  store i8* %"$msgobj_3769", i8** %"$m_0", align 8, !dbg !375
...
"$have_gas_3811":                                 ; preds = %"$out_of_gas_3810", %"$have_gas_3767"
  ...
  %"$ud-registry.oneMsg_call_3817" = call %TName_List_Message* %"$ud-registry.oneMsg_fptr_3814"(i8* %"$ud-registry.oneMsg_envptr_3815", i8* %"$$m_0_3816"), !dbg !376
  store %TName_List_Message* %"$ud-registry.oneMsg_call_3817", %TName_List_Message** %"$ud-registry.oneMsg_73", align 8, !dbg !376
  %"$$ud-registry.oneMsg_73_3818" = load %TName_List_Message*, %TName_List_Message** %"$ud-registry.oneMsg_73", align 8
  store %TName_List_Message* %"$$ud-registry.oneMsg_73_3818", %TName_List_Message** %msgs6, align 8, !dbg !376
...
"$have_gas_3825":                                 ; preds = %"$out_of_gas_3824", %"$have_gas_3811"
  ...
  call void @_send(i8* %"$execptr_load_3827", %_TyDescrTy_Typ* @"$TyDescr_ADT_List_Message_319", %TName_List_Message* %"$msgs_3828"), !dbg !377
  br label %"$matchsucc_3568"
...
entry:
  ...
  call void @"$configureNode_3459"(%Uint128 %_amount, [20 x i8]* %"$_origin_3833", [20 x i8]* %"$_sender_3835", [32 x i8]* %"$node_3837", [20 x i8]* %"$owner_3839", [20 x i8]* %"$resolver_3841"), !dbg !379
  ret void
}

define internal void @"$configureResolver_3842"(%Uint128 %_amount, [20 x i8]* %"$_origin_3843", [20 x i8]* %"$_sender_3844", [32 x i8]* %"$node_3845", [20 x i8]* %"$resolver_3846") !dbg !380 {
entry:
  ...
  %"$maybeRecord_call_3851" = call i8* @_fetch_field(i8* %"$execptr_load_3850", i8* getelementptr inbounds ([8 x i8], [8 x i8]* @"$records_3849", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_325", i32 1, i8* %"$indices_buf_3847", i32 1), !dbg !381
...
"$have_gas_3861":                                 ; preds = %"$out_of_gas_3860", %entry
  ...
  %"$maybeApproved_call_3867" = call i8* @_fetch_field(i8* %"$execptr_load_3866", i8* getelementptr inbounds ([10 x i8], [10 x i8]* @"$approvals_3865", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_324", i32 1, i8* %"$indices_buf_3863", i32 1), !dbg !382
...
"$have_gas_3887":                                 ; preds = %"$out_of_gas_3886", %"$have_gas_3882"
  ...
  call void %"$ud-registry.recordMemberOwner_fptr_3890"(i8* %"$ud-registry.recordMemberOwner_envptr_3891", [20 x i8]* %"$ud-registry.recordMemberOwner_retalloca_3893", %TName_Option_ud-registry.Record* %"$maybeRecord_3892"), !dbg !383
  %"$ud-registry.recordMemberOwner_ret_3894" = load [20 x i8], [20 x i8]* %"$ud-registry.recordMemberOwner_retalloca_3893", align 1
  store [20 x i8] %"$ud-registry.recordMemberOwner_ret_3894", [20 x i8]* %"$ud-registry.recordMemberOwner_88", align 1, !dbg !383
  %"$$ud-registry.recordMemberOwner_88_3895" = load [20 x i8], [20 x i8]* %"$ud-registry.recordMemberOwner_88", align 1
  store [20 x i8] %"$$ud-registry.recordMemberOwner_88_3895", [20 x i8]* %recordOwner, align 1, !dbg !383
  %maybeOperators = alloca %"TName_Option_List_(ByStr20)"*, align 8
  ...
  %"$maybeOperators_call_3901" = call i8* @_fetch_field(i8* %"$execptr_load_3900", i8* getelementptr inbounds ([10 x i8], [10 x i8]* @"$operators_3899", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_323", i32 1, i8* %"$indices_buf_3896", i32 1), !dbg !384
...
"$have_gas_3921":                                 ; preds = %"$out_of_gas_3920", %"$have_gas_3916"
  ...
  %"$ud-registry.getIsOAO_call_3927" = call { { { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* } (i8*, %TName_Option_ByStr20*)*, i8* } (i8*, [20 x i8]*)*, i8* } %"$ud-registry.getIsOAO_fptr_3924"(i8* %"$ud-registry.getIsOAO_envptr_3925", [20 x i8]* %"$ud-registry.getIsOAO__sender_3926"), !dbg !385
  store { { { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* } (i8*, %TName_Option_ByStr20*)*, i8* } (i8*, [20 x i8]*)*, i8* } %"$ud-registry.getIsOAO_call_3927", { { { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* } (i8*, %TName_Option_ByStr20*)*, i8* } (i8*, [20 x i8]*)*, i8* }* %"$ud-registry.getIsOAO_84", align 8, !dbg !385
  ...
  %"$$ud-registry.getIsOAO_84_call_3933" = call { { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* } (i8*, %TName_Option_ByStr20*)*, i8* } %"$$ud-registry.getIsOAO_84_fptr_3929"(i8* %"$$ud-registry.getIsOAO_84_envptr_3930", [20 x i8]* %"$$ud-registry.getIsOAO_84_recordOwner_3931"), !dbg !385
  store { { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* } (i8*, %TName_Option_ByStr20*)*, i8* } %"$$ud-registry.getIsOAO_84_call_3933", { { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* } (i8*, %TName_Option_ByStr20*)*, i8* }* %"$ud-registry.getIsOAO_85", align 8, !dbg !385
  ...
  %"$$ud-registry.getIsOAO_85_call_3938" = call { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* } %"$$ud-registry.getIsOAO_85_fptr_3935"(i8* %"$$ud-registry.getIsOAO_85_envptr_3936", %TName_Option_ByStr20* %"$maybeApproved_3937"), !dbg !385
  store { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* } %"$$ud-registry.getIsOAO_85_call_3938", { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* }* %"$ud-registry.getIsOAO_86", align 8, !dbg !385
  ...
  %"$$ud-registry.getIsOAO_86_call_3943" = call %TName_Bool* %"$$ud-registry.getIsOAO_86_fptr_3940"(i8* %"$$ud-registry.getIsOAO_86_envptr_3941", %"TName_Option_List_(ByStr20)"* %"$maybeOperators_3942"), !dbg !385
  store %TName_Bool* %"$$ud-registry.getIsOAO_86_call_3943", %TName_Bool** %"$ud-registry.getIsOAO_87", align 8, !dbg !385
  %"$$ud-registry.getIsOAO_87_3944" = load %TName_Bool*, %TName_Bool** %"$ud-registry.getIsOAO_87", align 8
  store %TName_Bool* %"$$ud-registry.getIsOAO_87_3944", %TName_Bool** %isSenderOAO, align 8, !dbg !385
...
"$have_gas_3965":                                 ; preds = %"$out_of_gas_3964", %"$have_gas_3960"
  ...
  store %TName_ud-registry.Record* %"$adtptr_3972", %TName_ud-registry.Record** %newRecord, align 8, !dbg !387
...
"$have_gas_3980":                                 ; preds = %"$out_of_gas_3979", %"$have_gas_3965"
  ...
  call void @_update_field(i8* %"$execptr_load_3984", i8* getelementptr inbounds ([8 x i8], [8 x i8]* @"$records_3985", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_325", i32 1, i8* %"$indices_buf_3982", i8* %"$update_value_3987"), !dbg !390
...
"$have_gas_3996":                                 ; preds = %"$out_of_gas_3995", %"$have_gas_3991"
  ...
  %"$ud-registry.eConfigured_call_4002" = call { { i8* (i8*, [20 x i8]*)*, i8* } (i8*, [20 x i8]*)*, i8* } %"$ud-registry.eConfigured_fptr_3999"(i8* %"$ud-registry.eConfigured_envptr_4000", [32 x i8]* %"$ud-registry.eConfigured_node_4001"), !dbg !391
  store { { i8* (i8*, [20 x i8]*)*, i8* } (i8*, [20 x i8]*)*, i8* } %"$ud-registry.eConfigured_call_4002", { { i8* (i8*, [20 x i8]*)*, i8* } (i8*, [20 x i8]*)*, i8* }* %"$ud-registry.eConfigured_80", align 8, !dbg !391
  ...
  %"$$ud-registry.eConfigured_80_call_4008" = call { i8* (i8*, [20 x i8]*)*, i8* } %"$$ud-registry.eConfigured_80_fptr_4004"(i8* %"$$ud-registry.eConfigured_80_envptr_4005", [20 x i8]* %"$$ud-registry.eConfigured_80_recordOwner_4006"), !dbg !391
  store { i8* (i8*, [20 x i8]*)*, i8* } %"$$ud-registry.eConfigured_80_call_4008", { i8* (i8*, [20 x i8]*)*, i8* }* %"$ud-registry.eConfigured_81", align 8, !dbg !391
  ...
  %"$$ud-registry.eConfigured_81_call_4013" = call i8* %"$$ud-registry.eConfigured_81_fptr_4010"(i8* %"$$ud-registry.eConfigured_81_envptr_4011", [20 x i8]* %"$$ud-registry.eConfigured_81_resolver_4012"), !dbg !391
  store i8* %"$$ud-registry.eConfigured_81_call_4013", i8** %"$ud-registry.eConfigured_82", align 8, !dbg !391
  %"$$ud-registry.eConfigured_82_4014" = load i8*, i8** %"$ud-registry.eConfigured_82", align 8
  store i8* %"$$ud-registry.eConfigured_82_4014", i8** %e, align 8, !dbg !391
...
"$have_gas_4021":                                 ; preds = %"$out_of_gas_4020", %"$have_gas_3996"
  ...
  call void @_event(i8* %"$execptr_load_4023", %_TyDescrTy_Typ* @"$TyDescr_Event_301", i8* %"$e_4024"), !dbg !392
...
"$have_gas_4040":                                 ; preds = %"$out_of_gas_4039", %"$have_gas_4035"
  ...
  store %String { i8* getelementptr inbounds ([43 x i8], [43 x i8]* @"$stringlit_4042", i32 0, i32 0), i32 43 }, %String* %m, align 8, !dbg !393
...
"$have_gas_4046":                                 ; preds = %"$out_of_gas_4045", %"$have_gas_4040"
  ...
  %"$ud-registry.eError_call_4052" = call i8* %"$ud-registry.eError_fptr_4049"(i8* %"$ud-registry.eError_envptr_4050", %String %"$m_4051"), !dbg !395
  store i8* %"$ud-registry.eError_call_4052", i8** %"$ud-registry.eError_83", align 8, !dbg !395
  %"$$ud-registry.eError_83_4053" = load i8*, i8** %"$ud-registry.eError_83", align 8
  store i8* %"$$ud-registry.eError_83_4053", i8** %e4, align 8, !dbg !395
...
"$have_gas_4060":                                 ; preds = %"$out_of_gas_4059", %"$have_gas_4046"
  ...
  call void @_event(i8* %"$execptr_load_4062", %_TyDescrTy_Typ* @"$TyDescr_Event_301", i8* %"$e_4063"), !dbg !396
  br label %"$matchsucc_3950"
...
entry:
  ...
  call void @"$configureResolver_3842"(%Uint128 %_amount, [20 x i8]* %"$_origin_4068", [20 x i8]* %"$_sender_4070", [32 x i8]* %"$node_4072", [20 x i8]* %"$resolver_4074"), !dbg !398
  ret void
}

define internal void @"$transfer_4075"(%Uint128 %_amount, [20 x i8]* %"$_origin_4076", [20 x i8]* %"$_sender_4077", [32 x i8]* %"$node_4078", [20 x i8]* %"$owner_4079") !dbg !399 {
entry:
  ...
  %"$maybeRecord_call_4084" = call i8* @_fetch_field(i8* %"$execptr_load_4083", i8* getelementptr inbounds ([8 x i8], [8 x i8]* @"$records_4082", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_325", i32 1, i8* %"$indices_buf_4080", i32 1), !dbg !400
...
"$have_gas_4094":                                 ; preds = %"$out_of_gas_4093", %entry
  ...
  %"$maybeApproved_call_4100" = call i8* @_fetch_field(i8* %"$execptr_load_4099", i8* getelementptr inbounds ([10 x i8], [10 x i8]* @"$approvals_4098", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_324", i32 1, i8* %"$indices_buf_4096", i32 1), !dbg !401
...
"$have_gas_4120":                                 ; preds = %"$out_of_gas_4119", %"$have_gas_4115"
  ...
  call void %"$ud-registry.recordMemberOwner_fptr_4123"(i8* %"$ud-registry.recordMemberOwner_envptr_4124", [20 x i8]* %"$ud-registry.recordMemberOwner_retalloca_4126", %TName_Option_ud-registry.Record* %"$maybeRecord_4125"), !dbg !402
  %"$ud-registry.recordMemberOwner_ret_4127" = load [20 x i8], [20 x i8]* %"$ud-registry.recordMemberOwner_retalloca_4126", align 1
  store [20 x i8] %"$ud-registry.recordMemberOwner_ret_4127", [20 x i8]* %"$ud-registry.recordMemberOwner_99", align 1, !dbg !402
  %"$$ud-registry.recordMemberOwner_99_4128" = load [20 x i8], [20 x i8]* %"$ud-registry.recordMemberOwner_99", align 1
  store [20 x i8] %"$$ud-registry.recordMemberOwner_99_4128", [20 x i8]* %recordOwner, align 1, !dbg !402
  %maybeOperators = alloca %"TName_Option_List_(ByStr20)"*, align 8
  ...
  %"$maybeOperators_call_4134" = call i8* @_fetch_field(i8* %"$execptr_load_4133", i8* getelementptr inbounds ([10 x i8], [10 x i8]* @"$operators_4132", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_323", i32 1, i8* %"$indices_buf_4129", i32 1), !dbg !403
...
"$have_gas_4154":                                 ; preds = %"$out_of_gas_4153", %"$have_gas_4149"
  ...
  %"$ud-registry.getIsOAO_call_4160" = call { { { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* } (i8*, %TName_Option_ByStr20*)*, i8* } (i8*, [20 x i8]*)*, i8* } %"$ud-registry.getIsOAO_fptr_4157"(i8* %"$ud-registry.getIsOAO_envptr_4158", [20 x i8]* %"$ud-registry.getIsOAO__sender_4159"), !dbg !404
  store { { { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* } (i8*, %TName_Option_ByStr20*)*, i8* } (i8*, [20 x i8]*)*, i8* } %"$ud-registry.getIsOAO_call_4160", { { { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* } (i8*, %TName_Option_ByStr20*)*, i8* } (i8*, [20 x i8]*)*, i8* }* %"$ud-registry.getIsOAO_95", align 8, !dbg !404
  ...
  %"$$ud-registry.getIsOAO_95_call_4166" = call { { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* } (i8*, %TName_Option_ByStr20*)*, i8* } %"$$ud-registry.getIsOAO_95_fptr_4162"(i8* %"$$ud-registry.getIsOAO_95_envptr_4163", [20 x i8]* %"$$ud-registry.getIsOAO_95_recordOwner_4164"), !dbg !404
  store { { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* } (i8*, %TName_Option_ByStr20*)*, i8* } %"$$ud-registry.getIsOAO_95_call_4166", { { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* } (i8*, %TName_Option_ByStr20*)*, i8* }* %"$ud-registry.getIsOAO_96", align 8, !dbg !404
  ...
  %"$$ud-registry.getIsOAO_96_call_4171" = call { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* } %"$$ud-registry.getIsOAO_96_fptr_4168"(i8* %"$$ud-registry.getIsOAO_96_envptr_4169", %TName_Option_ByStr20* %"$maybeApproved_4170"), !dbg !404
  store { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* } %"$$ud-registry.getIsOAO_96_call_4171", { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* }* %"$ud-registry.getIsOAO_97", align 8, !dbg !404
  ...
  %"$$ud-registry.getIsOAO_97_call_4176" = call %TName_Bool* %"$$ud-registry.getIsOAO_97_fptr_4173"(i8* %"$$ud-registry.getIsOAO_97_envptr_4174", %"TName_Option_List_(ByStr20)"* %"$maybeOperators_4175"), !dbg !404
  store %TName_Bool* %"$$ud-registry.getIsOAO_97_call_4176", %TName_Bool** %"$ud-registry.getIsOAO_98", align 8, !dbg !404
  %"$$ud-registry.getIsOAO_98_4177" = load %TName_Bool*, %TName_Bool** %"$ud-registry.getIsOAO_98", align 8
  store %TName_Bool* %"$$ud-registry.getIsOAO_98_4177", %TName_Bool** %isSenderOAO, align 8, !dbg !404
...
"$have_gas_4193":                                 ; preds = %"$out_of_gas_4192", %"$True_4188"
  ...
  call void @_update_field(i8* %"$execptr_load_4197", i8* getelementptr inbounds ([10 x i8], [10 x i8]* @"$approvals_4198", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_324", i32 1, i8* %"$indices_buf_4195", i8* null), !dbg !406
...
"$have_gas_4207":                                 ; preds = %"$out_of_gas_4206", %"$have_gas_4202"
  ...
  store %TName_ud-registry.Record* %"$adtptr_4214", %TName_ud-registry.Record** %newRecord, align 8, !dbg !409
...
"$have_gas_4222":                                 ; preds = %"$out_of_gas_4221", %"$have_gas_4207"
  ...
  call void @_update_field(i8* %"$execptr_load_4226", i8* getelementptr inbounds ([8 x i8], [8 x i8]* @"$records_4227", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_325", i32 1, i8* %"$indices_buf_4224", i8* %"$update_value_4229"), !dbg !410
...
"$have_gas_4238":                                 ; preds = %"$out_of_gas_4237", %"$have_gas_4233"
  ...
  %"$ud-registry.eConfigured_call_4244" = call { { i8* (i8*, [20 x i8]*)*, i8* } (i8*, [20 x i8]*)*, i8* } %"$ud-registry.eConfigured_fptr_4241"(i8* %"$ud-registry.eConfigured_envptr_4242", [32 x i8]* %"$ud-registry.eConfigured_node_4243"), !dbg !411
  store { { i8* (i8*, [20 x i8]*)*, i8* } (i8*, [20 x i8]*)*, i8* } %"$ud-registry.eConfigured_call_4244", { { i8* (i8*, [20 x i8]*)*, i8* } (i8*, [20 x i8]*)*, i8* }* %"$ud-registry.eConfigured_90", align 8, !dbg !411
  ...
  %"$$ud-registry.eConfigured_90_call_4249" = call { i8* (i8*, [20 x i8]*)*, i8* } %"$$ud-registry.eConfigured_90_fptr_4246"(i8* %"$$ud-registry.eConfigured_90_envptr_4247", [20 x i8]* %"$$ud-registry.eConfigured_90_owner_4248"), !dbg !411
  store { i8* (i8*, [20 x i8]*)*, i8* } %"$$ud-registry.eConfigured_90_call_4249", { i8* (i8*, [20 x i8]*)*, i8* }* %"$ud-registry.eConfigured_91", align 8, !dbg !411
  ...
  %"$$ud-registry.eConfigured_91_call_4255" = call i8* %"$$ud-registry.eConfigured_91_fptr_4251"(i8* %"$$ud-registry.eConfigured_91_envptr_4252", [20 x i8]* %"$$ud-registry.eConfigured_91_ud-registry.zeroByStr20_4253"), !dbg !411
  store i8* %"$$ud-registry.eConfigured_91_call_4255", i8** %"$ud-registry.eConfigured_92", align 8, !dbg !411
  %"$$ud-registry.eConfigured_92_4256" = load i8*, i8** %"$ud-registry.eConfigured_92", align 8
  store i8* %"$$ud-registry.eConfigured_92_4256", i8** %e, align 8, !dbg !411
...
"$have_gas_4263":                                 ; preds = %"$out_of_gas_4262", %"$have_gas_4238"
  ...
  call void @_event(i8* %"$execptr_load_4265", %_TyDescrTy_Typ* @"$TyDescr_Event_301", i8* %"$e_4266"), !dbg !412
...
"$have_gas_4280":                                 ; preds = %"$out_of_gas_4279", %"$have_gas_4275"
  ...
  store i8* %"$msgobj_4282", i8** %m, align 8, !dbg !413
...
"$have_gas_4323":                                 ; preds = %"$out_of_gas_4322", %"$have_gas_4280"
  ...
  %"$ud-registry.oneMsg_call_4329" = call %TName_List_Message* %"$ud-registry.oneMsg_fptr_4326"(i8* %"$ud-registry.oneMsg_envptr_4327", i8* %"$m_4328"), !dbg !414
  store %TName_List_Message* %"$ud-registry.oneMsg_call_4329", %TName_List_Message** %"$ud-registry.oneMsg_89", align 8, !dbg !414
  %"$$ud-registry.oneMsg_89_4330" = load %TName_List_Message*, %TName_List_Message** %"$ud-registry.oneMsg_89", align 8
  store %TName_List_Message* %"$$ud-registry.oneMsg_89_4330", %TName_List_Message** %msgs, align 8, !dbg !414
...
"$have_gas_4337":                                 ; preds = %"$out_of_gas_4336", %"$have_gas_4323"
  ...
  call void @_send(i8* %"$execptr_load_4339", %_TyDescrTy_Typ* @"$TyDescr_ADT_List_Message_319", %TName_List_Message* %"$msgs_4340"), !dbg !415
...
"$have_gas_4356":                                 ; preds = %"$out_of_gas_4355", %"$have_gas_4351"
  ...
  store %String { i8* getelementptr inbounds ([43 x i8], [43 x i8]* @"$stringlit_4358", i32 0, i32 0), i32 43 }, %String* %m6, align 8, !dbg !416
...
"$have_gas_4362":                                 ; preds = %"$out_of_gas_4361", %"$have_gas_4356"
  ...
  %"$ud-registry.eError_call_4368" = call i8* %"$ud-registry.eError_fptr_4365"(i8* %"$ud-registry.eError_envptr_4366", %String %"$m_4367"), !dbg !418
  store i8* %"$ud-registry.eError_call_4368", i8** %"$ud-registry.eError_94", align 8, !dbg !418
  %"$$ud-registry.eError_94_4369" = load i8*, i8** %"$ud-registry.eError_94", align 8
  store i8* %"$$ud-registry.eError_94_4369", i8** %e5, align 8, !dbg !418
...
"$have_gas_4376":                                 ; preds = %"$out_of_gas_4375", %"$have_gas_4362"
  ...
  call void @_event(i8* %"$execptr_load_4378", %_TyDescrTy_Typ* @"$TyDescr_Event_301", i8* %"$e_4379"), !dbg !419
...
"$have_gas_4436":                                 ; preds = %"$out_of_gas_4435", %"$have_gas_4393"
  ...
  %"$ud-registry.oneMsg_call_4442" = call %TName_List_Message* %"$ud-registry.oneMsg_fptr_4439"(i8* %"$ud-registry.oneMsg_envptr_4440", i8* %"$$m_1_4441"), !dbg !421
  store %TName_List_Message* %"$ud-registry.oneMsg_call_4442", %TName_List_Message** %"$ud-registry.oneMsg_93", align 8, !dbg !421
  %"$$ud-registry.oneMsg_93_4443" = load %TName_List_Message*, %TName_List_Message** %"$ud-registry.oneMsg_93", align 8
  store %TName_List_Message* %"$$ud-registry.oneMsg_93_4443", %TName_List_Message** %msgs7, align 8, !dbg !421
...
"$have_gas_4450":                                 ; preds = %"$out_of_gas_4449", %"$have_gas_4436"
  ...
  call void @_send(i8* %"$execptr_load_4452", %_TyDescrTy_Typ* @"$TyDescr_ADT_List_Message_319", %TName_List_Message* %"$msgs_4453"), !dbg !422
  br label %"$matchsucc_4183"
...
entry:
  ...
  call void @"$transfer_4075"(%Uint128 %_amount, [20 x i8]* %"$_origin_4458", [20 x i8]* %"$_sender_4460", [32 x i8]* %"$node_4462", [20 x i8]* %"$owner_4464"), !dbg !424
  ret void
}

define internal void @"$assign_4465"(%Uint128 %_amount, [20 x i8]* %"$_origin_4466", [20 x i8]* %"$_sender_4467", [32 x i8]* %"$parent_4468", %String %label, [20 x i8]* %"$owner_4469") !dbg !425 {
entry:
  ...
  %"$maybeRecord_call_4474" = call i8* @_fetch_field(i8* %"$execptr_load_4473", i8* getelementptr inbounds ([8 x i8], [8 x i8]* @"$records_4472", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_325", i32 1, i8* %"$indices_buf_4470", i32 1), !dbg !426
...
"$have_gas_4484":                                 ; preds = %"$out_of_gas_4483", %entry
  ...
  %"$maybeApproved_call_4490" = call i8* @_fetch_field(i8* %"$execptr_load_4489", i8* getelementptr inbounds ([10 x i8], [10 x i8]* @"$approvals_4488", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_324", i32 1, i8* %"$indices_buf_4486", i32 1), !dbg !427
...
"$have_gas_4510":                                 ; preds = %"$out_of_gas_4509", %"$have_gas_4505"
  ...
  call void %"$ud-registry.recordMemberOwner_fptr_4513"(i8* %"$ud-registry.recordMemberOwner_envptr_4514", [20 x i8]* %"$ud-registry.recordMemberOwner_retalloca_4516", %TName_Option_ud-registry.Record* %"$maybeRecord_4515"), !dbg !428
  %"$ud-registry.recordMemberOwner_ret_4517" = load [20 x i8], [20 x i8]* %"$ud-registry.recordMemberOwner_retalloca_4516", align 1
  store [20 x i8] %"$ud-registry.recordMemberOwner_ret_4517", [20 x i8]* %"$ud-registry.recordMemberOwner_114", align 1, !dbg !428
  %"$$ud-registry.recordMemberOwner_114_4518" = load [20 x i8], [20 x i8]* %"$ud-registry.recordMemberOwner_114", align 1
  store [20 x i8] %"$$ud-registry.recordMemberOwner_114_4518", [20 x i8]* %recordOwner, align 1, !dbg !428
  %maybeOperators = alloca %"TName_Option_List_(ByStr20)"*, align 8
  ...
  %"$maybeOperators_call_4524" = call i8* @_fetch_field(i8* %"$execptr_load_4523", i8* getelementptr inbounds ([10 x i8], [10 x i8]* @"$operators_4522", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_323", i32 1, i8* %"$indices_buf_4519", i32 1), !dbg !429
...
"$have_gas_4544":                                 ; preds = %"$out_of_gas_4543", %"$have_gas_4539"
  ...
  %"$ud-registry.getIsOAO_call_4550" = call { { { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* } (i8*, %TName_Option_ByStr20*)*, i8* } (i8*, [20 x i8]*)*, i8* } %"$ud-registry.getIsOAO_fptr_4547"(i8* %"$ud-registry.getIsOAO_envptr_4548", [20 x i8]* %"$ud-registry.getIsOAO__sender_4549"), !dbg !430
  store { { { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* } (i8*, %TName_Option_ByStr20*)*, i8* } (i8*, [20 x i8]*)*, i8* } %"$ud-registry.getIsOAO_call_4550", { { { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* } (i8*, %TName_Option_ByStr20*)*, i8* } (i8*, [20 x i8]*)*, i8* }* %"$ud-registry.getIsOAO_110", align 8, !dbg !430
  ...
  %"$$ud-registry.getIsOAO_110_call_4556" = call { { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* } (i8*, %TName_Option_ByStr20*)*, i8* } %"$$ud-registry.getIsOAO_110_fptr_4552"(i8* %"$$ud-registry.getIsOAO_110_envptr_4553", [20 x i8]* %"$$ud-registry.getIsOAO_110_recordOwner_4554"), !dbg !430
  store { { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* } (i8*, %TName_Option_ByStr20*)*, i8* } %"$$ud-registry.getIsOAO_110_call_4556", { { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* } (i8*, %TName_Option_ByStr20*)*, i8* }* %"$ud-registry.getIsOAO_111", align 8, !dbg !430
  ...
  %"$$ud-registry.getIsOAO_111_call_4561" = call { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* } %"$$ud-registry.getIsOAO_111_fptr_4558"(i8* %"$$ud-registry.getIsOAO_111_envptr_4559", %TName_Option_ByStr20* %"$maybeApproved_4560"), !dbg !430
  store { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* } %"$$ud-registry.getIsOAO_111_call_4561", { %TName_Bool* (i8*, %"TName_Option_List_(ByStr20)"*)*, i8* }* %"$ud-registry.getIsOAO_112", align 8, !dbg !430
  ...
  %"$$ud-registry.getIsOAO_112_call_4566" = call %TName_Bool* %"$$ud-registry.getIsOAO_112_fptr_4563"(i8* %"$$ud-registry.getIsOAO_112_envptr_4564", %"TName_Option_List_(ByStr20)"* %"$maybeOperators_4565"), !dbg !430
  store %TName_Bool* %"$$ud-registry.getIsOAO_112_call_4566", %TName_Bool** %"$ud-registry.getIsOAO_113", align 8, !dbg !430
  %"$$ud-registry.getIsOAO_113_4567" = load %TName_Bool*, %TName_Bool** %"$ud-registry.getIsOAO_113", align 8
  store %TName_Bool* %"$$ud-registry.getIsOAO_113_4567", %TName_Bool** %isSenderOAO, align 8, !dbg !430
...
"$have_gas_4588":                                 ; preds = %"$out_of_gas_4587", %"$have_gas_4583"
  ...
  %"$ud-registry.parentLabelToNode_call_4594" = call { void (i8*, [32 x i8]*, %String)*, i8* } %"$ud-registry.parentLabelToNode_fptr_4591"(i8* %"$ud-registry.parentLabelToNode_envptr_4592", [32 x i8]* %"$ud-registry.parentLabelToNode_parent_4593"), !dbg !432
  store { void (i8*, [32 x i8]*, %String)*, i8* } %"$ud-registry.parentLabelToNode_call_4594", { void (i8*, [32 x i8]*, %String)*, i8* }* %"$ud-registry.parentLabelToNode_106", align 8, !dbg !432
  ...
  call void %"$$ud-registry.parentLabelToNode_106_fptr_4596"(i8* %"$$ud-registry.parentLabelToNode_106_envptr_4597", [32 x i8]* %"$$ud-registry.parentLabelToNode_106_retalloca_4598", %String %label), !dbg !432
  %"$$ud-registry.parentLabelToNode_106_ret_4599" = load [32 x i8], [32 x i8]* %"$$ud-registry.parentLabelToNode_106_retalloca_4598", align 1
  store [32 x i8] %"$$ud-registry.parentLabelToNode_106_ret_4599", [32 x i8]* %"$ud-registry.parentLabelToNode_107", align 1, !dbg !432
  %"$$ud-registry.parentLabelToNode_107_4600" = load [32 x i8], [32 x i8]* %"$ud-registry.parentLabelToNode_107", align 1
  store [32 x i8] %"$$ud-registry.parentLabelToNode_107_4600", [32 x i8]* %node, align 1, !dbg !432
  ...
  %"$recordExists_call_4606" = call i8* @_fetch_field(i8* %"$execptr_load_4605", i8* getelementptr inbounds ([8 x i8], [8 x i8]* @"$records_4604", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_325", i32 1, i8* %"$indices_buf_4601", i32 0), !dbg !435
...
"$have_gas_4638":                                 ; preds = %"$out_of_gas_4637", %"$have_gas_4633"
  ...
  %"$ud-registry.eNewDomain_call_4644" = call { i8* (i8*, %String)*, i8* } %"$ud-registry.eNewDomain_fptr_4641"(i8* %"$ud-registry.eNewDomain_envptr_4642", [32 x i8]* %"$ud-registry.eNewDomain_parent_4643"), !dbg !437
  store { i8* (i8*, %String)*, i8* } %"$ud-registry.eNewDomain_call_4644", { i8* (i8*, %String)*, i8* }* %"$ud-registry.eNewDomain_104", align 8, !dbg !437
  ...
  %"$$ud-registry.eNewDomain_104_call_4648" = call i8* %"$$ud-registry.eNewDomain_104_fptr_4646"(i8* %"$$ud-registry.eNewDomain_104_envptr_4647", %String %label), !dbg !437
  store i8* %"$$ud-registry.eNewDomain_104_call_4648", i8** %"$ud-registry.eNewDomain_105", align 8, !dbg !437
  %"$$ud-registry.eNewDomain_105_4649" = load i8*, i8** %"$ud-registry.eNewDomain_105", align 8
  store i8* %"$$ud-registry.eNewDomain_105_4649", i8** %e, align 8, !dbg !437
...
"$have_gas_4656":                                 ; preds = %"$out_of_gas_4655", %"$have_gas_4638"
  ...
  call void @_event(i8* %"$execptr_load_4658", %_TyDescrTy_Typ* @"$TyDescr_Event_301", i8* %"$e_4659"), !dbg !440
...
"$have_gas_4663":                                 ; preds = %"$out_of_gas_4662", %"$matchsucc_4623"
  ...
  call void @_update_field(i8* %"$execptr_load_4668", i8* getelementptr inbounds ([10 x i8], [10 x i8]* @"$approvals_4669", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_324", i32 1, i8* %"$indices_buf_4665", i8* null), !dbg !441
...
"$have_gas_4678":                                 ; preds = %"$out_of_gas_4677", %"$have_gas_4673"
  ...
  store %TName_ud-registry.Record* %"$adtptr_4685", %TName_ud-registry.Record** %newRecord, align 8, !dbg !442
...
"$have_gas_4693":                                 ; preds = %"$out_of_gas_4692", %"$have_gas_4678"
  ...
  call void @_update_field(i8* %"$execptr_load_4698", i8* getelementptr inbounds ([8 x i8], [8 x i8]* @"$records_4699", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_325", i32 1, i8* %"$indices_buf_4695", i8* %"$update_value_4701"), !dbg !443
...
"$have_gas_4710":                                 ; preds = %"$out_of_gas_4709", %"$have_gas_4705"
  ...
  %"$ud-registry.eConfigured_call_4717" = call { { i8* (i8*, [20 x i8]*)*, i8* } (i8*, [20 x i8]*)*, i8* } %"$ud-registry.eConfigured_fptr_4713"(i8* %"$ud-registry.eConfigured_envptr_4714", [32 x i8]* %"$ud-registry.eConfigured_node_4715"), !dbg !444
  store { { i8* (i8*, [20 x i8]*)*, i8* } (i8*, [20 x i8]*)*, i8* } %"$ud-registry.eConfigured_call_4717", { { i8* (i8*, [20 x i8]*)*, i8* } (i8*, [20 x i8]*)*, i8* }* %"$ud-registry.eConfigured_101", align 8, !dbg !444
  ...
  %"$$ud-registry.eConfigured_101_call_4722" = call { i8* (i8*, [20 x i8]*)*, i8* } %"$$ud-registry.eConfigured_101_fptr_4719"(i8* %"$$ud-registry.eConfigured_101_envptr_4720", [20 x i8]* %"$$ud-registry.eConfigured_101_owner_4721"), !dbg !444
  store { i8* (i8*, [20 x i8]*)*, i8* } %"$$ud-registry.eConfigured_101_call_4722", { i8* (i8*, [20 x i8]*)*, i8* }* %"$ud-registry.eConfigured_102", align 8, !dbg !444
  ...
  %"$$ud-registry.eConfigured_102_call_4728" = call i8* %"$$ud-registry.eConfigured_102_fptr_4724"(i8* %"$$ud-registry.eConfigured_102_envptr_4725", [20 x i8]* %"$$ud-registry.eConfigured_102_ud-registry.zeroByStr20_4726"), !dbg !444
  store i8* %"$$ud-registry.eConfigured_102_call_4728", i8** %"$ud-registry.eConfigured_103", align 8, !dbg !444
  %"$$ud-registry.eConfigured_103_4729" = load i8*, i8** %"$ud-registry.eConfigured_103", align 8
  store i8* %"$$ud-registry.eConfigured_103_4729", i8** %e6, align 8, !dbg !444
...
"$have_gas_4736":                                 ; preds = %"$out_of_gas_4735", %"$have_gas_4710"
  ...
  call void @_event(i8* %"$execptr_load_4738", %_TyDescrTy_Typ* @"$TyDescr_Event_301", i8* %"$e_4739"), !dbg !445
...
"$have_gas_4753":                                 ; preds = %"$out_of_gas_4752", %"$have_gas_4748"
  ...
  store i8* %"$msgobj_4755", i8** %m, align 8, !dbg !446
...
"$have_gas_4803":                                 ; preds = %"$out_of_gas_4802", %"$have_gas_4753"
  ...
  %"$ud-registry.oneMsg_call_4809" = call %TName_List_Message* %"$ud-registry.oneMsg_fptr_4806"(i8* %"$ud-registry.oneMsg_envptr_4807", i8* %"$m_4808"), !dbg !447
  store %TName_List_Message* %"$ud-registry.oneMsg_call_4809", %TName_List_Message** %"$ud-registry.oneMsg_100", align 8, !dbg !447
  %"$$ud-registry.oneMsg_100_4810" = load %TName_List_Message*, %TName_List_Message** %"$ud-registry.oneMsg_100", align 8
  store %TName_List_Message* %"$$ud-registry.oneMsg_100_4810", %TName_List_Message** %msgs, align 8, !dbg !447
...
"$have_gas_4817":                                 ; preds = %"$out_of_gas_4816", %"$have_gas_4803"
  ...
  call void @_send(i8* %"$execptr_load_4819", %_TyDescrTy_Typ* @"$TyDescr_ADT_List_Message_319", %TName_List_Message* %"$msgs_4820"), !dbg !448
...
"$have_gas_4836":                                 ; preds = %"$out_of_gas_4835", %"$have_gas_4831"
  ...
  store %String { i8* getelementptr inbounds ([45 x i8], [45 x i8]* @"$stringlit_4838", i32 0, i32 0), i32 45 }, %String* %m8, align 8, !dbg !449
...
"$have_gas_4842":                                 ; preds = %"$out_of_gas_4841", %"$have_gas_4836"
  ...
  %"$ud-registry.eError_call_4848" = call i8* %"$ud-registry.eError_fptr_4845"(i8* %"$ud-registry.eError_envptr_4846", %String %"$m_4847"), !dbg !451
  store i8* %"$ud-registry.eError_call_4848", i8** %"$ud-registry.eError_109", align 8, !dbg !451
  %"$$ud-registry.eError_109_4849" = load i8*, i8** %"$ud-registry.eError_109", align 8
  store i8* %"$$ud-registry.eError_109_4849", i8** %e7, align 8, !dbg !451
...
"$have_gas_4856":                                 ; preds = %"$out_of_gas_4855", %"$have_gas_4842"
  ...
  call void @_event(i8* %"$execptr_load_4858", %_TyDescrTy_Typ* @"$TyDescr_Event_301", i8* %"$e_4859"), !dbg !452
...
"$have_gas_4873":                                 ; preds = %"$out_of_gas_4872", %"$have_gas_4868"
  ...
  store i8* %"$msgobj_4875", i8** %"$m_2", align 8, !dbg !453
...
"$have_gas_4924":                                 ; preds = %"$out_of_gas_4923", %"$have_gas_4873"
  ...
  %"$ud-registry.oneMsg_call_4930" = call %TName_List_Message* %"$ud-registry.oneMsg_fptr_4927"(i8* %"$ud-registry.oneMsg_envptr_4928", i8* %"$$m_2_4929"), !dbg !454
  store %TName_List_Message* %"$ud-registry.oneMsg_call_4930", %TName_List_Message** %"$ud-registry.oneMsg_108", align 8, !dbg !454
  %"$$ud-registry.oneMsg_108_4931" = load %TName_List_Message*, %TName_List_Message** %"$ud-registry.oneMsg_108", align 8
  store %TName_List_Message* %"$$ud-registry.oneMsg_108_4931", %TName_List_Message** %msgs9, align 8, !dbg !454
...
"$have_gas_4938":                                 ; preds = %"$out_of_gas_4937", %"$have_gas_4924"
  ...
  call void @_send(i8* %"$execptr_load_4940", %_TyDescrTy_Typ* @"$TyDescr_ADT_List_Message_319", %TName_List_Message* %"$msgs_4941"), !dbg !455
  br label %"$matchsucc_4573"
...
entry:
  ...
  call void @"$assign_4465"(%Uint128 %_amount, [20 x i8]* %"$_origin_4946", [20 x i8]* %"$_sender_4948", [32 x i8]* %"$parent_4950", %String %label, [20 x i8]* %"$owner_4954"), !dbg !457
  ret void
}

define internal void @"$bestow_4955"(%Uint128 %_amount, [20 x i8]* %"$_origin_4956", [20 x i8]* %"$_sender_4957", %String %label, [20 x i8]* %"$owner_4958", [20 x i8]* %"$resolver_4959") !dbg !458 {
entry:
  ...
  %"$currentAdmins_call_4962" = call i8* @_fetch_field(i8* %"$execptr_load_4961", i8* getelementptr inbounds ([7 x i8], [7 x i8]* @"$admins_4960", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_ADT_List_ByStr20_320", i32 0, i8* null, i32 1), !dbg !459
...
"$have_gas_4981":                                 ; preds = %"$out_of_gas_4980", %"$have_gas_4976"
  ...
  %"$ud-registry.parentLabelToNode_call_4988" = call { void (i8*, [32 x i8]*, %String)*, i8* } %"$ud-registry.parentLabelToNode_fptr_4984"(i8* %"$ud-registry.parentLabelToNode_envptr_4985", [32 x i8]* %"$ud-registry.parentLabelToNode_rootNode_4986"), !dbg !460
  store { void (i8*, [32 x i8]*, %String)*, i8* } %"$ud-registry.parentLabelToNode_call_4988", { void (i8*, [32 x i8]*, %String)*, i8* }* %"$ud-registry.parentLabelToNode_132", align 8, !dbg !460
  ...
  call void %"$$ud-registry.parentLabelToNode_132_fptr_4990"(i8* %"$$ud-registry.parentLabelToNode_132_envptr_4991", [32 x i8]* %"$$ud-registry.parentLabelToNode_132_retalloca_4992", %String %label), !dbg !460
  %"$$ud-registry.parentLabelToNode_132_ret_4993" = load [32 x i8], [32 x i8]* %"$$ud-registry.parentLabelToNode_132_retalloca_4992", align 1
  store [32 x i8] %"$$ud-registry.parentLabelToNode_132_ret_4993", [32 x i8]* %"$ud-registry.parentLabelToNode_133", align 1, !dbg !460
  %"$$ud-registry.parentLabelToNode_133_4994" = load [32 x i8], [32 x i8]* %"$ud-registry.parentLabelToNode_133", align 1
  store [32 x i8] %"$$ud-registry.parentLabelToNode_133_4994", [32 x i8]* %node, align 1, !dbg !460
  %recordExists = alloca %TName_Bool*, align 8
  ...
  %"$recordExists_call_5000" = call i8* @_fetch_field(i8* %"$execptr_load_4999", i8* getelementptr inbounds ([8 x i8], [8 x i8]* @"$records_4998", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_325", i32 1, i8* %"$indices_buf_4995", i32 0), !dbg !461
...
"$have_gas_5010":                                 ; preds = %"$out_of_gas_5009", %"$have_gas_4981"
  ...
  %"$maybeRecord_call_5017" = call i8* @_fetch_field(i8* %"$execptr_load_5016", i8* getelementptr inbounds ([8 x i8], [8 x i8]* @"$records_5015", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_325", i32 1, i8* %"$indices_buf_5012", i32 1), !dbg !462
...
"$have_gas_5027":                                 ; preds = %"$out_of_gas_5026", %"$have_gas_5010"
  ...
  %"$currentRegistrar_call_5031" = call i8* @_fetch_field(i8* %"$execptr_load_5030", i8* getelementptr inbounds ([10 x i8], [10 x i8]* @"$registrar_5029", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Bystr20_311", i32 0, i8* null, i32 1), !dbg !463
...
"$have_gas_5057":                                 ; preds = %"$out_of_gas_5056", %"$have_gas_5052"
  ...
  %"$ud-registry.listByStr20Contains_call_5063" = call { %TName_Bool* (i8*, [20 x i8]*)*, i8* } %"$ud-registry.listByStr20Contains_fptr_5060"(i8* %"$ud-registry.listByStr20Contains_envptr_5061", %TName_List_ByStr20* %"$currentAdmins_5062"), !dbg !464
  store { %TName_Bool* (i8*, [20 x i8]*)*, i8* } %"$ud-registry.listByStr20Contains_call_5063", { %TName_Bool* (i8*, [20 x i8]*)*, i8* }* %"$ud-registry.listByStr20Contains_121", align 8, !dbg !464
  ...
  %"$$ud-registry.listByStr20Contains_121_call_5068" = call %TName_Bool* %"$$ud-registry.listByStr20Contains_121_fptr_5065"(i8* %"$$ud-registry.listByStr20Contains_121_envptr_5066", [20 x i8]* %"$$ud-registry.listByStr20Contains_121__sender_5067"), !dbg !464
  store %TName_Bool* %"$$ud-registry.listByStr20Contains_121_call_5068", %TName_Bool** %"$ud-registry.listByStr20Contains_122", align 8, !dbg !464
  %"$$ud-registry.listByStr20Contains_122_5069" = load %TName_Bool*, %TName_Bool** %"$ud-registry.listByStr20Contains_122", align 8
  store %TName_Bool* %"$$ud-registry.listByStr20Contains_122_5069", %TName_Bool** %isSenderAdmin, align 8, !dbg !464
...
"$have_gas_5078":                                 ; preds = %"$out_of_gas_5077", %"$have_gas_5073"
  ...
  %"$eq_call_5086" = call %TName_Bool* @_eq_ByStrX(i8* %"$execptr_load_5080", i32 20, i8* %"$$eq_currentRegistrar_5081_5083", i8* %"$$eq__sender_5084_5085"), !dbg !465
  store %TName_Bool* %"$eq_call_5086", %TName_Bool** %isSenderRegistrar, align 8, !dbg !465
...
"$have_gas_5096":                                 ; preds = %"$out_of_gas_5095", %"$have_gas_5091"
  ...
  %"$BoolUtils.orb_call_5102" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.orb_fptr_5099"(i8* %"$BoolUtils.orb_envptr_5100", %TName_Bool* %"$isSenderRegistrar_5101"), !dbg !466
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.orb_call_5102", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.orb_123", align 8, !dbg !466
  ...
  %"$$BoolUtils.orb_123_call_5107" = call %TName_Bool* %"$$BoolUtils.orb_123_fptr_5104"(i8* %"$$BoolUtils.orb_123_envptr_5105", %TName_Bool* %"$isSenderAdmin_5106"), !dbg !466
  store %TName_Bool* %"$$BoolUtils.orb_123_call_5107", %TName_Bool** %"$BoolUtils.orb_124", align 8, !dbg !466
  %"$$BoolUtils.orb_124_5108" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.orb_124", align 8
  store %TName_Bool* %"$$BoolUtils.orb_124_5108", %TName_Bool** %isOkSender, align 8, !dbg !466
...
"$have_gas_5117":                                 ; preds = %"$out_of_gas_5116", %"$have_gas_5112"
  ...
  call void %"$ud-registry.recordMemberOwner_fptr_5120"(i8* %"$ud-registry.recordMemberOwner_envptr_5121", [20 x i8]* %"$ud-registry.recordMemberOwner_retalloca_5123", %TName_Option_ud-registry.Record* %"$maybeRecord_5122"), !dbg !467
  %"$ud-registry.recordMemberOwner_ret_5124" = load [20 x i8], [20 x i8]* %"$ud-registry.recordMemberOwner_retalloca_5123", align 1
  store [20 x i8] %"$ud-registry.recordMemberOwner_ret_5124", [20 x i8]* %"$ud-registry.recordMemberOwner_125", align 1, !dbg !467
  %"$$ud-registry.recordMemberOwner_125_5125" = load [20 x i8], [20 x i8]* %"$ud-registry.recordMemberOwner_125", align 1
  store [20 x i8] %"$$ud-registry.recordMemberOwner_125_5125", [20 x i8]* %recordOwner, align 1, !dbg !467
...
"$have_gas_5134":                                 ; preds = %"$out_of_gas_5133", %"$have_gas_5129"
  ...
  %"$eq_call_5143" = call %TName_Bool* @_eq_ByStrX(i8* %"$execptr_load_5136", i32 20, i8* %"$$eq_recordOwner_5137_5139", i8* %"$$eq_ud-registry.zeroByStr20_5140_5142"), !dbg !468
  store %TName_Bool* %"$eq_call_5143", %TName_Bool** %recordIsUnowned, align 8, !dbg !468
...
"$have_gas_5153":                                 ; preds = %"$out_of_gas_5152", %"$have_gas_5148"
  ...
  %"$eq_call_5162" = call %TName_Bool* @_eq_ByStrX(i8* %"$execptr_load_5155", i32 20, i8* %"$$eq_recordOwner_5156_5158", i8* %"$$eq_currentRegistrar_5159_5161"), !dbg !469
  store %TName_Bool* %"$eq_call_5162", %TName_Bool** %recordIsOwnedByRegistrar, align 8, !dbg !469
...
"$have_gas_5172":                                 ; preds = %"$out_of_gas_5171", %"$have_gas_5167"
  ...
  %"$BoolUtils.andb_call_5178" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_fptr_5175"(i8* %"$BoolUtils.andb_envptr_5176", %TName_Bool* %"$recordIsOwnedByRegistrar_5177"), !dbg !470
  ...
  %"$$BoolUtils.andb_126_call_5183" = call %TName_Bool* %"$$BoolUtils.andb_126_fptr_5180"(i8* %"$$BoolUtils.andb_126_envptr_5181", %TName_Bool* %"$isSenderRegistrar_5182"), !dbg !470
  ...
  store %TName_Bool* %"$$BoolUtils.andb_127_5184", %TName_Bool** %isRegistrarSenderAndOwned, align 8, !dbg !470
...
"$have_gas_5193":                                 ; preds = %"$out_of_gas_5192", %"$have_gas_5188"
  ...
  %"$BoolUtils.orb_call_5199" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.orb_fptr_5196"(i8* %"$BoolUtils.orb_envptr_5197", %TName_Bool* %"$recordIsUnowned_5198"), !dbg !471
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.orb_call_5199", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.orb_128", align 8, !dbg !471
  ...
  %"$$BoolUtils.orb_128_call_5204" = call %TName_Bool* %"$$BoolUtils.orb_128_fptr_5201"(i8* %"$$BoolUtils.orb_128_envptr_5202", %TName_Bool* %"$isRegistrarSenderAndOwned_5203"), !dbg !471
  store %TName_Bool* %"$$BoolUtils.orb_128_call_5204", %TName_Bool** %"$BoolUtils.orb_129", align 8, !dbg !471
  %"$$BoolUtils.orb_129_5205" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.orb_129", align 8
  store %TName_Bool* %"$$BoolUtils.orb_129_5205", %TName_Bool** %isOkRecordOwner, align 8, !dbg !471
...
"$have_gas_5209":                                 ; preds = %"$out_of_gas_5208", %"$have_gas_5193"
  ...
  %"$BoolUtils.andb_call_5215" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_fptr_5212"(i8* %"$BoolUtils.andb_envptr_5213", %TName_Bool* %"$isOkSender_5214"), !dbg !472
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_call_5215", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.andb_130", align 8, !dbg !472
  ...
  %"$$BoolUtils.andb_130_call_5220" = call %TName_Bool* %"$$BoolUtils.andb_130_fptr_5217"(i8* %"$$BoolUtils.andb_130_envptr_5218", %TName_Bool* %"$isOkRecordOwner_5219"), !dbg !472
  store %TName_Bool* %"$$BoolUtils.andb_130_call_5220", %TName_Bool** %"$BoolUtils.andb_131", align 8, !dbg !472
  %"$$BoolUtils.andb_131_5221" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.andb_131", align 8
  store %TName_Bool* %"$$BoolUtils.andb_131_5221", %TName_Bool** %isOk, align 8, !dbg !472
...
"$have_gas_5254":                                 ; preds = %"$out_of_gas_5253", %"$have_gas_5249"
  ...
  %"$ud-registry.eNewDomain_call_5261" = call { i8* (i8*, %String)*, i8* } %"$ud-registry.eNewDomain_fptr_5257"(i8* %"$ud-registry.eNewDomain_envptr_5258", [32 x i8]* %"$ud-registry.eNewDomain_rootNode_5259"), !dbg !477
  store { i8* (i8*, %String)*, i8* } %"$ud-registry.eNewDomain_call_5261", { i8* (i8*, %String)*, i8* }* %"$ud-registry.eNewDomain_118", align 8, !dbg !477
  ...
  %"$$ud-registry.eNewDomain_118_call_5265" = call i8* %"$$ud-registry.eNewDomain_118_fptr_5263"(i8* %"$$ud-registry.eNewDomain_118_envptr_5264", %String %label), !dbg !477
  store i8* %"$$ud-registry.eNewDomain_118_call_5265", i8** %"$ud-registry.eNewDomain_119", align 8, !dbg !477
  %"$$ud-registry.eNewDomain_119_5266" = load i8*, i8** %"$ud-registry.eNewDomain_119", align 8
  store i8* %"$$ud-registry.eNewDomain_119_5266", i8** %e, align 8, !dbg !477
...
"$have_gas_5273":                                 ; preds = %"$out_of_gas_5272", %"$have_gas_5254"
  ...
  call void @_event(i8* %"$execptr_load_5275", %_TyDescrTy_Typ* @"$TyDescr_Event_301", i8* %"$e_5276"), !dbg !480
...
"$have_gas_5285":                                 ; preds = %"$out_of_gas_5284", %"$have_gas_5280"
  ...
  store %TName_ud-registry.Record* %"$adtptr_5291", %TName_ud-registry.Record** %newRecord, align 8, !dbg !481
...
"$have_gas_5299":                                 ; preds = %"$out_of_gas_5298", %"$have_gas_5285"
  ...
  call void @_update_field(i8* %"$execptr_load_5304", i8* getelementptr inbounds ([8 x i8], [8 x i8]* @"$records_5305", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_325", i32 1, i8* %"$indices_buf_5301", i8* %"$update_value_5307"), !dbg !482
...
"$have_gas_5316":                                 ; preds = %"$out_of_gas_5315", %"$have_gas_5311"
  ...
  %"$ud-registry.eConfigured_call_5323" = call { { i8* (i8*, [20 x i8]*)*, i8* } (i8*, [20 x i8]*)*, i8* } %"$ud-registry.eConfigured_fptr_5319"(i8* %"$ud-registry.eConfigured_envptr_5320", [32 x i8]* %"$ud-registry.eConfigured_node_5321"), !dbg !483
  store { { i8* (i8*, [20 x i8]*)*, i8* } (i8*, [20 x i8]*)*, i8* } %"$ud-registry.eConfigured_call_5323", { { i8* (i8*, [20 x i8]*)*, i8* } (i8*, [20 x i8]*)*, i8* }* %"$ud-registry.eConfigured_115", align 8, !dbg !483
  ...
  %"$$ud-registry.eConfigured_115_call_5328" = call { i8* (i8*, [20 x i8]*)*, i8* } %"$$ud-registry.eConfigured_115_fptr_5325"(i8* %"$$ud-registry.eConfigured_115_envptr_5326", [20 x i8]* %"$$ud-registry.eConfigured_115_owner_5327"), !dbg !483
  store { i8* (i8*, [20 x i8]*)*, i8* } %"$$ud-registry.eConfigured_115_call_5328", { i8* (i8*, [20 x i8]*)*, i8* }* %"$ud-registry.eConfigured_116", align 8, !dbg !483
  ...
  %"$$ud-registry.eConfigured_116_call_5333" = call i8* %"$$ud-registry.eConfigured_116_fptr_5330"(i8* %"$$ud-registry.eConfigured_116_envptr_5331", [20 x i8]* %"$$ud-registry.eConfigured_116_resolver_5332"), !dbg !483
  store i8* %"$$ud-registry.eConfigured_116_call_5333", i8** %"$ud-registry.eConfigured_117", align 8, !dbg !483
  %"$$ud-registry.eConfigured_117_5334" = load i8*, i8** %"$ud-registry.eConfigured_117", align 8
  store i8* %"$$ud-registry.eConfigured_117_5334", i8** %e3, align 8, !dbg !483
...
"$have_gas_5341":                                 ; preds = %"$out_of_gas_5340", %"$have_gas_5316"
  ...
  call void @_event(i8* %"$execptr_load_5343", %_TyDescrTy_Typ* @"$TyDescr_Event_301", i8* %"$e_5344"), !dbg !484
...
"$have_gas_5360":                                 ; preds = %"$out_of_gas_5359", %"$have_gas_5355"
  ...
  store %String { i8* getelementptr inbounds ([12 x i8], [12 x i8]* @"$stringlit_5362", i32 0, i32 0), i32 12 }, %String* %m, align 8, !dbg !485
...
"$have_gas_5366":                                 ; preds = %"$out_of_gas_5365", %"$have_gas_5360"
  ...
  %"$ud-registry.eError_call_5372" = call i8* %"$ud-registry.eError_fptr_5369"(i8* %"$ud-registry.eError_envptr_5370", %String %"$m_5371"), !dbg !487
  store i8* %"$ud-registry.eError_call_5372", i8** %"$ud-registry.eError_120", align 8, !dbg !487
  %"$$ud-registry.eError_120_5373" = load i8*, i8** %"$ud-registry.eError_120", align 8
  store i8* %"$$ud-registry.eError_120_5373", i8** %e4, align 8, !dbg !487
...
"$have_gas_5380":                                 ; preds = %"$out_of_gas_5379", %"$have_gas_5366"
  ...
  call void @_event(i8* %"$execptr_load_5382", %_TyDescrTy_Typ* @"$TyDescr_Event_301", i8* %"$e_5383"), !dbg !488
  br label %"$matchsucc_5227"
...
entry:
  ...
  call void @"$bestow_4955"(%Uint128 %_amount, [20 x i8]* %"$_origin_5388", [20 x i8]* %"$_sender_5390", %String %label, [20 x i8]* %"$owner_5394", [20 x i8]* %"$resolver_5396"), !dbg !490
  ret void
}

define internal void @"$setRegistrar_5397"(%Uint128 %_amount, [20 x i8]* %"$_origin_5398", [20 x i8]* %"$_sender_5399", [20 x i8]* %"$address_5400") !dbg !491 {
entry:
  ...
  %"$currentAdmins_call_5403" = call i8* @_fetch_field(i8* %"$execptr_load_5402", i8* getelementptr inbounds ([7 x i8], [7 x i8]* @"$admins_5401", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_ADT_List_ByStr20_320", i32 0, i8* null, i32 1), !dbg !492
...
"$have_gas_5422":                                 ; preds = %"$out_of_gas_5421", %"$have_gas_5417"
  ...
  %"$ud-registry.listByStr20Contains_call_5428" = call { %TName_Bool* (i8*, [20 x i8]*)*, i8* } %"$ud-registry.listByStr20Contains_fptr_5425"(i8* %"$ud-registry.listByStr20Contains_envptr_5426", %TName_List_ByStr20* %"$currentAdmins_5427"), !dbg !493
  store { %TName_Bool* (i8*, [20 x i8]*)*, i8* } %"$ud-registry.listByStr20Contains_call_5428", { %TName_Bool* (i8*, [20 x i8]*)*, i8* }* %"$ud-registry.listByStr20Contains_135", align 8, !dbg !493
  ...
  %"$$ud-registry.listByStr20Contains_135_call_5433" = call %TName_Bool* %"$$ud-registry.listByStr20Contains_135_fptr_5430"(i8* %"$$ud-registry.listByStr20Contains_135_envptr_5431", [20 x i8]* %"$$ud-registry.listByStr20Contains_135__sender_5432"), !dbg !493
  store %TName_Bool* %"$$ud-registry.listByStr20Contains_135_call_5433", %TName_Bool** %"$ud-registry.listByStr20Contains_136", align 8, !dbg !493
  %"$$ud-registry.listByStr20Contains_136_5434" = load %TName_Bool*, %TName_Bool** %"$ud-registry.listByStr20Contains_136", align 8
  store %TName_Bool* %"$$ud-registry.listByStr20Contains_136_5434", %TName_Bool** %isOk, align 8, !dbg !493
...
"$have_gas_5455":                                 ; preds = %"$out_of_gas_5454", %"$have_gas_5450"
  ...
  %"$ud-registry.eNewRegistrar_call_5461" = call i8* %"$ud-registry.eNewRegistrar_fptr_5458"(i8* %"$ud-registry.eNewRegistrar_envptr_5459", [20 x i8]* %"$ud-registry.eNewRegistrar_address_5460"), !dbg !495
  store i8* %"$ud-registry.eNewRegistrar_call_5461", i8** %"$ud-registry.eNewRegistrar_134", align 8, !dbg !495
  %"$$ud-registry.eNewRegistrar_134_5462" = load i8*, i8** %"$ud-registry.eNewRegistrar_134", align 8
  store i8* %"$$ud-registry.eNewRegistrar_134_5462", i8** %e, align 8, !dbg !495
...
"$have_gas_5469":                                 ; preds = %"$out_of_gas_5468", %"$have_gas_5455"
  ...
  call void @_event(i8* %"$execptr_load_5471", %_TyDescrTy_Typ* @"$TyDescr_Event_301", i8* %"$e_5472"), !dbg !498
...
"$have_gas_5479":                                 ; preds = %"$out_of_gas_5478", %"$have_gas_5469"
  ...
  call void @_update_field(i8* %"$execptr_load_5481", i8* getelementptr inbounds ([10 x i8], [10 x i8]* @"$registrar_5482", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Bystr20_311", i32 0, i8* null, i8* %"$update_value_5484"), !dbg !499
...
entry:
  ...
  call void @"$setRegistrar_5397"(%Uint128 %_amount, [20 x i8]* %"$_origin_5489", [20 x i8]* %"$_sender_5491", [20 x i8]* %"$address_5493"), !dbg !501
  ret void
}

define internal void @"$register_5494"(%Uint128 %_amount, [20 x i8]* %"$_origin_5495", [20 x i8]* %"$_sender_5496", [32 x i8]* %"$parent_5497", %String %label) !dbg !502 {
entry:
...
"$have_gas_5506":                                 ; preds = %"$out_of_gas_5505", %"$have_gas_5501"
  ...
  %"$ud-registry.parentLabelToNode_call_5512" = call { void (i8*, [32 x i8]*, %String)*, i8* } %"$ud-registry.parentLabelToNode_fptr_5509"(i8* %"$ud-registry.parentLabelToNode_envptr_5510", [32 x i8]* %"$ud-registry.parentLabelToNode_parent_5511"), !dbg !503
  store { void (i8*, [32 x i8]*, %String)*, i8* } %"$ud-registry.parentLabelToNode_call_5512", { void (i8*, [32 x i8]*, %String)*, i8* }* %"$ud-registry.parentLabelToNode_141", align 8, !dbg !503
  ...
  call void %"$$ud-registry.parentLabelToNode_141_fptr_5514"(i8* %"$$ud-registry.parentLabelToNode_141_envptr_5515", [32 x i8]* %"$$ud-registry.parentLabelToNode_141_retalloca_5516", %String %label), !dbg !503
  %"$$ud-registry.parentLabelToNode_141_ret_5517" = load [32 x i8], [32 x i8]* %"$$ud-registry.parentLabelToNode_141_retalloca_5516", align 1
  store [32 x i8] %"$$ud-registry.parentLabelToNode_141_ret_5517", [32 x i8]* %"$ud-registry.parentLabelToNode_142", align 1, !dbg !503
  %"$$ud-registry.parentLabelToNode_142_5518" = load [32 x i8], [32 x i8]* %"$ud-registry.parentLabelToNode_142", align 1
  store [32 x i8] %"$$ud-registry.parentLabelToNode_142_5518", [32 x i8]* %node, align 1, !dbg !503
  %maybeRecord = alloca %TName_Option_ud-registry.Record*, align 8
  ...
  %"$maybeRecord_call_5524" = call i8* @_fetch_field(i8* %"$execptr_load_5523", i8* getelementptr inbounds ([8 x i8], [8 x i8]* @"$records_5522", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_325", i32 1, i8* %"$indices_buf_5519", i32 1), !dbg !504
...
"$have_gas_5534":                                 ; preds = %"$out_of_gas_5533", %"$have_gas_5506"
  ...
  %"$maybeApproved_call_5541" = call i8* @_fetch_field(i8* %"$execptr_load_5540", i8* getelementptr inbounds ([10 x i8], [10 x i8]* @"$approvals_5539", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_324", i32 1, i8* %"$indices_buf_5536", i32 1), !dbg !505
...
"$have_gas_5561":                                 ; preds = %"$out_of_gas_5560", %"$have_gas_5556"
  ...
  call void %"$ud-registry.recordMemberOwner_fptr_5564"(i8* %"$ud-registry.recordMemberOwner_envptr_5565", [20 x i8]* %"$ud-registry.recordMemberOwner_retalloca_5567", %TName_Option_ud-registry.Record* %"$maybeRecord_5566"), !dbg !506
  %"$ud-registry.recordMemberOwner_ret_5568" = load [20 x i8], [20 x i8]* %"$ud-registry.recordMemberOwner_retalloca_5567", align 1
  store [20 x i8] %"$ud-registry.recordMemberOwner_ret_5568", [20 x i8]* %"$ud-registry.recordMemberOwner_140", align 1, !dbg !506
  %"$$ud-registry.recordMemberOwner_140_5569" = load [20 x i8], [20 x i8]* %"$ud-registry.recordMemberOwner_140", align 1
  store [20 x i8] %"$$ud-registry.recordMemberOwner_140_5569", [20 x i8]* %recordOwner, align 1, !dbg !506
...
"$have_gas_5590":                                 ; preds = %"$out_of_gas_5589", %"$None_5585"
  ...
  store [20 x i8] %"$ud-registry.zeroByStr20_5592", [20 x i8]* %approved, align 1, !dbg !508
...
"$have_gas_5600":                                 ; preds = %"$out_of_gas_5599", %"$Some_5593"
  ...
  store [20 x i8] %"$approved_5602", [20 x i8]* %approved2, align 1, !dbg !511
  br label %"$matchsucc_5580"
...
"$matchsucc_5580":                                ; preds = %"$have_gas_5600", %"$have_gas_5590", %"$empty_default_5584"
  ...
  %"$currentRegistrar_call_5605" = call i8* @_fetch_field(i8* %"$execptr_load_5604", i8* getelementptr inbounds ([10 x i8], [10 x i8]* @"$registrar_5603", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Bystr20_311", i32 0, i8* null, i32 1), !dbg !513
...
"$have_gas_5631":                                 ; preds = %"$out_of_gas_5630", %"$have_gas_5626"
  ...
  %"$eq_call_5640" = call %TName_Bool* @_eq_ByStrX(i8* %"$execptr_load_5633", i32 20, i8* %"$$eq_recordOwner_5634_5636", i8* %"$$eq_ud-registry.zeroByStr20_5637_5639"), !dbg !514
  store %TName_Bool* %"$eq_call_5640", %TName_Bool** %isRecordUnowned, align 8, !dbg !514
...
"$have_gas_5650":                                 ; preds = %"$out_of_gas_5649", %"$have_gas_5645"
  ...
  %"$eq_call_5659" = call %TName_Bool* @_eq_ByStrX(i8* %"$execptr_load_5652", i32 20, i8* %"$$eq_approved_5653_5655", i8* %"$$eq_ud-registry.zeroByStr20_5656_5658"), !dbg !515
...
"$have_gas_5664":                                 ; preds = %"$out_of_gas_5663", %"$have_gas_5650"
  ...
  %"$BoolUtils.andb_call_5670" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_fptr_5667"(i8* %"$BoolUtils.andb_envptr_5668", %TName_Bool* %"$isRecordUnowned_5669"), !dbg !516
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_call_5670", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.andb_138", align 8, !dbg !516
  ...
  %"$$BoolUtils.andb_138_call_5675" = call %TName_Bool* %"$$BoolUtils.andb_138_fptr_5672"(i8* %"$$BoolUtils.andb_138_envptr_5673", %TName_Bool* %"$isUnapproved_5674"), !dbg !516
  store %TName_Bool* %"$$BoolUtils.andb_138_call_5675", %TName_Bool** %"$BoolUtils.andb_139", align 8, !dbg !516
  %"$$BoolUtils.andb_139_5676" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.andb_139", align 8
  store %TName_Bool* %"$$BoolUtils.andb_139_5676", %TName_Bool** %isOk, align 8, !dbg !516
...
"$have_gas_5692":                                 ; preds = %"$out_of_gas_5691", %"$True_5687"
  ...
  call void @_accept(i8* %"$execptr_load_5694"), !dbg !518
...
"$have_gas_5708":                                 ; preds = %"$out_of_gas_5707", %"$have_gas_5703"
  ...
  store i8* %"$msgobj_5710", i8** %m, align 8, !dbg !521
...
"$have_gas_5767":                                 ; preds = %"$out_of_gas_5766", %"$have_gas_5708"
  ...
  %"$ud-registry.oneMsg_call_5773" = call %TName_List_Message* %"$ud-registry.oneMsg_fptr_5770"(i8* %"$ud-registry.oneMsg_envptr_5771", i8* %"$m_5772"), !dbg !522
  store %TName_List_Message* %"$ud-registry.oneMsg_call_5773", %TName_List_Message** %"$ud-registry.oneMsg_137", align 8, !dbg !522
  %"$$ud-registry.oneMsg_137_5774" = load %TName_List_Message*, %TName_List_Message** %"$ud-registry.oneMsg_137", align 8
  store %TName_List_Message* %"$$ud-registry.oneMsg_137_5774", %TName_List_Message** %msgs, align 8, !dbg !522
...
"$have_gas_5781":                                 ; preds = %"$out_of_gas_5780", %"$have_gas_5767"
  ...
  call void @_send(i8* %"$execptr_load_5783", %_TyDescrTy_Typ* @"$TyDescr_ADT_List_Message_319", %TName_List_Message* %"$msgs_5784"), !dbg !523
...
entry:
  ...
  call void @"$register_5494"(%Uint128 %_amount, [20 x i8]* %"$_origin_5791", [20 x i8]* %"$_sender_5793", [32 x i8]* %"$parent_5795", %String %label), !dbg !525
  ret void
}

define internal void @"$onResolverConfigured_5798"(%Uint128 %_amount, [20 x i8]* %"$_origin_5799", [20 x i8]* %"$_sender_5800", [32 x i8]* %"$node_5801") !dbg !526 {
entry:
  ...
  %"$maybeRecord_call_5806" = call i8* @_fetch_field(i8* %"$execptr_load_5805", i8* getelementptr inbounds ([8 x i8], [8 x i8]* @"$records_5804", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Map_325", i32 1, i8* %"$indices_buf_5802", i32 1), !dbg !527
...
"$have_gas_5858":                                 ; preds = %"$out_of_gas_5857", %"$have_gas_5853"
  ...
  %"$eq_call_5866" = call %TName_Bool* @_eq_ByStrX(i8* %"$execptr_load_5860", i32 20, i8* %"$$eq_resolver_5861_5863", i8* %"$$eq__sender_5864_5865"), !dbg !532
  store %TName_Bool* %"$eq_call_5866", %TName_Bool** %isOk, align 8, !dbg !532
...
"$have_gas_5888":                                 ; preds = %"$out_of_gas_5887", %"$have_gas_5883"
  ...
  %"$ud-registry.eConfigured_call_5894" = call { { i8* (i8*, [20 x i8]*)*, i8* } (i8*, [20 x i8]*)*, i8* } %"$ud-registry.eConfigured_fptr_5891"(i8* %"$ud-registry.eConfigured_envptr_5892", [32 x i8]* %"$ud-registry.eConfigured_node_5893"), !dbg !536
  store { { i8* (i8*, [20 x i8]*)*, i8* } (i8*, [20 x i8]*)*, i8* } %"$ud-registry.eConfigured_call_5894", { { i8* (i8*, [20 x i8]*)*, i8* } (i8*, [20 x i8]*)*, i8* }* %"$ud-registry.eConfigured_143", align 8, !dbg !536
  ...
  %"$$ud-registry.eConfigured_143_call_5900" = call { i8* (i8*, [20 x i8]*)*, i8* } %"$$ud-registry.eConfigured_143_fptr_5896"(i8* %"$$ud-registry.eConfigured_143_envptr_5897", [20 x i8]* %"$$ud-registry.eConfigured_143_owner_5898"), !dbg !536
  store { i8* (i8*, [20 x i8]*)*, i8* } %"$$ud-registry.eConfigured_143_call_5900", { i8* (i8*, [20 x i8]*)*, i8* }* %"$ud-registry.eConfigured_144", align 8, !dbg !536
  ...
  %"$$ud-registry.eConfigured_144_call_5906" = call i8* %"$$ud-registry.eConfigured_144_fptr_5902"(i8* %"$$ud-registry.eConfigured_144_envptr_5903", [20 x i8]* %"$$ud-registry.eConfigured_144_resolver_5904"), !dbg !536
  store i8* %"$$ud-registry.eConfigured_144_call_5906", i8** %"$ud-registry.eConfigured_145", align 8, !dbg !536
  %"$$ud-registry.eConfigured_145_5907" = load i8*, i8** %"$ud-registry.eConfigured_145", align 8
  store i8* %"$$ud-registry.eConfigured_145_5907", i8** %e, align 8, !dbg !536
...
"$have_gas_5914":                                 ; preds = %"$out_of_gas_5913", %"$have_gas_5888"
  ...
  call void @_event(i8* %"$execptr_load_5916", %_TyDescrTy_Typ* @"$TyDescr_Event_301", i8* %"$e_5917"), !dbg !539
...
entry:
  ...
  call void @"$onResolverConfigured_5798"(%Uint128 %_amount, [20 x i8]* %"$_origin_5924", [20 x i8]* %"$_sender_5926", [32 x i8]* %"$node_5928"), !dbg !541
  ret void
}
