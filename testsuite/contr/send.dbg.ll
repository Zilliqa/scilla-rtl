...
define internal void @"$SendMsg_96"(%Uint128 %_amount, [20 x i8]* %"$_origin_97", [20 x i8]* %"$_sender_98") !dbg !15 {
entry:
...
"$have_gas_107":                                  ; preds = %"$out_of_gas_106", %"$have_gas_102"
  ...
  store i8* %"$msgobj_109", i8** %msg1, align 8, !dbg !16
...
"$have_gas_141":                                  ; preds = %"$out_of_gas_140", %"$have_gas_136"
  ...
  %"$send.one_msg_call_147" = call %TName_List_Message* %"$send.one_msg_fptr_144"(i8* %"$send.one_msg_envptr_145", i8* %"$msg1_146"), !dbg !17
  store %TName_List_Message* %"$send.one_msg_call_147", %TName_List_Message** %"$send.one_msg_1", align 8, !dbg !17
  %"$$send.one_msg_1_148" = load %TName_List_Message*, %TName_List_Message** %"$send.one_msg_1", align 8
  store %TName_List_Message* %"$$send.one_msg_1_148", %TName_List_Message** %msgs1, align 8, !dbg !17
...
"$have_gas_155":                                  ; preds = %"$out_of_gas_154", %"$have_gas_141"
  ...
  call void @_send(i8* %"$execptr_load_157", %_TyDescrTy_Typ* @"$TyDescr_ADT_List_Message_39", %TName_List_Message* %"$msgs1_158"), !dbg !18
  ret void
}
...
entry:
  ...
  call void @"$SendMsg_96"(%Uint128 %_amount, [20 x i8]* %"$_origin_163", [20 x i8]* %"$_sender_165"), !dbg !20
  ret void
}

define internal void @"$SendMsg2_166"(%Uint128 %_amount, [20 x i8]* %"$_origin_167", [20 x i8]* %"$_sender_168") !dbg !21 {
entry:
...
"$have_gas_177":                                  ; preds = %"$out_of_gas_176", %"$have_gas_172"
  ...
  store i8* %"$msgobj_179", i8** %msg1, align 8, !dbg !22
...
"$have_gas_211":                                  ; preds = %"$out_of_gas_210", %"$have_gas_206"
  ...
  store i8* %"$msgobj_213", i8** %msg2, align 8, !dbg !23
...
"$have_gas_245":                                  ; preds = %"$out_of_gas_244", %"$have_gas_240"
  ...
  %"$send.one_msg_call_251" = call %TName_List_Message* %"$send.one_msg_fptr_248"(i8* %"$send.one_msg_envptr_249", i8* %"$msg1_250"), !dbg !24
  store %TName_List_Message* %"$send.one_msg_call_251", %TName_List_Message** %"$send.one_msg_2", align 8, !dbg !24
  %"$$send.one_msg_2_252" = load %TName_List_Message*, %TName_List_Message** %"$send.one_msg_2", align 8
  store %TName_List_Message* %"$$send.one_msg_2_252", %TName_List_Message** %msgs1, align 8, !dbg !24
...
"$have_gas_261":                                  ; preds = %"$out_of_gas_260", %"$have_gas_256"
  ...
  store %TName_List_Message* %"$adtptr_269", %TName_List_Message** %msgs2, align 8, !dbg !25
...
"$have_gas_276":                                  ; preds = %"$out_of_gas_275", %"$have_gas_261"
  ...
  call void @_send(i8* %"$execptr_load_278", %_TyDescrTy_Typ* @"$TyDescr_ADT_List_Message_39", %TName_List_Message* %"$msgs2_279"), !dbg !26
  ret void
}
...
entry:
  ...
  call void @"$SendMsg2_166"(%Uint128 %_amount, [20 x i8]* %"$_origin_284", [20 x i8]* %"$_sender_286"), !dbg !28
  ret void
}
