...
"$have_gas_64":                                   ; preds = %"$out_of_gas_63", %entry
  ...
  call void @_update_field(i8* %"$execptr_load_66", i8* getelementptr inbounds ([2 x i8], [2 x i8]* @"$x_67", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Int32_6", i32 0, i8* null, i8* %"$update_value_70"), !dbg !11
  ret void
}

declare void @_update_field(i8*, i8*, %_TyDescrTy_Typ*, i32, i8*, i8*)

define internal void @"$create_event_71"(%Uint128 %_amount, [20 x i8]* %"$_origin_72", [20 x i8]* %"$_sender_73", %Int32 %m) !dbg !12 {
entry:
...
"$have_gas_82":                                   ; preds = %"$out_of_gas_81", %"$have_gas_77"
  ...
  store i8* %"$msgobj_84", i8** %e, align 8, !dbg !13
...
"$have_gas_107":                                  ; preds = %"$out_of_gas_106", %"$have_gas_82"
  ...
  call void @_event(i8* %"$execptr_load_109", %_TyDescrTy_Typ* @"$TyDescr_Event_28", i8* %"$e_110"), !dbg !14
  ret void
}
...
define internal void @"$t1_111"(%Uint128 %_amount, [20 x i8]* %"$_origin_112", [20 x i8]* %"$_sender_113", %TName_Bool* %c) !dbg !15 {
entry:
  ...
  %"$$x_1_call_116" = call i8* @_fetch_field(i8* %"$execptr_load_115", i8* getelementptr inbounds ([2 x i8], [2 x i8]* @"$x_114", i32 0, i32 0), %_TyDescrTy_Typ* @"$TyDescr_Int32_6", i32 0, i8* null, i32 1), !dbg !16
...
"$have_gas_147":                                  ; preds = %"$out_of_gas_146", %"$have_gas_142"
  ...
  store %Int32 %"$$x_2_149", %Int32* %y, align 4, !dbg !18
...
"$have_gas_158":                                  ; preds = %"$out_of_gas_157", %"$have_gas_153"
  ...
  %"$add_call_162" = call %Int32 @_add_Int32(%Int32 %"$$x_1_160", %Int32 %"$y_161"), !dbg !19
  store %Int32 %"$add_call_162", %Int32* %z, align 4, !dbg !19
...
"$have_gas_166":                                  ; preds = %"$out_of_gas_165", %"$have_gas_158"
  ...
  call void @"$create_event_71"(%Uint128 %_amount, [20 x i8]* %"$create_event__origin_168", [20 x i8]* %"$create_event__sender_169", %Int32 %"$z_170"), !dbg !20
  ret void
}
...
entry:
  ...
  call void @"$t1_111"(%Uint128 %_amount, [20 x i8]* %"$_origin_175", [20 x i8]* %"$_sender_177", %TName_Bool* %c), !dbg !22
  ret void
}
