...
"$have_gas_101":                                  ; preds = %"$out_of_gas_100", %"$have_gas_76"
  ...
  call void @_event(i8* %"$execptr_load_103", %_TyDescrTy_Typ* @"$TyDescr_Event_25", i8* %"$e_104"), !dbg !13
  ret void
}
...
"$have_gas_168":                                  ; preds = %"$out_of_gas_167", %"$have_gas_163"
  ...
  call void @"$create_event_65"(%Uint128 %_amount, [20 x i8]* %"$create_event__origin_170", [20 x i8]* %"$create_event__sender_171", %Int32 %"$y_172"), !dbg !26
...
"$have_gas_188":                                  ; preds = %"$out_of_gas_187", %"$have_gas_183"
  ...
  call void @"$create_event_65"(%Uint128 %_amount, [20 x i8]* %"$create_event__origin_190", [20 x i8]* %"$create_event__sender_191", %Int32 %"$y_192"), !dbg !29
  br label %"$matchsucc_149"
...
entry:
  ...
  call void @"$t1_105"(%Uint128 %_amount, [20 x i8]* %"$_origin_197", [20 x i8]* %"$_sender_199", %TName_Bool* %c), !dbg !31
  ret void
}
