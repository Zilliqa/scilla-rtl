...
@_contract_parameters = constant [2 x %"$ParamDescr_189"] [%"$ParamDescr_189" { %ParamDescrString { i8* getelementptr inbounds ([15 x i8], [15 x i8]* @"$pname__scilla_version_191", i32 0, i32 0), i32 15 }, %_TyDescrTy_Typ* @"$TyDescr_Uint32_4" }, %"$ParamDescr_189" { %ParamDescrString { i8* getelementptr inbounds ([13 x i8], [13 x i8]* @"$pname__this_address_192", i32 0, i32 0), i32 13 }, %_TyDescrTy_Typ* @"$TyDescr_Bystr20_30" }]
@_contract_parameters_length = constant i32 2
@"$tpname__amount_193" = unnamed_addr constant [7 x i8] c"_amount"
@"$tpname__origin_194" = unnamed_addr constant [7 x i8] c"_origin"
@"$tpname__sender_195" = unnamed_addr constant [7 x i8] c"_sender"
@"$tpname_c_196" = unnamed_addr constant [1 x i8] c"c"
@"$tparams_t1_197" = unnamed_addr constant [4 x %"$ParamDescr_189"] [%"$ParamDescr_189" { %ParamDescrString { i8* getelementptr inbounds ([7 x i8], [7 x i8]* @"$tpname__amount_193", i32 0, i32 0), i32 7 }, %_TyDescrTy_Typ* @"$TyDescr_Uint128_12" }, %"$ParamDescr_189" { %ParamDescrString { i8* getelementptr inbounds ([7 x i8], [7 x i8]* @"$tpname__origin_194", i32 0, i32 0), i32 7 }, %_TyDescrTy_Typ* @"$TyDescr_Addr_38" }, %"$ParamDescr_189" { %ParamDescrString { i8* getelementptr inbounds ([7 x i8], [7 x i8]* @"$tpname__sender_195", i32 0, i32 0), i32 7 }, %_TyDescrTy_Typ* @"$TyDescr_Addr_38" }, %"$ParamDescr_189" { %ParamDescrString { i8* getelementptr inbounds ([1 x i8], [1 x i8]* @"$tpname_c_196", i32 0, i32 0), i32 1 }, %_TyDescrTy_Typ* @"$TyDescr_ADT_Bool_34" }]
@"$tname_t1_198" = unnamed_addr constant [2 x i8] c"t1"
@_transition_parameters = constant [1 x %"$TransDescr_190"] [%"$TransDescr_190" { %ParamDescrString { i8* getelementptr inbounds ([2 x i8], [2 x i8]* @"$tname_t1_198", i32 0, i32 0), i32 2 }, i32 4, %"$ParamDescr_189"* getelementptr inbounds ([4 x %"$ParamDescr_189"], [4 x %"$ParamDescr_189"]* @"$tparams_t1_197", i32 0, i32 0) }]
...
define internal void @"$create_event_52"(%Uint128 %_amount, [20 x i8]* %"$_origin_53", [20 x i8]* %"$_sender_54", %Int32 %m) !dbg !10 {
entry:
...
"$have_gas_63":                                   ; preds = %"$out_of_gas_62", %"$have_gas_58"
  ...
  store i8* %"$msgobj_65", i8** %e, align 8, !dbg !11
...
"$have_gas_88":                                   ; preds = %"$out_of_gas_87", %"$have_gas_63"
  ...
  call void @_event(i8* %"$execptr_load_90", %_TyDescrTy_Typ* @"$TyDescr_Event_24", i8* %"$e_91"), !dbg !12
  ret void
}
...
define internal void @"$t1_92"(%Uint128 %_amount, [20 x i8]* %"$_origin_93", [20 x i8]* %"$_sender_94", %TName_Bool* %c) !dbg !13 {
entry:
...
"$have_gas_126":                                  ; preds = %"$out_of_gas_125", %"$matchsucc_105"
  ...
  call void @"$create_event_52"(%Uint128 %_amount, [20 x i8]* %"$create_event__origin_128", [20 x i8]* %"$create_event__sender_129", %Int32 %"$x_130"), !dbg !20
...
"$have_gas_155":                                  ; preds = %"$out_of_gas_154", %"$have_gas_150"
  ...
  call void @"$create_event_52"(%Uint128 %_amount, [20 x i8]* %"$create_event__origin_157", [20 x i8]* %"$create_event__sender_158", %Int32 %"$y_159"), !dbg !25
...
"$have_gas_175":                                  ; preds = %"$out_of_gas_174", %"$have_gas_170"
  ...
  call void @"$create_event_52"(%Uint128 %_amount, [20 x i8]* %"$create_event__origin_177", [20 x i8]* %"$create_event__sender_178", %Int32 %"$y_179"), !dbg !28
  br label %"$matchsucc_136"
...
entry:
  ...
  call void @"$t1_92"(%Uint128 %_amount, [20 x i8]* %"$_origin_184", [20 x i8]* %"$_sender_186", %TName_Bool* %c), !dbg !30
  ret void
}
