...
define internal void @"$SendMsg_90"(%Uint128 %_amount, [20 x i8]* %"$_origin_91", [20 x i8]* %"$_sender_92") {
entry:
...
"$have_gas_101":                                  ; preds = %"$out_of_gas_100", %"$have_gas_96"
  ...
  store i8* %"$msgobj_103", i8** %msg1, align 8
...
"$have_gas_135":                                  ; preds = %"$out_of_gas_134", %"$have_gas_130"
  ...
  %"$send.one_msg_call_141" = call %TName_List_Message* %"$send.one_msg_fptr_138"(i8* %"$send.one_msg_envptr_139", i8* %"$msg1_140")
  store %TName_List_Message* %"$send.one_msg_call_141", %TName_List_Message** %"$send.one_msg_0", align 8
  %"$$send.one_msg_0_142" = load %TName_List_Message*, %TName_List_Message** %"$send.one_msg_0", align 8
  store %TName_List_Message* %"$$send.one_msg_0_142", %TName_List_Message** %msgs1, align 8
...
"$have_gas_149":                                  ; preds = %"$out_of_gas_148", %"$have_gas_135"
  ...
  call void @_send(i8* %"$execptr_load_151", %_TyDescrTy_Typ* @"$TyDescr_ADT_List_Message_38", %TName_List_Message* %"$msgs1_152")
  ret void
}
...
entry:
  ...
  call void @"$SendMsg_90"(%Uint128 %_amount, [20 x i8]* %"$_origin_157", [20 x i8]* %"$_sender_159")
  ret void
}

define internal void @"$SendMsg2_160"(%Uint128 %_amount, [20 x i8]* %"$_origin_161", [20 x i8]* %"$_sender_162") {
entry:
...
"$have_gas_171":                                  ; preds = %"$out_of_gas_170", %"$have_gas_166"
  ...
  store i8* %"$msgobj_173", i8** %msg1, align 8
...
"$have_gas_205":                                  ; preds = %"$out_of_gas_204", %"$have_gas_200"
  ...
  store i8* %"$msgobj_207", i8** %msg2, align 8
...
"$have_gas_239":                                  ; preds = %"$out_of_gas_238", %"$have_gas_234"
  ...
  %"$send.one_msg_call_245" = call %TName_List_Message* %"$send.one_msg_fptr_242"(i8* %"$send.one_msg_envptr_243", i8* %"$msg1_244")
  store %TName_List_Message* %"$send.one_msg_call_245", %TName_List_Message** %"$send.one_msg_1", align 8
  %"$$send.one_msg_1_246" = load %TName_List_Message*, %TName_List_Message** %"$send.one_msg_1", align 8
  store %TName_List_Message* %"$$send.one_msg_1_246", %TName_List_Message** %msgs1, align 8
...
"$have_gas_255":                                  ; preds = %"$out_of_gas_254", %"$have_gas_250"
  ...
  store %TName_List_Message* %"$adtptr_263", %TName_List_Message** %msgs2, align 8
...
"$have_gas_270":                                  ; preds = %"$out_of_gas_269", %"$have_gas_255"
  ...
  call void @_send(i8* %"$execptr_load_272", %_TyDescrTy_Typ* @"$TyDescr_ADT_List_Message_38", %TName_List_Message* %"$msgs2_273")
  ret void
}
...
entry:
  ...
  call void @"$SendMsg2_160"(%Uint128 %_amount, [20 x i8]* %"$_origin_278", [20 x i8]* %"$_sender_280")
  ret void
}
