...
define internal void @"$SendMsg_101"(%Uint128 %_amount, [20 x i8]* %"$_origin_102", [20 x i8]* %"$_sender_103") {
entry:
...
"$have_gas_112":                                  ; preds = %"$out_of_gas_111", %"$have_gas_107"
  ...
  store i8* %"$msgobj_114", i8** %msg1, align 8
...
"$have_gas_146":                                  ; preds = %"$out_of_gas_145", %"$have_gas_141"
  ...
  %"$send.one_msg_call_152" = call %TName_List_Message* %"$send.one_msg_fptr_149"(i8* %"$send.one_msg_envptr_150", i8* %"$msg1_151")
  store %TName_List_Message* %"$send.one_msg_call_152", %TName_List_Message** %"$send.one_msg_1", align 8
  %"$$send.one_msg_1_153" = load %TName_List_Message*, %TName_List_Message** %"$send.one_msg_1", align 8
  store %TName_List_Message* %"$$send.one_msg_1_153", %TName_List_Message** %msgs1, align 8
...
"$have_gas_160":                                  ; preds = %"$out_of_gas_159", %"$have_gas_146"
  ...
  call void @_send(i8* %"$execptr_load_162", %_TyDescrTy_Typ* @"$TyDescr_ADT_List_Message_39", %TName_List_Message* %"$msgs1_163")
  ret void
}
...
entry:
  ...
  call void @"$SendMsg_101"(%Uint128 %_amount, [20 x i8]* %"$_origin_168", [20 x i8]* %"$_sender_170")
  ret void
}

define internal void @"$SendMsg2_171"(%Uint128 %_amount, [20 x i8]* %"$_origin_172", [20 x i8]* %"$_sender_173") {
entry:
...
"$have_gas_182":                                  ; preds = %"$out_of_gas_181", %"$have_gas_177"
  ...
  store i8* %"$msgobj_184", i8** %msg1, align 8
...
"$have_gas_216":                                  ; preds = %"$out_of_gas_215", %"$have_gas_211"
  ...
  store i8* %"$msgobj_218", i8** %msg2, align 8
...
"$have_gas_250":                                  ; preds = %"$out_of_gas_249", %"$have_gas_245"
  ...
  %"$send.one_msg_call_256" = call %TName_List_Message* %"$send.one_msg_fptr_253"(i8* %"$send.one_msg_envptr_254", i8* %"$msg1_255")
  store %TName_List_Message* %"$send.one_msg_call_256", %TName_List_Message** %"$send.one_msg_2", align 8
  %"$$send.one_msg_2_257" = load %TName_List_Message*, %TName_List_Message** %"$send.one_msg_2", align 8
  store %TName_List_Message* %"$$send.one_msg_2_257", %TName_List_Message** %msgs1, align 8
...
"$have_gas_266":                                  ; preds = %"$out_of_gas_265", %"$have_gas_261"
  ...
  store %TName_List_Message* %"$adtptr_274", %TName_List_Message** %msgs2, align 8
...
"$have_gas_281":                                  ; preds = %"$out_of_gas_280", %"$have_gas_266"
  ...
  call void @_send(i8* %"$execptr_load_283", %_TyDescrTy_Typ* @"$TyDescr_ADT_List_Message_39", %TName_List_Message* %"$msgs2_284")
  ret void
}
...
entry:
  ...
  call void @"$SendMsg2_171"(%Uint128 %_amount, [20 x i8]* %"$_origin_289", [20 x i8]* %"$_sender_291")
  ret void
}
