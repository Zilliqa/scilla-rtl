...
"$have_gas_81":                                   ; preds = %"$out_of_gas_80", %entry
  ...
  store { %TName_List_Message* (i8*, i8*)*, i8* } { %TName_List_Message* (i8*, i8*)* bitcast (%TName_List_Message* (%"$$fundef_2_env_52"*, i8*)* @"$fundef_2" to %TName_List_Message* (i8*, i8*)*), i8* null }, { %TName_List_Message* (i8*, i8*)*, i8* }* @send.one_msg, align 8, !dbg !11
  ret void
}
...
define internal void @"$SendMsg_86"(%Uint128 %_amount, [20 x i8]* %"$_sender_87") !dbg !13 {
entry:
...
"$have_gas_96":                                   ; preds = %"$out_of_gas_95", %"$have_gas_91"
  ...
  store i8* %"$msgobj_98", i8** %msg1, align 8, !dbg !14
...
"$have_gas_130":                                  ; preds = %"$out_of_gas_129", %"$have_gas_125"
  ...
  %"$send.one_msg_call_136" = call %TName_List_Message* %"$send.one_msg_fptr_133"(i8* %"$send.one_msg_envptr_134", i8* %"$msg1_135"), !dbg !15
  store %TName_List_Message* %"$send.one_msg_call_136", %TName_List_Message** %"$send.one_msg_0", align 8, !dbg !15
  %"$$send.one_msg_0_137" = load %TName_List_Message*, %TName_List_Message** %"$send.one_msg_0", align 8
  store %TName_List_Message* %"$$send.one_msg_0_137", %TName_List_Message** %msgs1, align 8, !dbg !15
...
"$have_gas_144":                                  ; preds = %"$out_of_gas_143", %"$have_gas_130"
  ...
  call void @_send(i8* %"$execptr_load_146", %_TyDescrTy_Typ* @"$TyDescr_ADT_List_Message_38", %TName_List_Message* %"$msgs1_147"), !dbg !16
  ret void
}
...
define void @SendMsg(i8* %0) !dbg !17 {
entry:
  ...
  call void @"$SendMsg_86"(%Uint128 %_amount, [20 x i8]* %"$_sender_152"), !dbg !18
  ret void
}

define internal void @"$SendMsg2_153"(%Uint128 %_amount, [20 x i8]* %"$_sender_154") !dbg !19 {
entry:
...
"$have_gas_163":                                  ; preds = %"$out_of_gas_162", %"$have_gas_158"
  ...
  store i8* %"$msgobj_165", i8** %msg1, align 8, !dbg !20
...
"$have_gas_197":                                  ; preds = %"$out_of_gas_196", %"$have_gas_192"
  ...
  store i8* %"$msgobj_199", i8** %msg2, align 8, !dbg !21
...
"$have_gas_231":                                  ; preds = %"$out_of_gas_230", %"$have_gas_226"
  ...
  %"$send.one_msg_call_237" = call %TName_List_Message* %"$send.one_msg_fptr_234"(i8* %"$send.one_msg_envptr_235", i8* %"$msg1_236"), !dbg !22
  store %TName_List_Message* %"$send.one_msg_call_237", %TName_List_Message** %"$send.one_msg_1", align 8, !dbg !22
  %"$$send.one_msg_1_238" = load %TName_List_Message*, %TName_List_Message** %"$send.one_msg_1", align 8
  store %TName_List_Message* %"$$send.one_msg_1_238", %TName_List_Message** %msgs1, align 8, !dbg !22
...
"$have_gas_247":                                  ; preds = %"$out_of_gas_246", %"$have_gas_242"
  ...
  store %TName_List_Message* %"$adtptr_255", %TName_List_Message** %msgs2, align 8, !dbg !23
...
"$have_gas_262":                                  ; preds = %"$out_of_gas_261", %"$have_gas_247"
  ...
  call void @_send(i8* %"$execptr_load_264", %_TyDescrTy_Typ* @"$TyDescr_ADT_List_Message_38", %TName_List_Message* %"$msgs2_265"), !dbg !24
  ret void
}

define void @SendMsg2(i8* %0) !dbg !25 {
entry:
  ...
  call void @"$SendMsg2_153"(%Uint128 %_amount, [20 x i8]* %"$_sender_270"), !dbg !26
  ret void
}
...
!13 = distinct !DISubprogram(name: "SendMsg", linkageName: "SendMsg", scope: !2, file: !2, line: 13, type: !5, scopeLine: 13, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !1, retainedNodes: !3)
!14 = !DILocation(line: 14, column: 10, scope: !13)
!15 = !DILocation(line: 15, column: 11, scope: !13)
!16 = !DILocation(line: 16, column: 3, scope: !13)
!17 = distinct !DISubprogram(name: "SendMsg", linkageName: "SendMsg", scope: !2, file: !2, line: 13, type: !5, scopeLine: 13, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !1, retainedNodes: !3)
!18 = !DILocation(line: 13, column: 12, scope: !17)
!19 = distinct !DISubprogram(name: "SendMsg2", linkageName: "SendMsg2", scope: !2, file: !2, line: 19, type: !5, scopeLine: 19, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !1, retainedNodes: !3)
!20 = !DILocation(line: 20, column: 10, scope: !19)
!21 = !DILocation(line: 21, column: 10, scope: !19)
!22 = !DILocation(line: 22, column: 11, scope: !19)
!23 = !DILocation(line: 23, column: 11, scope: !19)
!24 = !DILocation(line: 24, column: 3, scope: !19)
!25 = distinct !DISubprogram(name: "SendMsg2", linkageName: "SendMsg2", scope: !2, file: !2, line: 19, type: !5, scopeLine: 19, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !1, retainedNodes: !3)
!26 = !DILocation(line: 19, column: 12, scope: !25)
