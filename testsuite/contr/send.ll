...
"$have_gas_93":                                   ; preds = %"$out_of_gas_92", %"$have_gas_88"
  ...
  store { %TName_List_Message* (i8*, i8*)*, i8* } { %TName_List_Message* (i8*, i8*)* bitcast (%TName_List_Message* (%"$$fundef_3_env_59"*, i8*)* @"$fundef_3" to %TName_List_Message* (i8*, i8*)*), i8* null }, { %TName_List_Message* (i8*, i8*)*, i8* }* @send.one_msg, align 8
  ret void
}
...
define internal void @"$SendMsg_103"(%Uint128 %_amount, [20 x i8]* %"$_origin_104", [20 x i8]* %"$_sender_105") {
entry:
...
"$have_gas_114":                                  ; preds = %"$out_of_gas_113", %"$have_gas_109"
  ...
  store i8* %"$msgobj_116", i8** %msg1, align 8
...
"$have_gas_148":                                  ; preds = %"$out_of_gas_147", %"$have_gas_143"
  ...
  %"$send.one_msg_call_154" = call %TName_List_Message* %"$send.one_msg_fptr_151"(i8* %"$send.one_msg_envptr_152", i8* %"$msg1_153")
  store %TName_List_Message* %"$send.one_msg_call_154", %TName_List_Message** %"$send.one_msg_1", align 8
  %"$$send.one_msg_1_155" = load %TName_List_Message*, %TName_List_Message** %"$send.one_msg_1", align 8
  store %TName_List_Message* %"$$send.one_msg_1_155", %TName_List_Message** %msgs1, align 8
...
"$have_gas_162":                                  ; preds = %"$out_of_gas_161", %"$have_gas_148"
  ...
  call void @_send(i8* %"$execptr_load_164", %_TyDescrTy_Typ* @"$TyDescr_ADT_List_Message_41", %TName_List_Message* %"$msgs1_165")
  ret void
}
...
entry:
  ...
  call void @"$SendMsg_103"(%Uint128 %_amount, [20 x i8]* %"$_origin_170", [20 x i8]* %"$_sender_172")
  ret void
}

define internal void @"$SendMsg2_173"(%Uint128 %_amount, [20 x i8]* %"$_origin_174", [20 x i8]* %"$_sender_175") {
entry:
...
"$have_gas_184":                                  ; preds = %"$out_of_gas_183", %"$have_gas_179"
  ...
  store i8* %"$msgobj_186", i8** %msg1, align 8
...
"$have_gas_218":                                  ; preds = %"$out_of_gas_217", %"$have_gas_213"
  ...
  store i8* %"$msgobj_220", i8** %msg2, align 8
...
"$have_gas_252":                                  ; preds = %"$out_of_gas_251", %"$have_gas_247"
  ...
  %"$send.one_msg_call_258" = call %TName_List_Message* %"$send.one_msg_fptr_255"(i8* %"$send.one_msg_envptr_256", i8* %"$msg1_257")
  store %TName_List_Message* %"$send.one_msg_call_258", %TName_List_Message** %"$send.one_msg_2", align 8
  %"$$send.one_msg_2_259" = load %TName_List_Message*, %TName_List_Message** %"$send.one_msg_2", align 8
  store %TName_List_Message* %"$$send.one_msg_2_259", %TName_List_Message** %msgs1, align 8
...
"$have_gas_268":                                  ; preds = %"$out_of_gas_267", %"$have_gas_263"
  ...
  store %TName_List_Message* %"$adtptr_276", %TName_List_Message** %msgs2, align 8
...
"$have_gas_283":                                  ; preds = %"$out_of_gas_282", %"$have_gas_268"
  ...
  call void @_send(i8* %"$execptr_load_285", %_TyDescrTy_Typ* @"$TyDescr_ADT_List_Message_41", %TName_List_Message* %"$msgs2_286")
  ret void
}
...
entry:
  ...
  call void @"$SendMsg2_173"(%Uint128 %_amount, [20 x i8]* %"$_origin_291", [20 x i8]* %"$_sender_293")
  ret void
}
