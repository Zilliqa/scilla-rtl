...
define internal void @"$ThrowEmpty_58"(%Uint128 %_amount, [20 x i8]* %"$_origin_59", [20 x i8]* %"$_sender_60") {
entry:
...
"$have_gas_64":                                   ; preds = %"$out_of_gas_63", %entry
  ...
  call void @_throw(i8* %"$execptr_load_66", %_TyDescrTy_Typ* @"$TyDescr_Exception_28", i8* null)
  ret void
}
...
entry:
  ...
  call void @"$ThrowEmpty_58"(%Uint128 %_amount, [20 x i8]* %"$_origin_71", [20 x i8]* %"$_sender_73")
  ret void
}

define internal void @"$ThrowObj_74"(%Uint128 %_amount, [20 x i8]* %"$_origin_75", [20 x i8]* %"$_sender_76") {
entry:
...
"$have_gas_85":                                   ; preds = %"$out_of_gas_84", %"$have_gas_80"
  ...
  store i8* %"$msgobj_87", i8** %t, align 8
...
"$have_gas_103":                                  ; preds = %"$out_of_gas_102", %"$have_gas_85"
  ...
  call void @_throw(i8* %"$execptr_load_105", %_TyDescrTy_Typ* @"$TyDescr_Exception_28", i8* %"$t_106")
  ret void
}
...
entry:
  ...
  call void @"$ThrowObj_74"(%Uint128 %_amount, [20 x i8]* %"$_origin_111", [20 x i8]* %"$_sender_113")
  ret void
}
