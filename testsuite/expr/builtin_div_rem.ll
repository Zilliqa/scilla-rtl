...
define internal %TName_Bool* @"$fundef_77"(%"$$fundef_77_env_128"* %0, %TName_Bool* %1) {
entry:
...
"$have_gas_158":                                  ; preds = %"$out_of_gas_157", %"$False_153"
  ...
  store %TName_Bool* %"$adtptr_162", %TName_Bool** %"$retval_78", align 8
...
define internal { %TName_Bool* (i8*, %TName_Bool*)*, i8* } @"$fundef_75"(%"$$fundef_75_env_129"* %0, %TName_Bool* %1) {
entry:
...
"$have_gas_133":                                  ; preds = %"$out_of_gas_132", %entry
  ...
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$$fundef_77_cloval_138", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$retval_76", align 8
...
"$have_gas_174":                                  ; preds = %"$out_of_gas_173", %entry
  ...
  store { { %TName_Bool* (i8*, %TName_Bool*)*, i8* } (i8*, %TName_Bool*)*, i8* } { { %TName_Bool* (i8*, %TName_Bool*)*, i8* } (i8*, %TName_Bool*)* bitcast ({ %TName_Bool* (i8*, %TName_Bool*)*, i8* } (%"$$fundef_75_env_129"*, %TName_Bool*)* @"$fundef_75" to { %TName_Bool* (i8*, %TName_Bool*)*, i8* } (i8*, %TName_Bool*)*), i8* null }, { { %TName_Bool* (i8*, %TName_Bool*)*, i8* } (i8*, %TName_Bool*)*, i8* }* @BoolUtils.andb, align 8
  ret void
}
...
"$have_gas_192":                                  ; preds = %"$out_of_gas_191", %"$have_gas_187"
  ...
  store %TName_Bool* %"$adtptr_196", %TName_Bool** %test, align 8
...
"$have_gas_225":                                  ; preds = %"$out_of_gas_224", %"$have_gas_220"
  ...
  %"$div_call_229" = call %Uint32 @_div_Uint32(%Uint32 %"$arg1_227", %Uint32 %"$arg2_228")
  store %Uint32 %"$div_call_229", %Uint32* %res, align 4
...
"$have_gas_243":                                  ; preds = %"$out_of_gas_242", %"$have_gas_238"
  ...
  %"$eq_call_248" = call %TName_Bool* @_eq_Uint32(i8* %"$execptr_load_245", %Uint32 %"$res_246", %Uint32 %"$res__247")
  store %TName_Bool* %"$eq_call_248", %TName_Bool** %test_, align 8
...
"$have_gas_253":                                  ; preds = %"$out_of_gas_252", %"$have_gas_243"
  ...
  %"$BoolUtils.andb_call_259" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_fptr_256"(i8* %"$BoolUtils.andb_envptr_257", %TName_Bool* %"$test_258")
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_call_259", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.andb_55", align 8
  ...
  %"$$BoolUtils.andb_55_call_264" = call %TName_Bool* %"$$BoolUtils.andb_55_fptr_261"(i8* %"$$BoolUtils.andb_55_envptr_262", %TName_Bool* %"$test__263")
  store %TName_Bool* %"$$BoolUtils.andb_55_call_264", %TName_Bool** %"$BoolUtils.andb_56", align 8
  %"$$BoolUtils.andb_56_265" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.andb_56", align 8
  store %TName_Bool* %"$$BoolUtils.andb_56_265", %TName_Bool** %"$test_0", align 8
...
"$have_gas_274":                                  ; preds = %"$out_of_gas_273", %"$have_gas_269"
  ...
  store %Uint32 { i32 1844 }, %Uint32* %"$arg1_1", align 4
...
"$have_gas_284":                                  ; preds = %"$out_of_gas_283", %"$have_gas_279"
  ...
  store %Uint32 { i32 1843 }, %Uint32* %"$arg2_2", align 4
...
"$have_gas_294":                                  ; preds = %"$out_of_gas_293", %"$have_gas_289"
  ...
  %"$rem_call_298" = call %Uint32 @_rem_Uint32(%Uint32 %"$$arg1_1_296", %Uint32 %"$$arg2_2_297")
  store %Uint32 %"$rem_call_298", %Uint32* %"$res_3", align 4
...
"$have_gas_307":                                  ; preds = %"$out_of_gas_306", %"$have_gas_302"
  ...
  store %Uint32 { i32 1 }, %Uint32* %"$res__4", align 4
...
"$have_gas_312":                                  ; preds = %"$out_of_gas_311", %"$have_gas_307"
  ...
  %"$eq_call_317" = call %TName_Bool* @_eq_Uint32(i8* %"$execptr_load_314", %Uint32 %"$$res_3_315", %Uint32 %"$$res__4_316")
  store %TName_Bool* %"$eq_call_317", %TName_Bool** %"$test__5", align 8
...
"$have_gas_322":                                  ; preds = %"$out_of_gas_321", %"$have_gas_312"
  ...
  %"$BoolUtils.andb_call_328" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_fptr_325"(i8* %"$BoolUtils.andb_envptr_326", %TName_Bool* %"$$test_0_327")
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_call_328", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.andb_57", align 8
  ...
  %"$$BoolUtils.andb_57_call_333" = call %TName_Bool* %"$$BoolUtils.andb_57_fptr_330"(i8* %"$$BoolUtils.andb_57_envptr_331", %TName_Bool* %"$$test__5_332")
  store %TName_Bool* %"$$BoolUtils.andb_57_call_333", %TName_Bool** %"$BoolUtils.andb_58", align 8
  %"$$BoolUtils.andb_58_334" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.andb_58", align 8
  store %TName_Bool* %"$$BoolUtils.andb_58_334", %TName_Bool** %"$test_6", align 8
...
"$have_gas_353":                                  ; preds = %"$out_of_gas_352", %"$have_gas_348"
  ...
  store %Uint32 { i32 1845 }, %Uint32* %"$arg2_8", align 4
...
"$have_gas_363":                                  ; preds = %"$out_of_gas_362", %"$have_gas_358"
  ...
  %"$div_call_367" = call %Uint32 @_div_Uint32(%Uint32 %"$$arg1_7_365", %Uint32 %"$$arg2_8_366")
  store %Uint32 %"$div_call_367", %Uint32* %"$res_9", align 4
...
"$have_gas_376":                                  ; preds = %"$out_of_gas_375", %"$have_gas_371"
  ...
  store %Uint32 zeroinitializer, %Uint32* %"$res__10", align 4
...
"$have_gas_381":                                  ; preds = %"$out_of_gas_380", %"$have_gas_376"
  ...
  %"$eq_call_386" = call %TName_Bool* @_eq_Uint32(i8* %"$execptr_load_383", %Uint32 %"$$res_9_384", %Uint32 %"$$res__10_385")
  store %TName_Bool* %"$eq_call_386", %TName_Bool** %"$test__11", align 8
...
"$have_gas_391":                                  ; preds = %"$out_of_gas_390", %"$have_gas_381"
  ...
  %"$BoolUtils.andb_call_397" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_fptr_394"(i8* %"$BoolUtils.andb_envptr_395", %TName_Bool* %"$$test_6_396")
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_call_397", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.andb_59", align 8
  ...
  %"$$BoolUtils.andb_59_call_402" = call %TName_Bool* %"$$BoolUtils.andb_59_fptr_399"(i8* %"$$BoolUtils.andb_59_envptr_400", %TName_Bool* %"$$test__11_401")
  store %TName_Bool* %"$$BoolUtils.andb_59_call_402", %TName_Bool** %"$BoolUtils.andb_60", align 8
  %"$$BoolUtils.andb_60_403" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.andb_60", align 8
  store %TName_Bool* %"$$BoolUtils.andb_60_403", %TName_Bool** %"$test_12", align 8
...
"$have_gas_412":                                  ; preds = %"$out_of_gas_411", %"$have_gas_407"
  ...
  store %Int32 { i32 1844 }, %Int32* %"$arg1_13", align 4
...
"$have_gas_422":                                  ; preds = %"$out_of_gas_421", %"$have_gas_417"
  ...
  store %Int32 { i32 -1843 }, %Int32* %"$arg2_14", align 4
...
"$have_gas_432":                                  ; preds = %"$out_of_gas_431", %"$have_gas_427"
  ...
  %"$div_call_436" = call %Int32 @_div_Int32(%Int32 %"$$arg1_13_434", %Int32 %"$$arg2_14_435")
  store %Int32 %"$div_call_436", %Int32* %"$res_15", align 4
...
"$have_gas_445":                                  ; preds = %"$out_of_gas_444", %"$have_gas_440"
  ...
  store %Int32 { i32 -1 }, %Int32* %"$res__16", align 4
...
"$have_gas_450":                                  ; preds = %"$out_of_gas_449", %"$have_gas_445"
  ...
  %"$eq_call_455" = call %TName_Bool* @_eq_Int32(i8* %"$execptr_load_452", %Int32 %"$$res_15_453", %Int32 %"$$res__16_454")
  store %TName_Bool* %"$eq_call_455", %TName_Bool** %"$test__17", align 8
...
"$have_gas_460":                                  ; preds = %"$out_of_gas_459", %"$have_gas_450"
  ...
  %"$BoolUtils.andb_call_466" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_fptr_463"(i8* %"$BoolUtils.andb_envptr_464", %TName_Bool* %"$$test_12_465")
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_call_466", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.andb_61", align 8
  ...
  %"$$BoolUtils.andb_61_call_471" = call %TName_Bool* %"$$BoolUtils.andb_61_fptr_468"(i8* %"$$BoolUtils.andb_61_envptr_469", %TName_Bool* %"$$test__17_470")
  store %TName_Bool* %"$$BoolUtils.andb_61_call_471", %TName_Bool** %"$BoolUtils.andb_62", align 8
  %"$$BoolUtils.andb_62_472" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.andb_62", align 8
  store %TName_Bool* %"$$BoolUtils.andb_62_472", %TName_Bool** %"$test_18", align 8
...
"$have_gas_481":                                  ; preds = %"$out_of_gas_480", %"$have_gas_476"
  ...
  store %Int32 zeroinitializer, %Int32* %"$arg1_19", align 4
...
"$have_gas_501":                                  ; preds = %"$out_of_gas_500", %"$have_gas_496"
  ...
  %"$div_call_505" = call %Int32 @_div_Int32(%Int32 %"$$arg1_19_503", %Int32 %"$$arg2_20_504")
  store %Int32 %"$div_call_505", %Int32* %"$res_21", align 4
...
"$have_gas_514":                                  ; preds = %"$out_of_gas_513", %"$have_gas_509"
  ...
  store %Int32 zeroinitializer, %Int32* %"$res__22", align 4
...
"$have_gas_519":                                  ; preds = %"$out_of_gas_518", %"$have_gas_514"
  ...
  %"$eq_call_524" = call %TName_Bool* @_eq_Int32(i8* %"$execptr_load_521", %Int32 %"$$res_21_522", %Int32 %"$$res__22_523")
  store %TName_Bool* %"$eq_call_524", %TName_Bool** %"$test__23", align 8
...
"$have_gas_529":                                  ; preds = %"$out_of_gas_528", %"$have_gas_519"
  ...
  %"$BoolUtils.andb_call_535" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_fptr_532"(i8* %"$BoolUtils.andb_envptr_533", %TName_Bool* %"$$test_18_534")
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_call_535", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.andb_63", align 8
  ...
  %"$$BoolUtils.andb_63_call_540" = call %TName_Bool* %"$$BoolUtils.andb_63_fptr_537"(i8* %"$$BoolUtils.andb_63_envptr_538", %TName_Bool* %"$$test__23_539")
  store %TName_Bool* %"$$BoolUtils.andb_63_call_540", %TName_Bool** %"$BoolUtils.andb_64", align 8
  %"$$BoolUtils.andb_64_541" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.andb_64", align 8
  store %TName_Bool* %"$$BoolUtils.andb_64_541", %TName_Bool** %"$test_24", align 8
...
"$have_gas_550":                                  ; preds = %"$out_of_gas_549", %"$have_gas_545"
  ...
  store %Uint256 { i256 1844 }, %Uint256* %"$arg1_25", align 8
...
"$have_gas_560":                                  ; preds = %"$out_of_gas_559", %"$have_gas_555"
  ...
  store %Uint256 { i256 1843 }, %Uint256* %"$arg2_26", align 8
...
"$have_gas_570":                                  ; preds = %"$out_of_gas_569", %"$have_gas_565"
  ...
  %"$div_call_577" = call %Uint256* @_div_Uint256(i8* %"$execptr_load_572", %Uint256* %"$div_$arg1_25_573", %Uint256* %"$div_$arg2_26_575")
  %"$div_579" = load %Uint256, %Uint256* %"$div_call_577", align 8
  store %Uint256 %"$div_579", %Uint256* %"$res_27", align 8
...
"$have_gas_588":                                  ; preds = %"$out_of_gas_587", %"$have_gas_583"
  ...
  store %Uint256 { i256 1 }, %Uint256* %"$res__28", align 8
...
"$have_gas_593":                                  ; preds = %"$out_of_gas_592", %"$have_gas_588"
  ...
  %"$eq_call_600" = call %TName_Bool* @_eq_Uint256(i8* %"$execptr_load_595", %Uint256* %"$eq_$res_27_596", %Uint256* %"$eq_$res__28_598")
  store %TName_Bool* %"$eq_call_600", %TName_Bool** %"$test__29", align 8
...
"$have_gas_605":                                  ; preds = %"$out_of_gas_604", %"$have_gas_593"
  ...
  %"$BoolUtils.andb_call_611" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_fptr_608"(i8* %"$BoolUtils.andb_envptr_609", %TName_Bool* %"$$test_24_610")
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_call_611", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.andb_65", align 8
  ...
  %"$$BoolUtils.andb_65_call_616" = call %TName_Bool* %"$$BoolUtils.andb_65_fptr_613"(i8* %"$$BoolUtils.andb_65_envptr_614", %TName_Bool* %"$$test__29_615")
  store %TName_Bool* %"$$BoolUtils.andb_65_call_616", %TName_Bool** %"$BoolUtils.andb_66", align 8
  %"$$BoolUtils.andb_66_617" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.andb_66", align 8
  store %TName_Bool* %"$$BoolUtils.andb_66_617", %TName_Bool** %"$test_30", align 8
...
"$have_gas_646":                                  ; preds = %"$out_of_gas_645", %"$have_gas_641"
  ...
  %"$rem_call_653" = call %Uint256* @_rem_Uint256(i8* %"$execptr_load_648", %Uint256* %"$rem_$arg1_31_649", %Uint256* %"$rem_$arg2_32_651")
  %"$rem_655" = load %Uint256, %Uint256* %"$rem_call_653", align 8
  store %Uint256 %"$rem_655", %Uint256* %"$res_33", align 8
...
"$have_gas_669":                                  ; preds = %"$out_of_gas_668", %"$have_gas_664"
  ...
  %"$eq_call_676" = call %TName_Bool* @_eq_Uint256(i8* %"$execptr_load_671", %Uint256* %"$eq_$res_33_672", %Uint256* %"$eq_$res__34_674")
  store %TName_Bool* %"$eq_call_676", %TName_Bool** %"$test__35", align 8
...
"$have_gas_681":                                  ; preds = %"$out_of_gas_680", %"$have_gas_669"
  ...
  %"$BoolUtils.andb_call_687" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_fptr_684"(i8* %"$BoolUtils.andb_envptr_685", %TName_Bool* %"$$test_30_686")
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_call_687", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.andb_67", align 8
  ...
  %"$$BoolUtils.andb_67_call_692" = call %TName_Bool* %"$$BoolUtils.andb_67_fptr_689"(i8* %"$$BoolUtils.andb_67_envptr_690", %TName_Bool* %"$$test__35_691")
  store %TName_Bool* %"$$BoolUtils.andb_67_call_692", %TName_Bool** %"$BoolUtils.andb_68", align 8
  %"$$BoolUtils.andb_68_693" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.andb_68", align 8
  store %TName_Bool* %"$$BoolUtils.andb_68_693", %TName_Bool** %"$test_36", align 8
...
"$have_gas_712":                                  ; preds = %"$out_of_gas_711", %"$have_gas_707"
  ...
  store %Uint256 { i256 1845 }, %Uint256* %"$arg2_38", align 8
...
"$have_gas_722":                                  ; preds = %"$out_of_gas_721", %"$have_gas_717"
  ...
  %"$div_call_729" = call %Uint256* @_div_Uint256(i8* %"$execptr_load_724", %Uint256* %"$div_$arg1_37_725", %Uint256* %"$div_$arg2_38_727")
  %"$div_731" = load %Uint256, %Uint256* %"$div_call_729", align 8
  store %Uint256 %"$div_731", %Uint256* %"$res_39", align 8
...
"$have_gas_740":                                  ; preds = %"$out_of_gas_739", %"$have_gas_735"
  ...
  store %Uint256 zeroinitializer, %Uint256* %"$res__40", align 8
...
"$have_gas_745":                                  ; preds = %"$out_of_gas_744", %"$have_gas_740"
  ...
  %"$eq_call_752" = call %TName_Bool* @_eq_Uint256(i8* %"$execptr_load_747", %Uint256* %"$eq_$res_39_748", %Uint256* %"$eq_$res__40_750")
  store %TName_Bool* %"$eq_call_752", %TName_Bool** %"$test__41", align 8
...
"$have_gas_757":                                  ; preds = %"$out_of_gas_756", %"$have_gas_745"
  ...
  %"$BoolUtils.andb_call_763" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_fptr_760"(i8* %"$BoolUtils.andb_envptr_761", %TName_Bool* %"$$test_36_762")
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_call_763", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.andb_69", align 8
  ...
  %"$$BoolUtils.andb_69_call_768" = call %TName_Bool* %"$$BoolUtils.andb_69_fptr_765"(i8* %"$$BoolUtils.andb_69_envptr_766", %TName_Bool* %"$$test__41_767")
  store %TName_Bool* %"$$BoolUtils.andb_69_call_768", %TName_Bool** %"$BoolUtils.andb_70", align 8
  %"$$BoolUtils.andb_70_769" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.andb_70", align 8
  store %TName_Bool* %"$$BoolUtils.andb_70_769", %TName_Bool** %"$test_42", align 8
...
"$have_gas_778":                                  ; preds = %"$out_of_gas_777", %"$have_gas_773"
  ...
  store %Int256 { i256 1844 }, %Int256* %"$arg1_43", align 8
...
"$have_gas_788":                                  ; preds = %"$out_of_gas_787", %"$have_gas_783"
  ...
  store %Int256 { i256 -1843 }, %Int256* %"$arg2_44", align 8
...
"$have_gas_798":                                  ; preds = %"$out_of_gas_797", %"$have_gas_793"
  ...
  %"$div_call_805" = call %Int256* @_div_Int256(i8* %"$execptr_load_800", %Int256* %"$div_$arg1_43_801", %Int256* %"$div_$arg2_44_803")
  %"$div_807" = load %Int256, %Int256* %"$div_call_805", align 8
  store %Int256 %"$div_807", %Int256* %"$res_45", align 8
...
"$have_gas_816":                                  ; preds = %"$out_of_gas_815", %"$have_gas_811"
  ...
  store %Int256 { i256 -1 }, %Int256* %"$res__46", align 8
...
"$have_gas_821":                                  ; preds = %"$out_of_gas_820", %"$have_gas_816"
  ...
  %"$eq_call_828" = call %TName_Bool* @_eq_Int256(i8* %"$execptr_load_823", %Int256* %"$eq_$res_45_824", %Int256* %"$eq_$res__46_826")
  store %TName_Bool* %"$eq_call_828", %TName_Bool** %"$test__47", align 8
...
"$have_gas_833":                                  ; preds = %"$out_of_gas_832", %"$have_gas_821"
  ...
  %"$BoolUtils.andb_call_839" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_fptr_836"(i8* %"$BoolUtils.andb_envptr_837", %TName_Bool* %"$$test_42_838")
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_call_839", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.andb_71", align 8
  ...
  %"$$BoolUtils.andb_71_call_844" = call %TName_Bool* %"$$BoolUtils.andb_71_fptr_841"(i8* %"$$BoolUtils.andb_71_envptr_842", %TName_Bool* %"$$test__47_843")
  store %TName_Bool* %"$$BoolUtils.andb_71_call_844", %TName_Bool** %"$BoolUtils.andb_72", align 8
  %"$$BoolUtils.andb_72_845" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.andb_72", align 8
  store %TName_Bool* %"$$BoolUtils.andb_72_845", %TName_Bool** %"$test_48", align 8
...
"$have_gas_854":                                  ; preds = %"$out_of_gas_853", %"$have_gas_849"
  ...
  store %Int256 zeroinitializer, %Int256* %"$arg1_49", align 8
...
"$have_gas_874":                                  ; preds = %"$out_of_gas_873", %"$have_gas_869"
  ...
  %"$div_call_881" = call %Int256* @_div_Int256(i8* %"$execptr_load_876", %Int256* %"$div_$arg1_49_877", %Int256* %"$div_$arg2_50_879")
  %"$div_883" = load %Int256, %Int256* %"$div_call_881", align 8
  store %Int256 %"$div_883", %Int256* %"$res_51", align 8
...
"$have_gas_897":                                  ; preds = %"$out_of_gas_896", %"$have_gas_892"
  ...
  %"$eq_call_904" = call %TName_Bool* @_eq_Int256(i8* %"$execptr_load_899", %Int256* %"$eq_$res_51_900", %Int256* %"$eq_$res__52_902")
  store %TName_Bool* %"$eq_call_904", %TName_Bool** %"$test__53", align 8
...
"$have_gas_909":                                  ; preds = %"$out_of_gas_908", %"$have_gas_897"
  ...
  %"$BoolUtils.andb_call_915" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_fptr_912"(i8* %"$BoolUtils.andb_envptr_913", %TName_Bool* %"$$test_48_914")
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_call_915", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.andb_73", align 8
  ...
  %"$$BoolUtils.andb_73_call_920" = call %TName_Bool* %"$$BoolUtils.andb_73_fptr_917"(i8* %"$$BoolUtils.andb_73_envptr_918", %TName_Bool* %"$$test__53_919")
  store %TName_Bool* %"$$BoolUtils.andb_73_call_920", %TName_Bool** %"$BoolUtils.andb_74", align 8
  %"$$BoolUtils.andb_74_921" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.andb_74", align 8
  store %TName_Bool* %"$$BoolUtils.andb_74_921", %TName_Bool** %"$test_54", align 8
...
"$have_gas_925":                                  ; preds = %"$out_of_gas_924", %"$have_gas_909"
  ...
  store %TName_Bool* %"$$test_54_927", %TName_Bool** %"$expr_79", align 8
