...
define internal %TName_Bool* @"$fundef_83"(%"$$fundef_83_env_134"* %0, %TName_Bool* %1) {
entry:
...
"$have_gas_164":                                  ; preds = %"$out_of_gas_163", %"$False_159"
  ...
  store %TName_Bool* %"$adtptr_168", %TName_Bool** %"$retval_84", align 8
...
define internal { %TName_Bool* (i8*, %TName_Bool*)*, i8* } @"$fundef_81"(%"$$fundef_81_env_135"* %0, %TName_Bool* %1) {
entry:
...
"$have_gas_139":                                  ; preds = %"$out_of_gas_138", %entry
  ...
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$$fundef_83_cloval_144", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$retval_82", align 8
...
"$have_gas_190":                                  ; preds = %"$out_of_gas_189", %"$have_gas_185"
  ...
  store { { %TName_Bool* (i8*, %TName_Bool*)*, i8* } (i8*, %TName_Bool*)*, i8* } { { %TName_Bool* (i8*, %TName_Bool*)*, i8* } (i8*, %TName_Bool*)* bitcast ({ %TName_Bool* (i8*, %TName_Bool*)*, i8* } (%"$$fundef_81_env_135"*, %TName_Bool*)* @"$fundef_81" to { %TName_Bool* (i8*, %TName_Bool*)*, i8* } (i8*, %TName_Bool*)*), i8* null }, { { %TName_Bool* (i8*, %TName_Bool*)*, i8* } (i8*, %TName_Bool*)*, i8* }* @BoolUtils.andb, align 8
...
"$have_gas_271":                                  ; preds = %"$out_of_gas_270", %"$have_gas_266"
  ...
  %"$div_call_275" = call %Uint32 @_div_Uint32(%Uint32 %"$arg1_273", %Uint32 %"$arg2_274")
  store %Uint32 %"$div_call_275", %Uint32* %res, align 4
...
"$have_gas_294":                                  ; preds = %"$out_of_gas_293", %"$have_gas_289"
  ...
  %"$eq_call_299" = call %TName_Bool* @_eq_Uint32(i8* %"$execptr_load_296", %Uint32 %"$res_297", %Uint32 %"$res__298")
  store %TName_Bool* %"$eq_call_299", %TName_Bool** %test_, align 8
...
"$have_gas_304":                                  ; preds = %"$out_of_gas_303", %"$have_gas_294"
  ...
  %"$BoolUtils.andb_call_310" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_fptr_307"(i8* %"$BoolUtils.andb_envptr_308", %TName_Bool* %"$test_309")
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_call_310", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.andb_61", align 8
  ...
  %"$$BoolUtils.andb_61_call_315" = call %TName_Bool* %"$$BoolUtils.andb_61_fptr_312"(i8* %"$$BoolUtils.andb_61_envptr_313", %TName_Bool* %"$test__314")
  store %TName_Bool* %"$$BoolUtils.andb_61_call_315", %TName_Bool** %"$BoolUtils.andb_62", align 8
  %"$$BoolUtils.andb_62_316" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.andb_62", align 8
  store %TName_Bool* %"$$BoolUtils.andb_62_316", %TName_Bool** %"$test_6", align 8
...
"$have_gas_350":                                  ; preds = %"$out_of_gas_349", %"$have_gas_345"
  ...
  %"$rem_call_354" = call %Uint32 @_rem_Uint32(%Uint32 %"$$arg1_7_352", %Uint32 %"$$arg2_8_353")
  store %Uint32 %"$rem_call_354", %Uint32* %"$res_9", align 4
...
"$have_gas_373":                                  ; preds = %"$out_of_gas_372", %"$have_gas_368"
  ...
  %"$eq_call_378" = call %TName_Bool* @_eq_Uint32(i8* %"$execptr_load_375", %Uint32 %"$$res_9_376", %Uint32 %"$$res__10_377")
  store %TName_Bool* %"$eq_call_378", %TName_Bool** %"$test__11", align 8
...
"$have_gas_383":                                  ; preds = %"$out_of_gas_382", %"$have_gas_373"
  ...
  %"$BoolUtils.andb_call_389" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_fptr_386"(i8* %"$BoolUtils.andb_envptr_387", %TName_Bool* %"$$test_6_388")
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_call_389", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.andb_63", align 8
  ...
  %"$$BoolUtils.andb_63_call_394" = call %TName_Bool* %"$$BoolUtils.andb_63_fptr_391"(i8* %"$$BoolUtils.andb_63_envptr_392", %TName_Bool* %"$$test__11_393")
  store %TName_Bool* %"$$BoolUtils.andb_63_call_394", %TName_Bool** %"$BoolUtils.andb_64", align 8
  %"$$BoolUtils.andb_64_395" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.andb_64", align 8
  store %TName_Bool* %"$$BoolUtils.andb_64_395", %TName_Bool** %"$test_12", align 8
...
"$have_gas_429":                                  ; preds = %"$out_of_gas_428", %"$have_gas_424"
  ...
  %"$div_call_433" = call %Uint32 @_div_Uint32(%Uint32 %"$$arg1_13_431", %Uint32 %"$$arg2_14_432")
  store %Uint32 %"$div_call_433", %Uint32* %"$res_15", align 4
...
"$have_gas_452":                                  ; preds = %"$out_of_gas_451", %"$have_gas_447"
  ...
  %"$eq_call_457" = call %TName_Bool* @_eq_Uint32(i8* %"$execptr_load_454", %Uint32 %"$$res_15_455", %Uint32 %"$$res__16_456")
  store %TName_Bool* %"$eq_call_457", %TName_Bool** %"$test__17", align 8
...
"$have_gas_462":                                  ; preds = %"$out_of_gas_461", %"$have_gas_452"
  ...
  %"$BoolUtils.andb_call_468" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_fptr_465"(i8* %"$BoolUtils.andb_envptr_466", %TName_Bool* %"$$test_12_467")
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_call_468", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.andb_65", align 8
  ...
  %"$$BoolUtils.andb_65_call_473" = call %TName_Bool* %"$$BoolUtils.andb_65_fptr_470"(i8* %"$$BoolUtils.andb_65_envptr_471", %TName_Bool* %"$$test__17_472")
  store %TName_Bool* %"$$BoolUtils.andb_65_call_473", %TName_Bool** %"$BoolUtils.andb_66", align 8
  %"$$BoolUtils.andb_66_474" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.andb_66", align 8
  store %TName_Bool* %"$$BoolUtils.andb_66_474", %TName_Bool** %"$test_18", align 8
...
"$have_gas_508":                                  ; preds = %"$out_of_gas_507", %"$have_gas_503"
  ...
  %"$div_call_512" = call %Int32 @_div_Int32(%Int32 %"$$arg1_19_510", %Int32 %"$$arg2_20_511")
  store %Int32 %"$div_call_512", %Int32* %"$res_21", align 4
...
"$have_gas_531":                                  ; preds = %"$out_of_gas_530", %"$have_gas_526"
  ...
  %"$eq_call_536" = call %TName_Bool* @_eq_Int32(i8* %"$execptr_load_533", %Int32 %"$$res_21_534", %Int32 %"$$res__22_535")
  store %TName_Bool* %"$eq_call_536", %TName_Bool** %"$test__23", align 8
...
"$have_gas_541":                                  ; preds = %"$out_of_gas_540", %"$have_gas_531"
  ...
  %"$BoolUtils.andb_call_547" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_fptr_544"(i8* %"$BoolUtils.andb_envptr_545", %TName_Bool* %"$$test_18_546")
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_call_547", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.andb_67", align 8
  ...
  %"$$BoolUtils.andb_67_call_552" = call %TName_Bool* %"$$BoolUtils.andb_67_fptr_549"(i8* %"$$BoolUtils.andb_67_envptr_550", %TName_Bool* %"$$test__23_551")
  store %TName_Bool* %"$$BoolUtils.andb_67_call_552", %TName_Bool** %"$BoolUtils.andb_68", align 8
  %"$$BoolUtils.andb_68_553" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.andb_68", align 8
  store %TName_Bool* %"$$BoolUtils.andb_68_553", %TName_Bool** %"$test_24", align 8
...
"$have_gas_587":                                  ; preds = %"$out_of_gas_586", %"$have_gas_582"
  ...
  %"$div_call_591" = call %Int32 @_div_Int32(%Int32 %"$$arg1_25_589", %Int32 %"$$arg2_26_590")
  store %Int32 %"$div_call_591", %Int32* %"$res_27", align 4
...
"$have_gas_610":                                  ; preds = %"$out_of_gas_609", %"$have_gas_605"
  ...
  %"$eq_call_615" = call %TName_Bool* @_eq_Int32(i8* %"$execptr_load_612", %Int32 %"$$res_27_613", %Int32 %"$$res__28_614")
  store %TName_Bool* %"$eq_call_615", %TName_Bool** %"$test__29", align 8
...
"$have_gas_620":                                  ; preds = %"$out_of_gas_619", %"$have_gas_610"
  ...
  %"$BoolUtils.andb_call_626" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_fptr_623"(i8* %"$BoolUtils.andb_envptr_624", %TName_Bool* %"$$test_24_625")
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_call_626", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.andb_69", align 8
  ...
  %"$$BoolUtils.andb_69_call_631" = call %TName_Bool* %"$$BoolUtils.andb_69_fptr_628"(i8* %"$$BoolUtils.andb_69_envptr_629", %TName_Bool* %"$$test__29_630")
  store %TName_Bool* %"$$BoolUtils.andb_69_call_631", %TName_Bool** %"$BoolUtils.andb_70", align 8
  %"$$BoolUtils.andb_70_632" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.andb_70", align 8
  store %TName_Bool* %"$$BoolUtils.andb_70_632", %TName_Bool** %"$test_30", align 8
...
"$have_gas_667":                                  ; preds = %"$out_of_gas_666", %"$have_gas_661"
  ...
  %"$div_call_674" = call %Uint256* @_div_Uint256(i8* %"$execptr_load_669", %Uint256* %"$div_$arg1_31_670", %Uint256* %"$div_$arg2_32_672")
  %"$div_676" = load %Uint256, %Uint256* %"$div_call_674", align 8
  store %Uint256 %"$div_676", %Uint256* %"$res_33", align 8
...
"$have_gas_696":                                  ; preds = %"$out_of_gas_695", %"$have_gas_690"
  ...
  %"$eq_call_703" = call %TName_Bool* @_eq_Uint256(i8* %"$execptr_load_698", %Uint256* %"$eq_$res_33_699", %Uint256* %"$eq_$res__34_701")
  store %TName_Bool* %"$eq_call_703", %TName_Bool** %"$test__35", align 8
...
"$have_gas_708":                                  ; preds = %"$out_of_gas_707", %"$have_gas_696"
  ...
  %"$BoolUtils.andb_call_714" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_fptr_711"(i8* %"$BoolUtils.andb_envptr_712", %TName_Bool* %"$$test_30_713")
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_call_714", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.andb_71", align 8
  ...
  %"$$BoolUtils.andb_71_call_719" = call %TName_Bool* %"$$BoolUtils.andb_71_fptr_716"(i8* %"$$BoolUtils.andb_71_envptr_717", %TName_Bool* %"$$test__35_718")
  store %TName_Bool* %"$$BoolUtils.andb_71_call_719", %TName_Bool** %"$BoolUtils.andb_72", align 8
  %"$$BoolUtils.andb_72_720" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.andb_72", align 8
  store %TName_Bool* %"$$BoolUtils.andb_72_720", %TName_Bool** %"$test_36", align 8
...
"$have_gas_755":                                  ; preds = %"$out_of_gas_754", %"$have_gas_749"
  ...
  %"$rem_call_762" = call %Uint256* @_rem_Uint256(i8* %"$execptr_load_757", %Uint256* %"$rem_$arg1_37_758", %Uint256* %"$rem_$arg2_38_760")
  %"$rem_764" = load %Uint256, %Uint256* %"$rem_call_762", align 8
  store %Uint256 %"$rem_764", %Uint256* %"$res_39", align 8
...
"$have_gas_784":                                  ; preds = %"$out_of_gas_783", %"$have_gas_778"
  ...
  %"$eq_call_791" = call %TName_Bool* @_eq_Uint256(i8* %"$execptr_load_786", %Uint256* %"$eq_$res_39_787", %Uint256* %"$eq_$res__40_789")
  store %TName_Bool* %"$eq_call_791", %TName_Bool** %"$test__41", align 8
...
"$have_gas_796":                                  ; preds = %"$out_of_gas_795", %"$have_gas_784"
  ...
  %"$BoolUtils.andb_call_802" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_fptr_799"(i8* %"$BoolUtils.andb_envptr_800", %TName_Bool* %"$$test_36_801")
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_call_802", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.andb_73", align 8
  ...
  %"$$BoolUtils.andb_73_call_807" = call %TName_Bool* %"$$BoolUtils.andb_73_fptr_804"(i8* %"$$BoolUtils.andb_73_envptr_805", %TName_Bool* %"$$test__41_806")
  store %TName_Bool* %"$$BoolUtils.andb_73_call_807", %TName_Bool** %"$BoolUtils.andb_74", align 8
  %"$$BoolUtils.andb_74_808" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.andb_74", align 8
  store %TName_Bool* %"$$BoolUtils.andb_74_808", %TName_Bool** %"$test_42", align 8
...
"$have_gas_843":                                  ; preds = %"$out_of_gas_842", %"$have_gas_837"
  ...
  %"$div_call_850" = call %Uint256* @_div_Uint256(i8* %"$execptr_load_845", %Uint256* %"$div_$arg1_43_846", %Uint256* %"$div_$arg2_44_848")
  %"$div_852" = load %Uint256, %Uint256* %"$div_call_850", align 8
  store %Uint256 %"$div_852", %Uint256* %"$res_45", align 8
...
"$have_gas_872":                                  ; preds = %"$out_of_gas_871", %"$have_gas_866"
  ...
  %"$eq_call_879" = call %TName_Bool* @_eq_Uint256(i8* %"$execptr_load_874", %Uint256* %"$eq_$res_45_875", %Uint256* %"$eq_$res__46_877")
  store %TName_Bool* %"$eq_call_879", %TName_Bool** %"$test__47", align 8
...
"$have_gas_884":                                  ; preds = %"$out_of_gas_883", %"$have_gas_872"
  ...
  %"$BoolUtils.andb_call_890" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_fptr_887"(i8* %"$BoolUtils.andb_envptr_888", %TName_Bool* %"$$test_42_889")
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_call_890", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.andb_75", align 8
  ...
  %"$$BoolUtils.andb_75_call_895" = call %TName_Bool* %"$$BoolUtils.andb_75_fptr_892"(i8* %"$$BoolUtils.andb_75_envptr_893", %TName_Bool* %"$$test__47_894")
  store %TName_Bool* %"$$BoolUtils.andb_75_call_895", %TName_Bool** %"$BoolUtils.andb_76", align 8
  %"$$BoolUtils.andb_76_896" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.andb_76", align 8
  store %TName_Bool* %"$$BoolUtils.andb_76_896", %TName_Bool** %"$test_48", align 8
...
"$have_gas_931":                                  ; preds = %"$out_of_gas_930", %"$have_gas_925"
  ...
  %"$div_call_938" = call %Int256* @_div_Int256(i8* %"$execptr_load_933", %Int256* %"$div_$arg1_49_934", %Int256* %"$div_$arg2_50_936")
  %"$div_940" = load %Int256, %Int256* %"$div_call_938", align 8
  store %Int256 %"$div_940", %Int256* %"$res_51", align 8
...
"$have_gas_960":                                  ; preds = %"$out_of_gas_959", %"$have_gas_954"
  ...
  %"$eq_call_967" = call %TName_Bool* @_eq_Int256(i8* %"$execptr_load_962", %Int256* %"$eq_$res_51_963", %Int256* %"$eq_$res__52_965")
  store %TName_Bool* %"$eq_call_967", %TName_Bool** %"$test__53", align 8
...
"$have_gas_972":                                  ; preds = %"$out_of_gas_971", %"$have_gas_960"
  ...
  %"$BoolUtils.andb_call_978" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_fptr_975"(i8* %"$BoolUtils.andb_envptr_976", %TName_Bool* %"$$test_48_977")
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_call_978", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.andb_77", align 8
  ...
  %"$$BoolUtils.andb_77_call_983" = call %TName_Bool* %"$$BoolUtils.andb_77_fptr_980"(i8* %"$$BoolUtils.andb_77_envptr_981", %TName_Bool* %"$$test__53_982")
  store %TName_Bool* %"$$BoolUtils.andb_77_call_983", %TName_Bool** %"$BoolUtils.andb_78", align 8
  %"$$BoolUtils.andb_78_984" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.andb_78", align 8
  store %TName_Bool* %"$$BoolUtils.andb_78_984", %TName_Bool** %"$test_54", align 8
...
"$have_gas_1019":                                 ; preds = %"$out_of_gas_1018", %"$have_gas_1013"
  ...
  %"$div_call_1026" = call %Int256* @_div_Int256(i8* %"$execptr_load_1021", %Int256* %"$div_$arg1_55_1022", %Int256* %"$div_$arg2_56_1024")
  %"$div_1028" = load %Int256, %Int256* %"$div_call_1026", align 8
  store %Int256 %"$div_1028", %Int256* %"$res_57", align 8
...
"$have_gas_1048":                                 ; preds = %"$out_of_gas_1047", %"$have_gas_1042"
  ...
  %"$eq_call_1055" = call %TName_Bool* @_eq_Int256(i8* %"$execptr_load_1050", %Int256* %"$eq_$res_57_1051", %Int256* %"$eq_$res__58_1053")
  store %TName_Bool* %"$eq_call_1055", %TName_Bool** %"$test__59", align 8
...
"$have_gas_1060":                                 ; preds = %"$out_of_gas_1059", %"$have_gas_1048"
  ...
  %"$BoolUtils.andb_call_1066" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_fptr_1063"(i8* %"$BoolUtils.andb_envptr_1064", %TName_Bool* %"$$test_54_1065")
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_call_1066", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.andb_79", align 8
  ...
  %"$$BoolUtils.andb_79_call_1071" = call %TName_Bool* %"$$BoolUtils.andb_79_fptr_1068"(i8* %"$$BoolUtils.andb_79_envptr_1069", %TName_Bool* %"$$test__59_1070")
  store %TName_Bool* %"$$BoolUtils.andb_79_call_1071", %TName_Bool** %"$BoolUtils.andb_80", align 8
  %"$$BoolUtils.andb_80_1072" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.andb_80", align 8
  store %TName_Bool* %"$$BoolUtils.andb_80_1072", %TName_Bool** %"$test_60", align 8
...
"$have_gas_1076":                                 ; preds = %"$out_of_gas_1075", %"$have_gas_1060"
  ...
  store %TName_Bool* %"$$test_60_1078", %TName_Bool** %"$expr_85", align 8
