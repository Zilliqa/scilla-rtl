...
"$have_gas_230":                                  ; preds = %"$out_of_gas_229", %"$have_gas_225"
  ...
  %"$div_call_234" = call %Uint32 @_div_Uint32(%Uint32 %"$arg1_232", %Uint32 %"$arg2_233")
  store %Uint32 %"$div_call_234", %Uint32* %res, align 4
...
"$have_gas_253":                                  ; preds = %"$out_of_gas_252", %"$have_gas_248"
  ...
  %"$eq_call_258" = call %TName_Bool* @_eq_Uint32(i8* %"$execptr_load_255", %Uint32 %"$res_256", %Uint32 %"$res__257")
  store %TName_Bool* %"$eq_call_258", %TName_Bool** %test_, align 8
...
"$have_gas_263":                                  ; preds = %"$out_of_gas_262", %"$have_gas_253"
  ...
  %"$BoolUtils.andb_call_269" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_fptr_266"(i8* %"$BoolUtils.andb_envptr_267", %TName_Bool* %"$test_268")
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_call_269", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.andb_55", align 8
  ...
  %"$$BoolUtils.andb_55_call_274" = call %TName_Bool* %"$$BoolUtils.andb_55_fptr_271"(i8* %"$$BoolUtils.andb_55_envptr_272", %TName_Bool* %"$test__273")
  store %TName_Bool* %"$$BoolUtils.andb_55_call_274", %TName_Bool** %"$BoolUtils.andb_56", align 8
  %"$$BoolUtils.andb_56_275" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.andb_56", align 8
  store %TName_Bool* %"$$BoolUtils.andb_56_275", %TName_Bool** %"$test_0", align 8
...
"$have_gas_309":                                  ; preds = %"$out_of_gas_308", %"$have_gas_304"
  ...
  %"$rem_call_313" = call %Uint32 @_rem_Uint32(%Uint32 %"$$arg1_1_311", %Uint32 %"$$arg2_2_312")
  store %Uint32 %"$rem_call_313", %Uint32* %"$res_3", align 4
...
"$have_gas_332":                                  ; preds = %"$out_of_gas_331", %"$have_gas_327"
  ...
  %"$eq_call_337" = call %TName_Bool* @_eq_Uint32(i8* %"$execptr_load_334", %Uint32 %"$$res_3_335", %Uint32 %"$$res__4_336")
  store %TName_Bool* %"$eq_call_337", %TName_Bool** %"$test__5", align 8
...
"$have_gas_342":                                  ; preds = %"$out_of_gas_341", %"$have_gas_332"
  ...
  %"$BoolUtils.andb_call_348" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_fptr_345"(i8* %"$BoolUtils.andb_envptr_346", %TName_Bool* %"$$test_0_347")
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_call_348", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.andb_57", align 8
  ...
  %"$$BoolUtils.andb_57_call_353" = call %TName_Bool* %"$$BoolUtils.andb_57_fptr_350"(i8* %"$$BoolUtils.andb_57_envptr_351", %TName_Bool* %"$$test__5_352")
  store %TName_Bool* %"$$BoolUtils.andb_57_call_353", %TName_Bool** %"$BoolUtils.andb_58", align 8
  %"$$BoolUtils.andb_58_354" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.andb_58", align 8
  store %TName_Bool* %"$$BoolUtils.andb_58_354", %TName_Bool** %"$test_6", align 8
...
"$have_gas_388":                                  ; preds = %"$out_of_gas_387", %"$have_gas_383"
  ...
  %"$div_call_392" = call %Uint32 @_div_Uint32(%Uint32 %"$$arg1_7_390", %Uint32 %"$$arg2_8_391")
  store %Uint32 %"$div_call_392", %Uint32* %"$res_9", align 4
...
"$have_gas_411":                                  ; preds = %"$out_of_gas_410", %"$have_gas_406"
  ...
  %"$eq_call_416" = call %TName_Bool* @_eq_Uint32(i8* %"$execptr_load_413", %Uint32 %"$$res_9_414", %Uint32 %"$$res__10_415")
  store %TName_Bool* %"$eq_call_416", %TName_Bool** %"$test__11", align 8
...
"$have_gas_421":                                  ; preds = %"$out_of_gas_420", %"$have_gas_411"
  ...
  %"$BoolUtils.andb_call_427" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_fptr_424"(i8* %"$BoolUtils.andb_envptr_425", %TName_Bool* %"$$test_6_426")
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_call_427", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.andb_59", align 8
  ...
  %"$$BoolUtils.andb_59_call_432" = call %TName_Bool* %"$$BoolUtils.andb_59_fptr_429"(i8* %"$$BoolUtils.andb_59_envptr_430", %TName_Bool* %"$$test__11_431")
  store %TName_Bool* %"$$BoolUtils.andb_59_call_432", %TName_Bool** %"$BoolUtils.andb_60", align 8
  %"$$BoolUtils.andb_60_433" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.andb_60", align 8
  store %TName_Bool* %"$$BoolUtils.andb_60_433", %TName_Bool** %"$test_12", align 8
...
"$have_gas_467":                                  ; preds = %"$out_of_gas_466", %"$have_gas_462"
  ...
  %"$div_call_471" = call %Int32 @_div_Int32(%Int32 %"$$arg1_13_469", %Int32 %"$$arg2_14_470")
  store %Int32 %"$div_call_471", %Int32* %"$res_15", align 4
...
"$have_gas_490":                                  ; preds = %"$out_of_gas_489", %"$have_gas_485"
  ...
  %"$eq_call_495" = call %TName_Bool* @_eq_Int32(i8* %"$execptr_load_492", %Int32 %"$$res_15_493", %Int32 %"$$res__16_494")
  store %TName_Bool* %"$eq_call_495", %TName_Bool** %"$test__17", align 8
...
"$have_gas_500":                                  ; preds = %"$out_of_gas_499", %"$have_gas_490"
  ...
  %"$BoolUtils.andb_call_506" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_fptr_503"(i8* %"$BoolUtils.andb_envptr_504", %TName_Bool* %"$$test_12_505")
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_call_506", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.andb_61", align 8
  ...
  %"$$BoolUtils.andb_61_call_511" = call %TName_Bool* %"$$BoolUtils.andb_61_fptr_508"(i8* %"$$BoolUtils.andb_61_envptr_509", %TName_Bool* %"$$test__17_510")
  store %TName_Bool* %"$$BoolUtils.andb_61_call_511", %TName_Bool** %"$BoolUtils.andb_62", align 8
  %"$$BoolUtils.andb_62_512" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.andb_62", align 8
  store %TName_Bool* %"$$BoolUtils.andb_62_512", %TName_Bool** %"$test_18", align 8
...
"$have_gas_546":                                  ; preds = %"$out_of_gas_545", %"$have_gas_541"
  ...
  %"$div_call_550" = call %Int32 @_div_Int32(%Int32 %"$$arg1_19_548", %Int32 %"$$arg2_20_549")
  store %Int32 %"$div_call_550", %Int32* %"$res_21", align 4
...
"$have_gas_569":                                  ; preds = %"$out_of_gas_568", %"$have_gas_564"
  ...
  %"$eq_call_574" = call %TName_Bool* @_eq_Int32(i8* %"$execptr_load_571", %Int32 %"$$res_21_572", %Int32 %"$$res__22_573")
  store %TName_Bool* %"$eq_call_574", %TName_Bool** %"$test__23", align 8
...
"$have_gas_579":                                  ; preds = %"$out_of_gas_578", %"$have_gas_569"
  ...
  %"$BoolUtils.andb_call_585" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_fptr_582"(i8* %"$BoolUtils.andb_envptr_583", %TName_Bool* %"$$test_18_584")
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_call_585", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.andb_63", align 8
  ...
  %"$$BoolUtils.andb_63_call_590" = call %TName_Bool* %"$$BoolUtils.andb_63_fptr_587"(i8* %"$$BoolUtils.andb_63_envptr_588", %TName_Bool* %"$$test__23_589")
  store %TName_Bool* %"$$BoolUtils.andb_63_call_590", %TName_Bool** %"$BoolUtils.andb_64", align 8
  %"$$BoolUtils.andb_64_591" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.andb_64", align 8
  store %TName_Bool* %"$$BoolUtils.andb_64_591", %TName_Bool** %"$test_24", align 8
...
"$have_gas_626":                                  ; preds = %"$out_of_gas_625", %"$have_gas_620"
  ...
  %"$div_call_633" = call %Uint256* @_div_Uint256(i8* %"$execptr_load_628", %Uint256* %"$div_$arg1_25_629", %Uint256* %"$div_$arg2_26_631")
  %"$div_635" = load %Uint256, %Uint256* %"$div_call_633", align 8
  store %Uint256 %"$div_635", %Uint256* %"$res_27", align 8
...
"$have_gas_655":                                  ; preds = %"$out_of_gas_654", %"$have_gas_649"
  ...
  %"$eq_call_662" = call %TName_Bool* @_eq_Uint256(i8* %"$execptr_load_657", %Uint256* %"$eq_$res_27_658", %Uint256* %"$eq_$res__28_660")
  store %TName_Bool* %"$eq_call_662", %TName_Bool** %"$test__29", align 8
...
"$have_gas_667":                                  ; preds = %"$out_of_gas_666", %"$have_gas_655"
  ...
  %"$BoolUtils.andb_call_673" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_fptr_670"(i8* %"$BoolUtils.andb_envptr_671", %TName_Bool* %"$$test_24_672")
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_call_673", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.andb_65", align 8
  ...
  %"$$BoolUtils.andb_65_call_678" = call %TName_Bool* %"$$BoolUtils.andb_65_fptr_675"(i8* %"$$BoolUtils.andb_65_envptr_676", %TName_Bool* %"$$test__29_677")
  store %TName_Bool* %"$$BoolUtils.andb_65_call_678", %TName_Bool** %"$BoolUtils.andb_66", align 8
  %"$$BoolUtils.andb_66_679" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.andb_66", align 8
  store %TName_Bool* %"$$BoolUtils.andb_66_679", %TName_Bool** %"$test_30", align 8
...
"$have_gas_714":                                  ; preds = %"$out_of_gas_713", %"$have_gas_708"
  ...
  %"$rem_call_721" = call %Uint256* @_rem_Uint256(i8* %"$execptr_load_716", %Uint256* %"$rem_$arg1_31_717", %Uint256* %"$rem_$arg2_32_719")
  %"$rem_723" = load %Uint256, %Uint256* %"$rem_call_721", align 8
  store %Uint256 %"$rem_723", %Uint256* %"$res_33", align 8
...
"$have_gas_743":                                  ; preds = %"$out_of_gas_742", %"$have_gas_737"
  ...
  %"$eq_call_750" = call %TName_Bool* @_eq_Uint256(i8* %"$execptr_load_745", %Uint256* %"$eq_$res_33_746", %Uint256* %"$eq_$res__34_748")
...
"$have_gas_755":                                  ; preds = %"$out_of_gas_754", %"$have_gas_743"
  ...
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_call_761", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.andb_67", align 8
  ...
  %"$$BoolUtils.andb_67_call_766" = call %TName_Bool* %"$$BoolUtils.andb_67_fptr_763"(i8* %"$$BoolUtils.andb_67_envptr_764", %TName_Bool* %"$$test__35_765")
  store %TName_Bool* %"$$BoolUtils.andb_67_call_766", %TName_Bool** %"$BoolUtils.andb_68", align 8
  %"$$BoolUtils.andb_68_767" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.andb_68", align 8
  store %TName_Bool* %"$$BoolUtils.andb_68_767", %TName_Bool** %"$test_36", align 8
...
"$have_gas_802":                                  ; preds = %"$out_of_gas_801", %"$have_gas_796"
  ...
  %"$div_call_809" = call %Uint256* @_div_Uint256(i8* %"$execptr_load_804", %Uint256* %"$div_$arg1_37_805", %Uint256* %"$div_$arg2_38_807")
  %"$div_811" = load %Uint256, %Uint256* %"$div_call_809", align 8
  store %Uint256 %"$div_811", %Uint256* %"$res_39", align 8
...
"$have_gas_831":                                  ; preds = %"$out_of_gas_830", %"$have_gas_825"
  ...
  %"$eq_call_838" = call %TName_Bool* @_eq_Uint256(i8* %"$execptr_load_833", %Uint256* %"$eq_$res_39_834", %Uint256* %"$eq_$res__40_836")
  store %TName_Bool* %"$eq_call_838", %TName_Bool** %"$test__41", align 8
...
"$have_gas_843":                                  ; preds = %"$out_of_gas_842", %"$have_gas_831"
  ...
  %"$BoolUtils.andb_call_849" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_fptr_846"(i8* %"$BoolUtils.andb_envptr_847", %TName_Bool* %"$$test_36_848")
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_call_849", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.andb_69", align 8
  ...
  %"$$BoolUtils.andb_69_call_854" = call %TName_Bool* %"$$BoolUtils.andb_69_fptr_851"(i8* %"$$BoolUtils.andb_69_envptr_852", %TName_Bool* %"$$test__41_853")
  store %TName_Bool* %"$$BoolUtils.andb_69_call_854", %TName_Bool** %"$BoolUtils.andb_70", align 8
  %"$$BoolUtils.andb_70_855" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.andb_70", align 8
  store %TName_Bool* %"$$BoolUtils.andb_70_855", %TName_Bool** %"$test_42", align 8
...
"$have_gas_890":                                  ; preds = %"$out_of_gas_889", %"$have_gas_884"
  ...
  %"$div_call_897" = call %Int256* @_div_Int256(i8* %"$execptr_load_892", %Int256* %"$div_$arg1_43_893", %Int256* %"$div_$arg2_44_895")
  %"$div_899" = load %Int256, %Int256* %"$div_call_897", align 8
  store %Int256 %"$div_899", %Int256* %"$res_45", align 8
...
"$have_gas_919":                                  ; preds = %"$out_of_gas_918", %"$have_gas_913"
  ...
  %"$eq_call_926" = call %TName_Bool* @_eq_Int256(i8* %"$execptr_load_921", %Int256* %"$eq_$res_45_922", %Int256* %"$eq_$res__46_924")
  store %TName_Bool* %"$eq_call_926", %TName_Bool** %"$test__47", align 8
...
"$have_gas_931":                                  ; preds = %"$out_of_gas_930", %"$have_gas_919"
  ...
  %"$BoolUtils.andb_call_937" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_fptr_934"(i8* %"$BoolUtils.andb_envptr_935", %TName_Bool* %"$$test_42_936")
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_call_937", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.andb_71", align 8
  ...
  %"$$BoolUtils.andb_71_call_942" = call %TName_Bool* %"$$BoolUtils.andb_71_fptr_939"(i8* %"$$BoolUtils.andb_71_envptr_940", %TName_Bool* %"$$test__47_941")
  store %TName_Bool* %"$$BoolUtils.andb_71_call_942", %TName_Bool** %"$BoolUtils.andb_72", align 8
  %"$$BoolUtils.andb_72_943" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.andb_72", align 8
  store %TName_Bool* %"$$BoolUtils.andb_72_943", %TName_Bool** %"$test_48", align 8
...
"$have_gas_978":                                  ; preds = %"$out_of_gas_977", %"$have_gas_972"
  ...
  %"$div_call_985" = call %Int256* @_div_Int256(i8* %"$execptr_load_980", %Int256* %"$div_$arg1_49_981", %Int256* %"$div_$arg2_50_983")
  %"$div_987" = load %Int256, %Int256* %"$div_call_985", align 8
  store %Int256 %"$div_987", %Int256* %"$res_51", align 8
...
"$have_gas_1007":                                 ; preds = %"$out_of_gas_1006", %"$have_gas_1001"
  ...
  %"$eq_call_1014" = call %TName_Bool* @_eq_Int256(i8* %"$execptr_load_1009", %Int256* %"$eq_$res_51_1010", %Int256* %"$eq_$res__52_1012")
  store %TName_Bool* %"$eq_call_1014", %TName_Bool** %"$test__53", align 8
...
"$have_gas_1019":                                 ; preds = %"$out_of_gas_1018", %"$have_gas_1007"
  ...
  %"$BoolUtils.andb_call_1025" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_fptr_1022"(i8* %"$BoolUtils.andb_envptr_1023", %TName_Bool* %"$$test_48_1024")
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_call_1025", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.andb_73", align 8
  ...
  %"$$BoolUtils.andb_73_call_1030" = call %TName_Bool* %"$$BoolUtils.andb_73_fptr_1027"(i8* %"$$BoolUtils.andb_73_envptr_1028", %TName_Bool* %"$$test__53_1029")
  store %TName_Bool* %"$$BoolUtils.andb_73_call_1030", %TName_Bool** %"$BoolUtils.andb_74", align 8
  %"$$BoolUtils.andb_74_1031" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.andb_74", align 8
  store %TName_Bool* %"$$BoolUtils.andb_74_1031", %TName_Bool** %"$test_54", align 8
...
"$have_gas_1035":                                 ; preds = %"$out_of_gas_1034", %"$have_gas_1019"
  ...
  store %TName_Bool* %"$$test_54_1037", %TName_Bool** %"$expr_79", align 8
