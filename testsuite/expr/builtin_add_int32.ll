...
define internal %Int32 @"$scilla_expr_34"(i8* %0) !dbg !8 {
entry:
...
"$have_gas_43":                                   ; preds = %"$out_of_gas_42", %"$have_gas_38"
  ...
  store %Int32 { i32 1 }, %Int32* %one, align 4, !dbg !9
...
"$have_gas_53":                                   ; preds = %"$out_of_gas_52", %"$have_gas_48"
  ...
  store %Int32 { i32 2 }, %Int32* %two, align 4, !dbg !10
  %"$one_55" = load %Int32, %Int32* %one, align 4
  %"$two_56" = load %Int32, %Int32* %two, align 4
  %"$add_call_57" = call %Int32 @_add_Int32(%Int32 %"$one_55", %Int32 %"$two_56")
  store %Int32 %"$add_call_57", %Int32* %"$expr_0", align 4, !dbg !11
  %"$$expr_0_58" = load %Int32, %Int32* %"$expr_0", align 4
  ret %Int32 %"$$expr_0_58"
}
...
entry:
  ...
  %"$pval_60" = alloca %Int32, align 8
  %"$memvoidcast_61" = bitcast %Int32* %"$pval_60" to i8*
  store %Int32 %"$exprval_59", %Int32* %"$pval_60", align 4
