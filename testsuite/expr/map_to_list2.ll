...
"$have_gas_272":                                  ; preds = %"$out_of_gas_271", %"$have_gas_245"
  ...
  %"$to_list_call_277" = call i8* @_map_to_list(i8* %"$execptr_load_274", %_TyDescrTy_Typ* @"$TyDescr_Map_36", i8* %"$$mm1_275_276")
  %"$to_list_278" = bitcast i8* %"$to_list_call_277" to %"TName_List_Pair_(Int32)_(Map_(BNum)_(Int32))"*
  store %"TName_List_Pair_(Int32)_(Map_(BNum)_(Int32))"* %"$to_list_278", %"TName_List_Pair_(Int32)_(Map_(BNum)_(Int32))"** %"$expr_0", align 8
