...
"$have_gas_76":                                   ; preds = %"$out_of_gas_75", %"$have_gas_71"
  ...
  %"$div_call_80" = call %Int32 @_div_Int32(%Int32 %"$a_78", %Int32 %"$b_79")
  store %Int32 %"$div_call_80", %Int32* %res_div, align 4
...
"$have_gas_89":                                   ; preds = %"$out_of_gas_88", %"$have_gas_84"
  ...
  %"$rem_call_93" = call %Int32 @_rem_Int32(%Int32 %"$a_91", %Int32 %"$b_92")
  store %Int32 %"$rem_call_93", %Int32* %res_rem, align 4
...
"$have_gas_102":                                  ; preds = %"$out_of_gas_101", %"$have_gas_97"
  ...
  %"$add_call_106" = call %Int32 @_add_Int32(%Int32 %"$res_div_104", %Int32 %"$res_rem_105")
  store %Int32 %"$add_call_106", %Int32* %res1, align 4
...
"$have_gas_115":                                  ; preds = %"$out_of_gas_114", %"$have_gas_110"
  ...
  store %Int32 { i32 10 }, %Int32* %"$b_0", align 4
...
"$have_gas_125":                                  ; preds = %"$out_of_gas_124", %"$have_gas_120"
  ...
  store %Int32 { i32 -3 }, %Int32* %"$a_1", align 4
...
"$have_gas_135":                                  ; preds = %"$out_of_gas_134", %"$have_gas_130"
  ...
  %"$$a_1_137" = load %Int32, %Int32* %"$a_1", align 4
  %"$$b_0_138" = load %Int32, %Int32* %"$b_0", align 4
  %"$div_call_139" = call %Int32 @_div_Int32(%Int32 %"$$a_1_137", %Int32 %"$$b_0_138")
  store %Int32 %"$div_call_139", %Int32* %"$res_div_2", align 4
...
"$have_gas_148":                                  ; preds = %"$out_of_gas_147", %"$have_gas_143"
  ...
  %"$$a_1_150" = load %Int32, %Int32* %"$a_1", align 4
  %"$$b_0_151" = load %Int32, %Int32* %"$b_0", align 4
  %"$rem_call_152" = call %Int32 @_rem_Int32(%Int32 %"$$a_1_150", %Int32 %"$$b_0_151")
  store %Int32 %"$rem_call_152", %Int32* %"$res_rem_3", align 4
...
"$have_gas_161":                                  ; preds = %"$out_of_gas_160", %"$have_gas_156"
  ...
  %"$add_call_165" = call %Int32 @_add_Int32(%Int32 %"$$res_div_2_163", %Int32 %"$$res_rem_3_164")
  store %Int32 %"$add_call_165", %Int32* %res2, align 4
...
"$have_gas_174":                                  ; preds = %"$out_of_gas_173", %"$have_gas_169"
  ...
  store %Int32 { i32 -10 }, %Int32* %"$b_4", align 4
...
"$have_gas_184":                                  ; preds = %"$out_of_gas_183", %"$have_gas_179"
  ...
  store %Int32 { i32 -3 }, %Int32* %"$a_5", align 4
...
"$have_gas_194":                                  ; preds = %"$out_of_gas_193", %"$have_gas_189"
  ...
  %"$$a_5_196" = load %Int32, %Int32* %"$a_5", align 4
  %"$$b_4_197" = load %Int32, %Int32* %"$b_4", align 4
  %"$div_call_198" = call %Int32 @_div_Int32(%Int32 %"$$a_5_196", %Int32 %"$$b_4_197")
  store %Int32 %"$div_call_198", %Int32* %"$res_div_6", align 4
...
"$have_gas_207":                                  ; preds = %"$out_of_gas_206", %"$have_gas_202"
  ...
  %"$$a_5_209" = load %Int32, %Int32* %"$a_5", align 4
  %"$$b_4_210" = load %Int32, %Int32* %"$b_4", align 4
  %"$rem_call_211" = call %Int32 @_rem_Int32(%Int32 %"$$a_5_209", %Int32 %"$$b_4_210")
  store %Int32 %"$rem_call_211", %Int32* %"$res_rem_7", align 4
...
"$have_gas_220":                                  ; preds = %"$out_of_gas_219", %"$have_gas_215"
  ...
  %"$add_call_224" = call %Int32 @_add_Int32(%Int32 %"$$res_div_6_222", %Int32 %"$$res_rem_7_223")
  store %Int32 %"$add_call_224", %Int32* %res3, align 4
...
"$have_gas_233":                                  ; preds = %"$out_of_gas_232", %"$have_gas_228"
  ...
  store %Int32 { i32 10 }, %Int32* %"$b_8", align 4
...
"$have_gas_243":                                  ; preds = %"$out_of_gas_242", %"$have_gas_238"
  ...
  store %Int32 { i32 3 }, %Int32* %"$a_9", align 4
...
"$have_gas_253":                                  ; preds = %"$out_of_gas_252", %"$have_gas_248"
  ...
  %"$$a_9_255" = load %Int32, %Int32* %"$a_9", align 4
  %"$$b_8_256" = load %Int32, %Int32* %"$b_8", align 4
  %"$div_call_257" = call %Int32 @_div_Int32(%Int32 %"$$a_9_255", %Int32 %"$$b_8_256")
  store %Int32 %"$div_call_257", %Int32* %"$res_div_10", align 4
...
"$have_gas_266":                                  ; preds = %"$out_of_gas_265", %"$have_gas_261"
  ...
  %"$$a_9_268" = load %Int32, %Int32* %"$a_9", align 4
  %"$$b_8_269" = load %Int32, %Int32* %"$b_8", align 4
  %"$rem_call_270" = call %Int32 @_rem_Int32(%Int32 %"$$a_9_268", %Int32 %"$$b_8_269")
  store %Int32 %"$rem_call_270", %Int32* %"$res_rem_11", align 4
...
"$have_gas_279":                                  ; preds = %"$out_of_gas_278", %"$have_gas_274"
  ...
  %"$add_call_283" = call %Int32 @_add_Int32(%Int32 %"$$res_div_10_281", %Int32 %"$$res_rem_11_282")
  store %Int32 %"$add_call_283", %Int32* %res4, align 4
...
"$have_gas_292":                                  ; preds = %"$out_of_gas_291", %"$have_gas_287"
  ...
  %"$add_call_296" = call %Int32 @_add_Int32(%Int32 %"$res1_294", %Int32 %"$res2_295")
  store %Int32 %"$add_call_296", %Int32* %res5, align 4
...
"$have_gas_305":                                  ; preds = %"$out_of_gas_304", %"$have_gas_300"
  ...
  %"$add_call_309" = call %Int32 @_add_Int32(%Int32 %"$res5_307", %Int32 %"$res3_308")
  store %Int32 %"$add_call_309", %Int32* %res6, align 4
...
"$have_gas_318":                                  ; preds = %"$out_of_gas_317", %"$have_gas_313"
  ...
  %"$add_call_322" = call %Int32 @_add_Int32(%Int32 %"$res4_320", %Int32 %"$res6_321")
  store %Int32 %"$add_call_322", %Int32* %res7, align 4
...
"$have_gas_326":                                  ; preds = %"$out_of_gas_325", %"$have_gas_318"
  ...
  store %Int32 %"$res7_328", %Int32* %"$expr_12", align 4
