...
"$have_gas_171":                                  ; preds = %"$out_of_gas_170", %"$have_gas_166"
  ...
  %"$div_call_175" = call %Int32 @_div_Int32(%Int32 %"$$a_7_173", %Int32 %"$$b_6_174")
...
"$have_gas_184":                                  ; preds = %"$out_of_gas_183", %"$have_gas_179"
  ...
  %"$rem_call_188" = call %Int32 @_rem_Int32(%Int32 %"$$a_7_186", %Int32 %"$$b_6_187")
...
"$have_gas_230":                                  ; preds = %"$out_of_gas_229", %"$have_gas_225"
  ...
  %"$div_call_234" = call %Int32 @_div_Int32(%Int32 %"$$a_11_232", %Int32 %"$$b_10_233")
...
"$have_gas_243":                                  ; preds = %"$out_of_gas_242", %"$have_gas_238"
  ...
  %"$rem_call_247" = call %Int32 @_rem_Int32(%Int32 %"$$a_11_245", %Int32 %"$$b_10_246")
...
"$have_gas_289":                                  ; preds = %"$out_of_gas_288", %"$have_gas_284"
  ...
  %"$div_call_293" = call %Int32 @_div_Int32(%Int32 %"$$a_15_291", %Int32 %"$$b_14_292")
...
"$have_gas_302":                                  ; preds = %"$out_of_gas_301", %"$have_gas_297"
  ...
  %"$rem_call_306" = call %Int32 @_rem_Int32(%Int32 %"$$a_15_304", %Int32 %"$$b_14_305")
