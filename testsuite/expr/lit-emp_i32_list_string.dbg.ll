...
entry:
  ...
  call void @llvm.dbg.declare(metadata %"Map_Int32_List_(String)"** %"$expr_6", metadata !11, metadata !DIExpression()), !dbg !14
...
"$have_gas_92":                                   ; preds = %"$out_of_gas_91", %entry
  ...
  store %"Map_Int32_List_(String)"* %"$_new_empty_map_96", %"Map_Int32_List_(String)"** %"$expr_6", align 8, !dbg !14
...
!12 = !DIDerivedType(tag: DW_TAG_pointer_type, name: "Map (Int32) (List (String))", baseType: !13, size: 8, align: 8, dwarfAddressSpace: 0)
!13 = !DIBasicType(name: "Map (Int32) (List (String))", size: 8)
