...
define internal %"TName_Pair_Bool_Pair_(String)_(ByStr22)"* @"$scilla_expr_72"(i8* %0) !dbg !8 {
entry:
...
"$have_gas_81":                                   ; preds = %"$out_of_gas_80", %"$have_gas_76"
  ...
  store %String { i8* getelementptr inbounds ([5 x i8], [5 x i8]* @"$stringlit_83", i32 0, i32 0), i32 5 }, %String* %a, align 8, !dbg !9
...
"$have_gas_92":                                   ; preds = %"$out_of_gas_91", %"$have_gas_87"
  ...
  store %String { i8* getelementptr inbounds ([5 x i8], [5 x i8]* @"$stringlit_94", i32 0, i32 0), i32 5 }, %String* %b, align 8, !dbg !10
...
"$have_gas_98":                                   ; preds = %"$out_of_gas_97", %"$have_gas_92"
  ...
  %"$a_101" = load %String, %String* %a, align 8
  %"$b_102" = load %String, %String* %b, align 8
  %"$concat_call_103" = call %String @_concat_String(i8* %"$execptr_load_100", %String %"$a_101", %String %"$b_102")
  store %String %"$concat_call_103", %String* %str, align 8, !dbg !11
...
"$have_gas_112":                                  ; preds = %"$out_of_gas_111", %"$have_gas_107"
  ...
  store [2 x i8] c"\11\FF", [2 x i8]* %x, align 1, !dbg !12
...
"$have_gas_122":                                  ; preds = %"$out_of_gas_121", %"$have_gas_117"
  ...
  store [2 x i8] c"\FF\11", [2 x i8]* %y, align 1, !dbg !13
...
"$have_gas_127":                                  ; preds = %"$out_of_gas_126", %"$have_gas_122"
  ...
  %"$concat_x_130" = alloca [2 x i8], align 1
  %"$x_131" = load [2 x i8], [2 x i8]* %x, align 1
  store [2 x i8] %"$x_131", [2 x i8]* %"$concat_x_130", align 1
  %"$$concat_x_130_132" = bitcast [2 x i8]* %"$concat_x_130" to i8*
  %"$concat_y_133" = alloca [2 x i8], align 1
  %"$y_134" = load [2 x i8], [2 x i8]* %y, align 1
  store [2 x i8] %"$y_134", [2 x i8]* %"$concat_y_133", align 1
  ...
  %"$concat_138" = load [4 x i8], [4 x i8]* %"$concat_137", align 1
  store [4 x i8] %"$concat_138", [4 x i8]* %z, align 1, !dbg !14
...
"$have_gas_147":                                  ; preds = %"$out_of_gas_146", %"$have_gas_142"
  ...
  store [18 x i8] c"\00\11\00\11\00\11\00\11\00\11\00\11\00\11\00\11\00\11", [18 x i8]* %w, align 1, !dbg !15
...
"$have_gas_152":                                  ; preds = %"$out_of_gas_151", %"$have_gas_147"
  ...
  %"$concat_w_155" = alloca [18 x i8], align 1
  %"$w_156" = load [18 x i8], [18 x i8]* %w, align 1
  store [18 x i8] %"$w_156", [18 x i8]* %"$concat_w_155", align 1
  %"$$concat_w_155_157" = bitcast [18 x i8]* %"$concat_w_155" to i8*
  %"$concat_z_158" = alloca [4 x i8], align 1
  %"$z_159" = load [4 x i8], [4 x i8]* %z, align 1
  store [4 x i8] %"$z_159", [4 x i8]* %"$concat_z_158", align 1
  ...
  %"$concat_163" = load [22 x i8], [22 x i8]* %"$concat_162", align 1
  store [22 x i8] %"$concat_163", [22 x i8]* %bystrx, align 1, !dbg !16
...
"$have_gas_167":                                  ; preds = %"$out_of_gas_166", %"$have_gas_152"
  ...
  %"$to_bystr_x_170" = alloca [2 x i8], align 1
  %"$x_171" = load [2 x i8], [2 x i8]* %x, align 1
  store [2 x i8] %"$x_171", [2 x i8]* %"$to_bystr_x_170", align 1
  ...
  store %Bystr %"$to_bystr_call_173", %Bystr* %xbs, align 8, !dbg !17
...
"$have_gas_177":                                  ; preds = %"$out_of_gas_176", %"$have_gas_167"
  ...
  %"$to_bystr_y_180" = alloca [2 x i8], align 1
  %"$y_181" = load [2 x i8], [2 x i8]* %y, align 1
  store [2 x i8] %"$y_181", [2 x i8]* %"$to_bystr_y_180", align 1
  ...
  store %Bystr %"$to_bystr_call_183", %Bystr* %ybs, align 8, !dbg !18
...
"$have_gas_187":                                  ; preds = %"$out_of_gas_186", %"$have_gas_177"
  ...
  %"$xbs_190" = load %Bystr, %Bystr* %xbs, align 8
  %"$ybs_191" = load %Bystr, %Bystr* %ybs, align 8
  %"$concat_call_192" = call %Bystr @_concat_ByStr(i8* %"$execptr_load_189", %Bystr %"$xbs_190", %Bystr %"$ybs_191")
  store %Bystr %"$concat_call_192", %Bystr* %xybs, align 8, !dbg !19
...
"$have_gas_196":                                  ; preds = %"$out_of_gas_195", %"$have_gas_187"
  ...
  %"$to_bystr_z_199" = alloca [4 x i8], align 1
  %"$z_200" = load [4 x i8], [4 x i8]* %z, align 1
  store [4 x i8] %"$z_200", [4 x i8]* %"$to_bystr_z_199", align 1
  ...
  store %Bystr %"$to_bystr_call_202", %Bystr* %zbs, align 8, !dbg !20
...
"$have_gas_206":                                  ; preds = %"$out_of_gas_205", %"$have_gas_196"
  ...
  %"$xybs_209" = load %Bystr, %Bystr* %xybs, align 8
  %"$zbs_210" = load %Bystr, %Bystr* %zbs, align 8
  %"$eq_call_211" = call %TName_Bool* @_eq_ByStr(i8* %"$execptr_load_208", %Bystr %"$xybs_209", %Bystr %"$zbs_210")
  store %TName_Bool* %"$eq_call_211", %TName_Bool** %res1, align 8, !dbg !21
...
"$have_gas_220":                                  ; preds = %"$out_of_gas_219", %"$have_gas_215"
  ...
  %"$str_222" = load %String, %String* %str, align 8
  %"$bystrx_223" = load [22 x i8], [22 x i8]* %bystrx, align 1
...
"$have_gas_237":                                  ; preds = %"$out_of_gas_236", %"$have_gas_232"
  ...
  %"$res1_239" = load %TName_Bool*, %TName_Bool** %res1, align 8
  %"$res2_240" = load %TName_Pair_String_ByStr22*, %TName_Pair_String_ByStr22** %res2, align 8
  ...
  store i8 0, i8* %"$adtgep_242", align 1
  ...
  store %TName_Bool* %"$res1_239", %TName_Bool** %"$adtgep_243", align 8
  ...
  store %TName_Pair_String_ByStr22* %"$res2_240", %TName_Pair_String_ByStr22** %"$adtgep_244", align 8
  %"$adtptr_245" = bitcast %"CName_Pair_Bool_Pair_(String)_(ByStr22)"* %"$adtval_241" to %"TName_Pair_Bool_Pair_(String)_(ByStr22)"*
  store %"TName_Pair_Bool_Pair_(String)_(ByStr22)"* %"$adtptr_245", %"TName_Pair_Bool_Pair_(String)_(ByStr22)"** %res3, align 8, !dbg !23
...
"$have_gas_249":                                  ; preds = %"$out_of_gas_248", %"$have_gas_237"
  ...
  %"$res3_251" = load %"TName_Pair_Bool_Pair_(String)_(ByStr22)"*, %"TName_Pair_Bool_Pair_(String)_(ByStr22)"** %res3, align 8
  store %"TName_Pair_Bool_Pair_(String)_(ByStr22)"* %"$res3_251", %"TName_Pair_Bool_Pair_(String)_(ByStr22)"** %"$expr_0", align 8, !dbg !24
  %"$$expr_0_252" = load %"TName_Pair_Bool_Pair_(String)_(ByStr22)"*, %"TName_Pair_Bool_Pair_(String)_(ByStr22)"** %"$expr_0", align 8
...
!8 = distinct !DISubprogram(name: "$scilla_expr_72", linkageName: "$scilla_expr_72", scope: !2, file: !2, type: !5, spFlags: DISPFlagDefinition, unit: !1, retainedNodes: !3)
!9 = !DILocation(line: 1, column: 15, scope: !8)
!10 = !DILocation(line: 2, column: 15, scope: !8)
!11 = !DILocation(line: 3, column: 11, scope: !8)
!12 = !DILocation(line: 5, column: 9, scope: !8)
!13 = !DILocation(line: 6, column: 9, scope: !8)
!14 = !DILocation(line: 7, column: 9, scope: !8)
!15 = !DILocation(line: 8, column: 9, scope: !8)
!16 = !DILocation(line: 9, column: 14, scope: !8)
!17 = !DILocation(line: 11, column: 11, scope: !8)
!18 = !DILocation(line: 12, column: 11, scope: !8)
!19 = !DILocation(line: 13, column: 12, scope: !8)
!20 = !DILocation(line: 14, column: 11, scope: !8)
!21 = !DILocation(line: 15, column: 12, scope: !8)
!22 = !DILocation(line: 17, column: 12, scope: !8)
!23 = !DILocation(line: 19, column: 12, scope: !8)
!24 = !DILocation(line: 20, column: 1, scope: !8)
