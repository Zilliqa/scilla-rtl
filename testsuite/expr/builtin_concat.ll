...
"$have_gas_118":                                  ; preds = %"$out_of_gas_117", %"$have_gas_113"
  ...
  store %String { i8* getelementptr inbounds ([5 x i8], [5 x i8]* @"$stringlit_120", i32 0, i32 0), i32 5 }, %String* %a, align 8
...
"$have_gas_129":                                  ; preds = %"$out_of_gas_128", %"$have_gas_124"
  ...
  store %String { i8* getelementptr inbounds ([5 x i8], [5 x i8]* @"$stringlit_131", i32 0, i32 0), i32 5 }, %String* %b, align 8
...
"$have_gas_149":                                  ; preds = %"$out_of_gas_148", %"$have_gas_135"
  ...
  %"$concat_call_154" = call %String @_concat_String(i8* %"$execptr_load_151", %String %"$a_152", %String %"$b_153")
  store %String %"$concat_call_154", %String* %str, align 8
...
"$have_gas_183":                                  ; preds = %"$out_of_gas_182", %"$have_gas_178"
  ...
  %"$concat_call_192" = call i8* @_concat_ByStrX(i8* %"$execptr_load_185", i32 2, i8* %"$$concat_x_186_188", i32 2, i8* %"$$concat_y_189_191")
  %"$concat_193" = bitcast i8* %"$concat_call_192" to [4 x i8]*
  %"$concat_194" = load [4 x i8], [4 x i8]* %"$concat_193", align 1
  store [4 x i8] %"$concat_194", [4 x i8]* %z, align 1
...
"$have_gas_213":                                  ; preds = %"$out_of_gas_212", %"$have_gas_208"
  ...
  %"$concat_call_222" = call i8* @_concat_ByStrX(i8* %"$execptr_load_215", i32 18, i8* %"$$concat_w_216_218", i32 4, i8* %"$$concat_z_219_221")
  %"$concat_223" = bitcast i8* %"$concat_call_222" to [22 x i8]*
  %"$concat_224" = load [22 x i8], [22 x i8]* %"$concat_223", align 1
  store [22 x i8] %"$concat_224", [22 x i8]* %bystrx, align 1
...
"$have_gas_233":                                  ; preds = %"$out_of_gas_232", %"$have_gas_228"
  ...
  %"$to_bystr_call_239" = call %Bystr @_to_bystr(i8* %"$execptr_load_235", i32 2, i8* %"$$to_bystr_x_236_238")
  store %Bystr %"$to_bystr_call_239", %Bystr* %xbs, align 8
...
"$have_gas_248":                                  ; preds = %"$out_of_gas_247", %"$have_gas_243"
  ...
  %"$to_bystr_call_254" = call %Bystr @_to_bystr(i8* %"$execptr_load_250", i32 2, i8* %"$$to_bystr_y_251_253")
  store %Bystr %"$to_bystr_call_254", %Bystr* %ybs, align 8
...
"$have_gas_272":                                  ; preds = %"$out_of_gas_271", %"$have_gas_258"
  ...
  %"$concat_call_277" = call %Bystr @_concat_ByStr(i8* %"$execptr_load_274", %Bystr %"$xbs_275", %Bystr %"$ybs_276")
  store %Bystr %"$concat_call_277", %Bystr* %xybs, align 8
...
"$have_gas_286":                                  ; preds = %"$out_of_gas_285", %"$have_gas_281"
  ...
  %"$to_bystr_call_292" = call %Bystr @_to_bystr(i8* %"$execptr_load_288", i32 4, i8* %"$$to_bystr_z_289_291")
  store %Bystr %"$to_bystr_call_292", %Bystr* %zbs, align 8
...
"$have_gas_305":                                  ; preds = %"$out_of_gas_304", %"$have_gas_296"
  ...
  %"$eq_call_310" = call %TName_Bool* @_eq_ByStr(i8* %"$execptr_load_307", %Bystr %"$xybs_308", %Bystr %"$zbs_309")
  store %TName_Bool* %"$eq_call_310", %TName_Bool** %res1, align 8
...
"$have_gas_320":                                  ; preds = %"$out_of_gas_319", %"$have_gas_315"
  ...
  store %TName_Pair_String_ByStr22* %"$adtptr_328", %TName_Pair_String_ByStr22** %res2, align 8
...
"$have_gas_337":                                  ; preds = %"$out_of_gas_336", %"$have_gas_332"
  ...
  store %"TName_Pair_Bool_Pair_(String)_(ByStr22)"* %"$adtptr_345", %"TName_Pair_Bool_Pair_(String)_(ByStr22)"** %res3, align 8
...
"$have_gas_349":                                  ; preds = %"$out_of_gas_348", %"$have_gas_337"
  ...
  store %"TName_Pair_Bool_Pair_(String)_(ByStr22)"* %"$res3_351", %"TName_Pair_Bool_Pair_(String)_(ByStr22)"** %"$expr_6", align 8
