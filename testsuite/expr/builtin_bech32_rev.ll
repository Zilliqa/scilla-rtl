...
"$have_gas_107":                                  ; preds = %"$out_of_gas_106", %"$have_gas_102"
  ...
  store %String { i8* getelementptr inbounds ([3 x i8], [3 x i8]* @"$stringlit_109", i32 0, i32 0), i32 3 }, %String* %prefix, align 8
...
"$have_gas_123":                                  ; preds = %"$out_of_gas_122", %"$have_gas_107"
  ...
  %"$bystr20_to_bech32_call_129" = call %TName_Option_String* @_bystr20_to_bech32(i8* %"$execptr_load_125", %String %"$prefix_126", [20 x i8]* %"$bystr20_to_bech32_bystr20_addr_127")
  store %TName_Option_String* %"$bystr20_to_bech32_call_129", %TName_Option_String** %"$expr_6", align 8
