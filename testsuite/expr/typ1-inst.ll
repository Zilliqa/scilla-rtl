...
define internal { %Int32 (i8*, %Int32)*, i8* } @"$fundef_7"(%"$$fundef_7_env_47"* %0, %Uint32 %1) {
entry:
...
"$have_gas_74":                                   ; preds = %"$out_of_gas_73", %entry
  ...
  store { %Int32 (i8*, %Int32)*, i8* } { %Int32 (i8*, %Int32)* bitcast (%Int32 (%"$$fundef_9_env_46"*, %Int32)* @"$fundef_9" to %Int32 (i8*, %Int32)*), i8* null }, { %Int32 (i8*, %Int32)*, i8* }* %"$retval_8", align 8
  %"$$retval_8_79" = load { %Int32 (i8*, %Int32)*, i8* }, { %Int32 (i8*, %Int32)*, i8* }* %"$retval_8", align 8
  ret { %Int32 (i8*, %Int32)*, i8* } %"$$retval_8_79"
}

define internal { { %Int32 (i8*, %Int32)*, i8* } (i8*, %Uint32)*, i8* } @"$fundef_5"(%"$$fundef_5_env_48"* %0) {
entry:
...
"$have_gas_65":                                   ; preds = %"$out_of_gas_64", %entry
  ...
  store { { %Int32 (i8*, %Int32)*, i8* } (i8*, %Uint32)*, i8* } { { %Int32 (i8*, %Int32)*, i8* } (i8*, %Uint32)* bitcast ({ %Int32 (i8*, %Int32)*, i8* } (%"$$fundef_7_env_47"*, %Uint32)* @"$fundef_7" to { %Int32 (i8*, %Int32)*, i8* } (i8*, %Uint32)*), i8* null }, { { %Int32 (i8*, %Int32)*, i8* } (i8*, %Uint32)*, i8* }* %"$retval_6", align 8
...
define internal { i8*, i8* }* @"$fundef_3"(%"$$fundef_3_env_49"* %0) {
entry:
...
"$have_gas_53":                                   ; preds = %"$out_of_gas_52", %entry
  ...
  store { i8*, i8* }* %"$dyndisp_table_58", { i8*, i8* }** %"$retval_4", align 8
...
"$have_gas_94":                                   ; preds = %"$out_of_gas_93", %"$have_gas_89"
  ...
  store { i8*, i8* }* %"$dyndisp_table_99", { i8*, i8* }** %tf, align 8
...
"$have_gas_110":                                  ; preds = %"$out_of_gas_109", %"$have_gas_105"
  ...
  %"$tf_call_118" = call { i8*, i8* }* %"$tf_fptr_116"(i8* %"$tf_envptr_117")
  ...
  %"$tf_call_124" = call { { %Int32 (i8*, %Int32)*, i8* } (i8*, %Uint32)*, i8* } %"$tf_fptr_122"(i8* %"$tf_envptr_123")
  store { { %Int32 (i8*, %Int32)*, i8* } (i8*, %Uint32)*, i8* } %"$tf_call_124", { { %Int32 (i8*, %Int32)*, i8* } (i8*, %Uint32)*, i8* }* %t, align 8
...
"$have_gas_148":                                  ; preds = %"$out_of_gas_147", %"$have_gas_143"
  ...
  %"$t_call_154" = call { %Int32 (i8*, %Int32)*, i8* } %"$t_fptr_151"(i8* %"$t_envptr_152", %Uint32 %"$one_153")
  store { %Int32 (i8*, %Int32)*, i8* } %"$t_call_154", { %Int32 (i8*, %Int32)*, i8* }* %"$t_0", align 8
  ...
  %"$$t_0_call_159" = call %Int32 %"$$t_0_fptr_156"(i8* %"$$t_0_envptr_157", %Int32 %"$two_158")
  store %Int32 %"$$t_0_call_159", %Int32* %"$t_1", align 4
  %"$$t_1_160" = load %Int32, %Int32* %"$t_1", align 4
  store %Int32 %"$$t_1_160", %Int32* %"$expr_2", align 4
