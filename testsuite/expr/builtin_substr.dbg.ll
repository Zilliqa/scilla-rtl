...
"$have_gas_77":                                   ; preds = %"$out_of_gas_76", %"$have_gas_72"
  ...
  %"$to_bystr_call_83" = call %Bystr @_to_bystr(i8* %"$execptr_load_79", i32 6, i8* %"$$to_bystr_y_80_82"), !dbg !12
  store %Bystr %"$to_bystr_call_83", %Bystr* %ybs, align 8, !dbg !12
...
"$have_gas_124":                                  ; preds = %"$out_of_gas_123", %"$have_gas_107"
  ...
  %"$substr_call_130" = call %String @_substr_String(i8* %"$execptr_load_126", %String %"$x_127", %Uint32 %"$pos_128", %Uint32 %"$len_129"), !dbg !15
  store %String %"$substr_call_130", %String* %x_sub, align 8, !dbg !15
...
"$have_gas_151":                                  ; preds = %"$out_of_gas_150", %"$have_gas_134"
  ...
  %"$substr_call_157" = call %Bystr @_substr_ByStr(i8* %"$execptr_load_153", %Bystr %"$ybs_154", %Uint32 %"$pos_155", %Uint32 %"$len_156"), !dbg !16
  store %Bystr %"$substr_call_157", %Bystr* %ybs_sub, align 8, !dbg !16
...
"$have_gas_161":                                  ; preds = %"$out_of_gas_160", %"$have_gas_151"
  ...
  store %TName_Pair_String_ByStr* %"$adtptr_169", %TName_Pair_String_ByStr** %"$expr_0", align 8, !dbg !17
