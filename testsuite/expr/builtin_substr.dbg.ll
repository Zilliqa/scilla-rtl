...
"$have_gas_92":                                   ; preds = %"$out_of_gas_91", %"$have_gas_87"
  ...
  store %String { i8* getelementptr inbounds ([11 x i8], [11 x i8]* @"$stringlit_94", i32 0, i32 0), i32 11 }, %String* %x, align 8, !dbg !11
...
"$have_gas_113":                                  ; preds = %"$out_of_gas_112", %"$have_gas_108"
  ...
  %"$to_bystr_call_119" = call %Bystr @_to_bystr(i8* %"$execptr_load_115", i32 6, i8* %"$$to_bystr_y_116_118"), !dbg !13
  store %Bystr %"$to_bystr_call_119", %Bystr* %ybs, align 8, !dbg !13
...
"$have_gas_160":                                  ; preds = %"$out_of_gas_159", %"$have_gas_143"
  ...
  %"$substr_call_166" = call %String @_substr_String(i8* %"$execptr_load_162", %String %"$x_163", %Uint32 %"$pos_164", %Uint32 %"$len_165"), !dbg !16
  store %String %"$substr_call_166", %String* %x_sub, align 8, !dbg !16
...
"$have_gas_187":                                  ; preds = %"$out_of_gas_186", %"$have_gas_170"
  ...
  %"$substr_call_193" = call %Bystr @_substr_ByStr(i8* %"$execptr_load_189", %Bystr %"$ybs_190", %Uint32 %"$pos_191", %Uint32 %"$len_192"), !dbg !17
  store %Bystr %"$substr_call_193", %Bystr* %ybs_sub, align 8, !dbg !17
...
"$have_gas_197":                                  ; preds = %"$out_of_gas_196", %"$have_gas_187"
  ...
  store %TName_Pair_String_ByStr* %"$adtptr_205", %TName_Pair_String_ByStr** %"$expr_6", align 8, !dbg !18
