...
define internal %Uint32 @"$fundef_10"(%"$$fundef_10_env_49"* %0, %Uint32 %1) !dbg !4 {
entry:
...
define internal { %Uint32 (i8*, %Uint32)*, i8* } @"$fundef_8"(%"$$fundef_8_env_50"* %0) !dbg !9 {
entry:
...
"$have_gas_54":                                   ; preds = %"$out_of_gas_53", %entry
  ...
  store { %Uint32 (i8*, %Uint32)*, i8* } { %Uint32 (i8*, %Uint32)* bitcast (%Uint32 (%"$$fundef_10_env_49"*, %Uint32)* @"$fundef_10" to %Uint32 (i8*, %Uint32)*), i8* null }, { %Uint32 (i8*, %Uint32)*, i8* }* %"$retval_9", align 8, !dbg !10
...
"$have_gas_104":                                  ; preds = %"$out_of_gas_103", %"$have_gas_99"
  ...
  store { i8*, i8* }* %"$dyndisp_table_109", { i8*, i8* }** %tf, align 8, !dbg !15
...
"$have_gas_120":                                  ; preds = %"$out_of_gas_119", %"$have_gas_115"
  ...
  %"$tf_call_128" = call { %Uint32 (i8*, %Uint32)*, i8* } %"$tf_fptr_126"(i8* %"$tf_envptr_127"), !dbg !16
  store { %Uint32 (i8*, %Uint32)*, i8* } %"$tf_call_128", { %Uint32 (i8*, %Uint32)*, i8* }* %t, align 8, !dbg !17
...
"$have_gas_142":                                  ; preds = %"$out_of_gas_141", %"$have_gas_137"
  ...
  %"$t_call_148" = call %Uint32 %"$t_fptr_145"(i8* %"$t_envptr_146", %Uint32 %"$one_147"), !dbg !19
  store %Uint32 %"$t_call_148", %Uint32* %"$t_6", align 4, !dbg !19
  %"$$t_6_149" = load %Uint32, %Uint32* %"$t_6", align 4
  store %Uint32 %"$$t_6_149", %Uint32* %"$expr_7", align 4, !dbg !19
