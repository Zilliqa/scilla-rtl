...
"$have_gas_151":                                  ; preds = %"$out_of_gas_150", %"$have_gas_134"
  ...
  %"$schnorr_verify_call_159" = call %TName_Bool* @_schnorr_verify(i8* %"$execptr_load_153", [33 x i8]* %"$schnorr_verify_pk_154", %Bystr %"$msg_156", [64 x i8]* %"$schnorr_verify_sign_157")
  store %TName_Bool* %"$schnorr_verify_call_159", %TName_Bool** %"$expr_6", align 8
