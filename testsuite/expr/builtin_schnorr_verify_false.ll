...
"$have_gas_83":                                   ; preds = %"$out_of_gas_82", %"$have_gas_78"
  ...
  %"$to_bystr_call_89" = call %Bystr @_to_bystr(i8* %"$execptr_load_85", i32 32, i8* %"$$to_bystr_msg_bs_86_88")
  store %Bystr %"$to_bystr_call_89", %Bystr* %msg, align 8
...
"$have_gas_98":                                   ; preds = %"$out_of_gas_97", %"$have_gas_93"
  ...
  store [64 x i8] c"\91\9D\BD\E7\10\BF\A1\A2'\D1\D5\12 \02*oZ\92P\9B r\FC\0A\C5\0E\E9z:U\98zBT'm\E54\B0\18\A0\BB|\99\A7\FB\DBF\840\95i5\B3\EB\B6h\DF\8BO\A3\E2Z\AF", [64 x i8]* %sign, align 1
...
"$have_gas_115":                                  ; preds = %"$out_of_gas_114", %"$have_gas_98"
  ...
  %"$schnorr_verify_call_123" = call %TName_Bool* @_schnorr_verify(i8* %"$execptr_load_117", [33 x i8]* %"$schnorr_verify_pk_118", %Bystr %"$msg_120", [64 x i8]* %"$schnorr_verify_sign_121")
  store %TName_Bool* %"$schnorr_verify_call_123", %TName_Bool** %"$expr_0", align 8
