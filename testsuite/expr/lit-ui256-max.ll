...
"$have_gas_38":                                   ; preds = %"$out_of_gas_37", %entry
  ...
  store %Uint256 { i256 -1 }, %Uint256* %"$expr_0", align 8, !dbg !9
  %"$$expr_0_40" = load %Uint256, %Uint256* %"$expr_0", align 8
  store %Uint256 %"$$expr_0_40", %Uint256* %1, align 8
  ret void
}
...
entry:
  %"$mainval_41" = alloca %Uint256, align 8
  %"$memvoidcast_42" = bitcast %Uint256* %"$mainval_41" to i8*
  call void @"$scilla_expr_34"(i8* null, %Uint256* %"$mainval_41")
  call void @_print_scilla_val(%_TyDescrTy_Typ* @"$TyDescr_Uint256_17", i8* %"$memvoidcast_42")
  ret void
}
