...
define internal %TName_List_Int32* @"$fundef_8"(%"$$fundef_8_env_60"* %0, %Int32 %1) {
entry:
...
"$have_gas_69":                                   ; preds = %"$out_of_gas_68", %"$have_gas_64"
  ...
  store %TName_List_Int32* %"$adtptr_73", %TName_List_Int32** %n, align 8
...
"$have_gas_77":                                   ; preds = %"$out_of_gas_76", %"$have_gas_69"
  ...
  store %TName_List_Int32* %"$adtptr_84", %TName_List_Int32** %"$retval_9", align 8
...
"$have_gas_124":                                  ; preds = %"$out_of_gas_123", %"$have_gas_119"
  ...
  store { %TName_List_Int32* (i8*, %Int32)*, i8* } { %TName_List_Int32* (i8*, %Int32)* bitcast (%TName_List_Int32* (%"$$fundef_8_env_60"*, %Int32)* @"$fundef_8" to %TName_List_Int32* (i8*, %Int32)*), i8* null }, { %TName_List_Int32* (i8*, %Int32)*, i8* }* %f, align 8
...
"$have_gas_142":                                  ; preds = %"$out_of_gas_141", %"$have_gas_137"
  ...
  %"$f_call_148" = call %TName_List_Int32* %"$f_fptr_145"(i8* %"$f_envptr_146", %Int32 %"$i_147")
  store %TName_List_Int32* %"$f_call_148", %TName_List_Int32** %"$f_6", align 8
  %"$$f_6_149" = load %TName_List_Int32*, %TName_List_Int32** %"$f_6", align 8
  store %TName_List_Int32* %"$$f_6_149", %TName_List_Int32** %"$expr_7", align 8
