...
"$have_gas_44":                                   ; preds = %"$out_of_gas_43", %"$have_gas_39"
  ...
  store %String { i8* getelementptr inbounds ([11 x i8], [11 x i8]* @"$stringlit_46", i32 0, i32 0), i32 11 }, %String* %x, align 8, !dbg !10
...
"$have_gas_55":                                   ; preds = %"$out_of_gas_54", %"$have_gas_50"
  ...
  store %Uint32 { i32 7 }, %Uint32* %pos, align 4, !dbg !11
...
"$have_gas_65":                                   ; preds = %"$out_of_gas_64", %"$have_gas_60"
  ...
  store %Uint32 { i32 5 }, %Uint32* %len, align 4, !dbg !12
...
"$have_gas_82":                                   ; preds = %"$out_of_gas_81", %"$have_gas_65"
  ...
  %"$substr_call_88" = call %String @_substr_String(i8* %"$execptr_load_84", %String %"$x_85", %Uint32 %"$pos_86", %Uint32 %"$len_87"), !dbg !13
  store %String %"$substr_call_88", %String* %"$expr_0", align 8, !dbg !13
