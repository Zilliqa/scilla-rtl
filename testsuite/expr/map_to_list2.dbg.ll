...
"$have_gas_151":                                  ; preds = %"$out_of_gas_150", %"$have_gas_143"
  ...
  %"$put_call_161" = call i8* @_put(i8* %"$execptr_load_153", %_TyDescrTy_Typ* @"$TyDescr_Map_37", i8* %"$$m0_154_155", i8* %"$k1_156", i8* %"$$put_v1_158_160"), !dbg !17
  %"$put_162" = bitcast i8* %"$put_call_161" to %Map_BNum_Int32*
  store %Map_BNum_Int32* %"$put_162", %Map_BNum_Int32** %m1, align 8, !dbg !17
...
"$have_gas_166":                                  ; preds = %"$out_of_gas_165", %"$have_gas_151"
  ...
  %"$put_call_176" = call i8* @_put(i8* %"$execptr_load_168", %_TyDescrTy_Typ* @"$TyDescr_Map_37", i8* %"$$m1_169_170", i8* %"$k2_171", i8* %"$$put_v2_173_175"), !dbg !18
  %"$put_177" = bitcast i8* %"$put_call_176" to %Map_BNum_Int32*
  store %Map_BNum_Int32* %"$put_177", %Map_BNum_Int32** %m2, align 8, !dbg !18
...
"$have_gas_181":                                  ; preds = %"$out_of_gas_180", %"$have_gas_166"
  ...
  %"$put_call_191" = call i8* @_put(i8* %"$execptr_load_183", %_TyDescrTy_Typ* @"$TyDescr_Map_37", i8* %"$$m2_184_185", i8* %"$k3_186", i8* %"$$put_v3_188_190"), !dbg !19
  %"$put_192" = bitcast i8* %"$put_call_191" to %Map_BNum_Int32*
  store %Map_BNum_Int32* %"$put_192", %Map_BNum_Int32** %m3, align 8, !dbg !19
...
"$have_gas_201":                                  ; preds = %"$out_of_gas_200", %"$have_gas_196"
  ...
  store %"Map_Int32_Map_(BNum)_(Int32)"* %"$_new_empty_map_205", %"Map_Int32_Map_(BNum)_(Int32)"** %mm0, align 8, !dbg !20
...
"$have_gas_209":                                  ; preds = %"$out_of_gas_208", %"$have_gas_201"
  ...
  %"$put_call_219" = call i8* @_put(i8* %"$execptr_load_211", %_TyDescrTy_Typ* @"$TyDescr_Map_36", i8* %"$$mm0_212_213", i8* %"$$put_v1_214_216", i8* %"$$m3_217_218"), !dbg !21
  %"$put_220" = bitcast i8* %"$put_call_219" to %"Map_Int32_Map_(BNum)_(Int32)"*
  store %"Map_Int32_Map_(BNum)_(Int32)"* %"$put_220", %"Map_Int32_Map_(BNum)_(Int32)"** %mm1, align 8, !dbg !21
  ...
  %"$to_list_call_224" = call i8* @_map_to_list(i8* %"$execptr_load_221", %_TyDescrTy_Typ* @"$TyDescr_Map_36", i8* %"$$mm1_222_223"), !dbg !22
  %"$to_list_225" = bitcast i8* %"$to_list_call_224" to %"TName_List_Pair_(Int32)_(Map_(BNum)_(Int32))"*
  store %"TName_List_Pair_(Int32)_(Map_(BNum)_(Int32))"* %"$to_list_225", %"TName_List_Pair_(Int32)_(Map_(BNum)_(Int32))"** %"$expr_0", align 8, !dbg !22
