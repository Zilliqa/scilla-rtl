...
"$have_gas_107":                                  ; preds = %"$out_of_gas_106", %"$have_gas_102"
  ...
  store i8* %"$_new_bnum_call_111", i8** %k1, align 8, !dbg !11
...
"$have_gas_121":                                  ; preds = %"$out_of_gas_120", %"$have_gas_116"
  ...
  store i8* %"$_new_bnum_call_125", i8** %k2, align 8, !dbg !12
...
"$have_gas_135":                                  ; preds = %"$out_of_gas_134", %"$have_gas_130"
  ...
  store i8* %"$_new_bnum_call_139", i8** %k3, align 8, !dbg !13
...
"$have_gas_179":                                  ; preds = %"$out_of_gas_178", %"$have_gas_174"
  ...
  store %Map_BNum_Int32* %"$_new_empty_map_183", %Map_BNum_Int32** %m0, align 8, !dbg !17
...
"$have_gas_196":                                  ; preds = %"$out_of_gas_195", %"$have_gas_187"
  ...
  %"$put_call_206" = call i8* @_put(i8* %"$execptr_load_198", %_TyDescrTy_Typ* @"$TyDescr_Map_43", i8* %"$$m0_199_200", i8* %"$k1_201", i8* %"$$put_v1_203_205"), !dbg !18
  %"$put_207" = bitcast i8* %"$put_call_206" to %Map_BNum_Int32*
  store %Map_BNum_Int32* %"$put_207", %Map_BNum_Int32** %m1, align 8, !dbg !18
...
"$have_gas_220":                                  ; preds = %"$out_of_gas_219", %"$have_gas_211"
  ...
  %"$put_call_230" = call i8* @_put(i8* %"$execptr_load_222", %_TyDescrTy_Typ* @"$TyDescr_Map_43", i8* %"$$m1_223_224", i8* %"$k2_225", i8* %"$$put_v2_227_229"), !dbg !19
  %"$put_231" = bitcast i8* %"$put_call_230" to %Map_BNum_Int32*
  store %Map_BNum_Int32* %"$put_231", %Map_BNum_Int32** %m2, align 8, !dbg !19
...
"$have_gas_244":                                  ; preds = %"$out_of_gas_243", %"$have_gas_235"
  ...
  %"$put_call_254" = call i8* @_put(i8* %"$execptr_load_246", %_TyDescrTy_Typ* @"$TyDescr_Map_43", i8* %"$$m2_247_248", i8* %"$k3_249", i8* %"$$put_v3_251_253"), !dbg !20
  %"$put_255" = bitcast i8* %"$put_call_254" to %Map_BNum_Int32*
  store %Map_BNum_Int32* %"$put_255", %Map_BNum_Int32** %m3, align 8, !dbg !20
...
"$have_gas_264":                                  ; preds = %"$out_of_gas_263", %"$have_gas_259"
  ...
  store %"Map_Int32_Map_(BNum)_(Int32)"* %"$_new_empty_map_268", %"Map_Int32_Map_(BNum)_(Int32)"** %mm0, align 8, !dbg !21
...
"$have_gas_281":                                  ; preds = %"$out_of_gas_280", %"$have_gas_272"
  ...
  %"$put_call_291" = call i8* @_put(i8* %"$execptr_load_283", %_TyDescrTy_Typ* @"$TyDescr_Map_42", i8* %"$$mm0_284_285", i8* %"$$put_v1_286_288", i8* %"$$m3_289_290"), !dbg !22
  %"$put_292" = bitcast i8* %"$put_call_291" to %"Map_Int32_Map_(BNum)_(Int32)"*
  store %"Map_Int32_Map_(BNum)_(Int32)"* %"$put_292", %"Map_Int32_Map_(BNum)_(Int32)"** %mm1, align 8, !dbg !22
...
"$have_gas_308":                                  ; preds = %"$out_of_gas_307", %"$have_gas_281"
  ...
  %"$to_list_call_313" = call i8* @_map_to_list(i8* %"$execptr_load_310", %_TyDescrTy_Typ* @"$TyDescr_Map_42", i8* %"$$mm1_311_312"), !dbg !23
  %"$to_list_314" = bitcast i8* %"$to_list_call_313" to %"TName_List_Pair_(Int32)_(Map_(BNum)_(Int32))"*
  store %"TName_List_Pair_(Int32)_(Map_(BNum)_(Int32))"* %"$to_list_314", %"TName_List_Pair_(Int32)_(Map_(BNum)_(Int32))"** %"$expr_6", align 8, !dbg !23
