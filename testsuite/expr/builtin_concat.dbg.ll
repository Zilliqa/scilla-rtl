...
"$have_gas_113":                                  ; preds = %"$out_of_gas_112", %"$have_gas_99"
  ...
  %"$concat_call_118" = call %String @_concat_String(i8* %"$execptr_load_115", %String %"$a_116", %String %"$b_117"), !dbg !12
  store %String %"$concat_call_118", %String* %str, align 8, !dbg !12
...
"$have_gas_147":                                  ; preds = %"$out_of_gas_146", %"$have_gas_142"
  ...
  %"$concat_call_156" = call i8* @_concat_ByStrX(i8* %"$execptr_load_149", i32 2, i8* %"$$concat_x_150_152", i32 2, i8* %"$$concat_y_153_155"), !dbg !15
  %"$concat_157" = bitcast i8* %"$concat_call_156" to [4 x i8]*
  %"$concat_158" = load [4 x i8], [4 x i8]* %"$concat_157", align 1
  store [4 x i8] %"$concat_158", [4 x i8]* %z, align 1, !dbg !15
...
"$have_gas_177":                                  ; preds = %"$out_of_gas_176", %"$have_gas_172"
  ...
  %"$concat_call_186" = call i8* @_concat_ByStrX(i8* %"$execptr_load_179", i32 18, i8* %"$$concat_w_180_182", i32 4, i8* %"$$concat_z_183_185"), !dbg !17
  %"$concat_187" = bitcast i8* %"$concat_call_186" to [22 x i8]*
  %"$concat_188" = load [22 x i8], [22 x i8]* %"$concat_187", align 1
  store [22 x i8] %"$concat_188", [22 x i8]* %bystrx, align 1, !dbg !17
...
"$have_gas_197":                                  ; preds = %"$out_of_gas_196", %"$have_gas_192"
  ...
  %"$to_bystr_call_203" = call %Bystr @_to_bystr(i8* %"$execptr_load_199", i32 2, i8* %"$$to_bystr_x_200_202"), !dbg !18
  store %Bystr %"$to_bystr_call_203", %Bystr* %xbs, align 8, !dbg !18
...
"$have_gas_212":                                  ; preds = %"$out_of_gas_211", %"$have_gas_207"
  ...
  %"$to_bystr_call_218" = call %Bystr @_to_bystr(i8* %"$execptr_load_214", i32 2, i8* %"$$to_bystr_y_215_217"), !dbg !19
  store %Bystr %"$to_bystr_call_218", %Bystr* %ybs, align 8, !dbg !19
...
"$have_gas_236":                                  ; preds = %"$out_of_gas_235", %"$have_gas_222"
  ...
  %"$concat_call_241" = call %Bystr @_concat_ByStr(i8* %"$execptr_load_238", %Bystr %"$xbs_239", %Bystr %"$ybs_240"), !dbg !20
  store %Bystr %"$concat_call_241", %Bystr* %xybs, align 8, !dbg !20
...
"$have_gas_250":                                  ; preds = %"$out_of_gas_249", %"$have_gas_245"
  ...
  %"$to_bystr_call_256" = call %Bystr @_to_bystr(i8* %"$execptr_load_252", i32 4, i8* %"$$to_bystr_z_253_255"), !dbg !21
  store %Bystr %"$to_bystr_call_256", %Bystr* %zbs, align 8, !dbg !21
...
"$have_gas_269":                                  ; preds = %"$out_of_gas_268", %"$have_gas_260"
  ...
  %"$eq_call_274" = call %TName_Bool* @_eq_ByStr(i8* %"$execptr_load_271", %Bystr %"$xybs_272", %Bystr %"$zbs_273"), !dbg !22
  store %TName_Bool* %"$eq_call_274", %TName_Bool** %res1, align 8, !dbg !22
...
"$have_gas_284":                                  ; preds = %"$out_of_gas_283", %"$have_gas_279"
  ...
  store %TName_Pair_String_ByStr22* %"$adtptr_292", %TName_Pair_String_ByStr22** %res2, align 8, !dbg !23
...
"$have_gas_301":                                  ; preds = %"$out_of_gas_300", %"$have_gas_296"
  ...
  store %"TName_Pair_Bool_Pair_(String)_(ByStr22)"* %"$adtptr_309", %"TName_Pair_Bool_Pair_(String)_(ByStr22)"** %res3, align 8, !dbg !24
...
"$have_gas_313":                                  ; preds = %"$out_of_gas_312", %"$have_gas_301"
  ...
  store %"TName_Pair_Bool_Pair_(String)_(ByStr22)"* %"$res3_315", %"TName_Pair_Bool_Pair_(String)_(ByStr22)"** %"$expr_0", align 8, !dbg !25
