...
@"$TyDescr_ADT_Pair_String_ByStr20_42" = unnamed_addr constant %_TyDescrTy_Typ { i32 1, i8* bitcast (%"$TyDescrTy_ADTTyp_Specl_38"* @"$TyDescr_Pair_String_ByStr20_ADTTyp_Specl_58" to i8*) }
...
@"$TyDescr_Pair_Pair_String_ByStr20_Constr_m_args_53" = unnamed_addr constant [2 x %_TyDescrTy_Typ*] [%_TyDescrTy_Typ* @"$TyDescr_String_25", %_TyDescrTy_Typ* @"$TyDescr_Bystr20_37"]
@"$TyDescr_ADT_Pair_54" = unnamed_addr constant [4 x i8] c"Pair"
@"$TyDescr_Pair_Pair_String_ByStr20_ADTTyp_Constr_55" = unnamed_addr constant %"$TyDescrTy_ADTTyp_Constr_40" { %TyDescrString { i8* getelementptr inbounds ([4 x i8], [4 x i8]* @"$TyDescr_ADT_Pair_54", i32 0, i32 0), i32 4 }, i32 2, %_TyDescrTy_Typ** getelementptr inbounds ([2 x %_TyDescrTy_Typ*], [2 x %_TyDescrTy_Typ*]* @"$TyDescr_Pair_Pair_String_ByStr20_Constr_m_args_53", i32 0, i32 0) }
@"$TyDescr_Pair_String_ByStr20_ADTTyp_Specl_m_constrs_56" = unnamed_addr constant [1 x %"$TyDescrTy_ADTTyp_Constr_40"*] [%"$TyDescrTy_ADTTyp_Constr_40"* @"$TyDescr_Pair_Pair_String_ByStr20_ADTTyp_Constr_55"]
@"$TyDescr_Pair_String_ByStr20_ADTTyp_Specl_m_TArgs_57" = unnamed_addr constant [2 x %_TyDescrTy_Typ*] [%_TyDescrTy_Typ* @"$TyDescr_String_25", %_TyDescrTy_Typ* @"$TyDescr_Bystr20_37"]
@"$TyDescr_Pair_String_ByStr20_ADTTyp_Specl_58" = unnamed_addr constant %"$TyDescrTy_ADTTyp_Specl_38" { %_TyDescrTy_Typ** getelementptr inbounds ([2 x %_TyDescrTy_Typ*], [2 x %_TyDescrTy_Typ*]* @"$TyDescr_Pair_String_ByStr20_ADTTyp_Specl_m_TArgs_57", i32 0, i32 0), %"$TyDescrTy_ADTTyp_Constr_40"** getelementptr inbounds ([1 x %"$TyDescrTy_ADTTyp_Constr_40"*], [1 x %"$TyDescrTy_ADTTyp_Constr_40"*]* @"$TyDescr_Pair_String_ByStr20_ADTTyp_Specl_m_constrs_56", i32 0, i32 0), %"$TyDescrTy_ADTTyp_39"* @"$TyDescr_Pair_ADTTyp_46" }
@"$TyDescr_Pair_ADTTyp_m_specls_59" = unnamed_addr constant [2 x %"$TyDescrTy_ADTTyp_Specl_38"*] [%"$TyDescrTy_ADTTyp_Specl_38"* @"$TyDescr_Pair_ByStr_Int32_ADTTyp_Specl_52", %"$TyDescrTy_ADTTyp_Specl_38"* @"$TyDescr_Pair_String_ByStr20_ADTTyp_Specl_58"]
...
@_tydescr_table = constant [17 x %_TyDescrTy_Typ*] [%_TyDescrTy_Typ* @"$TyDescr_Event_31", %_TyDescrTy_Typ* @"$TyDescr_Int64_13", %_TyDescrTy_Typ* @"$TyDescr_ADT_Pair_String_ByStr20_42", %_TyDescrTy_Typ* @"$TyDescr_Bystr20_37", %_TyDescrTy_Typ* @"$TyDescr_Uint256_23", %_TyDescrTy_Typ* @"$TyDescr_Uint32_11", %_TyDescrTy_Typ* @"$TyDescr_Uint64_15", %_TyDescrTy_Typ* @"$TyDescr_Bnum_27", %_TyDescrTy_Typ* @"$TyDescr_Uint128_19", %_TyDescrTy_Typ* @"$TyDescr_ADT_Pair_ByStr_Int32_41", %_TyDescrTy_Typ* @"$TyDescr_Exception_33", %_TyDescrTy_Typ* @"$TyDescr_String_25", %_TyDescrTy_Typ* @"$TyDescr_Int256_21", %_TyDescrTy_Typ* @"$TyDescr_Int128_17", %_TyDescrTy_Typ* @"$TyDescr_Bystr_35", %_TyDescrTy_Typ* @"$TyDescr_Message_29", %_TyDescrTy_Typ* @"$TyDescr_Int32_9"]
...
"$have_gas_99":                                   ; preds = %"$out_of_gas_98", %"$have_gas_94"
  ...
  store %String { i8* getelementptr inbounds ([5 x i8], [5 x i8]* @"$stringlit_101", i32 0, i32 0), i32 5 }, %String* %s, align 8, !dbg !11
...
"$have_gas_105":                                  ; preds = %"$out_of_gas_104", %"$have_gas_99"
  ...
  %"$gasdivceil_112" = urem i64 %"$gasadd_111", 640
  %"$gasdivceil_113" = udiv i64 %"$gasadd_111", 640
...
"$have_gas_120":                                  ; preds = %"$out_of_gas_119", %"$have_gas_105"
  ...
  %"$ripemd160hash_s_123" = alloca %String, align 8
  %"$s_124" = load %String, %String* %s, align 8
  store %String %"$s_124", %String* %"$ripemd160hash_s_123", align 8
  %"$$ripemd160hash_s_123_125" = bitcast %String* %"$ripemd160hash_s_123" to i8*
  %"$ripemd160hash_call_126" = call [20 x i8]* @_ripemd160hash(i8* %"$execptr_load_122", %_TyDescrTy_Typ* @"$TyDescr_String_25", i8* %"$$ripemd160hash_s_123_125"), !dbg !12
  %"$ripemd160hash_128" = load [20 x i8], [20 x i8]* %"$ripemd160hash_call_126", align 1
  store [20 x i8] %"$ripemd160hash_128", [20 x i8]* %h1, align 1, !dbg !12
...
"$have_gas_132":                                  ; preds = %"$out_of_gas_131", %"$have_gas_120"
  ...
  %"$_literal_cost_h1_134" = alloca [20 x i8], align 1
  %"$h1_135" = load [20 x i8], [20 x i8]* %h1, align 1
  store [20 x i8] %"$h1_135", [20 x i8]* %"$_literal_cost_h1_134", align 1
  %"$$_literal_cost_h1_134_136" = bitcast [20 x i8]* %"$_literal_cost_h1_134" to i8*
  %"$_literal_cost_call_137" = call i64 @_literal_cost(%_TyDescrTy_Typ* @"$TyDescr_Bystr20_37", i8* %"$$_literal_cost_h1_134_136")
  %"$gasadd_138" = add i64 %"$_literal_cost_call_137", 0
  %"$gasdivceil_139" = urem i64 %"$gasadd_138", 640
  %"$gasdivceil_140" = udiv i64 %"$gasadd_138", 640
...
"$have_gas_147":                                  ; preds = %"$out_of_gas_146", %"$have_gas_132"
  ...
  %"$ripemd160hash_h1_150" = alloca [20 x i8], align 1
  %"$h1_151" = load [20 x i8], [20 x i8]* %h1, align 1
  store [20 x i8] %"$h1_151", [20 x i8]* %"$ripemd160hash_h1_150", align 1
  %"$$ripemd160hash_h1_150_152" = bitcast [20 x i8]* %"$ripemd160hash_h1_150" to i8*
  %"$ripemd160hash_call_153" = call [20 x i8]* @_ripemd160hash(i8* %"$execptr_load_149", %_TyDescrTy_Typ* @"$TyDescr_Bystr20_37", i8* %"$$ripemd160hash_h1_150_152"), !dbg !13
  %"$ripemd160hash_155" = load [20 x i8], [20 x i8]* %"$ripemd160hash_call_153", align 1
  store [20 x i8] %"$ripemd160hash_155", [20 x i8]* %h2, align 1, !dbg !13
...
"$have_gas_164":                                  ; preds = %"$out_of_gas_163", %"$have_gas_159"
  ...
  %"$h2_167" = load [20 x i8], [20 x i8]* %h2, align 1
  %"$adtval_168_load" = load i8*, i8** @_execptr, align 8
  %"$adtval_168_salloc" = call i8* @_salloc(i8* %"$adtval_168_load", i64 37)
  %"$adtval_168" = bitcast i8* %"$adtval_168_salloc" to %CName_Pair_String_ByStr20*
  %"$adtgep_169" = getelementptr inbounds %CName_Pair_String_ByStr20, %CName_Pair_String_ByStr20* %"$adtval_168", i32 0, i32 0
  store i8 0, i8* %"$adtgep_169", align 1
  %"$adtgep_170" = getelementptr inbounds %CName_Pair_String_ByStr20, %CName_Pair_String_ByStr20* %"$adtval_168", i32 0, i32 1
  store %String %"$s_166", %String* %"$adtgep_170", align 8
  %"$adtgep_171" = getelementptr inbounds %CName_Pair_String_ByStr20, %CName_Pair_String_ByStr20* %"$adtval_168", i32 0, i32 2
  store [20 x i8] %"$h2_167", [20 x i8]* %"$adtgep_171", align 1
  %"$adtptr_172" = bitcast %CName_Pair_String_ByStr20* %"$adtval_168" to %TName_Pair_String_ByStr20*
  store %TName_Pair_String_ByStr20* %"$adtptr_172", %TName_Pair_String_ByStr20** %sh, align 8, !dbg !14
...
"$have_gas_176":                                  ; preds = %"$out_of_gas_175", %"$have_gas_164"
  ...
  %"$sh_178" = load %TName_Pair_String_ByStr20*, %TName_Pair_String_ByStr20** %sh, align 8
  %"$$sh_178_179" = bitcast %TName_Pair_String_ByStr20* %"$sh_178" to i8*
  %"$_literal_cost_call_180" = call i64 @_literal_cost(%_TyDescrTy_Typ* @"$TyDescr_ADT_Pair_String_ByStr20_42", i8* %"$$sh_178_179")
  %"$gasadd_181" = add i64 %"$_literal_cost_call_180", 0
  %"$gasdivceil_182" = urem i64 %"$gasadd_181", 640
  %"$gasdivceil_183" = udiv i64 %"$gasadd_181", 640
...
"$have_gas_190":                                  ; preds = %"$out_of_gas_189", %"$have_gas_176"
  ...
  %"$sh_193" = load %TName_Pair_String_ByStr20*, %TName_Pair_String_ByStr20** %sh, align 8
  %"$$sh_193_194" = bitcast %TName_Pair_String_ByStr20* %"$sh_193" to i8*
  %"$ripemd160hash_call_195" = call [20 x i8]* @_ripemd160hash(i8* %"$execptr_load_192", %_TyDescrTy_Typ* @"$TyDescr_ADT_Pair_String_ByStr20_42", i8* %"$$sh_193_194"), !dbg !15
  %"$ripemd160hash_197" = load [20 x i8], [20 x i8]* %"$ripemd160hash_call_195", align 1
  store [20 x i8] %"$ripemd160hash_197", [20 x i8]* %sh2, align 1, !dbg !15
...
"$have_gas_201":                                  ; preds = %"$out_of_gas_200", %"$have_gas_190"
  ...
  %"$gascmp_204" = icmp ugt i64 20, %"$gasrem_203"
...
"$have_gas_206":                                  ; preds = %"$out_of_gas_205", %"$have_gas_201"
  %"$consume_207" = sub i64 %"$gasrem_203", 20
  store i64 %"$consume_207", i64* @_gasrem, align 8
  %"$execptr_load_208" = load i8*, i8** @_execptr, align 8
  %"$to_bystr_sh2_209" = alloca [20 x i8], align 1
  %"$sh2_210" = load [20 x i8], [20 x i8]* %sh2, align 1
  store [20 x i8] %"$sh2_210", [20 x i8]* %"$to_bystr_sh2_209", align 1
  %"$$to_bystr_sh2_209_211" = bitcast [20 x i8]* %"$to_bystr_sh2_209" to i8*
  %"$to_bystr_call_212" = call %Bystr @_to_bystr(i8* %"$execptr_load_208", i32 20, i8* %"$$to_bystr_sh2_209_211"), !dbg !16
  store %Bystr %"$to_bystr_call_212", %Bystr* %bystr1, align 8, !dbg !16
...
"$have_gas_221":                                  ; preds = %"$out_of_gas_220", %"$have_gas_216"
  ...
  store %Int32 { i32 4 }, %Int32* %i4, align 4, !dbg !17
...
"$have_gas_231":                                  ; preds = %"$out_of_gas_230", %"$have_gas_226"
  ...
  store %TName_Pair_ByStr_Int32* %"$adtptr_239", %TName_Pair_ByStr_Int32** %p2, align 8, !dbg !18
  ...
  %"$gasdivceil_244" = urem i64 %"$gasadd_243", 640
  %"$gasdivceil_245" = udiv i64 %"$gasadd_243", 640
...
"$have_gas_252":                                  ; preds = %"$out_of_gas_251", %"$have_gas_231"
  ...
  %"$ripemd160hash_call_257" = call [20 x i8]* @_ripemd160hash(i8* %"$execptr_load_254", %_TyDescrTy_Typ* @"$TyDescr_ADT_Pair_ByStr_Int32_41", i8* %"$$p2_255_256"), !dbg !19
  %"$ripemd160hash_259" = load [20 x i8], [20 x i8]* %"$ripemd160hash_call_257", align 1
  store [20 x i8] %"$ripemd160hash_259", [20 x i8]* %"$expr_6", align 1, !dbg !19
  %"$$expr_6_260" = load [20 x i8], [20 x i8]* %"$expr_6", align 1
  store [20 x i8] %"$$expr_6_260", [20 x i8]* %1, align 1
  ret void
}
...
entry:
  %"$mainval_261" = alloca [20 x i8], align 1
  %"$memvoidcast_262" = bitcast [20 x i8]* %"$mainval_261" to i8*
  call void @_scilla_expr_fun(i8* null, [20 x i8]* %"$mainval_261")
  %"$execptr_load_263" = load i8*, i8** @_execptr, align 8
  call void @_print_scilla_val(i8* %"$execptr_load_263", %_TyDescrTy_Typ* @"$TyDescr_Bystr20_37", i8* %"$memvoidcast_262")
  ret void
}
...
!17 = !DILocation(line: 7, column: 10, scope: !10)
