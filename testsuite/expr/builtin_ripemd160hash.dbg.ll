...
"$have_gas_69":                                   ; preds = %"$out_of_gas_68", %"$have_gas_63"
  ...
  store [20 x i8] %"$ripemd160hash_76", [20 x i8]* %h1, align 1, !dbg !11
...
"$have_gas_80":                                   ; preds = %"$out_of_gas_79", %"$have_gas_69"
  ...
  store [20 x i8] %"$ripemd160hash_87", [20 x i8]* %h2, align 1, !dbg !12
...
"$have_gas_96":                                   ; preds = %"$out_of_gas_95", %"$have_gas_91"
  ...
  store %TName_Pair_String_ByStr20* %"$adtptr_104", %TName_Pair_String_ByStr20** %sh, align 8, !dbg !13
...
"$have_gas_108":                                  ; preds = %"$out_of_gas_107", %"$have_gas_96"
  ...
  store [20 x i8] %"$ripemd160hash_114", [20 x i8]* %sh2, align 1, !dbg !14
...
"$have_gas_143":                                  ; preds = %"$out_of_gas_142", %"$have_gas_138"
  ...
  store [20 x i8] %"$ripemd160hash_156", [20 x i8]* %"$expr_0", align 1, !dbg !18
...
entry:
  ...
  call void @_print_scilla_val(i8* %"$execptr_load_160", %_TyDescrTy_Typ* @"$TyDescr_Bystr20_31", i8* %"$memvoidcast_159")
  ret void
}
