...
define internal %TName_Bool* @"$fundef_36"(%"$$fundef_36_env_99"* %0, %TName_Bool* %1) {
entry:
...
"$have_gas_200":                                  ; preds = %"$out_of_gas_199", %"$True_195"
  ...
  store %TName_Bool* %"$adtptr_204", %TName_Bool** %"$retval_37", align 8
...
"$have_gas_210":                                  ; preds = %"$out_of_gas_209", %"$False_205"
  ...
  store %TName_Bool* %"$adtptr_214", %TName_Bool** %"$retval_37", align 8
  br label %"$matchsucc_191"
...
define internal %TName_Bool* @"$fundef_40"(%"$$fundef_40_env_100"* %0, %TName_Bool* %1) {
entry:
...
"$have_gas_173":                                  ; preds = %"$out_of_gas_172", %"$True_168"
  ...
  store %TName_Bool* %"$adtptr_177", %TName_Bool** %"$retval_41", align 8
...
define internal { %TName_Bool* (i8*, %TName_Bool*)*, i8* } @"$fundef_38"(%"$$fundef_38_env_101"* %0, %TName_Bool* %1) {
entry:
...
"$have_gas_148":                                  ; preds = %"$out_of_gas_147", %entry
  ...
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$$fundef_40_cloval_153", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$retval_39", align 8
...
define internal %TName_Bool* @"$fundef_44"(%"$$fundef_44_env_102"* %0, %TName_Bool* %1) {
entry:
...
"$have_gas_132":                                  ; preds = %"$out_of_gas_131", %"$False_127"
  ...
  store %TName_Bool* %"$adtptr_136", %TName_Bool** %"$retval_45", align 8
...
define internal { %TName_Bool* (i8*, %TName_Bool*)*, i8* } @"$fundef_42"(%"$$fundef_42_env_103"* %0, %TName_Bool* %1) {
entry:
...
"$have_gas_107":                                  ; preds = %"$out_of_gas_106", %entry
  ...
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$$fundef_44_cloval_112", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$retval_43", align 8
...
"$have_gas_229":                                  ; preds = %"$out_of_gas_228", %"$have_gas_224"
  ...
  store { { %TName_Bool* (i8*, %TName_Bool*)*, i8* } (i8*, %TName_Bool*)*, i8* } { { %TName_Bool* (i8*, %TName_Bool*)*, i8* } (i8*, %TName_Bool*)* bitcast ({ %TName_Bool* (i8*, %TName_Bool*)*, i8* } (%"$$fundef_42_env_103"*, %TName_Bool*)* @"$fundef_42" to { %TName_Bool* (i8*, %TName_Bool*)*, i8* } (i8*, %TName_Bool*)*), i8* null }, { { %TName_Bool* (i8*, %TName_Bool*)*, i8* } (i8*, %TName_Bool*)*, i8* }* @BoolUtils.andb, align 8
...
"$have_gas_237":                                  ; preds = %"$out_of_gas_236", %"$have_gas_229"
  ...
  store { { %TName_Bool* (i8*, %TName_Bool*)*, i8* } (i8*, %TName_Bool*)*, i8* } { { %TName_Bool* (i8*, %TName_Bool*)*, i8* } (i8*, %TName_Bool*)* bitcast ({ %TName_Bool* (i8*, %TName_Bool*)*, i8* } (%"$$fundef_38_env_101"*, %TName_Bool*)* @"$fundef_38" to { %TName_Bool* (i8*, %TName_Bool*)*, i8* } (i8*, %TName_Bool*)*), i8* null }, { { %TName_Bool* (i8*, %TName_Bool*)*, i8* } (i8*, %TName_Bool*)*, i8* }* @BoolUtils.orb, align 8
...
"$have_gas_245":                                  ; preds = %"$out_of_gas_244", %"$have_gas_237"
  ...
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } { %TName_Bool* (i8*, %TName_Bool*)* bitcast (%TName_Bool* (%"$$fundef_36_env_99"*, %TName_Bool*)* @"$fundef_36" to %TName_Bool* (i8*, %TName_Bool*)*), i8* null }, { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* @BoolUtils.negb, align 8
...
"$have_gas_308":                                  ; preds = %"$out_of_gas_307", %"$have_gas_303"
  ...
  %"$eq_call_313" = call %TName_Bool* @_eq_Int32(i8* %"$execptr_load_310", %Int32 %"$i32a_311", %Int32 %"$i32aa_312")
  store %TName_Bool* %"$eq_call_313", %TName_Bool** %b1, align 8
...
"$have_gas_323":                                  ; preds = %"$out_of_gas_322", %"$have_gas_318"
  ...
  %"$eq_call_328" = call %TName_Bool* @_eq_Int32(i8* %"$execptr_load_325", %Int32 %"$i32a_326", %Int32 %"$i32b_327")
  store %TName_Bool* %"$eq_call_328", %TName_Bool** %b2, align 8
...
"$have_gas_369":                                  ; preds = %"$out_of_gas_368", %"$have_gas_363"
  ...
  %"$eq_call_374" = call %TName_Bool* @_eq_Uint128(i8* %"$execptr_load_371", %Uint128 %"$i128a_372", %Uint128 %"$i128b_373")
  store %TName_Bool* %"$eq_call_374", %TName_Bool** %b3, align 8
...
"$have_gas_385":                                  ; preds = %"$out_of_gas_384", %"$have_gas_379"
  ...
  %"$eq_call_390" = call %TName_Bool* @_eq_Uint128(i8* %"$execptr_load_387", %Uint128 %"$i128a_388", %Uint128 %"$i128a_389")
  store %TName_Bool* %"$eq_call_390", %TName_Bool** %b4, align 8
...
"$have_gas_400":                                  ; preds = %"$out_of_gas_399", %"$have_gas_395"
  ...
  %"$BoolUtils.andb_call_406" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_fptr_403"(i8* %"$BoolUtils.andb_envptr_404", %TName_Bool* %"$b1_405")
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_call_406", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.andb_7", align 8
  ...
  %"$$BoolUtils.andb_7_call_411" = call %TName_Bool* %"$$BoolUtils.andb_7_fptr_408"(i8* %"$$BoolUtils.andb_7_envptr_409", %TName_Bool* %"$b2_410")
  store %TName_Bool* %"$$BoolUtils.andb_7_call_411", %TName_Bool** %"$BoolUtils.andb_8", align 8
  %"$$BoolUtils.andb_8_412" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.andb_8", align 8
  store %TName_Bool* %"$$BoolUtils.andb_8_412", %TName_Bool** %b5, align 8
...
"$have_gas_421":                                  ; preds = %"$out_of_gas_420", %"$have_gas_416"
  ...
  %"$BoolUtils.orb_call_427" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.orb_fptr_424"(i8* %"$BoolUtils.orb_envptr_425", %TName_Bool* %"$b3_426")
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.orb_call_427", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.orb_9", align 8
  ...
  %"$$BoolUtils.orb_9_call_432" = call %TName_Bool* %"$$BoolUtils.orb_9_fptr_429"(i8* %"$$BoolUtils.orb_9_envptr_430", %TName_Bool* %"$b4_431")
  store %TName_Bool* %"$$BoolUtils.orb_9_call_432", %TName_Bool** %"$BoolUtils.orb_10", align 8
  %"$$BoolUtils.orb_10_433" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.orb_10", align 8
  store %TName_Bool* %"$$BoolUtils.orb_10_433", %TName_Bool** %b6, align 8
...
"$have_gas_442":                                  ; preds = %"$out_of_gas_441", %"$have_gas_437"
  ...
  %"$BoolUtils.andb_call_448" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_fptr_445"(i8* %"$BoolUtils.andb_envptr_446", %TName_Bool* %"$b5_447")
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_call_448", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.andb_11", align 8
  ...
  %"$$BoolUtils.andb_11_call_453" = call %TName_Bool* %"$$BoolUtils.andb_11_fptr_450"(i8* %"$$BoolUtils.andb_11_envptr_451", %TName_Bool* %"$b6_452")
  store %TName_Bool* %"$$BoolUtils.andb_11_call_453", %TName_Bool** %"$BoolUtils.andb_12", align 8
  %"$$BoolUtils.andb_12_454" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.andb_12", align 8
  store %TName_Bool* %"$$BoolUtils.andb_12_454", %TName_Bool** %b7, align 8
...
"$have_gas_494":                                  ; preds = %"$out_of_gas_493", %"$have_gas_488"
  ...
  %"$eq_call_499" = call %TName_Bool* @_eq_Uint128(i8* %"$execptr_load_496", %Uint128 %"$ui256a_497", %Uint128 %"$ui256b_498")
  store %TName_Bool* %"$eq_call_499", %TName_Bool** %b8, align 8
...
"$have_gas_510":                                  ; preds = %"$out_of_gas_509", %"$have_gas_504"
  ...
  %"$eq_call_515" = call %TName_Bool* @_eq_Uint128(i8* %"$execptr_load_512", %Uint128 %"$ui256a_513", %Uint128 %"$ui256a_514")
  store %TName_Bool* %"$eq_call_515", %TName_Bool** %b9, align 8
...
"$have_gas_525":                                  ; preds = %"$out_of_gas_524", %"$have_gas_520"
  ...
  %"$BoolUtils.andb_call_531" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_fptr_528"(i8* %"$BoolUtils.andb_envptr_529", %TName_Bool* %"$b7_530")
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_call_531", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.andb_13", align 8
  ...
  %"$$BoolUtils.andb_13_call_536" = call %TName_Bool* %"$$BoolUtils.andb_13_fptr_533"(i8* %"$$BoolUtils.andb_13_envptr_534", %TName_Bool* %"$b8_535")
  store %TName_Bool* %"$$BoolUtils.andb_13_call_536", %TName_Bool** %"$BoolUtils.andb_14", align 8
  %"$$BoolUtils.andb_14_537" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.andb_14", align 8
  store %TName_Bool* %"$$BoolUtils.andb_14_537", %TName_Bool** %b10, align 8
...
"$have_gas_546":                                  ; preds = %"$out_of_gas_545", %"$have_gas_541"
  ...
  %"$BoolUtils.orb_call_552" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.orb_fptr_549"(i8* %"$BoolUtils.orb_envptr_550", %TName_Bool* %"$b10_551")
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.orb_call_552", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.orb_15", align 8
  ...
  %"$$BoolUtils.orb_15_call_557" = call %TName_Bool* %"$$BoolUtils.orb_15_fptr_554"(i8* %"$$BoolUtils.orb_15_envptr_555", %TName_Bool* %"$b9_556")
  store %TName_Bool* %"$$BoolUtils.orb_15_call_557", %TName_Bool** %"$BoolUtils.orb_16", align 8
  %"$$BoolUtils.orb_16_558" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.orb_16", align 8
  store %TName_Bool* %"$$BoolUtils.orb_16_558", %TName_Bool** %b11, align 8
...
"$have_gas_567":                                  ; preds = %"$out_of_gas_566", %"$have_gas_562"
  ...
  store %String { i8* getelementptr inbounds ([5 x i8], [5 x i8]* @"$stringlit_569", i32 0, i32 0), i32 5 }, %String* %s1, align 8
...
"$have_gas_578":                                  ; preds = %"$out_of_gas_577", %"$have_gas_573"
  ...
  store %String { i8* getelementptr inbounds ([5 x i8], [5 x i8]* @"$stringlit_580", i32 0, i32 0), i32 5 }, %String* %s2, align 8
...
"$have_gas_589":                                  ; preds = %"$out_of_gas_588", %"$have_gas_584"
  ...
  store %String { i8* getelementptr inbounds ([5 x i8], [5 x i8]* @"$stringlit_591", i32 0, i32 0), i32 5 }, %String* %s11, align 8
...
"$have_gas_609":                                  ; preds = %"$out_of_gas_608", %"$have_gas_595"
  ...
  %"$eq_call_614" = call %TName_Bool* @_eq_String(i8* %"$execptr_load_611", %String %"$s1_612", %String %"$s2_613")
  store %TName_Bool* %"$eq_call_614", %TName_Bool** %b12, align 8
...
"$have_gas_633":                                  ; preds = %"$out_of_gas_632", %"$have_gas_619"
  ...
  %"$eq_call_638" = call %TName_Bool* @_eq_String(i8* %"$execptr_load_635", %String %"$s1_636", %String %"$s11_637")
  store %TName_Bool* %"$eq_call_638", %TName_Bool** %b13, align 8
...
"$have_gas_648":                                  ; preds = %"$out_of_gas_647", %"$have_gas_643"
  ...
  %"$BoolUtils.andb_call_654" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_fptr_651"(i8* %"$BoolUtils.andb_envptr_652", %TName_Bool* %"$b9_653")
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_call_654", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.andb_17", align 8
  ...
  %"$$BoolUtils.andb_17_call_659" = call %TName_Bool* %"$$BoolUtils.andb_17_fptr_656"(i8* %"$$BoolUtils.andb_17_envptr_657", %TName_Bool* %"$b12_658")
  store %TName_Bool* %"$$BoolUtils.andb_17_call_659", %TName_Bool** %"$BoolUtils.andb_18", align 8
  %"$$BoolUtils.andb_18_660" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.andb_18", align 8
  store %TName_Bool* %"$$BoolUtils.andb_18_660", %TName_Bool** %b14, align 8
...
"$have_gas_669":                                  ; preds = %"$out_of_gas_668", %"$have_gas_664"
  ...
  %"$BoolUtils.orb_call_675" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.orb_fptr_672"(i8* %"$BoolUtils.orb_envptr_673", %TName_Bool* %"$b13_674")
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.orb_call_675", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.orb_19", align 8
  ...
  %"$$BoolUtils.orb_19_call_680" = call %TName_Bool* %"$$BoolUtils.orb_19_fptr_677"(i8* %"$$BoolUtils.orb_19_envptr_678", %TName_Bool* %"$b14_679")
  store %TName_Bool* %"$$BoolUtils.orb_19_call_680", %TName_Bool** %"$BoolUtils.orb_20", align 8
  %"$$BoolUtils.orb_20_681" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.orb_20", align 8
  store %TName_Bool* %"$$BoolUtils.orb_20_681", %TName_Bool** %b15, align 8
...
"$have_gas_720":                                  ; preds = %"$out_of_gas_719", %"$have_gas_715"
  ...
  %"$eq_call_729" = call %TName_Bool* @_eq_ByStrX(i8* %"$execptr_load_722", i32 2, i8* %"$$eq_bs1_723_725", i8* %"$$eq_bs2_726_728")
  store %TName_Bool* %"$eq_call_729", %TName_Bool** %b16, align 8
...
"$have_gas_739":                                  ; preds = %"$out_of_gas_738", %"$have_gas_734"
  ...
  %"$eq_call_748" = call %TName_Bool* @_eq_ByStrX(i8* %"$execptr_load_741", i32 2, i8* %"$$eq_bs1_742_744", i8* %"$$eq_bs11_745_747")
  store %TName_Bool* %"$eq_call_748", %TName_Bool** %b17, align 8
...
"$have_gas_758":                                  ; preds = %"$out_of_gas_757", %"$have_gas_753"
  ...
  %"$BoolUtils.orb_call_764" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.orb_fptr_761"(i8* %"$BoolUtils.orb_envptr_762", %TName_Bool* %"$b16_763")
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.orb_call_764", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.orb_21", align 8
  ...
  %"$$BoolUtils.orb_21_call_769" = call %TName_Bool* %"$$BoolUtils.orb_21_fptr_766"(i8* %"$$BoolUtils.orb_21_envptr_767", %TName_Bool* %"$b17_768")
  store %TName_Bool* %"$$BoolUtils.orb_21_call_769", %TName_Bool** %"$BoolUtils.orb_22", align 8
  %"$$BoolUtils.orb_22_770" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.orb_22", align 8
  store %TName_Bool* %"$$BoolUtils.orb_22_770", %TName_Bool** %b18, align 8
...
"$have_gas_779":                                  ; preds = %"$out_of_gas_778", %"$have_gas_774"
  ...
  %"$BoolUtils.andb_call_785" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_fptr_782"(i8* %"$BoolUtils.andb_envptr_783", %TName_Bool* %"$b18_784")
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_call_785", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.andb_23", align 8
  ...
  %"$$BoolUtils.andb_23_call_790" = call %TName_Bool* %"$$BoolUtils.andb_23_fptr_787"(i8* %"$$BoolUtils.andb_23_envptr_788", %TName_Bool* %"$b15_789")
  store %TName_Bool* %"$$BoolUtils.andb_23_call_790", %TName_Bool** %"$BoolUtils.andb_24", align 8
  %"$$BoolUtils.andb_24_791" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.andb_24", align 8
  store %TName_Bool* %"$$BoolUtils.andb_24_791", %TName_Bool** %b19, align 8
...
"$have_gas_820":                                  ; preds = %"$out_of_gas_819", %"$have_gas_815"
  ...
  %"$eq_call_829" = call %TName_Bool* @_eq_ByStrX(i8* %"$execptr_load_822", i32 3, i8* %"$$eq_bs3_823_825", i8* %"$$eq_bs4_826_828")
  store %TName_Bool* %"$eq_call_829", %TName_Bool** %b20, align 8
...
"$have_gas_839":                                  ; preds = %"$out_of_gas_838", %"$have_gas_834"
  ...
  %"$BoolUtils.negb_call_845" = call %TName_Bool* %"$BoolUtils.negb_fptr_842"(i8* %"$BoolUtils.negb_envptr_843", %TName_Bool* %"$b20_844")
  store %TName_Bool* %"$BoolUtils.negb_call_845", %TName_Bool** %"$BoolUtils.negb_25", align 8
  %"$$BoolUtils.negb_25_846" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.negb_25", align 8
  store %TName_Bool* %"$$BoolUtils.negb_25_846", %TName_Bool** %b21, align 8
...
"$have_gas_855":                                  ; preds = %"$out_of_gas_854", %"$have_gas_850"
  ...
  %"$BoolUtils.andb_call_861" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_fptr_858"(i8* %"$BoolUtils.andb_envptr_859", %TName_Bool* %"$b19_860")
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_call_861", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.andb_26", align 8
  ...
  %"$$BoolUtils.andb_26_call_866" = call %TName_Bool* %"$$BoolUtils.andb_26_fptr_863"(i8* %"$$BoolUtils.andb_26_envptr_864", %TName_Bool* %"$b21_865")
  store %TName_Bool* %"$$BoolUtils.andb_26_call_866", %TName_Bool** %"$BoolUtils.andb_27", align 8
  %"$$BoolUtils.andb_27_867" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.andb_27", align 8
  store %TName_Bool* %"$$BoolUtils.andb_27_867", %TName_Bool** %b22, align 8
...
"$have_gas_876":                                  ; preds = %"$out_of_gas_875", %"$have_gas_871"
  ...
  %"$to_bystr_call_882" = call %Bystr @_to_bystr(i8* %"$execptr_load_878", i32 2, i8* %"$$to_bystr_bs1_879_881")
  store %Bystr %"$to_bystr_call_882", %Bystr* %"$bs11_6", align 8
...
"$have_gas_891":                                  ; preds = %"$out_of_gas_890", %"$have_gas_886"
  ...
  %"$to_bystr_call_897" = call %Bystr @_to_bystr(i8* %"$execptr_load_893", i32 2, i8* %"$$to_bystr_bs2_894_896")
  store %Bystr %"$to_bystr_call_897", %Bystr* %bs22, align 8
...
"$have_gas_910":                                  ; preds = %"$out_of_gas_909", %"$have_gas_901"
  ...
  %"$eq_call_915" = call %TName_Bool* @_eq_ByStr(i8* %"$execptr_load_912", %Bystr %"$$bs11_6_913", %Bystr %"$bs22_914")
  store %TName_Bool* %"$eq_call_915", %TName_Bool** %b23, align 8
...
"$have_gas_925":                                  ; preds = %"$out_of_gas_924", %"$have_gas_920"
  ...
  %"$BoolUtils.negb_call_931" = call %TName_Bool* %"$BoolUtils.negb_fptr_928"(i8* %"$BoolUtils.negb_envptr_929", %TName_Bool* %"$b23_930")
  store %TName_Bool* %"$BoolUtils.negb_call_931", %TName_Bool** %"$BoolUtils.negb_28", align 8
  %"$$BoolUtils.negb_28_932" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.negb_28", align 8
  store %TName_Bool* %"$$BoolUtils.negb_28_932", %TName_Bool** %b24, align 8
...
"$have_gas_941":                                  ; preds = %"$out_of_gas_940", %"$have_gas_936"
  ...
  %"$BoolUtils.andb_call_947" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_fptr_944"(i8* %"$BoolUtils.andb_envptr_945", %TName_Bool* %"$b22_946")
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_call_947", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.andb_29", align 8
  ...
  %"$$BoolUtils.andb_29_call_952" = call %TName_Bool* %"$$BoolUtils.andb_29_fptr_949"(i8* %"$$BoolUtils.andb_29_envptr_950", %TName_Bool* %"$b24_951")
  store %TName_Bool* %"$$BoolUtils.andb_29_call_952", %TName_Bool** %"$BoolUtils.andb_30", align 8
  %"$$BoolUtils.andb_30_953" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.andb_30", align 8
  store %TName_Bool* %"$$BoolUtils.andb_30_953", %TName_Bool** %b25, align 8
...
"$have_gas_962":                                  ; preds = %"$out_of_gas_961", %"$have_gas_957"
  ...
  store i8* %"$_new_bnum_call_966", i8** %bn1, align 8
...
"$have_gas_976":                                  ; preds = %"$out_of_gas_975", %"$have_gas_971"
  ...
  store i8* %"$_new_bnum_call_980", i8** %bn2, align 8
...
"$have_gas_990":                                  ; preds = %"$out_of_gas_989", %"$have_gas_985"
  ...
  store i8* %"$_new_bnum_call_994", i8** %bn3, align 8
...
"$have_gas_1004":                                 ; preds = %"$out_of_gas_1003", %"$have_gas_999"
  ...
  %"$eq_call_1009" = call %TName_Bool* @_eq_BNum(i8* %"$execptr_load_1006", i8* %"$bn1_1007", i8* %"$bn2_1008")
  store %TName_Bool* %"$eq_call_1009", %TName_Bool** %b26, align 8
...
"$have_gas_1019":                                 ; preds = %"$out_of_gas_1018", %"$have_gas_1014"
  ...
  %"$BoolUtils.negb_call_1025" = call %TName_Bool* %"$BoolUtils.negb_fptr_1022"(i8* %"$BoolUtils.negb_envptr_1023", %TName_Bool* %"$b26_1024")
  store %TName_Bool* %"$BoolUtils.negb_call_1025", %TName_Bool** %"$BoolUtils.negb_31", align 8
  %"$$BoolUtils.negb_31_1026" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.negb_31", align 8
  store %TName_Bool* %"$$BoolUtils.negb_31_1026", %TName_Bool** %b27, align 8
...
"$have_gas_1035":                                 ; preds = %"$out_of_gas_1034", %"$have_gas_1030"
  ...
  %"$eq_call_1040" = call %TName_Bool* @_eq_BNum(i8* %"$execptr_load_1037", i8* %"$bn1_1038", i8* %"$bn3_1039")
  store %TName_Bool* %"$eq_call_1040", %TName_Bool** %b28, align 8
...
"$have_gas_1050":                                 ; preds = %"$out_of_gas_1049", %"$have_gas_1045"
  ...
  %"$BoolUtils.andb_call_1056" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_fptr_1053"(i8* %"$BoolUtils.andb_envptr_1054", %TName_Bool* %"$b27_1055")
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_call_1056", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.andb_32", align 8
  ...
  %"$$BoolUtils.andb_32_call_1061" = call %TName_Bool* %"$$BoolUtils.andb_32_fptr_1058"(i8* %"$$BoolUtils.andb_32_envptr_1059", %TName_Bool* %"$b28_1060")
  store %TName_Bool* %"$$BoolUtils.andb_32_call_1061", %TName_Bool** %"$BoolUtils.andb_33", align 8
  %"$$BoolUtils.andb_33_1062" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.andb_33", align 8
  store %TName_Bool* %"$$BoolUtils.andb_33_1062", %TName_Bool** %b29, align 8
...
"$have_gas_1066":                                 ; preds = %"$out_of_gas_1065", %"$have_gas_1050"
  ...
  %"$BoolUtils.andb_call_1072" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_fptr_1069"(i8* %"$BoolUtils.andb_envptr_1070", %TName_Bool* %"$b25_1071")
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_call_1072", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.andb_34", align 8
  ...
  %"$$BoolUtils.andb_34_call_1077" = call %TName_Bool* %"$$BoolUtils.andb_34_fptr_1074"(i8* %"$$BoolUtils.andb_34_envptr_1075", %TName_Bool* %"$b29_1076")
  store %TName_Bool* %"$$BoolUtils.andb_34_call_1077", %TName_Bool** %"$BoolUtils.andb_35", align 8
  %"$$BoolUtils.andb_35_1078" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.andb_35", align 8
  store %TName_Bool* %"$$BoolUtils.andb_35_1078", %TName_Bool** %"$expr_46", align 8
