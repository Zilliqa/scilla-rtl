...
"$have_gas_82":                                   ; preds = %"$out_of_gas_81", %"$have_gas_77"
  ...
  store %String { i8* getelementptr inbounds ([11 x i8], [11 x i8]* @"$stringlit_84", i32 0, i32 0), i32 11 }, %String* %x, align 8
...
"$have_gas_120":                                  ; preds = %"$out_of_gas_119", %"$have_gas_103"
  ...
  %"$substr_call_126" = call %String @_substr_String(i8* %"$execptr_load_122", %String %"$x_123", %Uint32 %"$pos_124", %Uint32 %"$len_125")
  store %String %"$substr_call_126", %String* %"$expr_6", align 8
