...
"$have_gas_80":                                   ; preds = %"$out_of_gas_79", %"$have_gas_75"
  ...
  store %String { i8* getelementptr inbounds ([11 x i8], [11 x i8]* @"$stringlit_82", i32 0, i32 0), i32 11 }, %String* %x, align 8
...
"$have_gas_118":                                  ; preds = %"$out_of_gas_117", %"$have_gas_101"
  ...
  %"$substr_call_124" = call %String @_substr_String(i8* %"$execptr_load_120", %String %"$x_121", %Uint32 %"$pos_122", %Uint32 %"$len_123")
  store %String %"$substr_call_124", %String* %"$expr_6", align 8
