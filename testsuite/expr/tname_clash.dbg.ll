...
%"$ParamDescr_221" = type { %ParamDescrString, %_TyDescrTy_Typ* }
%ParamDescrString = type { i8*, i32 }
%"$TransDescr_222" = type { %ParamDescrString, i32, %"$ParamDescr_221"* }
...
@_contract_parameters = constant [0 x %"$ParamDescr_221"] zeroinitializer
@_contract_parameters_length = constant i32 0
@_transition_parameters = constant [0 x %"$TransDescr_222"] zeroinitializer
@_transition_parameters_length = constant i32 0

define internal { i8*, i8* }* @"$fundef_11"(%"$$fundef_11_env_58"* %0) !dbg !4 {
entry:
...
"$have_gas_114":                                  ; preds = %"$out_of_gas_113", %entry
  ...
  %"$tf_call_122" = call { i8*, i8* }* %"$tf_fptr_120"(i8* %"$tf_envptr_121"), !dbg !8
  store { i8*, i8* }* %"$tf_call_122", { i8*, i8* }** %"$retval_12", align 8, !dbg !9
  %"$$retval_12_123" = load { i8*, i8* }*, { i8*, i8* }** %"$retval_12", align 8
  ret { i8*, i8* }* %"$$retval_12_123"
}

define internal %TName_Pair_Int32_Int64* @"$fundef_9"(%"$$fundef_9_env_59"* %0, %Int64 %1) !dbg !10 {
entry:
...
"$have_gas_100":                                  ; preds = %"$out_of_gas_99", %entry
  ...
  store %TName_Pair_Int32_Int64* %"$adtptr_107", %TName_Pair_Int32_Int64** %"$retval_10", align 8, !dbg !11
...
define internal { %TName_Pair_Int32_Int64* (i8*, %Int64)*, i8* } @"$fundef_7"(%"$$fundef_7_env_60"* %0, %Int32 %1) !dbg !12 {
entry:
...
"$have_gas_87":                                   ; preds = %"$out_of_gas_86", %entry
  ...
  store { %TName_Pair_Int32_Int64* (i8*, %Int64)*, i8* } %"$$fundef_9_cloval_92", { %TName_Pair_Int32_Int64* (i8*, %Int64)*, i8* }* %"$retval_8", align 8, !dbg !13
...
define internal { { %TName_Pair_Int32_Int64* (i8*, %Int64)*, i8* } (i8*, %Int32)*, i8* } @"$fundef_5"(%"$$fundef_5_env_61"* %0) !dbg !14 {
entry:
...
"$have_gas_78":                                   ; preds = %"$out_of_gas_77", %entry
  ...
  store { { %TName_Pair_Int32_Int64* (i8*, %Int64)*, i8* } (i8*, %Int32)*, i8* } { { %TName_Pair_Int32_Int64* (i8*, %Int64)*, i8* } (i8*, %Int32)* bitcast ({ %TName_Pair_Int32_Int64* (i8*, %Int64)*, i8* } (%"$$fundef_7_env_60"*, %Int32)* @"$fundef_7" to { %TName_Pair_Int32_Int64* (i8*, %Int64)*, i8* } (i8*, %Int32)*), i8* null }, { { %TName_Pair_Int32_Int64* (i8*, %Int64)*, i8* } (i8*, %Int32)*, i8* }* %"$retval_6", align 8, !dbg !15
...
define internal { i8*, i8* }* @"$fundef_3"(%"$$fundef_3_env_62"* %0) !dbg !16 {
entry:
...
"$have_gas_66":                                   ; preds = %"$out_of_gas_65", %entry
  ...
  store { i8*, i8* }* %"$dyndisp_table_71", { i8*, i8* }** %"$retval_4", align 8, !dbg !17
...
"$have_gas_132":                                  ; preds = %"$out_of_gas_131", %"$have_gas_127"
  ...
  store { i8*, i8* }* %"$dyndisp_table_137", { i8*, i8* }** %tf, align 8, !dbg !21
...
"$have_gas_148":                                  ; preds = %"$out_of_gas_147", %"$have_gas_143"
  ...
  store { i8*, i8* }* %"$dyndisp_table_156", { i8*, i8* }** %tf2, align 8, !dbg !22
...
"$have_gas_167":                                  ; preds = %"$out_of_gas_166", %"$have_gas_162"
  ...
  %"$tf2_call_175" = call { i8*, i8* }* %"$tf2_fptr_173"(i8* %"$tf2_envptr_174"), !dbg !23
  ...
  %"$tf2_call_181" = call { { %TName_Pair_Int32_Int64* (i8*, %Int64)*, i8* } (i8*, %Int32)*, i8* } %"$tf2_fptr_179"(i8* %"$tf2_envptr_180"), !dbg !23
  store { { %TName_Pair_Int32_Int64* (i8*, %Int64)*, i8* } (i8*, %Int32)*, i8* } %"$tf2_call_181", { { %TName_Pair_Int32_Int64* (i8*, %Int64)*, i8* } (i8*, %Int32)*, i8* }* %f, align 8, !dbg !24
...
"$have_gas_205":                                  ; preds = %"$out_of_gas_204", %"$have_gas_200"
  ...
  %"$f_call_211" = call { %TName_Pair_Int32_Int64* (i8*, %Int64)*, i8* } %"$f_fptr_208"(i8* %"$f_envptr_209", %Int32 %"$one_210"), !dbg !27
  store { %TName_Pair_Int32_Int64* (i8*, %Int64)*, i8* } %"$f_call_211", { %TName_Pair_Int32_Int64* (i8*, %Int64)*, i8* }* %"$f_0", align 8, !dbg !27
  ...
  %"$$f_0_call_216" = call %TName_Pair_Int32_Int64* %"$$f_0_fptr_213"(i8* %"$$f_0_envptr_214", %Int64 %"$two_215"), !dbg !27
  store %TName_Pair_Int32_Int64* %"$$f_0_call_216", %TName_Pair_Int32_Int64** %"$f_1", align 8, !dbg !27
  %"$$f_1_217" = load %TName_Pair_Int32_Int64*, %TName_Pair_Int32_Int64** %"$f_1", align 8
  store %TName_Pair_Int32_Int64* %"$$f_1_217", %TName_Pair_Int32_Int64** %"$expr_2", align 8, !dbg !27
...
entry:
  ...
  call void @_print_scilla_val(%_TyDescrTy_Typ* @"$TyDescr_ADT_Pair_Int32_Int64_45", i8* %"$memvoidcast_220")
  ret void
}
