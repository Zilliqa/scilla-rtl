...
entry:
  %"$exprval_58" = call %Int32 @_scilla_expr_fun(i8* null)
  %"$pval_59" = alloca %Int32, align 8
  %"$memvoidcast_60" = bitcast %Int32* %"$pval_59" to i8*
  store %Int32 %"$exprval_58", %Int32* %"$pval_59", align 4
