...
"$have_gas_80":                                   ; preds = %"$out_of_gas_79", %"$have_gas_75"
  ...
  store %Int32 { i32 1 }, %Int32* %one, align 4, !dbg !11
...
"$have_gas_90":                                   ; preds = %"$out_of_gas_89", %"$have_gas_85"
  ...
  store %Int32 { i32 2 }, %Int32* %two, align 4, !dbg !12
...
"$have_gas_95":                                   ; preds = %"$out_of_gas_94", %"$have_gas_90"
  ...
  %"$one_97" = load %Int32, %Int32* %one, align 4
  %"$two_98" = load %Int32, %Int32* %two, align 4
  %"$add_call_99" = call %Int32 @_add_Int32(%Int32 %"$one_97", %Int32 %"$two_98"), !dbg !13
