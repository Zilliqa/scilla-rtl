...
"$have_gas_48":                                   ; preds = %"$out_of_gas_47", %"$have_gas_43"
  ...
  store [5 x i8] c"hello", [5 x i8]* %hello, align 1, !dbg !10
...
"$have_gas_58":                                   ; preds = %"$out_of_gas_57", %"$have_gas_53"
  ...
  store [6 x i8] c" world", [6 x i8]* %world, align 1, !dbg !11
...
"$have_gas_68":                                   ; preds = %"$out_of_gas_67", %"$have_gas_63"
  ...
  %"$to_bystr_call_74" = call %Bystr @_to_bystr(i8* %"$execptr_load_70", i32 6, i8* %"$$to_bystr_world_71_73"), !dbg !12
  store %Bystr %"$to_bystr_call_74", %Bystr* %worldx, align 8, !dbg !12
...
"$have_gas_87":                                   ; preds = %"$out_of_gas_86", %"$have_gas_78"
  ...
  %"$to_ascii_call_93" = call %String @_to_ascii(i8* %"$execptr_load_89", i8* %"$$to_ascii_hello_90_92", i32 5), !dbg !13
  store %String %"$to_ascii_call_93", %String* %hello_s, align 8, !dbg !13
...
"$have_gas_106":                                  ; preds = %"$out_of_gas_105", %"$have_gas_97"
  ...
  %"$to_ascii_call_112" = call %String @_to_ascii(i8* %"$execptr_load_111", i8* %"$to_ascii_109", i32 %"$to_ascii_110"), !dbg !14
  store %String %"$to_ascii_call_112", %String* %world_s, align 8, !dbg !14
...
"$have_gas_125":                                  ; preds = %"$out_of_gas_124", %"$have_gas_106"
  ...
  %"$concat_call_130" = call %String @_concat_String(i8* %"$execptr_load_127", %String %"$hello_s_128", %String %"$world_s_129"), !dbg !15
  store %String %"$concat_call_130", %String* %"$expr_0", align 8, !dbg !15
...
!10 = !DILocation(line: 1, column: 13, scope: !9)
!11 = !DILocation(line: 2, column: 13, scope: !9)
!12 = !DILocation(line: 3, column: 14, scope: !9)
!13 = !DILocation(line: 5, column: 15, scope: !9)
