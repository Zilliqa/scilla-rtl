...
"$have_gas_104":                                  ; preds = %"$out_of_gas_103", %"$have_gas_99"
  ...
  store %Uint32 zeroinitializer, %Uint32* %zero, align 4, !dbg !11
...
"$have_gas_114":                                  ; preds = %"$out_of_gas_113", %"$have_gas_109"
  ...
  store %Uint32 { i32 1 }, %Uint32* %one, align 4, !dbg !12
...
"$have_gas_124":                                  ; preds = %"$out_of_gas_123", %"$have_gas_119"
  ...
  store %Uint64 { i64 2 }, %Uint64* %two, align 8, !dbg !13
...
"$have_gas_134":                                  ; preds = %"$out_of_gas_133", %"$have_gas_129"
  ...
  store %Uint32 { i32 3 }, %Uint32* %three, align 4, !dbg !14
...
"$have_gas_144":                                  ; preds = %"$out_of_gas_143", %"$have_gas_139"
  ...
  store %Uint128 { i128 4 }, %Uint128* %four, align 8, !dbg !15
...
"$have_gas_154":                                  ; preds = %"$out_of_gas_153", %"$have_gas_149"
  ...
  store %Uint32 { i32 6 }, %Uint32* %six, align 4, !dbg !16
...
"$have_gas_164":                                  ; preds = %"$out_of_gas_163", %"$have_gas_159"
  ...
  store %Uint32 { i32 10 }, %Uint32* %ten, align 4, !dbg !17
...
"$have_gas_174":                                  ; preds = %"$out_of_gas_173", %"$have_gas_169"
  ...
  store %Uint256 { i256 36 }, %Uint256* %thirty_six, align 8, !dbg !18
...
"$have_gas_184":                                  ; preds = %"$out_of_gas_183", %"$have_gas_179"
  ...
  store %Uint256 { i256 57896044618658097711785492504343953926634992332820282019728792003956564819967 }, %Uint256* %uint256_max, align 8, !dbg !19
...
"$have_gas_194":                                  ; preds = %"$out_of_gas_193", %"$have_gas_189"
  ...
  store %Uint128 { i128 -1 }, %Uint128* %uint128_max, align 8, !dbg !20
...
"$have_gas_213":                                  ; preds = %"$out_of_gas_212", %"$have_gas_199"
  ...
  %"$isqrt_call_216" = call %Uint32 @_isqrt_Uint32(%Uint32 %"$zero_215"), !dbg !21
  store %Uint32 %"$isqrt_call_216", %Uint32* %isqrt_zero, align 4, !dbg !21
...
"$have_gas_234":                                  ; preds = %"$out_of_gas_233", %"$have_gas_220"
  ...
  %"$isqrt_call_237" = call %Uint32 @_isqrt_Uint32(%Uint32 %"$one_236"), !dbg !22
  store %Uint32 %"$isqrt_call_237", %Uint32* %isqrt_one, align 4, !dbg !22
...
"$have_gas_254":                                  ; preds = %"$out_of_gas_253", %"$have_gas_241"
  ...
  %"$isqrt_call_257" = call %Uint64 @_isqrt_Uint64(%Uint64 %"$two_256"), !dbg !23
  store %Uint64 %"$isqrt_call_257", %Uint64* %isqrt_two, align 8, !dbg !23
...
"$have_gas_275":                                  ; preds = %"$out_of_gas_274", %"$have_gas_261"
  ...
  %"$isqrt_call_278" = call %Uint32 @_isqrt_Uint32(%Uint32 %"$three_277"), !dbg !24
  store %Uint32 %"$isqrt_call_278", %Uint32* %isqrt_three, align 4, !dbg !24
...
"$have_gas_296":                                  ; preds = %"$out_of_gas_295", %"$have_gas_282"
  ...
  %"$isqrt_call_299" = call %Uint128 @_isqrt_Uint128(%Uint128 %"$four_298"), !dbg !25
  store %Uint128 %"$isqrt_call_299", %Uint128* %isqrt_four, align 8, !dbg !25
...
"$have_gas_317":                                  ; preds = %"$out_of_gas_316", %"$have_gas_303"
  ...
  %"$isqrt_call_320" = call %Uint32 @_isqrt_Uint32(%Uint32 %"$six_319"), !dbg !26
  store %Uint32 %"$isqrt_call_320", %Uint32* %isqrt_six, align 4, !dbg !26
...
"$have_gas_338":                                  ; preds = %"$out_of_gas_337", %"$have_gas_324"
  ...
  %"$isqrt_call_341" = call %Uint32 @_isqrt_Uint32(%Uint32 %"$ten_340"), !dbg !27
  store %Uint32 %"$isqrt_call_341", %Uint32* %isqrt_ten, align 4, !dbg !27
...
"$have_gas_368":                                  ; preds = %"$out_of_gas_367", %"$have_gas_345"
  ...
  %"$isqrt_call_373" = call %Uint256* @_isqrt_Uint256(i8* %"$execptr_load_370", %Uint256* %"$isqrt_thirty_six_371"), !dbg !28
  %"$isqrt_375" = load %Uint256, %Uint256* %"$isqrt_call_373", align 8
  store %Uint256 %"$isqrt_375", %Uint256* %isqrt_thirty_six, align 8, !dbg !28
...
"$have_gas_402":                                  ; preds = %"$out_of_gas_401", %"$have_gas_379"
  ...
  %"$isqrt_call_407" = call %Uint256* @_isqrt_Uint256(i8* %"$execptr_load_404", %Uint256* %"$isqrt_uint256_max_405"), !dbg !29
  %"$isqrt_409" = load %Uint256, %Uint256* %"$isqrt_call_407", align 8
  store %Uint256 %"$isqrt_409", %Uint256* %isqrt_uint256_max, align 8, !dbg !29
...
"$have_gas_427":                                  ; preds = %"$out_of_gas_426", %"$have_gas_413"
  ...
  %"$isqrt_call_430" = call %Uint128 @_isqrt_Uint128(%Uint128 %"$uint128_max_429"), !dbg !30
  store %Uint128 %"$isqrt_call_430", %Uint128* %isqrt_uint128_max, align 8, !dbg !30
...
"$have_gas_439":                                  ; preds = %"$out_of_gas_438", %"$have_gas_434"
  ...
  %"$add_call_443" = call %Uint32 @_add_Uint32(%Uint32 %"$isqrt_zero_441", %Uint32 %"$isqrt_one_442"), !dbg !31
  store %Uint32 %"$add_call_443", %Uint32* %res1, align 4, !dbg !31
...
"$have_gas_452":                                  ; preds = %"$out_of_gas_451", %"$have_gas_447"
  ...
  %"$add_call_456" = call %Uint32 @_add_Uint32(%Uint32 %"$isqrt_three_454", %Uint32 %"$isqrt_six_455"), !dbg !32
  store %Uint32 %"$add_call_456", %Uint32* %res2, align 4, !dbg !32
...
"$have_gas_465":                                  ; preds = %"$out_of_gas_464", %"$have_gas_460"
  ...
  %"$add_call_469" = call %Uint32 @_add_Uint32(%Uint32 %"$res1_467", %Uint32 %"$res2_468"), !dbg !33
  store %Uint32 %"$add_call_469", %Uint32* %res3, align 4, !dbg !33
...
"$have_gas_478":                                  ; preds = %"$out_of_gas_477", %"$have_gas_473"
  ...
  %"$add_call_482" = call %Uint32 @_add_Uint32(%Uint32 %"$res3_480", %Uint32 %"$isqrt_ten_481"), !dbg !34
  store %Uint32 %"$add_call_482", %Uint32* %res4, align 4, !dbg !34
...
"$have_gas_492":                                  ; preds = %"$out_of_gas_491", %"$have_gas_486"
  ...
  %"$add_call_499" = call %Uint256* @_add_Uint256(i8* %"$execptr_load_494", %Uint256* %"$add_isqrt_thirty_six_495", %Uint256* %"$add_isqrt_uint256_max_497"), !dbg !35
  %"$add_501" = load %Uint256, %Uint256* %"$add_call_499", align 8
  store %Uint256 %"$add_501", %Uint256* %res5, align 8, !dbg !35
...
"$have_gas_511":                                  ; preds = %"$out_of_gas_510", %"$have_gas_505"
  ...
  %"$add_call_515" = call %Uint128 @_add_Uint128(%Uint128 %"$isqrt_four_513", %Uint128 %"$isqrt_uint128_max_514"), !dbg !36
  store %Uint128 %"$add_call_515", %Uint128* %res6, align 8, !dbg !36
...
"$have_gas_524":                                  ; preds = %"$out_of_gas_523", %"$have_gas_519"
  ...
  store %TName_Pair_Uint128_Uint256* %"$adtptr_532", %TName_Pair_Uint128_Uint256** %res7, align 8, !dbg !37
...
"$have_gas_541":                                  ; preds = %"$out_of_gas_540", %"$have_gas_536"
  ...
  store %"TName_Pair_Pair_(Uint128)_(Uint256)_Uint32"* %"$adtptr_549", %"TName_Pair_Pair_(Uint128)_(Uint256)_Uint32"** %res8, align 8, !dbg !38
...
"$have_gas_553":                                  ; preds = %"$out_of_gas_552", %"$have_gas_541"
  ...
  store %"TName_Pair_Uint64_Pair_(Pair_(Uint128)_(Uint256))_(Uint32)"* %"$adtptr_561", %"TName_Pair_Uint64_Pair_(Pair_(Uint128)_(Uint256))_(Uint32)"** %"$expr_6", align 8, !dbg !39
...
!16 = !DILocation(line: 6, column: 11, scope: !10)
!17 = !DILocation(line: 7, column: 11, scope: !10)
!18 = !DILocation(line: 8, column: 18, scope: !10)
!19 = !DILocation(line: 9, column: 19, scope: !10)
!20 = !DILocation(line: 10, column: 19, scope: !10)
!21 = !DILocation(line: 12, column: 18, scope: !10)
!22 = !DILocation(line: 13, column: 17, scope: !10)
!23 = !DILocation(line: 14, column: 17, scope: !10)
!24 = !DILocation(line: 15, column: 19, scope: !10)
!25 = !DILocation(line: 16, column: 18, scope: !10)
!26 = !DILocation(line: 17, column: 17, scope: !10)
!27 = !DILocation(line: 18, column: 17, scope: !10)
!28 = !DILocation(line: 19, column: 24, scope: !10)
!29 = !DILocation(line: 20, column: 25, scope: !10)
!30 = !DILocation(line: 21, column: 25, scope: !10)
!31 = !DILocation(line: 23, column: 12, scope: !10)
!32 = !DILocation(line: 24, column: 12, scope: !10)
!33 = !DILocation(line: 25, column: 12, scope: !10)
!34 = !DILocation(line: 26, column: 12, scope: !10)
!35 = !DILocation(line: 28, column: 12, scope: !10)
!36 = !DILocation(line: 29, column: 12, scope: !10)
!37 = !DILocation(line: 31, column: 12, scope: !10)
!38 = !DILocation(line: 32, column: 12, scope: !10)
!39 = !DILocation(line: 33, column: 1, scope: !10)
