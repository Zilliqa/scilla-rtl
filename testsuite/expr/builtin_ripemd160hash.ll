...
"$have_gas_120":                                  ; preds = %"$out_of_gas_119", %"$have_gas_105"
  ...
  %"$ripemd160hash_call_126" = call [20 x i8]* @_ripemd160hash(i8* %"$execptr_load_122", %_TyDescrTy_Typ* @"$TyDescr_String_25", i8* %"$$ripemd160hash_s_123_125")
  %"$ripemd160hash_128" = load [20 x i8], [20 x i8]* %"$ripemd160hash_call_126", align 1
  store [20 x i8] %"$ripemd160hash_128", [20 x i8]* %h1, align 1
...
"$have_gas_147":                                  ; preds = %"$out_of_gas_146", %"$have_gas_132"
  ...
  %"$ripemd160hash_call_153" = call [20 x i8]* @_ripemd160hash(i8* %"$execptr_load_149", %_TyDescrTy_Typ* @"$TyDescr_Bystr20_37", i8* %"$$ripemd160hash_h1_150_152")
  %"$ripemd160hash_155" = load [20 x i8], [20 x i8]* %"$ripemd160hash_call_153", align 1
  store [20 x i8] %"$ripemd160hash_155", [20 x i8]* %h2, align 1
...
"$have_gas_164":                                  ; preds = %"$out_of_gas_163", %"$have_gas_159"
  ...
  store %TName_Pair_String_ByStr20* %"$adtptr_172", %TName_Pair_String_ByStr20** %sh, align 8
...
"$have_gas_190":                                  ; preds = %"$out_of_gas_189", %"$have_gas_176"
  ...
  %"$ripemd160hash_call_195" = call [20 x i8]* @_ripemd160hash(i8* %"$execptr_load_192", %_TyDescrTy_Typ* @"$TyDescr_ADT_Pair_String_ByStr20_42", i8* %"$$sh_193_194")
  %"$ripemd160hash_197" = load [20 x i8], [20 x i8]* %"$ripemd160hash_call_195", align 1
  store [20 x i8] %"$ripemd160hash_197", [20 x i8]* %sh2, align 1
...
"$have_gas_206":                                  ; preds = %"$out_of_gas_205", %"$have_gas_201"
  ...
  %"$to_bystr_call_212" = call %Bystr @_to_bystr(i8* %"$execptr_load_208", i32 20, i8* %"$$to_bystr_sh2_209_211")
...
"$have_gas_252":                                  ; preds = %"$out_of_gas_251", %"$have_gas_231"
  ...
  %"$ripemd160hash_call_257" = call [20 x i8]* @_ripemd160hash(i8* %"$execptr_load_254", %_TyDescrTy_Typ* @"$TyDescr_ADT_Pair_ByStr_Int32_41", i8* %"$$p2_255_256")
  %"$ripemd160hash_259" = load [20 x i8], [20 x i8]* %"$ripemd160hash_call_257", align 1
  store [20 x i8] %"$ripemd160hash_259", [20 x i8]* %"$expr_6", align 1
