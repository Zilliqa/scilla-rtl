...
"$have_gas_67":                                   ; preds = %"$out_of_gas_66", %"$have_gas_61"
  ...
  store [20 x i8] %"$ripemd160hash_74", [20 x i8]* %h1, align 1, !dbg !11
...
"$have_gas_78":                                   ; preds = %"$out_of_gas_77", %"$have_gas_67"
  ...
  store [20 x i8] %"$ripemd160hash_85", [20 x i8]* %h2, align 1, !dbg !12
...
"$have_gas_94":                                   ; preds = %"$out_of_gas_93", %"$have_gas_89"
  ...
  store %TName_Pair_String_ByStr20* %"$adtptr_102", %TName_Pair_String_ByStr20** %sh, align 8, !dbg !13
...
"$have_gas_106":                                  ; preds = %"$out_of_gas_105", %"$have_gas_94"
  ...
  store [20 x i8] %"$ripemd160hash_112", [20 x i8]* %sh2, align 1, !dbg !14
...
"$have_gas_141":                                  ; preds = %"$out_of_gas_140", %"$have_gas_136"
  ...
  store [20 x i8] %"$ripemd160hash_154", [20 x i8]* %"$expr_0", align 1, !dbg !18
