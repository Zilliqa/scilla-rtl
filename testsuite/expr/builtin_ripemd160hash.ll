...
"$have_gas_69":                                   ; preds = %"$out_of_gas_68", %"$have_gas_63"
  ...
  store [20 x i8] %"$ripemd160hash_77", [20 x i8]* %h1, align 1
...
"$have_gas_81":                                   ; preds = %"$out_of_gas_80", %"$have_gas_69"
  ...
  %"$ripemd160hash_h1_84" = alloca [20 x i8], align 1
  ...
  store [20 x i8] %"$ripemd160hash_89", [20 x i8]* %h2, align 1
...
"$have_gas_98":                                   ; preds = %"$out_of_gas_97", %"$have_gas_93"
  ...
  %"$h2_101" = load [20 x i8], [20 x i8]* %h2, align 1
  %"$adtval_102_load" = load i8*, i8** @_execptr, align 8
  %"$adtval_102_salloc" = call i8* @_salloc(i8* %"$adtval_102_load", i64 37)
  %"$adtval_102" = bitcast i8* %"$adtval_102_salloc" to %CName_Pair_String_ByStr20*
  %"$adtgep_103" = getelementptr inbounds %CName_Pair_String_ByStr20, %CName_Pair_String_ByStr20* %"$adtval_102", i32 0, i32 0
  store i8 0, i8* %"$adtgep_103", align 1
  %"$adtgep_104" = getelementptr inbounds %CName_Pair_String_ByStr20, %CName_Pair_String_ByStr20* %"$adtval_102", i32 0, i32 1
  store %String %"$s_100", %String* %"$adtgep_104", align 8
  %"$adtgep_105" = getelementptr inbounds %CName_Pair_String_ByStr20, %CName_Pair_String_ByStr20* %"$adtval_102", i32 0, i32 2
  store [20 x i8] %"$h2_101", [20 x i8]* %"$adtgep_105", align 1
  %"$adtptr_106" = bitcast %CName_Pair_String_ByStr20* %"$adtval_102" to %TName_Pair_String_ByStr20*
  store %TName_Pair_String_ByStr20* %"$adtptr_106", %TName_Pair_String_ByStr20** %sh, align 8
...
"$have_gas_110":                                  ; preds = %"$out_of_gas_109", %"$have_gas_98"
  ...
  store [20 x i8] %"$ripemd160hash_117", [20 x i8]* %sh2, align 1
...
"$have_gas_121":                                  ; preds = %"$out_of_gas_120", %"$have_gas_110"
  ...
  %"$to_bystr_sh2_124" = alloca [20 x i8], align 1
...
"$have_gas_146":                                  ; preds = %"$out_of_gas_145", %"$have_gas_141"
  ...
  store [20 x i8] %"$ripemd160hash_160", [20 x i8]* %"$expr_0", align 1
  %"$$expr_0_161" = load [20 x i8], [20 x i8]* %"$expr_0", align 1
  store [20 x i8] %"$$expr_0_161", [20 x i8]* %1, align 1
  ret void
}
...
entry:
  %"$mainval_162" = alloca [20 x i8], align 1
  %"$memvoidcast_163" = bitcast [20 x i8]* %"$mainval_162" to i8*
  call void @_scilla_expr_fun(i8* null, [20 x i8]* %"$mainval_162")
  %"$execptr_load_164" = load i8*, i8** @_execptr, align 8
  call void @_print_scilla_val(i8* %"$execptr_load_164", %_TyDescrTy_Typ* @"$TyDescr_Bystr20_31", i8* %"$memvoidcast_163")
  ret void
}
