...
"$have_gas_68":                                   ; preds = %"$out_of_gas_67", %"$have_gas_63"
  ...
  %"$to_uint64_call_74" = call i8* @_to_uint64(i8* %"$execptr_load_70", %_TyDescrTy_Typ* @"$TyDescr_Uint32_6", i8* %"$$to_uint64_a_71_73")
  %"$to_uint64_75" = bitcast i8* %"$to_uint64_call_74" to %TName_Option_Uint64*
  store %TName_Option_Uint64* %"$to_uint64_75", %TName_Option_Uint64** %b, align 8
...
"$have_gas_79":                                   ; preds = %"$out_of_gas_78", %"$have_gas_68"
  ...
  store %TName_Option_Uint64* %"$b_81", %TName_Option_Uint64** %"$a_0", align 8
...
"$have_gas_85":                                   ; preds = %"$out_of_gas_84", %"$have_gas_79"
  ...
  store %TName_Option_Uint64* %"$$a_0_87", %TName_Option_Uint64** %"$expr_1", align 8
