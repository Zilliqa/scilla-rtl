...
"$have_gas_109":                                  ; preds = %"$out_of_gas_108", %"$have_gas_104"
  ...
  %"$to_uint64_call_115" = call i8* @_to_uint64(i8* %"$execptr_load_111", %_TyDescrTy_Typ* @"$TyDescr_Uint32_12", i8* %"$$to_uint64_a_112_114")
  %"$to_uint64_116" = bitcast i8* %"$to_uint64_call_115" to %TName_Option_Uint64*
  store %TName_Option_Uint64* %"$to_uint64_116", %TName_Option_Uint64** %b, align 8
...
"$have_gas_120":                                  ; preds = %"$out_of_gas_119", %"$have_gas_109"
  ...
  store %TName_Option_Uint64* %"$b_122", %TName_Option_Uint64** %"$a_6", align 8
...
"$have_gas_126":                                  ; preds = %"$out_of_gas_125", %"$have_gas_120"
  ...
  store %TName_Option_Uint64* %"$$a_6_128", %TName_Option_Uint64** %"$expr_7", align 8
