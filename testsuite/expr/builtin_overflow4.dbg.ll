...
"$have_gas_92":                                   ; preds = %"$out_of_gas_91", %"$have_gas_87"
  ...
  store %Int32 { i32 2 }, %Int32* %b, align 4, !dbg !18
...
"$have_gas_97":                                   ; preds = %"$out_of_gas_96", %"$have_gas_92"
  ...
  %"$mul_call_101" = call %Int32 @_mul_Int32(%Int32 %"$a_99", %Int32 %"$b_100"), !dbg !19
  store %Int32 %"$mul_call_101", %Int32* %"$expr_6", align 4, !dbg !19
