...
"$have_gas_54":                                   ; preds = %"$out_of_gas_53", %"$have_gas_49"
  ...
  store %Int32 { i32 2 }, %Int32* %b, align 4, !dbg !11
...
"$have_gas_59":                                   ; preds = %"$out_of_gas_58", %"$have_gas_54"
  ...
  %"$mul_call_63" = call %Int32 @_mul_Int32(%Int32 %"$a_61", %Int32 %"$b_62"), !dbg !12
  store %Int32 %"$mul_call_63", %Int32* %"$expr_0", align 4, !dbg !12
