...
"$have_gas_153":                                  ; preds = %"$out_of_gas_152", %"$have_gas_136"
  ...
  %"$ecdsa_verify_call_161" = call %TName_Bool* @_ecdsa_verify(i8* %"$execptr_load_155", [33 x i8]* %"$ecdsa_verify_pk_156", %Bystr %"$msg_158", [64 x i8]* %"$ecdsa_verify_sign_159"), !dbg !15
  store %TName_Bool* %"$ecdsa_verify_call_161", %TName_Bool** %"$expr_6", align 8, !dbg !15
