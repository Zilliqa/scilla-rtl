...
"$have_gas_99":                                   ; preds = %"$out_of_gas_98", %"$have_gas_94"
  ...
  store [33 x i8] c"\03\01\08,\FE\D7\81$\A1X\92\DA\18\87\DA\FF\08Fi\E7\A2\ED'\11\9Eq\C2\0B\DA:.\00\DD", [33 x i8]* %pk, align 1, !dbg !11
...
"$have_gas_134":                                  ; preds = %"$out_of_gas_133", %"$have_gas_129"
  ...
  store [64 x i8] c"q3\EF\F4\00\B8I5\91\\\08\EC\D3.0\B2\06\D9\E7\B8\8D\85z8/\D1N\10S\0F0V1IpB\8C@/x\AB\96\14\03\18\80[\DB\C9M\87\B0tL\FB\A8\86\C5\80\BF\CD\DB\98_", [64 x i8]* %sign, align 1, !dbg !14
...
"$have_gas_151":                                  ; preds = %"$out_of_gas_150", %"$have_gas_134"
  ...
  %"$ecdsa_verify_pk_154" = alloca [33 x i8], align 1
  %"$pk_155" = load [33 x i8], [33 x i8]* %pk, align 1
  store [33 x i8] %"$pk_155", [33 x i8]* %"$ecdsa_verify_pk_154", align 1
  %"$msg_156" = load %Bystr, %Bystr* %msg, align 8
  %"$ecdsa_verify_sign_157" = alloca [64 x i8], align 1
  %"$sign_158" = load [64 x i8], [64 x i8]* %sign, align 1
  store [64 x i8] %"$sign_158", [64 x i8]* %"$ecdsa_verify_sign_157", align 1
  %"$ecdsa_verify_call_159" = call %TName_Bool* @_ecdsa_verify(i8* %"$execptr_load_153", [33 x i8]* %"$ecdsa_verify_pk_154", %Bystr %"$msg_156", [64 x i8]* %"$ecdsa_verify_sign_157"), !dbg !15
  store %TName_Bool* %"$ecdsa_verify_call_159", %TName_Bool** %"$expr_6", align 8, !dbg !15
