...
"$have_gas_105":                                  ; preds = %"$out_of_gas_104", %"$have_gas_100"
  ...
  store %String { i8* getelementptr inbounds ([3 x i8], [3 x i8]* @"$stringlit_107", i32 0, i32 0), i32 3 }, %String* %prefix, align 8, !dbg !12
...
"$have_gas_121":                                  ; preds = %"$out_of_gas_120", %"$have_gas_105"
  ...
  %"$bystr20_to_bech32_call_127" = call %TName_Option_String* @_bystr20_to_bech32(i8* %"$execptr_load_123", %String %"$prefix_124", [20 x i8]* %"$bystr20_to_bech32_bystr20_addr_125"), !dbg !13
  store %TName_Option_String* %"$bystr20_to_bech32_call_127", %TName_Option_String** %"$expr_6", align 8, !dbg !13
