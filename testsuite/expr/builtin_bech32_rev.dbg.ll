...
"$have_gas_85":                                   ; preds = %"$out_of_gas_84", %"$have_gas_69"
  ...
  %"$bystr20_to_bech32_call_91" = call %TName_Option_String* @_bystr20_to_bech32(i8* %"$execptr_load_87", %String %"$prefix_88", [20 x i8]* %"$bystr20_to_bech32_bystr20_addr_89"), !dbg !12
  store %TName_Option_String* %"$bystr20_to_bech32_call_91", %TName_Option_String** %"$expr_0", align 8, !dbg !12
