...
%"$ParamDescr_48" = type { %ParamDescrString, %_TyDescrTy_Typ* }
%ParamDescrString = type { i8*, i32 }
%"$TransDescr_49" = type { %ParamDescrString, i32, %"$ParamDescr_48"* }
...
@_tydescr_table = constant [15 x %_TyDescrTy_Typ*] [%_TyDescrTy_Typ* @"$TyDescr_Event_25", %_TyDescrTy_Typ* @"$TyDescr_Int64_7", %_TyDescrTy_Typ* @"$TyDescr_Bystr3_31", %_TyDescrTy_Typ* @"$TyDescr_Uint256_17", %_TyDescrTy_Typ* @"$TyDescr_Uint32_5", %_TyDescrTy_Typ* @"$TyDescr_Uint64_9", %_TyDescrTy_Typ* @"$TyDescr_Bnum_21", %_TyDescrTy_Typ* @"$TyDescr_Uint128_13", %_TyDescrTy_Typ* @"$TyDescr_Exception_27", %_TyDescrTy_Typ* @"$TyDescr_String_19", %_TyDescrTy_Typ* @"$TyDescr_Int256_15", %_TyDescrTy_Typ* @"$TyDescr_Int128_11", %_TyDescrTy_Typ* @"$TyDescr_Bystr_29", %_TyDescrTy_Typ* @"$TyDescr_Message_23", %_TyDescrTy_Typ* @"$TyDescr_Int32_3"]
@_tydescr_table_length = constant i32 15
@_contract_parameters = constant [0 x %"$ParamDescr_48"] zeroinitializer
@_contract_parameters_length = constant i32 0
@_transition_parameters = constant [0 x %"$TransDescr_49"] zeroinitializer
...
"$have_gas_41":                                   ; preds = %"$out_of_gas_40", %entry
  ...
  %"$$expr_0_43" = load [3 x i8], [3 x i8]* %"$expr_0", align 1
  ret [3 x i8] %"$$expr_0_43"
}
...
entry:
  %"$exprval_44" = call [3 x i8] @_scilla_expr_fun(i8* null)
  %"$pval_45" = alloca [3 x i8], align 1
  %"$memvoidcast_46" = bitcast [3 x i8]* %"$pval_45" to i8*
  store [3 x i8] %"$exprval_44", [3 x i8]* %"$pval_45", align 1
  %"$execptr_load_47" = load i8*, i8** @_execptr, align 8
  call void @_print_scilla_val(i8* %"$execptr_load_47", %_TyDescrTy_Typ* @"$TyDescr_Bystr3_31", i8* %"$memvoidcast_46")
  ret void
}
