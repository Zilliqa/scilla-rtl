...
"$have_gas_163":                                  ; preds = %"$out_of_gas_162", %"$have_gas_158"
  ...
  %"$to_bystr4_call_167" = call i8* @_uint32_to_bystrx(i8* %"$execptr_load_165", %Uint32 %"$uint32_100_166"), !dbg !12
  %"$to_bystr4_168" = bitcast i8* %"$to_bystr4_call_167" to [4 x i8]*
  %"$to_bystr4_169" = load [4 x i8], [4 x i8]* %"$to_bystr4_168", align 1
  store [4 x i8] %"$to_bystr4_169", [4 x i8]* %res1, align 1, !dbg !12
...
"$have_gas_188":                                  ; preds = %"$out_of_gas_187", %"$have_gas_183"
  ...
  %"$to_bystr8_call_192" = call i8* @_uint64_to_bystrx(i8* %"$execptr_load_190", %Uint64 %"$uint64_200_191"), !dbg !14
  %"$to_bystr8_193" = bitcast i8* %"$to_bystr8_call_192" to [8 x i8]*
  %"$to_bystr8_194" = load [8 x i8], [8 x i8]* %"$to_bystr8_193", align 1
  store [8 x i8] %"$to_bystr8_194", [8 x i8]* %res2, align 1, !dbg !14
...
"$have_gas_213":                                  ; preds = %"$out_of_gas_212", %"$have_gas_208"
  ...
  %"$to_bystr16_call_217" = call i8* @_uint128_to_bystrx(i8* %"$execptr_load_215", %Uint128 %"$uint128_300_216"), !dbg !16
  %"$to_bystr16_218" = bitcast i8* %"$to_bystr16_call_217" to [16 x i8]*
  %"$to_bystr16_219" = load [16 x i8], [16 x i8]* %"$to_bystr16_218", align 1
  store [16 x i8] %"$to_bystr16_219", [16 x i8]* %res3, align 1, !dbg !16
...
"$have_gas_238":                                  ; preds = %"$out_of_gas_237", %"$have_gas_233"
  ...
  %"$to_bystr32_call_243" = call i8* @_uint256_to_bystrx(i8* %"$execptr_load_240", %Uint256* %"$to_bystr32_uint256_400_241"), !dbg !18
  %"$to_bystr32_244" = bitcast i8* %"$to_bystr32_call_243" to [32 x i8]*
  %"$to_bystr32_245" = load [32 x i8], [32 x i8]* %"$to_bystr32_244", align 1
  store [32 x i8] %"$to_bystr32_245", [32 x i8]* %res4, align 1, !dbg !18
...
"$have_gas_264":                                  ; preds = %"$out_of_gas_263", %"$have_gas_259"
  ...
  %"$to_bystr_call_270" = call %Bystr @_to_bystr(i8* %"$execptr_load_266", i32 2, i8* %"$$to_bystr_x_267_269"), !dbg !20
  store %Bystr %"$to_bystr_call_270", %Bystr* %xbs, align 8, !dbg !20
...
"$have_gas_279":                                  ; preds = %"$out_of_gas_278", %"$have_gas_274"
  ...
  %"$to_bystr2_call_283" = call i8* @_bystr_to_bystrx(i8* %"$execptr_load_281", i32 2, %Bystr %"$xbs_282"), !dbg !21
  %"$to_bystr2_284" = bitcast i8* %"$to_bystr2_call_283" to %TName_Option_ByStr2*
  store %TName_Option_ByStr2* %"$to_bystr2_284", %TName_Option_ByStr2** %res_x_some, align 8, !dbg !21
...
"$have_gas_293":                                  ; preds = %"$out_of_gas_292", %"$have_gas_288"
  ...
  %"$to_bystr3_call_297" = call i8* @_bystr_to_bystrx(i8* %"$execptr_load_295", i32 3, %Bystr %"$xbs_296"), !dbg !22
  %"$to_bystr3_298" = bitcast i8* %"$to_bystr3_call_297" to %TName_Option_ByStr3*
  store %TName_Option_ByStr3* %"$to_bystr3_298", %TName_Option_ByStr3** %res_x_none, align 8, !dbg !22
...
"$have_gas_307":                                  ; preds = %"$out_of_gas_306", %"$have_gas_302"
  ...
  store %"TName_Pair_Option_(ByStr2)_Option_(ByStr3)"* %"$adtptr_315", %"TName_Pair_Option_(ByStr2)_Option_(ByStr3)"** %res_x_opt_out, align 8, !dbg !23
...
"$have_gas_324":                                  ; preds = %"$out_of_gas_323", %"$have_gas_319"
  ...
  store %TName_Pair_ByStr4_ByStr8* %"$adtptr_332", %TName_Pair_ByStr4_ByStr8** %out1, align 8, !dbg !24
...
"$have_gas_341":                                  ; preds = %"$out_of_gas_340", %"$have_gas_336"
  ...
  store %"TName_Pair_Pair_(ByStr4)_(ByStr8)_ByStr16"* %"$adtptr_349", %"TName_Pair_Pair_(ByStr4)_(ByStr8)_ByStr16"** %out2, align 8, !dbg !25
...
"$have_gas_358":                                  ; preds = %"$out_of_gas_357", %"$have_gas_353"
  ...
  store %"TName_Pair_Pair_(Pair_(ByStr4)_(ByStr8))_(ByStr16)_ByStr32"* %"$adtptr_366", %"TName_Pair_Pair_(Pair_(ByStr4)_(ByStr8))_(ByStr16)_ByStr32"** %out3, align 8, !dbg !26
...
"$have_gas_375":                                  ; preds = %"$out_of_gas_374", %"$have_gas_370"
  ...
  store %"TName_Pair_Pair_(Pair_(Pair_(ByStr4)_(ByStr8))_(ByStr16))_(ByStr32)_Pair_(Option_(ByStr2))_(Option_(ByStr3))"* %"$adtptr_383", %"TName_Pair_Pair_(Pair_(Pair_(ByStr4)_(ByStr8))_(ByStr16))_(ByStr32)_Pair_(Option_(ByStr2))_(Option_(ByStr3))"** %out4, align 8, !dbg !27
...
"$have_gas_387":                                  ; preds = %"$out_of_gas_386", %"$have_gas_375"
  ...
  store %"TName_Pair_Pair_(Pair_(Pair_(ByStr4)_(ByStr8))_(ByStr16))_(ByStr32)_Pair_(Option_(ByStr2))_(Option_(ByStr3))"* %"$out4_389", %"TName_Pair_Pair_(Pair_(Pair_(ByStr4)_(ByStr8))_(ByStr16))_(ByStr32)_Pair_(Option_(ByStr2))_(Option_(ByStr3))"** %"$expr_6", align 8, !dbg !28
