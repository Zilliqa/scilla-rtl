...
"$have_gas_127":                                  ; preds = %"$out_of_gas_126", %"$have_gas_122"
  ...
  %"$to_bystr4_call_131" = call i8* @_uint32_to_bystrx(i8* %"$execptr_load_129", %Uint32 %"$uint32_100_130"), !dbg !11
  %"$to_bystr4_132" = bitcast i8* %"$to_bystr4_call_131" to [4 x i8]*
  %"$to_bystr4_133" = load [4 x i8], [4 x i8]* %"$to_bystr4_132", align 1
  store [4 x i8] %"$to_bystr4_133", [4 x i8]* %res1, align 1, !dbg !11
...
"$have_gas_152":                                  ; preds = %"$out_of_gas_151", %"$have_gas_147"
  ...
  %"$to_bystr8_call_156" = call i8* @_uint64_to_bystrx(i8* %"$execptr_load_154", %Uint64 %"$uint64_200_155"), !dbg !13
  %"$to_bystr8_157" = bitcast i8* %"$to_bystr8_call_156" to [8 x i8]*
  %"$to_bystr8_158" = load [8 x i8], [8 x i8]* %"$to_bystr8_157", align 1
  store [8 x i8] %"$to_bystr8_158", [8 x i8]* %res2, align 1, !dbg !13
...
"$have_gas_177":                                  ; preds = %"$out_of_gas_176", %"$have_gas_172"
  ...
  %"$to_bystr16_call_181" = call i8* @_uint128_to_bystrx(i8* %"$execptr_load_179", %Uint128 %"$uint128_300_180"), !dbg !15
  %"$to_bystr16_182" = bitcast i8* %"$to_bystr16_call_181" to [16 x i8]*
  %"$to_bystr16_183" = load [16 x i8], [16 x i8]* %"$to_bystr16_182", align 1
  store [16 x i8] %"$to_bystr16_183", [16 x i8]* %res3, align 1, !dbg !15
...
"$have_gas_202":                                  ; preds = %"$out_of_gas_201", %"$have_gas_197"
  ...
  %"$to_bystr32_call_207" = call i8* @_uint256_to_bystrx(i8* %"$execptr_load_204", %Uint256* %"$to_bystr32_uint256_400_205"), !dbg !17
  %"$to_bystr32_208" = bitcast i8* %"$to_bystr32_call_207" to [32 x i8]*
  %"$to_bystr32_209" = load [32 x i8], [32 x i8]* %"$to_bystr32_208", align 1
  store [32 x i8] %"$to_bystr32_209", [32 x i8]* %res4, align 1, !dbg !17
...
"$have_gas_228":                                  ; preds = %"$out_of_gas_227", %"$have_gas_223"
  ...
  %"$to_bystr_call_234" = call %Bystr @_to_bystr(i8* %"$execptr_load_230", i32 2, i8* %"$$to_bystr_x_231_233"), !dbg !19
  store %Bystr %"$to_bystr_call_234", %Bystr* %xbs, align 8, !dbg !19
...
"$have_gas_243":                                  ; preds = %"$out_of_gas_242", %"$have_gas_238"
  ...
  %"$to_bystr2_call_247" = call i8* @_bystr_to_bystrx(i8* %"$execptr_load_245", i32 2, %Bystr %"$xbs_246"), !dbg !20
  %"$to_bystr2_248" = bitcast i8* %"$to_bystr2_call_247" to %TName_Option_ByStr2*
  store %TName_Option_ByStr2* %"$to_bystr2_248", %TName_Option_ByStr2** %res_x_some, align 8, !dbg !20
...
"$have_gas_257":                                  ; preds = %"$out_of_gas_256", %"$have_gas_252"
  ...
  %"$to_bystr3_call_261" = call i8* @_bystr_to_bystrx(i8* %"$execptr_load_259", i32 3, %Bystr %"$xbs_260"), !dbg !21
  %"$to_bystr3_262" = bitcast i8* %"$to_bystr3_call_261" to %TName_Option_ByStr3*
  store %TName_Option_ByStr3* %"$to_bystr3_262", %TName_Option_ByStr3** %res_x_none, align 8, !dbg !21
...
"$have_gas_271":                                  ; preds = %"$out_of_gas_270", %"$have_gas_266"
  ...
  store %"TName_Pair_Option_(ByStr2)_Option_(ByStr3)"* %"$adtptr_279", %"TName_Pair_Option_(ByStr2)_Option_(ByStr3)"** %res_x_opt_out, align 8, !dbg !22
...
"$have_gas_288":                                  ; preds = %"$out_of_gas_287", %"$have_gas_283"
  ...
  store %TName_Pair_ByStr4_ByStr8* %"$adtptr_296", %TName_Pair_ByStr4_ByStr8** %out1, align 8, !dbg !23
...
"$have_gas_305":                                  ; preds = %"$out_of_gas_304", %"$have_gas_300"
  ...
  store %"TName_Pair_Pair_(ByStr4)_(ByStr8)_ByStr16"* %"$adtptr_313", %"TName_Pair_Pair_(ByStr4)_(ByStr8)_ByStr16"** %out2, align 8, !dbg !24
...
"$have_gas_322":                                  ; preds = %"$out_of_gas_321", %"$have_gas_317"
  ...
  store %"TName_Pair_Pair_(Pair_(ByStr4)_(ByStr8))_(ByStr16)_ByStr32"* %"$adtptr_330", %"TName_Pair_Pair_(Pair_(ByStr4)_(ByStr8))_(ByStr16)_ByStr32"** %out3, align 8, !dbg !25
...
"$have_gas_339":                                  ; preds = %"$out_of_gas_338", %"$have_gas_334"
  ...
  store %"TName_Pair_Pair_(Pair_(Pair_(ByStr4)_(ByStr8))_(ByStr16))_(ByStr32)_Pair_(Option_(ByStr2))_(Option_(ByStr3))"* %"$adtptr_347", %"TName_Pair_Pair_(Pair_(Pair_(ByStr4)_(ByStr8))_(ByStr16))_(ByStr32)_Pair_(Option_(ByStr2))_(Option_(ByStr3))"** %out4, align 8, !dbg !26
...
"$have_gas_351":                                  ; preds = %"$out_of_gas_350", %"$have_gas_339"
  ...
  store %"TName_Pair_Pair_(Pair_(Pair_(ByStr4)_(ByStr8))_(ByStr16))_(ByStr32)_Pair_(Option_(ByStr2))_(Option_(ByStr3))"* %"$out4_353", %"TName_Pair_Pair_(Pair_(Pair_(ByStr4)_(ByStr8))_(ByStr16))_(ByStr32)_Pair_(Option_(ByStr2))_(Option_(ByStr3))"** %"$expr_0", align 8, !dbg !27
