...
define internal %TName_Bool* @"$fundef_110"(%"$$fundef_110_env_204"* %0, %TName_Bool* %1) {
entry:
...
"$have_gas_234":                                  ; preds = %"$out_of_gas_233", %"$False_229"
  ...
  store %TName_Bool* %"$adtptr_238", %TName_Bool** %"$retval_111", align 8
...
"$have_gas_244":                                  ; preds = %"$out_of_gas_243", %"$True_239"
  ...
  store %TName_Bool* %1, %TName_Bool** %"$retval_111", align 8
  br label %"$matchsucc_224"
...
define internal { %TName_Bool* (i8*, %TName_Bool*)*, i8* } @"$fundef_108"(%"$$fundef_108_env_205"* %0, %TName_Bool* %1) {
entry:
...
"$have_gas_209":                                  ; preds = %"$out_of_gas_208", %entry
  ...
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$$fundef_110_cloval_214", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$retval_109", align 8
...
"$have_gas_260":                                  ; preds = %"$out_of_gas_259", %"$have_gas_255"
  ...
  store { { %TName_Bool* (i8*, %TName_Bool*)*, i8* } (i8*, %TName_Bool*)*, i8* } { { %TName_Bool* (i8*, %TName_Bool*)*, i8* } (i8*, %TName_Bool*)* bitcast ({ %TName_Bool* (i8*, %TName_Bool*)*, i8* } (%"$$fundef_108_env_205"*, %TName_Bool*)* @"$fundef_108" to { %TName_Bool* (i8*, %TName_Bool*)*, i8* } (i8*, %TName_Bool*)*), i8* null }, { { %TName_Bool* (i8*, %TName_Bool*)*, i8* } (i8*, %TName_Bool*)*, i8* }* @BoolUtils.andb, align 8
...
"$have_gas_293":                                  ; preds = %"$out_of_gas_292", %"$have_gas_288"
  ...
  store %TName_Bool* %"$adtptr_297", %TName_Bool** %false, align 8
...
"$have_gas_306":                                  ; preds = %"$out_of_gas_305", %"$have_gas_301"
  ...
  store %TName_Bool* %"$adtptr_310", %TName_Bool** %test, align 8
...
"$have_gas_329":                                  ; preds = %"$out_of_gas_328", %"$have_gas_324"
  ...
  %"$to_uint32_call_335" = call i8* @_to_uint32(i8* %"$execptr_load_331", %_TyDescrTy_Typ* @"$TyDescr_Uint32_117", i8* %"$$to_uint32_input_332_334")
  %"$to_uint32_336" = bitcast i8* %"$to_uint32_call_335" to %TName_Option_Uint32*
  store %TName_Option_Uint32* %"$to_uint32_336", %TName_Option_Uint32** %resopt, align 8
...
"$have_gas_374":                                  ; preds = %"$out_of_gas_373", %"$have_gas_369"
  ...
  %"$eq_call_379" = call %TName_Bool* @_eq_Uint32(i8* %"$execptr_load_376", %Uint32 %"$res_377", %Uint32 %"$input__378")
  store %TName_Bool* %"$eq_call_379", %TName_Bool** %test_, align 8
...
"$have_gas_384":                                  ; preds = %"$out_of_gas_383", %"$have_gas_374"
  ...
  %"$BoolUtils.andb_call_390" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_fptr_387"(i8* %"$BoolUtils.andb_envptr_388", %TName_Bool* %"$test_389")
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_call_390", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.andb_84", align 8
  ...
  %"$$BoolUtils.andb_84_call_395" = call %TName_Bool* %"$$BoolUtils.andb_84_fptr_392"(i8* %"$$BoolUtils.andb_84_envptr_393", %TName_Bool* %"$test__394")
  store %TName_Bool* %"$$BoolUtils.andb_84_call_395", %TName_Bool** %"$BoolUtils.andb_85", align 8
  %"$$BoolUtils.andb_85_396" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.andb_85", align 8
  store %TName_Bool* %"$$BoolUtils.andb_85_396", %TName_Bool** %"$test_6", align 8
...
"$have_gas_402":                                  ; preds = %"$out_of_gas_401", %"$None_397"
  ...
  store %TName_Bool* %"$false_404", %TName_Bool** %"$test_6", align 8
  br label %"$matchsucc_347"
...
"$have_gas_423":                                  ; preds = %"$out_of_gas_422", %"$have_gas_418"
  ...
  %"$to_uint32_call_429" = call i8* @_to_uint32(i8* %"$execptr_load_425", %_TyDescrTy_Typ* @"$TyDescr_Uint128_125", i8* %"$$to_uint32_$input_7_426_428")
  %"$to_uint32_430" = bitcast i8* %"$to_uint32_call_429" to %TName_Option_Uint32*
  store %TName_Option_Uint32* %"$to_uint32_430", %TName_Option_Uint32** %"$resopt_8", align 8
...
"$have_gas_468":                                  ; preds = %"$out_of_gas_467", %"$have_gas_463"
  ...
  %"$eq_call_473" = call %TName_Bool* @_eq_Uint32(i8* %"$execptr_load_470", %Uint32 %"$res_471", %Uint32 %"$input__472")
  store %TName_Bool* %"$eq_call_473", %TName_Bool** %test_3, align 8
...
"$have_gas_478":                                  ; preds = %"$out_of_gas_477", %"$have_gas_468"
  ...
  %"$BoolUtils.andb_call_484" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_fptr_481"(i8* %"$BoolUtils.andb_envptr_482", %TName_Bool* %"$$test_6_483")
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_call_484", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.andb_86", align 8
  ...
  %"$$BoolUtils.andb_86_call_489" = call %TName_Bool* %"$$BoolUtils.andb_86_fptr_486"(i8* %"$$BoolUtils.andb_86_envptr_487", %TName_Bool* %"$test__488")
  store %TName_Bool* %"$$BoolUtils.andb_86_call_489", %TName_Bool** %"$BoolUtils.andb_87", align 8
  %"$$BoolUtils.andb_87_490" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.andb_87", align 8
  store %TName_Bool* %"$$BoolUtils.andb_87_490", %TName_Bool** %"$test_9", align 8
...
"$have_gas_496":                                  ; preds = %"$out_of_gas_495", %"$None_491"
  ...
  store %TName_Bool* %"$false_498", %TName_Bool** %"$test_9", align 8
  br label %"$matchsucc_441"
...
"$have_gas_507":                                  ; preds = %"$out_of_gas_506", %"$have_gas_502"
  ...
  store %Uint64 { i64 -1 }, %Uint64* %"$input_10", align 8
...
"$have_gas_517":                                  ; preds = %"$out_of_gas_516", %"$have_gas_512"
  ...
  %"$to_uint32_call_523" = call i8* @_to_uint32(i8* %"$execptr_load_519", %_TyDescrTy_Typ* @"$TyDescr_Uint64_121", i8* %"$$to_uint32_$input_10_520_522")
  %"$to_uint32_524" = bitcast i8* %"$to_uint32_call_523" to %TName_Option_Uint32*
  store %TName_Option_Uint32* %"$to_uint32_524", %TName_Option_Uint32** %"$resopt_11", align 8
...
"$have_gas_547":                                  ; preds = %"$out_of_gas_546", %"$Some_540"
  ...
  store %TName_Bool* %"$false_549", %TName_Bool** %"$test_12", align 8
...
"$have_gas_555":                                  ; preds = %"$out_of_gas_554", %"$None_550"
  ...
  store %TName_Bool* %"$$test_9_557", %TName_Bool** %"$test_12", align 8
  br label %"$matchsucc_535"
...
"$have_gas_566":                                  ; preds = %"$out_of_gas_565", %"$have_gas_561"
  ...
  store %Uint128 { i128 18446744073709551615 }, %Uint128* %"$input_13", align 8
...
"$have_gas_576":                                  ; preds = %"$out_of_gas_575", %"$have_gas_571"
  ...
  %"$to_uint32_call_582" = call i8* @_to_uint32(i8* %"$execptr_load_578", %_TyDescrTy_Typ* @"$TyDescr_Uint128_125", i8* %"$$to_uint32_$input_13_579_581")
  %"$to_uint32_583" = bitcast i8* %"$to_uint32_call_582" to %TName_Option_Uint32*
  store %TName_Option_Uint32* %"$to_uint32_583", %TName_Option_Uint32** %"$resopt_14", align 8
...
"$have_gas_606":                                  ; preds = %"$out_of_gas_605", %"$Some_599"
  ...
  store %TName_Bool* %"$false_608", %TName_Bool** %"$test_15", align 8
...
"$have_gas_614":                                  ; preds = %"$out_of_gas_613", %"$None_609"
  ...
  store %TName_Bool* %"$$test_12_616", %TName_Bool** %"$test_15", align 8
  br label %"$matchsucc_594"
...
"$have_gas_625":                                  ; preds = %"$out_of_gas_624", %"$have_gas_620"
  ...
  store %Uint256 { i256 18446744073709551615 }, %Uint256* %"$input_16", align 8
...
"$have_gas_635":                                  ; preds = %"$out_of_gas_634", %"$have_gas_630"
  ...
  %"$to_uint32_call_641" = call i8* @_to_uint32(i8* %"$execptr_load_637", %_TyDescrTy_Typ* @"$TyDescr_Uint256_129", i8* %"$$to_uint32_$input_16_638_640")
  %"$to_uint32_642" = bitcast i8* %"$to_uint32_call_641" to %TName_Option_Uint32*
  store %TName_Option_Uint32* %"$to_uint32_642", %TName_Option_Uint32** %"$resopt_17", align 8
...
"$have_gas_665":                                  ; preds = %"$out_of_gas_664", %"$Some_658"
  ...
  store %TName_Bool* %"$false_667", %TName_Bool** %"$test_18", align 8
...
"$have_gas_673":                                  ; preds = %"$out_of_gas_672", %"$None_668"
  ...
  store %TName_Bool* %"$$test_15_675", %TName_Bool** %"$test_18", align 8
  br label %"$matchsucc_653"
...
"$have_gas_684":                                  ; preds = %"$out_of_gas_683", %"$have_gas_679"
  ...
  store %Uint32 { i32 100 }, %Uint32* %"$input_19", align 4
...
"$have_gas_694":                                  ; preds = %"$out_of_gas_693", %"$have_gas_689"
  ...
  %"$to_uint64_call_700" = call i8* @_to_uint64(i8* %"$execptr_load_696", %_TyDescrTy_Typ* @"$TyDescr_Uint32_117", i8* %"$$to_uint64_$input_19_697_699")
  %"$to_uint64_701" = bitcast i8* %"$to_uint64_call_700" to %TName_Option_Uint64*
  store %TName_Option_Uint64* %"$to_uint64_701", %TName_Option_Uint64** %"$resopt_20", align 8
...
"$have_gas_739":                                  ; preds = %"$out_of_gas_738", %"$have_gas_734"
  ...
  %"$eq_call_744" = call %TName_Bool* @_eq_Uint64(i8* %"$execptr_load_741", %Uint64 %"$res_742", %Uint64 %"$input__743")
  store %TName_Bool* %"$eq_call_744", %TName_Bool** %test_6, align 8
...
"$have_gas_749":                                  ; preds = %"$out_of_gas_748", %"$have_gas_739"
  ...
  %"$BoolUtils.andb_call_755" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_fptr_752"(i8* %"$BoolUtils.andb_envptr_753", %TName_Bool* %"$$test_18_754")
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_call_755", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.andb_88", align 8
  ...
  %"$$BoolUtils.andb_88_call_760" = call %TName_Bool* %"$$BoolUtils.andb_88_fptr_757"(i8* %"$$BoolUtils.andb_88_envptr_758", %TName_Bool* %"$test__759")
  store %TName_Bool* %"$$BoolUtils.andb_88_call_760", %TName_Bool** %"$BoolUtils.andb_89", align 8
  %"$$BoolUtils.andb_89_761" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.andb_89", align 8
  store %TName_Bool* %"$$BoolUtils.andb_89_761", %TName_Bool** %"$test_21", align 8
...
"$have_gas_767":                                  ; preds = %"$out_of_gas_766", %"$None_762"
  ...
  store %TName_Bool* %"$false_769", %TName_Bool** %"$test_21", align 8
  br label %"$matchsucc_712"
...
"$have_gas_778":                                  ; preds = %"$out_of_gas_777", %"$have_gas_773"
  ...
  store %Uint64 { i64 -1 }, %Uint64* %"$input_22", align 8
...
"$have_gas_788":                                  ; preds = %"$out_of_gas_787", %"$have_gas_783"
  ...
  %"$to_uint64_call_794" = call i8* @_to_uint64(i8* %"$execptr_load_790", %_TyDescrTy_Typ* @"$TyDescr_Uint64_121", i8* %"$$to_uint64_$input_22_791_793")
  %"$to_uint64_795" = bitcast i8* %"$to_uint64_call_794" to %TName_Option_Uint64*
  store %TName_Option_Uint64* %"$to_uint64_795", %TName_Option_Uint64** %"$resopt_23", align 8
...
"$have_gas_833":                                  ; preds = %"$out_of_gas_832", %"$have_gas_828"
  ...
  %"$eq_call_838" = call %TName_Bool* @_eq_Uint64(i8* %"$execptr_load_835", %Uint64 %"$res_836", %Uint64 %"$input__837")
  store %TName_Bool* %"$eq_call_838", %TName_Bool** %test_9, align 8
...
"$have_gas_843":                                  ; preds = %"$out_of_gas_842", %"$have_gas_833"
  ...
  %"$BoolUtils.andb_call_849" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_fptr_846"(i8* %"$BoolUtils.andb_envptr_847", %TName_Bool* %"$$test_21_848")
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_call_849", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.andb_90", align 8
  ...
  %"$$BoolUtils.andb_90_call_854" = call %TName_Bool* %"$$BoolUtils.andb_90_fptr_851"(i8* %"$$BoolUtils.andb_90_envptr_852", %TName_Bool* %"$test__853")
  store %TName_Bool* %"$$BoolUtils.andb_90_call_854", %TName_Bool** %"$BoolUtils.andb_91", align 8
  %"$$BoolUtils.andb_91_855" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.andb_91", align 8
  store %TName_Bool* %"$$BoolUtils.andb_91_855", %TName_Bool** %"$test_24", align 8
...
"$have_gas_861":                                  ; preds = %"$out_of_gas_860", %"$None_856"
  ...
  store %TName_Bool* %"$false_863", %TName_Bool** %"$test_24", align 8
  br label %"$matchsucc_806"
...
"$have_gas_872":                                  ; preds = %"$out_of_gas_871", %"$have_gas_867"
  ...
  store %Uint128 { i128 18446744073709551615 }, %Uint128* %"$input_25", align 8
...
"$have_gas_882":                                  ; preds = %"$out_of_gas_881", %"$have_gas_877"
  ...
  %"$to_uint64_call_888" = call i8* @_to_uint64(i8* %"$execptr_load_884", %_TyDescrTy_Typ* @"$TyDescr_Uint128_125", i8* %"$$to_uint64_$input_25_885_887")
  %"$to_uint64_889" = bitcast i8* %"$to_uint64_call_888" to %TName_Option_Uint64*
  store %TName_Option_Uint64* %"$to_uint64_889", %TName_Option_Uint64** %"$resopt_26", align 8
...
"$have_gas_927":                                  ; preds = %"$out_of_gas_926", %"$have_gas_922"
  ...
  %"$eq_call_932" = call %TName_Bool* @_eq_Uint64(i8* %"$execptr_load_929", %Uint64 %"$res_930", %Uint64 %"$input__931")
  store %TName_Bool* %"$eq_call_932", %TName_Bool** %test_12, align 8
...
"$have_gas_937":                                  ; preds = %"$out_of_gas_936", %"$have_gas_927"
  ...
  %"$BoolUtils.andb_call_943" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_fptr_940"(i8* %"$BoolUtils.andb_envptr_941", %TName_Bool* %"$$test_24_942")
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_call_943", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.andb_92", align 8
  ...
  %"$$BoolUtils.andb_92_call_948" = call %TName_Bool* %"$$BoolUtils.andb_92_fptr_945"(i8* %"$$BoolUtils.andb_92_envptr_946", %TName_Bool* %"$test__947")
  store %TName_Bool* %"$$BoolUtils.andb_92_call_948", %TName_Bool** %"$BoolUtils.andb_93", align 8
  %"$$BoolUtils.andb_93_949" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.andb_93", align 8
  store %TName_Bool* %"$$BoolUtils.andb_93_949", %TName_Bool** %"$test_27", align 8
...
"$have_gas_955":                                  ; preds = %"$out_of_gas_954", %"$None_950"
  ...
  store %TName_Bool* %"$false_957", %TName_Bool** %"$test_27", align 8
  br label %"$matchsucc_900"
...
"$have_gas_966":                                  ; preds = %"$out_of_gas_965", %"$have_gas_961"
  ...
  store %Uint128 { i128 18446744073709551616 }, %Uint128* %"$input_28", align 8
...
"$have_gas_976":                                  ; preds = %"$out_of_gas_975", %"$have_gas_971"
  ...
  %"$to_uint64_call_982" = call i8* @_to_uint64(i8* %"$execptr_load_978", %_TyDescrTy_Typ* @"$TyDescr_Uint128_125", i8* %"$$to_uint64_$input_28_979_981")
  %"$to_uint64_983" = bitcast i8* %"$to_uint64_call_982" to %TName_Option_Uint64*
  store %TName_Option_Uint64* %"$to_uint64_983", %TName_Option_Uint64** %"$resopt_29", align 8
...
"$have_gas_1006":                                 ; preds = %"$out_of_gas_1005", %"$Some_999"
  ...
  store %TName_Bool* %"$false_1008", %TName_Bool** %"$test_30", align 8
...
"$have_gas_1014":                                 ; preds = %"$out_of_gas_1013", %"$None_1009"
  ...
  store %TName_Bool* %"$$test_27_1016", %TName_Bool** %"$test_30", align 8
  br label %"$matchsucc_994"
...
"$have_gas_1025":                                 ; preds = %"$out_of_gas_1024", %"$have_gas_1020"
  ...
  store %Uint256 { i256 18446744073709551616 }, %Uint256* %"$input_31", align 8
...
"$have_gas_1035":                                 ; preds = %"$out_of_gas_1034", %"$have_gas_1030"
  ...
  %"$to_uint64_call_1041" = call i8* @_to_uint64(i8* %"$execptr_load_1037", %_TyDescrTy_Typ* @"$TyDescr_Uint256_129", i8* %"$$to_uint64_$input_31_1038_1040")
  %"$to_uint64_1042" = bitcast i8* %"$to_uint64_call_1041" to %TName_Option_Uint64*
  store %TName_Option_Uint64* %"$to_uint64_1042", %TName_Option_Uint64** %"$resopt_32", align 8
...
"$have_gas_1065":                                 ; preds = %"$out_of_gas_1064", %"$Some_1058"
  ...
  store %TName_Bool* %"$false_1067", %TName_Bool** %"$test_33", align 8
...
"$have_gas_1073":                                 ; preds = %"$out_of_gas_1072", %"$None_1068"
  ...
  store %TName_Bool* %"$$test_30_1075", %TName_Bool** %"$test_33", align 8
  br label %"$matchsucc_1053"
...
"$have_gas_1084":                                 ; preds = %"$out_of_gas_1083", %"$have_gas_1079"
  ...
  store %Uint128 { i128 18446744073709551615 }, %Uint128* %"$input_34", align 8
...
"$have_gas_1094":                                 ; preds = %"$out_of_gas_1093", %"$have_gas_1089"
  ...
  %"$to_uint128_call_1100" = call i8* @_to_uint128(i8* %"$execptr_load_1096", %_TyDescrTy_Typ* @"$TyDescr_Uint128_125", i8* %"$$to_uint128_$input_34_1097_1099")
  %"$to_uint128_1101" = bitcast i8* %"$to_uint128_call_1100" to %TName_Option_Uint128*
  store %TName_Option_Uint128* %"$to_uint128_1101", %TName_Option_Uint128** %"$resopt_35", align 8
...
"$have_gas_1140":                                 ; preds = %"$out_of_gas_1139", %"$have_gas_1134"
  ...
  %"$eq_call_1145" = call %TName_Bool* @_eq_Uint128(i8* %"$execptr_load_1142", %Uint128 %"$res_1143", %Uint128 %"$input__1144")
  store %TName_Bool* %"$eq_call_1145", %TName_Bool** %test_15, align 8
...
"$have_gas_1150":                                 ; preds = %"$out_of_gas_1149", %"$have_gas_1140"
  ...
  %"$BoolUtils.andb_call_1156" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_fptr_1153"(i8* %"$BoolUtils.andb_envptr_1154", %TName_Bool* %"$$test_33_1155")
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_call_1156", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.andb_94", align 8
  ...
  %"$$BoolUtils.andb_94_call_1161" = call %TName_Bool* %"$$BoolUtils.andb_94_fptr_1158"(i8* %"$$BoolUtils.andb_94_envptr_1159", %TName_Bool* %"$test__1160")
  store %TName_Bool* %"$$BoolUtils.andb_94_call_1161", %TName_Bool** %"$BoolUtils.andb_95", align 8
  %"$$BoolUtils.andb_95_1162" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.andb_95", align 8
  store %TName_Bool* %"$$BoolUtils.andb_95_1162", %TName_Bool** %"$test_36", align 8
...
"$have_gas_1168":                                 ; preds = %"$out_of_gas_1167", %"$None_1163"
  ...
  store %TName_Bool* %"$false_1170", %TName_Bool** %"$test_36", align 8
  br label %"$matchsucc_1112"
...
"$have_gas_1179":                                 ; preds = %"$out_of_gas_1178", %"$have_gas_1174"
  ...
  store %Uint128 { i128 -1 }, %Uint128* %"$input_37", align 8
...
"$have_gas_1189":                                 ; preds = %"$out_of_gas_1188", %"$have_gas_1184"
  ...
  %"$to_uint128_call_1195" = call i8* @_to_uint128(i8* %"$execptr_load_1191", %_TyDescrTy_Typ* @"$TyDescr_Uint128_125", i8* %"$$to_uint128_$input_37_1192_1194")
  %"$to_uint128_1196" = bitcast i8* %"$to_uint128_call_1195" to %TName_Option_Uint128*
  store %TName_Option_Uint128* %"$to_uint128_1196", %TName_Option_Uint128** %"$resopt_38", align 8
...
"$have_gas_1235":                                 ; preds = %"$out_of_gas_1234", %"$have_gas_1229"
  ...
  %"$eq_call_1240" = call %TName_Bool* @_eq_Uint128(i8* %"$execptr_load_1237", %Uint128 %"$res_1238", %Uint128 %"$input__1239")
  store %TName_Bool* %"$eq_call_1240", %TName_Bool** %test_18, align 8
...
"$have_gas_1245":                                 ; preds = %"$out_of_gas_1244", %"$have_gas_1235"
  ...
  %"$BoolUtils.andb_call_1251" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_fptr_1248"(i8* %"$BoolUtils.andb_envptr_1249", %TName_Bool* %"$$test_36_1250")
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_call_1251", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.andb_96", align 8
  ...
  %"$$BoolUtils.andb_96_call_1256" = call %TName_Bool* %"$$BoolUtils.andb_96_fptr_1253"(i8* %"$$BoolUtils.andb_96_envptr_1254", %TName_Bool* %"$test__1255")
  store %TName_Bool* %"$$BoolUtils.andb_96_call_1256", %TName_Bool** %"$BoolUtils.andb_97", align 8
  %"$$BoolUtils.andb_97_1257" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.andb_97", align 8
  store %TName_Bool* %"$$BoolUtils.andb_97_1257", %TName_Bool** %"$test_39", align 8
...
"$have_gas_1263":                                 ; preds = %"$out_of_gas_1262", %"$None_1258"
  ...
  store %TName_Bool* %"$false_1265", %TName_Bool** %"$test_39", align 8
  br label %"$matchsucc_1207"
...
"$have_gas_1274":                                 ; preds = %"$out_of_gas_1273", %"$have_gas_1269"
  ...
  store %Uint256 { i256 340282366920938463463374607431768211456 }, %Uint256* %"$input_40", align 8
...
"$have_gas_1284":                                 ; preds = %"$out_of_gas_1283", %"$have_gas_1279"
  ...
  %"$to_uint128_call_1290" = call i8* @_to_uint128(i8* %"$execptr_load_1286", %_TyDescrTy_Typ* @"$TyDescr_Uint256_129", i8* %"$$to_uint128_$input_40_1287_1289")
  %"$to_uint128_1291" = bitcast i8* %"$to_uint128_call_1290" to %TName_Option_Uint128*
  store %TName_Option_Uint128* %"$to_uint128_1291", %TName_Option_Uint128** %"$resopt_41", align 8
...
"$have_gas_1314":                                 ; preds = %"$out_of_gas_1313", %"$Some_1307"
  ...
  store %TName_Bool* %"$false_1316", %TName_Bool** %"$test_42", align 8
...
"$have_gas_1322":                                 ; preds = %"$out_of_gas_1321", %"$None_1317"
  ...
  store %TName_Bool* %"$$test_39_1324", %TName_Bool** %"$test_42", align 8
  br label %"$matchsucc_1302"
...
"$have_gas_1333":                                 ; preds = %"$out_of_gas_1332", %"$have_gas_1328"
  ...
  store %Uint256 { i256 340282366920938463463374607431768211456 }, %Uint256* %"$input_43", align 8
...
"$have_gas_1343":                                 ; preds = %"$out_of_gas_1342", %"$have_gas_1338"
  ...
  %"$to_uint256_call_1349" = call i8* @_to_uint256(i8* %"$execptr_load_1345", %_TyDescrTy_Typ* @"$TyDescr_Uint256_129", i8* %"$$to_uint256_$input_43_1346_1348")
  %"$to_uint256_1350" = bitcast i8* %"$to_uint256_call_1349" to %TName_Option_Uint256*
  store %TName_Option_Uint256* %"$to_uint256_1350", %TName_Option_Uint256** %"$resopt_44", align 8
...
"$have_gas_1389":                                 ; preds = %"$out_of_gas_1388", %"$have_gas_1383"
  ...
  %"$eq_call_1396" = call %TName_Bool* @_eq_Uint256(i8* %"$execptr_load_1391", %Uint256* %"$eq_res_1392", %Uint256* %"$eq_input__1394")
  store %TName_Bool* %"$eq_call_1396", %TName_Bool** %test_21, align 8
...
"$have_gas_1401":                                 ; preds = %"$out_of_gas_1400", %"$have_gas_1389"
  ...
  %"$BoolUtils.andb_call_1407" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_fptr_1404"(i8* %"$BoolUtils.andb_envptr_1405", %TName_Bool* %"$$test_42_1406")
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_call_1407", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.andb_98", align 8
  ...
  %"$$BoolUtils.andb_98_call_1412" = call %TName_Bool* %"$$BoolUtils.andb_98_fptr_1409"(i8* %"$$BoolUtils.andb_98_envptr_1410", %TName_Bool* %"$test__1411")
  store %TName_Bool* %"$$BoolUtils.andb_98_call_1412", %TName_Bool** %"$BoolUtils.andb_99", align 8
  %"$$BoolUtils.andb_99_1413" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.andb_99", align 8
  store %TName_Bool* %"$$BoolUtils.andb_99_1413", %TName_Bool** %"$test_45", align 8
...
"$have_gas_1419":                                 ; preds = %"$out_of_gas_1418", %"$None_1414"
  ...
  store %TName_Bool* %"$false_1421", %TName_Bool** %"$test_45", align 8
  br label %"$matchsucc_1361"
...
"$have_gas_1430":                                 ; preds = %"$out_of_gas_1429", %"$have_gas_1425"
  ...
  store %Uint32 { i32 22 }, %Uint32* %"$input_46", align 4
...
"$have_gas_1440":                                 ; preds = %"$out_of_gas_1439", %"$have_gas_1435"
  ...
  %"$to_uint256_call_1446" = call i8* @_to_uint256(i8* %"$execptr_load_1442", %_TyDescrTy_Typ* @"$TyDescr_Uint32_117", i8* %"$$to_uint256_$input_46_1443_1445")
  %"$to_uint256_1447" = bitcast i8* %"$to_uint256_call_1446" to %TName_Option_Uint256*
  store %TName_Option_Uint256* %"$to_uint256_1447", %TName_Option_Uint256** %"$resopt_47", align 8
...
"$have_gas_1486":                                 ; preds = %"$out_of_gas_1485", %"$have_gas_1480"
  ...
  %"$eq_call_1493" = call %TName_Bool* @_eq_Uint256(i8* %"$execptr_load_1488", %Uint256* %"$eq_res_1489", %Uint256* %"$eq_input__1491")
  store %TName_Bool* %"$eq_call_1493", %TName_Bool** %test_24, align 8
...
"$have_gas_1498":                                 ; preds = %"$out_of_gas_1497", %"$have_gas_1486"
  ...
  %"$BoolUtils.andb_call_1504" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_fptr_1501"(i8* %"$BoolUtils.andb_envptr_1502", %TName_Bool* %"$$test_45_1503")
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_call_1504", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.andb_100", align 8
  ...
  %"$$BoolUtils.andb_100_call_1509" = call %TName_Bool* %"$$BoolUtils.andb_100_fptr_1506"(i8* %"$$BoolUtils.andb_100_envptr_1507", %TName_Bool* %"$test__1508")
  store %TName_Bool* %"$$BoolUtils.andb_100_call_1509", %TName_Bool** %"$BoolUtils.andb_101", align 8
  %"$$BoolUtils.andb_101_1510" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.andb_101", align 8
  store %TName_Bool* %"$$BoolUtils.andb_101_1510", %TName_Bool** %"$test_48", align 8
...
"$have_gas_1516":                                 ; preds = %"$out_of_gas_1515", %"$None_1511"
  ...
  store %TName_Bool* %"$false_1518", %TName_Bool** %"$test_48", align 8
  br label %"$matchsucc_1458"
...
"$have_gas_1527":                                 ; preds = %"$out_of_gas_1526", %"$have_gas_1522"
  ...
  store %Int32 { i32 2147483647 }, %Int32* %"$input_49", align 4
...
"$have_gas_1537":                                 ; preds = %"$out_of_gas_1536", %"$have_gas_1532"
  ...
  %"$to_uint32_call_1543" = call i8* @_to_uint32(i8* %"$execptr_load_1539", %_TyDescrTy_Typ* @"$TyDescr_Int32_115", i8* %"$$to_uint32_$input_49_1540_1542")
  %"$to_uint32_1544" = bitcast i8* %"$to_uint32_call_1543" to %TName_Option_Uint32*
  store %TName_Option_Uint32* %"$to_uint32_1544", %TName_Option_Uint32** %"$resopt_50", align 8
...
"$have_gas_1582":                                 ; preds = %"$out_of_gas_1581", %"$have_gas_1577"
  ...
  %"$eq_call_1587" = call %TName_Bool* @_eq_Uint32(i8* %"$execptr_load_1584", %Uint32 %"$res_1585", %Uint32 %"$input__1586")
  store %TName_Bool* %"$eq_call_1587", %TName_Bool** %test_27, align 8
...
"$have_gas_1592":                                 ; preds = %"$out_of_gas_1591", %"$have_gas_1582"
  ...
  %"$BoolUtils.andb_call_1598" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_fptr_1595"(i8* %"$BoolUtils.andb_envptr_1596", %TName_Bool* %"$$test_48_1597")
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_call_1598", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.andb_102", align 8
  ...
  %"$$BoolUtils.andb_102_call_1603" = call %TName_Bool* %"$$BoolUtils.andb_102_fptr_1600"(i8* %"$$BoolUtils.andb_102_envptr_1601", %TName_Bool* %"$test__1602")
  store %TName_Bool* %"$$BoolUtils.andb_102_call_1603", %TName_Bool** %"$BoolUtils.andb_103", align 8
  %"$$BoolUtils.andb_103_1604" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.andb_103", align 8
  store %TName_Bool* %"$$BoolUtils.andb_103_1604", %TName_Bool** %"$test_51", align 8
...
"$have_gas_1610":                                 ; preds = %"$out_of_gas_1609", %"$None_1605"
  ...
  store %TName_Bool* %"$false_1612", %TName_Bool** %"$test_51", align 8
  br label %"$matchsucc_1555"
...
"$have_gas_1621":                                 ; preds = %"$out_of_gas_1620", %"$have_gas_1616"
  ...
  store %Int32 { i32 -2147483648 }, %Int32* %"$input_52", align 4
...
"$have_gas_1631":                                 ; preds = %"$out_of_gas_1630", %"$have_gas_1626"
  ...
  %"$to_uint32_call_1637" = call i8* @_to_uint32(i8* %"$execptr_load_1633", %_TyDescrTy_Typ* @"$TyDescr_Int32_115", i8* %"$$to_uint32_$input_52_1634_1636")
  %"$to_uint32_1638" = bitcast i8* %"$to_uint32_call_1637" to %TName_Option_Uint32*
  store %TName_Option_Uint32* %"$to_uint32_1638", %TName_Option_Uint32** %"$resopt_53", align 8
...
"$have_gas_1661":                                 ; preds = %"$out_of_gas_1660", %"$Some_1654"
  ...
  store %TName_Bool* %"$false_1663", %TName_Bool** %"$test_54", align 8
...
"$have_gas_1669":                                 ; preds = %"$out_of_gas_1668", %"$None_1664"
  ...
  store %TName_Bool* %"$$test_51_1671", %TName_Bool** %"$test_54", align 8
  br label %"$matchsucc_1649"
...
"$have_gas_1680":                                 ; preds = %"$out_of_gas_1679", %"$have_gas_1675"
  ...
  store %String { i8* getelementptr inbounds ([11 x i8], [11 x i8]* @"$stringlit_1682", i32 0, i32 0), i32 11 }, %String* %"$input_55", align 8
...
"$have_gas_1691":                                 ; preds = %"$out_of_gas_1690", %"$have_gas_1686"
  ...
  %"$to_uint32_call_1697" = call i8* @_to_uint32(i8* %"$execptr_load_1693", %_TyDescrTy_Typ* @"$TyDescr_String_131", i8* %"$$to_uint32_$input_55_1694_1696")
  %"$to_uint32_1698" = bitcast i8* %"$to_uint32_call_1697" to %TName_Option_Uint32*
  store %TName_Option_Uint32* %"$to_uint32_1698", %TName_Option_Uint32** %"$resopt_56", align 8
...
"$have_gas_1721":                                 ; preds = %"$out_of_gas_1720", %"$Some_1714"
  ...
  store %TName_Bool* %"$false_1723", %TName_Bool** %"$test_57", align 8
...
"$have_gas_1729":                                 ; preds = %"$out_of_gas_1728", %"$None_1724"
  ...
  store %TName_Bool* %"$$test_54_1731", %TName_Bool** %"$test_57", align 8
  br label %"$matchsucc_1709"
...
"$have_gas_1740":                                 ; preds = %"$out_of_gas_1739", %"$have_gas_1735"
  ...
  store %Int256 { i256 57896044618658097711785492504343953926634992332820282019728792003956564819967 }, %Int256* %"$input_58", align 8
...
"$have_gas_1750":                                 ; preds = %"$out_of_gas_1749", %"$have_gas_1745"
  ...
  %"$to_uint256_call_1756" = call i8* @_to_uint256(i8* %"$execptr_load_1752", %_TyDescrTy_Typ* @"$TyDescr_Int256_127", i8* %"$$to_uint256_$input_58_1753_1755")
  %"$to_uint256_1757" = bitcast i8* %"$to_uint256_call_1756" to %TName_Option_Uint256*
  store %TName_Option_Uint256* %"$to_uint256_1757", %TName_Option_Uint256** %"$resopt_59", align 8
...
"$have_gas_1796":                                 ; preds = %"$out_of_gas_1795", %"$have_gas_1790"
  ...
  %"$eq_call_1803" = call %TName_Bool* @_eq_Uint256(i8* %"$execptr_load_1798", %Uint256* %"$eq_res_1799", %Uint256* %"$eq_input__1801")
  store %TName_Bool* %"$eq_call_1803", %TName_Bool** %test_30, align 8
...
"$have_gas_1808":                                 ; preds = %"$out_of_gas_1807", %"$have_gas_1796"
  ...
  %"$BoolUtils.andb_call_1814" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_fptr_1811"(i8* %"$BoolUtils.andb_envptr_1812", %TName_Bool* %"$$test_57_1813")
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_call_1814", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.andb_104", align 8
  ...
  %"$$BoolUtils.andb_104_call_1819" = call %TName_Bool* %"$$BoolUtils.andb_104_fptr_1816"(i8* %"$$BoolUtils.andb_104_envptr_1817", %TName_Bool* %"$test__1818")
  store %TName_Bool* %"$$BoolUtils.andb_104_call_1819", %TName_Bool** %"$BoolUtils.andb_105", align 8
  %"$$BoolUtils.andb_105_1820" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.andb_105", align 8
  store %TName_Bool* %"$$BoolUtils.andb_105_1820", %TName_Bool** %"$test_60", align 8
...
"$have_gas_1826":                                 ; preds = %"$out_of_gas_1825", %"$None_1821"
  ...
  store %TName_Bool* %"$false_1828", %TName_Bool** %"$test_60", align 8
  br label %"$matchsucc_1768"
...
"$have_gas_1837":                                 ; preds = %"$out_of_gas_1836", %"$have_gas_1832"
  ...
  store %String { i8* getelementptr inbounds ([77 x i8], [77 x i8]* @"$stringlit_1839", i32 0, i32 0), i32 77 }, %String* %"$input_61", align 8
...
"$have_gas_1848":                                 ; preds = %"$out_of_gas_1847", %"$have_gas_1843"
  ...
  %"$to_uint256_call_1854" = call i8* @_to_uint256(i8* %"$execptr_load_1850", %_TyDescrTy_Typ* @"$TyDescr_String_131", i8* %"$$to_uint256_$input_61_1851_1853")
  %"$to_uint256_1855" = bitcast i8* %"$to_uint256_call_1854" to %TName_Option_Uint256*
  store %TName_Option_Uint256* %"$to_uint256_1855", %TName_Option_Uint256** %"$resopt_62", align 8
...
"$have_gas_1894":                                 ; preds = %"$out_of_gas_1893", %"$have_gas_1888"
  ...
  %"$eq_call_1901" = call %TName_Bool* @_eq_Uint256(i8* %"$execptr_load_1896", %Uint256* %"$eq_res_1897", %Uint256* %"$eq_input__1899")
  store %TName_Bool* %"$eq_call_1901", %TName_Bool** %test_33, align 8
...
"$have_gas_1906":                                 ; preds = %"$out_of_gas_1905", %"$have_gas_1894"
  ...
  %"$BoolUtils.andb_call_1912" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_fptr_1909"(i8* %"$BoolUtils.andb_envptr_1910", %TName_Bool* %"$$test_60_1911")
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_call_1912", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.andb_106", align 8
  ...
  %"$$BoolUtils.andb_106_call_1917" = call %TName_Bool* %"$$BoolUtils.andb_106_fptr_1914"(i8* %"$$BoolUtils.andb_106_envptr_1915", %TName_Bool* %"$test__1916")
  store %TName_Bool* %"$$BoolUtils.andb_106_call_1917", %TName_Bool** %"$BoolUtils.andb_107", align 8
  %"$$BoolUtils.andb_107_1918" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.andb_107", align 8
  store %TName_Bool* %"$$BoolUtils.andb_107_1918", %TName_Bool** %"$test_63", align 8
...
"$have_gas_1924":                                 ; preds = %"$out_of_gas_1923", %"$None_1919"
  ...
  store %TName_Bool* %"$false_1926", %TName_Bool** %"$test_63", align 8
  br label %"$matchsucc_1866"
...
"$have_gas_1935":                                 ; preds = %"$out_of_gas_1934", %"$have_gas_1930"
  ...
  store %Int256 { i256 -282366920938463463374607431768211456 }, %Int256* %"$input_64", align 8
...
"$have_gas_1945":                                 ; preds = %"$out_of_gas_1944", %"$have_gas_1940"
  ...
  %"$to_uint256_call_1951" = call i8* @_to_uint256(i8* %"$execptr_load_1947", %_TyDescrTy_Typ* @"$TyDescr_Int256_127", i8* %"$$to_uint256_$input_64_1948_1950")
  %"$to_uint256_1952" = bitcast i8* %"$to_uint256_call_1951" to %TName_Option_Uint256*
  store %TName_Option_Uint256* %"$to_uint256_1952", %TName_Option_Uint256** %"$resopt_65", align 8
...
"$have_gas_1975":                                 ; preds = %"$out_of_gas_1974", %"$Some_1968"
  ...
  store %TName_Bool* %"$false_1977", %TName_Bool** %"$test_66", align 8
...
"$have_gas_1983":                                 ; preds = %"$out_of_gas_1982", %"$None_1978"
  ...
  store %TName_Bool* %"$$test_63_1985", %TName_Bool** %"$test_66", align 8
  br label %"$matchsucc_1963"
...
"$have_gas_1994":                                 ; preds = %"$out_of_gas_1993", %"$have_gas_1989"
  ...
  store %String { i8* getelementptr inbounds ([37 x i8], [37 x i8]* @"$stringlit_1996", i32 0, i32 0), i32 37 }, %String* %"$input_67", align 8
...
"$have_gas_2005":                                 ; preds = %"$out_of_gas_2004", %"$have_gas_2000"
  ...
  %"$to_uint256_call_2011" = call i8* @_to_uint256(i8* %"$execptr_load_2007", %_TyDescrTy_Typ* @"$TyDescr_String_131", i8* %"$$to_uint256_$input_67_2008_2010")
  %"$to_uint256_2012" = bitcast i8* %"$to_uint256_call_2011" to %TName_Option_Uint256*
  store %TName_Option_Uint256* %"$to_uint256_2012", %TName_Option_Uint256** %"$resopt_68", align 8
...
"$have_gas_2035":                                 ; preds = %"$out_of_gas_2034", %"$Some_2028"
  ...
  store %TName_Bool* %"$false_2037", %TName_Bool** %"$test_69", align 8
...
"$have_gas_2043":                                 ; preds = %"$out_of_gas_2042", %"$None_2038"
  ...
  store %TName_Bool* %"$$test_66_2045", %TName_Bool** %"$test_69", align 8
  br label %"$matchsucc_2023"
...
"$have_gas_2054":                                 ; preds = %"$out_of_gas_2053", %"$have_gas_2049"
  ...
  store %String { i8* getelementptr inbounds ([4 x i8], [4 x i8]* @"$stringlit_2056", i32 0, i32 0), i32 4 }, %String* %"$input_70", align 8
...
"$have_gas_2065":                                 ; preds = %"$out_of_gas_2064", %"$have_gas_2060"
  ...
  %"$to_uint64_call_2071" = call i8* @_to_uint64(i8* %"$execptr_load_2067", %_TyDescrTy_Typ* @"$TyDescr_String_131", i8* %"$$to_uint64_$input_70_2068_2070")
  %"$to_uint64_2072" = bitcast i8* %"$to_uint64_call_2071" to %TName_Option_Uint64*
  store %TName_Option_Uint64* %"$to_uint64_2072", %TName_Option_Uint64** %"$resopt_71", align 8
...
"$have_gas_2095":                                 ; preds = %"$out_of_gas_2094", %"$Some_2088"
  ...
  store %TName_Bool* %"$false_2097", %TName_Bool** %"$test_72", align 8
...
"$have_gas_2103":                                 ; preds = %"$out_of_gas_2102", %"$None_2098"
  ...
  store %TName_Bool* %"$$test_69_2105", %TName_Bool** %"$test_72", align 8
  br label %"$matchsucc_2083"
...
"$have_gas_2109":                                 ; preds = %"$out_of_gas_2108", %"$matchsucc_2083"
  ...
  store %TName_Bool* %"$$test_72_2111", %TName_Bool** %"$expr_112", align 8
