...
"$have_gas_173":                                  ; preds = %"$out_of_gas_172", %"$have_gas_168"
  ...
  %"$div_call_177" = call %Int32 @_div_Int32(%Int32 %"$$a_6_175", %Int32 %"$$b_7_176")
...
"$have_gas_186":                                  ; preds = %"$out_of_gas_185", %"$have_gas_181"
  ...
  %"$rem_call_190" = call %Int32 @_rem_Int32(%Int32 %"$$a_6_188", %Int32 %"$$b_7_189")
...
"$have_gas_232":                                  ; preds = %"$out_of_gas_231", %"$have_gas_227"
  ...
  %"$div_call_236" = call %Int32 @_div_Int32(%Int32 %"$$a_10_234", %Int32 %"$$b_11_235")
...
"$have_gas_245":                                  ; preds = %"$out_of_gas_244", %"$have_gas_240"
  ...
  %"$rem_call_249" = call %Int32 @_rem_Int32(%Int32 %"$$a_10_247", %Int32 %"$$b_11_248")
...
"$have_gas_291":                                  ; preds = %"$out_of_gas_290", %"$have_gas_286"
  ...
  %"$div_call_295" = call %Int32 @_div_Int32(%Int32 %"$$a_14_293", %Int32 %"$$b_15_294")
...
"$have_gas_304":                                  ; preds = %"$out_of_gas_303", %"$have_gas_299"
  ...
  %"$rem_call_308" = call %Int32 @_rem_Int32(%Int32 %"$$a_14_306", %Int32 %"$$b_15_307")
