...
"$have_gas_368":                                  ; preds = %"$out_of_gas_367", %"$have_gas_363"
  ...
  %"$add_call_372" = call %Int32 @_add_Int32(%Int32 %"$x_370", %Int32 %"$y_371")
  store %Int32 %"$add_call_372", %Int32* %z, align 4
...
"$have_gas_376":                                  ; preds = %"$out_of_gas_375", %"$have_gas_368"
  ...
  store %TName_Pair_Int32_Int32* %"$adtptr_384", %TName_Pair_Int32_Int32** %"$retval_25", align 8
...
"$have_gas_389":                                  ; preds = %"$out_of_gas_388", %entry
  ...
  store { i8*, i8* }* %"$dyndisp_table_394", { i8*, i8* }** @nat_fold, align 8
  ret void
}
...
"$have_gas_405":                                  ; preds = %"$out_of_gas_404", %"$have_gas_400"
  ...
  store %TName_Nat* %"$adtptr_409", %TName_Nat** %zero, align 8
...
"$have_gas_418":                                  ; preds = %"$out_of_gas_417", %"$have_gas_413"
  ...
  store %TName_Nat* %"$adtptr_424", %TName_Nat** %one, align 8
...
"$have_gas_433":                                  ; preds = %"$out_of_gas_432", %"$have_gas_428"
  ...
  store %TName_Nat* %"$adtptr_439", %TName_Nat** %two, align 8
...
"$have_gas_448":                                  ; preds = %"$out_of_gas_447", %"$have_gas_443"
  ...
  store %TName_Nat* %"$adtptr_454", %TName_Nat** %three, align 8
...
"$have_gas_463":                                  ; preds = %"$out_of_gas_462", %"$have_gas_458"
  ...
  store %TName_Nat* %"$adtptr_469", %TName_Nat** %four, align 8
...
"$have_gas_478":                                  ; preds = %"$out_of_gas_477", %"$have_gas_473"
  ...
  store %TName_Nat* %"$adtptr_484", %TName_Nat** %five, align 8
...
"$have_gas_493":                                  ; preds = %"$out_of_gas_492", %"$have_gas_488"
  ...
  store %TName_Nat* %"$adtptr_499", %TName_Nat** %six, align 8
...
"$have_gas_508":                                  ; preds = %"$out_of_gas_507", %"$have_gas_503"
  ...
  store %TName_Nat* %"$adtptr_514", %TName_Nat** %seven, align 8
...
"$have_gas_523":                                  ; preds = %"$out_of_gas_522", %"$have_gas_518"
  ...
  store { %Int32 (i8*, %TName_Nat*)*, i8* } %"$$fundef_20_cloval_528", { %Int32 (i8*, %TName_Nat*)*, i8* }* %fib, align 8
...
"$have_gas_534":                                  ; preds = %"$out_of_gas_533", %"$have_gas_523"
  ...
  %"$fib_call_540" = call %Int32 %"$fib_fptr_537"(i8* %"$fib_envptr_538", %TName_Nat* %"$seven_539")
  store %Int32 %"$fib_call_540", %Int32* %"$fib_10", align 4
  %"$$fib_10_541" = load %Int32, %Int32* %"$fib_10", align 4
  store %Int32 %"$$fib_10_541", %Int32* %"$expr_19", align 4
