...
"$have_gas_93":                                   ; preds = %"$out_of_gas_92", %"$have_gas_88"
  ...
  store %TName_Nat* %"$adtptr_97", %TName_Nat** %zero, align 8
...
"$have_gas_106":                                  ; preds = %"$out_of_gas_105", %"$have_gas_101"
  ...
  store %TName_Nat* %"$adtptr_112", %TName_Nat** %one, align 8
...
"$have_gas_121":                                  ; preds = %"$out_of_gas_120", %"$have_gas_116"
  ...
  store %TName_Nat* %"$adtptr_127", %TName_Nat** %two, align 8
...
"$have_gas_131":                                  ; preds = %"$out_of_gas_130", %"$have_gas_121"
  ...
  store %TName_Nat* %"$two_133", %TName_Nat** %"$expr_6", align 8
