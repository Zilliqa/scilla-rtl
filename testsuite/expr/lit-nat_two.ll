...
"$have_gas_95":                                   ; preds = %"$out_of_gas_94", %"$have_gas_90"
  ...
  store %TName_Nat* %"$adtptr_99", %TName_Nat** %zero, align 8
...
"$have_gas_108":                                  ; preds = %"$out_of_gas_107", %"$have_gas_103"
  ...
  store %TName_Nat* %"$adtptr_114", %TName_Nat** %one, align 8
...
"$have_gas_123":                                  ; preds = %"$out_of_gas_122", %"$have_gas_118"
  ...
  store %TName_Nat* %"$adtptr_129", %TName_Nat** %two, align 8
...
"$have_gas_133":                                  ; preds = %"$out_of_gas_132", %"$have_gas_123"
  ...
  store %TName_Nat* %"$two_135", %TName_Nat** %"$expr_6", align 8
