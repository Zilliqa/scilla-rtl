...
"$have_gas_177":                                  ; preds = %"$out_of_gas_176", %"$have_gas_163"
  ...
  %"$isqrt_call_180" = call %Uint32 @_isqrt_Uint32(%Uint32 %"$zero_179")
  store %Uint32 %"$isqrt_call_180", %Uint32* %isqrt_zero, align 4
...
"$have_gas_198":                                  ; preds = %"$out_of_gas_197", %"$have_gas_184"
  ...
  %"$isqrt_call_201" = call %Uint32 @_isqrt_Uint32(%Uint32 %"$one_200")
  store %Uint32 %"$isqrt_call_201", %Uint32* %isqrt_one, align 4
...
"$have_gas_218":                                  ; preds = %"$out_of_gas_217", %"$have_gas_205"
  ...
  %"$isqrt_call_221" = call %Uint64 @_isqrt_Uint64(%Uint64 %"$two_220")
  store %Uint64 %"$isqrt_call_221", %Uint64* %isqrt_two, align 8
...
"$have_gas_239":                                  ; preds = %"$out_of_gas_238", %"$have_gas_225"
  ...
  %"$isqrt_call_242" = call %Uint32 @_isqrt_Uint32(%Uint32 %"$three_241")
  store %Uint32 %"$isqrt_call_242", %Uint32* %isqrt_three, align 4
...
"$have_gas_260":                                  ; preds = %"$out_of_gas_259", %"$have_gas_246"
  ...
  %"$isqrt_call_263" = call %Uint128 @_isqrt_Uint128(%Uint128 %"$four_262")
  store %Uint128 %"$isqrt_call_263", %Uint128* %isqrt_four, align 8
...
"$have_gas_281":                                  ; preds = %"$out_of_gas_280", %"$have_gas_267"
  ...
  %"$isqrt_call_284" = call %Uint32 @_isqrt_Uint32(%Uint32 %"$six_283")
  store %Uint32 %"$isqrt_call_284", %Uint32* %isqrt_six, align 4
...
"$have_gas_302":                                  ; preds = %"$out_of_gas_301", %"$have_gas_288"
  ...
  %"$isqrt_call_305" = call %Uint32 @_isqrt_Uint32(%Uint32 %"$ten_304")
  store %Uint32 %"$isqrt_call_305", %Uint32* %isqrt_ten, align 4
...
"$have_gas_332":                                  ; preds = %"$out_of_gas_331", %"$have_gas_309"
  ...
  %"$isqrt_call_337" = call %Uint256* @_isqrt_Uint256(i8* %"$execptr_load_334", %Uint256* %"$isqrt_thirty_six_335")
  %"$isqrt_339" = load %Uint256, %Uint256* %"$isqrt_call_337", align 8
  store %Uint256 %"$isqrt_339", %Uint256* %isqrt_thirty_six, align 8
...
"$have_gas_366":                                  ; preds = %"$out_of_gas_365", %"$have_gas_343"
  ...
  %"$isqrt_call_371" = call %Uint256* @_isqrt_Uint256(i8* %"$execptr_load_368", %Uint256* %"$isqrt_uint256_max_369")
  %"$isqrt_373" = load %Uint256, %Uint256* %"$isqrt_call_371", align 8
  store %Uint256 %"$isqrt_373", %Uint256* %isqrt_uint256_max, align 8
...
"$have_gas_391":                                  ; preds = %"$out_of_gas_390", %"$have_gas_377"
  ...
  %"$isqrt_call_394" = call %Uint128 @_isqrt_Uint128(%Uint128 %"$uint128_max_393")
  store %Uint128 %"$isqrt_call_394", %Uint128* %isqrt_uint128_max, align 8
...
"$have_gas_403":                                  ; preds = %"$out_of_gas_402", %"$have_gas_398"
  ...
  %"$add_call_407" = call %Uint32 @_add_Uint32(%Uint32 %"$isqrt_zero_405", %Uint32 %"$isqrt_one_406")
  store %Uint32 %"$add_call_407", %Uint32* %res1, align 4
...
"$have_gas_416":                                  ; preds = %"$out_of_gas_415", %"$have_gas_411"
  ...
  %"$add_call_420" = call %Uint32 @_add_Uint32(%Uint32 %"$isqrt_three_418", %Uint32 %"$isqrt_six_419")
  store %Uint32 %"$add_call_420", %Uint32* %res2, align 4
...
"$have_gas_429":                                  ; preds = %"$out_of_gas_428", %"$have_gas_424"
  ...
  %"$add_call_433" = call %Uint32 @_add_Uint32(%Uint32 %"$res1_431", %Uint32 %"$res2_432")
  store %Uint32 %"$add_call_433", %Uint32* %res3, align 4
...
"$have_gas_442":                                  ; preds = %"$out_of_gas_441", %"$have_gas_437"
  ...
  %"$add_call_446" = call %Uint32 @_add_Uint32(%Uint32 %"$res3_444", %Uint32 %"$isqrt_ten_445")
  store %Uint32 %"$add_call_446", %Uint32* %res4, align 4
...
"$have_gas_456":                                  ; preds = %"$out_of_gas_455", %"$have_gas_450"
  ...
  %"$add_call_463" = call %Uint256* @_add_Uint256(i8* %"$execptr_load_458", %Uint256* %"$add_isqrt_thirty_six_459", %Uint256* %"$add_isqrt_uint256_max_461")
  %"$add_465" = load %Uint256, %Uint256* %"$add_call_463", align 8
  store %Uint256 %"$add_465", %Uint256* %res5, align 8
...
"$have_gas_475":                                  ; preds = %"$out_of_gas_474", %"$have_gas_469"
  ...
  %"$add_call_479" = call %Uint128 @_add_Uint128(%Uint128 %"$isqrt_four_477", %Uint128 %"$isqrt_uint128_max_478")
  store %Uint128 %"$add_call_479", %Uint128* %res6, align 8
...
"$have_gas_488":                                  ; preds = %"$out_of_gas_487", %"$have_gas_483"
  ...
  store %TName_Pair_Uint128_Uint256* %"$adtptr_496", %TName_Pair_Uint128_Uint256** %res7, align 8
...
"$have_gas_505":                                  ; preds = %"$out_of_gas_504", %"$have_gas_500"
  ...
  store %"TName_Pair_Pair_(Uint128)_(Uint256)_Uint32"* %"$adtptr_513", %"TName_Pair_Pair_(Uint128)_(Uint256)_Uint32"** %res8, align 8
...
"$have_gas_517":                                  ; preds = %"$out_of_gas_516", %"$have_gas_505"
  ...
  store %"TName_Pair_Uint64_Pair_(Pair_(Uint128)_(Uint256))_(Uint32)"* %"$adtptr_525", %"TName_Pair_Uint64_Pair_(Pair_(Uint128)_(Uint256))_(Uint32)"** %"$expr_0", align 8
