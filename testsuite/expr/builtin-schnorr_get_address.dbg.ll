...
"$have_gas_308":                                  ; preds = %"$out_of_gas_307", %"$have_gas_293"
  ...
  %"$schnorr_get_address_call_313" = call [20 x i8]* @_schnorr_get_address(i8* %"$execptr_load_310", [33 x i8]* %"$schnorr_get_address_p1_311"), !dbg !34
  %"$schnorr_get_address_315" = load [20 x i8], [20 x i8]* %"$schnorr_get_address_call_313", align 1
  store [20 x i8] %"$schnorr_get_address_315", [20 x i8]* %a1_gen, align 1, !dbg !34
...
"$have_gas_324":                                  ; preds = %"$out_of_gas_323", %"$have_gas_319"
  ...
  %"$eq_call_333" = call %TName_Bool* @_eq_ByStrX(i8* %"$execptr_load_326", i32 20, i8* %"$$eq_a1_327_329", i8* %"$$eq_a1_gen_330_332"), !dbg !35
  store %TName_Bool* %"$eq_call_333", %TName_Bool** %r1, align 8, !dbg !35
...
"$have_gas_373":                                  ; preds = %"$out_of_gas_372", %"$have_gas_358"
  ...
  %"$schnorr_get_address_call_378" = call [20 x i8]* @_schnorr_get_address(i8* %"$execptr_load_375", [33 x i8]* %"$schnorr_get_address_p2_376"), !dbg !38
  %"$schnorr_get_address_380" = load [20 x i8], [20 x i8]* %"$schnorr_get_address_call_378", align 1
  store [20 x i8] %"$schnorr_get_address_380", [20 x i8]* %a2_gen, align 1, !dbg !38
...
"$have_gas_389":                                  ; preds = %"$out_of_gas_388", %"$have_gas_384"
  ...
  %"$eq_call_398" = call %TName_Bool* @_eq_ByStrX(i8* %"$execptr_load_391", i32 20, i8* %"$$eq_a2_392_394", i8* %"$$eq_a2_gen_395_397"), !dbg !39
  store %TName_Bool* %"$eq_call_398", %TName_Bool** %r2, align 8, !dbg !39
...
"$have_gas_438":                                  ; preds = %"$out_of_gas_437", %"$have_gas_423"
  ...
  %"$schnorr_get_address_call_443" = call [20 x i8]* @_schnorr_get_address(i8* %"$execptr_load_440", [33 x i8]* %"$schnorr_get_address_p3_441"), !dbg !42
  %"$schnorr_get_address_445" = load [20 x i8], [20 x i8]* %"$schnorr_get_address_call_443", align 1
  store [20 x i8] %"$schnorr_get_address_445", [20 x i8]* %a3_gen, align 1, !dbg !42
...
"$have_gas_454":                                  ; preds = %"$out_of_gas_453", %"$have_gas_449"
  ...
  %"$eq_call_463" = call %TName_Bool* @_eq_ByStrX(i8* %"$execptr_load_456", i32 20, i8* %"$$eq_a3_457_459", i8* %"$$eq_a3_gen_460_462"), !dbg !43
  store %TName_Bool* %"$eq_call_463", %TName_Bool** %r3, align 8, !dbg !43
...
"$have_gas_503":                                  ; preds = %"$out_of_gas_502", %"$have_gas_488"
  ...
  %"$schnorr_get_address_call_508" = call [20 x i8]* @_schnorr_get_address(i8* %"$execptr_load_505", [33 x i8]* %"$schnorr_get_address_p4_506"), !dbg !46
  %"$schnorr_get_address_510" = load [20 x i8], [20 x i8]* %"$schnorr_get_address_call_508", align 1
  store [20 x i8] %"$schnorr_get_address_510", [20 x i8]* %a4_gen, align 1, !dbg !46
...
"$have_gas_519":                                  ; preds = %"$out_of_gas_518", %"$have_gas_514"
  ...
  %"$eq_call_528" = call %TName_Bool* @_eq_ByStrX(i8* %"$execptr_load_521", i32 20, i8* %"$$eq_a4_522_524", i8* %"$$eq_a4_gen_525_527"), !dbg !47
  store %TName_Bool* %"$eq_call_528", %TName_Bool** %r4, align 8, !dbg !47
...
"$have_gas_568":                                  ; preds = %"$out_of_gas_567", %"$have_gas_553"
  ...
  %"$schnorr_get_address_call_573" = call [20 x i8]* @_schnorr_get_address(i8* %"$execptr_load_570", [33 x i8]* %"$schnorr_get_address_p5_571"), !dbg !50
  %"$schnorr_get_address_575" = load [20 x i8], [20 x i8]* %"$schnorr_get_address_call_573", align 1
  store [20 x i8] %"$schnorr_get_address_575", [20 x i8]* %a5_gen, align 1, !dbg !50
...
"$have_gas_584":                                  ; preds = %"$out_of_gas_583", %"$have_gas_579"
  ...
  %"$eq_call_593" = call %TName_Bool* @_eq_ByStrX(i8* %"$execptr_load_586", i32 20, i8* %"$$eq_a5_587_589", i8* %"$$eq_a5_gen_590_592"), !dbg !51
  store %TName_Bool* %"$eq_call_593", %TName_Bool** %r5, align 8, !dbg !51
...
"$have_gas_633":                                  ; preds = %"$out_of_gas_632", %"$have_gas_618"
  ...
  %"$schnorr_get_address_call_638" = call [20 x i8]* @_schnorr_get_address(i8* %"$execptr_load_635", [33 x i8]* %"$schnorr_get_address_p6_636"), !dbg !54
  %"$schnorr_get_address_640" = load [20 x i8], [20 x i8]* %"$schnorr_get_address_call_638", align 1
  store [20 x i8] %"$schnorr_get_address_640", [20 x i8]* %a6_gen, align 1, !dbg !54
...
"$have_gas_649":                                  ; preds = %"$out_of_gas_648", %"$have_gas_644"
  ...
  %"$eq_call_658" = call %TName_Bool* @_eq_ByStrX(i8* %"$execptr_load_651", i32 20, i8* %"$$eq_a6_652_654", i8* %"$$eq_a6_gen_655_657"), !dbg !55
  store %TName_Bool* %"$eq_call_658", %TName_Bool** %r6, align 8, !dbg !55
...
"$have_gas_698":                                  ; preds = %"$out_of_gas_697", %"$have_gas_683"
  ...
  %"$schnorr_get_address_call_703" = call [20 x i8]* @_schnorr_get_address(i8* %"$execptr_load_700", [33 x i8]* %"$schnorr_get_address_p7_701"), !dbg !58
  %"$schnorr_get_address_705" = load [20 x i8], [20 x i8]* %"$schnorr_get_address_call_703", align 1
  store [20 x i8] %"$schnorr_get_address_705", [20 x i8]* %a7_gen, align 1, !dbg !58
...
"$have_gas_714":                                  ; preds = %"$out_of_gas_713", %"$have_gas_709"
  ...
  %"$eq_call_723" = call %TName_Bool* @_eq_ByStrX(i8* %"$execptr_load_716", i32 20, i8* %"$$eq_a7_717_719", i8* %"$$eq_a7_gen_720_722"), !dbg !59
  store %TName_Bool* %"$eq_call_723", %TName_Bool** %r7, align 8, !dbg !59
...
"$have_gas_763":                                  ; preds = %"$out_of_gas_762", %"$have_gas_748"
  ...
  %"$schnorr_get_address_call_768" = call [20 x i8]* @_schnorr_get_address(i8* %"$execptr_load_765", [33 x i8]* %"$schnorr_get_address_p8_766"), !dbg !62
  %"$schnorr_get_address_770" = load [20 x i8], [20 x i8]* %"$schnorr_get_address_call_768", align 1
  store [20 x i8] %"$schnorr_get_address_770", [20 x i8]* %a8_gen, align 1, !dbg !62
...
"$have_gas_779":                                  ; preds = %"$out_of_gas_778", %"$have_gas_774"
  ...
  %"$eq_call_788" = call %TName_Bool* @_eq_ByStrX(i8* %"$execptr_load_781", i32 20, i8* %"$$eq_a8_782_784", i8* %"$$eq_a8_gen_785_787"), !dbg !63
  store %TName_Bool* %"$eq_call_788", %TName_Bool** %r8, align 8, !dbg !63
...
"$have_gas_818":                                  ; preds = %"$out_of_gas_817", %"$have_gas_813"
  ...
  %"$BoolUtils.and_4_call_824" = call { { { %TName_Bool* (i8*, %TName_Bool*)*, i8* } (i8*, %TName_Bool*)*, i8* } (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.and_4_fptr_821"(i8* %"$BoolUtils.and_4_envptr_822", %TName_Bool* %"$r1_823"), !dbg !64
  store { { { %TName_Bool* (i8*, %TName_Bool*)*, i8* } (i8*, %TName_Bool*)*, i8* } (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.and_4_call_824", { { { %TName_Bool* (i8*, %TName_Bool*)*, i8* } (i8*, %TName_Bool*)*, i8* } (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.and_4_6", align 8, !dbg !64
  ...
  %"$$BoolUtils.and_4_6_call_829" = call { { %TName_Bool* (i8*, %TName_Bool*)*, i8* } (i8*, %TName_Bool*)*, i8* } %"$$BoolUtils.and_4_6_fptr_826"(i8* %"$$BoolUtils.and_4_6_envptr_827", %TName_Bool* %"$r2_828"), !dbg !64
  store { { %TName_Bool* (i8*, %TName_Bool*)*, i8* } (i8*, %TName_Bool*)*, i8* } %"$$BoolUtils.and_4_6_call_829", { { %TName_Bool* (i8*, %TName_Bool*)*, i8* } (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.and_4_7", align 8, !dbg !64
  ...
  %"$$BoolUtils.and_4_7_call_834" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$$BoolUtils.and_4_7_fptr_831"(i8* %"$$BoolUtils.and_4_7_envptr_832", %TName_Bool* %"$r3_833"), !dbg !64
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$$BoolUtils.and_4_7_call_834", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.and_4_8", align 8, !dbg !64
  ...
  %"$$BoolUtils.and_4_8_call_839" = call %TName_Bool* %"$$BoolUtils.and_4_8_fptr_836"(i8* %"$$BoolUtils.and_4_8_envptr_837", %TName_Bool* %"$r4_838"), !dbg !64
  store %TName_Bool* %"$$BoolUtils.and_4_8_call_839", %TName_Bool** %"$BoolUtils.and_4_9", align 8, !dbg !64
  %"$$BoolUtils.and_4_9_840" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.and_4_9", align 8
  store %TName_Bool* %"$$BoolUtils.and_4_9_840", %TName_Bool** %res1, align 8, !dbg !64
...
"$have_gas_849":                                  ; preds = %"$out_of_gas_848", %"$have_gas_844"
  ...
  %"$BoolUtils.and_4_call_855" = call { { { %TName_Bool* (i8*, %TName_Bool*)*, i8* } (i8*, %TName_Bool*)*, i8* } (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.and_4_fptr_852"(i8* %"$BoolUtils.and_4_envptr_853", %TName_Bool* %"$r5_854"), !dbg !65
  store { { { %TName_Bool* (i8*, %TName_Bool*)*, i8* } (i8*, %TName_Bool*)*, i8* } (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.and_4_call_855", { { { %TName_Bool* (i8*, %TName_Bool*)*, i8* } (i8*, %TName_Bool*)*, i8* } (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.and_4_10", align 8, !dbg !65
  ...
  %"$$BoolUtils.and_4_10_call_860" = call { { %TName_Bool* (i8*, %TName_Bool*)*, i8* } (i8*, %TName_Bool*)*, i8* } %"$$BoolUtils.and_4_10_fptr_857"(i8* %"$$BoolUtils.and_4_10_envptr_858", %TName_Bool* %"$r6_859"), !dbg !65
  store { { %TName_Bool* (i8*, %TName_Bool*)*, i8* } (i8*, %TName_Bool*)*, i8* } %"$$BoolUtils.and_4_10_call_860", { { %TName_Bool* (i8*, %TName_Bool*)*, i8* } (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.and_4_11", align 8, !dbg !65
  ...
  %"$$BoolUtils.and_4_11_call_865" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$$BoolUtils.and_4_11_fptr_862"(i8* %"$$BoolUtils.and_4_11_envptr_863", %TName_Bool* %"$r7_864"), !dbg !65
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$$BoolUtils.and_4_11_call_865", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.and_4_12", align 8, !dbg !65
  ...
  %"$$BoolUtils.and_4_12_call_870" = call %TName_Bool* %"$$BoolUtils.and_4_12_fptr_867"(i8* %"$$BoolUtils.and_4_12_envptr_868", %TName_Bool* %"$r8_869"), !dbg !65
  store %TName_Bool* %"$$BoolUtils.and_4_12_call_870", %TName_Bool** %"$BoolUtils.and_4_13", align 8, !dbg !65
  %"$$BoolUtils.and_4_13_871" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.and_4_13", align 8
  store %TName_Bool* %"$$BoolUtils.and_4_13_871", %TName_Bool** %res2, align 8, !dbg !65
...
"$have_gas_875":                                  ; preds = %"$out_of_gas_874", %"$have_gas_849"
  ...
  %"$BoolUtils.andb_call_881" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_fptr_878"(i8* %"$BoolUtils.andb_envptr_879", %TName_Bool* %"$res1_880"), !dbg !66
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_call_881", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.andb_14", align 8, !dbg !66
  ...
  %"$$BoolUtils.andb_14_call_886" = call %TName_Bool* %"$$BoolUtils.andb_14_fptr_883"(i8* %"$$BoolUtils.andb_14_envptr_884", %TName_Bool* %"$res2_885"), !dbg !66
  store %TName_Bool* %"$$BoolUtils.andb_14_call_886", %TName_Bool** %"$BoolUtils.andb_15", align 8, !dbg !66
  %"$$BoolUtils.andb_15_887" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.andb_15", align 8
  store %TName_Bool* %"$$BoolUtils.andb_15_887", %TName_Bool** %"$expr_28", align 8, !dbg !66
