...
define internal %Int32 @"$fundef_15"(%"$$fundef_15_env_52"* %0, %Int32 %1) !dbg !4 {
entry:
...
"$have_gas_112":                                  ; preds = %"$out_of_gas_111", %entry
  ...
  %"$add_call_115" = call %Int32 @_add_Int32(%Int32 %"$a__114", %Int32 %1), !dbg !8
...
define internal { %Int32 (i8*, %Int32)*, i8* } @"$fundef_13"(%"$$fundef_13_env_53"* %0, %Int32 %1) !dbg !9 {
entry:
...
"$have_gas_93":                                   ; preds = %"$out_of_gas_92", %"$have_gas_88"
  ...
  store %Int32 %1, %Int32* %a_, align 4, !dbg !10
...
"$have_gas_98":                                   ; preds = %"$out_of_gas_97", %"$have_gas_93"
  ...
  store { %Int32 (i8*, %Int32)*, i8* } %"$$fundef_15_cloval_103", { %Int32 (i8*, %Int32)*, i8* }* %"$retval_14", align 8, !dbg !11
  %"$$retval_14_106" = load { %Int32 (i8*, %Int32)*, i8* }, { %Int32 (i8*, %Int32)*, i8* }* %"$retval_14", align 8
  ret { %Int32 (i8*, %Int32)*, i8* } %"$$retval_14_106"
}

define internal %Int32 @"$fundef_11"(%"$$fundef_11_env_54"* %0, %Int32 %1) !dbg !12 {
entry:
...
"$have_gas_80":                                   ; preds = %"$out_of_gas_79", %entry
  ...
  %"$sub_call_83" = call %Int32 @_sub_Int32(%Int32 %"$a_82", %Int32 %1), !dbg !13
  store %Int32 %"$sub_call_83", %Int32* %"$retval_12", align 4, !dbg !13
  %"$$retval_12_84" = load %Int32, %Int32* %"$retval_12", align 4
  ret %Int32 %"$$retval_12_84"
}

define internal { %Int32 (i8*, %Int32)*, i8* } @"$fundef_9"(%"$$fundef_9_env_55"* %0, %Int32 %1) !dbg !14 {
entry:
...
"$have_gas_67":                                   ; preds = %"$out_of_gas_66", %entry
  ...
  store { %Int32 (i8*, %Int32)*, i8* } %"$$fundef_11_cloval_72", { %Int32 (i8*, %Int32)*, i8* }* %"$retval_10", align 8, !dbg !15
  %"$$retval_10_74" = load { %Int32 (i8*, %Int32)*, i8* }, { %Int32 (i8*, %Int32)*, i8* }* %"$retval_10", align 8
  ret { %Int32 (i8*, %Int32)*, i8* } %"$$retval_10_74"
}

define internal %Int32 @"$fundef_7"(%"$$fundef_7_env_56"* %0, %Int32 %1, %Int32 %2) !dbg !16 {
entry:
...
"$have_gas_60":                                   ; preds = %"$out_of_gas_59", %entry
  ...
  %"$add_call_62" = call %Int32 @_add_Int32(%Int32 %1, %Int32 %2), !dbg !17
  store %Int32 %"$add_call_62", %Int32* %"$retval_8", align 4, !dbg !17
...
define internal %Int32 @_scilla_expr_fun(i8* %0) !dbg !20 {
entry:
...
"$have_gas_125":                                  ; preds = %"$out_of_gas_124", %"$have_gas_120"
  ...
  store { %Int32 (i8*, %Int32, %Int32)*, i8* } { %Int32 (i8*, %Int32, %Int32)* bitcast (%Int32 (%"$$fundef_7_env_56"*, %Int32, %Int32)* @"$fundef_7" to %Int32 (i8*, %Int32, %Int32)*), i8* null }, { %Int32 (i8*, %Int32, %Int32)*, i8* }* %f1, align 8, !dbg !21
...
"$have_gas_138":                                  ; preds = %"$out_of_gas_137", %"$have_gas_133"
  ...
  store { { %Int32 (i8*, %Int32)*, i8* } (i8*, %Int32)*, i8* } { { %Int32 (i8*, %Int32)*, i8* } (i8*, %Int32)* bitcast ({ %Int32 (i8*, %Int32)*, i8* } (%"$$fundef_9_env_55"*, %Int32)* @"$fundef_9" to { %Int32 (i8*, %Int32)*, i8* } (i8*, %Int32)*), i8* null }, { { %Int32 (i8*, %Int32)*, i8* } (i8*, %Int32)*, i8* }* %f3, align 8, !dbg !22
...
"$have_gas_151":                                  ; preds = %"$out_of_gas_150", %"$have_gas_146"
  ...
  store { { %Int32 (i8*, %Int32)*, i8* } (i8*, %Int32)*, i8* } { { %Int32 (i8*, %Int32)*, i8* } (i8*, %Int32)* bitcast ({ %Int32 (i8*, %Int32)*, i8* } (%"$$fundef_13_env_53"*, %Int32)* @"$fundef_13" to { %Int32 (i8*, %Int32)*, i8* } (i8*, %Int32)*), i8* null }, { { %Int32 (i8*, %Int32)*, i8* } (i8*, %Int32)*, i8* }* %f2, align 8, !dbg !23
...
"$have_gas_164":                                  ; preds = %"$out_of_gas_163", %"$have_gas_159"
  ...
  store %Int32 { i32 1 }, %Int32* %n1, align 4, !dbg !24
...
"$have_gas_174":                                  ; preds = %"$out_of_gas_173", %"$have_gas_169"
  ...
  store %Int32 { i32 2 }, %Int32* %n2, align 4, !dbg !25
...
"$have_gas_184":                                  ; preds = %"$out_of_gas_183", %"$have_gas_179"
  ...
  %"$f1_call_191" = call %Int32 %"$f1_fptr_187"(i8* %"$f1_envptr_188", %Int32 %"$n1_189", %Int32 %"$n2_190"), !dbg !26
  store %Int32 %"$f1_call_191", %Int32* %res1, align 4, !dbg !26
...
"$have_gas_200":                                  ; preds = %"$out_of_gas_199", %"$have_gas_195"
  ...
  %"$f2_call_206" = call { %Int32 (i8*, %Int32)*, i8* } %"$f2_fptr_203"(i8* %"$f2_envptr_204", %Int32 %"$res1_205"), !dbg !27
  store { %Int32 (i8*, %Int32)*, i8* } %"$f2_call_206", { %Int32 (i8*, %Int32)*, i8* }* %"$f2_0", align 8, !dbg !27
  ...
  %"$$f2_0_call_211" = call %Int32 %"$$f2_0_fptr_208"(i8* %"$$f2_0_envptr_209", %Int32 %"$n1_210"), !dbg !27
  store %Int32 %"$$f2_0_call_211", %Int32* %"$f2_1", align 4, !dbg !27
  %"$$f2_1_212" = load %Int32, %Int32* %"$f2_1", align 4
  store %Int32 %"$$f2_1_212", %Int32* %res2, align 4, !dbg !27
...
"$have_gas_221":                                  ; preds = %"$out_of_gas_220", %"$have_gas_216"
  ...
  %"$f3_call_227" = call { %Int32 (i8*, %Int32)*, i8* } %"$f3_fptr_224"(i8* %"$f3_envptr_225", %Int32 %"$res2_226"), !dbg !28
  store { %Int32 (i8*, %Int32)*, i8* } %"$f3_call_227", { %Int32 (i8*, %Int32)*, i8* }* %"$f3_2", align 8, !dbg !28
  %"$$f3_2_228" = load { %Int32 (i8*, %Int32)*, i8* }, { %Int32 (i8*, %Int32)*, i8* }* %"$f3_2", align 8
  store { %Int32 (i8*, %Int32)*, i8* } %"$$f3_2_228", { %Int32 (i8*, %Int32)*, i8* }* %partial, align 8, !dbg !28
...
"$have_gas_237":                                  ; preds = %"$out_of_gas_236", %"$have_gas_232"
  ...
  %"$partial_call_243" = call %Int32 %"$partial_fptr_240"(i8* %"$partial_envptr_241", %Int32 %"$n1_242"), !dbg !29
  store %Int32 %"$partial_call_243", %Int32* %"$partial_3", align 4, !dbg !29
  %"$$partial_3_244" = load %Int32, %Int32* %"$partial_3", align 4
  store %Int32 %"$$partial_3_244", %Int32* %total, align 4, !dbg !29
...
"$have_gas_253":                                  ; preds = %"$out_of_gas_252", %"$have_gas_248"
  ...
  %"$f3_call_259" = call { %Int32 (i8*, %Int32)*, i8* } %"$f3_fptr_256"(i8* %"$f3_envptr_257", %Int32 %"$total_258"), !dbg !30
  store { %Int32 (i8*, %Int32)*, i8* } %"$f3_call_259", { %Int32 (i8*, %Int32)*, i8* }* %"$f3_4", align 8, !dbg !30
  ...
  %"$$f3_4_call_264" = call %Int32 %"$$f3_4_fptr_261"(i8* %"$$f3_4_envptr_262", %Int32 %"$n1_263"), !dbg !30
  store %Int32 %"$$f3_4_call_264", %Int32* %"$f3_5", align 4, !dbg !30
  %"$$f3_5_265" = load %Int32, %Int32* %"$f3_5", align 4
  store %Int32 %"$$f3_5_265", %Int32* %res3, align 4, !dbg !30
...
"$have_gas_274":                                  ; preds = %"$out_of_gas_273", %"$have_gas_269"
  ...
  store %Int32 %"$res3_276", %Int32* %"$expr_6", align 4, !dbg !31
...
!2 = !DIFile(filename: "uncurry_simple.scilexp", directory: "tests/codegen/expr")
!3 = !{}
...
!8 = !DILocation(line: 22, column: 17, scope: !4)
!9 = distinct !DISubprogram(name: "$fundef_13", linkageName: "$fundef_13", scope: !2, file: !2, line: 20, type: !5, scopeLine: 20, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !1, retainedNodes: !3)
!10 = !DILocation(line: 20, column: 18, scope: !9)
!11 = !DILocation(line: 22, column: 17, scope: !9)
!12 = distinct !DISubprogram(name: "$fundef_11", linkageName: "$fundef_11", scope: !2, file: !2, line: 14, type: !5, scopeLine: 14, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !1, retainedNodes: !3)
!13 = !DILocation(line: 14, column: 13, scope: !12)
!14 = distinct !DISubprogram(name: "$fundef_9", linkageName: "$fundef_9", scope: !2, file: !2, line: 13, type: !5, scopeLine: 13, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !1, retainedNodes: !3)
!15 = !DILocation(line: 14, column: 13, scope: !14)
!16 = distinct !DISubprogram(name: "$fundef_7", linkageName: "$fundef_7", scope: !2, file: !2, line: 4, type: !5, scopeLine: 4, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !1, retainedNodes: !3)
...
!20 = distinct !DISubprogram(name: "_scilla_expr_fun", linkageName: "_scilla_expr_fun", scope: !2, file: !2, line: 3, type: !5, scopeLine: 3, spFlags: DISPFlagDefinition, unit: !1, retainedNodes: !3)
!21 = !DILocation(line: 4, column: 9, scope: !20)
!22 = !DILocation(line: 13, column: 9, scope: !20)
!23 = !DILocation(line: 20, column: 9, scope: !20)
!24 = !DILocation(line: 25, column: 10, scope: !20)
!25 = !DILocation(line: 26, column: 10, scope: !20)
!26 = !DILocation(line: 29, column: 12, scope: !20)
!27 = !DILocation(line: 32, column: 12, scope: !20)
!28 = !DILocation(line: 35, column: 15, scope: !20)
!29 = !DILocation(line: 36, column: 13, scope: !20)
