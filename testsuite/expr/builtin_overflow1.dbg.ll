...
"$have_gas_82":                                   ; preds = %"$out_of_gas_81", %"$have_gas_77"
  ...
  store %Uint32 zeroinitializer, %Uint32* %a, align 4, !dbg !13
...
"$have_gas_97":                                   ; preds = %"$out_of_gas_96", %"$have_gas_92"
  ...
  %"$sub_call_101" = call %Uint32 @_sub_Uint32(%Uint32 %"$a_99", %Uint32 %"$b_100"), !dbg !19
  store %Uint32 %"$sub_call_101", %Uint32* %"$expr_6", align 4, !dbg !19
