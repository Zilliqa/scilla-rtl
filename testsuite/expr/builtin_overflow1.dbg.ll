...
"$have_gas_80":                                   ; preds = %"$out_of_gas_79", %"$have_gas_75"
  ...
  store %Uint32 zeroinitializer, %Uint32* %a, align 4, !dbg !11
...
"$have_gas_90":                                   ; preds = %"$out_of_gas_89", %"$have_gas_85"
  ...
  store %Uint32 { i32 1 }, %Uint32* %b, align 4, !dbg !12
...
"$have_gas_95":                                   ; preds = %"$out_of_gas_94", %"$have_gas_90"
  ...
  %"$a_97" = load %Uint32, %Uint32* %a, align 4
  %"$b_98" = load %Uint32, %Uint32* %b, align 4
  %"$sub_call_99" = call %Uint32 @_sub_Uint32(%Uint32 %"$a_97", %Uint32 %"$b_98"), !dbg !13
  store %Uint32 %"$sub_call_99", %Uint32* %"$expr_6", align 4, !dbg !13
...
!2 = !DIFile(filename: "builtin_overflow1.scilexp", directory: "codegen/expr")
!3 = !{}
