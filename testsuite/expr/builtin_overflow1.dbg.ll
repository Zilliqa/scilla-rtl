...
"$have_gas_44":                                   ; preds = %"$out_of_gas_43", %"$have_gas_39"
  ...
  store %Uint32 zeroinitializer, %Uint32* %a, align 4, !dbg !10
...
"$have_gas_54":                                   ; preds = %"$out_of_gas_53", %"$have_gas_49"
  ...
  store %Uint32 { i32 1 }, %Uint32* %b, align 4, !dbg !11
...
"$have_gas_59":                                   ; preds = %"$out_of_gas_58", %"$have_gas_54"
  ...
  %"$a_61" = load %Uint32, %Uint32* %a, align 4
  %"$b_62" = load %Uint32, %Uint32* %b, align 4
  %"$sub_call_63" = call %Uint32 @_sub_Uint32(%Uint32 %"$a_61", %Uint32 %"$b_62"), !dbg !12
  store %Uint32 %"$sub_call_63", %Uint32* %"$expr_0", align 4, !dbg !12
