...
"$have_gas_80":                                   ; preds = %"$out_of_gas_79", %"$have_gas_75"
  ...
  store %Int32 { i32 -1 }, %Int32* %a, align 4, !dbg !11
...
"$have_gas_90":                                   ; preds = %"$out_of_gas_89", %"$have_gas_85"
  ...
  store %Int32 { i32 -2147483648 }, %Int32* %b, align 4, !dbg !12
  %"$gasrem_92" = load i64, i64* @_gasrem, align 8
  %"$gascmp_93" = icmp ugt i64 4, %"$gasrem_92"
...
"$have_gas_95":                                   ; preds = %"$out_of_gas_94", %"$have_gas_90"
  %"$consume_96" = sub i64 %"$gasrem_92", 4
  store i64 %"$consume_96", i64* @_gasrem, align 8
  %"$a_97" = load %Int32, %Int32* %a, align 4
  %"$b_98" = load %Int32, %Int32* %b, align 4
  %"$add_call_99" = call %Int32 @_add_Int32(%Int32 %"$a_97", %Int32 %"$b_98"), !dbg !13
  store %Int32 %"$add_call_99", %Int32* %"$expr_6", align 4, !dbg !13
  %"$$expr_6_100" = load %Int32, %Int32* %"$expr_6", align 4
  ret %Int32 %"$$expr_6_100"
}
...
entry:
  %"$exprval_101" = call %Int32 @_scilla_expr_fun(i8* null)
  %"$pval_102" = alloca %Int32, align 8
  %"$memvoidcast_103" = bitcast %Int32* %"$pval_102" to i8*
  store %Int32 %"$exprval_101", %Int32* %"$pval_102", align 4
  %"$execptr_load_104" = load i8*, i8** @_execptr, align 8
  call void @_print_scilla_val(i8* %"$execptr_load_104", %_TyDescrTy_Typ* @"$TyDescr_Int32_9", i8* %"$memvoidcast_103")
  ret void
}
...
!2 = !DIFile(filename: "builtin_overflow3.scilexp", directory: "codegen/expr")
!3 = !{}
