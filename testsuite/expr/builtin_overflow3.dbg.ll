...
"$have_gas_82":                                   ; preds = %"$out_of_gas_81", %"$have_gas_77"
  ...
  store %Int32 { i32 -1 }, %Int32* %a, align 4, !dbg !13
...
"$have_gas_92":                                   ; preds = %"$out_of_gas_91", %"$have_gas_87"
  ...
  store %Int32 { i32 -2147483648 }, %Int32* %b, align 4, !dbg !18
...
"$have_gas_97":                                   ; preds = %"$out_of_gas_96", %"$have_gas_92"
  ...
  %"$add_call_101" = call %Int32 @_add_Int32(%Int32 %"$a_99", %Int32 %"$b_100"), !dbg !19
  store %Int32 %"$add_call_101", %Int32* %"$expr_6", align 4, !dbg !19
