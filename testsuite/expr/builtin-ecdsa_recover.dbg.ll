...
%"$ParamDescr_428" = type { %ParamDescrString, %_TyDescrTy_Typ* }
%ParamDescrString = type { i8*, i32 }
%"$TransDescr_429" = type { %ParamDescrString, i32, %"$ParamDescr_428"* }
...
@_contract_parameters = constant [0 x %"$ParamDescr_428"] zeroinitializer
@_contract_parameters_length = constant i32 0
@_transition_parameters = constant [0 x %"$TransDescr_429"] zeroinitializer
...
"$have_gas_272":                                  ; preds = %"$out_of_gas_271", %entry
  ...
  store [32 x i8] %"$sha256hash_278", [32 x i8]* %h1, align 1, !dbg !8
...
"$have_gas_282":                                  ; preds = %"$out_of_gas_281", %"$have_gas_272"
  ...
  store [32 x i8] %"$sha256hash_289", [32 x i8]* %h2, align 1, !dbg !9
  ...
  store %Bystr %"$to_bystr_call_294", %Bystr* %"$retval_14", align 8, !dbg !10
...
"$have_gas_123":                                  ; preds = %"$out_of_gas_122", %entry
  ...
  store [65 x i8] %"$ecdsa_recover_pk_130", [65 x i8]* %pk, align 1, !dbg !12
...
"$have_gas_154":                                  ; preds = %"$out_of_gas_153", %"$have_gas_149"
  ...
  store %Bystr %"$to_bystr_call_160", %Bystr* %pk_bs, align 8, !dbg !15
...
"$have_gas_164":                                  ; preds = %"$out_of_gas_163", %"$have_gas_154"
  ...
  store %Bystr %"$substr_call_170", %Bystr* %pk_, align 8, !dbg !16
...
"$have_gas_174":                                  ; preds = %"$out_of_gas_173", %"$have_gas_164"
  ...
  store [32 x i8] %"$keccak256hash_181", [32 x i8]* %pkHash, align 1, !dbg !17
...
"$have_gas_185":                                  ; preds = %"$out_of_gas_184", %"$have_gas_174"
  ...
  store %Bystr %"$to_bystr_call_191", %Bystr* %pkHash_bs, align 8, !dbg !18
...
"$have_gas_215":                                  ; preds = %"$out_of_gas_214", %"$have_gas_210"
  ...
  store %Bystr %"$substr_call_221", %Bystr* %addr_bs, align 8, !dbg !21
...
"$have_gas_225":                                  ; preds = %"$out_of_gas_224", %"$have_gas_215"
  ...
  store %TName_Option_ByStr20* %"$to_bystr20_230", %TName_Option_ByStr20** %addr_opt, align 8, !dbg !22
...
"$have_gas_248":                                  ; preds = %"$out_of_gas_247", %"$Some_241"
  ...
  store [20 x i8] %"$addr_250", [20 x i8]* %"$retval_12", align 1, !dbg !24
...
"$have_gas_355":                                  ; preds = %"$out_of_gas_354", %"$have_gas_350"
  ...
  store %Bystr %"$to_bystr_call_361", %Bystr* %msg_bs, align 8, !dbg !41
...
"$have_gas_370":                                  ; preds = %"$out_of_gas_369", %"$have_gas_365"
  ...
  %"$header_hash_call_376" = call %Bystr %"$header_hash_fptr_373"(i8* %"$header_hash_envptr_374", %Bystr %"$msg_bs_375"), !dbg !42
  store %Bystr %"$header_hash_call_376", %Bystr* %"$header_hash_2", align 8, !dbg !42
  %"$$header_hash_2_377" = load %Bystr, %Bystr* %"$header_hash_2", align 8
  store %Bystr %"$$header_hash_2_377", %Bystr* %msg_hashed, align 8, !dbg !42
...
"$have_gas_396":                                  ; preds = %"$out_of_gas_395", %"$have_gas_391"
  ...
  %"$ecrecover_call_402" = call { { void (i8*, [20 x i8]*, %Uint32)*, i8* } (i8*, [64 x i8]*)*, i8* } %"$ecrecover_fptr_399"(i8* %"$ecrecover_envptr_400", %Bystr %"$msg_hashed_401"), !dbg !44
  store { { void (i8*, [20 x i8]*, %Uint32)*, i8* } (i8*, [64 x i8]*)*, i8* } %"$ecrecover_call_402", { { void (i8*, [20 x i8]*, %Uint32)*, i8* } (i8*, [64 x i8]*)*, i8* }* %"$ecrecover_3", align 8, !dbg !44
  ...
  %"$$ecrecover_3_call_408" = call { void (i8*, [20 x i8]*, %Uint32)*, i8* } %"$$ecrecover_3_fptr_404"(i8* %"$$ecrecover_3_envptr_405", [64 x i8]* %"$$ecrecover_3_sig_406"), !dbg !44
  store { void (i8*, [20 x i8]*, %Uint32)*, i8* } %"$$ecrecover_3_call_408", { void (i8*, [20 x i8]*, %Uint32)*, i8* }* %"$ecrecover_4", align 8, !dbg !44
  ...
  call void %"$$ecrecover_4_fptr_410"(i8* %"$$ecrecover_4_envptr_411", [20 x i8]* %"$$ecrecover_4_retalloca_413", %Uint32 %"$recid_412"), !dbg !44
  %"$$ecrecover_4_ret_414" = load [20 x i8], [20 x i8]* %"$$ecrecover_4_retalloca_413", align 1
  store [20 x i8] %"$$ecrecover_4_ret_414", [20 x i8]* %"$ecrecover_5", align 1, !dbg !44
  %"$$ecrecover_5_415" = load [20 x i8], [20 x i8]* %"$ecrecover_5", align 1
  store [20 x i8] %"$$ecrecover_5_415", [20 x i8]* %addr_computed, align 1, !dbg !44
  ...
  store %TName_Bool* %"$eq_call_423", %TName_Bool** %"$expr_6", align 8, !dbg !45
...
entry:
  ...
  call void @_print_scilla_val(i8* %"$execptr_load_427", %_TyDescrTy_Typ* @"$TyDescr_ADT_Bool_57", i8* %"$memvoidcast_426")
  ret void
}
