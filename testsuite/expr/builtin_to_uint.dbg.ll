...
define internal %TName_Bool* @"$fundef_104"(%"$$fundef_104_env_198"* %0, %TName_Bool* %1) !dbg !4 {
entry:
...
"$have_gas_228":                                  ; preds = %"$out_of_gas_227", %"$False_223"
  ...
  store %TName_Bool* %"$adtptr_232", %TName_Bool** %"$retval_105", align 8, !dbg !10
...
"$have_gas_238":                                  ; preds = %"$out_of_gas_237", %"$True_233"
  ...
  store %TName_Bool* %1, %TName_Bool** %"$retval_105", align 8, !dbg !13
  br label %"$matchsucc_218"
...
define internal { %TName_Bool* (i8*, %TName_Bool*)*, i8* } @"$fundef_102"(%"$$fundef_102_env_199"* %0, %TName_Bool* %1) !dbg !15 {
entry:
...
"$have_gas_203":                                  ; preds = %"$out_of_gas_202", %entry
  ...
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$$fundef_104_cloval_208", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$retval_103", align 8, !dbg !16
...
"$have_gas_244":                                  ; preds = %"$out_of_gas_243", %entry
  ...
  store { { %TName_Bool* (i8*, %TName_Bool*)*, i8* } (i8*, %TName_Bool*)*, i8* } { { %TName_Bool* (i8*, %TName_Bool*)*, i8* } (i8*, %TName_Bool*)* bitcast ({ %TName_Bool* (i8*, %TName_Bool*)*, i8* } (%"$$fundef_102_env_199"*, %TName_Bool*)* @"$fundef_102" to { %TName_Bool* (i8*, %TName_Bool*)*, i8* } (i8*, %TName_Bool*)*), i8* null }, { { %TName_Bool* (i8*, %TName_Bool*)*, i8* } (i8*, %TName_Bool*)*, i8* }* @BoolUtils.andb, align 8, !dbg !19
  ret void
}
...
"$have_gas_257":                                  ; preds = %"$out_of_gas_256", %"$have_gas_252"
  ...
  store %TName_Bool* %"$adtptr_261", %TName_Bool** %false, align 8, !dbg !21
...
"$have_gas_270":                                  ; preds = %"$out_of_gas_269", %"$have_gas_265"
  ...
  store %TName_Bool* %"$adtptr_274", %TName_Bool** %test, align 8, !dbg !22
...
"$have_gas_283":                                  ; preds = %"$out_of_gas_282", %"$have_gas_278"
  ...
  store %Uint32 { i32 1844 }, %Uint32* %input, align 4, !dbg !23
...
"$have_gas_293":                                  ; preds = %"$out_of_gas_292", %"$have_gas_288"
  ...
  %"$to_uint32_call_299" = call i8* @_to_uint32(i8* %"$execptr_load_295", %_TyDescrTy_Typ* @"$TyDescr_Uint32_111", i8* %"$$to_uint32_input_296_298"), !dbg !24
  %"$to_uint32_300" = bitcast i8* %"$to_uint32_call_299" to %TName_Option_Uint32*
  store %TName_Option_Uint32* %"$to_uint32_300", %TName_Option_Uint32** %resopt, align 8, !dbg !24
...
"$have_gas_328":                                  ; preds = %"$out_of_gas_327", %"$have_gas_323"
  ...
  store %Uint32 { i32 1844 }, %Uint32* %input_, align 4, !dbg !26
...
"$have_gas_338":                                  ; preds = %"$out_of_gas_337", %"$have_gas_333"
  ...
  %"$eq_call_343" = call %TName_Bool* @_eq_Uint32(i8* %"$execptr_load_340", %Uint32 %"$res_341", %Uint32 %"$input__342"), !dbg !29
  store %TName_Bool* %"$eq_call_343", %TName_Bool** %test_, align 8, !dbg !29
...
"$have_gas_348":                                  ; preds = %"$out_of_gas_347", %"$have_gas_338"
  ...
  %"$BoolUtils.andb_call_354" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_fptr_351"(i8* %"$BoolUtils.andb_envptr_352", %TName_Bool* %"$test_353"), !dbg !30
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_call_354", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.andb_78", align 8, !dbg !30
  ...
  %"$$BoolUtils.andb_78_call_359" = call %TName_Bool* %"$$BoolUtils.andb_78_fptr_356"(i8* %"$$BoolUtils.andb_78_envptr_357", %TName_Bool* %"$test__358"), !dbg !30
  store %TName_Bool* %"$$BoolUtils.andb_78_call_359", %TName_Bool** %"$BoolUtils.andb_79", align 8, !dbg !30
  %"$$BoolUtils.andb_79_360" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.andb_79", align 8
  store %TName_Bool* %"$$BoolUtils.andb_79_360", %TName_Bool** %"$test_0", align 8, !dbg !30
...
"$have_gas_366":                                  ; preds = %"$out_of_gas_365", %"$None_361"
  ...
  store %TName_Bool* %"$false_368", %TName_Bool** %"$test_0", align 8, !dbg !31
  br label %"$matchsucc_311"
...
"$have_gas_377":                                  ; preds = %"$out_of_gas_376", %"$have_gas_372"
  ...
  store %Uint128 { i128 1844 }, %Uint128* %"$input_1", align 8, !dbg !33
...
"$have_gas_387":                                  ; preds = %"$out_of_gas_386", %"$have_gas_382"
  ...
  %"$to_uint32_call_393" = call i8* @_to_uint32(i8* %"$execptr_load_389", %_TyDescrTy_Typ* @"$TyDescr_Uint128_119", i8* %"$$to_uint32_$input_1_390_392"), !dbg !34
  %"$to_uint32_394" = bitcast i8* %"$to_uint32_call_393" to %TName_Option_Uint32*
  store %TName_Option_Uint32* %"$to_uint32_394", %TName_Option_Uint32** %"$resopt_2", align 8, !dbg !34
...
"$have_gas_422":                                  ; preds = %"$out_of_gas_421", %"$have_gas_417"
  ...
  store %Uint32 { i32 1844 }, %Uint32* %input_2, align 4, !dbg !36
...
"$have_gas_432":                                  ; preds = %"$out_of_gas_431", %"$have_gas_427"
  ...
  %"$eq_call_437" = call %TName_Bool* @_eq_Uint32(i8* %"$execptr_load_434", %Uint32 %"$res_435", %Uint32 %"$input__436"), !dbg !39
  store %TName_Bool* %"$eq_call_437", %TName_Bool** %test_3, align 8, !dbg !39
...
"$have_gas_442":                                  ; preds = %"$out_of_gas_441", %"$have_gas_432"
  ...
  %"$BoolUtils.andb_call_448" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_fptr_445"(i8* %"$BoolUtils.andb_envptr_446", %TName_Bool* %"$$test_0_447"), !dbg !40
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_call_448", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.andb_80", align 8, !dbg !40
  ...
  %"$$BoolUtils.andb_80_call_453" = call %TName_Bool* %"$$BoolUtils.andb_80_fptr_450"(i8* %"$$BoolUtils.andb_80_envptr_451", %TName_Bool* %"$test__452"), !dbg !40
  store %TName_Bool* %"$$BoolUtils.andb_80_call_453", %TName_Bool** %"$BoolUtils.andb_81", align 8, !dbg !40
  %"$$BoolUtils.andb_81_454" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.andb_81", align 8
  store %TName_Bool* %"$$BoolUtils.andb_81_454", %TName_Bool** %"$test_3", align 8, !dbg !40
...
"$have_gas_460":                                  ; preds = %"$out_of_gas_459", %"$None_455"
  ...
  store %TName_Bool* %"$false_462", %TName_Bool** %"$test_3", align 8, !dbg !41
  br label %"$matchsucc_405"
...
"$have_gas_471":                                  ; preds = %"$out_of_gas_470", %"$have_gas_466"
  ...
  store %Uint64 { i64 -1 }, %Uint64* %"$input_4", align 8, !dbg !43
...
"$have_gas_481":                                  ; preds = %"$out_of_gas_480", %"$have_gas_476"
  ...
  %"$to_uint32_call_487" = call i8* @_to_uint32(i8* %"$execptr_load_483", %_TyDescrTy_Typ* @"$TyDescr_Uint64_115", i8* %"$$to_uint32_$input_4_484_486"), !dbg !44
  %"$to_uint32_488" = bitcast i8* %"$to_uint32_call_487" to %TName_Option_Uint32*
  store %TName_Option_Uint32* %"$to_uint32_488", %TName_Option_Uint32** %"$resopt_5", align 8, !dbg !44
...
"$have_gas_511":                                  ; preds = %"$out_of_gas_510", %"$Some_504"
  ...
  store %TName_Bool* %"$false_513", %TName_Bool** %"$test_6", align 8, !dbg !46
...
"$have_gas_519":                                  ; preds = %"$out_of_gas_518", %"$None_514"
  ...
  store %TName_Bool* %"$$test_3_521", %TName_Bool** %"$test_6", align 8, !dbg !49
  br label %"$matchsucc_499"
...
"$have_gas_530":                                  ; preds = %"$out_of_gas_529", %"$have_gas_525"
  ...
  store %Uint128 { i128 18446744073709551615 }, %Uint128* %"$input_7", align 8, !dbg !51
...
"$have_gas_540":                                  ; preds = %"$out_of_gas_539", %"$have_gas_535"
  ...
  %"$to_uint32_call_546" = call i8* @_to_uint32(i8* %"$execptr_load_542", %_TyDescrTy_Typ* @"$TyDescr_Uint128_119", i8* %"$$to_uint32_$input_7_543_545"), !dbg !52
  %"$to_uint32_547" = bitcast i8* %"$to_uint32_call_546" to %TName_Option_Uint32*
  store %TName_Option_Uint32* %"$to_uint32_547", %TName_Option_Uint32** %"$resopt_8", align 8, !dbg !52
...
"$have_gas_570":                                  ; preds = %"$out_of_gas_569", %"$Some_563"
  ...
  store %TName_Bool* %"$false_572", %TName_Bool** %"$test_9", align 8, !dbg !54
...
"$have_gas_578":                                  ; preds = %"$out_of_gas_577", %"$None_573"
  ...
  store %TName_Bool* %"$$test_6_580", %TName_Bool** %"$test_9", align 8, !dbg !57
  br label %"$matchsucc_558"
...
"$have_gas_589":                                  ; preds = %"$out_of_gas_588", %"$have_gas_584"
  ...
  store %Uint256 { i256 18446744073709551615 }, %Uint256* %"$input_10", align 8, !dbg !59
...
"$have_gas_599":                                  ; preds = %"$out_of_gas_598", %"$have_gas_594"
  ...
  %"$to_uint32_call_605" = call i8* @_to_uint32(i8* %"$execptr_load_601", %_TyDescrTy_Typ* @"$TyDescr_Uint256_123", i8* %"$$to_uint32_$input_10_602_604"), !dbg !60
  %"$to_uint32_606" = bitcast i8* %"$to_uint32_call_605" to %TName_Option_Uint32*
  store %TName_Option_Uint32* %"$to_uint32_606", %TName_Option_Uint32** %"$resopt_11", align 8, !dbg !60
...
"$have_gas_629":                                  ; preds = %"$out_of_gas_628", %"$Some_622"
  ...
  store %TName_Bool* %"$false_631", %TName_Bool** %"$test_12", align 8, !dbg !62
...
"$have_gas_637":                                  ; preds = %"$out_of_gas_636", %"$None_632"
  ...
  store %TName_Bool* %"$$test_9_639", %TName_Bool** %"$test_12", align 8, !dbg !65
  br label %"$matchsucc_617"
...
"$have_gas_648":                                  ; preds = %"$out_of_gas_647", %"$have_gas_643"
  ...
  store %Uint32 { i32 100 }, %Uint32* %"$input_13", align 4, !dbg !67
...
"$have_gas_658":                                  ; preds = %"$out_of_gas_657", %"$have_gas_653"
  ...
  %"$to_uint64_call_664" = call i8* @_to_uint64(i8* %"$execptr_load_660", %_TyDescrTy_Typ* @"$TyDescr_Uint32_111", i8* %"$$to_uint64_$input_13_661_663"), !dbg !68
  %"$to_uint64_665" = bitcast i8* %"$to_uint64_call_664" to %TName_Option_Uint64*
  store %TName_Option_Uint64* %"$to_uint64_665", %TName_Option_Uint64** %"$resopt_14", align 8, !dbg !68
...
"$have_gas_693":                                  ; preds = %"$out_of_gas_692", %"$have_gas_688"
  ...
  store %Uint64 { i64 100 }, %Uint64* %input_5, align 8, !dbg !70
...
"$have_gas_703":                                  ; preds = %"$out_of_gas_702", %"$have_gas_698"
  ...
  %"$eq_call_708" = call %TName_Bool* @_eq_Uint64(i8* %"$execptr_load_705", %Uint64 %"$res_706", %Uint64 %"$input__707"), !dbg !73
  store %TName_Bool* %"$eq_call_708", %TName_Bool** %test_6, align 8, !dbg !73
...
"$have_gas_713":                                  ; preds = %"$out_of_gas_712", %"$have_gas_703"
  ...
  %"$BoolUtils.andb_call_719" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_fptr_716"(i8* %"$BoolUtils.andb_envptr_717", %TName_Bool* %"$$test_12_718"), !dbg !74
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_call_719", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.andb_82", align 8, !dbg !74
  ...
  %"$$BoolUtils.andb_82_call_724" = call %TName_Bool* %"$$BoolUtils.andb_82_fptr_721"(i8* %"$$BoolUtils.andb_82_envptr_722", %TName_Bool* %"$test__723"), !dbg !74
  store %TName_Bool* %"$$BoolUtils.andb_82_call_724", %TName_Bool** %"$BoolUtils.andb_83", align 8, !dbg !74
  %"$$BoolUtils.andb_83_725" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.andb_83", align 8
  store %TName_Bool* %"$$BoolUtils.andb_83_725", %TName_Bool** %"$test_15", align 8, !dbg !74
...
"$have_gas_731":                                  ; preds = %"$out_of_gas_730", %"$None_726"
  ...
  store %TName_Bool* %"$false_733", %TName_Bool** %"$test_15", align 8, !dbg !75
  br label %"$matchsucc_676"
...
"$have_gas_742":                                  ; preds = %"$out_of_gas_741", %"$have_gas_737"
  ...
  store %Uint64 { i64 -1 }, %Uint64* %"$input_16", align 8, !dbg !77
...
"$have_gas_752":                                  ; preds = %"$out_of_gas_751", %"$have_gas_747"
  ...
  %"$to_uint64_call_758" = call i8* @_to_uint64(i8* %"$execptr_load_754", %_TyDescrTy_Typ* @"$TyDescr_Uint64_115", i8* %"$$to_uint64_$input_16_755_757"), !dbg !78
  %"$to_uint64_759" = bitcast i8* %"$to_uint64_call_758" to %TName_Option_Uint64*
  store %TName_Option_Uint64* %"$to_uint64_759", %TName_Option_Uint64** %"$resopt_17", align 8, !dbg !78
...
"$have_gas_787":                                  ; preds = %"$out_of_gas_786", %"$have_gas_782"
  ...
  store %Uint64 { i64 -1 }, %Uint64* %input_8, align 8, !dbg !80
...
"$have_gas_797":                                  ; preds = %"$out_of_gas_796", %"$have_gas_792"
  ...
  %"$eq_call_802" = call %TName_Bool* @_eq_Uint64(i8* %"$execptr_load_799", %Uint64 %"$res_800", %Uint64 %"$input__801"), !dbg !83
  store %TName_Bool* %"$eq_call_802", %TName_Bool** %test_9, align 8, !dbg !83
...
"$have_gas_807":                                  ; preds = %"$out_of_gas_806", %"$have_gas_797"
  ...
  %"$BoolUtils.andb_call_813" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_fptr_810"(i8* %"$BoolUtils.andb_envptr_811", %TName_Bool* %"$$test_15_812"), !dbg !84
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_call_813", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.andb_84", align 8, !dbg !84
  ...
  %"$$BoolUtils.andb_84_call_818" = call %TName_Bool* %"$$BoolUtils.andb_84_fptr_815"(i8* %"$$BoolUtils.andb_84_envptr_816", %TName_Bool* %"$test__817"), !dbg !84
  store %TName_Bool* %"$$BoolUtils.andb_84_call_818", %TName_Bool** %"$BoolUtils.andb_85", align 8, !dbg !84
  %"$$BoolUtils.andb_85_819" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.andb_85", align 8
  store %TName_Bool* %"$$BoolUtils.andb_85_819", %TName_Bool** %"$test_18", align 8, !dbg !84
...
"$have_gas_825":                                  ; preds = %"$out_of_gas_824", %"$None_820"
  ...
  store %TName_Bool* %"$false_827", %TName_Bool** %"$test_18", align 8, !dbg !85
  br label %"$matchsucc_770"
...
"$have_gas_836":                                  ; preds = %"$out_of_gas_835", %"$have_gas_831"
  ...
  store %Uint128 { i128 18446744073709551615 }, %Uint128* %"$input_19", align 8, !dbg !87
...
"$have_gas_846":                                  ; preds = %"$out_of_gas_845", %"$have_gas_841"
  ...
  %"$to_uint64_call_852" = call i8* @_to_uint64(i8* %"$execptr_load_848", %_TyDescrTy_Typ* @"$TyDescr_Uint128_119", i8* %"$$to_uint64_$input_19_849_851"), !dbg !88
  %"$to_uint64_853" = bitcast i8* %"$to_uint64_call_852" to %TName_Option_Uint64*
  store %TName_Option_Uint64* %"$to_uint64_853", %TName_Option_Uint64** %"$resopt_20", align 8, !dbg !88
...
"$have_gas_881":                                  ; preds = %"$out_of_gas_880", %"$have_gas_876"
  ...
  store %Uint64 { i64 -1 }, %Uint64* %input_11, align 8, !dbg !90
...
"$have_gas_891":                                  ; preds = %"$out_of_gas_890", %"$have_gas_886"
  ...
  %"$eq_call_896" = call %TName_Bool* @_eq_Uint64(i8* %"$execptr_load_893", %Uint64 %"$res_894", %Uint64 %"$input__895"), !dbg !93
  store %TName_Bool* %"$eq_call_896", %TName_Bool** %test_12, align 8, !dbg !93
...
"$have_gas_901":                                  ; preds = %"$out_of_gas_900", %"$have_gas_891"
  ...
  %"$BoolUtils.andb_call_907" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_fptr_904"(i8* %"$BoolUtils.andb_envptr_905", %TName_Bool* %"$$test_18_906"), !dbg !94
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_call_907", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.andb_86", align 8, !dbg !94
  ...
  %"$$BoolUtils.andb_86_call_912" = call %TName_Bool* %"$$BoolUtils.andb_86_fptr_909"(i8* %"$$BoolUtils.andb_86_envptr_910", %TName_Bool* %"$test__911"), !dbg !94
  store %TName_Bool* %"$$BoolUtils.andb_86_call_912", %TName_Bool** %"$BoolUtils.andb_87", align 8, !dbg !94
  %"$$BoolUtils.andb_87_913" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.andb_87", align 8
  store %TName_Bool* %"$$BoolUtils.andb_87_913", %TName_Bool** %"$test_21", align 8, !dbg !94
...
"$have_gas_919":                                  ; preds = %"$out_of_gas_918", %"$None_914"
  ...
  store %TName_Bool* %"$false_921", %TName_Bool** %"$test_21", align 8, !dbg !95
  br label %"$matchsucc_864"
...
"$have_gas_930":                                  ; preds = %"$out_of_gas_929", %"$have_gas_925"
  ...
  store %Uint128 { i128 18446744073709551616 }, %Uint128* %"$input_22", align 8, !dbg !97
...
"$have_gas_940":                                  ; preds = %"$out_of_gas_939", %"$have_gas_935"
  ...
  %"$to_uint64_call_946" = call i8* @_to_uint64(i8* %"$execptr_load_942", %_TyDescrTy_Typ* @"$TyDescr_Uint128_119", i8* %"$$to_uint64_$input_22_943_945"), !dbg !98
  %"$to_uint64_947" = bitcast i8* %"$to_uint64_call_946" to %TName_Option_Uint64*
  store %TName_Option_Uint64* %"$to_uint64_947", %TName_Option_Uint64** %"$resopt_23", align 8, !dbg !98
...
"$have_gas_970":                                  ; preds = %"$out_of_gas_969", %"$Some_963"
  ...
  store %TName_Bool* %"$false_972", %TName_Bool** %"$test_24", align 8, !dbg !100
...
"$have_gas_978":                                  ; preds = %"$out_of_gas_977", %"$None_973"
  ...
  store %TName_Bool* %"$$test_21_980", %TName_Bool** %"$test_24", align 8, !dbg !103
  br label %"$matchsucc_958"
...
"$have_gas_989":                                  ; preds = %"$out_of_gas_988", %"$have_gas_984"
  ...
  store %Uint256 { i256 18446744073709551616 }, %Uint256* %"$input_25", align 8, !dbg !105
...
"$have_gas_999":                                  ; preds = %"$out_of_gas_998", %"$have_gas_994"
  ...
  %"$to_uint64_call_1005" = call i8* @_to_uint64(i8* %"$execptr_load_1001", %_TyDescrTy_Typ* @"$TyDescr_Uint256_123", i8* %"$$to_uint64_$input_25_1002_1004"), !dbg !106
  %"$to_uint64_1006" = bitcast i8* %"$to_uint64_call_1005" to %TName_Option_Uint64*
  store %TName_Option_Uint64* %"$to_uint64_1006", %TName_Option_Uint64** %"$resopt_26", align 8, !dbg !106
...
"$have_gas_1029":                                 ; preds = %"$out_of_gas_1028", %"$Some_1022"
  ...
  store %TName_Bool* %"$false_1031", %TName_Bool** %"$test_27", align 8, !dbg !108
...
"$have_gas_1037":                                 ; preds = %"$out_of_gas_1036", %"$None_1032"
  ...
  store %TName_Bool* %"$$test_24_1039", %TName_Bool** %"$test_27", align 8, !dbg !111
  br label %"$matchsucc_1017"
...
"$have_gas_1048":                                 ; preds = %"$out_of_gas_1047", %"$have_gas_1043"
  ...
  store %Uint128 { i128 18446744073709551615 }, %Uint128* %"$input_28", align 8, !dbg !113
...
"$have_gas_1058":                                 ; preds = %"$out_of_gas_1057", %"$have_gas_1053"
  ...
  %"$to_uint128_call_1064" = call i8* @_to_uint128(i8* %"$execptr_load_1060", %_TyDescrTy_Typ* @"$TyDescr_Uint128_119", i8* %"$$to_uint128_$input_28_1061_1063"), !dbg !114
  %"$to_uint128_1065" = bitcast i8* %"$to_uint128_call_1064" to %TName_Option_Uint128*
  store %TName_Option_Uint128* %"$to_uint128_1065", %TName_Option_Uint128** %"$resopt_29", align 8, !dbg !114
...
"$have_gas_1093":                                 ; preds = %"$out_of_gas_1092", %"$have_gas_1088"
  ...
  store %Uint128 { i128 18446744073709551615 }, %Uint128* %input_14, align 8, !dbg !116
...
"$have_gas_1104":                                 ; preds = %"$out_of_gas_1103", %"$have_gas_1098"
  ...
  %"$eq_call_1109" = call %TName_Bool* @_eq_Uint128(i8* %"$execptr_load_1106", %Uint128 %"$res_1107", %Uint128 %"$input__1108"), !dbg !119
  store %TName_Bool* %"$eq_call_1109", %TName_Bool** %test_15, align 8, !dbg !119
...
"$have_gas_1114":                                 ; preds = %"$out_of_gas_1113", %"$have_gas_1104"
  ...
  %"$BoolUtils.andb_call_1120" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_fptr_1117"(i8* %"$BoolUtils.andb_envptr_1118", %TName_Bool* %"$$test_27_1119"), !dbg !120
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_call_1120", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.andb_88", align 8, !dbg !120
  ...
  %"$$BoolUtils.andb_88_call_1125" = call %TName_Bool* %"$$BoolUtils.andb_88_fptr_1122"(i8* %"$$BoolUtils.andb_88_envptr_1123", %TName_Bool* %"$test__1124"), !dbg !120
  store %TName_Bool* %"$$BoolUtils.andb_88_call_1125", %TName_Bool** %"$BoolUtils.andb_89", align 8, !dbg !120
  %"$$BoolUtils.andb_89_1126" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.andb_89", align 8
  store %TName_Bool* %"$$BoolUtils.andb_89_1126", %TName_Bool** %"$test_30", align 8, !dbg !120
...
"$have_gas_1132":                                 ; preds = %"$out_of_gas_1131", %"$None_1127"
  ...
  store %TName_Bool* %"$false_1134", %TName_Bool** %"$test_30", align 8, !dbg !121
  br label %"$matchsucc_1076"
...
"$have_gas_1143":                                 ; preds = %"$out_of_gas_1142", %"$have_gas_1138"
  ...
  store %Uint128 { i128 -1 }, %Uint128* %"$input_31", align 8, !dbg !123
...
"$have_gas_1153":                                 ; preds = %"$out_of_gas_1152", %"$have_gas_1148"
  ...
  %"$to_uint128_call_1159" = call i8* @_to_uint128(i8* %"$execptr_load_1155", %_TyDescrTy_Typ* @"$TyDescr_Uint128_119", i8* %"$$to_uint128_$input_31_1156_1158"), !dbg !124
  %"$to_uint128_1160" = bitcast i8* %"$to_uint128_call_1159" to %TName_Option_Uint128*
  store %TName_Option_Uint128* %"$to_uint128_1160", %TName_Option_Uint128** %"$resopt_32", align 8, !dbg !124
...
"$have_gas_1188":                                 ; preds = %"$out_of_gas_1187", %"$have_gas_1183"
  ...
  store %Uint128 { i128 -1 }, %Uint128* %input_17, align 8, !dbg !126
...
"$have_gas_1199":                                 ; preds = %"$out_of_gas_1198", %"$have_gas_1193"
  ...
  %"$eq_call_1204" = call %TName_Bool* @_eq_Uint128(i8* %"$execptr_load_1201", %Uint128 %"$res_1202", %Uint128 %"$input__1203"), !dbg !129
  store %TName_Bool* %"$eq_call_1204", %TName_Bool** %test_18, align 8, !dbg !129
...
"$have_gas_1209":                                 ; preds = %"$out_of_gas_1208", %"$have_gas_1199"
  ...
  %"$BoolUtils.andb_call_1215" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_fptr_1212"(i8* %"$BoolUtils.andb_envptr_1213", %TName_Bool* %"$$test_30_1214"), !dbg !130
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_call_1215", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.andb_90", align 8, !dbg !130
  ...
  %"$$BoolUtils.andb_90_call_1220" = call %TName_Bool* %"$$BoolUtils.andb_90_fptr_1217"(i8* %"$$BoolUtils.andb_90_envptr_1218", %TName_Bool* %"$test__1219"), !dbg !130
  store %TName_Bool* %"$$BoolUtils.andb_90_call_1220", %TName_Bool** %"$BoolUtils.andb_91", align 8, !dbg !130
  %"$$BoolUtils.andb_91_1221" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.andb_91", align 8
  store %TName_Bool* %"$$BoolUtils.andb_91_1221", %TName_Bool** %"$test_33", align 8, !dbg !130
...
"$have_gas_1227":                                 ; preds = %"$out_of_gas_1226", %"$None_1222"
  ...
  store %TName_Bool* %"$false_1229", %TName_Bool** %"$test_33", align 8, !dbg !131
  br label %"$matchsucc_1171"
...
"$have_gas_1238":                                 ; preds = %"$out_of_gas_1237", %"$have_gas_1233"
  ...
  store %Uint256 { i256 340282366920938463463374607431768211456 }, %Uint256* %"$input_34", align 8, !dbg !133
...
"$have_gas_1248":                                 ; preds = %"$out_of_gas_1247", %"$have_gas_1243"
  ...
  %"$to_uint128_call_1254" = call i8* @_to_uint128(i8* %"$execptr_load_1250", %_TyDescrTy_Typ* @"$TyDescr_Uint256_123", i8* %"$$to_uint128_$input_34_1251_1253"), !dbg !134
  %"$to_uint128_1255" = bitcast i8* %"$to_uint128_call_1254" to %TName_Option_Uint128*
  store %TName_Option_Uint128* %"$to_uint128_1255", %TName_Option_Uint128** %"$resopt_35", align 8, !dbg !134
...
"$have_gas_1278":                                 ; preds = %"$out_of_gas_1277", %"$Some_1271"
  ...
  store %TName_Bool* %"$false_1280", %TName_Bool** %"$test_36", align 8, !dbg !136
...
"$have_gas_1286":                                 ; preds = %"$out_of_gas_1285", %"$None_1281"
  ...
  store %TName_Bool* %"$$test_33_1288", %TName_Bool** %"$test_36", align 8, !dbg !139
  br label %"$matchsucc_1266"
...
"$have_gas_1297":                                 ; preds = %"$out_of_gas_1296", %"$have_gas_1292"
  ...
  store %Uint256 { i256 340282366920938463463374607431768211456 }, %Uint256* %"$input_37", align 8, !dbg !141
...
"$have_gas_1307":                                 ; preds = %"$out_of_gas_1306", %"$have_gas_1302"
  ...
  %"$to_uint256_call_1313" = call i8* @_to_uint256(i8* %"$execptr_load_1309", %_TyDescrTy_Typ* @"$TyDescr_Uint256_123", i8* %"$$to_uint256_$input_37_1310_1312"), !dbg !142
  %"$to_uint256_1314" = bitcast i8* %"$to_uint256_call_1313" to %TName_Option_Uint256*
  store %TName_Option_Uint256* %"$to_uint256_1314", %TName_Option_Uint256** %"$resopt_38", align 8, !dbg !142
...
"$have_gas_1342":                                 ; preds = %"$out_of_gas_1341", %"$have_gas_1337"
  ...
  store %Uint256 { i256 340282366920938463463374607431768211456 }, %Uint256* %input_20, align 8, !dbg !144
...
"$have_gas_1353":                                 ; preds = %"$out_of_gas_1352", %"$have_gas_1347"
  ...
  %"$eq_call_1360" = call %TName_Bool* @_eq_Uint256(i8* %"$execptr_load_1355", %Uint256* %"$eq_res_1356", %Uint256* %"$eq_input__1358"), !dbg !147
  store %TName_Bool* %"$eq_call_1360", %TName_Bool** %test_21, align 8, !dbg !147
...
"$have_gas_1365":                                 ; preds = %"$out_of_gas_1364", %"$have_gas_1353"
  ...
  %"$BoolUtils.andb_call_1371" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_fptr_1368"(i8* %"$BoolUtils.andb_envptr_1369", %TName_Bool* %"$$test_36_1370"), !dbg !148
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_call_1371", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.andb_92", align 8, !dbg !148
  ...
  %"$$BoolUtils.andb_92_call_1376" = call %TName_Bool* %"$$BoolUtils.andb_92_fptr_1373"(i8* %"$$BoolUtils.andb_92_envptr_1374", %TName_Bool* %"$test__1375"), !dbg !148
  store %TName_Bool* %"$$BoolUtils.andb_92_call_1376", %TName_Bool** %"$BoolUtils.andb_93", align 8, !dbg !148
  %"$$BoolUtils.andb_93_1377" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.andb_93", align 8
  store %TName_Bool* %"$$BoolUtils.andb_93_1377", %TName_Bool** %"$test_39", align 8, !dbg !148
...
"$have_gas_1383":                                 ; preds = %"$out_of_gas_1382", %"$None_1378"
  ...
  store %TName_Bool* %"$false_1385", %TName_Bool** %"$test_39", align 8, !dbg !149
  br label %"$matchsucc_1325"
...
"$have_gas_1394":                                 ; preds = %"$out_of_gas_1393", %"$have_gas_1389"
  ...
  store %Uint32 { i32 22 }, %Uint32* %"$input_40", align 4, !dbg !151
...
"$have_gas_1404":                                 ; preds = %"$out_of_gas_1403", %"$have_gas_1399"
  ...
  %"$to_uint256_call_1410" = call i8* @_to_uint256(i8* %"$execptr_load_1406", %_TyDescrTy_Typ* @"$TyDescr_Uint32_111", i8* %"$$to_uint256_$input_40_1407_1409"), !dbg !152
  %"$to_uint256_1411" = bitcast i8* %"$to_uint256_call_1410" to %TName_Option_Uint256*
  store %TName_Option_Uint256* %"$to_uint256_1411", %TName_Option_Uint256** %"$resopt_41", align 8, !dbg !152
...
"$have_gas_1439":                                 ; preds = %"$out_of_gas_1438", %"$have_gas_1434"
  ...
  store %Uint256 { i256 22 }, %Uint256* %input_23, align 8, !dbg !154
...
"$have_gas_1450":                                 ; preds = %"$out_of_gas_1449", %"$have_gas_1444"
  ...
  %"$eq_call_1457" = call %TName_Bool* @_eq_Uint256(i8* %"$execptr_load_1452", %Uint256* %"$eq_res_1453", %Uint256* %"$eq_input__1455"), !dbg !157
  store %TName_Bool* %"$eq_call_1457", %TName_Bool** %test_24, align 8, !dbg !157
...
"$have_gas_1462":                                 ; preds = %"$out_of_gas_1461", %"$have_gas_1450"
  ...
  %"$BoolUtils.andb_call_1468" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_fptr_1465"(i8* %"$BoolUtils.andb_envptr_1466", %TName_Bool* %"$$test_39_1467"), !dbg !158
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_call_1468", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.andb_94", align 8, !dbg !158
  ...
  %"$$BoolUtils.andb_94_call_1473" = call %TName_Bool* %"$$BoolUtils.andb_94_fptr_1470"(i8* %"$$BoolUtils.andb_94_envptr_1471", %TName_Bool* %"$test__1472"), !dbg !158
  store %TName_Bool* %"$$BoolUtils.andb_94_call_1473", %TName_Bool** %"$BoolUtils.andb_95", align 8, !dbg !158
  %"$$BoolUtils.andb_95_1474" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.andb_95", align 8
  store %TName_Bool* %"$$BoolUtils.andb_95_1474", %TName_Bool** %"$test_42", align 8, !dbg !158
...
"$have_gas_1480":                                 ; preds = %"$out_of_gas_1479", %"$None_1475"
  ...
  store %TName_Bool* %"$false_1482", %TName_Bool** %"$test_42", align 8, !dbg !159
  br label %"$matchsucc_1422"
...
"$have_gas_1491":                                 ; preds = %"$out_of_gas_1490", %"$have_gas_1486"
  ...
  store %Int32 { i32 2147483647 }, %Int32* %"$input_43", align 4, !dbg !161
...
"$have_gas_1501":                                 ; preds = %"$out_of_gas_1500", %"$have_gas_1496"
  ...
  %"$to_uint32_call_1507" = call i8* @_to_uint32(i8* %"$execptr_load_1503", %_TyDescrTy_Typ* @"$TyDescr_Int32_109", i8* %"$$to_uint32_$input_43_1504_1506"), !dbg !162
  %"$to_uint32_1508" = bitcast i8* %"$to_uint32_call_1507" to %TName_Option_Uint32*
  store %TName_Option_Uint32* %"$to_uint32_1508", %TName_Option_Uint32** %"$resopt_44", align 8, !dbg !162
...
"$have_gas_1536":                                 ; preds = %"$out_of_gas_1535", %"$have_gas_1531"
  ...
  store %Uint32 { i32 2147483647 }, %Uint32* %input_26, align 4, !dbg !164
...
"$have_gas_1546":                                 ; preds = %"$out_of_gas_1545", %"$have_gas_1541"
  ...
  %"$eq_call_1551" = call %TName_Bool* @_eq_Uint32(i8* %"$execptr_load_1548", %Uint32 %"$res_1549", %Uint32 %"$input__1550"), !dbg !167
  store %TName_Bool* %"$eq_call_1551", %TName_Bool** %test_27, align 8, !dbg !167
...
"$have_gas_1556":                                 ; preds = %"$out_of_gas_1555", %"$have_gas_1546"
  ...
  %"$BoolUtils.andb_call_1562" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_fptr_1559"(i8* %"$BoolUtils.andb_envptr_1560", %TName_Bool* %"$$test_42_1561"), !dbg !168
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_call_1562", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.andb_96", align 8, !dbg !168
  ...
  %"$$BoolUtils.andb_96_call_1567" = call %TName_Bool* %"$$BoolUtils.andb_96_fptr_1564"(i8* %"$$BoolUtils.andb_96_envptr_1565", %TName_Bool* %"$test__1566"), !dbg !168
  store %TName_Bool* %"$$BoolUtils.andb_96_call_1567", %TName_Bool** %"$BoolUtils.andb_97", align 8, !dbg !168
  %"$$BoolUtils.andb_97_1568" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.andb_97", align 8
  store %TName_Bool* %"$$BoolUtils.andb_97_1568", %TName_Bool** %"$test_45", align 8, !dbg !168
...
"$have_gas_1574":                                 ; preds = %"$out_of_gas_1573", %"$None_1569"
  ...
  store %TName_Bool* %"$false_1576", %TName_Bool** %"$test_45", align 8, !dbg !169
  br label %"$matchsucc_1519"
...
"$have_gas_1585":                                 ; preds = %"$out_of_gas_1584", %"$have_gas_1580"
  ...
  store %Int32 { i32 -2147483648 }, %Int32* %"$input_46", align 4, !dbg !171
...
"$have_gas_1595":                                 ; preds = %"$out_of_gas_1594", %"$have_gas_1590"
  ...
  %"$to_uint32_call_1601" = call i8* @_to_uint32(i8* %"$execptr_load_1597", %_TyDescrTy_Typ* @"$TyDescr_Int32_109", i8* %"$$to_uint32_$input_46_1598_1600"), !dbg !172
  %"$to_uint32_1602" = bitcast i8* %"$to_uint32_call_1601" to %TName_Option_Uint32*
  store %TName_Option_Uint32* %"$to_uint32_1602", %TName_Option_Uint32** %"$resopt_47", align 8, !dbg !172
...
"$have_gas_1625":                                 ; preds = %"$out_of_gas_1624", %"$Some_1618"
  ...
  store %TName_Bool* %"$false_1627", %TName_Bool** %"$test_48", align 8, !dbg !174
...
"$have_gas_1633":                                 ; preds = %"$out_of_gas_1632", %"$None_1628"
  ...
  store %TName_Bool* %"$$test_45_1635", %TName_Bool** %"$test_48", align 8, !dbg !177
  br label %"$matchsucc_1613"
...
"$have_gas_1644":                                 ; preds = %"$out_of_gas_1643", %"$have_gas_1639"
  ...
  store %String { i8* getelementptr inbounds ([11 x i8], [11 x i8]* @"$stringlit_1646", i32 0, i32 0), i32 11 }, %String* %"$input_49", align 8, !dbg !179
...
"$have_gas_1655":                                 ; preds = %"$out_of_gas_1654", %"$have_gas_1650"
  ...
  %"$to_uint32_call_1661" = call i8* @_to_uint32(i8* %"$execptr_load_1657", %_TyDescrTy_Typ* @"$TyDescr_String_125", i8* %"$$to_uint32_$input_49_1658_1660"), !dbg !180
  %"$to_uint32_1662" = bitcast i8* %"$to_uint32_call_1661" to %TName_Option_Uint32*
  store %TName_Option_Uint32* %"$to_uint32_1662", %TName_Option_Uint32** %"$resopt_50", align 8, !dbg !180
...
"$have_gas_1685":                                 ; preds = %"$out_of_gas_1684", %"$Some_1678"
  ...
  store %TName_Bool* %"$false_1687", %TName_Bool** %"$test_51", align 8, !dbg !182
...
"$have_gas_1693":                                 ; preds = %"$out_of_gas_1692", %"$None_1688"
  ...
  store %TName_Bool* %"$$test_48_1695", %TName_Bool** %"$test_51", align 8, !dbg !185
  br label %"$matchsucc_1673"
...
"$have_gas_1704":                                 ; preds = %"$out_of_gas_1703", %"$have_gas_1699"
  ...
  store %Int256 { i256 57896044618658097711785492504343953926634992332820282019728792003956564819967 }, %Int256* %"$input_52", align 8, !dbg !187
...
"$have_gas_1714":                                 ; preds = %"$out_of_gas_1713", %"$have_gas_1709"
  ...
  %"$to_uint256_call_1720" = call i8* @_to_uint256(i8* %"$execptr_load_1716", %_TyDescrTy_Typ* @"$TyDescr_Int256_121", i8* %"$$to_uint256_$input_52_1717_1719"), !dbg !188
  %"$to_uint256_1721" = bitcast i8* %"$to_uint256_call_1720" to %TName_Option_Uint256*
  store %TName_Option_Uint256* %"$to_uint256_1721", %TName_Option_Uint256** %"$resopt_53", align 8, !dbg !188
...
"$have_gas_1749":                                 ; preds = %"$out_of_gas_1748", %"$have_gas_1744"
  ...
  store %Uint256 { i256 57896044618658097711785492504343953926634992332820282019728792003956564819967 }, %Uint256* %input_29, align 8, !dbg !190
...
"$have_gas_1760":                                 ; preds = %"$out_of_gas_1759", %"$have_gas_1754"
  ...
  %"$eq_call_1767" = call %TName_Bool* @_eq_Uint256(i8* %"$execptr_load_1762", %Uint256* %"$eq_res_1763", %Uint256* %"$eq_input__1765"), !dbg !193
  store %TName_Bool* %"$eq_call_1767", %TName_Bool** %test_30, align 8, !dbg !193
...
"$have_gas_1772":                                 ; preds = %"$out_of_gas_1771", %"$have_gas_1760"
  ...
  %"$BoolUtils.andb_call_1778" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_fptr_1775"(i8* %"$BoolUtils.andb_envptr_1776", %TName_Bool* %"$$test_51_1777"), !dbg !194
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_call_1778", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.andb_98", align 8, !dbg !194
  ...
  %"$$BoolUtils.andb_98_call_1783" = call %TName_Bool* %"$$BoolUtils.andb_98_fptr_1780"(i8* %"$$BoolUtils.andb_98_envptr_1781", %TName_Bool* %"$test__1782"), !dbg !194
  store %TName_Bool* %"$$BoolUtils.andb_98_call_1783", %TName_Bool** %"$BoolUtils.andb_99", align 8, !dbg !194
  %"$$BoolUtils.andb_99_1784" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.andb_99", align 8
  store %TName_Bool* %"$$BoolUtils.andb_99_1784", %TName_Bool** %"$test_54", align 8, !dbg !194
...
"$have_gas_1790":                                 ; preds = %"$out_of_gas_1789", %"$None_1785"
  ...
  store %TName_Bool* %"$false_1792", %TName_Bool** %"$test_54", align 8, !dbg !195
  br label %"$matchsucc_1732"
...
"$have_gas_1801":                                 ; preds = %"$out_of_gas_1800", %"$have_gas_1796"
  ...
  store %String { i8* getelementptr inbounds ([77 x i8], [77 x i8]* @"$stringlit_1803", i32 0, i32 0), i32 77 }, %String* %"$input_55", align 8, !dbg !197
...
"$have_gas_1812":                                 ; preds = %"$out_of_gas_1811", %"$have_gas_1807"
  ...
  %"$to_uint256_call_1818" = call i8* @_to_uint256(i8* %"$execptr_load_1814", %_TyDescrTy_Typ* @"$TyDescr_String_125", i8* %"$$to_uint256_$input_55_1815_1817"), !dbg !198
  %"$to_uint256_1819" = bitcast i8* %"$to_uint256_call_1818" to %TName_Option_Uint256*
  store %TName_Option_Uint256* %"$to_uint256_1819", %TName_Option_Uint256** %"$resopt_56", align 8, !dbg !198
...
"$have_gas_1847":                                 ; preds = %"$out_of_gas_1846", %"$have_gas_1842"
  ...
  store %Uint256 { i256 57896044618658097711785492504343953926634992332820282019728792003956564819967 }, %Uint256* %input_32, align 8, !dbg !200
...
"$have_gas_1858":                                 ; preds = %"$out_of_gas_1857", %"$have_gas_1852"
  ...
  %"$eq_call_1865" = call %TName_Bool* @_eq_Uint256(i8* %"$execptr_load_1860", %Uint256* %"$eq_res_1861", %Uint256* %"$eq_input__1863"), !dbg !203
  store %TName_Bool* %"$eq_call_1865", %TName_Bool** %test_33, align 8, !dbg !203
...
"$have_gas_1870":                                 ; preds = %"$out_of_gas_1869", %"$have_gas_1858"
  ...
  %"$BoolUtils.andb_call_1876" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_fptr_1873"(i8* %"$BoolUtils.andb_envptr_1874", %TName_Bool* %"$$test_54_1875"), !dbg !204
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_call_1876", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.andb_100", align 8, !dbg !204
  ...
  %"$$BoolUtils.andb_100_call_1881" = call %TName_Bool* %"$$BoolUtils.andb_100_fptr_1878"(i8* %"$$BoolUtils.andb_100_envptr_1879", %TName_Bool* %"$test__1880"), !dbg !204
  store %TName_Bool* %"$$BoolUtils.andb_100_call_1881", %TName_Bool** %"$BoolUtils.andb_101", align 8, !dbg !204
  %"$$BoolUtils.andb_101_1882" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.andb_101", align 8
  store %TName_Bool* %"$$BoolUtils.andb_101_1882", %TName_Bool** %"$test_57", align 8, !dbg !204
...
"$have_gas_1888":                                 ; preds = %"$out_of_gas_1887", %"$None_1883"
  ...
  store %TName_Bool* %"$false_1890", %TName_Bool** %"$test_57", align 8, !dbg !205
  br label %"$matchsucc_1830"
...
"$have_gas_1899":                                 ; preds = %"$out_of_gas_1898", %"$have_gas_1894"
  ...
  store %Int256 { i256 -282366920938463463374607431768211456 }, %Int256* %"$input_58", align 8, !dbg !207
...
"$have_gas_1909":                                 ; preds = %"$out_of_gas_1908", %"$have_gas_1904"
  ...
  %"$to_uint256_call_1915" = call i8* @_to_uint256(i8* %"$execptr_load_1911", %_TyDescrTy_Typ* @"$TyDescr_Int256_121", i8* %"$$to_uint256_$input_58_1912_1914"), !dbg !208
  %"$to_uint256_1916" = bitcast i8* %"$to_uint256_call_1915" to %TName_Option_Uint256*
  store %TName_Option_Uint256* %"$to_uint256_1916", %TName_Option_Uint256** %"$resopt_59", align 8, !dbg !208
...
"$have_gas_1939":                                 ; preds = %"$out_of_gas_1938", %"$Some_1932"
  ...
  store %TName_Bool* %"$false_1941", %TName_Bool** %"$test_60", align 8, !dbg !210
...
"$have_gas_1947":                                 ; preds = %"$out_of_gas_1946", %"$None_1942"
  ...
  store %TName_Bool* %"$$test_57_1949", %TName_Bool** %"$test_60", align 8, !dbg !213
  br label %"$matchsucc_1927"
...
"$have_gas_1958":                                 ; preds = %"$out_of_gas_1957", %"$have_gas_1953"
  ...
  store %String { i8* getelementptr inbounds ([37 x i8], [37 x i8]* @"$stringlit_1960", i32 0, i32 0), i32 37 }, %String* %"$input_61", align 8, !dbg !215
...
"$have_gas_1969":                                 ; preds = %"$out_of_gas_1968", %"$have_gas_1964"
  ...
  %"$to_uint256_call_1975" = call i8* @_to_uint256(i8* %"$execptr_load_1971", %_TyDescrTy_Typ* @"$TyDescr_String_125", i8* %"$$to_uint256_$input_61_1972_1974"), !dbg !216
  %"$to_uint256_1976" = bitcast i8* %"$to_uint256_call_1975" to %TName_Option_Uint256*
  store %TName_Option_Uint256* %"$to_uint256_1976", %TName_Option_Uint256** %"$resopt_62", align 8, !dbg !216
...
"$have_gas_1999":                                 ; preds = %"$out_of_gas_1998", %"$Some_1992"
  ...
  store %TName_Bool* %"$false_2001", %TName_Bool** %"$test_63", align 8, !dbg !218
...
"$have_gas_2007":                                 ; preds = %"$out_of_gas_2006", %"$None_2002"
  ...
  store %TName_Bool* %"$$test_60_2009", %TName_Bool** %"$test_63", align 8, !dbg !221
  br label %"$matchsucc_1987"
...
"$have_gas_2018":                                 ; preds = %"$out_of_gas_2017", %"$have_gas_2013"
  ...
  store %String { i8* getelementptr inbounds ([4 x i8], [4 x i8]* @"$stringlit_2020", i32 0, i32 0), i32 4 }, %String* %"$input_64", align 8, !dbg !223
...
"$have_gas_2029":                                 ; preds = %"$out_of_gas_2028", %"$have_gas_2024"
  ...
  %"$to_uint64_call_2035" = call i8* @_to_uint64(i8* %"$execptr_load_2031", %_TyDescrTy_Typ* @"$TyDescr_String_125", i8* %"$$to_uint64_$input_64_2032_2034"), !dbg !224
  %"$to_uint64_2036" = bitcast i8* %"$to_uint64_call_2035" to %TName_Option_Uint64*
  store %TName_Option_Uint64* %"$to_uint64_2036", %TName_Option_Uint64** %"$resopt_65", align 8, !dbg !224
...
"$have_gas_2059":                                 ; preds = %"$out_of_gas_2058", %"$Some_2052"
  ...
  store %TName_Bool* %"$false_2061", %TName_Bool** %"$test_66", align 8, !dbg !226
...
"$have_gas_2067":                                 ; preds = %"$out_of_gas_2066", %"$None_2062"
  ...
  store %TName_Bool* %"$$test_63_2069", %TName_Bool** %"$test_66", align 8, !dbg !229
  br label %"$matchsucc_2047"
...
"$have_gas_2073":                                 ; preds = %"$out_of_gas_2072", %"$matchsucc_2047"
  ...
  store %TName_Bool* %"$$test_66_2075", %TName_Bool** %"$expr_106", align 8, !dbg !231
...
!3 = !{}
!4 = distinct !DISubprogram(name: "$fundef_104", linkageName: "$fundef_104", scope: !5, file: !5, line: 8, type: !6, scopeLine: 8, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !1, retainedNodes: !3)
...
!15 = distinct !DISubprogram(name: "$fundef_102", linkageName: "$fundef_102", scope: !5, file: !5, line: 7, type: !6, scopeLine: 7, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !1, retainedNodes: !3)
...
!22 = !DILocation(line: 2, column: 12, scope: !20)
!23 = !DILocation(line: 4, column: 13, scope: !20)
!24 = !DILocation(line: 5, column: 14, scope: !20)
!25 = !DILocation(line: 7, column: 3, scope: !20)
!26 = !DILocation(line: 9, column: 18, scope: !27)
!27 = distinct !DILexicalBlock(scope: !28, file: !2, line: 8, column: 5)
!28 = distinct !DILexicalBlock(scope: !20, file: !2, line: 7, column: 3)
!29 = !DILocation(line: 10, column: 17, scope: !27)
!30 = !DILocation(line: 11, column: 5, scope: !27)
!31 = !DILocation(line: 12, column: 13, scope: !32)
!32 = distinct !DILexicalBlock(scope: !28, file: !2, line: 12, column: 5)
!33 = !DILocation(line: 16, column: 13, scope: !20)
!34 = !DILocation(line: 17, column: 14, scope: !20)
!35 = !DILocation(line: 19, column: 3, scope: !20)
!36 = !DILocation(line: 21, column: 18, scope: !37)
!37 = distinct !DILexicalBlock(scope: !38, file: !2, line: 20, column: 5)
!38 = distinct !DILexicalBlock(scope: !20, file: !2, line: 19, column: 3)
!39 = !DILocation(line: 22, column: 17, scope: !37)
!40 = !DILocation(line: 23, column: 5, scope: !37)
!41 = !DILocation(line: 24, column: 13, scope: !42)
!42 = distinct !DILexicalBlock(scope: !38, file: !2, line: 24, column: 5)
!43 = !DILocation(line: 28, column: 13, scope: !20)
!44 = !DILocation(line: 29, column: 14, scope: !20)
!45 = !DILocation(line: 31, column: 3, scope: !20)
!46 = !DILocation(line: 32, column: 15, scope: !47)
!47 = distinct !DILexicalBlock(scope: !48, file: !2, line: 32, column: 5)
!48 = distinct !DILexicalBlock(scope: !20, file: !2, line: 31, column: 3)
!49 = !DILocation(line: 33, column: 13, scope: !50)
!50 = distinct !DILexicalBlock(scope: !48, file: !2, line: 33, column: 5)
!51 = !DILocation(line: 37, column: 13, scope: !20)
!52 = !DILocation(line: 38, column: 14, scope: !20)
!53 = !DILocation(line: 40, column: 3, scope: !20)
!54 = !DILocation(line: 41, column: 15, scope: !55)
!55 = distinct !DILexicalBlock(scope: !56, file: !2, line: 41, column: 5)
!56 = distinct !DILexicalBlock(scope: !20, file: !2, line: 40, column: 3)
!57 = !DILocation(line: 42, column: 13, scope: !58)
!58 = distinct !DILexicalBlock(scope: !56, file: !2, line: 42, column: 5)
!59 = !DILocation(line: 46, column: 13, scope: !20)
!60 = !DILocation(line: 47, column: 14, scope: !20)
!61 = !DILocation(line: 49, column: 3, scope: !20)
!62 = !DILocation(line: 50, column: 15, scope: !63)
!63 = distinct !DILexicalBlock(scope: !64, file: !2, line: 50, column: 5)
!64 = distinct !DILexicalBlock(scope: !20, file: !2, line: 49, column: 3)
!65 = !DILocation(line: 51, column: 13, scope: !66)
!66 = distinct !DILexicalBlock(scope: !64, file: !2, line: 51, column: 5)
!67 = !DILocation(line: 55, column: 13, scope: !20)
!68 = !DILocation(line: 56, column: 14, scope: !20)
!69 = !DILocation(line: 58, column: 3, scope: !20)
!70 = !DILocation(line: 60, column: 18, scope: !71)
!71 = distinct !DILexicalBlock(scope: !72, file: !2, line: 59, column: 5)
!72 = distinct !DILexicalBlock(scope: !20, file: !2, line: 58, column: 3)
!73 = !DILocation(line: 61, column: 17, scope: !71)
!74 = !DILocation(line: 62, column: 5, scope: !71)
!75 = !DILocation(line: 63, column: 13, scope: !76)
!76 = distinct !DILexicalBlock(scope: !72, file: !2, line: 63, column: 5)
!77 = !DILocation(line: 67, column: 13, scope: !20)
!78 = !DILocation(line: 68, column: 14, scope: !20)
!79 = !DILocation(line: 70, column: 3, scope: !20)
!80 = !DILocation(line: 72, column: 18, scope: !81)
!81 = distinct !DILexicalBlock(scope: !82, file: !2, line: 71, column: 5)
!82 = distinct !DILexicalBlock(scope: !20, file: !2, line: 70, column: 3)
!83 = !DILocation(line: 73, column: 17, scope: !81)
!84 = !DILocation(line: 74, column: 5, scope: !81)
!85 = !DILocation(line: 75, column: 13, scope: !86)
!86 = distinct !DILexicalBlock(scope: !82, file: !2, line: 75, column: 5)
!87 = !DILocation(line: 79, column: 13, scope: !20)
!88 = !DILocation(line: 80, column: 14, scope: !20)
!89 = !DILocation(line: 82, column: 3, scope: !20)
!90 = !DILocation(line: 84, column: 18, scope: !91)
!91 = distinct !DILexicalBlock(scope: !92, file: !2, line: 83, column: 5)
!92 = distinct !DILexicalBlock(scope: !20, file: !2, line: 82, column: 3)
!93 = !DILocation(line: 85, column: 17, scope: !91)
!94 = !DILocation(line: 86, column: 5, scope: !91)
!95 = !DILocation(line: 87, column: 13, scope: !96)
!96 = distinct !DILexicalBlock(scope: !92, file: !2, line: 87, column: 5)
!97 = !DILocation(line: 91, column: 13, scope: !20)
!98 = !DILocation(line: 92, column: 14, scope: !20)
!99 = !DILocation(line: 94, column: 3, scope: !20)
!100 = !DILocation(line: 95, column: 15, scope: !101)
!101 = distinct !DILexicalBlock(scope: !102, file: !2, line: 95, column: 5)
!102 = distinct !DILexicalBlock(scope: !20, file: !2, line: 94, column: 3)
!103 = !DILocation(line: 96, column: 13, scope: !104)
!104 = distinct !DILexicalBlock(scope: !102, file: !2, line: 96, column: 5)
!105 = !DILocation(line: 100, column: 13, scope: !20)
!106 = !DILocation(line: 101, column: 14, scope: !20)
!107 = !DILocation(line: 103, column: 3, scope: !20)
!108 = !DILocation(line: 104, column: 15, scope: !109)
!109 = distinct !DILexicalBlock(scope: !110, file: !2, line: 104, column: 5)
!110 = distinct !DILexicalBlock(scope: !20, file: !2, line: 103, column: 3)
!111 = !DILocation(line: 105, column: 13, scope: !112)
!112 = distinct !DILexicalBlock(scope: !110, file: !2, line: 105, column: 5)
!113 = !DILocation(line: 109, column: 13, scope: !20)
!114 = !DILocation(line: 110, column: 14, scope: !20)
!115 = !DILocation(line: 112, column: 3, scope: !20)
!116 = !DILocation(line: 114, column: 18, scope: !117)
!117 = distinct !DILexicalBlock(scope: !118, file: !2, line: 113, column: 5)
!118 = distinct !DILexicalBlock(scope: !20, file: !2, line: 112, column: 3)
!119 = !DILocation(line: 115, column: 17, scope: !117)
!120 = !DILocation(line: 116, column: 5, scope: !117)
!121 = !DILocation(line: 117, column: 13, scope: !122)
!122 = distinct !DILexicalBlock(scope: !118, file: !2, line: 117, column: 5)
!123 = !DILocation(line: 121, column: 13, scope: !20)
!124 = !DILocation(line: 122, column: 14, scope: !20)
!125 = !DILocation(line: 124, column: 3, scope: !20)
!126 = !DILocation(line: 126, column: 18, scope: !127)
!127 = distinct !DILexicalBlock(scope: !128, file: !2, line: 125, column: 5)
!128 = distinct !DILexicalBlock(scope: !20, file: !2, line: 124, column: 3)
!129 = !DILocation(line: 127, column: 17, scope: !127)
!130 = !DILocation(line: 128, column: 5, scope: !127)
!131 = !DILocation(line: 129, column: 13, scope: !132)
!132 = distinct !DILexicalBlock(scope: !128, file: !2, line: 129, column: 5)
!133 = !DILocation(line: 133, column: 13, scope: !20)
!134 = !DILocation(line: 134, column: 14, scope: !20)
!135 = !DILocation(line: 136, column: 3, scope: !20)
!136 = !DILocation(line: 137, column: 15, scope: !137)
!137 = distinct !DILexicalBlock(scope: !138, file: !2, line: 137, column: 5)
!138 = distinct !DILexicalBlock(scope: !20, file: !2, line: 136, column: 3)
!139 = !DILocation(line: 138, column: 13, scope: !140)
!140 = distinct !DILexicalBlock(scope: !138, file: !2, line: 138, column: 5)
!141 = !DILocation(line: 142, column: 13, scope: !20)
!142 = !DILocation(line: 143, column: 14, scope: !20)
!143 = !DILocation(line: 145, column: 3, scope: !20)
!144 = !DILocation(line: 147, column: 18, scope: !145)
!145 = distinct !DILexicalBlock(scope: !146, file: !2, line: 146, column: 5)
!146 = distinct !DILexicalBlock(scope: !20, file: !2, line: 145, column: 3)
!147 = !DILocation(line: 148, column: 17, scope: !145)
!148 = !DILocation(line: 149, column: 5, scope: !145)
!149 = !DILocation(line: 150, column: 13, scope: !150)
!150 = distinct !DILexicalBlock(scope: !146, file: !2, line: 150, column: 5)
!151 = !DILocation(line: 154, column: 13, scope: !20)
!152 = !DILocation(line: 155, column: 14, scope: !20)
!153 = !DILocation(line: 157, column: 3, scope: !20)
!154 = !DILocation(line: 159, column: 18, scope: !155)
!155 = distinct !DILexicalBlock(scope: !156, file: !2, line: 158, column: 5)
!156 = distinct !DILexicalBlock(scope: !20, file: !2, line: 157, column: 3)
!157 = !DILocation(line: 160, column: 17, scope: !155)
!158 = !DILocation(line: 161, column: 5, scope: !155)
!159 = !DILocation(line: 162, column: 13, scope: !160)
!160 = distinct !DILexicalBlock(scope: !156, file: !2, line: 162, column: 5)
!161 = !DILocation(line: 166, column: 13, scope: !20)
!162 = !DILocation(line: 167, column: 14, scope: !20)
!163 = !DILocation(line: 169, column: 3, scope: !20)
!164 = !DILocation(line: 171, column: 18, scope: !165)
!165 = distinct !DILexicalBlock(scope: !166, file: !2, line: 170, column: 5)
!166 = distinct !DILexicalBlock(scope: !20, file: !2, line: 169, column: 3)
!167 = !DILocation(line: 172, column: 17, scope: !165)
!168 = !DILocation(line: 173, column: 5, scope: !165)
!169 = !DILocation(line: 174, column: 13, scope: !170)
!170 = distinct !DILexicalBlock(scope: !166, file: !2, line: 174, column: 5)
!171 = !DILocation(line: 178, column: 13, scope: !20)
!172 = !DILocation(line: 179, column: 14, scope: !20)
!173 = !DILocation(line: 181, column: 3, scope: !20)
!174 = !DILocation(line: 182, column: 15, scope: !175)
!175 = distinct !DILexicalBlock(scope: !176, file: !2, line: 182, column: 5)
!176 = distinct !DILexicalBlock(scope: !20, file: !2, line: 181, column: 3)
!177 = !DILocation(line: 183, column: 13, scope: !178)
!178 = distinct !DILexicalBlock(scope: !176, file: !2, line: 183, column: 5)
!179 = !DILocation(line: 187, column: 25, scope: !20)
!180 = !DILocation(line: 188, column: 14, scope: !20)
!181 = !DILocation(line: 190, column: 3, scope: !20)
!182 = !DILocation(line: 191, column: 15, scope: !183)
!183 = distinct !DILexicalBlock(scope: !184, file: !2, line: 191, column: 5)
!184 = distinct !DILexicalBlock(scope: !20, file: !2, line: 190, column: 3)
!185 = !DILocation(line: 192, column: 13, scope: !186)
!186 = distinct !DILexicalBlock(scope: !184, file: !2, line: 192, column: 5)
!187 = !DILocation(line: 196, column: 13, scope: !20)
!188 = !DILocation(line: 197, column: 14, scope: !20)
!189 = !DILocation(line: 199, column: 3, scope: !20)
!190 = !DILocation(line: 201, column: 18, scope: !191)
!191 = distinct !DILexicalBlock(scope: !192, file: !2, line: 200, column: 5)
!192 = distinct !DILexicalBlock(scope: !20, file: !2, line: 199, column: 3)
!193 = !DILocation(line: 202, column: 17, scope: !191)
!194 = !DILocation(line: 203, column: 5, scope: !191)
!195 = !DILocation(line: 204, column: 13, scope: !196)
!196 = distinct !DILexicalBlock(scope: !192, file: !2, line: 204, column: 5)
!197 = !DILocation(line: 208, column: 91, scope: !20)
!198 = !DILocation(line: 209, column: 14, scope: !20)
!199 = !DILocation(line: 211, column: 3, scope: !20)
!200 = !DILocation(line: 213, column: 18, scope: !201)
!201 = distinct !DILexicalBlock(scope: !202, file: !2, line: 212, column: 5)
!202 = distinct !DILexicalBlock(scope: !20, file: !2, line: 211, column: 3)
!203 = !DILocation(line: 214, column: 17, scope: !201)
!204 = !DILocation(line: 215, column: 5, scope: !201)
!205 = !DILocation(line: 216, column: 13, scope: !206)
!206 = distinct !DILexicalBlock(scope: !202, file: !2, line: 216, column: 5)
!207 = !DILocation(line: 220, column: 13, scope: !20)
!208 = !DILocation(line: 221, column: 14, scope: !20)
!209 = !DILocation(line: 223, column: 3, scope: !20)
!210 = !DILocation(line: 224, column: 15, scope: !211)
!211 = distinct !DILexicalBlock(scope: !212, file: !2, line: 224, column: 5)
!212 = distinct !DILexicalBlock(scope: !20, file: !2, line: 223, column: 3)
!213 = !DILocation(line: 225, column: 13, scope: !214)
!214 = distinct !DILexicalBlock(scope: !212, file: !2, line: 225, column: 5)
!215 = !DILocation(line: 229, column: 51, scope: !20)
!216 = !DILocation(line: 230, column: 14, scope: !20)
!217 = !DILocation(line: 232, column: 3, scope: !20)
!218 = !DILocation(line: 233, column: 15, scope: !219)
!219 = distinct !DILexicalBlock(scope: !220, file: !2, line: 233, column: 5)
!220 = distinct !DILexicalBlock(scope: !20, file: !2, line: 232, column: 3)
!221 = !DILocation(line: 234, column: 13, scope: !222)
!222 = distinct !DILexicalBlock(scope: !220, file: !2, line: 234, column: 5)
!223 = !DILocation(line: 238, column: 18, scope: !20)
!224 = !DILocation(line: 239, column: 14, scope: !20)
!225 = !DILocation(line: 241, column: 3, scope: !20)
!226 = !DILocation(line: 242, column: 15, scope: !227)
!227 = distinct !DILexicalBlock(scope: !228, file: !2, line: 242, column: 5)
!228 = distinct !DILexicalBlock(scope: !20, file: !2, line: 241, column: 3)
!229 = !DILocation(line: 243, column: 13, scope: !230)
!230 = distinct !DILexicalBlock(scope: !228, file: !2, line: 243, column: 5)
!231 = !DILocation(line: 247, column: 1, scope: !20)
