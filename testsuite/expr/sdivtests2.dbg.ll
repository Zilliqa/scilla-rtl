...
"$have_gas_92":                                   ; preds = %"$out_of_gas_91", %"$have_gas_87"
  ...
  store %Int32 { i32 -10 }, %Int32* %b, align 4, !dbg !11
...
"$have_gas_102":                                  ; preds = %"$out_of_gas_101", %"$have_gas_97"
  ...
  store %Int32 { i32 3 }, %Int32* %a, align 4, !dbg !12
...
"$have_gas_112":                                  ; preds = %"$out_of_gas_111", %"$have_gas_107"
  ...
  %"$div_call_116" = call %Int32 @_div_Int32(%Int32 %"$a_114", %Int32 %"$b_115"), !dbg !13
  store %Int32 %"$div_call_116", %Int32* %res_div, align 4, !dbg !13
...
"$have_gas_125":                                  ; preds = %"$out_of_gas_124", %"$have_gas_120"
  ...
  %"$rem_call_129" = call %Int32 @_rem_Int32(%Int32 %"$a_127", %Int32 %"$b_128"), !dbg !14
  store %Int32 %"$rem_call_129", %Int32* %res_rem, align 4, !dbg !14
...
"$have_gas_138":                                  ; preds = %"$out_of_gas_137", %"$have_gas_133"
  ...
  %"$add_call_142" = call %Int32 @_add_Int32(%Int32 %"$res_div_140", %Int32 %"$res_rem_141"), !dbg !15
  store %Int32 %"$add_call_142", %Int32* %res1, align 4, !dbg !15
...
"$have_gas_151":                                  ; preds = %"$out_of_gas_150", %"$have_gas_146"
  ...
  store %Int32 { i32 10 }, %Int32* %"$b_6", align 4, !dbg !16
...
"$have_gas_161":                                  ; preds = %"$out_of_gas_160", %"$have_gas_156"
  ...
  store %Int32 { i32 -3 }, %Int32* %"$a_7", align 4, !dbg !17
...
"$have_gas_171":                                  ; preds = %"$out_of_gas_170", %"$have_gas_166"
  ...
  %"$$a_7_173" = load %Int32, %Int32* %"$a_7", align 4
  %"$$b_6_174" = load %Int32, %Int32* %"$b_6", align 4
  %"$div_call_175" = call %Int32 @_div_Int32(%Int32 %"$$a_7_173", %Int32 %"$$b_6_174"), !dbg !18
  store %Int32 %"$div_call_175", %Int32* %"$res_div_8", align 4, !dbg !18
...
"$have_gas_184":                                  ; preds = %"$out_of_gas_183", %"$have_gas_179"
  ...
  %"$$a_7_186" = load %Int32, %Int32* %"$a_7", align 4
  %"$$b_6_187" = load %Int32, %Int32* %"$b_6", align 4
  %"$rem_call_188" = call %Int32 @_rem_Int32(%Int32 %"$$a_7_186", %Int32 %"$$b_6_187"), !dbg !19
  store %Int32 %"$rem_call_188", %Int32* %"$res_rem_9", align 4, !dbg !19
...
"$have_gas_197":                                  ; preds = %"$out_of_gas_196", %"$have_gas_192"
  ...
  %"$add_call_201" = call %Int32 @_add_Int32(%Int32 %"$$res_div_8_199", %Int32 %"$$res_rem_9_200"), !dbg !20
  store %Int32 %"$add_call_201", %Int32* %res2, align 4, !dbg !20
...
"$have_gas_210":                                  ; preds = %"$out_of_gas_209", %"$have_gas_205"
  ...
  store %Int32 { i32 -10 }, %Int32* %"$b_10", align 4, !dbg !21
...
"$have_gas_220":                                  ; preds = %"$out_of_gas_219", %"$have_gas_215"
  ...
  store %Int32 { i32 -3 }, %Int32* %"$a_11", align 4, !dbg !22
...
"$have_gas_230":                                  ; preds = %"$out_of_gas_229", %"$have_gas_225"
  ...
  %"$$a_11_232" = load %Int32, %Int32* %"$a_11", align 4
  %"$$b_10_233" = load %Int32, %Int32* %"$b_10", align 4
  %"$div_call_234" = call %Int32 @_div_Int32(%Int32 %"$$a_11_232", %Int32 %"$$b_10_233"), !dbg !23
  store %Int32 %"$div_call_234", %Int32* %"$res_div_12", align 4, !dbg !23
...
"$have_gas_243":                                  ; preds = %"$out_of_gas_242", %"$have_gas_238"
  ...
  %"$$a_11_245" = load %Int32, %Int32* %"$a_11", align 4
  %"$$b_10_246" = load %Int32, %Int32* %"$b_10", align 4
  %"$rem_call_247" = call %Int32 @_rem_Int32(%Int32 %"$$a_11_245", %Int32 %"$$b_10_246"), !dbg !24
  store %Int32 %"$rem_call_247", %Int32* %"$res_rem_13", align 4, !dbg !24
...
"$have_gas_256":                                  ; preds = %"$out_of_gas_255", %"$have_gas_251"
  ...
  %"$add_call_260" = call %Int32 @_add_Int32(%Int32 %"$$res_div_12_258", %Int32 %"$$res_rem_13_259"), !dbg !25
  store %Int32 %"$add_call_260", %Int32* %res3, align 4, !dbg !25
...
"$have_gas_269":                                  ; preds = %"$out_of_gas_268", %"$have_gas_264"
  ...
  store %Int32 { i32 10 }, %Int32* %"$b_14", align 4, !dbg !26
...
"$have_gas_279":                                  ; preds = %"$out_of_gas_278", %"$have_gas_274"
  ...
  store %Int32 { i32 3 }, %Int32* %"$a_15", align 4, !dbg !27
...
"$have_gas_289":                                  ; preds = %"$out_of_gas_288", %"$have_gas_284"
  ...
  %"$$a_15_291" = load %Int32, %Int32* %"$a_15", align 4
  %"$$b_14_292" = load %Int32, %Int32* %"$b_14", align 4
  %"$div_call_293" = call %Int32 @_div_Int32(%Int32 %"$$a_15_291", %Int32 %"$$b_14_292"), !dbg !28
  store %Int32 %"$div_call_293", %Int32* %"$res_div_16", align 4, !dbg !28
...
"$have_gas_302":                                  ; preds = %"$out_of_gas_301", %"$have_gas_297"
  ...
  %"$$a_15_304" = load %Int32, %Int32* %"$a_15", align 4
  %"$$b_14_305" = load %Int32, %Int32* %"$b_14", align 4
  %"$rem_call_306" = call %Int32 @_rem_Int32(%Int32 %"$$a_15_304", %Int32 %"$$b_14_305"), !dbg !29
  store %Int32 %"$rem_call_306", %Int32* %"$res_rem_17", align 4, !dbg !29
...
"$have_gas_315":                                  ; preds = %"$out_of_gas_314", %"$have_gas_310"
  ...
  %"$add_call_319" = call %Int32 @_add_Int32(%Int32 %"$$res_div_16_317", %Int32 %"$$res_rem_17_318"), !dbg !30
  store %Int32 %"$add_call_319", %Int32* %res4, align 4, !dbg !30
...
"$have_gas_328":                                  ; preds = %"$out_of_gas_327", %"$have_gas_323"
  ...
  %"$add_call_332" = call %Int32 @_add_Int32(%Int32 %"$res1_330", %Int32 %"$res2_331"), !dbg !31
  store %Int32 %"$add_call_332", %Int32* %res5, align 4, !dbg !31
...
"$have_gas_341":                                  ; preds = %"$out_of_gas_340", %"$have_gas_336"
  ...
  %"$add_call_345" = call %Int32 @_add_Int32(%Int32 %"$res5_343", %Int32 %"$res3_344"), !dbg !32
  store %Int32 %"$add_call_345", %Int32* %res6, align 4, !dbg !32
...
"$have_gas_354":                                  ; preds = %"$out_of_gas_353", %"$have_gas_349"
  ...
  %"$add_call_358" = call %Int32 @_add_Int32(%Int32 %"$res4_356", %Int32 %"$res6_357"), !dbg !33
  store %Int32 %"$add_call_358", %Int32* %res7, align 4, !dbg !33
...
"$have_gas_362":                                  ; preds = %"$out_of_gas_361", %"$have_gas_354"
  ...
  store %Int32 %"$res7_364", %Int32* %"$expr_18", align 4, !dbg !34
