...
"$have_gas_173":                                  ; preds = %"$out_of_gas_172", %"$have_gas_168"
  ...
  %"$div_call_177" = call %Int32 @_div_Int32(%Int32 %"$$a_7_175", %Int32 %"$$b_6_176"), !dbg !18
...
"$have_gas_186":                                  ; preds = %"$out_of_gas_185", %"$have_gas_181"
  ...
  %"$rem_call_190" = call %Int32 @_rem_Int32(%Int32 %"$$a_7_188", %Int32 %"$$b_6_189"), !dbg !19
...
"$have_gas_232":                                  ; preds = %"$out_of_gas_231", %"$have_gas_227"
  ...
  %"$div_call_236" = call %Int32 @_div_Int32(%Int32 %"$$a_11_234", %Int32 %"$$b_10_235"), !dbg !23
...
"$have_gas_245":                                  ; preds = %"$out_of_gas_244", %"$have_gas_240"
  ...
  %"$rem_call_249" = call %Int32 @_rem_Int32(%Int32 %"$$a_11_247", %Int32 %"$$b_10_248"), !dbg !24
...
"$have_gas_291":                                  ; preds = %"$out_of_gas_290", %"$have_gas_286"
  ...
  %"$div_call_295" = call %Int32 @_div_Int32(%Int32 %"$$a_15_293", %Int32 %"$$b_14_294"), !dbg !28
...
"$have_gas_304":                                  ; preds = %"$out_of_gas_303", %"$have_gas_299"
  ...
  %"$rem_call_308" = call %Int32 @_rem_Int32(%Int32 %"$$a_15_306", %Int32 %"$$b_14_307"), !dbg !29
