...
"$have_gas_89":                                   ; preds = %"$out_of_gas_88", %entry
  ...
  call void @llvm.dbg.declare(metadata %Int32* %b, metadata !14, metadata !DIExpression()), !dbg !15
...
"$have_gas_94":                                   ; preds = %"$out_of_gas_93", %"$have_gas_89"
  ...
  store %Int32 { i32 -10 }, %Int32* %b, align 4, !dbg !13
...
"$have_gas_99":                                   ; preds = %"$out_of_gas_98", %"$have_gas_94"
  ...
  call void @llvm.dbg.declare(metadata %Int32* %a, metadata !16, metadata !DIExpression()), !dbg !17
...
"$have_gas_104":                                  ; preds = %"$out_of_gas_103", %"$have_gas_99"
  ...
  store %Int32 { i32 3 }, %Int32* %a, align 4, !dbg !18
...
"$have_gas_148":                                  ; preds = %"$out_of_gas_147", %"$have_gas_140"
  ...
  call void @llvm.dbg.declare(metadata %Int32* %"$b_6", metadata !28, metadata !DIExpression()), !dbg !29
...
"$have_gas_153":                                  ; preds = %"$out_of_gas_152", %"$have_gas_148"
  ...
  store %Int32 { i32 10 }, %Int32* %"$b_6", align 4, !dbg !30
...
"$have_gas_158":                                  ; preds = %"$out_of_gas_157", %"$have_gas_153"
  ...
  call void @llvm.dbg.declare(metadata %Int32* %"$a_7", metadata !31, metadata !DIExpression()), !dbg !32
...
"$have_gas_163":                                  ; preds = %"$out_of_gas_162", %"$have_gas_158"
  ...
  store %Int32 { i32 -3 }, %Int32* %"$a_7", align 4, !dbg !33
...
"$have_gas_173":                                  ; preds = %"$out_of_gas_172", %"$have_gas_168"
  ...
  %"$div_call_177" = call %Int32 @_div_Int32(%Int32 %"$$a_7_175", %Int32 %"$$b_6_176"), !dbg !36
...
"$have_gas_186":                                  ; preds = %"$out_of_gas_185", %"$have_gas_181"
  ...
  %"$rem_call_190" = call %Int32 @_rem_Int32(%Int32 %"$$a_7_188", %Int32 %"$$b_6_189"), !dbg !39
...
"$have_gas_207":                                  ; preds = %"$out_of_gas_206", %"$have_gas_199"
  ...
  call void @llvm.dbg.declare(metadata %Int32* %"$b_10", metadata !43, metadata !DIExpression()), !dbg !44
...
"$have_gas_212":                                  ; preds = %"$out_of_gas_211", %"$have_gas_207"
  ...
  store %Int32 { i32 -10 }, %Int32* %"$b_10", align 4, !dbg !45
...
"$have_gas_217":                                  ; preds = %"$out_of_gas_216", %"$have_gas_212"
  ...
  call void @llvm.dbg.declare(metadata %Int32* %"$a_11", metadata !46, metadata !DIExpression()), !dbg !47
...
"$have_gas_222":                                  ; preds = %"$out_of_gas_221", %"$have_gas_217"
  ...
  store %Int32 { i32 -3 }, %Int32* %"$a_11", align 4, !dbg !48
...
"$have_gas_232":                                  ; preds = %"$out_of_gas_231", %"$have_gas_227"
  ...
  %"$div_call_236" = call %Int32 @_div_Int32(%Int32 %"$$a_11_234", %Int32 %"$$b_10_235"), !dbg !51
...
"$have_gas_245":                                  ; preds = %"$out_of_gas_244", %"$have_gas_240"
  ...
  %"$rem_call_249" = call %Int32 @_rem_Int32(%Int32 %"$$a_11_247", %Int32 %"$$b_10_248"), !dbg !54
...
"$have_gas_266":                                  ; preds = %"$out_of_gas_265", %"$have_gas_258"
  ...
  call void @llvm.dbg.declare(metadata %Int32* %"$b_14", metadata !58, metadata !DIExpression()), !dbg !59
...
"$have_gas_271":                                  ; preds = %"$out_of_gas_270", %"$have_gas_266"
  ...
  store %Int32 { i32 10 }, %Int32* %"$b_14", align 4, !dbg !60
...
"$have_gas_276":                                  ; preds = %"$out_of_gas_275", %"$have_gas_271"
  ...
  call void @llvm.dbg.declare(metadata %Int32* %"$a_15", metadata !61, metadata !DIExpression()), !dbg !62
...
"$have_gas_281":                                  ; preds = %"$out_of_gas_280", %"$have_gas_276"
  ...
  store %Int32 { i32 3 }, %Int32* %"$a_15", align 4, !dbg !63
...
"$have_gas_291":                                  ; preds = %"$out_of_gas_290", %"$have_gas_286"
  ...
  %"$div_call_295" = call %Int32 @_div_Int32(%Int32 %"$$a_15_293", %Int32 %"$$b_14_294"), !dbg !66
...
"$have_gas_304":                                  ; preds = %"$out_of_gas_303", %"$have_gas_299"
  ...
  %"$rem_call_308" = call %Int32 @_rem_Int32(%Int32 %"$$a_15_306", %Int32 %"$$b_14_307"), !dbg !69
...
!2 = !DIFile(filename: "sdivtests2.scilexp", directory: "codegen/expr")
