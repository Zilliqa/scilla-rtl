...
"$have_gas_56":                                   ; preds = %"$out_of_gas_55", %"$have_gas_51"
  ...
  store %Int32 { i32 -10 }, %Int32* %b, align 4, !dbg !10
...
"$have_gas_66":                                   ; preds = %"$out_of_gas_65", %"$have_gas_61"
  ...
  store %Int32 { i32 3 }, %Int32* %a, align 4, !dbg !11
...
"$have_gas_115":                                  ; preds = %"$out_of_gas_114", %"$have_gas_110"
  ...
  store %Int32 { i32 10 }, %Int32* %"$b_0", align 4, !dbg !15
...
"$have_gas_125":                                  ; preds = %"$out_of_gas_124", %"$have_gas_120"
  ...
  store %Int32 { i32 -3 }, %Int32* %"$a_1", align 4, !dbg !16
...
"$have_gas_135":                                  ; preds = %"$out_of_gas_134", %"$have_gas_130"
  ...
  %"$div_call_139" = call %Int32 @_div_Int32(%Int32 %"$$a_1_137", %Int32 %"$$b_0_138"), !dbg !17
...
"$have_gas_148":                                  ; preds = %"$out_of_gas_147", %"$have_gas_143"
  ...
  %"$rem_call_152" = call %Int32 @_rem_Int32(%Int32 %"$$a_1_150", %Int32 %"$$b_0_151"), !dbg !18
...
"$have_gas_174":                                  ; preds = %"$out_of_gas_173", %"$have_gas_169"
  ...
  store %Int32 { i32 -10 }, %Int32* %"$b_4", align 4, !dbg !20
...
"$have_gas_184":                                  ; preds = %"$out_of_gas_183", %"$have_gas_179"
  ...
  store %Int32 { i32 -3 }, %Int32* %"$a_5", align 4, !dbg !21
...
"$have_gas_194":                                  ; preds = %"$out_of_gas_193", %"$have_gas_189"
  ...
  %"$div_call_198" = call %Int32 @_div_Int32(%Int32 %"$$a_5_196", %Int32 %"$$b_4_197"), !dbg !22
...
"$have_gas_207":                                  ; preds = %"$out_of_gas_206", %"$have_gas_202"
  ...
  %"$rem_call_211" = call %Int32 @_rem_Int32(%Int32 %"$$a_5_209", %Int32 %"$$b_4_210"), !dbg !23
...
"$have_gas_233":                                  ; preds = %"$out_of_gas_232", %"$have_gas_228"
  ...
  store %Int32 { i32 10 }, %Int32* %"$b_8", align 4, !dbg !25
...
"$have_gas_243":                                  ; preds = %"$out_of_gas_242", %"$have_gas_238"
  ...
  store %Int32 { i32 3 }, %Int32* %"$a_9", align 4, !dbg !26
...
"$have_gas_253":                                  ; preds = %"$out_of_gas_252", %"$have_gas_248"
  ...
  %"$div_call_257" = call %Int32 @_div_Int32(%Int32 %"$$a_9_255", %Int32 %"$$b_8_256"), !dbg !27
...
"$have_gas_266":                                  ; preds = %"$out_of_gas_265", %"$have_gas_261"
  ...
  %"$rem_call_270" = call %Int32 @_rem_Int32(%Int32 %"$$a_9_268", %Int32 %"$$b_8_269"), !dbg !28
