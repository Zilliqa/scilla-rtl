...
"$have_gas_75":                                   ; preds = %"$out_of_gas_74", %entry
  ...
  store %Int256 { i256 -57896044618658097711785492504343953926634992332820282019728792003956564819968 }, %Int256* %"$expr_6", align 8, !dbg !11
  %"$$expr_6_77" = load %Int256, %Int256* %"$expr_6", align 8
  store %Int256 %"$$expr_6_77", %Int256* %1, align 8
  ret void
}
...
entry:
  %"$mainval_78" = alloca %Int256, align 8
  %"$memvoidcast_79" = bitcast %Int256* %"$mainval_78" to i8*
  call void @_scilla_expr_fun(i8* null, %Int256* %"$mainval_78")
  %"$execptr_load_80" = load i8*, i8** @_execptr, align 8
  call void @_print_scilla_val(i8* %"$execptr_load_80", %_TyDescrTy_Typ* @"$TyDescr_Int256_21", i8* %"$memvoidcast_79")
  ret void
}
...
!2 = !DIFile(filename: "lit-i256-min.scilexp", directory: "codegen/expr")
!3 = !{}
