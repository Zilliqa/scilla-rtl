...
"$have_gas_39":                                   ; preds = %"$out_of_gas_38", %entry
  ...
  store %Int256 { i256 -57896044618658097711785492504343953926634992332820282019728792003956564819968 }, %Int256* %"$expr_0", align 8, !dbg !10
...
entry:
  ...
  call void @_print_scilla_val(i8* %"$execptr_load_44", %_TyDescrTy_Typ* @"$TyDescr_Int256_15", i8* %"$memvoidcast_43")
  ret void
}
