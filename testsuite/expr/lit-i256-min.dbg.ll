...
"$have_gas_77":                                   ; preds = %"$out_of_gas_76", %entry
  ...
  store %Int256 { i256 -57896044618658097711785492504343953926634992332820282019728792003956564819968 }, %Int256* %"$expr_6", align 8, !dbg !13
...
entry:
  %"$mainval_80" = alloca %Int256, align 8
  %"$memvoidcast_81" = bitcast %Int256* %"$mainval_80" to i8*
  call void @_scilla_expr_fun(i8* null, %Int256* %"$mainval_80")
  %"$execptr_load_82" = load i8*, i8** @_execptr, align 8
  call void @_print_scilla_val(i8* %"$execptr_load_82", %_TyDescrTy_Typ* @"$TyDescr_Int256_21", i8* %"$memvoidcast_81")
  ret void
}
