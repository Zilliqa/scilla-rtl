...
"$have_gas_101":                                  ; preds = %"$out_of_gas_100", %entry
  ...
  store { { %TName_Bool* (i8*, %TName_Bool*)*, i8* } (i8*, %TName_Bool*)*, i8* } { { %TName_Bool* (i8*, %TName_Bool*)*, i8* } (i8*, %TName_Bool*)* bitcast ({ %TName_Bool* (i8*, %TName_Bool*)*, i8* } (%"$$fundef_2_env_56"*, %TName_Bool*)* @"$fundef_2" to { %TName_Bool* (i8*, %TName_Bool*)*, i8* } (i8*, %TName_Bool*)*), i8* null }, { { %TName_Bool* (i8*, %TName_Bool*)*, i8* } (i8*, %TName_Bool*)*, i8* }* @BoolUtils.andb, align 8, !dbg !20
...
"$have_gas_183":                                  ; preds = %"$out_of_gas_182", %"$have_gas_174"
  ...
  %"$badd_call_190" = call i8* @_badd(i8* %"$execptr_load_185", i8* %"$a100_186", %_TyDescrTy_Typ* @"$TyDescr_Uint32_11", i8* %"$$badd_i32_1_187_189"), !dbg !28
  store i8* %"$badd_call_190", i8** %a101, align 8, !dbg !28
...
"$have_gas_195":                                  ; preds = %"$out_of_gas_194", %"$have_gas_183"
  ...
  %"$badd_call_202" = call i8* @_badd(i8* %"$execptr_load_197", i8* %"$a101_198", %_TyDescrTy_Typ* @"$TyDescr_Uint64_15", i8* %"$$badd_i64_1_199_201"), !dbg !29
  store i8* %"$badd_call_202", i8** %a102, align 8, !dbg !29
...
"$have_gas_207":                                  ; preds = %"$out_of_gas_206", %"$have_gas_195"
  ...
  %"$badd_call_214" = call i8* @_badd(i8* %"$execptr_load_209", i8* %"$a102_210", %_TyDescrTy_Typ* @"$TyDescr_Uint128_19", i8* %"$$badd_i128_1_211_213"), !dbg !30
  store i8* %"$badd_call_214", i8** %a103, align 8, !dbg !30
...
"$have_gas_219":                                  ; preds = %"$out_of_gas_218", %"$have_gas_207"
  ...
  %"$badd_call_226" = call i8* @_badd(i8* %"$execptr_load_221", i8* %"$a103_222", %_TyDescrTy_Typ* @"$TyDescr_Uint256_23", i8* %"$$badd_i256_1_223_225"), !dbg !31
  store i8* %"$badd_call_226", i8** %a104, align 8, !dbg !31
...
"$have_gas_231":                                  ; preds = %"$out_of_gas_230", %"$have_gas_219"
  ...
  %"$bsub_call_236" = call %Int256* @_bsub(i8* %"$execptr_load_233", i8* %"$a104_234", i8* %"$a100_235"), !dbg !32
  %"$bsub_238" = load %Int256, %Int256* %"$bsub_call_236", align 8
  store %Int256 %"$bsub_238", %Int256* %sub1, align 8, !dbg !32
...
"$have_gas_242":                                  ; preds = %"$out_of_gas_241", %"$have_gas_231"
  ...
  %"$eq_call_249" = call %TName_Bool* @_eq_Int256(i8* %"$execptr_load_244", %Int256* %"$eq_i256_4_245", %Int256* %"$eq_sub1_247"), !dbg !33
  store %TName_Bool* %"$eq_call_249", %TName_Bool** %res1, align 8, !dbg !33
...
"$have_gas_254":                                  ; preds = %"$out_of_gas_253", %"$have_gas_242"
  ...
  %"$bsub_call_259" = call %Int256* @_bsub(i8* %"$execptr_load_256", i8* %"$a100_257", i8* %"$a104_258"), !dbg !34
  %"$bsub_261" = load %Int256, %Int256* %"$bsub_call_259", align 8
  store %Int256 %"$bsub_261", %Int256* %sub2, align 8, !dbg !34
...
"$have_gas_265":                                  ; preds = %"$out_of_gas_264", %"$have_gas_254"
  ...
  %"$eq_call_272" = call %TName_Bool* @_eq_Int256(i8* %"$execptr_load_267", %Int256* %"$eq_i256_m4_268", %Int256* %"$eq_sub2_270"), !dbg !35
  store %TName_Bool* %"$eq_call_272", %TName_Bool** %res2, align 8, !dbg !35
...
"$have_gas_277":                                  ; preds = %"$out_of_gas_276", %"$have_gas_265"
  ...
  %"$BoolUtils.andb_call_283" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_fptr_280"(i8* %"$BoolUtils.andb_envptr_281", %TName_Bool* %"$res1_282"), !dbg !36
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_call_283", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.andb_0", align 8, !dbg !36
  ...
  %"$$BoolUtils.andb_0_call_288" = call %TName_Bool* %"$$BoolUtils.andb_0_fptr_285"(i8* %"$$BoolUtils.andb_0_envptr_286", %TName_Bool* %"$res2_287"), !dbg !36
  store %TName_Bool* %"$$BoolUtils.andb_0_call_288", %TName_Bool** %"$BoolUtils.andb_1", align 8, !dbg !36
  %"$$BoolUtils.andb_1_289" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.andb_1", align 8
  store %TName_Bool* %"$$BoolUtils.andb_1_289", %TName_Bool** %"$expr_6", align 8, !dbg !36
...
!22 = !DILocation(line: 2, column: 13, scope: !19)
!23 = !DILocation(line: 3, column: 14, scope: !19)
!24 = !DILocation(line: 4, column: 14, scope: !19)
!25 = !DILocation(line: 6, column: 14, scope: !19)
!26 = !DILocation(line: 7, column: 15, scope: !19)
!27 = !DILocation(line: 9, column: 12, scope: !19)
!28 = !DILocation(line: 10, column: 12, scope: !19)
!29 = !DILocation(line: 11, column: 12, scope: !19)
!30 = !DILocation(line: 12, column: 12, scope: !19)
!31 = !DILocation(line: 13, column: 12, scope: !19)
!32 = !DILocation(line: 15, column: 12, scope: !19)
!33 = !DILocation(line: 16, column: 12, scope: !19)
!34 = !DILocation(line: 19, column: 12, scope: !19)
!35 = !DILocation(line: 20, column: 12, scope: !19)
