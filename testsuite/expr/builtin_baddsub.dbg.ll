...
entry:
  ...
  call void @llvm.dbg.declare(metadata %TName_Bool** %"$retval_11", metadata !9, metadata !DIExpression()), !dbg !12
...
"$have_gas_93":                                   ; preds = %"$out_of_gas_92", %"$False_88"
  ...
  store %TName_Bool* %"$adtptr_97", %TName_Bool** %"$retval_11", align 8, !dbg !13
...
"$have_gas_103":                                  ; preds = %"$out_of_gas_102", %"$True_98"
  ...
  store %TName_Bool* %1, %TName_Bool** %"$retval_11", align 8, !dbg !16
  br label %"$matchsucc_83"
...
define internal { %TName_Bool* (i8*, %TName_Bool*)*, i8* } @"$fundef_8"(%"$$fundef_8_env_64"* %0, %TName_Bool* %1) !dbg !18 {
entry:
...
"$have_gas_68":                                   ; preds = %"$out_of_gas_67", %entry
  ...
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$$fundef_10_cloval_73", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$retval_9", align 8, !dbg !19
...
"$have_gas_119":                                  ; preds = %"$out_of_gas_118", %"$have_gas_114"
  ...
  store { { %TName_Bool* (i8*, %TName_Bool*)*, i8* } (i8*, %TName_Bool*)*, i8* } { { %TName_Bool* (i8*, %TName_Bool*)*, i8* } (i8*, %TName_Bool*)* bitcast ({ %TName_Bool* (i8*, %TName_Bool*)*, i8* } (%"$$fundef_8_env_64"*, %TName_Bool*)* @"$fundef_8" to { %TName_Bool* (i8*, %TName_Bool*)*, i8* } (i8*, %TName_Bool*)*), i8* null }, { { %TName_Bool* (i8*, %TName_Bool*)*, i8* } (i8*, %TName_Bool*)*, i8* }* @BoolUtils.andb, align 8, !dbg !23
...
entry:
  ...
  call void @llvm.dbg.declare(metadata %TName_Bool** %"$expr_12", metadata !25, metadata !DIExpression()), !dbg !26
...
"$have_gas_147":                                  ; preds = %"$out_of_gas_146", %entry
  ...
  call void @llvm.dbg.declare(metadata %Uint32* %i32_1, metadata !27, metadata !DIExpression()), !dbg !29
...
"$have_gas_152":                                  ; preds = %"$out_of_gas_151", %"$have_gas_147"
  ...
  store %Uint32 { i32 1 }, %Uint32* %i32_1, align 4, !dbg !26
...
"$have_gas_157":                                  ; preds = %"$out_of_gas_156", %"$have_gas_152"
  ...
  call void @llvm.dbg.declare(metadata %Uint64* %i64_1, metadata !30, metadata !DIExpression()), !dbg !32
...
"$have_gas_162":                                  ; preds = %"$out_of_gas_161", %"$have_gas_157"
  ...
  store %Uint64 { i64 1 }, %Uint64* %i64_1, align 8, !dbg !33
...
"$have_gas_167":                                  ; preds = %"$out_of_gas_166", %"$have_gas_162"
  ...
  call void @llvm.dbg.declare(metadata %Uint128* %i128_1, metadata !34, metadata !DIExpression()), !dbg !36
...
"$have_gas_172":                                  ; preds = %"$out_of_gas_171", %"$have_gas_167"
  ...
  store %Uint128 { i128 1 }, %Uint128* %i128_1, align 8, !dbg !37
...
"$have_gas_177":                                  ; preds = %"$out_of_gas_176", %"$have_gas_172"
  ...
  call void @llvm.dbg.declare(metadata %Uint256* %i256_1, metadata !38, metadata !DIExpression()), !dbg !40
...
"$have_gas_182":                                  ; preds = %"$out_of_gas_181", %"$have_gas_177"
  ...
  store %Uint256 { i256 1 }, %Uint256* %i256_1, align 8, !dbg !41
...
"$have_gas_187":                                  ; preds = %"$out_of_gas_186", %"$have_gas_182"
  ...
  call void @llvm.dbg.declare(metadata %Int256* %i256_4, metadata !42, metadata !DIExpression()), !dbg !44
...
"$have_gas_192":                                  ; preds = %"$out_of_gas_191", %"$have_gas_187"
  ...
  store %Int256 { i256 4 }, %Int256* %i256_4, align 8, !dbg !45
...
"$have_gas_197":                                  ; preds = %"$out_of_gas_196", %"$have_gas_192"
  ...
  call void @llvm.dbg.declare(metadata %Int256* %i256_m4, metadata !46, metadata !DIExpression()), !dbg !47
...
"$have_gas_202":                                  ; preds = %"$out_of_gas_201", %"$have_gas_197"
  ...
  store %Int256 { i256 -4 }, %Int256* %i256_m4, align 8, !dbg !48
...
"$have_gas_207":                                  ; preds = %"$out_of_gas_206", %"$have_gas_202"
  ...
  call void @llvm.dbg.declare(metadata i8** %a100, metadata !49, metadata !DIExpression()), !dbg !52
...
"$have_gas_212":                                  ; preds = %"$out_of_gas_211", %"$have_gas_207"
  ...
  store i8* %"$_new_bnum_call_216", i8** %a100, align 8, !dbg !53
...
"$have_gas_221":                                  ; preds = %"$out_of_gas_220", %"$have_gas_212"
  ...
  call void @llvm.dbg.declare(metadata i8** %a101, metadata !54, metadata !DIExpression()), !dbg !55
...
"$have_gas_226":                                  ; preds = %"$out_of_gas_225", %"$have_gas_221"
  ...
  %"$badd_call_233" = call i8* @_badd(i8* %"$execptr_load_228", i8* %"$a100_229", %_TyDescrTy_Typ* @"$TyDescr_Uint32_17", i8* %"$$badd_i32_1_230_232"), !dbg !56
  store i8* %"$badd_call_233", i8** %a101, align 8, !dbg !56
...
"$have_gas_238":                                  ; preds = %"$out_of_gas_237", %"$have_gas_226"
  ...
  call void @llvm.dbg.declare(metadata i8** %a102, metadata !57, metadata !DIExpression()), !dbg !58
...
"$have_gas_243":                                  ; preds = %"$out_of_gas_242", %"$have_gas_238"
  ...
  %"$badd_call_250" = call i8* @_badd(i8* %"$execptr_load_245", i8* %"$a101_246", %_TyDescrTy_Typ* @"$TyDescr_Uint64_21", i8* %"$$badd_i64_1_247_249"), !dbg !59
  store i8* %"$badd_call_250", i8** %a102, align 8, !dbg !59
...
"$have_gas_255":                                  ; preds = %"$out_of_gas_254", %"$have_gas_243"
  ...
  call void @llvm.dbg.declare(metadata i8** %a103, metadata !60, metadata !DIExpression()), !dbg !61
...
"$have_gas_260":                                  ; preds = %"$out_of_gas_259", %"$have_gas_255"
  ...
  %"$badd_call_267" = call i8* @_badd(i8* %"$execptr_load_262", i8* %"$a102_263", %_TyDescrTy_Typ* @"$TyDescr_Uint128_25", i8* %"$$badd_i128_1_264_266"), !dbg !62
  store i8* %"$badd_call_267", i8** %a103, align 8, !dbg !62
...
"$have_gas_272":                                  ; preds = %"$out_of_gas_271", %"$have_gas_260"
  ...
  call void @llvm.dbg.declare(metadata i8** %a104, metadata !63, metadata !DIExpression()), !dbg !64
...
"$have_gas_277":                                  ; preds = %"$out_of_gas_276", %"$have_gas_272"
  ...
  %"$badd_call_284" = call i8* @_badd(i8* %"$execptr_load_279", i8* %"$a103_280", %_TyDescrTy_Typ* @"$TyDescr_Uint256_29", i8* %"$$badd_i256_1_281_283"), !dbg !65
  store i8* %"$badd_call_284", i8** %a104, align 8, !dbg !65
...
"$have_gas_289":                                  ; preds = %"$out_of_gas_288", %"$have_gas_277"
  ...
  call void @llvm.dbg.declare(metadata %Int256* %sub1, metadata !66, metadata !DIExpression()), !dbg !67
...
"$have_gas_294":                                  ; preds = %"$out_of_gas_293", %"$have_gas_289"
  ...
  %"$bsub_call_299" = call %Int256* @_bsub(i8* %"$execptr_load_296", i8* %"$a104_297", i8* %"$a100_298"), !dbg !68
  %"$bsub_301" = load %Int256, %Int256* %"$bsub_call_299", align 8
  store %Int256 %"$bsub_301", %Int256* %sub1, align 8, !dbg !68
...
"$have_gas_305":                                  ; preds = %"$out_of_gas_304", %"$have_gas_294"
  ...
  call void @llvm.dbg.declare(metadata %TName_Bool** %res1, metadata !69, metadata !DIExpression()), !dbg !70
...
"$have_gas_311":                                  ; preds = %"$out_of_gas_310", %"$have_gas_305"
  ...
  %"$eq_call_318" = call %TName_Bool* @_eq_Int256(i8* %"$execptr_load_313", %Int256* %"$eq_i256_4_314", %Int256* %"$eq_sub1_316"), !dbg !71
  store %TName_Bool* %"$eq_call_318", %TName_Bool** %res1, align 8, !dbg !71
...
"$have_gas_323":                                  ; preds = %"$out_of_gas_322", %"$have_gas_311"
  ...
  call void @llvm.dbg.declare(metadata %Int256* %sub2, metadata !72, metadata !DIExpression()), !dbg !73
...
"$have_gas_328":                                  ; preds = %"$out_of_gas_327", %"$have_gas_323"
  ...
  %"$bsub_call_333" = call %Int256* @_bsub(i8* %"$execptr_load_330", i8* %"$a100_331", i8* %"$a104_332"), !dbg !74
  %"$bsub_335" = load %Int256, %Int256* %"$bsub_call_333", align 8
  store %Int256 %"$bsub_335", %Int256* %sub2, align 8, !dbg !74
...
"$have_gas_339":                                  ; preds = %"$out_of_gas_338", %"$have_gas_328"
  ...
  call void @llvm.dbg.declare(metadata %TName_Bool** %res2, metadata !75, metadata !DIExpression()), !dbg !76
...
"$have_gas_345":                                  ; preds = %"$out_of_gas_344", %"$have_gas_339"
  ...
  %"$eq_call_352" = call %TName_Bool* @_eq_Int256(i8* %"$execptr_load_347", %Int256* %"$eq_i256_m4_348", %Int256* %"$eq_sub2_350"), !dbg !77
  store %TName_Bool* %"$eq_call_352", %TName_Bool** %res2, align 8, !dbg !77
...
"$have_gas_357":                                  ; preds = %"$out_of_gas_356", %"$have_gas_345"
  ...
  %"$BoolUtils.andb_call_363" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_fptr_360"(i8* %"$BoolUtils.andb_envptr_361", %TName_Bool* %"$res1_362"), !dbg !78
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_call_363", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.andb_6", align 8, !dbg !78
  %"$BoolUtils.andb_7" = alloca %TName_Bool*, align 8
  call void @llvm.dbg.declare(metadata %TName_Bool** %"$BoolUtils.andb_7", metadata !79, metadata !DIExpression()), !dbg !78
  ...
  %"$$BoolUtils.andb_6_call_368" = call %TName_Bool* %"$$BoolUtils.andb_6_fptr_365"(i8* %"$$BoolUtils.andb_6_envptr_366", %TName_Bool* %"$res2_367"), !dbg !78
  store %TName_Bool* %"$$BoolUtils.andb_6_call_368", %TName_Bool** %"$BoolUtils.andb_7", align 8, !dbg !78
  %"$$BoolUtils.andb_7_369" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.andb_7", align 8
  store %TName_Bool* %"$$BoolUtils.andb_7_369", %TName_Bool** %"$expr_12", align 8, !dbg !78
...
!8 = !{}
!9 = !DILocalVariable(name: "$retval_11", scope: !3, file: !4, line: 8, type: !10)
...
!18 = distinct !DISubprogram(name: "$fundef_8", linkageName: "$fundef_8", scope: !4, file: !4, line: 7, type: !5, scopeLine: 7, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !1, retainedNodes: !8)
...
!25 = !DILocalVariable(name: "$expr_12", scope: !24, file: !2, line: 1, type: !10)
!26 = !DILocation(line: 1, column: 13, scope: !24)
!27 = !DILocalVariable(name: "i32_1", scope: !24, file: !2, line: 1, type: !28)
!28 = !DIBasicType(name: "Uint32", size: 4)
!29 = !DILocation(line: 1, column: 5, scope: !24)
!30 = !DILocalVariable(name: "i64_1", scope: !24, file: !2, line: 2, type: !31)
!31 = !DIBasicType(name: "Uint64", size: 8)
!32 = !DILocation(line: 2, column: 5, scope: !24)
!33 = !DILocation(line: 2, column: 13, scope: !24)
!34 = !DILocalVariable(name: "i128_1", scope: !24, file: !2, line: 3, type: !35)
!35 = !DIBasicType(name: "Uint128", size: 16)
!36 = !DILocation(line: 3, column: 5, scope: !24)
!37 = !DILocation(line: 3, column: 14, scope: !24)
!38 = !DILocalVariable(name: "i256_1", scope: !24, file: !2, line: 4, type: !39)
!39 = !DIBasicType(name: "Uint256", size: 32)
!40 = !DILocation(line: 4, column: 5, scope: !24)
!41 = !DILocation(line: 4, column: 14, scope: !24)
!42 = !DILocalVariable(name: "i256_4", scope: !24, file: !2, line: 6, type: !43)
!43 = !DIBasicType(name: "Int256", size: 32)
!44 = !DILocation(line: 6, column: 5, scope: !24)
!45 = !DILocation(line: 6, column: 14, scope: !24)
!46 = !DILocalVariable(name: "i256_m4", scope: !24, file: !2, line: 7, type: !43)
!47 = !DILocation(line: 7, column: 5, scope: !24)
!48 = !DILocation(line: 7, column: 15, scope: !24)
!49 = !DILocalVariable(name: "a100", scope: !24, file: !2, line: 9, type: !50)
!50 = !DIDerivedType(tag: DW_TAG_pointer_type, name: "BNum", baseType: !51, size: 8, align: 8, dwarfAddressSpace: 0)
!51 = !DIBasicType(name: "BNum", size: 8)
!52 = !DILocation(line: 9, column: 5, scope: !24)
!53 = !DILocation(line: 9, column: 12, scope: !24)
!54 = !DILocalVariable(name: "a101", scope: !24, file: !2, line: 10, type: !50)
!55 = !DILocation(line: 10, column: 5, scope: !24)
!56 = !DILocation(line: 10, column: 12, scope: !24)
!57 = !DILocalVariable(name: "a102", scope: !24, file: !2, line: 11, type: !50)
!58 = !DILocation(line: 11, column: 5, scope: !24)
!59 = !DILocation(line: 11, column: 12, scope: !24)
!60 = !DILocalVariable(name: "a103", scope: !24, file: !2, line: 12, type: !50)
!61 = !DILocation(line: 12, column: 5, scope: !24)
!62 = !DILocation(line: 12, column: 12, scope: !24)
!63 = !DILocalVariable(name: "a104", scope: !24, file: !2, line: 13, type: !50)
!64 = !DILocation(line: 13, column: 5, scope: !24)
!65 = !DILocation(line: 13, column: 12, scope: !24)
!66 = !DILocalVariable(name: "sub1", scope: !24, file: !2, line: 15, type: !43)
!67 = !DILocation(line: 15, column: 5, scope: !24)
!68 = !DILocation(line: 15, column: 12, scope: !24)
!69 = !DILocalVariable(name: "res1", scope: !24, file: !2, line: 16, type: !10)
!70 = !DILocation(line: 16, column: 5, scope: !24)
!71 = !DILocation(line: 16, column: 12, scope: !24)
!72 = !DILocalVariable(name: "sub2", scope: !24, file: !2, line: 19, type: !43)
!73 = !DILocation(line: 19, column: 5, scope: !24)
!74 = !DILocation(line: 19, column: 12, scope: !24)
!75 = !DILocalVariable(name: "res2", scope: !24, file: !2, line: 20, type: !10)
!76 = !DILocation(line: 20, column: 5, scope: !24)
!77 = !DILocation(line: 20, column: 12, scope: !24)
!78 = !DILocation(line: 22, column: 1, scope: !24)
!79 = !DILocalVariable(name: "$BoolUtils.andb_7", scope: !24, file: !2, line: 22, type: !10)
