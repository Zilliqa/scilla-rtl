...
define internal %TName_Bool* @"$fundef_10"(%"$$fundef_10_env_61"* %0, %TName_Bool* %1) !dbg !4 {
entry:
...
"$have_gas_91":                                   ; preds = %"$out_of_gas_90", %"$False_86"
  ...
  store %TName_Bool* %"$adtptr_95", %TName_Bool** %"$retval_11", align 8, !dbg !10
...
define internal { %TName_Bool* (i8*, %TName_Bool*)*, i8* } @"$fundef_8"(%"$$fundef_8_env_62"* %0, %TName_Bool* %1) !dbg !15 {
entry:
...
"$have_gas_66":                                   ; preds = %"$out_of_gas_65", %entry
  ...
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$$fundef_10_cloval_71", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$retval_9", align 8, !dbg !16
...
"$have_gas_117":                                  ; preds = %"$out_of_gas_116", %"$have_gas_112"
  ...
  store { { %TName_Bool* (i8*, %TName_Bool*)*, i8* } (i8*, %TName_Bool*)*, i8* } { { %TName_Bool* (i8*, %TName_Bool*)*, i8* } (i8*, %TName_Bool*)* bitcast ({ %TName_Bool* (i8*, %TName_Bool*)*, i8* } (%"$$fundef_8_env_62"*, %TName_Bool*)* @"$fundef_8" to { %TName_Bool* (i8*, %TName_Bool*)*, i8* } (i8*, %TName_Bool*)*), i8* null }, { { %TName_Bool* (i8*, %TName_Bool*)*, i8* } (i8*, %TName_Bool*)*, i8* }* @BoolUtils.andb, align 8, !dbg !20
...
"$have_gas_210":                                  ; preds = %"$out_of_gas_209", %"$have_gas_205"
  ...
  store i8* %"$_new_bnum_call_214", i8** %a100, align 8, !dbg !28
...
"$have_gas_224":                                  ; preds = %"$out_of_gas_223", %"$have_gas_219"
  ...
  %"$badd_call_231" = call i8* @_badd(i8* %"$execptr_load_226", i8* %"$a100_227", %_TyDescrTy_Typ* @"$TyDescr_Uint32_17", i8* %"$$badd_i32_1_228_230"), !dbg !29
  store i8* %"$badd_call_231", i8** %a101, align 8, !dbg !29
...
"$have_gas_241":                                  ; preds = %"$out_of_gas_240", %"$have_gas_236"
  ...
  %"$badd_call_248" = call i8* @_badd(i8* %"$execptr_load_243", i8* %"$a101_244", %_TyDescrTy_Typ* @"$TyDescr_Uint64_21", i8* %"$$badd_i64_1_245_247"), !dbg !30
  store i8* %"$badd_call_248", i8** %a102, align 8, !dbg !30
...
"$have_gas_258":                                  ; preds = %"$out_of_gas_257", %"$have_gas_253"
  ...
  %"$badd_call_265" = call i8* @_badd(i8* %"$execptr_load_260", i8* %"$a102_261", %_TyDescrTy_Typ* @"$TyDescr_Uint128_25", i8* %"$$badd_i128_1_262_264"), !dbg !31
  store i8* %"$badd_call_265", i8** %a103, align 8, !dbg !31
...
"$have_gas_275":                                  ; preds = %"$out_of_gas_274", %"$have_gas_270"
  ...
  %"$badd_call_282" = call i8* @_badd(i8* %"$execptr_load_277", i8* %"$a103_278", %_TyDescrTy_Typ* @"$TyDescr_Uint256_29", i8* %"$$badd_i256_1_279_281"), !dbg !32
  store i8* %"$badd_call_282", i8** %a104, align 8, !dbg !32
...
"$have_gas_292":                                  ; preds = %"$out_of_gas_291", %"$have_gas_287"
  ...
  %"$bsub_call_297" = call %Int256* @_bsub(i8* %"$execptr_load_294", i8* %"$a104_295", i8* %"$a100_296"), !dbg !33
  %"$bsub_299" = load %Int256, %Int256* %"$bsub_call_297", align 8
  store %Int256 %"$bsub_299", %Int256* %sub1, align 8, !dbg !33
...
"$have_gas_309":                                  ; preds = %"$out_of_gas_308", %"$have_gas_303"
  ...
  %"$eq_call_316" = call %TName_Bool* @_eq_Int256(i8* %"$execptr_load_311", %Int256* %"$eq_i256_4_312", %Int256* %"$eq_sub1_314"), !dbg !34
  store %TName_Bool* %"$eq_call_316", %TName_Bool** %res1, align 8, !dbg !34
...
"$have_gas_326":                                  ; preds = %"$out_of_gas_325", %"$have_gas_321"
  ...
  %"$bsub_call_331" = call %Int256* @_bsub(i8* %"$execptr_load_328", i8* %"$a100_329", i8* %"$a104_330"), !dbg !35
  %"$bsub_333" = load %Int256, %Int256* %"$bsub_call_331", align 8
  store %Int256 %"$bsub_333", %Int256* %sub2, align 8, !dbg !35
...
"$have_gas_343":                                  ; preds = %"$out_of_gas_342", %"$have_gas_337"
  ...
  %"$eq_call_350" = call %TName_Bool* @_eq_Int256(i8* %"$execptr_load_345", %Int256* %"$eq_i256_m4_346", %Int256* %"$eq_sub2_348"), !dbg !36
  store %TName_Bool* %"$eq_call_350", %TName_Bool** %res2, align 8, !dbg !36
...
"$have_gas_355":                                  ; preds = %"$out_of_gas_354", %"$have_gas_343"
  ...
  %"$BoolUtils.andb_call_361" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_fptr_358"(i8* %"$BoolUtils.andb_envptr_359", %TName_Bool* %"$res1_360"), !dbg !37
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_call_361", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.andb_6", align 8, !dbg !37
  ...
  %"$$BoolUtils.andb_6_call_366" = call %TName_Bool* %"$$BoolUtils.andb_6_fptr_363"(i8* %"$$BoolUtils.andb_6_envptr_364", %TName_Bool* %"$res2_365"), !dbg !37
  store %TName_Bool* %"$$BoolUtils.andb_6_call_366", %TName_Bool** %"$BoolUtils.andb_7", align 8, !dbg !37
  %"$$BoolUtils.andb_7_367" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.andb_7", align 8
  store %TName_Bool* %"$$BoolUtils.andb_7_367", %TName_Bool** %"$expr_12", align 8, !dbg !37
