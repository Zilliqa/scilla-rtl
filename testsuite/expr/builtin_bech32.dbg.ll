...
@"$stringlit_97" = unnamed_addr constant [42 x i8] c"zil102n74869xnvdwq3yh8p0k9jjgtejruft268tg8"
...
"$have_gas_95":                                   ; preds = %"$out_of_gas_94", %"$have_gas_90"
  ...
  store %String { i8* getelementptr inbounds ([42 x i8], [42 x i8]* @"$stringlit_97", i32 0, i32 0), i32 42 }, %String* %bech32str, align 8, !dbg !11
...
"$have_gas_106":                                  ; preds = %"$out_of_gas_105", %"$have_gas_101"
  ...
  store %String { i8* getelementptr inbounds ([3 x i8], [3 x i8]* @"$stringlit_108", i32 0, i32 0), i32 3 }, %String* %prefix, align 8, !dbg !12
...
"$have_gas_122":                                  ; preds = %"$out_of_gas_121", %"$have_gas_106"
  ...
  %"$bech32_to_bystr20_call_127" = call %TName_Option_ByStr20* @_bech32_to_bystr20(i8* %"$execptr_load_124", %String %"$prefix_125", %String %"$bech32str_126"), !dbg !13
  store %TName_Option_ByStr20* %"$bech32_to_bystr20_call_127", %TName_Option_ByStr20** %"$expr_6", align 8, !dbg !13
