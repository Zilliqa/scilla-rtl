...
"$have_gas_113":                                  ; preds = %"$out_of_gas_112", %"$have_gas_108"
  ...
  store %TName_List_Int32* %"$adtptr_117", %TName_List_Int32** %nil_int32, align 8
...
"$have_gas_136":                                  ; preds = %"$out_of_gas_135", %"$have_gas_131"
  ...
  store %TName_List_Int32* %"$adtptr_144", %TName_List_Int32** %cons_int32, align 8
...
"$have_gas_153":                                  ; preds = %"$out_of_gas_152", %"$have_gas_148"
  ...
  store %TName_List_Uint32* %"$adtptr_157", %TName_List_Uint32** %nil_uint32, align 8
...
"$have_gas_176":                                  ; preds = %"$out_of_gas_175", %"$have_gas_171"
  ...
  store %TName_List_Uint32* %"$adtptr_184", %TName_List_Uint32** %cons_uint32, align 8
...
"$have_gas_188":                                  ; preds = %"$out_of_gas_187", %"$have_gas_176"
  ...
  store %"TName_Pair_List_(Int32)_List_(Uint32)"* %"$adtptr_196", %"TName_Pair_List_(Int32)_List_(Uint32)"** %"$expr_6", align 8
