...
define internal %Int32 @"$fundef_9"(%"$$fundef_9_env_69"* %0, %"TName_Option_Option_(Int32)"* %1) !dbg !4 {
entry:
...
"$have_gas_88":                                   ; preds = %"$out_of_gas_87", %"$None_83"
  ...
  store %Int32 %"$x_90", %Int32* %"$retval_10", align 4, !dbg !9
...
"$have_gas_105":                                  ; preds = %"$out_of_gas_104", %"$None_100"
  ...
  store %Int32 %"$y_107", %Int32* %"$retval_10", align 4, !dbg !14
...
"$have_gas_115":                                  ; preds = %"$out_of_gas_114", %"$Some_108"
  ...
  store %Int32 %"$z_117", %Int32* %"$retval_10", align 4, !dbg !17
  br label %"$matchsucc_95"
...
define internal %Int32 @_scilla_expr_fun(i8* %0) !dbg !22 {
entry:
...
"$have_gas_177":                                  ; preds = %"$out_of_gas_176", %"$have_gas_172"
  ...
  store { %Int32 (i8*, %"TName_Option_Option_(Int32)"*)*, i8* } %"$$fundef_9_cloval_182", { %Int32 (i8*, %"TName_Option_Option_(Int32)"*)*, i8* }* %f, align 8, !dbg !25
...
"$have_gas_195":                                  ; preds = %"$out_of_gas_194", %"$have_gas_190"
  ...
  store %TName_Option_Int32* %"$adtptr_201", %TName_Option_Int32** %o1, align 8, !dbg !26
...
"$have_gas_210":                                  ; preds = %"$out_of_gas_209", %"$have_gas_205"
  ...
  store %"TName_Option_Option_(Int32)"* %"$adtptr_216", %"TName_Option_Option_(Int32)"** %o2, align 8, !dbg !27
...
"$have_gas_220":                                  ; preds = %"$out_of_gas_219", %"$have_gas_210"
  ...
  %"$f_call_226" = call %Int32 %"$f_fptr_223"(i8* %"$f_envptr_224", %"TName_Option_Option_(Int32)"* %"$o2_225"), !dbg !28
  store %Int32 %"$f_call_226", %Int32* %"$f_7", align 4, !dbg !28
  %"$$f_7_227" = load %Int32, %Int32* %"$f_7", align 4
  store %Int32 %"$$f_7_227", %Int32* %"$expr_8", align 4, !dbg !28
...
!27 = !DILocation(line: 11, column: 10, scope: !22)
