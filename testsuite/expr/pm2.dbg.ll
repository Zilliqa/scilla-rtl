...
%"$ParamDescr_197" = type { %ParamDescrString, %_TyDescrTy_Typ* }
%ParamDescrString = type { i8*, i32 }
%"$TransDescr_198" = type { %ParamDescrString, i32, %"$ParamDescr_197"* }
%Int32 = type { i32 }
...
"$have_gas_82":                                   ; preds = %"$out_of_gas_81", %"$None_77"
  ...
  store %Int32 %"$x_84", %Int32* %"$retval_4", align 4, !dbg !9
...
"$have_gas_99":                                   ; preds = %"$out_of_gas_98", %"$None_94"
  ...
  store %Int32 %"$y_101", %Int32* %"$retval_4", align 4, !dbg !14
...
"$have_gas_109":                                  ; preds = %"$out_of_gas_108", %"$Some_102"
  ...
  store %Int32 %"$z_111", %Int32* %"$retval_4", align 4, !dbg !17
  br label %"$matchsucc_89"
...
"$have_gas_141":                                  ; preds = %"$out_of_gas_140", %"$have_gas_136"
  ...
  store { %Int32 (i8*, %"TName_Option_Option_(Int32)"*)*, i8* } %"$$fundef_3_cloval_146", { %Int32 (i8*, %"TName_Option_Option_(Int32)"*)*, i8* }* %f, align 8, !dbg !24
...
"$have_gas_159":                                  ; preds = %"$out_of_gas_158", %"$have_gas_154"
  ...
  store %TName_Option_Int32* %"$adtptr_165", %TName_Option_Int32** %o1, align 8, !dbg !25
...
"$have_gas_174":                                  ; preds = %"$out_of_gas_173", %"$have_gas_169"
  ...
  store %"TName_Option_Option_(Int32)"* %"$adtptr_180", %"TName_Option_Option_(Int32)"** %o2, align 8, !dbg !26
...
"$have_gas_184":                                  ; preds = %"$out_of_gas_183", %"$have_gas_174"
  ...
  %"$f_call_190" = call %Int32 %"$f_fptr_187"(i8* %"$f_envptr_188", %"TName_Option_Option_(Int32)"* %"$o2_189"), !dbg !27
  store %Int32 %"$f_call_190", %Int32* %"$f_1", align 4, !dbg !27
  %"$$f_1_191" = load %Int32, %Int32* %"$f_1", align 4
  store %Int32 %"$$f_1_191", %Int32* %"$expr_2", align 4, !dbg !27
...
entry:
  ...
  call void @_print_scilla_val(i8* %"$execptr_load_196", %_TyDescrTy_Typ* @"$TyDescr_Int32_7", i8* %"$memvoidcast_195")
  ret void
}
