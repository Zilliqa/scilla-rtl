...
"$have_gas_977":                                  ; preds = %"$out_of_gas_976", %entry
  ...
  store { i8*, i8* }* %"$dyndisp_table_988", { i8*, i8* }** @nat_fold, align 8, !dbg !104
...
"$have_gas_998":                                  ; preds = %"$out_of_gas_997", %"$have_gas_977"
  ...
  store { %Uint32 (i8*, %TName_Nat*)*, i8* } %"$$fundef_45_cloval_1003", { %Uint32 (i8*, %TName_Nat*)*, i8* }* @NatUtils.nat_to_int, align 8, !dbg !105
...
"$have_gas_1174":                                 ; preds = %"$out_of_gas_1173", %"$have_gas_1166"
  ...
  store %TName_Nat* %"$to_nat_call_1178", %TName_Nat** %n, align 8, !dbg !119
...
"$have_gas_1187":                                 ; preds = %"$out_of_gas_1186", %"$have_gas_1182"
  ...
  %"$ackermann_call_1193" = call { %TName_Nat* (i8*, %TName_Nat*)*, i8* } %"$ackermann_fptr_1190"(i8* %"$ackermann_envptr_1191", %TName_Nat* %"$m_1192"), !dbg !120
  store { %TName_Nat* (i8*, %TName_Nat*)*, i8* } %"$ackermann_call_1193", { %TName_Nat* (i8*, %TName_Nat*)*, i8* }* %"$ackermann_18", align 8, !dbg !120
  ...
  %"$$ackermann_18_call_1198" = call %TName_Nat* %"$$ackermann_18_fptr_1195"(i8* %"$$ackermann_18_envptr_1196", %TName_Nat* %"$n_1197"), !dbg !120
  store %TName_Nat* %"$$ackermann_18_call_1198", %TName_Nat** %"$ackermann_19", align 8, !dbg !120
  %"$$ackermann_19_1199" = load %TName_Nat*, %TName_Nat** %"$ackermann_19", align 8
  store %TName_Nat* %"$$ackermann_19_1199", %TName_Nat** %ack00, align 8, !dbg !120
...
"$have_gas_1208":                                 ; preds = %"$out_of_gas_1207", %"$have_gas_1203"
  ...
  %"$NatUtils.nat_to_int_call_1214" = call %Uint32 %"$NatUtils.nat_to_int_fptr_1211"(i8* %"$NatUtils.nat_to_int_envptr_1212", %TName_Nat* %"$ack00_1213"), !dbg !121
  store %Uint32 %"$NatUtils.nat_to_int_call_1214", %Uint32* %"$NatUtils.nat_to_int_20", align 4, !dbg !121
  %"$$NatUtils.nat_to_int_20_1215" = load %Uint32, %Uint32* %"$NatUtils.nat_to_int_20", align 4
  store %Uint32 %"$$NatUtils.nat_to_int_20_1215", %Uint32* %int01, align 4, !dbg !121
...
"$have_gas_1219":                                 ; preds = %"$out_of_gas_1218", %"$have_gas_1208"
  ...
  store %Uint32 %"$int01_1221", %Uint32* %"$expr_51", align 4, !dbg !122
