...
@"$stringlit_60" = unnamed_addr constant [42 x i8] c"zil102n74869xnvdwq3yh8p0k9jjgtejruft268tg9"
...
define internal %TName_Option_ByStr20* @"$scilla_expr_49"(i8* %0) {
entry:
  %"$expr_0" = alloca %TName_Option_ByStr20*
...
"$have_gas_58":                                   ; preds = %"$out_of_gas_57", %"$have_gas_53"
  ...
  store %String { i8* getelementptr inbounds ([42 x i8], [42 x i8]* @"$stringlit_60", i32 0, i32 0), i32 42 }, %String* %bech32str
...
"$have_gas_69":                                   ; preds = %"$out_of_gas_68", %"$have_gas_64"
  ...
  store %String { i8* getelementptr inbounds ([3 x i8], [3 x i8]* @"$stringlit_71", i32 0, i32 0), i32 3 }, %String* %prefix
  %"$execptr_load_72" = load i8*, i8** @_execptr
  %"$prefix_73" = load %String, %String* %prefix
  %"$bech32str_74" = load %String, %String* %bech32str
  %"$bech32_to_bystr20_call_75" = call %TName_Option_ByStr20* @_bech32_to_bystr20(i8* %"$execptr_load_72", %String %"$prefix_73", %String %"$bech32str_74")
  store %TName_Option_ByStr20* %"$bech32_to_bystr20_call_75", %TName_Option_ByStr20** %"$expr_0"
  %"$$expr_0_76" = load %TName_Option_ByStr20*, %TName_Option_ByStr20** %"$expr_0"
  ret %TName_Option_ByStr20* %"$$expr_0_76"
}
...
entry:
  %"$exprval_77" = call %TName_Option_ByStr20* @"$scilla_expr_49"(i8* null)
  %"$memvoidcast_78" = bitcast %TName_Option_ByStr20* %"$exprval_77" to i8*
  call void @_print_scilla_val(%_TyDescrTy_Typ* @"$TyDescr_ADT_Option_ByStr20_35", i8* %"$memvoidcast_78")
  ret void
}
