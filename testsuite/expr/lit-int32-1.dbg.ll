...
%"$ParamDescr_46" = type { %ParamDescrString, %_TyDescrTy_Typ* }
%ParamDescrString = type { i8*, i32 }
%"$TransDescr_47" = type { %ParamDescrString, i32, %"$ParamDescr_46"* }
%Int32 = type { i32 }
...
@_contract_parameters = constant [0 x %"$ParamDescr_46"] zeroinitializer
@_contract_parameters_length = constant i32 0
@_transition_parameters = constant [0 x %"$TransDescr_47"] zeroinitializer
...
"$have_gas_39":                                   ; preds = %"$out_of_gas_38", %entry
  ...
  store %Int32 { i32 -1 }, %Int32* %"$expr_0", align 4, !dbg !10
...
entry:
  ...
  %"$execptr_load_45" = load i8*, i8** @_execptr, align 8
  call void @_print_scilla_val(i8* %"$execptr_load_45", %_TyDescrTy_Typ* @"$TyDescr_Int32_3", i8* %"$memvoidcast_44")
  ret void
}
