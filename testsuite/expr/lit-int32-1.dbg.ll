...
"$have_gas_77":                                   ; preds = %"$out_of_gas_76", %entry
  ...
  store %Int32 { i32 -1 }, %Int32* %"$expr_6", align 4, !dbg !13
  %"$$expr_6_79" = load %Int32, %Int32* %"$expr_6", align 4
  ret %Int32 %"$$expr_6_79"
}
...
entry:
  %"$exprval_80" = call %Int32 @_scilla_expr_fun(i8* null)
  %"$pval_81" = alloca %Int32, align 8
  %"$memvoidcast_82" = bitcast %Int32* %"$pval_81" to i8*
  store %Int32 %"$exprval_80", %Int32* %"$pval_81", align 4
  %"$execptr_load_83" = load i8*, i8** @_execptr, align 8
  call void @_print_scilla_val(i8* %"$execptr_load_83", %_TyDescrTy_Typ* @"$TyDescr_Int32_9", i8* %"$memvoidcast_82")
  ret void
}
