...
"$have_gas_75":                                   ; preds = %"$out_of_gas_74", %entry
  ...
  store %Int32 { i32 -1 }, %Int32* %"$expr_6", align 4, !dbg !11
  %"$$expr_6_77" = load %Int32, %Int32* %"$expr_6", align 4
  ret %Int32 %"$$expr_6_77"
}
...
entry:
  %"$exprval_78" = call %Int32 @_scilla_expr_fun(i8* null)
  %"$pval_79" = alloca %Int32, align 8
  %"$memvoidcast_80" = bitcast %Int32* %"$pval_79" to i8*
  store %Int32 %"$exprval_78", %Int32* %"$pval_79", align 4
  %"$execptr_load_81" = load i8*, i8** @_execptr, align 8
  call void @_print_scilla_val(i8* %"$execptr_load_81", %_TyDescrTy_Typ* @"$TyDescr_Int32_9", i8* %"$memvoidcast_80")
  ret void
}
...
!2 = !DIFile(filename: "lit-int32-1.scilexp", directory: "codegen/expr")
!3 = !{}
