...
"$have_gas_60":                                   ; preds = %"$out_of_gas_59", %"$have_gas_54"
  ...
  %"$add_call_67" = call %Uint256* @_add_Uint256(i8* %"$execptr_load_62", %Uint256* %"$add_one_63", %Uint256* %"$add_two_65"), !dbg !12
  %"$add_69" = load %Uint256, %Uint256* %"$add_call_67", align 8
  store %Uint256 %"$add_69", %Uint256* %"$expr_0", align 8, !dbg !12
