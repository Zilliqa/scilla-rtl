...
entry:
  ...
  call void @llvm.dbg.declare(metadata %Uint256* %"$expr_6", metadata !11, metadata !DIExpression()), !dbg !13
...
"$have_gas_77":                                   ; preds = %"$out_of_gas_76", %entry
  ...
  call void @llvm.dbg.declare(metadata %Uint256* %one, metadata !14, metadata !DIExpression()), !dbg !15
...
"$have_gas_82":                                   ; preds = %"$out_of_gas_81", %"$have_gas_77"
  ...
  store %Uint256 { i256 10000000 }, %Uint256* %one, align 8, !dbg !13
...
"$have_gas_87":                                   ; preds = %"$out_of_gas_86", %"$have_gas_82"
  ...
  call void @llvm.dbg.declare(metadata %Uint256* %two, metadata !16, metadata !DIExpression()), !dbg !17
...
"$have_gas_92":                                   ; preds = %"$out_of_gas_91", %"$have_gas_87"
  ...
  store %Uint256 { i256 111 }, %Uint256* %two, align 8, !dbg !18
  %"$gasrem_95" = load i64, i64* @_gasrem, align 8
  %"$gascmp_96" = icmp ugt i64 16, %"$gasrem_95"
...
"$have_gas_98":                                   ; preds = %"$out_of_gas_97", %"$have_gas_92"
  %"$consume_99" = sub i64 %"$gasrem_95", 16
  store i64 %"$consume_99", i64* @_gasrem, align 8
  %"$execptr_load_100" = load i8*, i8** @_execptr, align 8
  %"$add_one_101" = alloca %Uint256, align 8
  %"$one_102" = load %Uint256, %Uint256* %one, align 8
  store %Uint256 %"$one_102", %Uint256* %"$add_one_101", align 8
  %"$add_two_103" = alloca %Uint256, align 8
  %"$two_104" = load %Uint256, %Uint256* %two, align 8
  store %Uint256 %"$two_104", %Uint256* %"$add_two_103", align 8
  %"$add_call_105" = call %Uint256* @_add_Uint256(i8* %"$execptr_load_100", %Uint256* %"$add_one_101", %Uint256* %"$add_two_103"), !dbg !19
  %"$add_107" = load %Uint256, %Uint256* %"$add_call_105", align 8
  store %Uint256 %"$add_107", %Uint256* %"$expr_6", align 8, !dbg !19
  %"$$expr_6_108" = load %Uint256, %Uint256* %"$expr_6", align 8
  store %Uint256 %"$$expr_6_108", %Uint256* %1, align 8
  ret void
}
...
entry:
  %"$mainval_109" = alloca %Uint256, align 8
  %"$memvoidcast_110" = bitcast %Uint256* %"$mainval_109" to i8*
  call void @_scilla_expr_fun(i8* null, %Uint256* %"$mainval_109")
  %"$execptr_load_111" = load i8*, i8** @_execptr, align 8
  call void @_print_scilla_val(i8* %"$execptr_load_111", %_TyDescrTy_Typ* @"$TyDescr_Uint256_23", i8* %"$memvoidcast_110")
  ret void
}
...
!12 = !DIBasicType(name: "Uint256", size: 32)
!13 = !DILocation(line: 1, column: 11, scope: !10)
!14 = !DILocalVariable(name: "one", scope: !10, file: !2, line: 1, type: !12)
!15 = !DILocation(line: 1, column: 5, scope: !10)
!16 = !DILocalVariable(name: "two", scope: !10, file: !2, line: 2, type: !12)
!17 = !DILocation(line: 2, column: 5, scope: !10)
!18 = !DILocation(line: 2, column: 11, scope: !10)
!19 = !DILocation(line: 3, column: 1, scope: !10)
