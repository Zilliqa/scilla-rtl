...
define internal void @_scilla_expr_fun(i8* %0, %Uint256* %1) !dbg !10 {
entry:
...
"$have_gas_80":                                   ; preds = %"$out_of_gas_79", %"$have_gas_75"
  ...
  store %Uint256 { i256 10000000 }, %Uint256* %one, align 8, !dbg !11
...
"$have_gas_90":                                   ; preds = %"$out_of_gas_89", %"$have_gas_85"
  ...
  store %Uint256 { i256 111 }, %Uint256* %two, align 8, !dbg !12
  %"$gasrem_93" = load i64, i64* @_gasrem, align 8
  %"$gascmp_94" = icmp ugt i64 16, %"$gasrem_93"
...
"$have_gas_96":                                   ; preds = %"$out_of_gas_95", %"$have_gas_90"
  %"$consume_97" = sub i64 %"$gasrem_93", 16
  store i64 %"$consume_97", i64* @_gasrem, align 8
  %"$execptr_load_98" = load i8*, i8** @_execptr, align 8
  %"$add_one_99" = alloca %Uint256, align 8
  %"$one_100" = load %Uint256, %Uint256* %one, align 8
  store %Uint256 %"$one_100", %Uint256* %"$add_one_99", align 8
  %"$add_two_101" = alloca %Uint256, align 8
  %"$two_102" = load %Uint256, %Uint256* %two, align 8
  store %Uint256 %"$two_102", %Uint256* %"$add_two_101", align 8
  %"$add_call_103" = call %Uint256* @_add_Uint256(i8* %"$execptr_load_98", %Uint256* %"$add_one_99", %Uint256* %"$add_two_101"), !dbg !13
  %"$add_105" = load %Uint256, %Uint256* %"$add_call_103", align 8
  store %Uint256 %"$add_105", %Uint256* %"$expr_6", align 8, !dbg !13
  %"$$expr_6_106" = load %Uint256, %Uint256* %"$expr_6", align 8
  store %Uint256 %"$$expr_6_106", %Uint256* %1, align 8
  ret void
}
...
entry:
  %"$mainval_107" = alloca %Uint256, align 8
  %"$memvoidcast_108" = bitcast %Uint256* %"$mainval_107" to i8*
  call void @_scilla_expr_fun(i8* null, %Uint256* %"$mainval_107")
  %"$execptr_load_109" = load i8*, i8** @_execptr, align 8
  call void @_print_scilla_val(i8* %"$execptr_load_109", %_TyDescrTy_Typ* @"$TyDescr_Uint256_23", i8* %"$memvoidcast_108")
  ret void
}
...
!11 = !DILocation(line: 1, column: 11, scope: !10)
