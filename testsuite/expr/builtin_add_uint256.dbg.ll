...
"$have_gas_98":                                   ; preds = %"$out_of_gas_97", %"$have_gas_92"
  ...
  %"$add_call_105" = call %Uint256* @_add_Uint256(i8* %"$execptr_load_100", %Uint256* %"$add_one_101", %Uint256* %"$add_two_103"), !dbg !13
  %"$add_107" = load %Uint256, %Uint256* %"$add_call_105", align 8
  store %Uint256 %"$add_107", %Uint256* %"$expr_6", align 8, !dbg !13
