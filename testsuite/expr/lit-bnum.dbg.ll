...
%"$ParamDescr_49" = type { %ParamDescrString, %_TyDescrTy_Typ* }
%ParamDescrString = type { i8*, i32 }
%"$TransDescr_50" = type { %ParamDescrString, i32, %"$ParamDescr_49"* }
...
@"$BNumLit_41" = unnamed_addr constant [3 x i8] c"100"
...
@_contract_parameters = constant [0 x %"$ParamDescr_49"] zeroinitializer
@_contract_parameters_length = constant i32 0
@_transition_parameters = constant [0 x %"$TransDescr_50"] zeroinitializer
...
define internal i8* @_scilla_expr_fun(i8* %0) !dbg !9 {
entry:
...
"$have_gas_39":                                   ; preds = %"$out_of_gas_38", %entry
  ...
  %"$_new_bnum_call_43" = call i8* @_new_bnum(i8* %"$execptr_load_42", %BNumString { i8* getelementptr inbounds ([3 x i8], [3 x i8]* @"$BNumLit_41", i32 0, i32 0), i32 3 })
  store i8* %"$_new_bnum_call_43", i8** %"$expr_0", align 8, !dbg !10
  %"$$expr_0_45" = load i8*, i8** %"$expr_0", align 8
  ret i8* %"$$expr_0_45"
}
...
entry:
  %"$exprval_46" = call i8* @_scilla_expr_fun(i8* null)
  %"$execptr_load_48" = load i8*, i8** @_execptr, align 8
  call void @_print_scilla_val(i8* %"$execptr_load_48", %_TyDescrTy_Typ* @"$TyDescr_Bnum_21", i8* %"$exprval_46")
  ret void
}
