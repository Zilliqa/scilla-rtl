...
%Int32 = type { i32 }
%"$ParamDescr_85" = type { %ParamDescrString, %_TyDescrTy_Typ* }
%ParamDescrString = type { i8*, i32 }
%"$TransDescr_86" = type { %ParamDescrString, i32, %"$ParamDescr_85"* }
...
@_contract_parameters = constant [0 x %"$ParamDescr_85"] zeroinitializer
@_contract_parameters_length = constant i32 0
@_transition_parameters = constant [0 x %"$TransDescr_86"] zeroinitializer
...
define internal i8* @_scilla_expr_fun(i8* %0) !dbg !10 {
entry:
  %"$expr_6" = alloca i8*, align 8
...
"$have_gas_75":                                   ; preds = %"$out_of_gas_74", %entry
  ...
  store i8* %"$_new_bnum_call_79", i8** %"$expr_6", align 8, !dbg !11
  %"$$expr_6_81" = load i8*, i8** %"$expr_6", align 8
  ret i8* %"$$expr_6_81"
}
...
entry:
  %"$exprval_82" = call i8* @_scilla_expr_fun(i8* null)
  %"$execptr_load_84" = load i8*, i8** @_execptr, align 8
  call void @_print_scilla_val(i8* %"$execptr_load_84", %_TyDescrTy_Typ* @"$TyDescr_Bnum_27", i8* %"$exprval_82")
  ret void
}
...
!2 = !DIFile(filename: "lit-bnum.scilexp", directory: "codegen/expr")
!3 = !{}
