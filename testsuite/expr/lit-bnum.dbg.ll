...
@_contract_parameters = constant [0 x %"$ParamDescr_87"] zeroinitializer
@_contract_parameters_length = constant i32 0
@_transition_parameters = constant [0 x %"$TransDescr_88"] zeroinitializer
...
entry:
  ...
  call void @llvm.dbg.declare(metadata i8** %"$expr_6", metadata !11, metadata !DIExpression()), !dbg !14
...
"$have_gas_77":                                   ; preds = %"$out_of_gas_76", %entry
  ...
  store i8* %"$_new_bnum_call_81", i8** %"$expr_6", align 8, !dbg !14
  %"$$expr_6_83" = load i8*, i8** %"$expr_6", align 8
  ret i8* %"$$expr_6_83"
}
...
entry:
  %"$exprval_84" = call i8* @_scilla_expr_fun(i8* null)
  %"$execptr_load_86" = load i8*, i8** @_execptr, align 8
  call void @_print_scilla_val(i8* %"$execptr_load_86", %_TyDescrTy_Typ* @"$TyDescr_Bnum_27", i8* %"$exprval_84")
  ret void
}
...
!12 = !DIDerivedType(tag: DW_TAG_pointer_type, name: "BNum", baseType: !13, size: 8, align: 8, dwarfAddressSpace: 0)
!13 = !DIBasicType(name: "BNum", size: 8)
!14 = !DILocation(line: 1, column: 1, scope: !10)
