...
@"$TyDescr_Bool_ADTTyp_27" = unnamed_addr constant %"$TyDescrTy_ADTTyp_23" { %TyDescrString { i8* getelementptr inbounds ([4 x i8], [4 x i8]* @"$TyDescr_ADT_Bool_38", i32 0, i32 0), i32 4 }, i32 0, i32 2, i32 1, %"$TyDescrTy_ADTTyp_Specl_22"** getelementptr inbounds ([1 x %"$TyDescrTy_ADTTyp_Specl_22"*], [1 x %"$TyDescrTy_ADTTyp_Specl_22"*]* @"$TyDescr_Bool_ADTTyp_m_specls_37", i32 0, i32 0) }
...
entry:
  ...
  %"$adtval_40" = bitcast i8* %"$adtval_40_salloc" to %False*
