...
"$have_gas_68":                                   ; preds = %"$out_of_gas_67", %"$have_gas_62"
  ...
  %"$sha256hash_s_71" = alloca %String, align 8
  %"$s_72" = load %String, %String* %s, align 8
  store %String %"$s_72", %String* %"$sha256hash_s_71", align 8
  ...
  %"$sha256hash_75" = load [32 x i8], [32 x i8]* %"$sha256hash_call_74", align 1
  store [32 x i8] %"$sha256hash_75", [32 x i8]* %h1, align 1, !dbg !10
...
"$have_gas_79":                                   ; preds = %"$out_of_gas_78", %"$have_gas_68"
  ...
  %"$sha256hash_h1_82" = alloca [32 x i8], align 1
  %"$h1_83" = load [32 x i8], [32 x i8]* %h1, align 1
  store [32 x i8] %"$h1_83", [32 x i8]* %"$sha256hash_h1_82", align 1
  ...
  %"$sha256hash_86" = load [32 x i8], [32 x i8]* %"$sha256hash_call_85", align 1
  store [32 x i8] %"$sha256hash_86", [32 x i8]* %h2, align 1, !dbg !11
...
"$have_gas_107":                                  ; preds = %"$out_of_gas_106", %"$have_gas_95"
  ...
  %"$sha256hash_113" = load [32 x i8], [32 x i8]* %"$sha256hash_call_112", align 1
  store [32 x i8] %"$sha256hash_113", [32 x i8]* %sh2, align 1, !dbg !13
...
"$have_gas_142":                                  ; preds = %"$out_of_gas_141", %"$have_gas_137"
  ...
  %"$sha256hash_155" = load [32 x i8], [32 x i8]* %"$sha256hash_call_154", align 1
  store [32 x i8] %"$sha256hash_155", [32 x i8]* %"$expr_0", align 1, !dbg !17
