...
"$have_gas_69":                                   ; preds = %"$out_of_gas_68", %"$have_gas_63"
  ...
  store [32 x i8] %"$sha256hash_76", [32 x i8]* %h1, align 1
...
"$have_gas_80":                                   ; preds = %"$out_of_gas_79", %"$have_gas_69"
  ...
  store [32 x i8] %"$sha256hash_87", [32 x i8]* %h2, align 1
...
"$have_gas_108":                                  ; preds = %"$out_of_gas_107", %"$have_gas_96"
  ...
  store [32 x i8] %"$sha256hash_114", [32 x i8]* %sh2, align 1
...
"$have_gas_143":                                  ; preds = %"$out_of_gas_142", %"$have_gas_138"
  ...
  store [32 x i8] %"$sha256hash_156", [32 x i8]* %"$expr_0", align 1
