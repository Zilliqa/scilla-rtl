...
"$have_gas_67":                                   ; preds = %"$out_of_gas_66", %"$have_gas_61"
  ...
  %"$sha256hash_s_70" = alloca %String, align 8
  %"$s_71" = load %String, %String* %s, align 8
  store %String %"$s_71", %String* %"$sha256hash_s_70", align 8
...
"$have_gas_78":                                   ; preds = %"$out_of_gas_77", %"$have_gas_67"
  ...
  %"$sha256hash_h1_81" = alloca [32 x i8], align 1
  %"$h1_82" = load [32 x i8], [32 x i8]* %h1, align 1
  store [32 x i8] %"$h1_82", [32 x i8]* %"$sha256hash_h1_81", align 1
