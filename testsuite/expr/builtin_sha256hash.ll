...
"$have_gas_69":                                   ; preds = %"$out_of_gas_68", %"$have_gas_63"
  ...
  store [32 x i8] %"$sha256hash_77", [32 x i8]* %h1, align 1
...
"$have_gas_81":                                   ; preds = %"$out_of_gas_80", %"$have_gas_69"
  ...
  store [32 x i8] %"$sha256hash_89", [32 x i8]* %h2, align 1
...
"$have_gas_110":                                  ; preds = %"$out_of_gas_109", %"$have_gas_98"
  ...
  store [32 x i8] %"$sha256hash_117", [32 x i8]* %sh2, align 1
...
"$have_gas_146":                                  ; preds = %"$out_of_gas_145", %"$have_gas_141"
  ...
  store [32 x i8] %"$sha256hash_160", [32 x i8]* %"$expr_0", align 1
