...
@_contract_parameters = constant [0 x %"$ParamDescr_107"] zeroinitializer
@_contract_parameters_length = constant i32 0
@_transition_parameters = constant [0 x %"$TransDescr_108"] zeroinitializer
...
"$have_gas_82":                                   ; preds = %"$out_of_gas_81", %"$have_gas_77"
  ...
  store %Int32 { i32 2147483647 }, %Int32* %a, align 4, !dbg !13
...
"$have_gas_92":                                   ; preds = %"$out_of_gas_91", %"$have_gas_87"
  ...
  store %Int32 zeroinitializer, %Int32* %b, align 4, !dbg !18
  %"$gasrem_94" = load i64, i64* @_gasrem, align 8
  %"$gascmp_95" = icmp ugt i64 20, %"$gasrem_94"
...
"$have_gas_97":                                   ; preds = %"$out_of_gas_96", %"$have_gas_92"
  %"$consume_98" = sub i64 %"$gasrem_94", 20
  store i64 %"$consume_98", i64* @_gasrem, align 8
  %"$a_99" = load %Int32, %Int32* %a, align 4
  %"$b_100" = load %Int32, %Int32* %b, align 4
  %"$div_call_101" = call %Int32 @_div_Int32(%Int32 %"$a_99", %Int32 %"$b_100"), !dbg !19
  store %Int32 %"$div_call_101", %Int32* %"$expr_6", align 4, !dbg !19
  %"$$expr_6_102" = load %Int32, %Int32* %"$expr_6", align 4
  ret %Int32 %"$$expr_6_102"
}
...
entry:
  %"$exprval_103" = call %Int32 @_scilla_expr_fun(i8* null)
  %"$pval_104" = alloca %Int32, align 8
  %"$memvoidcast_105" = bitcast %Int32* %"$pval_104" to i8*
  store %Int32 %"$exprval_103", %Int32* %"$pval_104", align 4
  %"$execptr_load_106" = load i8*, i8** @_execptr, align 8
  call void @_print_scilla_val(i8* %"$execptr_load_106", %_TyDescrTy_Typ* @"$TyDescr_Int32_9", i8* %"$memvoidcast_105")
  ret void
}
...
!14 = !DILocalVariable(name: "a", scope: !10, file: !2, line: 1, type: !12)
!15 = !DILocation(line: 1, column: 5, scope: !10)
!16 = !DILocalVariable(name: "b", scope: !10, file: !2, line: 2, type: !12)
