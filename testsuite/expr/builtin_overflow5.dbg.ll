...
"$have_gas_80":                                   ; preds = %"$out_of_gas_79", %"$have_gas_75"
  ...
  store %Int32 { i32 2147483647 }, %Int32* %a, align 4, !dbg !11
...
"$have_gas_90":                                   ; preds = %"$out_of_gas_89", %"$have_gas_85"
  ...
  store %Int32 zeroinitializer, %Int32* %b, align 4, !dbg !12
...
"$have_gas_95":                                   ; preds = %"$out_of_gas_94", %"$have_gas_90"
  ...
  %"$div_call_99" = call %Int32 @_div_Int32(%Int32 %"$a_97", %Int32 %"$b_98"), !dbg !13
  store %Int32 %"$div_call_99", %Int32* %"$expr_6", align 4, !dbg !13
...
!2 = !DIFile(filename: "builtin_overflow5.scilexp", directory: "codegen/expr")
!3 = !{}
