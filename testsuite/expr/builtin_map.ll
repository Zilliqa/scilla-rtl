...
define internal %Uint32 @"$scilla_expr_108"(i8* %0) !dbg !15 {
entry:
...
"$have_gas_117":                                  ; preds = %"$out_of_gas_116", %"$have_gas_112"
  ...
  store { %Uint32 (i8*, %TName_Bool*)*, i8* } { %Uint32 (i8*, %TName_Bool*)* bitcast (%Uint32 (%"$$fundef_8_env_83"*, %TName_Bool*)* @"$fundef_8" to %Uint32 (i8*, %TName_Bool*)*), i8* null }, { %Uint32 (i8*, %TName_Bool*)*, i8* }* %bool_to_uint, align 8, !dbg !16
...
"$have_gas_130":                                  ; preds = %"$out_of_gas_129", %"$have_gas_125"
  ...
  store %Uint32 zeroinitializer, %Uint32* %i0, align 4, !dbg !17
...
"$have_gas_140":                                  ; preds = %"$out_of_gas_139", %"$have_gas_135"
  ...
  store %Uint32 { i32 1 }, %Uint32* %i1, align 4, !dbg !18
...
"$have_gas_150":                                  ; preds = %"$out_of_gas_149", %"$have_gas_145"
  ...
  store %Map_Uint32_Uint32* %"$Emp_154", %Map_Uint32_Uint32** %a, align 8, !dbg !19
...
"$have_gas_158":                                  ; preds = %"$out_of_gas_157", %"$have_gas_150"
  ...
  %"$put_i0_163" = alloca %Uint32, align 8
  %"$i0_164" = load %Uint32, %Uint32* %i0, align 4
  store %Uint32 %"$i0_164", %Uint32* %"$put_i0_163", align 4
  %"$$put_i0_163_165" = bitcast %Uint32* %"$put_i0_163" to i8*
  %"$put_i1_166" = alloca %Uint32, align 8
  %"$i1_167" = load %Uint32, %Uint32* %i1, align 4
  store %Uint32 %"$i1_167", %Uint32* %"$put_i1_166", align 4
  ...
  store %Map_Uint32_Uint32* %"$_put_170", %Map_Uint32_Uint32** %a1, align 8, !dbg !20
...
"$have_gas_179":                                  ; preds = %"$out_of_gas_178", %"$have_gas_174"
  ...
  %"$a1_181" = load %Map_Uint32_Uint32*, %Map_Uint32_Uint32** %a1, align 8
  ...
  store %Map_Uint32_Uint32* %"$a1_181", %Map_Uint32_Uint32** %"$adtgep_184", align 8
  %"$adtptr_185" = bitcast %"CName_Some_Map_(Uint32)_(Uint32)"* %"$adtval_182" to %"TName_Option_Map_(Uint32)_(Uint32)"*
  store %"TName_Option_Map_(Uint32)_(Uint32)"* %"$adtptr_185", %"TName_Option_Map_(Uint32)_(Uint32)"** %o, align 8, !dbg !21
...
"$have_gas_194":                                  ; preds = %"$out_of_gas_193", %"$have_gas_189"
  ...
  store %"Map_Uint32_Option_(Map_(Uint32)_(Uint32))"* %"$Emp_198", %"Map_Uint32_Option_(Map_(Uint32)_(Uint32))"** %b, align 8, !dbg !22
...
"$have_gas_202":                                  ; preds = %"$out_of_gas_201", %"$have_gas_194"
  ...
  %"$b_205" = load %"Map_Uint32_Option_(Map_(Uint32)_(Uint32))"*, %"Map_Uint32_Option_(Map_(Uint32)_(Uint32))"** %b, align 8
  %"$$b_205_206" = bitcast %"Map_Uint32_Option_(Map_(Uint32)_(Uint32))"* %"$b_205" to i8*
  %"$put_i1_207" = alloca %Uint32, align 8
  %"$i1_208" = load %Uint32, %Uint32* %i1, align 4
  store %Uint32 %"$i1_208", %Uint32* %"$put_i1_207", align 4
  %"$$put_i1_207_209" = bitcast %Uint32* %"$put_i1_207" to i8*
  %"$o_210" = load %"TName_Option_Map_(Uint32)_(Uint32)"*, %"TName_Option_Map_(Uint32)_(Uint32)"** %o, align 8
  ...
  store %"Map_Uint32_Option_(Map_(Uint32)_(Uint32))"* %"$_put_213", %"Map_Uint32_Option_(Map_(Uint32)_(Uint32))"** %b1, align 8, !dbg !23
...
"$have_gas_217":                                  ; preds = %"$out_of_gas_216", %"$have_gas_202"
  ...
  %"$b1_220" = load %"Map_Uint32_Option_(Map_(Uint32)_(Uint32))"*, %"Map_Uint32_Option_(Map_(Uint32)_(Uint32))"** %b1, align 8
  %"$$b1_220_221" = bitcast %"Map_Uint32_Option_(Map_(Uint32)_(Uint32))"* %"$b1_220" to i8*
  %"$get_i1_222" = alloca %Uint32, align 8
  %"$i1_223" = load %Uint32, %Uint32* %i1, align 4
  store %Uint32 %"$i1_223", %Uint32* %"$get_i1_222", align 4
  ...
  store %"TName_Option_Option_(Map_(Uint32)_(Uint32))"* %"$_get_226", %"TName_Option_Option_(Map_(Uint32)_(Uint32))"** %res1, align 8, !dbg !24
...
"$have_gas_230":                                  ; preds = %"$out_of_gas_229", %"$have_gas_217"
  ...
  %"$res1_267" = load %"TName_Option_Option_(Map_(Uint32)_(Uint32))"*, %"TName_Option_Option_(Map_(Uint32)_(Uint32))"** %res1, align 8
  ...
  %"$res1_tag_269" = load i8, i8* %"$res1_tag_268", align 1
...
"$Some_271":                                      ; preds = %"$have_gas_230"
  ...
  %"$$res1_2_load_274" = load %"TName_Option_Map_(Uint32)_(Uint32)"*, %"TName_Option_Map_(Uint32)_(Uint32)"** %"$$res1_2_gep_273", align 8
  %"$res1_2" = alloca %"TName_Option_Map_(Uint32)_(Uint32)"*, align 8
  store %"TName_Option_Map_(Uint32)_(Uint32)"* %"$$res1_2_load_274", %"TName_Option_Map_(Uint32)_(Uint32)"** %"$res1_2", align 8
  %"$$res1_2_276" = load %"TName_Option_Map_(Uint32)_(Uint32)"*, %"TName_Option_Map_(Uint32)_(Uint32)"** %"$res1_2", align 8
  ...
  %"$$res1_2_tag_278" = load i8, i8* %"$$res1_2_tag_277", align 1
...
"$Some_280":                                      ; preds = %"$Some_271"
  ...
  %"$$a1_0_load_283" = load %Map_Uint32_Uint32*, %Map_Uint32_Uint32** %"$$a1_0_gep_282", align 8
  %"$a1_0" = alloca %Map_Uint32_Uint32*, align 8
  store %Map_Uint32_Uint32* %"$$a1_0_load_283", %Map_Uint32_Uint32** %"$a1_0", align 8
...
"$have_gas_287":                                  ; preds = %"$out_of_gas_286", %"$Some_280"
  ...
  %"$b1_290" = load %"Map_Uint32_Option_(Map_(Uint32)_(Uint32))"*, %"Map_Uint32_Option_(Map_(Uint32)_(Uint32))"** %b1, align 8
  %"$$b1_290_291" = bitcast %"Map_Uint32_Option_(Map_(Uint32)_(Uint32))"* %"$b1_290" to i8*
  %"$contains_i1_292" = alloca %Uint32, align 8
  %"$i1_293" = load %Uint32, %Uint32* %i1, align 4
  store %Uint32 %"$i1_293", %Uint32* %"$contains_i1_292", align 4
  ...
  store %TName_Bool* %"$contains_call_295", %TName_Bool** %p11, align 8, !dbg !29
...
"$have_gas_304":                                  ; preds = %"$out_of_gas_303", %"$have_gas_299"
  ...
  %"$bool_to_uint_306" = load { %Uint32 (i8*, %TName_Bool*)*, i8* }, { %Uint32 (i8*, %TName_Bool*)*, i8* }* %bool_to_uint, align 8
  ...
  %"$p1_309" = load %TName_Bool*, %TName_Bool** %p11, align 8
  %"$bool_to_uint_call_310" = call %Uint32 %"$bool_to_uint_fptr_307"(i8* %"$bool_to_uint_envptr_308", %TName_Bool* %"$p1_309"), !dbg !32
  store %Uint32 %"$bool_to_uint_call_310", %Uint32* %"$bool_to_uint_3", align 4, !dbg !32
  %"$$bool_to_uint_3_311" = load %Uint32, %Uint32* %"$bool_to_uint_3", align 4
  store %Uint32 %"$$bool_to_uint_3_311", %Uint32* %p1_i, align 4, !dbg !32
...
"$have_gas_315":                                  ; preds = %"$out_of_gas_314", %"$have_gas_304"
  ...
  %"$$a1_0_318" = load %Map_Uint32_Uint32*, %Map_Uint32_Uint32** %"$a1_0", align 8
  %"$$$a1_0_318_319" = bitcast %Map_Uint32_Uint32* %"$$a1_0_318" to i8*
  %"$contains_i0_320" = alloca %Uint32, align 8
  %"$i0_321" = load %Uint32, %Uint32* %i0, align 4
  store %Uint32 %"$i0_321", %Uint32* %"$contains_i0_320", align 4
  ...
  store %TName_Bool* %"$contains_call_323", %TName_Bool** %p2, align 8, !dbg !33
...
"$have_gas_332":                                  ; preds = %"$out_of_gas_331", %"$have_gas_327"
  ...
  %"$bool_to_uint_334" = load { %Uint32 (i8*, %TName_Bool*)*, i8* }, { %Uint32 (i8*, %TName_Bool*)*, i8* }* %bool_to_uint, align 8
  ...
  %"$p2_337" = load %TName_Bool*, %TName_Bool** %p2, align 8
  %"$bool_to_uint_call_338" = call %Uint32 %"$bool_to_uint_fptr_335"(i8* %"$bool_to_uint_envptr_336", %TName_Bool* %"$p2_337"), !dbg !34
  store %Uint32 %"$bool_to_uint_call_338", %Uint32* %"$bool_to_uint_4", align 4, !dbg !34
  %"$$bool_to_uint_4_339" = load %Uint32, %Uint32* %"$bool_to_uint_4", align 4
  store %Uint32 %"$$bool_to_uint_4_339", %Uint32* %p2_i, align 4, !dbg !34
...
"$have_gas_343":                                  ; preds = %"$out_of_gas_342", %"$have_gas_332"
  ...
  %"$p1_i_345" = load %Uint32, %Uint32* %p1_i, align 4
  %"$p2_i_346" = load %Uint32, %Uint32* %p2_i, align 4
  %"$add_call_347" = call %Uint32 @_add_Uint32(%Uint32 %"$p1_i_345", %Uint32 %"$p2_i_346")
  store %Uint32 %"$add_call_347", %Uint32* %p3, align 4, !dbg !35
...
"$have_gas_351":                                  ; preds = %"$out_of_gas_350", %"$have_gas_343"
  ...
  %"$$a1_0_354" = load %Map_Uint32_Uint32*, %Map_Uint32_Uint32** %"$a1_0", align 8
  %"$$$a1_0_354_355" = bitcast %Map_Uint32_Uint32* %"$$a1_0_354" to i8*
  %"$_i1_356" = alloca %Uint32, align 8
  %"$i1_357" = load %Uint32, %Uint32* %i1, align 4
  store %Uint32 %"$i1_357", %Uint32* %"$_i1_356", align 4
  ...
  store %Map_Uint32_Uint32* %"$_remove_360", %Map_Uint32_Uint32** %a2, align 8, !dbg !36
...
"$have_gas_364":                                  ; preds = %"$out_of_gas_363", %"$have_gas_351"
  ...
  %"$a2_367" = load %Map_Uint32_Uint32*, %Map_Uint32_Uint32** %a2, align 8
  %"$$a2_367_368" = bitcast %Map_Uint32_Uint32* %"$a2_367" to i8*
  %"$contains_i0_369" = alloca %Uint32, align 8
  %"$i0_370" = load %Uint32, %Uint32* %i0, align 4
  store %Uint32 %"$i0_370", %Uint32* %"$contains_i0_369", align 4
  ...
  store %TName_Bool* %"$contains_call_372", %TName_Bool** %p5, align 8, !dbg !37
...
"$have_gas_381":                                  ; preds = %"$out_of_gas_380", %"$have_gas_376"
  ...
  %"$bool_to_uint_383" = load { %Uint32 (i8*, %TName_Bool*)*, i8* }, { %Uint32 (i8*, %TName_Bool*)*, i8* }* %bool_to_uint, align 8
  ...
  %"$p5_386" = load %TName_Bool*, %TName_Bool** %p5, align 8
  %"$bool_to_uint_call_387" = call %Uint32 %"$bool_to_uint_fptr_384"(i8* %"$bool_to_uint_envptr_385", %TName_Bool* %"$p5_386"), !dbg !38
  store %Uint32 %"$bool_to_uint_call_387", %Uint32* %"$bool_to_uint_5", align 4, !dbg !38
  %"$$bool_to_uint_5_388" = load %Uint32, %Uint32* %"$bool_to_uint_5", align 4
  store %Uint32 %"$$bool_to_uint_5_388", %Uint32* %p5_i, align 4, !dbg !38
...
"$have_gas_392":                                  ; preds = %"$out_of_gas_391", %"$have_gas_381"
  ...
  %"$p3_394" = load %Uint32, %Uint32* %p3, align 4
  %"$p5_i_395" = load %Uint32, %Uint32* %p5_i, align 4
  %"$add_call_396" = call %Uint32 @_add_Uint32(%Uint32 %"$p3_394", %Uint32 %"$p5_i_395")
  store %Uint32 %"$add_call_396", %Uint32* %p6, align 4, !dbg !39
...
"$have_gas_400":                                  ; preds = %"$out_of_gas_399", %"$have_gas_392"
  ...
  %"$$a1_0_403" = load %Map_Uint32_Uint32*, %Map_Uint32_Uint32** %"$a1_0", align 8
  %"$$$a1_0_403_404" = bitcast %Map_Uint32_Uint32* %"$$a1_0_403" to i8*
  %"$put_i1_405" = alloca %Uint32, align 8
  %"$i1_406" = load %Uint32, %Uint32* %i1, align 4
  store %Uint32 %"$i1_406", %Uint32* %"$put_i1_405", align 4
  %"$$put_i1_405_407" = bitcast %Uint32* %"$put_i1_405" to i8*
  %"$put_i0_408" = alloca %Uint32, align 8
  %"$i0_409" = load %Uint32, %Uint32* %i0, align 4
  store %Uint32 %"$i0_409", %Uint32* %"$put_i0_408", align 4
  ...
  store %Map_Uint32_Uint32* %"$_put_412", %Map_Uint32_Uint32** %a3, align 8, !dbg !40
...
"$have_gas_416":                                  ; preds = %"$out_of_gas_415", %"$have_gas_400"
  ...
  %"$a3_419" = load %Map_Uint32_Uint32*, %Map_Uint32_Uint32** %a3, align 8
  %"$$a3_419_420" = bitcast %Map_Uint32_Uint32* %"$a3_419" to i8*
  %"$put_p6_421" = alloca %Uint32, align 8
  %"$p6_422" = load %Uint32, %Uint32* %p6, align 4
  store %Uint32 %"$p6_422", %Uint32* %"$put_p6_421", align 4
  %"$$put_p6_421_423" = bitcast %Uint32* %"$put_p6_421" to i8*
  %"$put_p3_424" = alloca %Uint32, align 8
  %"$p3_425" = load %Uint32, %Uint32* %p3, align 4
  store %Uint32 %"$p3_425", %Uint32* %"$put_p3_424", align 4
  ...
  store %Map_Uint32_Uint32* %"$_put_428", %Map_Uint32_Uint32** %a4, align 8, !dbg !41
...
"$have_gas_432":                                  ; preds = %"$out_of_gas_431", %"$have_gas_416"
  ...
  %"$a4_434" = load %Map_Uint32_Uint32*, %Map_Uint32_Uint32** %a4, align 8
  %"$$a4_434_435" = bitcast %Map_Uint32_Uint32* %"$a4_434" to i8*
  %"$size_call_436" = call %Uint32 @_size(i8* %"$$a4_434_435")
  store %Uint32 %"$size_call_436", %Uint32* %p7_i, align 4, !dbg !42
  %"$p6_437" = load %Uint32, %Uint32* %p6, align 4
  %"$p7_i_438" = load %Uint32, %Uint32* %p7_i, align 4
  %"$add_call_439" = call %Uint32 @_add_Uint32(%Uint32 %"$p6_437", %Uint32 %"$p7_i_438")
  store %Uint32 %"$add_call_439", %Uint32* %"$expr_7", align 4, !dbg !43
...
"$have_gas_236":                                  ; preds = %"$out_of_gas_235", %"$joinp_1"
  ...
  %"$a1_239" = load %Map_Uint32_Uint32*, %Map_Uint32_Uint32** %a1, align 8
  %"$$a1_239_240" = bitcast %Map_Uint32_Uint32* %"$a1_239" to i8*
  %"$contains_i0_241" = alloca %Uint32, align 8
  %"$i0_242" = load %Uint32, %Uint32* %i0, align 4
  store %Uint32 %"$i0_242", %Uint32* %"$contains_i0_241", align 4
  ...
  store %TName_Bool* %"$contains_call_244", %TName_Bool** %p, align 8, !dbg !44
...
"$have_gas_253":                                  ; preds = %"$out_of_gas_252", %"$have_gas_248"
  ...
  %"$bool_to_uint_255" = load { %Uint32 (i8*, %TName_Bool*)*, i8* }, { %Uint32 (i8*, %TName_Bool*)*, i8* }* %bool_to_uint, align 8
  ...
  %"$p_258" = load %TName_Bool*, %TName_Bool** %p, align 8
  %"$bool_to_uint_call_259" = call %Uint32 %"$bool_to_uint_fptr_256"(i8* %"$bool_to_uint_envptr_257", %TName_Bool* %"$p_258"), !dbg !46
  store %Uint32 %"$bool_to_uint_call_259", %Uint32* %"$bool_to_uint_6", align 4, !dbg !46
  %"$$bool_to_uint_6_260" = load %Uint32, %Uint32* %"$bool_to_uint_6", align 4
  store %Uint32 %"$$bool_to_uint_6_260", %Uint32* %p1, align 4, !dbg !46
...
"$have_gas_264":                                  ; preds = %"$out_of_gas_263", %"$have_gas_253"
  ...
  %"$p1_266" = load %Uint32, %Uint32* %p1, align 4
  store %Uint32 %"$p1_266", %Uint32* %"$expr_7", align 4, !dbg !47
  br label %"$matchsucc_232"

"$matchsucc_232":                                 ; preds = %"$matchsucc_275", %"$have_gas_264"
  %"$$expr_7_440" = load %Uint32, %Uint32* %"$expr_7", align 4
...
entry:
  ...
  %"$pval_442" = alloca %Uint32, align 8
  %"$memvoidcast_443" = bitcast %Uint32* %"$pval_442" to i8*
  store %Uint32 %"$exprval_441", %Uint32* %"$pval_442", align 4
...
!15 = distinct !DISubprogram(name: "$scilla_expr_108", linkageName: "$scilla_expr_108", scope: !2, file: !2, type: !5, spFlags: DISPFlagDefinition, unit: !1, retainedNodes: !3)
!16 = !DILocation(line: 3, column: 5, scope: !15)
!17 = !DILocation(line: 8, column: 10, scope: !15)
!18 = !DILocation(line: 9, column: 10, scope: !15)
!19 = !DILocation(line: 10, column: 9, scope: !15)
!20 = !DILocation(line: 11, column: 10, scope: !15)
!21 = !DILocation(line: 12, column: 9, scope: !15)
!22 = !DILocation(line: 13, column: 9, scope: !15)
!23 = !DILocation(line: 14, column: 10, scope: !15)
!24 = !DILocation(line: 15, column: 12, scope: !15)
!25 = !DILocation(line: 16, column: 1, scope: !15)
!26 = !DILocation(line: 16, column: 1, scope: !27)
!27 = distinct !DILexicalBlock(scope: !28, file: !2, line: 17, column: 3)
!28 = distinct !DILexicalBlock(scope: !15, file: !2, line: 16, column: 1)
!29 = !DILocation(line: 18, column: 12, scope: !30)
!30 = distinct !DILexicalBlock(scope: !31, file: !2, line: 17, column: 9)
!31 = distinct !DILexicalBlock(scope: !27, file: !2, line: 16, column: 1)
!32 = !DILocation(line: 19, column: 14, scope: !30)
!33 = !DILocation(line: 20, column: 12, scope: !30)
!34 = !DILocation(line: 21, column: 14, scope: !30)
!35 = !DILocation(line: 22, column: 12, scope: !30)
!36 = !DILocation(line: 23, column: 12, scope: !30)
!37 = !DILocation(line: 24, column: 12, scope: !30)
!38 = !DILocation(line: 25, column: 14, scope: !30)
!39 = !DILocation(line: 26, column: 12, scope: !30)
!40 = !DILocation(line: 27, column: 12, scope: !30)
!41 = !DILocation(line: 28, column: 12, scope: !30)
!42 = !DILocation(line: 29, column: 14, scope: !30)
!43 = !DILocation(line: 30, column: 3, scope: !30)
!44 = !DILocation(line: 32, column: 11, scope: !45)
!45 = distinct !DILexicalBlock(scope: !28, file: !2, line: 16, column: 1)
!46 = !DILocation(line: 33, column: 12, scope: !45)
