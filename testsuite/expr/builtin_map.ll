...
"$have_gas_352":                                  ; preds = %"$out_of_gas_351", %"$have_gas_344"
  ...
  store %Map_Uint32_Uint32* %"$_361", %Map_Uint32_Uint32** %a2, align 8
...
"$have_gas_401":                                  ; preds = %"$out_of_gas_400", %"$have_gas_393"
  ...
  store %Map_Uint32_Uint32* %"$put_413", %Map_Uint32_Uint32** %a3, align 8
...
"$have_gas_417":                                  ; preds = %"$out_of_gas_416", %"$have_gas_401"
  ...
  store %Map_Uint32_Uint32* %"$put_429", %Map_Uint32_Uint32** %a4, align 8
