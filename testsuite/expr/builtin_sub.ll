...
"$have_gas_254":                                  ; preds = %"$out_of_gas_253", %"$have_gas_249"
  ...
  %"$sub_call_258" = call %Uint32 @_sub_Uint32(%Uint32 %"$arg1_256", %Uint32 %"$arg2_257")
  store %Uint32 %"$sub_call_258", %Uint32* %res, align 4
...
"$have_gas_277":                                  ; preds = %"$out_of_gas_276", %"$have_gas_272"
  ...
  %"$eq_call_282" = call %TName_Bool* @_eq_Uint32(i8* %"$execptr_load_279", %Uint32 %"$res_280", %Uint32 %"$res__281")
  store %TName_Bool* %"$eq_call_282", %TName_Bool** %test_, align 8
...
"$have_gas_287":                                  ; preds = %"$out_of_gas_286", %"$have_gas_277"
  ...
  %"$BoolUtils.andb_call_293" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_fptr_290"(i8* %"$BoolUtils.andb_envptr_291", %TName_Bool* %"$test_292")
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_call_293", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.andb_73", align 8
  ...
  %"$$BoolUtils.andb_73_call_298" = call %TName_Bool* %"$$BoolUtils.andb_73_fptr_295"(i8* %"$$BoolUtils.andb_73_envptr_296", %TName_Bool* %"$test__297")
  store %TName_Bool* %"$$BoolUtils.andb_73_call_298", %TName_Bool** %"$BoolUtils.andb_74", align 8
  %"$$BoolUtils.andb_74_299" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.andb_74", align 8
  store %TName_Bool* %"$$BoolUtils.andb_74_299", %TName_Bool** %"$test_0", align 8
...
"$have_gas_333":                                  ; preds = %"$out_of_gas_332", %"$have_gas_328"
  ...
  %"$sub_call_337" = call %Int32 @_sub_Int32(%Int32 %"$$arg1_2_335", %Int32 %"$$arg2_1_336")
  store %Int32 %"$sub_call_337", %Int32* %"$res_3", align 4
...
"$have_gas_356":                                  ; preds = %"$out_of_gas_355", %"$have_gas_351"
  ...
  %"$eq_call_361" = call %TName_Bool* @_eq_Int32(i8* %"$execptr_load_358", %Int32 %"$$res_3_359", %Int32 %"$$res__4_360")
  store %TName_Bool* %"$eq_call_361", %TName_Bool** %"$test__5", align 8
...
"$have_gas_366":                                  ; preds = %"$out_of_gas_365", %"$have_gas_356"
  ...
  %"$BoolUtils.andb_call_372" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_fptr_369"(i8* %"$BoolUtils.andb_envptr_370", %TName_Bool* %"$$test_0_371")
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_call_372", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.andb_75", align 8
  ...
  %"$$BoolUtils.andb_75_call_377" = call %TName_Bool* %"$$BoolUtils.andb_75_fptr_374"(i8* %"$$BoolUtils.andb_75_envptr_375", %TName_Bool* %"$$test__5_376")
  store %TName_Bool* %"$$BoolUtils.andb_75_call_377", %TName_Bool** %"$BoolUtils.andb_76", align 8
  %"$$BoolUtils.andb_76_378" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.andb_76", align 8
  store %TName_Bool* %"$$BoolUtils.andb_76_378", %TName_Bool** %"$test_6", align 8
...
"$have_gas_412":                                  ; preds = %"$out_of_gas_411", %"$have_gas_407"
  ...
  %"$sub_call_416" = call %Uint64 @_sub_Uint64(%Uint64 %"$$arg1_7_414", %Uint64 %"$$arg2_8_415")
  store %Uint64 %"$sub_call_416", %Uint64* %"$res_9", align 8
...
"$have_gas_435":                                  ; preds = %"$out_of_gas_434", %"$have_gas_430"
  ...
  %"$eq_call_440" = call %TName_Bool* @_eq_Uint64(i8* %"$execptr_load_437", %Uint64 %"$$res_9_438", %Uint64 %"$$res__10_439")
  store %TName_Bool* %"$eq_call_440", %TName_Bool** %"$test__11", align 8
...
"$have_gas_445":                                  ; preds = %"$out_of_gas_444", %"$have_gas_435"
  ...
  %"$BoolUtils.andb_call_451" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_fptr_448"(i8* %"$BoolUtils.andb_envptr_449", %TName_Bool* %"$$test_6_450")
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_call_451", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.andb_77", align 8
  ...
  %"$$BoolUtils.andb_77_call_456" = call %TName_Bool* %"$$BoolUtils.andb_77_fptr_453"(i8* %"$$BoolUtils.andb_77_envptr_454", %TName_Bool* %"$$test__11_455")
  store %TName_Bool* %"$$BoolUtils.andb_77_call_456", %TName_Bool** %"$BoolUtils.andb_78", align 8
  %"$$BoolUtils.andb_78_457" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.andb_78", align 8
  store %TName_Bool* %"$$BoolUtils.andb_78_457", %TName_Bool** %"$test_12", align 8
...
"$have_gas_491":                                  ; preds = %"$out_of_gas_490", %"$have_gas_486"
  ...
  %"$sub_call_495" = call %Int64 @_sub_Int64(%Int64 %"$$arg1_14_493", %Int64 %"$$arg2_13_494")
  store %Int64 %"$sub_call_495", %Int64* %"$res_15", align 8
...
"$have_gas_514":                                  ; preds = %"$out_of_gas_513", %"$have_gas_509"
  ...
  %"$eq_call_519" = call %TName_Bool* @_eq_Int64(i8* %"$execptr_load_516", %Int64 %"$$res_15_517", %Int64 %"$$res__16_518")
  store %TName_Bool* %"$eq_call_519", %TName_Bool** %"$test__17", align 8
...
"$have_gas_524":                                  ; preds = %"$out_of_gas_523", %"$have_gas_514"
  ...
  %"$BoolUtils.andb_call_530" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_fptr_527"(i8* %"$BoolUtils.andb_envptr_528", %TName_Bool* %"$$test_12_529")
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_call_530", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.andb_79", align 8
  ...
  %"$$BoolUtils.andb_79_call_535" = call %TName_Bool* %"$$BoolUtils.andb_79_fptr_532"(i8* %"$$BoolUtils.andb_79_envptr_533", %TName_Bool* %"$$test__17_534")
  store %TName_Bool* %"$$BoolUtils.andb_79_call_535", %TName_Bool** %"$BoolUtils.andb_80", align 8
  %"$$BoolUtils.andb_80_536" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.andb_80", align 8
  store %TName_Bool* %"$$BoolUtils.andb_80_536", %TName_Bool** %"$test_18", align 8
...
"$have_gas_570":                                  ; preds = %"$out_of_gas_569", %"$have_gas_565"
  ...
  %"$sub_call_574" = call %Int64 @_sub_Int64(%Int64 %"$$arg1_19_572", %Int64 %"$$arg2_20_573")
  store %Int64 %"$sub_call_574", %Int64* %"$res_21", align 8
...
"$have_gas_593":                                  ; preds = %"$out_of_gas_592", %"$have_gas_588"
  ...
  %"$eq_call_598" = call %TName_Bool* @_eq_Int64(i8* %"$execptr_load_595", %Int64 %"$$res_21_596", %Int64 %"$$res__22_597")
  store %TName_Bool* %"$eq_call_598", %TName_Bool** %"$test__23", align 8
...
"$have_gas_603":                                  ; preds = %"$out_of_gas_602", %"$have_gas_593"
  ...
  %"$BoolUtils.andb_call_609" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_fptr_606"(i8* %"$BoolUtils.andb_envptr_607", %TName_Bool* %"$$test_18_608")
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_call_609", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.andb_81", align 8
  ...
  %"$$BoolUtils.andb_81_call_614" = call %TName_Bool* %"$$BoolUtils.andb_81_fptr_611"(i8* %"$$BoolUtils.andb_81_envptr_612", %TName_Bool* %"$$test__23_613")
  store %TName_Bool* %"$$BoolUtils.andb_81_call_614", %TName_Bool** %"$BoolUtils.andb_82", align 8
  %"$$BoolUtils.andb_82_615" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.andb_82", align 8
  store %TName_Bool* %"$$BoolUtils.andb_82_615", %TName_Bool** %"$test_24", align 8
...
"$have_gas_650":                                  ; preds = %"$out_of_gas_649", %"$have_gas_644"
  ...
  %"$sub_call_654" = call %Uint128 @_sub_Uint128(%Uint128 %"$$arg1_25_652", %Uint128 %"$$arg2_26_653")
  store %Uint128 %"$sub_call_654", %Uint128* %"$res_27", align 8
...
"$have_gas_674":                                  ; preds = %"$out_of_gas_673", %"$have_gas_668"
  ...
  %"$eq_call_679" = call %TName_Bool* @_eq_Uint128(i8* %"$execptr_load_676", %Uint128 %"$$res_27_677", %Uint128 %"$$res__28_678")
  store %TName_Bool* %"$eq_call_679", %TName_Bool** %"$test__29", align 8
...
"$have_gas_684":                                  ; preds = %"$out_of_gas_683", %"$have_gas_674"
  ...
  %"$BoolUtils.andb_call_690" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_fptr_687"(i8* %"$BoolUtils.andb_envptr_688", %TName_Bool* %"$$test_24_689")
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_call_690", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.andb_83", align 8
  ...
  %"$$BoolUtils.andb_83_call_695" = call %TName_Bool* %"$$BoolUtils.andb_83_fptr_692"(i8* %"$$BoolUtils.andb_83_envptr_693", %TName_Bool* %"$$test__29_694")
  store %TName_Bool* %"$$BoolUtils.andb_83_call_695", %TName_Bool** %"$BoolUtils.andb_84", align 8
  %"$$BoolUtils.andb_84_696" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.andb_84", align 8
  store %TName_Bool* %"$$BoolUtils.andb_84_696", %TName_Bool** %"$test_30", align 8
...
"$have_gas_731":                                  ; preds = %"$out_of_gas_730", %"$have_gas_725"
  ...
  %"$sub_call_735" = call %Uint128 @_sub_Uint128(%Uint128 %"$$arg1_31_733", %Uint128 %"$$arg2_32_734")
  store %Uint128 %"$sub_call_735", %Uint128* %"$res_33", align 8
...
"$have_gas_755":                                  ; preds = %"$out_of_gas_754", %"$have_gas_749"
  ...
  %"$eq_call_760" = call %TName_Bool* @_eq_Uint128(i8* %"$execptr_load_757", %Uint128 %"$$res_33_758", %Uint128 %"$$res__34_759")
  store %TName_Bool* %"$eq_call_760", %TName_Bool** %"$test__35", align 8
...
"$have_gas_765":                                  ; preds = %"$out_of_gas_764", %"$have_gas_755"
  ...
  %"$BoolUtils.andb_call_771" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_fptr_768"(i8* %"$BoolUtils.andb_envptr_769", %TName_Bool* %"$$test_30_770")
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_call_771", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.andb_85", align 8
  ...
  %"$$BoolUtils.andb_85_call_776" = call %TName_Bool* %"$$BoolUtils.andb_85_fptr_773"(i8* %"$$BoolUtils.andb_85_envptr_774", %TName_Bool* %"$$test__35_775")
  store %TName_Bool* %"$$BoolUtils.andb_85_call_776", %TName_Bool** %"$BoolUtils.andb_86", align 8
  %"$$BoolUtils.andb_86_777" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.andb_86", align 8
  store %TName_Bool* %"$$BoolUtils.andb_86_777", %TName_Bool** %"$test_36", align 8
...
"$have_gas_812":                                  ; preds = %"$out_of_gas_811", %"$have_gas_806"
  ...
  %"$sub_call_819" = call %Uint256* @_sub_Uint256(i8* %"$execptr_load_814", %Uint256* %"$sub_$arg1_37_815", %Uint256* %"$sub_$arg2_38_817")
  %"$sub_821" = load %Uint256, %Uint256* %"$sub_call_819", align 8
  store %Uint256 %"$sub_821", %Uint256* %"$res_39", align 8
...
"$have_gas_841":                                  ; preds = %"$out_of_gas_840", %"$have_gas_835"
  ...
  %"$eq_call_848" = call %TName_Bool* @_eq_Uint256(i8* %"$execptr_load_843", %Uint256* %"$eq_$res_39_844", %Uint256* %"$eq_$res__40_846")
  store %TName_Bool* %"$eq_call_848", %TName_Bool** %"$test__41", align 8
...
"$have_gas_853":                                  ; preds = %"$out_of_gas_852", %"$have_gas_841"
  ...
  %"$BoolUtils.andb_call_859" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_fptr_856"(i8* %"$BoolUtils.andb_envptr_857", %TName_Bool* %"$$test_36_858")
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_call_859", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.andb_87", align 8
  ...
  %"$$BoolUtils.andb_87_call_864" = call %TName_Bool* %"$$BoolUtils.andb_87_fptr_861"(i8* %"$$BoolUtils.andb_87_envptr_862", %TName_Bool* %"$$test__41_863")
  store %TName_Bool* %"$$BoolUtils.andb_87_call_864", %TName_Bool** %"$BoolUtils.andb_88", align 8
  %"$$BoolUtils.andb_88_865" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.andb_88", align 8
  store %TName_Bool* %"$$BoolUtils.andb_88_865", %TName_Bool** %"$test_42", align 8
...
"$have_gas_900":                                  ; preds = %"$out_of_gas_899", %"$have_gas_894"
  ...
  %"$sub_call_907" = call %Uint256* @_sub_Uint256(i8* %"$execptr_load_902", %Uint256* %"$sub_$arg1_43_903", %Uint256* %"$sub_$arg2_44_905")
  %"$sub_909" = load %Uint256, %Uint256* %"$sub_call_907", align 8
  store %Uint256 %"$sub_909", %Uint256* %"$res_45", align 8
...
"$have_gas_929":                                  ; preds = %"$out_of_gas_928", %"$have_gas_923"
  ...
  %"$eq_call_936" = call %TName_Bool* @_eq_Uint256(i8* %"$execptr_load_931", %Uint256* %"$eq_$res_45_932", %Uint256* %"$eq_$res__46_934")
  store %TName_Bool* %"$eq_call_936", %TName_Bool** %"$test__47", align 8
...
"$have_gas_941":                                  ; preds = %"$out_of_gas_940", %"$have_gas_929"
  ...
  %"$BoolUtils.andb_call_947" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_fptr_944"(i8* %"$BoolUtils.andb_envptr_945", %TName_Bool* %"$$test_42_946")
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_call_947", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.andb_89", align 8
  ...
  %"$$BoolUtils.andb_89_call_952" = call %TName_Bool* %"$$BoolUtils.andb_89_fptr_949"(i8* %"$$BoolUtils.andb_89_envptr_950", %TName_Bool* %"$$test__47_951")
  store %TName_Bool* %"$$BoolUtils.andb_89_call_952", %TName_Bool** %"$BoolUtils.andb_90", align 8
  %"$$BoolUtils.andb_90_953" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.andb_90", align 8
  store %TName_Bool* %"$$BoolUtils.andb_90_953", %TName_Bool** %"$test_48", align 8
...
"$have_gas_988":                                  ; preds = %"$out_of_gas_987", %"$have_gas_982"
  ...
  %"$sub_call_995" = call %Uint256* @_sub_Uint256(i8* %"$execptr_load_990", %Uint256* %"$sub_$arg1_49_991", %Uint256* %"$sub_$arg2_50_993")
  %"$sub_997" = load %Uint256, %Uint256* %"$sub_call_995", align 8
  store %Uint256 %"$sub_997", %Uint256* %"$res_51", align 8
...
"$have_gas_1017":                                 ; preds = %"$out_of_gas_1016", %"$have_gas_1011"
  ...
  %"$eq_call_1024" = call %TName_Bool* @_eq_Uint256(i8* %"$execptr_load_1019", %Uint256* %"$eq_$res_51_1020", %Uint256* %"$eq_$res__52_1022")
  store %TName_Bool* %"$eq_call_1024", %TName_Bool** %"$test__53", align 8
...
"$have_gas_1029":                                 ; preds = %"$out_of_gas_1028", %"$have_gas_1017"
  ...
  %"$BoolUtils.andb_call_1035" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_fptr_1032"(i8* %"$BoolUtils.andb_envptr_1033", %TName_Bool* %"$$test_48_1034")
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_call_1035", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.andb_91", align 8
  ...
  %"$$BoolUtils.andb_91_call_1040" = call %TName_Bool* %"$$BoolUtils.andb_91_fptr_1037"(i8* %"$$BoolUtils.andb_91_envptr_1038", %TName_Bool* %"$$test__53_1039")
  store %TName_Bool* %"$$BoolUtils.andb_91_call_1040", %TName_Bool** %"$BoolUtils.andb_92", align 8
  %"$$BoolUtils.andb_92_1041" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.andb_92", align 8
  store %TName_Bool* %"$$BoolUtils.andb_92_1041", %TName_Bool** %"$test_54", align 8
...
"$have_gas_1076":                                 ; preds = %"$out_of_gas_1075", %"$have_gas_1070"
  ...
  %"$sub_call_1083" = call %Int256* @_sub_Int256(i8* %"$execptr_load_1078", %Int256* %"$sub_$arg1_55_1079", %Int256* %"$sub_$arg2_56_1081")
  %"$sub_1085" = load %Int256, %Int256* %"$sub_call_1083", align 8
  store %Int256 %"$sub_1085", %Int256* %"$res_57", align 8
...
"$have_gas_1105":                                 ; preds = %"$out_of_gas_1104", %"$have_gas_1099"
  ...
  %"$eq_call_1112" = call %TName_Bool* @_eq_Int256(i8* %"$execptr_load_1107", %Int256* %"$eq_$res_57_1108", %Int256* %"$eq_$res__58_1110")
  store %TName_Bool* %"$eq_call_1112", %TName_Bool** %"$test__59", align 8
...
"$have_gas_1117":                                 ; preds = %"$out_of_gas_1116", %"$have_gas_1105"
  ...
  %"$BoolUtils.andb_call_1123" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_fptr_1120"(i8* %"$BoolUtils.andb_envptr_1121", %TName_Bool* %"$$test_54_1122")
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_call_1123", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.andb_93", align 8
  ...
  %"$$BoolUtils.andb_93_call_1128" = call %TName_Bool* %"$$BoolUtils.andb_93_fptr_1125"(i8* %"$$BoolUtils.andb_93_envptr_1126", %TName_Bool* %"$$test__59_1127")
  store %TName_Bool* %"$$BoolUtils.andb_93_call_1128", %TName_Bool** %"$BoolUtils.andb_94", align 8
  %"$$BoolUtils.andb_94_1129" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.andb_94", align 8
  store %TName_Bool* %"$$BoolUtils.andb_94_1129", %TName_Bool** %"$test_60", align 8
...
"$have_gas_1164":                                 ; preds = %"$out_of_gas_1163", %"$have_gas_1158"
  ...
  %"$sub_call_1171" = call %Int256* @_sub_Int256(i8* %"$execptr_load_1166", %Int256* %"$sub_$arg1_62_1167", %Int256* %"$sub_$arg2_61_1169")
  %"$sub_1173" = load %Int256, %Int256* %"$sub_call_1171", align 8
  store %Int256 %"$sub_1173", %Int256* %"$res_63", align 8
...
"$have_gas_1193":                                 ; preds = %"$out_of_gas_1192", %"$have_gas_1187"
  ...
  %"$eq_call_1200" = call %TName_Bool* @_eq_Int256(i8* %"$execptr_load_1195", %Int256* %"$eq_$res_63_1196", %Int256* %"$eq_$res__64_1198")
  store %TName_Bool* %"$eq_call_1200", %TName_Bool** %"$test__65", align 8
...
"$have_gas_1205":                                 ; preds = %"$out_of_gas_1204", %"$have_gas_1193"
  ...
  %"$BoolUtils.andb_call_1211" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_fptr_1208"(i8* %"$BoolUtils.andb_envptr_1209", %TName_Bool* %"$$test_60_1210")
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_call_1211", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.andb_95", align 8
  ...
  %"$$BoolUtils.andb_95_call_1216" = call %TName_Bool* %"$$BoolUtils.andb_95_fptr_1213"(i8* %"$$BoolUtils.andb_95_envptr_1214", %TName_Bool* %"$$test__65_1215")
  store %TName_Bool* %"$$BoolUtils.andb_95_call_1216", %TName_Bool** %"$BoolUtils.andb_96", align 8
  %"$$BoolUtils.andb_96_1217" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.andb_96", align 8
  store %TName_Bool* %"$$BoolUtils.andb_96_1217", %TName_Bool** %"$test_66", align 8
...
"$have_gas_1252":                                 ; preds = %"$out_of_gas_1251", %"$have_gas_1246"
  ...
  %"$sub_call_1259" = call %Int256* @_sub_Int256(i8* %"$execptr_load_1254", %Int256* %"$sub_$arg1_67_1255", %Int256* %"$sub_$arg2_68_1257")
  %"$sub_1261" = load %Int256, %Int256* %"$sub_call_1259", align 8
  store %Int256 %"$sub_1261", %Int256* %"$res_69", align 8
...
"$have_gas_1281":                                 ; preds = %"$out_of_gas_1280", %"$have_gas_1275"
  ...
  %"$eq_call_1288" = call %TName_Bool* @_eq_Int256(i8* %"$execptr_load_1283", %Int256* %"$eq_$res_69_1284", %Int256* %"$eq_$res__70_1286")
  store %TName_Bool* %"$eq_call_1288", %TName_Bool** %"$test__71", align 8
...
"$have_gas_1293":                                 ; preds = %"$out_of_gas_1292", %"$have_gas_1281"
  ...
  %"$BoolUtils.andb_call_1299" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_fptr_1296"(i8* %"$BoolUtils.andb_envptr_1297", %TName_Bool* %"$$test_66_1298")
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_call_1299", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.andb_97", align 8
  ...
  %"$$BoolUtils.andb_97_call_1304" = call %TName_Bool* %"$$BoolUtils.andb_97_fptr_1301"(i8* %"$$BoolUtils.andb_97_envptr_1302", %TName_Bool* %"$$test__71_1303")
  store %TName_Bool* %"$$BoolUtils.andb_97_call_1304", %TName_Bool** %"$BoolUtils.andb_98", align 8
  %"$$BoolUtils.andb_98_1305" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.andb_98", align 8
  store %TName_Bool* %"$$BoolUtils.andb_98_1305", %TName_Bool** %"$test_72", align 8
...
"$have_gas_1309":                                 ; preds = %"$out_of_gas_1308", %"$have_gas_1293"
  ...
  store %TName_Bool* %"$$test_72_1311", %TName_Bool** %"$expr_103", align 8
