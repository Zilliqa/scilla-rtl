...
define internal %TName_Bool* @"$fundef_107"(%"$$fundef_107_env_158"* %0, %TName_Bool* %1) {
entry:
...
"$have_gas_188":                                  ; preds = %"$out_of_gas_187", %"$False_183"
  ...
  store %TName_Bool* %"$adtptr_192", %TName_Bool** %"$retval_108", align 8
...
define internal { %TName_Bool* (i8*, %TName_Bool*)*, i8* } @"$fundef_105"(%"$$fundef_105_env_159"* %0, %TName_Bool* %1) {
entry:
...
"$have_gas_163":                                  ; preds = %"$out_of_gas_162", %entry
  ...
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$$fundef_107_cloval_168", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$retval_106", align 8
...
"$have_gas_214":                                  ; preds = %"$out_of_gas_213", %"$have_gas_209"
  ...
  store { { %TName_Bool* (i8*, %TName_Bool*)*, i8* } (i8*, %TName_Bool*)*, i8* } { { %TName_Bool* (i8*, %TName_Bool*)*, i8* } (i8*, %TName_Bool*)* bitcast ({ %TName_Bool* (i8*, %TName_Bool*)*, i8* } (%"$$fundef_105_env_159"*, %TName_Bool*)* @"$fundef_105" to { %TName_Bool* (i8*, %TName_Bool*)*, i8* } (i8*, %TName_Bool*)*), i8* null }, { { %TName_Bool* (i8*, %TName_Bool*)*, i8* } (i8*, %TName_Bool*)*, i8* }* @BoolUtils.andb, align 8
...
"$have_gas_257":                                  ; preds = %"$out_of_gas_256", %"$have_gas_252"
  ...
  store %TName_Bool* %"$adtptr_261", %TName_Bool** %test, align 8
...
"$have_gas_295":                                  ; preds = %"$out_of_gas_294", %"$have_gas_290"
  ...
  %"$sub_call_299" = call %Uint32 @_sub_Uint32(%Uint32 %"$arg1_297", %Uint32 %"$arg2_298")
  store %Uint32 %"$sub_call_299", %Uint32* %res, align 4
...
"$have_gas_318":                                  ; preds = %"$out_of_gas_317", %"$have_gas_313"
  ...
  %"$eq_call_323" = call %TName_Bool* @_eq_Uint32(i8* %"$execptr_load_320", %Uint32 %"$res_321", %Uint32 %"$res__322")
  store %TName_Bool* %"$eq_call_323", %TName_Bool** %test_, align 8
...
"$have_gas_328":                                  ; preds = %"$out_of_gas_327", %"$have_gas_318"
  ...
  %"$BoolUtils.andb_call_334" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_fptr_331"(i8* %"$BoolUtils.andb_envptr_332", %TName_Bool* %"$test_333")
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_call_334", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.andb_79", align 8
  ...
  %"$$BoolUtils.andb_79_call_339" = call %TName_Bool* %"$$BoolUtils.andb_79_fptr_336"(i8* %"$$BoolUtils.andb_79_envptr_337", %TName_Bool* %"$test__338")
  store %TName_Bool* %"$$BoolUtils.andb_79_call_339", %TName_Bool** %"$BoolUtils.andb_80", align 8
  %"$$BoolUtils.andb_80_340" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.andb_80", align 8
  store %TName_Bool* %"$$BoolUtils.andb_80_340", %TName_Bool** %"$test_6", align 8
...
"$have_gas_374":                                  ; preds = %"$out_of_gas_373", %"$have_gas_369"
  ...
  %"$sub_call_378" = call %Int32 @_sub_Int32(%Int32 %"$$arg1_8_376", %Int32 %"$$arg2_7_377")
  store %Int32 %"$sub_call_378", %Int32* %"$res_9", align 4
...
"$have_gas_397":                                  ; preds = %"$out_of_gas_396", %"$have_gas_392"
  ...
  %"$eq_call_402" = call %TName_Bool* @_eq_Int32(i8* %"$execptr_load_399", %Int32 %"$$res_9_400", %Int32 %"$$res__10_401")
  store %TName_Bool* %"$eq_call_402", %TName_Bool** %"$test__11", align 8
...
"$have_gas_407":                                  ; preds = %"$out_of_gas_406", %"$have_gas_397"
  ...
  %"$BoolUtils.andb_call_413" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_fptr_410"(i8* %"$BoolUtils.andb_envptr_411", %TName_Bool* %"$$test_6_412")
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_call_413", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.andb_81", align 8
  ...
  %"$$BoolUtils.andb_81_call_418" = call %TName_Bool* %"$$BoolUtils.andb_81_fptr_415"(i8* %"$$BoolUtils.andb_81_envptr_416", %TName_Bool* %"$$test__11_417")
  store %TName_Bool* %"$$BoolUtils.andb_81_call_418", %TName_Bool** %"$BoolUtils.andb_82", align 8
  %"$$BoolUtils.andb_82_419" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.andb_82", align 8
  store %TName_Bool* %"$$BoolUtils.andb_82_419", %TName_Bool** %"$test_12", align 8
...
"$have_gas_453":                                  ; preds = %"$out_of_gas_452", %"$have_gas_448"
  ...
  %"$sub_call_457" = call %Uint64 @_sub_Uint64(%Uint64 %"$$arg1_13_455", %Uint64 %"$$arg2_14_456")
  store %Uint64 %"$sub_call_457", %Uint64* %"$res_15", align 8
...
"$have_gas_476":                                  ; preds = %"$out_of_gas_475", %"$have_gas_471"
  ...
  %"$eq_call_481" = call %TName_Bool* @_eq_Uint64(i8* %"$execptr_load_478", %Uint64 %"$$res_15_479", %Uint64 %"$$res__16_480")
  store %TName_Bool* %"$eq_call_481", %TName_Bool** %"$test__17", align 8
...
"$have_gas_486":                                  ; preds = %"$out_of_gas_485", %"$have_gas_476"
  ...
  %"$BoolUtils.andb_call_492" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_fptr_489"(i8* %"$BoolUtils.andb_envptr_490", %TName_Bool* %"$$test_12_491")
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_call_492", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.andb_83", align 8
  ...
  %"$$BoolUtils.andb_83_call_497" = call %TName_Bool* %"$$BoolUtils.andb_83_fptr_494"(i8* %"$$BoolUtils.andb_83_envptr_495", %TName_Bool* %"$$test__17_496")
  store %TName_Bool* %"$$BoolUtils.andb_83_call_497", %TName_Bool** %"$BoolUtils.andb_84", align 8
  %"$$BoolUtils.andb_84_498" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.andb_84", align 8
  store %TName_Bool* %"$$BoolUtils.andb_84_498", %TName_Bool** %"$test_18", align 8
...
"$have_gas_532":                                  ; preds = %"$out_of_gas_531", %"$have_gas_527"
  ...
  %"$sub_call_536" = call %Int64 @_sub_Int64(%Int64 %"$$arg1_20_534", %Int64 %"$$arg2_19_535")
  store %Int64 %"$sub_call_536", %Int64* %"$res_21", align 8
...
"$have_gas_555":                                  ; preds = %"$out_of_gas_554", %"$have_gas_550"
  ...
  %"$eq_call_560" = call %TName_Bool* @_eq_Int64(i8* %"$execptr_load_557", %Int64 %"$$res_21_558", %Int64 %"$$res__22_559")
  store %TName_Bool* %"$eq_call_560", %TName_Bool** %"$test__23", align 8
...
"$have_gas_565":                                  ; preds = %"$out_of_gas_564", %"$have_gas_555"
  ...
  %"$BoolUtils.andb_call_571" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_fptr_568"(i8* %"$BoolUtils.andb_envptr_569", %TName_Bool* %"$$test_18_570")
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_call_571", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.andb_85", align 8
  ...
  %"$$BoolUtils.andb_85_call_576" = call %TName_Bool* %"$$BoolUtils.andb_85_fptr_573"(i8* %"$$BoolUtils.andb_85_envptr_574", %TName_Bool* %"$$test__23_575")
  store %TName_Bool* %"$$BoolUtils.andb_85_call_576", %TName_Bool** %"$BoolUtils.andb_86", align 8
  %"$$BoolUtils.andb_86_577" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.andb_86", align 8
  store %TName_Bool* %"$$BoolUtils.andb_86_577", %TName_Bool** %"$test_24", align 8
...
"$have_gas_611":                                  ; preds = %"$out_of_gas_610", %"$have_gas_606"
  ...
  %"$sub_call_615" = call %Int64 @_sub_Int64(%Int64 %"$$arg1_25_613", %Int64 %"$$arg2_26_614")
  store %Int64 %"$sub_call_615", %Int64* %"$res_27", align 8
...
"$have_gas_634":                                  ; preds = %"$out_of_gas_633", %"$have_gas_629"
  ...
  %"$eq_call_639" = call %TName_Bool* @_eq_Int64(i8* %"$execptr_load_636", %Int64 %"$$res_27_637", %Int64 %"$$res__28_638")
  store %TName_Bool* %"$eq_call_639", %TName_Bool** %"$test__29", align 8
...
"$have_gas_644":                                  ; preds = %"$out_of_gas_643", %"$have_gas_634"
  ...
  %"$BoolUtils.andb_call_650" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_fptr_647"(i8* %"$BoolUtils.andb_envptr_648", %TName_Bool* %"$$test_24_649")
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_call_650", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.andb_87", align 8
  ...
  %"$$BoolUtils.andb_87_call_655" = call %TName_Bool* %"$$BoolUtils.andb_87_fptr_652"(i8* %"$$BoolUtils.andb_87_envptr_653", %TName_Bool* %"$$test__29_654")
  store %TName_Bool* %"$$BoolUtils.andb_87_call_655", %TName_Bool** %"$BoolUtils.andb_88", align 8
  %"$$BoolUtils.andb_88_656" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.andb_88", align 8
  store %TName_Bool* %"$$BoolUtils.andb_88_656", %TName_Bool** %"$test_30", align 8
...
"$have_gas_691":                                  ; preds = %"$out_of_gas_690", %"$have_gas_685"
  ...
  %"$sub_call_695" = call %Uint128 @_sub_Uint128(%Uint128 %"$$arg1_31_693", %Uint128 %"$$arg2_32_694")
  store %Uint128 %"$sub_call_695", %Uint128* %"$res_33", align 8
...
"$have_gas_715":                                  ; preds = %"$out_of_gas_714", %"$have_gas_709"
  ...
  %"$eq_call_720" = call %TName_Bool* @_eq_Uint128(i8* %"$execptr_load_717", %Uint128 %"$$res_33_718", %Uint128 %"$$res__34_719")
  store %TName_Bool* %"$eq_call_720", %TName_Bool** %"$test__35", align 8
...
"$have_gas_725":                                  ; preds = %"$out_of_gas_724", %"$have_gas_715"
  ...
  %"$BoolUtils.andb_call_731" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_fptr_728"(i8* %"$BoolUtils.andb_envptr_729", %TName_Bool* %"$$test_30_730")
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_call_731", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.andb_89", align 8
  ...
  %"$$BoolUtils.andb_89_call_736" = call %TName_Bool* %"$$BoolUtils.andb_89_fptr_733"(i8* %"$$BoolUtils.andb_89_envptr_734", %TName_Bool* %"$$test__35_735")
  store %TName_Bool* %"$$BoolUtils.andb_89_call_736", %TName_Bool** %"$BoolUtils.andb_90", align 8
  %"$$BoolUtils.andb_90_737" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.andb_90", align 8
  store %TName_Bool* %"$$BoolUtils.andb_90_737", %TName_Bool** %"$test_36", align 8
...
"$have_gas_772":                                  ; preds = %"$out_of_gas_771", %"$have_gas_766"
  ...
  %"$sub_call_776" = call %Uint128 @_sub_Uint128(%Uint128 %"$$arg1_37_774", %Uint128 %"$$arg2_38_775")
  store %Uint128 %"$sub_call_776", %Uint128* %"$res_39", align 8
...
"$have_gas_796":                                  ; preds = %"$out_of_gas_795", %"$have_gas_790"
  ...
  %"$eq_call_801" = call %TName_Bool* @_eq_Uint128(i8* %"$execptr_load_798", %Uint128 %"$$res_39_799", %Uint128 %"$$res__40_800")
  store %TName_Bool* %"$eq_call_801", %TName_Bool** %"$test__41", align 8
...
"$have_gas_806":                                  ; preds = %"$out_of_gas_805", %"$have_gas_796"
  ...
  %"$BoolUtils.andb_call_812" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_fptr_809"(i8* %"$BoolUtils.andb_envptr_810", %TName_Bool* %"$$test_36_811")
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_call_812", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.andb_91", align 8
  ...
  %"$$BoolUtils.andb_91_call_817" = call %TName_Bool* %"$$BoolUtils.andb_91_fptr_814"(i8* %"$$BoolUtils.andb_91_envptr_815", %TName_Bool* %"$$test__41_816")
  store %TName_Bool* %"$$BoolUtils.andb_91_call_817", %TName_Bool** %"$BoolUtils.andb_92", align 8
  %"$$BoolUtils.andb_92_818" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.andb_92", align 8
  store %TName_Bool* %"$$BoolUtils.andb_92_818", %TName_Bool** %"$test_42", align 8
...
"$have_gas_853":                                  ; preds = %"$out_of_gas_852", %"$have_gas_847"
  ...
  %"$sub_call_860" = call %Uint256* @_sub_Uint256(i8* %"$execptr_load_855", %Uint256* %"$sub_$arg1_43_856", %Uint256* %"$sub_$arg2_44_858")
  %"$sub_862" = load %Uint256, %Uint256* %"$sub_call_860", align 8
  store %Uint256 %"$sub_862", %Uint256* %"$res_45", align 8
...
"$have_gas_882":                                  ; preds = %"$out_of_gas_881", %"$have_gas_876"
  ...
  %"$eq_call_889" = call %TName_Bool* @_eq_Uint256(i8* %"$execptr_load_884", %Uint256* %"$eq_$res_45_885", %Uint256* %"$eq_$res__46_887")
  store %TName_Bool* %"$eq_call_889", %TName_Bool** %"$test__47", align 8
...
"$have_gas_894":                                  ; preds = %"$out_of_gas_893", %"$have_gas_882"
  ...
  %"$BoolUtils.andb_call_900" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_fptr_897"(i8* %"$BoolUtils.andb_envptr_898", %TName_Bool* %"$$test_42_899")
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_call_900", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.andb_93", align 8
  ...
  %"$$BoolUtils.andb_93_call_905" = call %TName_Bool* %"$$BoolUtils.andb_93_fptr_902"(i8* %"$$BoolUtils.andb_93_envptr_903", %TName_Bool* %"$$test__47_904")
  store %TName_Bool* %"$$BoolUtils.andb_93_call_905", %TName_Bool** %"$BoolUtils.andb_94", align 8
  %"$$BoolUtils.andb_94_906" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.andb_94", align 8
  store %TName_Bool* %"$$BoolUtils.andb_94_906", %TName_Bool** %"$test_48", align 8
...
"$have_gas_941":                                  ; preds = %"$out_of_gas_940", %"$have_gas_935"
  ...
  %"$sub_call_948" = call %Uint256* @_sub_Uint256(i8* %"$execptr_load_943", %Uint256* %"$sub_$arg1_49_944", %Uint256* %"$sub_$arg2_50_946")
  %"$sub_950" = load %Uint256, %Uint256* %"$sub_call_948", align 8
  store %Uint256 %"$sub_950", %Uint256* %"$res_51", align 8
...
"$have_gas_970":                                  ; preds = %"$out_of_gas_969", %"$have_gas_964"
  ...
  %"$eq_call_977" = call %TName_Bool* @_eq_Uint256(i8* %"$execptr_load_972", %Uint256* %"$eq_$res_51_973", %Uint256* %"$eq_$res__52_975")
  store %TName_Bool* %"$eq_call_977", %TName_Bool** %"$test__53", align 8
...
"$have_gas_982":                                  ; preds = %"$out_of_gas_981", %"$have_gas_970"
  ...
  %"$BoolUtils.andb_call_988" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_fptr_985"(i8* %"$BoolUtils.andb_envptr_986", %TName_Bool* %"$$test_48_987")
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_call_988", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.andb_95", align 8
  ...
  %"$$BoolUtils.andb_95_call_993" = call %TName_Bool* %"$$BoolUtils.andb_95_fptr_990"(i8* %"$$BoolUtils.andb_95_envptr_991", %TName_Bool* %"$$test__53_992")
  store %TName_Bool* %"$$BoolUtils.andb_95_call_993", %TName_Bool** %"$BoolUtils.andb_96", align 8
  %"$$BoolUtils.andb_96_994" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.andb_96", align 8
  store %TName_Bool* %"$$BoolUtils.andb_96_994", %TName_Bool** %"$test_54", align 8
...
"$have_gas_1029":                                 ; preds = %"$out_of_gas_1028", %"$have_gas_1023"
  ...
  %"$sub_call_1036" = call %Uint256* @_sub_Uint256(i8* %"$execptr_load_1031", %Uint256* %"$sub_$arg1_55_1032", %Uint256* %"$sub_$arg2_56_1034")
  %"$sub_1038" = load %Uint256, %Uint256* %"$sub_call_1036", align 8
  store %Uint256 %"$sub_1038", %Uint256* %"$res_57", align 8
...
"$have_gas_1058":                                 ; preds = %"$out_of_gas_1057", %"$have_gas_1052"
  ...
  %"$eq_call_1065" = call %TName_Bool* @_eq_Uint256(i8* %"$execptr_load_1060", %Uint256* %"$eq_$res_57_1061", %Uint256* %"$eq_$res__58_1063")
  store %TName_Bool* %"$eq_call_1065", %TName_Bool** %"$test__59", align 8
...
"$have_gas_1070":                                 ; preds = %"$out_of_gas_1069", %"$have_gas_1058"
  ...
  %"$BoolUtils.andb_call_1076" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_fptr_1073"(i8* %"$BoolUtils.andb_envptr_1074", %TName_Bool* %"$$test_54_1075")
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_call_1076", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.andb_97", align 8
  ...
  %"$$BoolUtils.andb_97_call_1081" = call %TName_Bool* %"$$BoolUtils.andb_97_fptr_1078"(i8* %"$$BoolUtils.andb_97_envptr_1079", %TName_Bool* %"$$test__59_1080")
  store %TName_Bool* %"$$BoolUtils.andb_97_call_1081", %TName_Bool** %"$BoolUtils.andb_98", align 8
  %"$$BoolUtils.andb_98_1082" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.andb_98", align 8
  store %TName_Bool* %"$$BoolUtils.andb_98_1082", %TName_Bool** %"$test_60", align 8
...
"$have_gas_1117":                                 ; preds = %"$out_of_gas_1116", %"$have_gas_1111"
  ...
  %"$sub_call_1124" = call %Int256* @_sub_Int256(i8* %"$execptr_load_1119", %Int256* %"$sub_$arg1_61_1120", %Int256* %"$sub_$arg2_62_1122")
  %"$sub_1126" = load %Int256, %Int256* %"$sub_call_1124", align 8
  store %Int256 %"$sub_1126", %Int256* %"$res_63", align 8
...
"$have_gas_1146":                                 ; preds = %"$out_of_gas_1145", %"$have_gas_1140"
  ...
  %"$eq_call_1153" = call %TName_Bool* @_eq_Int256(i8* %"$execptr_load_1148", %Int256* %"$eq_$res_63_1149", %Int256* %"$eq_$res__64_1151")
  store %TName_Bool* %"$eq_call_1153", %TName_Bool** %"$test__65", align 8
...
"$have_gas_1158":                                 ; preds = %"$out_of_gas_1157", %"$have_gas_1146"
  ...
  %"$BoolUtils.andb_call_1164" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_fptr_1161"(i8* %"$BoolUtils.andb_envptr_1162", %TName_Bool* %"$$test_60_1163")
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_call_1164", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.andb_99", align 8
  ...
  %"$$BoolUtils.andb_99_call_1169" = call %TName_Bool* %"$$BoolUtils.andb_99_fptr_1166"(i8* %"$$BoolUtils.andb_99_envptr_1167", %TName_Bool* %"$$test__65_1168")
  store %TName_Bool* %"$$BoolUtils.andb_99_call_1169", %TName_Bool** %"$BoolUtils.andb_100", align 8
  %"$$BoolUtils.andb_100_1170" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.andb_100", align 8
  store %TName_Bool* %"$$BoolUtils.andb_100_1170", %TName_Bool** %"$test_66", align 8
...
"$have_gas_1205":                                 ; preds = %"$out_of_gas_1204", %"$have_gas_1199"
  ...
  %"$sub_call_1212" = call %Int256* @_sub_Int256(i8* %"$execptr_load_1207", %Int256* %"$sub_$arg1_68_1208", %Int256* %"$sub_$arg2_67_1210")
  %"$sub_1214" = load %Int256, %Int256* %"$sub_call_1212", align 8
  store %Int256 %"$sub_1214", %Int256* %"$res_69", align 8
...
"$have_gas_1234":                                 ; preds = %"$out_of_gas_1233", %"$have_gas_1228"
  ...
  %"$eq_call_1241" = call %TName_Bool* @_eq_Int256(i8* %"$execptr_load_1236", %Int256* %"$eq_$res_69_1237", %Int256* %"$eq_$res__70_1239")
  store %TName_Bool* %"$eq_call_1241", %TName_Bool** %"$test__71", align 8
...
"$have_gas_1246":                                 ; preds = %"$out_of_gas_1245", %"$have_gas_1234"
  ...
  %"$BoolUtils.andb_call_1252" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_fptr_1249"(i8* %"$BoolUtils.andb_envptr_1250", %TName_Bool* %"$$test_66_1251")
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_call_1252", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.andb_101", align 8
  ...
  %"$$BoolUtils.andb_101_call_1257" = call %TName_Bool* %"$$BoolUtils.andb_101_fptr_1254"(i8* %"$$BoolUtils.andb_101_envptr_1255", %TName_Bool* %"$$test__71_1256")
  store %TName_Bool* %"$$BoolUtils.andb_101_call_1257", %TName_Bool** %"$BoolUtils.andb_102", align 8
  %"$$BoolUtils.andb_102_1258" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.andb_102", align 8
  store %TName_Bool* %"$$BoolUtils.andb_102_1258", %TName_Bool** %"$test_72", align 8
...
"$have_gas_1293":                                 ; preds = %"$out_of_gas_1292", %"$have_gas_1287"
  ...
  %"$sub_call_1300" = call %Int256* @_sub_Int256(i8* %"$execptr_load_1295", %Int256* %"$sub_$arg1_73_1296", %Int256* %"$sub_$arg2_74_1298")
  %"$sub_1302" = load %Int256, %Int256* %"$sub_call_1300", align 8
  store %Int256 %"$sub_1302", %Int256* %"$res_75", align 8
...
"$have_gas_1322":                                 ; preds = %"$out_of_gas_1321", %"$have_gas_1316"
  ...
  %"$eq_call_1329" = call %TName_Bool* @_eq_Int256(i8* %"$execptr_load_1324", %Int256* %"$eq_$res_75_1325", %Int256* %"$eq_$res__76_1327")
  store %TName_Bool* %"$eq_call_1329", %TName_Bool** %"$test__77", align 8
...
"$have_gas_1334":                                 ; preds = %"$out_of_gas_1333", %"$have_gas_1322"
  ...
  %"$BoolUtils.andb_call_1340" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_fptr_1337"(i8* %"$BoolUtils.andb_envptr_1338", %TName_Bool* %"$$test_72_1339")
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_call_1340", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.andb_103", align 8
  ...
  %"$$BoolUtils.andb_103_call_1345" = call %TName_Bool* %"$$BoolUtils.andb_103_fptr_1342"(i8* %"$$BoolUtils.andb_103_envptr_1343", %TName_Bool* %"$$test__77_1344")
  store %TName_Bool* %"$$BoolUtils.andb_103_call_1345", %TName_Bool** %"$BoolUtils.andb_104", align 8
  %"$$BoolUtils.andb_104_1346" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.andb_104", align 8
  store %TName_Bool* %"$$BoolUtils.andb_104_1346", %TName_Bool** %"$test_78", align 8
...
"$have_gas_1350":                                 ; preds = %"$out_of_gas_1349", %"$have_gas_1334"
  ...
  store %TName_Bool* %"$$test_78_1352", %TName_Bool** %"$expr_109", align 8
