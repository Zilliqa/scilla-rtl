...
"$have_gas_98":                                   ; preds = %"$out_of_gas_97", %"$have_gas_92"
  ...
  %"$add_call_105" = call %Int256* @_add_Int256(i8* %"$execptr_load_100", %Int256* %"$add_one_101", %Int256* %"$add_two_103"), !dbg !13
  %"$add_107" = load %Int256, %Int256* %"$add_call_105", align 8
  store %Int256 %"$add_107", %Int256* %"$expr_6", align 8, !dbg !13
