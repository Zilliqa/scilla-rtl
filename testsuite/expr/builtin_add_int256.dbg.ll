...
"$have_gas_60":                                   ; preds = %"$out_of_gas_59", %"$have_gas_54"
  ...
  %"$add_one_63" = alloca %Int256, align 8
  %"$one_64" = load %Int256, %Int256* %one, align 8
  store %Int256 %"$one_64", %Int256* %"$add_one_63", align 8
  %"$add_two_65" = alloca %Int256, align 8
  %"$two_66" = load %Int256, %Int256* %two, align 8
  store %Int256 %"$two_66", %Int256* %"$add_two_65", align 8
  %"$add_call_67" = call %Int256* @_add_Int256(i8* %"$execptr_load_62", %Int256* %"$add_one_63", %Int256* %"$add_two_65"), !dbg !12
  %"$add_69" = load %Int256, %Int256* %"$add_call_67", align 8
  store %Int256 %"$add_69", %Int256* %"$expr_0", align 8, !dbg !12
  %"$$expr_0_70" = load %Int256, %Int256* %"$expr_0", align 8
  store %Int256 %"$$expr_0_70", %Int256* %1, align 8
  ret void
}
...
entry:
  %"$mainval_71" = alloca %Int256, align 8
  %"$memvoidcast_72" = bitcast %Int256* %"$mainval_71" to i8*
  call void @_scilla_expr_fun(i8* null, %Int256* %"$mainval_71")
  %"$execptr_load_73" = load i8*, i8** @_execptr, align 8
  call void @_print_scilla_val(i8* %"$execptr_load_73", %_TyDescrTy_Typ* @"$TyDescr_Int256_15", i8* %"$memvoidcast_72")
  ret void
}
