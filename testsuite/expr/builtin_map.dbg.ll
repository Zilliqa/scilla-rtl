...
"$have_gas_288":                                  ; preds = %"$out_of_gas_287", %"$Some_281"
  ...
  store %TName_Bool* %"$contains_call_296", %TName_Bool** %p11, align 8, !dbg !30
...
"$have_gas_305":                                  ; preds = %"$out_of_gas_304", %"$have_gas_300"
  ...
  %"$bool_to_uint_call_311" = call %Uint32 %"$bool_to_uint_fptr_308"(i8* %"$bool_to_uint_envptr_309", %TName_Bool* %"$p1_310"), !dbg !33
  store %Uint32 %"$bool_to_uint_call_311", %Uint32* %"$bool_to_uint_3", align 4, !dbg !33
  %"$$bool_to_uint_3_312" = load %Uint32, %Uint32* %"$bool_to_uint_3", align 4
  store %Uint32 %"$$bool_to_uint_3_312", %Uint32* %p1_i, align 4, !dbg !33
...
"$have_gas_316":                                  ; preds = %"$out_of_gas_315", %"$have_gas_305"
  ...
  store %TName_Bool* %"$contains_call_324", %TName_Bool** %p2, align 8, !dbg !34
...
"$have_gas_333":                                  ; preds = %"$out_of_gas_332", %"$have_gas_328"
  ...
  %"$bool_to_uint_call_339" = call %Uint32 %"$bool_to_uint_fptr_336"(i8* %"$bool_to_uint_envptr_337", %TName_Bool* %"$p2_338"), !dbg !35
  store %Uint32 %"$bool_to_uint_call_339", %Uint32* %"$bool_to_uint_4", align 4, !dbg !35
  %"$$bool_to_uint_4_340" = load %Uint32, %Uint32* %"$bool_to_uint_4", align 4
  store %Uint32 %"$$bool_to_uint_4_340", %Uint32* %p2_i, align 4, !dbg !35
...
"$have_gas_344":                                  ; preds = %"$out_of_gas_343", %"$have_gas_333"
  ...
  store %Uint32 %"$add_call_348", %Uint32* %p3, align 4, !dbg !36
...
"$have_gas_365":                                  ; preds = %"$out_of_gas_364", %"$have_gas_352"
  ...
  store %TName_Bool* %"$contains_call_373", %TName_Bool** %p5, align 8, !dbg !38
...
"$have_gas_382":                                  ; preds = %"$out_of_gas_381", %"$have_gas_377"
  ...
  %"$bool_to_uint_call_388" = call %Uint32 %"$bool_to_uint_fptr_385"(i8* %"$bool_to_uint_envptr_386", %TName_Bool* %"$p5_387"), !dbg !39
  store %Uint32 %"$bool_to_uint_call_388", %Uint32* %"$bool_to_uint_5", align 4, !dbg !39
  %"$$bool_to_uint_5_389" = load %Uint32, %Uint32* %"$bool_to_uint_5", align 4
  store %Uint32 %"$$bool_to_uint_5_389", %Uint32* %p5_i, align 4, !dbg !39
...
"$have_gas_393":                                  ; preds = %"$out_of_gas_392", %"$have_gas_382"
  ...
  store %Uint32 %"$add_call_397", %Uint32* %p6, align 4, !dbg !40
...
"$have_gas_433":                                  ; preds = %"$out_of_gas_432", %"$have_gas_417"
  ...
  store %Uint32 %"$size_call_437", %Uint32* %p7_i, align 4, !dbg !43
  ...
  store %Uint32 %"$add_call_440", %Uint32* %"$expr_7", align 4, !dbg !44
...
"$have_gas_254":                                  ; preds = %"$out_of_gas_253", %"$have_gas_249"
  ...
  %"$bool_to_uint_call_260" = call %Uint32 %"$bool_to_uint_fptr_257"(i8* %"$bool_to_uint_envptr_258", %TName_Bool* %"$p_259"), !dbg !47
  store %Uint32 %"$bool_to_uint_call_260", %Uint32* %"$bool_to_uint_6", align 4, !dbg !47
  %"$$bool_to_uint_6_261" = load %Uint32, %Uint32* %"$bool_to_uint_6", align 4
  store %Uint32 %"$$bool_to_uint_6_261", %Uint32* %p1, align 4, !dbg !47
...
"$have_gas_265":                                  ; preds = %"$out_of_gas_264", %"$have_gas_254"
  ...
  store %Uint32 %"$p1_267", %Uint32* %"$expr_7", align 4, !dbg !48
  br label %"$matchsucc_233"
