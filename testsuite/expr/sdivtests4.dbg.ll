...
"$have_gas_56":                                   ; preds = %"$out_of_gas_55", %"$have_gas_51"
  ...
  store %Int256 { i256 -1001 }, %Int256* %b, align 8, !dbg !10
...
"$have_gas_66":                                   ; preds = %"$out_of_gas_65", %"$have_gas_61"
  ...
  store %Int256 { i256 31 }, %Int256* %a, align 8, !dbg !11
...
"$have_gas_133":                                  ; preds = %"$out_of_gas_132", %"$have_gas_128"
  ...
  store %Int256 { i256 101111111111111 }, %Int256* %"$b_0", align 8, !dbg !15
...
"$have_gas_143":                                  ; preds = %"$out_of_gas_142", %"$have_gas_138"
  ...
  store %Int256 { i256 -311111111111 }, %Int256* %"$a_1", align 8, !dbg !16
...
"$have_gas_210":                                  ; preds = %"$out_of_gas_209", %"$have_gas_205"
  ...
  store %Int256 { i256 -10 }, %Int256* %"$b_4", align 8, !dbg !20
...
"$have_gas_220":                                  ; preds = %"$out_of_gas_219", %"$have_gas_215"
  ...
  store %Int256 { i256 -3 }, %Int256* %"$a_5", align 8, !dbg !21
...
"$have_gas_287":                                  ; preds = %"$out_of_gas_286", %"$have_gas_282"
  ...
  store %Int256 { i256 10 }, %Int256* %"$b_8", align 8, !dbg !25
...
"$have_gas_297":                                  ; preds = %"$out_of_gas_296", %"$have_gas_292"
  ...
  store %Int256 { i256 3 }, %Int256* %"$a_9", align 8, !dbg !26
