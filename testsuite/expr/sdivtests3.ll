...
"$have_gas_113":                                  ; preds = %"$out_of_gas_112", %"$have_gas_107"
  ...
  %"$div_call_120" = call %Int256* @_div_Int256(i8* %"$execptr_load_115", %Int256* %"$div_a_116", %Int256* %"$div_b_118")
  %"$div_122" = load %Int256, %Int256* %"$div_call_120", align 8
  store %Int256 %"$div_122", %Int256* %res_div, align 8
...
"$have_gas_132":                                  ; preds = %"$out_of_gas_131", %"$have_gas_126"
  ...
  %"$rem_call_139" = call %Int256* @_rem_Int256(i8* %"$execptr_load_134", %Int256* %"$rem_a_135", %Int256* %"$rem_b_137")
  %"$rem_141" = load %Int256, %Int256* %"$rem_call_139", align 8
  store %Int256 %"$rem_141", %Int256* %res_rem, align 8
...
"$have_gas_151":                                  ; preds = %"$out_of_gas_150", %"$have_gas_145"
  ...
  %"$add_call_158" = call %Int256* @_add_Int256(i8* %"$execptr_load_153", %Int256* %"$add_res_div_154", %Int256* %"$add_res_rem_156")
  %"$add_160" = load %Int256, %Int256* %"$add_call_158", align 8
  store %Int256 %"$add_160", %Int256* %res1, align 8
...
"$have_gas_190":                                  ; preds = %"$out_of_gas_189", %"$have_gas_184"
  ...
  %"$div_call_197" = call %Int256* @_div_Int256(i8* %"$execptr_load_192", %Int256* %"$div_$a_7_193", %Int256* %"$div_$b_6_195")
  %"$div_199" = load %Int256, %Int256* %"$div_call_197", align 8
  store %Int256 %"$div_199", %Int256* %"$res_div_8", align 8
...
"$have_gas_209":                                  ; preds = %"$out_of_gas_208", %"$have_gas_203"
  ...
  %"$rem_call_216" = call %Int256* @_rem_Int256(i8* %"$execptr_load_211", %Int256* %"$rem_$a_7_212", %Int256* %"$rem_$b_6_214")
  %"$rem_218" = load %Int256, %Int256* %"$rem_call_216", align 8
  store %Int256 %"$rem_218", %Int256* %"$res_rem_9", align 8
...
"$have_gas_228":                                  ; preds = %"$out_of_gas_227", %"$have_gas_222"
  ...
  %"$add_call_235" = call %Int256* @_add_Int256(i8* %"$execptr_load_230", %Int256* %"$add_$res_div_8_231", %Int256* %"$add_$res_rem_9_233")
  %"$add_237" = load %Int256, %Int256* %"$add_call_235", align 8
  store %Int256 %"$add_237", %Int256* %res2, align 8
...
"$have_gas_267":                                  ; preds = %"$out_of_gas_266", %"$have_gas_261"
  ...
  %"$div_call_274" = call %Int256* @_div_Int256(i8* %"$execptr_load_269", %Int256* %"$div_$a_11_270", %Int256* %"$div_$b_10_272")
  %"$div_276" = load %Int256, %Int256* %"$div_call_274", align 8
  store %Int256 %"$div_276", %Int256* %"$res_div_12", align 8
...
"$have_gas_286":                                  ; preds = %"$out_of_gas_285", %"$have_gas_280"
  ...
  %"$rem_call_293" = call %Int256* @_rem_Int256(i8* %"$execptr_load_288", %Int256* %"$rem_$a_11_289", %Int256* %"$rem_$b_10_291")
  %"$rem_295" = load %Int256, %Int256* %"$rem_call_293", align 8
  store %Int256 %"$rem_295", %Int256* %"$res_rem_13", align 8
...
"$have_gas_305":                                  ; preds = %"$out_of_gas_304", %"$have_gas_299"
  ...
  %"$add_call_312" = call %Int256* @_add_Int256(i8* %"$execptr_load_307", %Int256* %"$add_$res_div_12_308", %Int256* %"$add_$res_rem_13_310")
  %"$add_314" = load %Int256, %Int256* %"$add_call_312", align 8
  store %Int256 %"$add_314", %Int256* %res3, align 8
...
"$have_gas_344":                                  ; preds = %"$out_of_gas_343", %"$have_gas_338"
  ...
  %"$div_call_351" = call %Int256* @_div_Int256(i8* %"$execptr_load_346", %Int256* %"$div_$a_15_347", %Int256* %"$div_$b_14_349")
  %"$div_353" = load %Int256, %Int256* %"$div_call_351", align 8
  store %Int256 %"$div_353", %Int256* %"$res_div_16", align 8
...
"$have_gas_363":                                  ; preds = %"$out_of_gas_362", %"$have_gas_357"
  ...
  %"$rem_call_370" = call %Int256* @_rem_Int256(i8* %"$execptr_load_365", %Int256* %"$rem_$a_15_366", %Int256* %"$rem_$b_14_368")
  %"$rem_372" = load %Int256, %Int256* %"$rem_call_370", align 8
  store %Int256 %"$rem_372", %Int256* %"$res_rem_17", align 8
...
"$have_gas_382":                                  ; preds = %"$out_of_gas_381", %"$have_gas_376"
  ...
  %"$add_call_389" = call %Int256* @_add_Int256(i8* %"$execptr_load_384", %Int256* %"$add_$res_div_16_385", %Int256* %"$add_$res_rem_17_387")
  %"$add_391" = load %Int256, %Int256* %"$add_call_389", align 8
  store %Int256 %"$add_391", %Int256* %res4, align 8
...
"$have_gas_401":                                  ; preds = %"$out_of_gas_400", %"$have_gas_395"
  ...
  %"$add_call_408" = call %Int256* @_add_Int256(i8* %"$execptr_load_403", %Int256* %"$add_res1_404", %Int256* %"$add_res2_406")
  %"$add_410" = load %Int256, %Int256* %"$add_call_408", align 8
  store %Int256 %"$add_410", %Int256* %res5, align 8
...
"$have_gas_420":                                  ; preds = %"$out_of_gas_419", %"$have_gas_414"
  ...
  %"$add_call_427" = call %Int256* @_add_Int256(i8* %"$execptr_load_422", %Int256* %"$add_res5_423", %Int256* %"$add_res3_425")
  %"$add_429" = load %Int256, %Int256* %"$add_call_427", align 8
  store %Int256 %"$add_429", %Int256* %res6, align 8
...
"$have_gas_439":                                  ; preds = %"$out_of_gas_438", %"$have_gas_433"
  ...
  %"$add_call_446" = call %Int256* @_add_Int256(i8* %"$execptr_load_441", %Int256* %"$add_res4_442", %Int256* %"$add_res6_444")
  %"$add_448" = load %Int256, %Int256* %"$add_call_446", align 8
  store %Int256 %"$add_448", %Int256* %res7, align 8
...
"$have_gas_452":                                  ; preds = %"$out_of_gas_451", %"$have_gas_439"
  ...
  store %Int256 %"$res7_454", %Int256* %"$expr_18", align 8
