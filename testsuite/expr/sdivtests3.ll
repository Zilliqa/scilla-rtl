...
"$have_gas_94":                                   ; preds = %"$out_of_gas_93", %"$have_gas_89"
  ...
  store %Int256 { i256 -11111111111111110 }, %Int256* %b, align 8
...
"$have_gas_104":                                  ; preds = %"$out_of_gas_103", %"$have_gas_99"
  ...
  store %Int256 { i256 11119999993 }, %Int256* %a, align 8
...
"$have_gas_115":                                  ; preds = %"$out_of_gas_114", %"$have_gas_109"
  ...
  %"$div_call_122" = call %Int256* @_div_Int256(i8* %"$execptr_load_117", %Int256* %"$div_a_118", %Int256* %"$div_b_120")
  %"$div_124" = load %Int256, %Int256* %"$div_call_122", align 8
  store %Int256 %"$div_124", %Int256* %res_div, align 8
...
"$have_gas_134":                                  ; preds = %"$out_of_gas_133", %"$have_gas_128"
  ...
  %"$rem_call_141" = call %Int256* @_rem_Int256(i8* %"$execptr_load_136", %Int256* %"$rem_a_137", %Int256* %"$rem_b_139")
  %"$rem_143" = load %Int256, %Int256* %"$rem_call_141", align 8
  store %Int256 %"$rem_143", %Int256* %res_rem, align 8
...
"$have_gas_153":                                  ; preds = %"$out_of_gas_152", %"$have_gas_147"
  ...
  %"$add_call_160" = call %Int256* @_add_Int256(i8* %"$execptr_load_155", %Int256* %"$add_res_div_156", %Int256* %"$add_res_rem_158")
  %"$add_162" = load %Int256, %Int256* %"$add_call_160", align 8
  store %Int256 %"$add_162", %Int256* %res1, align 8
...
"$have_gas_171":                                  ; preds = %"$out_of_gas_170", %"$have_gas_166"
  ...
  store %Int256 { i256 11111110 }, %Int256* %"$b_6", align 8
...
"$have_gas_181":                                  ; preds = %"$out_of_gas_180", %"$have_gas_176"
  ...
  store %Int256 { i256 -7773 }, %Int256* %"$a_7", align 8
...
"$have_gas_192":                                  ; preds = %"$out_of_gas_191", %"$have_gas_186"
  ...
  %"$div_call_199" = call %Int256* @_div_Int256(i8* %"$execptr_load_194", %Int256* %"$div_$a_7_195", %Int256* %"$div_$b_6_197")
  %"$div_201" = load %Int256, %Int256* %"$div_call_199", align 8
  store %Int256 %"$div_201", %Int256* %"$res_div_8", align 8
...
"$have_gas_211":                                  ; preds = %"$out_of_gas_210", %"$have_gas_205"
  ...
  %"$rem_call_218" = call %Int256* @_rem_Int256(i8* %"$execptr_load_213", %Int256* %"$rem_$a_7_214", %Int256* %"$rem_$b_6_216")
  %"$rem_220" = load %Int256, %Int256* %"$rem_call_218", align 8
  store %Int256 %"$rem_220", %Int256* %"$res_rem_9", align 8
...
"$have_gas_230":                                  ; preds = %"$out_of_gas_229", %"$have_gas_224"
  ...
  %"$add_call_237" = call %Int256* @_add_Int256(i8* %"$execptr_load_232", %Int256* %"$add_$res_div_8_233", %Int256* %"$add_$res_rem_9_235")
  %"$add_239" = load %Int256, %Int256* %"$add_call_237", align 8
  store %Int256 %"$add_239", %Int256* %res2, align 8
...
"$have_gas_248":                                  ; preds = %"$out_of_gas_247", %"$have_gas_243"
  ...
  store %Int256 { i256 -10777 }, %Int256* %"$b_10", align 8
...
"$have_gas_258":                                  ; preds = %"$out_of_gas_257", %"$have_gas_253"
  ...
  store %Int256 { i256 -37 }, %Int256* %"$a_11", align 8
...
"$have_gas_269":                                  ; preds = %"$out_of_gas_268", %"$have_gas_263"
  ...
  %"$div_call_276" = call %Int256* @_div_Int256(i8* %"$execptr_load_271", %Int256* %"$div_$a_11_272", %Int256* %"$div_$b_10_274")
  %"$div_278" = load %Int256, %Int256* %"$div_call_276", align 8
  store %Int256 %"$div_278", %Int256* %"$res_div_12", align 8
...
"$have_gas_288":                                  ; preds = %"$out_of_gas_287", %"$have_gas_282"
  ...
  %"$rem_call_295" = call %Int256* @_rem_Int256(i8* %"$execptr_load_290", %Int256* %"$rem_$a_11_291", %Int256* %"$rem_$b_10_293")
  %"$rem_297" = load %Int256, %Int256* %"$rem_call_295", align 8
  store %Int256 %"$rem_297", %Int256* %"$res_rem_13", align 8
...
"$have_gas_307":                                  ; preds = %"$out_of_gas_306", %"$have_gas_301"
  ...
  %"$add_call_314" = call %Int256* @_add_Int256(i8* %"$execptr_load_309", %Int256* %"$add_$res_div_12_310", %Int256* %"$add_$res_rem_13_312")
  %"$add_316" = load %Int256, %Int256* %"$add_call_314", align 8
  store %Int256 %"$add_316", %Int256* %res3, align 8
...
"$have_gas_325":                                  ; preds = %"$out_of_gas_324", %"$have_gas_320"
  ...
  store %Int256 { i256 1898560 }, %Int256* %"$b_14", align 8
...
"$have_gas_335":                                  ; preds = %"$out_of_gas_334", %"$have_gas_330"
  ...
  store %Int256 { i256 13323 }, %Int256* %"$a_15", align 8
...
"$have_gas_346":                                  ; preds = %"$out_of_gas_345", %"$have_gas_340"
  ...
  %"$div_call_353" = call %Int256* @_div_Int256(i8* %"$execptr_load_348", %Int256* %"$div_$a_15_349", %Int256* %"$div_$b_14_351")
  %"$div_355" = load %Int256, %Int256* %"$div_call_353", align 8
  store %Int256 %"$div_355", %Int256* %"$res_div_16", align 8
...
"$have_gas_365":                                  ; preds = %"$out_of_gas_364", %"$have_gas_359"
  ...
  %"$rem_call_372" = call %Int256* @_rem_Int256(i8* %"$execptr_load_367", %Int256* %"$rem_$a_15_368", %Int256* %"$rem_$b_14_370")
  %"$rem_374" = load %Int256, %Int256* %"$rem_call_372", align 8
  store %Int256 %"$rem_374", %Int256* %"$res_rem_17", align 8
...
"$have_gas_384":                                  ; preds = %"$out_of_gas_383", %"$have_gas_378"
  ...
  %"$add_call_391" = call %Int256* @_add_Int256(i8* %"$execptr_load_386", %Int256* %"$add_$res_div_16_387", %Int256* %"$add_$res_rem_17_389")
  %"$add_393" = load %Int256, %Int256* %"$add_call_391", align 8
  store %Int256 %"$add_393", %Int256* %res4, align 8
...
"$have_gas_403":                                  ; preds = %"$out_of_gas_402", %"$have_gas_397"
  ...
  %"$add_call_410" = call %Int256* @_add_Int256(i8* %"$execptr_load_405", %Int256* %"$add_res1_406", %Int256* %"$add_res2_408")
  %"$add_412" = load %Int256, %Int256* %"$add_call_410", align 8
  store %Int256 %"$add_412", %Int256* %res5, align 8
...
"$have_gas_422":                                  ; preds = %"$out_of_gas_421", %"$have_gas_416"
  ...
  %"$add_call_429" = call %Int256* @_add_Int256(i8* %"$execptr_load_424", %Int256* %"$add_res5_425", %Int256* %"$add_res3_427")
  %"$add_431" = load %Int256, %Int256* %"$add_call_429", align 8
  store %Int256 %"$add_431", %Int256* %res6, align 8
...
"$have_gas_441":                                  ; preds = %"$out_of_gas_440", %"$have_gas_435"
  ...
  %"$add_call_448" = call %Int256* @_add_Int256(i8* %"$execptr_load_443", %Int256* %"$add_res4_444", %Int256* %"$add_res6_446")
  %"$add_450" = load %Int256, %Int256* %"$add_call_448", align 8
  store %Int256 %"$add_450", %Int256* %res7, align 8
...
"$have_gas_454":                                  ; preds = %"$out_of_gas_453", %"$have_gas_441"
  ...
  store %Int256 %"$res7_456", %Int256* %"$expr_18", align 8
