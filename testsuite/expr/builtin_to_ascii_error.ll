...
%"$ParamDescr_57" = type { %ParamDescrString, %_TyDescrTy_Typ* }
%ParamDescrString = type { i8*, i32 }
%"$TransDescr_58" = type { %ParamDescrString, i32, %"$ParamDescr_57"* }
%String = type { i8*, i32 }
...
@_contract_parameters = constant [0 x %"$ParamDescr_57"] zeroinitializer
@_contract_parameters_length = constant i32 0
@_transition_parameters = constant [0 x %"$TransDescr_58"] zeroinitializer
...
"$have_gas_46":                                   ; preds = %"$out_of_gas_45", %"$have_gas_41"
  ...
  store %String %"$to_ascii_call_52", %String* %"$expr_0", align 8
