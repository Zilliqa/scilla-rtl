...
"$have_gas_56":                                   ; preds = %"$out_of_gas_55", %"$have_gas_51"
  ...
  store %Int256 { i256 -11111111111111110 }, %Int256* %b, align 8, !dbg !10
...
"$have_gas_66":                                   ; preds = %"$out_of_gas_65", %"$have_gas_61"
  ...
  store %Int256 { i256 11119999993 }, %Int256* %a, align 8, !dbg !11
...
"$have_gas_77":                                   ; preds = %"$out_of_gas_76", %"$have_gas_71"
  ...
  %"$div_call_84" = call %Int256* @_div_Int256(i8* %"$execptr_load_79", %Int256* %"$div_a_80", %Int256* %"$div_b_82"), !dbg !12
  %"$div_86" = load %Int256, %Int256* %"$div_call_84", align 8
  store %Int256 %"$div_86", %Int256* %res_div, align 8, !dbg !12
...
"$have_gas_96":                                   ; preds = %"$out_of_gas_95", %"$have_gas_90"
  ...
  %"$rem_call_103" = call %Int256* @_rem_Int256(i8* %"$execptr_load_98", %Int256* %"$rem_a_99", %Int256* %"$rem_b_101"), !dbg !13
  %"$rem_105" = load %Int256, %Int256* %"$rem_call_103", align 8
  store %Int256 %"$rem_105", %Int256* %res_rem, align 8, !dbg !13
...
"$have_gas_115":                                  ; preds = %"$out_of_gas_114", %"$have_gas_109"
  ...
  %"$add_call_122" = call %Int256* @_add_Int256(i8* %"$execptr_load_117", %Int256* %"$add_res_div_118", %Int256* %"$add_res_rem_120"), !dbg !14
  %"$add_124" = load %Int256, %Int256* %"$add_call_122", align 8
  store %Int256 %"$add_124", %Int256* %res1, align 8, !dbg !14
...
"$have_gas_133":                                  ; preds = %"$out_of_gas_132", %"$have_gas_128"
  ...
  store %Int256 { i256 11111110 }, %Int256* %"$b_0", align 8, !dbg !15
...
"$have_gas_143":                                  ; preds = %"$out_of_gas_142", %"$have_gas_138"
  ...
  store %Int256 { i256 -7773 }, %Int256* %"$a_1", align 8, !dbg !16
...
"$have_gas_154":                                  ; preds = %"$out_of_gas_153", %"$have_gas_148"
  ...
  %"$div_call_161" = call %Int256* @_div_Int256(i8* %"$execptr_load_156", %Int256* %"$div_$a_1_157", %Int256* %"$div_$b_0_159"), !dbg !17
  %"$div_163" = load %Int256, %Int256* %"$div_call_161", align 8
  store %Int256 %"$div_163", %Int256* %"$res_div_2", align 8, !dbg !17
...
"$have_gas_173":                                  ; preds = %"$out_of_gas_172", %"$have_gas_167"
  ...
  %"$rem_call_180" = call %Int256* @_rem_Int256(i8* %"$execptr_load_175", %Int256* %"$rem_$a_1_176", %Int256* %"$rem_$b_0_178"), !dbg !18
  %"$rem_182" = load %Int256, %Int256* %"$rem_call_180", align 8
  store %Int256 %"$rem_182", %Int256* %"$res_rem_3", align 8, !dbg !18
...
"$have_gas_192":                                  ; preds = %"$out_of_gas_191", %"$have_gas_186"
  ...
  %"$add_call_199" = call %Int256* @_add_Int256(i8* %"$execptr_load_194", %Int256* %"$add_$res_div_2_195", %Int256* %"$add_$res_rem_3_197"), !dbg !19
  %"$add_201" = load %Int256, %Int256* %"$add_call_199", align 8
  store %Int256 %"$add_201", %Int256* %res2, align 8, !dbg !19
...
"$have_gas_210":                                  ; preds = %"$out_of_gas_209", %"$have_gas_205"
  ...
  store %Int256 { i256 -10777 }, %Int256* %"$b_4", align 8, !dbg !20
...
"$have_gas_220":                                  ; preds = %"$out_of_gas_219", %"$have_gas_215"
  ...
  store %Int256 { i256 -37 }, %Int256* %"$a_5", align 8, !dbg !21
...
"$have_gas_231":                                  ; preds = %"$out_of_gas_230", %"$have_gas_225"
  ...
  %"$div_call_238" = call %Int256* @_div_Int256(i8* %"$execptr_load_233", %Int256* %"$div_$a_5_234", %Int256* %"$div_$b_4_236"), !dbg !22
  %"$div_240" = load %Int256, %Int256* %"$div_call_238", align 8
  store %Int256 %"$div_240", %Int256* %"$res_div_6", align 8, !dbg !22
...
"$have_gas_250":                                  ; preds = %"$out_of_gas_249", %"$have_gas_244"
  ...
  %"$rem_call_257" = call %Int256* @_rem_Int256(i8* %"$execptr_load_252", %Int256* %"$rem_$a_5_253", %Int256* %"$rem_$b_4_255"), !dbg !23
  %"$rem_259" = load %Int256, %Int256* %"$rem_call_257", align 8
  store %Int256 %"$rem_259", %Int256* %"$res_rem_7", align 8, !dbg !23
...
"$have_gas_269":                                  ; preds = %"$out_of_gas_268", %"$have_gas_263"
  ...
  %"$add_call_276" = call %Int256* @_add_Int256(i8* %"$execptr_load_271", %Int256* %"$add_$res_div_6_272", %Int256* %"$add_$res_rem_7_274"), !dbg !24
  %"$add_278" = load %Int256, %Int256* %"$add_call_276", align 8
  store %Int256 %"$add_278", %Int256* %res3, align 8, !dbg !24
...
"$have_gas_287":                                  ; preds = %"$out_of_gas_286", %"$have_gas_282"
  ...
  store %Int256 { i256 1898560 }, %Int256* %"$b_8", align 8, !dbg !25
...
"$have_gas_297":                                  ; preds = %"$out_of_gas_296", %"$have_gas_292"
  ...
  store %Int256 { i256 13323 }, %Int256* %"$a_9", align 8, !dbg !26
...
"$have_gas_308":                                  ; preds = %"$out_of_gas_307", %"$have_gas_302"
  ...
  %"$div_call_315" = call %Int256* @_div_Int256(i8* %"$execptr_load_310", %Int256* %"$div_$a_9_311", %Int256* %"$div_$b_8_313"), !dbg !27
  %"$div_317" = load %Int256, %Int256* %"$div_call_315", align 8
  store %Int256 %"$div_317", %Int256* %"$res_div_10", align 8, !dbg !27
...
"$have_gas_327":                                  ; preds = %"$out_of_gas_326", %"$have_gas_321"
  ...
  %"$rem_call_334" = call %Int256* @_rem_Int256(i8* %"$execptr_load_329", %Int256* %"$rem_$a_9_330", %Int256* %"$rem_$b_8_332"), !dbg !28
  %"$rem_336" = load %Int256, %Int256* %"$rem_call_334", align 8
  store %Int256 %"$rem_336", %Int256* %"$res_rem_11", align 8, !dbg !28
...
"$have_gas_346":                                  ; preds = %"$out_of_gas_345", %"$have_gas_340"
  ...
  %"$add_call_353" = call %Int256* @_add_Int256(i8* %"$execptr_load_348", %Int256* %"$add_$res_div_10_349", %Int256* %"$add_$res_rem_11_351"), !dbg !29
  %"$add_355" = load %Int256, %Int256* %"$add_call_353", align 8
  store %Int256 %"$add_355", %Int256* %res4, align 8, !dbg !29
...
"$have_gas_365":                                  ; preds = %"$out_of_gas_364", %"$have_gas_359"
  ...
  %"$add_call_372" = call %Int256* @_add_Int256(i8* %"$execptr_load_367", %Int256* %"$add_res1_368", %Int256* %"$add_res2_370"), !dbg !30
  %"$add_374" = load %Int256, %Int256* %"$add_call_372", align 8
  store %Int256 %"$add_374", %Int256* %res5, align 8, !dbg !30
...
"$have_gas_384":                                  ; preds = %"$out_of_gas_383", %"$have_gas_378"
  ...
  %"$add_call_391" = call %Int256* @_add_Int256(i8* %"$execptr_load_386", %Int256* %"$add_res5_387", %Int256* %"$add_res3_389"), !dbg !31
  %"$add_393" = load %Int256, %Int256* %"$add_call_391", align 8
  store %Int256 %"$add_393", %Int256* %res6, align 8, !dbg !31
...
"$have_gas_403":                                  ; preds = %"$out_of_gas_402", %"$have_gas_397"
  ...
  %"$add_call_410" = call %Int256* @_add_Int256(i8* %"$execptr_load_405", %Int256* %"$add_res4_406", %Int256* %"$add_res6_408"), !dbg !32
  %"$add_412" = load %Int256, %Int256* %"$add_call_410", align 8
  store %Int256 %"$add_412", %Int256* %res7, align 8, !dbg !32
...
"$have_gas_416":                                  ; preds = %"$out_of_gas_415", %"$have_gas_403"
  ...
  store %Int256 %"$res7_418", %Int256* %"$expr_12", align 8, !dbg !33
