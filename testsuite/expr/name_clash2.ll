...
define internal %Uint32 @"$fundef_9"(%"$$fundef_9_env_48"* %0, %Uint32 %1) {
entry:
...
"$have_gas_103":                                  ; preds = %"$out_of_gas_102", %"$have_gas_98"
  ...
  store { %Uint32 (i8*, %Uint32)*, i8* } { %Uint32 (i8*, %Uint32)* bitcast (%Uint32 (%"$$fundef_9_env_48"*, %Uint32)* @"$fundef_9" to %Uint32 (i8*, %Uint32)*), i8* null }, { %Uint32 (i8*, %Uint32)*, i8* }* %f, align 8
...
"$have_gas_116":                                  ; preds = %"$out_of_gas_115", %"$have_gas_111"
  ...
  %"$f_call_122" = call %Uint32 %"$f_fptr_119"(i8* %"$f_envptr_120", %Uint32 %"$a_121")
  store %Uint32 %"$f_call_122", %Uint32* %"$f_7", align 4
  %"$$f_7_123" = load %Uint32, %Uint32* %"$f_7", align 4
  store %Uint32 %"$$f_7_123", %Uint32* %b, align 4
...
"$have_gas_127":                                  ; preds = %"$out_of_gas_126", %"$have_gas_116"
  ...
  %"$add_call_131" = call %Uint32 @_add_Uint32(%Uint32 %"$a_129", %Uint32 %"$b_130")
  store %Uint32 %"$add_call_131", %Uint32* %"$expr_8", align 4
