...
define internal %Uint32 @"$scilla_expr_38"(i8* %0) !dbg !8 {
entry:
...
"$have_gas_47":                                   ; preds = %"$out_of_gas_46", %"$have_gas_42"
  ...
  store %String { i8* getelementptr inbounds ([5 x i8], [5 x i8]* @"$stringlit_49", i32 0, i32 0), i32 5 }, %String* %s1, align 8, !dbg !9
...
"$have_gas_58":                                   ; preds = %"$out_of_gas_57", %"$have_gas_53"
  ...
  store %String { i8* getelementptr inbounds ([0 x i8], [0 x i8]* @"$stringlit_60", i32 0, i32 0), i32 0 }, %String* %s2, align 8, !dbg !10
...
"$have_gas_69":                                   ; preds = %"$out_of_gas_68", %"$have_gas_64"
  ...
  store [2 x i8] c"\FF\EE", [2 x i8]* %b1x, align 1, !dbg !11
...
"$have_gas_79":                                   ; preds = %"$out_of_gas_78", %"$have_gas_74"
  ...
  store [0 x i8] zeroinitializer, [0 x i8]* %b2x, align 1, !dbg !12
...
"$have_gas_84":                                   ; preds = %"$out_of_gas_83", %"$have_gas_79"
  ...
  %"$to_bystr_b1x_87" = alloca [2 x i8], align 1
  %"$b1x_88" = load [2 x i8], [2 x i8]* %b1x, align 1
  store [2 x i8] %"$b1x_88", [2 x i8]* %"$to_bystr_b1x_87", align 1
  ...
  store %Bystr %"$to_bystr_call_90", %Bystr* %b1, align 8, !dbg !13
...
"$have_gas_94":                                   ; preds = %"$out_of_gas_93", %"$have_gas_84"
  ...
  %"$to_bystr_b2x_97" = alloca [0 x i8], align 1
  %"$b2x_98" = load [0 x i8], [0 x i8]* %b2x, align 1
  store [0 x i8] %"$b2x_98", [0 x i8]* %"$to_bystr_b2x_97", align 1
  ...
  store %Bystr %"$to_bystr_call_100", %Bystr* %b2, align 8, !dbg !14
...
"$have_gas_104":                                  ; preds = %"$out_of_gas_103", %"$have_gas_94"
  ...
  %"$s1_106" = load %String, %String* %s1, align 8
  %"$strlen_call_107" = call %Uint32 @_strlen_String(%String %"$s1_106")
  store %Uint32 %"$strlen_call_107", %Uint32* %n1, align 4, !dbg !15
...
"$have_gas_111":                                  ; preds = %"$out_of_gas_110", %"$have_gas_104"
  ...
  %"$s2_113" = load %String, %String* %s2, align 8
  %"$strlen_call_114" = call %Uint32 @_strlen_String(%String %"$s2_113")
  store %Uint32 %"$strlen_call_114", %Uint32* %n2, align 4, !dbg !16
...
"$have_gas_118":                                  ; preds = %"$out_of_gas_117", %"$have_gas_111"
  ...
  %"$b1_120" = load %Bystr, %Bystr* %b1, align 8
  %"$strlen_call_121" = call %Uint32 @_strlen_ByStr(%Bystr %"$b1_120")
  store %Uint32 %"$strlen_call_121", %Uint32* %n3, align 4, !dbg !17
...
"$have_gas_125":                                  ; preds = %"$out_of_gas_124", %"$have_gas_118"
  ...
  %"$b2_127" = load %Bystr, %Bystr* %b2, align 8
  %"$strlen_call_128" = call %Uint32 @_strlen_ByStr(%Bystr %"$b2_127")
  store %Uint32 %"$strlen_call_128", %Uint32* %n4, align 4, !dbg !18
...
"$have_gas_132":                                  ; preds = %"$out_of_gas_131", %"$have_gas_125"
  ...
  %"$n1_134" = load %Uint32, %Uint32* %n1, align 4
  %"$n2_135" = load %Uint32, %Uint32* %n2, align 4
  %"$add_call_136" = call %Uint32 @_add_Uint32(%Uint32 %"$n1_134", %Uint32 %"$n2_135")
  store %Uint32 %"$add_call_136", %Uint32* %n5, align 4, !dbg !19
...
"$have_gas_140":                                  ; preds = %"$out_of_gas_139", %"$have_gas_132"
  ...
  %"$n3_142" = load %Uint32, %Uint32* %n3, align 4
  %"$n4_143" = load %Uint32, %Uint32* %n4, align 4
  %"$add_call_144" = call %Uint32 @_add_Uint32(%Uint32 %"$n3_142", %Uint32 %"$n4_143")
  store %Uint32 %"$add_call_144", %Uint32* %n6, align 4, !dbg !20
  %"$n5_145" = load %Uint32, %Uint32* %n5, align 4
  %"$n6_146" = load %Uint32, %Uint32* %n6, align 4
  %"$add_call_147" = call %Uint32 @_add_Uint32(%Uint32 %"$n5_145", %Uint32 %"$n6_146")
  store %Uint32 %"$add_call_147", %Uint32* %"$expr_0", align 4, !dbg !21
  %"$$expr_0_148" = load %Uint32, %Uint32* %"$expr_0", align 4
...
!9 = !DILocation(line: 1, column: 16, scope: !8)
!10 = !DILocation(line: 2, column: 11, scope: !8)
!11 = !DILocation(line: 4, column: 11, scope: !8)
...
!17 = !DILocation(line: 12, column: 10, scope: !8)
!18 = !DILocation(line: 13, column: 10, scope: !8)
!19 = !DILocation(line: 15, column: 10, scope: !8)
!20 = !DILocation(line: 16, column: 10, scope: !8)
!21 = !DILocation(line: 17, column: 1, scope: !8)
