...
%"$ParamDescr_44" = type { %ParamDescrString, %_TyDescrTy_Typ* }
%ParamDescrString = type { i8*, i32 }
%"$TransDescr_45" = type { %ParamDescrString, i32, %"$ParamDescr_44"* }
%Uint256 = type { i256 }
...
@_contract_parameters = constant [0 x %"$ParamDescr_44"] zeroinitializer
@_contract_parameters_length = constant i32 0
@_transition_parameters = constant [0 x %"$TransDescr_45"] zeroinitializer
