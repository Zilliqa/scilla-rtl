...
"$have_gas_75":                                   ; preds = %"$out_of_gas_74", %entry
  ...
  store %Uint256 { i256 -1 }, %Uint256* %"$expr_6", align 8, !dbg !11
  %"$$expr_6_77" = load %Uint256, %Uint256* %"$expr_6", align 8
  store %Uint256 %"$$expr_6_77", %Uint256* %1, align 8
  ret void
}
...
entry:
  %"$mainval_78" = alloca %Uint256, align 8
  %"$memvoidcast_79" = bitcast %Uint256* %"$mainval_78" to i8*
  call void @_scilla_expr_fun(i8* null, %Uint256* %"$mainval_78")
  %"$execptr_load_80" = load i8*, i8** @_execptr, align 8
  call void @_print_scilla_val(i8* %"$execptr_load_80", %_TyDescrTy_Typ* @"$TyDescr_Uint256_23", i8* %"$memvoidcast_79")
  ret void
}
...
!2 = !DIFile(filename: "lit-ui256-max.scilexp", directory: "codegen/expr")
!3 = !{}
