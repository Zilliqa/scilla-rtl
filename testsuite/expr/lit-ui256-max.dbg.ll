...
%"$ParamDescr_45" = type { %ParamDescrString, %_TyDescrTy_Typ* }
%ParamDescrString = type { i8*, i32 }
%"$TransDescr_46" = type { %ParamDescrString, i32, %"$ParamDescr_45"* }
%Uint256 = type { i256 }
...
@_contract_parameters = constant [0 x %"$ParamDescr_45"] zeroinitializer
@_contract_parameters_length = constant i32 0
@_transition_parameters = constant [0 x %"$TransDescr_46"] zeroinitializer
...
"$have_gas_39":                                   ; preds = %"$out_of_gas_38", %entry
  ...
  store %Uint256 { i256 -1 }, %Uint256* %"$expr_0", align 8, !dbg !10
  %"$$expr_0_41" = load %Uint256, %Uint256* %"$expr_0", align 8
  store %Uint256 %"$$expr_0_41", %Uint256* %1, align 8
  ret void
}
...
entry:
  %"$mainval_42" = alloca %Uint256, align 8
  %"$memvoidcast_43" = bitcast %Uint256* %"$mainval_42" to i8*
  call void @_scilla_expr_fun(i8* null, %Uint256* %"$mainval_42")
  %"$execptr_load_44" = load i8*, i8** @_execptr, align 8
  call void @_print_scilla_val(i8* %"$execptr_load_44", %_TyDescrTy_Typ* @"$TyDescr_Uint256_17", i8* %"$memvoidcast_43")
  ret void
}
