...
%"$ParamDescr_74" = type { %ParamDescrString, %_TyDescrTy_Typ* }
%ParamDescrString = type { i8*, i32 }
%"$TransDescr_75" = type { %ParamDescrString, i32, %"$ParamDescr_74"* }
%Uint256 = type { i256 }
...
@_contract_parameters = constant [0 x %"$ParamDescr_74"] zeroinitializer
@_contract_parameters_length = constant i32 0
@_transition_parameters = constant [0 x %"$TransDescr_75"] zeroinitializer
...
"$have_gas_54":                                   ; preds = %"$out_of_gas_53", %"$have_gas_49"
  ...
  %"$gascmp_58" = icmp ugt i64 16, %"$gasrem_57"
...
"$have_gas_60":                                   ; preds = %"$out_of_gas_59", %"$have_gas_54"
  %"$consume_61" = sub i64 %"$gasrem_57", 16
  store i64 %"$consume_61", i64* @_gasrem, align 8
  %"$execptr_load_62" = load i8*, i8** @_execptr, align 8
  %"$add_one_63" = alloca %Uint256, align 8
  %"$one_64" = load %Uint256, %Uint256* %one, align 8
  store %Uint256 %"$one_64", %Uint256* %"$add_one_63", align 8
  %"$add_two_65" = alloca %Uint256, align 8
  %"$two_66" = load %Uint256, %Uint256* %two, align 8
  store %Uint256 %"$two_66", %Uint256* %"$add_two_65", align 8
  %"$add_call_67" = call %Uint256* @_add_Uint256(i8* %"$execptr_load_62", %Uint256* %"$add_one_63", %Uint256* %"$add_two_65")
  %"$add_69" = load %Uint256, %Uint256* %"$add_call_67", align 8
  store %Uint256 %"$add_69", %Uint256* %"$expr_0", align 8
  %"$$expr_0_70" = load %Uint256, %Uint256* %"$expr_0", align 8
  store %Uint256 %"$$expr_0_70", %Uint256* %1, align 8
  ret void
}
...
entry:
  %"$mainval_71" = alloca %Uint256, align 8
  %"$memvoidcast_72" = bitcast %Uint256* %"$mainval_71" to i8*
  call void @_scilla_expr_fun(i8* null, %Uint256* %"$mainval_71")
  %"$execptr_load_73" = load i8*, i8** @_execptr, align 8
  call void @_print_scilla_val(i8* %"$execptr_load_73", %_TyDescrTy_Typ* @"$TyDescr_Uint256_17", i8* %"$memvoidcast_72")
  ret void
}
