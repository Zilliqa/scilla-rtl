...
"$have_gas_80":                                   ; preds = %"$out_of_gas_79", %"$have_gas_75"
  ...
  store %Uint256 { i256 10000000 }, %Uint256* %one, align 8
...
"$have_gas_90":                                   ; preds = %"$out_of_gas_89", %"$have_gas_85"
  ...
  store %Uint256 { i256 111 }, %Uint256* %two, align 8
...
"$have_gas_96":                                   ; preds = %"$out_of_gas_95", %"$have_gas_90"
  ...
  %"$add_call_103" = call %Uint256* @_add_Uint256(i8* %"$execptr_load_98", %Uint256* %"$add_one_99", %Uint256* %"$add_two_101")
  %"$add_105" = load %Uint256, %Uint256* %"$add_call_103", align 8
  store %Uint256 %"$add_105", %Uint256* %"$expr_6", align 8
