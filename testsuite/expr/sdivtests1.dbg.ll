...
"$have_gas_171":                                  ; preds = %"$out_of_gas_170", %"$have_gas_166"
  ...
  %"$div_call_175" = call %Int32 @_div_Int32(%Int32 %"$$a_6_173", %Int32 %"$$b_7_174"), !dbg !18
...
"$have_gas_184":                                  ; preds = %"$out_of_gas_183", %"$have_gas_179"
  ...
  %"$rem_call_188" = call %Int32 @_rem_Int32(%Int32 %"$$a_6_186", %Int32 %"$$b_7_187"), !dbg !19
...
"$have_gas_230":                                  ; preds = %"$out_of_gas_229", %"$have_gas_225"
  ...
  %"$div_call_234" = call %Int32 @_div_Int32(%Int32 %"$$a_10_232", %Int32 %"$$b_11_233"), !dbg !23
...
"$have_gas_243":                                  ; preds = %"$out_of_gas_242", %"$have_gas_238"
  ...
  %"$rem_call_247" = call %Int32 @_rem_Int32(%Int32 %"$$a_10_245", %Int32 %"$$b_11_246"), !dbg !24
...
"$have_gas_289":                                  ; preds = %"$out_of_gas_288", %"$have_gas_284"
  ...
  %"$div_call_293" = call %Int32 @_div_Int32(%Int32 %"$$a_14_291", %Int32 %"$$b_15_292"), !dbg !28
...
"$have_gas_302":                                  ; preds = %"$out_of_gas_301", %"$have_gas_297"
  ...
  %"$rem_call_306" = call %Int32 @_rem_Int32(%Int32 %"$$a_14_304", %Int32 %"$$b_15_305"), !dbg !29
