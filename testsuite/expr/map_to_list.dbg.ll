...
"$have_gas_165":                                  ; preds = %"$out_of_gas_164", %"$have_gas_160"
  ...
  store %Map_Int32_Int32* %"$_new_empty_map_169", %Map_Int32_Int32** %m0, align 8, !dbg !17
...
"$have_gas_182":                                  ; preds = %"$out_of_gas_181", %"$have_gas_173"
  ...
  %"$put_call_193" = call i8* @_put(i8* %"$execptr_load_184", %_TyDescrTy_Typ* @"$TyDescr_Map_42", i8* %"$$m0_185_186", i8* %"$$put_k1_187_189", i8* %"$$put_v1_190_192"), !dbg !18
  %"$put_194" = bitcast i8* %"$put_call_193" to %Map_Int32_Int32*
  store %Map_Int32_Int32* %"$put_194", %Map_Int32_Int32** %m1, align 8, !dbg !18
...
"$have_gas_207":                                  ; preds = %"$out_of_gas_206", %"$have_gas_198"
  ...
  %"$put_call_218" = call i8* @_put(i8* %"$execptr_load_209", %_TyDescrTy_Typ* @"$TyDescr_Map_42", i8* %"$$m1_210_211", i8* %"$$put_k2_212_214", i8* %"$$put_v2_215_217"), !dbg !19
  %"$put_219" = bitcast i8* %"$put_call_218" to %Map_Int32_Int32*
  store %Map_Int32_Int32* %"$put_219", %Map_Int32_Int32** %m2, align 8, !dbg !19
...
"$have_gas_232":                                  ; preds = %"$out_of_gas_231", %"$have_gas_223"
  ...
  %"$put_call_243" = call i8* @_put(i8* %"$execptr_load_234", %_TyDescrTy_Typ* @"$TyDescr_Map_42", i8* %"$$m2_235_236", i8* %"$$put_k3_237_239", i8* %"$$put_v3_240_242"), !dbg !20
  %"$put_244" = bitcast i8* %"$put_call_243" to %Map_Int32_Int32*
  store %Map_Int32_Int32* %"$put_244", %Map_Int32_Int32** %m3, align 8, !dbg !20
...
"$have_gas_260":                                  ; preds = %"$out_of_gas_259", %"$have_gas_232"
  ...
  %"$to_list_call_265" = call i8* @_map_to_list(i8* %"$execptr_load_262", %_TyDescrTy_Typ* @"$TyDescr_Map_42", i8* %"$$m3_263_264"), !dbg !21
  %"$to_list_266" = bitcast i8* %"$to_list_call_265" to %"TName_List_Pair_(Int32)_(Int32)"*
  store %"TName_List_Pair_(Int32)_(Int32)"* %"$to_list_266", %"TName_List_Pair_(Int32)_(Int32)"** %"$expr_6", align 8, !dbg !21
