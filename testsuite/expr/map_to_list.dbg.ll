...
"$have_gas_137":                                  ; preds = %"$out_of_gas_136", %"$have_gas_129"
  ...
  %"$put_call_148" = call i8* @_put(i8* %"$execptr_load_139", %_TyDescrTy_Typ* @"$TyDescr_Map_36", i8* %"$$m0_140_141", i8* %"$$put_k1_142_144", i8* %"$$put_v1_145_147"), !dbg !17
  %"$put_149" = bitcast i8* %"$put_call_148" to %Map_Int32_Int32*
  store %Map_Int32_Int32* %"$put_149", %Map_Int32_Int32** %m1, align 8, !dbg !17
...
"$have_gas_153":                                  ; preds = %"$out_of_gas_152", %"$have_gas_137"
  ...
  %"$put_call_164" = call i8* @_put(i8* %"$execptr_load_155", %_TyDescrTy_Typ* @"$TyDescr_Map_36", i8* %"$$m1_156_157", i8* %"$$put_k2_158_160", i8* %"$$put_v2_161_163"), !dbg !18
  %"$put_165" = bitcast i8* %"$put_call_164" to %Map_Int32_Int32*
  store %Map_Int32_Int32* %"$put_165", %Map_Int32_Int32** %m2, align 8, !dbg !18
...
"$have_gas_169":                                  ; preds = %"$out_of_gas_168", %"$have_gas_153"
  ...
  %"$put_call_180" = call i8* @_put(i8* %"$execptr_load_171", %_TyDescrTy_Typ* @"$TyDescr_Map_36", i8* %"$$m2_172_173", i8* %"$$put_k3_174_176", i8* %"$$put_v3_177_179"), !dbg !19
  %"$put_181" = bitcast i8* %"$put_call_180" to %Map_Int32_Int32*
  store %Map_Int32_Int32* %"$put_181", %Map_Int32_Int32** %m3, align 8, !dbg !19
  ...
  %"$to_list_call_185" = call i8* @_map_to_list(i8* %"$execptr_load_182", %_TyDescrTy_Typ* @"$TyDescr_Map_36", i8* %"$$m3_183_184"), !dbg !20
  %"$to_list_186" = bitcast i8* %"$to_list_call_185" to %"TName_List_Pair_(Int32)_(Int32)"*
  store %"TName_List_Pair_(Int32)_(Int32)"* %"$to_list_186", %"TName_List_Pair_(Int32)_(Int32)"** %"$expr_0", align 8, !dbg !20
