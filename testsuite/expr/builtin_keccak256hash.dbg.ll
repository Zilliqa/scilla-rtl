...
define internal void @_scilla_expr_fun(i8* %0, [32 x i8]* %1) !dbg !10 {
entry:
  %"$expr_6" = alloca [32 x i8], align 1
  call void @llvm.dbg.declare(metadata [32 x i8]* %"$expr_6", metadata !11, metadata !DIExpression()), !dbg !13
...
"$have_gas_107":                                  ; preds = %"$out_of_gas_106", %"$have_gas_101"
  ...
  call void @llvm.dbg.declare(metadata [32 x i8]* %h1, metadata !17, metadata !DIExpression()), !dbg !18
  ...
  %"$gasdivceil_114" = urem i64 %"$gasadd_113", 2040
  %"$gasdivceil_115" = udiv i64 %"$gasadd_113", 2040
...
"$have_gas_122":                                  ; preds = %"$out_of_gas_121", %"$have_gas_107"
  ...
  %"$keccak256hash_s_125" = alloca %String, align 8
  %"$s_126" = load %String, %String* %s, align 8
  store %String %"$s_126", %String* %"$keccak256hash_s_125", align 8
  %"$$keccak256hash_s_125_127" = bitcast %String* %"$keccak256hash_s_125" to i8*
  %"$keccak256hash_call_128" = call [32 x i8]* @_keccak256hash(i8* %"$execptr_load_124", %_TyDescrTy_Typ* @"$TyDescr_String_25", i8* %"$$keccak256hash_s_125_127"), !dbg !19
  %"$keccak256hash_130" = load [32 x i8], [32 x i8]* %"$keccak256hash_call_128", align 1
  store [32 x i8] %"$keccak256hash_130", [32 x i8]* %h1, align 1, !dbg !19
...
"$have_gas_134":                                  ; preds = %"$out_of_gas_133", %"$have_gas_122"
  ...
  call void @llvm.dbg.declare(metadata [32 x i8]* %h2, metadata !20, metadata !DIExpression()), !dbg !21
  ...
  %"$gasdivceil_141" = urem i64 %"$gasadd_140", 2040
  %"$gasdivceil_142" = udiv i64 %"$gasadd_140", 2040
...
"$have_gas_149":                                  ; preds = %"$out_of_gas_148", %"$have_gas_134"
  ...
  %"$keccak256hash_h1_152" = alloca [32 x i8], align 1
  %"$h1_153" = load [32 x i8], [32 x i8]* %h1, align 1
  store [32 x i8] %"$h1_153", [32 x i8]* %"$keccak256hash_h1_152", align 1
  %"$$keccak256hash_h1_152_154" = bitcast [32 x i8]* %"$keccak256hash_h1_152" to i8*
  %"$keccak256hash_call_155" = call [32 x i8]* @_keccak256hash(i8* %"$execptr_load_151", %_TyDescrTy_Typ* @"$TyDescr_Bystr32_39", i8* %"$$keccak256hash_h1_152_154"), !dbg !22
  %"$keccak256hash_157" = load [32 x i8], [32 x i8]* %"$keccak256hash_call_155", align 1
  store [32 x i8] %"$keccak256hash_157", [32 x i8]* %h2, align 1, !dbg !22
...
"$have_gas_161":                                  ; preds = %"$out_of_gas_160", %"$have_gas_149"
  ...
  call void @llvm.dbg.declare(metadata %TName_Pair_String_ByStr32** %sh, metadata !23, metadata !DIExpression()), !dbg !26
...
"$have_gas_166":                                  ; preds = %"$out_of_gas_165", %"$have_gas_161"
  ...
  store %TName_Pair_String_ByStr32* %"$adtptr_174", %TName_Pair_String_ByStr32** %sh, align 8, !dbg !27
...
"$have_gas_178":                                  ; preds = %"$out_of_gas_177", %"$have_gas_166"
  ...
  call void @llvm.dbg.declare(metadata [32 x i8]* %sh2, metadata !28, metadata !DIExpression()), !dbg !29
  ...
  %"$gasdivceil_184" = urem i64 %"$gasadd_183", 2040
  %"$gasdivceil_185" = udiv i64 %"$gasadd_183", 2040
...
"$have_gas_192":                                  ; preds = %"$out_of_gas_191", %"$have_gas_178"
  ...
  %"$keccak256hash_call_197" = call [32 x i8]* @_keccak256hash(i8* %"$execptr_load_194", %_TyDescrTy_Typ* @"$TyDescr_ADT_Pair_String_ByStr32_44", i8* %"$$sh_195_196"), !dbg !30
  %"$keccak256hash_199" = load [32 x i8], [32 x i8]* %"$keccak256hash_call_197", align 1
  store [32 x i8] %"$keccak256hash_199", [32 x i8]* %sh2, align 1, !dbg !30
...
"$have_gas_208":                                  ; preds = %"$out_of_gas_207", %"$have_gas_203"
  ...
  %"$to_bystr_call_214" = call %Bystr @_to_bystr(i8* %"$execptr_load_210", i32 32, i8* %"$$to_bystr_sh2_211_213"), !dbg !34
...
"$have_gas_233":                                  ; preds = %"$out_of_gas_232", %"$have_gas_228"
  ...
  %"$gasdivceil_246" = urem i64 %"$gasadd_245", 2040
  %"$gasdivceil_247" = udiv i64 %"$gasadd_245", 2040
...
"$have_gas_254":                                  ; preds = %"$out_of_gas_253", %"$have_gas_233"
  ...
  %"$keccak256hash_call_259" = call [32 x i8]* @_keccak256hash(i8* %"$execptr_load_256", %_TyDescrTy_Typ* @"$TyDescr_ADT_Pair_ByStr_Int32_43", i8* %"$$p2_257_258"), !dbg !44
  %"$keccak256hash_261" = load [32 x i8], [32 x i8]* %"$keccak256hash_call_259", align 1
  store [32 x i8] %"$keccak256hash_261", [32 x i8]* %"$expr_6", align 1, !dbg !44
...
!24 = !DIDerivedType(tag: DW_TAG_pointer_type, name: "Pair (String) (ByStr32)", baseType: !25, size: 8, align: 8, dwarfAddressSpace: 0)
!25 = !DIBasicType(name: "Pair (String) (ByStr32)", size: 8)
