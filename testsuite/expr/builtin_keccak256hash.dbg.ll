...
"$have_gas_67":                                   ; preds = %"$out_of_gas_66", %"$have_gas_61"
  ...
  %"$keccak256hash_s_70" = alloca %String, align 8
  %"$s_71" = load %String, %String* %s, align 8
  store %String %"$s_71", %String* %"$keccak256hash_s_70", align 8
  %"$$keccak256hash_s_70_72" = bitcast %String* %"$keccak256hash_s_70" to i8*
  %"$keccak256hash_call_73" = call [32 x i8]* @_keccak256hash(i8* %"$execptr_load_69", %_TyDescrTy_Typ* @"$TyDescr_String_19", i8* %"$$keccak256hash_s_70_72")
  %"$keccak256hash_74" = load [32 x i8], [32 x i8]* %"$keccak256hash_call_73", align 1
  store [32 x i8] %"$keccak256hash_74", [32 x i8]* %h1, align 1, !dbg !11
...
"$have_gas_78":                                   ; preds = %"$out_of_gas_77", %"$have_gas_67"
  ...
  %"$keccak256hash_h1_81" = alloca [32 x i8], align 1
  %"$h1_82" = load [32 x i8], [32 x i8]* %h1, align 1
  store [32 x i8] %"$h1_82", [32 x i8]* %"$keccak256hash_h1_81", align 1
  %"$$keccak256hash_h1_81_83" = bitcast [32 x i8]* %"$keccak256hash_h1_81" to i8*
  %"$keccak256hash_call_84" = call [32 x i8]* @_keccak256hash(i8* %"$execptr_load_80", %_TyDescrTy_Typ* @"$TyDescr_Bystr32_31", i8* %"$$keccak256hash_h1_81_83")
  %"$keccak256hash_85" = load [32 x i8], [32 x i8]* %"$keccak256hash_call_84", align 1
  store [32 x i8] %"$keccak256hash_85", [32 x i8]* %h2, align 1, !dbg !12
...
"$have_gas_94":                                   ; preds = %"$out_of_gas_93", %"$have_gas_89"
  ...
  %"$h2_97" = load [32 x i8], [32 x i8]* %h2, align 1
  %"$adtval_98_load" = load i8*, i8** @_execptr, align 8
  %"$adtval_98_salloc" = call i8* @_salloc(i8* %"$adtval_98_load", i64 49)
  %"$adtval_98" = bitcast i8* %"$adtval_98_salloc" to %CName_Pair_String_ByStr32*
  %"$adtgep_99" = getelementptr inbounds %CName_Pair_String_ByStr32, %CName_Pair_String_ByStr32* %"$adtval_98", i32 0, i32 0
  store i8 0, i8* %"$adtgep_99", align 1
  %"$adtgep_100" = getelementptr inbounds %CName_Pair_String_ByStr32, %CName_Pair_String_ByStr32* %"$adtval_98", i32 0, i32 1
...
"$have_gas_106":                                  ; preds = %"$out_of_gas_105", %"$have_gas_94"
  ...
  %"$sh_109" = load %TName_Pair_String_ByStr32*, %TName_Pair_String_ByStr32** %sh, align 8
  %"$$sh_109_110" = bitcast %TName_Pair_String_ByStr32* %"$sh_109" to i8*
  %"$keccak256hash_call_111" = call [32 x i8]* @_keccak256hash(i8* %"$execptr_load_108", %_TyDescrTy_Typ* @"$TyDescr_ADT_Pair_String_ByStr32_36", i8* %"$$sh_109_110")
  %"$keccak256hash_112" = load [32 x i8], [32 x i8]* %"$keccak256hash_call_111", align 1
  store [32 x i8] %"$keccak256hash_112", [32 x i8]* %sh2, align 1, !dbg !14
...
"$have_gas_116":                                  ; preds = %"$out_of_gas_115", %"$have_gas_106"
  ...
  %"$to_bystr_sh2_119" = alloca [32 x i8], align 1
  %"$sh2_120" = load [32 x i8], [32 x i8]* %sh2, align 1
...
"$have_gas_141":                                  ; preds = %"$out_of_gas_140", %"$have_gas_136"
  ...
  %"$keccak256hash_call_153" = call [32 x i8]* @_keccak256hash(i8* %"$execptr_load_150", %_TyDescrTy_Typ* @"$TyDescr_ADT_Pair_ByStr_Int32_35", i8* %"$$p2_151_152")
  %"$keccak256hash_154" = load [32 x i8], [32 x i8]* %"$keccak256hash_call_153", align 1
  store [32 x i8] %"$keccak256hash_154", [32 x i8]* %"$expr_0", align 1, !dbg !18
...
entry:
  %"$mainval_156" = alloca [32 x i8], align 1
  %"$memvoidcast_157" = bitcast [32 x i8]* %"$mainval_156" to i8*
  call void @_scilla_expr_fun(i8* null, [32 x i8]* %"$mainval_156")
