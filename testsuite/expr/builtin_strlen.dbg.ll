...
"$have_gas_84":                                   ; preds = %"$out_of_gas_83", %"$have_gas_79"
  ...
  store %String { i8* getelementptr inbounds ([5 x i8], [5 x i8]* @"$stringlit_86", i32 0, i32 0), i32 5 }, %String* %s1, align 8, !dbg !11
...
"$have_gas_95":                                   ; preds = %"$out_of_gas_94", %"$have_gas_90"
  ...
  store %String { i8* getelementptr inbounds ([0 x i8], [0 x i8]* @"$stringlit_97", i32 0, i32 0), i32 0 }, %String* %s2, align 8, !dbg !12
...
"$have_gas_106":                                  ; preds = %"$out_of_gas_105", %"$have_gas_101"
  ...
  store [2 x i8] c"\FF\EE", [2 x i8]* %b1x, align 1, !dbg !13
...
"$have_gas_116":                                  ; preds = %"$out_of_gas_115", %"$have_gas_111"
  ...
  store [0 x i8] zeroinitializer, [0 x i8]* %b2x, align 1, !dbg !14
...
"$have_gas_126":                                  ; preds = %"$out_of_gas_125", %"$have_gas_121"
  ...
  %"$to_bystr_call_132" = call %Bystr @_to_bystr(i8* %"$execptr_load_128", i32 2, i8* %"$$to_bystr_b1x_129_131"), !dbg !15
  store %Bystr %"$to_bystr_call_132", %Bystr* %b1, align 8, !dbg !15
...
"$have_gas_141":                                  ; preds = %"$out_of_gas_140", %"$have_gas_136"
  ...
  %"$to_bystr_call_147" = call %Bystr @_to_bystr(i8* %"$execptr_load_143", i32 0, i8* %"$$to_bystr_b2x_144_146"), !dbg !16
  store %Bystr %"$to_bystr_call_147", %Bystr* %b2, align 8, !dbg !16
...
"$have_gas_160":                                  ; preds = %"$out_of_gas_159", %"$have_gas_151"
  ...
  %"$strlen_call_163" = call %Uint32 @_strlen_String(%String %"$s1_162"), !dbg !17
  store %Uint32 %"$strlen_call_163", %Uint32* %n1, align 4, !dbg !17
...
"$have_gas_176":                                  ; preds = %"$out_of_gas_175", %"$have_gas_167"
  ...
  %"$strlen_call_179" = call %Uint32 @_strlen_String(%String %"$s2_178"), !dbg !18
  store %Uint32 %"$strlen_call_179", %Uint32* %n2, align 4, !dbg !18
...
"$have_gas_192":                                  ; preds = %"$out_of_gas_191", %"$have_gas_183"
  ...
  %"$strlen_call_195" = call %Uint32 @_strlen_ByStr(%Bystr %"$b1_194"), !dbg !19
  store %Uint32 %"$strlen_call_195", %Uint32* %n3, align 4, !dbg !19
...
"$have_gas_208":                                  ; preds = %"$out_of_gas_207", %"$have_gas_199"
  ...
  %"$strlen_call_211" = call %Uint32 @_strlen_ByStr(%Bystr %"$b2_210"), !dbg !20
  store %Uint32 %"$strlen_call_211", %Uint32* %n4, align 4, !dbg !20
...
"$have_gas_220":                                  ; preds = %"$out_of_gas_219", %"$have_gas_215"
  ...
  %"$add_call_224" = call %Uint32 @_add_Uint32(%Uint32 %"$n1_222", %Uint32 %"$n2_223"), !dbg !21
  store %Uint32 %"$add_call_224", %Uint32* %n5, align 4, !dbg !21
...
"$have_gas_233":                                  ; preds = %"$out_of_gas_232", %"$have_gas_228"
  ...
  %"$add_call_237" = call %Uint32 @_add_Uint32(%Uint32 %"$n3_235", %Uint32 %"$n4_236"), !dbg !22
  store %Uint32 %"$add_call_237", %Uint32* %n6, align 4, !dbg !22
...
"$have_gas_241":                                  ; preds = %"$out_of_gas_240", %"$have_gas_233"
  ...
  %"$add_call_245" = call %Uint32 @_add_Uint32(%Uint32 %"$n5_243", %Uint32 %"$n6_244"), !dbg !23
  store %Uint32 %"$add_call_245", %Uint32* %"$expr_6", align 4, !dbg !23
...
!11 = !DILocation(line: 1, column: 16, scope: !10)
...
!17 = !DILocation(line: 10, column: 10, scope: !10)
!18 = !DILocation(line: 11, column: 10, scope: !10)
!19 = !DILocation(line: 12, column: 10, scope: !10)
!20 = !DILocation(line: 13, column: 10, scope: !10)
!21 = !DILocation(line: 15, column: 10, scope: !10)
!22 = !DILocation(line: 16, column: 10, scope: !10)
!23 = !DILocation(line: 17, column: 1, scope: !10)
