...
define internal %TName_Bool* @"$fundef_21"(%"$$fundef_21_env_76"* %0, %TName_Bool* %1) {
entry:
...
"$have_gas_134":                                  ; preds = %"$out_of_gas_133", %"$True_129"
  ...
  store %TName_Bool* %"$adtptr_138", %TName_Bool** %"$retval_22", align 8
...
"$have_gas_144":                                  ; preds = %"$out_of_gas_143", %"$False_139"
  ...
  store %TName_Bool* %"$adtptr_148", %TName_Bool** %"$retval_22", align 8
  br label %"$matchsucc_125"
...
define internal %TName_Bool* @"$fundef_25"(%"$$fundef_25_env_77"* %0, %TName_Bool* %1) {
entry:
...
"$have_gas_107":                                  ; preds = %"$out_of_gas_106", %"$False_102"
  ...
  store %TName_Bool* %"$adtptr_111", %TName_Bool** %"$retval_26", align 8
...
define internal { %TName_Bool* (i8*, %TName_Bool*)*, i8* } @"$fundef_23"(%"$$fundef_23_env_78"* %0, %TName_Bool* %1) {
entry:
...
"$have_gas_82":                                   ; preds = %"$out_of_gas_81", %entry
  ...
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$$fundef_25_cloval_87", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$retval_24", align 8
...
"$have_gas_163":                                  ; preds = %"$out_of_gas_162", %"$have_gas_158"
  ...
  store { { %TName_Bool* (i8*, %TName_Bool*)*, i8* } (i8*, %TName_Bool*)*, i8* } { { %TName_Bool* (i8*, %TName_Bool*)*, i8* } (i8*, %TName_Bool*)* bitcast ({ %TName_Bool* (i8*, %TName_Bool*)*, i8* } (%"$$fundef_23_env_78"*, %TName_Bool*)* @"$fundef_23" to { %TName_Bool* (i8*, %TName_Bool*)*, i8* } (i8*, %TName_Bool*)*), i8* null }, { { %TName_Bool* (i8*, %TName_Bool*)*, i8* } (i8*, %TName_Bool*)*, i8* }* @BoolUtils.andb, align 8
...
"$have_gas_171":                                  ; preds = %"$out_of_gas_170", %"$have_gas_163"
  ...
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } { %TName_Bool* (i8*, %TName_Bool*)* bitcast (%TName_Bool* (%"$$fundef_21_env_76"*, %TName_Bool*)* @"$fundef_21" to %TName_Bool* (i8*, %TName_Bool*)*), i8* null }, { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* @BoolUtils.negb, align 8
...
"$have_gas_204":                                  ; preds = %"$out_of_gas_203", %"$have_gas_199"
  ...
  store i8* %"$_new_bnum_call_208", i8** %bn1, align 8
...
"$have_gas_218":                                  ; preds = %"$out_of_gas_217", %"$have_gas_213"
  ...
  store i8* %"$_new_bnum_call_222", i8** %bn2, align 8
...
"$have_gas_232":                                  ; preds = %"$out_of_gas_231", %"$have_gas_227"
  ...
  %"$blt_call_237" = call %TName_Bool* @_lt_BNum(i8* %"$execptr_load_234", i8* %"$bn1_235", i8* %"$bn2_236")
  store %TName_Bool* %"$blt_call_237", %TName_Bool** %res1, align 8
...
"$have_gas_247":                                  ; preds = %"$out_of_gas_246", %"$have_gas_242"
  ...
  %"$blt_call_252" = call %TName_Bool* @_lt_BNum(i8* %"$execptr_load_249", i8* %"$bn2_250", i8* %"$bn1_251")
  store %TName_Bool* %"$blt_call_252", %TName_Bool** %res2n, align 8
...
"$have_gas_262":                                  ; preds = %"$out_of_gas_261", %"$have_gas_257"
  ...
  %"$BoolUtils.negb_call_268" = call %TName_Bool* %"$BoolUtils.negb_fptr_265"(i8* %"$BoolUtils.negb_envptr_266", %TName_Bool* %"$res2n_267")
  store %TName_Bool* %"$BoolUtils.negb_call_268", %TName_Bool** %"$BoolUtils.negb_8", align 8
  %"$$BoolUtils.negb_8_269" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.negb_8", align 8
  store %TName_Bool* %"$$BoolUtils.negb_8_269", %TName_Bool** %res2, align 8
...
"$have_gas_298":                                  ; preds = %"$out_of_gas_297", %"$have_gas_293"
  ...
  %"$lt_call_303" = call %TName_Bool* @_lt_Int32(i8* %"$execptr_load_300", %Int32 %"$n1_301", %Int32 %"$n2_302")
  store %TName_Bool* %"$lt_call_303", %TName_Bool** %res3, align 8
...
"$have_gas_313":                                  ; preds = %"$out_of_gas_312", %"$have_gas_308"
  ...
  %"$lt_call_318" = call %TName_Bool* @_lt_Int32(i8* %"$execptr_load_315", %Int32 %"$n2_316", %Int32 %"$n1_317")
  store %TName_Bool* %"$lt_call_318", %TName_Bool** %res4n, align 8
...
"$have_gas_328":                                  ; preds = %"$out_of_gas_327", %"$have_gas_323"
  ...
  %"$BoolUtils.negb_call_334" = call %TName_Bool* %"$BoolUtils.negb_fptr_331"(i8* %"$BoolUtils.negb_envptr_332", %TName_Bool* %"$res4n_333")
  store %TName_Bool* %"$BoolUtils.negb_call_334", %TName_Bool** %"$BoolUtils.negb_9", align 8
  %"$$BoolUtils.negb_9_335" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.negb_9", align 8
  store %TName_Bool* %"$$BoolUtils.negb_9_335", %TName_Bool** %res4, align 8
...
"$have_gas_344":                                  ; preds = %"$out_of_gas_343", %"$have_gas_339"
  ...
  store %Uint256 { i256 100 }, %Uint256* %"$n1_6", align 8
...
"$have_gas_354":                                  ; preds = %"$out_of_gas_353", %"$have_gas_349"
  ...
  store %Uint256 { i256 200 }, %Uint256* %"$n2_7", align 8
...
"$have_gas_365":                                  ; preds = %"$out_of_gas_364", %"$have_gas_359"
  ...
  %"$lt_call_372" = call %TName_Bool* @_lt_Uint256(i8* %"$execptr_load_367", %Uint256* %"$lt_$n1_6_368", %Uint256* %"$lt_$n2_7_370")
  store %TName_Bool* %"$lt_call_372", %TName_Bool** %res5, align 8
...
"$have_gas_383":                                  ; preds = %"$out_of_gas_382", %"$have_gas_377"
  ...
  %"$lt_call_390" = call %TName_Bool* @_lt_Uint256(i8* %"$execptr_load_385", %Uint256* %"$lt_$n2_7_386", %Uint256* %"$lt_$n1_6_388")
  store %TName_Bool* %"$lt_call_390", %TName_Bool** %res6n, align 8
...
"$have_gas_400":                                  ; preds = %"$out_of_gas_399", %"$have_gas_395"
  ...
  %"$BoolUtils.negb_call_406" = call %TName_Bool* %"$BoolUtils.negb_fptr_403"(i8* %"$BoolUtils.negb_envptr_404", %TName_Bool* %"$res6n_405")
  store %TName_Bool* %"$BoolUtils.negb_call_406", %TName_Bool** %"$BoolUtils.negb_10", align 8
  %"$$BoolUtils.negb_10_407" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.negb_10", align 8
  store %TName_Bool* %"$$BoolUtils.negb_10_407", %TName_Bool** %res6, align 8
...
"$have_gas_416":                                  ; preds = %"$out_of_gas_415", %"$have_gas_411"
  ...
  %"$BoolUtils.andb_call_422" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_fptr_419"(i8* %"$BoolUtils.andb_envptr_420", %TName_Bool* %"$res1_421")
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_call_422", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.andb_11", align 8
  ...
  %"$$BoolUtils.andb_11_call_427" = call %TName_Bool* %"$$BoolUtils.andb_11_fptr_424"(i8* %"$$BoolUtils.andb_11_envptr_425", %TName_Bool* %"$res2_426")
  store %TName_Bool* %"$$BoolUtils.andb_11_call_427", %TName_Bool** %"$BoolUtils.andb_12", align 8
  %"$$BoolUtils.andb_12_428" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.andb_12", align 8
  store %TName_Bool* %"$$BoolUtils.andb_12_428", %TName_Bool** %res7, align 8
...
"$have_gas_437":                                  ; preds = %"$out_of_gas_436", %"$have_gas_432"
  ...
  %"$BoolUtils.andb_call_443" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_fptr_440"(i8* %"$BoolUtils.andb_envptr_441", %TName_Bool* %"$res3_442")
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_call_443", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.andb_13", align 8
  ...
  %"$$BoolUtils.andb_13_call_448" = call %TName_Bool* %"$$BoolUtils.andb_13_fptr_445"(i8* %"$$BoolUtils.andb_13_envptr_446", %TName_Bool* %"$res4_447")
  store %TName_Bool* %"$$BoolUtils.andb_13_call_448", %TName_Bool** %"$BoolUtils.andb_14", align 8
  %"$$BoolUtils.andb_14_449" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.andb_14", align 8
  store %TName_Bool* %"$$BoolUtils.andb_14_449", %TName_Bool** %res8, align 8
...
"$have_gas_458":                                  ; preds = %"$out_of_gas_457", %"$have_gas_453"
  ...
  %"$BoolUtils.andb_call_464" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_fptr_461"(i8* %"$BoolUtils.andb_envptr_462", %TName_Bool* %"$res5_463")
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_call_464", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.andb_15", align 8
  ...
  %"$$BoolUtils.andb_15_call_469" = call %TName_Bool* %"$$BoolUtils.andb_15_fptr_466"(i8* %"$$BoolUtils.andb_15_envptr_467", %TName_Bool* %"$res6_468")
  store %TName_Bool* %"$$BoolUtils.andb_15_call_469", %TName_Bool** %"$BoolUtils.andb_16", align 8
  %"$$BoolUtils.andb_16_470" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.andb_16", align 8
  store %TName_Bool* %"$$BoolUtils.andb_16_470", %TName_Bool** %res9, align 8
...
"$have_gas_479":                                  ; preds = %"$out_of_gas_478", %"$have_gas_474"
  ...
  %"$BoolUtils.andb_call_485" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_fptr_482"(i8* %"$BoolUtils.andb_envptr_483", %TName_Bool* %"$res7_484")
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_call_485", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.andb_17", align 8
  ...
  %"$$BoolUtils.andb_17_call_490" = call %TName_Bool* %"$$BoolUtils.andb_17_fptr_487"(i8* %"$$BoolUtils.andb_17_envptr_488", %TName_Bool* %"$res8_489")
  store %TName_Bool* %"$$BoolUtils.andb_17_call_490", %TName_Bool** %"$BoolUtils.andb_18", align 8
  %"$$BoolUtils.andb_18_491" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.andb_18", align 8
  store %TName_Bool* %"$$BoolUtils.andb_18_491", %TName_Bool** %res10, align 8
...
"$have_gas_495":                                  ; preds = %"$out_of_gas_494", %"$have_gas_479"
  ...
  %"$BoolUtils.andb_call_501" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_fptr_498"(i8* %"$BoolUtils.andb_envptr_499", %TName_Bool* %"$res9_500")
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_call_501", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.andb_19", align 8
  ...
  %"$$BoolUtils.andb_19_call_506" = call %TName_Bool* %"$$BoolUtils.andb_19_fptr_503"(i8* %"$$BoolUtils.andb_19_envptr_504", %TName_Bool* %"$res10_505")
  store %TName_Bool* %"$$BoolUtils.andb_19_call_506", %TName_Bool** %"$BoolUtils.andb_20", align 8
  %"$$BoolUtils.andb_20_507" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.andb_20", align 8
  store %TName_Bool* %"$$BoolUtils.andb_20_507", %TName_Bool** %"$expr_27", align 8
