...
define internal %TName_Bool* @"$fundef_21"(%"$$fundef_21_env_78"* %0, %TName_Bool* %1) {
entry:
...
"$have_gas_136":                                  ; preds = %"$out_of_gas_135", %"$True_131"
  ...
  store %TName_Bool* %"$adtptr_140", %TName_Bool** %"$retval_22", align 8
...
"$have_gas_146":                                  ; preds = %"$out_of_gas_145", %"$False_141"
  ...
  store %TName_Bool* %"$adtptr_150", %TName_Bool** %"$retval_22", align 8
  br label %"$matchsucc_127"
...
define internal %TName_Bool* @"$fundef_25"(%"$$fundef_25_env_79"* %0, %TName_Bool* %1) {
entry:
...
"$have_gas_109":                                  ; preds = %"$out_of_gas_108", %"$False_104"
  ...
  store %TName_Bool* %"$adtptr_113", %TName_Bool** %"$retval_26", align 8
...
define internal { %TName_Bool* (i8*, %TName_Bool*)*, i8* } @"$fundef_23"(%"$$fundef_23_env_80"* %0, %TName_Bool* %1) {
entry:
...
"$have_gas_84":                                   ; preds = %"$out_of_gas_83", %entry
  ...
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$$fundef_25_cloval_89", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$retval_24", align 8
...
"$have_gas_165":                                  ; preds = %"$out_of_gas_164", %"$have_gas_160"
  ...
  store { { %TName_Bool* (i8*, %TName_Bool*)*, i8* } (i8*, %TName_Bool*)*, i8* } { { %TName_Bool* (i8*, %TName_Bool*)*, i8* } (i8*, %TName_Bool*)* bitcast ({ %TName_Bool* (i8*, %TName_Bool*)*, i8* } (%"$$fundef_23_env_80"*, %TName_Bool*)* @"$fundef_23" to { %TName_Bool* (i8*, %TName_Bool*)*, i8* } (i8*, %TName_Bool*)*), i8* null }, { { %TName_Bool* (i8*, %TName_Bool*)*, i8* } (i8*, %TName_Bool*)*, i8* }* @BoolUtils.andb, align 8
...
"$have_gas_173":                                  ; preds = %"$out_of_gas_172", %"$have_gas_165"
  ...
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } { %TName_Bool* (i8*, %TName_Bool*)* bitcast (%TName_Bool* (%"$$fundef_21_env_78"*, %TName_Bool*)* @"$fundef_21" to %TName_Bool* (i8*, %TName_Bool*)*), i8* null }, { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* @BoolUtils.negb, align 8
...
"$have_gas_206":                                  ; preds = %"$out_of_gas_205", %"$have_gas_201"
  ...
  store i8* %"$_new_bnum_call_210", i8** %bn1, align 8
...
"$have_gas_220":                                  ; preds = %"$out_of_gas_219", %"$have_gas_215"
  ...
  store i8* %"$_new_bnum_call_224", i8** %bn2, align 8
...
"$have_gas_234":                                  ; preds = %"$out_of_gas_233", %"$have_gas_229"
  ...
  %"$blt_call_239" = call %TName_Bool* @_lt_BNum(i8* %"$execptr_load_236", i8* %"$bn1_237", i8* %"$bn2_238")
  store %TName_Bool* %"$blt_call_239", %TName_Bool** %res1, align 8
...
"$have_gas_249":                                  ; preds = %"$out_of_gas_248", %"$have_gas_244"
  ...
  %"$blt_call_254" = call %TName_Bool* @_lt_BNum(i8* %"$execptr_load_251", i8* %"$bn2_252", i8* %"$bn1_253")
  store %TName_Bool* %"$blt_call_254", %TName_Bool** %res2n, align 8
...
"$have_gas_264":                                  ; preds = %"$out_of_gas_263", %"$have_gas_259"
  ...
  %"$BoolUtils.negb_call_270" = call %TName_Bool* %"$BoolUtils.negb_fptr_267"(i8* %"$BoolUtils.negb_envptr_268", %TName_Bool* %"$res2n_269")
  store %TName_Bool* %"$BoolUtils.negb_call_270", %TName_Bool** %"$BoolUtils.negb_8", align 8
  %"$$BoolUtils.negb_8_271" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.negb_8", align 8
  store %TName_Bool* %"$$BoolUtils.negb_8_271", %TName_Bool** %res2, align 8
...
"$have_gas_300":                                  ; preds = %"$out_of_gas_299", %"$have_gas_295"
  ...
  %"$lt_call_305" = call %TName_Bool* @_lt_Int32(i8* %"$execptr_load_302", %Int32 %"$n1_303", %Int32 %"$n2_304")
  store %TName_Bool* %"$lt_call_305", %TName_Bool** %res3, align 8
...
"$have_gas_315":                                  ; preds = %"$out_of_gas_314", %"$have_gas_310"
  ...
  %"$lt_call_320" = call %TName_Bool* @_lt_Int32(i8* %"$execptr_load_317", %Int32 %"$n2_318", %Int32 %"$n1_319")
  store %TName_Bool* %"$lt_call_320", %TName_Bool** %res4n, align 8
...
"$have_gas_330":                                  ; preds = %"$out_of_gas_329", %"$have_gas_325"
  ...
  %"$BoolUtils.negb_call_336" = call %TName_Bool* %"$BoolUtils.negb_fptr_333"(i8* %"$BoolUtils.negb_envptr_334", %TName_Bool* %"$res4n_335")
  store %TName_Bool* %"$BoolUtils.negb_call_336", %TName_Bool** %"$BoolUtils.negb_9", align 8
  %"$$BoolUtils.negb_9_337" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.negb_9", align 8
  store %TName_Bool* %"$$BoolUtils.negb_9_337", %TName_Bool** %res4, align 8
...
"$have_gas_367":                                  ; preds = %"$out_of_gas_366", %"$have_gas_361"
  ...
  %"$lt_call_374" = call %TName_Bool* @_lt_Uint256(i8* %"$execptr_load_369", %Uint256* %"$lt_$n1_6_370", %Uint256* %"$lt_$n2_7_372")
  store %TName_Bool* %"$lt_call_374", %TName_Bool** %res5, align 8
...
"$have_gas_385":                                  ; preds = %"$out_of_gas_384", %"$have_gas_379"
  ...
  %"$lt_call_392" = call %TName_Bool* @_lt_Uint256(i8* %"$execptr_load_387", %Uint256* %"$lt_$n2_7_388", %Uint256* %"$lt_$n1_6_390")
  store %TName_Bool* %"$lt_call_392", %TName_Bool** %res6n, align 8
...
"$have_gas_402":                                  ; preds = %"$out_of_gas_401", %"$have_gas_397"
  ...
  %"$BoolUtils.negb_call_408" = call %TName_Bool* %"$BoolUtils.negb_fptr_405"(i8* %"$BoolUtils.negb_envptr_406", %TName_Bool* %"$res6n_407")
  store %TName_Bool* %"$BoolUtils.negb_call_408", %TName_Bool** %"$BoolUtils.negb_10", align 8
  %"$$BoolUtils.negb_10_409" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.negb_10", align 8
  store %TName_Bool* %"$$BoolUtils.negb_10_409", %TName_Bool** %res6, align 8
...
"$have_gas_418":                                  ; preds = %"$out_of_gas_417", %"$have_gas_413"
  ...
  %"$BoolUtils.andb_call_424" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_fptr_421"(i8* %"$BoolUtils.andb_envptr_422", %TName_Bool* %"$res1_423")
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_call_424", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.andb_11", align 8
  ...
  %"$$BoolUtils.andb_11_call_429" = call %TName_Bool* %"$$BoolUtils.andb_11_fptr_426"(i8* %"$$BoolUtils.andb_11_envptr_427", %TName_Bool* %"$res2_428")
  store %TName_Bool* %"$$BoolUtils.andb_11_call_429", %TName_Bool** %"$BoolUtils.andb_12", align 8
  %"$$BoolUtils.andb_12_430" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.andb_12", align 8
  store %TName_Bool* %"$$BoolUtils.andb_12_430", %TName_Bool** %res7, align 8
...
"$have_gas_439":                                  ; preds = %"$out_of_gas_438", %"$have_gas_434"
  ...
  %"$BoolUtils.andb_call_445" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_fptr_442"(i8* %"$BoolUtils.andb_envptr_443", %TName_Bool* %"$res3_444")
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_call_445", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.andb_13", align 8
  ...
  %"$$BoolUtils.andb_13_call_450" = call %TName_Bool* %"$$BoolUtils.andb_13_fptr_447"(i8* %"$$BoolUtils.andb_13_envptr_448", %TName_Bool* %"$res4_449")
  store %TName_Bool* %"$$BoolUtils.andb_13_call_450", %TName_Bool** %"$BoolUtils.andb_14", align 8
  %"$$BoolUtils.andb_14_451" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.andb_14", align 8
  store %TName_Bool* %"$$BoolUtils.andb_14_451", %TName_Bool** %res8, align 8
...
"$have_gas_460":                                  ; preds = %"$out_of_gas_459", %"$have_gas_455"
  ...
  %"$BoolUtils.andb_call_466" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_fptr_463"(i8* %"$BoolUtils.andb_envptr_464", %TName_Bool* %"$res5_465")
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_call_466", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.andb_15", align 8
  ...
  %"$$BoolUtils.andb_15_call_471" = call %TName_Bool* %"$$BoolUtils.andb_15_fptr_468"(i8* %"$$BoolUtils.andb_15_envptr_469", %TName_Bool* %"$res6_470")
  store %TName_Bool* %"$$BoolUtils.andb_15_call_471", %TName_Bool** %"$BoolUtils.andb_16", align 8
  %"$$BoolUtils.andb_16_472" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.andb_16", align 8
  store %TName_Bool* %"$$BoolUtils.andb_16_472", %TName_Bool** %res9, align 8
...
"$have_gas_481":                                  ; preds = %"$out_of_gas_480", %"$have_gas_476"
  ...
  %"$BoolUtils.andb_call_487" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_fptr_484"(i8* %"$BoolUtils.andb_envptr_485", %TName_Bool* %"$res7_486")
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_call_487", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.andb_17", align 8
  ...
  %"$$BoolUtils.andb_17_call_492" = call %TName_Bool* %"$$BoolUtils.andb_17_fptr_489"(i8* %"$$BoolUtils.andb_17_envptr_490", %TName_Bool* %"$res8_491")
  store %TName_Bool* %"$$BoolUtils.andb_17_call_492", %TName_Bool** %"$BoolUtils.andb_18", align 8
  %"$$BoolUtils.andb_18_493" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.andb_18", align 8
  store %TName_Bool* %"$$BoolUtils.andb_18_493", %TName_Bool** %res10, align 8
...
"$have_gas_497":                                  ; preds = %"$out_of_gas_496", %"$have_gas_481"
  ...
  %"$BoolUtils.andb_call_503" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_fptr_500"(i8* %"$BoolUtils.andb_envptr_501", %TName_Bool* %"$res9_502")
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_call_503", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.andb_19", align 8
  ...
  %"$$BoolUtils.andb_19_call_508" = call %TName_Bool* %"$$BoolUtils.andb_19_fptr_505"(i8* %"$$BoolUtils.andb_19_envptr_506", %TName_Bool* %"$res10_507")
  store %TName_Bool* %"$$BoolUtils.andb_19_call_508", %TName_Bool** %"$BoolUtils.andb_20", align 8
  %"$$BoolUtils.andb_20_509" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.andb_20", align 8
  store %TName_Bool* %"$$BoolUtils.andb_20_509", %TName_Bool** %"$expr_27", align 8
