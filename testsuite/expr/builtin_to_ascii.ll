...
"$have_gas_104":                                  ; preds = %"$out_of_gas_103", %"$have_gas_99"
  ...
  %"$to_bystr_call_110" = call %Bystr @_to_bystr(i8* %"$execptr_load_106", i32 6, i8* %"$$to_bystr_world_107_109")
  store %Bystr %"$to_bystr_call_110", %Bystr* %worldx, align 8
...
"$have_gas_123":                                  ; preds = %"$out_of_gas_122", %"$have_gas_114"
  ...
  %"$to_ascii_call_129" = call %String @_to_ascii(i8* %"$execptr_load_125", i8* %"$$to_ascii_hello_126_128", i32 5)
  store %String %"$to_ascii_call_129", %String* %hello_s, align 8
...
"$have_gas_142":                                  ; preds = %"$out_of_gas_141", %"$have_gas_133"
  ...
  %"$to_ascii_call_148" = call %String @_to_ascii(i8* %"$execptr_load_147", i8* %"$to_ascii_145", i32 %"$to_ascii_146")
  store %String %"$to_ascii_call_148", %String* %world_s, align 8
...
"$have_gas_161":                                  ; preds = %"$out_of_gas_160", %"$have_gas_142"
  ...
  %"$concat_call_166" = call %String @_concat_String(i8* %"$execptr_load_163", %String %"$hello_s_164", %String %"$world_s_165")
  store %String %"$concat_call_166", %String* %"$expr_6", align 8
