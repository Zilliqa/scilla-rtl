...
"$have_gas_165":                                  ; preds = %"$out_of_gas_164", %"$have_gas_160"
  ...
  %"$to_bystr4_call_169" = call i8* @_uint32_to_bystrx(i8* %"$execptr_load_167", %Uint32 %"$uint32_100_168")
...
"$have_gas_190":                                  ; preds = %"$out_of_gas_189", %"$have_gas_185"
  ...
  %"$to_bystr8_call_194" = call i8* @_uint64_to_bystrx(i8* %"$execptr_load_192", %Uint64 %"$uint64_200_193")
...
"$have_gas_215":                                  ; preds = %"$out_of_gas_214", %"$have_gas_210"
  ...
  %"$to_bystr16_call_219" = call i8* @_uint128_to_bystrx(i8* %"$execptr_load_217", %Uint128 %"$uint128_300_218")
...
"$have_gas_240":                                  ; preds = %"$out_of_gas_239", %"$have_gas_235"
  ...
  %"$to_bystr32_call_245" = call i8* @_uint256_to_bystrx(i8* %"$execptr_load_242", %Uint256* %"$to_bystr32_uint256_400_243")
...
"$have_gas_266":                                  ; preds = %"$out_of_gas_265", %"$have_gas_261"
  ...
  %"$to_bystr_call_272" = call %Bystr @_to_bystr(i8* %"$execptr_load_268", i32 2, i8* %"$$to_bystr_x_269_271")
  store %Bystr %"$to_bystr_call_272", %Bystr* %xbs, align 8
...
"$have_gas_281":                                  ; preds = %"$out_of_gas_280", %"$have_gas_276"
  ...
  %"$to_bystr2_call_285" = call i8* @_bystr_to_bystrx(i8* %"$execptr_load_283", i32 2, %Bystr %"$xbs_284")
  %"$to_bystr2_286" = bitcast i8* %"$to_bystr2_call_285" to %TName_Option_ByStr2*
  store %TName_Option_ByStr2* %"$to_bystr2_286", %TName_Option_ByStr2** %res_x_some, align 8
...
"$have_gas_295":                                  ; preds = %"$out_of_gas_294", %"$have_gas_290"
  ...
  %"$to_bystr3_call_299" = call i8* @_bystr_to_bystrx(i8* %"$execptr_load_297", i32 3, %Bystr %"$xbs_298")
  %"$to_bystr3_300" = bitcast i8* %"$to_bystr3_call_299" to %TName_Option_ByStr3*
  store %TName_Option_ByStr3* %"$to_bystr3_300", %TName_Option_ByStr3** %res_x_none, align 8
...
"$have_gas_309":                                  ; preds = %"$out_of_gas_308", %"$have_gas_304"
  ...
  store %"TName_Pair_Option_(ByStr2)_Option_(ByStr3)"* %"$adtptr_317", %"TName_Pair_Option_(ByStr2)_Option_(ByStr3)"** %res_x_opt_out, align 8
...
"$have_gas_326":                                  ; preds = %"$out_of_gas_325", %"$have_gas_321"
  ...
  store %TName_Pair_ByStr4_ByStr8* %"$adtptr_334", %TName_Pair_ByStr4_ByStr8** %out1, align 8
...
"$have_gas_343":                                  ; preds = %"$out_of_gas_342", %"$have_gas_338"
  ...
  store %"TName_Pair_Pair_(ByStr4)_(ByStr8)_ByStr16"* %"$adtptr_351", %"TName_Pair_Pair_(ByStr4)_(ByStr8)_ByStr16"** %out2, align 8
...
"$have_gas_360":                                  ; preds = %"$out_of_gas_359", %"$have_gas_355"
  ...
  store %"TName_Pair_Pair_(Pair_(ByStr4)_(ByStr8))_(ByStr16)_ByStr32"* %"$adtptr_368", %"TName_Pair_Pair_(Pair_(ByStr4)_(ByStr8))_(ByStr16)_ByStr32"** %out3, align 8
...
"$have_gas_377":                                  ; preds = %"$out_of_gas_376", %"$have_gas_372"
  ...
  store %"TName_Pair_Pair_(Pair_(Pair_(ByStr4)_(ByStr8))_(ByStr16))_(ByStr32)_Pair_(Option_(ByStr2))_(Option_(ByStr3))"* %"$adtptr_385", %"TName_Pair_Pair_(Pair_(Pair_(ByStr4)_(ByStr8))_(ByStr16))_(ByStr32)_Pair_(Option_(ByStr2))_(Option_(ByStr3))"** %out4, align 8
...
"$have_gas_389":                                  ; preds = %"$out_of_gas_388", %"$have_gas_377"
  ...
  store %"TName_Pair_Pair_(Pair_(Pair_(ByStr4)_(ByStr8))_(ByStr16))_(ByStr32)_Pair_(Option_(ByStr2))_(Option_(ByStr3))"* %"$out4_391", %"TName_Pair_Pair_(Pair_(Pair_(ByStr4)_(ByStr8))_(ByStr16))_(ByStr32)_Pair_(Option_(ByStr2))_(Option_(ByStr3))"** %"$expr_6", align 8
