...
%Int32 = type { i32 }
%"$ParamDescr_151" = type { %ParamDescrString, %_TyDescrTy_Typ* }
%ParamDescrString = type { i8*, i32 }
%"$TransDescr_152" = type { %ParamDescrString, i32, %"$ParamDescr_151"* }
...
@"$TyDescr_ADT_Bool_41" = unnamed_addr constant %_TyDescrTy_Typ { i32 1, i8* bitcast (%"$TyDescrTy_ADTTyp_Specl_38"* @"$TyDescr_Bool_ADTTyp_Specl_54" to i8*) }
@"$TyDescr_Bool_ADTTyp_45" = unnamed_addr constant %"$TyDescrTy_ADTTyp_39" { %TyDescrString { i8* getelementptr inbounds ([4 x i8], [4 x i8]* @"$TyDescr_ADT_Bool_56", i32 0, i32 0), i32 4 }, i32 0, i32 2, i32 1, %"$TyDescrTy_ADTTyp_Specl_38"** getelementptr inbounds ([1 x %"$TyDescrTy_ADTTyp_Specl_38"*], [1 x %"$TyDescrTy_ADTTyp_Specl_38"*]* @"$TyDescr_Bool_ADTTyp_m_specls_55", i32 0, i32 0) }
...
@"$TyDescr_Bool_False_ADTTyp_Constr_51" = unnamed_addr constant %"$TyDescrTy_ADTTyp_Constr_40" { %TyDescrString { i8* getelementptr inbounds ([5 x i8], [5 x i8]* @"$TyDescr_ADT_False_50", i32 0, i32 0), i32 5 }, i32 0, %_TyDescrTy_Typ** getelementptr inbounds ([0 x %_TyDescrTy_Typ*], [0 x %_TyDescrTy_Typ*]* @"$TyDescr_Bool_False_Constr_m_args_49", i32 0, i32 0) }
@"$TyDescr_Bool_ADTTyp_Specl_m_constrs_52" = unnamed_addr constant [2 x %"$TyDescrTy_ADTTyp_Constr_40"*] [%"$TyDescrTy_ADTTyp_Constr_40"* @"$TyDescr_Bool_True_ADTTyp_Constr_48", %"$TyDescrTy_ADTTyp_Constr_40"* @"$TyDescr_Bool_False_ADTTyp_Constr_51"]
@"$TyDescr_Bool_ADTTyp_Specl_m_TArgs_53" = unnamed_addr constant [0 x %_TyDescrTy_Typ*] zeroinitializer
@"$TyDescr_Bool_ADTTyp_Specl_54" = unnamed_addr constant %"$TyDescrTy_ADTTyp_Specl_38" { %_TyDescrTy_Typ** getelementptr inbounds ([0 x %_TyDescrTy_Typ*], [0 x %_TyDescrTy_Typ*]* @"$TyDescr_Bool_ADTTyp_Specl_m_TArgs_53", i32 0, i32 0), %"$TyDescrTy_ADTTyp_Constr_40"** getelementptr inbounds ([2 x %"$TyDescrTy_ADTTyp_Constr_40"*], [2 x %"$TyDescrTy_ADTTyp_Constr_40"*]* @"$TyDescr_Bool_ADTTyp_Specl_m_constrs_52", i32 0, i32 0), %"$TyDescrTy_ADTTyp_39"* @"$TyDescr_Bool_ADTTyp_45" }
@"$TyDescr_Bool_ADTTyp_m_specls_55" = unnamed_addr constant [1 x %"$TyDescrTy_ADTTyp_Specl_38"*] [%"$TyDescrTy_ADTTyp_Specl_38"* @"$TyDescr_Bool_ADTTyp_Specl_54"]
...
@_tydescr_table = constant [16 x %_TyDescrTy_Typ*] [%_TyDescrTy_Typ* @"$TyDescr_Event_31", %_TyDescrTy_Typ* @"$TyDescr_Int64_13", %_TyDescrTy_Typ* @"$TyDescr_ADT_Bool_41", %_TyDescrTy_Typ* @"$TyDescr_Uint256_23", %_TyDescrTy_Typ* @"$TyDescr_Uint32_11", %_TyDescrTy_Typ* @"$TyDescr_Uint64_15", %_TyDescrTy_Typ* @"$TyDescr_Bnum_27", %_TyDescrTy_Typ* @"$TyDescr_Uint128_19", %_TyDescrTy_Typ* @"$TyDescr_Exception_33", %_TyDescrTy_Typ* @"$TyDescr_String_25", %_TyDescrTy_Typ* @"$TyDescr_Int256_21", %_TyDescrTy_Typ* @"$TyDescr_Int128_17", %_TyDescrTy_Typ* @"$TyDescr_Bystr_37", %_TyDescrTy_Typ* @"$TyDescr_ReplicateContr_35", %_TyDescrTy_Typ* @"$TyDescr_Message_29", %_TyDescrTy_Typ* @"$TyDescr_Int32_9"]
@_tydescr_table_length = constant i32 16
@_contract_parameters = constant [0 x %"$ParamDescr_151"] zeroinitializer
@_contract_parameters_length = constant i32 0
@_transition_parameters = constant [0 x %"$TransDescr_152"] zeroinitializer
...
entry:
  ...
  call void @llvm.dbg.declare(metadata %Int32* %"$expr_6", metadata !11, metadata !DIExpression()), !dbg !13
...
"$have_gas_90":                                   ; preds = %"$out_of_gas_89", %entry
  ...
  call void @llvm.dbg.declare(metadata %TName_Bool** %b, metadata !14, metadata !DIExpression()), !dbg !17
...
"$have_gas_95":                                   ; preds = %"$out_of_gas_94", %"$have_gas_90"
  ...
  %"$adtval_97" = bitcast i8* %"$adtval_97_salloc" to %CName_False*
  %"$adtgep_98" = getelementptr inbounds %CName_False, %CName_False* %"$adtval_97", i32 0, i32 0
  store i8 1, i8* %"$adtgep_98", align 1
  %"$adtptr_99" = bitcast %CName_False* %"$adtval_97" to %TName_Bool*
  store %TName_Bool* %"$adtptr_99", %TName_Bool** %b, align 8, !dbg !13
...
"$have_gas_103":                                  ; preds = %"$out_of_gas_102", %"$have_gas_95"
  ...
  switch i8 %"$b_tag_108", label %"$empty_default_109" [
    i8 0, label %"$True_110"
    i8 1, label %"$False_128"
  ], !dbg !18

"$True_110":                                      ; preds = %"$have_gas_103"
  %"$b_111" = bitcast %TName_Bool* %"$b_106" to %CName_True*
...
"$out_of_gas_114":                                ; preds = %"$True_110"
  call void @_out_of_gas()
  br label %"$have_gas_115"

"$have_gas_115":                                  ; preds = %"$out_of_gas_114", %"$True_110"
  %"$consume_116" = sub i64 %"$gasrem_112", 1
  store i64 %"$consume_116", i64* @_gasrem, align 8
  %x = alloca %Int32, align 8
  call void @llvm.dbg.declare(metadata %Int32* %x, metadata !19, metadata !DIExpression()), !dbg !22
...
"$have_gas_120":                                  ; preds = %"$out_of_gas_119", %"$have_gas_115"
  ...
  store %Int32 { i32 1 }, %Int32* %x, align 4, !dbg !23
...
"$have_gas_125":                                  ; preds = %"$out_of_gas_124", %"$have_gas_120"
  ...
  store %Int32 %"$x_127", %Int32* %"$expr_6", align 4, !dbg !24
  br label %"$matchsucc_105"

"$False_128":                                     ; preds = %"$have_gas_103"
  %"$b_129" = bitcast %TName_Bool* %"$b_106" to %CName_False*
...
"$out_of_gas_132":                                ; preds = %"$False_128"
  call void @_out_of_gas()
  br label %"$have_gas_133"

"$have_gas_133":                                  ; preds = %"$out_of_gas_132", %"$False_128"
  %"$consume_134" = sub i64 %"$gasrem_130", 1
  store i64 %"$consume_134", i64* @_gasrem, align 8
  %x1 = alloca %Int32, align 8
  call void @llvm.dbg.declare(metadata %Int32* %x1, metadata !25, metadata !DIExpression()), !dbg !27
...
"$have_gas_138":                                  ; preds = %"$out_of_gas_137", %"$have_gas_133"
  ...
  store %Int32 { i32 2 }, %Int32* %x1, align 4, !dbg !28
...
"$have_gas_143":                                  ; preds = %"$out_of_gas_142", %"$have_gas_138"
  ...
  %"$x_145" = load %Int32, %Int32* %x1, align 4
  store %Int32 %"$x_145", %Int32* %"$expr_6", align 4, !dbg !29
  br label %"$matchsucc_105"

"$empty_default_109":                             ; preds = %"$have_gas_103"
  br label %"$matchsucc_105"

"$matchsucc_105":                                 ; preds = %"$have_gas_143", %"$have_gas_125", %"$empty_default_109"
  %"$$expr_6_146" = load %Int32, %Int32* %"$expr_6", align 4
  ret %Int32 %"$$expr_6_146"
}
...
entry:
  %"$exprval_147" = call %Int32 @_scilla_expr_fun(i8* null)
  %"$pval_148" = alloca %Int32, align 8
  %"$memvoidcast_149" = bitcast %Int32* %"$pval_148" to i8*
  store %Int32 %"$exprval_147", %Int32* %"$pval_148", align 4
  %"$execptr_load_150" = load i8*, i8** @_execptr, align 8
  call void @_print_scilla_val(i8* %"$execptr_load_150", %_TyDescrTy_Typ* @"$TyDescr_Int32_9", i8* %"$memvoidcast_149")
  ret void
}
...
!2 = !DIFile(filename: "match_assign.scilexp", directory: "codegen/expr")
...
!13 = !DILocation(line: 1, column: 9, scope: !10)
!14 = !DILocalVariable(name: "b", scope: !10, file: !2, line: 1, type: !15)
!15 = !DIDerivedType(tag: DW_TAG_pointer_type, name: "Bool", baseType: !16, size: 8, align: 8, dwarfAddressSpace: 0)
!16 = !DIBasicType(name: "Bool", size: 8)
!17 = !DILocation(line: 1, column: 5, scope: !10)
!18 = !DILocation(line: 2, column: 1, scope: !10)
!19 = !DILocalVariable(name: "x", scope: !20, file: !2, line: 4, type: !12)
!20 = distinct !DILexicalBlock(scope: !21, file: !2, line: 3, column: 3)
!21 = distinct !DILexicalBlock(scope: !10, file: !2, line: 2, column: 1)
!22 = !DILocation(line: 4, column: 7, scope: !20)
!23 = !DILocation(line: 4, column: 11, scope: !20)
!24 = !DILocation(line: 5, column: 3, scope: !20)
!25 = !DILocalVariable(name: "x", scope: !26, file: !2, line: 7, type: !12)
!26 = distinct !DILexicalBlock(scope: !21, file: !2, line: 6, column: 3)
!27 = !DILocation(line: 7, column: 7, scope: !26)
!28 = !DILocation(line: 7, column: 11, scope: !26)
!29 = !DILocation(line: 8, column: 3, scope: !26)
