...
entry:
  ...
  call void @llvm.dbg.declare(metadata %TName_List_Int32** %"$expr_6", metadata !11, metadata !DIExpression()), !dbg !14
...
"$have_gas_90":                                   ; preds = %"$out_of_gas_89", %entry
  ...
  store %TName_List_Int32* %"$adtptr_94", %TName_List_Int32** %"$expr_6", align 8, !dbg !14
