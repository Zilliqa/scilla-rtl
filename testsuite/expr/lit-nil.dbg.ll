...
"$have_gas_52":                                   ; preds = %"$out_of_gas_51", %entry
  ...
  store %TName_List_Int32* %"$adtptr_56", %TName_List_Int32** %"$expr_0", align 8, !dbg !10
...
entry:
  ...
  call void @_print_scilla_val(%_TyDescrTy_Typ* @"$TyDescr_ADT_List_Int32_33", i8* %"$memvoidcast_59")
  ret void
}
