...
"$have_gas_93":                                   ; preds = %"$out_of_gas_92", %"$have_gas_88"
  ...
  %"$adtval_95" = bitcast i8* %"$adtval_95_salloc" to %CName_Zero*
  %"$adtgep_96" = getelementptr inbounds %CName_Zero, %CName_Zero* %"$adtval_95", i32 0, i32 0
  store i8 0, i8* %"$adtgep_96", align 1
  %"$adtptr_97" = bitcast %CName_Zero* %"$adtval_95" to %TName_Nat*
  store %TName_Nat* %"$adtptr_97", %TName_Nat** %zero, align 8, !dbg !11
...
"$have_gas_106":                                  ; preds = %"$out_of_gas_105", %"$have_gas_101"
  ...
  %"$zero_108" = load %TName_Nat*, %TName_Nat** %zero, align 8
  %"$adtval_109_load" = load i8*, i8** @_execptr, align 8
  %"$adtval_109_salloc" = call i8* @_salloc(i8* %"$adtval_109_load", i64 9)
  %"$adtval_109" = bitcast i8* %"$adtval_109_salloc" to %CName_Succ*
  %"$adtgep_110" = getelementptr inbounds %CName_Succ, %CName_Succ* %"$adtval_109", i32 0, i32 0
  store i8 1, i8* %"$adtgep_110", align 1
  %"$adtgep_111" = getelementptr inbounds %CName_Succ, %CName_Succ* %"$adtval_109", i32 0, i32 1
  store %TName_Nat* %"$zero_108", %TName_Nat** %"$adtgep_111", align 8
  %"$adtptr_112" = bitcast %CName_Succ* %"$adtval_109" to %TName_Nat*
  store %TName_Nat* %"$adtptr_112", %TName_Nat** %one, align 8, !dbg !12
...
"$have_gas_121":                                  ; preds = %"$out_of_gas_120", %"$have_gas_116"
  ...
  %"$one_123" = load %TName_Nat*, %TName_Nat** %one, align 8
  %"$adtval_124_load" = load i8*, i8** @_execptr, align 8
  %"$adtval_124_salloc" = call i8* @_salloc(i8* %"$adtval_124_load", i64 9)
  %"$adtval_124" = bitcast i8* %"$adtval_124_salloc" to %CName_Succ*
  %"$adtgep_125" = getelementptr inbounds %CName_Succ, %CName_Succ* %"$adtval_124", i32 0, i32 0
  store i8 1, i8* %"$adtgep_125", align 1
  %"$adtgep_126" = getelementptr inbounds %CName_Succ, %CName_Succ* %"$adtval_124", i32 0, i32 1
  store %TName_Nat* %"$one_123", %TName_Nat** %"$adtgep_126", align 8
  %"$adtptr_127" = bitcast %CName_Succ* %"$adtval_124" to %TName_Nat*
  store %TName_Nat* %"$adtptr_127", %TName_Nat** %two, align 8, !dbg !13
...
"$have_gas_131":                                  ; preds = %"$out_of_gas_130", %"$have_gas_121"
  ...
  %"$two_133" = load %TName_Nat*, %TName_Nat** %two, align 8
  store %TName_Nat* %"$two_133", %TName_Nat** %"$expr_6", align 8, !dbg !14
  %"$$expr_6_134" = load %TName_Nat*, %TName_Nat** %"$expr_6", align 8
  ret %TName_Nat* %"$$expr_6_134"
}
...
entry:
  %"$exprval_135" = call %TName_Nat* @_scilla_expr_fun(i8* null)
  %"$memvoidcast_136" = bitcast %TName_Nat* %"$exprval_135" to i8*
  %"$execptr_load_137" = load i8*, i8** @_execptr, align 8
  call void @_print_scilla_val(i8* %"$execptr_load_137", %_TyDescrTy_Typ* @"$TyDescr_ADT_Nat_39", i8* %"$memvoidcast_136")
  ret void
}
