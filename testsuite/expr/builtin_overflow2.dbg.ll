...
"$have_gas_77":                                   ; preds = %"$out_of_gas_76", %entry
  ...
  call void @llvm.dbg.declare(metadata %Uint32* %a, metadata !14, metadata !DIExpression()), !dbg !15
...
"$have_gas_87":                                   ; preds = %"$out_of_gas_86", %"$have_gas_82"
  ...
  call void @llvm.dbg.declare(metadata %Uint32* %b, metadata !16, metadata !DIExpression()), !dbg !17
...
"$have_gas_92":                                   ; preds = %"$out_of_gas_91", %"$have_gas_87"
  ...
  store %Uint32 { i32 -1 }, %Uint32* %b, align 4, !dbg !18
  %"$gasrem_94" = load i64, i64* @_gasrem, align 8
  %"$gascmp_95" = icmp ugt i64 4, %"$gasrem_94"
...
"$have_gas_97":                                   ; preds = %"$out_of_gas_96", %"$have_gas_92"
  %"$consume_98" = sub i64 %"$gasrem_94", 4
  store i64 %"$consume_98", i64* @_gasrem, align 8
  %"$a_99" = load %Uint32, %Uint32* %a, align 4
  %"$b_100" = load %Uint32, %Uint32* %b, align 4
  %"$add_call_101" = call %Uint32 @_add_Uint32(%Uint32 %"$a_99", %Uint32 %"$b_100"), !dbg !19
  store %Uint32 %"$add_call_101", %Uint32* %"$expr_6", align 4, !dbg !19
  %"$$expr_6_102" = load %Uint32, %Uint32* %"$expr_6", align 4
  ret %Uint32 %"$$expr_6_102"
}
...
entry:
  %"$exprval_103" = call %Uint32 @_scilla_expr_fun(i8* null)
  %"$pval_104" = alloca %Uint32, align 8
  %"$memvoidcast_105" = bitcast %Uint32* %"$pval_104" to i8*
  store %Uint32 %"$exprval_103", %Uint32* %"$pval_104", align 4
  %"$execptr_load_106" = load i8*, i8** @_execptr, align 8
  call void @_print_scilla_val(i8* %"$execptr_load_106", %_TyDescrTy_Typ* @"$TyDescr_Uint32_11", i8* %"$memvoidcast_105")
  ret void
}
