...
"$have_gas_95":                                   ; preds = %"$out_of_gas_94", %"$have_gas_90"
  ...
  %"$add_call_99" = call %Uint32 @_add_Uint32(%Uint32 %"$a_97", %Uint32 %"$b_98"), !dbg !13
...
!2 = !DIFile(filename: "builtin_overflow2.scilexp", directory: "codegen/expr")
!3 = !{}
