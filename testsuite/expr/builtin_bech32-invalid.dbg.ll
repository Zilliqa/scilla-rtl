...
@"$stringlit_99" = unnamed_addr constant [42 x i8] c"zil102n74869xnvdwq3yh8p0k9jjgtejruft268tg9"
...
define internal %TName_Option_ByStr20* @_scilla_expr_fun(i8* %0) !dbg !10 {
entry:
  %"$expr_6" = alloca %TName_Option_ByStr20*, align 8
  call void @llvm.dbg.declare(metadata %TName_Option_ByStr20** %"$expr_6", metadata !11, metadata !DIExpression()), !dbg !14
...
"$have_gas_92":                                   ; preds = %"$out_of_gas_91", %entry
  ...
  call void @llvm.dbg.declare(metadata %String* %bech32str, metadata !15, metadata !DIExpression()), !dbg !17
...
"$have_gas_97":                                   ; preds = %"$out_of_gas_96", %"$have_gas_92"
  ...
  store %String { i8* getelementptr inbounds ([42 x i8], [42 x i8]* @"$stringlit_99", i32 0, i32 0), i32 42 }, %String* %bech32str, align 8, !dbg !14
...
"$have_gas_103":                                  ; preds = %"$out_of_gas_102", %"$have_gas_97"
  ...
  call void @llvm.dbg.declare(metadata %String* %prefix, metadata !18, metadata !DIExpression()), !dbg !19
...
"$have_gas_108":                                  ; preds = %"$out_of_gas_107", %"$have_gas_103"
  ...
  store %String { i8* getelementptr inbounds ([3 x i8], [3 x i8]* @"$stringlit_110", i32 0, i32 0), i32 3 }, %String* %prefix, align 8, !dbg !20
...
"$have_gas_124":                                  ; preds = %"$out_of_gas_123", %"$have_gas_108"
  ...
  %"$bech32_to_bystr20_call_129" = call %TName_Option_ByStr20* @_bech32_to_bystr20(i8* %"$execptr_load_126", %String %"$prefix_127", %String %"$bech32str_128"), !dbg !21
...
!2 = !DIFile(filename: "builtin_bech32-invalid.scilexp", directory: "codegen/expr")
...
!12 = !DIDerivedType(tag: DW_TAG_pointer_type, name: "Option (ByStr20)", baseType: !13, size: 8, align: 8, dwarfAddressSpace: 0)
!13 = !DIBasicType(name: "Option (ByStr20)", size: 8)
!14 = !DILocation(line: 1, column: 60, scope: !10)
!15 = !DILocalVariable(name: "bech32str", scope: !10, file: !2, line: 1, type: !16)
!16 = !DIBasicType(name: "String", size: 16)
!17 = !DILocation(line: 1, column: 5, scope: !10)
!18 = !DILocalVariable(name: "prefix", scope: !10, file: !2, line: 2, type: !16)
