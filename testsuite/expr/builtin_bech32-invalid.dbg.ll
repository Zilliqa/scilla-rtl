...
"$have_gas_97":                                   ; preds = %"$out_of_gas_96", %"$have_gas_92"
  ...
  store %String { i8* getelementptr inbounds ([42 x i8], [42 x i8]* @"$stringlit_99", i32 0, i32 0), i32 42 }, %String* %bech32str, align 8, !dbg !11
...
"$have_gas_108":                                  ; preds = %"$out_of_gas_107", %"$have_gas_103"
  ...
  store %String { i8* getelementptr inbounds ([3 x i8], [3 x i8]* @"$stringlit_110", i32 0, i32 0), i32 3 }, %String* %prefix, align 8, !dbg !12
...
"$have_gas_124":                                  ; preds = %"$out_of_gas_123", %"$have_gas_108"
  ...
  %"$bech32_to_bystr20_call_129" = call %TName_Option_ByStr20* @_bech32_to_bystr20(i8* %"$execptr_load_126", %String %"$prefix_127", %String %"$bech32str_128"), !dbg !13
  store %TName_Option_ByStr20* %"$bech32_to_bystr20_call_129", %TName_Option_ByStr20** %"$expr_6", align 8, !dbg !13
...
!11 = !DILocation(line: 1, column: 60, scope: !10)
