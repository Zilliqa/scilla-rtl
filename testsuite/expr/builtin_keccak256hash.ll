...
"$have_gas_67":                                   ; preds = %"$out_of_gas_66", %"$have_gas_61"
  ...
  store [32 x i8] %"$keccak256hash_74", [32 x i8]* %h1, align 1
...
"$have_gas_78":                                   ; preds = %"$out_of_gas_77", %"$have_gas_67"
  ...
  store [32 x i8] %"$keccak256hash_85", [32 x i8]* %h2, align 1
...
"$have_gas_106":                                  ; preds = %"$out_of_gas_105", %"$have_gas_94"
  ...
  store [32 x i8] %"$keccak256hash_112", [32 x i8]* %sh2, align 1
...
"$have_gas_141":                                  ; preds = %"$out_of_gas_140", %"$have_gas_136"
  ...
  store [32 x i8] %"$keccak256hash_154", [32 x i8]* %"$expr_0", align 1
