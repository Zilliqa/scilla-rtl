...
"$have_gas_122":                                  ; preds = %"$out_of_gas_121", %"$have_gas_107"
  ...
  %"$keccak256hash_call_128" = call [32 x i8]* @_keccak256hash(i8* %"$execptr_load_124", %_TyDescrTy_Typ* @"$TyDescr_String_25", i8* %"$$keccak256hash_s_125_127")
...
"$have_gas_149":                                  ; preds = %"$out_of_gas_148", %"$have_gas_134"
  ...
  %"$keccak256hash_call_155" = call [32 x i8]* @_keccak256hash(i8* %"$execptr_load_151", %_TyDescrTy_Typ* @"$TyDescr_Bystr32_39", i8* %"$$keccak256hash_h1_152_154")
...
"$have_gas_192":                                  ; preds = %"$out_of_gas_191", %"$have_gas_178"
  ...
  %"$keccak256hash_call_197" = call [32 x i8]* @_keccak256hash(i8* %"$execptr_load_194", %_TyDescrTy_Typ* @"$TyDescr_ADT_Pair_String_ByStr32_44", i8* %"$$sh_195_196")
...
"$have_gas_254":                                  ; preds = %"$out_of_gas_253", %"$have_gas_233"
  ...
  %"$keccak256hash_call_259" = call [32 x i8]* @_keccak256hash(i8* %"$execptr_load_256", %_TyDescrTy_Typ* @"$TyDescr_ADT_Pair_ByStr_Int32_43", i8* %"$$p2_257_258")
