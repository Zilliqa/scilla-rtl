...
define internal { %TName_Nat* (i8*, %TName_Nat*)*, i8* } @"$fundef_170"(%"$$fundef_170_env_220"* %0, %TName_Nat* %1) !dbg !4 {
entry:
...
"$have_gas_1049":                                 ; preds = %"$out_of_gas_1048", %entry
  ...
  %"$iter_nat_nat_call_1055" = call { { { %TName_Nat* (i8*, %TName_Nat*)*, i8* } (i8*, { %TName_Nat* (i8*, %TName_Nat*)*, i8* })*, i8* } (i8*, %TName_Nat*)*, i8* } %"$iter_nat_nat_fptr_1052"(i8* %"$iter_nat_nat_envptr_1053", { { %TName_Nat* (i8*, %TName_Nat*)*, i8* } (i8*, { %TName_Nat* (i8*, %TName_Nat*)*, i8* })*, i8* } %"$f_1054"), !dbg !8
  store { { { %TName_Nat* (i8*, %TName_Nat*)*, i8* } (i8*, { %TName_Nat* (i8*, %TName_Nat*)*, i8* })*, i8* } (i8*, %TName_Nat*)*, i8* } %"$iter_nat_nat_call_1055", { { { %TName_Nat* (i8*, %TName_Nat*)*, i8* } (i8*, { %TName_Nat* (i8*, %TName_Nat*)*, i8* })*, i8* } (i8*, %TName_Nat*)*, i8* }* %"$iter_nat_nat_44", align 8, !dbg !8
  ...
  %"$$iter_nat_nat_44_call_1059" = call { { %TName_Nat* (i8*, %TName_Nat*)*, i8* } (i8*, { %TName_Nat* (i8*, %TName_Nat*)*, i8* })*, i8* } %"$$iter_nat_nat_44_fptr_1057"(i8* %"$$iter_nat_nat_44_envptr_1058", %TName_Nat* %1), !dbg !8
  store { { %TName_Nat* (i8*, %TName_Nat*)*, i8* } (i8*, { %TName_Nat* (i8*, %TName_Nat*)*, i8* })*, i8* } %"$$iter_nat_nat_44_call_1059", { { %TName_Nat* (i8*, %TName_Nat*)*, i8* } (i8*, { %TName_Nat* (i8*, %TName_Nat*)*, i8* })*, i8* }* %"$iter_nat_nat_45", align 8, !dbg !8
  ...
  %"$$iter_nat_nat_45_call_1064" = call { %TName_Nat* (i8*, %TName_Nat*)*, i8* } %"$$iter_nat_nat_45_fptr_1061"(i8* %"$$iter_nat_nat_45_envptr_1062", { %TName_Nat* (i8*, %TName_Nat*)*, i8* } %"$nat_succ_1063"), !dbg !8
  store { %TName_Nat* (i8*, %TName_Nat*)*, i8* } %"$$iter_nat_nat_45_call_1064", { %TName_Nat* (i8*, %TName_Nat*)*, i8* }* %"$iter_nat_nat_46", align 8, !dbg !8
  %"$$iter_nat_nat_46_1065" = load { %TName_Nat* (i8*, %TName_Nat*)*, i8* }, { %TName_Nat* (i8*, %TName_Nat*)*, i8* }* %"$iter_nat_nat_46", align 8
  store { %TName_Nat* (i8*, %TName_Nat*)*, i8* } %"$$iter_nat_nat_46_1065", { %TName_Nat* (i8*, %TName_Nat*)*, i8* }* %"$retval_171", align 8, !dbg !8
...
define internal %TName_Nat* @"$fundef_168"(%"$$fundef_168_env_221"* %0, %TName_Nat* %1) !dbg !9 {
entry:
...
"$have_gas_1022":                                 ; preds = %"$out_of_gas_1021", %entry
  ...
  %"$iter_nat_call_1028" = call { { %TName_Nat* (i8*, %TName_Nat*)*, i8* } (i8*, %TName_Nat*)*, i8* } %"$iter_nat_fptr_1025"(i8* %"$iter_nat_envptr_1026", { %TName_Nat* (i8*, %TName_Nat*)*, i8* } %"$ack_1027"), !dbg !10
  store { { %TName_Nat* (i8*, %TName_Nat*)*, i8* } (i8*, %TName_Nat*)*, i8* } %"$iter_nat_call_1028", { { %TName_Nat* (i8*, %TName_Nat*)*, i8* } (i8*, %TName_Nat*)*, i8* }* %"$iter_nat_41", align 8, !dbg !10
  ...
  %"$$iter_nat_41_call_1032" = call { %TName_Nat* (i8*, %TName_Nat*)*, i8* } %"$$iter_nat_41_fptr_1030"(i8* %"$$iter_nat_41_envptr_1031", %TName_Nat* %1), !dbg !10
  store { %TName_Nat* (i8*, %TName_Nat*)*, i8* } %"$$iter_nat_41_call_1032", { %TName_Nat* (i8*, %TName_Nat*)*, i8* }* %"$iter_nat_42", align 8, !dbg !10
  ...
  %"$$iter_nat_42_call_1037" = call %TName_Nat* %"$$iter_nat_42_fptr_1034"(i8* %"$$iter_nat_42_envptr_1035", %TName_Nat* %"$x0_1036"), !dbg !10
  store %TName_Nat* %"$$iter_nat_42_call_1037", %TName_Nat** %"$iter_nat_43", align 8, !dbg !10
  %"$$iter_nat_43_1038" = load %TName_Nat*, %TName_Nat** %"$iter_nat_43", align 8
  store %TName_Nat* %"$$iter_nat_43_1038", %TName_Nat** %"$retval_169", align 8, !dbg !10
  %"$$retval_169_1039" = load %TName_Nat*, %TName_Nat** %"$retval_169", align 8
  ret %TName_Nat* %"$$retval_169_1039"
}

define internal { %TName_Nat* (i8*, %TName_Nat*)*, i8* } @"$fundef_166"(%"$$fundef_166_env_222"* %0, { %TName_Nat* (i8*, %TName_Nat*)*, i8* } %1) !dbg !11 {
entry:
...
"$have_gas_991":                                  ; preds = %"$out_of_gas_990", %"$have_gas_986"
  ...
  %"$ack_call_996" = call %TName_Nat* %"$ack_fptr_993"(i8* %"$ack_envptr_994", %TName_Nat* %"$one_995"), !dbg !12
  store %TName_Nat* %"$ack_call_996", %TName_Nat** %"$ack_40", align 8, !dbg !12
  %"$$ack_40_997" = load %TName_Nat*, %TName_Nat** %"$ack_40", align 8
  store %TName_Nat* %"$$ack_40_997", %TName_Nat** %x0, align 8, !dbg !12
...
"$have_gas_1001":                                 ; preds = %"$out_of_gas_1000", %"$have_gas_991"
  ...
  store { %TName_Nat* (i8*, %TName_Nat*)*, i8* } %"$$fundef_168_cloval_1006", { %TName_Nat* (i8*, %TName_Nat*)*, i8* }* %"$retval_167", align 8, !dbg !13
...
define internal %TName_Nat* @"$fundef_164"(%"$$fundef_164_env_223"* %0, %TName_Nat* %1) !dbg !14 {
entry:
...
"$have_gas_970":                                  ; preds = %"$out_of_gas_969", %entry
  ...
  %"$f_call_976" = call %TName_Nat* %"$f_fptr_973"(i8* %"$f_envptr_974", %TName_Nat* %"$x_975"), !dbg !15
  store %TName_Nat* %"$f_call_976", %TName_Nat** %"$f_36", align 8, !dbg !15
  %"$$f_36_977" = load %TName_Nat*, %TName_Nat** %"$f_36", align 8
  store %TName_Nat* %"$$f_36_977", %TName_Nat** %"$retval_165", align 8, !dbg !15
  %"$$retval_165_978" = load %TName_Nat*, %TName_Nat** %"$retval_165", align 8
  ret %TName_Nat* %"$$retval_165_978"
}

define internal { %TName_Nat* (i8*, %TName_Nat*)*, i8* } @"$fundef_162"(%"$$fundef_162_env_224"* %0, %TName_Nat* %1) !dbg !16 {
entry:
...
"$have_gas_953":                                  ; preds = %"$out_of_gas_952", %entry
  ...
  store { %TName_Nat* (i8*, %TName_Nat*)*, i8* } %"$$fundef_164_cloval_958", { %TName_Nat* (i8*, %TName_Nat*)*, i8* }* %"$retval_163", align 8, !dbg !17
...
define internal %TName_Nat* @"$fundef_160"(%"$$fundef_160_env_225"* %0, %TName_Nat* %1) !dbg !18 {
entry:
...
"$have_gas_902":                                  ; preds = %"$out_of_gas_901", %"$have_gas_897"
  ...
  %"$nat_fold_call_910" = call { { { %TName_Nat* (i8*, %TName_Nat*)*, i8* } (i8*, %TName_Nat*)*, i8* } (i8*, { { %TName_Nat* (i8*, %TName_Nat*)*, i8* } (i8*, %TName_Nat*)*, i8* })*, i8* } %"$nat_fold_fptr_908"(i8* %"$nat_fold_envptr_909"), !dbg !19
  store { { { %TName_Nat* (i8*, %TName_Nat*)*, i8* } (i8*, %TName_Nat*)*, i8* } (i8*, { { %TName_Nat* (i8*, %TName_Nat*)*, i8* } (i8*, %TName_Nat*)*, i8* })*, i8* } %"$nat_fold_call_910", { { { %TName_Nat* (i8*, %TName_Nat*)*, i8* } (i8*, %TName_Nat*)*, i8* } (i8*, { { %TName_Nat* (i8*, %TName_Nat*)*, i8* } (i8*, %TName_Nat*)*, i8* })*, i8* }* %folder, align 8, !dbg !20
...
"$have_gas_919":                                  ; preds = %"$out_of_gas_918", %"$have_gas_914"
  ...
  store { { %TName_Nat* (i8*, %TName_Nat*)*, i8* } (i8*, %TName_Nat*)*, i8* } %"$$fundef_162_cloval_924", { { %TName_Nat* (i8*, %TName_Nat*)*, i8* } (i8*, %TName_Nat*)*, i8* }* %step, align 8, !dbg !21
...
"$have_gas_930":                                  ; preds = %"$out_of_gas_929", %"$have_gas_919"
  ...
  %"$folder_call_936" = call { { %TName_Nat* (i8*, %TName_Nat*)*, i8* } (i8*, %TName_Nat*)*, i8* } %"$folder_fptr_933"(i8* %"$folder_envptr_934", { { %TName_Nat* (i8*, %TName_Nat*)*, i8* } (i8*, %TName_Nat*)*, i8* } %"$step_935"), !dbg !22
  store { { %TName_Nat* (i8*, %TName_Nat*)*, i8* } (i8*, %TName_Nat*)*, i8* } %"$folder_call_936", { { %TName_Nat* (i8*, %TName_Nat*)*, i8* } (i8*, %TName_Nat*)*, i8* }* %"$folder_37", align 8, !dbg !22
  ...
  %"$$folder_37_call_940" = call { %TName_Nat* (i8*, %TName_Nat*)*, i8* } %"$$folder_37_fptr_938"(i8* %"$$folder_37_envptr_939", %TName_Nat* %1), !dbg !22
  store { %TName_Nat* (i8*, %TName_Nat*)*, i8* } %"$$folder_37_call_940", { %TName_Nat* (i8*, %TName_Nat*)*, i8* }* %"$folder_38", align 8, !dbg !22
  ...
  %"$$folder_38_call_945" = call %TName_Nat* %"$$folder_38_fptr_942"(i8* %"$$folder_38_envptr_943", %TName_Nat* %"$n_944"), !dbg !22
  store %TName_Nat* %"$$folder_38_call_945", %TName_Nat** %"$folder_39", align 8, !dbg !22
  %"$$folder_39_946" = load %TName_Nat*, %TName_Nat** %"$folder_39", align 8
  store %TName_Nat* %"$$folder_39_946", %TName_Nat** %"$retval_161", align 8, !dbg !22
  %"$$retval_161_947" = load %TName_Nat*, %TName_Nat** %"$retval_161", align 8
  ret %TName_Nat* %"$$retval_161_947"
}

define internal { %TName_Nat* (i8*, %TName_Nat*)*, i8* } @"$fundef_158"(%"$$fundef_158_env_226"* %0, %TName_Nat* %1) !dbg !23 {
entry:
...
"$have_gas_876":                                  ; preds = %"$out_of_gas_875", %entry
  ...
  store { %TName_Nat* (i8*, %TName_Nat*)*, i8* } %"$$fundef_160_cloval_881", { %TName_Nat* (i8*, %TName_Nat*)*, i8* }* %"$retval_159", align 8, !dbg !24
...
define internal { { %TName_Nat* (i8*, %TName_Nat*)*, i8* } (i8*, %TName_Nat*)*, i8* } @"$fundef_156"(%"$$fundef_156_env_227"* %0, { %TName_Nat* (i8*, %TName_Nat*)*, i8* } %1) !dbg !25 {
entry:
...
"$have_gas_859":                                  ; preds = %"$out_of_gas_858", %entry
  ...
  store { { %TName_Nat* (i8*, %TName_Nat*)*, i8* } (i8*, %TName_Nat*)*, i8* } %"$$fundef_158_cloval_864", { { %TName_Nat* (i8*, %TName_Nat*)*, i8* } (i8*, %TName_Nat*)*, i8* }* %"$retval_157", align 8, !dbg !26
...
define internal { { { %TName_Nat* (i8*, %TName_Nat*)*, i8* } (i8*, %TName_Nat*)*, i8* } (i8*, { %TName_Nat* (i8*, %TName_Nat*)*, i8* })*, i8* } @"$fundef_154"(%"$$fundef_154_env_228"* %0) !dbg !27 {
entry:
...
"$have_gas_845":                                  ; preds = %"$out_of_gas_844", %entry
  ...
  store { { { %TName_Nat* (i8*, %TName_Nat*)*, i8* } (i8*, %TName_Nat*)*, i8* } (i8*, { %TName_Nat* (i8*, %TName_Nat*)*, i8* })*, i8* } %"$$fundef_156_cloval_850", { { { %TName_Nat* (i8*, %TName_Nat*)*, i8* } (i8*, %TName_Nat*)*, i8* } (i8*, { %TName_Nat* (i8*, %TName_Nat*)*, i8* })*, i8* }* %"$retval_155", align 8, !dbg !28
...
define internal { %TName_Nat* (i8*, %TName_Nat*)*, i8* } @"$fundef_152"(%"$$fundef_152_env_229"* %0, %TName_Nat* %1) !dbg !29 {
entry:
...
"$have_gas_831":                                  ; preds = %"$out_of_gas_830", %entry
  ...
  %"$f_call_837" = call { %TName_Nat* (i8*, %TName_Nat*)*, i8* } %"$f_fptr_834"(i8* %"$f_envptr_835", { %TName_Nat* (i8*, %TName_Nat*)*, i8* } %"$x_836"), !dbg !30
  store { %TName_Nat* (i8*, %TName_Nat*)*, i8* } %"$f_call_837", { %TName_Nat* (i8*, %TName_Nat*)*, i8* }* %"$f_36", align 8, !dbg !30
  %"$$f_36_838" = load { %TName_Nat* (i8*, %TName_Nat*)*, i8* }, { %TName_Nat* (i8*, %TName_Nat*)*, i8* }* %"$f_36", align 8
  store { %TName_Nat* (i8*, %TName_Nat*)*, i8* } %"$$f_36_838", { %TName_Nat* (i8*, %TName_Nat*)*, i8* }* %"$retval_153", align 8, !dbg !30
...
define internal { { %TName_Nat* (i8*, %TName_Nat*)*, i8* } (i8*, %TName_Nat*)*, i8* } @"$fundef_150"(%"$$fundef_150_env_230"* %0, { %TName_Nat* (i8*, %TName_Nat*)*, i8* } %1) !dbg !31 {
entry:
...
"$have_gas_814":                                  ; preds = %"$out_of_gas_813", %entry
  ...
  store { { %TName_Nat* (i8*, %TName_Nat*)*, i8* } (i8*, %TName_Nat*)*, i8* } %"$$fundef_152_cloval_819", { { %TName_Nat* (i8*, %TName_Nat*)*, i8* } (i8*, %TName_Nat*)*, i8* }* %"$retval_151", align 8, !dbg !32
...
define internal { %TName_Nat* (i8*, %TName_Nat*)*, i8* } @"$fundef_148"(%"$$fundef_148_env_231"* %0, { %TName_Nat* (i8*, %TName_Nat*)*, i8* } %1) !dbg !33 {
entry:
...
"$have_gas_763":                                  ; preds = %"$out_of_gas_762", %"$have_gas_758"
  ...
  %"$nat_fold_call_771" = call { { { { %TName_Nat* (i8*, %TName_Nat*)*, i8* } (i8*, %TName_Nat*)*, i8* } (i8*, { %TName_Nat* (i8*, %TName_Nat*)*, i8* })*, i8* } (i8*, { { { %TName_Nat* (i8*, %TName_Nat*)*, i8* } (i8*, %TName_Nat*)*, i8* } (i8*, { %TName_Nat* (i8*, %TName_Nat*)*, i8* })*, i8* })*, i8* } %"$nat_fold_fptr_769"(i8* %"$nat_fold_envptr_770"), !dbg !34
  store { { { { %TName_Nat* (i8*, %TName_Nat*)*, i8* } (i8*, %TName_Nat*)*, i8* } (i8*, { %TName_Nat* (i8*, %TName_Nat*)*, i8* })*, i8* } (i8*, { { { %TName_Nat* (i8*, %TName_Nat*)*, i8* } (i8*, %TName_Nat*)*, i8* } (i8*, { %TName_Nat* (i8*, %TName_Nat*)*, i8* })*, i8* })*, i8* } %"$nat_fold_call_771", { { { { %TName_Nat* (i8*, %TName_Nat*)*, i8* } (i8*, %TName_Nat*)*, i8* } (i8*, { %TName_Nat* (i8*, %TName_Nat*)*, i8* })*, i8* } (i8*, { { { %TName_Nat* (i8*, %TName_Nat*)*, i8* } (i8*, %TName_Nat*)*, i8* } (i8*, { %TName_Nat* (i8*, %TName_Nat*)*, i8* })*, i8* })*, i8* }* %folder, align 8, !dbg !35
...
"$have_gas_780":                                  ; preds = %"$out_of_gas_779", %"$have_gas_775"
  ...
  store { { { %TName_Nat* (i8*, %TName_Nat*)*, i8* } (i8*, %TName_Nat*)*, i8* } (i8*, { %TName_Nat* (i8*, %TName_Nat*)*, i8* })*, i8* } %"$$fundef_150_cloval_785", { { { %TName_Nat* (i8*, %TName_Nat*)*, i8* } (i8*, %TName_Nat*)*, i8* } (i8*, { %TName_Nat* (i8*, %TName_Nat*)*, i8* })*, i8* }* %step, align 8, !dbg !36
...
"$have_gas_791":                                  ; preds = %"$out_of_gas_790", %"$have_gas_780"
  ...
  %"$folder_call_797" = call { { { %TName_Nat* (i8*, %TName_Nat*)*, i8* } (i8*, %TName_Nat*)*, i8* } (i8*, { %TName_Nat* (i8*, %TName_Nat*)*, i8* })*, i8* } %"$folder_fptr_794"(i8* %"$folder_envptr_795", { { { %TName_Nat* (i8*, %TName_Nat*)*, i8* } (i8*, %TName_Nat*)*, i8* } (i8*, { %TName_Nat* (i8*, %TName_Nat*)*, i8* })*, i8* } %"$step_796"), !dbg !37
  store { { { %TName_Nat* (i8*, %TName_Nat*)*, i8* } (i8*, %TName_Nat*)*, i8* } (i8*, { %TName_Nat* (i8*, %TName_Nat*)*, i8* })*, i8* } %"$folder_call_797", { { { %TName_Nat* (i8*, %TName_Nat*)*, i8* } (i8*, %TName_Nat*)*, i8* } (i8*, { %TName_Nat* (i8*, %TName_Nat*)*, i8* })*, i8* }* %"$folder_37", align 8, !dbg !37
  ...
  %"$$folder_37_call_801" = call { { %TName_Nat* (i8*, %TName_Nat*)*, i8* } (i8*, %TName_Nat*)*, i8* } %"$$folder_37_fptr_799"(i8* %"$$folder_37_envptr_800", { %TName_Nat* (i8*, %TName_Nat*)*, i8* } %1), !dbg !37
  store { { %TName_Nat* (i8*, %TName_Nat*)*, i8* } (i8*, %TName_Nat*)*, i8* } %"$$folder_37_call_801", { { %TName_Nat* (i8*, %TName_Nat*)*, i8* } (i8*, %TName_Nat*)*, i8* }* %"$folder_38", align 8, !dbg !37
  ...
  %"$$folder_38_call_806" = call { %TName_Nat* (i8*, %TName_Nat*)*, i8* } %"$$folder_38_fptr_803"(i8* %"$$folder_38_envptr_804", %TName_Nat* %"$n_805"), !dbg !37
  store { %TName_Nat* (i8*, %TName_Nat*)*, i8* } %"$$folder_38_call_806", { %TName_Nat* (i8*, %TName_Nat*)*, i8* }* %"$folder_39", align 8, !dbg !37
  %"$$folder_39_807" = load { %TName_Nat* (i8*, %TName_Nat*)*, i8* }, { %TName_Nat* (i8*, %TName_Nat*)*, i8* }* %"$folder_39", align 8
  store { %TName_Nat* (i8*, %TName_Nat*)*, i8* } %"$$folder_39_807", { %TName_Nat* (i8*, %TName_Nat*)*, i8* }* %"$retval_149", align 8, !dbg !37
...
define internal { { %TName_Nat* (i8*, %TName_Nat*)*, i8* } (i8*, { %TName_Nat* (i8*, %TName_Nat*)*, i8* })*, i8* } @"$fundef_146"(%"$$fundef_146_env_232"* %0, %TName_Nat* %1) !dbg !38 {
entry:
...
"$have_gas_737":                                  ; preds = %"$out_of_gas_736", %entry
  ...
  store { { %TName_Nat* (i8*, %TName_Nat*)*, i8* } (i8*, { %TName_Nat* (i8*, %TName_Nat*)*, i8* })*, i8* } %"$$fundef_148_cloval_742", { { %TName_Nat* (i8*, %TName_Nat*)*, i8* } (i8*, { %TName_Nat* (i8*, %TName_Nat*)*, i8* })*, i8* }* %"$retval_147", align 8, !dbg !39
...
define internal { { { %TName_Nat* (i8*, %TName_Nat*)*, i8* } (i8*, { %TName_Nat* (i8*, %TName_Nat*)*, i8* })*, i8* } (i8*, %TName_Nat*)*, i8* } @"$fundef_144"(%"$$fundef_144_env_233"* %0, { { %TName_Nat* (i8*, %TName_Nat*)*, i8* } (i8*, { %TName_Nat* (i8*, %TName_Nat*)*, i8* })*, i8* } %1) !dbg !40 {
entry:
...
"$have_gas_720":                                  ; preds = %"$out_of_gas_719", %entry
  ...
  store { { { %TName_Nat* (i8*, %TName_Nat*)*, i8* } (i8*, { %TName_Nat* (i8*, %TName_Nat*)*, i8* })*, i8* } (i8*, %TName_Nat*)*, i8* } %"$$fundef_146_cloval_725", { { { %TName_Nat* (i8*, %TName_Nat*)*, i8* } (i8*, { %TName_Nat* (i8*, %TName_Nat*)*, i8* })*, i8* } (i8*, %TName_Nat*)*, i8* }* %"$retval_145", align 8, !dbg !41
...
define internal { { { { %TName_Nat* (i8*, %TName_Nat*)*, i8* } (i8*, { %TName_Nat* (i8*, %TName_Nat*)*, i8* })*, i8* } (i8*, %TName_Nat*)*, i8* } (i8*, { { %TName_Nat* (i8*, %TName_Nat*)*, i8* } (i8*, { %TName_Nat* (i8*, %TName_Nat*)*, i8* })*, i8* })*, i8* } @"$fundef_142"(%"$$fundef_142_env_234"* %0) !dbg !42 {
entry:
...
"$have_gas_706":                                  ; preds = %"$out_of_gas_705", %entry
  ...
  store { { { { %TName_Nat* (i8*, %TName_Nat*)*, i8* } (i8*, { %TName_Nat* (i8*, %TName_Nat*)*, i8* })*, i8* } (i8*, %TName_Nat*)*, i8* } (i8*, { { %TName_Nat* (i8*, %TName_Nat*)*, i8* } (i8*, { %TName_Nat* (i8*, %TName_Nat*)*, i8* })*, i8* })*, i8* } %"$$fundef_144_cloval_711", { { { { %TName_Nat* (i8*, %TName_Nat*)*, i8* } (i8*, { %TName_Nat* (i8*, %TName_Nat*)*, i8* })*, i8* } (i8*, %TName_Nat*)*, i8* } (i8*, { { %TName_Nat* (i8*, %TName_Nat*)*, i8* } (i8*, { %TName_Nat* (i8*, %TName_Nat*)*, i8* })*, i8* })*, i8* }* %"$retval_143", align 8, !dbg !43
...
define internal %TName_Nat* @"$fundef_140"(%"$$fundef_140_env_235"* %0, %TName_Nat* %1) !dbg !44 {
entry:
...
"$have_gas_694":                                  ; preds = %"$out_of_gas_693", %entry
  ...
  store %TName_Nat* %"$adtptr_699", %TName_Nat** %"$retval_141", align 8, !dbg !45
  %"$$retval_141_700" = load %TName_Nat*, %TName_Nat** %"$retval_141", align 8
  ret %TName_Nat* %"$$retval_141_700"
}

define internal %Uint32 @"$fundef_137"(%"$$fundef_137_env_236"* %0, %TName_Nat* %1) !dbg !46 {
entry:
...
"$have_gas_685":                                  ; preds = %"$out_of_gas_684", %entry
  ...
  %"$add_call_689" = call %Uint32 @_add_Uint32(%Uint32 %"$z_687", %Uint32 %"$one_int_688"), !dbg !48
  store %Uint32 %"$add_call_689", %Uint32* %"$retval_138", align 4, !dbg !48
  %"$$retval_138_690" = load %Uint32, %Uint32* %"$retval_138", align 4
  ret %Uint32 %"$$retval_138_690"
}

define internal { %Uint32 (i8*, %TName_Nat*)*, i8* } @"$fundef_135"(%"$$fundef_135_env_237"* %0, %Uint32 %1) !dbg !49 {
entry:
...
"$have_gas_668":                                  ; preds = %"$out_of_gas_667", %entry
  ...
  store { %Uint32 (i8*, %TName_Nat*)*, i8* } %"$$fundef_137_cloval_673", { %Uint32 (i8*, %TName_Nat*)*, i8* }* %"$retval_136", align 8, !dbg !50
...
define internal %Uint32 @"$fundef_133"(%"$$fundef_133_env_238"* %0, %TName_Nat* %1) !dbg !51 {
entry:
...
"$have_gas_597":                                  ; preds = %"$out_of_gas_596", %"$have_gas_592"
  ...
  %"$$nat_fold_6_call_605" = call { { { %Uint32 (i8*, %TName_Nat*)*, i8* } (i8*, %Uint32)*, i8* } (i8*, { { %Uint32 (i8*, %TName_Nat*)*, i8* } (i8*, %Uint32)*, i8* })*, i8* } %"$$nat_fold_6_fptr_603"(i8* %"$$nat_fold_6_envptr_604"), !dbg !52
  store { { { %Uint32 (i8*, %TName_Nat*)*, i8* } (i8*, %Uint32)*, i8* } (i8*, { { %Uint32 (i8*, %TName_Nat*)*, i8* } (i8*, %Uint32)*, i8* })*, i8* } %"$$nat_fold_6_call_605", { { { %Uint32 (i8*, %TName_Nat*)*, i8* } (i8*, %Uint32)*, i8* } (i8*, { { %Uint32 (i8*, %TName_Nat*)*, i8* } (i8*, %Uint32)*, i8* })*, i8* }* %fold, align 8, !dbg !53
...
"$have_gas_624":                                  ; preds = %"$out_of_gas_623", %"$have_gas_619"
  ...
  store { { %Uint32 (i8*, %TName_Nat*)*, i8* } (i8*, %Uint32)*, i8* } %"$$fundef_135_cloval_629", { { %Uint32 (i8*, %TName_Nat*)*, i8* } (i8*, %Uint32)*, i8* }* %f, align 8, !dbg !55
...
"$have_gas_645":                                  ; preds = %"$out_of_gas_644", %"$have_gas_640"
  ...
  %"$fold_call_651" = call { { %Uint32 (i8*, %TName_Nat*)*, i8* } (i8*, %Uint32)*, i8* } %"$fold_fptr_648"(i8* %"$fold_envptr_649", { { %Uint32 (i8*, %TName_Nat*)*, i8* } (i8*, %Uint32)*, i8* } %"$f_650"), !dbg !57
  store { { %Uint32 (i8*, %TName_Nat*)*, i8* } (i8*, %Uint32)*, i8* } %"$fold_call_651", { { %Uint32 (i8*, %TName_Nat*)*, i8* } (i8*, %Uint32)*, i8* }* %"$fold_33", align 8, !dbg !57
  ...
  %"$$fold_33_call_656" = call { %Uint32 (i8*, %TName_Nat*)*, i8* } %"$$fold_33_fptr_653"(i8* %"$$fold_33_envptr_654", %Uint32 %"$zero_int_655"), !dbg !57
  store { %Uint32 (i8*, %TName_Nat*)*, i8* } %"$$fold_33_call_656", { %Uint32 (i8*, %TName_Nat*)*, i8* }* %"$fold_34", align 8, !dbg !57
  ...
  %"$$fold_34_call_660" = call %Uint32 %"$$fold_34_fptr_658"(i8* %"$$fold_34_envptr_659", %TName_Nat* %1), !dbg !57
  store %Uint32 %"$$fold_34_call_660", %Uint32* %"$fold_35", align 4, !dbg !57
  %"$$fold_35_661" = load %Uint32, %Uint32* %"$fold_35", align 4
  store %Uint32 %"$$fold_35_661", %Uint32* %"$retval_134", align 4, !dbg !57
  %"$$retval_134_662" = load %Uint32, %Uint32* %"$retval_134", align 4
  ret %Uint32 %"$$retval_134_662"
}

define internal %Uint32 @"$fundef_131"(%"$$fundef_131_env_239"* %0, %TName_Nat* %1) !dbg !58 {
entry:
...
"$have_gas_549":                                  ; preds = %"$out_of_gas_548", %"$have_gas_544"
  ...
  %"$fn_call_555" = call { %Uint32 (i8*, %TName_Nat*)*, i8* } %"$fn_fptr_552"(i8* %"$fn_envptr_553", %Uint32 %"$f0_554"), !dbg !61
  store { %Uint32 (i8*, %TName_Nat*)*, i8* } %"$fn_call_555", { %Uint32 (i8*, %TName_Nat*)*, i8* }* %"$fn_29", align 8, !dbg !61
  ...
  %"$$fn_29_call_560" = call %Uint32 %"$$fn_29_fptr_557"(i8* %"$$fn_29_envptr_558", %TName_Nat* %"$n1_559"), !dbg !61
  store %Uint32 %"$$fn_29_call_560", %Uint32* %"$fn_30", align 4, !dbg !61
  %"$$fn_30_561" = load %Uint32, %Uint32* %"$fn_30", align 4
  store %Uint32 %"$$fn_30_561", %Uint32* %res, align 4, !dbg !61
...
"$have_gas_565":                                  ; preds = %"$out_of_gas_564", %"$have_gas_549"
  ...
  %"$g_call_571" = call { %Uint32 (i8*, %TName_Nat*)*, i8* } %"$g_fptr_568"(i8* %"$g_envptr_569", %Uint32 %"$res_570"), !dbg !64
  store { %Uint32 (i8*, %TName_Nat*)*, i8* } %"$g_call_571", { %Uint32 (i8*, %TName_Nat*)*, i8* }* %"$g_31", align 8, !dbg !64
  ...
  %"$$g_31_call_576" = call %Uint32 %"$$g_31_fptr_573"(i8* %"$$g_31_envptr_574", %TName_Nat* %"$n1_575"), !dbg !64
  store %Uint32 %"$$g_31_call_576", %Uint32* %"$g_32", align 4, !dbg !64
  %"$$g_32_577" = load %Uint32, %Uint32* %"$g_32", align 4
  store %Uint32 %"$$g_32_577", %Uint32* %"$retval_132", align 4, !dbg !64
...
"$have_gas_583":                                  ; preds = %"$out_of_gas_582", %"$Zero_578"
  ...
  store %Uint32 %"$f0_585", %Uint32* %"$retval_132", align 4, !dbg !65
  br label %"$matchsucc_533"
...
define internal { %Uint32 (i8*, %TName_Nat*)*, i8* } @"$fundef_129"(%"$$fundef_129_env_240"* %0, %Uint32 %1) !dbg !67 {
entry:
...
"$have_gas_510":                                  ; preds = %"$out_of_gas_509", %"$have_gas_505"
  ...
  store { %Uint32 (i8*, %TName_Nat*)*, i8* } %"$$fundef_131_cloval_515", { %Uint32 (i8*, %TName_Nat*)*, i8* }* %"$retval_130", align 8, !dbg !68
...
define internal { { %Uint32 (i8*, %TName_Nat*)*, i8* } (i8*, %Uint32)*, i8* } @"$fundef_127"(%"$$fundef_127_env_241"* %0, { { %Uint32 (i8*, %TName_Nat*)*, i8* } (i8*, %Uint32)*, i8* } %1) !dbg !69 {
entry:
...
"$have_gas_487":                                  ; preds = %"$out_of_gas_486", %entry
  ...
  %g = alloca { { %Uint32 (i8*, %TName_Nat*)*, i8* } (i8*, %Uint32)*, i8* }, align 8
  store { { %Uint32 (i8*, %TName_Nat*)*, i8* } (i8*, %Uint32)*, i8* } %"$$fundef_129_cloval_492", { { %Uint32 (i8*, %TName_Nat*)*, i8* } (i8*, %Uint32)*, i8* }* %g, align 8, !dbg !70
  ...
  store { { %Uint32 (i8*, %TName_Nat*)*, i8* } (i8*, %Uint32)*, i8* } %"$g_496", { { %Uint32 (i8*, %TName_Nat*)*, i8* } (i8*, %Uint32)*, i8* }* %"$retval_128", align 8, !dbg !70
...
define internal { { { %Uint32 (i8*, %TName_Nat*)*, i8* } (i8*, %Uint32)*, i8* } (i8*, { { %Uint32 (i8*, %TName_Nat*)*, i8* } (i8*, %Uint32)*, i8* })*, i8* } @"$fundef_125"(%"$$fundef_125_env_242"* %0) !dbg !71 {
entry:
...
define internal %TName_Nat* @"$fundef_123"(%"$$fundef_123_env_243"* %0, %TName_Nat* %1) !dbg !73 {
entry:
...
"$have_gas_437":                                  ; preds = %"$out_of_gas_436", %"$have_gas_432"
  ...
  %"$fn_call_443" = call { %TName_Nat* (i8*, %TName_Nat*)*, i8* } %"$fn_fptr_440"(i8* %"$fn_envptr_441", %TName_Nat* %"$f0_442"), !dbg !75
  store { %TName_Nat* (i8*, %TName_Nat*)*, i8* } %"$fn_call_443", { %TName_Nat* (i8*, %TName_Nat*)*, i8* }* %"$fn_25", align 8, !dbg !75
  ...
  %"$$fn_25_call_448" = call %TName_Nat* %"$$fn_25_fptr_445"(i8* %"$$fn_25_envptr_446", %TName_Nat* %"$n1_447"), !dbg !75
  store %TName_Nat* %"$$fn_25_call_448", %TName_Nat** %"$fn_26", align 8, !dbg !75
  %"$$fn_26_449" = load %TName_Nat*, %TName_Nat** %"$fn_26", align 8
  store %TName_Nat* %"$$fn_26_449", %TName_Nat** %res, align 8, !dbg !75
...
"$have_gas_453":                                  ; preds = %"$out_of_gas_452", %"$have_gas_437"
  ...
  %"$g_call_459" = call { %TName_Nat* (i8*, %TName_Nat*)*, i8* } %"$g_fptr_456"(i8* %"$g_envptr_457", %TName_Nat* %"$res_458"), !dbg !78
  store { %TName_Nat* (i8*, %TName_Nat*)*, i8* } %"$g_call_459", { %TName_Nat* (i8*, %TName_Nat*)*, i8* }* %"$g_27", align 8, !dbg !78
  ...
  %"$$g_27_call_464" = call %TName_Nat* %"$$g_27_fptr_461"(i8* %"$$g_27_envptr_462", %TName_Nat* %"$n1_463"), !dbg !78
  store %TName_Nat* %"$$g_27_call_464", %TName_Nat** %"$g_28", align 8, !dbg !78
  %"$$g_28_465" = load %TName_Nat*, %TName_Nat** %"$g_28", align 8
  store %TName_Nat* %"$$g_28_465", %TName_Nat** %"$retval_124", align 8, !dbg !78
...
"$have_gas_471":                                  ; preds = %"$out_of_gas_470", %"$Zero_466"
  ...
  store %TName_Nat* %"$f0_473", %TName_Nat** %"$retval_124", align 8, !dbg !79
  br label %"$matchsucc_421"
...
define internal { %TName_Nat* (i8*, %TName_Nat*)*, i8* } @"$fundef_121"(%"$$fundef_121_env_244"* %0, %TName_Nat* %1) !dbg !81 {
entry:
...
"$have_gas_398":                                  ; preds = %"$out_of_gas_397", %"$have_gas_393"
  ...
  store { %TName_Nat* (i8*, %TName_Nat*)*, i8* } %"$$fundef_123_cloval_403", { %TName_Nat* (i8*, %TName_Nat*)*, i8* }* %"$retval_122", align 8, !dbg !82
...
define internal { { %TName_Nat* (i8*, %TName_Nat*)*, i8* } (i8*, %TName_Nat*)*, i8* } @"$fundef_119"(%"$$fundef_119_env_245"* %0, { { %TName_Nat* (i8*, %TName_Nat*)*, i8* } (i8*, %TName_Nat*)*, i8* } %1) !dbg !83 {
entry:
...
"$have_gas_375":                                  ; preds = %"$out_of_gas_374", %entry
  ...
  %g = alloca { { %TName_Nat* (i8*, %TName_Nat*)*, i8* } (i8*, %TName_Nat*)*, i8* }, align 8
  store { { %TName_Nat* (i8*, %TName_Nat*)*, i8* } (i8*, %TName_Nat*)*, i8* } %"$$fundef_121_cloval_380", { { %TName_Nat* (i8*, %TName_Nat*)*, i8* } (i8*, %TName_Nat*)*, i8* }* %g, align 8, !dbg !84
  ...
  store { { %TName_Nat* (i8*, %TName_Nat*)*, i8* } (i8*, %TName_Nat*)*, i8* } %"$g_384", { { %TName_Nat* (i8*, %TName_Nat*)*, i8* } (i8*, %TName_Nat*)*, i8* }* %"$retval_120", align 8, !dbg !84
...
define internal { { { %TName_Nat* (i8*, %TName_Nat*)*, i8* } (i8*, %TName_Nat*)*, i8* } (i8*, { { %TName_Nat* (i8*, %TName_Nat*)*, i8* } (i8*, %TName_Nat*)*, i8* })*, i8* } @"$fundef_117"(%"$$fundef_117_env_246"* %0) !dbg !85 {
entry:
...
define internal { %TName_Nat* (i8*, %TName_Nat*)*, i8* } @"$fundef_115"(%"$$fundef_115_env_247"* %0, %TName_Nat* %1) !dbg !87 {
entry:
...
"$have_gas_325":                                  ; preds = %"$out_of_gas_324", %"$have_gas_320"
  ...
  %"$fn_call_331" = call { { %TName_Nat* (i8*, %TName_Nat*)*, i8* } (i8*, %TName_Nat*)*, i8* } %"$fn_fptr_328"(i8* %"$fn_envptr_329", { %TName_Nat* (i8*, %TName_Nat*)*, i8* } %"$f0_330"), !dbg !89
  store { { %TName_Nat* (i8*, %TName_Nat*)*, i8* } (i8*, %TName_Nat*)*, i8* } %"$fn_call_331", { { %TName_Nat* (i8*, %TName_Nat*)*, i8* } (i8*, %TName_Nat*)*, i8* }* %"$fn_25", align 8, !dbg !89
  ...
  %"$$fn_25_call_336" = call { %TName_Nat* (i8*, %TName_Nat*)*, i8* } %"$$fn_25_fptr_333"(i8* %"$$fn_25_envptr_334", %TName_Nat* %"$n1_335"), !dbg !89
  store { %TName_Nat* (i8*, %TName_Nat*)*, i8* } %"$$fn_25_call_336", { %TName_Nat* (i8*, %TName_Nat*)*, i8* }* %"$fn_26", align 8, !dbg !89
  %"$$fn_26_337" = load { %TName_Nat* (i8*, %TName_Nat*)*, i8* }, { %TName_Nat* (i8*, %TName_Nat*)*, i8* }* %"$fn_26", align 8
  store { %TName_Nat* (i8*, %TName_Nat*)*, i8* } %"$$fn_26_337", { %TName_Nat* (i8*, %TName_Nat*)*, i8* }* %res, align 8, !dbg !89
...
"$have_gas_341":                                  ; preds = %"$out_of_gas_340", %"$have_gas_325"
  ...
  %"$g_call_347" = call { { %TName_Nat* (i8*, %TName_Nat*)*, i8* } (i8*, %TName_Nat*)*, i8* } %"$g_fptr_344"(i8* %"$g_envptr_345", { %TName_Nat* (i8*, %TName_Nat*)*, i8* } %"$res_346"), !dbg !92
  store { { %TName_Nat* (i8*, %TName_Nat*)*, i8* } (i8*, %TName_Nat*)*, i8* } %"$g_call_347", { { %TName_Nat* (i8*, %TName_Nat*)*, i8* } (i8*, %TName_Nat*)*, i8* }* %"$g_27", align 8, !dbg !92
  ...
  %"$$g_27_call_352" = call { %TName_Nat* (i8*, %TName_Nat*)*, i8* } %"$$g_27_fptr_349"(i8* %"$$g_27_envptr_350", %TName_Nat* %"$n1_351"), !dbg !92
  store { %TName_Nat* (i8*, %TName_Nat*)*, i8* } %"$$g_27_call_352", { %TName_Nat* (i8*, %TName_Nat*)*, i8* }* %"$g_28", align 8, !dbg !92
  %"$$g_28_353" = load { %TName_Nat* (i8*, %TName_Nat*)*, i8* }, { %TName_Nat* (i8*, %TName_Nat*)*, i8* }* %"$g_28", align 8
  store { %TName_Nat* (i8*, %TName_Nat*)*, i8* } %"$$g_28_353", { %TName_Nat* (i8*, %TName_Nat*)*, i8* }* %"$retval_116", align 8, !dbg !92
...
"$have_gas_359":                                  ; preds = %"$out_of_gas_358", %"$Zero_354"
  ...
  store { %TName_Nat* (i8*, %TName_Nat*)*, i8* } %"$f0_361", { %TName_Nat* (i8*, %TName_Nat*)*, i8* }* %"$retval_116", align 8, !dbg !93
  br label %"$matchsucc_309"
...
define internal { { %TName_Nat* (i8*, %TName_Nat*)*, i8* } (i8*, %TName_Nat*)*, i8* } @"$fundef_113"(%"$$fundef_113_env_248"* %0, { %TName_Nat* (i8*, %TName_Nat*)*, i8* } %1) !dbg !95 {
entry:
...
"$have_gas_286":                                  ; preds = %"$out_of_gas_285", %"$have_gas_281"
  ...
  store { { %TName_Nat* (i8*, %TName_Nat*)*, i8* } (i8*, %TName_Nat*)*, i8* } %"$$fundef_115_cloval_291", { { %TName_Nat* (i8*, %TName_Nat*)*, i8* } (i8*, %TName_Nat*)*, i8* }* %"$retval_114", align 8, !dbg !96
...
define internal { { { %TName_Nat* (i8*, %TName_Nat*)*, i8* } (i8*, %TName_Nat*)*, i8* } (i8*, { %TName_Nat* (i8*, %TName_Nat*)*, i8* })*, i8* } @"$fundef_111"(%"$$fundef_111_env_249"* %0, { { { %TName_Nat* (i8*, %TName_Nat*)*, i8* } (i8*, %TName_Nat*)*, i8* } (i8*, { %TName_Nat* (i8*, %TName_Nat*)*, i8* })*, i8* } %1) !dbg !97 {
entry:
...
"$have_gas_263":                                  ; preds = %"$out_of_gas_262", %entry
  ...
  %g = alloca { { { %TName_Nat* (i8*, %TName_Nat*)*, i8* } (i8*, %TName_Nat*)*, i8* } (i8*, { %TName_Nat* (i8*, %TName_Nat*)*, i8* })*, i8* }, align 8
  store { { { %TName_Nat* (i8*, %TName_Nat*)*, i8* } (i8*, %TName_Nat*)*, i8* } (i8*, { %TName_Nat* (i8*, %TName_Nat*)*, i8* })*, i8* } %"$$fundef_113_cloval_268", { { { %TName_Nat* (i8*, %TName_Nat*)*, i8* } (i8*, %TName_Nat*)*, i8* } (i8*, { %TName_Nat* (i8*, %TName_Nat*)*, i8* })*, i8* }* %g, align 8, !dbg !98
  ...
  store { { { %TName_Nat* (i8*, %TName_Nat*)*, i8* } (i8*, %TName_Nat*)*, i8* } (i8*, { %TName_Nat* (i8*, %TName_Nat*)*, i8* })*, i8* } %"$g_272", { { { %TName_Nat* (i8*, %TName_Nat*)*, i8* } (i8*, %TName_Nat*)*, i8* } (i8*, { %TName_Nat* (i8*, %TName_Nat*)*, i8* })*, i8* }* %"$retval_112", align 8, !dbg !98
...
define internal { { { { %TName_Nat* (i8*, %TName_Nat*)*, i8* } (i8*, %TName_Nat*)*, i8* } (i8*, { %TName_Nat* (i8*, %TName_Nat*)*, i8* })*, i8* } (i8*, { { { %TName_Nat* (i8*, %TName_Nat*)*, i8* } (i8*, %TName_Nat*)*, i8* } (i8*, { %TName_Nat* (i8*, %TName_Nat*)*, i8* })*, i8* })*, i8* } @"$fundef_109"(%"$$fundef_109_env_250"* %0) !dbg !99 {
entry:
...
"$have_gas_254":                                  ; preds = %"$out_of_gas_253", %entry
  ...
  store { { { { %TName_Nat* (i8*, %TName_Nat*)*, i8* } (i8*, %TName_Nat*)*, i8* } (i8*, { %TName_Nat* (i8*, %TName_Nat*)*, i8* })*, i8* } (i8*, { { { %TName_Nat* (i8*, %TName_Nat*)*, i8* } (i8*, %TName_Nat*)*, i8* } (i8*, { %TName_Nat* (i8*, %TName_Nat*)*, i8* })*, i8* })*, i8* } { { { { %TName_Nat* (i8*, %TName_Nat*)*, i8* } (i8*, %TName_Nat*)*, i8* } (i8*, { %TName_Nat* (i8*, %TName_Nat*)*, i8* })*, i8* } (i8*, { { { %TName_Nat* (i8*, %TName_Nat*)*, i8* } (i8*, %TName_Nat*)*, i8* } (i8*, { %TName_Nat* (i8*, %TName_Nat*)*, i8* })*, i8* })* bitcast ({ { { %TName_Nat* (i8*, %TName_Nat*)*, i8* } (i8*, %TName_Nat*)*, i8* } (i8*, { %TName_Nat* (i8*, %TName_Nat*)*, i8* })*, i8* } (%"$$fundef_111_env_249"*, { { { %TName_Nat* (i8*, %TName_Nat*)*, i8* } (i8*, %TName_Nat*)*, i8* } (i8*, { %TName_Nat* (i8*, %TName_Nat*)*, i8* })*, i8* })* @"$fundef_111" to { { { %TName_Nat* (i8*, %TName_Nat*)*, i8* } (i8*, %TName_Nat*)*, i8* } (i8*, { %TName_Nat* (i8*, %TName_Nat*)*, i8* })*, i8* } (i8*, { { { %TName_Nat* (i8*, %TName_Nat*)*, i8* } (i8*, %TName_Nat*)*, i8* } (i8*, { %TName_Nat* (i8*, %TName_Nat*)*, i8* })*, i8* })*), i8* null }, { { { { %TName_Nat* (i8*, %TName_Nat*)*, i8* } (i8*, %TName_Nat*)*, i8* } (i8*, { %TName_Nat* (i8*, %TName_Nat*)*, i8* })*, i8* } (i8*, { { { %TName_Nat* (i8*, %TName_Nat*)*, i8* } (i8*, %TName_Nat*)*, i8* } (i8*, { %TName_Nat* (i8*, %TName_Nat*)*, i8* })*, i8* })*, i8* }* %"$retval_110", align 8, !dbg !100
...
"$have_gas_1075":                                 ; preds = %"$out_of_gas_1074", %"$have_gas_1070"
  ...
  store { i8*, i8* }* %"$dyndisp_table_1083", { i8*, i8* }** @nat_fold, align 8, !dbg !104
...
"$have_gas_1111":                                 ; preds = %"$out_of_gas_1110", %"$have_gas_1106"
  ...
  store { i8*, i8* }* %"$dyndisp_table_1116", { i8*, i8* }** %"$nat_fold_6", align 8, !dbg !104
  ...
  store { %Uint32 (i8*, %TName_Nat*)*, i8* } %"$$fundef_133_cloval_1122", { %Uint32 (i8*, %TName_Nat*)*, i8* }* @NatUtils.nat_to_int, align 8, !dbg !105
...
"$have_gas_1138":                                 ; preds = %"$out_of_gas_1137", %"$have_gas_1133"
  ...
  store { %TName_Nat* (i8*, %TName_Nat*)*, i8* } { %TName_Nat* (i8*, %TName_Nat*)* bitcast (%TName_Nat* (%"$$fundef_140_env_235"*, %TName_Nat*)* @"$fundef_140" to %TName_Nat* (i8*, %TName_Nat*)*), i8* null }, { %TName_Nat* (i8*, %TName_Nat*)*, i8* }* %nat_succ, align 8, !dbg !107
...
"$have_gas_1151":                                 ; preds = %"$out_of_gas_1150", %"$have_gas_1146"
  ...
  store { i8*, i8* }* %"$dyndisp_table_1162", { i8*, i8* }** %nat_iter, align 8, !dbg !108
...
"$have_gas_1180":                                 ; preds = %"$out_of_gas_1179", %"$have_gas_1175"
  ...
  %"$nat_iter_call_1188" = call { { { %TName_Nat* (i8*, %TName_Nat*)*, i8* } (i8*, %TName_Nat*)*, i8* } (i8*, { %TName_Nat* (i8*, %TName_Nat*)*, i8* })*, i8* } %"$nat_iter_fptr_1186"(i8* %"$nat_iter_envptr_1187"), !dbg !109
  store { { { %TName_Nat* (i8*, %TName_Nat*)*, i8* } (i8*, %TName_Nat*)*, i8* } (i8*, { %TName_Nat* (i8*, %TName_Nat*)*, i8* })*, i8* } %"$nat_iter_call_1188", { { { %TName_Nat* (i8*, %TName_Nat*)*, i8* } (i8*, %TName_Nat*)*, i8* } (i8*, { %TName_Nat* (i8*, %TName_Nat*)*, i8* })*, i8* }* %iter_nat, align 8, !dbg !110
...
"$have_gas_1197":                                 ; preds = %"$out_of_gas_1196", %"$have_gas_1192"
  ...
  %"$nat_iter_call_1205" = call { { { { %TName_Nat* (i8*, %TName_Nat*)*, i8* } (i8*, { %TName_Nat* (i8*, %TName_Nat*)*, i8* })*, i8* } (i8*, %TName_Nat*)*, i8* } (i8*, { { %TName_Nat* (i8*, %TName_Nat*)*, i8* } (i8*, { %TName_Nat* (i8*, %TName_Nat*)*, i8* })*, i8* })*, i8* } %"$nat_iter_fptr_1203"(i8* %"$nat_iter_envptr_1204"), !dbg !111
  store { { { { %TName_Nat* (i8*, %TName_Nat*)*, i8* } (i8*, { %TName_Nat* (i8*, %TName_Nat*)*, i8* })*, i8* } (i8*, %TName_Nat*)*, i8* } (i8*, { { %TName_Nat* (i8*, %TName_Nat*)*, i8* } (i8*, { %TName_Nat* (i8*, %TName_Nat*)*, i8* })*, i8* })*, i8* } %"$nat_iter_call_1205", { { { { %TName_Nat* (i8*, %TName_Nat*)*, i8* } (i8*, { %TName_Nat* (i8*, %TName_Nat*)*, i8* })*, i8* } (i8*, %TName_Nat*)*, i8* } (i8*, { { %TName_Nat* (i8*, %TName_Nat*)*, i8* } (i8*, { %TName_Nat* (i8*, %TName_Nat*)*, i8* })*, i8* })*, i8* }* %iter_nat_nat, align 8, !dbg !112
...
"$have_gas_1214":                                 ; preds = %"$out_of_gas_1213", %"$have_gas_1209"
  ...
  store %TName_Nat* %"$adtptr_1218", %TName_Nat** %zero, align 8, !dbg !113
...
"$have_gas_1227":                                 ; preds = %"$out_of_gas_1226", %"$have_gas_1222"
  ...
  store %TName_Nat* %"$adtptr_1233", %TName_Nat** %one, align 8, !dbg !114
...
"$have_gas_1242":                                 ; preds = %"$out_of_gas_1241", %"$have_gas_1237"
  ...
  store { { %TName_Nat* (i8*, %TName_Nat*)*, i8* } (i8*, { %TName_Nat* (i8*, %TName_Nat*)*, i8* })*, i8* } %"$$fundef_166_cloval_1247", { { %TName_Nat* (i8*, %TName_Nat*)*, i8* } (i8*, { %TName_Nat* (i8*, %TName_Nat*)*, i8* })*, i8* }* %f, align 8, !dbg !115
...
"$have_gas_1255":                                 ; preds = %"$out_of_gas_1254", %"$have_gas_1242"
  ...
  store { { %TName_Nat* (i8*, %TName_Nat*)*, i8* } (i8*, %TName_Nat*)*, i8* } %"$$fundef_170_cloval_1260", { { %TName_Nat* (i8*, %TName_Nat*)*, i8* } (i8*, %TName_Nat*)*, i8* }* %ackermann, align 8, !dbg !116
...
"$have_gas_1275":                                 ; preds = %"$out_of_gas_1274", %"$have_gas_1270"
  ...
  store %Uint32 zeroinitializer, %Uint32* %uint0, align 4, !dbg !117
...
"$have_gas_1285":                                 ; preds = %"$out_of_gas_1284", %"$have_gas_1280"
  ...
  store %Uint32 { i32 1 }, %Uint32* %uint1, align 4, !dbg !118
...
"$have_gas_1295":                                 ; preds = %"$out_of_gas_1294", %"$have_gas_1290"
  ...
  store %Uint32 { i32 2 }, %Uint32* %uint2, align 4, !dbg !119
...
"$have_gas_1305":                                 ; preds = %"$out_of_gas_1304", %"$have_gas_1300"
  ...
  store %Uint32 { i32 3 }, %Uint32* %uint3, align 4, !dbg !120
...
"$have_gas_1315":                                 ; preds = %"$out_of_gas_1314", %"$have_gas_1310"
  ...
  store %Uint32 { i32 4 }, %Uint32* %uint4, align 4, !dbg !121
...
"$have_gas_1328":                                 ; preds = %"$out_of_gas_1327", %"$have_gas_1320"
  ...
  %"$to_nat_call_1332" = call %TName_Nat* @_to_nat(i8* %"$execptr_load_1330", %Uint32 %"$uint0_1331"), !dbg !122
  store %TName_Nat* %"$to_nat_call_1332", %TName_Nat** %n0, align 8, !dbg !122
...
"$have_gas_1345":                                 ; preds = %"$out_of_gas_1344", %"$have_gas_1337"
  ...
  %"$to_nat_call_1349" = call %TName_Nat* @_to_nat(i8* %"$execptr_load_1347", %Uint32 %"$uint1_1348"), !dbg !123
  store %TName_Nat* %"$to_nat_call_1349", %TName_Nat** %n1, align 8, !dbg !123
...
"$have_gas_1362":                                 ; preds = %"$out_of_gas_1361", %"$have_gas_1354"
  ...
  %"$to_nat_call_1366" = call %TName_Nat* @_to_nat(i8* %"$execptr_load_1364", %Uint32 %"$uint2_1365"), !dbg !124
  store %TName_Nat* %"$to_nat_call_1366", %TName_Nat** %n2, align 8, !dbg !124
...
"$have_gas_1379":                                 ; preds = %"$out_of_gas_1378", %"$have_gas_1371"
  ...
  %"$to_nat_call_1383" = call %TName_Nat* @_to_nat(i8* %"$execptr_load_1381", %Uint32 %"$uint3_1382"), !dbg !125
  store %TName_Nat* %"$to_nat_call_1383", %TName_Nat** %n3, align 8, !dbg !125
...
"$have_gas_1396":                                 ; preds = %"$out_of_gas_1395", %"$have_gas_1388"
  ...
  %"$to_nat_call_1400" = call %TName_Nat* @_to_nat(i8* %"$execptr_load_1398", %Uint32 %"$uint4_1399"), !dbg !126
  store %TName_Nat* %"$to_nat_call_1400", %TName_Nat** %n4, align 8, !dbg !126
...
"$have_gas_1410":                                 ; preds = %"$out_of_gas_1409", %"$have_gas_1405"
  ...
  %"$ackermann_call_1416" = call { %TName_Nat* (i8*, %TName_Nat*)*, i8* } %"$ackermann_fptr_1413"(i8* %"$ackermann_envptr_1414", %TName_Nat* %"$n0_1415"), !dbg !127
  store { %TName_Nat* (i8*, %TName_Nat*)*, i8* } %"$ackermann_call_1416", { %TName_Nat* (i8*, %TName_Nat*)*, i8* }* %"$ackermann_47", align 8, !dbg !127
  ...
  %"$$ackermann_47_call_1421" = call %TName_Nat* %"$$ackermann_47_fptr_1418"(i8* %"$$ackermann_47_envptr_1419", %TName_Nat* %"$n0_1420"), !dbg !127
  store %TName_Nat* %"$$ackermann_47_call_1421", %TName_Nat** %"$ackermann_48", align 8, !dbg !127
  %"$$ackermann_48_1422" = load %TName_Nat*, %TName_Nat** %"$ackermann_48", align 8
  store %TName_Nat* %"$$ackermann_48_1422", %TName_Nat** %ack00, align 8, !dbg !127
...
"$have_gas_1431":                                 ; preds = %"$out_of_gas_1430", %"$have_gas_1426"
  ...
  %"$ackermann_call_1437" = call { %TName_Nat* (i8*, %TName_Nat*)*, i8* } %"$ackermann_fptr_1434"(i8* %"$ackermann_envptr_1435", %TName_Nat* %"$n0_1436"), !dbg !128
  store { %TName_Nat* (i8*, %TName_Nat*)*, i8* } %"$ackermann_call_1437", { %TName_Nat* (i8*, %TName_Nat*)*, i8* }* %"$ackermann_49", align 8, !dbg !128
  ...
  %"$$ackermann_49_call_1442" = call %TName_Nat* %"$$ackermann_49_fptr_1439"(i8* %"$$ackermann_49_envptr_1440", %TName_Nat* %"$n1_1441"), !dbg !128
  store %TName_Nat* %"$$ackermann_49_call_1442", %TName_Nat** %"$ackermann_50", align 8, !dbg !128
  %"$$ackermann_50_1443" = load %TName_Nat*, %TName_Nat** %"$ackermann_50", align 8
  store %TName_Nat* %"$$ackermann_50_1443", %TName_Nat** %ack01, align 8, !dbg !128
...
"$have_gas_1452":                                 ; preds = %"$out_of_gas_1451", %"$have_gas_1447"
  ...
  %"$ackermann_call_1458" = call { %TName_Nat* (i8*, %TName_Nat*)*, i8* } %"$ackermann_fptr_1455"(i8* %"$ackermann_envptr_1456", %TName_Nat* %"$n0_1457"), !dbg !129
  store { %TName_Nat* (i8*, %TName_Nat*)*, i8* } %"$ackermann_call_1458", { %TName_Nat* (i8*, %TName_Nat*)*, i8* }* %"$ackermann_51", align 8, !dbg !129
  ...
  %"$$ackermann_51_call_1463" = call %TName_Nat* %"$$ackermann_51_fptr_1460"(i8* %"$$ackermann_51_envptr_1461", %TName_Nat* %"$n2_1462"), !dbg !129
  store %TName_Nat* %"$$ackermann_51_call_1463", %TName_Nat** %"$ackermann_52", align 8, !dbg !129
  %"$$ackermann_52_1464" = load %TName_Nat*, %TName_Nat** %"$ackermann_52", align 8
  store %TName_Nat* %"$$ackermann_52_1464", %TName_Nat** %ack02, align 8, !dbg !129
...
"$have_gas_1473":                                 ; preds = %"$out_of_gas_1472", %"$have_gas_1468"
  ...
  %"$ackermann_call_1479" = call { %TName_Nat* (i8*, %TName_Nat*)*, i8* } %"$ackermann_fptr_1476"(i8* %"$ackermann_envptr_1477", %TName_Nat* %"$n0_1478"), !dbg !130
  store { %TName_Nat* (i8*, %TName_Nat*)*, i8* } %"$ackermann_call_1479", { %TName_Nat* (i8*, %TName_Nat*)*, i8* }* %"$ackermann_53", align 8, !dbg !130
  ...
  %"$$ackermann_53_call_1484" = call %TName_Nat* %"$$ackermann_53_fptr_1481"(i8* %"$$ackermann_53_envptr_1482", %TName_Nat* %"$n3_1483"), !dbg !130
  store %TName_Nat* %"$$ackermann_53_call_1484", %TName_Nat** %"$ackermann_54", align 8, !dbg !130
  %"$$ackermann_54_1485" = load %TName_Nat*, %TName_Nat** %"$ackermann_54", align 8
  store %TName_Nat* %"$$ackermann_54_1485", %TName_Nat** %ack03, align 8, !dbg !130
...
"$have_gas_1494":                                 ; preds = %"$out_of_gas_1493", %"$have_gas_1489"
  ...
  %"$ackermann_call_1500" = call { %TName_Nat* (i8*, %TName_Nat*)*, i8* } %"$ackermann_fptr_1497"(i8* %"$ackermann_envptr_1498", %TName_Nat* %"$n0_1499"), !dbg !131
  store { %TName_Nat* (i8*, %TName_Nat*)*, i8* } %"$ackermann_call_1500", { %TName_Nat* (i8*, %TName_Nat*)*, i8* }* %"$ackermann_55", align 8, !dbg !131
  ...
  %"$$ackermann_55_call_1505" = call %TName_Nat* %"$$ackermann_55_fptr_1502"(i8* %"$$ackermann_55_envptr_1503", %TName_Nat* %"$n4_1504"), !dbg !131
  store %TName_Nat* %"$$ackermann_55_call_1505", %TName_Nat** %"$ackermann_56", align 8, !dbg !131
  %"$$ackermann_56_1506" = load %TName_Nat*, %TName_Nat** %"$ackermann_56", align 8
  store %TName_Nat* %"$$ackermann_56_1506", %TName_Nat** %ack04, align 8, !dbg !131
...
"$have_gas_1515":                                 ; preds = %"$out_of_gas_1514", %"$have_gas_1510"
  ...
  %"$ackermann_call_1521" = call { %TName_Nat* (i8*, %TName_Nat*)*, i8* } %"$ackermann_fptr_1518"(i8* %"$ackermann_envptr_1519", %TName_Nat* %"$n1_1520"), !dbg !132
  store { %TName_Nat* (i8*, %TName_Nat*)*, i8* } %"$ackermann_call_1521", { %TName_Nat* (i8*, %TName_Nat*)*, i8* }* %"$ackermann_57", align 8, !dbg !132
  ...
  %"$$ackermann_57_call_1526" = call %TName_Nat* %"$$ackermann_57_fptr_1523"(i8* %"$$ackermann_57_envptr_1524", %TName_Nat* %"$n0_1525"), !dbg !132
  store %TName_Nat* %"$$ackermann_57_call_1526", %TName_Nat** %"$ackermann_58", align 8, !dbg !132
  %"$$ackermann_58_1527" = load %TName_Nat*, %TName_Nat** %"$ackermann_58", align 8
  store %TName_Nat* %"$$ackermann_58_1527", %TName_Nat** %ack10, align 8, !dbg !132
...
"$have_gas_1536":                                 ; preds = %"$out_of_gas_1535", %"$have_gas_1531"
  ...
  %"$ackermann_call_1542" = call { %TName_Nat* (i8*, %TName_Nat*)*, i8* } %"$ackermann_fptr_1539"(i8* %"$ackermann_envptr_1540", %TName_Nat* %"$n1_1541"), !dbg !133
  store { %TName_Nat* (i8*, %TName_Nat*)*, i8* } %"$ackermann_call_1542", { %TName_Nat* (i8*, %TName_Nat*)*, i8* }* %"$ackermann_59", align 8, !dbg !133
  ...
  %"$$ackermann_59_call_1547" = call %TName_Nat* %"$$ackermann_59_fptr_1544"(i8* %"$$ackermann_59_envptr_1545", %TName_Nat* %"$n1_1546"), !dbg !133
  store %TName_Nat* %"$$ackermann_59_call_1547", %TName_Nat** %"$ackermann_60", align 8, !dbg !133
  %"$$ackermann_60_1548" = load %TName_Nat*, %TName_Nat** %"$ackermann_60", align 8
  store %TName_Nat* %"$$ackermann_60_1548", %TName_Nat** %ack11, align 8, !dbg !133
...
"$have_gas_1557":                                 ; preds = %"$out_of_gas_1556", %"$have_gas_1552"
  ...
  %"$ackermann_call_1563" = call { %TName_Nat* (i8*, %TName_Nat*)*, i8* } %"$ackermann_fptr_1560"(i8* %"$ackermann_envptr_1561", %TName_Nat* %"$n1_1562"), !dbg !134
  store { %TName_Nat* (i8*, %TName_Nat*)*, i8* } %"$ackermann_call_1563", { %TName_Nat* (i8*, %TName_Nat*)*, i8* }* %"$ackermann_61", align 8, !dbg !134
  ...
  %"$$ackermann_61_call_1568" = call %TName_Nat* %"$$ackermann_61_fptr_1565"(i8* %"$$ackermann_61_envptr_1566", %TName_Nat* %"$n2_1567"), !dbg !134
  store %TName_Nat* %"$$ackermann_61_call_1568", %TName_Nat** %"$ackermann_62", align 8, !dbg !134
  %"$$ackermann_62_1569" = load %TName_Nat*, %TName_Nat** %"$ackermann_62", align 8
  store %TName_Nat* %"$$ackermann_62_1569", %TName_Nat** %ack12, align 8, !dbg !134
...
"$have_gas_1578":                                 ; preds = %"$out_of_gas_1577", %"$have_gas_1573"
  ...
  %"$ackermann_call_1584" = call { %TName_Nat* (i8*, %TName_Nat*)*, i8* } %"$ackermann_fptr_1581"(i8* %"$ackermann_envptr_1582", %TName_Nat* %"$n1_1583"), !dbg !135
  store { %TName_Nat* (i8*, %TName_Nat*)*, i8* } %"$ackermann_call_1584", { %TName_Nat* (i8*, %TName_Nat*)*, i8* }* %"$ackermann_63", align 8, !dbg !135
  ...
  %"$$ackermann_63_call_1589" = call %TName_Nat* %"$$ackermann_63_fptr_1586"(i8* %"$$ackermann_63_envptr_1587", %TName_Nat* %"$n3_1588"), !dbg !135
  store %TName_Nat* %"$$ackermann_63_call_1589", %TName_Nat** %"$ackermann_64", align 8, !dbg !135
  %"$$ackermann_64_1590" = load %TName_Nat*, %TName_Nat** %"$ackermann_64", align 8
  store %TName_Nat* %"$$ackermann_64_1590", %TName_Nat** %ack13, align 8, !dbg !135
...
"$have_gas_1599":                                 ; preds = %"$out_of_gas_1598", %"$have_gas_1594"
  ...
  %"$ackermann_call_1605" = call { %TName_Nat* (i8*, %TName_Nat*)*, i8* } %"$ackermann_fptr_1602"(i8* %"$ackermann_envptr_1603", %TName_Nat* %"$n1_1604"), !dbg !136
  store { %TName_Nat* (i8*, %TName_Nat*)*, i8* } %"$ackermann_call_1605", { %TName_Nat* (i8*, %TName_Nat*)*, i8* }* %"$ackermann_65", align 8, !dbg !136
  ...
  %"$$ackermann_65_call_1610" = call %TName_Nat* %"$$ackermann_65_fptr_1607"(i8* %"$$ackermann_65_envptr_1608", %TName_Nat* %"$n4_1609"), !dbg !136
  store %TName_Nat* %"$$ackermann_65_call_1610", %TName_Nat** %"$ackermann_66", align 8, !dbg !136
  %"$$ackermann_66_1611" = load %TName_Nat*, %TName_Nat** %"$ackermann_66", align 8
  store %TName_Nat* %"$$ackermann_66_1611", %TName_Nat** %ack14, align 8, !dbg !136
...
"$have_gas_1620":                                 ; preds = %"$out_of_gas_1619", %"$have_gas_1615"
  ...
  %"$ackermann_call_1626" = call { %TName_Nat* (i8*, %TName_Nat*)*, i8* } %"$ackermann_fptr_1623"(i8* %"$ackermann_envptr_1624", %TName_Nat* %"$n2_1625"), !dbg !137
  store { %TName_Nat* (i8*, %TName_Nat*)*, i8* } %"$ackermann_call_1626", { %TName_Nat* (i8*, %TName_Nat*)*, i8* }* %"$ackermann_67", align 8, !dbg !137
  ...
  %"$$ackermann_67_call_1631" = call %TName_Nat* %"$$ackermann_67_fptr_1628"(i8* %"$$ackermann_67_envptr_1629", %TName_Nat* %"$n0_1630"), !dbg !137
  store %TName_Nat* %"$$ackermann_67_call_1631", %TName_Nat** %"$ackermann_68", align 8, !dbg !137
  %"$$ackermann_68_1632" = load %TName_Nat*, %TName_Nat** %"$ackermann_68", align 8
  store %TName_Nat* %"$$ackermann_68_1632", %TName_Nat** %ack20, align 8, !dbg !137
...
"$have_gas_1641":                                 ; preds = %"$out_of_gas_1640", %"$have_gas_1636"
  ...
  %"$ackermann_call_1647" = call { %TName_Nat* (i8*, %TName_Nat*)*, i8* } %"$ackermann_fptr_1644"(i8* %"$ackermann_envptr_1645", %TName_Nat* %"$n2_1646"), !dbg !138
  store { %TName_Nat* (i8*, %TName_Nat*)*, i8* } %"$ackermann_call_1647", { %TName_Nat* (i8*, %TName_Nat*)*, i8* }* %"$ackermann_69", align 8, !dbg !138
  ...
  %"$$ackermann_69_call_1652" = call %TName_Nat* %"$$ackermann_69_fptr_1649"(i8* %"$$ackermann_69_envptr_1650", %TName_Nat* %"$n1_1651"), !dbg !138
  store %TName_Nat* %"$$ackermann_69_call_1652", %TName_Nat** %"$ackermann_70", align 8, !dbg !138
  %"$$ackermann_70_1653" = load %TName_Nat*, %TName_Nat** %"$ackermann_70", align 8
  store %TName_Nat* %"$$ackermann_70_1653", %TName_Nat** %ack21, align 8, !dbg !138
...
"$have_gas_1662":                                 ; preds = %"$out_of_gas_1661", %"$have_gas_1657"
  ...
  %"$ackermann_call_1668" = call { %TName_Nat* (i8*, %TName_Nat*)*, i8* } %"$ackermann_fptr_1665"(i8* %"$ackermann_envptr_1666", %TName_Nat* %"$n2_1667"), !dbg !139
  store { %TName_Nat* (i8*, %TName_Nat*)*, i8* } %"$ackermann_call_1668", { %TName_Nat* (i8*, %TName_Nat*)*, i8* }* %"$ackermann_71", align 8, !dbg !139
  ...
  %"$$ackermann_71_call_1673" = call %TName_Nat* %"$$ackermann_71_fptr_1670"(i8* %"$$ackermann_71_envptr_1671", %TName_Nat* %"$n2_1672"), !dbg !139
  store %TName_Nat* %"$$ackermann_71_call_1673", %TName_Nat** %"$ackermann_72", align 8, !dbg !139
  %"$$ackermann_72_1674" = load %TName_Nat*, %TName_Nat** %"$ackermann_72", align 8
  store %TName_Nat* %"$$ackermann_72_1674", %TName_Nat** %ack22, align 8, !dbg !139
...
"$have_gas_1683":                                 ; preds = %"$out_of_gas_1682", %"$have_gas_1678"
  ...
  %"$ackermann_call_1689" = call { %TName_Nat* (i8*, %TName_Nat*)*, i8* } %"$ackermann_fptr_1686"(i8* %"$ackermann_envptr_1687", %TName_Nat* %"$n2_1688"), !dbg !140
  store { %TName_Nat* (i8*, %TName_Nat*)*, i8* } %"$ackermann_call_1689", { %TName_Nat* (i8*, %TName_Nat*)*, i8* }* %"$ackermann_73", align 8, !dbg !140
  ...
  %"$$ackermann_73_call_1694" = call %TName_Nat* %"$$ackermann_73_fptr_1691"(i8* %"$$ackermann_73_envptr_1692", %TName_Nat* %"$n3_1693"), !dbg !140
  store %TName_Nat* %"$$ackermann_73_call_1694", %TName_Nat** %"$ackermann_74", align 8, !dbg !140
  %"$$ackermann_74_1695" = load %TName_Nat*, %TName_Nat** %"$ackermann_74", align 8
  store %TName_Nat* %"$$ackermann_74_1695", %TName_Nat** %ack23, align 8, !dbg !140
...
"$have_gas_1704":                                 ; preds = %"$out_of_gas_1703", %"$have_gas_1699"
  ...
  %"$ackermann_call_1710" = call { %TName_Nat* (i8*, %TName_Nat*)*, i8* } %"$ackermann_fptr_1707"(i8* %"$ackermann_envptr_1708", %TName_Nat* %"$n2_1709"), !dbg !141
  store { %TName_Nat* (i8*, %TName_Nat*)*, i8* } %"$ackermann_call_1710", { %TName_Nat* (i8*, %TName_Nat*)*, i8* }* %"$ackermann_75", align 8, !dbg !141
  ...
  %"$$ackermann_75_call_1715" = call %TName_Nat* %"$$ackermann_75_fptr_1712"(i8* %"$$ackermann_75_envptr_1713", %TName_Nat* %"$n4_1714"), !dbg !141
  store %TName_Nat* %"$$ackermann_75_call_1715", %TName_Nat** %"$ackermann_76", align 8, !dbg !141
  %"$$ackermann_76_1716" = load %TName_Nat*, %TName_Nat** %"$ackermann_76", align 8
  store %TName_Nat* %"$$ackermann_76_1716", %TName_Nat** %ack24, align 8, !dbg !141
...
"$have_gas_1725":                                 ; preds = %"$out_of_gas_1724", %"$have_gas_1720"
  ...
  %"$ackermann_call_1731" = call { %TName_Nat* (i8*, %TName_Nat*)*, i8* } %"$ackermann_fptr_1728"(i8* %"$ackermann_envptr_1729", %TName_Nat* %"$n3_1730"), !dbg !142
  store { %TName_Nat* (i8*, %TName_Nat*)*, i8* } %"$ackermann_call_1731", { %TName_Nat* (i8*, %TName_Nat*)*, i8* }* %"$ackermann_77", align 8, !dbg !142
  ...
  %"$$ackermann_77_call_1736" = call %TName_Nat* %"$$ackermann_77_fptr_1733"(i8* %"$$ackermann_77_envptr_1734", %TName_Nat* %"$n0_1735"), !dbg !142
  store %TName_Nat* %"$$ackermann_77_call_1736", %TName_Nat** %"$ackermann_78", align 8, !dbg !142
  %"$$ackermann_78_1737" = load %TName_Nat*, %TName_Nat** %"$ackermann_78", align 8
  store %TName_Nat* %"$$ackermann_78_1737", %TName_Nat** %ack30, align 8, !dbg !142
...
"$have_gas_1746":                                 ; preds = %"$out_of_gas_1745", %"$have_gas_1741"
  ...
  %"$ackermann_call_1752" = call { %TName_Nat* (i8*, %TName_Nat*)*, i8* } %"$ackermann_fptr_1749"(i8* %"$ackermann_envptr_1750", %TName_Nat* %"$n3_1751"), !dbg !143
  store { %TName_Nat* (i8*, %TName_Nat*)*, i8* } %"$ackermann_call_1752", { %TName_Nat* (i8*, %TName_Nat*)*, i8* }* %"$ackermann_79", align 8, !dbg !143
  ...
  %"$$ackermann_79_call_1757" = call %TName_Nat* %"$$ackermann_79_fptr_1754"(i8* %"$$ackermann_79_envptr_1755", %TName_Nat* %"$n1_1756"), !dbg !143
  store %TName_Nat* %"$$ackermann_79_call_1757", %TName_Nat** %"$ackermann_80", align 8, !dbg !143
  %"$$ackermann_80_1758" = load %TName_Nat*, %TName_Nat** %"$ackermann_80", align 8
  store %TName_Nat* %"$$ackermann_80_1758", %TName_Nat** %ack31, align 8, !dbg !143
...
"$have_gas_1767":                                 ; preds = %"$out_of_gas_1766", %"$have_gas_1762"
  ...
  %"$ackermann_call_1773" = call { %TName_Nat* (i8*, %TName_Nat*)*, i8* } %"$ackermann_fptr_1770"(i8* %"$ackermann_envptr_1771", %TName_Nat* %"$n3_1772"), !dbg !144
  store { %TName_Nat* (i8*, %TName_Nat*)*, i8* } %"$ackermann_call_1773", { %TName_Nat* (i8*, %TName_Nat*)*, i8* }* %"$ackermann_81", align 8, !dbg !144
  ...
  %"$$ackermann_81_call_1778" = call %TName_Nat* %"$$ackermann_81_fptr_1775"(i8* %"$$ackermann_81_envptr_1776", %TName_Nat* %"$n2_1777"), !dbg !144
  store %TName_Nat* %"$$ackermann_81_call_1778", %TName_Nat** %"$ackermann_82", align 8, !dbg !144
  %"$$ackermann_82_1779" = load %TName_Nat*, %TName_Nat** %"$ackermann_82", align 8
  store %TName_Nat* %"$$ackermann_82_1779", %TName_Nat** %ack32, align 8, !dbg !144
...
"$have_gas_1788":                                 ; preds = %"$out_of_gas_1787", %"$have_gas_1783"
  ...
  %"$ackermann_call_1794" = call { %TName_Nat* (i8*, %TName_Nat*)*, i8* } %"$ackermann_fptr_1791"(i8* %"$ackermann_envptr_1792", %TName_Nat* %"$n3_1793"), !dbg !145
  store { %TName_Nat* (i8*, %TName_Nat*)*, i8* } %"$ackermann_call_1794", { %TName_Nat* (i8*, %TName_Nat*)*, i8* }* %"$ackermann_83", align 8, !dbg !145
  ...
  %"$$ackermann_83_call_1799" = call %TName_Nat* %"$$ackermann_83_fptr_1796"(i8* %"$$ackermann_83_envptr_1797", %TName_Nat* %"$n3_1798"), !dbg !145
  store %TName_Nat* %"$$ackermann_83_call_1799", %TName_Nat** %"$ackermann_84", align 8, !dbg !145
  %"$$ackermann_84_1800" = load %TName_Nat*, %TName_Nat** %"$ackermann_84", align 8
  store %TName_Nat* %"$$ackermann_84_1800", %TName_Nat** %ack33, align 8, !dbg !145
...
"$have_gas_1809":                                 ; preds = %"$out_of_gas_1808", %"$have_gas_1804"
  ...
  %"$ackermann_call_1815" = call { %TName_Nat* (i8*, %TName_Nat*)*, i8* } %"$ackermann_fptr_1812"(i8* %"$ackermann_envptr_1813", %TName_Nat* %"$n3_1814"), !dbg !146
  store { %TName_Nat* (i8*, %TName_Nat*)*, i8* } %"$ackermann_call_1815", { %TName_Nat* (i8*, %TName_Nat*)*, i8* }* %"$ackermann_85", align 8, !dbg !146
  ...
  %"$$ackermann_85_call_1820" = call %TName_Nat* %"$$ackermann_85_fptr_1817"(i8* %"$$ackermann_85_envptr_1818", %TName_Nat* %"$n4_1819"), !dbg !146
  store %TName_Nat* %"$$ackermann_85_call_1820", %TName_Nat** %"$ackermann_86", align 8, !dbg !146
  %"$$ackermann_86_1821" = load %TName_Nat*, %TName_Nat** %"$ackermann_86", align 8
  store %TName_Nat* %"$$ackermann_86_1821", %TName_Nat** %ack34, align 8, !dbg !146
...
"$have_gas_1830":                                 ; preds = %"$out_of_gas_1829", %"$have_gas_1825"
  ...
  %"$ackermann_call_1836" = call { %TName_Nat* (i8*, %TName_Nat*)*, i8* } %"$ackermann_fptr_1833"(i8* %"$ackermann_envptr_1834", %TName_Nat* %"$n4_1835"), !dbg !147
  store { %TName_Nat* (i8*, %TName_Nat*)*, i8* } %"$ackermann_call_1836", { %TName_Nat* (i8*, %TName_Nat*)*, i8* }* %"$ackermann_87", align 8, !dbg !147
  ...
  %"$$ackermann_87_call_1841" = call %TName_Nat* %"$$ackermann_87_fptr_1838"(i8* %"$$ackermann_87_envptr_1839", %TName_Nat* %"$n0_1840"), !dbg !147
  store %TName_Nat* %"$$ackermann_87_call_1841", %TName_Nat** %"$ackermann_88", align 8, !dbg !147
  %"$$ackermann_88_1842" = load %TName_Nat*, %TName_Nat** %"$ackermann_88", align 8
  store %TName_Nat* %"$$ackermann_88_1842", %TName_Nat** %ack40, align 8, !dbg !147
...
"$have_gas_1851":                                 ; preds = %"$out_of_gas_1850", %"$have_gas_1846"
  ...
  %"$NatUtils.nat_to_int_call_1857" = call %Uint32 %"$NatUtils.nat_to_int_fptr_1854"(i8* %"$NatUtils.nat_to_int_envptr_1855", %TName_Nat* %"$ack00_1856"), !dbg !148
  store %Uint32 %"$NatUtils.nat_to_int_call_1857", %Uint32* %"$NatUtils.nat_to_int_89", align 4, !dbg !148
  %"$$NatUtils.nat_to_int_89_1858" = load %Uint32, %Uint32* %"$NatUtils.nat_to_int_89", align 4
  store %Uint32 %"$$NatUtils.nat_to_int_89_1858", %Uint32* %int01, align 4, !dbg !148
...
"$have_gas_1867":                                 ; preds = %"$out_of_gas_1866", %"$have_gas_1862"
  ...
  %"$NatUtils.nat_to_int_call_1873" = call %Uint32 %"$NatUtils.nat_to_int_fptr_1870"(i8* %"$NatUtils.nat_to_int_envptr_1871", %TName_Nat* %"$ack02_1872"), !dbg !149
  store %Uint32 %"$NatUtils.nat_to_int_call_1873", %Uint32* %"$NatUtils.nat_to_int_90", align 4, !dbg !149
  %"$$NatUtils.nat_to_int_90_1874" = load %Uint32, %Uint32* %"$NatUtils.nat_to_int_90", align 4
  store %Uint32 %"$$NatUtils.nat_to_int_90_1874", %Uint32* %int02, align 4, !dbg !149
...
"$have_gas_1883":                                 ; preds = %"$out_of_gas_1882", %"$have_gas_1878"
  ...
  %"$NatUtils.nat_to_int_call_1889" = call %Uint32 %"$NatUtils.nat_to_int_fptr_1886"(i8* %"$NatUtils.nat_to_int_envptr_1887", %TName_Nat* %"$ack03_1888"), !dbg !150
  store %Uint32 %"$NatUtils.nat_to_int_call_1889", %Uint32* %"$NatUtils.nat_to_int_91", align 4, !dbg !150
  %"$$NatUtils.nat_to_int_91_1890" = load %Uint32, %Uint32* %"$NatUtils.nat_to_int_91", align 4
  store %Uint32 %"$$NatUtils.nat_to_int_91_1890", %Uint32* %int03, align 4, !dbg !150
...
"$have_gas_1899":                                 ; preds = %"$out_of_gas_1898", %"$have_gas_1894"
  ...
  %"$NatUtils.nat_to_int_call_1905" = call %Uint32 %"$NatUtils.nat_to_int_fptr_1902"(i8* %"$NatUtils.nat_to_int_envptr_1903", %TName_Nat* %"$ack04_1904"), !dbg !151
  store %Uint32 %"$NatUtils.nat_to_int_call_1905", %Uint32* %"$NatUtils.nat_to_int_92", align 4, !dbg !151
  %"$$NatUtils.nat_to_int_92_1906" = load %Uint32, %Uint32* %"$NatUtils.nat_to_int_92", align 4
  store %Uint32 %"$$NatUtils.nat_to_int_92_1906", %Uint32* %int04, align 4, !dbg !151
...
"$have_gas_1915":                                 ; preds = %"$out_of_gas_1914", %"$have_gas_1910"
  ...
  %"$NatUtils.nat_to_int_call_1921" = call %Uint32 %"$NatUtils.nat_to_int_fptr_1918"(i8* %"$NatUtils.nat_to_int_envptr_1919", %TName_Nat* %"$ack10_1920"), !dbg !152
  store %Uint32 %"$NatUtils.nat_to_int_call_1921", %Uint32* %"$NatUtils.nat_to_int_93", align 4, !dbg !152
  %"$$NatUtils.nat_to_int_93_1922" = load %Uint32, %Uint32* %"$NatUtils.nat_to_int_93", align 4
  store %Uint32 %"$$NatUtils.nat_to_int_93_1922", %Uint32* %int10, align 4, !dbg !152
...
"$have_gas_1931":                                 ; preds = %"$out_of_gas_1930", %"$have_gas_1926"
  ...
  %"$NatUtils.nat_to_int_call_1937" = call %Uint32 %"$NatUtils.nat_to_int_fptr_1934"(i8* %"$NatUtils.nat_to_int_envptr_1935", %TName_Nat* %"$ack11_1936"), !dbg !153
  store %Uint32 %"$NatUtils.nat_to_int_call_1937", %Uint32* %"$NatUtils.nat_to_int_94", align 4, !dbg !153
  %"$$NatUtils.nat_to_int_94_1938" = load %Uint32, %Uint32* %"$NatUtils.nat_to_int_94", align 4
  store %Uint32 %"$$NatUtils.nat_to_int_94_1938", %Uint32* %int11, align 4, !dbg !153
...
"$have_gas_1947":                                 ; preds = %"$out_of_gas_1946", %"$have_gas_1942"
  ...
  %"$NatUtils.nat_to_int_call_1953" = call %Uint32 %"$NatUtils.nat_to_int_fptr_1950"(i8* %"$NatUtils.nat_to_int_envptr_1951", %TName_Nat* %"$ack12_1952"), !dbg !154
  store %Uint32 %"$NatUtils.nat_to_int_call_1953", %Uint32* %"$NatUtils.nat_to_int_95", align 4, !dbg !154
  %"$$NatUtils.nat_to_int_95_1954" = load %Uint32, %Uint32* %"$NatUtils.nat_to_int_95", align 4
  store %Uint32 %"$$NatUtils.nat_to_int_95_1954", %Uint32* %int12, align 4, !dbg !154
...
"$have_gas_1963":                                 ; preds = %"$out_of_gas_1962", %"$have_gas_1958"
  ...
  %"$NatUtils.nat_to_int_call_1969" = call %Uint32 %"$NatUtils.nat_to_int_fptr_1966"(i8* %"$NatUtils.nat_to_int_envptr_1967", %TName_Nat* %"$ack13_1968"), !dbg !155
  store %Uint32 %"$NatUtils.nat_to_int_call_1969", %Uint32* %"$NatUtils.nat_to_int_96", align 4, !dbg !155
  %"$$NatUtils.nat_to_int_96_1970" = load %Uint32, %Uint32* %"$NatUtils.nat_to_int_96", align 4
  store %Uint32 %"$$NatUtils.nat_to_int_96_1970", %Uint32* %int13, align 4, !dbg !155
...
"$have_gas_1979":                                 ; preds = %"$out_of_gas_1978", %"$have_gas_1974"
  ...
  %"$NatUtils.nat_to_int_call_1985" = call %Uint32 %"$NatUtils.nat_to_int_fptr_1982"(i8* %"$NatUtils.nat_to_int_envptr_1983", %TName_Nat* %"$ack14_1984"), !dbg !156
  store %Uint32 %"$NatUtils.nat_to_int_call_1985", %Uint32* %"$NatUtils.nat_to_int_97", align 4, !dbg !156
  %"$$NatUtils.nat_to_int_97_1986" = load %Uint32, %Uint32* %"$NatUtils.nat_to_int_97", align 4
  store %Uint32 %"$$NatUtils.nat_to_int_97_1986", %Uint32* %int14, align 4, !dbg !156
...
"$have_gas_1995":                                 ; preds = %"$out_of_gas_1994", %"$have_gas_1990"
  ...
  %"$NatUtils.nat_to_int_call_2001" = call %Uint32 %"$NatUtils.nat_to_int_fptr_1998"(i8* %"$NatUtils.nat_to_int_envptr_1999", %TName_Nat* %"$ack20_2000"), !dbg !157
  store %Uint32 %"$NatUtils.nat_to_int_call_2001", %Uint32* %"$NatUtils.nat_to_int_98", align 4, !dbg !157
  %"$$NatUtils.nat_to_int_98_2002" = load %Uint32, %Uint32* %"$NatUtils.nat_to_int_98", align 4
  store %Uint32 %"$$NatUtils.nat_to_int_98_2002", %Uint32* %int20, align 4, !dbg !157
...
"$have_gas_2011":                                 ; preds = %"$out_of_gas_2010", %"$have_gas_2006"
  ...
  %"$NatUtils.nat_to_int_call_2017" = call %Uint32 %"$NatUtils.nat_to_int_fptr_2014"(i8* %"$NatUtils.nat_to_int_envptr_2015", %TName_Nat* %"$ack21_2016"), !dbg !158
  store %Uint32 %"$NatUtils.nat_to_int_call_2017", %Uint32* %"$NatUtils.nat_to_int_99", align 4, !dbg !158
  %"$$NatUtils.nat_to_int_99_2018" = load %Uint32, %Uint32* %"$NatUtils.nat_to_int_99", align 4
  store %Uint32 %"$$NatUtils.nat_to_int_99_2018", %Uint32* %int21, align 4, !dbg !158
...
"$have_gas_2027":                                 ; preds = %"$out_of_gas_2026", %"$have_gas_2022"
  ...
  %"$NatUtils.nat_to_int_call_2033" = call %Uint32 %"$NatUtils.nat_to_int_fptr_2030"(i8* %"$NatUtils.nat_to_int_envptr_2031", %TName_Nat* %"$ack22_2032"), !dbg !159
  store %Uint32 %"$NatUtils.nat_to_int_call_2033", %Uint32* %"$NatUtils.nat_to_int_100", align 4, !dbg !159
  %"$$NatUtils.nat_to_int_100_2034" = load %Uint32, %Uint32* %"$NatUtils.nat_to_int_100", align 4
  store %Uint32 %"$$NatUtils.nat_to_int_100_2034", %Uint32* %int22, align 4, !dbg !159
...
"$have_gas_2043":                                 ; preds = %"$out_of_gas_2042", %"$have_gas_2038"
  ...
  %"$NatUtils.nat_to_int_call_2049" = call %Uint32 %"$NatUtils.nat_to_int_fptr_2046"(i8* %"$NatUtils.nat_to_int_envptr_2047", %TName_Nat* %"$ack23_2048"), !dbg !160
  store %Uint32 %"$NatUtils.nat_to_int_call_2049", %Uint32* %"$NatUtils.nat_to_int_101", align 4, !dbg !160
  %"$$NatUtils.nat_to_int_101_2050" = load %Uint32, %Uint32* %"$NatUtils.nat_to_int_101", align 4
  store %Uint32 %"$$NatUtils.nat_to_int_101_2050", %Uint32* %int23, align 4, !dbg !160
...
"$have_gas_2059":                                 ; preds = %"$out_of_gas_2058", %"$have_gas_2054"
  ...
  %"$NatUtils.nat_to_int_call_2065" = call %Uint32 %"$NatUtils.nat_to_int_fptr_2062"(i8* %"$NatUtils.nat_to_int_envptr_2063", %TName_Nat* %"$ack23_2064"), !dbg !161
  store %Uint32 %"$NatUtils.nat_to_int_call_2065", %Uint32* %"$NatUtils.nat_to_int_102", align 4, !dbg !161
  %"$$NatUtils.nat_to_int_102_2066" = load %Uint32, %Uint32* %"$NatUtils.nat_to_int_102", align 4
  store %Uint32 %"$$NatUtils.nat_to_int_102_2066", %Uint32* %int24, align 4, !dbg !161
...
"$have_gas_2075":                                 ; preds = %"$out_of_gas_2074", %"$have_gas_2070"
  ...
  %"$NatUtils.nat_to_int_call_2081" = call %Uint32 %"$NatUtils.nat_to_int_fptr_2078"(i8* %"$NatUtils.nat_to_int_envptr_2079", %TName_Nat* %"$ack30_2080"), !dbg !162
  store %Uint32 %"$NatUtils.nat_to_int_call_2081", %Uint32* %"$NatUtils.nat_to_int_103", align 4, !dbg !162
  %"$$NatUtils.nat_to_int_103_2082" = load %Uint32, %Uint32* %"$NatUtils.nat_to_int_103", align 4
  store %Uint32 %"$$NatUtils.nat_to_int_103_2082", %Uint32* %int30, align 4, !dbg !162
...
"$have_gas_2091":                                 ; preds = %"$out_of_gas_2090", %"$have_gas_2086"
  ...
  %"$NatUtils.nat_to_int_call_2097" = call %Uint32 %"$NatUtils.nat_to_int_fptr_2094"(i8* %"$NatUtils.nat_to_int_envptr_2095", %TName_Nat* %"$ack31_2096"), !dbg !163
  store %Uint32 %"$NatUtils.nat_to_int_call_2097", %Uint32* %"$NatUtils.nat_to_int_104", align 4, !dbg !163
  %"$$NatUtils.nat_to_int_104_2098" = load %Uint32, %Uint32* %"$NatUtils.nat_to_int_104", align 4
  store %Uint32 %"$$NatUtils.nat_to_int_104_2098", %Uint32* %int31, align 4, !dbg !163
...
"$have_gas_2107":                                 ; preds = %"$out_of_gas_2106", %"$have_gas_2102"
  ...
  %"$NatUtils.nat_to_int_call_2113" = call %Uint32 %"$NatUtils.nat_to_int_fptr_2110"(i8* %"$NatUtils.nat_to_int_envptr_2111", %TName_Nat* %"$ack32_2112"), !dbg !164
  store %Uint32 %"$NatUtils.nat_to_int_call_2113", %Uint32* %"$NatUtils.nat_to_int_105", align 4, !dbg !164
  %"$$NatUtils.nat_to_int_105_2114" = load %Uint32, %Uint32* %"$NatUtils.nat_to_int_105", align 4
  store %Uint32 %"$$NatUtils.nat_to_int_105_2114", %Uint32* %int32, align 4, !dbg !164
...
"$have_gas_2123":                                 ; preds = %"$out_of_gas_2122", %"$have_gas_2118"
  ...
  %"$NatUtils.nat_to_int_call_2129" = call %Uint32 %"$NatUtils.nat_to_int_fptr_2126"(i8* %"$NatUtils.nat_to_int_envptr_2127", %TName_Nat* %"$ack33_2128"), !dbg !165
  store %Uint32 %"$NatUtils.nat_to_int_call_2129", %Uint32* %"$NatUtils.nat_to_int_106", align 4, !dbg !165
  %"$$NatUtils.nat_to_int_106_2130" = load %Uint32, %Uint32* %"$NatUtils.nat_to_int_106", align 4
  store %Uint32 %"$$NatUtils.nat_to_int_106_2130", %Uint32* %int33, align 4, !dbg !165
...
"$have_gas_2139":                                 ; preds = %"$out_of_gas_2138", %"$have_gas_2134"
  ...
  %"$NatUtils.nat_to_int_call_2145" = call %Uint32 %"$NatUtils.nat_to_int_fptr_2142"(i8* %"$NatUtils.nat_to_int_envptr_2143", %TName_Nat* %"$ack34_2144"), !dbg !166
  store %Uint32 %"$NatUtils.nat_to_int_call_2145", %Uint32* %"$NatUtils.nat_to_int_107", align 4, !dbg !166
  %"$$NatUtils.nat_to_int_107_2146" = load %Uint32, %Uint32* %"$NatUtils.nat_to_int_107", align 4
  store %Uint32 %"$$NatUtils.nat_to_int_107_2146", %Uint32* %int34, align 4, !dbg !166
...
"$have_gas_2155":                                 ; preds = %"$out_of_gas_2154", %"$have_gas_2150"
  ...
  %"$NatUtils.nat_to_int_call_2161" = call %Uint32 %"$NatUtils.nat_to_int_fptr_2158"(i8* %"$NatUtils.nat_to_int_envptr_2159", %TName_Nat* %"$ack40_2160"), !dbg !167
  store %Uint32 %"$NatUtils.nat_to_int_call_2161", %Uint32* %"$NatUtils.nat_to_int_108", align 4, !dbg !167
  %"$$NatUtils.nat_to_int_108_2162" = load %Uint32, %Uint32* %"$NatUtils.nat_to_int_108", align 4
  store %Uint32 %"$$NatUtils.nat_to_int_108_2162", %Uint32* %int40, align 4, !dbg !167
...
"$have_gas_2171":                                 ; preds = %"$out_of_gas_2170", %"$have_gas_2166"
  ...
  %"$add_call_2175" = call %Uint32 @_add_Uint32(%Uint32 %"$int01_2173", %Uint32 %"$int02_2174"), !dbg !168
  store %Uint32 %"$add_call_2175", %Uint32* %sum, align 4, !dbg !168
...
"$have_gas_2184":                                 ; preds = %"$out_of_gas_2183", %"$have_gas_2179"
  ...
  %"$add_call_2188" = call %Uint32 @_add_Uint32(%Uint32 %"$sum_2186", %Uint32 %"$int03_2187"), !dbg !169
  store %Uint32 %"$add_call_2188", %Uint32* %"$sum_7", align 4, !dbg !169
...
"$have_gas_2197":                                 ; preds = %"$out_of_gas_2196", %"$have_gas_2192"
  ...
  %"$add_call_2201" = call %Uint32 @_add_Uint32(%Uint32 %"$$sum_7_2199", %Uint32 %"$int04_2200"), !dbg !170
  store %Uint32 %"$add_call_2201", %Uint32* %"$sum_8", align 4, !dbg !170
...
"$have_gas_2210":                                 ; preds = %"$out_of_gas_2209", %"$have_gas_2205"
  ...
  %"$add_call_2214" = call %Uint32 @_add_Uint32(%Uint32 %"$$sum_8_2212", %Uint32 %"$int10_2213"), !dbg !171
  store %Uint32 %"$add_call_2214", %Uint32* %"$sum_9", align 4, !dbg !171
...
"$have_gas_2223":                                 ; preds = %"$out_of_gas_2222", %"$have_gas_2218"
  ...
  %"$add_call_2227" = call %Uint32 @_add_Uint32(%Uint32 %"$$sum_9_2225", %Uint32 %"$int11_2226"), !dbg !172
  store %Uint32 %"$add_call_2227", %Uint32* %"$sum_10", align 4, !dbg !172
...
"$have_gas_2236":                                 ; preds = %"$out_of_gas_2235", %"$have_gas_2231"
  ...
  %"$add_call_2240" = call %Uint32 @_add_Uint32(%Uint32 %"$$sum_10_2238", %Uint32 %"$int12_2239"), !dbg !173
  store %Uint32 %"$add_call_2240", %Uint32* %"$sum_11", align 4, !dbg !173
...
"$have_gas_2249":                                 ; preds = %"$out_of_gas_2248", %"$have_gas_2244"
  ...
  %"$add_call_2253" = call %Uint32 @_add_Uint32(%Uint32 %"$$sum_11_2251", %Uint32 %"$int13_2252"), !dbg !174
  store %Uint32 %"$add_call_2253", %Uint32* %"$sum_12", align 4, !dbg !174
...
"$have_gas_2262":                                 ; preds = %"$out_of_gas_2261", %"$have_gas_2257"
  ...
  %"$add_call_2266" = call %Uint32 @_add_Uint32(%Uint32 %"$$sum_12_2264", %Uint32 %"$int14_2265"), !dbg !175
  store %Uint32 %"$add_call_2266", %Uint32* %"$sum_13", align 4, !dbg !175
...
"$have_gas_2275":                                 ; preds = %"$out_of_gas_2274", %"$have_gas_2270"
  ...
  %"$add_call_2279" = call %Uint32 @_add_Uint32(%Uint32 %"$$sum_13_2277", %Uint32 %"$int20_2278"), !dbg !176
  store %Uint32 %"$add_call_2279", %Uint32* %"$sum_14", align 4, !dbg !176
...
"$have_gas_2288":                                 ; preds = %"$out_of_gas_2287", %"$have_gas_2283"
  ...
  %"$add_call_2292" = call %Uint32 @_add_Uint32(%Uint32 %"$$sum_14_2290", %Uint32 %"$int21_2291"), !dbg !177
  store %Uint32 %"$add_call_2292", %Uint32* %"$sum_15", align 4, !dbg !177
...
"$have_gas_2301":                                 ; preds = %"$out_of_gas_2300", %"$have_gas_2296"
  ...
  %"$add_call_2305" = call %Uint32 @_add_Uint32(%Uint32 %"$$sum_15_2303", %Uint32 %"$int22_2304"), !dbg !178
  store %Uint32 %"$add_call_2305", %Uint32* %"$sum_16", align 4, !dbg !178
...
"$have_gas_2314":                                 ; preds = %"$out_of_gas_2313", %"$have_gas_2309"
  ...
  %"$add_call_2318" = call %Uint32 @_add_Uint32(%Uint32 %"$$sum_16_2316", %Uint32 %"$int23_2317"), !dbg !179
  store %Uint32 %"$add_call_2318", %Uint32* %"$sum_17", align 4, !dbg !179
...
"$have_gas_2327":                                 ; preds = %"$out_of_gas_2326", %"$have_gas_2322"
  ...
  %"$add_call_2331" = call %Uint32 @_add_Uint32(%Uint32 %"$$sum_17_2329", %Uint32 %"$int24_2330"), !dbg !180
  store %Uint32 %"$add_call_2331", %Uint32* %"$sum_18", align 4, !dbg !180
...
"$have_gas_2340":                                 ; preds = %"$out_of_gas_2339", %"$have_gas_2335"
  ...
  %"$add_call_2344" = call %Uint32 @_add_Uint32(%Uint32 %"$$sum_18_2342", %Uint32 %"$int30_2343"), !dbg !181
  store %Uint32 %"$add_call_2344", %Uint32* %"$sum_19", align 4, !dbg !181
...
"$have_gas_2353":                                 ; preds = %"$out_of_gas_2352", %"$have_gas_2348"
  ...
  %"$add_call_2357" = call %Uint32 @_add_Uint32(%Uint32 %"$$sum_19_2355", %Uint32 %"$int31_2356"), !dbg !182
  store %Uint32 %"$add_call_2357", %Uint32* %"$sum_20", align 4, !dbg !182
...
"$have_gas_2366":                                 ; preds = %"$out_of_gas_2365", %"$have_gas_2361"
  ...
  %"$add_call_2370" = call %Uint32 @_add_Uint32(%Uint32 %"$$sum_20_2368", %Uint32 %"$int32_2369"), !dbg !183
  store %Uint32 %"$add_call_2370", %Uint32* %"$sum_21", align 4, !dbg !183
...
"$have_gas_2379":                                 ; preds = %"$out_of_gas_2378", %"$have_gas_2374"
  ...
  %"$add_call_2383" = call %Uint32 @_add_Uint32(%Uint32 %"$$sum_21_2381", %Uint32 %"$int33_2382"), !dbg !184
  store %Uint32 %"$add_call_2383", %Uint32* %"$sum_22", align 4, !dbg !184
...
"$have_gas_2392":                                 ; preds = %"$out_of_gas_2391", %"$have_gas_2387"
  ...
  %"$add_call_2396" = call %Uint32 @_add_Uint32(%Uint32 %"$$sum_22_2394", %Uint32 %"$int34_2395"), !dbg !185
  store %Uint32 %"$add_call_2396", %Uint32* %"$sum_23", align 4, !dbg !185
...
"$have_gas_2405":                                 ; preds = %"$out_of_gas_2404", %"$have_gas_2400"
  ...
  %"$add_call_2409" = call %Uint32 @_add_Uint32(%Uint32 %"$$sum_23_2407", %Uint32 %"$int40_2408"), !dbg !186
  store %Uint32 %"$add_call_2409", %Uint32* %"$sum_24", align 4, !dbg !186
...
"$have_gas_2413":                                 ; preds = %"$out_of_gas_2412", %"$have_gas_2405"
  ...
  store %Uint32 %"$$sum_24_2415", %Uint32* %"$expr_139", align 4, !dbg !187
...
!3 = !{}
!4 = distinct !DISubprogram(name: "$fundef_170", linkageName: "$fundef_170", scope: !2, file: !2, line: 25, type: !5, scopeLine: 25, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !1, retainedNodes: !3)
!5 = !DISubroutineType(types: !6)
!6 = !{!7}
!7 = !DIBasicType(tag: DW_TAG_unspecified_type, name: "void")
!8 = !DILocation(line: 25, column: 23, scope: !4)
!9 = distinct !DISubprogram(name: "$fundef_168", linkageName: "$fundef_168", scope: !2, file: !2, line: 24, type: !5, scopeLine: 24, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !1, retainedNodes: !3)
!10 = !DILocation(line: 24, column: 22, scope: !9)
!11 = distinct !DISubprogram(name: "$fundef_166", linkageName: "$fundef_166", scope: !2, file: !2, line: 23, type: !5, scopeLine: 23, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !1, retainedNodes: !3)
!12 = !DILocation(line: 23, column: 14, scope: !11)
!13 = !DILocation(line: 24, column: 22, scope: !11)
!14 = distinct !DISubprogram(name: "$fundef_164", linkageName: "$fundef_164", scope: !2, file: !2, line: 13, type: !5, scopeLine: 13, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !1, retainedNodes: !3)
!15 = !DILocation(line: 13, column: 52, scope: !14)
!16 = distinct !DISubprogram(name: "$fundef_162", linkageName: "$fundef_162", scope: !2, file: !2, line: 13, type: !5, scopeLine: 13, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !1, retainedNodes: !3)
!17 = !DILocation(line: 13, column: 52, scope: !16)
!18 = distinct !DISubprogram(name: "$fundef_160", linkageName: "$fundef_160", scope: !2, file: !2, line: 12, type: !5, scopeLine: 12, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !1, retainedNodes: !3)
...
!23 = distinct !DISubprogram(name: "$fundef_158", linkageName: "$fundef_158", scope: !2, file: !2, line: 11, type: !5, scopeLine: 11, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !1, retainedNodes: !3)
!24 = !DILocation(line: 12, column: 3, scope: !23)
!25 = distinct !DISubprogram(name: "$fundef_156", linkageName: "$fundef_156", scope: !2, file: !2, line: 10, type: !5, scopeLine: 10, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !1, retainedNodes: !3)
!26 = !DILocation(line: 11, column: 3, scope: !25)
!27 = distinct !DISubprogram(name: "$fundef_154", linkageName: "$fundef_154", scope: !2, file: !2, line: 10, type: !5, scopeLine: 10, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !1, retainedNodes: !3)
!28 = !DILocation(line: 10, column: 3, scope: !27)
!29 = distinct !DISubprogram(name: "$fundef_152", linkageName: "$fundef_152", scope: !2, file: !2, line: 13, type: !5, scopeLine: 13, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !1, retainedNodes: !3)
!30 = !DILocation(line: 13, column: 52, scope: !29)
!31 = distinct !DISubprogram(name: "$fundef_150", linkageName: "$fundef_150", scope: !2, file: !2, line: 13, type: !5, scopeLine: 13, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !1, retainedNodes: !3)
!32 = !DILocation(line: 13, column: 52, scope: !31)
!33 = distinct !DISubprogram(name: "$fundef_148", linkageName: "$fundef_148", scope: !2, file: !2, line: 12, type: !5, scopeLine: 12, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !1, retainedNodes: !3)
...
!38 = distinct !DISubprogram(name: "$fundef_146", linkageName: "$fundef_146", scope: !2, file: !2, line: 11, type: !5, scopeLine: 11, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !1, retainedNodes: !3)
!39 = !DILocation(line: 12, column: 3, scope: !38)
!40 = distinct !DISubprogram(name: "$fundef_144", linkageName: "$fundef_144", scope: !2, file: !2, line: 10, type: !5, scopeLine: 10, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !1, retainedNodes: !3)
!41 = !DILocation(line: 11, column: 3, scope: !40)
!42 = distinct !DISubprogram(name: "$fundef_142", linkageName: "$fundef_142", scope: !2, file: !2, line: 10, type: !5, scopeLine: 10, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !1, retainedNodes: !3)
!43 = !DILocation(line: 10, column: 3, scope: !42)
!44 = distinct !DISubprogram(name: "$fundef_140", linkageName: "$fundef_140", scope: !2, file: !2, line: 3, type: !5, scopeLine: 3, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !1, retainedNodes: !3)
!45 = !DILocation(line: 3, column: 20, scope: !44)
!46 = distinct !DISubprogram(name: "$fundef_137", linkageName: "$fundef_137", scope: !47, file: !47, line: 55, type: !5, scopeLine: 55, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !1, retainedNodes: !3)
!47 = !DIFile(filename: "NatUtils.scillib", directory: "../src/stdlib")
!48 = !DILocation(line: 55, column: 7, scope: !46)
!49 = distinct !DISubprogram(name: "$fundef_135", linkageName: "$fundef_135", scope: !47, file: !47, line: 54, type: !5, scopeLine: 54, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !1, retainedNodes: !3)
!50 = !DILocation(line: 55, column: 7, scope: !49)
!51 = distinct !DISubprogram(name: "$fundef_133", linkageName: "$fundef_133", scope: !47, file: !47, line: 52, type: !5, scopeLine: 52, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !1, retainedNodes: !3)
...
!58 = distinct !DISubprogram(name: "$fundef_131", linkageName: "$fundef_131", scope: !59, file: !59, line: 1, type: !5, scopeLine: 1, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !1, retainedNodes: !3)
...
!67 = distinct !DISubprogram(name: "$fundef_129", linkageName: "$fundef_129", scope: !59, file: !59, line: 1, type: !5, scopeLine: 1, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !1, retainedNodes: !3)
!68 = !DILocation(line: 1, column: 34, scope: !67)
!69 = distinct !DISubprogram(name: "$fundef_127", linkageName: "$fundef_127", scope: !59, file: !59, line: 1, type: !5, scopeLine: 1, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !1, retainedNodes: !3)
!70 = !DILocation(line: 1, column: 18, scope: !69)
!71 = distinct !DISubprogram(name: "$fundef_125", linkageName: "$fundef_125", scope: !59, file: !59, line: 1, type: !5, scopeLine: 1, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !1, retainedNodes: !3)
!72 = !DILocation(line: 1, column: 18, scope: !71)
!73 = distinct !DISubprogram(name: "$fundef_123", linkageName: "$fundef_123", scope: !59, file: !59, line: 1, type: !5, scopeLine: 1, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !1, retainedNodes: !3)
...
!81 = distinct !DISubprogram(name: "$fundef_121", linkageName: "$fundef_121", scope: !59, file: !59, line: 1, type: !5, scopeLine: 1, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !1, retainedNodes: !3)
!82 = !DILocation(line: 1, column: 34, scope: !81)
!83 = distinct !DISubprogram(name: "$fundef_119", linkageName: "$fundef_119", scope: !59, file: !59, line: 1, type: !5, scopeLine: 1, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !1, retainedNodes: !3)
!84 = !DILocation(line: 1, column: 18, scope: !83)
!85 = distinct !DISubprogram(name: "$fundef_117", linkageName: "$fundef_117", scope: !59, file: !59, line: 1, type: !5, scopeLine: 1, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !1, retainedNodes: !3)
!86 = !DILocation(line: 1, column: 18, scope: !85)
!87 = distinct !DISubprogram(name: "$fundef_115", linkageName: "$fundef_115", scope: !59, file: !59, line: 1, type: !5, scopeLine: 1, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !1, retainedNodes: !3)
...
!95 = distinct !DISubprogram(name: "$fundef_113", linkageName: "$fundef_113", scope: !59, file: !59, line: 1, type: !5, scopeLine: 1, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !1, retainedNodes: !3)
!96 = !DILocation(line: 1, column: 34, scope: !95)
!97 = distinct !DISubprogram(name: "$fundef_111", linkageName: "$fundef_111", scope: !59, file: !59, line: 1, type: !5, scopeLine: 1, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !1, retainedNodes: !3)
!98 = !DILocation(line: 1, column: 18, scope: !97)
!99 = distinct !DISubprogram(name: "$fundef_109", linkageName: "$fundef_109", scope: !59, file: !59, line: 1, type: !5, scopeLine: 1, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !1, retainedNodes: !3)
...
!119 = !DILocation(line: 31, column: 13, scope: !106)
!120 = !DILocation(line: 32, column: 13, scope: !106)
!121 = !DILocation(line: 33, column: 13, scope: !106)
!122 = !DILocation(line: 35, column: 10, scope: !106)
!123 = !DILocation(line: 36, column: 10, scope: !106)
!124 = !DILocation(line: 37, column: 10, scope: !106)
!125 = !DILocation(line: 38, column: 10, scope: !106)
!126 = !DILocation(line: 39, column: 10, scope: !106)
!127 = !DILocation(line: 41, column: 13, scope: !106)
!128 = !DILocation(line: 42, column: 13, scope: !106)
!129 = !DILocation(line: 43, column: 13, scope: !106)
!130 = !DILocation(line: 44, column: 13, scope: !106)
!131 = !DILocation(line: 45, column: 13, scope: !106)
!132 = !DILocation(line: 46, column: 13, scope: !106)
!133 = !DILocation(line: 47, column: 13, scope: !106)
!134 = !DILocation(line: 48, column: 13, scope: !106)
!135 = !DILocation(line: 49, column: 13, scope: !106)
!136 = !DILocation(line: 50, column: 13, scope: !106)
!137 = !DILocation(line: 51, column: 13, scope: !106)
!138 = !DILocation(line: 52, column: 13, scope: !106)
!139 = !DILocation(line: 53, column: 13, scope: !106)
!140 = !DILocation(line: 54, column: 13, scope: !106)
!141 = !DILocation(line: 55, column: 13, scope: !106)
!142 = !DILocation(line: 56, column: 13, scope: !106)
!143 = !DILocation(line: 57, column: 13, scope: !106)
!144 = !DILocation(line: 58, column: 13, scope: !106)
!145 = !DILocation(line: 59, column: 13, scope: !106)
!146 = !DILocation(line: 60, column: 13, scope: !106)
!147 = !DILocation(line: 61, column: 13, scope: !106)
!148 = !DILocation(line: 63, column: 13, scope: !106)
!149 = !DILocation(line: 64, column: 13, scope: !106)
!150 = !DILocation(line: 65, column: 13, scope: !106)
!151 = !DILocation(line: 66, column: 13, scope: !106)
!152 = !DILocation(line: 67, column: 13, scope: !106)
!153 = !DILocation(line: 68, column: 13, scope: !106)
!154 = !DILocation(line: 69, column: 13, scope: !106)
!155 = !DILocation(line: 70, column: 13, scope: !106)
!156 = !DILocation(line: 71, column: 13, scope: !106)
!157 = !DILocation(line: 72, column: 13, scope: !106)
!158 = !DILocation(line: 73, column: 13, scope: !106)
!159 = !DILocation(line: 74, column: 13, scope: !106)
!160 = !DILocation(line: 75, column: 13, scope: !106)
!161 = !DILocation(line: 76, column: 13, scope: !106)
!162 = !DILocation(line: 77, column: 13, scope: !106)
!163 = !DILocation(line: 78, column: 13, scope: !106)
!164 = !DILocation(line: 79, column: 13, scope: !106)
!165 = !DILocation(line: 80, column: 13, scope: !106)
!166 = !DILocation(line: 81, column: 13, scope: !106)
!167 = !DILocation(line: 82, column: 13, scope: !106)
!168 = !DILocation(line: 84, column: 11, scope: !106)
!169 = !DILocation(line: 85, column: 11, scope: !106)
!170 = !DILocation(line: 86, column: 11, scope: !106)
!171 = !DILocation(line: 87, column: 11, scope: !106)
!172 = !DILocation(line: 88, column: 11, scope: !106)
!173 = !DILocation(line: 89, column: 11, scope: !106)
!174 = !DILocation(line: 90, column: 11, scope: !106)
!175 = !DILocation(line: 91, column: 11, scope: !106)
!176 = !DILocation(line: 92, column: 11, scope: !106)
!177 = !DILocation(line: 93, column: 11, scope: !106)
!178 = !DILocation(line: 94, column: 11, scope: !106)
!179 = !DILocation(line: 95, column: 11, scope: !106)
!180 = !DILocation(line: 96, column: 11, scope: !106)
!181 = !DILocation(line: 97, column: 11, scope: !106)
!182 = !DILocation(line: 98, column: 11, scope: !106)
!183 = !DILocation(line: 99, column: 11, scope: !106)
!184 = !DILocation(line: 100, column: 11, scope: !106)
!185 = !DILocation(line: 101, column: 11, scope: !106)
!186 = !DILocation(line: 102, column: 11, scope: !106)
!187 = !DILocation(line: 104, column: 1, scope: !106)
