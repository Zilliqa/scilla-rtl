...
"$have_gas_89":                                   ; preds = %"$out_of_gas_88", %entry
  ...
  store %Int32 %1, %Int32* %"$retval_16", align 4, !dbg !8
  %"$$retval_16_91" = load %Int32, %Int32* %"$retval_16", align 4
  ret %Int32 %"$$retval_16_91"
}

define internal { %Int32 (i8*, %Int32)*, i8* } @"$fundef_13"(%"$$fundef_13_env_53"* %0, %Uint32 %1) !dbg !9 {
entry:
...
"$have_gas_80":                                   ; preds = %"$out_of_gas_79", %entry
  ...
  store { %Int32 (i8*, %Int32)*, i8* } { %Int32 (i8*, %Int32)* bitcast (%Int32 (%"$$fundef_15_env_52"*, %Int32)* @"$fundef_15" to %Int32 (i8*, %Int32)*), i8* null }, { %Int32 (i8*, %Int32)*, i8* }* %"$retval_14", align 8, !dbg !10
  %"$$retval_14_85" = load { %Int32 (i8*, %Int32)*, i8* }, { %Int32 (i8*, %Int32)*, i8* }* %"$retval_14", align 8
  ret { %Int32 (i8*, %Int32)*, i8* } %"$$retval_14_85"
}

define internal { { %Int32 (i8*, %Int32)*, i8* } (i8*, %Uint32)*, i8* } @"$fundef_11"(%"$$fundef_11_env_54"* %0) !dbg !11 {
entry:
...
"$have_gas_71":                                   ; preds = %"$out_of_gas_70", %entry
  ...
  store { { %Int32 (i8*, %Int32)*, i8* } (i8*, %Uint32)*, i8* } { { %Int32 (i8*, %Int32)*, i8* } (i8*, %Uint32)* bitcast ({ %Int32 (i8*, %Int32)*, i8* } (%"$$fundef_13_env_53"*, %Uint32)* @"$fundef_13" to { %Int32 (i8*, %Int32)*, i8* } (i8*, %Uint32)*), i8* null }, { { %Int32 (i8*, %Int32)*, i8* } (i8*, %Uint32)*, i8* }* %"$retval_12", align 8, !dbg !12
...
define internal { i8*, i8* }* @"$fundef_9"(%"$$fundef_9_env_55"* %0) !dbg !13 {
entry:
...
"$have_gas_59":                                   ; preds = %"$out_of_gas_58", %entry
  ...
  store { i8*, i8* }* %"$dyndisp_table_64", { i8*, i8* }** %"$retval_10", align 8, !dbg !14
...
define internal %Int32 @_scilla_expr_fun(i8* %0) !dbg !18 {
entry:
...
"$have_gas_130":                                  ; preds = %"$out_of_gas_129", %"$have_gas_125"
  ...
  store { i8*, i8* }* %"$dyndisp_table_135", { i8*, i8* }** %tf, align 8, !dbg !19
...
"$have_gas_146":                                  ; preds = %"$out_of_gas_145", %"$have_gas_141"
  ...
  %"$tf_call_154" = call { i8*, i8* }* %"$tf_fptr_152"(i8* %"$tf_envptr_153"), !dbg !20
  ...
  %"$tf_call_160" = call { { %Int32 (i8*, %Int32)*, i8* } (i8*, %Uint32)*, i8* } %"$tf_fptr_158"(i8* %"$tf_envptr_159"), !dbg !20
  store { { %Int32 (i8*, %Int32)*, i8* } (i8*, %Uint32)*, i8* } %"$tf_call_160", { { %Int32 (i8*, %Int32)*, i8* } (i8*, %Uint32)*, i8* }* %t, align 8, !dbg !21
...
"$have_gas_169":                                  ; preds = %"$out_of_gas_168", %"$have_gas_164"
  ...
  store %Uint32 { i32 1 }, %Uint32* %one, align 4, !dbg !22
...
"$have_gas_179":                                  ; preds = %"$out_of_gas_178", %"$have_gas_174"
  ...
  store %Int32 { i32 2 }, %Int32* %two, align 4, !dbg !23
...
"$have_gas_184":                                  ; preds = %"$out_of_gas_183", %"$have_gas_179"
  ...
  %"$t_call_190" = call { %Int32 (i8*, %Int32)*, i8* } %"$t_fptr_187"(i8* %"$t_envptr_188", %Uint32 %"$one_189"), !dbg !24
  store { %Int32 (i8*, %Int32)*, i8* } %"$t_call_190", { %Int32 (i8*, %Int32)*, i8* }* %"$t_6", align 8, !dbg !24
  ...
  %"$$t_6_call_195" = call %Int32 %"$$t_6_fptr_192"(i8* %"$$t_6_envptr_193", %Int32 %"$two_194"), !dbg !24
  store %Int32 %"$$t_6_call_195", %Int32* %"$t_7", align 4, !dbg !24
  %"$$t_7_196" = load %Int32, %Int32* %"$t_7", align 4
  store %Int32 %"$$t_7_196", %Int32* %"$expr_8", align 4, !dbg !24
...
!3 = !{}
!4 = distinct !DISubprogram(name: "$fundef_15", linkageName: "$fundef_15", scope: !2, file: !2, line: 6, type: !5, scopeLine: 6, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !1, retainedNodes: !3)
!5 = !DISubroutineType(types: !6)
!6 = !{!7}
!7 = !DIBasicType(tag: DW_TAG_unspecified_type, name: "void")
!8 = !DILocation(line: 6, column: 5, scope: !4)
!9 = distinct !DISubprogram(name: "$fundef_13", linkageName: "$fundef_13", scope: !2, file: !2, line: 5, type: !5, scopeLine: 5, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !1, retainedNodes: !3)
...
!13 = distinct !DISubprogram(name: "$fundef_9", linkageName: "$fundef_9", scope: !2, file: !2, line: 3, type: !5, scopeLine: 3, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !1, retainedNodes: !3)
...
!18 = distinct !DISubprogram(name: "_scilla_expr_fun", linkageName: "_scilla_expr_fun", scope: !2, file: !2, line: 2, type: !5, scopeLine: 2, spFlags: DISPFlagDefinition, unit: !1, retainedNodes: !3)
!19 = !DILocation(line: 2, column: 3, scope: !18)
!20 = !DILocation(line: 9, column: 10, scope: !18)
!21 = !DILocation(line: 9, column: 9, scope: !18)
!22 = !DILocation(line: 10, column: 11, scope: !18)
!23 = !DILocation(line: 11, column: 11, scope: !18)
!24 = !DILocation(line: 12, column: 1, scope: !18)
