...
"$have_gas_39":                                   ; preds = %"$out_of_gas_38", %entry
  ...
  store %String { i8* getelementptr inbounds ([11 x i8], [11 x i8]* @"$stringlit_41", i32 0, i32 0), i32 11 }, %String* %"$expr_0", align 8, !dbg !10
...
entry:
  ...
  call void @_print_scilla_val(i8* %"$execptr_load_46", %_TyDescrTy_Typ* @"$TyDescr_String_19", i8* %"$memvoidcast_45")
  ret void
}
