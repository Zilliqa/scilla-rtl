...
@"$stringlit_79" = unnamed_addr constant [11 x i8] c"hello world"
...
"$have_gas_77":                                   ; preds = %"$out_of_gas_76", %entry
  ...
  store %String { i8* getelementptr inbounds ([11 x i8], [11 x i8]* @"$stringlit_79", i32 0, i32 0), i32 11 }, %String* %"$expr_6", align 8, !dbg !11
  %"$$expr_6_80" = load %String, %String* %"$expr_6", align 8
  ret %String %"$$expr_6_80"
}
...
entry:
  %"$exprval_81" = call %String @_scilla_expr_fun(i8* null)
  %"$pval_82" = alloca %String, align 8
  %"$memvoidcast_83" = bitcast %String* %"$pval_82" to i8*
  store %String %"$exprval_81", %String* %"$pval_82", align 8
  %"$execptr_load_84" = load i8*, i8** @_execptr, align 8
  call void @_print_scilla_val(i8* %"$execptr_load_84", %_TyDescrTy_Typ* @"$TyDescr_String_25", i8* %"$memvoidcast_83")
  ret void
}
