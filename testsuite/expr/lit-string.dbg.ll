...
@"$stringlit_77" = unnamed_addr constant [11 x i8] c"hello world"
...
"$have_gas_75":                                   ; preds = %"$out_of_gas_74", %entry
  ...
  store %String { i8* getelementptr inbounds ([11 x i8], [11 x i8]* @"$stringlit_77", i32 0, i32 0), i32 11 }, %String* %"$expr_6", align 8, !dbg !11
  %"$$expr_6_78" = load %String, %String* %"$expr_6", align 8
  ret %String %"$$expr_6_78"
}
...
entry:
  %"$exprval_79" = call %String @_scilla_expr_fun(i8* null)
  %"$pval_80" = alloca %String, align 8
  %"$memvoidcast_81" = bitcast %String* %"$pval_80" to i8*
  store %String %"$exprval_79", %String* %"$pval_80", align 8
  %"$execptr_load_82" = load i8*, i8** @_execptr, align 8
  call void @_print_scilla_val(i8* %"$execptr_load_82", %_TyDescrTy_Typ* @"$TyDescr_String_25", i8* %"$memvoidcast_81")
  ret void
}
