...
"$have_gas_98":                                   ; preds = %"$out_of_gas_97", %"$have_gas_93"
  ...
  store %Uint32 { i32 2 }, %Uint32* %"$a_6", align 4
...
"$have_gas_103":                                  ; preds = %"$out_of_gas_102", %"$have_gas_98"
  ...
  store %Uint32 %"$$a_6_105", %Uint32* %x, align 4
...
"$have_gas_109":                                  ; preds = %"$out_of_gas_108", %"$have_gas_103"
  ...
  %"$add_call_113" = call %Uint32 @_add_Uint32(%Uint32 %"$a_111", %Uint32 %"$x_112")
  store %Uint32 %"$add_call_113", %Uint32* %"$expr_7", align 4
