...
"$have_gas_98":                                   ; preds = %"$out_of_gas_97", %"$have_gas_93"
  ...
  store [64 x i8] c"q3\EF\F4\00\B8I5\91\\\08\EC\D3.0\B2\06\D9\E7\B8\8D\85z8/\D1N\10S\0F0V1IpB\8C@/x\AB\96\14\03\18\80[\DB\C9M\87\B0tL\FB\A8\86\C5\80\BF\CD\DB\98^", [64 x i8]* %sign, align 1
...
"$have_gas_115":                                  ; preds = %"$out_of_gas_114", %"$have_gas_98"
  ...
  %"$ecdsa_verify_call_123" = call %TName_Bool* @_ecdsa_verify(i8* %"$execptr_load_117", [33 x i8]* %"$ecdsa_verify_pk_118", %Bystr %"$msg_120", [64 x i8]* %"$ecdsa_verify_sign_121")
  store %TName_Bool* %"$ecdsa_verify_call_123", %TName_Bool** %"$expr_0", align 8
