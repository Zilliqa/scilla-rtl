...
"$have_gas_38":                                   ; preds = %"$out_of_gas_37", %entry
  ...
  store %Int256 { i256 -57896044618658097711785492504343953926634992332820282019728792003956564819968 }, %Int256* %"$expr_0", align 8, !dbg !9
  %"$$expr_0_40" = load %Int256, %Int256* %"$expr_0", align 8
  store %Int256 %"$$expr_0_40", %Int256* %1, align 8
  ret void
}
...
entry:
  %"$mainval_41" = alloca %Int256, align 8
  %"$memvoidcast_42" = bitcast %Int256* %"$mainval_41" to i8*
  call void @"$scilla_expr_34"(i8* null, %Int256* %"$mainval_41")
  call void @_print_scilla_val(%_TyDescrTy_Typ* @"$TyDescr_Int256_15", i8* %"$memvoidcast_42")
  ret void
}
