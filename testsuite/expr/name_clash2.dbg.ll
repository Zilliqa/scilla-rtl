...
define internal %Uint32 @"$fundef_9"(%"$$fundef_9_env_46"* %0, %Uint32 %1) !dbg !4 {
entry:
...
"$have_gas_101":                                  ; preds = %"$out_of_gas_100", %"$have_gas_96"
  ...
  store { %Uint32 (i8*, %Uint32)*, i8* } { %Uint32 (i8*, %Uint32)* bitcast (%Uint32 (%"$$fundef_9_env_46"*, %Uint32)* @"$fundef_9" to %Uint32 (i8*, %Uint32)*), i8* null }, { %Uint32 (i8*, %Uint32)*, i8* }* %f, align 8, !dbg !14
...
"$have_gas_114":                                  ; preds = %"$out_of_gas_113", %"$have_gas_109"
  ...
  %"$f_call_120" = call %Uint32 %"$f_fptr_117"(i8* %"$f_envptr_118", %Uint32 %"$a_119"), !dbg !15
  store %Uint32 %"$f_call_120", %Uint32* %"$f_7", align 4, !dbg !15
  %"$$f_7_121" = load %Uint32, %Uint32* %"$f_7", align 4
  store %Uint32 %"$$f_7_121", %Uint32* %b, align 4, !dbg !15
...
"$have_gas_125":                                  ; preds = %"$out_of_gas_124", %"$have_gas_114"
  ...
  %"$add_call_129" = call %Uint32 @_add_Uint32(%Uint32 %"$a_127", %Uint32 %"$b_128"), !dbg !16
  store %Uint32 %"$add_call_129", %Uint32* %"$expr_8", align 4, !dbg !16
