...
define internal %Uint32 @"$fundef_22"(%"$$fundef_22_env_59"* %0, { i8*, i8* }* %1) {
entry:
...
"$have_gas_167":                                  ; preds = %"$out_of_gas_166", %"$have_gas_162"
  ...
  %"$c_call_174" = call { %Uint32 (i8*, %Uint32)*, i8* } %"$c_fptr_172"(i8* %"$c_envptr_173")
  store { %Uint32 (i8*, %Uint32)*, i8* } %"$c_call_174", { %Uint32 (i8*, %Uint32)*, i8* }* %c32, align 8
...
"$have_gas_178":                                  ; preds = %"$out_of_gas_177", %"$have_gas_167"
  ...
  %"$c32_call_184" = call %Uint32 %"$c32_fptr_181"(i8* %"$c32_envptr_182", %Uint32 %"$zero_183")
  store %Uint32 %"$c32_call_184", %Uint32* %"$c32_7", align 4
  %"$$c32_7_185" = load %Uint32, %Uint32* %"$c32_7", align 4
  store %Uint32 %"$$c32_7_185", %Uint32* %"$retval_23", align 4
  %"$$retval_23_186" = load %Uint32, %Uint32* %"$retval_23", align 4
  ret %Uint32 %"$$retval_23_186"
}

define internal %Uint32 @"$fundef_20"(%"$$fundef_20_env_60"* %0, %Uint32 %1) {
entry:
...
"$have_gas_118":                                  ; preds = %"$out_of_gas_117", %"$have_gas_113"
  ...
  %"$n_call_126" = call { %Uint32 (i8*, %Uint32)*, i8* } %"$n_fptr_124"(i8* %"$n_envptr_125")
  store { %Uint32 (i8*, %Uint32)*, i8* } %"$n_call_126", { %Uint32 (i8*, %Uint32)*, i8* }* %nX, align 8
...
"$have_gas_135":                                  ; preds = %"$out_of_gas_134", %"$have_gas_130"
  ...
  %"$nX_call_140" = call %Uint32 %"$nX_fptr_138"(i8* %"$nX_envptr_139", %Uint32 %1)
  store %Uint32 %"$nX_call_140", %Uint32* %"$nX_6", align 4
  %"$$nX_6_141" = load %Uint32, %Uint32* %"$nX_6", align 4
  store %Uint32 %"$$nX_6_141", %Uint32* %nXz, align 4
...
"$have_gas_145":                                  ; preds = %"$out_of_gas_144", %"$have_gas_135"
  ...
  store %Uint32 %"$nXz_147", %Uint32* %"$retval_21", align 4
  %"$$retval_21_148" = load %Uint32, %Uint32* %"$retval_21", align 4
  ret %Uint32 %"$$retval_21_148"
}

define internal { %Uint32 (i8*, %Uint32)*, i8* } @"$fundef_18"(%"$$fundef_18_env_61"* %0) {
entry:
...
"$have_gas_99":                                   ; preds = %"$out_of_gas_98", %entry
  ...
  store { %Uint32 (i8*, %Uint32)*, i8* } %"$$fundef_20_cloval_104", { %Uint32 (i8*, %Uint32)*, i8* }* %"$retval_19", align 8
  %"$$retval_19_107" = load { %Uint32 (i8*, %Uint32)*, i8* }, { %Uint32 (i8*, %Uint32)*, i8* }* %"$retval_19", align 8
  ret { %Uint32 (i8*, %Uint32)*, i8* } %"$$retval_19_107"
}

define internal { i8*, i8* }* @"$fundef_16"(%"$$fundef_16_env_62"* %0, { i8*, i8* }* %1) {
entry:
...
"$have_gas_83":                                   ; preds = %"$out_of_gas_82", %entry
  ...
  store { i8*, i8* }* %"$dyndisp_table_90", { i8*, i8* }** %"$retval_17", align 8
  %"$$retval_17_93" = load { i8*, i8* }*, { i8*, i8* }** %"$retval_17", align 8
  ret { i8*, i8* }* %"$$retval_17_93"
}

define internal %Uint32 @"$fundef_14"(%"$$fundef_14_env_63"* %0, %Uint32 %1) {
entry:
...
define internal { %Uint32 (i8*, %Uint32)*, i8* } @"$fundef_12"(%"$$fundef_12_env_64"* %0) {
entry:
...
"$have_gas_68":                                   ; preds = %"$out_of_gas_67", %entry
  ...
  store { %Uint32 (i8*, %Uint32)*, i8* } { %Uint32 (i8*, %Uint32)* bitcast (%Uint32 (%"$$fundef_14_env_63"*, %Uint32)* @"$fundef_14" to %Uint32 (i8*, %Uint32)*), i8* null }, { %Uint32 (i8*, %Uint32)*, i8* }* %"$retval_13", align 8
...
"$have_gas_225":                                  ; preds = %"$out_of_gas_224", %"$have_gas_220"
  ...
  store { i8*, i8* }* %"$dyndisp_table_230", { i8*, i8* }** %c1, align 8
...
"$have_gas_241":                                  ; preds = %"$out_of_gas_240", %"$have_gas_236"
  ...
  store { { i8*, i8* }* (i8*, { i8*, i8* }*)*, i8* } { { i8*, i8* }* (i8*, { i8*, i8* }*)* bitcast ({ i8*, i8* }* (%"$$fundef_16_env_62"*, { i8*, i8* }*)* @"$fundef_16" to { i8*, i8* }* (i8*, { i8*, i8* }*)*), i8* null }, { { i8*, i8* }* (i8*, { i8*, i8* }*)*, i8* }* %app_arg, align 8
...
"$have_gas_254":                                  ; preds = %"$out_of_gas_253", %"$have_gas_249"
  ...
  store { %Uint32 (i8*, { i8*, i8* }*)*, i8* } { %Uint32 (i8*, { i8*, i8* }*)* bitcast (%Uint32 (%"$$fundef_22_env_59"*, { i8*, i8* }*)* @"$fundef_22" to %Uint32 (i8*, { i8*, i8* }*)*), i8* null }, { %Uint32 (i8*, { i8*, i8* }*)*, i8* }* %start, align 8
...
"$have_gas_267":                                  ; preds = %"$out_of_gas_266", %"$have_gas_262"
  ...
  %"$app_arg_call_273" = call { i8*, i8* }* %"$app_arg_fptr_270"(i8* %"$app_arg_envptr_271", { i8*, i8* }* %"$c1_272")
  store { i8*, i8* }* %"$app_arg_call_273", { i8*, i8* }** %"$app_arg_8", align 8
  %"$$app_arg_8_274" = load { i8*, i8* }*, { i8*, i8* }** %"$app_arg_8", align 8
  store { i8*, i8* }* %"$$app_arg_8_274", { i8*, i8* }** %c2, align 8
...
"$have_gas_283":                                  ; preds = %"$out_of_gas_282", %"$have_gas_278"
  ...
  %"$app_arg_call_289" = call { i8*, i8* }* %"$app_arg_fptr_286"(i8* %"$app_arg_envptr_287", { i8*, i8* }* %"$c2_288")
  store { i8*, i8* }* %"$app_arg_call_289", { i8*, i8* }** %"$app_arg_9", align 8
  %"$$app_arg_9_290" = load { i8*, i8* }*, { i8*, i8* }** %"$app_arg_9", align 8
  store { i8*, i8* }* %"$$app_arg_9_290", { i8*, i8* }** %c3, align 8
...
"$have_gas_294":                                  ; preds = %"$out_of_gas_293", %"$have_gas_283"
  ...
  %"$start_call_300" = call %Uint32 %"$start_fptr_297"(i8* %"$start_envptr_298", { i8*, i8* }* %"$c3_299")
  store %Uint32 %"$start_call_300", %Uint32* %"$start_10", align 4
  %"$$start_10_301" = load %Uint32, %Uint32* %"$start_10", align 4
  store %Uint32 %"$$start_10_301", %Uint32* %"$expr_11", align 4
