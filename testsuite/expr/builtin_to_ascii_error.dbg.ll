...
"$have_gas_91":                                   ; preds = %"$out_of_gas_90", %"$have_gas_82"
  ...
  %"$to_ascii_call_97" = call %String @_to_ascii(i8* %"$execptr_load_93", i8* %"$$to_ascii_hello_0_94_96", i32 6), !dbg !12
  store %String %"$to_ascii_call_97", %String* %"$expr_6", align 8, !dbg !12
