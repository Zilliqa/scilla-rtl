...
"$have_gas_90":                                   ; preds = %"$out_of_gas_89", %"$have_gas_85"
  ...
  store %Uint32 { i32 2 }, %Uint32* %two, align 4, !dbg !12
...
"$have_gas_95":                                   ; preds = %"$out_of_gas_94", %"$have_gas_90"
  ...
  %"$one_97" = load %Uint32, %Uint32* %one, align 4
  %"$two_98" = load %Uint32, %Uint32* %two, align 4
  %"$add_call_99" = call %Uint32 @_add_Uint32(%Uint32 %"$one_97", %Uint32 %"$two_98"), !dbg !13
  store %Uint32 %"$add_call_99", %Uint32* %"$expr_6", align 4, !dbg !13
  %"$$expr_6_100" = load %Uint32, %Uint32* %"$expr_6", align 4
  ret %Uint32 %"$$expr_6_100"
}
...
entry:
  %"$exprval_101" = call %Uint32 @_scilla_expr_fun(i8* null)
  %"$pval_102" = alloca %Uint32, align 8
  %"$memvoidcast_103" = bitcast %Uint32* %"$pval_102" to i8*
  store %Uint32 %"$exprval_101", %Uint32* %"$pval_102", align 4
  %"$execptr_load_104" = load i8*, i8** @_execptr, align 8
  call void @_print_scilla_val(i8* %"$execptr_load_104", %_TyDescrTy_Typ* @"$TyDescr_Uint32_11", i8* %"$memvoidcast_103")
  ret void
}
...
!2 = !DIFile(filename: "builtin_add_uint32.scilexp", directory: "codegen/expr")
!3 = !{}
