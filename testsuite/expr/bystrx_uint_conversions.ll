...
"$have_gas_324":                                  ; preds = %"$out_of_gas_323", %"$have_gas_316"
  ...
  store %Uint256 %"$to_uint256_332", %Uint256* %res19, align 8
...
"$have_gas_336":                                  ; preds = %"$out_of_gas_335", %"$have_gas_324"
  ...
  store %Uint256 %"$to_uint256_344", %Uint256* %res20, align 8
...
"$have_gas_348":                                  ; preds = %"$out_of_gas_347", %"$have_gas_336"
  ...
  store %Uint256 %"$to_uint256_356", %Uint256* %res21, align 8
...
"$have_gas_360":                                  ; preds = %"$out_of_gas_359", %"$have_gas_348"
  ...
  store %Uint256 %"$to_uint256_368", %Uint256* %res22, align 8
...
"$have_gas_372":                                  ; preds = %"$out_of_gas_371", %"$have_gas_360"
  ...
  store %Uint256 %"$add_381", %Uint256* %"$sum1_3", align 8
...
"$have_gas_385":                                  ; preds = %"$out_of_gas_384", %"$have_gas_372"
  ...
  store %Uint256 %"$add_394", %Uint256* %"$sum2_4", align 8
...
"$have_gas_398":                                  ; preds = %"$out_of_gas_397", %"$have_gas_385"
  ...
  store %Uint256 %"$add_407", %Uint256* %sum_256, align 8
...
"$have_gas_416":                                  ; preds = %"$out_of_gas_415", %"$have_gas_411"
  ...
  store %TName_Pair_Uint32_Uint64* %"$adtptr_424", %TName_Pair_Uint32_Uint64** %respair1, align 8
...
"$have_gas_433":                                  ; preds = %"$out_of_gas_432", %"$have_gas_428"
  ...
  store %TName_Pair_Uint128_Uint256* %"$adtptr_441", %TName_Pair_Uint128_Uint256** %respair2, align 8
...
"$have_gas_450":                                  ; preds = %"$out_of_gas_449", %"$have_gas_445"
  ...
  store %"TName_Pair_Pair_(Uint32)_(Uint64)_Pair_(Uint128)_(Uint256)"* %"$adtptr_458", %"TName_Pair_Pair_(Uint32)_(Uint64)_Pair_(Uint128)_(Uint256)"** %restuple, align 8
...
"$have_gas_462":                                  ; preds = %"$out_of_gas_461", %"$have_gas_450"
  ...
  store %"TName_Pair_Pair_(Uint32)_(Uint64)_Pair_(Uint128)_(Uint256)"* %"$restuple_464", %"TName_Pair_Pair_(Uint32)_(Uint64)_Pair_(Uint128)_(Uint256)"** %"$expr_5", align 8
