...
"$have_gas_155":                                  ; preds = %"$out_of_gas_154", %"$have_gas_150"
  ...
  %"$to_uint32_call_161" = call %Uint32 @_bystrx_to_uint32(i8* %"$execptr_load_157", i32 1, i8* %"$$to_uint32_zero_158_160")
  store %Uint32 %"$to_uint32_call_161", %Uint32* %res7, align 4
...
"$have_gas_170":                                  ; preds = %"$out_of_gas_169", %"$have_gas_165"
  ...
  %"$to_uint32_call_176" = call %Uint32 @_bystrx_to_uint32(i8* %"$execptr_load_172", i32 1, i8* %"$$to_uint32_one_1_173_175")
  store %Uint32 %"$to_uint32_call_176", %Uint32* %res8, align 4
...
"$have_gas_185":                                  ; preds = %"$out_of_gas_184", %"$have_gas_180"
  ...
  %"$to_uint32_call_191" = call %Uint32 @_bystrx_to_uint32(i8* %"$execptr_load_187", i32 3, i8* %"$$to_uint32_one_3_188_190")
  store %Uint32 %"$to_uint32_call_191", %Uint32* %res9, align 4
...
"$have_gas_200":                                  ; preds = %"$out_of_gas_199", %"$have_gas_195"
  ...
  %"$to_uint32_call_206" = call %Uint32 @_bystrx_to_uint32(i8* %"$execptr_load_202", i32 4, i8* %"$$to_uint32_one_4_203_205")
  store %Uint32 %"$to_uint32_call_206", %Uint32* %res10, align 4
...
"$have_gas_215":                                  ; preds = %"$out_of_gas_214", %"$have_gas_210"
  ...
  %"$add_call_219" = call %Uint32 @_add_Uint32(%Uint32 %"$res7_217", %Uint32 %"$res8_218")
  store %Uint32 %"$add_call_219", %Uint32* %sum1, align 4
...
"$have_gas_228":                                  ; preds = %"$out_of_gas_227", %"$have_gas_223"
  ...
  %"$add_call_232" = call %Uint32 @_add_Uint32(%Uint32 %"$res9_230", %Uint32 %"$res10_231")
  store %Uint32 %"$add_call_232", %Uint32* %sum2, align 4
...
"$have_gas_241":                                  ; preds = %"$out_of_gas_240", %"$have_gas_236"
  ...
  %"$add_call_245" = call %Uint32 @_add_Uint32(%Uint32 %"$sum1_243", %Uint32 %"$sum2_244")
  store %Uint32 %"$add_call_245", %Uint32* %sum_32, align 4
...
"$have_gas_254":                                  ; preds = %"$out_of_gas_253", %"$have_gas_249"
  ...
  %"$to_uint64_call_260" = call %Uint64 @_bystrx_to_uint64(i8* %"$execptr_load_256", i32 1, i8* %"$$to_uint64_one_1_257_259")
  store %Uint64 %"$to_uint64_call_260", %Uint64* %res12, align 8
...
"$have_gas_269":                                  ; preds = %"$out_of_gas_268", %"$have_gas_264"
  ...
  %"$to_uint64_call_275" = call %Uint64 @_bystrx_to_uint64(i8* %"$execptr_load_271", i32 4, i8* %"$$to_uint64_one_4_272_274")
  store %Uint64 %"$to_uint64_call_275", %Uint64* %res13, align 8
...
"$have_gas_284":                                  ; preds = %"$out_of_gas_283", %"$have_gas_279"
  ...
  %"$to_uint64_call_290" = call %Uint64 @_bystrx_to_uint64(i8* %"$execptr_load_286", i32 8, i8* %"$$to_uint64_one_8_287_289")
  store %Uint64 %"$to_uint64_call_290", %Uint64* %res14, align 8
...
"$have_gas_299":                                  ; preds = %"$out_of_gas_298", %"$have_gas_294"
  ...
  %"$add_call_303" = call %Uint64 @_add_Uint64(%Uint64 %"$res12_301", %Uint64 %"$res13_302")
  store %Uint64 %"$add_call_303", %Uint64* %"$sum1_0", align 8
...
"$have_gas_312":                                  ; preds = %"$out_of_gas_311", %"$have_gas_307"
  ...
  %"$add_call_316" = call %Uint64 @_add_Uint64(%Uint64 %"$$sum1_0_314", %Uint64 %"$res14_315")
  store %Uint64 %"$add_call_316", %Uint64* %sum_64, align 8
...
"$have_gas_325":                                  ; preds = %"$out_of_gas_324", %"$have_gas_320"
  ...
  %"$to_uint128_call_331" = call %Uint128 @_bystrx_to_uint128(i8* %"$execptr_load_327", i32 1, i8* %"$$to_uint128_one_1_328_330")
  store %Uint128 %"$to_uint128_call_331", %Uint128* %res15, align 8
...
"$have_gas_340":                                  ; preds = %"$out_of_gas_339", %"$have_gas_335"
  ...
  %"$to_uint128_call_346" = call %Uint128 @_bystrx_to_uint128(i8* %"$execptr_load_342", i32 4, i8* %"$$to_uint128_one_4_343_345")
  store %Uint128 %"$to_uint128_call_346", %Uint128* %res16, align 8
...
"$have_gas_355":                                  ; preds = %"$out_of_gas_354", %"$have_gas_350"
  ...
  %"$to_uint128_call_361" = call %Uint128 @_bystrx_to_uint128(i8* %"$execptr_load_357", i32 8, i8* %"$$to_uint128_one_8_358_360")
  store %Uint128 %"$to_uint128_call_361", %Uint128* %res17, align 8
...
"$have_gas_370":                                  ; preds = %"$out_of_gas_369", %"$have_gas_365"
  ...
  %"$to_uint128_call_376" = call %Uint128 @_bystrx_to_uint128(i8* %"$execptr_load_372", i32 16, i8* %"$$to_uint128_one_16_373_375")
  store %Uint128 %"$to_uint128_call_376", %Uint128* %res18, align 8
...
"$have_gas_386":                                  ; preds = %"$out_of_gas_385", %"$have_gas_380"
  ...
  %"$add_call_390" = call %Uint128 @_add_Uint128(%Uint128 %"$res15_388", %Uint128 %"$res16_389")
  store %Uint128 %"$add_call_390", %Uint128* %"$sum1_1", align 8
...
"$have_gas_400":                                  ; preds = %"$out_of_gas_399", %"$have_gas_394"
  ...
  %"$add_call_404" = call %Uint128 @_add_Uint128(%Uint128 %"$res17_402", %Uint128 %"$res18_403")
  store %Uint128 %"$add_call_404", %Uint128* %"$sum2_2", align 8
...
"$have_gas_414":                                  ; preds = %"$out_of_gas_413", %"$have_gas_408"
  ...
  %"$add_call_418" = call %Uint128 @_add_Uint128(%Uint128 %"$$sum1_1_416", %Uint128 %"$$sum2_2_417")
  store %Uint128 %"$add_call_418", %Uint128* %sum_128, align 8
...
"$have_gas_427":                                  ; preds = %"$out_of_gas_426", %"$have_gas_422"
  ...
  %"$to_uint256_call_433" = call %Uint256* @_bystrx_to_uint256(i8* %"$execptr_load_429", i32 1, i8* %"$$to_uint256_one_1_430_432")
  %"$to_uint256_435" = load %Uint256, %Uint256* %"$to_uint256_call_433", align 8
  store %Uint256 %"$to_uint256_435", %Uint256* %res19, align 8
...
"$have_gas_444":                                  ; preds = %"$out_of_gas_443", %"$have_gas_439"
  ...
  %"$to_uint256_call_450" = call %Uint256* @_bystrx_to_uint256(i8* %"$execptr_load_446", i32 8, i8* %"$$to_uint256_one_8_447_449")
  %"$to_uint256_452" = load %Uint256, %Uint256* %"$to_uint256_call_450", align 8
  store %Uint256 %"$to_uint256_452", %Uint256* %res20, align 8
...
"$have_gas_461":                                  ; preds = %"$out_of_gas_460", %"$have_gas_456"
  ...
  %"$to_uint256_call_467" = call %Uint256* @_bystrx_to_uint256(i8* %"$execptr_load_463", i32 16, i8* %"$$to_uint256_one_16_464_466")
  %"$to_uint256_469" = load %Uint256, %Uint256* %"$to_uint256_call_467", align 8
  store %Uint256 %"$to_uint256_469", %Uint256* %res21, align 8
...
"$have_gas_478":                                  ; preds = %"$out_of_gas_477", %"$have_gas_473"
  ...
  %"$to_uint256_call_484" = call %Uint256* @_bystrx_to_uint256(i8* %"$execptr_load_480", i32 32, i8* %"$$to_uint256_one_32_481_483")
  %"$to_uint256_486" = load %Uint256, %Uint256* %"$to_uint256_call_484", align 8
  store %Uint256 %"$to_uint256_486", %Uint256* %res22, align 8
...
"$have_gas_496":                                  ; preds = %"$out_of_gas_495", %"$have_gas_490"
  ...
  %"$add_call_503" = call %Uint256* @_add_Uint256(i8* %"$execptr_load_498", %Uint256* %"$add_res19_499", %Uint256* %"$add_res20_501")
  %"$add_505" = load %Uint256, %Uint256* %"$add_call_503", align 8
  store %Uint256 %"$add_505", %Uint256* %"$sum1_3", align 8
...
"$have_gas_515":                                  ; preds = %"$out_of_gas_514", %"$have_gas_509"
  ...
  %"$add_call_522" = call %Uint256* @_add_Uint256(i8* %"$execptr_load_517", %Uint256* %"$add_res21_518", %Uint256* %"$add_res22_520")
  %"$add_524" = load %Uint256, %Uint256* %"$add_call_522", align 8
  store %Uint256 %"$add_524", %Uint256* %"$sum2_4", align 8
...
"$have_gas_534":                                  ; preds = %"$out_of_gas_533", %"$have_gas_528"
  ...
  %"$add_call_541" = call %Uint256* @_add_Uint256(i8* %"$execptr_load_536", %Uint256* %"$add_$sum1_3_537", %Uint256* %"$add_$sum2_4_539")
  %"$add_543" = load %Uint256, %Uint256* %"$add_call_541", align 8
  store %Uint256 %"$add_543", %Uint256* %sum_256, align 8
...
"$have_gas_552":                                  ; preds = %"$out_of_gas_551", %"$have_gas_547"
  ...
  store %TName_Pair_Uint32_Uint64* %"$adtptr_560", %TName_Pair_Uint32_Uint64** %respair1, align 8
...
"$have_gas_569":                                  ; preds = %"$out_of_gas_568", %"$have_gas_564"
  ...
  store %TName_Pair_Uint128_Uint256* %"$adtptr_577", %TName_Pair_Uint128_Uint256** %respair2, align 8
...
"$have_gas_586":                                  ; preds = %"$out_of_gas_585", %"$have_gas_581"
  ...
  store %"TName_Pair_Pair_(Uint32)_(Uint64)_Pair_(Uint128)_(Uint256)"* %"$adtptr_594", %"TName_Pair_Pair_(Uint32)_(Uint64)_Pair_(Uint128)_(Uint256)"** %restuple, align 8
...
"$have_gas_598":                                  ; preds = %"$out_of_gas_597", %"$have_gas_586"
  ...
  store %"TName_Pair_Pair_(Uint32)_(Uint64)_Pair_(Uint128)_(Uint256)"* %"$restuple_600", %"TName_Pair_Pair_(Uint32)_(Uint64)_Pair_(Uint128)_(Uint256)"** %"$expr_5", align 8
