...
define internal %"TName_Pair_Pair_(Uint32)_(Uint64)_Pair_(Uint128)_(Uint256)"* @"$scilla_expr_75"(i8* %0) !dbg !8 {
entry:
...
"$have_gas_84":                                   ; preds = %"$out_of_gas_83", %"$have_gas_79"
  ...
  store [1 x i8] zeroinitializer, [1 x i8]* %zero, align 1, !dbg !9
...
"$have_gas_94":                                   ; preds = %"$out_of_gas_93", %"$have_gas_89"
  ...
  store [1 x i8] c"\01", [1 x i8]* %one_1, align 1, !dbg !10
...
"$have_gas_104":                                  ; preds = %"$out_of_gas_103", %"$have_gas_99"
  ...
  store [3 x i8] c"\00\00\01", [3 x i8]* %one_3, align 1, !dbg !11
...
"$have_gas_114":                                  ; preds = %"$out_of_gas_113", %"$have_gas_109"
  ...
  store [4 x i8] c"\00\00\00\01", [4 x i8]* %one_4, align 1, !dbg !12
...
"$have_gas_124":                                  ; preds = %"$out_of_gas_123", %"$have_gas_119"
  ...
  store [8 x i8] c"\00\00\00\00\00\00\00\01", [8 x i8]* %one_8, align 1, !dbg !13
...
"$have_gas_134":                                  ; preds = %"$out_of_gas_133", %"$have_gas_129"
  ...
  store [16 x i8] c"\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\01", [16 x i8]* %one_16, align 1, !dbg !14
...
"$have_gas_144":                                  ; preds = %"$out_of_gas_143", %"$have_gas_139"
  ...
  store [32 x i8] c"\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\01", [32 x i8]* %one_32, align 1, !dbg !15
...
"$have_gas_149":                                  ; preds = %"$out_of_gas_148", %"$have_gas_144"
  ...
  %"$to_uint32_zero_152" = alloca [1 x i8], align 1
  %"$zero_153" = load [1 x i8], [1 x i8]* %zero, align 1
  store [1 x i8] %"$zero_153", [1 x i8]* %"$to_uint32_zero_152", align 1
  ...
  store %Uint32 %"$to_uint32_call_155", %Uint32* %res7, align 4, !dbg !16
...
"$have_gas_159":                                  ; preds = %"$out_of_gas_158", %"$have_gas_149"
  ...
  %"$to_uint32_one_1_162" = alloca [1 x i8], align 1
  %"$one_1_163" = load [1 x i8], [1 x i8]* %one_1, align 1
  store [1 x i8] %"$one_1_163", [1 x i8]* %"$to_uint32_one_1_162", align 1
  ...
  store %Uint32 %"$to_uint32_call_165", %Uint32* %res8, align 4, !dbg !17
...
"$have_gas_169":                                  ; preds = %"$out_of_gas_168", %"$have_gas_159"
  ...
  %"$to_uint32_one_3_172" = alloca [3 x i8], align 1
  %"$one_3_173" = load [3 x i8], [3 x i8]* %one_3, align 1
  store [3 x i8] %"$one_3_173", [3 x i8]* %"$to_uint32_one_3_172", align 1
  ...
  store %Uint32 %"$to_uint32_call_175", %Uint32* %res9, align 4, !dbg !18
...
"$have_gas_179":                                  ; preds = %"$out_of_gas_178", %"$have_gas_169"
  ...
  %"$to_uint32_one_4_182" = alloca [4 x i8], align 1
  %"$one_4_183" = load [4 x i8], [4 x i8]* %one_4, align 1
  store [4 x i8] %"$one_4_183", [4 x i8]* %"$to_uint32_one_4_182", align 1
  ...
  store %Uint32 %"$to_uint32_call_185", %Uint32* %res10, align 4, !dbg !19
...
"$have_gas_189":                                  ; preds = %"$out_of_gas_188", %"$have_gas_179"
  ...
  %"$res7_191" = load %Uint32, %Uint32* %res7, align 4
  %"$res8_192" = load %Uint32, %Uint32* %res8, align 4
  %"$add_call_193" = call %Uint32 @_add_Uint32(%Uint32 %"$res7_191", %Uint32 %"$res8_192")
  store %Uint32 %"$add_call_193", %Uint32* %sum1, align 4, !dbg !20
...
"$have_gas_197":                                  ; preds = %"$out_of_gas_196", %"$have_gas_189"
  ...
  %"$res9_199" = load %Uint32, %Uint32* %res9, align 4
  %"$res10_200" = load %Uint32, %Uint32* %res10, align 4
  %"$add_call_201" = call %Uint32 @_add_Uint32(%Uint32 %"$res9_199", %Uint32 %"$res10_200")
  store %Uint32 %"$add_call_201", %Uint32* %sum2, align 4, !dbg !21
...
"$have_gas_205":                                  ; preds = %"$out_of_gas_204", %"$have_gas_197"
  ...
  %"$sum1_207" = load %Uint32, %Uint32* %sum1, align 4
  %"$sum2_208" = load %Uint32, %Uint32* %sum2, align 4
  %"$add_call_209" = call %Uint32 @_add_Uint32(%Uint32 %"$sum1_207", %Uint32 %"$sum2_208")
  store %Uint32 %"$add_call_209", %Uint32* %sum_32, align 4, !dbg !22
...
"$have_gas_213":                                  ; preds = %"$out_of_gas_212", %"$have_gas_205"
  ...
  %"$to_uint64_one_1_216" = alloca [1 x i8], align 1
  %"$one_1_217" = load [1 x i8], [1 x i8]* %one_1, align 1
  store [1 x i8] %"$one_1_217", [1 x i8]* %"$to_uint64_one_1_216", align 1
  ...
  store %Uint64 %"$to_uint64_call_219", %Uint64* %res12, align 8, !dbg !23
...
"$have_gas_223":                                  ; preds = %"$out_of_gas_222", %"$have_gas_213"
  ...
  %"$to_uint64_one_4_226" = alloca [4 x i8], align 1
  %"$one_4_227" = load [4 x i8], [4 x i8]* %one_4, align 1
  store [4 x i8] %"$one_4_227", [4 x i8]* %"$to_uint64_one_4_226", align 1
  ...
  store %Uint64 %"$to_uint64_call_229", %Uint64* %res13, align 8, !dbg !24
...
"$have_gas_233":                                  ; preds = %"$out_of_gas_232", %"$have_gas_223"
  ...
  %"$to_uint64_one_8_236" = alloca [8 x i8], align 1
  %"$one_8_237" = load [8 x i8], [8 x i8]* %one_8, align 1
  store [8 x i8] %"$one_8_237", [8 x i8]* %"$to_uint64_one_8_236", align 1
  ...
  store %Uint64 %"$to_uint64_call_239", %Uint64* %res14, align 8, !dbg !25
...
"$have_gas_243":                                  ; preds = %"$out_of_gas_242", %"$have_gas_233"
  ...
  %"$res12_245" = load %Uint64, %Uint64* %res12, align 8
  %"$res13_246" = load %Uint64, %Uint64* %res13, align 8
  %"$add_call_247" = call %Uint64 @_add_Uint64(%Uint64 %"$res12_245", %Uint64 %"$res13_246")
  store %Uint64 %"$add_call_247", %Uint64* %"$sum1_0", align 8, !dbg !26
...
"$have_gas_251":                                  ; preds = %"$out_of_gas_250", %"$have_gas_243"
  ...
  %"$$sum1_0_253" = load %Uint64, %Uint64* %"$sum1_0", align 8
  %"$res14_254" = load %Uint64, %Uint64* %res14, align 8
  %"$add_call_255" = call %Uint64 @_add_Uint64(%Uint64 %"$$sum1_0_253", %Uint64 %"$res14_254")
  store %Uint64 %"$add_call_255", %Uint64* %sum_64, align 8, !dbg !27
...
"$have_gas_259":                                  ; preds = %"$out_of_gas_258", %"$have_gas_251"
  ...
  %"$to_uint128_one_1_262" = alloca [1 x i8], align 1
  %"$one_1_263" = load [1 x i8], [1 x i8]* %one_1, align 1
  store [1 x i8] %"$one_1_263", [1 x i8]* %"$to_uint128_one_1_262", align 1
  ...
  store %Uint128 %"$to_uint128_call_265", %Uint128* %res15, align 8, !dbg !28
...
"$have_gas_269":                                  ; preds = %"$out_of_gas_268", %"$have_gas_259"
  ...
  %"$to_uint128_one_4_272" = alloca [4 x i8], align 1
  %"$one_4_273" = load [4 x i8], [4 x i8]* %one_4, align 1
  store [4 x i8] %"$one_4_273", [4 x i8]* %"$to_uint128_one_4_272", align 1
  ...
  store %Uint128 %"$to_uint128_call_275", %Uint128* %res16, align 8, !dbg !29
...
"$have_gas_279":                                  ; preds = %"$out_of_gas_278", %"$have_gas_269"
  ...
  %"$to_uint128_one_8_282" = alloca [8 x i8], align 1
  %"$one_8_283" = load [8 x i8], [8 x i8]* %one_8, align 1
  store [8 x i8] %"$one_8_283", [8 x i8]* %"$to_uint128_one_8_282", align 1
  ...
  store %Uint128 %"$to_uint128_call_285", %Uint128* %res17, align 8, !dbg !30
...
"$have_gas_289":                                  ; preds = %"$out_of_gas_288", %"$have_gas_279"
  ...
  %"$to_uint128_one_16_292" = alloca [16 x i8], align 1
  %"$one_16_293" = load [16 x i8], [16 x i8]* %one_16, align 1
  store [16 x i8] %"$one_16_293", [16 x i8]* %"$to_uint128_one_16_292", align 1
  ...
  store %Uint128 %"$to_uint128_call_295", %Uint128* %res18, align 8, !dbg !31
...
"$have_gas_299":                                  ; preds = %"$out_of_gas_298", %"$have_gas_289"
  ...
  %"$res15_301" = load %Uint128, %Uint128* %res15, align 8
  %"$res16_302" = load %Uint128, %Uint128* %res16, align 8
  %"$add_call_303" = call %Uint128 @_add_Uint128(%Uint128 %"$res15_301", %Uint128 %"$res16_302")
  store %Uint128 %"$add_call_303", %Uint128* %"$sum1_1", align 8, !dbg !32
...
"$have_gas_307":                                  ; preds = %"$out_of_gas_306", %"$have_gas_299"
  ...
  %"$res17_309" = load %Uint128, %Uint128* %res17, align 8
  %"$res18_310" = load %Uint128, %Uint128* %res18, align 8
  %"$add_call_311" = call %Uint128 @_add_Uint128(%Uint128 %"$res17_309", %Uint128 %"$res18_310")
  store %Uint128 %"$add_call_311", %Uint128* %"$sum2_2", align 8, !dbg !33
...
"$have_gas_315":                                  ; preds = %"$out_of_gas_314", %"$have_gas_307"
  ...
  %"$$sum1_1_317" = load %Uint128, %Uint128* %"$sum1_1", align 8
  %"$$sum2_2_318" = load %Uint128, %Uint128* %"$sum2_2", align 8
  %"$add_call_319" = call %Uint128 @_add_Uint128(%Uint128 %"$$sum1_1_317", %Uint128 %"$$sum2_2_318")
  store %Uint128 %"$add_call_319", %Uint128* %sum_128, align 8, !dbg !34
...
"$have_gas_323":                                  ; preds = %"$out_of_gas_322", %"$have_gas_315"
  ...
  %"$to_uint256_one_1_326" = alloca [1 x i8], align 1
  %"$one_1_327" = load [1 x i8], [1 x i8]* %one_1, align 1
  store [1 x i8] %"$one_1_327", [1 x i8]* %"$to_uint256_one_1_326", align 1
  ...
  %"$bystrx_to_uint_load_330" = load %Uint256, %Uint256* %"$to_uint256_call_329", align 8
  store %Uint256 %"$bystrx_to_uint_load_330", %Uint256* %res19, align 8, !dbg !35
...
"$have_gas_334":                                  ; preds = %"$out_of_gas_333", %"$have_gas_323"
  ...
  %"$to_uint256_one_8_337" = alloca [8 x i8], align 1
  %"$one_8_338" = load [8 x i8], [8 x i8]* %one_8, align 1
  store [8 x i8] %"$one_8_338", [8 x i8]* %"$to_uint256_one_8_337", align 1
  ...
  %"$bystrx_to_uint_load_341" = load %Uint256, %Uint256* %"$to_uint256_call_340", align 8
  store %Uint256 %"$bystrx_to_uint_load_341", %Uint256* %res20, align 8, !dbg !36
...
"$have_gas_345":                                  ; preds = %"$out_of_gas_344", %"$have_gas_334"
  ...
  %"$to_uint256_one_16_348" = alloca [16 x i8], align 1
  %"$one_16_349" = load [16 x i8], [16 x i8]* %one_16, align 1
  store [16 x i8] %"$one_16_349", [16 x i8]* %"$to_uint256_one_16_348", align 1
  ...
  %"$bystrx_to_uint_load_352" = load %Uint256, %Uint256* %"$to_uint256_call_351", align 8
  store %Uint256 %"$bystrx_to_uint_load_352", %Uint256* %res21, align 8, !dbg !37
...
"$have_gas_356":                                  ; preds = %"$out_of_gas_355", %"$have_gas_345"
  ...
  %"$to_uint256_one_32_359" = alloca [32 x i8], align 1
  %"$one_32_360" = load [32 x i8], [32 x i8]* %one_32, align 1
  store [32 x i8] %"$one_32_360", [32 x i8]* %"$to_uint256_one_32_359", align 1
  ...
  %"$bystrx_to_uint_load_363" = load %Uint256, %Uint256* %"$to_uint256_call_362", align 8
  store %Uint256 %"$bystrx_to_uint_load_363", %Uint256* %res22, align 8, !dbg !38
...
"$have_gas_367":                                  ; preds = %"$out_of_gas_366", %"$have_gas_356"
  ...
  %"$add_res19_370" = alloca %Uint256, align 8
  %"$res19_371" = load %Uint256, %Uint256* %res19, align 8
  store %Uint256 %"$res19_371", %Uint256* %"$add_res19_370", align 8
  %"$add_res20_372" = alloca %Uint256, align 8
  %"$res20_373" = load %Uint256, %Uint256* %res20, align 8
  store %Uint256 %"$res20_373", %Uint256* %"$add_res20_372", align 8
  %"$add_call_374" = call %Uint256* @_add_Uint256(i8* %"$execptr_load_369", %Uint256* %"$add_res19_370", %Uint256* %"$add_res20_372")
  %"$add_375" = load %Uint256, %Uint256* %"$add_call_374", align 8
  store %Uint256 %"$add_375", %Uint256* %"$sum1_3", align 8, !dbg !39
...
"$have_gas_379":                                  ; preds = %"$out_of_gas_378", %"$have_gas_367"
  ...
  %"$add_res21_382" = alloca %Uint256, align 8
  %"$res21_383" = load %Uint256, %Uint256* %res21, align 8
  store %Uint256 %"$res21_383", %Uint256* %"$add_res21_382", align 8
  %"$add_res22_384" = alloca %Uint256, align 8
  %"$res22_385" = load %Uint256, %Uint256* %res22, align 8
  store %Uint256 %"$res22_385", %Uint256* %"$add_res22_384", align 8
  %"$add_call_386" = call %Uint256* @_add_Uint256(i8* %"$execptr_load_381", %Uint256* %"$add_res21_382", %Uint256* %"$add_res22_384")
  %"$add_387" = load %Uint256, %Uint256* %"$add_call_386", align 8
  store %Uint256 %"$add_387", %Uint256* %"$sum2_4", align 8, !dbg !40
...
"$have_gas_391":                                  ; preds = %"$out_of_gas_390", %"$have_gas_379"
  ...
  %"$add_$sum1_3_394" = alloca %Uint256, align 8
  %"$$sum1_3_395" = load %Uint256, %Uint256* %"$sum1_3", align 8
  store %Uint256 %"$$sum1_3_395", %Uint256* %"$add_$sum1_3_394", align 8
  %"$add_$sum2_4_396" = alloca %Uint256, align 8
  %"$$sum2_4_397" = load %Uint256, %Uint256* %"$sum2_4", align 8
  store %Uint256 %"$$sum2_4_397", %Uint256* %"$add_$sum2_4_396", align 8
  %"$add_call_398" = call %Uint256* @_add_Uint256(i8* %"$execptr_load_393", %Uint256* %"$add_$sum1_3_394", %Uint256* %"$add_$sum2_4_396")
  %"$add_399" = load %Uint256, %Uint256* %"$add_call_398", align 8
  store %Uint256 %"$add_399", %Uint256* %sum_256, align 8, !dbg !41
...
"$have_gas_408":                                  ; preds = %"$out_of_gas_407", %"$have_gas_403"
  ...
  %"$sum_32_410" = load %Uint32, %Uint32* %sum_32, align 4
  %"$sum_64_411" = load %Uint64, %Uint64* %sum_64, align 8
  %"$adtval_412_load" = load i8*, i8** @_execptr, align 8
...
"$have_gas_425":                                  ; preds = %"$out_of_gas_424", %"$have_gas_420"
  ...
  %"$sum_128_427" = load %Uint128, %Uint128* %sum_128, align 8
  %"$sum_256_428" = load %Uint256, %Uint256* %sum_256, align 8
...
"$have_gas_442":                                  ; preds = %"$out_of_gas_441", %"$have_gas_437"
  ...
  %"$respair1_444" = load %TName_Pair_Uint32_Uint64*, %TName_Pair_Uint32_Uint64** %respair1, align 8
  %"$respair2_445" = load %TName_Pair_Uint128_Uint256*, %TName_Pair_Uint128_Uint256** %respair2, align 8
  ...
  store i8 0, i8* %"$adtgep_447", align 1
  ...
  store %TName_Pair_Uint32_Uint64* %"$respair1_444", %TName_Pair_Uint32_Uint64** %"$adtgep_448", align 8
  ...
  store %TName_Pair_Uint128_Uint256* %"$respair2_445", %TName_Pair_Uint128_Uint256** %"$adtgep_449", align 8
  ...
  store %"TName_Pair_Pair_(Uint32)_(Uint64)_Pair_(Uint128)_(Uint256)"* %"$adtptr_450", %"TName_Pair_Pair_(Uint32)_(Uint64)_Pair_(Uint128)_(Uint256)"** %restuple, align 8, !dbg !44
...
"$have_gas_454":                                  ; preds = %"$out_of_gas_453", %"$have_gas_442"
  ...
  %"$restuple_456" = load %"TName_Pair_Pair_(Uint32)_(Uint64)_Pair_(Uint128)_(Uint256)"*, %"TName_Pair_Pair_(Uint32)_(Uint64)_Pair_(Uint128)_(Uint256)"** %restuple, align 8
  store %"TName_Pair_Pair_(Uint32)_(Uint64)_Pair_(Uint128)_(Uint256)"* %"$restuple_456", %"TName_Pair_Pair_(Uint32)_(Uint64)_Pair_(Uint128)_(Uint256)"** %"$expr_5", align 8, !dbg !45
  %"$$expr_5_457" = load %"TName_Pair_Pair_(Uint32)_(Uint64)_Pair_(Uint128)_(Uint256)"*, %"TName_Pair_Pair_(Uint32)_(Uint64)_Pair_(Uint128)_(Uint256)"** %"$expr_5", align 8
...
!8 = distinct !DISubprogram(name: "$scilla_expr_75", linkageName: "$scilla_expr_75", scope: !2, file: !2, type: !5, spFlags: DISPFlagDefinition, unit: !1, retainedNodes: !3)
!9 = !DILocation(line: 1, column: 12, scope: !8)
!10 = !DILocation(line: 2, column: 13, scope: !8)
!11 = !DILocation(line: 3, column: 13, scope: !8)
!12 = !DILocation(line: 4, column: 13, scope: !8)
!13 = !DILocation(line: 5, column: 13, scope: !8)
!14 = !DILocation(line: 6, column: 14, scope: !8)
!15 = !DILocation(line: 7, column: 14, scope: !8)
!16 = !DILocation(line: 9, column: 12, scope: !8)
!17 = !DILocation(line: 10, column: 12, scope: !8)
!18 = !DILocation(line: 11, column: 12, scope: !8)
!19 = !DILocation(line: 12, column: 13, scope: !8)
!20 = !DILocation(line: 13, column: 12, scope: !8)
!21 = !DILocation(line: 14, column: 12, scope: !8)
!22 = !DILocation(line: 15, column: 14, scope: !8)
!23 = !DILocation(line: 17, column: 13, scope: !8)
!24 = !DILocation(line: 18, column: 13, scope: !8)
!25 = !DILocation(line: 19, column: 13, scope: !8)
!26 = !DILocation(line: 20, column: 12, scope: !8)
!27 = !DILocation(line: 21, column: 14, scope: !8)
!28 = !DILocation(line: 23, column: 13, scope: !8)
!29 = !DILocation(line: 24, column: 13, scope: !8)
!30 = !DILocation(line: 25, column: 13, scope: !8)
!31 = !DILocation(line: 26, column: 13, scope: !8)
!32 = !DILocation(line: 27, column: 12, scope: !8)
!33 = !DILocation(line: 28, column: 12, scope: !8)
!34 = !DILocation(line: 29, column: 15, scope: !8)
!35 = !DILocation(line: 31, column: 13, scope: !8)
!36 = !DILocation(line: 32, column: 13, scope: !8)
!37 = !DILocation(line: 33, column: 13, scope: !8)
!38 = !DILocation(line: 34, column: 13, scope: !8)
!39 = !DILocation(line: 35, column: 12, scope: !8)
!40 = !DILocation(line: 36, column: 12, scope: !8)
!41 = !DILocation(line: 37, column: 15, scope: !8)
!42 = !DILocation(line: 39, column: 16, scope: !8)
!43 = !DILocation(line: 40, column: 16, scope: !8)
!44 = !DILocation(line: 41, column: 16, scope: !8)
!45 = !DILocation(line: 43, column: 1, scope: !8)
