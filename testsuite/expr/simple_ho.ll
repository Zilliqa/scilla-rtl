...
define internal %Int32 @"$scilla_expr_83"(i8* %0) !dbg !15 {
entry:
...
"$have_gas_92":                                   ; preds = %"$out_of_gas_91", %"$have_gas_87"
  ...
  store { { %Int32 (i8*, %Int32)*, i8* } (i8*, { %Int32 (i8*, %Int32)*, i8* })*, i8* } { { %Int32 (i8*, %Int32)*, i8* } (i8*, { %Int32 (i8*, %Int32)*, i8* })* bitcast ({ %Int32 (i8*, %Int32)*, i8* } (%"$$fundef_4_env_45"*, { %Int32 (i8*, %Int32)*, i8* })* @"$fundef_4" to { %Int32 (i8*, %Int32)*, i8* } (i8*, { %Int32 (i8*, %Int32)*, i8* })*), i8* null }, { { %Int32 (i8*, %Int32)*, i8* } (i8*, { %Int32 (i8*, %Int32)*, i8* })*, i8* }* %ho, align 8, !dbg !16
...
"$have_gas_105":                                  ; preds = %"$out_of_gas_104", %"$have_gas_100"
  ...
  store { %Int32 (i8*, %Int32)*, i8* } { %Int32 (i8*, %Int32)* bitcast (%Int32 (%"$$fundef_8_env_43"*, %Int32)* @"$fundef_8" to %Int32 (i8*, %Int32)*), i8* null }, { %Int32 (i8*, %Int32)*, i8* }* %inc, align 8, !dbg !17
...
"$have_gas_118":                                  ; preds = %"$out_of_gas_117", %"$have_gas_113"
  ...
  store %Int32 { i32 100 }, %Int32* %hundred, align 4, !dbg !18
...
"$have_gas_123":                                  ; preds = %"$out_of_gas_122", %"$have_gas_118"
  ...
  %"$ho_125" = load { { %Int32 (i8*, %Int32)*, i8* } (i8*, { %Int32 (i8*, %Int32)*, i8* })*, i8* }, { { %Int32 (i8*, %Int32)*, i8* } (i8*, { %Int32 (i8*, %Int32)*, i8* })*, i8* }* %ho, align 8
  ...
  %"$inc_128" = load { %Int32 (i8*, %Int32)*, i8* }, { %Int32 (i8*, %Int32)*, i8* }* %inc, align 8
  %"$ho_call_129" = call { %Int32 (i8*, %Int32)*, i8* } %"$ho_fptr_126"(i8* %"$ho_envptr_127", { %Int32 (i8*, %Int32)*, i8* } %"$inc_128"), !dbg !19
  store { %Int32 (i8*, %Int32)*, i8* } %"$ho_call_129", { %Int32 (i8*, %Int32)*, i8* }* %"$ho_1", align 8, !dbg !19
  %"$ho_2" = alloca %Int32, align 8
  %"$$ho_1_130" = load { %Int32 (i8*, %Int32)*, i8* }, { %Int32 (i8*, %Int32)*, i8* }* %"$ho_1", align 8
  %"$$ho_1_fptr_131" = extractvalue { %Int32 (i8*, %Int32)*, i8* } %"$$ho_1_130", 0
  %"$$ho_1_envptr_132" = extractvalue { %Int32 (i8*, %Int32)*, i8* } %"$$ho_1_130", 1
  %"$hundred_133" = load %Int32, %Int32* %hundred, align 4
  %"$$ho_1_call_134" = call %Int32 %"$$ho_1_fptr_131"(i8* %"$$ho_1_envptr_132", %Int32 %"$hundred_133"), !dbg !19
  store %Int32 %"$$ho_1_call_134", %Int32* %"$ho_2", align 4, !dbg !19
  %"$$ho_2_135" = load %Int32, %Int32* %"$ho_2", align 4
  store %Int32 %"$$ho_2_135", %Int32* %"$expr_3", align 4, !dbg !19
  %"$$expr_3_136" = load %Int32, %Int32* %"$expr_3", align 4
...
entry:
  ...
  %"$pval_138" = alloca %Int32, align 8
  %"$memvoidcast_139" = bitcast %Int32* %"$pval_138" to i8*
  store %Int32 %"$exprval_137", %Int32* %"$pval_138", align 4
...
!15 = distinct !DISubprogram(name: "$scilla_expr_83", linkageName: "$scilla_expr_83", scope: !2, file: !2, type: !5, spFlags: DISPFlagDefinition, unit: !1, retainedNodes: !3)
!16 = !DILocation(line: 3, column: 3, scope: !15)
!17 = !DILocation(line: 9, column: 5, scope: !15)
!18 = !DILocation(line: 13, column: 15, scope: !15)
!19 = !DILocation(line: 14, column: 1, scope: !15)
