...
"$have_gas_69":                                   ; preds = %"$out_of_gas_68", %"$have_gas_63"
  ...
  %"$sha256hash_76" = load [32 x i8], [32 x i8]* %"$sha256hash_call_75", align 1
  store [32 x i8] %"$sha256hash_76", [32 x i8]* %h1, align 1, !dbg !11
...
"$have_gas_80":                                   ; preds = %"$out_of_gas_79", %"$have_gas_69"
  ...
  %"$sha256hash_h1_83" = alloca [32 x i8], align 1
  %"$h1_84" = load [32 x i8], [32 x i8]* %h1, align 1
  store [32 x i8] %"$h1_84", [32 x i8]* %"$sha256hash_h1_83", align 1
  %"$$sha256hash_h1_83_85" = bitcast [32 x i8]* %"$sha256hash_h1_83" to i8*
  %"$sha256hash_call_86" = call [32 x i8]* @_sha256hash(i8* %"$execptr_load_82", %_TyDescrTy_Typ* @"$TyDescr_Bystr32_31", i8* %"$$sha256hash_h1_83_85")
  %"$sha256hash_87" = load [32 x i8], [32 x i8]* %"$sha256hash_call_86", align 1
  store [32 x i8] %"$sha256hash_87", [32 x i8]* %h2, align 1, !dbg !12
...
"$have_gas_108":                                  ; preds = %"$out_of_gas_107", %"$have_gas_96"
  ...
  %"$sha256hash_call_113" = call [32 x i8]* @_sha256hash(i8* %"$execptr_load_110", %_TyDescrTy_Typ* @"$TyDescr_ADT_Pair_String_ByStr32_36", i8* %"$$sh_111_112")
  %"$sha256hash_114" = load [32 x i8], [32 x i8]* %"$sha256hash_call_113", align 1
  store [32 x i8] %"$sha256hash_114", [32 x i8]* %sh2, align 1, !dbg !14
...
"$have_gas_143":                                  ; preds = %"$out_of_gas_142", %"$have_gas_138"
  ...
  %"$sha256hash_call_155" = call [32 x i8]* @_sha256hash(i8* %"$execptr_load_152", %_TyDescrTy_Typ* @"$TyDescr_ADT_Pair_ByStr_Int32_35", i8* %"$$p2_153_154")
  %"$sha256hash_156" = load [32 x i8], [32 x i8]* %"$sha256hash_call_155", align 1
  store [32 x i8] %"$sha256hash_156", [32 x i8]* %"$expr_0", align 1, !dbg !18
