...
"$have_gas_122":                                  ; preds = %"$out_of_gas_121", %"$have_gas_107"
  ...
  %"$sha256hash_call_128" = call [32 x i8]* @_sha256hash(i8* %"$execptr_load_124", %_TyDescrTy_Typ* @"$TyDescr_String_25", i8* %"$$sha256hash_s_125_127"), !dbg !12
  %"$sha256hash_130" = load [32 x i8], [32 x i8]* %"$sha256hash_call_128", align 1
  store [32 x i8] %"$sha256hash_130", [32 x i8]* %h1, align 1, !dbg !12
...
"$have_gas_149":                                  ; preds = %"$out_of_gas_148", %"$have_gas_134"
  ...
  %"$sha256hash_call_155" = call [32 x i8]* @_sha256hash(i8* %"$execptr_load_151", %_TyDescrTy_Typ* @"$TyDescr_Bystr32_39", i8* %"$$sha256hash_h1_152_154"), !dbg !13
  %"$sha256hash_157" = load [32 x i8], [32 x i8]* %"$sha256hash_call_155", align 1
  store [32 x i8] %"$sha256hash_157", [32 x i8]* %h2, align 1, !dbg !13
...
"$have_gas_192":                                  ; preds = %"$out_of_gas_191", %"$have_gas_178"
  ...
  %"$sha256hash_call_197" = call [32 x i8]* @_sha256hash(i8* %"$execptr_load_194", %_TyDescrTy_Typ* @"$TyDescr_ADT_Pair_String_ByStr32_44", i8* %"$$sh_195_196"), !dbg !15
  %"$sha256hash_199" = load [32 x i8], [32 x i8]* %"$sha256hash_call_197", align 1
  store [32 x i8] %"$sha256hash_199", [32 x i8]* %sh2, align 1, !dbg !15
...
"$have_gas_254":                                  ; preds = %"$out_of_gas_253", %"$have_gas_233"
  ...
  %"$sha256hash_call_259" = call [32 x i8]* @_sha256hash(i8* %"$execptr_load_256", %_TyDescrTy_Typ* @"$TyDescr_ADT_Pair_ByStr_Int32_43", i8* %"$$p2_257_258"), !dbg !19
  %"$sha256hash_261" = load [32 x i8], [32 x i8]* %"$sha256hash_call_259", align 1
  store [32 x i8] %"$sha256hash_261", [32 x i8]* %"$expr_6", align 1, !dbg !19
