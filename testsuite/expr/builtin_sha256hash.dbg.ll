...
"$have_gas_69":                                   ; preds = %"$out_of_gas_68", %"$have_gas_63"
  ...
  %"$gasdivceil_75" = urem i64 %"$_literal_cost_call_74", 960
  %"$gasdivceil_76" = udiv i64 %"$_literal_cost_call_74", 960
...
"$have_gas_83":                                   ; preds = %"$out_of_gas_82", %"$have_gas_69"
  ...
  %"$sha256hash_s_86" = alloca %String, align 8
  %"$s_87" = load %String, %String* %s, align 8
  store %String %"$s_87", %String* %"$sha256hash_s_86", align 8
  %"$$sha256hash_s_86_88" = bitcast %String* %"$sha256hash_s_86" to i8*
  %"$sha256hash_call_89" = call [32 x i8]* @_sha256hash(i8* %"$execptr_load_85", %_TyDescrTy_Typ* @"$TyDescr_String_19", i8* %"$$sha256hash_s_86_88"), !dbg !11
  %"$sha256hash_91" = load [32 x i8], [32 x i8]* %"$sha256hash_call_89", align 1
  store [32 x i8] %"$sha256hash_91", [32 x i8]* %h1, align 1, !dbg !11
...
"$have_gas_95":                                   ; preds = %"$out_of_gas_94", %"$have_gas_83"
  ...
  %"$gasdivceil_101" = urem i64 %"$_literal_cost_call_100", 960
  %"$gasdivceil_102" = udiv i64 %"$_literal_cost_call_100", 960
...
"$have_gas_109":                                  ; preds = %"$out_of_gas_108", %"$have_gas_95"
  ...
  %"$sha256hash_h1_112" = alloca [32 x i8], align 1
  %"$h1_113" = load [32 x i8], [32 x i8]* %h1, align 1
  store [32 x i8] %"$h1_113", [32 x i8]* %"$sha256hash_h1_112", align 1
  %"$$sha256hash_h1_112_114" = bitcast [32 x i8]* %"$sha256hash_h1_112" to i8*
  %"$sha256hash_call_115" = call [32 x i8]* @_sha256hash(i8* %"$execptr_load_111", %_TyDescrTy_Typ* @"$TyDescr_Bystr32_31", i8* %"$$sha256hash_h1_112_114"), !dbg !12
  %"$sha256hash_117" = load [32 x i8], [32 x i8]* %"$sha256hash_call_115", align 1
  store [32 x i8] %"$sha256hash_117", [32 x i8]* %h2, align 1, !dbg !12
...
"$have_gas_138":                                  ; preds = %"$out_of_gas_137", %"$have_gas_126"
  ...
  %"$gasdivceil_143" = urem i64 %"$_literal_cost_call_142", 960
  %"$gasdivceil_144" = udiv i64 %"$_literal_cost_call_142", 960
...
"$have_gas_151":                                  ; preds = %"$out_of_gas_150", %"$have_gas_138"
  ...
  %"$sha256hash_call_156" = call [32 x i8]* @_sha256hash(i8* %"$execptr_load_153", %_TyDescrTy_Typ* @"$TyDescr_ADT_Pair_String_ByStr32_36", i8* %"$$sh_154_155"), !dbg !14
  %"$sha256hash_158" = load [32 x i8], [32 x i8]* %"$sha256hash_call_156", align 1
  store [32 x i8] %"$sha256hash_158", [32 x i8]* %sh2, align 1, !dbg !14
...
"$have_gas_192":                                  ; preds = %"$out_of_gas_191", %"$have_gas_187"
  ...
  %"$gasdivceil_204" = urem i64 %"$_literal_cost_call_203", 960
  %"$gasdivceil_205" = udiv i64 %"$_literal_cost_call_203", 960
...
"$have_gas_212":                                  ; preds = %"$out_of_gas_211", %"$have_gas_192"
  ...
  %"$sha256hash_call_217" = call [32 x i8]* @_sha256hash(i8* %"$execptr_load_214", %_TyDescrTy_Typ* @"$TyDescr_ADT_Pair_ByStr_Int32_35", i8* %"$$p2_215_216"), !dbg !18
  %"$sha256hash_219" = load [32 x i8], [32 x i8]* %"$sha256hash_call_217", align 1
  store [32 x i8] %"$sha256hash_219", [32 x i8]* %"$expr_0", align 1, !dbg !18
