...
"$have_gas_69":                                   ; preds = %"$out_of_gas_68", %"$have_gas_63"
  ...
  %"$sha256hash_call_75" = call [32 x i8]* @_sha256hash(i8* %"$execptr_load_71", %_TyDescrTy_Typ* @"$TyDescr_String_19", i8* %"$$sha256hash_s_72_74"), !dbg !11
...
"$have_gas_81":                                   ; preds = %"$out_of_gas_80", %"$have_gas_69"
  ...
  %"$sha256hash_call_87" = call [32 x i8]* @_sha256hash(i8* %"$execptr_load_83", %_TyDescrTy_Typ* @"$TyDescr_Bystr32_31", i8* %"$$sha256hash_h1_84_86"), !dbg !12
...
"$have_gas_110":                                  ; preds = %"$out_of_gas_109", %"$have_gas_98"
  ...
  %"$sha256hash_call_115" = call [32 x i8]* @_sha256hash(i8* %"$execptr_load_112", %_TyDescrTy_Typ* @"$TyDescr_ADT_Pair_String_ByStr32_36", i8* %"$$sh_113_114"), !dbg !14
...
"$have_gas_146":                                  ; preds = %"$out_of_gas_145", %"$have_gas_141"
  ...
  %"$sha256hash_call_158" = call [32 x i8]* @_sha256hash(i8* %"$execptr_load_155", %_TyDescrTy_Typ* @"$TyDescr_ADT_Pair_ByStr_Int32_35", i8* %"$$p2_156_157"), !dbg !18
