...
"$have_gas_105":                                  ; preds = %"$out_of_gas_104", %"$have_gas_99"
  ...
  %"$gasdivceil_112" = urem i64 %"$gasadd_111", 960
  %"$gasdivceil_113" = udiv i64 %"$gasadd_111", 960
...
"$have_gas_120":                                  ; preds = %"$out_of_gas_119", %"$have_gas_105"
  ...
  %"$sha256hash_s_123" = alloca %String, align 8
  %"$s_124" = load %String, %String* %s, align 8
  store %String %"$s_124", %String* %"$sha256hash_s_123", align 8
  %"$$sha256hash_s_123_125" = bitcast %String* %"$sha256hash_s_123" to i8*
  %"$sha256hash_call_126" = call [32 x i8]* @_sha256hash(i8* %"$execptr_load_122", %_TyDescrTy_Typ* @"$TyDescr_String_25", i8* %"$$sha256hash_s_123_125"), !dbg !12
  %"$sha256hash_128" = load [32 x i8], [32 x i8]* %"$sha256hash_call_126", align 1
  store [32 x i8] %"$sha256hash_128", [32 x i8]* %h1, align 1, !dbg !12
...
"$have_gas_132":                                  ; preds = %"$out_of_gas_131", %"$have_gas_120"
  ...
  %"$gasdivceil_139" = urem i64 %"$gasadd_138", 960
  %"$gasdivceil_140" = udiv i64 %"$gasadd_138", 960
...
"$have_gas_147":                                  ; preds = %"$out_of_gas_146", %"$have_gas_132"
  ...
  %"$sha256hash_h1_150" = alloca [32 x i8], align 1
  %"$h1_151" = load [32 x i8], [32 x i8]* %h1, align 1
  store [32 x i8] %"$h1_151", [32 x i8]* %"$sha256hash_h1_150", align 1
  %"$$sha256hash_h1_150_152" = bitcast [32 x i8]* %"$sha256hash_h1_150" to i8*
  %"$sha256hash_call_153" = call [32 x i8]* @_sha256hash(i8* %"$execptr_load_149", %_TyDescrTy_Typ* @"$TyDescr_Bystr32_37", i8* %"$$sha256hash_h1_150_152"), !dbg !13
  %"$sha256hash_155" = load [32 x i8], [32 x i8]* %"$sha256hash_call_153", align 1
  store [32 x i8] %"$sha256hash_155", [32 x i8]* %h2, align 1, !dbg !13
...
"$have_gas_164":                                  ; preds = %"$out_of_gas_163", %"$have_gas_159"
  ...
  store %TName_Pair_String_ByStr32* %"$adtptr_172", %TName_Pair_String_ByStr32** %sh, align 8, !dbg !14
...
"$have_gas_176":                                  ; preds = %"$out_of_gas_175", %"$have_gas_164"
  ...
  %"$gasdivceil_182" = urem i64 %"$gasadd_181", 960
  %"$gasdivceil_183" = udiv i64 %"$gasadd_181", 960
...
"$have_gas_190":                                  ; preds = %"$out_of_gas_189", %"$have_gas_176"
  ...
  %"$sha256hash_call_195" = call [32 x i8]* @_sha256hash(i8* %"$execptr_load_192", %_TyDescrTy_Typ* @"$TyDescr_ADT_Pair_String_ByStr32_42", i8* %"$$sh_193_194"), !dbg !15
  %"$sha256hash_197" = load [32 x i8], [32 x i8]* %"$sha256hash_call_195", align 1
  store [32 x i8] %"$sha256hash_197", [32 x i8]* %sh2, align 1, !dbg !15
...
"$have_gas_206":                                  ; preds = %"$out_of_gas_205", %"$have_gas_201"
  ...
  %"$to_bystr_call_212" = call %Bystr @_to_bystr(i8* %"$execptr_load_208", i32 32, i8* %"$$to_bystr_sh2_209_211"), !dbg !16
...
"$have_gas_231":                                  ; preds = %"$out_of_gas_230", %"$have_gas_226"
  ...
  %"$gasdivceil_244" = urem i64 %"$gasadd_243", 960
  %"$gasdivceil_245" = udiv i64 %"$gasadd_243", 960
...
"$have_gas_252":                                  ; preds = %"$out_of_gas_251", %"$have_gas_231"
  ...
  %"$sha256hash_call_257" = call [32 x i8]* @_sha256hash(i8* %"$execptr_load_254", %_TyDescrTy_Typ* @"$TyDescr_ADT_Pair_ByStr_Int32_41", i8* %"$$p2_255_256"), !dbg !19
  %"$sha256hash_259" = load [32 x i8], [32 x i8]* %"$sha256hash_call_257", align 1
  store [32 x i8] %"$sha256hash_259", [32 x i8]* %"$expr_6", align 1, !dbg !19
