...
%"$ParamDescr_65" = type { %ParamDescrString, %_TyDescrTy_Typ* }
%ParamDescrString = type { i8*, i32 }
%"$TransDescr_66" = type { %ParamDescrString, i32, %"$ParamDescr_65"* }
...
@_contract_parameters = constant [0 x %"$ParamDescr_65"] zeroinitializer
@_contract_parameters_length = constant i32 0
@_transition_parameters = constant [0 x %"$TransDescr_66"] zeroinitializer
