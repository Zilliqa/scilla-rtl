...
define internal %TName_Bool* @"$fundef_15"(%"$$fundef_15_env_78"* %0, %TName_Bool* %1) !dbg !4 {
entry:
...
"$have_gas_179":                                  ; preds = %"$out_of_gas_178", %"$True_174"
  ...
  store %TName_Bool* %"$adtptr_183", %TName_Bool** %"$retval_16", align 8, !dbg !10
...
"$have_gas_189":                                  ; preds = %"$out_of_gas_188", %"$False_184"
  ...
  store %TName_Bool* %"$adtptr_193", %TName_Bool** %"$retval_16", align 8, !dbg !13
  br label %"$matchsucc_170"
...
define internal %TName_Bool* @"$fundef_19"(%"$$fundef_19_env_79"* %0, %TName_Bool* %1) !dbg !15 {
entry:
...
"$have_gas_152":                                  ; preds = %"$out_of_gas_151", %"$True_147"
  ...
  store %TName_Bool* %"$adtptr_156", %TName_Bool** %"$retval_20", align 8, !dbg !17
...
define internal { %TName_Bool* (i8*, %TName_Bool*)*, i8* } @"$fundef_17"(%"$$fundef_17_env_80"* %0, %TName_Bool* %1) !dbg !22 {
entry:
...
"$have_gas_127":                                  ; preds = %"$out_of_gas_126", %entry
  ...
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$$fundef_19_cloval_132", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$retval_18", align 8, !dbg !23
...
define internal %TName_Bool* @"$fundef_23"(%"$$fundef_23_env_81"* %0, %TName_Bool* %1) !dbg !24 {
entry:
...
"$have_gas_111":                                  ; preds = %"$out_of_gas_110", %"$False_106"
  ...
  store %TName_Bool* %"$adtptr_115", %TName_Bool** %"$retval_24", align 8, !dbg !26
...
define internal { %TName_Bool* (i8*, %TName_Bool*)*, i8* } @"$fundef_21"(%"$$fundef_21_env_82"* %0, %TName_Bool* %1) !dbg !31 {
entry:
...
"$have_gas_86":                                   ; preds = %"$out_of_gas_85", %entry
  ...
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$$fundef_23_cloval_91", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$retval_22", align 8, !dbg !32
...
"$have_gas_198":                                  ; preds = %"$out_of_gas_197", %entry
  ...
  store { { %TName_Bool* (i8*, %TName_Bool*)*, i8* } (i8*, %TName_Bool*)*, i8* } { { %TName_Bool* (i8*, %TName_Bool*)*, i8* } (i8*, %TName_Bool*)* bitcast ({ %TName_Bool* (i8*, %TName_Bool*)*, i8* } (%"$$fundef_21_env_82"*, %TName_Bool*)* @"$fundef_21" to { %TName_Bool* (i8*, %TName_Bool*)*, i8* } (i8*, %TName_Bool*)*), i8* null }, { { %TName_Bool* (i8*, %TName_Bool*)*, i8* } (i8*, %TName_Bool*)*, i8* }* @BoolUtils.andb, align 8, !dbg !36
...
"$have_gas_206":                                  ; preds = %"$out_of_gas_205", %"$have_gas_198"
  ...
  store { { %TName_Bool* (i8*, %TName_Bool*)*, i8* } (i8*, %TName_Bool*)*, i8* } { { %TName_Bool* (i8*, %TName_Bool*)*, i8* } (i8*, %TName_Bool*)* bitcast ({ %TName_Bool* (i8*, %TName_Bool*)*, i8* } (%"$$fundef_17_env_80"*, %TName_Bool*)* @"$fundef_17" to { %TName_Bool* (i8*, %TName_Bool*)*, i8* } (i8*, %TName_Bool*)*), i8* null }, { { %TName_Bool* (i8*, %TName_Bool*)*, i8* } (i8*, %TName_Bool*)*, i8* }* @BoolUtils.orb, align 8, !dbg !37
...
"$have_gas_214":                                  ; preds = %"$out_of_gas_213", %"$have_gas_206"
  ...
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } { %TName_Bool* (i8*, %TName_Bool*)* bitcast (%TName_Bool* (%"$$fundef_15_env_78"*, %TName_Bool*)* @"$fundef_15" to %TName_Bool* (i8*, %TName_Bool*)*), i8* null }, { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* @BoolUtils.negb, align 8, !dbg !38
...
"$have_gas_312":                                  ; preds = %"$out_of_gas_311", %"$have_gas_307"
  ...
  %"$eq_call_317" = call %TName_Bool* @_eq_Uint128(i8* %"$execptr_load_314", %Uint128 %"$ui256a_315", %Uint128 %"$ui256a_316"), !dbg !40
  store %TName_Bool* %"$eq_call_317", %TName_Bool** %b9, align 8, !dbg !40
...
"$have_gas_337":                                  ; preds = %"$out_of_gas_336", %"$have_gas_332"
  ...
  store %String { i8* getelementptr inbounds ([5 x i8], [5 x i8]* @"$stringlit_339", i32 0, i32 0), i32 5 }, %String* %s1, align 8, !dbg !41
...
"$have_gas_348":                                  ; preds = %"$out_of_gas_347", %"$have_gas_343"
  ...
  store %String { i8* getelementptr inbounds ([5 x i8], [5 x i8]* @"$stringlit_350", i32 0, i32 0), i32 5 }, %String* %s2, align 8, !dbg !42
...
"$have_gas_359":                                  ; preds = %"$out_of_gas_358", %"$have_gas_354"
  ...
  store %String { i8* getelementptr inbounds ([5 x i8], [5 x i8]* @"$stringlit_361", i32 0, i32 0), i32 5 }, %String* %s11, align 8, !dbg !43
...
"$have_gas_365":                                  ; preds = %"$out_of_gas_364", %"$have_gas_359"
  ...
  %"$eq_call_370" = call %TName_Bool* @_eq_String(i8* %"$execptr_load_367", %String %"$s1_368", %String %"$s2_369"), !dbg !44
  store %TName_Bool* %"$eq_call_370", %TName_Bool** %b12, align 8, !dbg !44
...
"$have_gas_375":                                  ; preds = %"$out_of_gas_374", %"$have_gas_365"
  ...
  %"$eq_call_380" = call %TName_Bool* @_eq_String(i8* %"$execptr_load_377", %String %"$s1_378", %String %"$s11_379"), !dbg !45
  store %TName_Bool* %"$eq_call_380", %TName_Bool** %b13, align 8, !dbg !45
...
"$have_gas_390":                                  ; preds = %"$out_of_gas_389", %"$have_gas_385"
  ...
  %"$BoolUtils.andb_call_396" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_fptr_393"(i8* %"$BoolUtils.andb_envptr_394", %TName_Bool* %"$b9_395"), !dbg !46
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_call_396", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.andb_1", align 8, !dbg !46
  ...
  %"$$BoolUtils.andb_1_call_401" = call %TName_Bool* %"$$BoolUtils.andb_1_fptr_398"(i8* %"$$BoolUtils.andb_1_envptr_399", %TName_Bool* %"$b12_400"), !dbg !46
  store %TName_Bool* %"$$BoolUtils.andb_1_call_401", %TName_Bool** %"$BoolUtils.andb_2", align 8, !dbg !46
  %"$$BoolUtils.andb_2_402" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.andb_2", align 8
  store %TName_Bool* %"$$BoolUtils.andb_2_402", %TName_Bool** %b14, align 8, !dbg !46
...
"$have_gas_411":                                  ; preds = %"$out_of_gas_410", %"$have_gas_406"
  ...
  %"$BoolUtils.orb_call_417" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.orb_fptr_414"(i8* %"$BoolUtils.orb_envptr_415", %TName_Bool* %"$b13_416"), !dbg !47
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.orb_call_417", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.orb_3", align 8, !dbg !47
  ...
  %"$$BoolUtils.orb_3_call_422" = call %TName_Bool* %"$$BoolUtils.orb_3_fptr_419"(i8* %"$$BoolUtils.orb_3_envptr_420", %TName_Bool* %"$b14_421"), !dbg !47
  store %TName_Bool* %"$$BoolUtils.orb_3_call_422", %TName_Bool** %"$BoolUtils.orb_4", align 8, !dbg !47
  %"$$BoolUtils.orb_4_423" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.orb_4", align 8
  store %TName_Bool* %"$$BoolUtils.orb_4_423", %TName_Bool** %b15, align 8, !dbg !47
...
"$have_gas_457":                                  ; preds = %"$out_of_gas_456", %"$have_gas_452"
  ...
  %"$eq_call_466" = call %TName_Bool* @_eq_ByStrX(i8* %"$execptr_load_459", i32 2, i8* %"$$eq_bs1_460_462", i8* %"$$eq_bs2_463_465"), !dbg !51
  store %TName_Bool* %"$eq_call_466", %TName_Bool** %b16, align 8, !dbg !51
...
"$have_gas_471":                                  ; preds = %"$out_of_gas_470", %"$have_gas_457"
  ...
  %"$eq_call_480" = call %TName_Bool* @_eq_ByStrX(i8* %"$execptr_load_473", i32 2, i8* %"$$eq_bs1_474_476", i8* %"$$eq_bs11_477_479"), !dbg !52
  store %TName_Bool* %"$eq_call_480", %TName_Bool** %b17, align 8, !dbg !52
...
"$have_gas_490":                                  ; preds = %"$out_of_gas_489", %"$have_gas_485"
  ...
  %"$BoolUtils.orb_call_496" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.orb_fptr_493"(i8* %"$BoolUtils.orb_envptr_494", %TName_Bool* %"$b16_495"), !dbg !53
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.orb_call_496", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.orb_5", align 8, !dbg !53
  ...
  %"$$BoolUtils.orb_5_call_501" = call %TName_Bool* %"$$BoolUtils.orb_5_fptr_498"(i8* %"$$BoolUtils.orb_5_envptr_499", %TName_Bool* %"$b17_500"), !dbg !53
  store %TName_Bool* %"$$BoolUtils.orb_5_call_501", %TName_Bool** %"$BoolUtils.orb_6", align 8, !dbg !53
  %"$$BoolUtils.orb_6_502" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.orb_6", align 8
  store %TName_Bool* %"$$BoolUtils.orb_6_502", %TName_Bool** %b18, align 8, !dbg !53
...
"$have_gas_511":                                  ; preds = %"$out_of_gas_510", %"$have_gas_506"
  ...
  %"$BoolUtils.andb_call_517" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_fptr_514"(i8* %"$BoolUtils.andb_envptr_515", %TName_Bool* %"$b18_516"), !dbg !54
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_call_517", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.andb_7", align 8, !dbg !54
  ...
  %"$$BoolUtils.andb_7_call_522" = call %TName_Bool* %"$$BoolUtils.andb_7_fptr_519"(i8* %"$$BoolUtils.andb_7_envptr_520", %TName_Bool* %"$b15_521"), !dbg !54
  store %TName_Bool* %"$$BoolUtils.andb_7_call_522", %TName_Bool** %"$BoolUtils.andb_8", align 8, !dbg !54
  %"$$BoolUtils.andb_8_523" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.andb_8", align 8
  store %TName_Bool* %"$$BoolUtils.andb_8_523", %TName_Bool** %b19, align 8, !dbg !54
...
"$have_gas_547":                                  ; preds = %"$out_of_gas_546", %"$have_gas_542"
  ...
  %"$eq_call_556" = call %TName_Bool* @_eq_ByStrX(i8* %"$execptr_load_549", i32 3, i8* %"$$eq_bs3_550_552", i8* %"$$eq_bs4_553_555"), !dbg !57
  store %TName_Bool* %"$eq_call_556", %TName_Bool** %b20, align 8, !dbg !57
...
"$have_gas_566":                                  ; preds = %"$out_of_gas_565", %"$have_gas_561"
  ...
  %"$BoolUtils.negb_call_572" = call %TName_Bool* %"$BoolUtils.negb_fptr_569"(i8* %"$BoolUtils.negb_envptr_570", %TName_Bool* %"$b20_571"), !dbg !58
  store %TName_Bool* %"$BoolUtils.negb_call_572", %TName_Bool** %"$BoolUtils.negb_9", align 8, !dbg !58
  %"$$BoolUtils.negb_9_573" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.negb_9", align 8
  store %TName_Bool* %"$$BoolUtils.negb_9_573", %TName_Bool** %b21, align 8, !dbg !58
...
"$have_gas_582":                                  ; preds = %"$out_of_gas_581", %"$have_gas_577"
  ...
  %"$BoolUtils.andb_call_588" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_fptr_585"(i8* %"$BoolUtils.andb_envptr_586", %TName_Bool* %"$b19_587"), !dbg !59
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_call_588", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.andb_10", align 8, !dbg !59
  ...
  %"$$BoolUtils.andb_10_call_593" = call %TName_Bool* %"$$BoolUtils.andb_10_fptr_590"(i8* %"$$BoolUtils.andb_10_envptr_591", %TName_Bool* %"$b21_592"), !dbg !59
  store %TName_Bool* %"$$BoolUtils.andb_10_call_593", %TName_Bool** %"$BoolUtils.andb_11", align 8, !dbg !59
  %"$$BoolUtils.andb_11_594" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.andb_11", align 8
  store %TName_Bool* %"$$BoolUtils.andb_11_594", %TName_Bool** %b22, align 8, !dbg !59
...
"$have_gas_598":                                  ; preds = %"$out_of_gas_597", %"$have_gas_582"
  ...
  %"$to_bystr_call_604" = call %Bystr @_to_bystr(i8* %"$execptr_load_600", i32 2, i8* %"$$to_bystr_bs1_601_603"), !dbg !60
  store %Bystr %"$to_bystr_call_604", %Bystr* %"$bs11_0", align 8, !dbg !60
...
"$have_gas_608":                                  ; preds = %"$out_of_gas_607", %"$have_gas_598"
  ...
  %"$to_bystr_call_614" = call %Bystr @_to_bystr(i8* %"$execptr_load_610", i32 2, i8* %"$$to_bystr_bs2_611_613"), !dbg !61
  store %Bystr %"$to_bystr_call_614", %Bystr* %bs22, align 8, !dbg !61
...
"$have_gas_618":                                  ; preds = %"$out_of_gas_617", %"$have_gas_608"
  ...
  %"$eq_call_623" = call %TName_Bool* @_eq_ByStr(i8* %"$execptr_load_620", %Bystr %"$$bs11_0_621", %Bystr %"$bs22_622"), !dbg !62
  store %TName_Bool* %"$eq_call_623", %TName_Bool** %b23, align 8, !dbg !62
...
"$have_gas_633":                                  ; preds = %"$out_of_gas_632", %"$have_gas_628"
  ...
  %"$BoolUtils.negb_call_639" = call %TName_Bool* %"$BoolUtils.negb_fptr_636"(i8* %"$BoolUtils.negb_envptr_637", %TName_Bool* %"$b23_638"), !dbg !63
  store %TName_Bool* %"$BoolUtils.negb_call_639", %TName_Bool** %"$BoolUtils.negb_12", align 8, !dbg !63
  %"$$BoolUtils.negb_12_640" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.negb_12", align 8
  store %TName_Bool* %"$$BoolUtils.negb_12_640", %TName_Bool** %b24, align 8, !dbg !63
...
"$have_gas_649":                                  ; preds = %"$out_of_gas_648", %"$have_gas_644"
  ...
  %"$BoolUtils.andb_call_655" = call { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_fptr_652"(i8* %"$BoolUtils.andb_envptr_653", %TName_Bool* %"$b22_654"), !dbg !64
  store { %TName_Bool* (i8*, %TName_Bool*)*, i8* } %"$BoolUtils.andb_call_655", { %TName_Bool* (i8*, %TName_Bool*)*, i8* }* %"$BoolUtils.andb_13", align 8, !dbg !64
  ...
  %"$$BoolUtils.andb_13_call_660" = call %TName_Bool* %"$$BoolUtils.andb_13_fptr_657"(i8* %"$$BoolUtils.andb_13_envptr_658", %TName_Bool* %"$b24_659"), !dbg !64
  store %TName_Bool* %"$$BoolUtils.andb_13_call_660", %TName_Bool** %"$BoolUtils.andb_14", align 8, !dbg !64
  %"$$BoolUtils.andb_14_661" = load %TName_Bool*, %TName_Bool** %"$BoolUtils.andb_14", align 8
  store %TName_Bool* %"$$BoolUtils.andb_14_661", %TName_Bool** %b25, align 8, !dbg !64
...
"$have_gas_665":                                  ; preds = %"$out_of_gas_664", %"$have_gas_649"
  ...
  store %TName_Bool* %"$b25_667", %TName_Bool** %"$expr_25", align 8, !dbg !65
