...
"$have_gas_90":                                   ; preds = %"$out_of_gas_89", %"$have_gas_85"
  ...
  store { %Int32 (i8*, %Int32)*, i8* } { %Int32 (i8*, %Int32)* bitcast (%Int32 (%"$$fundef_8_env_45"*, %Int32)* @"$fundef_8" to %Int32 (i8*, %Int32)*), i8* null }, { %Int32 (i8*, %Int32)*, i8* }* %f, align 8
...
"$have_gas_108":                                  ; preds = %"$out_of_gas_107", %"$have_gas_103"
  ...
  %"$f_call_114" = call %Int32 %"$f_fptr_111"(i8* %"$f_envptr_112", %Int32 %"$i_113")
  store %Int32 %"$f_call_114", %Int32* %"$f_6", align 4
  %"$$f_6_115" = load %Int32, %Int32* %"$f_6", align 4
  store %Int32 %"$$f_6_115", %Int32* %"$expr_7", align 4
