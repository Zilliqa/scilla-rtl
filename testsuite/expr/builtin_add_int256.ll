...
define internal void @"$scilla_expr_34"(i8* %0, %Int256* %1) !dbg !8 {
entry:
...
"$have_gas_43":                                   ; preds = %"$out_of_gas_42", %"$have_gas_38"
  ...
  store %Int256 { i256 -1 }, %Int256* %one, align 8, !dbg !9
...
"$have_gas_53":                                   ; preds = %"$out_of_gas_52", %"$have_gas_48"
  ...
  store %Int256 { i256 2 }, %Int256* %two, align 8, !dbg !10
  %"$execptr_load_55" = load i8*, i8** @_execptr, align 8
  %"$add_one_56" = alloca %Int256, align 8
  %"$one_57" = load %Int256, %Int256* %one, align 8
  store %Int256 %"$one_57", %Int256* %"$add_one_56", align 8
  %"$add_two_58" = alloca %Int256, align 8
  %"$two_59" = load %Int256, %Int256* %two, align 8
  store %Int256 %"$two_59", %Int256* %"$add_two_58", align 8
  %"$add_call_60" = call %Int256* @_add_Int256(i8* %"$execptr_load_55", %Int256* %"$add_one_56", %Int256* %"$add_two_58")
  %"$add_61" = load %Int256, %Int256* %"$add_call_60", align 8
  store %Int256 %"$add_61", %Int256* %"$expr_0", align 8, !dbg !11
  %"$$expr_0_62" = load %Int256, %Int256* %"$expr_0", align 8
  store %Int256 %"$$expr_0_62", %Int256* %1, align 8
  ret void
}
...
entry:
  %"$mainval_63" = alloca %Int256, align 8
  %"$memvoidcast_64" = bitcast %Int256* %"$mainval_63" to i8*
  call void @"$scilla_expr_34"(i8* null, %Int256* %"$mainval_63")
  call void @_print_scilla_val(%_TyDescrTy_Typ* @"$TyDescr_Int256_15", i8* %"$memvoidcast_64")
  ret void
}
