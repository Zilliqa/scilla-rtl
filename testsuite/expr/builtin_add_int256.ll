...
"$have_gas_53":                                   ; preds = %"$out_of_gas_52", %"$have_gas_48"
  ...
  %"$add_one_56" = alloca %Int256
  %"$one_57" = load %Int256, %Int256* %one
  store %Int256 %"$one_57", %Int256* %"$add_one_56"
  %"$add_two_58" = alloca %Int256
  %"$two_59" = load %Int256, %Int256* %two
  store %Int256 %"$two_59", %Int256* %"$add_two_58"
  %"$add_call_60" = call %Int256* @_add_Int256(i8* %"$execptr_load_55", %Int256* %"$add_one_56", %Int256* %"$add_two_58")
  %"$add_61" = load %Int256, %Int256* %"$add_call_60"
  store %Int256 %"$add_61", %Int256* %"$expr_0"
  %"$$expr_0_62" = load %Int256, %Int256* %"$expr_0"
  store %Int256 %"$$expr_0_62", %Int256* %1
  ret void
}
