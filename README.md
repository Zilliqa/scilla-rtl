...
Install these Ubuntu packages
  - `sudo apt-get install build-essential cmake libboost-dev libboost-test-dev libjsoncpp-dev libboost-filesystem-dev libboost-program-options-dev libsecp256k1-dev`
